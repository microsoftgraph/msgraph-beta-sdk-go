...
// RenewGroupResponse provides operations to call the renewGroup method.
...
func (m *RenewGroupResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *RenewGroupResponse) SetAdditionalData(value map[string]interface{})() {
