...
func (m *GroupLifecyclePoliciesRequestBuilder) MicrosoftGraphRenewGroup()(*MicrosoftGraphRenewGroupRenewGroupRequestBuilder) {
    return NewMicrosoftGraphRenewGroupRenewGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
