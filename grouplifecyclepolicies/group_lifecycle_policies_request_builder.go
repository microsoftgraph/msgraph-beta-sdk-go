...
func (m *GroupLifecyclePoliciesRequestBuilder) MicrosoftGraphRenewGroup()(*MicrosoftGraphRenewGroupRequestBuilder) {
    return NewMicrosoftGraphRenewGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
