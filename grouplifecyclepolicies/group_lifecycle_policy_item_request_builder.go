...
func (m *GroupLifecyclePolicyItemRequestBuilder) AddGroup()(*ItemAddgroupAddGroupRequestBuilder) {
    return NewItemAddgroupAddGroupRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *GroupLifecyclePolicyItemRequestBuilder) RemoveGroup()(*ItemRemovegroupRemoveGroupRequestBuilder) {
    return NewItemRemovegroupRemoveGroupRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
