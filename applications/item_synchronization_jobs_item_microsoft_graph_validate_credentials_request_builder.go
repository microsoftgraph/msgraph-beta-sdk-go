...
// ItemSynchronizationJobsItemMicrosoftGraphValidateCredentialsRequestBuilder provides operations to call the validateCredentials method.
...
// ItemSynchronizationJobsItemMicrosoftGraphValidateCredentialsRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSynchronizationJobsItemMicrosoftGraphValidateCredentialsRequestBuilderPostRequestConfiguration struct {
    // Request headers
