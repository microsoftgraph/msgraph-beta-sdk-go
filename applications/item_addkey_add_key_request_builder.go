...
func NewItemAddkeyAddKeyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAddkeyAddKeyRequestBuilder) {
    m := &ItemAddkeyAddKeyRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/applications/{application%2Did}/addKey", pathParameters),
    }
    return m
}
...
func NewItemAddkeyAddKeyRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAddkeyAddKeyRequestBuilder) {
    ...
    return NewItemAddkeyAddKeyRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemAddkeyAddKeyRequestBuilder) Post(ctx context.Context, body ItemAddkeyAddKeyPostRequestBodyable, requestConfiguration *ItemAddkeyAddKeyRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.KeyCredentialable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateKeyCredentialFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemAddkeyAddKeyRequestBuilder) WithUrl(rawUrl string)(*ItemAddkeyAddKeyRequestBuilder) {
    return NewItemAddkeyAddKeyRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
