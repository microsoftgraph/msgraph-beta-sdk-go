...
func NewHomeRealmDiscoveryPoliciesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HomeRealmDiscoveryPoliciesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/applications/{application_id}/homeRealmDiscoveryPolicies{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *HomeRealmDiscoveryPoliciesRequestBuilder) Ref()(*i9b2ba2d887107cd013ea79707d9430fc8226eba441a936aea297fdfa60ffc1b9.RefRequestBuilder) {
    return i9b2ba2d887107cd013ea79707d9430fc8226eba441a936aea297fdfa60ffc1b9.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
