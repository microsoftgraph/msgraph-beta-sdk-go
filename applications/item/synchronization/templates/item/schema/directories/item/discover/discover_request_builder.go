...
func NewDiscoverRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DiscoverRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/applications/{application_id}/synchronization/templates/{synchronizationTemplate_id}/schema/directories/{directoryDefinition_id}/microsoft.graph.discover";
