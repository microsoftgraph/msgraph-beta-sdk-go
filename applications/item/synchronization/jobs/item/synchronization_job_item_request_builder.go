...
// DeleteWithResponseHandler delete navigation property jobs for applications
...
// PatchWithResponseHandler update the navigation property jobs in applications
