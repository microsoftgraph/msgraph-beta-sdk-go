...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property jobs for applications
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property jobs in applications
