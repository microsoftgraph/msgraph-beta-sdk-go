...
// RestartRequestBuilder builds and executes requests for operations under \applications\{application-id}\synchronization\jobs\{synchronizationJob-id}\microsoft.graph.restart
...
// RestartRequestBuilderPostOptions options for Post
type RestartRequestBuilderPostOptions struct {
    // 
...
func (m *RestartRequestBuilder) CreatePostRequestInformation(options *RestartRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *RestartRequestBuilder) Post(options *RestartRequestBuilderPostOptions)(error) {
