...
func (m *RestartRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body RestartRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action restart
func (m *RestartRequestBuilder) PostWithResponseHandler(body RestartRequestBodyable, requestConfiguration *RestartRequestBuilderPostRequestConfiguration)(error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action restart
func (m *RestartRequestBuilder) PostWithResponseHandler(body RestartRequestBodyable, requestConfiguration *RestartRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
