...
func (m *AcquireAccessTokenRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body AcquireAccessTokenRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action acquireAccessToken
func (m *AcquireAccessTokenRequestBuilder) PostWithResponseHandler(body AcquireAccessTokenRequestBodyable, requestConfiguration *AcquireAccessTokenRequestBuilderPostRequestConfiguration)(error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action acquireAccessToken
func (m *AcquireAccessTokenRequestBuilder) PostWithResponseHandler(body AcquireAccessTokenRequestBodyable, requestConfiguration *AcquireAccessTokenRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
