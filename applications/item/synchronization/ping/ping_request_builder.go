...
func (m *PingRequestBuilder) CreateGetRequestInformationWithRequestConfiguration()(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// GetWithResponseHandler invoke function Ping
func (m *PingRequestBuilder) GetWithResponseHandler(requestConfiguration *PingRequestBuilderGetRequestConfiguration)(PingResponseable, error) {
    return m.GetWithResponseHandler(requestConfiguration, nil);
}
// GetWithResponseHandler invoke function Ping
func (m *PingRequestBuilder) GetWithResponseHandler(requestConfiguration *PingRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(PingResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformationWithRequestConfiguration(requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreatePingResponseFromDiscriminatorValue, responseHandler, nil)
    if err != nil {
        return nil, err
    }
