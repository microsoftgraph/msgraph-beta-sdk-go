...
func (m *PingRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *PingRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PingRequestBuilder) Get(ctx context.Context, requestConfiguration *PingRequestBuilderGetRequestConfiguration)(PingResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreatePingResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
