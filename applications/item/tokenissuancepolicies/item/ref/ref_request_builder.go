...
// RefRequestBuilderDeleteQueryParameters delete ref of navigation property tokenIssuancePolicies for applications
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/applications/{application%2Did}/tokenIssuancePolicies/{tokenIssuancePolicy%2Did}/$ref{?%40id}";
...
// CreateDeleteRequestInformationWithRequestConfiguration delete ref of navigation property tokenIssuancePolicies for applications
...
// DeleteWithRequestConfigurationAndResponseHandler delete ref of navigation property tokenIssuancePolicies for applications
