...
import (
    ...
    i31f4f3f747040397c7a77b3c84d060c65376d6f7d1465b661d0be2a7e25cdb59 "github.com/microsoftgraph/msgraph-beta-sdk-go/applications/item/owners/serviceprincipal/count"
)
...
func NewServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ServicePrincipalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/applications/{application%2Did}/owners/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ServicePrincipalRequestBuilder) Count()(*i31f4f3f747040397c7a77b3c84d060c65376d6f7d1465b661d0be2a7e25cdb59.CountRequestBuilder) {
    return i31f4f3f747040397c7a77b3c84d060c65376d6f7d1465b661d0be2a7e25cdb59.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
