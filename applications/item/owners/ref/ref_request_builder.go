...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/applications/{application%2Did}/owners/$ref{?%24top,%24skip,%24search,%24filter,%24count,%24orderby}";
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property ref to owners for applications
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property ref to owners for applications
