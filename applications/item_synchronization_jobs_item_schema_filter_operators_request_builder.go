...
// ItemSynchronizationJobsItemSchemaFilterOperatorsRequestBuilderGetQueryParameters list all operators supported in the scoping filters for a synchronizationSchema.
