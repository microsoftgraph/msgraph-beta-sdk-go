...
func NewApplicationsItemTokenIssuancePoliciesRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenIssuancePoliciesRefRequestBuilder) {
    m := &ApplicationsItemTokenIssuancePoliciesRefRequestBuilder{
    }
...
func NewApplicationsItemTokenIssuancePoliciesRefRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenIssuancePoliciesRefRequestBuilder) {
    ...
    return NewApplicationsItemTokenIssuancePoliciesRefRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation list the tokenIssuancePolicy objects that are assigned to an application.
func (m *ApplicationsItemTokenIssuancePoliciesRefRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemTokenIssuancePoliciesRefRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemTokenIssuancePoliciesRefRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ReferenceCreateable, requestConfiguration *ApplicationsItemTokenIssuancePoliciesRefRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ApplicationsItemTokenIssuancePoliciesRefRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsItemTokenIssuancePoliciesRefRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.StringCollectionResponseable, error) {
...
func (m *ApplicationsItemTokenIssuancePoliciesRefRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ReferenceCreateable, requestConfiguration *ApplicationsItemTokenIssuancePoliciesRefRequestBuilderPostRequestConfiguration)(error) {
