...
func NewItemMicrosoftGraphGetMemberObjectsGetMemberObjectsResponse()(*ItemMicrosoftGraphGetMemberObjectsGetMemberObjectsResponse) {
    m := &ItemMicrosoftGraphGetMemberObjectsGetMemberObjectsResponse{
...
func CreateItemMicrosoftGraphGetMemberObjectsGetMemberObjectsResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemMicrosoftGraphGetMemberObjectsGetMemberObjectsResponse(), nil
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemMicrosoftGraphGetMemberObjectsGetMemberObjectsResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemMicrosoftGraphGetMemberObjectsGetMemberObjectsResponse) GetValue()([]string) {
    return m.value
}
// Serialize serializes information the current object
func (m *ItemMicrosoftGraphGetMemberObjectsGetMemberObjectsResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ItemMicrosoftGraphGetMemberObjectsGetMemberObjectsResponse) SetValue(value []string)() {
    m.value = value
}
