...
func NewItemSynchronizationJobsItemProvisionondemandProvisionOnDemandPostRequestBody()(*ItemSynchronizationJobsItemProvisionondemandProvisionOnDemandPostRequestBody) {
    m := &ItemSynchronizationJobsItemProvisionondemandProvisionOnDemandPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemSynchronizationJobsItemProvisionondemandProvisionOnDemandPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateItemSynchronizationJobsItemProvisionondemandProvisionOnDemandPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemSynchronizationJobsItemProvisionondemandProvisionOnDemandPostRequestBody(), nil
}
...
func (m *ItemSynchronizationJobsItemProvisionondemandProvisionOnDemandPostRequestBody) GetParameters()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SynchronizationJobApplicationParametersable) {
    val, err := m.GetBackingStore().Get("parameters")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SynchronizationJobApplicationParametersable)
    }
    return nil
}
...
func (m *ItemSynchronizationJobsItemProvisionondemandProvisionOnDemandPostRequestBody) SetParameters(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SynchronizationJobApplicationParametersable)() {
...
type ItemSynchronizationJobsItemProvisionondemandProvisionOnDemandPostRequestBodyable interface {
    ...
    GetParameters()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SynchronizationJobApplicationParametersable)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetParameters(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SynchronizationJobApplicationParametersable)()
}
