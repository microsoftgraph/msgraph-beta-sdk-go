...
func NewItemMicrosoftGraphRemovePasswordRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphRemovePasswordRequestBuilder) {
    m := &ItemMicrosoftGraphRemovePasswordRequestBuilder{
    }
...
func NewItemMicrosoftGraphRemovePasswordRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphRemovePasswordRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemMicrosoftGraphRemovePasswordRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemMicrosoftGraphRemovePasswordRequestBuilder) Post(ctx context.Context, body ItemMicrosoftGraphRemovePasswordRemovePasswordPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphRemovePasswordRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemMicrosoftGraphRemovePasswordRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemMicrosoftGraphRemovePasswordRemovePasswordPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphRemovePasswordRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
