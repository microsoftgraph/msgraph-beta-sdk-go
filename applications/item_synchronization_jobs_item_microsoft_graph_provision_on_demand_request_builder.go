...
// ItemSynchronizationJobsItemMicrosoftGraphProvisionOnDemandRequestBuilder provides operations to call the provisionOnDemand method.
...
// ItemSynchronizationJobsItemMicrosoftGraphProvisionOnDemandRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSynchronizationJobsItemMicrosoftGraphProvisionOnDemandRequestBuilderPostRequestConfiguration struct {
    // Request headers
