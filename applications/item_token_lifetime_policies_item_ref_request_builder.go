...
// ItemTokenLifetimePoliciesItemRefRequestBuilderDeleteQueryParameters remove a tokenLifetimePolicy from an application or servicePrincipal. This API is supported in the following national cloud deployments.
...
// Delete remove a tokenLifetimePolicy from an application or servicePrincipal. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToDeleteRequestInformation remove a tokenLifetimePolicy from an application or servicePrincipal. This API is supported in the following national cloud deployments.
