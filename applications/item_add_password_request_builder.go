...
// Post adds a strong password to an application. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation adds a strong password to an application. This API is supported in the following national cloud deployments.
