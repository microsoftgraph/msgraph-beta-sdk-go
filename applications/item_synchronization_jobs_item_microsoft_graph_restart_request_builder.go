...
// ItemSynchronizationJobsItemMicrosoftGraphRestartRequestBuilder provides operations to call the restart method.
...
// ItemSynchronizationJobsItemMicrosoftGraphRestartRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSynchronizationJobsItemMicrosoftGraphRestartRequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func (m *ItemSynchronizationJobsItemMicrosoftGraphRestartRequestBuilder) Post(ctx context.Context, body ItemSynchronizationJobsItemMicrosoftGraphRestartRestartPostRequestBodyable, requestConfiguration *ItemSynchronizationJobsItemMicrosoftGraphRestartRequestBuilderPostRequestConfiguration)(error) {
