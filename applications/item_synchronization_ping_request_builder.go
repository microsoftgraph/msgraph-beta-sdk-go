...
// NewItemSynchronizationPingRequestBuilderInternal instantiates a new PingRequestBuilder and sets the default values.
...
// NewItemSynchronizationPingRequestBuilder instantiates a new PingRequestBuilder and sets the default values.
...
func (m *ItemSynchronizationPingRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemSynchronizationPingRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemSynchronizationPingRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSynchronizationPingRequestBuilderGetRequestConfiguration)(ItemSynchronizationPingResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateItemSynchronizationPingResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
