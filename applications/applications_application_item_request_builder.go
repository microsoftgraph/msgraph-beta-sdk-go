...
func (m *ApplicationsApplicationItemRequestBuilder) AppManagementPolicies()(*ApplicationsItemAppManagementPoliciesRequestBuilder) {
    return NewApplicationsItemAppManagementPoliciesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ApplicationsApplicationItemRequestBuilder) AppManagementPoliciesById(id string)(*ApplicationsItemAppManagementPoliciesAppManagementPolicyItemRequestBuilder) {
    ...
    return NewApplicationsItemAppManagementPoliciesAppManagementPolicyItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *ApplicationsApplicationItemRequestBuilder) ConnectorGroup()(*ApplicationsItemConnectorGroupRequestBuilder) {
    return NewApplicationsItemConnectorGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ApplicationsApplicationItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Applicationable, requestConfiguration *ApplicationsApplicationItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ApplicationsApplicationItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsApplicationItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Applicationable, error) {
...
func (m *ApplicationsApplicationItemRequestBuilder) Synchronization()(*ApplicationsItemSynchronizationRequestBuilder) {
    return NewApplicationsItemSynchronizationRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
