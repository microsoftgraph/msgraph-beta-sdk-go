...
// ItemConnectorGroupRequestBuilder provides operations to manage the connectorGroup property of the microsoft.graph.application entity.
...
type ItemConnectorGroupRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemConnectorGroupRequestBuilderGetQueryParameters
}
// NewItemConnectorGroupRequestBuilderInternal instantiates a new ConnectorGroupRequestBuilder and sets the default values.
func NewItemConnectorGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemConnectorGroupRequestBuilder) {
    m := &ItemConnectorGroupRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/applications/{application%2Did}/connectorGroup{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemConnectorGroupRequestBuilder instantiates a new ConnectorGroupRequestBuilder and sets the default values.
func NewItemConnectorGroupRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemConnectorGroupRequestBuilder) {
...
func (m *ItemConnectorGroupRequestBuilder) WithUrl(rawUrl string)(*ItemConnectorGroupRequestBuilder) {
    return NewItemConnectorGroupRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
