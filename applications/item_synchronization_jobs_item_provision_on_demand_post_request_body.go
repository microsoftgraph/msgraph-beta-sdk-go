...
// ItemSynchronizationJobsItemProvisionOnDemandPostRequestBody provides operations to call the provisionOnDemand method.
...
func (m *ItemSynchronizationJobsItemProvisionOnDemandPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemSynchronizationJobsItemProvisionOnDemandPostRequestBody) SetAdditionalData(value map[string]interface{})() {
