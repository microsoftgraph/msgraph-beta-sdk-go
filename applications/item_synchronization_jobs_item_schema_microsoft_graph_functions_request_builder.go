...
// ItemSynchronizationJobsItemSchemaMicrosoftGraphFunctionsRequestBuilder provides operations to call the functions method.
...
// ItemSynchronizationJobsItemSchemaMicrosoftGraphFunctionsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSynchronizationJobsItemSchemaMicrosoftGraphFunctionsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemSynchronizationJobsItemSchemaMicrosoftGraphFunctionsRequestBuilderGetQueryParameters
}
...
func (m *ItemSynchronizationJobsItemSchemaMicrosoftGraphFunctionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSynchronizationJobsItemSchemaMicrosoftGraphFunctionsRequestBuilderGetRequestConfiguration)(ItemSynchronizationJobsItemSchemaMicrosoftGraphFunctionsFunctionsResponseable, error) {
...
func (m *ItemSynchronizationJobsItemSchemaMicrosoftGraphFunctionsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSynchronizationJobsItemSchemaMicrosoftGraphFunctionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
