...
// ByTokenIssuancePolicyIdString gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.applications.item.tokenIssuancePolicies.item collection
