...
func (m *ItemSynchronizationTemplatesItemSchemaDirectoriesRequestBuilder) Count()(*ItemSynchronizationTemplatesItemSchemaDirectoriesCountRequestBuilder) {
    return NewItemSynchronizationTemplatesItemSchemaDirectoriesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation contains the collection of directories and all of their objects.
func (m *ItemSynchronizationTemplatesItemSchemaDirectoriesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemSynchronizationTemplatesItemSchemaDirectoriesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
