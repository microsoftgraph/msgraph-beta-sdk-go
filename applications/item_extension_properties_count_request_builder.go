...
func (m *ItemExtensionPropertiesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemExtensionPropertiesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
