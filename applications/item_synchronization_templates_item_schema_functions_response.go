...
// ItemSynchronizationTemplatesItemSchemaFunctionsResponse provides operations to call the functions method.
...
func (m *ItemSynchronizationTemplatesItemSchemaFunctionsResponse) GetValue()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AttributeMappingFunctionSchemaable) {
    return m.value
}
...
func (m *ItemSynchronizationTemplatesItemSchemaFunctionsResponse) SetValue(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AttributeMappingFunctionSchemaable)() {
    m.value = value
}
