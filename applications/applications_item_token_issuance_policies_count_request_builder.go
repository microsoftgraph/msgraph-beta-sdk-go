...
func NewApplicationsItemTokenIssuancePoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenIssuancePoliciesCountRequestBuilder) {
    m := &ApplicationsItemTokenIssuancePoliciesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/applications/{application%2Did}/tokenIssuancePolicies/$count";
...
func NewApplicationsItemTokenIssuancePoliciesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationsItemTokenIssuancePoliciesCountRequestBuilder) {
    ...
    return NewApplicationsItemTokenIssuancePoliciesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *ApplicationsItemTokenIssuancePoliciesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ApplicationsItemTokenIssuancePoliciesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplicationsItemTokenIssuancePoliciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplicationsItemTokenIssuancePoliciesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
