...
func (m *MessageEventItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *MessageEventItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
