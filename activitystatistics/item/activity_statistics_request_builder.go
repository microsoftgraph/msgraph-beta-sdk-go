...
// ActivityStatisticsRequestBuilder builds and executes requests for operations under \activitystatistics\{activityStatistics-id}
...
// ActivityStatisticsRequestBuilderGetQueryParameters get entity from activitystatistics by key
...
func NewActivityStatisticsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivityStatisticsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/activitystatistics/{activityStatistics_id}{?select,expand}";
...
// CreateDeleteRequestInformation delete entity from activitystatistics
...
// CreateGetRequestInformation get entity from activitystatistics by key
...
// CreatePatchRequestInformation update entity in activitystatistics
