...
func NewProgramItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, programId *string)(*ProgramItemRequestBuilder) {
...
func NewProgramItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ProgramItemRequestBuilder) {
    ...
    return NewProgramItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ProgramItemRequestBuilder) ControlsById(id string)(*ItemControlsProgramControlItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemControlsProgramControlItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
