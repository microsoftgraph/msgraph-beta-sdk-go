...
// NewForwardingPoliciesItemPolicyRulesPolicyRuleItemRequestBuilderInternal instantiates a new PolicyRuleItemRequestBuilder and sets the default values.
func NewForwardingPoliciesItemPolicyRulesPolicyRuleItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ForwardingPoliciesItemPolicyRulesPolicyRuleItemRequestBuilder) {
    m := &ForwardingPoliciesItemPolicyRulesPolicyRuleItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/forwardingPolicies/{forwardingPolicy%2Did}/policyRules/{policyRule%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewForwardingPoliciesItemPolicyRulesPolicyRuleItemRequestBuilder instantiates a new PolicyRuleItemRequestBuilder and sets the default values.
