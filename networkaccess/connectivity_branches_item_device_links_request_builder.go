...
// ByDeviceLinkIdString provides operations to manage the deviceLinks property of the microsoft.graph.networkaccess.branchSite entity.
func (m *ConnectivityBranchesItemDeviceLinksRequestBuilder) ByDeviceLinkIdString(deviceLinkId string)(*ConnectivityBranchesItemDeviceLinksDeviceLinkItemRequestBuilder) {
