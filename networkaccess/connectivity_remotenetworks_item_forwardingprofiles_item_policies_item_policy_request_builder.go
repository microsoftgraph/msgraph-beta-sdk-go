...
// NewConnectivityRemotenetworksItemForwardingprofilesItemPoliciesItemPolicyRequestBuilderInternal instantiates a new ConnectivityRemotenetworksItemForwardingprofilesItemPoliciesItemPolicyRequestBuilder and sets the default values.
func NewConnectivityRemotenetworksItemForwardingprofilesItemPoliciesItemPolicyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityRemotenetworksItemForwardingprofilesItemPoliciesItemPolicyRequestBuilder) {
    m := &ConnectivityRemotenetworksItemForwardingprofilesItemPoliciesItemPolicyRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/forwardingProfiles/{forwardingProfile%2Did}/policies/{policyLink%2Did}/policy{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewConnectivityRemotenetworksItemForwardingprofilesItemPoliciesItemPolicyRequestBuilder instantiates a new ConnectivityRemotenetworksItemForwardingprofilesItemPoliciesItemPolicyRequestBuilder and sets the default values.
