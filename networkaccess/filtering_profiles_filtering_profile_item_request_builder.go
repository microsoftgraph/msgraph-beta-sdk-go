...
// NewFilteringProfilesFilteringProfileItemRequestBuilderInternal instantiates a new FilteringProfileItemRequestBuilder and sets the default values.
func NewFilteringProfilesFilteringProfileItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FilteringProfilesFilteringProfileItemRequestBuilder) {
    m := &FilteringProfilesFilteringProfileItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/filteringProfiles/{filteringProfile%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewFilteringProfilesFilteringProfileItemRequestBuilder instantiates a new FilteringProfileItemRequestBuilder and sets the default values.
