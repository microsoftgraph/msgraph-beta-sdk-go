...
func (m *ConnectivityRemoteNetworksRemoteNetworkItemRequestBuilder) ConnectivityConfiguration()(*ConnectivityRemoteNetworksItemConnectivityConfigurationRequestBuilder) {
    return NewConnectivityRemoteNetworksItemConnectivityConfigurationRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// NewConnectivityRemoteNetworksRemoteNetworkItemRequestBuilderInternal instantiates a new RemoteNetworkItemRequestBuilder and sets the default values.
func NewConnectivityRemoteNetworksRemoteNetworkItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityRemoteNetworksRemoteNetworkItemRequestBuilder) {
    m := &ConnectivityRemoteNetworksRemoteNetworkItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewConnectivityRemoteNetworksRemoteNetworkItemRequestBuilder instantiates a new RemoteNetworkItemRequestBuilder and sets the default values.
...
func (m *ConnectivityRemoteNetworksRemoteNetworkItemRequestBuilder) DeviceLinks()(*ConnectivityRemoteNetworksItemDeviceLinksRequestBuilder) {
    return NewConnectivityRemoteNetworksItemDeviceLinksRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
