...
// ConnectivityBranchesItemForwardingProfilesForwardingProfileItemRequestBuilderGetQueryParameters get forwardingProfiles from networkAccess
...
// NewConnectivityBranchesItemForwardingProfilesForwardingProfileItemRequestBuilderInternal instantiates a new ForwardingProfileItemRequestBuilder and sets the default values.
func NewConnectivityBranchesItemForwardingProfilesForwardingProfileItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityBranchesItemForwardingProfilesForwardingProfileItemRequestBuilder) {
    m := &ConnectivityBranchesItemForwardingProfilesForwardingProfileItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/connectivity/branches/{branchSite%2Did}/forwardingProfiles/{forwardingProfile%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewConnectivityBranchesItemForwardingProfilesForwardingProfileItemRequestBuilder instantiates a new ForwardingProfileItemRequestBuilder and sets the default values.
