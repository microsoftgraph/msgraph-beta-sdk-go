...
// NewConnectivityRemoteNetworksItemDeviceLinksCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewConnectivityRemoteNetworksItemDeviceLinksCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityRemoteNetworksItemDeviceLinksCountRequestBuilder) {
    m := &ConnectivityRemoteNetworksItemDeviceLinksCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/deviceLinks/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewConnectivityRemoteNetworksItemDeviceLinksCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
