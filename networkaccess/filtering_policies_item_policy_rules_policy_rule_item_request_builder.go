...
// NewFilteringPoliciesItemPolicyRulesPolicyRuleItemRequestBuilderInternal instantiates a new PolicyRuleItemRequestBuilder and sets the default values.
func NewFilteringPoliciesItemPolicyRulesPolicyRuleItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FilteringPoliciesItemPolicyRulesPolicyRuleItemRequestBuilder) {
    m := &FilteringPoliciesItemPolicyRulesPolicyRuleItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/filteringPolicies/{filteringPolicy%2Did}/policyRules/{policyRule%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewFilteringPoliciesItemPolicyRulesPolicyRuleItemRequestBuilder instantiates a new PolicyRuleItemRequestBuilder and sets the default values.
