...
func (m *ReportsMicrosoftgraphnetworkaccesscrosstenantaccessreportwithstartdatetimewithenddatetimeCrossTenantAccessReportWithStartDateTimeWithEndDateTimeGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["value"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i43e723cc778f0f3f3a05d36b9df74faa56771e9360d8ed793c50bdaacec8d5d2.CreateCrossTenantAccessFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i43e723cc778f0f3f3a05d36b9df74faa56771e9360d8ed793c50bdaacec8d5d2.CrossTenantAccessable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i43e723cc778f0f3f3a05d36b9df74faa56771e9360d8ed793c50bdaacec8d5d2.CrossTenantAccessable)
                }
            }
            m.SetValue(res)
        }
...
func (m *ReportsMicrosoftgraphnetworkaccesscrosstenantaccessreportwithstartdatetimewithenddatetimeCrossTenantAccessReportWithStartDateTimeWithEndDateTimeGetResponse) GetValue()([]i43e723cc778f0f3f3a05d36b9df74faa56771e9360d8ed793c50bdaacec8d5d2.CrossTenantAccessable) {
    ...
    if val != nil {
        return val.([]i43e723cc778f0f3f3a05d36b9df74faa56771e9360d8ed793c50bdaacec8d5d2.CrossTenantAccessable)
    }
    return nil
}
// Serialize serializes information the current object
func (m *ReportsMicrosoftgraphnetworkaccesscrosstenantaccessreportwithstartdatetimewithenddatetimeCrossTenantAccessReportWithStartDateTimeWithEndDateTimeGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ReportsMicrosoftgraphnetworkaccesscrosstenantaccessreportwithstartdatetimewithenddatetimeCrossTenantAccessReportWithStartDateTimeWithEndDateTimeGetResponse) SetValue(value []i43e723cc778f0f3f3a05d36b9df74faa56771e9360d8ed793c50bdaacec8d5d2.CrossTenantAccessable)() {
...
type ReportsMicrosoftgraphnetworkaccesscrosstenantaccessreportwithstartdatetimewithenddatetimeCrossTenantAccessReportWithStartDateTimeWithEndDateTimeGetResponseable interface {
    ...
    GetValue()([]i43e723cc778f0f3f3a05d36b9df74faa56771e9360d8ed793c50bdaacec8d5d2.CrossTenantAccessable)
    SetValue(value []i43e723cc778f0f3f3a05d36b9df74faa56771e9360d8ed793c50bdaacec8d5d2.CrossTenantAccessable)()
}
