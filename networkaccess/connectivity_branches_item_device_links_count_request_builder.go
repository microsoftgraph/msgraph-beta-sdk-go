...
func (m *ConnectivityBranchesItemDeviceLinksCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConnectivityBranchesItemDeviceLinksCountRequestBuilderGetRequestConfiguration)(*int64, error) {
