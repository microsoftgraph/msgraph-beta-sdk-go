...
// NewReportsMicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByRequestBuilderInternal instantiates a new ReportsMicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByRequestBuilder and sets the default values.
...
// NewReportsMicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByRequestBuilder instantiates a new ReportsMicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByRequestBuilder and sets the default values.
...
// returns a ReportsMicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByResponseable when successful
...
// returns a ReportsMicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
...
// returns a *ReportsMicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByRequestBuilder when successful
