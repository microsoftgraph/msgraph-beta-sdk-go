...
// ConnectivityRemoteNetworksItemConnectivityConfigurationRequestBuilderGetQueryParameters get connectivityConfiguration from networkAccess
...
// NewConnectivityRemoteNetworksItemConnectivityConfigurationRequestBuilderInternal instantiates a new ConnectivityConfigurationRequestBuilder and sets the default values.
func NewConnectivityRemoteNetworksItemConnectivityConfigurationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityRemoteNetworksItemConnectivityConfigurationRequestBuilder) {
    m := &ConnectivityRemoteNetworksItemConnectivityConfigurationRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/connectivityConfiguration{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewConnectivityRemoteNetworksItemConnectivityConfigurationRequestBuilder instantiates a new ConnectivityConfigurationRequestBuilder and sets the default values.
...
// Get get connectivityConfiguration from networkAccess
...
// ToGetRequestInformation get connectivityConfiguration from networkAccess
