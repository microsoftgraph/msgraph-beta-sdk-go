...
// NewConnectivityRemoteNetworksItemForwardingProfilesItemPoliciesPolicyLinkItemRequestBuilderInternal instantiates a new PolicyLinkItemRequestBuilder and sets the default values.
func NewConnectivityRemoteNetworksItemForwardingProfilesItemPoliciesPolicyLinkItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityRemoteNetworksItemForwardingProfilesItemPoliciesPolicyLinkItemRequestBuilder) {
    m := &ConnectivityRemoteNetworksItemForwardingProfilesItemPoliciesPolicyLinkItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/forwardingProfiles/{forwardingProfile%2Did}/policies/{policyLink%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewConnectivityRemoteNetworksItemForwardingProfilesItemPoliciesPolicyLinkItemRequestBuilder instantiates a new PolicyLinkItemRequestBuilder and sets the default values.
