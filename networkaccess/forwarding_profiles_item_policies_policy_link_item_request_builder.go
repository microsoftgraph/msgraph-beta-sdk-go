...
// NewForwardingProfilesItemPoliciesPolicyLinkItemRequestBuilderInternal instantiates a new PolicyLinkItemRequestBuilder and sets the default values.
func NewForwardingProfilesItemPoliciesPolicyLinkItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ForwardingProfilesItemPoliciesPolicyLinkItemRequestBuilder) {
    m := &ForwardingProfilesItemPoliciesPolicyLinkItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/forwardingProfiles/{forwardingProfile%2Did}/policies/{policyLink%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewForwardingProfilesItemPoliciesPolicyLinkItemRequestBuilder instantiates a new PolicyLinkItemRequestBuilder and sets the default values.
