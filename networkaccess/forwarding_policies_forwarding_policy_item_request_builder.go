...
// ForwardingPoliciesForwardingPolicyItemRequestBuilderGetQueryParameters retrieve information about a specific forwarding policy. This API is supported in the following national cloud deployments.
