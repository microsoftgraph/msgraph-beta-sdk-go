...
func (m *ConnectivityBranchesItemForwardingProfilesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConnectivityBranchesItemForwardingProfilesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
