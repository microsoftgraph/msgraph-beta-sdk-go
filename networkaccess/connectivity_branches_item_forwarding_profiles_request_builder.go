...
// ConnectivityBranchesItemForwardingProfilesRequestBuilder provides operations to manage the forwardingProfiles property of the microsoft.graph.networkaccess.branchSite entity.
type ConnectivityBranchesItemForwardingProfilesRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ConnectivityBranchesItemForwardingProfilesRequestBuilderGetQueryParameters retrieve a list of traffic forwarding profiles associated with a branch. This API is available in the following national cloud deployments.
...
// ConnectivityBranchesItemForwardingProfilesRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ConnectivityBranchesItemForwardingProfilesRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ConnectivityBranchesItemForwardingProfilesRequestBuilderGetQueryParameters
}
// ConnectivityBranchesItemForwardingProfilesRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ConnectivityBranchesItemForwardingProfilesRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
// NewConnectivityBranchesItemForwardingProfilesRequestBuilderInternal instantiates a new ForwardingProfilesRequestBuilder and sets the default values.
func NewConnectivityBranchesItemForwardingProfilesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityBranchesItemForwardingProfilesRequestBuilder) {
    m := &ConnectivityBranchesItemForwardingProfilesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/connectivity/branches/{branchSite%2Did}/forwardingProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewConnectivityBranchesItemForwardingProfilesRequestBuilder instantiates a new ForwardingProfilesRequestBuilder and sets the default values.
func NewConnectivityBranchesItemForwardingProfilesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityBranchesItemForwardingProfilesRequestBuilder) {
    ...
    return NewConnectivityBranchesItemForwardingProfilesRequestBuilderInternal(urlParams, requestAdapter)
}
...
// Get retrieve a list of traffic forwarding profiles associated with a branch. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
func (m *ConnectivityBranchesItemForwardingProfilesRequestBuilder) Post(ctx context.Context, body i43e723cc778f0f3f3a05d36b9df74faa56771e9360d8ed793c50bdaacec8d5d2.ForwardingProfileable, requestConfiguration *ConnectivityBranchesItemForwardingProfilesRequestBuilderPostRequestConfiguration)(i43e723cc778f0f3f3a05d36b9df74faa56771e9360d8ed793c50bdaacec8d5d2.ForwardingProfileable, error) {
...
// ToGetRequestInformation retrieve a list of traffic forwarding profiles associated with a branch. This API is available in the following national cloud deployments.
...
func (m *ConnectivityBranchesItemForwardingProfilesRequestBuilder) WithUrl(rawUrl string)(*ConnectivityBranchesItemForwardingProfilesRequestBuilder) {
    return NewConnectivityBranchesItemForwardingProfilesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
