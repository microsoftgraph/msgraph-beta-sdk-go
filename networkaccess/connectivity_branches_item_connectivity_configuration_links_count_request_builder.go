...
// NewConnectivityBranchesItemConnectivityConfigurationLinksCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewConnectivityBranchesItemConnectivityConfigurationLinksCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityBranchesItemConnectivityConfigurationLinksCountRequestBuilder) {
    m := &ConnectivityBranchesItemConnectivityConfigurationLinksCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/connectivity/branches/{branchSite%2Did}/connectivityConfiguration/links/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewConnectivityBranchesItemConnectivityConfigurationLinksCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
