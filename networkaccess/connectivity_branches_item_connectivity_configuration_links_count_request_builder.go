...
func (m *ConnectivityBranchesItemConnectivityConfigurationLinksCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConnectivityBranchesItemConnectivityConfigurationLinksCountRequestBuilderGetRequestConfiguration)(*int64, error) {
