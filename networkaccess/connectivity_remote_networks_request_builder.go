...
// NewConnectivityRemoteNetworksRequestBuilderInternal instantiates a new RemoteNetworksRequestBuilder and sets the default values.
func NewConnectivityRemoteNetworksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityRemoteNetworksRequestBuilder) {
    m := &ConnectivityRemoteNetworksRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewConnectivityRemoteNetworksRequestBuilder instantiates a new RemoteNetworksRequestBuilder and sets the default values.
