...
// NewConnectivityBranchesItemConnectivityConfigurationLinksRequestBuilderInternal instantiates a new LinksRequestBuilder and sets the default values.
func NewConnectivityBranchesItemConnectivityConfigurationLinksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityBranchesItemConnectivityConfigurationLinksRequestBuilder) {
    m := &ConnectivityBranchesItemConnectivityConfigurationLinksRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/connectivity/branches/{branchSite%2Did}/connectivityConfiguration/links{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewConnectivityBranchesItemConnectivityConfigurationLinksRequestBuilder instantiates a new LinksRequestBuilder and sets the default values.
