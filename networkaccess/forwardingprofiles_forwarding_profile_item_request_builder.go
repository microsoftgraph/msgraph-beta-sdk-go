...
func (m *ForwardingprofilesForwardingProfileItemRequestBuilder) ServicePrincipal()(*ForwardingprofilesItemServiceprincipalServicePrincipalRequestBuilder) {
    return NewForwardingprofilesItemServiceprincipalServicePrincipalRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
