...
// NewConnectivityRemoteNetworksItemForwardingProfilesCountRequestBuilderInternal instantiates a new ConnectivityRemoteNetworksItemForwardingProfilesCountRequestBuilder and sets the default values.
func NewConnectivityRemoteNetworksItemForwardingProfilesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectivityRemoteNetworksItemForwardingProfilesCountRequestBuilder) {
    m := &ConnectivityRemoteNetworksItemForwardingProfilesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/forwardingProfiles/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewConnectivityRemoteNetworksItemForwardingProfilesCountRequestBuilder instantiates a new ConnectivityRemoteNetworksItemForwardingProfilesCountRequestBuilder and sets the default values.
