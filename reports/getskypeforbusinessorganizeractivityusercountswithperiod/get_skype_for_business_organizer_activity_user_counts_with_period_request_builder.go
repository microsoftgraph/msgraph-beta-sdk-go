...
func (m *GetSkypeForBusinessOrganizerActivityUserCountsWithPeriodRequestBuilder) Get(options *GetSkypeForBusinessOrganizerActivityUserCountsWithPeriodRequestBuilderGetOptions)([]byte, error) {
