...
func NewDailyPrintUsageSummariesByUserCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DailyPrintUsageSummariesByUserCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/reports/dailyPrintUsageSummariesByUser/$count";
...
func (m *DailyPrintUsageSummariesByUserCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DailyPrintUsageSummariesByUserCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
