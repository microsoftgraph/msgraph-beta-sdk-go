...
// NewUserInsightsMonthlyMfaCompletionsRequestBuilderInternal instantiates a new MfaCompletionsRequestBuilder and sets the default values.
func NewUserInsightsMonthlyMfaCompletionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsMonthlyMfaCompletionsRequestBuilder) {
    m := &UserInsightsMonthlyMfaCompletionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/monthly/mfaCompletions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewUserInsightsMonthlyMfaCompletionsRequestBuilder instantiates a new MfaCompletionsRequestBuilder and sets the default values.
...
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/monthlyuserinsightmetricsroot-list-mfacompletions?view=graph-rest-1.0
