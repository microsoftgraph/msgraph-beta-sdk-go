...
func (m *GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilder) Get(options *GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilderGetOptions)(GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodResponseable), nil
}
