...
// NewUserInsightsDailyInactiveUsersByApplicationRequestBuilderInternal instantiates a new InactiveUsersByApplicationRequestBuilder and sets the default values.
func NewUserInsightsDailyInactiveUsersByApplicationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsDailyInactiveUsersByApplicationRequestBuilder) {
    m := &UserInsightsDailyInactiveUsersByApplicationRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/daily/inactiveUsersByApplication{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewUserInsightsDailyInactiveUsersByApplicationRequestBuilder instantiates a new InactiveUsersByApplicationRequestBuilder and sets the default values.
