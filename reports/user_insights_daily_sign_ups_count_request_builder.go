...
func (m *UserInsightsDailySignUpsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserInsightsDailySignUpsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
