...
// NewUserInsightsDailySignUpsCountRequestBuilderInternal instantiates a new UserInsightsDailySignUpsCountRequestBuilder and sets the default values.
func NewUserInsightsDailySignUpsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsDailySignUpsCountRequestBuilder) {
    m := &UserInsightsDailySignUpsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/daily/signUps/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewUserInsightsDailySignUpsCountRequestBuilder instantiates a new UserInsightsDailySignUpsCountRequestBuilder and sets the default values.
