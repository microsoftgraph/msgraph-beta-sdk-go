...
func NewGetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, date *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly)(*GetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilder) {
    m := &GetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilder{
...
func NewGetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilder) {
    ...
    return NewGetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function getTeamsUserActivityUserDetail
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilder) Get(ctx context.Context, requestConfiguration *GetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilder) WithUrl(rawUrl string)(*GetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilder) {
    return NewGetteamsuseractivityuserdetailwithdateGetTeamsUserActivityUserDetailWithDateRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
