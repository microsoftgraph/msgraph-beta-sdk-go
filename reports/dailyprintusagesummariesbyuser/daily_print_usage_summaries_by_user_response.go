...
// DailyPrintUsageSummariesByUserResponse 
...
// NewDailyPrintUsageSummariesByUserResponse instantiates a new dailyPrintUsageSummariesByUserResponse and sets the default values.
