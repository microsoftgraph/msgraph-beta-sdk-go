...
// ServiceActivityGetUsageMetricsForTeamsByLaunchWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters get usage metrics based on the number of times users opened the Teams app without error.
...
// Get get usage metrics based on the number of times users opened the Teams app without error.
...
// GetAsGetUsageMetricsForTeamsByLaunchWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesGetResponse get usage metrics based on the number of times users opened the Teams app without error.
...
// ToGetRequestInformation get usage metrics based on the number of times users opened the Teams app without error.
