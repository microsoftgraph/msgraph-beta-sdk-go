...
// GetTeamsUserActivityDistributionUserCountsWithPeriodRequestBuilder builds and executes requests for operations under \reports\microsoft.graph.getTeamsUserActivityDistributionUserCounts(period='{period}')
...
func (m *GetTeamsUserActivityDistributionUserCountsWithPeriodRequestBuilder) Get(options *GetTeamsUserActivityDistributionUserCountsWithPeriodRequestBuilderGetOptions)([]byte, error) {
