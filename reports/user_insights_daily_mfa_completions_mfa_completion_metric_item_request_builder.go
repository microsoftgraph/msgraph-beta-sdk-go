...
// UserInsightsDailyMfaCompletionsMfaCompletionMetricItemRequestBuilderGetQueryParameters get mfaCompletions from reports
...
// NewUserInsightsDailyMfaCompletionsMfaCompletionMetricItemRequestBuilderInternal instantiates a new MfaCompletionMetricItemRequestBuilder and sets the default values.
func NewUserInsightsDailyMfaCompletionsMfaCompletionMetricItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsDailyMfaCompletionsMfaCompletionMetricItemRequestBuilder) {
    m := &UserInsightsDailyMfaCompletionsMfaCompletionMetricItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/daily/mfaCompletions/{mfaCompletionMetric%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewUserInsightsDailyMfaCompletionsMfaCompletionMetricItemRequestBuilder instantiates a new MfaCompletionMetricItemRequestBuilder and sets the default values.
