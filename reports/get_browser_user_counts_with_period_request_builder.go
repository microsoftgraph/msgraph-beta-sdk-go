...
// GetBrowserUserCountsWithPeriodRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type GetBrowserUserCountsWithPeriodRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
func (m *GetBrowserUserCountsWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetBrowserUserCountsWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetBrowserUserCountsWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetBrowserUserCountsWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *GetBrowserUserCountsWithPeriodRequestBuilder when successful
func (m *GetBrowserUserCountsWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetBrowserUserCountsWithPeriodRequestBuilder) {
    return NewGetBrowserUserCountsWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
