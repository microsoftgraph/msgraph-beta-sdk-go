...
// AppCredentialSignInActivitiesAppCredentialSignInActivityItemRequestBuilderGetQueryParameters get an appCredentialSignInActivity object that contains recent activity of an application credential. This API is supported in the following national cloud deployments.
...
// NewAppCredentialSignInActivitiesAppCredentialSignInActivityItemRequestBuilderInternal instantiates a new AppCredentialSignInActivityItemRequestBuilder and sets the default values.
func NewAppCredentialSignInActivitiesAppCredentialSignInActivityItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AppCredentialSignInActivitiesAppCredentialSignInActivityItemRequestBuilder) {
    m := &AppCredentialSignInActivitiesAppCredentialSignInActivityItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/appCredentialSignInActivities/{appCredentialSignInActivity%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewAppCredentialSignInActivitiesAppCredentialSignInActivityItemRequestBuilder instantiates a new AppCredentialSignInActivityItemRequestBuilder and sets the default values.
...
// Get get an appCredentialSignInActivity object that contains recent activity of an application credential. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get an appCredentialSignInActivity object that contains recent activity of an application credential. This API is supported in the following national cloud deployments.
