...
// NewUserInsightsMonthlyInactiveUsersMonthlyInactiveUsersMetricItemRequestBuilderInternal instantiates a new MonthlyInactiveUsersMetricItemRequestBuilder and sets the default values.
func NewUserInsightsMonthlyInactiveUsersMonthlyInactiveUsersMetricItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsMonthlyInactiveUsersMonthlyInactiveUsersMetricItemRequestBuilder) {
    m := &UserInsightsMonthlyInactiveUsersMonthlyInactiveUsersMetricItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/monthly/inactiveUsers/{monthlyInactiveUsersMetric%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewUserInsightsMonthlyInactiveUsersMonthlyInactiveUsersMetricItemRequestBuilder instantiates a new MonthlyInactiveUsersMetricItemRequestBuilder and sets the default values.
