...
func (m *GetOffice365GroupsActivityDetailWithPeriodRequestBuilder) Get(options *GetOffice365GroupsActivityDetailWithPeriodRequestBuilderGetOptions)(GetOffice365GroupsActivityDetailWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetOffice365GroupsActivityDetailWithPeriodResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
