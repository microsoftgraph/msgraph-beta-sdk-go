...
// ByPrintUsageByPrinterIdString provides operations to manage the monthlyPrintUsageSummariesByPrinter property of the microsoft.graph.reportRoot entity.
...
func (m *MonthlyPrintUsageSummariesByPrinterRequestBuilder) ByPrintUsageByPrinterIdString(printUsageByPrinterId string)(*MonthlyPrintUsageSummariesByPrinterPrintUsageByPrinterItemRequestBuilder) {
