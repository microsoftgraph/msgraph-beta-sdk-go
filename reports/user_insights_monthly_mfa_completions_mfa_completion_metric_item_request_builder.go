...
// UserInsightsMonthlyMfaCompletionsMfaCompletionMetricItemRequestBuilder provides operations to manage the mfaCompletions property of the microsoft.graph.monthlyUserInsightMetricsRoot entity.
type UserInsightsMonthlyMfaCompletionsMfaCompletionMetricItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// UserInsightsMonthlyMfaCompletionsMfaCompletionMetricItemRequestBuilderGetQueryParameters insights for MFA usage on apps registered in the tenant for a specified period.
type UserInsightsMonthlyMfaCompletionsMfaCompletionMetricItemRequestBuilderGetQueryParameters struct {
    // Expand related entities
    Expand []string `uriparametername:"%24expand"`
    // Select properties to be returned
    Select []string `uriparametername:"%24select"`
}
// UserInsightsMonthlyMfaCompletionsMfaCompletionMetricItemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type UserInsightsMonthlyMfaCompletionsMfaCompletionMetricItemRequestBuilderGetRequestConfiguration struct {
    // Request headers
