...
func (m *GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriodRequestBuilder) Get(options *GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriodRequestBuilderGetOptions)([]byte, error) {
