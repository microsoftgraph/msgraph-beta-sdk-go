...
func (m *MonthlyPrintUsageSummariesByUserRequestBuilder) Count()(*MonthlyPrintUsageSummariesByUserCountRequestBuilder) {
    return NewMonthlyPrintUsageSummariesByUserCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get monthlyPrintUsageSummariesByUser from reports
func (m *MonthlyPrintUsageSummariesByUserRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *MonthlyPrintUsageSummariesByUserRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
