...
func (m *GetTeamsTeamActivityDetailWithPeriodRequestBuilder) CreateGetRequestInformationWithRequestConfiguration()(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreateGetRequestInformationWithRequestConfiguration(nil);
}
// CreateGetRequestInformationWithRequestConfiguration invoke function getTeamsTeamActivityDetail
func (m *GetTeamsTeamActivityDetailWithPeriodRequestBuilder) CreateGetRequestInformationWithRequestConfiguration(requestConfiguration *GetTeamsTeamActivityDetailWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetTeamsTeamActivityDetailWithPeriodRequestBuilder) GetWithResponseHandler(requestConfiguration *GetTeamsTeamActivityDetailWithPeriodRequestBuilderGetRequestConfiguration)(GetTeamsTeamActivityDetailWithPeriodResponseable, error) {
    return m.GetWithResponseHandler(requestConfiguration, nil);
}
// GetWithResponseHandler invoke function getTeamsTeamActivityDetail
func (m *GetTeamsTeamActivityDetailWithPeriodRequestBuilder) GetWithResponseHandler(requestConfiguration *GetTeamsTeamActivityDetailWithPeriodRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(GetTeamsTeamActivityDetailWithPeriodResponseable, error) {
