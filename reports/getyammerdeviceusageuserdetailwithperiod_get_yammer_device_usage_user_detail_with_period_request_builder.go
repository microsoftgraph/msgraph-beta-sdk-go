...
func NewGetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilder) {
    m := &GetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilder{
...
func NewGetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilder) {
    ...
    return NewGetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function getYammerDeviceUsageUserDetail
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilder) {
    return NewGetyammerdeviceusageuserdetailwithperiodGetYammerDeviceUsageUserDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
