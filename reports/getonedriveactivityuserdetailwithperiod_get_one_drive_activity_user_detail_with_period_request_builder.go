...
func NewGetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilder) {
    m := &GetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilder{
...
func NewGetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilder) {
    ...
    return NewGetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function getOneDriveActivityUserDetail
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilder) {
    return NewGetonedriveactivityuserdetailwithperiodGetOneDriveActivityUserDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
