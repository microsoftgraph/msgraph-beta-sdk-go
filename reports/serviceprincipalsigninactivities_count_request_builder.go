...
// NewServiceprincipalsigninactivitiesCountRequestBuilderInternal instantiates a new ServiceprincipalsigninactivitiesCountRequestBuilder and sets the default values.
func NewServiceprincipalsigninactivitiesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ServiceprincipalsigninactivitiesCountRequestBuilder) {
    m := &ServiceprincipalsigninactivitiesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/servicePrincipalSignInActivities/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewServiceprincipalsigninactivitiesCountRequestBuilder instantiates a new ServiceprincipalsigninactivitiesCountRequestBuilder and sets the default values.
