...
func NewGetOffice365ActivationCountsResponse()(*GetOffice365ActivationCountsResponse) {
    m := &GetOffice365ActivationCountsResponse{
    }
...
func (m *GetOffice365ActivationCountsResponse) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *GetOffice365ActivationCountsResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetOffice365ActivationCountsResponse) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
