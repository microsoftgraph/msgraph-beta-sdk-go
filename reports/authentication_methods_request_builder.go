...
func (m *AuthenticationMethodsRequestBuilder) MicrosoftGraphUsersRegisteredByFeature()(*AuthenticationMethodsMicrosoftGraphUsersRegisteredByFeatureRequestBuilder) {
    return NewAuthenticationMethodsMicrosoftGraphUsersRegisteredByFeatureRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *AuthenticationMethodsRequestBuilder) MicrosoftGraphUsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRoles(includedUserRoles *string, includedUserTypes *string)(*AuthenticationMethodsMicrosoftGraphUsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRolesRequestBuilder) {
    return NewAuthenticationMethodsMicrosoftGraphUsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRolesRequestBuilderInternal(m.pathParameters, m.requestAdapter, includedUserRoles, includedUserTypes)
}
// MicrosoftGraphUsersRegisteredByMethod provides operations to call the usersRegisteredByMethod method.
func (m *AuthenticationMethodsRequestBuilder) MicrosoftGraphUsersRegisteredByMethod()(*AuthenticationMethodsMicrosoftGraphUsersRegisteredByMethodRequestBuilder) {
    return NewAuthenticationMethodsMicrosoftGraphUsersRegisteredByMethodRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *AuthenticationMethodsRequestBuilder) MicrosoftGraphUsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRoles(includedUserRoles *string, includedUserTypes *string)(*AuthenticationMethodsMicrosoftGraphUsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilder) {
    return NewAuthenticationMethodsMicrosoftGraphUsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilderInternal(m.pathParameters, m.requestAdapter, includedUserRoles, includedUserTypes)
}
