...
func (m *GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder) Get(options *GetYammerDeviceUsageUserDetailWithPeriodRequestBuilderGetOptions)(GetYammerDeviceUsageUserDetailWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetYammerDeviceUsageUserDetailWithPeriodResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
