...
func (m *GetSkypeForBusinessActivityUserCountsWithPeriodRequestBuilder) GetWithResponseHandler(requestConfiguration *GetSkypeForBusinessActivityUserCountsWithPeriodRequestBuilderGetRequestConfiguration)(GetSkypeForBusinessActivityUserCountsWithPeriodResponseable, error) {
