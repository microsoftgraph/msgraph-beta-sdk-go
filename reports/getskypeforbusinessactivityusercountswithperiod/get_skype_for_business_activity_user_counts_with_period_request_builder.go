...
func (m *GetSkypeForBusinessActivityUserCountsWithPeriodRequestBuilder) Get(options *GetSkypeForBusinessActivityUserCountsWithPeriodRequestBuilderGetOptions)(GetSkypeForBusinessActivityUserCountsWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetSkypeForBusinessActivityUserCountsWithPeriodResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
