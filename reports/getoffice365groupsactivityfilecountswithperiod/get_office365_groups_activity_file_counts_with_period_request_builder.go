...
func (m *GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder) Get(options *GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetOptions)(GetOffice365GroupsActivityFileCountsWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetOffice365GroupsActivityFileCountsWithPeriodResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
