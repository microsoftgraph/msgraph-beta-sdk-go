...
func NewGetBrowserUserDetailWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetBrowserUserDetailWithPeriodRequestBuilder) {
    m := &GetBrowserUserDetailWithPeriodRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/getBrowserUserDetail(period='{period}')", pathParameters),
    }
    if period != nil {
...
func (m *GetBrowserUserDetailWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetBrowserUserDetailWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetBrowserUserDetailWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetBrowserUserDetailWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *GetBrowserUserDetailWithPeriodRequestBuilder when successful
func (m *GetBrowserUserDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetBrowserUserDetailWithPeriodRequestBuilder) {
    return NewGetBrowserUserDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
