...
func NewGetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilder) {
    m := &GetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilder{
...
func NewGetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilder) {
    ...
    return NewGetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function getSharePointActivityUserDetail
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilder) {
    return NewGetsharepointactivityuserdetailwithperiodGetSharePointActivityUserDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
