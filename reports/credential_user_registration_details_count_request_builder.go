...
func (m *CredentialUserRegistrationDetailsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CredentialUserRegistrationDetailsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
