...
// DeviceConfigurationUserActivityRequestBuilder builds and executes requests for operations under \reports\microsoft.graph.deviceConfigurationUserActivity()
...
func (m *DeviceConfigurationUserActivityRequestBuilder) Get(options *DeviceConfigurationUserActivityRequestBuilderGetOptions)(*DeviceConfigurationUserActivityResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewDeviceConfigurationUserActivityResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
