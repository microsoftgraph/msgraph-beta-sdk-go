...
// NewUserInsightsDailyInactiveUsersByApplicationDailyInactiveUsersByApplicationMetricItemRequestBuilderInternal instantiates a new DailyInactiveUsersByApplicationMetricItemRequestBuilder and sets the default values.
func NewUserInsightsDailyInactiveUsersByApplicationDailyInactiveUsersByApplicationMetricItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsDailyInactiveUsersByApplicationDailyInactiveUsersByApplicationMetricItemRequestBuilder) {
    m := &UserInsightsDailyInactiveUsersByApplicationDailyInactiveUsersByApplicationMetricItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/daily/inactiveUsersByApplication/{dailyInactiveUsersByApplicationMetric%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewUserInsightsDailyInactiveUsersByApplicationDailyInactiveUsersByApplicationMetricItemRequestBuilder instantiates a new DailyInactiveUsersByApplicationMetricItemRequestBuilder and sets the default values.
