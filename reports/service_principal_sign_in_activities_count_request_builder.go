...
func (m *ServicePrincipalSignInActivitiesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ServicePrincipalSignInActivitiesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
