...
// GetWithResponseHandler get dailyPrintUsageByPrinter from reports
...
// PostWithResponseHandler create new navigation property to dailyPrintUsageByPrinter for reports
