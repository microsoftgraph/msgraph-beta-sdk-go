...
// UserInsightsDailySignUpsUserSignUpMetricItemRequestBuilderGetQueryParameters get signUps from reports
...
// NewUserInsightsDailySignUpsUserSignUpMetricItemRequestBuilderInternal instantiates a new UserSignUpMetricItemRequestBuilder and sets the default values.
func NewUserInsightsDailySignUpsUserSignUpMetricItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsDailySignUpsUserSignUpMetricItemRequestBuilder) {
    m := &UserInsightsDailySignUpsUserSignUpMetricItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/daily/signUps/{userSignUpMetric%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewUserInsightsDailySignUpsUserSignUpMetricItemRequestBuilder instantiates a new UserSignUpMetricItemRequestBuilder and sets the default values.
