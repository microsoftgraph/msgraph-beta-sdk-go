...
func NewGetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilder) {
    m := &GetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/getTeamsTeamActivityDetail(period='{period}')", pathParameters),
    }
    if period != nil {
...
func NewGetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilder) {
    ...
    return NewGetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function getTeamsTeamActivityDetail
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilder) {
    return NewGetteamsteamactivitydetailwithperiodGetTeamsTeamActivityDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
