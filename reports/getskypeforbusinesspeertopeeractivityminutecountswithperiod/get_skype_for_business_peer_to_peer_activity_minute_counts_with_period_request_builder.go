...
func (m *GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilder) Get(options *GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodRequestBuilderGetOptions)(GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriodResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
