...
func (m *GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder) Get(options *GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilderGetOptions)([]byte, error) {
