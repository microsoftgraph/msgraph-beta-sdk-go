...
func (m *GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder) Get()(GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodResponseable, error) {
