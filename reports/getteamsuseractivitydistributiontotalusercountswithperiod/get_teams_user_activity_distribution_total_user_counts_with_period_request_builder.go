...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriodRequestBuilder) Get()(GetTeamsUserActivityDistributionTotalUserCountsWithPeriodResponseable, error) {
