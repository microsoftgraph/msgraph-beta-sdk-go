...
// 
type GetTeamsUserActivityDistributionTotalUserCountsWithPeriod struct {
...
// Instantiates a new getTeamsUserActivityDistributionTotalUserCountsWithPeriod and sets the default values.
func NewGetTeamsUserActivityDistributionTotalUserCountsWithPeriod()(*GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) {
    m := &GetTeamsUserActivityDistributionTotalUserCountsWithPeriod{
        Entity: *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewEntity(),
    }
    return m
}
// Gets the calls property value. The number of unique 1:1 calls that users participated in.
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) GetCalls()(*int64) {
    if m == nil {
        return nil
    } else {
        return m.calls
...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) GetMeetings()(*int64) {
    if m == nil {
        return nil
    } else {
        return m.meetings
...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) GetPrivateChatMessages()(*int64) {
    if m == nil {
        return nil
    } else {
...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) GetReportPeriod()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) GetReportRefreshDate()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) GetTeamChatMessages()(*int64) {
    if m == nil {
        return nil
    } else {
...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) IsNil()(bool) {
    return m == nil
}
// Serializes information the current object
// Parameters:
//  - writer : Serialization writer to use to serialize this model
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) SetCalls(value *int64)() {
    m.calls = value
}
...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) SetMeetings(value *int64)() {
    m.meetings = value
}
...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) SetPrivateChatMessages(value *int64)() {
    m.privateChatMessages = value
}
// Sets the reportPeriod property value. The number of days the report covers.
// Parameters:
//  - value : Value to set for the reportPeriod property.
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) SetReportPeriod(value *string)() {
    m.reportPeriod = value
}
// Sets the reportRefreshDate property value. The latest date of the content.
// Parameters:
//  - value : Value to set for the reportRefreshDate property.
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) SetReportRefreshDate(value *string)() {
...
func (m *GetTeamsUserActivityDistributionTotalUserCountsWithPeriod) SetTeamChatMessages(value *int64)() {
