...
func (m *GetSharePointSiteUsageStorageWithPeriodRequestBuilder) CreateGetRequestInformationWithRequestConfiguration()(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// GetWithResponseHandler invoke function getSharePointSiteUsageStorage
func (m *GetSharePointSiteUsageStorageWithPeriodRequestBuilder) GetWithResponseHandler(requestConfiguration *GetSharePointSiteUsageStorageWithPeriodRequestBuilderGetRequestConfiguration)(GetSharePointSiteUsageStorageWithPeriodResponseable, error) {
    return m.GetWithResponseHandler(requestConfiguration, nil);
}
// GetWithResponseHandler invoke function getSharePointSiteUsageStorage
func (m *GetSharePointSiteUsageStorageWithPeriodRequestBuilder) GetWithResponseHandler(requestConfiguration *GetSharePointSiteUsageStorageWithPeriodRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(GetSharePointSiteUsageStorageWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformationWithRequestConfiguration(requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetSharePointSiteUsageStorageWithPeriodResponseFromDiscriminatorValue, responseHandler, nil)
    if err != nil {
        return nil, err
    }
