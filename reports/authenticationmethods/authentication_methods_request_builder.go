...
// DeleteWithResponseHandler delete navigation property authenticationMethods for reports
...
// PatchWithResponseHandler update the navigation property authenticationMethods in reports
