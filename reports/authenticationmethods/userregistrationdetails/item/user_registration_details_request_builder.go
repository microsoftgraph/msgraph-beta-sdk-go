...
// UserRegistrationDetailsRequestBuilder builds and executes requests for operations under \reports\authenticationMethods\userRegistrationDetails\{userRegistrationDetails-id}
...
// UserRegistrationDetailsRequestBuilderDeleteOptions options for Delete
type UserRegistrationDetailsRequestBuilderDeleteOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// UserRegistrationDetailsRequestBuilderPatchOptions options for Patch
type UserRegistrationDetailsRequestBuilderPatchOptions struct {
    // 
    Body *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserRegistrationDetails;
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
...
func NewUserRegistrationDetailsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UserRegistrationDetailsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/reports/authenticationMethods/userRegistrationDetails/{userRegistrationDetails_id}{?select,expand}";
...
func (m *UserRegistrationDetailsRequestBuilder) Get(options *UserRegistrationDetailsRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserRegistrationDetails, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewUserRegistrationDetails() }, nil)
    if err != nil {
        return nil, err
    }
