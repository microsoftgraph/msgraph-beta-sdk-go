...
func NewGetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder) {
    m := &GetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder{
...
func NewGetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder) {
    ...
    return NewGetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function getSkypeForBusinessDeviceUsageUserDetail
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder) {
    return NewGetskypeforbusinessdeviceusageuserdetailwithperiodGetSkypeForBusinessDeviceUsageUserDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
