...
// UserinsightsMonthlyAuthenticationsAuthenticationsMetricItemRequestBuilderGetQueryParameters insights for authentications on apps registered in the tenant for a specified period.
...
// NewUserinsightsMonthlyAuthenticationsAuthenticationsMetricItemRequestBuilderInternal instantiates a new UserinsightsMonthlyAuthenticationsAuthenticationsMetricItemRequestBuilder and sets the default values.
func NewUserinsightsMonthlyAuthenticationsAuthenticationsMetricItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserinsightsMonthlyAuthenticationsAuthenticationsMetricItemRequestBuilder) {
    m := &UserinsightsMonthlyAuthenticationsAuthenticationsMetricItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/monthly/authentications/{authenticationsMetric%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewUserinsightsMonthlyAuthenticationsAuthenticationsMetricItemRequestBuilder instantiates a new UserinsightsMonthlyAuthenticationsAuthenticationsMetricItemRequestBuilder and sets the default values.
