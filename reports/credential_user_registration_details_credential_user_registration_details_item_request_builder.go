...
func (m *CredentialUserRegistrationDetailsCredentialUserRegistrationDetailsItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *CredentialUserRegistrationDetailsCredentialUserRegistrationDetailsItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
