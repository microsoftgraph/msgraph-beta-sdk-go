...
func (m *AuthenticationMethodsUserRegistrationDetailsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AuthenticationMethodsUserRegistrationDetailsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
