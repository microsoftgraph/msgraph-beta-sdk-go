...
// GetCredentialUserRegistrationCountRequestBuilder builds and executes requests for operations under \reports\microsoft.graph.getCredentialUserRegistrationCount()
...
func (m *GetCredentialUserRegistrationCountRequestBuilder) Get(options *GetCredentialUserRegistrationCountRequestBuilderGetOptions)([]i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CredentialUserRegistrationCount, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewCredentialUserRegistrationCount() }, nil, nil)
    if err != nil {
        return nil, err
    }
    val := make([]i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CredentialUserRegistrationCount, len(res))
    for i, v := range res {
        val[i] = *(v.(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CredentialUserRegistrationCount))
    }
    return val, nil
}
