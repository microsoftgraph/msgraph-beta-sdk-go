...
func (m *GetYammerGroupsActivityDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetYammerGroupsActivityDetailWithPeriodRequestBuilder) {
    return NewGetYammerGroupsActivityDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
