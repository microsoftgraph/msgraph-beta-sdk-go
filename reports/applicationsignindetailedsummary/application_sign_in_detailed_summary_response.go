...
// ApplicationSignInDetailedSummaryResponse 
...
// NewApplicationSignInDetailedSummaryResponse instantiates a new applicationSignInDetailedSummaryResponse and sets the default values.
