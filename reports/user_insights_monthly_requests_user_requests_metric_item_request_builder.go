...
// UserInsightsMonthlyRequestsUserRequestsMetricItemRequestBuilderGetQueryParameters get requests from reports
...
// NewUserInsightsMonthlyRequestsUserRequestsMetricItemRequestBuilderInternal instantiates a new UserRequestsMetricItemRequestBuilder and sets the default values.
func NewUserInsightsMonthlyRequestsUserRequestsMetricItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsMonthlyRequestsUserRequestsMetricItemRequestBuilder) {
    m := &UserInsightsMonthlyRequestsUserRequestsMetricItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/monthly/requests/{userRequestsMetric%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewUserInsightsMonthlyRequestsUserRequestsMetricItemRequestBuilder instantiates a new UserRequestsMetricItemRequestBuilder and sets the default values.
