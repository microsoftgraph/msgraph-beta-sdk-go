...
// GetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder builds and executes requests for operations under \reports\microsoft.graph.getTeamsDeviceUsageTotalUserCounts(period='{period}')
...
func (m *GetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder) Get(options *GetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilderGetOptions)([]byte, error) {
