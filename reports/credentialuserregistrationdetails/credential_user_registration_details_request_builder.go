...
// CredentialUserRegistrationDetailsRequestBuilder builds and executes requests for operations under \reports\credentialUserRegistrationDetails
...
func NewCredentialUserRegistrationDetailsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CredentialUserRegistrationDetailsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/reports/credentialUserRegistrationDetails{?top,skip,search,filter,count,orderby,select,expand}";
...
// CreatePostRequestInformation details of the usage of self-service password reset and multi-factor authentication (MFA) for all registered users.
...
func (m *CredentialUserRegistrationDetailsRequestBuilder) Get(options *CredentialUserRegistrationDetailsRequestBuilderGetOptions)(*CredentialUserRegistrationDetailsResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewCredentialUserRegistrationDetailsResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*CredentialUserRegistrationDetailsResponse), nil
}
// Post details of the usage of self-service password reset and multi-factor authentication (MFA) for all registered users.
func (m *CredentialUserRegistrationDetailsRequestBuilder) Post(options *CredentialUserRegistrationDetailsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CredentialUserRegistrationDetails, error) {
