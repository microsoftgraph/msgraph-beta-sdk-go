...
func (m *GetOneDriveUsageAccountDetailWithPeriodRequestBuilder) Get(options *GetOneDriveUsageAccountDetailWithPeriodRequestBuilderGetOptions)(GetOneDriveUsageAccountDetailWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetOneDriveUsageAccountDetailWithPeriodResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
