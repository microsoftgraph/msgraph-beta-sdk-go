...
func (m *GetOneDriveUsageAccountDetailWithPeriodRequestBuilder) GetWithResponseHandler(requestConfiguration *GetOneDriveUsageAccountDetailWithPeriodRequestBuilderGetRequestConfiguration)(GetOneDriveUsageAccountDetailWithPeriodResponseable, error) {
    return m.GetWithResponseHandler(requestConfiguration, nil);
}
// GetWithResponseHandler invoke function getOneDriveUsageAccountDetail
func (m *GetOneDriveUsageAccountDetailWithPeriodRequestBuilder) GetWithResponseHandler(requestConfiguration *GetOneDriveUsageAccountDetailWithPeriodRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(GetOneDriveUsageAccountDetailWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformationWithRequestConfiguration(requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetOneDriveUsageAccountDetailWithPeriodResponseFromDiscriminatorValue, responseHandler, nil)
    if err != nil {
        return nil, err
    }
    return res.(GetOneDriveUsageAccountDetailWithPeriodResponseable), nil
}
