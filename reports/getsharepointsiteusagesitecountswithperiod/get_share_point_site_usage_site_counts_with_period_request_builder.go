...
func (m *GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder) Get(options *GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilderGetOptions)(GetSharePointSiteUsageSiteCountsWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetSharePointSiteUsageSiteCountsWithPeriodResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(GetSharePointSiteUsageSiteCountsWithPeriodResponseable), nil
}
