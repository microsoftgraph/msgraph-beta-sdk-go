...
// UserInsightsDailyAuthenticationsRequestBuilderGetQueryParameters get authentications from reports
...
// NewUserInsightsDailyAuthenticationsRequestBuilderInternal instantiates a new AuthenticationsRequestBuilder and sets the default values.
func NewUserInsightsDailyAuthenticationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsDailyAuthenticationsRequestBuilder) {
    m := &UserInsightsDailyAuthenticationsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/daily/authentications{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewUserInsightsDailyAuthenticationsRequestBuilder instantiates a new AuthenticationsRequestBuilder and sets the default values.
