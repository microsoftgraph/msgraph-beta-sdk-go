...
func (m *GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder) Get(options *GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilderGetOptions)([]byte, error) {
