...
func (m *GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder) Get()(GetSkypeForBusinessParticipantActivityCountsWithPeriodResponseable, error) {
