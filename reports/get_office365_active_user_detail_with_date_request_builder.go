...
// GetOffice365ActiveUserDetailWithDateRequestBuilderGetQueryParameters invoke function getOffice365ActiveUserDetail
type GetOffice365ActiveUserDetailWithDateRequestBuilderGetQueryParameters struct {
...
type GetOffice365ActiveUserDetailWithDateRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *GetOffice365ActiveUserDetailWithDateRequestBuilderGetQueryParameters
}
...
func NewGetOffice365ActiveUserDetailWithDateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, date *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly)(*GetOffice365ActiveUserDetailWithDateRequestBuilder) {
    m := &GetOffice365ActiveUserDetailWithDateRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/getOffice365ActiveUserDetail(date={date}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters),
    }
    if date != nil {
...
func (m *GetOffice365ActiveUserDetailWithDateRequestBuilder) Get(ctx context.Context, requestConfiguration *GetOffice365ActiveUserDetailWithDateRequestBuilderGetRequestConfiguration)(GetOffice365ActiveUserDetailWithDateResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateGetOffice365ActiveUserDetailWithDateResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *GetOffice365ActiveUserDetailWithDateRequestBuilder) GetAsGetOffice365ActiveUserDetailWithDateGetResponse(ctx context.Context, requestConfiguration *GetOffice365ActiveUserDetailWithDateRequestBuilderGetRequestConfiguration)(GetOffice365ActiveUserDetailWithDateGetResponseable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateGetOffice365ActiveUserDetailWithDateGetResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(GetOffice365ActiveUserDetailWithDateGetResponseable), nil
}
