...
func (m *UserInsightsDailyInactiveUsersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserInsightsDailyInactiveUsersCountRequestBuilderGetRequestConfiguration)(*int64, error) {
