...
func (m *UserInsightsDailyMfaCompletionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserInsightsDailyMfaCompletionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
