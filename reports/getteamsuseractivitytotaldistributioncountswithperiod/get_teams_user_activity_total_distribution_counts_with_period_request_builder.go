...
func (m *GetTeamsUserActivityTotalDistributionCountsWithPeriodRequestBuilder) Get()(GetTeamsUserActivityTotalDistributionCountsWithPeriodResponseable, error) {
