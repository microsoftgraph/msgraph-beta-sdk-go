...
func (m *UserInsightsMonthlyInactiveUsersByApplicationCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserInsightsMonthlyInactiveUsersByApplicationCountRequestBuilderGetRequestConfiguration)(*int64, error) {
