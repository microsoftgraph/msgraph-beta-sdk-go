...
// NewUserInsightsMonthlyInactiveUsersByApplicationCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewUserInsightsMonthlyInactiveUsersByApplicationCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsMonthlyInactiveUsersByApplicationCountRequestBuilder) {
    m := &UserInsightsMonthlyInactiveUsersByApplicationCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/monthly/inactiveUsersByApplication/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewUserInsightsMonthlyInactiveUsersByApplicationCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
