...
func (m *GetOneDriveActivityUserDetailWithPeriodRequestBuilder) Get(options *GetOneDriveActivityUserDetailWithPeriodRequestBuilderGetOptions)(GetOneDriveActivityUserDetailWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetOneDriveActivityUserDetailWithPeriodResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
