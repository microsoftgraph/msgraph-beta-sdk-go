...
func (m *ReportsRequestBuilder) GetFormsUserActivityCountsWithPeriod(period *string)(*GetFormsUserActivityCountsWithPeriodRequestBuilder) {
    return NewGetFormsUserActivityCountsWithPeriodRequestBuilderInternal(m.pathParameters, m.requestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetFormsUserActivityUserCountsWithPeriod(period *string)(*GetFormsUserActivityUserCountsWithPeriodRequestBuilder) {
    return NewGetFormsUserActivityUserCountsWithPeriodRequestBuilderInternal(m.pathParameters, m.requestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetFormsUserActivityUserDetailWithDate(date *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly)(*GetFormsUserActivityUserDetailWithDateRequestBuilder) {
    return NewGetFormsUserActivityUserDetailWithDateRequestBuilderInternal(m.pathParameters, m.requestAdapter, date)
}
...
func (m *ReportsRequestBuilder) GetFormsUserActivityUserDetailWithPeriod(period *string)(*GetFormsUserActivityUserDetailWithPeriodRequestBuilder) {
    return NewGetFormsUserActivityUserDetailWithPeriodRequestBuilderInternal(m.pathParameters, m.requestAdapter, period)
}
