...
func (m *ReportsRequestBuilder) AppCredentialSignInActivities()(*AppcredentialsigninactivitiesAppCredentialSignInActivitiesRequestBuilder) {
    return NewAppcredentialsigninactivitiesAppCredentialSignInActivitiesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) ApplicationSignInDetailedSummary()(*ApplicationsignindetailedsummaryApplicationSignInDetailedSummaryRequestBuilder) {
    return NewApplicationsignindetailedsummaryApplicationSignInDetailedSummaryRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) CredentialUserRegistrationDetails()(*CredentialuserregistrationdetailsCredentialUserRegistrationDetailsRequestBuilder) {
    return NewCredentialuserregistrationdetailsCredentialUserRegistrationDetailsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) DailyPrintUsage()(*DailyprintusageDailyPrintUsageRequestBuilder) {
    return NewDailyprintusageDailyPrintUsageRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) DailyPrintUsageSummariesByPrinter()(*DailyprintusagesummariesbyprinterDailyPrintUsageSummariesByPrinterRequestBuilder) {
    return NewDailyprintusagesummariesbyprinterDailyPrintUsageSummariesByPrinterRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) DailyPrintUsageSummariesByUser()(*DailyprintusagesummariesbyuserDailyPrintUsageSummariesByUserRequestBuilder) {
    return NewDailyprintusagesummariesbyuserDailyPrintUsageSummariesByUserRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) GetAttackSimulationRepeatOffenders()(*GetattacksimulationrepeatoffendersGetAttackSimulationRepeatOffendersRequestBuilder) {
    return NewGetattacksimulationrepeatoffendersGetAttackSimulationRepeatOffendersRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) GetAttackSimulationSimulationUserCoverage()(*GetattacksimulationsimulationusercoverageGetAttackSimulationSimulationUserCoverageRequestBuilder) {
    return NewGetattacksimulationsimulationusercoverageGetAttackSimulationSimulationUserCoverageRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) GetAttackSimulationTrainingUserCoverage()(*GetattacksimulationtrainingusercoverageGetAttackSimulationTrainingUserCoverageRequestBuilder) {
    return NewGetattacksimulationtrainingusercoverageGetAttackSimulationTrainingUserCoverageRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) GetAzureADApplicationSignInSummaryWithPeriod(period *string)(*GetazureadapplicationsigninsummarywithperiodGetAzureADApplicationSignInSummaryWithPeriodRequestBuilder) {
    return NewGetazureadapplicationsigninsummarywithperiodGetAzureADApplicationSignInSummaryWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetBrowserDistributionUserCountsWithPeriod(period *string)(*GetbrowserdistributionusercountswithperiodGetBrowserDistributionUserCountsWithPeriodRequestBuilder) {
    return NewGetbrowserdistributionusercountswithperiodGetBrowserDistributionUserCountsWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetBrowserUserCountsWithPeriod(period *string)(*GetbrowserusercountswithperiodGetBrowserUserCountsWithPeriodRequestBuilder) {
    return NewGetbrowserusercountswithperiodGetBrowserUserCountsWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetBrowserUserDetailWithPeriod(period *string)(*GetbrowseruserdetailwithperiodGetBrowserUserDetailWithPeriodRequestBuilder) {
    return NewGetbrowseruserdetailwithperiodGetBrowserUserDetailWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetCredentialUsageSummaryWithPeriod(period *string)(*GetcredentialusagesummarywithperiodGetCredentialUsageSummaryWithPeriodRequestBuilder) {
    return NewGetcredentialusagesummarywithperiodGetCredentialUsageSummaryWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetCredentialUserRegistrationCount()(*GetcredentialuserregistrationcountGetCredentialUserRegistrationCountRequestBuilder) {
    return NewGetcredentialuserregistrationcountGetCredentialUserRegistrationCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) GetFormsUserActivityCountsWithPeriod(period *string)(*GetformsuseractivitycountswithperiodGetFormsUserActivityCountsWithPeriodRequestBuilder) {
    return NewGetformsuseractivitycountswithperiodGetFormsUserActivityCountsWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetFormsUserActivityUserCountsWithPeriod(period *string)(*GetformsuseractivityusercountswithperiodGetFormsUserActivityUserCountsWithPeriodRequestBuilder) {
    return NewGetformsuseractivityusercountswithperiodGetFormsUserActivityUserCountsWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetFormsUserActivityUserDetailWithDate(date *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly)(*GetformsuseractivityuserdetailwithdateGetFormsUserActivityUserDetailWithDateRequestBuilder) {
    return NewGetformsuseractivityuserdetailwithdateGetFormsUserActivityUserDetailWithDateRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, date)
}
...
func (m *ReportsRequestBuilder) GetFormsUserActivityUserDetailWithPeriod(period *string)(*GetformsuseractivityuserdetailwithperiodGetFormsUserActivityUserDetailWithPeriodRequestBuilder) {
    return NewGetformsuseractivityuserdetailwithperiodGetFormsUserActivityUserDetailWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetTeamsDeviceUsageDistributionTotalUserCountsWithPeriod(period *string)(*GetteamsdeviceusagedistributiontotalusercountswithperiodGetTeamsDeviceUsageDistributionTotalUserCountsWithPeriodRequestBuilder) {
    return NewGetteamsdeviceusagedistributiontotalusercountswithperiodGetTeamsDeviceUsageDistributionTotalUserCountsWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetTeamsDeviceUsageTotalUserCountsWithPeriod(period *string)(*GetteamsdeviceusagetotalusercountswithperiodGetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder) {
    return NewGetteamsdeviceusagetotalusercountswithperiodGetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetTeamsUserActivityDistributionTotalUserCountsWithPeriod(period *string)(*GetteamsuseractivitydistributiontotalusercountswithperiodGetTeamsUserActivityDistributionTotalUserCountsWithPeriodRequestBuilder) {
    return NewGetteamsuseractivitydistributiontotalusercountswithperiodGetTeamsUserActivityDistributionTotalUserCountsWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetTeamsUserActivityDistributionUserCountsWithPeriod(period *string)(*GetteamsuseractivitydistributionusercountswithperiodGetTeamsUserActivityDistributionUserCountsWithPeriodRequestBuilder) {
    return NewGetteamsuseractivitydistributionusercountswithperiodGetTeamsUserActivityDistributionUserCountsWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetTeamsUserActivityTotalCountsWithPeriod(period *string)(*GetteamsuseractivitytotalcountswithperiodGetTeamsUserActivityTotalCountsWithPeriodRequestBuilder) {
    return NewGetteamsuseractivitytotalcountswithperiodGetTeamsUserActivityTotalCountsWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetTeamsUserActivityTotalDistributionCountsWithPeriod(period *string)(*GetteamsuseractivitytotaldistributioncountswithperiodGetTeamsUserActivityTotalDistributionCountsWithPeriodRequestBuilder) {
    return NewGetteamsuseractivitytotaldistributioncountswithperiodGetTeamsUserActivityTotalDistributionCountsWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) GetTeamsUserActivityTotalUserCountsWithPeriod(period *string)(*GetteamsuseractivitytotalusercountswithperiodGetTeamsUserActivityTotalUserCountsWithPeriodRequestBuilder) {
    return NewGetteamsuseractivitytotalusercountswithperiodGetTeamsUserActivityTotalUserCountsWithPeriodRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, period)
}
...
func (m *ReportsRequestBuilder) ManagedDeviceEnrollmentAbandonmentDetailsWithSkipWithTopWithFilterWithSkipToken(filter *string, skip *int32, skipToken *string, top *int32)(*ManageddeviceenrollmentabandonmentdetailswithskipwithtopwithfilterwithskiptokenManagedDeviceEnrollmentAbandonmentDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder) {
    return NewManageddeviceenrollmentabandonmentdetailswithskipwithtopwithfilterwithskiptokenManagedDeviceEnrollmentAbandonmentDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, filter, skip, skipToken, top)
}
...
func (m *ReportsRequestBuilder) ManagedDeviceEnrollmentAbandonmentSummaryWithSkipWithTopWithFilterWithSkipToken(filter *string, skip *int32, skipToken *string, top *int32)(*ManageddeviceenrollmentabandonmentsummarywithskipwithtopwithfilterwithskiptokenManagedDeviceEnrollmentAbandonmentSummaryWithSkipWithTopWithFilterWithSkipTokenRequestBuilder) {
    return NewManageddeviceenrollmentabandonmentsummarywithskipwithtopwithfilterwithskiptokenManagedDeviceEnrollmentAbandonmentSummaryWithSkipWithTopWithFilterWithSkipTokenRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, filter, skip, skipToken, top)
}
...
func (m *ReportsRequestBuilder) ManagedDeviceEnrollmentFailureTrends()(*ManageddeviceenrollmentfailuretrendsManagedDeviceEnrollmentFailureTrendsRequestBuilder) {
    return NewManageddeviceenrollmentfailuretrendsManagedDeviceEnrollmentFailureTrendsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) MonthlyPrintUsageSummariesByPrinter()(*MonthlyprintusagesummariesbyprinterMonthlyPrintUsageSummariesByPrinterRequestBuilder) {
    return NewMonthlyprintusagesummariesbyprinterMonthlyPrintUsageSummariesByPrinterRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) MonthlyPrintUsageSummariesByUser()(*MonthlyprintusagesummariesbyuserMonthlyPrintUsageSummariesByUserRequestBuilder) {
    return NewMonthlyprintusagesummariesbyuserMonthlyPrintUsageSummariesByUserRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) ServiceActivity()(*ServiceactivityServiceActivityRequestBuilder) {
    return NewServiceactivityServiceActivityRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) ServicePrincipalSignInActivities()(*ServiceprincipalsigninactivitiesServicePrincipalSignInActivitiesRequestBuilder) {
    return NewServiceprincipalsigninactivitiesServicePrincipalSignInActivitiesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) UserCredentialUsageDetails()(*UsercredentialusagedetailsUserCredentialUsageDetailsRequestBuilder) {
    return NewUsercredentialusagedetailsUserCredentialUsageDetailsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReportsRequestBuilder) UserInsights()(*UserinsightsUserInsightsRequestBuilder) {
    return NewUserinsightsUserInsightsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
