...
func (m *GetSharePointActivityUserCountsWithPeriodRequestBuilder) Get(options *GetSharePointActivityUserCountsWithPeriodRequestBuilderGetOptions)([]byte, error) {
