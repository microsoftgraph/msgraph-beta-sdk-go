...
// NewGetSharePointActivityUserCountsWithPeriod instantiates a new getSharePointActivityUserCountsWithPeriod and sets the default values.
...
// GetVisitedPage gets the visitedPage property value. 
