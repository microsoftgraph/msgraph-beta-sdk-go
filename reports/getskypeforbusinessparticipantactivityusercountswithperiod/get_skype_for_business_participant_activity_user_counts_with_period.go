...
// NewGetSkypeForBusinessParticipantActivityUserCountsWithPeriod instantiates a new getSkypeForBusinessParticipantActivityUserCountsWithPeriod and sets the default values.
