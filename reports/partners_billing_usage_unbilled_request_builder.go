...
// NewPartnersBillingUsageUnbilledRequestBuilderInternal instantiates a new UnbilledRequestBuilder and sets the default values.
func NewPartnersBillingUsageUnbilledRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PartnersBillingUsageUnbilledRequestBuilder) {
    m := &PartnersBillingUsageUnbilledRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/partners/billing/usage/unbilled{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewPartnersBillingUsageUnbilledRequestBuilder instantiates a new UnbilledRequestBuilder and sets the default values.
