...
func (m *UserInsightsMonthlyMfaCompletionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserInsightsMonthlyMfaCompletionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
