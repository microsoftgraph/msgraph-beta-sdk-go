...
// NewUserInsightsMonthlyMfaCompletionsCountRequestBuilderInternal instantiates a new UserInsightsMonthlyMfaCompletionsCountRequestBuilder and sets the default values.
func NewUserInsightsMonthlyMfaCompletionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsMonthlyMfaCompletionsCountRequestBuilder) {
    m := &UserInsightsMonthlyMfaCompletionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/monthly/mfaCompletions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewUserInsightsMonthlyMfaCompletionsCountRequestBuilder instantiates a new UserInsightsMonthlyMfaCompletionsCountRequestBuilder and sets the default values.
