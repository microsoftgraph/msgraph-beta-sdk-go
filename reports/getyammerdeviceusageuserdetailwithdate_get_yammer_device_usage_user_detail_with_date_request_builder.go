...
func NewGetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, date *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly)(*GetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilder) {
    m := &GetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilder{
...
func NewGetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilder) {
    ...
    return NewGetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function getYammerDeviceUsageUserDetail
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilder) Get(ctx context.Context, requestConfiguration *GetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilder) WithUrl(rawUrl string)(*GetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilder) {
    return NewGetyammerdeviceusageuserdetailwithdateGetYammerDeviceUsageUserDetailWithDateRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
