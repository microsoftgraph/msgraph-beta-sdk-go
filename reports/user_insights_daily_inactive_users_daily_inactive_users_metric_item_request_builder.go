...
// NewUserInsightsDailyInactiveUsersDailyInactiveUsersMetricItemRequestBuilderInternal instantiates a new DailyInactiveUsersMetricItemRequestBuilder and sets the default values.
func NewUserInsightsDailyInactiveUsersDailyInactiveUsersMetricItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsDailyInactiveUsersDailyInactiveUsersMetricItemRequestBuilder) {
    m := &UserInsightsDailyInactiveUsersDailyInactiveUsersMetricItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/daily/inactiveUsers/{dailyInactiveUsersMetric%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewUserInsightsDailyInactiveUsersDailyInactiveUsersMetricItemRequestBuilder instantiates a new DailyInactiveUsersMetricItemRequestBuilder and sets the default values.
