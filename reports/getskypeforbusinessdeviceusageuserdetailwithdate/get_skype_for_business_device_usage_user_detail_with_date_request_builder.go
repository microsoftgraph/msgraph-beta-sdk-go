...
// getSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder builds and executes requests for operations under \reports\microsoft.graph.getSkypeForBusinessDeviceUsageUserDetail(date={date})
...
func NewGetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder) {
...
func (m *GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder) CreateGetRequestInformation(options *GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder) Get(options *GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilderGetOptions)([]GetSkypeForBusinessDeviceUsageUserDetailWithDate, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGetSkypeForBusinessDeviceUsageUserDetailWithDate() }, nil)
    if err != nil {
        return nil, err
    }
    val := make([]GetSkypeForBusinessDeviceUsageUserDetailWithDate, len(res))
    for i, v := range res {
        val[i] = *(v.(*GetSkypeForBusinessDeviceUsageUserDetailWithDate))
    }
    return val, nil
}
