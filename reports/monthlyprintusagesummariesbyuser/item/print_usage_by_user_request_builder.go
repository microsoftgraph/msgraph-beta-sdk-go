...
// PrintUsageByUserRequestBuilder builds and executes requests for operations under \reports\monthlyPrintUsageSummariesByUser\{printUsageByUser-id}
...
// PrintUsageByUserRequestBuilderGetQueryParameters get monthlyPrintUsageSummariesByUser from reports
...
func NewPrintUsageByUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PrintUsageByUserRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/reports/monthlyPrintUsageSummariesByUser/{printUsageByUser_id}{?select,expand}";
