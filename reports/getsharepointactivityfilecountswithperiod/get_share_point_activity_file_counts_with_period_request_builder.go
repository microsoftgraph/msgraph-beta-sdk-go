...
func (m *GetSharePointActivityFileCountsWithPeriodRequestBuilder) Get(options *GetSharePointActivityFileCountsWithPeriodRequestBuilderGetOptions)([]byte, error) {
