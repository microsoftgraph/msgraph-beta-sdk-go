...
func (m *GetSharePointActivityFileCountsWithPeriodRequestBuilder) Get(options *GetSharePointActivityFileCountsWithPeriodRequestBuilderGetOptions)(GetSharePointActivityFileCountsWithPeriodResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetSharePointActivityFileCountsWithPeriodResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
