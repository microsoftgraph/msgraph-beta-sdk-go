...
// UserInsightsDailyActiveUsersRequestBuilderGetQueryParameters get activeUsers from reports
...
// NewUserInsightsDailyActiveUsersRequestBuilderInternal instantiates a new ActiveUsersRequestBuilder and sets the default values.
func NewUserInsightsDailyActiveUsersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsDailyActiveUsersRequestBuilder) {
    m := &UserInsightsDailyActiveUsersRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/daily/activeUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewUserInsightsDailyActiveUsersRequestBuilder instantiates a new ActiveUsersRequestBuilder and sets the default values.
