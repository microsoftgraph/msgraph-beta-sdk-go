...
func NewGetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder) {
    m := &GetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder{
...
func NewGetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder) {
    ...
    return NewGetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function getSkypeForBusinessPeerToPeerActivityCounts
// returns a []byte when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *GetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder) {
    return NewGetskypeforbusinesspeertopeeractivitycountswithperiodGetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
