...
// UserInsightsMonthlySummaryInsightSummaryItemRequestBuilderGetQueryParameters get summary from reports
...
// NewUserInsightsMonthlySummaryInsightSummaryItemRequestBuilderInternal instantiates a new InsightSummaryItemRequestBuilder and sets the default values.
func NewUserInsightsMonthlySummaryInsightSummaryItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserInsightsMonthlySummaryInsightSummaryItemRequestBuilder) {
    m := &UserInsightsMonthlySummaryInsightSummaryItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/userInsights/monthly/summary/{insightSummary%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewUserInsightsMonthlySummaryInsightSummaryItemRequestBuilder instantiates a new InsightSummaryItemRequestBuilder and sets the default values.
