...
// returns a *string when successful
func (m *ItemChatsItemSendActivityNotificationPostRequestBody) GetIconId()(*string) {
...
func (m *ItemChatsItemSendActivityNotificationPostRequestBody) SetIconId(value *string)() {
