...
func (m *ItemChatsRequestBuilder) MicrosoftGraphAllMessages()(*ItemChatsMicrosoftGraphAllMessagesRequestBuilder) {
    return NewItemChatsMicrosoftGraphAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
