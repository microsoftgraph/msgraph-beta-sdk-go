...
func (m *ItemChatsRequestBuilder) MicrosoftGraphAllMessages()(*ItemChatsMicrosoftGraphAllMessagesAllMessagesRequestBuilder) {
    return NewItemChatsMicrosoftGraphAllMessagesAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetAllMessages provides operations to call the getAllMessages method.
func (m *ItemChatsRequestBuilder) MicrosoftGraphGetAllMessages()(*ItemChatsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilder) {
    return NewItemChatsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
