...
// ItemDevicesItemUsageRightsUsageRightItemRequestBuilder provides operations to manage the usageRights property of the microsoft.graph.device entity.
type ItemDevicesItemUsageRightsUsageRightItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemDevicesItemUsageRightsUsageRightItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemDevicesItemUsageRightsUsageRightItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
type ItemDevicesItemUsageRightsUsageRightItemRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemDevicesItemUsageRightsUsageRightItemRequestBuilderGetQueryParameters
}
// ItemDevicesItemUsageRightsUsageRightItemRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemDevicesItemUsageRightsUsageRightItemRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewItemDevicesItemUsageRightsUsageRightItemRequestBuilderInternal instantiates a new ItemDevicesItemUsageRightsUsageRightItemRequestBuilder and sets the default values.
...
// NewItemDevicesItemUsageRightsUsageRightItemRequestBuilder instantiates a new ItemDevicesItemUsageRightsUsageRightItemRequestBuilder and sets the default values.
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemDevicesItemUsageRightsUsageRightItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDevicesItemUsageRightsUsageRightItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UsageRightable, error) {
...
// returns a *RequestInformation when successful
func (m *ItemDevicesItemUsageRightsUsageRightItemRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemDevicesItemUsageRightsUsageRightItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemDevicesItemUsageRightsUsageRightItemRequestBuilder) ToPatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UsageRightable, requestConfiguration *ItemDevicesItemUsageRightsUsageRightItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.PATCH, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/usageRights/{usageRight%2Did}", m.BaseRequestBuilder.PathParameters)
    if requestConfiguration != nil {
        requestInfo.Headers.AddAll(requestConfiguration.Headers)
        requestInfo.AddRequestOptions(requestConfiguration.Options)
    }
...
func (m *ItemDevicesItemUsageRightsUsageRightItemRequestBuilder) WithUrl(rawUrl string)(*ItemDevicesItemUsageRightsUsageRightItemRequestBuilder) {
    return NewItemDevicesItemUsageRightsUsageRightItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
