...
// NewItemManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilderInternal instantiates a new ItemManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder and sets the default values.
...
// NewItemManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder instantiates a new ItemManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder and sets the default values.
...
func (m *ItemManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder) WithUrl(rawUrl string)(*ItemManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder) {
    return NewItemManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
