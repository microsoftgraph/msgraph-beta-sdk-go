...
// NewItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilderInternal instantiates a new ItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilder and sets the default values.
func NewItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilder) {
    m := &ItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/ownedDevices/{directoryObject%2Did}/graph.appRoleAssignment{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilder instantiates a new ItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilder and sets the default values.
...
func (m *ItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AppRoleAssignmentable, error) {
...
func (m *ItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilder) WithUrl(rawUrl string)(*ItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilder) {
    return NewItemOwnedDevicesItemGraphAppRoleAssignmentRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
