...
func (m *ItemDevicesItemRegisteredOwnersGraphServicePrincipalCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDevicesItemRegisteredOwnersGraphServicePrincipalCountRequestBuilderGetRequestConfiguration)(*int64, error) {
