...
func (m *ItemInformationProtectionEncryptBufferPostRequestBody) GetLabelId()(*UUID) {
    return m.labelId
}
...
func (m *ItemInformationProtectionEncryptBufferPostRequestBody) SetLabelId(value *UUID)() {
    m.labelId = value
}
