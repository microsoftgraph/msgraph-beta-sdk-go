...
// NewItemManagedDevicesItemDeprovisionRequestBuilderInternal instantiates a new DeprovisionRequestBuilder and sets the default values.
func NewItemManagedDevicesItemDeprovisionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemManagedDevicesItemDeprovisionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deprovision";
...
// NewItemManagedDevicesItemDeprovisionRequestBuilder instantiates a new DeprovisionRequestBuilder and sets the default values.
