...
func (m *ItemCalendarsItemEventsItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarsItemEventsItemInstancesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemCalendarsItemEventsItemInstancesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
