...
// ItemCloudPCsRequestBuilderGetQueryParameters list the cloudPC devices that are attributed to the signed-in user.  This API is supported in the following national cloud deployments.
...
// Get list the cloudPC devices that are attributed to the signed-in user.  This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation list the cloudPC devices that are attributed to the signed-in user.  This API is supported in the following national cloud deployments.
