...
func (m *ItemAppConsentRequestsForApprovalCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemAppConsentRequestsForApprovalCountRequestBuilderGetRequestConfiguration)(*int64, error) {
