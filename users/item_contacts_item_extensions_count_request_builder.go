...
func (m *ItemContactsItemExtensionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemContactsItemExtensionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
