...
// ItemMailFoldersItemChildFoldersItemUserConfigurationsUserConfigurationItemRequestBuilderGetQueryParameters the user configuration objects associated to the mailFolder.
