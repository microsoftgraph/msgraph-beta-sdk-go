...
// ItemDevicesItemUsageRightsRequestBuilderGetQueryParameters retrieve a list of usageRight objects for a given device. This API is supported in the following national cloud deployments.
