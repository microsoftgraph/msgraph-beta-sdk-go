...
// ByPersonInterestIdString provides operations to manage the interests property of the microsoft.graph.profile entity.
func (m *ItemProfileInterestsRequestBuilder) ByPersonInterestIdString(personInterestId string)(*ItemProfileInterestsPersonInterestItemRequestBuilder) {
