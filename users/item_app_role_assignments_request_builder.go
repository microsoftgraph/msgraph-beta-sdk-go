...
// Post create new navigation property to appRoleAssignments for users
...
// ToPostRequestInformation create new navigation property to appRoleAssignments for users
