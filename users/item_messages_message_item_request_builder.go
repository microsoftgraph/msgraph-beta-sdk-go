...
func (m *ItemMessagesMessageItemRequestBuilder) MicrosoftGraphUnsubscribe()(*ItemMessagesItemMicrosoftGraphUnsubscribeRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphUnsubscribeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
