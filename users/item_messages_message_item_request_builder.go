...
func (m *ItemMessagesMessageItemRequestBuilder) AttachmentsById(id string)(*ItemMessagesItemAttachmentsAttachmentItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemMessagesItemAttachmentsAttachmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewItemMessagesMessageItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, messageId *string)(*ItemMessagesMessageItemRequestBuilder) {
...
func NewItemMessagesMessageItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMessagesMessageItemRequestBuilder) {
    ...
    return NewItemMessagesMessageItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemMessagesMessageItemRequestBuilder) ExtensionsById(id string)(*ItemMessagesItemExtensionsExtensionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemMessagesItemExtensionsExtensionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemMessagesMessageItemRequestBuilder) Mentions()(*ItemMessagesItemMentionsRequestBuilder) {
    return NewItemMessagesItemMentionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MentionsById provides operations to manage the mentions property of the microsoft.graph.message entity.
func (m *ItemMessagesMessageItemRequestBuilder) MentionsById(id string)(*ItemMessagesItemMentionsMentionItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    idPtr := &id
    return NewItemMessagesItemMentionsMentionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
// MicrosoftGraphCopy provides operations to call the copy method.
func (m *ItemMessagesMessageItemRequestBuilder) MicrosoftGraphCopy()(*ItemMessagesItemMicrosoftGraphCopyCopyRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphCopyCopyRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCreateForward provides operations to call the createForward method.
func (m *ItemMessagesMessageItemRequestBuilder) MicrosoftGraphCreateForward()(*ItemMessagesItemMicrosoftGraphCreateForwardCreateForwardRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphCreateForwardCreateForwardRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCreateReply provides operations to call the createReply method.
func (m *ItemMessagesMessageItemRequestBuilder) MicrosoftGraphCreateReply()(*ItemMessagesItemMicrosoftGraphCreateReplyCreateReplyRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphCreateReplyCreateReplyRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCreateReplyAll provides operations to call the createReplyAll method.
func (m *ItemMessagesMessageItemRequestBuilder) MicrosoftGraphCreateReplyAll()(*ItemMessagesItemMicrosoftGraphCreateReplyAllCreateReplyAllRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphCreateReplyAllCreateReplyAllRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphForward provides operations to call the forward method.
func (m *ItemMessagesMessageItemRequestBuilder) MicrosoftGraphForward()(*ItemMessagesItemMicrosoftGraphForwardForwardRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphForwardForwardRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphMove provides operations to call the move method.
func (m *ItemMessagesMessageItemRequestBuilder) MicrosoftGraphMove()(*ItemMessagesItemMicrosoftGraphMoveMoveRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphMoveMoveRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphReply provides operations to call the reply method.
func (m *ItemMessagesMessageItemRequestBuilder) MicrosoftGraphReply()(*ItemMessagesItemMicrosoftGraphReplyReplyRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphReplyReplyRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphReplyAll provides operations to call the replyAll method.
func (m *ItemMessagesMessageItemRequestBuilder) MicrosoftGraphReplyAll()(*ItemMessagesItemMicrosoftGraphReplyAllReplyAllRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphReplyAllReplyAllRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSend provides operations to call the send method.
func (m *ItemMessagesMessageItemRequestBuilder) MicrosoftGraphSend()(*ItemMessagesItemMicrosoftGraphSendSendRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphSendSendRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnsubscribe provides operations to call the unsubscribe method.
func (m *ItemMessagesMessageItemRequestBuilder) MicrosoftGraphUnsubscribe()(*ItemMessagesItemMicrosoftGraphUnsubscribeUnsubscribeRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphUnsubscribeUnsubscribeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemMessagesMessageItemRequestBuilder) MultiValueExtendedPropertiesById(id string)(*ItemMessagesItemMultiValueExtendedPropertiesMultiValueLegacyExtendedPropertyItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemMessagesItemMultiValueExtendedPropertiesMultiValueLegacyExtendedPropertyItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemMessagesMessageItemRequestBuilder) SingleValueExtendedPropertiesById(id string)(*ItemMessagesItemSingleValueExtendedPropertiesSingleValueLegacyExtendedPropertyItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemMessagesItemSingleValueExtendedPropertiesSingleValueLegacyExtendedPropertyItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
