...
// ItemOnenoteSectionsOnenoteSectionItemRequestBuilderGetQueryParameters retrieve the properties and relationships of a section object. This API is supported in the following national cloud deployments.
...
func NewItemOnenoteSectionsOnenoteSectionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnenoteSectionsOnenoteSectionItemRequestBuilder) {
    m := &ItemOnenoteSectionsOnenoteSectionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get retrieve the properties and relationships of a section object. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve the properties and relationships of a section object. This API is supported in the following national cloud deployments.
