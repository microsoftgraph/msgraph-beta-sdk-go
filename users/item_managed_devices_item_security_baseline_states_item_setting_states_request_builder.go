...
// NewItemManagedDevicesItemSecurityBaselineStatesItemSettingStatesRequestBuilderInternal instantiates a new SettingStatesRequestBuilder and sets the default values.
...
// NewItemManagedDevicesItemSecurityBaselineStatesItemSettingStatesRequestBuilder instantiates a new SettingStatesRequestBuilder and sets the default values.
...
func (m *ItemManagedDevicesItemSecurityBaselineStatesItemSettingStatesRequestBuilder) Count()(*ItemManagedDevicesItemSecurityBaselineStatesItemSettingStatesCountRequestBuilder) {
    return NewItemManagedDevicesItemSecurityBaselineStatesItemSettingStatesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the security baseline state for different settings for a device
func (m *ItemManagedDevicesItemSecurityBaselineStatesItemSettingStatesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemManagedDevicesItemSecurityBaselineStatesItemSettingStatesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
