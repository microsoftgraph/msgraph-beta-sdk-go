...
func (m *ItemOutlookTasksOutlookTaskItemRequestBuilder) MicrosoftGraphComplete()(*ItemOutlookTasksItemMicrosoftGraphCompleteRequestBuilder) {
    return NewItemOutlookTasksItemMicrosoftGraphCompleteRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
