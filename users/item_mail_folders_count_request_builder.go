...
func (m *ItemMailFoldersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMailFoldersCountRequestBuilderGetRequestConfiguration)(*int64, error) {
