...
func NewItemOwnedobjectsItemGraphgroupGraphGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedobjectsItemGraphgroupGraphGroupRequestBuilder) {
    m := &ItemOwnedobjectsItemGraphgroupGraphGroupRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/graph.group{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
func NewItemOwnedobjectsItemGraphgroupGraphGroupRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedobjectsItemGraphgroupGraphGroupRequestBuilder) {
    ...
    return NewItemOwnedobjectsItemGraphgroupGraphGroupRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the item of type microsoft.graph.directoryObject as microsoft.graph.group
// returns a Groupable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemOwnedobjectsItemGraphgroupGraphGroupRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedobjectsItemGraphgroupGraphGroupRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Groupable, error) {
...
func (m *ItemOwnedobjectsItemGraphgroupGraphGroupRequestBuilder) WithUrl(rawUrl string)(*ItemOwnedobjectsItemGraphgroupGraphGroupRequestBuilder) {
    return NewItemOwnedobjectsItemGraphgroupGraphGroupRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
