...
func (m *ItemMailfoldersItemMessagesItemAttachmentsRequestBuilder) CreateUploadSession()(*ItemMailfoldersItemMessagesItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilder) {
    return NewItemMailfoldersItemMessagesItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
