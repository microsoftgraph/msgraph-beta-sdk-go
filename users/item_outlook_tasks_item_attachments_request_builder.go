...
func (m *ItemOutlookTasksItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*ItemOutlookTasksItemAttachmentsMicrosoftGraphCreateUploadSessionRequestBuilder) {
    return NewItemOutlookTasksItemAttachmentsMicrosoftGraphCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
