...
func (m *ItemOutlookTasksItemAttachmentsRequestBuilder) Count()(*ItemOutlookTasksItemAttachmentsCountRequestBuilder) {
    return NewItemOutlookTasksItemAttachmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of attachment objects attached to an Outlook task.
func (m *ItemOutlookTasksItemAttachmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemOutlookTasksItemAttachmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemOutlookTasksItemAttachmentsRequestBuilder) CreateUploadSession()(*ItemOutlookTasksItemAttachmentsCreateUploadSessionRequestBuilder) {
    return NewItemOutlookTasksItemAttachmentsCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
