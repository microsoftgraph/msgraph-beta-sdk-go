...
func (m *ItemOutlookTasksItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*ItemOutlookTasksItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilder) {
    return NewItemOutlookTasksItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
