...
// ItemMessagesItemCreateReplyPostRequestBody provides operations to call the createReply method.
...
func (m *ItemMessagesItemCreateReplyPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMessagesItemCreateReplyPostRequestBody) GetMessage()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Messageable) {
    return m.message
}
...
func (m *ItemMessagesItemCreateReplyPostRequestBody) SetAdditionalData(value map[string]interface{})() {
...
func (m *ItemMessagesItemCreateReplyPostRequestBody) SetMessage(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Messageable)() {
    m.message = value
}
