...
// NewItemDeviceEnrollmentConfigurationsCreateEnrollmentNotificationConfigurationRequestBuilderInternal instantiates a new CreateEnrollmentNotificationConfigurationRequestBuilder and sets the default values.
func NewItemDeviceEnrollmentConfigurationsCreateEnrollmentNotificationConfigurationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDeviceEnrollmentConfigurationsCreateEnrollmentNotificationConfigurationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations/createEnrollmentNotificationConfiguration";
...
// NewItemDeviceEnrollmentConfigurationsCreateEnrollmentNotificationConfigurationRequestBuilder instantiates a new CreateEnrollmentNotificationConfigurationRequestBuilder and sets the default values.
