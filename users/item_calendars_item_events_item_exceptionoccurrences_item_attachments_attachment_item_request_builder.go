...
// NewItemCalendarsItemEventsItemExceptionoccurrencesItemAttachmentsAttachmentItemRequestBuilderInternal instantiates a new ItemCalendarsItemEventsItemExceptionoccurrencesItemAttachmentsAttachmentItemRequestBuilder and sets the default values.
func NewItemCalendarsItemEventsItemExceptionoccurrencesItemAttachmentsAttachmentItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarsItemEventsItemExceptionoccurrencesItemAttachmentsAttachmentItemRequestBuilder) {
    m := &ItemCalendarsItemEventsItemExceptionoccurrencesItemAttachmentsAttachmentItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments/{attachment%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemCalendarsItemEventsItemExceptionoccurrencesItemAttachmentsAttachmentItemRequestBuilder instantiates a new ItemCalendarsItemEventsItemExceptionoccurrencesItemAttachmentsAttachmentItemRequestBuilder and sets the default values.
...
func (m *ItemCalendarsItemEventsItemExceptionoccurrencesItemAttachmentsAttachmentItemRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarsItemEventsItemExceptionoccurrencesItemAttachmentsAttachmentItemRequestBuilder) {
    return NewItemCalendarsItemEventsItemExceptionoccurrencesItemAttachmentsAttachmentItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
