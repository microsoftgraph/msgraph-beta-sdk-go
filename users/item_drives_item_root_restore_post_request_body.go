...
// ItemDrivesItemRootRestorePostRequestBody provides operations to call the restore method.
...
func (m *ItemDrivesItemRootRestorePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemDrivesItemRootRestorePostRequestBody) SetAdditionalData(value map[string]interface{})() {
