...
// ItemUsagerightsUsageRightsRequestBuilder provides operations to manage the usageRights property of the microsoft.graph.user entity.
type ItemUsagerightsUsageRightsRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemUsagerightsUsageRightsRequestBuilderGetQueryParameters retrieve a list of usageRight objects for a given user.
...
func NewItemUsagerightsUsageRightsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemUsagerightsUsageRightsRequestBuilder) {
    m := &ItemUsagerightsUsageRightsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/usageRights{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
...
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/user-list-usagerights?view=graph-rest-beta
