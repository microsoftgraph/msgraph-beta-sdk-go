...
func NewItemOnenoteSectionsItemPagesOnenotePageItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, onenotePageId *string)(*ItemOnenoteSectionsItemPagesOnenotePageItemRequestBuilder) {
...
func NewItemOnenoteSectionsItemPagesOnenotePageItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnenoteSectionsItemPagesOnenotePageItemRequestBuilder) {
    ...
    return NewItemOnenoteSectionsItemPagesOnenotePageItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemOnenoteSectionsItemPagesOnenotePageItemRequestBuilder) MicrosoftGraphCopyToSection()(*ItemOnenoteSectionsItemPagesItemMicrosoftGraphCopyToSectionCopyToSectionRequestBuilder) {
    return NewItemOnenoteSectionsItemPagesItemMicrosoftGraphCopyToSectionCopyToSectionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphOnenotePatchContent provides operations to call the onenotePatchContent method.
func (m *ItemOnenoteSectionsItemPagesOnenotePageItemRequestBuilder) MicrosoftGraphOnenotePatchContent()(*ItemOnenoteSectionsItemPagesItemMicrosoftGraphOnenotePatchContentOnenotePatchContentRequestBuilder) {
    return NewItemOnenoteSectionsItemPagesItemMicrosoftGraphOnenotePatchContentOnenotePatchContentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphPreview provides operations to call the preview method.
func (m *ItemOnenoteSectionsItemPagesOnenotePageItemRequestBuilder) MicrosoftGraphPreview()(*ItemOnenoteSectionsItemPagesItemMicrosoftGraphPreviewPreviewRequestBuilder) {
    return NewItemOnenoteSectionsItemPagesItemMicrosoftGraphPreviewPreviewRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
