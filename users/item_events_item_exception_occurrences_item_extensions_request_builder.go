...
func (m *ItemEventsItemExceptionOccurrencesItemExtensionsRequestBuilder) Count()(*ItemEventsItemExceptionOccurrencesItemExtensionsCountRequestBuilder) {
    return NewItemEventsItemExceptionOccurrencesItemExtensionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the collection of open extensions defined for the event. Nullable.
func (m *ItemEventsItemExceptionOccurrencesItemExtensionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemEventsItemExceptionOccurrencesItemExtensionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
