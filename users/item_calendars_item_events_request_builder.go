...
func (m *ItemCalendarsItemEventsRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarsItemEventsMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemCalendarsItemEventsMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
