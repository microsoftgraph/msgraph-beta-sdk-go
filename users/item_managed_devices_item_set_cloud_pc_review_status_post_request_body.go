...
// ItemManagedDevicesItemSetCloudPcReviewStatusPostRequestBody provides operations to call the setCloudPcReviewStatus method.
...
func (m *ItemManagedDevicesItemSetCloudPcReviewStatusPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemManagedDevicesItemSetCloudPcReviewStatusPostRequestBody) SetAdditionalData(value map[string]interface{})() {
