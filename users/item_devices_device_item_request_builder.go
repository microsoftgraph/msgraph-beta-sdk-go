...
func (m *ItemDevicesDeviceItemRequestBuilder) CommandsById(id string)(*ItemDevicesItemCommandsCommandItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemDevicesItemCommandsCommandItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
// NewItemDevicesDeviceItemRequestBuilderInternal instantiates a new DeviceItemRequestBuilder and sets the default values.
func NewItemDevicesDeviceItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, deviceId *string)(*ItemDevicesDeviceItemRequestBuilder) {
...
func NewItemDevicesDeviceItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDevicesDeviceItemRequestBuilder) {
    ...
    return NewItemDevicesDeviceItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemDevicesDeviceItemRequestBuilder) ExtensionsById(id string)(*ItemDevicesItemExtensionsExtensionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemDevicesItemExtensionsExtensionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemDevicesDeviceItemRequestBuilder) MemberOfById(id string)(*ItemDevicesItemMemberOfDirectoryObjectItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemDevicesItemMemberOfDirectoryObjectItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
// MicrosoftGraphCheckMemberGroups provides operations to call the checkMemberGroups method.
func (m *ItemDevicesDeviceItemRequestBuilder) MicrosoftGraphCheckMemberGroups()(*ItemDevicesItemMicrosoftGraphCheckMemberGroupsCheckMemberGroupsRequestBuilder) {
    return NewItemDevicesItemMicrosoftGraphCheckMemberGroupsCheckMemberGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCheckMemberObjects provides operations to call the checkMemberObjects method.
func (m *ItemDevicesDeviceItemRequestBuilder) MicrosoftGraphCheckMemberObjects()(*ItemDevicesItemMicrosoftGraphCheckMemberObjectsCheckMemberObjectsRequestBuilder) {
    return NewItemDevicesItemMicrosoftGraphCheckMemberObjectsCheckMemberObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetMemberGroups provides operations to call the getMemberGroups method.
func (m *ItemDevicesDeviceItemRequestBuilder) MicrosoftGraphGetMemberGroups()(*ItemDevicesItemMicrosoftGraphGetMemberGroupsGetMemberGroupsRequestBuilder) {
    return NewItemDevicesItemMicrosoftGraphGetMemberGroupsGetMemberGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetMemberObjects provides operations to call the getMemberObjects method.
func (m *ItemDevicesDeviceItemRequestBuilder) MicrosoftGraphGetMemberObjects()(*ItemDevicesItemMicrosoftGraphGetMemberObjectsGetMemberObjectsRequestBuilder) {
    return NewItemDevicesItemMicrosoftGraphGetMemberObjectsGetMemberObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRestore provides operations to call the restore method.
func (m *ItemDevicesDeviceItemRequestBuilder) MicrosoftGraphRestore()(*ItemDevicesItemMicrosoftGraphRestoreRestoreRequestBuilder) {
    return NewItemDevicesItemMicrosoftGraphRestoreRestoreRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemDevicesDeviceItemRequestBuilder) RegisteredOwnersById(id string)(*ItemDevicesItemRegisteredOwnersDirectoryObjectItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemDevicesItemRegisteredOwnersDirectoryObjectItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemDevicesDeviceItemRequestBuilder) RegisteredUsersById(id string)(*ItemDevicesItemRegisteredUsersDirectoryObjectItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemDevicesItemRegisteredUsersDirectoryObjectItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemDevicesDeviceItemRequestBuilder) TransitiveMemberOfById(id string)(*ItemDevicesItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemDevicesItemTransitiveMemberOfDirectoryObjectItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemDevicesDeviceItemRequestBuilder) UsageRightsById(id string)(*ItemDevicesItemUsageRightsUsageRightItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemDevicesItemUsageRightsUsageRightItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
