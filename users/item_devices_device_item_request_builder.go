...
func (m *ItemDevicesDeviceItemRequestBuilder) MicrosoftGraphCheckMemberGroups()(*ItemDevicesItemMicrosoftGraphCheckMemberGroupsRequestBuilder) {
    return NewItemDevicesItemMicrosoftGraphCheckMemberGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCheckMemberObjects provides operations to call the checkMemberObjects method.
func (m *ItemDevicesDeviceItemRequestBuilder) MicrosoftGraphCheckMemberObjects()(*ItemDevicesItemMicrosoftGraphCheckMemberObjectsRequestBuilder) {
    return NewItemDevicesItemMicrosoftGraphCheckMemberObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetMemberGroups provides operations to call the getMemberGroups method.
func (m *ItemDevicesDeviceItemRequestBuilder) MicrosoftGraphGetMemberGroups()(*ItemDevicesItemMicrosoftGraphGetMemberGroupsRequestBuilder) {
    return NewItemDevicesItemMicrosoftGraphGetMemberGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetMemberObjects provides operations to call the getMemberObjects method.
func (m *ItemDevicesDeviceItemRequestBuilder) MicrosoftGraphGetMemberObjects()(*ItemDevicesItemMicrosoftGraphGetMemberObjectsRequestBuilder) {
    return NewItemDevicesItemMicrosoftGraphGetMemberObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRestore provides operations to call the restore method.
func (m *ItemDevicesDeviceItemRequestBuilder) MicrosoftGraphRestore()(*ItemDevicesItemMicrosoftGraphRestoreRequestBuilder) {
    return NewItemDevicesItemMicrosoftGraphRestoreRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
