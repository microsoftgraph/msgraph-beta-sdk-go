...
// NewItemMailfoldersItemUserconfigurationsCountRequestBuilder instantiates a new ItemMailfoldersItemUserconfigurationsCountRequestBuilder and sets the default values.
