...
// ByProjectParticipationIdString provides operations to manage the projects property of the microsoft.graph.profile entity.
func (m *ItemProfileProjectsRequestBuilder) ByProjectParticipationIdString(projectParticipationId string)(*ItemProfileProjectsProjectParticipationItemRequestBuilder) {
