...
// NewItemCalendarsItemEventsItemInstancesItemAttachmentsCountRequestBuilderInternal instantiates a new ItemCalendarsItemEventsItemInstancesItemAttachmentsCountRequestBuilder and sets the default values.
func NewItemCalendarsItemEventsItemInstancesItemAttachmentsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarsItemEventsItemInstancesItemAttachmentsCountRequestBuilder) {
    m := &ItemCalendarsItemEventsItemInstancesItemAttachmentsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/attachments/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemCalendarsItemEventsItemInstancesItemAttachmentsCountRequestBuilder instantiates a new ItemCalendarsItemEventsItemInstancesItemAttachmentsCountRequestBuilder and sets the default values.
