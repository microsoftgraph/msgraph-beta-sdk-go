...
// NewItemManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilderInternal instantiates a new ItemManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilder and sets the default values.
func NewItemManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilder) {
    m := &ItemManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilder instantiates a new ItemManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilder and sets the default values.
...
// returns a *ItemManageddevicesItemSecuritybaselinestatesItemSettingstatesSettingStatesRequestBuilder when successful
func (m *ItemManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilder) SettingStates()(*ItemManageddevicesItemSecuritybaselinestatesItemSettingstatesSettingStatesRequestBuilder) {
    return NewItemManageddevicesItemSecuritybaselinestatesItemSettingstatesSettingStatesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// ToPatchRequestInformation update the navigation property securityBaselineStates in users
// returns a *RequestInformation when successful
...
func (m *ItemManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilder) WithUrl(rawUrl string)(*ItemManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilder) {
    return NewItemManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
