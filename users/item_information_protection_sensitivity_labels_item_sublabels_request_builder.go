...
func (m *ItemInformationProtectionSensitivityLabelsItemSublabelsRequestBuilder) MicrosoftGraphEvaluate()(*ItemInformationProtectionSensitivityLabelsItemSublabelsMicrosoftGraphEvaluateRequestBuilder) {
    return NewItemInformationProtectionSensitivityLabelsItemSublabelsMicrosoftGraphEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
