...
func (m *ItemPendingAccessReviewInstancesItemStagesRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*ItemPendingAccessReviewInstancesItemStagesMicrosoftGraphFilterByCurrentUserWithOnFilterByCurrentUserWithOnRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemStagesMicrosoftGraphFilterByCurrentUserWithOnFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
