...
// NewItemPendingAccessReviewInstancesItemStagesRequestBuilderInternal instantiates a new StagesRequestBuilder and sets the default values.
...
// NewItemPendingAccessReviewInstancesItemStagesRequestBuilder instantiates a new StagesRequestBuilder and sets the default values.
...
func (m *ItemPendingAccessReviewInstancesItemStagesRequestBuilder) Count()(*ItemPendingAccessReviewInstancesItemStagesCountRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemStagesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation retrieve the stages in a multi-stage access review instance.
func (m *ItemPendingAccessReviewInstancesItemStagesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemPendingAccessReviewInstancesItemStagesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemPendingAccessReviewInstancesItemStagesRequestBuilder) FilterByCurrentUserWithOn(on *string)(*ItemPendingAccessReviewInstancesItemStagesFilterByCurrentUserWithOnRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemStagesFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on);
}
