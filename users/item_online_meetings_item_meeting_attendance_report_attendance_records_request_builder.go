...
// ItemOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilderGetQueryParameters list of attendance records of an attendance report. Read-only.
...
func (m *ItemOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder) ByAttendanceRecordId(attendanceRecordId string)(*ItemOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsAttendanceRecordItemRequestBuilder) {
...
// NewItemOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilderInternal instantiates a new ItemOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder and sets the default values.
...
// NewItemOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder instantiates a new ItemOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder and sets the default values.
...
func (m *ItemOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder) WithUrl(rawUrl string)(*ItemOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder) {
    return NewItemOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
