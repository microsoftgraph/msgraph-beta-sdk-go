...
// ItemManagedDevicesItemRequestRemoteHelpSessionAccessPostRequestBody 
...
func (m *ItemManagedDevicesItemRequestRemoteHelpSessionAccessPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemManagedDevicesItemRequestRemoteHelpSessionAccessPostRequestBody) SetAdditionalData(value map[string]any)() {
