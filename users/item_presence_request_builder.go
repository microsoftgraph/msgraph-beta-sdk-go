...
func (m *ItemPresenceRequestBuilder) MicrosoftGraphSetStatusMessage()(*ItemPresenceMicrosoftGraphSetStatusMessageRequestBuilder) {
    return NewItemPresenceMicrosoftGraphSetStatusMessageRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
