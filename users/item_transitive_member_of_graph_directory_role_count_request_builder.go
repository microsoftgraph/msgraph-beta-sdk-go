...
func (m *ItemTransitiveMemberOfGraphDirectoryRoleCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTransitiveMemberOfGraphDirectoryRoleCountRequestBuilderGetRequestConfiguration)(*int64, error) {
