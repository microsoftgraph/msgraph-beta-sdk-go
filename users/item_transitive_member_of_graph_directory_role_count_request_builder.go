...
// NewItemTransitiveMemberOfGraphDirectoryRoleCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemTransitiveMemberOfGraphDirectoryRoleCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTransitiveMemberOfGraphDirectoryRoleCountRequestBuilder) {
    m := &ItemTransitiveMemberOfGraphDirectoryRoleCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/transitiveMemberOf/graph.directoryRole/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewItemTransitiveMemberOfGraphDirectoryRoleCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
