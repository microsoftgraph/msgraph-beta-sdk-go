...
func (m *ItemJoinedGroupsGetUserOwnedObjectsRequestBuilder) WithUrl(rawUrl string)(*ItemJoinedGroupsGetUserOwnedObjectsRequestBuilder) {
    return NewItemJoinedGroupsGetUserOwnedObjectsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
