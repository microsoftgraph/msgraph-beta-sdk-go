...
func (m *ItemManagedDevicesItemDetectedAppsRequestBuilder) Count()(*ItemManagedDevicesItemDetectedAppsCountRequestBuilder) {
    return NewItemManagedDevicesItemDetectedAppsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation all applications currently installed on the device
func (m *ItemManagedDevicesItemDetectedAppsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemManagedDevicesItemDetectedAppsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
