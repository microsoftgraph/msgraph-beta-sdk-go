...
func (m *ItemPendingAccessReviewInstancesItemStagesItemDecisionsRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*ItemPendingAccessReviewInstancesItemStagesItemDecisionsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemStagesItemDecisionsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
// MicrosoftGraphRecordAllDecisions provides operations to call the recordAllDecisions method.
func (m *ItemPendingAccessReviewInstancesItemStagesItemDecisionsRequestBuilder) MicrosoftGraphRecordAllDecisions()(*ItemPendingAccessReviewInstancesItemStagesItemDecisionsMicrosoftGraphRecordAllDecisionsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemStagesItemDecisionsMicrosoftGraphRecordAllDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
