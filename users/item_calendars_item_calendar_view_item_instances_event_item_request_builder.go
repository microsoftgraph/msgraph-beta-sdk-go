...
func (m *ItemCalendarsItemCalendarViewItemInstancesEventItemRequestBuilder) PermanentDelete()(*ItemCalendarsItemCalendarViewItemInstancesItemPermanentDeleteRequestBuilder) {
    return NewItemCalendarsItemCalendarViewItemInstancesItemPermanentDeleteRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
