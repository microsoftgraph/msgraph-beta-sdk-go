...
// NewItemVirtualEventsWebinarsRequestBuilderInternal instantiates a new WebinarsRequestBuilder and sets the default values.
func NewItemVirtualEventsWebinarsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemVirtualEventsWebinarsRequestBuilder) {
    m := &ItemVirtualEventsWebinarsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/virtualEvents/webinars{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemVirtualEventsWebinarsRequestBuilder instantiates a new WebinarsRequestBuilder and sets the default values.
