...
// ItemProfileWebsitesRequestBuilderGetQueryParameters retrieve a list of personWebsite objects from a user's profile. This API is available in the following national cloud deployments.
...
// Get retrieve a list of personWebsite objects from a user's profile. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create a new personWebsite object in a user's profile. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve a list of personWebsite objects from a user's profile. This API is available in the following national cloud deployments.
...
// ToPostRequestInformation create a new personWebsite object in a user's profile. This API is available in the following national cloud deployments.
