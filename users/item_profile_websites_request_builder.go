...
// ItemProfileWebsitesRequestBuilderGetQueryParameters retrieve a list of personWebsite objects from a user's profile.
...
// NewItemProfileWebsitesRequestBuilderInternal instantiates a new WebsitesRequestBuilder and sets the default values.
func NewItemProfileWebsitesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemProfileWebsitesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/profile/websites{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemProfileWebsitesRequestBuilder instantiates a new WebsitesRequestBuilder and sets the default values.
...
func (m *ItemProfileWebsitesRequestBuilder) Count()(*ItemProfileWebsitesCountRequestBuilder) {
    return NewItemProfileWebsitesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation retrieve a list of personWebsite objects from a user's profile.
func (m *ItemProfileWebsitesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemProfileWebsitesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/profile-list-websites?view=graph-rest-1.0
...
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/profile-post-websites?view=graph-rest-1.0
