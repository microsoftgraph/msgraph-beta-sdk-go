...
func (m *ItemMailFoldersItemUserConfigurationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMailFoldersItemUserConfigurationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
