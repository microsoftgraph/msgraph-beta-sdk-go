...
func NewItemActivitiesUserActivityItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, userActivityId *string)(*ItemActivitiesUserActivityItemRequestBuilder) {
...
func NewItemActivitiesUserActivityItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemActivitiesUserActivityItemRequestBuilder) {
    ...
    return NewItemActivitiesUserActivityItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemActivitiesUserActivityItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemActivitiesUserActivityItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserActivityable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateUserActivityFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemActivitiesUserActivityItemRequestBuilder) HistoryItemsById(id string)(*ItemActivitiesItemHistoryItemsActivityHistoryItemItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemActivitiesItemHistoryItemsActivityHistoryItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
