...
// NewItemPendingAccessReviewInstancesItemStagesCountRequestBuilderInternal instantiates a new ItemPendingAccessReviewInstancesItemStagesCountRequestBuilder and sets the default values.
func NewItemPendingAccessReviewInstancesItemStagesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPendingAccessReviewInstancesItemStagesCountRequestBuilder) {
    m := &ItemPendingAccessReviewInstancesItemStagesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemPendingAccessReviewInstancesItemStagesCountRequestBuilder instantiates a new ItemPendingAccessReviewInstancesItemStagesCountRequestBuilder and sets the default values.
...
func (m *ItemPendingAccessReviewInstancesItemStagesCountRequestBuilder) WithUrl(rawUrl string)(*ItemPendingAccessReviewInstancesItemStagesCountRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemStagesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
