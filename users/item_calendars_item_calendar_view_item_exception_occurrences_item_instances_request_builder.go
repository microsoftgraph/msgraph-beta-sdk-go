...
func (m *ItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
