...
// ItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilderGetQueryParameters get the instances (occurrences) of an event for a specified time range.  If the event is a `seriesMaster` type, this returns theoccurrences and exceptions of the event in the specified time range.
...
// NewItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilderInternal instantiates a new InstancesRequestBuilder and sets the default values.
...
// NewItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder instantiates a new InstancesRequestBuilder and sets the default values.
...
func (m *ItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder) Count()(*ItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesCountRequestBuilder) {
    return NewItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemCalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
