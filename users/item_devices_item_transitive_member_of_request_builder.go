...
func (m *ItemDevicesItemTransitiveMemberOfRequestBuilder) MicrosoftGraphApplication()(*ItemDevicesItemTransitiveMemberOfMicrosoftGraphApplicationApplicationRequestBuilder) {
    return NewItemDevicesItemTransitiveMemberOfMicrosoftGraphApplicationApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDevice casts the previous resource to device.
func (m *ItemDevicesItemTransitiveMemberOfRequestBuilder) MicrosoftGraphDevice()(*ItemDevicesItemTransitiveMemberOfMicrosoftGraphDeviceDeviceRequestBuilder) {
    return NewItemDevicesItemTransitiveMemberOfMicrosoftGraphDeviceDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGroup casts the previous resource to group.
func (m *ItemDevicesItemTransitiveMemberOfRequestBuilder) MicrosoftGraphGroup()(*ItemDevicesItemTransitiveMemberOfMicrosoftGraphGroupGroupRequestBuilder) {
    return NewItemDevicesItemTransitiveMemberOfMicrosoftGraphGroupGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphOrgContact casts the previous resource to orgContact.
func (m *ItemDevicesItemTransitiveMemberOfRequestBuilder) MicrosoftGraphOrgContact()(*ItemDevicesItemTransitiveMemberOfMicrosoftGraphOrgContactOrgContactRequestBuilder) {
    return NewItemDevicesItemTransitiveMemberOfMicrosoftGraphOrgContactOrgContactRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *ItemDevicesItemTransitiveMemberOfRequestBuilder) MicrosoftGraphServicePrincipal()(*ItemDevicesItemTransitiveMemberOfMicrosoftGraphServicePrincipalServicePrincipalRequestBuilder) {
    return NewItemDevicesItemTransitiveMemberOfMicrosoftGraphServicePrincipalServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *ItemDevicesItemTransitiveMemberOfRequestBuilder) MicrosoftGraphUser()(*ItemDevicesItemTransitiveMemberOfMicrosoftGraphUserUserRequestBuilder) {
    return NewItemDevicesItemTransitiveMemberOfMicrosoftGraphUserUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
