...
func (m *ItemChatsItemPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) MicrosoftGraphCheckMemberGroups()(*ItemChatsItemPermissionGrantsItemMicrosoftGraphCheckMemberGroupsRequestBuilder) {
    return NewItemChatsItemPermissionGrantsItemMicrosoftGraphCheckMemberGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCheckMemberObjects provides operations to call the checkMemberObjects method.
func (m *ItemChatsItemPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) MicrosoftGraphCheckMemberObjects()(*ItemChatsItemPermissionGrantsItemMicrosoftGraphCheckMemberObjectsRequestBuilder) {
    return NewItemChatsItemPermissionGrantsItemMicrosoftGraphCheckMemberObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetMemberGroups provides operations to call the getMemberGroups method.
func (m *ItemChatsItemPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) MicrosoftGraphGetMemberGroups()(*ItemChatsItemPermissionGrantsItemMicrosoftGraphGetMemberGroupsRequestBuilder) {
    return NewItemChatsItemPermissionGrantsItemMicrosoftGraphGetMemberGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetMemberObjects provides operations to call the getMemberObjects method.
func (m *ItemChatsItemPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) MicrosoftGraphGetMemberObjects()(*ItemChatsItemPermissionGrantsItemMicrosoftGraphGetMemberObjectsRequestBuilder) {
    return NewItemChatsItemPermissionGrantsItemMicrosoftGraphGetMemberObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRestore provides operations to call the restore method.
func (m *ItemChatsItemPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) MicrosoftGraphRestore()(*ItemChatsItemPermissionGrantsItemMicrosoftGraphRestoreRequestBuilder) {
    return NewItemChatsItemPermissionGrantsItemMicrosoftGraphRestoreRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
