...
func (m *ItemContactsRequestBuilder) MicrosoftGraphDelta()(*ItemContactsMicrosoftGraphDeltaRequestBuilder) {
    return NewItemContactsMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
