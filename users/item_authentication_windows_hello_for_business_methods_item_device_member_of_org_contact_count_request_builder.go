...
// ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfOrgContactCountRequestBuilderGetQueryParameters get the number of the resource
type ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfOrgContactCountRequestBuilderGetQueryParameters struct {
...
type ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfOrgContactCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfOrgContactCountRequestBuilderGetQueryParameters
}
...
func NewItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfOrgContactCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfOrgContactCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.orgContact/$count{?%24search,%24filter}";
