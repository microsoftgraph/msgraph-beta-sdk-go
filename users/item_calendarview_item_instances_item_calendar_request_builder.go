...
func NewItemCalendarviewItemInstancesItemCalendarRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarviewItemInstancesItemCalendarRequestBuilder) {
    m := &ItemCalendarviewItemInstancesItemCalendarRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/calendar{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemCalendarviewItemInstancesItemCalendarRequestBuilder instantiates a new ItemCalendarviewItemInstancesItemCalendarRequestBuilder and sets the default values.
...
func (m *ItemCalendarviewItemInstancesItemCalendarRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarviewItemInstancesItemCalendarRequestBuilder) {
    return NewItemCalendarviewItemInstancesItemCalendarRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
