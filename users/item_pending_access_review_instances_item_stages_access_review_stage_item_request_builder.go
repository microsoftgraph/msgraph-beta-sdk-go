...
func (m *ItemPendingAccessReviewInstancesItemStagesAccessReviewStageItemRequestBuilder) MicrosoftGraphStop()(*ItemPendingAccessReviewInstancesItemStagesItemMicrosoftGraphStopRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemStagesItemMicrosoftGraphStopRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
