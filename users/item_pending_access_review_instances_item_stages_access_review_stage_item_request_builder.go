...
func (m *ItemPendingAccessReviewInstancesItemStagesAccessReviewStageItemRequestBuilder) AcceptRecommendations()(*ItemPendingAccessReviewInstancesItemStagesItemAcceptRecommendationsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemStagesItemAcceptRecommendationsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemPendingAccessReviewInstancesItemStagesAccessReviewStageItemRequestBuilder) BatchRecordDecisions()(*ItemPendingAccessReviewInstancesItemStagesItemBatchRecordDecisionsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemStagesItemBatchRecordDecisionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
