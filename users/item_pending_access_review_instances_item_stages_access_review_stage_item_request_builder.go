...
func (m *ItemPendingAccessReviewInstancesItemStagesAccessReviewStageItemRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemPendingAccessReviewInstancesItemStagesAccessReviewStageItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemPendingAccessReviewInstancesItemStagesAccessReviewStageItemRequestBuilder) DecisionsById(id string)(*AccessReviewInstanceDecisionItemItemRequestBuilder) {
    urlTplParams := make(map[string]string)
...
func (m *ItemPendingAccessReviewInstancesItemStagesAccessReviewStageItemRequestBuilder) Stop()(*ItemPendingAccessReviewInstancesItemStagesItemStopRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemStagesItemStopRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
