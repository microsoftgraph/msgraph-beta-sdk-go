...
func (m *ItemDevicesItemRegisteredUsersDirectoryObjectItemRequestBuilder) MicrosoftGraphEndpoint()(*ItemDevicesItemRegisteredUsersItemMicrosoftGraphEndpointRequestBuilder) {
    return NewItemDevicesItemRegisteredUsersItemMicrosoftGraphEndpointRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *ItemDevicesItemRegisteredUsersDirectoryObjectItemRequestBuilder) MicrosoftGraphServicePrincipal()(*ItemDevicesItemRegisteredUsersItemMicrosoftGraphServicePrincipalRequestBuilder) {
    return NewItemDevicesItemRegisteredUsersItemMicrosoftGraphServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *ItemDevicesItemRegisteredUsersDirectoryObjectItemRequestBuilder) MicrosoftGraphUser()(*ItemDevicesItemRegisteredUsersItemMicrosoftGraphUserRequestBuilder) {
    return NewItemDevicesItemRegisteredUsersItemMicrosoftGraphUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
