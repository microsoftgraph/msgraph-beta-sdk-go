...
// NewItemDevicesItemMemberofDirectoryObjectItemRequestBuilderInternal instantiates a new ItemDevicesItemMemberofDirectoryObjectItemRequestBuilder and sets the default values.
func NewItemDevicesItemMemberofDirectoryObjectItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDevicesItemMemberofDirectoryObjectItemRequestBuilder) {
    m := &ItemDevicesItemMemberofDirectoryObjectItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/{directoryObject%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemDevicesItemMemberofDirectoryObjectItemRequestBuilder instantiates a new ItemDevicesItemMemberofDirectoryObjectItemRequestBuilder and sets the default values.
...
// returns a *ItemDevicesItemMemberofItemGraphadministrativeunitGraphAdministrativeUnitRequestBuilder when successful
func (m *ItemDevicesItemMemberofDirectoryObjectItemRequestBuilder) GraphAdministrativeUnit()(*ItemDevicesItemMemberofItemGraphadministrativeunitGraphAdministrativeUnitRequestBuilder) {
    return NewItemDevicesItemMemberofItemGraphadministrativeunitGraphAdministrativeUnitRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// GraphGroup casts the previous resource to group.
// returns a *ItemDevicesItemMemberofItemGraphgroupGraphGroupRequestBuilder when successful
func (m *ItemDevicesItemMemberofDirectoryObjectItemRequestBuilder) GraphGroup()(*ItemDevicesItemMemberofItemGraphgroupGraphGroupRequestBuilder) {
    return NewItemDevicesItemMemberofItemGraphgroupGraphGroupRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemDevicesItemMemberofDirectoryObjectItemRequestBuilder) WithUrl(rawUrl string)(*ItemDevicesItemMemberofDirectoryObjectItemRequestBuilder) {
    return NewItemDevicesItemMemberofDirectoryObjectItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
