...
func (m *ItemMailFoldersItemMessagesItemExtensionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMailFoldersItemMessagesItemExtensionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
