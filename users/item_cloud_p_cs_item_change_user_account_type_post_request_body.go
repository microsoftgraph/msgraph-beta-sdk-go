...
// ItemCloudPCsItemChangeUserAccountTypePostRequestBody provides operations to call the changeUserAccountType method.
...
func (m *ItemCloudPCsItemChangeUserAccountTypePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCloudPCsItemChangeUserAccountTypePostRequestBody) SetAdditionalData(value map[string]interface{})() {
