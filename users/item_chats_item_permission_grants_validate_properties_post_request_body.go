...
// ItemChatsItemPermissionGrantsValidatePropertiesPostRequestBody provides operations to call the validateProperties method.
...
func (m *ItemChatsItemPermissionGrantsValidatePropertiesPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemChatsItemPermissionGrantsValidatePropertiesPostRequestBody) GetOnBehalfOfUserId()(*UUID) {
...
func (m *ItemChatsItemPermissionGrantsValidatePropertiesPostRequestBody) SetAdditionalData(value map[string]interface{})() {
...
func (m *ItemChatsItemPermissionGrantsValidatePropertiesPostRequestBody) SetOnBehalfOfUserId(value *UUID)() {
