...
// ItemManagedDevicesItemUpdateWindowsDeviceAccountPostRequestBody provides operations to call the updateWindowsDeviceAccount method.
...
func (m *ItemManagedDevicesItemUpdateWindowsDeviceAccountPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemManagedDevicesItemUpdateWindowsDeviceAccountPostRequestBody) SetAdditionalData(value map[string]interface{})() {
