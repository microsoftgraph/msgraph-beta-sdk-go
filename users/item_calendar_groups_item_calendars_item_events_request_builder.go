...
func (m *ItemCalendarGroupsItemCalendarsItemEventsRequestBuilder) ByEventIdString(eventId string)(*ItemCalendarGroupsItemCalendarsItemEventsEventItemRequestBuilder) {
