...
func (m *ItemSecurityInformationProtectionLabelPolicySettingsRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemSecurityInformationProtectionLabelPolicySettingsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
