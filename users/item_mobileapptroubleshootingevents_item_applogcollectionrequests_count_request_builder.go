...
// NewItemMobileapptroubleshootingeventsItemApplogcollectionrequestsCountRequestBuilderInternal instantiates a new ItemMobileapptroubleshootingeventsItemApplogcollectionrequestsCountRequestBuilder and sets the default values.
func NewItemMobileapptroubleshootingeventsItemApplogcollectionrequestsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMobileapptroubleshootingeventsItemApplogcollectionrequestsCountRequestBuilder) {
    m := &ItemMobileapptroubleshootingeventsItemApplogcollectionrequestsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemMobileapptroubleshootingeventsItemApplogcollectionrequestsCountRequestBuilder instantiates a new ItemMobileapptroubleshootingeventsItemApplogcollectionrequestsCountRequestBuilder and sets the default values.
