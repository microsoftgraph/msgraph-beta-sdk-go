...
// ItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilderGetQueryParameters get labels from users
...
func NewItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilder) {
    m := &ItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/{informationProtectionLabel%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
// ToDeleteRequestInformation delete navigation property labels for users
// Deprecated: This API will no longer be accessible, please see microsoft.graph.security.informationProtection APIs. as of 2021-02/Beta_SensitivityLabels
...
// ToPatchRequestInformation update the navigation property labels in users
// Deprecated: This API will no longer be accessible, please see microsoft.graph.security.informationProtection APIs. as of 2021-02/Beta_SensitivityLabels
// returns a *RequestInformation when successful
