...
func NewItemProfilePhonesItemPhoneItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, itemPhoneId *string)(*ItemProfilePhonesItemPhoneItemRequestBuilder) {
...
func NewItemProfilePhonesItemPhoneItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemProfilePhonesItemPhoneItemRequestBuilder) {
    ...
    return NewItemProfilePhonesItemPhoneItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemProfilePhonesItemPhoneItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemProfilePhonesItemPhoneItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ItemPhoneable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateItemPhoneFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// ToDeleteRequestInformation delete navigation property phones for users
...
// ToPatchRequestInformation update the navigation property phones in users
