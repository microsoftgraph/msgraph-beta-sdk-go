...
// ItemProfilePhonesItemPhoneItemRequestBuilder provides operations to manage the phones property of the microsoft.graph.profile entity.
type ItemProfilePhonesItemPhoneItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemProfilePhonesItemPhoneItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemProfilePhonesItemPhoneItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// ItemProfilePhonesItemPhoneItemRequestBuilderGetQueryParameters retrieve the properties and relationships of an itemPhone object in a user's profile. This API is available in the following national cloud deployments.
...
type ItemProfilePhonesItemPhoneItemRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemProfilePhonesItemPhoneItemRequestBuilderGetQueryParameters
}
// ItemProfilePhonesItemPhoneItemRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemProfilePhonesItemPhoneItemRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewItemProfilePhonesItemPhoneItemRequestBuilderInternal instantiates a new ItemPhoneItemRequestBuilder and sets the default values.
func NewItemProfilePhonesItemPhoneItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemProfilePhonesItemPhoneItemRequestBuilder) {
    m := &ItemProfilePhonesItemPhoneItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/phones/{itemPhone%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemProfilePhonesItemPhoneItemRequestBuilder instantiates a new ItemPhoneItemRequestBuilder and sets the default values.
func NewItemProfilePhonesItemPhoneItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemProfilePhonesItemPhoneItemRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemProfilePhonesItemPhoneItemRequestBuilderInternal(urlParams, requestAdapter)
}
// Delete delete an itemPhone object from the user's profile. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Get retrieve the properties and relationships of an itemPhone object in a user's profile. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Patch update the properties of an itemPhone object in a user's profile. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToDeleteRequestInformation delete an itemPhone object from the user's profile. This API is available in the following national cloud deployments.
...
// ToGetRequestInformation retrieve the properties and relationships of an itemPhone object in a user's profile. This API is available in the following national cloud deployments.
...
// ToPatchRequestInformation update the properties of an itemPhone object in a user's profile. This API is available in the following national cloud deployments.
