...
// Delete delete a focused Inbox override specified by its ID. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToDeleteRequestInformation delete a focused Inbox override specified by its ID. This API is supported in the following national cloud deployments.
