...
// returns a *ItemCalendarsItemEventsItemInstancesItemExceptionOccurrencesItemAttachmentsCreateUploadSessionRequestBuilder when successful
func (m *ItemCalendarsItemEventsItemInstancesItemExceptionOccurrencesItemAttachmentsRequestBuilder) CreateUploadSession()(*ItemCalendarsItemEventsItemInstancesItemExceptionOccurrencesItemAttachmentsCreateUploadSessionRequestBuilder) {
    return NewItemCalendarsItemEventsItemInstancesItemExceptionOccurrencesItemAttachmentsCreateUploadSessionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
