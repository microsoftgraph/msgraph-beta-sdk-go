...
func (m *UserItemRequestBuilder) MicrosoftGraphActivateServicePlan()(*ItemMicrosoftGraphActivateServicePlanRequestBuilder) {
    return NewItemMicrosoftGraphActivateServicePlanRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *UserItemRequestBuilder) MicrosoftGraphFindRoomLists()(*ItemMicrosoftGraphFindRoomListsRequestBuilder) {
    return NewItemMicrosoftGraphFindRoomListsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphFindRooms provides operations to call the findRooms method.
func (m *UserItemRequestBuilder) MicrosoftGraphFindRooms()(*ItemMicrosoftGraphFindRoomsRequestBuilder) {
    return NewItemMicrosoftGraphFindRoomsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphFindRoomsWithRoomList provides operations to call the findRooms method.
func (m *UserItemRequestBuilder) MicrosoftGraphFindRoomsWithRoomList(roomList *string)(*ItemMicrosoftGraphFindRoomsWithRoomListRequestBuilder) {
    return NewItemMicrosoftGraphFindRoomsWithRoomListRequestBuilderInternal(m.pathParameters, m.requestAdapter, roomList)
}
...
func (m *UserItemRequestBuilder) MicrosoftGraphGetEffectiveDeviceEnrollmentConfigurations()(*ItemMicrosoftGraphGetEffectiveDeviceEnrollmentConfigurationsRequestBuilder) {
    return NewItemMicrosoftGraphGetEffectiveDeviceEnrollmentConfigurationsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetLoggedOnManagedDevices provides operations to call the getLoggedOnManagedDevices method.
func (m *UserItemRequestBuilder) MicrosoftGraphGetLoggedOnManagedDevices()(*ItemMicrosoftGraphGetLoggedOnManagedDevicesRequestBuilder) {
    return NewItemMicrosoftGraphGetLoggedOnManagedDevicesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *UserItemRequestBuilder) MicrosoftGraphGetManagedDevicesWithFailedOrPendingApps()(*ItemMicrosoftGraphGetManagedDevicesWithFailedOrPendingAppsRequestBuilder) {
    return NewItemMicrosoftGraphGetManagedDevicesWithFailedOrPendingAppsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *UserItemRequestBuilder) MicrosoftGraphInvalidateAllRefreshTokens()(*ItemMicrosoftGraphInvalidateAllRefreshTokensRequestBuilder) {
    return NewItemMicrosoftGraphInvalidateAllRefreshTokensRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphIsManagedAppUserBlocked provides operations to call the isManagedAppUserBlocked method.
func (m *UserItemRequestBuilder) MicrosoftGraphIsManagedAppUserBlocked()(*ItemMicrosoftGraphIsManagedAppUserBlockedRequestBuilder) {
    return NewItemMicrosoftGraphIsManagedAppUserBlockedRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *UserItemRequestBuilder) MicrosoftGraphUnblockManagedApps()(*ItemMicrosoftGraphUnblockManagedAppsRequestBuilder) {
    return NewItemMicrosoftGraphUnblockManagedAppsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphWipeAndBlockManagedApps provides operations to call the wipeAndBlockManagedApps method.
func (m *UserItemRequestBuilder) MicrosoftGraphWipeAndBlockManagedApps()(*ItemMicrosoftGraphWipeAndBlockManagedAppsRequestBuilder) {
    return NewItemMicrosoftGraphWipeAndBlockManagedAppsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *UserItemRequestBuilder) MicrosoftGraphWipeManagedAppRegistrationByDeviceTag()(*ItemMicrosoftGraphWipeManagedAppRegistrationByDeviceTagRequestBuilder) {
    return NewItemMicrosoftGraphWipeManagedAppRegistrationByDeviceTagRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *UserItemRequestBuilder) MicrosoftGraphWipeManagedAppRegistrationsByAzureAdDeviceId()(*ItemMicrosoftGraphWipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder) {
    return NewItemMicrosoftGraphWipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
