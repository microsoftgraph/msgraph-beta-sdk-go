...
// NewItemInformationprotectionSensitivitylabelsCountRequestBuilderInternal instantiates a new ItemInformationprotectionSensitivitylabelsCountRequestBuilder and sets the default values.
func NewItemInformationprotectionSensitivitylabelsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInformationprotectionSensitivitylabelsCountRequestBuilder) {
    m := &ItemInformationprotectionSensitivitylabelsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/informationProtection/sensitivityLabels/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemInformationprotectionSensitivitylabelsCountRequestBuilder instantiates a new ItemInformationprotectionSensitivitylabelsCountRequestBuilder and sets the default values.
...
func (m *ItemInformationprotectionSensitivitylabelsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemInformationprotectionSensitivitylabelsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemInformationprotectionSensitivitylabelsCountRequestBuilder) WithUrl(rawUrl string)(*ItemInformationprotectionSensitivitylabelsCountRequestBuilder) {
    return NewItemInformationprotectionSensitivitylabelsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
