...
// ItemProfilePhonesRequestBuilderGetQueryParameters retrieve a list of itemPhone objects from a user's profile. This API is available in the following national cloud deployments.
...
func NewItemProfilePhonesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemProfilePhonesRequestBuilder) {
    m := &ItemProfilePhonesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/phones{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemProfilePhonesRequestBuilder instantiates a new PhonesRequestBuilder and sets the default values.
...
// Get retrieve a list of itemPhone objects from a user's profile. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Post use this API to create a new itemPhone object in a user's profile. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve a list of itemPhone objects from a user's profile. This API is available in the following national cloud deployments.
...
// ToPostRequestInformation use this API to create a new itemPhone object in a user's profile. This API is available in the following national cloud deployments.
