...
// ItemContactFoldersRequestBuilderGetQueryParameters get all the contact folders in the signed-in user's mailbox. This API is supported in the following national cloud deployments.
...
// Get get all the contact folders in the signed-in user's mailbox. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get all the contact folders in the signed-in user's mailbox. This API is supported in the following national cloud deployments.
