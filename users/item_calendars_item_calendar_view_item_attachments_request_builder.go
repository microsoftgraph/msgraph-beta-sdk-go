...
func (m *ItemCalendarsItemCalendarViewItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*ItemCalendarsItemCalendarViewItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilder) {
    return NewItemCalendarsItemCalendarViewItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
