...
// UsersItemDrivesItemRootRequestBuilderGetQueryParameters retrieve the metadata for a driveItem in a drive by file system path or ID.
...
func (m *UsersItemDrivesItemRootRequestBuilder) Activities()(*UsersItemDrivesItemRootActivitiesRequestBuilder) {
    return NewUsersItemDrivesItemRootActivitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ActivitiesById provides operations to manage the activities property of the microsoft.graph.driveItem entity.
func (m *UsersItemDrivesItemRootRequestBuilder) ActivitiesById(id string)(*UsersItemDrivesItemRootActivitiesItemActivityOLDItemRequestBuilder) {
    ...
    return NewUsersItemDrivesItemRootActivitiesItemActivityOLDItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *UsersItemDrivesItemRootRequestBuilder) AssignSensitivityLabel()(*UsersItemDrivesItemRootAssignSensitivityLabelRequestBuilder) {
    return NewUsersItemDrivesItemRootAssignSensitivityLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *UsersItemDrivesItemRootRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, requestConfiguration *UsersItemDrivesItemRootRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *UsersItemDrivesItemRootRequestBuilder) ExtractSensitivityLabels()(*UsersItemDrivesItemRootExtractSensitivityLabelsRequestBuilder) {
    return NewUsersItemDrivesItemRootExtractSensitivityLabelsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *UsersItemDrivesItemRootRequestBuilder) Get(ctx context.Context, requestConfiguration *UsersItemDrivesItemRootRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
