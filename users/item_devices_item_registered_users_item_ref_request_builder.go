...
// ItemDevicesItemRegisteredUsersItemRefRequestBuilderDeleteQueryParameters delete ref of navigation property registeredUsers for users
...
func (m *ItemDevicesItemRegisteredUsersItemRefRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemDevicesItemRegisteredUsersItemRefRequestBuilderDeleteRequestConfiguration)([]byte, error) {
