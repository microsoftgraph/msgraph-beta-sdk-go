...
func (m *ItemFindRoomsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemFindRoomsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemFindRoomsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemFindRoomsRequestBuilderGetRequestConfiguration)(ItemFindRoomsResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateItemFindRoomsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
