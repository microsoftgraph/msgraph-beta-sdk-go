...
func (m *ItemDeviceenrollmentconfigurationsDeviceEnrollmentConfigurationItemRequestBuilder) SetPriority()(*ItemDeviceenrollmentconfigurationsItemSetprioritySetPriorityRequestBuilder) {
    return NewItemDeviceenrollmentconfigurationsItemSetprioritySetPriorityRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
