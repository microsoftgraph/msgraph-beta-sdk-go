...
// NewItemPendingAccessReviewInstancesItemDecisionsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemPendingAccessReviewInstancesItemDecisionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPendingAccessReviewInstancesItemDecisionsCountRequestBuilder) {
    m := &ItemPendingAccessReviewInstancesItemDecisionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/decisions/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewItemPendingAccessReviewInstancesItemDecisionsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
