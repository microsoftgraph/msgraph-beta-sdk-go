...
// NewItemCloudPCsItemReprovisionRequestBuilderInternal instantiates a new ReprovisionRequestBuilder and sets the default values.
func NewItemCloudPCsItemReprovisionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCloudPCsItemReprovisionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}/reprovision";
...
// NewItemCloudPCsItemReprovisionRequestBuilder instantiates a new ReprovisionRequestBuilder and sets the default values.
