...
func (m *ItemDevicesItemTransitiveMemberOfGraphAdministrativeUnitCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDevicesItemTransitiveMemberOfGraphAdministrativeUnitCountRequestBuilderGetRequestConfiguration)(*int64, error) {
