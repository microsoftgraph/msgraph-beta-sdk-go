...
// ItemCloudPCsItemRenamePostRequestBody provides operations to call the rename method.
...
func (m *ItemCloudPCsItemRenamePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCloudPCsItemRenamePostRequestBody) SetAdditionalData(value map[string]interface{})() {
