...
func (m *ItemAuthenticationMethodsAuthenticationMethodItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemAuthenticationMethodsAuthenticationMethodItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AuthenticationMethodable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateAuthenticationMethodFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemAuthenticationMethodsAuthenticationMethodItemRequestBuilder) MicrosoftGraphDisableSmsSignIn()(*ItemAuthenticationMethodsItemMicrosoftGraphDisableSmsSignInDisableSmsSignInRequestBuilder) {
    return NewItemAuthenticationMethodsItemMicrosoftGraphDisableSmsSignInDisableSmsSignInRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEnableSmsSignIn provides operations to call the enableSmsSignIn method.
func (m *ItemAuthenticationMethodsAuthenticationMethodItemRequestBuilder) MicrosoftGraphEnableSmsSignIn()(*ItemAuthenticationMethodsItemMicrosoftGraphEnableSmsSignInEnableSmsSignInRequestBuilder) {
    return NewItemAuthenticationMethodsItemMicrosoftGraphEnableSmsSignInEnableSmsSignInRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
