...
// ItemEventsItemExceptionOccurrencesItemForwardRequestBuilder provides operations to call the forward method.
type ItemEventsItemExceptionOccurrencesItemForwardRequestBuilder struct {
...
// ItemEventsItemExceptionOccurrencesItemForwardRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemEventsItemExceptionOccurrencesItemForwardRequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func (m *ItemEventsItemExceptionOccurrencesItemForwardRequestBuilder) Post(ctx context.Context, body ItemEventsItemExceptionOccurrencesItemForwardPostRequestBodyable, requestConfiguration *ItemEventsItemExceptionOccurrencesItemForwardRequestBuilderPostRequestConfiguration)(error) {
