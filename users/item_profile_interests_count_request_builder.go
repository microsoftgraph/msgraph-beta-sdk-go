...
func (m *ItemProfileInterestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemProfileInterestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
