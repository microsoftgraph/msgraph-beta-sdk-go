...
// NewItemChatsItemMessagesItemUnsetReactionRequestBuilderInternal instantiates a new ItemChatsItemMessagesItemUnsetReactionRequestBuilder and sets the default values.
...
// NewItemChatsItemMessagesItemUnsetReactionRequestBuilder instantiates a new ItemChatsItemMessagesItemUnsetReactionRequestBuilder and sets the default values.
...
func (m *ItemChatsItemMessagesItemUnsetReactionRequestBuilder) WithUrl(rawUrl string)(*ItemChatsItemMessagesItemUnsetReactionRequestBuilder) {
    return NewItemChatsItemMessagesItemUnsetReactionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
