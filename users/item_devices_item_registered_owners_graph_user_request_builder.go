...
// NewItemDevicesItemRegisteredOwnersGraphUserRequestBuilderInternal instantiates a new ItemDevicesItemRegisteredOwnersGraphUserRequestBuilder and sets the default values.
func NewItemDevicesItemRegisteredOwnersGraphUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDevicesItemRegisteredOwnersGraphUserRequestBuilder) {
    m := &ItemDevicesItemRegisteredOwnersGraphUserRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/graph.user{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemDevicesItemRegisteredOwnersGraphUserRequestBuilder instantiates a new ItemDevicesItemRegisteredOwnersGraphUserRequestBuilder and sets the default values.
