...
func (m *ItemOnlineMeetingsItemRegistrationRegistrantsRequestBuilder) ByMeetingRegistrantBaseIdString(meetingRegistrantBaseId string)(*ItemOnlineMeetingsItemRegistrationRegistrantsMeetingRegistrantBaseItemRequestBuilder) {
...
// NewItemOnlineMeetingsItemRegistrationRegistrantsRequestBuilderInternal instantiates a new RegistrantsRequestBuilder and sets the default values.
func NewItemOnlineMeetingsItemRegistrationRegistrantsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnlineMeetingsItemRegistrationRegistrantsRequestBuilder) {
    m := &ItemOnlineMeetingsItemRegistrationRegistrantsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/registration/registrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemOnlineMeetingsItemRegistrationRegistrantsRequestBuilder instantiates a new RegistrantsRequestBuilder and sets the default values.
