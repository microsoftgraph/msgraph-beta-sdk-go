...
func (m *ItemCalendarsItemCalendarViewItemInstancesRequestBuilder) ByEventId1(eventId1 string)(*ItemCalendarsItemCalendarViewItemInstancesEventItemRequestBuilder) {
    ...
    return NewItemCalendarsItemCalendarViewItemInstancesEventItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
// NewItemCalendarsItemCalendarViewItemInstancesRequestBuilderInternal instantiates a new ItemCalendarsItemCalendarViewItemInstancesRequestBuilder and sets the default values.
...
// NewItemCalendarsItemCalendarViewItemInstancesRequestBuilder instantiates a new ItemCalendarsItemCalendarViewItemInstancesRequestBuilder and sets the default values.
...
// returns a *ItemCalendarsItemCalendarViewItemInstancesCountRequestBuilder when successful
func (m *ItemCalendarsItemCalendarViewItemInstancesRequestBuilder) Count()(*ItemCalendarsItemCalendarViewItemInstancesCountRequestBuilder) {
    return NewItemCalendarsItemCalendarViewItemInstancesCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemCalendarsItemCalendarViewItemInstancesRequestBuilder) Delta()(*ItemCalendarsItemCalendarViewItemInstancesDeltaRequestBuilder) {
    return NewItemCalendarsItemCalendarViewItemInstancesDeltaRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemCalendarsItemCalendarViewItemInstancesRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarsItemCalendarViewItemInstancesRequestBuilder) {
    return NewItemCalendarsItemCalendarViewItemInstancesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
