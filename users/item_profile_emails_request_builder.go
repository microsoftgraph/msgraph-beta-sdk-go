...
func (m *ItemProfileEmailsRequestBuilder) Count()(*ItemProfileEmailsCountRequestBuilder) {
    return NewItemProfileEmailsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation retrieve a list of itemEmail objects from a user's profile.
func (m *ItemProfileEmailsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemProfileEmailsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
