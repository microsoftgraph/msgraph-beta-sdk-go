...
// ItemAuthenticationPlatformCredentialMethodsItemDeviceRequestBuilderGetQueryParameters get device from users
...
// NewItemAuthenticationPlatformCredentialMethodsItemDeviceRequestBuilderInternal instantiates a new DeviceRequestBuilder and sets the default values.
func NewItemAuthenticationPlatformCredentialMethodsItemDeviceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAuthenticationPlatformCredentialMethodsItemDeviceRequestBuilder) {
    m := &ItemAuthenticationPlatformCredentialMethodsItemDeviceRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/authentication/platformCredentialMethods/{platformCredentialAuthenticationMethod%2Did}/device{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemAuthenticationPlatformCredentialMethodsItemDeviceRequestBuilder instantiates a new DeviceRequestBuilder and sets the default values.
