...
func (m *ItemOutlookTaskFoldersItemTasksItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*ItemOutlookTaskFoldersItemTasksItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilder) {
    return NewItemOutlookTaskFoldersItemTasksItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
