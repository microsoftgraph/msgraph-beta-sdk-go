...
// ItemEventsItemDeclinePostRequestBody provides operations to call the decline method.
...
func (m *ItemEventsItemDeclinePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemEventsItemDeclinePostRequestBody) SetAdditionalData(value map[string]interface{})() {
