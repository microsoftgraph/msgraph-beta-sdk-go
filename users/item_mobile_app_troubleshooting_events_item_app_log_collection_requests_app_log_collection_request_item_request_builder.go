...
func (m *ItemMobileAppTroubleshootingEventsItemAppLogCollectionRequestsAppLogCollectionRequestItemRequestBuilder) MicrosoftGraphCreateDownloadUrl()(*ItemMobileAppTroubleshootingEventsItemAppLogCollectionRequestsItemMicrosoftGraphCreateDownloadUrlRequestBuilder) {
    return NewItemMobileAppTroubleshootingEventsItemAppLogCollectionRequestsItemMicrosoftGraphCreateDownloadUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
