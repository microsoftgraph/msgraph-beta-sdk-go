...
// NewItemDeviceEnrollmentConfigurationsItemAssignmentsRequestBuilderInternal instantiates a new AssignmentsRequestBuilder and sets the default values.
...
// NewItemDeviceEnrollmentConfigurationsItemAssignmentsRequestBuilder instantiates a new AssignmentsRequestBuilder and sets the default values.
...
func (m *ItemDeviceEnrollmentConfigurationsItemAssignmentsRequestBuilder) Count()(*ItemDeviceEnrollmentConfigurationsItemAssignmentsCountRequestBuilder) {
    return NewItemDeviceEnrollmentConfigurationsItemAssignmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the list of group assignments for the device configuration profile
func (m *ItemDeviceEnrollmentConfigurationsItemAssignmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemDeviceEnrollmentConfigurationsItemAssignmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
