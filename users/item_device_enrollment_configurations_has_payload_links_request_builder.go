...
// NewItemDeviceEnrollmentConfigurationsHasPayloadLinksRequestBuilderInternal instantiates a new ItemDeviceEnrollmentConfigurationsHasPayloadLinksRequestBuilder and sets the default values.
...
// NewItemDeviceEnrollmentConfigurationsHasPayloadLinksRequestBuilder instantiates a new ItemDeviceEnrollmentConfigurationsHasPayloadLinksRequestBuilder and sets the default values.
...
// returns a ItemDeviceEnrollmentConfigurationsHasPayloadLinksResponseable when successful
...
// returns a ItemDeviceEnrollmentConfigurationsHasPayloadLinksPostResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
