...
func (m *ItemPendingAccessReviewInstancesItemDecisionsItemInstanceRequestBuilder) MicrosoftGraphAcceptRecommendations()(*ItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphAcceptRecommendationsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphAcceptRecommendationsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyDecisions provides operations to call the applyDecisions method.
func (m *ItemPendingAccessReviewInstancesItemDecisionsItemInstanceRequestBuilder) MicrosoftGraphApplyDecisions()(*ItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphApplyDecisionsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphApplyDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBatchRecordDecisions provides operations to call the batchRecordDecisions method.
func (m *ItemPendingAccessReviewInstancesItemDecisionsItemInstanceRequestBuilder) MicrosoftGraphBatchRecordDecisions()(*ItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphBatchRecordDecisionsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphBatchRecordDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphResetDecisions provides operations to call the resetDecisions method.
func (m *ItemPendingAccessReviewInstancesItemDecisionsItemInstanceRequestBuilder) MicrosoftGraphResetDecisions()(*ItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphResetDecisionsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphResetDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSendReminder provides operations to call the sendReminder method.
func (m *ItemPendingAccessReviewInstancesItemDecisionsItemInstanceRequestBuilder) MicrosoftGraphSendReminder()(*ItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphSendReminderRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphSendReminderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphStop provides operations to call the stop method.
func (m *ItemPendingAccessReviewInstancesItemDecisionsItemInstanceRequestBuilder) MicrosoftGraphStop()(*ItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphStopRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemDecisionsItemInstanceMicrosoftGraphStopRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
