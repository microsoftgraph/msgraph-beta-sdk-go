...
func (m *ItemDirectReportsGraphUserCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDirectReportsGraphUserCountRequestBuilderGetRequestConfiguration)(*int64, error) {
