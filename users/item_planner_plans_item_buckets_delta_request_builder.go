...
// ItemPlannerPlansItemBucketsDeltaRequestBuilder provides operations to call the delta method.
type ItemPlannerPlansItemBucketsDeltaRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemPlannerPlansItemBucketsDeltaRequestBuilderGetQueryParameters get newly created, updated, or deleted buckets in a Planner plan without having to perform a full read of the entire resource collection. For details, see Use delta query to track changes in Microsoft Graph data.
type ItemPlannerPlansItemBucketsDeltaRequestBuilderGetQueryParameters struct {
...
type ItemPlannerPlansItemBucketsDeltaRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemPlannerPlansItemBucketsDeltaRequestBuilderGetQueryParameters
}
// NewItemPlannerPlansItemBucketsDeltaRequestBuilderInternal instantiates a new ItemPlannerPlansItemBucketsDeltaRequestBuilder and sets the default values.
func NewItemPlannerPlansItemBucketsDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPlannerPlansItemBucketsDeltaRequestBuilder) {
    m := &ItemPlannerPlansItemBucketsDeltaRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/buckets/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemPlannerPlansItemBucketsDeltaRequestBuilder instantiates a new ItemPlannerPlansItemBucketsDeltaRequestBuilder and sets the default values.
func NewItemPlannerPlansItemBucketsDeltaRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPlannerPlansItemBucketsDeltaRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemPlannerPlansItemBucketsDeltaRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemPlannerPlansItemBucketsDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemPlannerPlansItemBucketsDeltaRequestBuilderGetRequestConfiguration)(ItemPlannerPlansItemBucketsDeltaResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateItemPlannerPlansItemBucketsDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemPlannerPlansItemBucketsDeltaRequestBuilder) GetAsDeltaGetResponse(ctx context.Context, requestConfiguration *ItemPlannerPlansItemBucketsDeltaRequestBuilderGetRequestConfiguration)(ItemPlannerPlansItemBucketsDeltaGetResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateItemPlannerPlansItemBucketsDeltaGetResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
