...
func (m *ItemJoinedGroupsRequestBuilder) MicrosoftGraphDelta()(*ItemJoinedGroupsMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemJoinedGroupsMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateDynamicMembership provides operations to call the evaluateDynamicMembership method.
func (m *ItemJoinedGroupsRequestBuilder) MicrosoftGraphEvaluateDynamicMembership()(*ItemJoinedGroupsMicrosoftGraphEvaluateDynamicMembershipEvaluateDynamicMembershipRequestBuilder) {
    return NewItemJoinedGroupsMicrosoftGraphEvaluateDynamicMembershipEvaluateDynamicMembershipRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetByIds provides operations to call the getByIds method.
func (m *ItemJoinedGroupsRequestBuilder) MicrosoftGraphGetByIds()(*ItemJoinedGroupsMicrosoftGraphGetByIdsGetByIdsRequestBuilder) {
    return NewItemJoinedGroupsMicrosoftGraphGetByIdsGetByIdsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetUserOwnedObjects provides operations to call the getUserOwnedObjects method.
func (m *ItemJoinedGroupsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*ItemJoinedGroupsMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilder) {
    return NewItemJoinedGroupsMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphValidateProperties provides operations to call the validateProperties method.
func (m *ItemJoinedGroupsRequestBuilder) MicrosoftGraphValidateProperties()(*ItemJoinedGroupsMicrosoftGraphValidatePropertiesValidatePropertiesRequestBuilder) {
    return NewItemJoinedGroupsMicrosoftGraphValidatePropertiesValidatePropertiesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
