...
// ItemOwnedObjectsMicrosoftGraphApplicationRequestBuilder casts the previous resource to application.
...
// ItemOwnedObjectsMicrosoftGraphApplicationRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemOwnedObjectsMicrosoftGraphApplicationRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemOwnedObjectsMicrosoftGraphApplicationRequestBuilderGetQueryParameters
}
...
func (m *ItemOwnedObjectsMicrosoftGraphApplicationRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedObjectsMicrosoftGraphApplicationRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ApplicationCollectionResponseable, error) {
...
func (m *ItemOwnedObjectsMicrosoftGraphApplicationRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemOwnedObjectsMicrosoftGraphApplicationRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
