...
// ItemIsManagedAppUserBlockedResponse provides operations to call the isManagedAppUserBlocked method.
...
func (m *ItemIsManagedAppUserBlockedResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemIsManagedAppUserBlockedResponse) SetAdditionalData(value map[string]interface{})() {
