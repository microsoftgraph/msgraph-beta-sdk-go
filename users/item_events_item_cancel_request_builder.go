...
// NewItemEventsItemCancelRequestBuilderInternal instantiates a new ItemEventsItemCancelRequestBuilder and sets the default values.
func NewItemEventsItemCancelRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemEventsItemCancelRequestBuilder) {
    m := &ItemEventsItemCancelRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}/cancel", pathParameters),
    }
    return m
}
// NewItemEventsItemCancelRequestBuilder instantiates a new ItemEventsItemCancelRequestBuilder and sets the default values.
...
func (m *ItemEventsItemCancelRequestBuilder) WithUrl(rawUrl string)(*ItemEventsItemCancelRequestBuilder) {
    return NewItemEventsItemCancelRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
