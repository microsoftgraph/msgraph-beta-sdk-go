...
// NewItemInformationProtectionDecryptBufferRequestBuilderInternal instantiates a new ItemInformationProtectionDecryptBufferRequestBuilder and sets the default values.
func NewItemInformationProtectionDecryptBufferRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInformationProtectionDecryptBufferRequestBuilder) {
    m := &ItemInformationProtectionDecryptBufferRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/informationProtection/decryptBuffer", pathParameters),
    }
    return m
}
// NewItemInformationProtectionDecryptBufferRequestBuilder instantiates a new ItemInformationProtectionDecryptBufferRequestBuilder and sets the default values.
