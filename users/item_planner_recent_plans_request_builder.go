...
// ItemPlannerRecentPlansRequestBuilderGetQueryParameters read-only. Nullable. Returns the plannerPlans that have been recently viewed by the user in apps that support recent plans.
...
// NewItemPlannerRecentPlansRequestBuilderInternal instantiates a new ItemPlannerRecentPlansRequestBuilder and sets the default values.
...
// NewItemPlannerRecentPlansRequestBuilder instantiates a new ItemPlannerRecentPlansRequestBuilder and sets the default values.
