...
// ItemTransitiveReportsRequestBuilderGetQueryParameters get the transitive reports for an agentUser.
...
// Get get the transitive reports for an agentUser.
...
// ToGetRequestInformation get the transitive reports for an agentUser.
