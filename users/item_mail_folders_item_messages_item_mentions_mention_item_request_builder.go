...
func (m *ItemMailFoldersItemMessagesItemMentionsMentionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemMailFoldersItemMessagesItemMentionsMentionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
