...
func (m *ItemManagedDevicesItemLogCollectionRequestsDeviceLogCollectionResponseItemRequestBuilder) MicrosoftGraphCreateDownloadUrl()(*ItemManagedDevicesItemLogCollectionRequestsItemMicrosoftGraphCreateDownloadUrlRequestBuilder) {
    return NewItemManagedDevicesItemLogCollectionRequestsItemMicrosoftGraphCreateDownloadUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
