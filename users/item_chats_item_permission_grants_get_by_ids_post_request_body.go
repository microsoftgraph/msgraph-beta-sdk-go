...
// ItemChatsItemPermissionGrantsGetByIdsPostRequestBody provides operations to call the getByIds method.
...
func (m *ItemChatsItemPermissionGrantsGetByIdsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemChatsItemPermissionGrantsGetByIdsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
