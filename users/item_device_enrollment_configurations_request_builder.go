...
func (m *ItemDeviceEnrollmentConfigurationsRequestBuilder) Count()(*ItemDeviceEnrollmentConfigurationsCountRequestBuilder) {
    return NewItemDeviceEnrollmentConfigurationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemDeviceEnrollmentConfigurationsRequestBuilder) MicrosoftGraphCreateEnrollmentNotificationConfiguration()(*ItemDeviceEnrollmentConfigurationsMicrosoftGraphCreateEnrollmentNotificationConfigurationCreateEnrollmentNotificationConfigurationRequestBuilder) {
    return NewItemDeviceEnrollmentConfigurationsMicrosoftGraphCreateEnrollmentNotificationConfigurationCreateEnrollmentNotificationConfigurationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphHasPayloadLinks provides operations to call the hasPayloadLinks method.
func (m *ItemDeviceEnrollmentConfigurationsRequestBuilder) MicrosoftGraphHasPayloadLinks()(*ItemDeviceEnrollmentConfigurationsMicrosoftGraphHasPayloadLinksHasPayloadLinksRequestBuilder) {
    return NewItemDeviceEnrollmentConfigurationsMicrosoftGraphHasPayloadLinksHasPayloadLinksRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
