...
// ItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilder provides operations to manage the deviceTemplate property of the microsoft.graph.device entity.
...
// ItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilderGetQueryParameters
}
// NewItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilderInternal instantiates a new ItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilder and sets the default values.
func NewItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilder) {
    m := &ItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/deviceTemplate/{deviceTemplate%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilder instantiates a new ItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilder and sets the default values.
...
func (m *ItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilder) WithUrl(rawUrl string)(*ItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilder) {
    return NewItemDevicesItemDeviceTemplateDeviceTemplateItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
