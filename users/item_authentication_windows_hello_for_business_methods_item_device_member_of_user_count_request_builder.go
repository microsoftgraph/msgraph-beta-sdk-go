...
// ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfUserCountRequestBuilderGetQueryParameters get the number of the resource
type ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfUserCountRequestBuilderGetQueryParameters struct {
...
type ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfUserCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfUserCountRequestBuilderGetQueryParameters
}
...
func NewItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfUserCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfUserCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.user/$count{?%24search,%24filter}";
