...
// returns a *ItemCalendargroupsItemCalendarsItemEventsItemInstancesItemExceptionoccurrencesItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilder when successful
func (m *ItemCalendargroupsItemCalendarsItemEventsItemInstancesItemExceptionoccurrencesItemAttachmentsRequestBuilder) CreateUploadSession()(*ItemCalendargroupsItemCalendarsItemEventsItemInstancesItemExceptionoccurrencesItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilder) {
    return NewItemCalendargroupsItemCalendarsItemEventsItemInstancesItemExceptionoccurrencesItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
