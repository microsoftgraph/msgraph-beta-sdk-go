...
func (m *ItemMailFoldersItemChildFoldersItemMessagesMessageItemRequestBuilder) MicrosoftGraphUnsubscribe()(*ItemMailFoldersItemChildFoldersItemMessagesItemMicrosoftGraphUnsubscribeRequestBuilder) {
    return NewItemMailFoldersItemChildFoldersItemMessagesItemMicrosoftGraphUnsubscribeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
