...
func (m *ItemPendingAccessReviewInstancesItemDecisionsRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*ItemPendingAccessReviewInstancesItemDecisionsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemDecisionsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
// MicrosoftGraphRecordAllDecisions provides operations to call the recordAllDecisions method.
func (m *ItemPendingAccessReviewInstancesItemDecisionsRequestBuilder) MicrosoftGraphRecordAllDecisions()(*ItemPendingAccessReviewInstancesItemDecisionsMicrosoftGraphRecordAllDecisionsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemDecisionsMicrosoftGraphRecordAllDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
