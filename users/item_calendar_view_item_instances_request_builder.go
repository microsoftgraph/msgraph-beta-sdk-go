...
func (m *ItemCalendarViewItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarViewItemInstancesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemCalendarViewItemInstancesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
