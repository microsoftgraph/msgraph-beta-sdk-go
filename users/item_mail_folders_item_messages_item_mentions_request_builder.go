...
// NewItemMailFoldersItemMessagesItemMentionsRequestBuilder instantiates a new MentionsRequestBuilder and sets the default values.
...
func (m *ItemMailFoldersItemMessagesItemMentionsRequestBuilder) Count()(*ItemMailFoldersItemMessagesItemMentionsCountRequestBuilder) {
    return NewItemMailFoldersItemMessagesItemMentionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemMailFoldersItemMessagesItemMentionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemMailFoldersItemMessagesItemMentionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
