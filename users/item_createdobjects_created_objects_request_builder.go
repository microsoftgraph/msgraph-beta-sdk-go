...
// ItemCreatedobjectsCreatedObjectsRequestBuilder provides operations to manage the createdObjects property of the microsoft.graph.user entity.
type ItemCreatedobjectsCreatedObjectsRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemCreatedobjectsCreatedObjectsRequestBuilderGetQueryParameters directory objects that the user created. Read-only. Nullable.
