...
func (m *ItemManagedDevicesRequestBuilder) MicrosoftGraphAppDiagnosticsWithUpn(upn *string)(*ItemManagedDevicesMicrosoftGraphAppDiagnosticsWithUpnAppDiagnosticsWithUpnRequestBuilder) {
    return NewItemManagedDevicesMicrosoftGraphAppDiagnosticsWithUpnAppDiagnosticsWithUpnRequestBuilderInternal(m.pathParameters, m.requestAdapter, upn)
}
// MicrosoftGraphBulkReprovisionCloudPc provides operations to call the bulkReprovisionCloudPc method.
func (m *ItemManagedDevicesRequestBuilder) MicrosoftGraphBulkReprovisionCloudPc()(*ItemManagedDevicesMicrosoftGraphBulkReprovisionCloudPcBulkReprovisionCloudPcRequestBuilder) {
    return NewItemManagedDevicesMicrosoftGraphBulkReprovisionCloudPcBulkReprovisionCloudPcRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBulkRestoreCloudPc provides operations to call the bulkRestoreCloudPc method.
func (m *ItemManagedDevicesRequestBuilder) MicrosoftGraphBulkRestoreCloudPc()(*ItemManagedDevicesMicrosoftGraphBulkRestoreCloudPcBulkRestoreCloudPcRequestBuilder) {
    return NewItemManagedDevicesMicrosoftGraphBulkRestoreCloudPcBulkRestoreCloudPcRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBulkSetCloudPcReviewStatus provides operations to call the bulkSetCloudPcReviewStatus method.
func (m *ItemManagedDevicesRequestBuilder) MicrosoftGraphBulkSetCloudPcReviewStatus()(*ItemManagedDevicesMicrosoftGraphBulkSetCloudPcReviewStatusBulkSetCloudPcReviewStatusRequestBuilder) {
    return NewItemManagedDevicesMicrosoftGraphBulkSetCloudPcReviewStatusBulkSetCloudPcReviewStatusRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDownloadAppDiagnostics provides operations to call the downloadAppDiagnostics method.
func (m *ItemManagedDevicesRequestBuilder) MicrosoftGraphDownloadAppDiagnostics()(*ItemManagedDevicesMicrosoftGraphDownloadAppDiagnosticsDownloadAppDiagnosticsRequestBuilder) {
    return NewItemManagedDevicesMicrosoftGraphDownloadAppDiagnosticsDownloadAppDiagnosticsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphExecuteAction provides operations to call the executeAction method.
func (m *ItemManagedDevicesRequestBuilder) MicrosoftGraphExecuteAction()(*ItemManagedDevicesMicrosoftGraphExecuteActionExecuteActionRequestBuilder) {
    return NewItemManagedDevicesMicrosoftGraphExecuteActionExecuteActionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphMoveDevicesToOU provides operations to call the moveDevicesToOU method.
func (m *ItemManagedDevicesRequestBuilder) MicrosoftGraphMoveDevicesToOU()(*ItemManagedDevicesMicrosoftGraphMoveDevicesToOUMoveDevicesToOURequestBuilder) {
    return NewItemManagedDevicesMicrosoftGraphMoveDevicesToOUMoveDevicesToOURequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
