...
func (m *ItemCalendargroupsItemCalendarsItemCalendarviewItemAttachmentsRequestBuilder) CreateUploadSession()(*ItemCalendargroupsItemCalendarsItemCalendarviewItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilder) {
    return NewItemCalendargroupsItemCalendarsItemCalendarviewItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
