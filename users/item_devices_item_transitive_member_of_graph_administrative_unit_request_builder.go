...
// NewItemDevicesItemTransitiveMemberOfGraphAdministrativeUnitRequestBuilderInternal instantiates a new GraphAdministrativeUnitRequestBuilder and sets the default values.
func NewItemDevicesItemTransitiveMemberOfGraphAdministrativeUnitRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDevicesItemTransitiveMemberOfGraphAdministrativeUnitRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/transitiveMemberOf/graph.administrativeUnit{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemDevicesItemTransitiveMemberOfGraphAdministrativeUnitRequestBuilder instantiates a new GraphAdministrativeUnitRequestBuilder and sets the default values.
...
func (m *ItemDevicesItemTransitiveMemberOfGraphAdministrativeUnitRequestBuilder) Count()(*ItemDevicesItemTransitiveMemberOfGraphAdministrativeUnitCountRequestBuilder) {
    return NewItemDevicesItemTransitiveMemberOfGraphAdministrativeUnitCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
