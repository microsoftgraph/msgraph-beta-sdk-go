...
func (m *ItemCalendarEventsItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarEventsItemInstancesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemCalendarEventsItemInstancesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
