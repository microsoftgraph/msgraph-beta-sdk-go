...
func (m *ItemEventsRequestBuilder) MicrosoftGraphDelta()(*ItemEventsMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemEventsMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
