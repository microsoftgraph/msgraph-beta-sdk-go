...
func (m *UsersItemCalendarEventsEventItemRequestBuilder) ExceptionOccurrences()(*UsersItemCalendarEventsItemExceptionOccurrencesRequestBuilder) {
    return NewUsersItemCalendarEventsItemExceptionOccurrencesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *UsersItemCalendarEventsEventItemRequestBuilder) ExceptionOccurrencesById(id string)(*UsersItemCalendarEventsItemExceptionOccurrencesEventItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewUsersItemCalendarEventsItemExceptionOccurrencesEventItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *UsersItemCalendarEventsEventItemRequestBuilder) Get(ctx context.Context, requestConfiguration *UsersItemCalendarEventsEventItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Eventable, error) {
...
func (m *UsersItemCalendarEventsEventItemRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Eventable, requestConfiguration *UsersItemCalendarEventsEventItemRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Eventable, error) {
