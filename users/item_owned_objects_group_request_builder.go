...
func NewItemOwnedObjectsGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedObjectsGroupRequestBuilder) {
    m := &ItemOwnedObjectsGroupRequestBuilder{
    }
...
func NewItemOwnedObjectsGroupRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedObjectsGroupRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemOwnedObjectsGroupRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ItemOwnedObjectsGroupRequestBuilder) Count()(*ItemOwnedObjectsGroupCountRequestBuilder) {
    return NewItemOwnedObjectsGroupCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemOwnedObjectsGroupRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemOwnedObjectsGroupRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemOwnedObjectsGroupRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedObjectsGroupRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GroupCollectionResponseable, error) {
