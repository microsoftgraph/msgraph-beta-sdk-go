...
// ByItemPatentIdString provides operations to manage the patents property of the microsoft.graph.profile entity.
func (m *ItemProfilePatentsRequestBuilder) ByItemPatentIdString(itemPatentId string)(*ItemProfilePatentsItemPatentItemRequestBuilder) {
