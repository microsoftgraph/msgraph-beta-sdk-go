...
// NewItemSettingsContactMergeSuggestionsRequestBuilderInternal instantiates a new ContactMergeSuggestionsRequestBuilder and sets the default values.
...
// NewItemSettingsContactMergeSuggestionsRequestBuilder instantiates a new ContactMergeSuggestionsRequestBuilder and sets the default values.
...
func (m *ItemSettingsContactMergeSuggestionsRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemSettingsContactMergeSuggestionsRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemSettingsContactMergeSuggestionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemSettingsContactMergeSuggestionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
