...
// ItemManagedDevicesItemResizeCloudPcPostRequestBody provides operations to call the resizeCloudPc method.
...
func (m *ItemManagedDevicesItemResizeCloudPcPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemManagedDevicesItemResizeCloudPcPostRequestBody) SetAdditionalData(value map[string]interface{})() {
