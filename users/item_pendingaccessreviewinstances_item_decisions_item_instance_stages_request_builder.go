...
// ItemPendingaccessreviewinstancesItemDecisionsItemInstanceStagesRequestBuilderGetQueryParameters if the instance has multiple stages, this returns the collection of stages. A new stage will only be created when the previous stage ends. The existence, number, and settings of stages on a review instance are created based on the accessReviewStageSettings on the parent accessReviewScheduleDefinition.
...
func (m *ItemPendingaccessreviewinstancesItemDecisionsItemInstanceStagesRequestBuilder) FilterByCurrentUserWithOn(on *string)(*ItemPendingaccessreviewinstancesItemDecisionsItemInstanceStagesFilterbycurrentuserwithonFilterByCurrentUserWithOnRequestBuilder) {
    return NewItemPendingaccessreviewinstancesItemDecisionsItemInstanceStagesFilterbycurrentuserwithonFilterByCurrentUserWithOnRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, on)
}
