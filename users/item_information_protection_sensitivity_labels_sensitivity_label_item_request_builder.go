...
func NewItemInformationProtectionSensitivityLabelsSensitivityLabelItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInformationProtectionSensitivityLabelsSensitivityLabelItemRequestBuilder) {
    m := &ItemInformationProtectionSensitivityLabelsSensitivityLabelItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}", pathParameters),
    }
    return m
}
...
// returns a *ItemInformationProtectionSensitivityLabelsItemRightsRequestBuilder when successful
func (m *ItemInformationProtectionSensitivityLabelsSensitivityLabelItemRequestBuilder) Rights()(*ItemInformationProtectionSensitivityLabelsItemRightsRequestBuilder) {
    return NewItemInformationProtectionSensitivityLabelsItemRightsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
