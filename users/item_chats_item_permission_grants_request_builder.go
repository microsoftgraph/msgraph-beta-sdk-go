...
func NewItemChatsItemPermissionGrantsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemChatsItemPermissionGrantsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemChatsItemPermissionGrantsRequestBuilder) MicrosoftGraphGetByIds()(*ItemChatsItemPermissionGrantsMicrosoftGraphGetByIdsGetByIdsRequestBuilder) {
    return NewItemChatsItemPermissionGrantsMicrosoftGraphGetByIdsGetByIdsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetUserOwnedObjects provides operations to call the getUserOwnedObjects method.
func (m *ItemChatsItemPermissionGrantsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*ItemChatsItemPermissionGrantsMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilder) {
    return NewItemChatsItemPermissionGrantsMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphValidateProperties provides operations to call the validateProperties method.
func (m *ItemChatsItemPermissionGrantsRequestBuilder) MicrosoftGraphValidateProperties()(*ItemChatsItemPermissionGrantsMicrosoftGraphValidatePropertiesValidatePropertiesRequestBuilder) {
    return NewItemChatsItemPermissionGrantsMicrosoftGraphValidatePropertiesValidatePropertiesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
