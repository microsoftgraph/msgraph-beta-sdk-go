...
func (m *ItemOnlineMeetingsItemSendVirtualAppointmentReminderSmsPostRequestBody) GetPhoneNumbers()([]string) {
...
func (m *ItemOnlineMeetingsItemSendVirtualAppointmentReminderSmsPostRequestBody) SetPhoneNumbers(value []string)() {
