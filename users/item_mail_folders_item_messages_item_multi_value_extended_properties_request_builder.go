...
// ByMultiValueLegacyExtendedPropertyId provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.message entity.
func (m *ItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesRequestBuilder) ByMultiValueLegacyExtendedPropertyId(multiValueLegacyExtendedPropertyId string)(*ItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesMultiValueLegacyExtendedPropertyItemRequestBuilder) {
...
func (m *ItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesRequestBuilder) Count()(*ItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesCountRequestBuilder) {
    return NewItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// Get the collection of multi-value extended properties defined for the message. Nullable.
func (m *ItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMailFoldersItemMessagesItemMultiValueExtendedPropertiesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MultiValueLegacyExtendedPropertyCollectionResponseable, error) {
