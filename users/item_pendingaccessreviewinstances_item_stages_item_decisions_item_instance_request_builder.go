...
// ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilderGetQueryParameters there's exactly one accessReviewInstance associated with each decision. The instance is the parent of the decision item, representing the recurrence of the access review the decision is made on.
...
// returns a *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceAcceptrecommendationsAcceptRecommendationsRequestBuilder when successful
func (m *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder) AcceptRecommendations()(*ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceAcceptrecommendationsAcceptRecommendationsRequestBuilder) {
    return NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceAcceptrecommendationsAcceptRecommendationsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// ApplyDecisions provides operations to call the applyDecisions method.
// returns a *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceApplydecisionsApplyDecisionsRequestBuilder when successful
func (m *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder) ApplyDecisions()(*ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceApplydecisionsApplyDecisionsRequestBuilder) {
    return NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceApplydecisionsApplyDecisionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// BatchRecordDecisions provides operations to call the batchRecordDecisions method.
// returns a *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceBatchrecorddecisionsBatchRecordDecisionsRequestBuilder when successful
func (m *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder) BatchRecordDecisions()(*ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceBatchrecorddecisionsBatchRecordDecisionsRequestBuilder) {
    return NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceBatchrecorddecisionsBatchRecordDecisionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilderInternal instantiates a new ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder and sets the default values.
...
// NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder instantiates a new ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder and sets the default values.
...
// returns a *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceContactedreviewersContactedReviewersRequestBuilder when successful
func (m *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder) ContactedReviewers()(*ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceContactedreviewersContactedReviewersRequestBuilder) {
    return NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceContactedreviewersContactedReviewersRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// Decisions provides operations to manage the decisions property of the microsoft.graph.accessReviewInstance entity.
// returns a *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceDecisionsRequestBuilder when successful
...
// returns a *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceDefinitionRequestBuilder when successful
func (m *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder) Definition()(*ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceDefinitionRequestBuilder) {
    return NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceDefinitionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceResetdecisionsResetDecisionsRequestBuilder when successful
func (m *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder) ResetDecisions()(*ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceResetdecisionsResetDecisionsRequestBuilder) {
    return NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceResetdecisionsResetDecisionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// SendReminder provides operations to call the sendReminder method.
// returns a *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceSendreminderSendReminderRequestBuilder when successful
func (m *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder) SendReminder()(*ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceSendreminderSendReminderRequestBuilder) {
    return NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceSendreminderSendReminderRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// Stop provides operations to call the stop method.
// returns a *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceStopRequestBuilder when successful
func (m *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder) Stop()(*ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceStopRequestBuilder) {
    return NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceStopRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder) StopApplyDecisions()(*ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceStopapplydecisionsStopApplyDecisionsRequestBuilder) {
    return NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceStopapplydecisionsStopApplyDecisionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder) WithUrl(rawUrl string)(*ItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder) {
    return NewItemPendingaccessreviewinstancesItemStagesItemDecisionsItemInstanceRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
