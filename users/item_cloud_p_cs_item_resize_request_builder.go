...
// NewItemCloudPCsItemResizeRequestBuilderInternal instantiates a new ResizeRequestBuilder and sets the default values.
...
// NewItemCloudPCsItemResizeRequestBuilder instantiates a new ResizeRequestBuilder and sets the default values.
