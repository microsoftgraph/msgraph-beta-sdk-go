...
func (m *ItemTodoListsItemTasksItemAttachmentsCreateuploadsessionCreateUploadSessionPostRequestBody) GetAttachmentInfo()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AttachmentInfoable) {
    val, err := m.GetBackingStore().Get("attachmentInfo")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AttachmentInfoable)
    }
    return nil
}
...
func (m *ItemTodoListsItemTasksItemAttachmentsCreateuploadsessionCreateUploadSessionPostRequestBody) SetAttachmentInfo(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AttachmentInfoable)() {
