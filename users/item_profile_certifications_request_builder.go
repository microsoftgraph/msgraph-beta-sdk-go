...
// NewItemProfileCertificationsRequestBuilderInternal instantiates a new CertificationsRequestBuilder and sets the default values.
func NewItemProfileCertificationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemProfileCertificationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/profile/certifications{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemProfileCertificationsRequestBuilder instantiates a new CertificationsRequestBuilder and sets the default values.
...
func (m *ItemProfileCertificationsRequestBuilder) Count()(*ItemProfileCertificationsCountRequestBuilder) {
    return NewItemProfileCertificationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation retrieve a list of personCertification objects from a user's profile.
func (m *ItemProfileCertificationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemProfileCertificationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
