...
func (m *ItemInformationProtectionSensitivityLabelsRequestBuilder) ComputeInheritanceWithLabelIdsWithLocaleWithContentFormats(contentFormats *string, labelIds *string, locale *string)(*ItemInformationProtectionSensitivityLabelsComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilder) {
    return NewItemInformationProtectionSensitivityLabelsComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, contentFormats, labelIds, locale)
}
...
func (m *ItemInformationProtectionSensitivityLabelsRequestBuilder) ComputeRightsAndInheritance()(*ItemInformationProtectionSensitivityLabelsComputeRightsAndInheritanceRequestBuilder) {
    return NewItemInformationProtectionSensitivityLabelsComputeRightsAndInheritanceRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
