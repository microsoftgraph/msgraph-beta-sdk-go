...
func (m *ItemDeviceEnrollmentConfigurationsDeviceEnrollmentConfigurationItemRequestBuilder) MicrosoftGraphAssign()(*ItemDeviceEnrollmentConfigurationsItemMicrosoftGraphAssignRequestBuilder) {
    return NewItemDeviceEnrollmentConfigurationsItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSetPriority provides operations to call the setPriority method.
func (m *ItemDeviceEnrollmentConfigurationsDeviceEnrollmentConfigurationItemRequestBuilder) MicrosoftGraphSetPriority()(*ItemDeviceEnrollmentConfigurationsItemMicrosoftGraphSetPriorityRequestBuilder) {
    return NewItemDeviceEnrollmentConfigurationsItemMicrosoftGraphSetPriorityRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
