...
// ItemManagedDevicesItemEndRemoteHelpSessionPostRequestBody provides operations to call the endRemoteHelpSession method.
...
func (m *ItemManagedDevicesItemEndRemoteHelpSessionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemManagedDevicesItemEndRemoteHelpSessionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
