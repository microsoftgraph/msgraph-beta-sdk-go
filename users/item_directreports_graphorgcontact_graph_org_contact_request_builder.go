...
func NewItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilder) {
    m := &ItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilder{
...
func NewItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilder) {
    ...
    return NewItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ItemDirectreportsGraphorgcontactCountRequestBuilder when successful
func (m *ItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilder) Count()(*ItemDirectreportsGraphorgcontactCountRequestBuilder) {
...
func (m *ItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OrgContactCollectionResponseable, error) {
...
func (m *ItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilder) WithUrl(rawUrl string)(*ItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilder) {
    return NewItemDirectreportsGraphorgcontactGraphOrgContactRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
