...
// NewItemEventsItemExceptionoccurrencesItemExtensionsCountRequestBuilderInternal instantiates a new ItemEventsItemExceptionoccurrencesItemExtensionsCountRequestBuilder and sets the default values.
func NewItemEventsItemExceptionoccurrencesItemExtensionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemEventsItemExceptionoccurrencesItemExtensionsCountRequestBuilder) {
    m := &ItemEventsItemExceptionoccurrencesItemExtensionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/extensions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemEventsItemExceptionoccurrencesItemExtensionsCountRequestBuilder instantiates a new ItemEventsItemExceptionoccurrencesItemExtensionsCountRequestBuilder and sets the default values.
