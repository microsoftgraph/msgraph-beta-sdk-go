...
func (m *ItemChatsChatItemRequestBuilder) RemoveAllAccessForUser()(*ItemChatsItemRemoveallaccessforuserRemoveAllAccessForUserRequestBuilder) {
    return NewItemChatsItemRemoveallaccessforuserRemoveAllAccessForUserRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
