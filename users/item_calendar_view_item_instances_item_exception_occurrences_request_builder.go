...
func (m *ItemCalendarViewItemInstancesItemExceptionOccurrencesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarViewItemInstancesItemExceptionOccurrencesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemCalendarViewItemInstancesItemExceptionOccurrencesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
