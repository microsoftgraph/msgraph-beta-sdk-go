...
type ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody instantiates a new ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody and sets the default values.
func NewItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody()(*ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) {
    m := &ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody(), nil
}
// GetActivityType gets the activityType property value. The activityType property
// returns a *string when successful
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) GetActivityType()(*string) {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetChainId gets the chainId property value. The chainId property
// returns a *int64 when successful
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) GetChainId()(*int64) {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) GetPreviewText()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ItemBodyable) {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) GetRecipient()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkNotificationRecipientable) {
...
// returns a *string when successful
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) GetTeamsAppId()(*string) {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) GetTemplateParameters()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.KeyValuePairable) {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) GetTopic()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkActivityTopicable) {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) SetActivityType(value *string)() {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetChainId sets the chainId property value. The chainId property
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) SetChainId(value *int64)() {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) SetPreviewText(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ItemBodyable)() {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) SetRecipient(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkNotificationRecipientable)() {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) SetTeamsAppId(value *string)() {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) SetTemplateParameters(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.KeyValuePairable)() {
...
func (m *ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBody) SetTopic(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkActivityTopicable)() {
    err := m.GetBackingStore().Set("topic", value)
    if err != nil {
        panic(err)
    }
}
type ItemChatsItemSendactivitynotificationSendActivityNotificationPostRequestBodyable interface {
