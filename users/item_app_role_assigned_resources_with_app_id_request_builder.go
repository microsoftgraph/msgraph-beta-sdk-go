...
// ItemAppRoleAssignedResourcesWithAppIdRequestBuilder provides operations to manage the appRoleAssignedResources property of the microsoft.graph.user entity.
type ItemAppRoleAssignedResourcesWithAppIdRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemAppRoleAssignedResourcesWithAppIdRequestBuilderGetQueryParameters get appRoleAssignedResources from users
type ItemAppRoleAssignedResourcesWithAppIdRequestBuilderGetQueryParameters struct {
    // Expand related entities
    Expand []string `uriparametername:"%24expand"`
    // Select properties to be returned
    Select []string `uriparametername:"%24select"`
}
// ItemAppRoleAssignedResourcesWithAppIdRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemAppRoleAssignedResourcesWithAppIdRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemAppRoleAssignedResourcesWithAppIdRequestBuilderGetQueryParameters
}
// NewItemAppRoleAssignedResourcesWithAppIdRequestBuilderInternal instantiates a new ItemAppRoleAssignedResourcesWithAppIdRequestBuilder and sets the default values.
...
// NewItemAppRoleAssignedResourcesWithAppIdRequestBuilder instantiates a new ItemAppRoleAssignedResourcesWithAppIdRequestBuilder and sets the default values.
func NewItemAppRoleAssignedResourcesWithAppIdRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAppRoleAssignedResourcesWithAppIdRequestBuilder) {
