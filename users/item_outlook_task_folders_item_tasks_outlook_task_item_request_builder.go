...
func (m *ItemOutlookTaskFoldersItemTasksOutlookTaskItemRequestBuilder) MicrosoftGraphComplete()(*ItemOutlookTaskFoldersItemTasksItemMicrosoftGraphCompleteRequestBuilder) {
    return NewItemOutlookTaskFoldersItemTasksItemMicrosoftGraphCompleteRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
