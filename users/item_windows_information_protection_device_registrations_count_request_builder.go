...
func (m *ItemWindowsInformationProtectionDeviceRegistrationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemWindowsInformationProtectionDeviceRegistrationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
