...
// NewItemCloudPCsItemCreateSnapshotRequestBuilderInternal instantiates a new ItemCloudPCsItemCreateSnapshotRequestBuilder and sets the default values.
...
// NewItemCloudPCsItemCreateSnapshotRequestBuilder instantiates a new ItemCloudPCsItemCreateSnapshotRequestBuilder and sets the default values.
...
func (m *ItemCloudPCsItemCreateSnapshotRequestBuilder) Post(ctx context.Context, body ItemCloudPCsItemCreateSnapshotPostRequestBodyable, requestConfiguration *ItemCloudPCsItemCreateSnapshotRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemCloudPCsItemCreateSnapshotRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemCloudPCsItemCreateSnapshotPostRequestBodyable, requestConfiguration *ItemCloudPCsItemCreateSnapshotRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
