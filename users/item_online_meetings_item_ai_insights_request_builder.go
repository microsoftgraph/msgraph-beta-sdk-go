...
// ItemOnlineMeetingsItemAiInsightsRequestBuilder provides operations to manage the aiInsights property of the microsoft.graph.onlineMeeting entity.
type ItemOnlineMeetingsItemAiInsightsRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemOnlineMeetingsItemAiInsightsRequestBuilderGetQueryParameters get aiInsights from users
type ItemOnlineMeetingsItemAiInsightsRequestBuilderGetQueryParameters struct {
...
// ItemOnlineMeetingsItemAiInsightsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemOnlineMeetingsItemAiInsightsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemOnlineMeetingsItemAiInsightsRequestBuilderGetQueryParameters
}
// ItemOnlineMeetingsItemAiInsightsRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemOnlineMeetingsItemAiInsightsRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func (m *ItemOnlineMeetingsItemAiInsightsRequestBuilder) ByCallAiInsightId(callAiInsightId string)(*ItemOnlineMeetingsItemAiInsightsCallAiInsightItemRequestBuilder) {
    ...
    return NewItemOnlineMeetingsItemAiInsightsCallAiInsightItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
// NewItemOnlineMeetingsItemAiInsightsRequestBuilderInternal instantiates a new ItemOnlineMeetingsItemAiInsightsRequestBuilder and sets the default values.
func NewItemOnlineMeetingsItemAiInsightsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnlineMeetingsItemAiInsightsRequestBuilder) {
    m := &ItemOnlineMeetingsItemAiInsightsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/aiInsights{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemOnlineMeetingsItemAiInsightsRequestBuilder instantiates a new ItemOnlineMeetingsItemAiInsightsRequestBuilder and sets the default values.
func NewItemOnlineMeetingsItemAiInsightsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnlineMeetingsItemAiInsightsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemOnlineMeetingsItemAiInsightsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ItemOnlineMeetingsItemAiInsightsCountRequestBuilder when successful
func (m *ItemOnlineMeetingsItemAiInsightsRequestBuilder) Count()(*ItemOnlineMeetingsItemAiInsightsCountRequestBuilder) {
