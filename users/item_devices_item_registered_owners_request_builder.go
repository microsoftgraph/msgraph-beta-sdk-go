...
func (m *ItemDevicesItemRegisteredOwnersRequestBuilder) MicrosoftGraphEndpoint()(*ItemDevicesItemRegisteredOwnersMicrosoftGraphEndpointEndpointRequestBuilder) {
    return NewItemDevicesItemRegisteredOwnersMicrosoftGraphEndpointEndpointRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *ItemDevicesItemRegisteredOwnersRequestBuilder) MicrosoftGraphServicePrincipal()(*ItemDevicesItemRegisteredOwnersMicrosoftGraphServicePrincipalServicePrincipalRequestBuilder) {
    return NewItemDevicesItemRegisteredOwnersMicrosoftGraphServicePrincipalServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *ItemDevicesItemRegisteredOwnersRequestBuilder) MicrosoftGraphUser()(*ItemDevicesItemRegisteredOwnersMicrosoftGraphUserUserRequestBuilder) {
    return NewItemDevicesItemRegisteredOwnersMicrosoftGraphUserUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
