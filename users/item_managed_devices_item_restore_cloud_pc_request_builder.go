...
// Post restore a Cloud PC device to a previous state with an Intune managed device ID. This API is supported in the following national cloud deployments.
...
// ToPostRequestInformation restore a Cloud PC device to a previous state with an Intune managed device ID. This API is supported in the following national cloud deployments.
// Deprecated: The restoreCloudPc API is deprecated and will stop returning on Sep 30, 2023. Please use restore instead as of 2023-07/restoreCloudPc on 2023-08-22 and will be removed 2023-10-30
