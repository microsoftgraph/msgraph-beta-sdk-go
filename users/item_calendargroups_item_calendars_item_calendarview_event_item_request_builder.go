...
func (m *ItemCalendargroupsItemCalendarsItemCalendarviewEventItemRequestBuilder) ExceptionOccurrences()(*ItemCalendargroupsItemCalendarsItemCalendarviewItemExceptionoccurrencesExceptionOccurrencesRequestBuilder) {
    return NewItemCalendargroupsItemCalendarsItemCalendarviewItemExceptionoccurrencesExceptionOccurrencesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
