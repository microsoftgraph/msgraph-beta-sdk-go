...
// ItemProfileInterestsPersonInterestItemRequestBuilder provides operations to manage the interests property of the microsoft.graph.profile entity.
type ItemProfileInterestsPersonInterestItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemProfileInterestsPersonInterestItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemProfileInterestsPersonInterestItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// ItemProfileInterestsPersonInterestItemRequestBuilderGetQueryParameters retrieve the properties and relationships of a personInterest object in a user's profile. This API is available in the following national cloud deployments.
...
type ItemProfileInterestsPersonInterestItemRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemProfileInterestsPersonInterestItemRequestBuilderGetQueryParameters
}
// ItemProfileInterestsPersonInterestItemRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemProfileInterestsPersonInterestItemRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewItemProfileInterestsPersonInterestItemRequestBuilderInternal instantiates a new PersonInterestItemRequestBuilder and sets the default values.
func NewItemProfileInterestsPersonInterestItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemProfileInterestsPersonInterestItemRequestBuilder) {
    m := &ItemProfileInterestsPersonInterestItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/interests/{personInterest%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemProfileInterestsPersonInterestItemRequestBuilder instantiates a new PersonInterestItemRequestBuilder and sets the default values.
func NewItemProfileInterestsPersonInterestItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemProfileInterestsPersonInterestItemRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemProfileInterestsPersonInterestItemRequestBuilderInternal(urlParams, requestAdapter)
}
// Delete deletes a personInterest object from a user's profile. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Get retrieve the properties and relationships of a personInterest object in a user's profile. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Patch update the properties of a personInterest object in a user's profile. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToDeleteRequestInformation deletes a personInterest object from a user's profile. This API is available in the following national cloud deployments.
...
// ToGetRequestInformation retrieve the properties and relationships of a personInterest object in a user's profile. This API is available in the following national cloud deployments.
...
// ToPatchRequestInformation update the properties of a personInterest object in a user's profile. This API is available in the following national cloud deployments.
...
func (m *ItemProfileInterestsPersonInterestItemRequestBuilder) WithUrl(rawUrl string)(*ItemProfileInterestsPersonInterestItemRequestBuilder) {
    return NewItemProfileInterestsPersonInterestItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
