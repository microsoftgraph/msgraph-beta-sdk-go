...
// NewItemCalendarCalendarViewItemExceptionOccurrencesItemCancelRequestBuilderInternal instantiates a new ItemCalendarCalendarViewItemExceptionOccurrencesItemCancelRequestBuilder and sets the default values.
func NewItemCalendarCalendarViewItemExceptionOccurrencesItemCancelRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarCalendarViewItemExceptionOccurrencesItemCancelRequestBuilder) {
    m := &ItemCalendarCalendarViewItemExceptionOccurrencesItemCancelRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/cancel", pathParameters),
    }
    return m
}
// NewItemCalendarCalendarViewItemExceptionOccurrencesItemCancelRequestBuilder instantiates a new ItemCalendarCalendarViewItemExceptionOccurrencesItemCancelRequestBuilder and sets the default values.
...
func (m *ItemCalendarCalendarViewItemExceptionOccurrencesItemCancelRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarCalendarViewItemExceptionOccurrencesItemCancelRequestBuilder) {
    return NewItemCalendarCalendarViewItemExceptionOccurrencesItemCancelRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
