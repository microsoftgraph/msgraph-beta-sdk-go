...
func (m *ItemDevicesItemMemberOfRequestBuilder) MicrosoftGraphApplication()(*ItemDevicesItemMemberOfMicrosoftGraphApplicationApplicationRequestBuilder) {
    return NewItemDevicesItemMemberOfMicrosoftGraphApplicationApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDevice casts the previous resource to device.
func (m *ItemDevicesItemMemberOfRequestBuilder) MicrosoftGraphDevice()(*ItemDevicesItemMemberOfMicrosoftGraphDeviceDeviceRequestBuilder) {
    return NewItemDevicesItemMemberOfMicrosoftGraphDeviceDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGroup casts the previous resource to group.
func (m *ItemDevicesItemMemberOfRequestBuilder) MicrosoftGraphGroup()(*ItemDevicesItemMemberOfMicrosoftGraphGroupGroupRequestBuilder) {
    return NewItemDevicesItemMemberOfMicrosoftGraphGroupGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphOrgContact casts the previous resource to orgContact.
func (m *ItemDevicesItemMemberOfRequestBuilder) MicrosoftGraphOrgContact()(*ItemDevicesItemMemberOfMicrosoftGraphOrgContactOrgContactRequestBuilder) {
    return NewItemDevicesItemMemberOfMicrosoftGraphOrgContactOrgContactRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *ItemDevicesItemMemberOfRequestBuilder) MicrosoftGraphServicePrincipal()(*ItemDevicesItemMemberOfMicrosoftGraphServicePrincipalServicePrincipalRequestBuilder) {
    return NewItemDevicesItemMemberOfMicrosoftGraphServicePrincipalServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *ItemDevicesItemMemberOfRequestBuilder) MicrosoftGraphUser()(*ItemDevicesItemMemberOfMicrosoftGraphUserUserRequestBuilder) {
    return NewItemDevicesItemMemberOfMicrosoftGraphUserUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
