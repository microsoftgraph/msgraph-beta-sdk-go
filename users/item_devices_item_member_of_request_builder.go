...
func (m *ItemDevicesItemMemberOfRequestBuilder) Application()(*ItemDevicesItemMemberOfApplicationRequestBuilder) {
    return NewItemDevicesItemMemberOfApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemDevicesItemMemberOfRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemDevicesItemMemberOfRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemDevicesItemMemberOfRequestBuilder) Device()(*ItemDevicesItemMemberOfDeviceRequestBuilder) {
    return NewItemDevicesItemMemberOfDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemDevicesItemMemberOfRequestBuilder) Group()(*ItemDevicesItemMemberOfGroupRequestBuilder) {
    return NewItemDevicesItemMemberOfGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// OrgContact casts the previous resource to orgContact.
func (m *ItemDevicesItemMemberOfRequestBuilder) OrgContact()(*ItemDevicesItemMemberOfOrgContactRequestBuilder) {
    return NewItemDevicesItemMemberOfOrgContactRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ServicePrincipal casts the previous resource to servicePrincipal.
func (m *ItemDevicesItemMemberOfRequestBuilder) ServicePrincipal()(*ItemDevicesItemMemberOfServicePrincipalRequestBuilder) {
    return NewItemDevicesItemMemberOfServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// User casts the previous resource to user.
func (m *ItemDevicesItemMemberOfRequestBuilder) User()(*ItemDevicesItemMemberOfUserRequestBuilder) {
    return NewItemDevicesItemMemberOfUserRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
