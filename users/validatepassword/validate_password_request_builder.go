...
func (m *ValidatePasswordRequestBuilder) CreatePostRequestInformation(options *ValidatePasswordRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ValidatePasswordRequestBuilder) Post(options *ValidatePasswordRequestBuilderPostOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PasswordValidationInformationable, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreatePasswordValidationInformationFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
