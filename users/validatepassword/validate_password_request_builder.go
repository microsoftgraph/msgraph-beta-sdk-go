...
func (m *ValidatePasswordRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body ValidatePasswordRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreatePostRequestInformationWithRequestConfiguration(body, nil);
}
// CreatePostRequestInformationWithRequestConfiguration invoke action validatePassword
func (m *ValidatePasswordRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body ValidatePasswordRequestBodyable, requestConfiguration *ValidatePasswordRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action validatePassword
func (m *ValidatePasswordRequestBuilder) PostWithResponseHandler(body ValidatePasswordRequestBodyable, requestConfiguration *ValidatePasswordRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PasswordValidationInformationable, error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action validatePassword
func (m *ValidatePasswordRequestBuilder) PostWithResponseHandler(body ValidatePasswordRequestBodyable, requestConfiguration *ValidatePasswordRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PasswordValidationInformationable, error) {
    requestInfo, err := m.CreatePostRequestInformationWithRequestConfiguration(body, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreatePasswordValidationInformationFromDiscriminatorValue, responseHandler, nil)
    if err != nil {
        return nil, err
    }
