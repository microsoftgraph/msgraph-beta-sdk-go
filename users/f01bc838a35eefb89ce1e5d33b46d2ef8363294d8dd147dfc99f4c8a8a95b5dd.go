...
// ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilder builds and executes requests for operations under \users\{user-id}\authentication\hardwareOathMethods\{hardwareOathAuthenticationMethod-id}\device\hardwareOathDevices\{hardwareOathTokenAuthenticationMethodDevice-id}\assignTo\mailboxSettings
type ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilder struct {
...
type ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilderGetQueryParameters struct {
    // Expand related entities
    Expand []string `uriparametername:"%24expand"`
    // Select properties to be returned
    Select []string `uriparametername:"%24select"`
}
// ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilderGetQueryParameters
}
// ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
// NewItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilder instantiates a new ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilder and sets the default values.
func NewItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilder) {
    ...
    return NewItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilder) WithUrl(rawUrl string)(*ItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilder) {
    return NewItemAuthenticationHardwareOathMethodsItemDeviceHardwareOathDevicesItemAssignToMailboxSettingsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
