...
func (m *ItemEventsItemExceptionOccurrencesItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemEventsItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemEventsItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
