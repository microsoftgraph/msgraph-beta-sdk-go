...
// ItemEventsItemExceptionOccurrencesItemInstancesRequestBuilderGetQueryParameters get the instances (occurrences) of an event for a specified time range.  If the event is a `seriesMaster` type, this returns theoccurrences and exceptions of the event in the specified time range.
...
func NewItemEventsItemExceptionOccurrencesItemInstancesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemEventsItemExceptionOccurrencesItemInstancesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
...
func (m *ItemEventsItemExceptionOccurrencesItemInstancesRequestBuilder) Count()(*ItemEventsItemExceptionOccurrencesItemInstancesCountRequestBuilder) {
    return NewItemEventsItemExceptionOccurrencesItemInstancesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemEventsItemExceptionOccurrencesItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemEventsItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemEventsItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
