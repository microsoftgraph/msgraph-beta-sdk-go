...
// ItemManagedDevicesItemGetFileVaultKeyResponse provides operations to call the getFileVaultKey method.
...
func (m *ItemManagedDevicesItemGetFileVaultKeyResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemManagedDevicesItemGetFileVaultKeyResponse) SetAdditionalData(value map[string]interface{})() {
