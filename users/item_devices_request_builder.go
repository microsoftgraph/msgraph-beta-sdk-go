...
// ItemDevicesRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemDevicesRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemDevicesRequestBuilderGetQueryParameters
}
// ItemDevicesRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemDevicesRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func NewItemDevicesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDevicesRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemDevicesRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemDevicesRequestBuilder) MicrosoftGraphDelta()(*ItemDevicesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemDevicesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetByIds provides operations to call the getByIds method.
func (m *ItemDevicesRequestBuilder) MicrosoftGraphGetByIds()(*ItemDevicesMicrosoftGraphGetByIdsRequestBuilder) {
    return NewItemDevicesMicrosoftGraphGetByIdsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetUserOwnedObjects provides operations to call the getUserOwnedObjects method.
func (m *ItemDevicesRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*ItemDevicesMicrosoftGraphGetUserOwnedObjectsRequestBuilder) {
    return NewItemDevicesMicrosoftGraphGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphValidateProperties provides operations to call the validateProperties method.
func (m *ItemDevicesRequestBuilder) MicrosoftGraphValidateProperties()(*ItemDevicesMicrosoftGraphValidatePropertiesRequestBuilder) {
    return NewItemDevicesMicrosoftGraphValidatePropertiesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
