...
// ItemPlannerTasksRequestBuilderGetQueryParameters read-only. Nullable. Returns the plannerTasks assigned to the user.
...
func (m *ItemPlannerTasksRequestBuilder) Delta()(*ItemPlannerTasksDeltaRequestBuilder) {
