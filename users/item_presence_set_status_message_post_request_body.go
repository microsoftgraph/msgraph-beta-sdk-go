...
// ItemPresenceSetStatusMessagePostRequestBody provides operations to call the setStatusMessage method.
...
func (m *ItemPresenceSetStatusMessagePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemPresenceSetStatusMessagePostRequestBody) SetAdditionalData(value map[string]interface{})() {
