...
func (m *ItemCalendargroupsItemCalendarsItemEventsEventItemRequestBuilder) ExceptionOccurrences()(*ItemCalendargroupsItemCalendarsItemEventsItemExceptionoccurrencesExceptionOccurrencesRequestBuilder) {
    return NewItemCalendargroupsItemCalendarsItemEventsItemExceptionoccurrencesExceptionOccurrencesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
