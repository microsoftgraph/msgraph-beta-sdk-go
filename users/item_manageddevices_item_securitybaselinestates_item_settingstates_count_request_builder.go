...
// NewItemManageddevicesItemSecuritybaselinestatesItemSettingstatesCountRequestBuilderInternal instantiates a new ItemManageddevicesItemSecuritybaselinestatesItemSettingstatesCountRequestBuilder and sets the default values.
func NewItemManageddevicesItemSecuritybaselinestatesItemSettingstatesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemManageddevicesItemSecuritybaselinestatesItemSettingstatesCountRequestBuilder) {
    m := &ItemManageddevicesItemSecuritybaselinestatesItemSettingstatesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}/settingStates/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemManageddevicesItemSecuritybaselinestatesItemSettingstatesCountRequestBuilder instantiates a new ItemManageddevicesItemSecuritybaselinestatesItemSettingstatesCountRequestBuilder and sets the default values.
...
func (m *ItemManageddevicesItemSecuritybaselinestatesItemSettingstatesCountRequestBuilder) WithUrl(rawUrl string)(*ItemManageddevicesItemSecuritybaselinestatesItemSettingstatesCountRequestBuilder) {
    return NewItemManageddevicesItemSecuritybaselinestatesItemSettingstatesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
