...
// ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredOwnersCountRequestBuilderGetQueryParameters get the number of the resource
type ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredOwnersCountRequestBuilderGetQueryParameters struct {
...
type ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredOwnersCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredOwnersCountRequestBuilderGetQueryParameters
}
...
func NewItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredOwnersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceRegisteredOwnersCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredOwners/$count{?%24search,%24filter}";
