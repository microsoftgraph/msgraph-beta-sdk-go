...
func (m *ItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateApplication()(*ItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateApplicationEvaluateApplicationRequestBuilder) {
    return NewItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateApplicationEvaluateApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateClassificationResults provides operations to call the evaluateClassificationResults method.
func (m *ItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateClassificationResults()(*ItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateClassificationResultsEvaluateClassificationResultsRequestBuilder) {
    return NewItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateClassificationResultsEvaluateClassificationResultsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateRemoval provides operations to call the evaluateRemoval method.
func (m *ItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateRemoval()(*ItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateRemovalEvaluateRemovalRequestBuilder) {
    return NewItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateRemovalEvaluateRemovalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphExtractLabel provides operations to call the extractLabel method.
func (m *ItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphExtractLabel()(*ItemInformationProtectionPolicyLabelsMicrosoftGraphExtractLabelExtractLabelRequestBuilder) {
    return NewItemInformationProtectionPolicyLabelsMicrosoftGraphExtractLabelExtractLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
