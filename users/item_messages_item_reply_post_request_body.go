...
// ItemMessagesItemReplyPostRequestBody provides operations to call the reply method.
...
func (m *ItemMessagesItemReplyPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMessagesItemReplyPostRequestBody) GetMessage()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Messageable) {
    return m.message
}
...
func (m *ItemMessagesItemReplyPostRequestBody) SetAdditionalData(value map[string]interface{})() {
...
func (m *ItemMessagesItemReplyPostRequestBody) SetMessage(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Messageable)() {
    m.message = value
}
