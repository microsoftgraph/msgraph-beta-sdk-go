...
func NewItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, accessReviewInstanceId *string)(*ItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) {
...
func NewItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) {
    ...
    return NewItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) ContactedReviewersById(id string)(*ItemPendingAccessReviewInstancesItemContactedReviewersAccessReviewReviewerItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemPendingAccessReviewInstancesItemContactedReviewersAccessReviewReviewerItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) DecisionsById(id string)(*ItemPendingAccessReviewInstancesItemDecisionsAccessReviewInstanceDecisionItemItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemPendingAccessReviewInstancesItemDecisionsAccessReviewInstanceDecisionItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphAcceptRecommendations()(*ItemPendingAccessReviewInstancesItemMicrosoftGraphAcceptRecommendationsAcceptRecommendationsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemMicrosoftGraphAcceptRecommendationsAcceptRecommendationsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyDecisions provides operations to call the applyDecisions method.
func (m *ItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphApplyDecisions()(*ItemPendingAccessReviewInstancesItemMicrosoftGraphApplyDecisionsApplyDecisionsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemMicrosoftGraphApplyDecisionsApplyDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBatchRecordDecisions provides operations to call the batchRecordDecisions method.
func (m *ItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphBatchRecordDecisions()(*ItemPendingAccessReviewInstancesItemMicrosoftGraphBatchRecordDecisionsBatchRecordDecisionsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemMicrosoftGraphBatchRecordDecisionsBatchRecordDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphResetDecisions provides operations to call the resetDecisions method.
func (m *ItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphResetDecisions()(*ItemPendingAccessReviewInstancesItemMicrosoftGraphResetDecisionsResetDecisionsRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemMicrosoftGraphResetDecisionsResetDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSendReminder provides operations to call the sendReminder method.
func (m *ItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphSendReminder()(*ItemPendingAccessReviewInstancesItemMicrosoftGraphSendReminderSendReminderRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemMicrosoftGraphSendReminderSendReminderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphStop provides operations to call the stop method.
func (m *ItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphStop()(*ItemPendingAccessReviewInstancesItemMicrosoftGraphStopStopRequestBuilder) {
    return NewItemPendingAccessReviewInstancesItemMicrosoftGraphStopStopRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) StagesById(id string)(*ItemPendingAccessReviewInstancesItemStagesAccessReviewStageItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemPendingAccessReviewInstancesItemStagesAccessReviewStageItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
