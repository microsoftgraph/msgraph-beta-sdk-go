...
// ItemDrivesItemItemsItemListItemVersionsCountRequestBuilderGetQueryParameters get the number of the resource
type ItemDrivesItemItemsItemListItemVersionsCountRequestBuilderGetQueryParameters struct {
...
type ItemDrivesItemItemsItemListItemVersionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemDrivesItemItemsItemListItemVersionsCountRequestBuilderGetQueryParameters
}
...
func NewItemDrivesItemItemsItemListItemVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDrivesItemItemsItemListItemVersionsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/versions/$count{?%24search,%24filter}";
...
func (m *ItemDrivesItemItemsItemListItemVersionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemDrivesItemItemsItemListItemVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
