...
// ItemProfilePublicationsRequestBuilderGetQueryParameters retrieve a list of itemPublication objects from a user's profile. This API is supported in the following national cloud deployments.
...
// Get retrieve a list of itemPublication objects from a user's profile. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create a new itemPublication object in a user's profile. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve a list of itemPublication objects from a user's profile. This API is supported in the following national cloud deployments.
...
// ToPostRequestInformation create a new itemPublication object in a user's profile. This API is supported in the following national cloud deployments.
