...
// NewItemProfilePublicationsRequestBuilderInternal instantiates a new PublicationsRequestBuilder and sets the default values.
...
// NewItemProfilePublicationsRequestBuilder instantiates a new PublicationsRequestBuilder and sets the default values.
...
func (m *ItemProfilePublicationsRequestBuilder) Count()(*ItemProfilePublicationsCountRequestBuilder) {
    return NewItemProfilePublicationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation retrieve a list of itemPublication objects from a user's profile.
func (m *ItemProfilePublicationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemProfilePublicationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
