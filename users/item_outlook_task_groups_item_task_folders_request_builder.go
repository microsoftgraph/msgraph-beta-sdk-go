...
func (m *ItemOutlookTaskGroupsItemTaskFoldersRequestBuilder) Count()(*ItemOutlookTaskGroupsItemTaskFoldersCountRequestBuilder) {
    return NewItemOutlookTaskGroupsItemTaskFoldersCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get Outlook task folders in a specific outlookTaskGroup.
func (m *ItemOutlookTaskGroupsItemTaskFoldersRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemOutlookTaskGroupsItemTaskFoldersRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
