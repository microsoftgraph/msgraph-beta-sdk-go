...
// ItemOutlookTaskGroupsItemTaskFoldersRequestBuilderGetQueryParameters get Outlook task folders in a specific outlookTaskGroup. This API is supported in the following national cloud deployments.
...
// Get get Outlook task folders in a specific outlookTaskGroup. This API is supported in the following national cloud deployments.
// Deprecated: The Outlook tasks API is deprecated and will stop returning data on February 20, 2023. Please use the new To Do API. For more details, please visit https://developer.microsoft.com/en-us/office/blogs/announcing-the-general-availability-of-microsoft-to-do-apis-on-graph/ as of 2020-08/Outlook_Tasks on 2021-02-20 and will be removed 2023-02-20
// [Find more info here]
// 
...
// Post create an Outlook task folder under a specified outlookTaskGroup. This API is supported in the following national cloud deployments.
// Deprecated: The Outlook tasks API is deprecated and will stop returning data on February 20, 2023. Please use the new To Do API. For more details, please visit https://developer.microsoft.com/en-us/office/blogs/announcing-the-general-availability-of-microsoft-to-do-apis-on-graph/ as of 2020-08/Outlook_Tasks on 2021-02-20 and will be removed 2023-02-20
// [Find more info here]
// 
...
// ToGetRequestInformation get Outlook task folders in a specific outlookTaskGroup. This API is supported in the following national cloud deployments.
// Deprecated: The Outlook tasks API is deprecated and will stop returning data on February 20, 2023. Please use the new To Do API. For more details, please visit https://developer.microsoft.com/en-us/office/blogs/announcing-the-general-availability-of-microsoft-to-do-apis-on-graph/ as of 2020-08/Outlook_Tasks on 2021-02-20 and will be removed 2023-02-20
...
// ToPostRequestInformation create an Outlook task folder under a specified outlookTaskGroup. This API is supported in the following national cloud deployments.
// Deprecated: The Outlook tasks API is deprecated and will stop returning data on February 20, 2023. Please use the new To Do API. For more details, please visit https://developer.microsoft.com/en-us/office/blogs/announcing-the-general-availability-of-microsoft-to-do-apis-on-graph/ as of 2020-08/Outlook_Tasks on 2021-02-20 and will be removed 2023-02-20
