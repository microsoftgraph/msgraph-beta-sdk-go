...
func (m *ItemCalendarsItemCalendarviewEventItemRequestBuilder) ExceptionOccurrences()(*ItemCalendarsItemCalendarviewItemExceptionoccurrencesExceptionOccurrencesRequestBuilder) {
    return NewItemCalendarsItemCalendarviewItemExceptionoccurrencesExceptionOccurrencesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
