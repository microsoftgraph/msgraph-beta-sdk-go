...
func (m *ItemPendingAccessReviewInstancesRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*ItemPendingAccessReviewInstancesMicrosoftGraphFilterByCurrentUserWithOnRequestBuilder) {
    return NewItemPendingAccessReviewInstancesMicrosoftGraphFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
