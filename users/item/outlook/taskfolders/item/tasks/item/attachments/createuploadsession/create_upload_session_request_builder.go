...
// Builds and executes requests for operations under \users\{user-id}\outlook\taskFolders\{outlookTaskFolder-id}\tasks\{outlookTask-id}\attachments\microsoft.graph.createUploadSession
...
// Union type wrapper for classes uploadSession
...
// Gets the uploadSession property value. Union type representation for type uploadSession
...
// Sets the uploadSession property value. Union type representation for type uploadSession
// Parameters:
//  - value : Value to set for the uploadSession property.
...
func NewCreateUploadSessionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CreateUploadSessionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/users/{user_id}/outlook/taskFolders/{outlookTaskFolder_id}/tasks/{outlookTask_id}/attachments/microsoft.graph.createUploadSession";
