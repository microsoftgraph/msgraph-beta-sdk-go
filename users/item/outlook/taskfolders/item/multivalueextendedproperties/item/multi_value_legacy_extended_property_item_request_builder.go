...
// MultiValueLegacyExtendedPropertyItemRequestBuilder provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.outlookTaskFolder entity.
...
// MultiValueLegacyExtendedPropertyItemRequestBuilderGetQueryParameters the collection of multi-value extended properties defined for the task folder. Read-only. Nullable.
...
// DeleteWithResponseHandler delete navigation property multiValueExtendedProperties for users
...
// PatchWithResponseHandler update the navigation property multiValueExtendedProperties in users
