...
import (
    ...
    i259bfdc6b5a664007a204f5e2464b664d3515453145cf7ecde52742a1bd85e12 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/outlook/taskgroups/item/taskfolders/item/tasks/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/outlook/taskGroups/{outlookTaskGroup_id}/taskFolders/{outlookTaskFolder_id}/tasks/{outlookTask_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i259bfdc6b5a664007a204f5e2464b664d3515453145cf7ecde52742a1bd85e12.CountRequestBuilder) {
    return i259bfdc6b5a664007a204f5e2464b664d3515453145cf7ecde52742a1bd85e12.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
