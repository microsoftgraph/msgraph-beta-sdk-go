...
func (m *CompleteRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *CompleteRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CompleteRequestBuilder) Post(ctx context.Context, requestConfiguration *CompleteRequestBuilderPostRequestConfiguration)(CompleteResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateCompleteResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
