...
import (
    ...
    ide00634a45775da4d25249d416d93fc8fe1eeb029ad9a0b37687d8d0bd218363 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/outlook/taskgroups/item/taskfolders/item/tasks/count"
)
...
func NewTasksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TasksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/outlook/taskGroups/{outlookTaskGroup_id}/taskFolders/{outlookTaskFolder_id}/tasks{?top,skip,filter,count,orderby,select}";
...
func (m *TasksRequestBuilder) Count()(*ide00634a45775da4d25249d416d93fc8fe1eeb029ad9a0b37687d8d0bd218363.CountRequestBuilder) {
    return ide00634a45775da4d25249d416d93fc8fe1eeb029ad9a0b37687d8d0bd218363.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
