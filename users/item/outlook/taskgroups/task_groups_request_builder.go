...
// Builds and executes requests for operations under \users\{user-id}\outlook\taskGroups
...
func NewTaskGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TaskGroupsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/users/{user_id}/outlook/taskGroups{?top,skip,filter,count,orderby,select}";
