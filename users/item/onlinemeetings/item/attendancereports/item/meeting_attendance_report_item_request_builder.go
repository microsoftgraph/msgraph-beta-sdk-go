...
// DeleteWithResponseHandler delete navigation property attendanceReports for users
...
// PatchWithResponseHandler update the navigation property attendanceReports in users
