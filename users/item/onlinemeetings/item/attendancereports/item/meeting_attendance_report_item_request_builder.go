...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property attendanceReports for users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property attendanceReports in users
