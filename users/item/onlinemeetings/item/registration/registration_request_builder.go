...
// DeleteWithResponseHandler delete navigation property registration for users
...
// PatchWithResponseHandler update the navigation property registration in users
