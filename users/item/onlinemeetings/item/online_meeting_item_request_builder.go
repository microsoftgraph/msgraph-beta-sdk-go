...
// DeleteWithResponseHandler delete navigation property onlineMeetings for users
...
// GetWithResponseHandler get onlineMeetings from users
...
// PatchWithResponseHandler update the navigation property onlineMeetings in users
