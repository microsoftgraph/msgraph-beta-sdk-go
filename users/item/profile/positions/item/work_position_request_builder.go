...
// WorkPositionRequestBuilder builds and executes requests for operations under \users\{user-id}\profile\positions\{workPosition-id}
...
type WorkPositionRequestBuilderGetOptions struct {
    ...
    Q *WorkPositionRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
func NewWorkPositionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*WorkPositionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/profile/positions/{workPosition_id}{?select,expand}";
