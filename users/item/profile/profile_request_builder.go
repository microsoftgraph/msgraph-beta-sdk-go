...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property profile for users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property profile in users
