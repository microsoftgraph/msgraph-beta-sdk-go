...
// LanguagesRequestBuilder builds and executes requests for operations under \users\{user-id}\profile\languages
...
// CreatePostRequestInformation represents detailed information about languages that a user has added to their profile.
...
func (m *LanguagesRequestBuilder) Get(options *LanguagesRequestBuilderGetOptions)(*LanguagesResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewLanguagesResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*LanguagesResponse), nil
}
// Post represents detailed information about languages that a user has added to their profile.
func (m *LanguagesRequestBuilder) Post(options *LanguagesRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.LanguageProficiency, error) {
