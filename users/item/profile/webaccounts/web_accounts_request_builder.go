...
type WebAccountsRequestBuilderGetOptions struct {
    ...
    Q *WebAccountsRequestBuilderGetQueryParameters;
...
func NewWebAccountsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*WebAccountsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/profile/webAccounts{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *WebAccountsRequestBuilder) Get(options *WebAccountsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WebAccountCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateWebAccountCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WebAccountCollectionResponseable), nil
}
// Post create new navigation property to webAccounts for users
func (m *WebAccountsRequestBuilder) Post(options *WebAccountsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WebAccountable, error) {
