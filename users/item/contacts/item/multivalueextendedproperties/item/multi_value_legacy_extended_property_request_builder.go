...
// MultiValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \users\{user-id}\contacts\{contact-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
