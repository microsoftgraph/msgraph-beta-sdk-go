...
// MultiValueLegacyExtendedPropertyItemRequestBuilder builds and executes requests for operations under \users\{user-id}\contacts\{contact-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
...
// CreateDeleteRequestInformation the collection of multi-value extended properties defined for the contact. Read-only. Nullable.
...
// CreatePatchRequestInformation the collection of multi-value extended properties defined for the contact. Read-only. Nullable.
...
// Delete the collection of multi-value extended properties defined for the contact. Read-only. Nullable.
...
// Patch the collection of multi-value extended properties defined for the contact. Read-only. Nullable.
