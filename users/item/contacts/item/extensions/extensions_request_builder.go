...
import (
    ...
    i990ae3c1e0e332b099d03485934d90ac605442270d59bfa50abd0c8aeaf49ecc "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/contacts/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/contacts/{contact_id}/extensions{?top,skip,filter,count,orderby,select,expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*i990ae3c1e0e332b099d03485934d90ac605442270d59bfa50abd0c8aeaf49ecc.CountRequestBuilder) {
    return i990ae3c1e0e332b099d03485934d90ac605442270d59bfa50abd0c8aeaf49ecc.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
