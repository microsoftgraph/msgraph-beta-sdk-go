...
// GetWithResponseHandler get media content for the navigation property photo from users
...
// PutWithResponseHandler update media content for the navigation property photo in users
