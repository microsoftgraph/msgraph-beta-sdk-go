...
import (
    ...
    ida9635d25e4d5fd160d3317f5d7e5b69d3810866e3ba558c4598a650b4b5c3a0 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendarview/item/instances/delta"
    ie511e3e25527ee44d0cbee20c5ba830c97358438e0554725912bfeaf281cd204 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendarview/item/instances/count"
)
...
func NewInstancesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*InstancesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendarView/{event_id}/instances{?top,skip,filter,count,orderby,select}";
...
func (m *InstancesRequestBuilder) Count()(*ie511e3e25527ee44d0cbee20c5ba830c97358438e0554725912bfeaf281cd204.CountRequestBuilder) {
    return ie511e3e25527ee44d0cbee20c5ba830c97358438e0554725912bfeaf281cd204.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *InstancesRequestBuilder) Delta()(*ida9635d25e4d5fd160d3317f5d7e5b69d3810866e3ba558c4598a650b4b5c3a0.DeltaRequestBuilder) {
    return ida9635d25e4d5fd160d3317f5d7e5b69d3810866e3ba558c4598a650b4b5c3a0.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
