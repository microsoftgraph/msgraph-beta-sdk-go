...
import (
    ...
    i7fff63cd1920f5022e0ebec109ee94da72697496741518e4b194a621e405981e "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendarview/item/instances/item/exceptionoccurrences/item/attachments/count"
    ifdd69d3106ffba466cd9e662638320dcdb0fd27bd3915fec67f18fdf7ee7de2d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendarview/item/instances/item/exceptionoccurrences/item/attachments/createuploadsession"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendarView/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/attachments{?top,skip,filter,count,orderby,select,expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*i7fff63cd1920f5022e0ebec109ee94da72697496741518e4b194a621e405981e.CountRequestBuilder) {
    return i7fff63cd1920f5022e0ebec109ee94da72697496741518e4b194a621e405981e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*ifdd69d3106ffba466cd9e662638320dcdb0fd27bd3915fec67f18fdf7ee7de2d.CreateUploadSessionRequestBuilder) {
    return ifdd69d3106ffba466cd9e662638320dcdb0fd27bd3915fec67f18fdf7ee7de2d.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
