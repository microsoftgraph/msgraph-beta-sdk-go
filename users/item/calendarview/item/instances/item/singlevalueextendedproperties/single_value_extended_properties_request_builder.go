...
import (
    ...
    i2ae88f0ee55ff29b68aae22db2d26c0b5f2a948af70dda10f029ff14223b7295 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendarview/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendarView/{event_id}/instances/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i2ae88f0ee55ff29b68aae22db2d26c0b5f2a948af70dda10f029ff14223b7295.CountRequestBuilder) {
    return i2ae88f0ee55ff29b68aae22db2d26c0b5f2a948af70dda10f029ff14223b7295.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
