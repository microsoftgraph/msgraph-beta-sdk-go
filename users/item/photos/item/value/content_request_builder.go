...
// GetWithResponseHandler get media content for the navigation property photos from users
...
// PutWithResponseHandler update media content for the navigation property photos in users
