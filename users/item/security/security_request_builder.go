...
import (
    ...
    if4616ad223f65a8a90ce314eed4d3bd4914e535b7236314b22c4501076bc545d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/security/informationprotection"
)
...
// SecurityRequestBuilderGetQueryParameters get security from users
...
// CreateDeleteRequestInformationWithRequestConfiguration delete navigation property security for users
func (m *SecurityRequestBuilder) CreateDeleteRequestInformationWithRequestConfiguration()(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// CreateGetRequestInformationWithRequestConfiguration get security from users
...
// CreatePatchRequestInformationWithRequestConfiguration update the navigation property security in users
...
// DeleteWithResponseHandler delete navigation property security for users
func (m *SecurityRequestBuilder) DeleteWithResponseHandler(requestConfiguration *SecurityRequestBuilderDeleteRequestConfiguration)(error) {
    return m.DeleteWithResponseHandler(requestConfiguration, nil);
}
// DeleteWithResponseHandler delete navigation property security for users
func (m *SecurityRequestBuilder) DeleteWithResponseHandler(requestConfiguration *SecurityRequestBuilderDeleteRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
...
// GetWithResponseHandler get security from users
...
func (m *SecurityRequestBuilder) InformationProtection()(*if4616ad223f65a8a90ce314eed4d3bd4914e535b7236314b22c4501076bc545d.InformationProtectionRequestBuilder) {
    return if4616ad223f65a8a90ce314eed4d3bd4914e535b7236314b22c4501076bc545d.NewInformationProtectionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// PatchWithResponseHandler update the navigation property security in users
