...
// DeleteWithResponseHandler delete navigation property parent for users
...
// GetWithResponseHandler get parent from users
...
// PatchWithResponseHandler update the navigation property parent in users
