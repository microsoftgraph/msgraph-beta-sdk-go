...
// ParentRequestBuilder builds and executes requests for operations under \users\{user-id}\security\informationProtection\sensitivityLabels\{sensitivityLabel-id}\parent
...
func NewParentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/security/informationProtection/sensitivityLabels/{sensitivityLabel_id}/parent{?select,expand}";
