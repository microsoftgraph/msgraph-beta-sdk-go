...
import (
    ...
    i4742b1d1f36a9324f305884110260b1ccb6087640e0a171442ee584a5fd32a30 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/mailfolders/item/childfolders/item/singlevalueextendedproperties/count"
)

// SingleValueExtendedPropertiesRequestBuilder provides operations to manage the singleValueExtendedProperties property of the microsoft.graph.mailFolder entity.
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/childFolders/{mailFolder_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i4742b1d1f36a9324f305884110260b1ccb6087640e0a171442ee584a5fd32a30.CountRequestBuilder) {
    return i4742b1d1f36a9324f305884110260b1ccb6087640e0a171442ee584a5fd32a30.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
