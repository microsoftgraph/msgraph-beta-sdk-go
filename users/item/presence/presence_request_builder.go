...
// DeleteWithResponseHandler delete navigation property presence for users
...
// GetWithResponseHandler get presence from users
...
// PatchWithResponseHandler update the navigation property presence in users
