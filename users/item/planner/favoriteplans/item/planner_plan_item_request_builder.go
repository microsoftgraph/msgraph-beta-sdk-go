...
// PlannerPlanItemRequestBuilder provides operations to manage the favoritePlans property of the microsoft.graph.plannerUser entity.
...
// PlannerPlanItemRequestBuilderGetQueryParameters read-only. Nullable. Returns the plannerPlans that the user marked as favorites.
...
func NewPlannerPlanItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PlannerPlanItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/planner/favoritePlans/{plannerPlan_id}{?select,expand}";
