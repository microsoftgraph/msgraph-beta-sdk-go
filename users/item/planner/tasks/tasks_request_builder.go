...
// TasksRequestBuilder builds and executes requests for operations under \users\{user-id}\planner\tasks
...
// CreatePostRequestInformation read-only. Nullable. Returns the plannerPlans shared with the user.
...
// Post read-only. Nullable. Returns the plannerPlans shared with the user.
func (m *TasksRequestBuilder) Post(options *TasksRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PlannerTask, error) {
