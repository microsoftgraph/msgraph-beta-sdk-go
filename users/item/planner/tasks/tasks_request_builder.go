...
// CreatePostRequestInformation read-only. Nullable. Returns the plannerTasks assigned to the user.
...
// Post read-only. Nullable. Returns the plannerTasks assigned to the user.
