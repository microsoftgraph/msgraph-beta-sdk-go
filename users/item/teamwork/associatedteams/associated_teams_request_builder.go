...
// AssociatedTeamsRequestBuilderGetQueryParameters get associatedTeams from users
...
func NewAssociatedTeamsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AssociatedTeamsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/teamwork/associatedTeams{?top,skip,search,filter,count,orderby,select,expand}";
...
// CreateGetRequestInformation get associatedTeams from users
...
// Get get associatedTeams from users
