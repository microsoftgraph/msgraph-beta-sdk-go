...
import (
    ...
    i6f381d4b3dcd42232de6e79c26e419b3b800ac46a9cc87fd167eb2dfc0631f2d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendars/item/calendarview/item/exceptionoccurrences/count"
)
...
func NewExceptionOccurrencesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExceptionOccurrencesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/calendarView/{event_id}/exceptionOccurrences{?top,skip,filter,count,orderby,select,expand}";
...
func (m *ExceptionOccurrencesRequestBuilder) Count()(*i6f381d4b3dcd42232de6e79c26e419b3b800ac46a9cc87fd167eb2dfc0631f2d.CountRequestBuilder) {
    return i6f381d4b3dcd42232de6e79c26e419b3b800ac46a9cc87fd167eb2dfc0631f2d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
