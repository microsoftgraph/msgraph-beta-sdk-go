...
import (
    ...
    id3b3f19538f468a818bea82a382891ede1691ce77a2ea4b1a3b158738c69d265 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendars/item/events/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/events/{event_id}/instances/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*id3b3f19538f468a818bea82a382891ede1691ce77a2ea4b1a3b158738c69d265.CountRequestBuilder) {
    return id3b3f19538f468a818bea82a382891ede1691ce77a2ea4b1a3b158738c69d265.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
