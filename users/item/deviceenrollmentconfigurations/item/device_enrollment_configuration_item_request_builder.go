...
// DeleteWithResponseHandler delete navigation property deviceEnrollmentConfigurations for users
...
// PatchWithResponseHandler update the navigation property deviceEnrollmentConfigurations in users
