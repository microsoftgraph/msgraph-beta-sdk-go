...
// CreateGetRequestInformationWithRequestConfiguration get authentication from users
...
// GetWithRequestConfigurationAndResponseHandler get authentication from users
