...
// DeleteWithResponseHandler delete navigation property emailMethods for users
...
// PatchWithResponseHandler update the navigation property emailMethods in users
