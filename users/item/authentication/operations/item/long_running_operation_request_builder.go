...
// LongRunningOperationRequestBuilder builds and executes requests for operations under \users\{user-id}\authentication\operations\{longRunningOperation-id}
...
// LongRunningOperationRequestBuilderGetQueryParameters get operations from users
