...
// OperationsRequestBuilder builds and executes requests for operations under \users\{user-id}\authentication\operations
...
func (m *OperationsRequestBuilder) Post(options *OperationsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.LongRunningOperation, error) {
