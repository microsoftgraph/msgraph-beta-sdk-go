...
// DeleteWithResponseHandler delete navigation property passwordMethods for users
...
// PatchWithResponseHandler update the navigation property passwordMethods in users
