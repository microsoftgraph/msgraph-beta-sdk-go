...
// TemporaryAccessPassMethodsResponse 
...
// NewTemporaryAccessPassMethodsResponse instantiates a new temporaryAccessPassMethodsResponse and sets the default values.
