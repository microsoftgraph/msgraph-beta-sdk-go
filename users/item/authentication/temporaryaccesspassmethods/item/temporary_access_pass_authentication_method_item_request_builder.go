...
// DeleteWithResponseHandler delete navigation property temporaryAccessPassMethods for users
...
// PatchWithResponseHandler update the navigation property temporaryAccessPassMethods in users
