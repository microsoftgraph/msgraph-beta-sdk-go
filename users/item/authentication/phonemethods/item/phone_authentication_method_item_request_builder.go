...
// DeleteWithResponseHandler delete navigation property phoneMethods for users
...
// PatchWithResponseHandler update the navigation property phoneMethods in users
