...
import (
    ...
    i9f8ed0b48bc530a8458b57ffd3ebb4dca665a0eda6ae538ae01ad4ca8370008b "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/authentication/windowshelloforbusinessmethods/item/device/usagerights/count"
)
...
func NewUsageRightsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UsageRightsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/usageRights{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *UsageRightsRequestBuilder) Count()(*i9f8ed0b48bc530a8458b57ffd3ebb4dca665a0eda6ae538ae01ad4ca8370008b.CountRequestBuilder) {
    return i9f8ed0b48bc530a8458b57ffd3ebb4dca665a0eda6ae538ae01ad4ca8370008b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
