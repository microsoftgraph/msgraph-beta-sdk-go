...
import (
    ...
    i036fee62665c70f066e9e5ae8eb1b633a50bc3c33c777e677740ad06512a9562 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/authentication/windowshelloforbusinessmethods/item/device/memberof/device/count"
)
...
func NewDeviceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DeviceRequestBuilder) Count()(*i036fee62665c70f066e9e5ae8eb1b633a50bc3c33c777e677740ad06512a9562.CountRequestBuilder) {
    return i036fee62665c70f066e9e5ae8eb1b633a50bc3c33c777e677740ad06512a9562.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
