...
import (
    ...
    i504b0c34adbec62e2c1400244c32c3cd8b19a4b40075c41f8e795c60ad979d48 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/authentication/passwordlessmicrosoftauthenticatormethods/item/device/transitivememberof/device/count"
)
...
func NewDeviceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/transitiveMemberOf/microsoft.graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DeviceRequestBuilder) Count()(*i504b0c34adbec62e2c1400244c32c3cd8b19a4b40075c41f8e795c60ad979d48.CountRequestBuilder) {
    return i504b0c34adbec62e2c1400244c32c3cd8b19a4b40075c41f8e795c60ad979d48.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DeviceRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceCollectionResponseable, error) {
