...
import (
    ...
    i42f731cc7a6cefe3c25b74c64d710c57c2855eecec202cfb76b00bdb4ab10e23 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/authentication/passwordlessmicrosoftauthenticatormethods/item/device/registeredusers/serviceprincipal/count"
)
...
func NewServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ServicePrincipalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/registeredUsers/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ServicePrincipalRequestBuilder) Count()(*i42f731cc7a6cefe3c25b74c64d710c57c2855eecec202cfb76b00bdb4ab10e23.CountRequestBuilder) {
    return i42f731cc7a6cefe3c25b74c64d710c57c2855eecec202cfb76b00bdb4ab10e23.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
