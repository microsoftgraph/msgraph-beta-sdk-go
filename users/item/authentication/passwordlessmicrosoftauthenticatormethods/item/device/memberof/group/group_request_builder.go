...
import (
    ...
    i7932c498b389147d324c2db6a2ba6f36574717121f9fb00e286536be780e2856 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/authentication/passwordlessmicrosoftauthenticatormethods/item/device/memberof/group/count"
)
...
func NewGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *GroupRequestBuilder) Count()(*i7932c498b389147d324c2db6a2ba6f36574717121f9fb00e286536be780e2856.CountRequestBuilder) {
    return i7932c498b389147d324c2db6a2ba6f36574717121f9fb00e286536be780e2856.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
