...
import (
    ...
    i33107fd4b17aea9c5b5c1683e8bfbd28a5ac7472c89546b80333d8f2712ed909 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/authentication/passwordlessmicrosoftauthenticatormethods/item/device/registeredowners/endpoint/count"
)
...
func NewEndpointRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EndpointRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/registeredOwners/microsoft.graph.endpoint{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *EndpointRequestBuilder) Count()(*i33107fd4b17aea9c5b5c1683e8bfbd28a5ac7472c89546b80333d8f2712ed909.CountRequestBuilder) {
    return i33107fd4b17aea9c5b5c1683e8bfbd28a5ac7472c89546b80333d8f2712ed909.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *EndpointRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *EndpointRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EndpointRequestBuilder) Get(ctx context.Context, requestConfiguration *EndpointRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.EndpointCollectionResponseable, error) {
