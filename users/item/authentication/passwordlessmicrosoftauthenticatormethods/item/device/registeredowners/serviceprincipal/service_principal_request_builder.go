...
import (
    ...
    ic35a47e6e00e9aad4393056620867f0f2a93a3ec9a336bc8686707079cbb7a71 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/authentication/passwordlessmicrosoftauthenticatormethods/item/device/registeredowners/serviceprincipal/count"
)
...
func NewServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ServicePrincipalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/registeredOwners/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ServicePrincipalRequestBuilder) Count()(*ic35a47e6e00e9aad4393056620867f0f2a93a3ec9a336bc8686707079cbb7a71.CountRequestBuilder) {
    return ic35a47e6e00e9aad4393056620867f0f2a93a3ec9a336bc8686707079cbb7a71.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ServicePrincipalRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ServicePrincipalRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ServicePrincipalRequestBuilder) Get(ctx context.Context, requestConfiguration *ServicePrincipalRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ServicePrincipalCollectionResponseable, error) {
