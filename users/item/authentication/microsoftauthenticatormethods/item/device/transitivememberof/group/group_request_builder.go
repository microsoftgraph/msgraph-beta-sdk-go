...
import (
    ...
    if4e99cc12e8b1dd55e28fc58d8d9521d2ea099c4a1c60f40feb081e71908fa2d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/authentication/microsoftauthenticatormethods/item/device/transitivememberof/group/count"
)
...
func NewGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/transitiveMemberOf/microsoft.graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *GroupRequestBuilder) Count()(*if4e99cc12e8b1dd55e28fc58d8d9521d2ea099c4a1c60f40feb081e71908fa2d.CountRequestBuilder) {
    return if4e99cc12e8b1dd55e28fc58d8d9521d2ea099c4a1c60f40feb081e71908fa2d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
