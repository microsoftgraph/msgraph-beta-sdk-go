...
// Fido2AuthenticationMethodRequestBuilder builds and executes requests for operations under \users\{user-id}\authentication\fido2Methods\{fido2AuthenticationMethod-id}
...
// Fido2AuthenticationMethodRequestBuilderGetQueryParameters get fido2Methods from users
...
type Fido2AuthenticationMethodRequestBuilderPatchOptions struct {
    // 
    Body *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Fido2AuthenticationMethod;
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
...
func NewFido2AuthenticationMethodRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Fido2AuthenticationMethodRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/authentication/fido2Methods/{fido2AuthenticationMethod_id}{?select,expand}";
...
// CreatePatchRequestInformation update the navigation property fido2Methods in users
...
func (m *Fido2AuthenticationMethodRequestBuilder) Get(options *Fido2AuthenticationMethodRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Fido2AuthenticationMethod, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewFido2AuthenticationMethod() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Fido2AuthenticationMethod), nil
}
// Patch update the navigation property fido2Methods in users
