...
// DeleteWithResponseHandler delete navigation property calendarView for users
...
// PatchWithResponseHandler update the navigation property calendarView in users
