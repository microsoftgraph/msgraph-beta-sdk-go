...
import (
    ...
    i5afe301e3303bad09dd68d57d4492a115641e153a62555589169dbab6334fa9e "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendar/calendarview/item/exceptionoccurrences/item/instances/delta"
    ia2dc7a56d56a65056fa0cf08d768a31154dcbe8fa341981fc7a92a24a9b8feef "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendar/calendarview/item/exceptionoccurrences/item/instances/count"
)
...
func NewInstancesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InstancesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
...
func (m *InstancesRequestBuilder) Count()(*ia2dc7a56d56a65056fa0cf08d768a31154dcbe8fa341981fc7a92a24a9b8feef.CountRequestBuilder) {
    return ia2dc7a56d56a65056fa0cf08d768a31154dcbe8fa341981fc7a92a24a9b8feef.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *InstancesRequestBuilder) Delta()(*i5afe301e3303bad09dd68d57d4492a115641e153a62555589169dbab6334fa9e.DeltaRequestBuilder) {
    return i5afe301e3303bad09dd68d57d4492a115641e153a62555589169dbab6334fa9e.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
