...
import (
    ...
    if24ccb53cc57cf3adffc95dd25facc372c492c29851d24c1f95b3da596a29834 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendar/calendarview/item/instances/item/exceptionoccurrences/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendar/calendarView/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*if24ccb53cc57cf3adffc95dd25facc372c492c29851d24c1f95b3da596a29834.CountRequestBuilder) {
    return if24ccb53cc57cf3adffc95dd25facc372c492c29851d24c1f95b3da596a29834.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
