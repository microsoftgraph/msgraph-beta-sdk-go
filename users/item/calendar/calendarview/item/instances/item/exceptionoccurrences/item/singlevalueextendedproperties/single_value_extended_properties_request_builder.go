...
import (
    ...
    i5ef0cd0cdc5cc2d8252ca20d6df99ddf2aa18c47528181b30f5b0379f760f044 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendar/calendarview/item/instances/item/exceptionoccurrences/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i5ef0cd0cdc5cc2d8252ca20d6df99ddf2aa18c47528181b30f5b0379f760f044.CountRequestBuilder) {
    return i5ef0cd0cdc5cc2d8252ca20d6df99ddf2aa18c47528181b30f5b0379f760f044.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
