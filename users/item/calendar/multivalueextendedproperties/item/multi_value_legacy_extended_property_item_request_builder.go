...
// MultiValueLegacyExtendedPropertyItemRequestBuilder builds and executes requests for operations under \users\{user-id}\calendar\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
