...
import (
    ...
    i2d60574d32f9913542ff433eea3143eace10dfac16a4388e8a38d0975343f416 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendar/events/item/exceptionoccurrences/item/attachments/count"
    if7bf3fb0062c3aae3ac7864f7914f57eed7d877bc600d0c1cd3d85df7f9abfce "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendar/events/item/exceptionoccurrences/item/attachments/createuploadsession"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendar/events/{event_id}/exceptionOccurrences/{event_id1}/attachments{?top,skip,filter,count,orderby,select,expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*i2d60574d32f9913542ff433eea3143eace10dfac16a4388e8a38d0975343f416.CountRequestBuilder) {
    return i2d60574d32f9913542ff433eea3143eace10dfac16a4388e8a38d0975343f416.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*if7bf3fb0062c3aae3ac7864f7914f57eed7d877bc600d0c1cd3d85df7f9abfce.CreateUploadSessionRequestBuilder) {
    return if7bf3fb0062c3aae3ac7864f7914f57eed7d877bc600d0c1cd3d85df7f9abfce.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
