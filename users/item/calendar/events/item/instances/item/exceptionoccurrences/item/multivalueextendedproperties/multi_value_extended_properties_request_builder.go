...
import (
    ...
    i9ad53cbe9a6a8ce6476fbfdafce51c222b82838be1f87d44db71d3eef510addb "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendar/events/item/instances/item/exceptionoccurrences/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendar/events/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*i9ad53cbe9a6a8ce6476fbfdafce51c222b82838be1f87d44db71d3eef510addb.CountRequestBuilder) {
    return i9ad53cbe9a6a8ce6476fbfdafce51c222b82838be1f87d44db71d3eef510addb.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
