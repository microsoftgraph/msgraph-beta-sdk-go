...
import (
    ...
    ie0f6d6236e4c26322064b82bcb1368ecbfab946a9957a73f7c839db521cdfd60 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendar/events/item/instances/item/exceptionoccurrences/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendar/events/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*ie0f6d6236e4c26322064b82bcb1368ecbfab946a9957a73f7c839db521cdfd60.CountRequestBuilder) {
    return ie0f6d6236e4c26322064b82bcb1368ecbfab946a9957a73f7c839db521cdfd60.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
