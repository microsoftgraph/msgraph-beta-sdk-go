...
// IsManagedAppUserBlockedRequestBuilder builds and executes requests for operations under \users\{user-id}\microsoft.graph.isManagedAppUserBlocked()
...
func (m *IsManagedAppUserBlockedRequestBuilder) Get(options *IsManagedAppUserBlockedRequestBuilderGetOptions)(*bool, error) {
