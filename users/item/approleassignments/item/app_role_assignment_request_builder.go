...
// AppRoleAssignmentRequestBuilder builds and executes requests for operations under \users\{user-id}\appRoleAssignments\{appRoleAssignment-id}
...
// AppRoleAssignmentRequestBuilderGetQueryParameters represents the app roles a user has been granted for an application. Supports $expand.
