...
// DeleteWithResponseHandler delete navigation property appRoleAssignments for users
...
// PatchWithResponseHandler update the navigation property appRoleAssignments in users
