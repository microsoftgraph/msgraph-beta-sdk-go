...
import (
    ...
    i982580c0c92d678dceed4db81532aa79b29ab04a5403dfe42c908a3edb61b539 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/manageddevices/item/detectedapps/ref"
)

// DetectedAppsRequestBuilder builds and executes requests for operations under \users\{user-id}\managedDevices\{managedDevice-id}\detectedApps
...
func NewDetectedAppsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DetectedAppsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/managedDevices/{managedDevice_id}/detectedApps{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *DetectedAppsRequestBuilder) Ref()(*i982580c0c92d678dceed4db81532aa79b29ab04a5403dfe42c908a3edb61b539.RefRequestBuilder) {
    return i982580c0c92d678dceed4db81532aa79b29ab04a5403dfe42c908a3edb61b539.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
