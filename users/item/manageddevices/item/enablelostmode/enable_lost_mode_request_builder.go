...
func NewEnableLostModeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EnableLostModeRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/microsoft.graph.enableLostMode";
...
func (m *EnableLostModeRequestBuilder) CreatePostRequestInformation(ctx context.Context, body EnableLostModePostRequestBodyable, requestConfiguration *EnableLostModeRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EnableLostModeRequestBuilder) Post(ctx context.Context, body EnableLostModePostRequestBodyable, requestConfiguration *EnableLostModeRequestBuilderPostRequestConfiguration)(error) {
