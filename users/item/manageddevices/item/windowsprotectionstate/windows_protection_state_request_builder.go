...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property windowsProtectionState for users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property windowsProtectionState in users
