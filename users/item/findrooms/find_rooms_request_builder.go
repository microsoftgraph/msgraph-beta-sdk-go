...
func NewFindRoomsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FindRoomsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/microsoft.graph.findRooms()";
...
func (m *FindRoomsRequestBuilder) CreateGetRequestInformation(options *FindRoomsRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *FindRoomsRequestBuilder) Get(options *FindRoomsRequestBuilderGetOptions)(FindRoomsResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateFindRoomsResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
