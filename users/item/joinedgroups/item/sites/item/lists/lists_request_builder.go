...
import (
    ...
    i9fc2c52223d6dd0464f51c96358cbc4d5aad0a618d83b7658e354e6f3feab621 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/lists/count"
)
...
func NewListsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ListsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/lists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ListsRequestBuilder) Count()(*i9fc2c52223d6dd0464f51c96358cbc4d5aad0a618d83b7658e354e6f3feab621.CountRequestBuilder) {
    return i9fc2c52223d6dd0464f51c96358cbc4d5aad0a618d83b7658e354e6f3feab621.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
