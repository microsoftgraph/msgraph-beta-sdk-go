...
import (
    ...
    if68813293c981be2f1ba59853cc21a3d59e4eecbce119be45416b3250fc9eaa5 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/lists/item/items/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *VersionsRequestBuilder) Count()(*if68813293c981be2f1ba59853cc21a3d59e4eecbce119be45416b3250fc9eaa5.CountRequestBuilder) {
    return if68813293c981be2f1ba59853cc21a3d59e4eecbce119be45416b3250fc9eaa5.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
