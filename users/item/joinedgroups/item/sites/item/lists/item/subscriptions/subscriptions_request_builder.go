...
import (
    ...
    ia22efbea2c89161743ca65b8b578beda79430de6a061bcd016c7460e4f6e7fd6 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/lists/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*ia22efbea2c89161743ca65b8b578beda79430de6a061bcd016c7460e4f6e7fd6.CountRequestBuilder) {
    return ia22efbea2c89161743ca65b8b578beda79430de6a061bcd016c7460e4f6e7fd6.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
