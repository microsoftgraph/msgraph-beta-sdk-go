...
import (
    ...
    ibf16bc80e754e2cbe9a896bffc8ca92a9f99b1ee23aec43f4e2425140e1848eb "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/lists/item/items/item/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*ibf16bc80e754e2cbe9a896bffc8ca92a9f99b1ee23aec43f4e2425140e1848eb.CountRequestBuilder) {
    return ibf16bc80e754e2cbe9a896bffc8ca92a9f99b1ee23aec43f4e2425140e1848eb.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
