...
import (
    ...
    i90d16c59df0075b32fef1cd0bd0e750c49fb7778d334e20ebaef1f2d1bb0b960 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/drives/count"
)
...
func NewDrivesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/drives{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DrivesRequestBuilder) Count()(*i90d16c59df0075b32fef1cd0bd0e750c49fb7778d334e20ebaef1f2d1bb0b960.CountRequestBuilder) {
    return i90d16c59df0075b32fef1cd0bd0e750c49fb7778d334e20ebaef1f2d1bb0b960.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
