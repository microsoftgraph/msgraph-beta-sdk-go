...
import (
    ...
    i31e3e65a0fc8e87cd0b2ee0a8b173dca8a2ad5b498e3aafa24388103a4e0d38d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/items/count"
)
...
func NewItemsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemsRequestBuilder) Count()(*i31e3e65a0fc8e87cd0b2ee0a8b173dca8a2ad5b498e3aafa24388103a4e0d38d.CountRequestBuilder) {
    return i31e3e65a0fc8e87cd0b2ee0a8b173dca8a2ad5b498e3aafa24388103a4e0d38d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
