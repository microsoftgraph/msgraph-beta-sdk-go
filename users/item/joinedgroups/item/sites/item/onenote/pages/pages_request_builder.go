...
import (
    ...
    ifcd36d7877817d241e0862e24f5113b0e320ac95599c601005351fb7737768e2 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/onenote/pages/count"
)
...
func NewPagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PagesRequestBuilder) Count()(*ifcd36d7877817d241e0862e24f5113b0e320ac95599c601005351fb7737768e2.CountRequestBuilder) {
    return ifcd36d7877817d241e0862e24f5113b0e320ac95599c601005351fb7737768e2.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
