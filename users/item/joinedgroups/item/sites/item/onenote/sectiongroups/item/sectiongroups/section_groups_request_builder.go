...
import (
    ...
    if57b8a5a145ea85b0ae86e99ed36000d5a8fad25eeafc242eba32e1079c0d6d0 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/onenote/sectiongroups/item/sectiongroups/count"
)
...
func NewSectionGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SectionGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SectionGroupsRequestBuilder) Count()(*if57b8a5a145ea85b0ae86e99ed36000d5a8fad25eeafc242eba32e1079c0d6d0.CountRequestBuilder) {
    return if57b8a5a145ea85b0ae86e99ed36000d5a8fad25eeafc242eba32e1079c0d6d0.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
