...
import (
    ...
    ic09a29f5a0d6e9d7f02f9610e5df5ef9efc6dca22ed5820e8789d3ecfe6a4ddf "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/onenote/sectiongroups/item/sections/count"
)
...
func NewSectionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SectionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SectionsRequestBuilder) Count()(*ic09a29f5a0d6e9d7f02f9610e5df5ef9efc6dca22ed5820e8789d3ecfe6a4ddf.CountRequestBuilder) {
    return ic09a29f5a0d6e9d7f02f9610e5df5ef9efc6dca22ed5820e8789d3ecfe6a4ddf.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
