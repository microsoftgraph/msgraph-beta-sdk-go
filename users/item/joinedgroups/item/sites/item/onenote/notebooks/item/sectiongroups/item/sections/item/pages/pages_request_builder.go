...
import (
    ...
    i20be8cf98c2a5e9c42678db5eaabc7427389d63d0297cf937cafa04674ff0852 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/onenote/notebooks/item/sectiongroups/item/sections/item/pages/count"
)
...
func NewPagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PagesRequestBuilder) Count()(*i20be8cf98c2a5e9c42678db5eaabc7427389d63d0297cf937cafa04674ff0852.CountRequestBuilder) {
    return i20be8cf98c2a5e9c42678db5eaabc7427389d63d0297cf937cafa04674ff0852.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
