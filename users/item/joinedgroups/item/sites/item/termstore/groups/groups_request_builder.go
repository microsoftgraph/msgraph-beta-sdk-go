...
import (
    ...
    i08d68658d97c5e8317f2f64e09a154d04d4da2b932d82735639b0c5de3cc849d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/groups/count"
)
...
func NewGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/groups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *GroupsRequestBuilder) Count()(*i08d68658d97c5e8317f2f64e09a154d04d4da2b932d82735639b0c5de3cc849d.CountRequestBuilder) {
    return i08d68658d97c5e8317f2f64e09a154d04d4da2b932d82735639b0c5de3cc849d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to groups for users
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to groups for users
...
// Post create new navigation property to groups for users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to groups for users
