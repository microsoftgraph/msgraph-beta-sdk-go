...
import (
    ...
    ibe54e9fce45a03a959163f76eab810c4ee22a6fa75fab0564f37d93319c9db32 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/groups/item/sets"
    icb107b75c7d5f5b7fb23e14d047af04c1fef7837bf4632a3f618f1cbcce17e59 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/groups/item/sets/item"
)
...
func NewGroupItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}{?%24select,%24expand}";
...
// CreateDeleteRequestInformation delete navigation property groups for users
...
// CreateDeleteRequestInformationWithRequestConfiguration delete navigation property groups for users
...
// CreatePatchRequestInformation update the navigation property groups in users
...
// CreatePatchRequestInformationWithRequestConfiguration update the navigation property groups in users
...
// Delete delete navigation property groups for users
func (m *GroupItemRequestBuilder) Delete()(error) {
    return m.DeleteWithRequestConfigurationAndResponseHandler(nil, nil);
}
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property groups for users
...
// Patch update the navigation property groups in users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property groups in users
...
func (m *GroupItemRequestBuilder) Sets()(*ibe54e9fce45a03a959163f76eab810c4ee22a6fa75fab0564f37d93319c9db32.SetsRequestBuilder) {
    return ibe54e9fce45a03a959163f76eab810c4ee22a6fa75fab0564f37d93319c9db32.NewSetsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SetsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.users.item.joinedGroups.item.sites.item.termStore.groups.item.sets.item collection
func (m *GroupItemRequestBuilder) SetsById(id string)(*icb107b75c7d5f5b7fb23e14d047af04c1fef7837bf4632a3f618f1cbcce17e59.SetItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return icb107b75c7d5f5b7fb23e14d047af04c1fef7837bf4632a3f618f1cbcce17e59.NewSetItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
