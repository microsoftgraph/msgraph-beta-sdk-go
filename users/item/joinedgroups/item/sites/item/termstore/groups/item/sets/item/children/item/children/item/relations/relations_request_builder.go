...
import (
    ...
    i71459191a0fb3f0f6d74122cbcc67d7e8320178cb08cb1689cbce28258ae7473 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/groups/item/sets/item/children/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets/{set%2Did}/children/{term%2Did}/children/{term%2Did1}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *RelationsRequestBuilder) Count()(*i71459191a0fb3f0f6d74122cbcc67d7e8320178cb08cb1689cbce28258ae7473.CountRequestBuilder) {
    return i71459191a0fb3f0f6d74122cbcc67d7e8320178cb08cb1689cbce28258ae7473.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
