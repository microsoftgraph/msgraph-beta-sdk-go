...
import (
    ...
    i375aac851f61eac74a7d6ce9b78fe3ca9eb7d519978c8d7b2f6741af0f6121f8 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/groups/item/sets/item/terms/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets/{set%2Did}/terms/{term%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i375aac851f61eac74a7d6ce9b78fe3ca9eb7d519978c8d7b2f6741af0f6121f8.CountRequestBuilder) {
    return i375aac851f61eac74a7d6ce9b78fe3ca9eb7d519978c8d7b2f6741af0f6121f8.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
