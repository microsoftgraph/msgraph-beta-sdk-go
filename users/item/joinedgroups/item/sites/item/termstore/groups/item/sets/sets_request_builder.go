...
import (
    ...
    i7bd4e38c34abb42c33dce05206dd6968c5b88effe92a86283e66cee0e325de44 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/groups/item/sets/count"
)
...
func NewSetsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SetsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SetsRequestBuilder) Count()(*i7bd4e38c34abb42c33dce05206dd6968c5b88effe92a86283e66cee0e325de44.CountRequestBuilder) {
    return i7bd4e38c34abb42c33dce05206dd6968c5b88effe92a86283e66cee0e325de44.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
