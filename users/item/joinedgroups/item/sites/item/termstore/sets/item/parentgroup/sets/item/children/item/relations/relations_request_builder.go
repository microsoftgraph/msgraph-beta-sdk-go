...
import (
    ...
    i752f27f25e1a5ba0ada09eadcab6935e2b123c5303bc21bc4d06db78cf27a81a "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/parentgroup/sets/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *RelationsRequestBuilder) Count()(*i752f27f25e1a5ba0ada09eadcab6935e2b123c5303bc21bc4d06db78cf27a81a.CountRequestBuilder) {
    return i752f27f25e1a5ba0ada09eadcab6935e2b123c5303bc21bc4d06db78cf27a81a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
