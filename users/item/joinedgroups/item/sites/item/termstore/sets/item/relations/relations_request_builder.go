...
import (
    ...
    if6ff9b15bb43b251a23f76b39dc4db5ce02f77f6f3cc6e10ffc0db02502ae486 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *RelationsRequestBuilder) Count()(*if6ff9b15bb43b251a23f76b39dc4db5ce02f77f6f3cc6e10ffc0db02502ae486.CountRequestBuilder) {
    return if6ff9b15bb43b251a23f76b39dc4db5ce02f77f6f3cc6e10ffc0db02502ae486.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
