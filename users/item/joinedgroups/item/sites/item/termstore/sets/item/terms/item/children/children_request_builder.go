...
import (
    ...
    i172d5e9935dd1ff59b65fec086663efe80c8fea14db381b8d3115bcbea2c7e9c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/terms/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i172d5e9935dd1ff59b65fec086663efe80c8fea14db381b8d3115bcbea2c7e9c.CountRequestBuilder) {
    return i172d5e9935dd1ff59b65fec086663efe80c8fea14db381b8d3115bcbea2c7e9c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
