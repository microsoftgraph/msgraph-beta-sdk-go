...
import (
    ...
    i186dd8b44e86dfef27bf9deea04139caf4fe78202389f0b6e0f0c68a25f8970a "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i186dd8b44e86dfef27bf9deea04139caf4fe78202389f0b6e0f0c68a25f8970a.CountRequestBuilder) {
    return i186dd8b44e86dfef27bf9deea04139caf4fe78202389f0b6e0f0c68a25f8970a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
