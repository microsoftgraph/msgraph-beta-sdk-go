...
import (
    ...
    i29bf96eacbae80110ea6862d1c06d258f7a2a4aae08bbddcef4412239ac1760c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/children/item/set"
    i426fa96629fde7b41206296a0928cbb2a53ca7693b976264d4e9aa07ee16a2b9 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/children/item/relations"
    i83aa4252da93f1d138ce9aab9385656614718547cc83e4ae66d65d67527e6357 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/children/item/children"
    i3e592427c857f890e65143aae3b094a20e22aee11cb0a074340e962811584329 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/children/item/children/item"
    i679c6276a0ab385e01b46ef7cf04f8164afbf8ef50e1794374836ef262cbb67d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/children/item/relations/item"
)
...
func (m *TermItemRequestBuilder) Children()(*i83aa4252da93f1d138ce9aab9385656614718547cc83e4ae66d65d67527e6357.ChildrenRequestBuilder) {
    return i83aa4252da93f1d138ce9aab9385656614718547cc83e4ae66d65d67527e6357.NewChildrenRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ChildrenById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.users.item.joinedGroups.item.sites.item.termStore.sets.item.children.item.children.item collection
func (m *TermItemRequestBuilder) ChildrenById(id string)(*i3e592427c857f890e65143aae3b094a20e22aee11cb0a074340e962811584329.TermItemRequestBuilder) {
    ...
    return i3e592427c857f890e65143aae3b094a20e22aee11cb0a074340e962811584329.NewTermItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func NewTermItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TermItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}{?%24select,%24expand}";
    urlTplParams := make(map[string]string)
...
func (m *TermItemRequestBuilder) Relations()(*i426fa96629fde7b41206296a0928cbb2a53ca7693b976264d4e9aa07ee16a2b9.RelationsRequestBuilder) {
    return i426fa96629fde7b41206296a0928cbb2a53ca7693b976264d4e9aa07ee16a2b9.NewRelationsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// RelationsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.users.item.joinedGroups.item.sites.item.termStore.sets.item.children.item.relations.item collection
func (m *TermItemRequestBuilder) RelationsById(id string)(*i679c6276a0ab385e01b46ef7cf04f8164afbf8ef50e1794374836ef262cbb67d.RelationItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i679c6276a0ab385e01b46ef7cf04f8164afbf8ef50e1794374836ef262cbb67d.NewRelationItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
// Set the set property
func (m *TermItemRequestBuilder) Set()(*i29bf96eacbae80110ea6862d1c06d258f7a2a4aae08bbddcef4412239ac1760c.SetRequestBuilder) {
    return i29bf96eacbae80110ea6862d1c06d258f7a2a4aae08bbddcef4412239ac1760c.NewSetRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
