...
import (
    ...
    i507640746d2969415b633cfe5f05dab7f19cb78bbe0237ac1811420ca6e7a9d9 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/parentgroup/sets/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i507640746d2969415b633cfe5f05dab7f19cb78bbe0237ac1811420ca6e7a9d9.CountRequestBuilder) {
    return i507640746d2969415b633cfe5f05dab7f19cb78bbe0237ac1811420ca6e7a9d9.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
