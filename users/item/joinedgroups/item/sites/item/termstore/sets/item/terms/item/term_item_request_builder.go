...
import (
    ...
    i59cdf59bbc2ffbc2025bd58567339313673e9969f88b7685abb94838ee050360 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/terms/item/set"
    ie6a3595b8b3792cd53c5e333e55ab28dfd9e78da8aa377b93bd64532a66c7707 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/terms/item/relations"
    ied18ee2bd596d2d4341e96cf857b6cd8b131b9acd44109e2e3fad156db30ac09 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/terms/item/children"
    ia5d756d6f8cf341955f93fb76c59d7f0b2c562adaef9888dd35068c9760962cd "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/terms/item/children/item"
    id417c35d4fa3d7f043fdd53b9768983a70d32820f853ca312aa5c77cf2642ca6 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/terms/item/relations/item"
)
...
func (m *TermItemRequestBuilder) Children()(*ied18ee2bd596d2d4341e96cf857b6cd8b131b9acd44109e2e3fad156db30ac09.ChildrenRequestBuilder) {
    return ied18ee2bd596d2d4341e96cf857b6cd8b131b9acd44109e2e3fad156db30ac09.NewChildrenRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ChildrenById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.users.item.joinedGroups.item.sites.item.termStore.sets.item.terms.item.children.item collection
func (m *TermItemRequestBuilder) ChildrenById(id string)(*ia5d756d6f8cf341955f93fb76c59d7f0b2c562adaef9888dd35068c9760962cd.TermItemRequestBuilder) {
    ...
    return ia5d756d6f8cf341955f93fb76c59d7f0b2c562adaef9888dd35068c9760962cd.NewTermItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func NewTermItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TermItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}{?%24select,%24expand}";
    urlTplParams := make(map[string]string)
...
func (m *TermItemRequestBuilder) Relations()(*ie6a3595b8b3792cd53c5e333e55ab28dfd9e78da8aa377b93bd64532a66c7707.RelationsRequestBuilder) {
    return ie6a3595b8b3792cd53c5e333e55ab28dfd9e78da8aa377b93bd64532a66c7707.NewRelationsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// RelationsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.users.item.joinedGroups.item.sites.item.termStore.sets.item.terms.item.relations.item collection
func (m *TermItemRequestBuilder) RelationsById(id string)(*id417c35d4fa3d7f043fdd53b9768983a70d32820f853ca312aa5c77cf2642ca6.RelationItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return id417c35d4fa3d7f043fdd53b9768983a70d32820f853ca312aa5c77cf2642ca6.NewRelationItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
// Set the set property
func (m *TermItemRequestBuilder) Set()(*i59cdf59bbc2ffbc2025bd58567339313673e9969f88b7685abb94838ee050360.SetRequestBuilder) {
    return i59cdf59bbc2ffbc2025bd58567339313673e9969f88b7685abb94838ee050360.NewSetRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
