...
import (
    ...
    i498e56719e05a8d66de8a9cc604e8b639e91693a0a74c168e1fc3e3b7485ba23 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/terms/item/children/item/set"
    i57a5180337912a51ff79f6b5ae00c18782a7823e7ee00166f38be806d6aa153e "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/terms/item/children/item/relations"
    ifedc6ac453222cdd3d35f0a05b6ea274a941883ee3b4dd56064767775eff4977 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/termstore/sets/item/terms/item/children/item/relations/item"
)
...
func NewTermItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TermItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}";
...
func (m *TermItemRequestBuilder) Relations()(*i57a5180337912a51ff79f6b5ae00c18782a7823e7ee00166f38be806d6aa153e.RelationsRequestBuilder) {
    return i57a5180337912a51ff79f6b5ae00c18782a7823e7ee00166f38be806d6aa153e.NewRelationsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// RelationsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.users.item.joinedGroups.item.sites.item.termStore.sets.item.terms.item.children.item.relations.item collection
func (m *TermItemRequestBuilder) RelationsById(id string)(*ifedc6ac453222cdd3d35f0a05b6ea274a941883ee3b4dd56064767775eff4977.RelationItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return ifedc6ac453222cdd3d35f0a05b6ea274a941883ee3b4dd56064767775eff4977.NewRelationItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
// Set the set property
func (m *TermItemRequestBuilder) Set()(*i498e56719e05a8d66de8a9cc604e8b639e91693a0a74c168e1fc3e3b7485ba23.SetRequestBuilder) {
    return i498e56719e05a8d66de8a9cc604e8b639e91693a0a74c168e1fc3e3b7485ba23.NewSetRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
