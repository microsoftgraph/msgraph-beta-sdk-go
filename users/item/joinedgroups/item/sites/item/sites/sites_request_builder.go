...
import (
    ...
    ib1e33d299e2c50c04018a624d3f54fced229598e51464bfeb0c8ac8302f2ca42 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/sites/item/sites/count"
)
...
func NewSitesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SitesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/sites/{site%2Did}/sites{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SitesRequestBuilder) Count()(*ib1e33d299e2c50c04018a624d3f54fced229598e51464bfeb0c8ac8302f2ca42.CountRequestBuilder) {
    return ib1e33d299e2c50c04018a624d3f54fced229598e51464bfeb0c8ac8302f2ca42.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
