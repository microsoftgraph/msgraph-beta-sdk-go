...
import (
    ...
    i046fe968b78eb36def2b05c623f106f073f685861b649f717ba2015e7c50f532 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/approleassignments/count"
)
...
func NewAppRoleAssignmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AppRoleAssignmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/appRoleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AppRoleAssignmentsRequestBuilder) Count()(*i046fe968b78eb36def2b05c623f106f073f685861b649f717ba2015e7c50f532.CountRequestBuilder) {
    return i046fe968b78eb36def2b05c623f106f073f685861b649f717ba2015e7c50f532.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
