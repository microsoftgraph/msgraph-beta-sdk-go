...
import (
    ...
    i1af204a792ab699e0be8e149071e17b5a07bf8ae39ed1994acd364ec47e24d5e "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/extensions/count"
)

// ExtensionsRequestBuilder provides operations to manage the extensions property of the microsoft.graph.group entity.
...
// ExtensionsRequestBuilderGetQueryParameters the collection of open extensions defined for the group. Read-only. Nullable.
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/extensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*i1af204a792ab699e0be8e149071e17b5a07bf8ae39ed1994acd364ec47e24d5e.CountRequestBuilder) {
    return i1af204a792ab699e0be8e149071e17b5a07bf8ae39ed1994acd364ec47e24d5e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
