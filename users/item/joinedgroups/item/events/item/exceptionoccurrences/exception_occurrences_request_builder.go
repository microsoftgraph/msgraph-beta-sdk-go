...
import (
    ...
    i1f559f301ac56554d1152411ba23b8d5900a514c113f40fa52983d26d539e061 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/events/item/exceptionoccurrences/delta"
    i2b860c2ac09cd11a0837092fa1e1b9ad7c81d7cfc85153857a48788321531f14 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/events/item/exceptionoccurrences/count"
)
...
func NewExceptionOccurrencesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExceptionOccurrencesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events/{event%2Did}/exceptionOccurrences{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExceptionOccurrencesRequestBuilder) Count()(*i2b860c2ac09cd11a0837092fa1e1b9ad7c81d7cfc85153857a48788321531f14.CountRequestBuilder) {
    return i2b860c2ac09cd11a0837092fa1e1b9ad7c81d7cfc85153857a48788321531f14.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ExceptionOccurrencesRequestBuilder) Delta()(*i1f559f301ac56554d1152411ba23b8d5900a514c113f40fa52983d26d539e061.DeltaRequestBuilder) {
    return i1f559f301ac56554d1152411ba23b8d5900a514c113f40fa52983d26d539e061.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
