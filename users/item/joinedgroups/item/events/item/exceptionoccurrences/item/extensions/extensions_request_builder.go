...
import (
    ...
    if54ecc97bcbce144d75c08178582e45783786a946f8cdd456d7ec981ef432e16 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/events/item/exceptionoccurrences/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*if54ecc97bcbce144d75c08178582e45783786a946f8cdd456d7ec981ef432e16.CountRequestBuilder) {
    return if54ecc97bcbce144d75c08178582e45783786a946f8cdd456d7ec981ef432e16.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
