...
import (
    ...
    i22f5574bf8d9573e84a985541469cea7affe9ac9b27a9640356c158384669d37 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/events/item/exceptionoccurrences/item/instances/count"
    i95850d4ed9e6faff0d7832a0ea133a70907a39651d771e4ee92476522cc0c4f3 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/events/item/exceptionoccurrences/item/instances/delta"
)
...
func NewInstancesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InstancesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
...
func (m *InstancesRequestBuilder) Count()(*i22f5574bf8d9573e84a985541469cea7affe9ac9b27a9640356c158384669d37.CountRequestBuilder) {
    return i22f5574bf8d9573e84a985541469cea7affe9ac9b27a9640356c158384669d37.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *InstancesRequestBuilder) Delta()(*i95850d4ed9e6faff0d7832a0ea133a70907a39651d771e4ee92476522cc0c4f3.DeltaRequestBuilder) {
    return i95850d4ed9e6faff0d7832a0ea133a70907a39651d771e4ee92476522cc0c4f3.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
