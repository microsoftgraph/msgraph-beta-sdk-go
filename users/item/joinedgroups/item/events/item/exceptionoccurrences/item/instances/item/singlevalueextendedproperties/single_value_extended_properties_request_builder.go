...
import (
    ...
    i032ad389dac9f075d3801cf448415de7a0d2b1c7bfd9d8254765e91dacf60580 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/events/item/exceptionoccurrences/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i032ad389dac9f075d3801cf448415de7a0d2b1c7bfd9d8254765e91dacf60580.CountRequestBuilder) {
    return i032ad389dac9f075d3801cf448415de7a0d2b1c7bfd9d8254765e91dacf60580.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
