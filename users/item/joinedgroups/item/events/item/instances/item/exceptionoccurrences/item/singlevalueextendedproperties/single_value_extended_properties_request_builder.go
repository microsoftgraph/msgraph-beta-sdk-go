...
import (
    ...
    i045c455b6faee6a3d508938f7f94ddbc9e927e25edcb77ca672c0fc4a045db70 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/events/item/instances/item/exceptionoccurrences/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i045c455b6faee6a3d508938f7f94ddbc9e927e25edcb77ca672c0fc4a045db70.CountRequestBuilder) {
    return i045c455b6faee6a3d508938f7f94ddbc9e927e25edcb77ca672c0fc4a045db70.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
