...
import (
    ...
    i0919a28ba5b880706786979c65af7fa113aef147208ebe977da0e5efee44dc4a "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/events/item/instances/item/exceptionoccurrences/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*i0919a28ba5b880706786979c65af7fa113aef147208ebe977da0e5efee44dc4a.CountRequestBuilder) {
    return i0919a28ba5b880706786979c65af7fa113aef147208ebe977da0e5efee44dc4a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
