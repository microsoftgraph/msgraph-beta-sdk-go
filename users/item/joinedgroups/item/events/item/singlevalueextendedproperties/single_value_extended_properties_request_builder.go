...
import (
    ...
    i37d08aaad4a30b4d6d9a1b65908a2001c8d9e4264a1408d410d74c05b59d2c08 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/events/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/events/{event%2Did}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i37d08aaad4a30b4d6d9a1b65908a2001c8d9e4264a1408d410d74c05b59d2c08.CountRequestBuilder) {
    return i37d08aaad4a30b4d6d9a1b65908a2001c8d9e4264a1408d410d74c05b59d2c08.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
