...
import (
    ...
    i0bd1ed688f847ffbe6a920a9fedbb968efa5c640003851be626151980cbafb89 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/threads/item/posts/item/inreplyto/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/inReplyTo/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i0bd1ed688f847ffbe6a920a9fedbb968efa5c640003851be626151980cbafb89.CountRequestBuilder) {
    return i0bd1ed688f847ffbe6a920a9fedbb968efa5c640003851be626151980cbafb89.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
