...
import (
    ...
    iaefead892595b2f9d37e505765c02ef4a7aaabef306d73f4464a3c831cbc9984 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/count"
)

// DrivesRequestBuilder provides operations to manage the drives property of the microsoft.graph.group entity.
...
func NewDrivesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DrivesRequestBuilder) Count()(*iaefead892595b2f9d37e505765c02ef4a7aaabef306d73f4464a3c831cbc9984.CountRequestBuilder) {
    return iaefead892595b2f9d37e505765c02ef4a7aaabef306d73f4464a3c831cbc9984.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
