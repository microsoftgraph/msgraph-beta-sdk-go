...
import (
    ...
    i0833cfaf81ce9a89085b181a056c9aecea258476052c6896b7c9d74912a8a3e7 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/special/count"
)
...
func NewSpecialRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SpecialRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/special{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SpecialRequestBuilder) Count()(*i0833cfaf81ce9a89085b181a056c9aecea258476052c6896b7c9d74912a8a3e7.CountRequestBuilder) {
    return i0833cfaf81ce9a89085b181a056c9aecea258476052c6896b7c9d74912a8a3e7.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
