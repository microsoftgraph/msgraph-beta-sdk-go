...
import (
    ...
    ieba9a3178de109c109520640794b0591635b726200a4b66faea92e0a90fbfb08 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/list/items/item/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/driveItem{?%24select,%24expand}";
...
func (m *DriveItemRequestBuilder) Content()(*ieba9a3178de109c109520640794b0591635b726200a4b66faea92e0a90fbfb08.ContentRequestBuilder) {
    return ieba9a3178de109c109520640794b0591635b726200a4b66faea92e0a90fbfb08.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
