...
import (
    ...
    i6375a757c76f360fa47fb7b00d37d9b8285e3244357699d6f24c3a7ae964a704 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/list/items/item/activities/item/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i6375a757c76f360fa47fb7b00d37d9b8285e3244357699d6f24c3a7ae964a704.ContentRequestBuilder) {
    return i6375a757c76f360fa47fb7b00d37d9b8285e3244357699d6f24c3a7ae964a704.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
