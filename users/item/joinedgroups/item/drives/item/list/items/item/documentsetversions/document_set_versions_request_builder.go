...
import (
    ...
    iabff26afd0ad12b92751d265ac9b90866714f967c37782b5be6193415a97664f "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/list/items/item/documentsetversions/count"
)
...
func NewDocumentSetVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DocumentSetVersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DocumentSetVersionsRequestBuilder) Count()(*iabff26afd0ad12b92751d265ac9b90866714f967c37782b5be6193415a97664f.CountRequestBuilder) {
    return iabff26afd0ad12b92751d265ac9b90866714f967c37782b5be6193415a97664f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
