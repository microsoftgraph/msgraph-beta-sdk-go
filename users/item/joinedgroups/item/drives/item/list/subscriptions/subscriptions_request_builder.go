...
import (
    ...
    ifccebcdeefeab0a2edfaa830cc75a7e578fef5b055602e1433cd1741bc57e3ec "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/list/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*ifccebcdeefeab0a2edfaa830cc75a7e578fef5b055602e1433cd1741bc57e3ec.CountRequestBuilder) {
    return ifccebcdeefeab0a2edfaa830cc75a7e578fef5b055602e1433cd1741bc57e3ec.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
