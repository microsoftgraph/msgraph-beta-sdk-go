...
import (
    ...
    i4b37646da1d1b2e2857181e5d400a0323e7cef1aa78dcf02e2b377895cf5fe7f "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/list/contenttypes/item/basetypes/count"
)
...
func NewBaseTypesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BaseTypesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/baseTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *BaseTypesRequestBuilder) Count()(*i4b37646da1d1b2e2857181e5d400a0323e7cef1aa78dcf02e2b377895cf5fe7f.CountRequestBuilder) {
    return i4b37646da1d1b2e2857181e5d400a0323e7cef1aa78dcf02e2b377895cf5fe7f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
