...
import (
    ...
    i8e019603ec2782a0b581cbaa9e7a28e441b36a29d50c16f55bd62836cfdc925c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/list/contenttypes/item/columnlinks/count"
)
...
func NewColumnLinksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ColumnLinksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnLinks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ColumnLinksRequestBuilder) Count()(*i8e019603ec2782a0b581cbaa9e7a28e441b36a29d50c16f55bd62836cfdc925c.CountRequestBuilder) {
    return i8e019603ec2782a0b581cbaa9e7a28e441b36a29d50c16f55bd62836cfdc925c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
