...
import (
    ...
    ib9acd7dab413267faac155a31851a67cd89642b28dc7f3a3868a6b907d698081 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/items/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ChildrenRequestBuilder) Count()(*ib9acd7dab413267faac155a31851a67cd89642b28dc7f3a3868a6b907d698081.CountRequestBuilder) {
    return ib9acd7dab413267faac155a31851a67cd89642b28dc7f3a3868a6b907d698081.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ChildrenRequestBuilder) Get()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemCollectionResponseable, error) {
