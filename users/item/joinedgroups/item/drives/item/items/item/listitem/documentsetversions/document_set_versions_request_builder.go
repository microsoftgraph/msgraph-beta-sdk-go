...
import (
    ...
    id726c11b652dffcb4a28887711a945b9b31290d4de821cee5ab630cdc57b05f5 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/items/item/listitem/documentsetversions/count"
)
...
func NewDocumentSetVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DocumentSetVersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DocumentSetVersionsRequestBuilder) Count()(*id726c11b652dffcb4a28887711a945b9b31290d4de821cee5ab630cdc57b05f5.CountRequestBuilder) {
    return id726c11b652dffcb4a28887711a945b9b31290d4de821cee5ab630cdc57b05f5.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
