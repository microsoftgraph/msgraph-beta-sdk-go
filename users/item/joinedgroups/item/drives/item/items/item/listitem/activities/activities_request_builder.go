...
import (
    ...
    i467f925ac935a1ed070d05a832ef77f5bc8582b8b98f7712d01b914048aabe44 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/items/item/listitem/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i467f925ac935a1ed070d05a832ef77f5bc8582b8b98f7712d01b914048aabe44.CountRequestBuilder) {
    return i467f925ac935a1ed070d05a832ef77f5bc8582b8b98f7712d01b914048aabe44.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
