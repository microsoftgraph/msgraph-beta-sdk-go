...
import (
    ...
    ibce7c05de14fc456eeaa23d08086107645a3d031f8d9b5bd81b4661eb94f03f2 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/items/item/children/item/content"
)

// DriveItemItemRequestBuilder provides operations to manage the children property of the microsoft.graph.driveItem entity.
...
// DriveItemItemRequestBuilderGetQueryParameters collection containing Item objects for the immediate children of Item. Only items representing folders have children. Read-only. Nullable.
...
func NewDriveItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/children/{driveItem%2Did1}{?%24select,%24expand}";
...
func (m *DriveItemItemRequestBuilder) Content()(*ibce7c05de14fc456eeaa23d08086107645a3d031f8d9b5bd81b4661eb94f03f2.ContentRequestBuilder) {
    return ibce7c05de14fc456eeaa23d08086107645a3d031f8d9b5bd81b4661eb94f03f2.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
