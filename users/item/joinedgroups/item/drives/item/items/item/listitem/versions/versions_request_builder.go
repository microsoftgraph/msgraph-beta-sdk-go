...
import (
    ...
    i666c5eac4735f719b2a3a8ef766d095847b5a6eca33db8cb0314560f76955585 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/items/item/listitem/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *VersionsRequestBuilder) Count()(*i666c5eac4735f719b2a3a8ef766d095847b5a6eca33db8cb0314560f76955585.CountRequestBuilder) {
    return i666c5eac4735f719b2a3a8ef766d095847b5a6eca33db8cb0314560f76955585.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
