...
import (
    ...
    i608ffa51c8fc76c82a92d9e31d877aeed20d4e969d1e2b0c7896ddcbee56762c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/root/listitem/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/listItem/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *VersionsRequestBuilder) Count()(*i608ffa51c8fc76c82a92d9e31d877aeed20d4e969d1e2b0c7896ddcbee56762c.CountRequestBuilder) {
    return i608ffa51c8fc76c82a92d9e31d877aeed20d4e969d1e2b0c7896ddcbee56762c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
