...
import (
    ...
    i160a596d9b7149f3b2f7f8d8da7891bf2d3130f8cdd26813aac637d5335dfaf8 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/root/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*i160a596d9b7149f3b2f7f8d8da7891bf2d3130f8cdd26813aac637d5335dfaf8.CountRequestBuilder) {
    return i160a596d9b7149f3b2f7f8d8da7891bf2d3130f8cdd26813aac637d5335dfaf8.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to subscriptions for users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to subscriptions for users
