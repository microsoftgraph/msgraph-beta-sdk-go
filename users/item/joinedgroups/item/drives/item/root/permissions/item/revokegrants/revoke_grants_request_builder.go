...
func NewRevokeGrantsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RevokeGrantsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/root/permissions/{permission%2Did}/microsoft.graph.revokeGrants";
...
func (m *RevokeGrantsRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body RevokeGrantsRequestBodyable, requestConfiguration *RevokeGrantsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
