...
import (
    ...
    ie0562629b79f87c0be6bd7bfd826416f40b3429690cf3c449b3659d0abc50a0e "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/drives/item/bundles/count"
)
...
func NewBundlesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BundlesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/drives/{drive%2Did}/bundles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *BundlesRequestBuilder) Count()(*ie0562629b79f87c0be6bd7bfd826416f40b3429690cf3c449b3659d0abc50a0e.CountRequestBuilder) {
    return ie0562629b79f87c0be6bd7bfd826416f40b3429690cf3c449b3659d0abc50a0e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *BundlesRequestBuilder) Get()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemCollectionResponseable, error) {
