...
import (
    ...
    ia953983b590f780ff17635f6d95ff729399a0d3dddb83c8a051347d6c2253c96 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/planner/plans/item/tasks/count"
)
...
func NewTasksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TasksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *TasksRequestBuilder) Count()(*ia953983b590f780ff17635f6d95ff729399a0d3dddb83c8a051347d6c2253c96.CountRequestBuilder) {
    return ia953983b590f780ff17635f6d95ff729399a0d3dddb83c8a051347d6c2253c96.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
