...
import (
    ...
    i751bb19fd091f92466e5df4a2c5b0a71e836910d9a937d4d5ab49628e4c5dc10 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/planner/plans/item/buckets/count"
)
...
func NewBucketsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BucketsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *BucketsRequestBuilder) Count()(*i751bb19fd091f92466e5df4a2c5b0a71e836910d9a937d4d5ab49628e4c5dc10.CountRequestBuilder) {
    return i751bb19fd091f92466e5df4a2c5b0a71e836910d9a937d4d5ab49628e4c5dc10.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to buckets for users
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to buckets for users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to buckets for users
