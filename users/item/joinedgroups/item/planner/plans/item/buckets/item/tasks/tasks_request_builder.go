...
import (
    ...
    i26b2fa6a646ff36c004f875b73f5696792aa3c8504a31ed96bf9810256cc3f8a "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/planner/plans/item/buckets/item/tasks/count"
)
...
func NewTasksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TasksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *TasksRequestBuilder) Count()(*i26b2fa6a646ff36c004f875b73f5696792aa3c8504a31ed96bf9810256cc3f8a.CountRequestBuilder) {
    return i26b2fa6a646ff36c004f875b73f5696792aa3c8504a31ed96bf9810256cc3f8a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
