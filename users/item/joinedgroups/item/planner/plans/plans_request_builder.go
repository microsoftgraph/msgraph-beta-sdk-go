...
import (
    ...
    ie6f737ee0dc8be653a06d107c9bc33de5904388472fd46132a76a48420329135 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/planner/plans/count"
)
...
func NewPlansRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PlansRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/planner/plans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PlansRequestBuilder) Count()(*ie6f737ee0dc8be653a06d107c9bc33de5904388472fd46132a76a48420329135.CountRequestBuilder) {
    return ie6f737ee0dc8be653a06d107c9bc33de5904388472fd46132a76a48420329135.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to plans for users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to plans for users
