...
import (
    ...
    i94a37e14e738c4a1c02be8824e7317a96331ea8b5b60da3b6a3539b75e9f3e57 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/owners/count"
)
...
func NewOwnersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OwnersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *OwnersRequestBuilder) Count()(*i94a37e14e738c4a1c02be8824e7317a96331ea8b5b60da3b6a3539b75e9f3e57.CountRequestBuilder) {
    return i94a37e14e738c4a1c02be8824e7317a96331ea8b5b60da3b6a3539b75e9f3e57.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
