...
import (
    ...
    ia4dad56f02baf47233ce96e583bdb5d1e64e7bb23faaa629b7666a0d98c69154 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/onenote/resources/count"
)
...
func NewResourcesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ResourcesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/resources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ResourcesRequestBuilder) Count()(*ia4dad56f02baf47233ce96e583bdb5d1e64e7bb23faaa629b7666a0d98c69154.CountRequestBuilder) {
    return ia4dad56f02baf47233ce96e583bdb5d1e64e7bb23faaa629b7666a0d98c69154.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
