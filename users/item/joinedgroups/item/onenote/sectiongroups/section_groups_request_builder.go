...
import (
    ...
    i9fde77f2c6c0be870e0db4f2775373e95c31fb093e084fc0429ca44da6d09f65 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/onenote/sectiongroups/count"
)
...
func NewSectionGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SectionGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SectionGroupsRequestBuilder) Count()(*i9fde77f2c6c0be870e0db4f2775373e95c31fb093e084fc0429ca44da6d09f65.CountRequestBuilder) {
    return i9fde77f2c6c0be870e0db4f2775373e95c31fb093e084fc0429ca44da6d09f65.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
