...
import (
    ...
    ideceb18a40cdf1ec406add81265f7b4b49dfb1369541d85f2376cbfab9fd79d0 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/onenote/sectiongroups/item/sectiongroups/count"
)
...
func NewSectionGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SectionGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SectionGroupsRequestBuilder) Count()(*ideceb18a40cdf1ec406add81265f7b4b49dfb1369541d85f2376cbfab9fd79d0.CountRequestBuilder) {
    return ideceb18a40cdf1ec406add81265f7b4b49dfb1369541d85f2376cbfab9fd79d0.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
