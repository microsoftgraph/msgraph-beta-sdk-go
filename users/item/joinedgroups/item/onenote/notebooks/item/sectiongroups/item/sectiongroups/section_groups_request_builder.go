...
import (
    ...
    ie21c30ef67f43dbf77b7eb62f3e4a2c2c8f96d27bd41d2757318b78952601d71 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/onenote/notebooks/item/sectiongroups/item/sectiongroups/count"
)
...
func NewSectionGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SectionGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SectionGroupsRequestBuilder) Count()(*ie21c30ef67f43dbf77b7eb62f3e4a2c2c8f96d27bd41d2757318b78952601d71.CountRequestBuilder) {
    return ie21c30ef67f43dbf77b7eb62f3e4a2c2c8f96d27bd41d2757318b78952601d71.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
