...
import (
    ...
    i4b420e1018d5fd9d935447e17f12d7e553a3dbde8f9a7de7f4985b431b22bf2b "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/onenote/notebooks/item/sectiongroups/item/sections/count"
)
...
func NewSectionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SectionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SectionsRequestBuilder) Count()(*i4b420e1018d5fd9d935447e17f12d7e553a3dbde8f9a7de7f4985b431b22bf2b.CountRequestBuilder) {
    return i4b420e1018d5fd9d935447e17f12d7e553a3dbde8f9a7de7f4985b431b22bf2b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
