...
import (
    ...
    i77a7fc6bcaea1687a0588f56db8ba90f4964c5bc8f0d762b82060505f783c0be "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/onenote/notebooks/item/sectiongroups/count"
)
...
func NewSectionGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SectionGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SectionGroupsRequestBuilder) Count()(*i77a7fc6bcaea1687a0588f56db8ba90f4964c5bc8f0d762b82060505f783c0be.CountRequestBuilder) {
    return i77a7fc6bcaea1687a0588f56db8ba90f4964c5bc8f0d762b82060505f783c0be.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
