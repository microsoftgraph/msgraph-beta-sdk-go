...
import (
    ...
    i2c951aa3568f84ff91c410120657e56c201ada53ab38c23bf433a9db297d41c7 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/onenote/notebooks/getnotebookfromweburl"
    i5b2f9d5503ddd4507c975c7599fa19a21a51de92c532d4f57eaa7bdb1d4e0743 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/onenote/notebooks/getrecentnotebookswithincludepersonalnotebooks"
    ibe2d4b4a6bc71626e146b8993c826ebdba651ee165be6ce3ef2fe3dfe45659b2 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/onenote/notebooks/count"
)
...
func NewNotebooksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*NotebooksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *NotebooksRequestBuilder) Count()(*ibe2d4b4a6bc71626e146b8993c826ebdba651ee165be6ce3ef2fe3dfe45659b2.CountRequestBuilder) {
    return ibe2d4b4a6bc71626e146b8993c826ebdba651ee165be6ce3ef2fe3dfe45659b2.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *NotebooksRequestBuilder) GetNotebookFromWebUrl()(*i2c951aa3568f84ff91c410120657e56c201ada53ab38c23bf433a9db297d41c7.GetNotebookFromWebUrlRequestBuilder) {
    return i2c951aa3568f84ff91c410120657e56c201ada53ab38c23bf433a9db297d41c7.NewGetNotebookFromWebUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// GetRecentNotebooksWithIncludePersonalNotebooks provides operations to call the getRecentNotebooks method.
func (m *NotebooksRequestBuilder) GetRecentNotebooksWithIncludePersonalNotebooks(includePersonalNotebooks *bool)(*i5b2f9d5503ddd4507c975c7599fa19a21a51de92c532d4f57eaa7bdb1d4e0743.GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder) {
    return i5b2f9d5503ddd4507c975c7599fa19a21a51de92c532d4f57eaa7bdb1d4e0743.NewGetRecentNotebooksWithIncludePersonalNotebooksRequestBuilderInternal(m.pathParameters, m.requestAdapter, includePersonalNotebooks);
}
