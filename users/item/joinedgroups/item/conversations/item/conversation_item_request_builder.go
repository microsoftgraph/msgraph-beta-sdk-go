...
import (
    ...
    i50274fc5d1beab1123996d2c0419d100aec33cb42eb62535622ec8dc31cfbf45 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/conversations/item/threads"
    i02454e3aff45fe504fe837dc8ce6a685274f64c653a1f33403f87bbefc52281c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/conversations/item/threads/item"
)
...
func NewConversationItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConversationItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/conversations/{conversation%2Did}{?%24select}";
...
// CreateDeleteRequestInformation delete navigation property conversations for users
...
// CreateDeleteRequestInformationWithRequestConfiguration delete navigation property conversations for users
...
// CreatePatchRequestInformation update the navigation property conversations in users
...
// CreatePatchRequestInformationWithRequestConfiguration update the navigation property conversations in users
...
// Delete delete navigation property conversations for users
func (m *ConversationItemRequestBuilder) Delete()(error) {
    return m.DeleteWithRequestConfigurationAndResponseHandler(nil, nil);
}
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property conversations for users
...
// Patch update the navigation property conversations in users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property conversations in users
...
func (m *ConversationItemRequestBuilder) Threads()(*i50274fc5d1beab1123996d2c0419d100aec33cb42eb62535622ec8dc31cfbf45.ThreadsRequestBuilder) {
    return i50274fc5d1beab1123996d2c0419d100aec33cb42eb62535622ec8dc31cfbf45.NewThreadsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ThreadsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.users.item.joinedGroups.item.conversations.item.threads.item collection
func (m *ConversationItemRequestBuilder) ThreadsById(id string)(*i02454e3aff45fe504fe837dc8ce6a685274f64c653a1f33403f87bbefc52281c.ConversationThreadItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i02454e3aff45fe504fe837dc8ce6a685274f64c653a1f33403f87bbefc52281c.NewConversationThreadItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
