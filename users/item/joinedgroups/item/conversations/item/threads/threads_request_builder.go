...
import (
    ...
    ia8af7f33176ef5ec44aaaa736832700163abf88ef9c5b952fe1b2a2e2873e168 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/conversations/item/threads/count"
)
...
func NewThreadsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreadsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/conversations/{conversation%2Did}/threads{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ThreadsRequestBuilder) Count()(*ia8af7f33176ef5ec44aaaa736832700163abf88ef9c5b952fe1b2a2e2873e168.CountRequestBuilder) {
    return ia8af7f33176ef5ec44aaaa736832700163abf88ef9c5b952fe1b2a2e2873e168.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
