...
import (
    ...
    i5ddbcf5e6bb1b598654962490b28dab90505b560fddeebffa11a3e56da5f3015 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/conversations/item/threads/item/posts/count"
)
...
func NewPostsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PostsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PostsRequestBuilder) Count()(*i5ddbcf5e6bb1b598654962490b28dab90505b560fddeebffa11a3e56da5f3015.CountRequestBuilder) {
    return i5ddbcf5e6bb1b598654962490b28dab90505b560fddeebffa11a3e56da5f3015.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
