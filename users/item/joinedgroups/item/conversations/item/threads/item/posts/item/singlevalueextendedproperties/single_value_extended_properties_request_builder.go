...
import (
    ...
    i5d2569b2a67166c16dbfc32f368fb3a81db857d001bb3197cfee71a9a1fae865 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/conversations/item/threads/item/posts/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i5d2569b2a67166c16dbfc32f368fb3a81db857d001bb3197cfee71a9a1fae865.CountRequestBuilder) {
    return i5d2569b2a67166c16dbfc32f368fb3a81db857d001bb3197cfee71a9a1fae865.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
