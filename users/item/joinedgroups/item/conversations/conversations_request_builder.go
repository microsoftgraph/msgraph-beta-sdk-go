...
import (
    ...
    i33e787dcc9679d383fae9664b0bbdfc359f26b3103caa242207b93ff19280767 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/conversations/count"
)
...
func NewConversationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConversationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/conversations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
...
func (m *ConversationsRequestBuilder) Count()(*i33e787dcc9679d383fae9664b0bbdfc359f26b3103caa242207b93ff19280767.CountRequestBuilder) {
    return i33e787dcc9679d383fae9664b0bbdfc359f26b3103caa242207b93ff19280767.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to conversations for users
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to conversations for users
...
// Post create new navigation property to conversations for users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to conversations for users
