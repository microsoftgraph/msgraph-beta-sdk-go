...
import (
    ...
    icc1d0c8879135b5c8fa8b7516a1926fb6609fea6286bd93622eaf9126e9ffeb5 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/rejectedsenders/count"
)
...
func NewRejectedSendersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RejectedSendersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/rejectedSenders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
...
func (m *RejectedSendersRequestBuilder) Count()(*icc1d0c8879135b5c8fa8b7516a1926fb6609fea6286bd93622eaf9126e9ffeb5.CountRequestBuilder) {
    return icc1d0c8879135b5c8fa8b7516a1926fb6609fea6286bd93622eaf9126e9ffeb5.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
