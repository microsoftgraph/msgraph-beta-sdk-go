...
import (
    ...
    ie2bab7a17c3af5106e6eb4d83ffb48c045be6a9029ca43fd762a0e944924a4e6 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/memberswithlicenseerrors/count"
)
...
func NewMembersWithLicenseErrorsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MembersWithLicenseErrorsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/membersWithLicenseErrors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *MembersWithLicenseErrorsRequestBuilder) Count()(*ie2bab7a17c3af5106e6eb4d83ffb48c045be6a9029ca43fd762a0e944924a4e6.CountRequestBuilder) {
    return ie2bab7a17c3af5106e6eb4d83ffb48c045be6a9029ca43fd762a0e944924a4e6.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
