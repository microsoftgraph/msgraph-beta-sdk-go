...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/photo/$value";
...
// CreateGetRequestInformationWithRequestConfiguration get media content for the navigation property photo from users
...
// CreatePutRequestInformationWithRequestConfiguration update media content for the navigation property photo in users
...
// GetWithRequestConfigurationAndResponseHandler get media content for the navigation property photo from users
...
// PutWithRequestConfigurationAndResponseHandler update media content for the navigation property photo in users
