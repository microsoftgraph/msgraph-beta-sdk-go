...
import (
    ...
    ibcc2d9780db25ca507e114c1431ead696a224eb0f58b68b32118dbd217c574d4 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/acceptedsenders/count"
)
...
func NewAcceptedSendersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AcceptedSendersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/acceptedSenders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
...
func (m *AcceptedSendersRequestBuilder) Count()(*ibcc2d9780db25ca507e114c1431ead696a224eb0f58b68b32118dbd217c574d4.CountRequestBuilder) {
    return ibcc2d9780db25ca507e114c1431ead696a224eb0f58b68b32118dbd217c574d4.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
