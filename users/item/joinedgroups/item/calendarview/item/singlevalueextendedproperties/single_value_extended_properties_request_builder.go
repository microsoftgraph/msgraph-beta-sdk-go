...
import (
    ...
    i5a953508dc691ef8ed70ec8113eceef99a6d55b029dda8ae1999b550871ff06e "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendarview/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView/{event%2Did}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i5a953508dc691ef8ed70ec8113eceef99a6d55b029dda8ae1999b550871ff06e.CountRequestBuilder) {
    return i5a953508dc691ef8ed70ec8113eceef99a6d55b029dda8ae1999b550871ff06e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
