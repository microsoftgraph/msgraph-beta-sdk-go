...
import (
    ...
    i7b741a084675628982b27553b668b53cf25eb71b401ec53d4d0c9b6ea953d50c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendarview/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i7b741a084675628982b27553b668b53cf25eb71b401ec53d4d0c9b6ea953d50c.CountRequestBuilder) {
    return i7b741a084675628982b27553b668b53cf25eb71b401ec53d4d0c9b6ea953d50c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
