...
import (
    ...
    if75a0dbee1d7cf509d4ae4692f0b2fdd353c068cc45264d48ae23de6e4e4514e "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendarview/item/instances/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*if75a0dbee1d7cf509d4ae4692f0b2fdd353c068cc45264d48ae23de6e4e4514e.CountRequestBuilder) {
    return if75a0dbee1d7cf509d4ae4692f0b2fdd353c068cc45264d48ae23de6e4e4514e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
