...
import (
    ...
    i255a83dcb8d6750383152912bb92d4d88e81b1685dfd58e81f904ae1ec4400fe "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendarview/item/instances/item/exceptionoccurrences/item/attachments/count"
    if13fcdf6bbb7afdf946ec854b2b31aed2d3a5c5e304b570d7b2ae9732ae5a03d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendarview/item/instances/item/exceptionoccurrences/item/attachments/createuploadsession"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*i255a83dcb8d6750383152912bb92d4d88e81b1685dfd58e81f904ae1ec4400fe.CountRequestBuilder) {
    return i255a83dcb8d6750383152912bb92d4d88e81b1685dfd58e81f904ae1ec4400fe.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*if13fcdf6bbb7afdf946ec854b2b31aed2d3a5c5e304b570d7b2ae9732ae5a03d.CreateUploadSessionRequestBuilder) {
    return if13fcdf6bbb7afdf946ec854b2b31aed2d3a5c5e304b570d7b2ae9732ae5a03d.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
