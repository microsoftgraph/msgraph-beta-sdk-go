...
import (
    ...
    i2c20c091d9866dcf694aa9587ad437292368e6cfdf1fb58c723cc4a1e47d079c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendarview/count"
    iab39aae88afd728f43a8eb0590e0547690efa7230325bb99c3d5df0d1d353a3f "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendarview/delta"
)
...
func NewCalendarViewRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CalendarViewRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendarView{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
...
func (m *CalendarViewRequestBuilder) Count()(*i2c20c091d9866dcf694aa9587ad437292368e6cfdf1fb58c723cc4a1e47d079c.CountRequestBuilder) {
    return i2c20c091d9866dcf694aa9587ad437292368e6cfdf1fb58c723cc4a1e47d079c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *CalendarViewRequestBuilder) Delta()(*iab39aae88afd728f43a8eb0590e0547690efa7230325bb99c3d5df0d1d353a3f.DeltaRequestBuilder) {
    return iab39aae88afd728f43a8eb0590e0547690efa7230325bb99c3d5df0d1d353a3f.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
