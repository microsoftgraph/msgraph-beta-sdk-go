...
func NewGroupLifecyclePolicyItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupLifecyclePolicyItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/groupLifecyclePolicies/{groupLifecyclePolicy%2Did}{?%24select,%24expand}";
...
// CreateDeleteRequestInformation delete navigation property groupLifecyclePolicies for users
...
// CreateDeleteRequestInformationWithRequestConfiguration delete navigation property groupLifecyclePolicies for users
...
// CreatePatchRequestInformation update the navigation property groupLifecyclePolicies in users
...
// CreatePatchRequestInformationWithRequestConfiguration update the navigation property groupLifecyclePolicies in users
...
// Delete delete navigation property groupLifecyclePolicies for users
func (m *GroupLifecyclePolicyItemRequestBuilder) Delete()(error) {
    return m.DeleteWithRequestConfigurationAndResponseHandler(nil, nil);
}
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property groupLifecyclePolicies for users
...
// Patch update the navigation property groupLifecyclePolicies in users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property groupLifecyclePolicies in users
