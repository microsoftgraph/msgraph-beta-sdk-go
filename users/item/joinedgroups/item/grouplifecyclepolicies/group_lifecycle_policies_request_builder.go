...
import (
    ...
    i96f746266fb4ecee879032cdd48abad2485636bb2b23d3d72149a977c77ee5bc "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/grouplifecyclepolicies/count"
)
...
func NewGroupLifecyclePoliciesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupLifecyclePoliciesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/groupLifecyclePolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *GroupLifecyclePoliciesRequestBuilder) Count()(*i96f746266fb4ecee879032cdd48abad2485636bb2b23d3d72149a977c77ee5bc.CountRequestBuilder) {
    return i96f746266fb4ecee879032cdd48abad2485636bb2b23d3d72149a977c77ee5bc.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to groupLifecyclePolicies for users
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to groupLifecyclePolicies for users
...
// Post create new navigation property to groupLifecyclePolicies for users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to groupLifecyclePolicies for users
