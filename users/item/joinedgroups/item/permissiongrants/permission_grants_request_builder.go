...
import (
    ...
    i1d5a8d5997f937a70eb65dcc9c5be138f54b3f7745621f84ce337dcd1ee984c6 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/permissiongrants/count"
)
...
func NewPermissionGrantsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissionGrantsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PermissionGrantsRequestBuilder) Count()(*i1d5a8d5997f937a70eb65dcc9c5be138f54b3f7745621f84ce337dcd1ee984c6.CountRequestBuilder) {
    return i1d5a8d5997f937a70eb65dcc9c5be138f54b3f7745621f84ce337dcd1ee984c6.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
