...
import (
    ...
    i1477803d2dc94eefded6a9005467592bb6bc9c31a29c48e81a9e950f4414837a "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/memberof/count"
)
...
func NewMemberOfRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MemberOfRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *MemberOfRequestBuilder) Count()(*i1477803d2dc94eefded6a9005467592bb6bc9c31a29c48e81a9e950f4414837a.CountRequestBuilder) {
    return i1477803d2dc94eefded6a9005467592bb6bc9c31a29c48e81a9e950f4414837a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
