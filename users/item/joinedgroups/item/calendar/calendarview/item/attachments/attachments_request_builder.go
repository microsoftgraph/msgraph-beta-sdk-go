...
import (
    ...
    i8b78ab5aae970b6f98f5b069004ea2d727781ddf659aa280caaf827b5eeee661 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendar/calendarview/item/attachments/createuploadsession"
    if013daec0afa80907df3eaea67085ba03d8fad6db8b54a1a38b78ca27fdffa75 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendar/calendarview/item/attachments/count"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*if013daec0afa80907df3eaea67085ba03d8fad6db8b54a1a38b78ca27fdffa75.CountRequestBuilder) {
    return if013daec0afa80907df3eaea67085ba03d8fad6db8b54a1a38b78ca27fdffa75.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*i8b78ab5aae970b6f98f5b069004ea2d727781ddf659aa280caaf827b5eeee661.CreateUploadSessionRequestBuilder) {
    return i8b78ab5aae970b6f98f5b069004ea2d727781ddf659aa280caaf827b5eeee661.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
