...
import (
    ...
    i30dc3df16d08f0adb52512062e223fd345ecb0bd6c614743531ebd0dcff257f9 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendar/calendarview/item/exceptionoccurrences/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*i30dc3df16d08f0adb52512062e223fd345ecb0bd6c614743531ebd0dcff257f9.CountRequestBuilder) {
    return i30dc3df16d08f0adb52512062e223fd345ecb0bd6c614743531ebd0dcff257f9.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
