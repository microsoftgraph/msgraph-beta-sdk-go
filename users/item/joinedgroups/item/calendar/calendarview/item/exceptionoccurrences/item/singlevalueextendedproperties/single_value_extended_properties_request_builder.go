...
import (
    ...
    i0228fa79c91d980c90f4b0393a31a94cce8b4432e9c7e5f581efacc2c18f225f "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendar/calendarview/item/exceptionoccurrences/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i0228fa79c91d980c90f4b0393a31a94cce8b4432e9c7e5f581efacc2c18f225f.CountRequestBuilder) {
    return i0228fa79c91d980c90f4b0393a31a94cce8b4432e9c7e5f581efacc2c18f225f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
