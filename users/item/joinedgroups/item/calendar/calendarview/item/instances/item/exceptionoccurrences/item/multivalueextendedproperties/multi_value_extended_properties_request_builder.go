...
import (
    ...
    ic6fa255cd267ee1fc772ca74ae2aa91f79f56c961ceafd1fd451766d46fc48cc "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendar/calendarview/item/instances/item/exceptionoccurrences/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*ic6fa255cd267ee1fc772ca74ae2aa91f79f56c961ceafd1fd451766d46fc48cc.CountRequestBuilder) {
    return ic6fa255cd267ee1fc772ca74ae2aa91f79f56c961ceafd1fd451766d46fc48cc.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
