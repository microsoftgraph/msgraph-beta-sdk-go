...
import (
    ...
    if611f68e1dda4cb13b0f4c636e8c9eb41a220a8f3417b507d4bf9b6d3d6160b9 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendar/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*if611f68e1dda4cb13b0f4c636e8c9eb41a220a8f3417b507d4bf9b6d3d6160b9.CountRequestBuilder) {
    return if611f68e1dda4cb13b0f4c636e8c9eb41a220a8f3417b507d4bf9b6d3d6160b9.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
