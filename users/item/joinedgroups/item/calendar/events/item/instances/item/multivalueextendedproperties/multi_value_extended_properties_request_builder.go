...
import (
    ...
    i6c8deb2750bf42086d1ed5a630c6671a83c451045e37c376219127d4bebc6e1a "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendar/events/item/instances/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*i6c8deb2750bf42086d1ed5a630c6671a83c451045e37c376219127d4bebc6e1a.CountRequestBuilder) {
    return i6c8deb2750bf42086d1ed5a630c6671a83c451045e37c376219127d4bebc6e1a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
