...
import (
    ...
    ifbfcf629c74edb6f057fd9162a932e641e379473b556e68ef616136537130ca6 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendar/events/item/exceptionoccurrences/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*ifbfcf629c74edb6f057fd9162a932e641e379473b556e68ef616136537130ca6.CountRequestBuilder) {
    return ifbfcf629c74edb6f057fd9162a932e641e379473b556e68ef616136537130ca6.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
