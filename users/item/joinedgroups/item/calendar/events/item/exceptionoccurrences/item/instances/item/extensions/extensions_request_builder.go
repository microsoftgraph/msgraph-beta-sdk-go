...
import (
    ...
    i73c8c59638a8dd256b11f1620a79e7d900b0bf5164fd0731d806f9155064221a "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/calendar/events/item/exceptionoccurrences/item/instances/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*i73c8c59638a8dd256b11f1620a79e7d900b0bf5164fd0731d806f9155064221a.CountRequestBuilder) {
    return i73c8c59638a8dd256b11f1620a79e7d900b0bf5164fd0731d806f9155064221a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
