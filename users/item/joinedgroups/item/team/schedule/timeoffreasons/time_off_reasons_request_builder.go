...
import (
    ...
    i47c5e89ddfed26ef4e221cc7165ed4250d9e8a7b0699addfccd5dcb401e82a9d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/schedule/timeoffreasons/count"
)
...
func NewTimeOffReasonsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TimeOffReasonsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/schedule/timeOffReasons{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
...
func (m *TimeOffReasonsRequestBuilder) Count()(*i47c5e89ddfed26ef4e221cc7165ed4250d9e8a7b0699addfccd5dcb401e82a9d.CountRequestBuilder) {
    return i47c5e89ddfed26ef4e221cc7165ed4250d9e8a7b0699addfccd5dcb401e82a9d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to timeOffReasons for users
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to timeOffReasons for users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to timeOffReasons for users
