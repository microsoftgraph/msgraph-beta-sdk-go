...
import (
    ...
    iedaf3ccfa40cfa5304f84a8dbe9b50b55c0a57d475a3f6a16b4740044741d51c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/schedule/schedulinggroups/count"
)
...
func NewSchedulingGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SchedulingGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/schedule/schedulingGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
...
func (m *SchedulingGroupsRequestBuilder) Count()(*iedaf3ccfa40cfa5304f84a8dbe9b50b55c0a57d475a3f6a16b4740044741d51c.CountRequestBuilder) {
    return iedaf3ccfa40cfa5304f84a8dbe9b50b55c0a57d475a3f6a16b4740044741d51c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to schedulingGroups for users
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to schedulingGroups for users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to schedulingGroups for users
