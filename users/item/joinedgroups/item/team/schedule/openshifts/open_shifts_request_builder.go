...
import (
    ...
    icdd57f5ea99a5ddde61f4750af9a9c5318bb9f271ad8b53660634ae1428dc437 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/schedule/openshifts/count"
)
...
// OpenShiftsRequestBuilderGetQueryParameters get openShifts from users
...
func NewOpenShiftsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OpenShiftsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/schedule/openShifts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *OpenShiftsRequestBuilder) Count()(*icdd57f5ea99a5ddde61f4750af9a9c5318bb9f271ad8b53660634ae1428dc437.CountRequestBuilder) {
    return icdd57f5ea99a5ddde61f4750af9a9c5318bb9f271ad8b53660634ae1428dc437.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to openShifts for users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to openShifts for users
