...
import (
    ...
    ifb22c4fc8b390288489230498b886dba380d75eaace9aae2e06ec837d269bd7f "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/schedule/shifts/count"
)
...
func NewShiftsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ShiftsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/schedule/shifts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
...
func (m *ShiftsRequestBuilder) Count()(*ifb22c4fc8b390288489230498b886dba380d75eaace9aae2e06ec837d269bd7f.CountRequestBuilder) {
    return ifb22c4fc8b390288489230498b886dba380d75eaace9aae2e06ec837d269bd7f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
