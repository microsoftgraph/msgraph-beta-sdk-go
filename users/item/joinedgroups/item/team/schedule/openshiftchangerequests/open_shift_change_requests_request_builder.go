...
import (
    ...
    iaebdb9c7d010fe4afa8a6912c2d1fb2f3bd16ddd91c8eb7eaf36df21379e9639 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/schedule/openshiftchangerequests/count"
)
...
func NewOpenShiftChangeRequestsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OpenShiftChangeRequestsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/schedule/openShiftChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *OpenShiftChangeRequestsRequestBuilder) Count()(*iaebdb9c7d010fe4afa8a6912c2d1fb2f3bd16ddd91c8eb7eaf36df21379e9639.CountRequestBuilder) {
    return iaebdb9c7d010fe4afa8a6912c2d1fb2f3bd16ddd91c8eb7eaf36df21379e9639.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
