...
import (
    ...
    ie308df116c63772616c4ede2f3efe16ccb6e0f77f7fbcdd14a90bbc58c96a165 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/primarychannel/sharedwithteams/count"
)
...
func NewSharedWithTeamsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharedWithTeamsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/primaryChannel/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SharedWithTeamsRequestBuilder) Count()(*ie308df116c63772616c4ede2f3efe16ccb6e0f77f7fbcdd14a90bbc58c96a165.CountRequestBuilder) {
    return ie308df116c63772616c4ede2f3efe16ccb6e0f77f7fbcdd14a90bbc58c96a165.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
