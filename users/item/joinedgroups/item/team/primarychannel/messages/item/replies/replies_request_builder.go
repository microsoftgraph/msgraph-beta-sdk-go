...
import (
    ...
    i2b3ebdbf2084f8739d24db2cf5935e6cc4d36934f9b442b4e30877a7a3e07862 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/primarychannel/messages/item/replies/delta"
    i5e4b54067ebb2050e5495f8a2ffb095eb8a3d7cad3ab9759ba0a562aa102d73d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/primarychannel/messages/item/replies/count"
)
...
func NewRepliesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RepliesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *RepliesRequestBuilder) Count()(*i5e4b54067ebb2050e5495f8a2ffb095eb8a3d7cad3ab9759ba0a562aa102d73d.CountRequestBuilder) {
    return i5e4b54067ebb2050e5495f8a2ffb095eb8a3d7cad3ab9759ba0a562aa102d73d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *RepliesRequestBuilder) Delta()(*i2b3ebdbf2084f8739d24db2cf5935e6cc4d36934f9b442b4e30877a7a3e07862.DeltaRequestBuilder) {
    return i2b3ebdbf2084f8739d24db2cf5935e6cc4d36934f9b442b4e30877a7a3e07862.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
