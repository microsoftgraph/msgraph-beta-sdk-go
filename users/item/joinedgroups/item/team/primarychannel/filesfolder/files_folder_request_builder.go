...
import (
    ...
    i7c5d672c4287a366f25c8ba5c558e04b07efb43526ec7bad6df2393b04666089 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/primarychannel/filesfolder/content"
)
...
func NewFilesFolderRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FilesFolderRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/primaryChannel/filesFolder{?%24select,%24expand}";
...
func (m *FilesFolderRequestBuilder) Content()(*i7c5d672c4287a366f25c8ba5c558e04b07efb43526ec7bad6df2393b04666089.ContentRequestBuilder) {
    return i7c5d672c4287a366f25c8ba5c558e04b07efb43526ec7bad6df2393b04666089.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
