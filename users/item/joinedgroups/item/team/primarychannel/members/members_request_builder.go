...
import (
    ...
    i3c1be7ede228dee7a7c8acd64550b002e19653c8dd912dd5d3288cd2d780cb09 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/primarychannel/members/add"
    if05fdd24649acd438fd930d115c3fd3c7e641da206a4da30b6bb017b9adfa340 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/primarychannel/members/count"
)
...
func (m *MembersRequestBuilder) Add()(*i3c1be7ede228dee7a7c8acd64550b002e19653c8dd912dd5d3288cd2d780cb09.AddRequestBuilder) {
    return i3c1be7ede228dee7a7c8acd64550b002e19653c8dd912dd5d3288cd2d780cb09.NewAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/primaryChannel/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *MembersRequestBuilder) Count()(*if05fdd24649acd438fd930d115c3fd3c7e641da206a4da30b6bb017b9adfa340.CountRequestBuilder) {
    return if05fdd24649acd438fd930d115c3fd3c7e641da206a4da30b6bb017b9adfa340.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
