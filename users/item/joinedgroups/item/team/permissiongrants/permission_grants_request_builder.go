...
import (
    ...
    i590d5c5a9f95aeba73f1ac38f3ecc8c2feb485a9d36157df891724488f69eea5 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/permissiongrants/count"
)
...
func NewPermissionGrantsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissionGrantsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PermissionGrantsRequestBuilder) Count()(*i590d5c5a9f95aeba73f1ac38f3ecc8c2feb485a9d36157df891724488f69eea5.CountRequestBuilder) {
    return i590d5c5a9f95aeba73f1ac38f3ecc8c2feb485a9d36157df891724488f69eea5.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to permissionGrants for users
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to permissionGrants for users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to permissionGrants for users
