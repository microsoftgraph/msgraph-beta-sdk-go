...
import (
    ...
    ide2ecea18d163158e1e74a14551b1c96bd6f07a1f4f3a26003a3decd82dccbd6 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/owners/count"
)
...
func NewOwnersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OwnersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *OwnersRequestBuilder) Count()(*ide2ecea18d163158e1e74a14551b1c96bd6f07a1f4f3a26003a3decd82dccbd6.CountRequestBuilder) {
    return ide2ecea18d163158e1e74a14551b1c96bd6f07a1f4f3a26003a3decd82dccbd6.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
