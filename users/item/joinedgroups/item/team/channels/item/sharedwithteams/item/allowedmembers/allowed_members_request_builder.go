...
import (
    ...
    ice03f577400e987bbf2121cf3b625954e331cee66ca3878f1357d79bf43009cd "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/channels/item/sharedwithteams/item/allowedmembers/count"
)
...
func NewAllowedMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AllowedMembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AllowedMembersRequestBuilder) Count()(*ice03f577400e987bbf2121cf3b625954e331cee66ca3878f1357d79bf43009cd.CountRequestBuilder) {
    return ice03f577400e987bbf2121cf3b625954e331cee66ca3878f1357d79bf43009cd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
