...
import (
    ...
    iadd5a361015dea978cf8ac1232ac0e6968ebfb094782c016e67a82f31b704c5c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/channels/item/members/add"
    ifca73b71d520297f21beeedf0245bf1e349ca14035d73a99fad989751ecdf4a3 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/channels/item/members/count"
)
...
func (m *MembersRequestBuilder) Add()(*iadd5a361015dea978cf8ac1232ac0e6968ebfb094782c016e67a82f31b704c5c.AddRequestBuilder) {
    return iadd5a361015dea978cf8ac1232ac0e6968ebfb094782c016e67a82f31b704c5c.NewAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *MembersRequestBuilder) Count()(*ifca73b71d520297f21beeedf0245bf1e349ca14035d73a99fad989751ecdf4a3.CountRequestBuilder) {
    return ifca73b71d520297f21beeedf0245bf1e349ca14035d73a99fad989751ecdf4a3.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
