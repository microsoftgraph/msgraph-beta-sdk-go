...
import (
    ...
    ifb76bd8531ba87a9ace348c92696c481bc97d3f4fc55ead612ec6b30b1a73e96 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/team/allchannels/count"
)
...
func NewAllChannelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AllChannelsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/team/allChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AllChannelsRequestBuilder) Count()(*ifb76bd8531ba87a9ace348c92696c481bc97d3f4fc55ead612ec6b30b1a73e96.CountRequestBuilder) {
    return ifb76bd8531ba87a9ace348c92696c481bc97d3f4fc55ead612ec6b30b1a73e96.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
