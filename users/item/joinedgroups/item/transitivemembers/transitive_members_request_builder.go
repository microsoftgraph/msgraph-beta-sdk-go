...
import (
    ...
    i463bf7aaa3ad6fa568af9587fc66dd99b36c5ec994db250d8b495743c845335b "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/joinedgroups/item/transitivemembers/count"
)
...
// TransitiveMembersRequestBuilderGetQueryParameters get transitiveMembers from users
...
func NewTransitiveMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TransitiveMembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/{group%2Did}/transitiveMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *TransitiveMembersRequestBuilder) Count()(*i463bf7aaa3ad6fa568af9587fc66dd99b36c5ec994db250d8b495743c845335b.CountRequestBuilder) {
    return i463bf7aaa3ad6fa568af9587fc66dd99b36c5ec994db250d8b495743c845335b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get transitiveMembers from users
...
// CreateGetRequestInformationWithRequestConfiguration get transitiveMembers from users
...
// Get get transitiveMembers from users
...
// GetWithRequestConfigurationAndResponseHandler get transitiveMembers from users
