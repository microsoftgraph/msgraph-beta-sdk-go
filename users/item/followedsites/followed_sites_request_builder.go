...
// FollowedSitesRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type FollowedSitesRequestBuilderGetRequestConfiguration struct {
    // Request headers
