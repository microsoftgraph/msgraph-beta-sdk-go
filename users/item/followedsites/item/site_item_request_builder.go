...
// SiteItemRequestBuilder provides operations to manage the followedSites property of the microsoft.graph.user entity.
...
// SiteItemRequestBuilderGetQueryParameters get followedSites from users
...
func NewSiteItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SiteItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/followedSites/{site_id}{?select,expand}";
