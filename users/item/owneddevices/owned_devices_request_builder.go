...
import (
    ...
    i7cc00efcfe9453ef4e4f22d585595d0f590b193c746807c5ce0559c811a322a0 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/owneddevices/ref"
)

// OwnedDevicesRequestBuilder builds and executes requests for operations under \users\{user-id}\ownedDevices
...
func NewOwnedDevicesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OwnedDevicesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/ownedDevices{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *OwnedDevicesRequestBuilder) Ref()(*i7cc00efcfe9453ef4e4f22d585595d0f590b193c746807c5ce0559c811a322a0.RefRequestBuilder) {
    return i7cc00efcfe9453ef4e4f22d585595d0f590b193c746807c5ce0559c811a322a0.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
