...
import (
    ...
    i0cb3975185a3255bbcc4cd2bd4268319be322ec83447d1010c58b2c21ed38b23 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/sections/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/users/{user_id}/onenote/sections/{onenoteSection_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i0cb3975185a3255bbcc4cd2bd4268319be322ec83447d1010c58b2c21ed38b23.CopyNotebookRequestBuilder) {
    return i0cb3975185a3255bbcc4cd2bd4268319be322ec83447d1010c58b2c21ed38b23.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the section group. Read-only.
// Parameters:
