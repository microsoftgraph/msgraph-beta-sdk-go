...
import (
    ...
    i4bc3d7a23fdd87fc7092cca3060f35c1baf9981ca802bdbac501f58d41120477 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/sections/item/pages/item/parentnotebook/sectiongroups/item/sections/item/copytonotebook"
    i7dffb1e922e0ad3862096a5267c8042766f838d1d4482f306637a561d1427e95 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/sections/item/pages/item/parentnotebook/sectiongroups/item/sections/item/copytosectiongroup"
)

// OnenoteSectionRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\sections\{onenoteSection-id}\pages\{onenotePage-id}\parentNotebook\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id1}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id1}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*i4bc3d7a23fdd87fc7092cca3060f35c1baf9981ca802bdbac501f58d41120477.CopyToNotebookRequestBuilder) {
    return i4bc3d7a23fdd87fc7092cca3060f35c1baf9981ca802bdbac501f58d41120477.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*i7dffb1e922e0ad3862096a5267c8042766f838d1d4482f306637a561d1427e95.CopyToSectionGroupRequestBuilder) {
    return i7dffb1e922e0ad3862096a5267c8042766f838d1d4482f306637a561d1427e95.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
