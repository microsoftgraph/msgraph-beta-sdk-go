...
import (
    ...
    i2a17c45d0f75a457e1aaa4c79bbc8a21811575d6d3d3a1adbd100e3c48bc2b91 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/sections/item/pages/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/users/{user_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i2a17c45d0f75a457e1aaa4c79bbc8a21811575d6d3d3a1adbd100e3c48bc2b91.CopyNotebookRequestBuilder) {
    return i2a17c45d0f75a457e1aaa4c79bbc8a21811575d6d3d3a1adbd100e3c48bc2b91.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
