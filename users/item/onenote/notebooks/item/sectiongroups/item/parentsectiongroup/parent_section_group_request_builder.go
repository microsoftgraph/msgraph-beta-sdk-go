...
import (
    ...
    i68b146b625317d53ebb71f05c3f4ef1d0f17508ab9eec7650280903f971de32c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/notebooks/item/sectiongroups/item/parentsectiongroup/ref"
)

// ParentSectionGroupRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\notebooks\{notebook-id}\sectionGroups\{sectionGroup-id}\parentSectionGroup
...
func NewParentSectionGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentSectionGroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/parentSectionGroup{?select,expand}";
...
func (m *ParentSectionGroupRequestBuilder) Ref()(*i68b146b625317d53ebb71f05c3f4ef1d0f17508ab9eec7650280903f971de32c.RefRequestBuilder) {
    return i68b146b625317d53ebb71f05c3f4ef1d0f17508ab9eec7650280903f971de32c.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
