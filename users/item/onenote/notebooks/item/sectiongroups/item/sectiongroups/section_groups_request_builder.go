...
import (
    ...
    if5619976358b95ebbf3412ad7aae3fb49f28d4387a7db6151927f92927c6cd4b "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/notebooks/item/sectiongroups/item/sectiongroups/count"
)
...
func NewSectionGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SectionGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sectionGroups{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SectionGroupsRequestBuilder) Count()(*if5619976358b95ebbf3412ad7aae3fb49f28d4387a7db6151927f92927c6cd4b.CountRequestBuilder) {
    return if5619976358b95ebbf3412ad7aae3fb49f28d4387a7db6151927f92927c6cd4b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
