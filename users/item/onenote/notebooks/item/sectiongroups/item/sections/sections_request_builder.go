...
import (
    ...
    id51ee4d20a346a068629f3c1db173e5b961bd1da629a4ce26003ded06859b32d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/notebooks/item/sectiongroups/item/sections/count"
)
...
func NewSectionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SectionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SectionsRequestBuilder) Count()(*id51ee4d20a346a068629f3c1db173e5b961bd1da629a4ce26003ded06859b32d.CountRequestBuilder) {
    return id51ee4d20a346a068629f3c1db173e5b961bd1da629a4ce26003ded06859b32d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
