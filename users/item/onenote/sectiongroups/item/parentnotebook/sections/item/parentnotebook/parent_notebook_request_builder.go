...
import (
    ...
    id4f20a58343678ff00ff60313836d54d37fdde05bdd5ae4f746e8c103ac17d59 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/sectiongroups/item/parentnotebook/sections/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/users/{user_id}/onenote/sectionGroups/{sectionGroup_id}/parentNotebook/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*id4f20a58343678ff00ff60313836d54d37fdde05bdd5ae4f746e8c103ac17d59.CopyNotebookRequestBuilder) {
    return id4f20a58343678ff00ff60313836d54d37fdde05bdd5ae4f746e8c103ac17d59.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
