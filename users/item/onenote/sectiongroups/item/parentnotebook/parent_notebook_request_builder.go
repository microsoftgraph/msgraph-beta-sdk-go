...
import (
    ...
    i43b029cd3450189e3e10121a5f113b51147bce991f9d37265595d21476e0f320 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/sectiongroups/item/parentnotebook/copynotebook"
    ia174457c4724e2d072db8e30072f178977a2d6d8dd62c06f06b2c06191df42a0 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/sectiongroups/item/parentnotebook/sectiongroups"
    ibf29c7716eff38e23a855910f0500fc116b88693aaa177e3758d98715373e865 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/sectiongroups/item/parentnotebook/sections"
    i045458b1e2f8d4783d7474f0244529c367fc46a5d4dadcf136ebe83f7c522ae6 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/sectiongroups/item/parentnotebook/sections/item"
    ic2ed495b04400dbcfe763114324416920f1f20bc98e5773e18b1087d91d92f30 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/sectiongroups/item/parentnotebook/sectiongroups/item"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i43b029cd3450189e3e10121a5f113b51147bce991f9d37265595d21476e0f320.CopyNotebookRequestBuilder) {
    return i43b029cd3450189e3e10121a5f113b51147bce991f9d37265595d21476e0f320.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ParentNotebookRequestBuilder) SectionGroups()(*ia174457c4724e2d072db8e30072f178977a2d6d8dd62c06f06b2c06191df42a0.SectionGroupsRequestBuilder) {
    return ia174457c4724e2d072db8e30072f178977a2d6d8dd62c06f06b2c06191df42a0.NewSectionGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionGroupsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.users.item.onenote.sectionGroups.item.parentNotebook.sectionGroups.item collection
func (m *ParentNotebookRequestBuilder) SectionGroupsById(id string)(*ic2ed495b04400dbcfe763114324416920f1f20bc98e5773e18b1087d91d92f30.SectionGroupRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return ic2ed495b04400dbcfe763114324416920f1f20bc98e5773e18b1087d91d92f30.NewSectionGroupRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
func (m *ParentNotebookRequestBuilder) Sections()(*ibf29c7716eff38e23a855910f0500fc116b88693aaa177e3758d98715373e865.SectionsRequestBuilder) {
    return ibf29c7716eff38e23a855910f0500fc116b88693aaa177e3758d98715373e865.NewSectionsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.users.item.onenote.sectionGroups.item.parentNotebook.sections.item collection
func (m *ParentNotebookRequestBuilder) SectionsById(id string)(*i045458b1e2f8d4783d7474f0244529c367fc46a5d4dadcf136ebe83f7c522ae6.OnenoteSectionRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i045458b1e2f8d4783d7474f0244529c367fc46a5d4dadcf136ebe83f7c522ae6.NewOnenoteSectionRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
