...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property resources for users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property resources in users
