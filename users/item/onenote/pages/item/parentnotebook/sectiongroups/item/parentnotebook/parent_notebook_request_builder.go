...
import (
    ...
    i959401123eea24a467e67dc3f026f13121bea1d465bbdc8d803211206ba61e1c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/pages/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/users/{user_id}/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i959401123eea24a467e67dc3f026f13121bea1d465bbdc8d803211206ba61e1c.CopyNotebookRequestBuilder) {
    return i959401123eea24a467e67dc3f026f13121bea1d465bbdc8d803211206ba61e1c.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
