...
import (
    ...
    i44cd16a073f00255c156c9051fc3770921051c035944f37ebbbab144cb646296 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/pages/item/parentsection/parentnotebook/sections/item/copytonotebook"
    if01227e7a5bba5eb779d36e8d0970727c45c7a45358e71fd41cb27ff751eba59 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/pages/item/parentsection/parentnotebook/sections/item/copytosectiongroup"
)

// onenoteSectionRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\pages\{onenotePage-id}\parentSection\parentNotebook\sections\{onenoteSection-id}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/pages/{onenotePage_id}/parentSection/parentNotebook/sections/{onenoteSection_id}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*i44cd16a073f00255c156c9051fc3770921051c035944f37ebbbab144cb646296.CopyToNotebookRequestBuilder) {
    return i44cd16a073f00255c156c9051fc3770921051c035944f37ebbbab144cb646296.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*if01227e7a5bba5eb779d36e8d0970727c45c7a45358e71fd41cb27ff751eba59.CopyToSectionGroupRequestBuilder) {
    return if01227e7a5bba5eb779d36e8d0970727c45c7a45358e71fd41cb27ff751eba59.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
