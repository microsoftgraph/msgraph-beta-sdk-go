...
import (
    ...
    i1fa0abdef91dac576ff0f2fe5d035be6452d2848afcfdea49985ef008411d4dd "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/pages/item/parentsection/parentsectiongroup/sectiongroups"
    i8a50cf68abb12460e83b9764fe1031e76479369172be1f3899359cd3e0a85a8d "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/pages/item/parentsection/parentsectiongroup/parentnotebook"
    i8d934493f2d7403ccfe5b101ea01bc73cd43995d3144abe0278e8a178a947932 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/pages/item/parentsection/parentsectiongroup/sections"
    ia455ad8260f3d616b8464f2d88953de4d1203e49e5830c63c0f83e770c30d900 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/pages/item/parentsection/parentsectiongroup/sections/item"
    id176542bbf8ab97078daefca986d5f99d6b7ef7f24325c20686de0915e6a6455 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/onenote/pages/item/parentsection/parentsectiongroup/sectiongroups/item"
)

// ParentSectionGroupRequestBuilder builds and executes requests for operations under \users\{user-id}\onenote\pages\{onenotePage-id}\parentSection\parentSectionGroup
...
func NewParentSectionGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentSectionGroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup{?select,expand}";
...
func (m *ParentSectionGroupRequestBuilder) ParentNotebook()(*i8a50cf68abb12460e83b9764fe1031e76479369172be1f3899359cd3e0a85a8d.ParentNotebookRequestBuilder) {
    return i8a50cf68abb12460e83b9764fe1031e76479369172be1f3899359cd3e0a85a8d.NewParentNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ParentSectionGroupRequestBuilder) SectionGroups()(*i1fa0abdef91dac576ff0f2fe5d035be6452d2848afcfdea49985ef008411d4dd.SectionGroupsRequestBuilder) {
    return i1fa0abdef91dac576ff0f2fe5d035be6452d2848afcfdea49985ef008411d4dd.NewSectionGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionGroupsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.users.item.onenote.pages.item.parentSection.parentSectionGroup.sectionGroups.item collection
func (m *ParentSectionGroupRequestBuilder) SectionGroupsById(id string)(*id176542bbf8ab97078daefca986d5f99d6b7ef7f24325c20686de0915e6a6455.SectionGroupRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return id176542bbf8ab97078daefca986d5f99d6b7ef7f24325c20686de0915e6a6455.NewSectionGroupRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
func (m *ParentSectionGroupRequestBuilder) Sections()(*i8d934493f2d7403ccfe5b101ea01bc73cd43995d3144abe0278e8a178a947932.SectionsRequestBuilder) {
    return i8d934493f2d7403ccfe5b101ea01bc73cd43995d3144abe0278e8a178a947932.NewSectionsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.users.item.onenote.pages.item.parentSection.parentSectionGroup.sections.item collection
func (m *ParentSectionGroupRequestBuilder) SectionsById(id string)(*ia455ad8260f3d616b8464f2d88953de4d1203e49e5830c63c0f83e770c30d900.OnenoteSectionRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return ia455ad8260f3d616b8464f2d88953de4d1203e49e5830c63c0f83e770c30d900.NewOnenoteSectionRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
