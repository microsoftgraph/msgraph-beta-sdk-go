...
// DeleteWithResponseHandler delete navigation property userConsentRequests for users
...
// PatchWithResponseHandler update the navigation property userConsentRequests in users
