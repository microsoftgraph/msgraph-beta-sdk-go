...
// ApprovalStepRequestBuilder builds and executes requests for operations under \users\{user-id}\appConsentRequestsForApproval\{appConsentRequest-id}\userConsentRequests\{userConsentRequest-id}\approval\steps\{approvalStep-id}
...
// ApprovalStepRequestBuilderGetQueryParameters get steps from users
...
func NewApprovalStepRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ApprovalStepRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/appConsentRequestsForApproval/{appConsentRequest_id}/userConsentRequests/{userConsentRequest_id}/approval/steps/{approvalStep_id}{?select,expand}";
