...
// ExtensionsRequestBuilder builds and executes requests for operations under \users\{user-id}\todo\lists\{todoTaskList-id}\tasks\{todoTask-id}\extensions
...
// CreatePostRequestInformation the collection of open extensions defined for the task. Nullable.
...
// Post the collection of open extensions defined for the task. Nullable.
