...
// DeleteWithResponseHandler delete navigation property exceptionOccurrences for users
...
// PatchWithResponseHandler update the navigation property exceptionOccurrences in users
