...
// EventsRequestBuilder builds and executes requests for operations under \users\{user-id}\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\events
...
// CreatePostRequestInformation the events in the calendar. Navigation property. Read-only.
...
// Delta builds and executes requests for operations under \users\{user-id}\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\events\microsoft.graph.delta()
...
func (m *EventsRequestBuilder) Get(options *EventsRequestBuilderGetOptions)(*EventsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewEventsResponse() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*EventsResponse), nil
}
// Post the events in the calendar. Navigation property. Read-only.
func (m *EventsRequestBuilder) Post(options *EventsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Event, error) {
