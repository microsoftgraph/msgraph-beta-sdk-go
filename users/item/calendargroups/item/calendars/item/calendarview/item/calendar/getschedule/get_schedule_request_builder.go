...
// Builds and executes requests for operations under \users\{user-id}\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\calendarView\{event-id}\calendar\microsoft.graph.getSchedule
...
func (m *GetScheduleRequestBuilder) Post(options *GetScheduleRequestBuilderPostOptions)([]GetSchedule, error) {
    ...
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGetSchedule() }, nil)
    if err != nil {
        return nil, err
    }
