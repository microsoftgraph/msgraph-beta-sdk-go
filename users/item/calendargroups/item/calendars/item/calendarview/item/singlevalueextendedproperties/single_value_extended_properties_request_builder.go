...
import (
    ...
    i14dc9810b276928813fb2e9d4adfcbce2e7ab38e30e08c95409a0b9cc7429f99 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/calendargroups/item/calendars/item/calendarview/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/calendarView/{event_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i14dc9810b276928813fb2e9d4adfcbce2e7ab38e30e08c95409a0b9cc7429f99.CountRequestBuilder) {
    return i14dc9810b276928813fb2e9d4adfcbce2e7ab38e30e08c95409a0b9cc7429f99.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
