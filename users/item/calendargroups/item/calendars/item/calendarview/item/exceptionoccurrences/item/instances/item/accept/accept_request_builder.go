...
func (m *AcceptRequestBuilder) Post(body AcceptPostRequestBodyable)(error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action accept
func (m *AcceptRequestBuilder) PostWithRequestConfigurationAndResponseHandler(body AcceptPostRequestBodyable, requestConfiguration *AcceptRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
