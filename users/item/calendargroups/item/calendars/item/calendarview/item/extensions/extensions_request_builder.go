...
// ExtensionsRequestBuilder builds and executes requests for operations under \users\{user-id}\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\calendarView\{event-id}\extensions
...
// CreatePostRequestInformation the collection of open extensions defined for the event. Nullable.
...
// Post the collection of open extensions defined for the event. Nullable.
