...
func (m *TentativelyAcceptRequestBuilder) Post(body TentativelyAcceptPostRequestBodyable)(error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action tentativelyAccept
func (m *TentativelyAcceptRequestBuilder) PostWithRequestConfigurationAndResponseHandler(body TentativelyAcceptPostRequestBodyable, requestConfiguration *TentativelyAcceptRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
