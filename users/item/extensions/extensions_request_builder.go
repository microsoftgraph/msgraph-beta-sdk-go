...
// CreatePostRequestInformation the collection of open extensions defined for the user. Read-only. Nullable.
...
// Post the collection of open extensions defined for the user. Read-only. Nullable.
