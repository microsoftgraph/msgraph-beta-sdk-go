...
func (m *PeopleRequestBuilder) Get(options *PeopleRequestBuilderGetOptions)(*PeopleResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewPeopleResponse() }, nil)
    if err != nil {
        return nil, err
    }
...
func (m *PeopleRequestBuilder) Post(options *PeopleRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Person, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewPerson() }, nil)
    if err != nil {
        return nil, err
    }
