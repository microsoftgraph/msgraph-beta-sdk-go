...
type ContactFoldersResponse struct {
    ...
    nextLink *string;
    // 
    value []i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ContactFolder;
}
// NewContactFoldersResponse instantiates a new contactFoldersResponse and sets the default values.
func NewContactFoldersResponse()(*ContactFoldersResponse) {
    m := &ContactFoldersResponse{
    }
...
func (m *ContactFoldersResponse) GetValue()([]i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ContactFolder) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *ContactFoldersResponse) SetValue(value []i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ContactFolder)() {
    if m != nil {
        m.value = value
    }
}
