...
import (
    ...
    i4f56d9e131477bcafcde7800e9178bd3bf8b9d38ed6f850adc3849ef3b01611e "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/contactfolders/item/contacts/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/contactFolders/{contactFolder_id}/contacts/{contact_id}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*i4f56d9e131477bcafcde7800e9178bd3bf8b9d38ed6f850adc3849ef3b01611e.CountRequestBuilder) {
    return i4f56d9e131477bcafcde7800e9178bd3bf8b9d38ed6f850adc3849ef3b01611e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
