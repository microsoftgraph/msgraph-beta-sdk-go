...
import (
    ...
    if60ae21f2be61a9b83fd50fe1926fdd7ccb9624fbbd38e98e574f38452800ab4 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/pendingaccessreviewinstances/item/stages/item/decisions/item/insights/count"
)
...
func NewInsightsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InsightsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/insights{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *InsightsRequestBuilder) Count()(*if60ae21f2be61a9b83fd50fe1926fdd7ccb9624fbbd38e98e574f38452800ab4.CountRequestBuilder) {
    return if60ae21f2be61a9b83fd50fe1926fdd7ccb9624fbbd38e98e574f38452800ab4.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to insights for users
...
// PostWithResponseHandler create new navigation property to insights for users
