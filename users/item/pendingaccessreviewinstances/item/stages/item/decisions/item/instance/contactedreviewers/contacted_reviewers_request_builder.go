...
import (
    ...
    i8b512578ec3371a400d3b6a97bf133c73bf45de7d4ce81a3f9ee77d0436bfcd5 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/pendingaccessreviewinstances/item/stages/item/decisions/item/instance/contactedreviewers/count"
)
...
func NewContactedReviewersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ContactedReviewersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/contactedReviewers{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
...
func (m *ContactedReviewersRequestBuilder) Count()(*i8b512578ec3371a400d3b6a97bf133c73bf45de7d4ce81a3f9ee77d0436bfcd5.CountRequestBuilder) {
    return i8b512578ec3371a400d3b6a97bf133c73bf45de7d4ce81a3f9ee77d0436bfcd5.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
