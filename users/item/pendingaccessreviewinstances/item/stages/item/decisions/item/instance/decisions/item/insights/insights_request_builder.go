...
import (
    ...
    icfb514e15da10c96fe95ac71e868285c1c6f4f45ba03644408227a3e742878ad "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/pendingaccessreviewinstances/item/stages/item/decisions/item/instance/decisions/item/insights/count"
)
...
func NewInsightsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InsightsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/pendingAccessReviewInstances/{accessReviewInstance_id}/stages/{accessReviewStage_id}/decisions/{accessReviewInstanceDecisionItem_id}/instance/decisions/{accessReviewInstanceDecisionItem_id1}/insights{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *InsightsRequestBuilder) Count()(*icfb514e15da10c96fe95ac71e868285c1c6f4f45ba03644408227a3e742878ad.CountRequestBuilder) {
    return icfb514e15da10c96fe95ac71e868285c1c6f4f45ba03644408227a3e742878ad.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
