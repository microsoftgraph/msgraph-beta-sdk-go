...
// CreateDeleteRequestInformationWithRequestConfiguration delete navigation property stages for users
...
// CreatePatchRequestInformationWithRequestConfiguration update the navigation property stages in users
...
func (m *AccessReviewStageItemRequestBuilder) Decisions()(*i6569cc4c438add39750c2fc7006bc0dc5f8b76fdb8fc83861535db7be56727e4.DecisionsRequestBuilder) {
...
func (m *AccessReviewStageItemRequestBuilder) DecisionsById(id string)(*ib24dda4023173e4d186210e89b253814cbe954575a5e8ac7d28704d7148b9e24.AccessReviewInstanceDecisionItemItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return ib24dda4023173e4d186210e89b253814cbe954575a5e8ac7d28704d7148b9e24.NewAccessReviewInstanceDecisionItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
// Delete delete navigation property stages for users
func (m *AccessReviewStageItemRequestBuilder) Delete()(error) {
    return m.DeleteWithRequestConfigurationAndResponseHandler(nil, nil);
}
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property stages for users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property stages in users
...
func (m *AccessReviewStageItemRequestBuilder) Stop()(*i8b8389b2e9644d3bc4df86f811daa472f1287eaa50c625e1e175a95dfa24b37f.StopRequestBuilder) {
