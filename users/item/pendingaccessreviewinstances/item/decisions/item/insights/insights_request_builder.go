...
import (
    ...
    i2a6a07e9feb50db278d3be835b2a1d239e1fe0c10df5a38d8de5cc6f399b94ac "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/pendingaccessreviewinstances/item/decisions/item/insights/count"
)
...
func NewInsightsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InsightsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/pendingAccessReviewInstances/{accessReviewInstance_id}/decisions/{accessReviewInstanceDecisionItem_id}/insights{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *InsightsRequestBuilder) Count()(*i2a6a07e9feb50db278d3be835b2a1d239e1fe0c10df5a38d8de5cc6f399b94ac.CountRequestBuilder) {
    return i2a6a07e9feb50db278d3be835b2a1d239e1fe0c10df5a38d8de5cc6f399b94ac.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
