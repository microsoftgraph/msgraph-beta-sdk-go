...
import (
    ...
    i5238bd2bb0de16ce112c2b73052318ac259677e06afe4c29ff1603cbeb8cbcde "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/pendingaccessreviewinstances/item/decisions/item/instance/contactedreviewers/count"
)
...
func NewContactedReviewersRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContactedReviewersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/pendingAccessReviewInstances/{accessReviewInstance_id}/decisions/{accessReviewInstanceDecisionItem_id}/instance/contactedReviewers{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ContactedReviewersRequestBuilder) Count()(*i5238bd2bb0de16ce112c2b73052318ac259677e06afe4c29ff1603cbeb8cbcde.CountRequestBuilder) {
    return i5238bd2bb0de16ce112c2b73052318ac259677e06afe4c29ff1603cbeb8cbcde.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
