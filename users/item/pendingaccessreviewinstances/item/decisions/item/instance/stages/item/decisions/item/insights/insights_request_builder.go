...
import (
    ...
    ic8ecd0cd5c3ece1fe3cdb98605ccf5cd473607468dff35b3c47b4139783d3091 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/pendingaccessreviewinstances/item/decisions/item/instance/stages/item/decisions/item/insights/count"
)
...
func NewInsightsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*InsightsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/pendingAccessReviewInstances/{accessReviewInstance_id}/decisions/{accessReviewInstanceDecisionItem_id}/instance/stages/{accessReviewStage_id}/decisions/{accessReviewInstanceDecisionItem_id1}/insights{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *InsightsRequestBuilder) Count()(*ic8ecd0cd5c3ece1fe3cdb98605ccf5cd473607468dff35b3c47b4139783d3091.CountRequestBuilder) {
    return ic8ecd0cd5c3ece1fe3cdb98605ccf5cd473607468dff35b3c47b4139783d3091.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
