...
// DeleteWithResponseHandler delete navigation property pendingAccessReviewInstances for users
...
// PatchWithResponseHandler update the navigation property pendingAccessReviewInstances in users
