...
// DeleteWithResponseHandler delete navigation property permissionGrants for users
...
// PatchWithResponseHandler update the navigation property permissionGrants in users
