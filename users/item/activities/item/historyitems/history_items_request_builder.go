...
// Builds and executes requests for operations under \users\{user-id}\activities\{userActivity-id}\historyItems
...
type HistoryItemsRequestBuilderGetOptions struct {
    ...
    Q *HistoryItemsRequestBuilderGetQueryParameters;
...
func (m *HistoryItemsRequestBuilder) Get(options *HistoryItemsRequestBuilderGetOptions)(*HistoryItemsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewHistoryItemsResponse() }, nil)
    if err != nil {
        return nil, err
    }
...
func (m *HistoryItemsRequestBuilder) Post(options *HistoryItemsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ActivityHistoryItem, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewActivityHistoryItem() }, nil)
    if err != nil {
        return nil, err
    }
