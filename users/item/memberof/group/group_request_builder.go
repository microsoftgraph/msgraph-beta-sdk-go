...
import (
    ...
    if198f8fb0b4c233f420899ee09c04636db7b8c74f874c5b05a95f120e1001d59 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/memberof/group/count"
)
...
func NewGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/memberOf/microsoft.graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *GroupRequestBuilder) Count()(*if198f8fb0b4c233f420899ee09c04636db7b8c74f874c5b05a95f120e1001d59.CountRequestBuilder) {
    return if198f8fb0b4c233f420899ee09c04636db7b8c74f874c5b05a95f120e1001d59.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
