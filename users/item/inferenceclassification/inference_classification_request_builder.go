...
func NewInferenceClassificationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*InferenceClassificationRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/users/{user_id}/inferenceClassification{?select}";
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.users.item.inferenceClassification.overrides.item collection
// Parameters:
