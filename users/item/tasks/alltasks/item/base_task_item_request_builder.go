...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property alltasks for users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property alltasks in users
