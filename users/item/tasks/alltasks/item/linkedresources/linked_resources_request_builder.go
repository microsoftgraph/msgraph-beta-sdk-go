...
import (
    ...
    i089511f5d4611c6ad75139297a53084879f0aeb9e1ee7fe18a0463a5bdfa7b3b "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/tasks/alltasks/item/linkedresources/count"
)
...
func NewLinkedResourcesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LinkedResourcesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/tasks/alltasks/{baseTask%2Did}/linkedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *LinkedResourcesRequestBuilder) Count()(*i089511f5d4611c6ad75139297a53084879f0aeb9e1ee7fe18a0463a5bdfa7b3b.CountRequestBuilder) {
    return i089511f5d4611c6ad75139297a53084879f0aeb9e1ee7fe18a0463a5bdfa7b3b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
