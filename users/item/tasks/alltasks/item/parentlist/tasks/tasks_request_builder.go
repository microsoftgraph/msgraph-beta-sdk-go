...
import (
    ...
    i639ac85adc17971885c4def0166ac7b1d2dbad02dca9fb6c3cb58faa61836b9e "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/tasks/alltasks/item/parentlist/tasks/delta"
)

// TasksRequestBuilder builds and executes requests for operations under \users\{user-id}\tasks\alltasks\{baseTask-id}\parentList\tasks
...
func NewTasksRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TasksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/tasks/alltasks/{baseTask_id}/parentList/tasks{?top,skip,search,filter,count,orderby,select,expand}";
...
// Delta builds and executes requests for operations under \users\{user-id}\tasks\alltasks\{baseTask-id}\parentList\tasks\microsoft.graph.delta()
func (m *TasksRequestBuilder) Delta()(*i639ac85adc17971885c4def0166ac7b1d2dbad02dca9fb6c3cb58faa61836b9e.DeltaRequestBuilder) {
    return i639ac85adc17971885c4def0166ac7b1d2dbad02dca9fb6c3cb58faa61836b9e.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
