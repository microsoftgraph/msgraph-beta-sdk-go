...
import (
    ...
    i7f19dee70cec4c4682e398c90c715c4a19db6668e6769f60c7ca3fc94b34c752 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/tasks/alltasks/item/parentlist/tasks/item/move"
)

// BaseTaskRequestBuilder builds and executes requests for operations under \users\{user-id}\tasks\alltasks\{baseTask-id}\parentList\tasks\{baseTask-id1}
...
func NewBaseTaskRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BaseTaskRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/tasks/alltasks/{baseTask_id}/parentList/tasks/{baseTask_id1}{?select,expand}";
...
func (m *BaseTaskRequestBuilder) Move()(*i7f19dee70cec4c4682e398c90c715c4a19db6668e6769f60c7ca3fc94b34c752.MoveRequestBuilder) {
    return i7f19dee70cec4c4682e398c90c715c4a19db6668e6769f60c7ca3fc94b34c752.NewMoveRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
