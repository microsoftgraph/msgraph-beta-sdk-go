...
import (
    ...
    i90150b83c1151a8c20e190d4d2471e8756ce479c73e66cdbbe0c909828fc3a55 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/tasks/lists/item/tasks/item/linkedresources/count"
)
...
func NewLinkedResourcesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LinkedResourcesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/tasks/lists/{baseTaskList%2Did}/tasks/{baseTask%2Did}/linkedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *LinkedResourcesRequestBuilder) Count()(*i90150b83c1151a8c20e190d4d2471e8756ce479c73e66cdbbe0c909828fc3a55.CountRequestBuilder) {
    return i90150b83c1151a8c20e190d4d2471e8756ce479c73e66cdbbe0c909828fc3a55.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to linkedResources for users
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to linkedResources for users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to linkedResources for users
