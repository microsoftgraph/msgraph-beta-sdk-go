...
func NewMoveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MoveRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/tasks/lists/{baseTaskList%2Did}/tasks/{baseTask%2Did}/microsoft.graph.move";
...
// CreatePostRequestInformation move a baseTask object from one baseTaskList to another.
...
// CreatePostRequestInformationWithRequestConfiguration move a baseTask object from one baseTaskList to another.
...
// Post move a baseTask object from one baseTaskList to another.
func (m *MoveRequestBuilder) Post(ctx context.Context, body MovePostRequestBodyable, requestConfiguration *MoveRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.BaseTaskable, error) {
