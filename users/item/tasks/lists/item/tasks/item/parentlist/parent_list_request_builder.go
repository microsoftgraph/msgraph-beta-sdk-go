...
import (
    ...
    i1396e78977e009fe15350dec2fbb2ca292a003793a6886e6388b334f85635b90 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/tasks/lists/item/tasks/item/parentlist/ref"
)

// ParentListRequestBuilder builds and executes requests for operations under \users\{user-id}\tasks\lists\{baseTaskList-id}\tasks\{baseTask-id}\parentList
...
func NewParentListRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentListRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/tasks/lists/{baseTaskList_id}/tasks/{baseTask_id}/parentList{?select,expand}";
...
func (m *ParentListRequestBuilder) Ref()(*i1396e78977e009fe15350dec2fbb2ca292a003793a6886e6388b334f85635b90.RefRequestBuilder) {
    return i1396e78977e009fe15350dec2fbb2ca292a003793a6886e6388b334f85635b90.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
