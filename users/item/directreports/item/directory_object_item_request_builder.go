...
import (
    ...
    i481e48e791df51bc64dc4df6d6398d26850744b21b11bbb361f1d462e210caab "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/directreports/item/user"
    i4eb492e02d6e104fd3194ec955ab6c820e5812699dabf4cea70c2515ea4d47bf "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/directreports/item/orgcontact"
)

// DirectoryObjectItemRequestBuilder provides operations to manage the directReports property of the microsoft.graph.user entity.
...
// DirectoryObjectItemRequestBuilderGetQueryParameters the users and contacts that report to the user. (The users and contacts that have their manager property set to this user.) Read-only. Nullable. Supports $expand.
...
func (m *DirectoryObjectItemRequestBuilder) OrgContact()(*i4eb492e02d6e104fd3194ec955ab6c820e5812699dabf4cea70c2515ea4d47bf.OrgContactRequestBuilder) {
    return i4eb492e02d6e104fd3194ec955ab6c820e5812699dabf4cea70c2515ea4d47bf.NewOrgContactRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// User the user property
func (m *DirectoryObjectItemRequestBuilder) User()(*i481e48e791df51bc64dc4df6d6398d26850744b21b11bbb361f1d462e210caab.UserRequestBuilder) {
    return i481e48e791df51bc64dc4df6d6398d26850744b21b11bbb361f1d462e210caab.NewUserRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
