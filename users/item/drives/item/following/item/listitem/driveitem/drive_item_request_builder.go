...
import (
    ...
    ibc262f644c3d08778d7c013e114f222325de4a2af4dc68bbf187e1039a2a892a "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/following/item/listitem/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/following/{driveItem_id}/listItem/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*ibc262f644c3d08778d7c013e114f222325de4a2af4dc68bbf187e1039a2a892a.ContentRequestBuilder) {
    return ibc262f644c3d08778d7c013e114f222325de4a2af4dc68bbf187e1039a2a892a.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
