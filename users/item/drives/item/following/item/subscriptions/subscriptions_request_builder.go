...
import (
    ...
    if7768d9be77df72e7a48b802a48321c7323ee9635a8935dfbcf4f060afab4a09 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/following/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/following/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*if7768d9be77df72e7a48b802a48321c7323ee9635a8935dfbcf4f060afab4a09.CountRequestBuilder) {
    return if7768d9be77df72e7a48b802a48321c7323ee9635a8935dfbcf4f060afab4a09.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
