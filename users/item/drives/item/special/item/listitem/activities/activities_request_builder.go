...
import (
    ...
    ie72464cc001fb3ed657db23f3d60695d3ed3f80e23447e0978cf57cdf4d68584 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/special/item/listitem/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/special/{driveItem_id}/listItem/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*ie72464cc001fb3ed657db23f3d60695d3ed3f80e23447e0978cf57cdf4d68584.CountRequestBuilder) {
    return ie72464cc001fb3ed657db23f3d60695d3ed3f80e23447e0978cf57cdf4d68584.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
