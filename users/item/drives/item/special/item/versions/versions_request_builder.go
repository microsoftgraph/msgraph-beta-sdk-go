...
import (
    ...
    i5fa67fdb9cc35ce18f1b1c444db93cba4305d2e71c13530618796abd212ebc41 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/special/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/special/{driveItem_id}/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*i5fa67fdb9cc35ce18f1b1c444db93cba4305d2e71c13530618796abd212ebc41.CountRequestBuilder) {
    return i5fa67fdb9cc35ce18f1b1c444db93cba4305d2e71c13530618796abd212ebc41.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *VersionsRequestBuilder) Get(options *VersionsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DriveItemVersionCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateDriveItemVersionCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DriveItemVersionCollectionResponseable), nil
}
// Post create new navigation property to versions for users
func (m *VersionsRequestBuilder) Post(options *VersionsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DriveItemVersionable, error) {
