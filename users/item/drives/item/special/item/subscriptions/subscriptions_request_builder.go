...
import (
    ...
    i59672b372b91bb505348ee0f15252f06f3cf3f19d024ab210067ba633e44436c "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/special/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/special/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*i59672b372b91bb505348ee0f15252f06f3cf3f19d024ab210067ba633e44436c.CountRequestBuilder) {
    return i59672b372b91bb505348ee0f15252f06f3cf3f19d024ab210067ba633e44436c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *SubscriptionsRequestBuilder) Get(options *SubscriptionsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.SubscriptionCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateSubscriptionCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.SubscriptionCollectionResponseable), nil
}
// Post create new navigation property to subscriptions for users
func (m *SubscriptionsRequestBuilder) Post(options *SubscriptionsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Subscriptionable, error) {
