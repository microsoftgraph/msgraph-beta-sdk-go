...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property subscriptions for users
...
// GetWithRequestConfigurationAndResponseHandler the set of subscriptions on the item. Only supported on the root of a drive.
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property subscriptions in users
