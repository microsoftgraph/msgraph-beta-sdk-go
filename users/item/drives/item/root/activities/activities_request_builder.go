...
import (
    ...
    i16cd9509c3644a1a714ad309f0ec0ea662b46731b2ec7215f2d5de9dd9206bed "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/root/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/root/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i16cd9509c3644a1a714ad309f0ec0ea662b46731b2ec7215f2d5de9dd9206bed.CountRequestBuilder) {
    return i16cd9509c3644a1a714ad309f0ec0ea662b46731b2ec7215f2d5de9dd9206bed.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
