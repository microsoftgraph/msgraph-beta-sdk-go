...
import (
    ...
    i75c5e9f348f8c1145284a3376d02d4f0ae2b2b1208c081363abf6d1dab788cac "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/items/count"
)
...
func NewItemsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ItemsRequestBuilder) Count()(*i75c5e9f348f8c1145284a3376d02d4f0ae2b2b1208c081363abf6d1dab788cac.CountRequestBuilder) {
    return i75c5e9f348f8c1145284a3376d02d4f0ae2b2b1208c081363abf6d1dab788cac.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// PostWithResponseHandler create new navigation property to items for users
