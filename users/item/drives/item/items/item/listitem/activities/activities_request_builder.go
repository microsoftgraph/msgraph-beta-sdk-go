...
import (
    ...
    if1909ffd84db99ee81fc4830ca476374d0b27e43450741d87280837954184eb1 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/items/item/listitem/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/items/{driveItem_id}/listItem/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*if1909ffd84db99ee81fc4830ca476374d0b27e43450741d87280837954184eb1.CountRequestBuilder) {
    return if1909ffd84db99ee81fc4830ca476374d0b27e43450741d87280837954184eb1.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
