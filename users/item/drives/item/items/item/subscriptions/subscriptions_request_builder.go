...
import (
    ...
    ia259f3e93a9a76fbf443b0030f4e0e138628fcea1e8daf153e0b9e4b1f1d2caf "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/items/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/items/{driveItem_id}/subscriptions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*ia259f3e93a9a76fbf443b0030f4e0e138628fcea1e8daf153e0b9e4b1f1d2caf.CountRequestBuilder) {
    return ia259f3e93a9a76fbf443b0030f4e0e138628fcea1e8daf153e0b9e4b1f1d2caf.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
