...
import (
    ...
    i6f93c597f2d50e25840a0110af9de951926dbd6a77989454a0a3d0cfffdcef99 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/list/activities/item/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/list/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i6f93c597f2d50e25840a0110af9de951926dbd6a77989454a0a3d0cfffdcef99.ContentRequestBuilder) {
    return i6f93c597f2d50e25840a0110af9de951926dbd6a77989454a0a3d0cfffdcef99.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
