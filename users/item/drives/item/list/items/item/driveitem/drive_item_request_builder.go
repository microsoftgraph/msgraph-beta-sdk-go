...
import (
    ...
    i5d9e029a39107198378616e273c4d997a1b5a41d59b72c5bab97a6e9e5409c8b "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/list/items/item/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/list/items/{listItem_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i5d9e029a39107198378616e273c4d997a1b5a41d59b72c5bab97a6e9e5409c8b.ContentRequestBuilder) {
    return i5d9e029a39107198378616e273c4d997a1b5a41d59b72c5bab97a6e9e5409c8b.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
