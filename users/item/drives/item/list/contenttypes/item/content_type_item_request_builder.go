...
// DeleteWithResponseHandler delete navigation property contentTypes for users
...
// PatchWithResponseHandler update the navigation property contentTypes in users
