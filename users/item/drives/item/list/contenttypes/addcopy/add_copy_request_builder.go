...
// CreatePostRequestInformationWithRequestConfiguration add a copy of a [content type][contentType] from a [site][site] to a [list][list].
...
func (m *AddCopyRequestBuilder) Post(ctx context.Context, body AddCopyPostRequestBodyable, requestConfiguration *AddCopyRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ContentTypeable, error) {
