...
import (
    ...
    iba87b85d96bda2be93a7ff8754b46627fcf9c7a6381364f952596cac94c243e4 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/bundles/count"
)
...
func NewBundlesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BundlesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *BundlesRequestBuilder) Count()(*iba87b85d96bda2be93a7ff8754b46627fcf9c7a6381364f952596cac94c243e4.CountRequestBuilder) {
    return iba87b85d96bda2be93a7ff8754b46627fcf9c7a6381364f952596cac94c243e4.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to bundles for users
...
func (m *BundlesRequestBuilder) Get(options *BundlesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DriveItemCollectionResponseable, error) {
...
// Post create new navigation property to bundles for users
func (m *BundlesRequestBuilder) Post(options *BundlesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DriveItemable, error) {
