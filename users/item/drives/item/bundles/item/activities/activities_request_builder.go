...
import (
    ...
    i1a07847c32791637f0a15768195acc6638fff78d2dcaf5b9e104737104ba005f "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/drives/item/bundles/item/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/bundles/{driveItem_id}/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i1a07847c32791637f0a15768195acc6638fff78d2dcaf5b9e104737104ba005f.CountRequestBuilder) {
    return i1a07847c32791637f0a15768195acc6638fff78d2dcaf5b9e104737104ba005f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
