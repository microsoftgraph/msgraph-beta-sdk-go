...
// Builds and executes requests for operations under \users\{user-id}\approvals\{approval-id}\steps
...
func NewStepsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*StepsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/users/{user_id}/approvals/{approval_id}/steps{?top,skip,search,filter,count,orderby,select,expand}";
