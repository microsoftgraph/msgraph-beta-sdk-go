...
// LicenseDetailsItemRequestBuilder builds and executes requests for operations under \users\{user-id}\licenseDetails\{licenseDetails-id}
...
type LicenseDetailsItemRequestBuilderGetOptions struct {
    ...
    Q *LicenseDetailsItemRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
func NewLicenseDetailsItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LicenseDetailsItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/licenseDetails/{licenseDetails_id}{?select,expand}";
...
// CreateDeleteRequestInformation a collection of this user's license details. Read-only.
...
// CreatePatchRequestInformation a collection of this user's license details. Read-only.
...
// Delete a collection of this user's license details. Read-only.
...
func (m *LicenseDetailsItemRequestBuilder) Get(options *LicenseDetailsItemRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.LicenseDetails, error) {
...
// Patch a collection of this user's license details. Read-only.
