...
// DeleteWithResponseHandler delete navigation property sensitivityLabels for users
...
// PatchWithResponseHandler update the navigation property sensitivityLabels in users
