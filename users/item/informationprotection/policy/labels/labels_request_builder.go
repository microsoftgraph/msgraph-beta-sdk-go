...
// GetWithRequestConfigurationAndResponseHandler get labels from users
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to labels for users
