...
func NewSignDigestRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SignDigestRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/informationProtection/microsoft.graph.signDigest";
...
func (m *SignDigestRequestBuilder) CreatePostRequestInformation(ctx context.Context, body SignDigestPostRequestBodyable, requestConfiguration *SignDigestRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SignDigestRequestBuilder) Post(ctx context.Context, body SignDigestPostRequestBodyable, requestConfiguration *SignDigestRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SigningResultable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateSigningResultFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
