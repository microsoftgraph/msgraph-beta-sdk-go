...
// CreateDeleteRequestInformation delete navigation property bitlocker for users
...
// CreateDeleteRequestInformationWithRequestConfiguration delete navigation property bitlocker for users
...
// Delete delete navigation property bitlocker for users
func (m *BitlockerRequestBuilder) Delete()(error) {
    return m.DeleteWithRequestConfigurationAndResponseHandler(nil, nil);
}
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property bitlocker for users
