...
// DeleteWithResponseHandler delete navigation property bitlocker for users
...
// GetWithResponseHandler get bitlocker from users
...
// PatchWithResponseHandler update the navigation property bitlocker in users
