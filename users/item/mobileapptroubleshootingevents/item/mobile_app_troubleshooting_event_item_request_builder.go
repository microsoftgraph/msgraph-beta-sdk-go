...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property mobileAppTroubleshootingEvents for users
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property mobileAppTroubleshootingEvents in users
