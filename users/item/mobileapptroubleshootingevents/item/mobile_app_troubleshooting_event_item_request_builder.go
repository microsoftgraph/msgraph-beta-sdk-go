...
// DeleteWithResponseHandler delete navigation property mobileAppTroubleshootingEvents for users
...
// PatchWithResponseHandler update the navigation property mobileAppTroubleshootingEvents in users
