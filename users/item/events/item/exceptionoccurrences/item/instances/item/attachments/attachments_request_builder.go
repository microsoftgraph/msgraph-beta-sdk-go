...
import (
    ...
    i6147297eb50cd1cac82e870561aebcad5ff236c3013bf353ae07bba783921a2f "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/events/item/exceptionoccurrences/item/instances/item/attachments/count"
    if23b7748664320ad72bd2c74665114418d15e61c7534fed5339845e35d353e04 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/events/item/exceptionoccurrences/item/instances/item/attachments/createuploadsession"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/events/{event_id}/exceptionOccurrences/{event_id1}/instances/{event_id2}/attachments{?top,skip,filter,count,orderby,select,expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*i6147297eb50cd1cac82e870561aebcad5ff236c3013bf353ae07bba783921a2f.CountRequestBuilder) {
    return i6147297eb50cd1cac82e870561aebcad5ff236c3013bf353ae07bba783921a2f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*if23b7748664320ad72bd2c74665114418d15e61c7534fed5339845e35d353e04.CreateUploadSessionRequestBuilder) {
    return if23b7748664320ad72bd2c74665114418d15e61c7534fed5339845e35d353e04.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
