...
import (
    ...
    ifdb1b833647de7e1e9c701ddd1e80c52ed98404413f9c088c101e0a473ca2c48 "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/events/item/exceptionoccurrences/item/instances/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/events/{event_id}/exceptionOccurrences/{event_id1}/instances/{event_id2}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*ifdb1b833647de7e1e9c701ddd1e80c52ed98404413f9c088c101e0a473ca2c48.CountRequestBuilder) {
    return ifdb1b833647de7e1e9c701ddd1e80c52ed98404413f9c088c101e0a473ca2c48.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
