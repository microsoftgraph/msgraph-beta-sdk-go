...
// exceptionOccurrencesRequestBuilder builds and executes requests for operations under \users\{user-id}\events\{event-id}\exceptionOccurrences
...
// Delta builds and executes requests for operations under \users\{user-id}\events\{event-id}\exceptionOccurrences\microsoft.graph.delta()
