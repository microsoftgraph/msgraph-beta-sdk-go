...
// Builds and executes requests for operations under \users\{user-id}\events\{event-id}\exceptionOccurrences
...
func NewExceptionOccurrencesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ExceptionOccurrencesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/users/{user_id}/events/{event_id}/exceptionOccurrences{?top,skip,filter,count,orderby,select,expand}";
...
// Builds and executes requests for operations under \users\{user-id}\events\{event-id}\exceptionOccurrences\microsoft.graph.delta()
