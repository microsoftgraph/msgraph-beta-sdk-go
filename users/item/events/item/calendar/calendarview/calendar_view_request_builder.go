...
import (
    ...
    i4be12d959c6d186c98dc7a90192492706270ef934fb486252916248b75d437ac "github.com/microsoftgraph/msgraph-beta-sdk-go/users/item/events/item/calendar/calendarview/delta"
)

// calendarViewRequestBuilder builds and executes requests for operations under \users\{user-id}\events\{event-id}\calendar\calendarView
...
func NewCalendarViewRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CalendarViewRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user_id}/events/{event_id}/calendar/calendarView{?top,skip,filter,count,orderby,select}";
...
// Delta builds and executes requests for operations under \users\{user-id}\events\{event-id}\calendar\calendarView\microsoft.graph.delta()
func (m *CalendarViewRequestBuilder) Delta()(*i4be12d959c6d186c98dc7a90192492706270ef934fb486252916248b75d437ac.DeltaRequestBuilder) {
    return i4be12d959c6d186c98dc7a90192492706270ef934fb486252916248b75d437ac.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
