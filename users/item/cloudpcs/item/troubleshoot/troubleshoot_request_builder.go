...
func NewTroubleshootRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TroubleshootRequestBuilder) {
    m := &TroubleshootRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/users/{user_id}/cloudPCs/{cloudPC_id}/microsoft.graph.troubleshoot";
...
func NewTroubleshootRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TroubleshootRequestBuilder) {
...
func (m *TroubleshootRequestBuilder) CreatePostRequestInformation(options *TroubleshootRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
