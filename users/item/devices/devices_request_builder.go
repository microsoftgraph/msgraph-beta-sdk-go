...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to devices for users
...
// PostWithResponseHandler create new navigation property to devices for users
