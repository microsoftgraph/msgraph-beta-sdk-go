...
// NewItemCalendarviewItemExceptionoccurrencesItemInstancesItemCancelRequestBuilderInternal instantiates a new ItemCalendarviewItemExceptionoccurrencesItemInstancesItemCancelRequestBuilder and sets the default values.
...
// NewItemCalendarviewItemExceptionoccurrencesItemInstancesItemCancelRequestBuilder instantiates a new ItemCalendarviewItemExceptionoccurrencesItemInstancesItemCancelRequestBuilder and sets the default values.
...
func (m *ItemCalendarviewItemExceptionoccurrencesItemInstancesItemCancelRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarviewItemExceptionoccurrencesItemInstancesItemCancelRequestBuilder) {
    return NewItemCalendarviewItemExceptionoccurrencesItemInstancesItemCancelRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
