...
// NewItemPendingAccessReviewInstancesItemContactedReviewersCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemPendingAccessReviewInstancesItemContactedReviewersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPendingAccessReviewInstancesItemContactedReviewersCountRequestBuilder) {
    m := &ItemPendingAccessReviewInstancesItemContactedReviewersCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/contactedReviewers/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewItemPendingAccessReviewInstancesItemContactedReviewersCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
