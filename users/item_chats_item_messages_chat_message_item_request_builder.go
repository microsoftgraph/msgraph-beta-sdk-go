...
func (m *ItemChatsItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphSetReaction()(*ItemChatsItemMessagesItemMicrosoftGraphSetReactionSetReactionRequestBuilder) {
    return NewItemChatsItemMessagesItemMicrosoftGraphSetReactionSetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemChatsItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphUnsetReaction()(*ItemChatsItemMessagesItemMicrosoftGraphUnsetReactionUnsetReactionRequestBuilder) {
    return NewItemChatsItemMessagesItemMicrosoftGraphUnsetReactionUnsetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
