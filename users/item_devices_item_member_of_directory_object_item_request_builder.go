...
func (m *ItemDevicesItemMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphApplication()(*ItemDevicesItemMemberOfItemMicrosoftGraphApplicationRequestBuilder) {
    return NewItemDevicesItemMemberOfItemMicrosoftGraphApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDevice casts the previous resource to device.
func (m *ItemDevicesItemMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphDevice()(*ItemDevicesItemMemberOfItemMicrosoftGraphDeviceRequestBuilder) {
    return NewItemDevicesItemMemberOfItemMicrosoftGraphDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGroup casts the previous resource to group.
func (m *ItemDevicesItemMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphGroup()(*ItemDevicesItemMemberOfItemMicrosoftGraphGroupRequestBuilder) {
    return NewItemDevicesItemMemberOfItemMicrosoftGraphGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphOrgContact casts the previous resource to orgContact.
func (m *ItemDevicesItemMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphOrgContact()(*ItemDevicesItemMemberOfItemMicrosoftGraphOrgContactRequestBuilder) {
    return NewItemDevicesItemMemberOfItemMicrosoftGraphOrgContactRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *ItemDevicesItemMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphServicePrincipal()(*ItemDevicesItemMemberOfItemMicrosoftGraphServicePrincipalRequestBuilder) {
    return NewItemDevicesItemMemberOfItemMicrosoftGraphServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *ItemDevicesItemMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphUser()(*ItemDevicesItemMemberOfItemMicrosoftGraphUserRequestBuilder) {
    return NewItemDevicesItemMemberOfItemMicrosoftGraphUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
