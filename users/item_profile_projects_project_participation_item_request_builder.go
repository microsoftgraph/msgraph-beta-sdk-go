...
// ItemProfileProjectsProjectParticipationItemRequestBuilder provides operations to manage the projects property of the microsoft.graph.profile entity.
type ItemProfileProjectsProjectParticipationItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemProfileProjectsProjectParticipationItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemProfileProjectsProjectParticipationItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// ItemProfileProjectsProjectParticipationItemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemProfileProjectsProjectParticipationItemRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemProfileProjectsProjectParticipationItemRequestBuilderGetQueryParameters
}
// ItemProfileProjectsProjectParticipationItemRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemProfileProjectsProjectParticipationItemRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func NewItemProfileProjectsProjectParticipationItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemProfileProjectsProjectParticipationItemRequestBuilder) {
    m := &ItemProfileProjectsProjectParticipationItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/profile/projects/{projectParticipation%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *ItemProfileProjectsProjectParticipationItemRequestBuilder) WithUrl(rawUrl string)(*ItemProfileProjectsProjectParticipationItemRequestBuilder) {
    return NewItemProfileProjectsProjectParticipationItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
