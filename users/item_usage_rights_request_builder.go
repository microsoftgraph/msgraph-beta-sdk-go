...
// ItemUsageRightsRequestBuilderGetQueryParameters retrieve a list of usageRight objects for a given user. This API is available in the following national cloud deployments.
...
// Get retrieve a list of usageRight objects for a given user. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve a list of usageRight objects for a given user. This API is available in the following national cloud deployments.
