...
// BySkillProficiencyIdString provides operations to manage the skills property of the microsoft.graph.profile entity.
func (m *ItemProfileSkillsRequestBuilder) BySkillProficiencyIdString(skillProficiencyId string)(*ItemProfileSkillsSkillProficiencyItemRequestBuilder) {
