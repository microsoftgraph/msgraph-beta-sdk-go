...
func (m *ItemMailFoldersItemChildFoldersItemMessagesRequestBuilder) MicrosoftGraphDelta()(*ItemMailFoldersItemChildFoldersItemMessagesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemMailFoldersItemChildFoldersItemMessagesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
