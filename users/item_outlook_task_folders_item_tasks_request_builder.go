...
// ItemOutlookTaskFoldersItemTasksRequestBuilderGetQueryParameters the tasks in this task folder. Read-only. Nullable.
...
// NewItemOutlookTaskFoldersItemTasksRequestBuilderInternal instantiates a new ItemOutlookTaskFoldersItemTasksRequestBuilder and sets the default values.
func NewItemOutlookTaskFoldersItemTasksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOutlookTaskFoldersItemTasksRequestBuilder) {
    m := &ItemOutlookTaskFoldersItemTasksRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemOutlookTaskFoldersItemTasksRequestBuilder instantiates a new ItemOutlookTaskFoldersItemTasksRequestBuilder and sets the default values.
