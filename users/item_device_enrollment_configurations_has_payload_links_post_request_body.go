...
// ItemDeviceEnrollmentConfigurationsHasPayloadLinksPostRequestBody provides operations to call the hasPayloadLinks method.
...
func (m *ItemDeviceEnrollmentConfigurationsHasPayloadLinksPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemDeviceEnrollmentConfigurationsHasPayloadLinksPostRequestBody) SetAdditionalData(value map[string]interface{})() {
