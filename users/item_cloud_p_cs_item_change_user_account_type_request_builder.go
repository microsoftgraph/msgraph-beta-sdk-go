...
// Post change the account type of the user on a specific Cloud PC. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation change the account type of the user on a specific Cloud PC. This API is supported in the following national cloud deployments.
