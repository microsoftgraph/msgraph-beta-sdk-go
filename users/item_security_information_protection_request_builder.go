...
func (m *ItemSecurityInformationProtectionRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemSecurityInformationProtectionRequestBuilderDeleteRequestConfiguration)([]byte, error) {
