...
func (m *ItemCalendarsItemEventsItemExceptionOccurrencesItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*ItemCalendarsItemEventsItemExceptionOccurrencesItemAttachmentsMicrosoftGraphCreateUploadSessionRequestBuilder) {
    return NewItemCalendarsItemEventsItemExceptionOccurrencesItemAttachmentsMicrosoftGraphCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
