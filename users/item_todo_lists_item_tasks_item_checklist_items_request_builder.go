...
// ItemTodoListsItemTasksItemChecklistItemsRequestBuilderGetQueryParameters get the checklistItem resources associated to the checklistItems navigation property of a todoTask. This API is available in the following national cloud deployments.
...
// Get get the checklistItem resources associated to the checklistItems navigation property of a todoTask. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create a new checklistItem object as a subtask in a bigger todoTask. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get the checklistItem resources associated to the checklistItems navigation property of a todoTask. This API is available in the following national cloud deployments.
...
// ToPostRequestInformation create a new checklistItem object as a subtask in a bigger todoTask. This API is available in the following national cloud deployments.
