...
// ItemCalendarsItemEventsItemExceptionOccurrencesItemExtensionsRequestBuilderGetQueryParameters the collection of open extensions defined for the event. Nullable.
...
// NewItemCalendarsItemEventsItemExceptionOccurrencesItemExtensionsRequestBuilderInternal instantiates a new ExtensionsRequestBuilder and sets the default values.
...
// NewItemCalendarsItemEventsItemExceptionOccurrencesItemExtensionsRequestBuilder instantiates a new ExtensionsRequestBuilder and sets the default values.
...
func (m *ItemCalendarsItemEventsItemExceptionOccurrencesItemExtensionsRequestBuilder) Count()(*ItemCalendarsItemEventsItemExceptionOccurrencesItemExtensionsCountRequestBuilder) {
    return NewItemCalendarsItemEventsItemExceptionOccurrencesItemExtensionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the collection of open extensions defined for the event. Nullable.
func (m *ItemCalendarsItemEventsItemExceptionOccurrencesItemExtensionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemCalendarsItemEventsItemExceptionOccurrencesItemExtensionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
