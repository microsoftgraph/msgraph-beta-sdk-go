...
// NewItemOutlookTasksCountRequestBuilderInternal instantiates a new ItemOutlookTasksCountRequestBuilder and sets the default values.
func NewItemOutlookTasksCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOutlookTasksCountRequestBuilder) {
    m := &ItemOutlookTasksCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/outlook/tasks/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemOutlookTasksCountRequestBuilder instantiates a new ItemOutlookTasksCountRequestBuilder and sets the default values.
...
func (m *ItemOutlookTasksCountRequestBuilder) WithUrl(rawUrl string)(*ItemOutlookTasksCountRequestBuilder) {
    return NewItemOutlookTasksCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
