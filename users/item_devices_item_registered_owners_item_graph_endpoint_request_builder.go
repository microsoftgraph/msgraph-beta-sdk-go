...
// NewItemDevicesItemRegisteredOwnersItemGraphEndpointRequestBuilderInternal instantiates a new ItemDevicesItemRegisteredOwnersItemGraphEndpointRequestBuilder and sets the default values.
...
// NewItemDevicesItemRegisteredOwnersItemGraphEndpointRequestBuilder instantiates a new ItemDevicesItemRegisteredOwnersItemGraphEndpointRequestBuilder and sets the default values.
...
func (m *ItemDevicesItemRegisteredOwnersItemGraphEndpointRequestBuilder) WithUrl(rawUrl string)(*ItemDevicesItemRegisteredOwnersItemGraphEndpointRequestBuilder) {
    return NewItemDevicesItemRegisteredOwnersItemGraphEndpointRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
