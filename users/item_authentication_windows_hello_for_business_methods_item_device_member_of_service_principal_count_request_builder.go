...
// ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderGetQueryParameters get the number of the resource
type ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderGetQueryParameters struct {
...
type ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderGetQueryParameters
}
...
func NewItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
...
func (m *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
