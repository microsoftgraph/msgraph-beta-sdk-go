...
// NewItemDevicesItemRegisteredUsersGraphEndpointRequestBuilderInternal instantiates a new ItemDevicesItemRegisteredUsersGraphEndpointRequestBuilder and sets the default values.
...
// NewItemDevicesItemRegisteredUsersGraphEndpointRequestBuilder instantiates a new ItemDevicesItemRegisteredUsersGraphEndpointRequestBuilder and sets the default values.
...
func (m *ItemDevicesItemRegisteredUsersGraphEndpointRequestBuilder) WithUrl(rawUrl string)(*ItemDevicesItemRegisteredUsersGraphEndpointRequestBuilder) {
    return NewItemDevicesItemRegisteredUsersGraphEndpointRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
