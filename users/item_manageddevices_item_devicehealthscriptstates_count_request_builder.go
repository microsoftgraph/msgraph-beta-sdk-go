...
// NewItemManageddevicesItemDevicehealthscriptstatesCountRequestBuilderInternal instantiates a new ItemManageddevicesItemDevicehealthscriptstatesCountRequestBuilder and sets the default values.
func NewItemManageddevicesItemDevicehealthscriptstatesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemManageddevicesItemDevicehealthscriptstatesCountRequestBuilder) {
    m := &ItemManageddevicesItemDevicehealthscriptstatesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemManageddevicesItemDevicehealthscriptstatesCountRequestBuilder instantiates a new ItemManageddevicesItemDevicehealthscriptstatesCountRequestBuilder and sets the default values.
