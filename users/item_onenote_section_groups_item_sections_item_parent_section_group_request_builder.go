...
// NewItemOnenoteSectionGroupsItemSectionsItemParentSectionGroupRequestBuilderInternal instantiates a new ItemOnenoteSectionGroupsItemSectionsItemParentSectionGroupRequestBuilder and sets the default values.
func NewItemOnenoteSectionGroupsItemSectionsItemParentSectionGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnenoteSectionGroupsItemSectionsItemParentSectionGroupRequestBuilder) {
    m := &ItemOnenoteSectionGroupsItemSectionsItemParentSectionGroupRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/parentSectionGroup{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemOnenoteSectionGroupsItemSectionsItemParentSectionGroupRequestBuilder instantiates a new ItemOnenoteSectionGroupsItemSectionsItemParentSectionGroupRequestBuilder and sets the default values.
