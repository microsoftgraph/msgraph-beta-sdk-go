...
// ItemCalendarsItemCalendarviewItemExceptionoccurrencesItemInstancesItemExtensionsRequestBuilderGetQueryParameters the collection of open extensions defined for the event. Nullable.
...
// NewItemCalendarsItemCalendarviewItemExceptionoccurrencesItemInstancesItemExtensionsRequestBuilderInternal instantiates a new ItemCalendarsItemCalendarviewItemExceptionoccurrencesItemInstancesItemExtensionsRequestBuilder and sets the default values.
func NewItemCalendarsItemCalendarviewItemExceptionoccurrencesItemInstancesItemExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarsItemCalendarviewItemExceptionoccurrencesItemInstancesItemExtensionsRequestBuilder) {
    m := &ItemCalendarsItemCalendarviewItemExceptionoccurrencesItemInstancesItemExtensionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/extensions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemCalendarsItemCalendarviewItemExceptionoccurrencesItemInstancesItemExtensionsRequestBuilder instantiates a new ItemCalendarsItemCalendarviewItemExceptionoccurrencesItemInstancesItemExtensionsRequestBuilder and sets the default values.
