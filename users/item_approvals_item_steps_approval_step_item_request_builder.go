...
// ItemApprovalsItemStepsApprovalStepItemRequestBuilderGetQueryParameters get steps from users
...
func (m *ItemApprovalsItemStepsApprovalStepItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemApprovalsItemStepsApprovalStepItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
