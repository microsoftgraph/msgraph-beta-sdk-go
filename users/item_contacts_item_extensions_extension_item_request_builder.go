...
func (m *ItemContactsItemExtensionsExtensionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemContactsItemExtensionsExtensionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
