...
// ItemAuthenticationPasswordlessMicrosoftAuthenticatorMethodsItemDeviceGetMemberObjectsPostRequestBody provides operations to call the getMemberObjects method.
...
// NewItemAuthenticationPasswordlessMicrosoftAuthenticatorMethodsItemDeviceGetMemberObjectsPostRequestBody instantiates a new ItemAuthenticationPasswordlessMicrosoftAuthenticatorMethodsItemDeviceGetMemberObjectsPostRequestBody and sets the default values.
...
func CreateItemAuthenticationPasswordlessMicrosoftAuthenticatorMethodsItemDeviceGetMemberObjectsPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
...
func (m *ItemAuthenticationPasswordlessMicrosoftAuthenticatorMethodsItemDeviceGetMemberObjectsPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemAuthenticationPasswordlessMicrosoftAuthenticatorMethodsItemDeviceGetMemberObjectsPostRequestBody) GetSecurityEnabledOnly()(*bool) {
    return m.securityEnabledOnly
}
// Serialize serializes information the current object
func (m *ItemAuthenticationPasswordlessMicrosoftAuthenticatorMethodsItemDeviceGetMemberObjectsPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemAuthenticationPasswordlessMicrosoftAuthenticatorMethodsItemDeviceGetMemberObjectsPostRequestBody) SetSecurityEnabledOnly(value *bool)() {
