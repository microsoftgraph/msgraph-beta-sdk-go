...
func (m *UsersRequestBuilder) MicrosoftGraphGetManagedAppBlockedUsers()(*MicrosoftGraphGetManagedAppBlockedUsersRequestBuilder) {
    return NewMicrosoftGraphGetManagedAppBlockedUsersRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetUserOwnedObjects provides operations to call the getUserOwnedObjects method.
func (m *UsersRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*MicrosoftGraphGetUserOwnedObjectsRequestBuilder) {
...
func (m *UsersRequestBuilder) MicrosoftGraphValidatePassword()(*MicrosoftGraphValidatePasswordRequestBuilder) {
    return NewMicrosoftGraphValidatePasswordRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
