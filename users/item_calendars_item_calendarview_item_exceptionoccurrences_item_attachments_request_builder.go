...
func (m *ItemCalendarsItemCalendarviewItemExceptionoccurrencesItemAttachmentsRequestBuilder) CreateUploadSession()(*ItemCalendarsItemCalendarviewItemExceptionoccurrencesItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilder) {
    return NewItemCalendarsItemCalendarviewItemExceptionoccurrencesItemAttachmentsCreateuploadsessionCreateUploadSessionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
