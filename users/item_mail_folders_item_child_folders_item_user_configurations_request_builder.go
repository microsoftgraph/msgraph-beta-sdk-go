...
func (m *ItemMailFoldersItemChildFoldersItemUserConfigurationsRequestBuilder) Count()(*ItemMailFoldersItemChildFoldersItemUserConfigurationsCountRequestBuilder) {
    return NewItemMailFoldersItemChildFoldersItemUserConfigurationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get userConfigurations from users
func (m *ItemMailFoldersItemChildFoldersItemUserConfigurationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemMailFoldersItemChildFoldersItemUserConfigurationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
