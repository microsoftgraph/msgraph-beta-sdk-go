...
func (m *ItemMailFoldersItemMessagesMessageItemRequestBuilder) MicrosoftGraphUnsubscribe()(*ItemMailFoldersItemMessagesItemMicrosoftGraphUnsubscribeRequestBuilder) {
    return NewItemMailFoldersItemMessagesItemMicrosoftGraphUnsubscribeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
