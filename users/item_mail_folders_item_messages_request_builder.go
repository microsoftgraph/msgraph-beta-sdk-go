...
func (m *ItemMailFoldersItemMessagesRequestBuilder) MicrosoftGraphDelta()(*ItemMailFoldersItemMessagesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemMailFoldersItemMessagesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
