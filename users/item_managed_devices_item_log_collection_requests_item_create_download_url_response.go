...
// ItemManagedDevicesItemLogCollectionRequestsItemCreateDownloadUrlResponse provides operations to call the createDownloadUrl method.
...
func (m *ItemManagedDevicesItemLogCollectionRequestsItemCreateDownloadUrlResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemManagedDevicesItemLogCollectionRequestsItemCreateDownloadUrlResponse) SetAdditionalData(value map[string]interface{})() {
