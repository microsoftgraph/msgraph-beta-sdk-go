...
func (m *ItemContactFoldersItemChildFoldersItemContactsRequestBuilder) ByContactIdString(contactId string)(*ItemContactFoldersItemChildFoldersItemContactsContactItemRequestBuilder) {
