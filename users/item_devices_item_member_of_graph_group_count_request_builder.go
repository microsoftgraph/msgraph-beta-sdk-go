...
// NewItemDevicesItemMemberOfGraphGroupCountRequestBuilderInternal instantiates a new ItemDevicesItemMemberOfGraphGroupCountRequestBuilder and sets the default values.
func NewItemDevicesItemMemberOfGraphGroupCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDevicesItemMemberOfGraphGroupCountRequestBuilder) {
    m := &ItemDevicesItemMemberOfGraphGroupCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/graph.group/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemDevicesItemMemberOfGraphGroupCountRequestBuilder instantiates a new ItemDevicesItemMemberOfGraphGroupCountRequestBuilder and sets the default values.
