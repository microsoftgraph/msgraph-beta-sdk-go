...
// NewItemCloudPCsItemRenameRequestBuilderInternal instantiates a new RenameRequestBuilder and sets the default values.
...
// NewItemCloudPCsItemRenameRequestBuilder instantiates a new RenameRequestBuilder and sets the default values.
...
// Post rename a specific Cloud PC. Use this API to update the displayName for the Cloud PC entity. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation rename a specific Cloud PC. Use this API to update the displayName for the Cloud PC entity. This API is available in the following national cloud deployments.
