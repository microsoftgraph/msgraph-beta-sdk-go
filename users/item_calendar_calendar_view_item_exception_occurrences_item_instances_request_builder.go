...
// ItemCalendarCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilderGetQueryParameters get the instances (occurrences) of an event for a specified time range.  If the event is a `seriesMaster` type, this returns theoccurrences and exceptions of the event in the specified time range.
...
// NewItemCalendarCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilderInternal instantiates a new InstancesRequestBuilder and sets the default values.
...
// NewItemCalendarCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder instantiates a new InstancesRequestBuilder and sets the default values.
...
func (m *ItemCalendarCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder) Count()(*ItemCalendarCalendarViewItemExceptionOccurrencesItemInstancesCountRequestBuilder) {
    return NewItemCalendarCalendarViewItemExceptionOccurrencesItemInstancesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemCalendarCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemCalendarCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemCalendarCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder) Delta()(*ItemCalendarCalendarViewItemExceptionOccurrencesItemInstancesDeltaRequestBuilder) {
    return NewItemCalendarCalendarViewItemExceptionOccurrencesItemInstancesDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
