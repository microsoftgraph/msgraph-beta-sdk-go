...
// NewItemEventsItemExceptionOccurrencesItemAcceptRequestBuilderInternal instantiates a new ItemEventsItemExceptionOccurrencesItemAcceptRequestBuilder and sets the default values.
func NewItemEventsItemExceptionOccurrencesItemAcceptRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemEventsItemExceptionOccurrencesItemAcceptRequestBuilder) {
    m := &ItemEventsItemExceptionOccurrencesItemAcceptRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/accept", pathParameters),
    }
    return m
}
// NewItemEventsItemExceptionOccurrencesItemAcceptRequestBuilder instantiates a new ItemEventsItemExceptionOccurrencesItemAcceptRequestBuilder and sets the default values.
