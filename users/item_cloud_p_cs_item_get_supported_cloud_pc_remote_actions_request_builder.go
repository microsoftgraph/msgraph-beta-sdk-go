...
// ItemCloudPCsItemGetSupportedCloudPcRemoteActionsRequestBuilderGetQueryParameters get a list of supported Cloud PC remote actions for a specific Cloud PC device, including the action names and capabilities.
...
// NewItemCloudPCsItemGetSupportedCloudPcRemoteActionsRequestBuilderInternal instantiates a new ItemCloudPCsItemGetSupportedCloudPcRemoteActionsRequestBuilder and sets the default values.
...
// NewItemCloudPCsItemGetSupportedCloudPcRemoteActionsRequestBuilder instantiates a new ItemCloudPCsItemGetSupportedCloudPcRemoteActionsRequestBuilder and sets the default values.
