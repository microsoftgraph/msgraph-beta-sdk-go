...
// ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder provides operations to call the itemAt method.
type ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilderInternal instantiates a new ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, index *int32)(*ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder) {
    m := &ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder{
...
// NewItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder instantiates a new ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder) {
    ...
    return NewItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilderInternal(urlParams, requestAdapter, nil)
}
// Get invoke function itemAt
// returns a WorkbookDocumentTaskChangeable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WorkbookDocumentTaskChangeable, error) {
...
func (m *ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
