...
// NewItemItemsItemWorkbookFunctionsRank_EqRequestBuilderInternal instantiates a new Rank_EqRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsRank_EqRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsRank_EqRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/rank_Eq";
...
// NewItemItemsItemWorkbookFunctionsRank_EqRequestBuilder instantiates a new Rank_EqRequestBuilder and sets the default values.
