...
// NewItemItemsItemWorkbookFunctionsDcountRequestBuilderInternal instantiates a new DcountRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsDcountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsDcountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/dcount";
...
// NewItemItemsItemWorkbookFunctionsDcountRequestBuilder instantiates a new DcountRequestBuilder and sets the default values.
