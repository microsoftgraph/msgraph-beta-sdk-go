...
// NewItemItemsItemWorkbookFunctionsLogNorm_DistRequestBuilderInternal instantiates a new LogNorm_DistRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsLogNorm_DistRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsLogNorm_DistRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/logNorm_Dist";
...
// NewItemItemsItemWorkbookFunctionsLogNorm_DistRequestBuilder instantiates a new LogNorm_DistRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookFunctionsLogNorm_DistRequestBuilder) Post(ctx context.Context, body ItemItemsItemWorkbookFunctionsLogNorm_DistPostRequestBodyable, requestConfiguration *ItemItemsItemWorkbookFunctionsLogNorm_DistRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WorkbookFunctionResultable, error) {
