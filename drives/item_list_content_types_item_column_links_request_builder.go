...
// ByColumnLinkIdString provides operations to manage the columnLinks property of the microsoft.graph.contentType entity.
func (m *ItemListContentTypesItemColumnLinksRequestBuilder) ByColumnLinkIdString(columnLinkId string)(*ItemListContentTypesItemColumnLinksColumnLinkItemRequestBuilder) {
