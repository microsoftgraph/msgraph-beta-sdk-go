...
func (m *ItemListItemsListItemItemRequestBuilder) MicrosoftGraphCreateLink()(*ItemListItemsItemMicrosoftGraphCreateLinkRequestBuilder) {
    return NewItemListItemsItemMicrosoftGraphCreateLinkRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
