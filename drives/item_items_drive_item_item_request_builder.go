...
func (m *ItemItemsDriveItemItemRequestBuilder) ActivitiesById(id string)(*ItemItemsItemActivitiesItemActivityOLDItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemActivitiesItemActivityOLDItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemItemsDriveItemItemRequestBuilder) ChildrenById(id string)(*ItemItemsItemChildrenDriveItemItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemChildrenDriveItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
// MicrosoftGraphAssignSensitivityLabel provides operations to call the assignSensitivityLabel method.
func (m *ItemItemsDriveItemItemRequestBuilder) MicrosoftGraphAssignSensitivityLabel()(*ItemItemsItemMicrosoftGraphAssignSensitivityLabelAssignSensitivityLabelRequestBuilder) {
    return NewItemItemsItemMicrosoftGraphAssignSensitivityLabelAssignSensitivityLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// MicrosoftGraphExtractSensitivityLabels provides operations to call the extractSensitivityLabels method.
func (m *ItemItemsDriveItemItemRequestBuilder) MicrosoftGraphExtractSensitivityLabels()(*ItemItemsItemMicrosoftGraphExtractSensitivityLabelsExtractSensitivityLabelsRequestBuilder) {
    return NewItemItemsItemMicrosoftGraphExtractSensitivityLabelsExtractSensitivityLabelsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemItemsDriveItemItemRequestBuilder) PermissionsById(id string)(*ItemItemsItemPermissionsPermissionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemPermissionsPermissionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemItemsDriveItemItemRequestBuilder) SubscriptionsById(id string)(*ItemItemsItemSubscriptionsSubscriptionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemSubscriptionsSubscriptionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemItemsDriveItemItemRequestBuilder) ThumbnailsById(id string)(*ItemItemsItemThumbnailsThumbnailSetItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemThumbnailsThumbnailSetItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemItemsDriveItemItemRequestBuilder) VersionsById(id string)(*ItemItemsItemVersionsDriveItemVersionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemVersionsDriveItemVersionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
