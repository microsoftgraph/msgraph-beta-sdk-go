...
// ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody 
type ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody instantiates a new ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody()(*ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody) {
    m := &ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody) GetAlpha()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
...
func (m *ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["size"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetSize(val.(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable))
        }
        return nil
    }
...
func (m *ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody) GetSize()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
...
func (m *ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody) GetStandardDev()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
...
func (m *ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody) SetAlpha(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
...
func (m *ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody) SetSize(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
...
func (m *ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBody) SetStandardDev(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
    err := m.GetBackingStore().Set("standardDev", value)
    if err != nil {
        panic(err)
    }
}
// ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBodyable 
type ItemItemsItemWorkbookFunctionsConfidence_NormPostRequestBodyable interface {
    ...
    GetSize()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)
    ...
    SetSize(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)()
