...
import (
    ...
    ib68a150b227b26af9a1e366e5e21b7ecf1f8ca32796cbb27eac8a6c4569a9a5c "github.com/microsoftgraph/msgraph-beta-sdk-go/drives/item/bundles/item/listitem/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/listItem/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*ib68a150b227b26af9a1e366e5e21b7ecf1f8ca32796cbb27eac8a6c4569a9a5c.CountRequestBuilder) {
    return ib68a150b227b26af9a1e366e5e21b7ecf1f8ca32796cbb27eac8a6c4569a9a5c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
