...
// RichLongRunningOperationRequestBuilder builds and executes requests for operations under \drives\{drive-id}\list\operations\{richLongRunningOperation-id}
...
// RichLongRunningOperationRequestBuilderGetQueryParameters get operations from drives
