...
// ContentRequestBuilder builds and executes requests for operations under \drives\{drive-id}\list\items\{listItem-id}\activities\{itemActivityOLD-id}\driveItem\content
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/list/items/{listItem_id}/activities/{itemActivityOLD_id}/driveItem/content";
...
// CreateGetRequestInformation get media content for the navigation property driveItem from drives
...
// CreatePutRequestInformation update media content for the navigation property driveItem in drives
...
// Get get media content for the navigation property driveItem from drives
...
// Put update media content for the navigation property driveItem in drives
