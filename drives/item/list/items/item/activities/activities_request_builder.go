...
import (
    ...
    i462f4c1abe228c571859198105322d48ffe4bd42ef39ad8bf42482fa0020f532 "github.com/microsoftgraph/msgraph-beta-sdk-go/drives/item/list/items/item/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/list/items/{listItem_id}/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i462f4c1abe228c571859198105322d48ffe4bd42ef39ad8bf42482fa0020f532.CountRequestBuilder) {
    return i462f4c1abe228c571859198105322d48ffe4bd42ef39ad8bf42482fa0020f532.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
