...
// GetCompatibleHubContentTypesRequestBuilder builds and executes requests for operations under \drives\{drive-id}\list\contentTypes\{contentType-id}\baseTypes\microsoft.graph.getCompatibleHubContentTypes()
...
func NewGetCompatibleHubContentTypesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GetCompatibleHubContentTypesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/list/contentTypes/{contentType_id}/baseTypes/microsoft.graph.getCompatibleHubContentTypes()";
...
func (m *GetCompatibleHubContentTypesRequestBuilder) Get(options *GetCompatibleHubContentTypesRequestBuilderGetOptions)([]GetCompatibleHubContentTypes, error) {
    ...
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGetCompatibleHubContentTypes() }, nil)
    if err != nil {
        return nil, err
    }
