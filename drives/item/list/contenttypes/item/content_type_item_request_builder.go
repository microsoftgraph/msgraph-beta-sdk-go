...
// DeleteWithResponseHandler delete navigation property contentTypes for drives
...
// PatchWithResponseHandler update the navigation property contentTypes in drives
