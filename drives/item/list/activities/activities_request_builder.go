...
// ActivitiesRequestBuilder builds and executes requests for operations under \drives\{drive-id}\list\activities
...
// CreatePostRequestInformation the recent activities that took place within this list.
...
func (m *ActivitiesRequestBuilder) Get(options *ActivitiesRequestBuilderGetOptions)(*ActivitiesResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewActivitiesResponse() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*ActivitiesResponse), nil
}
// Post the recent activities that took place within this list.
