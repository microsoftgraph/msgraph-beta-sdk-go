...
import (
    ...
    i3f920b21965b6916ef1badc48ee56efc6883433a71e8b7faa388d537c929c185 "github.com/microsoftgraph/msgraph-beta-sdk-go/drives/item/list/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/list/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i3f920b21965b6916ef1badc48ee56efc6883433a71e8b7faa388d537c929c185.CountRequestBuilder) {
    return i3f920b21965b6916ef1badc48ee56efc6883433a71e8b7faa388d537c929c185.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
