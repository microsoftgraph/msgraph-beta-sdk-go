...
// Builds and executes requests for operations under \drives\{drive-id}\list\activities\{itemActivityOLD-id}\listItem\driveItem\content
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/drives/{drive_id}/list/activities/{itemActivityOLD_id}/listItem/driveItem/content";
