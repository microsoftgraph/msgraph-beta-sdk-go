...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/drives/{drive_id}/following/{driveItem_id}{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i75eb803effc4876884c7e0c6664eddcbe2110bbdf4af5809f0a2c16a06b0a9ed.ContentRequestBuilder) {
