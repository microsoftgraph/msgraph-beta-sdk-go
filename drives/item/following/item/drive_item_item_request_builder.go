...
// DriveItemItemRequestBuilder builds and executes requests for operations under \drives\{drive-id}\following\{driveItem-id}
...
// CreateDeleteRequestInformation the list of items the user is following. Only in OneDrive for Business.
...
// CreatePatchRequestInformation the list of items the user is following. Only in OneDrive for Business.
...
// Delete the list of items the user is following. Only in OneDrive for Business.
...
// Patch the list of items the user is following. Only in OneDrive for Business.
