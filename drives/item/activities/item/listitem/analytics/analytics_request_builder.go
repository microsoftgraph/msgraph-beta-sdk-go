...
import (
    ...
    i8984cfab10b908eba7df9c86e0231f79c5ae247d35fa0d1872eeeb90891a21a1 "github.com/microsoftgraph/msgraph-beta-sdk-go/drives/item/activities/item/listitem/analytics/ref"
)

// AnalyticsRequestBuilder builds and executes requests for operations under \drives\{drive-id}\activities\{itemActivityOLD-id}\listItem\analytics
...
func NewAnalyticsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AnalyticsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/activities/{itemActivityOLD_id}/listItem/analytics{?select,expand}";
...
func (m *AnalyticsRequestBuilder) Ref()(*i8984cfab10b908eba7df9c86e0231f79c5ae247d35fa0d1872eeeb90891a21a1.RefRequestBuilder) {
    return i8984cfab10b908eba7df9c86e0231f79c5ae247d35fa0d1872eeeb90891a21a1.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
