...
// FieldsRequestBuilder builds and executes requests for operations under \drives\{drive-id}\activities\{itemActivityOLD-id}\listItem\fields
...
func NewFieldsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FieldsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/activities/{itemActivityOLD_id}/listItem/fields{?select,expand}";
