...
// ActivitiesRequestBuilder builds and executes requests for operations under \drives\{drive-id}\activities
...
// CreatePostRequestInformation the list of recent activities that took place under this drive.
...
// Post the list of recent activities that took place under this drive.
