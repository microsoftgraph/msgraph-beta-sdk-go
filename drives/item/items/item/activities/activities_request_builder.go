...
import (
    ...
    i9825bdf807545d817bff76b86904715732662b1145c58c0aeb5bb5300a1b80b9 "github.com/microsoftgraph/msgraph-beta-sdk-go/drives/item/items/item/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive_id}/items/{driveItem_id}/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i9825bdf807545d817bff76b86904715732662b1145c58c0aeb5bb5300a1b80b9.CountRequestBuilder) {
    return i9825bdf807545d817bff76b86904715732662b1145c58c0aeb5bb5300a1b80b9.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
