...
// GetWithResponseHandler get content for the navigation property versions from drives
...
// PutWithResponseHandler update content for the navigation property versions in drives
