...
import (
    ...
    idb6a8e5a5105d67ba5020b4ccbb336f3445a5b6f6ddaa0f235b30c4976d4c19e "github.com/microsoftgraph/msgraph-beta-sdk-go/drives/item/items/item/listitem/documentsetversions/count"
)
...
func NewDocumentSetVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DocumentSetVersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DocumentSetVersionsRequestBuilder) Count()(*idb6a8e5a5105d67ba5020b4ccbb336f3445a5b6f6ddaa0f235b30c4976d4c19e.CountRequestBuilder) {
    return idb6a8e5a5105d67ba5020b4ccbb336f3445a5b6f6ddaa0f235b30c4976d4c19e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to documentSetVersions for drives
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to documentSetVersions for drives
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to documentSetVersions for drives
