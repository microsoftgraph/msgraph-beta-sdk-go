...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property activities for drives
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property activities in drives
