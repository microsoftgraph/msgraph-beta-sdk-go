...
// DeleteWithResponseHandler delete navigation property activities for drives
...
// PatchWithResponseHandler update the navigation property activities in drives
