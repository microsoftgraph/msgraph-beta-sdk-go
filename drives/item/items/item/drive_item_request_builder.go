...
// DriveItemRequestBuilder builds and executes requests for operations under \drives\{drive-id}\items\{driveItem-id}
...
// DriveItemRequestBuilderGetQueryParameters all items contained in the drive. Read-only. Nullable.
...
// CreateDeleteRequestInformation all items contained in the drive. Read-only. Nullable.
...
// CreatePatchRequestInformation all items contained in the drive. Read-only. Nullable.
...
// Delete all items contained in the drive. Read-only. Nullable.
...
// Patch all items contained in the drive. Read-only. Nullable.
