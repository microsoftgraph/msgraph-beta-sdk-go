...
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphFindFindPostRequestBody) GetFindText()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
    return m.findText
}
// GetStartNum gets the startNum property value. The startNum property
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphFindFindPostRequestBody) GetStartNum()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
    return m.startNum
}
// GetWithinText gets the withinText property value. The withinText property
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphFindFindPostRequestBody) GetWithinText()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
    return m.withinText
}
...
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphFindFindPostRequestBody) SetFindText(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
    m.findText = value
}
// SetStartNum sets the startNum property value. The startNum property
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphFindFindPostRequestBody) SetStartNum(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
    m.startNum = value
}
// SetWithinText sets the withinText property value. The withinText property
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphFindFindPostRequestBody) SetWithinText(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
    m.withinText = value
}
