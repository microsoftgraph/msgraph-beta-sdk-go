...
// NewItemItemsItemWorkbookFunctionsDec2BinRequestBuilderInternal instantiates a new Dec2BinRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsDec2BinRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsDec2BinRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/dec2Bin";
...
// NewItemItemsItemWorkbookFunctionsDec2BinRequestBuilder instantiates a new Dec2BinRequestBuilder and sets the default values.
