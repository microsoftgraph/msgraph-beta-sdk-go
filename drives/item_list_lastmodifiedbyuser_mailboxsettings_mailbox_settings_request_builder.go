...
func NewItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilder) {
    m := &ItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilder{
...
func NewItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilder) {
    ...
    return NewItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MailboxSettingsable, error) {
...
// returns a MailboxSettingsable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MailboxSettingsable, requestConfiguration *ItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MailboxSettingsable, error) {
...
func (m *ItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilder) WithUrl(rawUrl string)(*ItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilder) {
    return NewItemListLastmodifiedbyuserMailboxsettingsMailboxSettingsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
