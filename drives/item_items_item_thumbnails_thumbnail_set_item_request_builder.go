...
func (m *ItemItemsItemThumbnailsThumbnailSetItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemItemsItemThumbnailsThumbnailSetItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
