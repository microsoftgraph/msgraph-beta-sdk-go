...
// returns a *ItemItemsItemAnalyticsItemactivitystatsItemActivitiesItemDriveitemContentstreamContentStreamRequestBuilder when successful
func (m *ItemItemsItemAnalyticsItemactivitystatsItemActivitiesItemDriveitemDriveItemRequestBuilder) ContentStream()(*ItemItemsItemAnalyticsItemactivitystatsItemActivitiesItemDriveitemContentstreamContentStreamRequestBuilder) {
    return NewItemItemsItemAnalyticsItemactivitystatsItemActivitiesItemDriveitemContentstreamContentStreamRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
