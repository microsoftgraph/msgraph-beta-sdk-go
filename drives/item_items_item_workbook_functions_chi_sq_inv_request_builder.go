...
// NewItemItemsItemWorkbookFunctionsChiSq_InvRequestBuilderInternal instantiates a new ChiSq_InvRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsChiSq_InvRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsChiSq_InvRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/chiSq_Inv";
...
// NewItemItemsItemWorkbookFunctionsChiSq_InvRequestBuilder instantiates a new ChiSq_InvRequestBuilder and sets the default values.
