...
// Post use this API to create a new ChartPoint. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation use this API to create a new ChartPoint. This API is supported in the following national cloud deployments.
