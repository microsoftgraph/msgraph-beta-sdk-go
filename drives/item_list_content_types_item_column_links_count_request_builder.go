...
func (m *ItemListContentTypesItemColumnLinksCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListContentTypesItemColumnLinksCountRequestBuilderGetRequestConfiguration)(*int64, error) {
