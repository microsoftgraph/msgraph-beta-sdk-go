...
// ItemItemsItemWorkbookTablesRequestBuilderGetQueryParameters retrieve a list of table objects.
...
func NewItemItemsItemWorkbookTablesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookTablesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemItemsItemWorkbookTablesRequestBuilder instantiates a new TablesRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookTablesRequestBuilder) Count()(*ItemItemsItemWorkbookTablesMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookTablesMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemItemsItemWorkbookTablesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookTablesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WorkbookTableCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateWorkbookTableCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemItemsItemWorkbookTablesRequestBuilder) MicrosoftGraphAdd()(*ItemItemsItemWorkbookTablesMicrosoftGraphAddAddRequestBuilder) {
    return NewItemItemsItemWorkbookTablesMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCount provides operations to call the count method.
func (m *ItemItemsItemWorkbookTablesRequestBuilder) MicrosoftGraphCount()(*ItemItemsItemWorkbookTablesMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookTablesMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphItemAtWithIndex provides operations to call the itemAt method.
func (m *ItemItemsItemWorkbookTablesRequestBuilder) MicrosoftGraphItemAtWithIndex(index *int32)(*ItemItemsItemWorkbookTablesMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilder) {
    return NewItemItemsItemWorkbookTablesMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilderInternal(m.pathParameters, m.requestAdapter, index)
}
// Post create new navigation property to tables for drives
func (m *ItemItemsItemWorkbookTablesRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WorkbookTableable, requestConfiguration *ItemItemsItemWorkbookTablesRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WorkbookTableable, error) {
