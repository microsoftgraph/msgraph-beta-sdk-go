...
func NewDrivesItemFollowingCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemFollowingCountRequestBuilder) {
    m := &DrivesItemFollowingCountRequestBuilder{
    }
...
func NewDrivesItemFollowingCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemFollowingCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemFollowingCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DrivesItemFollowingCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemFollowingCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemFollowingCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemFollowingCountRequestBuilderGetRequestConfiguration)(*int32, error) {
