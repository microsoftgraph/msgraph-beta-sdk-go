...
func (m *ItemItemsItemAnalyticsRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemItemsItemAnalyticsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
