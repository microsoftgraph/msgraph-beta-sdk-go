...
// Post restore a driveItem that has been deleted and is currently in the recycle bin. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation restore a driveItem that has been deleted and is currently in the recycle bin. This API is supported in the following national cloud deployments.
