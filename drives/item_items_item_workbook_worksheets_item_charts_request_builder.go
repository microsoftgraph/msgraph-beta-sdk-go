...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsRequestBuilder) Count()(*ItemItemsItemWorkbookWorksheetsItemChartsMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsRequestBuilder) MicrosoftGraphAdd()(*ItemItemsItemWorkbookWorksheetsItemChartsMicrosoftGraphAddAddRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCount provides operations to call the count method.
func (m *ItemItemsItemWorkbookWorksheetsItemChartsRequestBuilder) MicrosoftGraphCount()(*ItemItemsItemWorkbookWorksheetsItemChartsMicrosoftGraphCountCountRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsMicrosoftGraphCountCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphItemAtWithIndex provides operations to call the itemAt method.
func (m *ItemItemsItemWorkbookWorksheetsItemChartsRequestBuilder) MicrosoftGraphItemAtWithIndex(index *int32)(*ItemItemsItemWorkbookWorksheetsItemChartsMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsMicrosoftGraphItemAtWithIndexItemAtWithIndexRequestBuilderInternal(m.pathParameters, m.requestAdapter, index)
}
// MicrosoftGraphItemWithName provides operations to call the item method.
func (m *ItemItemsItemWorkbookWorksheetsItemChartsRequestBuilder) MicrosoftGraphItemWithName(name *string)(*ItemItemsItemWorkbookWorksheetsItemChartsMicrosoftGraphItemWithNameItemWithNameRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsMicrosoftGraphItemWithNameItemWithNameRequestBuilderInternal(m.pathParameters, m.requestAdapter, name)
}
