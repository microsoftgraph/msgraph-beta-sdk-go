...
// NewItemItemsItemWorkbookWorksheetsItemNamesAddRequestBuilderInternal instantiates a new ItemItemsItemWorkbookWorksheetsItemNamesAddRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookWorksheetsItemNamesAddRequestBuilder instantiates a new ItemItemsItemWorkbookWorksheetsItemNamesAddRequestBuilder and sets the default values.
...
// returns a *ItemItemsItemWorkbookWorksheetsItemNamesAddRequestBuilder when successful
func (m *ItemItemsItemWorkbookWorksheetsItemNamesAddRequestBuilder) WithUrl(rawUrl string)(*ItemItemsItemWorkbookWorksheetsItemNamesAddRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemNamesAddRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
