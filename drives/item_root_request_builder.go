...
// ItemRootRequestBuilderGetQueryParameters retrieve the metadata for a driveItem in a drive by file system path or ID. This API is supported in the following national cloud deployments.
...
// Get retrieve the metadata for a driveItem in a drive by file system path or ID. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve the metadata for a driveItem in a drive by file system path or ID. This API is supported in the following national cloud deployments.
