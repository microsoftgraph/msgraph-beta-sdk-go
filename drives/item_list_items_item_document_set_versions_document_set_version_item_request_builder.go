...
func (m *ItemListItemsItemDocumentSetVersionsDocumentSetVersionItemRequestBuilder) MicrosoftGraphRestore()(*ItemListItemsItemDocumentSetVersionsItemMicrosoftGraphRestoreRequestBuilder) {
    return NewItemListItemsItemDocumentSetVersionsItemMicrosoftGraphRestoreRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
