...
func NewDrivesItemBundlesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemBundlesCountRequestBuilder) {
    m := &DrivesItemBundlesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/bundles/$count";
...
func NewDrivesItemBundlesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemBundlesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemBundlesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DrivesItemBundlesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemBundlesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemBundlesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemBundlesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
