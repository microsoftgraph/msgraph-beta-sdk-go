...
// NewItemItemsItemWorkbookFunctionsQuartile_ExcRequestBuilderInternal instantiates a new Quartile_ExcRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsQuartile_ExcRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsQuartile_ExcRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/quartile_Exc";
...
// NewItemItemsItemWorkbookFunctionsQuartile_ExcRequestBuilder instantiates a new Quartile_ExcRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookFunctionsQuartile_ExcRequestBuilder) Post(ctx context.Context, body ItemItemsItemWorkbookFunctionsQuartile_ExcPostRequestBodyable, requestConfiguration *ItemItemsItemWorkbookFunctionsQuartile_ExcRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WorkbookFunctionResultable, error) {
