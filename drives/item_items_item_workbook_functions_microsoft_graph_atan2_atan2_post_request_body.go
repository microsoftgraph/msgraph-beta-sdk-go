...
type ItemItemsItemWorkbookFunctionsMicrosoftGraphAtan2Atan2PostRequestBody struct {
    ...
    // The xNum property
    xNum ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable
    // The yNum property
    yNum ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable
}
...
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphAtan2Atan2PostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["xNum"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetXNum(val.(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable))
        }
        return nil
    }
    res["yNum"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetYNum(val.(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable))
        }
        return nil
    }
    return res
...
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphAtan2Atan2PostRequestBody) GetXNum()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
    return m.xNum
}
// GetYNum gets the yNum property value. The yNum property
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphAtan2Atan2PostRequestBody) GetYNum()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
    return m.yNum
}
...
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphAtan2Atan2PostRequestBody) SetXNum(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
    m.xNum = value
}
// SetYNum sets the yNum property value. The yNum property
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphAtan2Atan2PostRequestBody) SetYNum(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
    m.yNum = value
}
