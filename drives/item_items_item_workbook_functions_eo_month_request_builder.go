...
// ItemItemsItemWorkbookFunctionsEoMonthRequestBuilder provides operations to call the eoMonth method.
type ItemItemsItemWorkbookFunctionsEoMonthRequestBuilder struct {
...
// ItemItemsItemWorkbookFunctionsEoMonthRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemItemsItemWorkbookFunctionsEoMonthRequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func NewItemItemsItemWorkbookFunctionsEoMonthRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsEoMonthRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/eoMonth";
