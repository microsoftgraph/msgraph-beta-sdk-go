...
// ItemItemsItemWorkbookTablesItemRowsCountRequestBuilder provides operations to count the resources in the collection.
...
// ItemItemsItemWorkbookTablesItemRowsCountRequestBuilderGetQueryParameters get the number of the resource
type ItemItemsItemWorkbookTablesItemRowsCountRequestBuilderGetQueryParameters struct {
...
type ItemItemsItemWorkbookTablesItemRowsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemItemsItemWorkbookTablesItemRowsCountRequestBuilderGetQueryParameters
}
// NewItemItemsItemWorkbookTablesItemRowsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookTablesItemRowsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookTablesItemRowsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows/$count{?%24search,%24filter}";
...
// NewItemItemsItemWorkbookTablesItemRowsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookTablesItemRowsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookTablesItemRowsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
