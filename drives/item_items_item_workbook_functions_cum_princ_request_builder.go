...
// NewItemItemsItemWorkbookFunctionsCumPrincRequestBuilderInternal instantiates a new CumPrincRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsCumPrincRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsCumPrincRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/cumPrinc";
...
// NewItemItemsItemWorkbookFunctionsCumPrincRequestBuilder instantiates a new CumPrincRequestBuilder and sets the default values.
