...
func NewDrivesItemRootListItemVersionsItemRestoreVersionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootListItemVersionsItemRestoreVersionRequestBuilder) {
    m := &DrivesItemRootListItemVersionsItemRestoreVersionRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/root/listItem/versions/{listItemVersion%2Did}/microsoft.graph.restoreVersion";
...
func NewDrivesItemRootListItemVersionsItemRestoreVersionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootListItemVersionsItemRestoreVersionRequestBuilder) {
    ...
    return NewDrivesItemRootListItemVersionsItemRestoreVersionRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action restoreVersion
func (m *DrivesItemRootListItemVersionsItemRestoreVersionRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *DrivesItemRootListItemVersionsItemRestoreVersionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemRootListItemVersionsItemRestoreVersionRequestBuilder) Post(ctx context.Context, requestConfiguration *DrivesItemRootListItemVersionsItemRestoreVersionRequestBuilderPostRequestConfiguration)(error) {
