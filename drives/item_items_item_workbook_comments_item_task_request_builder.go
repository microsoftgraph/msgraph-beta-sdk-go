...
// ItemItemsItemWorkbookCommentsItemTaskRequestBuilderGetQueryParameters get task from drives
...
// NewItemItemsItemWorkbookCommentsItemTaskRequestBuilderInternal instantiates a new TaskRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookCommentsItemTaskRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookCommentsItemTaskRequestBuilder) {
    m := &ItemItemsItemWorkbookCommentsItemTaskRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/task{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemItemsItemWorkbookCommentsItemTaskRequestBuilder instantiates a new TaskRequestBuilder and sets the default values.
