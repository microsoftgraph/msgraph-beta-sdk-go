...
func NewItemRootUnfollowRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootUnfollowRequestBuilder) {
    m := &ItemRootUnfollowRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/root/microsoft.graph.unfollow";
...
func NewItemRootUnfollowRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootUnfollowRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemRootUnfollowRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation unfollow a driveItem.
func (m *ItemRootUnfollowRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *ItemRootUnfollowRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRootUnfollowRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemRootUnfollowRequestBuilderPostRequestConfiguration)(error) {
