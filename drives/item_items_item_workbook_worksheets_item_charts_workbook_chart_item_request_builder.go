...
func NewItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, workbookChartId *string)(*ItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilder) {
...
func NewItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilder) {
    ...
    return NewItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilder) MicrosoftGraphImage()(*ItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphImageImageRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphImageImageRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphImageWithWidth provides operations to call the image method.
func (m *ItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilder) MicrosoftGraphImageWithWidth(width *int32)(*ItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphImageWithWidthImageWithWidthRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphImageWithWidthImageWithWidthRequestBuilderInternal(m.pathParameters, m.requestAdapter, width)
}
// MicrosoftGraphImageWithWidthWithHeight provides operations to call the image method.
func (m *ItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilder) MicrosoftGraphImageWithWidthWithHeight(height *int32, width *int32)(*ItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphImageWithWidthWithHeightImageWithWidthWithHeightRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphImageWithWidthWithHeightImageWithWidthWithHeightRequestBuilderInternal(m.pathParameters, m.requestAdapter, height, width)
}
// MicrosoftGraphImageWithWidthWithHeightWithFittingMode provides operations to call the image method.
func (m *ItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilder) MicrosoftGraphImageWithWidthWithHeightWithFittingMode(fittingMode *string, height *int32, width *int32)(*ItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphImageWithWidthWithHeightWithFittingModeImageWithWidthWithHeightWithFittingModeRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphImageWithWidthWithHeightWithFittingModeImageWithWidthWithHeightWithFittingModeRequestBuilderInternal(m.pathParameters, m.requestAdapter, fittingMode, height, width)
}
// MicrosoftGraphSetData provides operations to call the setData method.
func (m *ItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilder) MicrosoftGraphSetData()(*ItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphSetDataSetDataRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphSetDataSetDataRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSetPosition provides operations to call the setPosition method.
func (m *ItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilder) MicrosoftGraphSetPosition()(*ItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphSetPositionSetPositionRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsItemMicrosoftGraphSetPositionSetPositionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilder) SeriesById(id string)(*ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesWorkbookChartSeriesItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookWorksheetsItemChartsItemSeriesWorkbookChartSeriesItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
