...
// NewItemItemsItemWorkbookFunctionsT_Dist_2TRequestBuilderInternal instantiates a new T_Dist_2TRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsT_Dist_2TRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsT_Dist_2TRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/t_Dist_2T";
...
// NewItemItemsItemWorkbookFunctionsT_Dist_2TRequestBuilder instantiates a new T_Dist_2TRequestBuilder and sets the default values.
