...
// ItemFollowingRequestBuilderGetQueryParameters list the items that the signed-in user followed.This collection includes items that are in the user's drive and items they have access to from other drives.
...
// Get list the items that the signed-in user followed.This collection includes items that are in the user's drive and items they have access to from other drives.
...
// ToGetRequestInformation list the items that the signed-in user followed.This collection includes items that are in the user's drive and items they have access to from other drives.
