...
// NewItemItemsItemWorkbookNamesItemRangeRequestBuilderInternal instantiates a new RangeRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookNamesItemRangeRequestBuilder instantiates a new RangeRequestBuilder and sets the default values.
...
// Get returns the range object that is associated with the name. Throws an exception if the named item's type is not a range. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation returns the range object that is associated with the name. Throws an exception if the named item's type is not a range. This API is supported in the following national cloud deployments.
