...
// ItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBody 
...
func (m *ItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBody) GetX()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
...
func (m *ItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBody) SetX(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
    err := m.GetBackingStore().Set("x", value)
    if err != nil {
        panic(err)
    }
}
// ItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBodyable 
