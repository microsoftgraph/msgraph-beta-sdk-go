...
// ItemRootListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters get the number of the resource
type ItemRootListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters struct {
...
type ItemRootListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemRootListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters
}
...
func NewItemRootListItemDocumentSetVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootListItemDocumentSetVersionsCountRequestBuilder) {
    m := &ItemRootListItemDocumentSetVersionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/root/listItem/documentSetVersions/$count{?%24search,%24filter}";
...
func NewItemRootListItemDocumentSetVersionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootListItemDocumentSetVersionsCountRequestBuilder) {
    ...
    return NewItemRootListItemDocumentSetVersionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemRootListItemDocumentSetVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRootListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemRootListItemDocumentSetVersionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemRootListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
