...
func NewItemRootCopyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootCopyRequestBuilder) {
    m := &ItemRootCopyRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/root/microsoft.graph.copy";
...
func NewItemRootCopyRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootCopyRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemRootCopyRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemRootCopyRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ItemRootCopyPostRequestBodyable, requestConfiguration *ItemRootCopyRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRootCopyRequestBuilder) Post(ctx context.Context, body ItemRootCopyPostRequestBodyable, requestConfiguration *ItemRootCopyRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
