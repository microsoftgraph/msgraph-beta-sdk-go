...
// ItemListItemsDeltaRequestBuilderGetQueryParameters invoke function delta
...
// NewItemListItemsDeltaRequestBuilderInternal instantiates a new DeltaRequestBuilder and sets the default values.
...
// NewItemListItemsDeltaRequestBuilder instantiates a new DeltaRequestBuilder and sets the default values.
...
func (m *ItemListItemsDeltaRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemListItemsDeltaRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemListItemsDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListItemsDeltaRequestBuilderGetRequestConfiguration)(ItemListItemsDeltaResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateItemListItemsDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
