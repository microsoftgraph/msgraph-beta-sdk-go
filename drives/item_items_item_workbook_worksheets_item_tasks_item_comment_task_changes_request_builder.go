...
// NewItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesRequestBuilderInternal instantiates a new ItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesRequestBuilder) {
    m := &ItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tasks/{workbookDocumentTask%2Did}/comment/task/changes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesRequestBuilder instantiates a new ItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesRequestBuilder and sets the default values.
...
// returns a *ItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesCountRequestBuilder when successful
...
// returns a *ItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesItematwithindexItemAtWithIndexRequestBuilder when successful
func (m *ItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesRequestBuilder) ItemAtWithIndex(index *int32)(*ItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesItematwithindexItemAtWithIndexRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesItematwithindexItemAtWithIndexRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, index)
}
...
// returns a *ItemItemsItemWorkbookWorksheetsItemTasksItemCommentTaskChangesRequestBuilder when successful
