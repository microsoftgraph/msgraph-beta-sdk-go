...
func (m *ItemItemsItemWorkbookRequestBuilder) CommentsById(id string)(*ItemItemsItemWorkbookCommentsWorkbookCommentItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookCommentsWorkbookCommentItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemItemsItemWorkbookRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Workbookable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateWorkbookFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemItemsItemWorkbookRequestBuilder) MicrosoftGraphCloseSession()(*ItemItemsItemWorkbookMicrosoftGraphCloseSessionCloseSessionRequestBuilder) {
    return NewItemItemsItemWorkbookMicrosoftGraphCloseSessionCloseSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCreateSession provides operations to call the createSession method.
func (m *ItemItemsItemWorkbookRequestBuilder) MicrosoftGraphCreateSession()(*ItemItemsItemWorkbookMicrosoftGraphCreateSessionCreateSessionRequestBuilder) {
    return NewItemItemsItemWorkbookMicrosoftGraphCreateSessionCreateSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRefreshSession provides operations to call the refreshSession method.
func (m *ItemItemsItemWorkbookRequestBuilder) MicrosoftGraphRefreshSession()(*ItemItemsItemWorkbookMicrosoftGraphRefreshSessionRefreshSessionRequestBuilder) {
    return NewItemItemsItemWorkbookMicrosoftGraphRefreshSessionRefreshSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSessionInfoResourceWithKey provides operations to call the sessionInfoResource method.
func (m *ItemItemsItemWorkbookRequestBuilder) MicrosoftGraphSessionInfoResourceWithKey(key *string)(*ItemItemsItemWorkbookMicrosoftGraphSessionInfoResourceWithKeySessionInfoResourceWithKeyRequestBuilder) {
    return NewItemItemsItemWorkbookMicrosoftGraphSessionInfoResourceWithKeySessionInfoResourceWithKeyRequestBuilderInternal(m.pathParameters, m.requestAdapter, key)
}
// MicrosoftGraphTableRowOperationResultWithKey provides operations to call the tableRowOperationResult method.
func (m *ItemItemsItemWorkbookRequestBuilder) MicrosoftGraphTableRowOperationResultWithKey(key *string)(*ItemItemsItemWorkbookMicrosoftGraphTableRowOperationResultWithKeyTableRowOperationResultWithKeyRequestBuilder) {
    return NewItemItemsItemWorkbookMicrosoftGraphTableRowOperationResultWithKeyTableRowOperationResultWithKeyRequestBuilderInternal(m.pathParameters, m.requestAdapter, key)
}
...
func (m *ItemItemsItemWorkbookRequestBuilder) NamesById(id string)(*ItemItemsItemWorkbookNamesWorkbookNamedItemItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookNamesWorkbookNamedItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemItemsItemWorkbookRequestBuilder) OperationsById(id string)(*ItemItemsItemWorkbookOperationsWorkbookOperationItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookOperationsWorkbookOperationItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemItemsItemWorkbookRequestBuilder) TablesById(id string)(*ItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookTablesWorkbookTableItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemItemsItemWorkbookRequestBuilder) WorksheetsById(id string)(*ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
