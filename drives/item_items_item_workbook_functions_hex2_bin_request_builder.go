...
// NewItemItemsItemWorkbookFunctionsHex2BinRequestBuilderInternal instantiates a new Hex2BinRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsHex2BinRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsHex2BinRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/hex2Bin";
...
// NewItemItemsItemWorkbookFunctionsHex2BinRequestBuilder instantiates a new Hex2BinRequestBuilder and sets the default values.
