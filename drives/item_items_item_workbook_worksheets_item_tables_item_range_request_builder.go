...
// NewItemItemsItemWorkbookWorksheetsItemTablesItemRangeRequestBuilderInternal instantiates a new RangeRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookWorksheetsItemTablesItemRangeRequestBuilder instantiates a new RangeRequestBuilder and sets the default values.
...
// Get gets the range object associated with the entire table. This API is available in the following national cloud deployments.
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/table-range?view=graph-rest-1.0
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemRangeRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookWorksheetsItemTablesItemRangeRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WorkbookRangeable, error) {
...
// ToGetRequestInformation gets the range object associated with the entire table. This API is available in the following national cloud deployments.
