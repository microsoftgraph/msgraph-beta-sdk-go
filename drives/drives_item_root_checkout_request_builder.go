...
func NewDrivesItemRootCheckoutRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootCheckoutRequestBuilder) {
    m := &DrivesItemRootCheckoutRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/root/microsoft.graph.checkout";
...
func NewDrivesItemRootCheckoutRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootCheckoutRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemRootCheckoutRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DrivesItemRootCheckoutRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *DrivesItemRootCheckoutRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemRootCheckoutRequestBuilder) Post(ctx context.Context, requestConfiguration *DrivesItemRootCheckoutRequestBuilderPostRequestConfiguration)(error) {
