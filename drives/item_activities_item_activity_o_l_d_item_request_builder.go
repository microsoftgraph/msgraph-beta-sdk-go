...
func NewItemActivitiesItemActivityOLDItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemActivitiesItemActivityOLDItemRequestBuilder) {
    m := &ItemActivitiesItemActivityOLDItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *ItemActivitiesItemActivityOLDItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemActivitiesItemActivityOLDItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
