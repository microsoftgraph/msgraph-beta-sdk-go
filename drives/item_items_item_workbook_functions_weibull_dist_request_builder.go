...
// NewItemItemsItemWorkbookFunctionsWeibull_DistRequestBuilderInternal instantiates a new Weibull_DistRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsWeibull_DistRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsWeibull_DistRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/weibull_Dist";
...
// NewItemItemsItemWorkbookFunctionsWeibull_DistRequestBuilder instantiates a new Weibull_DistRequestBuilder and sets the default values.
