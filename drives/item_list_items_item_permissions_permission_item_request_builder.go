...
// ItemListItemsItemPermissionsPermissionItemRequestBuilderGetQueryParameters get permissions from drives
...
// returns a *ItemListItemsItemPermissionsItemRevokegrantsRevokeGrantsRequestBuilder when successful
func (m *ItemListItemsItemPermissionsPermissionItemRequestBuilder) RevokeGrants()(*ItemListItemsItemPermissionsItemRevokegrantsRevokeGrantsRequestBuilder) {
    return NewItemListItemsItemPermissionsItemRevokegrantsRevokeGrantsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
