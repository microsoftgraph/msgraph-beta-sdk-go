...
// NewItemItemsItemWorkbookFunctionsIso_CeilingRequestBuilderInternal instantiates a new Iso_CeilingRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsIso_CeilingRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsIso_CeilingRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/iso_Ceiling";
...
// NewItemItemsItemWorkbookFunctionsIso_CeilingRequestBuilder instantiates a new Iso_CeilingRequestBuilder and sets the default values.
