...
func (m *ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder) ByDocumentSetVersionId(documentSetVersionId string)(*ItemListItemsItemDocumentsetversionsDocumentSetVersionItemRequestBuilder) {
...
func NewItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder) {
    m := &ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder{
...
func NewItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder) {
    ...
    return NewItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ItemListItemsItemDocumentsetversionsCountRequestBuilder when successful
func (m *ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder) Count()(*ItemListItemsItemDocumentsetversionsCountRequestBuilder) {
...
func (m *ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DocumentSetVersionCollectionResponseable, error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DocumentSetVersionable, requestConfiguration *ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DocumentSetVersionable, error) {
...
func (m *ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder when successful
func (m *ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder) WithUrl(rawUrl string)(*ItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder) {
    return NewItemListItemsItemDocumentsetversionsDocumentSetVersionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
