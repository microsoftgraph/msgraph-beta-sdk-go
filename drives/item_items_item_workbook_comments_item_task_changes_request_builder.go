...
// ItemItemsItemWorkbookCommentsItemTaskChangesRequestBuilderGetQueryParameters get changes from drives
...
// NewItemItemsItemWorkbookCommentsItemTaskChangesRequestBuilderInternal instantiates a new ChangesRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookCommentsItemTaskChangesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookCommentsItemTaskChangesRequestBuilder) {
    m := &ItemItemsItemWorkbookCommentsItemTaskChangesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/task/changes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemItemsItemWorkbookCommentsItemTaskChangesRequestBuilder instantiates a new ChangesRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookCommentsItemTaskChangesRequestBuilder) ItemAtWithIndex(index *int32)(*ItemItemsItemWorkbookCommentsItemTaskChangesItemAtWithIndexRequestBuilder) {
    return NewItemItemsItemWorkbookCommentsItemTaskChangesItemAtWithIndexRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, index)
}
