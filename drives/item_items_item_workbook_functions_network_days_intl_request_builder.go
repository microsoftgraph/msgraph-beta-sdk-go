...
// NewItemItemsItemWorkbookFunctionsNetworkDays_IntlRequestBuilderInternal instantiates a new NetworkDays_IntlRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsNetworkDays_IntlRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsNetworkDays_IntlRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/networkDays_Intl";
...
// NewItemItemsItemWorkbookFunctionsNetworkDays_IntlRequestBuilder instantiates a new NetworkDays_IntlRequestBuilder and sets the default values.
