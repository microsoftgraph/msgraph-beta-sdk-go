...
// NewItemItemsItemWorkbookFunctionsBinom_InvRequestBuilderInternal instantiates a new Binom_InvRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsBinom_InvRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsBinom_InvRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/binom_Inv";
...
// NewItemItemsItemWorkbookFunctionsBinom_InvRequestBuilder instantiates a new Binom_InvRequestBuilder and sets the default values.
