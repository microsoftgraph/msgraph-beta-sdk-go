...
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphDstDevPDstDevPPostRequestBody) GetCriteria()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
    return m.criteria
}
// GetDatabase gets the database property value. The database property
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphDstDevPDstDevPPostRequestBody) GetDatabase()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
    return m.database
}
// GetField gets the field property value. The field property
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphDstDevPDstDevPPostRequestBody) GetField()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable) {
    return m.field
}
...
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphDstDevPDstDevPPostRequestBody) SetCriteria(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
    m.criteria = value
}
// SetDatabase sets the database property value. The database property
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphDstDevPDstDevPPostRequestBody) SetDatabase(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
    m.database = value
}
// SetField sets the field property value. The field property
func (m *ItemItemsItemWorkbookFunctionsMicrosoftGraphDstDevPDstDevPPostRequestBody) SetField(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Jsonable)() {
    m.field = value
}
