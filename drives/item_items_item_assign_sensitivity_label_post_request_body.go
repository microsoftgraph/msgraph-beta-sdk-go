...
// ItemItemsItemAssignSensitivityLabelPostRequestBody provides operations to call the assignSensitivityLabel method.
...
func (m *ItemItemsItemAssignSensitivityLabelPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemItemsItemAssignSensitivityLabelPostRequestBody) SetAdditionalData(value map[string]interface{})() {
