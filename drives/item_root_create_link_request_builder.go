...
func NewItemRootCreateLinkRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootCreateLinkRequestBuilder) {
    m := &ItemRootCreateLinkRequestBuilder{
    }
...
func NewItemRootCreateLinkRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootCreateLinkRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemRootCreateLinkRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemRootCreateLinkRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ItemRootCreateLinkPostRequestBodyable, requestConfiguration *ItemRootCreateLinkRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRootCreateLinkRequestBuilder) Post(ctx context.Context, body ItemRootCreateLinkPostRequestBodyable, requestConfiguration *ItemRootCreateLinkRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Permissionable, error) {
