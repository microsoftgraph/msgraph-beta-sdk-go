...
// ItemItemsItemWorkbookTablesCountRequestBuilder provides operations to count the resources in the collection.
...
// ItemItemsItemWorkbookTablesCountRequestBuilderGetQueryParameters get the number of the resource
type ItemItemsItemWorkbookTablesCountRequestBuilderGetQueryParameters struct {
...
type ItemItemsItemWorkbookTablesCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemItemsItemWorkbookTablesCountRequestBuilderGetQueryParameters
}
// NewItemItemsItemWorkbookTablesCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookTablesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookTablesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/$count{?%24search,%24filter}";
...
// NewItemItemsItemWorkbookTablesCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookTablesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookTablesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
