...
// NewItemItemsItemWorkbookFunctionsImLog2RequestBuilderInternal instantiates a new ImLog2RequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsImLog2RequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsImLog2RequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/imLog2";
...
// NewItemItemsItemWorkbookFunctionsImLog2RequestBuilder instantiates a new ImLog2RequestBuilder and sets the default values.
