...
func (m *ItemItemsItemWorkbookWorksheetsItemNamesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookWorksheetsItemNamesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WorkbookNamedItemCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateWorkbookNamedItemCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemItemsItemWorkbookWorksheetsItemNamesRequestBuilder) MicrosoftGraphAdd()(*ItemItemsItemWorkbookWorksheetsItemNamesMicrosoftGraphAddAddRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemNamesMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphAddFormulaLocal provides operations to call the addFormulaLocal method.
func (m *ItemItemsItemWorkbookWorksheetsItemNamesRequestBuilder) MicrosoftGraphAddFormulaLocal()(*ItemItemsItemWorkbookWorksheetsItemNamesMicrosoftGraphAddFormulaLocalAddFormulaLocalRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemNamesMicrosoftGraphAddFormulaLocalAddFormulaLocalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
