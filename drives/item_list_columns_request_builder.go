...
// ByColumnDefinitionIdString provides operations to manage the columns property of the microsoft.graph.list entity.
func (m *ItemListColumnsRequestBuilder) ByColumnDefinitionIdString(columnDefinitionId string)(*ItemListColumnsColumnDefinitionItemRequestBuilder) {
