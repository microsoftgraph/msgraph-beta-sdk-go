...
// ItemRootAssignSensitivityLabelPostRequestBody 
...
func (m *ItemRootAssignSensitivityLabelPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemRootAssignSensitivityLabelPostRequestBody) SetAdditionalData(value map[string]any)() {
