...
// NewItemItemsItemWorkbookFunctionsDec2OctRequestBuilderInternal instantiates a new Dec2OctRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsDec2OctRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsDec2OctRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/dec2Oct";
...
// NewItemItemsItemWorkbookFunctionsDec2OctRequestBuilder instantiates a new Dec2OctRequestBuilder and sets the default values.
