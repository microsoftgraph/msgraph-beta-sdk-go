...
func (m *ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) ChartsById(id string)(*ItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookWorksheetsItemChartsWorkbookChartItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, workbookWorksheetId *string)(*ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) {
...
func NewItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) {
    ...
    return NewItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) MicrosoftGraphCellWithRowWithColumn(column *int32, row *int32)(*ItemItemsItemWorkbookWorksheetsItemMicrosoftGraphCellWithRowWithColumnCellWithRowWithColumnRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemMicrosoftGraphCellWithRowWithColumnCellWithRowWithColumnRequestBuilderInternal(m.pathParameters, m.requestAdapter, column, row)
}
// MicrosoftGraphRange provides operations to call the range method.
func (m *ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) MicrosoftGraphRange()(*ItemItemsItemWorkbookWorksheetsItemMicrosoftGraphRangeRangeRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemMicrosoftGraphRangeRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRangeWithAddress provides operations to call the range method.
func (m *ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) MicrosoftGraphRangeWithAddress(address *string)(*ItemItemsItemWorkbookWorksheetsItemMicrosoftGraphRangeWithAddressRangeWithAddressRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemMicrosoftGraphRangeWithAddressRangeWithAddressRequestBuilderInternal(m.pathParameters, m.requestAdapter, address)
}
// MicrosoftGraphUsedRange provides operations to call the usedRange method.
func (m *ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) MicrosoftGraphUsedRange()(*ItemItemsItemWorkbookWorksheetsItemMicrosoftGraphUsedRangeUsedRangeRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemMicrosoftGraphUsedRangeUsedRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUsedRangeWithValuesOnly provides operations to call the usedRange method.
func (m *ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) MicrosoftGraphUsedRangeWithValuesOnly(valuesOnly *bool)(*ItemItemsItemWorkbookWorksheetsItemMicrosoftGraphUsedRangeWithValuesOnlyUsedRangeWithValuesOnlyRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemMicrosoftGraphUsedRangeWithValuesOnlyUsedRangeWithValuesOnlyRequestBuilderInternal(m.pathParameters, m.requestAdapter, valuesOnly)
}
...
func (m *ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) NamesById(id string)(*ItemItemsItemWorkbookWorksheetsItemNamesWorkbookNamedItemItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookWorksheetsItemNamesWorkbookNamedItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) PivotTablesById(id string)(*ItemItemsItemWorkbookWorksheetsItemPivotTablesWorkbookPivotTableItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookWorksheetsItemPivotTablesWorkbookPivotTableItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemItemsItemWorkbookWorksheetsWorkbookWorksheetItemRequestBuilder) TablesById(id string)(*ItemItemsItemWorkbookWorksheetsItemTablesWorkbookTableItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsItemWorkbookWorksheetsItemTablesWorkbookTableItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
