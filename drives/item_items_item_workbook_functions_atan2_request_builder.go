...
func NewItemItemsItemWorkbookFunctionsAtan2RequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsAtan2RequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/atan2";
...
func (m *ItemItemsItemWorkbookFunctionsAtan2RequestBuilder) Post(ctx context.Context, body ItemItemsItemWorkbookFunctionsAtan2PostRequestBodyable, requestConfiguration *ItemItemsItemWorkbookFunctionsAtan2RequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WorkbookFunctionResultable, error) {
