...
// NewItemItemsItemWorkbookFunctionsDmaxRequestBuilderInternal instantiates a new DmaxRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsDmaxRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsDmaxRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/dmax";
...
// NewItemItemsItemWorkbookFunctionsDmaxRequestBuilder instantiates a new DmaxRequestBuilder and sets the default values.
