...
// NewItemItemsItemWorkbookWorksheetsItemTasksItemAtWithIndexChangesRequestBuilderInternal instantiates a new ChangesRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookWorksheetsItemTasksItemAtWithIndexChangesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemTasksItemAtWithIndexChangesRequestBuilder) {
    m := &ItemItemsItemWorkbookWorksheetsItemTasksItemAtWithIndexChangesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tasks/itemAt(index={index})/changes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemItemsItemWorkbookWorksheetsItemTasksItemAtWithIndexChangesRequestBuilder instantiates a new ChangesRequestBuilder and sets the default values.
