...
func NewDrivesItemRootContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootContentRequestBuilder) {
    m := &DrivesItemRootContentRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/root/content";
...
func NewDrivesItemRootContentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootContentRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemRootContentRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation the content stream, if the item represents a file.
func (m *DrivesItemRootContentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemRootContentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemRootContentRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *DrivesItemRootContentRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *DrivesItemRootContentRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemRootContentRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *DrivesItemRootContentRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *DrivesItemRootContentRequestBuilderPutRequestConfiguration)(error) {
