...
// NewItemItemsItemWorkbookFunctionsAverageRequestBuilderInternal instantiates a new AverageRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsAverageRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsAverageRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/average";
...
// NewItemItemsItemWorkbookFunctionsAverageRequestBuilder instantiates a new AverageRequestBuilder and sets the default values.
