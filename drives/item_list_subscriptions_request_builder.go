...
func (m *ItemListSubscriptionsRequestBuilder) GetVapidPublicKey()(*ItemListSubscriptionsGetVapidPublicKeyRequestBuilder) {
    return NewItemListSubscriptionsGetVapidPublicKeyRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
