...
// NewItemItemsItemWorkbookFunctionsPriceDiscRequestBuilderInternal instantiates a new PriceDiscRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsPriceDiscRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsPriceDiscRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/priceDisc";
...
// NewItemItemsItemWorkbookFunctionsPriceDiscRequestBuilder instantiates a new PriceDiscRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookFunctionsPriceDiscRequestBuilder) Post(ctx context.Context, body ItemItemsItemWorkbookFunctionsPriceDiscPostRequestBodyable, requestConfiguration *ItemItemsItemWorkbookFunctionsPriceDiscRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WorkbookFunctionResultable, error) {
