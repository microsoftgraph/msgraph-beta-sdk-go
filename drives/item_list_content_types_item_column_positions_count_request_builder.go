...
func (m *ItemListContentTypesItemColumnPositionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListContentTypesItemColumnPositionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
