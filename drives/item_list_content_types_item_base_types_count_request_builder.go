...
func (m *ItemListContentTypesItemBaseTypesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListContentTypesItemBaseTypesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
