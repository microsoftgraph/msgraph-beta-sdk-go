...
// ItemItemsItemWorkbookFunctionsDays360RequestBuilder provides operations to call the days360 method.
type ItemItemsItemWorkbookFunctionsDays360RequestBuilder struct {
...
// ItemItemsItemWorkbookFunctionsDays360RequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemItemsItemWorkbookFunctionsDays360RequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func NewItemItemsItemWorkbookFunctionsDays360RequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsDays360RequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/days360";
