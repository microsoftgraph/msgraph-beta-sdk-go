...
// NewItemItemsItemWorkbookFunctionsCeiling_MathRequestBuilderInternal instantiates a new Ceiling_MathRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookFunctionsCeiling_MathRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookFunctionsCeiling_MathRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/ceiling_Math";
...
// NewItemItemsItemWorkbookFunctionsCeiling_MathRequestBuilder instantiates a new Ceiling_MathRequestBuilder and sets the default values.
