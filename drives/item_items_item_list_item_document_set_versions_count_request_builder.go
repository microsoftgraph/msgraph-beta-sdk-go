...
// ItemItemsItemListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters get the number of the resource
type ItemItemsItemListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters struct {
...
type ItemItemsItemListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemItemsItemListItemDocumentSetVersionsCountRequestBuilderGetQueryParameters
}
...
func NewItemItemsItemListItemDocumentSetVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemListItemDocumentSetVersionsCountRequestBuilder) {
    m := &ItemItemsItemListItemDocumentSetVersionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions/$count{?%24search,%24filter}";
...
func NewItemItemsItemListItemDocumentSetVersionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemListItemDocumentSetVersionsCountRequestBuilder) {
    ...
    return NewItemItemsItemListItemDocumentSetVersionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemItemsItemListItemDocumentSetVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemItemsItemListItemDocumentSetVersionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemItemsItemListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
