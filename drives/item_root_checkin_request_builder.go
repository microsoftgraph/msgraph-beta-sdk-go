...
func NewItemRootCheckinRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootCheckinRequestBuilder) {
    m := &ItemRootCheckinRequestBuilder{
    }
...
func NewItemRootCheckinRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRootCheckinRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemRootCheckinRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemRootCheckinRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ItemRootCheckinPostRequestBodyable, requestConfiguration *ItemRootCheckinRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRootCheckinRequestBuilder) Post(ctx context.Context, body ItemRootCheckinPostRequestBodyable, requestConfiguration *ItemRootCheckinRequestBuilderPostRequestConfiguration)(error) {
