...
// ItemItemsItemWorkbookWorksheetsItemChartsItemWithNameTitleRequestBuilderGetQueryParameters retrieve the properties and relationships of charttitle object.
...
// NewItemItemsItemWorkbookWorksheetsItemChartsItemWithNameTitleRequestBuilderInternal instantiates a new TitleRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookWorksheetsItemChartsItemWithNameTitleRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemChartsItemWithNameTitleRequestBuilder) {
    m := &ItemItemsItemWorkbookWorksheetsItemChartsItemWithNameTitleRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/item(name='{name}')/title{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemItemsItemWorkbookWorksheetsItemChartsItemWithNameTitleRequestBuilder instantiates a new TitleRequestBuilder and sets the default values.
