...
func NewDrivesItemListDriveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListDriveRequestBuilder) {
    m := &DrivesItemListDriveRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/list/drive{?%24select,%24expand}";
...
func NewDrivesItemListDriveRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListDriveRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemListDriveRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DrivesItemListDriveRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemListDriveRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemListDriveRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemListDriveRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Driveable, error) {
