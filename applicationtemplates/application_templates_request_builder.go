...
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/applicationtemplate-list?view=graph-rest-1.0
...
// ToPostRequestInformation add new entity to applicationTemplates
