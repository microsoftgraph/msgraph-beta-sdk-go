...
func (m *MessageRecipientItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *MessageRecipientItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
