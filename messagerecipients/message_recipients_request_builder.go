...
// ByMessageRecipientIdString provides operations to manage the collection of messageRecipient entities.
func (m *MessageRecipientsRequestBuilder) ByMessageRecipientIdString(messageRecipientId string)(*MessageRecipientItemRequestBuilder) {
...
func NewMessageRecipientsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MessageRecipientsRequestBuilder) {
    m := &MessageRecipientsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/messageRecipients{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
