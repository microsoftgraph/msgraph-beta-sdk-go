...
// Builds and executes requests for operations under \messageRecipients\{messageRecipient-id}\events\{messageEvent-id}
...
func NewMessageEventRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MessageEventRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/messageRecipients/{messageRecipient_id}/events/{messageEvent_id}{?select,expand}";
