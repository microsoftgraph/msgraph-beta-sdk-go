...
// MessageEventRequestBuilder builds and executes requests for operations under \messageRecipients\{messageRecipient-id}\events\{messageEvent-id}
...
type MessageEventRequestBuilderGetOptions struct {
    ...
    Q *MessageEventRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
// MessageEventRequestBuilderGetQueryParameters get events from messageRecipients
...
func NewMessageEventRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MessageEventRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/messageRecipients/{messageRecipient_id}/events/{messageEvent_id}{?select,expand}";
...
// CreateDeleteRequestInformation delete navigation property events for messageRecipients
...
// CreatePatchRequestInformation update the navigation property events in messageRecipients
...
// Patch update the navigation property events in messageRecipients
