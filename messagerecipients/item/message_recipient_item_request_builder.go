...
// MessageRecipientItemRequestBuilderDeleteOptions options for Delete
type MessageRecipientItemRequestBuilderDeleteOptions struct {
    // Request headers
...
// MessageRecipientItemRequestBuilderGetOptions options for Get
type MessageRecipientItemRequestBuilderGetOptions struct {
    // Request headers
    Headers map[string]string;
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption;
...
type MessageRecipientItemRequestBuilderPatchOptions struct {
    // 
    Body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MessageRecipientable;
    // Request headers
    Headers map[string]string;
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption;
...
func NewMessageRecipientItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MessageRecipientItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/messageRecipients/{messageRecipient_id}{?select,expand}";
...
// CreateDeleteRequestInformation delete entity from messageRecipients
func (m *MessageRecipientItemRequestBuilder) CreateDeleteRequestInformation(options *MessageRecipientItemRequestBuilderDeleteOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// CreateGetRequestInformation get entity from messageRecipients by key
func (m *MessageRecipientItemRequestBuilder) CreateGetRequestInformation(options *MessageRecipientItemRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
// CreatePatchRequestInformation update entity in messageRecipients
func (m *MessageRecipientItemRequestBuilder) CreatePatchRequestInformation(options *MessageRecipientItemRequestBuilderPatchOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *MessageRecipientItemRequestBuilder) Delete(options *MessageRecipientItemRequestBuilderDeleteOptions)(error) {
...
func (m *MessageRecipientItemRequestBuilder) Get(options *MessageRecipientItemRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MessageRecipientable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateMessageRecipientFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
