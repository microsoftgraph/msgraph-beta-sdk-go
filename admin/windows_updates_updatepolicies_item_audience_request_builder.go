...
func (m *WindowsUpdatesUpdatepoliciesItemAudienceRequestBuilder) ApplicableContent()(*WindowsUpdatesUpdatepoliciesItemAudienceApplicablecontentApplicableContentRequestBuilder) {
    return NewWindowsUpdatesUpdatepoliciesItemAudienceApplicablecontentApplicableContentRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// NewWindowsUpdatesUpdatepoliciesItemAudienceRequestBuilderInternal instantiates a new WindowsUpdatesUpdatepoliciesItemAudienceRequestBuilder and sets the default values.
func NewWindowsUpdatesUpdatepoliciesItemAudienceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsUpdatesUpdatepoliciesItemAudienceRequestBuilder) {
    m := &WindowsUpdatesUpdatepoliciesItemAudienceRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewWindowsUpdatesUpdatepoliciesItemAudienceRequestBuilder instantiates a new WindowsUpdatesUpdatepoliciesItemAudienceRequestBuilder and sets the default values.
...
// returns a *WindowsUpdatesUpdatepoliciesItemAudienceMicrosoftgraphwindowsupdatesupdateaudienceMicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilder when successful
func (m *WindowsUpdatesUpdatepoliciesItemAudienceRequestBuilder) MicrosoftGraphWindowsUpdatesUpdateAudience()(*WindowsUpdatesUpdatepoliciesItemAudienceMicrosoftgraphwindowsupdatesupdateaudienceMicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilder) {
    return NewWindowsUpdatesUpdatepoliciesItemAudienceMicrosoftgraphwindowsupdatesupdateaudienceMicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *WindowsUpdatesUpdatepoliciesItemAudienceRequestBuilder) MicrosoftGraphWindowsUpdatesUpdateAudienceById()(*WindowsUpdatesUpdatepoliciesItemAudienceMicrosoftgraphwindowsupdatesupdateaudiencebyidMicrosoftGraphWindowsUpdatesUpdateAudienceByIdRequestBuilder) {
    return NewWindowsUpdatesUpdatepoliciesItemAudienceMicrosoftgraphwindowsupdatesupdateaudiencebyidMicrosoftGraphWindowsUpdatesUpdateAudienceByIdRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
