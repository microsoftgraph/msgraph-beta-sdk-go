...
// NewWindowsUpdatesDeploymentsItemAudienceExclusionsCountRequestBuilderInternal instantiates a new WindowsUpdatesDeploymentsItemAudienceExclusionsCountRequestBuilder and sets the default values.
func NewWindowsUpdatesDeploymentsItemAudienceExclusionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsUpdatesDeploymentsItemAudienceExclusionsCountRequestBuilder) {
    m := &WindowsUpdatesDeploymentsItemAudienceExclusionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/exclusions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewWindowsUpdatesDeploymentsItemAudienceExclusionsCountRequestBuilder instantiates a new WindowsUpdatesDeploymentsItemAudienceExclusionsCountRequestBuilder and sets the default values.
...
func (m *WindowsUpdatesDeploymentsItemAudienceExclusionsCountRequestBuilder) WithUrl(rawUrl string)(*WindowsUpdatesDeploymentsItemAudienceExclusionsCountRequestBuilder) {
    return NewWindowsUpdatesDeploymentsItemAudienceExclusionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
