...
func (m *ServiceAnnouncementIssuesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ServiceAnnouncementIssuesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
