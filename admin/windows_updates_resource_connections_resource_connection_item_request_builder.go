...
// NewWindowsUpdatesResourceConnectionsResourceConnectionItemRequestBuilderInternal instantiates a new WindowsUpdatesResourceConnectionsResourceConnectionItemRequestBuilder and sets the default values.
func NewWindowsUpdatesResourceConnectionsResourceConnectionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsUpdatesResourceConnectionsResourceConnectionItemRequestBuilder) {
    m := &WindowsUpdatesResourceConnectionsResourceConnectionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/windows/updates/resourceConnections/{resourceConnection%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewWindowsUpdatesResourceConnectionsResourceConnectionItemRequestBuilder instantiates a new WindowsUpdatesResourceConnectionsResourceConnectionItemRequestBuilder and sets the default values.
