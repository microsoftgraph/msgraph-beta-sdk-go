...
// ReportSettingsRequestBuilderGetQueryParameters get the tenant-level settings for Microsoft 365 reports. This API is available in the following national cloud deployments.
...
func NewReportSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ReportSettingsRequestBuilder) {
    m := &ReportSettingsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/reportSettings{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get get the tenant-level settings for Microsoft 365 reports. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
func (m *ReportSettingsRequestBuilder) Get(ctx context.Context, requestConfiguration *ReportSettingsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AdminReportSettingsable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateAdminReportSettingsFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// Patch update tenant-level settings for Microsoft 365 reports. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get the tenant-level settings for Microsoft 365 reports. This API is available in the following national cloud deployments.
...
// ToPatchRequestInformation update tenant-level settings for Microsoft 365 reports. This API is available in the following national cloud deployments.
