...
func (m *ExchangeMessageTracesItemRecipientsItemEventsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ExchangeMessageTracesItemRecipientsItemEventsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
