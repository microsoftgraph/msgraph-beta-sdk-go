...
func NewWindowsUpdatesUpdatePoliciesItemAudienceMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsUpdatesUpdatePoliciesItemAudienceMembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *WindowsUpdatesUpdatePoliciesItemAudienceMembersRequestBuilder) Count()(*WindowsUpdatesUpdatePoliciesItemAudienceMembersCountRequestBuilder) {
    return NewWindowsUpdatesUpdatePoliciesItemAudienceMembersCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *WindowsUpdatesUpdatePoliciesItemAudienceMembersRequestBuilder) WindowsUpdatesEnrollAssets()(*WindowsUpdatesUpdatePoliciesItemAudienceMembersWindowsUpdatesEnrollAssetsRequestBuilder) {
    return NewWindowsUpdatesUpdatePoliciesItemAudienceMembersWindowsUpdatesEnrollAssetsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// WindowsUpdatesEnrollAssetsById provides operations to call the enrollAssetsById method.
func (m *WindowsUpdatesUpdatePoliciesItemAudienceMembersRequestBuilder) WindowsUpdatesEnrollAssetsById()(*WindowsUpdatesUpdatePoliciesItemAudienceMembersWindowsUpdatesEnrollAssetsByIdRequestBuilder) {
    return NewWindowsUpdatesUpdatePoliciesItemAudienceMembersWindowsUpdatesEnrollAssetsByIdRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// WindowsUpdatesUnenrollAssets provides operations to call the unenrollAssets method.
func (m *WindowsUpdatesUpdatePoliciesItemAudienceMembersRequestBuilder) WindowsUpdatesUnenrollAssets()(*WindowsUpdatesUpdatePoliciesItemAudienceMembersWindowsUpdatesUnenrollAssetsRequestBuilder) {
    return NewWindowsUpdatesUpdatePoliciesItemAudienceMembersWindowsUpdatesUnenrollAssetsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// WindowsUpdatesUnenrollAssetsById provides operations to call the unenrollAssetsById method.
func (m *WindowsUpdatesUpdatePoliciesItemAudienceMembersRequestBuilder) WindowsUpdatesUnenrollAssetsById()(*WindowsUpdatesUpdatePoliciesItemAudienceMembersWindowsUpdatesUnenrollAssetsByIdRequestBuilder) {
    return NewWindowsUpdatesUpdatePoliciesItemAudienceMembersWindowsUpdatesUnenrollAssetsByIdRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
