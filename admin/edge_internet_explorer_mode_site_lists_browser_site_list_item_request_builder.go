...
func (m *EdgeInternetExplorerModeSiteListsBrowserSiteListItemRequestBuilder) MicrosoftGraphPublish()(*EdgeInternetExplorerModeSiteListsItemMicrosoftGraphPublishRequestBuilder) {
    return NewEdgeInternetExplorerModeSiteListsItemMicrosoftGraphPublishRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
