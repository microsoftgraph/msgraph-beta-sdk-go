...
// ExchangeMailboxesItemFoldersMailboxFolderItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ExchangeMailboxesItemFoldersMailboxFolderItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// ExchangeMailboxesItemFoldersMailboxFolderItemRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ExchangeMailboxesItemFoldersMailboxFolderItemRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
// Delete delete a mailboxFolder or a child mailboxFolder within a mailbox.
...
func (m *ExchangeMailboxesItemFoldersMailboxFolderItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ExchangeMailboxesItemFoldersMailboxFolderItemRequestBuilderDeleteRequestConfiguration)(error) {
...
// Patch update mailboxFolder properties such as the displayName within a mailbox.
// Deprecated: Private preview for Import Export APIs as of 2021-08/PrivatePreview:importExport on 2021-08-19 and will be removed 2021-11-15
// returns a MailboxFolderable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
...
// ToDeleteRequestInformation delete a mailboxFolder or a child mailboxFolder within a mailbox.
// Deprecated: Private preview for Import Export APIs as of 2021-08/PrivatePreview:importExport on 2021-08-19 and will be removed 2021-11-15
...
// ToPatchRequestInformation update mailboxFolder properties such as the displayName within a mailbox.
// Deprecated: Private preview for Import Export APIs as of 2021-08/PrivatePreview:importExport on 2021-08-19 and will be removed 2021-11-15
// returns a *RequestInformation when successful
