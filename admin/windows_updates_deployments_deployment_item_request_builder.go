...
// NewWindowsUpdatesDeploymentsDeploymentItemRequestBuilder instantiates a new WindowsUpdatesDeploymentsDeploymentItemRequestBuilder and sets the default values.
