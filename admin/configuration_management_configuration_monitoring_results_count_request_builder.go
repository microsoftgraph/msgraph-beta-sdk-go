...
func (m *ConfigurationManagementConfigurationMonitoringResultsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConfigurationManagementConfigurationMonitoringResultsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
