...
func (m *WindowsUpdatesProductsRequestBuilder) MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogID(catalogID *string)(*WindowsUpdatesProductsMicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogIDRequestBuilder) {
    return NewWindowsUpdatesProductsMicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogIDRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, catalogID)
}
...
func (m *WindowsUpdatesProductsRequestBuilder) MicrosoftGraphWindowsUpdatesFindByKbNumberWithKbNumber(kbNumber *int32)(*WindowsUpdatesProductsMicrosoftGraphWindowsUpdatesFindByKbNumberWithKbNumberRequestBuilder) {
    return NewWindowsUpdatesProductsMicrosoftGraphWindowsUpdatesFindByKbNumberWithKbNumberRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, kbNumber)
}
...
func (m *WindowsUpdatesProductsRequestBuilder) ToPostRequestInformation(ctx context.Context, body i17376df570f19ff3c32da2d66a677d31250ed0ff64059351645f48a152316b3c.Productable, requestConfiguration *WindowsUpdatesProductsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.POST, "{+baseurl}/admin/windows/updates/products", m.BaseRequestBuilder.PathParameters)
    if requestConfiguration != nil {
        requestInfo.Headers.AddAll(requestConfiguration.Headers)
        requestInfo.AddRequestOptions(requestConfiguration.Options)
    }
