...
func (m *WindowsUpdatesDeploymentsItemAudienceMembersItemAddMembersPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *WindowsUpdatesDeploymentsItemAudienceMembersItemAddMembersPostRequestBody) SetAdditionalData(value map[string]any)() {
