...
func (m *WindowsUpdatesUpdatePoliciesItemAudienceExclusionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsUpdatesUpdatePoliciesItemAudienceExclusionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
