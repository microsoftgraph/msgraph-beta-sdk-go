...
// WindowsUpdatesUpdatableAssetsItemAddMembersByIdPostRequestBody provides operations to call the addMembersById method.
...
func (m *WindowsUpdatesUpdatableAssetsItemAddMembersByIdPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *WindowsUpdatesUpdatableAssetsItemAddMembersByIdPostRequestBody) SetAdditionalData(value map[string]interface{})() {
