...
func (m *WindowsUpdatesDeploymentaudiencesItemApplicablecontentApplicableContentCatalogEntryItemRequestBuilder) CatalogEntry()(*WindowsUpdatesDeploymentaudiencesItemApplicablecontentItemCatalogentryCatalogEntryRequestBuilder) {
    return NewWindowsUpdatesDeploymentaudiencesItemApplicablecontentItemCatalogentryCatalogEntryRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *WindowsUpdatesDeploymentaudiencesItemApplicablecontentApplicableContentCatalogEntryItemRequestBuilder) MatchedDevices()(*WindowsUpdatesDeploymentaudiencesItemApplicablecontentItemMatcheddevicesMatchedDevicesRequestBuilder) {
    return NewWindowsUpdatesDeploymentaudiencesItemApplicablecontentItemMatcheddevicesMatchedDevicesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
