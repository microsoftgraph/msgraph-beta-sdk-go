...
func (m *ExchangeMailboxesItemFoldersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ExchangeMailboxesItemFoldersCountRequestBuilderGetRequestConfiguration)(*int64, error) {
