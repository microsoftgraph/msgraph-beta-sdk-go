...
func (m *ExchangeMessageTracesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ExchangeMessageTracesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
