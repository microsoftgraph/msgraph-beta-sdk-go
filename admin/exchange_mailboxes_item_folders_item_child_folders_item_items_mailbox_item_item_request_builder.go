...
// ExchangeMailboxesItemFoldersItemChildFoldersItemItemsMailboxItemItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ExchangeMailboxesItemFoldersItemChildFoldersItemItemsMailboxItemItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// Delete delete navigation property items for admin
...
func (m *ExchangeMailboxesItemFoldersItemChildFoldersItemItemsMailboxItemItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ExchangeMailboxesItemFoldersItemChildFoldersItemItemsMailboxItemItemRequestBuilderDeleteRequestConfiguration)(error) {
...
// ToDeleteRequestInformation delete navigation property items for admin
// Deprecated: Private preview for Import Export APIs as of 2021-08/PrivatePreview:importExport on 2021-08-19 and will be removed 2021-11-15
// returns a *RequestInformation when successful
func (m *ExchangeMailboxesItemFoldersItemChildFoldersItemItemsMailboxItemItemRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *ExchangeMailboxesItemFoldersItemChildFoldersItemItemsMailboxItemItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
