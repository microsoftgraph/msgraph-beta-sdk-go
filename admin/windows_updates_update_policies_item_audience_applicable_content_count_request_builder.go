...
func (m *WindowsUpdatesUpdatePoliciesItemAudienceApplicableContentCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsUpdatesUpdatePoliciesItemAudienceApplicableContentCountRequestBuilderGetRequestConfiguration)(*int64, error) {
