...
// WindowsUpdatesUpdatePoliciesUpdatePolicyItemRequestBuilderGetQueryParameters get updatePolicies from admin
...
func (m *WindowsUpdatesUpdatePoliciesUpdatePolicyItemRequestBuilder) ComplianceChangesById(id string)(*WindowsUpdatesUpdatePoliciesItemComplianceChangesComplianceChangeItemRequestBuilder) {
    ...
    idPtr := &id
    return NewWindowsUpdatesUpdatePoliciesItemComplianceChangesComplianceChangeItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewWindowsUpdatesUpdatePoliciesUpdatePolicyItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, updatePolicyId *string)(*WindowsUpdatesUpdatePoliciesUpdatePolicyItemRequestBuilder) {
...
func NewWindowsUpdatesUpdatePoliciesUpdatePolicyItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsUpdatesUpdatePoliciesUpdatePolicyItemRequestBuilder) {
    ...
    return NewWindowsUpdatesUpdatePoliciesUpdatePolicyItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
// Get get updatePolicies from admin
...
// ToGetRequestInformation get updatePolicies from admin
