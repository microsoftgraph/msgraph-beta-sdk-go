...
func (m *ServiceAnnouncementMessagesItemAttachmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ServiceAnnouncementMessagesItemAttachmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
