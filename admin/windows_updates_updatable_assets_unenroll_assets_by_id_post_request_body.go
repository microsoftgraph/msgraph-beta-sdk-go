...
// WindowsUpdatesUpdatableAssetsUnenrollAssetsByIdPostRequestBody provides operations to call the unenrollAssetsById method.
...
func (m *WindowsUpdatesUpdatableAssetsUnenrollAssetsByIdPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *WindowsUpdatesUpdatableAssetsUnenrollAssetsByIdPostRequestBody) SetAdditionalData(value map[string]interface{})() {
