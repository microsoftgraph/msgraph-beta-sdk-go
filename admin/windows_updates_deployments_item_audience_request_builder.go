...
func (m *WindowsUpdatesDeploymentsItemAudienceRequestBuilder) ApplicableContent()(*WindowsUpdatesDeploymentsItemAudienceApplicablecontentApplicableContentRequestBuilder) {
    return NewWindowsUpdatesDeploymentsItemAudienceApplicablecontentApplicableContentRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// NewWindowsUpdatesDeploymentsItemAudienceRequestBuilderInternal instantiates a new WindowsUpdatesDeploymentsItemAudienceRequestBuilder and sets the default values.
...
// NewWindowsUpdatesDeploymentsItemAudienceRequestBuilder instantiates a new WindowsUpdatesDeploymentsItemAudienceRequestBuilder and sets the default values.
...
func (m *WindowsUpdatesDeploymentsItemAudienceRequestBuilder) MicrosoftGraphWindowsUpdatesUpdateAudience()(*WindowsUpdatesDeploymentsItemAudienceMicrosoftgraphwindowsupdatesupdateaudienceMicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilder) {
    return NewWindowsUpdatesDeploymentsItemAudienceMicrosoftgraphwindowsupdatesupdateaudienceMicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *WindowsUpdatesDeploymentsItemAudienceRequestBuilder) MicrosoftGraphWindowsUpdatesUpdateAudienceById()(*WindowsUpdatesDeploymentsItemAudienceMicrosoftgraphwindowsupdatesupdateaudiencebyidMicrosoftGraphWindowsUpdatesUpdateAudienceByIdRequestBuilder) {
    return NewWindowsUpdatesDeploymentsItemAudienceMicrosoftgraphwindowsupdatesupdateaudiencebyidMicrosoftGraphWindowsUpdatesUpdateAudienceByIdRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *WindowsUpdatesDeploymentsItemAudienceRequestBuilder when successful
