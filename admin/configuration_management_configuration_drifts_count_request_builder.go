...
func NewConfigurationManagementConfigurationDriftsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConfigurationManagementConfigurationDriftsCountRequestBuilder) {
    m := &ConfigurationManagementConfigurationDriftsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/configurationManagement/configurationDrifts/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewConfigurationManagementConfigurationDriftsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConfigurationManagementConfigurationDriftsCountRequestBuilder) {
    ...
    return NewConfigurationManagementConfigurationDriftsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ConfigurationManagementConfigurationDriftsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConfigurationManagementConfigurationDriftsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ConfigurationManagementConfigurationDriftsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ConfigurationManagementConfigurationDriftsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ConfigurationManagementConfigurationDriftsCountRequestBuilder) WithUrl(rawUrl string)(*ConfigurationManagementConfigurationDriftsCountRequestBuilder) {
    return NewConfigurationManagementConfigurationDriftsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
