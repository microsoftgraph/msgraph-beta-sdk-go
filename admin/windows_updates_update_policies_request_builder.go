...
// WindowsUpdatesUpdatePoliciesRequestBuilderGetQueryParameters get a list of updatePolicy objects and their properties. This API is supported in the following national cloud deployments.
...
// Get get a list of updatePolicy objects and their properties. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create a new updatePolicy object. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get a list of updatePolicy objects and their properties. This API is supported in the following national cloud deployments.
...
// ToPostRequestInformation create a new updatePolicy object. This API is supported in the following national cloud deployments.
