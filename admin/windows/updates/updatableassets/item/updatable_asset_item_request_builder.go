...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property updatableAssets for admin
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property updatableAssets in admin
