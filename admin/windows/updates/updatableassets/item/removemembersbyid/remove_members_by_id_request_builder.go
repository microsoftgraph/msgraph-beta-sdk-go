...
// CreatePostRequestInformationWithRequestConfiguration remove members of the same type from an updatableAssetGroup. You can also use the method removeMembers to remove members.
