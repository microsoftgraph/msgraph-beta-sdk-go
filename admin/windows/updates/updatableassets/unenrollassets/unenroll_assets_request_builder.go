...
func (m *UnenrollAssetsRequestBuilder) CreatePostRequestInformation(body UnenrollAssetsPostRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreatePostRequestInformationWithRequestConfiguration(body, nil);
}
// CreatePostRequestInformationWithRequestConfiguration invoke action unenrollAssets
func (m *UnenrollAssetsRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body UnenrollAssetsPostRequestBodyable, requestConfiguration *UnenrollAssetsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UnenrollAssetsRequestBuilder) Post(body UnenrollAssetsPostRequestBodyable)(error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action unenrollAssets
func (m *UnenrollAssetsRequestBuilder) PostWithRequestConfigurationAndResponseHandler(body UnenrollAssetsPostRequestBodyable, requestConfiguration *UnenrollAssetsRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
