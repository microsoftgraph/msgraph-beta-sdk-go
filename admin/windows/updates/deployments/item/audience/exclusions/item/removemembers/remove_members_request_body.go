...
func (m *RemoveMembersRequestBody) GetAssets()([]i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UpdatableAsset) {
    if m == nil {
        return nil
    } else {
        return m.assets
...
func (m *RemoveMembersRequestBody) SetAssets(value []i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UpdatableAsset)() {
    if m != nil {
        m.assets = value
    }
}
