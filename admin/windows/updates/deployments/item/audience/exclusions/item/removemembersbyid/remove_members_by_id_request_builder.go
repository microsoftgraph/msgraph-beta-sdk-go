...
// RemoveMembersByIdRequestBuilder builds and executes requests for operations under \admin\windows\updates\deployments\{deployment-id}\audience\exclusions\{updatableAsset-id}\microsoft.graph.windowsUpdates.removeMembersById
...
func NewRemoveMembersByIdRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RemoveMembersByIdRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/admin/windows/updates/deployments/{deployment_id}/audience/exclusions/{updatableAsset_id}/microsoft.graph.windowsUpdates.removeMembersById";
