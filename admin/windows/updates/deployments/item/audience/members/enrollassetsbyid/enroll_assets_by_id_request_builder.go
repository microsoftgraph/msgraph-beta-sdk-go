...
func NewEnrollAssetsByIdRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EnrollAssetsByIdRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members/microsoft.graph.windowsUpdates.enrollAssetsById";
...
func (m *EnrollAssetsByIdRequestBuilder) CreatePostRequestInformation(ctx context.Context, body EnrollAssetsByIdPostRequestBodyable, requestConfiguration *EnrollAssetsByIdRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EnrollAssetsByIdRequestBuilder) Post(ctx context.Context, body EnrollAssetsByIdPostRequestBodyable, requestConfiguration *EnrollAssetsByIdRequestBuilderPostRequestConfiguration)(error) {
