...
// Builds and executes requests for operations under \admin\windows\updates\deployments\{deployment-id}\audience\members\{updatableAsset-id}\microsoft.graph.windowsUpdates.removeMembersById
