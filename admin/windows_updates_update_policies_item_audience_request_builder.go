...
func (m *WindowsUpdatesUpdatePoliciesItemAudienceRequestBuilder) Delete(ctx context.Context, requestConfiguration *WindowsUpdatesUpdatePoliciesItemAudienceRequestBuilderDeleteRequestConfiguration)([]byte, error) {
