...
// EdgeInternetExplorerModeSiteListsItemPublishPostRequestBody provides operations to call the publish method.
...
func (m *EdgeInternetExplorerModeSiteListsItemPublishPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *EdgeInternetExplorerModeSiteListsItemPublishPostRequestBody) GetSharedCookies()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.BrowserSharedCookieable) {
    return m.sharedCookies
}
// GetSites gets the sites property value. The sites property
func (m *EdgeInternetExplorerModeSiteListsItemPublishPostRequestBody) GetSites()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.BrowserSiteable) {
    return m.sites
}
...
func (m *EdgeInternetExplorerModeSiteListsItemPublishPostRequestBody) SetAdditionalData(value map[string]interface{})() {
...
func (m *EdgeInternetExplorerModeSiteListsItemPublishPostRequestBody) SetSharedCookies(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.BrowserSharedCookieable)() {
    m.sharedCookies = value
}
// SetSites sets the sites property value. The sites property
func (m *EdgeInternetExplorerModeSiteListsItemPublishPostRequestBody) SetSites(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.BrowserSiteable)() {
    m.sites = value
}
