...
func (m *WindowsUpdatesUpdatePoliciesItemComplianceChangesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsUpdatesUpdatePoliciesItemComplianceChangesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
