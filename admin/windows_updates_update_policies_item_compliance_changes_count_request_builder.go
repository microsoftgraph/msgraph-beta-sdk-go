...
// NewWindowsUpdatesUpdatePoliciesItemComplianceChangesCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewWindowsUpdatesUpdatePoliciesItemComplianceChangesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsUpdatesUpdatePoliciesItemComplianceChangesCountRequestBuilder) {
    m := &WindowsUpdatesUpdatePoliciesItemComplianceChangesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/complianceChanges/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewWindowsUpdatesUpdatePoliciesItemComplianceChangesCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
