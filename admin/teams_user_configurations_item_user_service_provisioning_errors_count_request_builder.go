...
func NewTeamsUserConfigurationsItemUserServiceProvisioningErrorsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamsUserConfigurationsItemUserServiceProvisioningErrorsCountRequestBuilder) {
    m := &TeamsUserConfigurationsItemUserServiceProvisioningErrorsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/teams/userConfigurations/{teamsUserConfiguration%2Did}/user/serviceProvisioningErrors/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewTeamsUserConfigurationsItemUserServiceProvisioningErrorsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamsUserConfigurationsItemUserServiceProvisioningErrorsCountRequestBuilder) {
    ...
    return NewTeamsUserConfigurationsItemUserServiceProvisioningErrorsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *TeamsUserConfigurationsItemUserServiceProvisioningErrorsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TeamsUserConfigurationsItemUserServiceProvisioningErrorsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *TeamsUserConfigurationsItemUserServiceProvisioningErrorsCountRequestBuilder) WithUrl(rawUrl string)(*TeamsUserConfigurationsItemUserServiceProvisioningErrorsCountRequestBuilder) {
    return NewTeamsUserConfigurationsItemUserServiceProvisioningErrorsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
