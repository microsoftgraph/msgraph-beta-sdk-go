...
func NewWindowsUpdatesDeploymentAudiencesItemExclusionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsUpdatesDeploymentAudiencesItemExclusionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/exclusions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *WindowsUpdatesDeploymentAudiencesItemExclusionsRequestBuilder) Count()(*WindowsUpdatesDeploymentAudiencesItemExclusionsCountRequestBuilder) {
    return NewWindowsUpdatesDeploymentAudiencesItemExclusionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *WindowsUpdatesDeploymentAudiencesItemExclusionsRequestBuilder) MicrosoftGraphWindowsUpdatesEnrollAssets()(*WindowsUpdatesDeploymentAudiencesItemExclusionsMicrosoftGraphWindowsUpdatesEnrollAssetsEnrollAssetsRequestBuilder) {
    return NewWindowsUpdatesDeploymentAudiencesItemExclusionsMicrosoftGraphWindowsUpdatesEnrollAssetsEnrollAssetsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphWindowsUpdatesEnrollAssetsById provides operations to call the enrollAssetsById method.
func (m *WindowsUpdatesDeploymentAudiencesItemExclusionsRequestBuilder) MicrosoftGraphWindowsUpdatesEnrollAssetsById()(*WindowsUpdatesDeploymentAudiencesItemExclusionsMicrosoftGraphWindowsUpdatesEnrollAssetsByIdEnrollAssetsByIdRequestBuilder) {
    return NewWindowsUpdatesDeploymentAudiencesItemExclusionsMicrosoftGraphWindowsUpdatesEnrollAssetsByIdEnrollAssetsByIdRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphWindowsUpdatesUnenrollAssets provides operations to call the unenrollAssets method.
func (m *WindowsUpdatesDeploymentAudiencesItemExclusionsRequestBuilder) MicrosoftGraphWindowsUpdatesUnenrollAssets()(*WindowsUpdatesDeploymentAudiencesItemExclusionsMicrosoftGraphWindowsUpdatesUnenrollAssetsUnenrollAssetsRequestBuilder) {
    return NewWindowsUpdatesDeploymentAudiencesItemExclusionsMicrosoftGraphWindowsUpdatesUnenrollAssetsUnenrollAssetsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphWindowsUpdatesUnenrollAssetsById provides operations to call the unenrollAssetsById method.
func (m *WindowsUpdatesDeploymentAudiencesItemExclusionsRequestBuilder) MicrosoftGraphWindowsUpdatesUnenrollAssetsById()(*WindowsUpdatesDeploymentAudiencesItemExclusionsMicrosoftGraphWindowsUpdatesUnenrollAssetsByIdUnenrollAssetsByIdRequestBuilder) {
    return NewWindowsUpdatesDeploymentAudiencesItemExclusionsMicrosoftGraphWindowsUpdatesUnenrollAssetsByIdUnenrollAssetsByIdRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
