...
func NewExchangeMailboxesItemFoldersItemItemsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExchangeMailboxesItemFoldersItemItemsCountRequestBuilder) {
    m := &ExchangeMailboxesItemFoldersItemItemsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}/items/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewExchangeMailboxesItemFoldersItemItemsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExchangeMailboxesItemFoldersItemItemsCountRequestBuilder) {
    ...
    return NewExchangeMailboxesItemFoldersItemItemsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// Deprecated: Private preview for Import Export APIs as of 2021-08/PrivatePreview:importExport
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ExchangeMailboxesItemFoldersItemItemsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ExchangeMailboxesItemFoldersItemItemsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ExchangeMailboxesItemFoldersItemItemsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ExchangeMailboxesItemFoldersItemItemsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ExchangeMailboxesItemFoldersItemItemsCountRequestBuilder) WithUrl(rawUrl string)(*ExchangeMailboxesItemFoldersItemItemsCountRequestBuilder) {
    return NewExchangeMailboxesItemFoldersItemItemsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
