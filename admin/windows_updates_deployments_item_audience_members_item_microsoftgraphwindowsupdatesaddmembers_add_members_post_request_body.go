...
// NewWindowsUpdatesDeploymentsItemAudienceMembersItemMicrosoftgraphwindowsupdatesaddmembersAddMembersPostRequestBody instantiates a new WindowsUpdatesDeploymentsItemAudienceMembersItemMicrosoftgraphwindowsupdatesaddmembersAddMembersPostRequestBody and sets the default values.
func NewWindowsUpdatesDeploymentsItemAudienceMembersItemMicrosoftgraphwindowsupdatesaddmembersAddMembersPostRequestBody()(*WindowsUpdatesDeploymentsItemAudienceMembersItemMicrosoftgraphwindowsupdatesaddmembersAddMembersPostRequestBody) {
    m := &WindowsUpdatesDeploymentsItemAudienceMembersItemMicrosoftgraphwindowsupdatesaddmembersAddMembersPostRequestBody{
    }
...
func (m *WindowsUpdatesDeploymentsItemAudienceMembersItemMicrosoftgraphwindowsupdatesaddmembersAddMembersPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetAssets() != nil {
...
func (m *WindowsUpdatesDeploymentsItemAudienceMembersItemMicrosoftgraphwindowsupdatesaddmembersAddMembersPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *WindowsUpdatesDeploymentsItemAudienceMembersItemMicrosoftgraphwindowsupdatesaddmembersAddMembersPostRequestBody) SetAssets(value []i17376df570f19ff3c32da2d66a677d31250ed0ff64059351645f48a152316b3c.UpdatableAssetable)() {
