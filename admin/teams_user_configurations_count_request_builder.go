...
func (m *TeamsUserConfigurationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TeamsUserConfigurationsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
