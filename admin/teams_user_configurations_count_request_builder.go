...
func NewTeamsUserConfigurationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamsUserConfigurationsCountRequestBuilder) {
    m := &TeamsUserConfigurationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/teams/userConfigurations/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewTeamsUserConfigurationsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamsUserConfigurationsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewTeamsUserConfigurationsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int64 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *TeamsUserConfigurationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TeamsUserConfigurationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
...
func (m *TeamsUserConfigurationsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *TeamsUserConfigurationsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *TeamsUserConfigurationsCountRequestBuilder) WithUrl(rawUrl string)(*TeamsUserConfigurationsCountRequestBuilder) {
    return NewTeamsUserConfigurationsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
