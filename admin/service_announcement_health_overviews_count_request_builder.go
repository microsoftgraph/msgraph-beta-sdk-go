...
func (m *ServiceAnnouncementHealthOverviewsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ServiceAnnouncementHealthOverviewsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
