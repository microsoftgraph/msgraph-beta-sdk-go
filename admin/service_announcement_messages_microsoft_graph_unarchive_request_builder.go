...
func NewServiceAnnouncementMessagesMicrosoftGraphUnarchiveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ServiceAnnouncementMessagesMicrosoftGraphUnarchiveRequestBuilder) {
    m := &ServiceAnnouncementMessagesMicrosoftGraphUnarchiveRequestBuilder{
    }
...
func NewServiceAnnouncementMessagesMicrosoftGraphUnarchiveRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ServiceAnnouncementMessagesMicrosoftGraphUnarchiveRequestBuilder) {
    ...
    return NewServiceAnnouncementMessagesMicrosoftGraphUnarchiveRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ServiceAnnouncementMessagesMicrosoftGraphUnarchiveRequestBuilder) Post(ctx context.Context, body ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchivePostRequestBodyable, requestConfiguration *ServiceAnnouncementMessagesMicrosoftGraphUnarchiveRequestBuilderPostRequestConfiguration)(ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponseable), nil
}
// ToPostRequestInformation unarchive a list of serviceUpdateMessages for the signed in user.
func (m *ServiceAnnouncementMessagesMicrosoftGraphUnarchiveRequestBuilder) ToPostRequestInformation(ctx context.Context, body ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchivePostRequestBodyable, requestConfiguration *ServiceAnnouncementMessagesMicrosoftGraphUnarchiveRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
