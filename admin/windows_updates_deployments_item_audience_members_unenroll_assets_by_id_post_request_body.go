...
func (m *WindowsUpdatesDeploymentsItemAudienceMembersUnenrollAssetsByIdPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *WindowsUpdatesDeploymentsItemAudienceMembersUnenrollAssetsByIdPostRequestBody) SetAdditionalData(value map[string]any)() {
