...
func (m *ServiceAnnouncementMessagesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ServiceAnnouncementMessagesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
