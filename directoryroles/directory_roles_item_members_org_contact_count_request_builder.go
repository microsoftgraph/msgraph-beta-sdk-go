...
func NewDirectoryRolesItemMembersOrgContactCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersOrgContactCountRequestBuilder) {
    m := &DirectoryRolesItemMembersOrgContactCountRequestBuilder{
    }
...
func NewDirectoryRolesItemMembersOrgContactCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRolesItemMembersOrgContactCountRequestBuilder) {
    ...
    return NewDirectoryRolesItemMembersOrgContactCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DirectoryRolesItemMembersOrgContactCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersOrgContactCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRolesItemMembersOrgContactCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRolesItemMembersOrgContactCountRequestBuilderGetRequestConfiguration)(*int32, error) {
