...
func (m *DeltaResponse) GetValue()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DirectoryRoleable) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *DeltaResponse) SetValue(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DirectoryRoleable)() {
    if m != nil {
        m.value = value
    }
}
