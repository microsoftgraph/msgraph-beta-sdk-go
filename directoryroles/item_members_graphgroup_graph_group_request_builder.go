...
type ItemMembersGraphgroupGraphGroupRequestBuilderGetQueryParameters struct {
...
type ItemMembersGraphgroupGraphGroupRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemMembersGraphgroupGraphGroupRequestBuilderGetQueryParameters
}
...
func NewItemMembersGraphgroupGraphGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersGraphgroupGraphGroupRequestBuilder) {
    m := &ItemMembersGraphgroupGraphGroupRequestBuilder{
...
func NewItemMembersGraphgroupGraphGroupRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersGraphgroupGraphGroupRequestBuilder) {
    ...
    return NewItemMembersGraphgroupGraphGroupRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemMembersGraphgroupGraphGroupRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMembersGraphgroupGraphGroupRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GroupCollectionResponseable, error) {
...
func (m *ItemMembersGraphgroupGraphGroupRequestBuilder) WithUrl(rawUrl string)(*ItemMembersGraphgroupGraphGroupRequestBuilder) {
    return NewItemMembersGraphgroupGraphGroupRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
