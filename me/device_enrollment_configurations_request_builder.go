...
func (m *DeviceEnrollmentConfigurationsRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceEnrollmentConfigurationsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceEnrollmentConfigurationCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceEnrollmentConfigurationCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *DeviceEnrollmentConfigurationsRequestBuilder) MicrosoftGraphCreateEnrollmentNotificationConfiguration()(*DeviceEnrollmentConfigurationsMicrosoftGraphCreateEnrollmentNotificationConfigurationCreateEnrollmentNotificationConfigurationRequestBuilder) {
    return NewDeviceEnrollmentConfigurationsMicrosoftGraphCreateEnrollmentNotificationConfigurationCreateEnrollmentNotificationConfigurationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphHasPayloadLinks provides operations to call the hasPayloadLinks method.
func (m *DeviceEnrollmentConfigurationsRequestBuilder) MicrosoftGraphHasPayloadLinks()(*DeviceEnrollmentConfigurationsMicrosoftGraphHasPayloadLinksHasPayloadLinksRequestBuilder) {
    return NewDeviceEnrollmentConfigurationsMicrosoftGraphHasPayloadLinksHasPayloadLinksRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// ToPostRequestInformation create new navigation property to deviceEnrollmentConfigurations for me
