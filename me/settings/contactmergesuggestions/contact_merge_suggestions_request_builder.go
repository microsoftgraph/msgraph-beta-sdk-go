...
// ContactMergeSuggestionsRequestBuilder builds and executes requests for operations under \me\settings\contactMergeSuggestions
...
// ContactMergeSuggestionsRequestBuilderGetQueryParameters get contactMergeSuggestions from me
...
func NewContactMergeSuggestionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContactMergeSuggestionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/settings/contactMergeSuggestions{?select,expand}";
...
// CreateGetRequestInformation get contactMergeSuggestions from me
...
// Get get contactMergeSuggestions from me
