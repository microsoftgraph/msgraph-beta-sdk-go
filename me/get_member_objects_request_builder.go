...
func (m *GetMemberObjectsRequestBuilder) Post(ctx context.Context, body GetMemberObjectsPostRequestBodyable, requestConfiguration *GetMemberObjectsRequestBuilderPostRequestConfiguration)(GetMemberObjectsResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateGetMemberObjectsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *GetMemberObjectsRequestBuilder) ToPostRequestInformation(ctx context.Context, body GetMemberObjectsPostRequestBodyable, requestConfiguration *GetMemberObjectsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
