...
func (m *ForwardRequestBody) GetMessage()(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Messageable) {
    if m == nil {
        return nil
    } else {
        return m.message
...
func (m *ForwardRequestBody) GetToRecipients()([]i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Recipientable) {
    if m == nil {
        return nil
    } else {
...
func (m *ForwardRequestBody) SetMessage(value i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Messageable)() {
    if m != nil {
        m.message = value
    }
}
// SetToRecipients sets the toRecipients property value. 
func (m *ForwardRequestBody) SetToRecipients(value []i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Recipientable)() {
    if m != nil {
