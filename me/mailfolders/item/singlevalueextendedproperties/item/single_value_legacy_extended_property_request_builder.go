...
// SingleValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \me\mailFolders\{mailFolder-id}\singleValueExtendedProperties\{singleValueLegacyExtendedProperty-id}
