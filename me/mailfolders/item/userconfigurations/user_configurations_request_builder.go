...
import (
    ...
    i7699ef7d76343195f0c39a7eb2c9462e08c0ec3e145bc133c1fccbeaf7fd1f25 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/mailfolders/item/userconfigurations/count"
)
...
func NewUserConfigurationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserConfigurationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/mailFolders/{mailFolder_id}/userConfigurations{?top,skip,filter,count,orderby,select}";
...
func (m *UserConfigurationsRequestBuilder) Count()(*i7699ef7d76343195f0c39a7eb2c9462e08c0ec3e145bc133c1fccbeaf7fd1f25.CountRequestBuilder) {
    return i7699ef7d76343195f0c39a7eb2c9462e08c0ec3e145bc133c1fccbeaf7fd1f25.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
