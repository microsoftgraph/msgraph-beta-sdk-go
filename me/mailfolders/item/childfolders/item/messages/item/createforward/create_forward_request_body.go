...
func (m *CreateForwardRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *CreateForwardRequestBody) GetMessage()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Messageable) {
    if m == nil {
        return nil
    } else {
        return m.message
...
func (m *CreateForwardRequestBody) GetToRecipients()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Recipientable) {
    if m == nil {
        return nil
    } else {
...
func (m *CreateForwardRequestBody) SetMessage(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Messageable)() {
    if m != nil {
        m.message = value
    }
}
// SetToRecipients sets the toRecipients property value. The ToRecipients property
func (m *CreateForwardRequestBody) SetToRecipients(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Recipientable)() {
    if m != nil {
