...
import (
    ...
    i5f42e224265a9d980a05b735eaf46b2b9a6a36a8ebac44cd47dcde3773e400af "github.com/microsoftgraph/msgraph-beta-sdk-go/me/mailfolders/item/childfolders/item/multivalueextendedproperties/count"
)

// MultiValueExtendedPropertiesRequestBuilder provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.mailFolder entity.
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*i5f42e224265a9d980a05b735eaf46b2b9a6a36a8ebac44cd47dcde3773e400af.CountRequestBuilder) {
    return i5f42e224265a9d980a05b735eaf46b2b9a6a36a8ebac44cd47dcde3773e400af.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
