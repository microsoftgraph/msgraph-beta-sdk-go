...
import (
    ...
    ifc3af74404ffefa051d50e3d0f56f0dda7f45aa97ca0a17bb8ddd120e1187e3d "github.com/microsoftgraph/msgraph-beta-sdk-go/me/devices/item/registeredowners/serviceprincipal/count"
)
...
func NewServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ServicePrincipalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/devices/{device%2Did}/registeredOwners/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ServicePrincipalRequestBuilder) Count()(*ifc3af74404ffefa051d50e3d0f56f0dda7f45aa97ca0a17bb8ddd120e1187e3d.CountRequestBuilder) {
    return ifc3af74404ffefa051d50e3d0f56f0dda7f45aa97ca0a17bb8ddd120e1187e3d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
