...
func NewDrivesItemRootCopyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootCopyRequestBuilder) {
    m := &DrivesItemRootCopyRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/microsoft.graph.copy";
...
func NewDrivesItemRootCopyRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemRootCopyRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemRootCopyRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DrivesItemRootCopyRequestBuilder) CreatePostRequestInformation(ctx context.Context, body DrivesItemRootCopyPostRequestBodyable, requestConfiguration *DrivesItemRootCopyRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemRootCopyRequestBuilder) Post(ctx context.Context, body DrivesItemRootCopyPostRequestBodyable, requestConfiguration *DrivesItemRootCopyRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
