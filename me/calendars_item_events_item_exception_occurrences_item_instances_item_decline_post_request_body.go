...
// CalendarsItemEventsItemExceptionOccurrencesItemInstancesItemDeclinePostRequestBody 
...
func (m *CalendarsItemEventsItemExceptionOccurrencesItemInstancesItemDeclinePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CalendarsItemEventsItemExceptionOccurrencesItemInstancesItemDeclinePostRequestBody) SetAdditionalData(value map[string]any)() {
