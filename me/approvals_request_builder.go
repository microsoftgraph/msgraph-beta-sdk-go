...
func (m *ApprovalsRequestBuilder) Count()(*ApprovalsCountRequestBuilder) {
    return NewApprovalsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ApprovalsRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*ApprovalsMicrosoftGraphFilterByCurrentUserWithOnFilterByCurrentUserWithOnRequestBuilder) {
    return NewApprovalsMicrosoftGraphFilterByCurrentUserWithOnFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
