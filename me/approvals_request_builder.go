...
func (m *ApprovalsRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*ApprovalsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilder) {
    return NewApprovalsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
