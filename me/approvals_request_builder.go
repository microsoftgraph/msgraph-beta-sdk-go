...
func (m *ApprovalsRequestBuilder) FilterByCurrentUserWithOn(on *string)(*ApprovalsFilterByCurrentUserWithOnRequestBuilder) {
    return NewApprovalsFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on);
}
