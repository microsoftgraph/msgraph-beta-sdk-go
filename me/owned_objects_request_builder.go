...
// OwnedObjectsRequestBuilderGetQueryParameters directory objects that are owned by the user. Read-only. Nullable. Supports $expand and $filter (/$count eq 0, /$count ne 0, /$count eq 1, /$count ne 1).
...
func (m *OwnedObjectsRequestBuilder) MicrosoftGraphApplication()(*OwnedObjectsMicrosoftGraphApplicationApplicationRequestBuilder) {
    return NewOwnedObjectsMicrosoftGraphApplicationApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGroup casts the previous resource to group.
func (m *OwnedObjectsRequestBuilder) MicrosoftGraphGroup()(*OwnedObjectsMicrosoftGraphGroupGroupRequestBuilder) {
    return NewOwnedObjectsMicrosoftGraphGroupGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *OwnedObjectsRequestBuilder) MicrosoftGraphServicePrincipal()(*OwnedObjectsMicrosoftGraphServicePrincipalServicePrincipalRequestBuilder) {
    return NewOwnedObjectsMicrosoftGraphServicePrincipalServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
