...
func (m *ChatsItemMessagesItemSetReactionPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ChatsItemMessagesItemSetReactionPostRequestBody) SetAdditionalData(value map[string]any)() {
