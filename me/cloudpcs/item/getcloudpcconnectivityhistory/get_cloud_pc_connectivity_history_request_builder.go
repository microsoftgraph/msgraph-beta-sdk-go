...
func NewGetCloudPcConnectivityHistoryRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetCloudPcConnectivityHistoryRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/microsoft.graph.getCloudPcConnectivityHistory()";
...
func (m *GetCloudPcConnectivityHistoryRequestBuilder) Get()(GetCloudPcConnectivityHistoryResponseable, error) {
    return m.GetWithRequestConfigurationAndResponseHandler(nil, nil);
}
// GetWithRequestConfigurationAndResponseHandler invoke function getCloudPcConnectivityHistory
func (m *GetCloudPcConnectivityHistoryRequestBuilder) GetWithRequestConfigurationAndResponseHandler(requestConfiguration *GetCloudPcConnectivityHistoryRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(GetCloudPcConnectivityHistoryResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetCloudPcConnectivityHistoryResponseFromDiscriminatorValue, responseHandler, errorMapping)
    if err != nil {
        return nil, err
    }
