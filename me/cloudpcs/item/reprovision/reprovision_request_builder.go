...
type ReprovisionRequestBuilderPostOptions struct {
    // 
    Body ReprovisionRequestBodyable;
    // Request headers
...
func NewReprovisionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ReprovisionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/cloudPCs/{cloudPC_id}/microsoft.graph.reprovision";
...
func (m *ReprovisionRequestBuilder) CreatePostRequestInformation(options *ReprovisionRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
