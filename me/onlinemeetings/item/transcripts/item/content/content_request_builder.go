...
// CreateGetRequestInformation get content for the navigation property transcripts from me
...
// CreateGetRequestInformationWithRequestConfiguration get content for the navigation property transcripts from me
...
// CreatePutRequestInformation update content for the navigation property transcripts in me
...
// CreatePutRequestInformationWithRequestConfiguration update content for the navigation property transcripts in me
...
// Get get content for the navigation property transcripts from me
func (m *ContentRequestBuilder) Get()([]byte, error) {
    return m.GetWithRequestConfigurationAndResponseHandler(nil, nil);
}
// GetWithRequestConfigurationAndResponseHandler get content for the navigation property transcripts from me
...
// Put update content for the navigation property transcripts in me
func (m *ContentRequestBuilder) Put(body []byte)(error) {
    return m.PutWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PutWithRequestConfigurationAndResponseHandler update content for the navigation property transcripts in me
