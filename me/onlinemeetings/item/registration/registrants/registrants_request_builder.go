...
// Builds and executes requests for operations under \me\onlineMeetings\{onlineMeeting-id}\registration\registrants
...
func NewRegistrantsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RegistrantsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/me/onlineMeetings/{onlineMeeting_id}/registration/registrants{?top,skip,search,filter,count,orderby,select,expand}";
