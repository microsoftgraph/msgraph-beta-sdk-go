...
func (m *ManagedDevicesItemWindowsProtectionStateRequestBuilder) DetectedMalwareStateById(id string)(*ManagedDevicesItemWindowsProtectionStateDetectedMalwareStateWindowsDeviceMalwareStateItemRequestBuilder) {
    ...
    idPtr := &id
    return NewManagedDevicesItemWindowsProtectionStateDetectedMalwareStateWindowsDeviceMalwareStateItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
// ToDeleteRequestInformation delete navigation property windowsProtectionState for me
...
// ToPatchRequestInformation update the navigation property windowsProtectionState in me
