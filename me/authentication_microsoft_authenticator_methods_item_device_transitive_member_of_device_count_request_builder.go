...
// AuthenticationMicrosoftAuthenticatorMethodsItemDeviceTransitiveMemberOfDeviceCountRequestBuilderGetQueryParameters get the number of the resource
type AuthenticationMicrosoftAuthenticatorMethodsItemDeviceTransitiveMemberOfDeviceCountRequestBuilderGetQueryParameters struct {
...
type AuthenticationMicrosoftAuthenticatorMethodsItemDeviceTransitiveMemberOfDeviceCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *AuthenticationMicrosoftAuthenticatorMethodsItemDeviceTransitiveMemberOfDeviceCountRequestBuilderGetQueryParameters
}
...
func NewAuthenticationMicrosoftAuthenticatorMethodsItemDeviceTransitiveMemberOfDeviceCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AuthenticationMicrosoftAuthenticatorMethodsItemDeviceTransitiveMemberOfDeviceCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/transitiveMemberOf/microsoft.graph.device/$count{?%24search,%24filter}";
