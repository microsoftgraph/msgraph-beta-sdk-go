...
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphAppDiagnosticsWithUpn(upn *string)(*ManagedDevicesMicrosoftGraphAppDiagnosticsWithUpnRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphAppDiagnosticsWithUpnRequestBuilderInternal(m.pathParameters, m.requestAdapter, upn)
}
// MicrosoftGraphBulkReprovisionCloudPc provides operations to call the bulkReprovisionCloudPc method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphBulkReprovisionCloudPc()(*ManagedDevicesMicrosoftGraphBulkReprovisionCloudPcRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphBulkReprovisionCloudPcRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBulkRestoreCloudPc provides operations to call the bulkRestoreCloudPc method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphBulkRestoreCloudPc()(*ManagedDevicesMicrosoftGraphBulkRestoreCloudPcRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphBulkRestoreCloudPcRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBulkSetCloudPcReviewStatus provides operations to call the bulkSetCloudPcReviewStatus method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphBulkSetCloudPcReviewStatus()(*ManagedDevicesMicrosoftGraphBulkSetCloudPcReviewStatusRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphBulkSetCloudPcReviewStatusRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDownloadAppDiagnostics provides operations to call the downloadAppDiagnostics method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphDownloadAppDiagnostics()(*ManagedDevicesMicrosoftGraphDownloadAppDiagnosticsRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphDownloadAppDiagnosticsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphExecuteAction provides operations to call the executeAction method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphExecuteAction()(*ManagedDevicesMicrosoftGraphExecuteActionRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphExecuteActionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphMoveDevicesToOU provides operations to call the moveDevicesToOU method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphMoveDevicesToOU()(*ManagedDevicesMicrosoftGraphMoveDevicesToOURequestBuilder) {
    return NewManagedDevicesMicrosoftGraphMoveDevicesToOURequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
