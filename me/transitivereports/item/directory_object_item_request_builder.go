...
// DirectoryObjectItemRequestBuilder provides operations to manage the transitiveReports property of the microsoft.graph.user entity.
...
// DirectoryObjectItemRequestBuilderGetQueryParameters the transitive reports for a user. Read-only.
