...
// OutlookTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilderGetQueryParameters get the number of the resource
type OutlookTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilderGetQueryParameters struct {
...
type OutlookTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *OutlookTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilderGetQueryParameters
}
...
func NewOutlookTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OutlookTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/outlook/taskFolders/{outlookTaskFolder%2Did}/tasks/{outlookTask%2Did}/singleValueExtendedProperties/$count{?%24search,%24filter}";
