...
func (m *ChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody) SetAdditionalData(value map[string]any)() {
