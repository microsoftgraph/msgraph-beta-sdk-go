...
// DrivesItemItemsItemPreviewPostRequestBody 
...
func (m *DrivesItemItemsItemPreviewPostRequestBody) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAllowEdit gets the allowEdit property value. The allowEdit property
func (m *DrivesItemItemsItemPreviewPostRequestBody) GetAllowEdit()(*bool) {
    return m.allowEdit
}
// GetChromeless gets the chromeless property value. The chromeless property
func (m *DrivesItemItemsItemPreviewPostRequestBody) GetChromeless()(*bool) {
    return m.chromeless
}
...
func (m *DrivesItemItemsItemPreviewPostRequestBody) GetViewer()(*string) {
    return m.viewer
}
...
func (m *DrivesItemItemsItemPreviewPostRequestBody) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAllowEdit sets the allowEdit property value. The allowEdit property
func (m *DrivesItemItemsItemPreviewPostRequestBody) SetAllowEdit(value *bool)() {
    m.allowEdit = value
}
// SetChromeless sets the chromeless property value. The chromeless property
func (m *DrivesItemItemsItemPreviewPostRequestBody) SetChromeless(value *bool)() {
    m.chromeless = value
}
...
func (m *DrivesItemItemsItemPreviewPostRequestBody) SetViewer(value *string)() {
    m.viewer = value
}
