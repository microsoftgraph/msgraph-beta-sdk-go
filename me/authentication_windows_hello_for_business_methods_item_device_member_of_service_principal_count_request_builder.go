...
// AuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderGetQueryParameters get the number of the resource
type AuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderGetQueryParameters struct {
...
type AuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *AuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderGetQueryParameters
}
...
func NewAuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
...
func (m *AuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AuthenticationWindowsHelloForBusinessMethodsItemDeviceMemberOfServicePrincipalCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
