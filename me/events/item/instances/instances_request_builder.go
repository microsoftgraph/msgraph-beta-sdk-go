...
// InstancesRequestBuilder builds and executes requests for operations under \me\events\{event-id}\instances
...
// Delta builds and executes requests for operations under \me\events\{event-id}\instances\microsoft.graph.delta()
