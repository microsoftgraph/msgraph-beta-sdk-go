...
import (
    ...
    i61996948a2e040f8b652837a6bd514e23b959b4574bd709ccde7ec6987d1573d "github.com/microsoftgraph/msgraph-beta-sdk-go/me/events/item/instances/item/exceptionoccurrences/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/events/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i61996948a2e040f8b652837a6bd514e23b959b4574bd709ccde7ec6987d1573d.CountRequestBuilder) {
    return i61996948a2e040f8b652837a6bd514e23b959b4574bd709ccde7ec6987d1573d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
