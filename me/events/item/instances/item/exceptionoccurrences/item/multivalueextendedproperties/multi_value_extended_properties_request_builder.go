...
import (
    ...
    i645a8c53bc66b62e7aeff8c9028d8ec7cea94d8f6eb6bb6a767b72c14045d4b1 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/events/item/instances/item/exceptionoccurrences/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/events/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*i645a8c53bc66b62e7aeff8c9028d8ec7cea94d8f6eb6bb6a767b72c14045d4b1.CountRequestBuilder) {
    return i645a8c53bc66b62e7aeff8c9028d8ec7cea94d8f6eb6bb6a767b72c14045d4b1.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
