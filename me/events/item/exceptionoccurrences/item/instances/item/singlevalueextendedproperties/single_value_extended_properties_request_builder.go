...
import (
    ...
    i248d4af92f1096e0780c5501d3b04b3850a6ffa8d9367626f7341a05d20a62aa "github.com/microsoftgraph/msgraph-beta-sdk-go/me/events/item/exceptionoccurrences/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/events/{event_id}/exceptionOccurrences/{event_id1}/instances/{event_id2}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i248d4af92f1096e0780c5501d3b04b3850a6ffa8d9367626f7341a05d20a62aa.CountRequestBuilder) {
    return i248d4af92f1096e0780c5501d3b04b3850a6ffa8d9367626f7341a05d20a62aa.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
