...
import (
    ...
    ib2a5add0994381c56851aea82ebc73a5dfdadb95f189f323dac776fb2a2c66b9 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/events/item/exceptionoccurrences/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/events/{event_id}/exceptionOccurrences/{event_id1}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*ib2a5add0994381c56851aea82ebc73a5dfdadb95f189f323dac776fb2a2c66b9.CountRequestBuilder) {
    return ib2a5add0994381c56851aea82ebc73a5dfdadb95f189f323dac776fb2a2c66b9.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
