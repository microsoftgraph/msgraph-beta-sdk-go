...
// CreateUploadSessionRequestBuilder builds and executes requests for operations under \me\events\{event-id}\attachments\microsoft.graph.createUploadSession
