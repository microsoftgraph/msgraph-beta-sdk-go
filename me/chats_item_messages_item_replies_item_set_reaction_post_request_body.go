...
// ChatsItemMessagesItemRepliesItemSetReactionPostRequestBody provides operations to call the setReaction method.
...
func (m *ChatsItemMessagesItemRepliesItemSetReactionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ChatsItemMessagesItemRepliesItemSetReactionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
