...
func (m *ChatsRequestBuilder) MicrosoftGraphAllMessages()(*ChatsMicrosoftGraphAllMessagesRequestBuilder) {
    return NewChatsMicrosoftGraphAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
