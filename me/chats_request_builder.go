...
func (m *ChatsRequestBuilder) MicrosoftGraphAllMessages()(*ChatsMicrosoftGraphAllMessagesAllMessagesRequestBuilder) {
    return NewChatsMicrosoftGraphAllMessagesAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetAllMessages provides operations to call the getAllMessages method.
func (m *ChatsRequestBuilder) MicrosoftGraphGetAllMessages()(*ChatsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilder) {
    return NewChatsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
