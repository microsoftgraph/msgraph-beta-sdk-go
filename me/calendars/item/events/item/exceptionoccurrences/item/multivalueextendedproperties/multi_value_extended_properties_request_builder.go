...
import (
    ...
    ib7b37a4456dbe46ea75ff7197b07be5f1860d5cbc402fd7134ffe69b1235dec7 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendars/item/events/item/exceptionoccurrences/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendars/{calendar_id}/events/{event_id}/exceptionOccurrences/{event_id1}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*ib7b37a4456dbe46ea75ff7197b07be5f1860d5cbc402fd7134ffe69b1235dec7.CountRequestBuilder) {
    return ib7b37a4456dbe46ea75ff7197b07be5f1860d5cbc402fd7134ffe69b1235dec7.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
