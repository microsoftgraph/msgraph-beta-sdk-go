...
import (
    ...
    if82b401bf511d08731fe560381cceb29832225b9784b126c3d632488614abe87 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendars/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendars/{calendar_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*if82b401bf511d08731fe560381cceb29832225b9784b126c3d632488614abe87.CountRequestBuilder) {
    return if82b401bf511d08731fe560381cceb29832225b9784b126c3d632488614abe87.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
