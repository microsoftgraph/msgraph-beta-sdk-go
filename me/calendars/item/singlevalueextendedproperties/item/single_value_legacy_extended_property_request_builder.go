...
// SingleValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \me\calendars\{calendar-id}\singleValueExtendedProperties\{singleValueLegacyExtendedProperty-id}
