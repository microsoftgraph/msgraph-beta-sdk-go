...
// CalendarViewRequestBuilder builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView
...
// Delta builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView\microsoft.graph.delta()
