...
import (
    ...
    i5506137a778a6d29902fbe0ba56e713c88f67fb5e5406ca00949a8d80e7ebad4 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendar/events/item/exceptionoccurrences/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendar/events/{event_id}/exceptionOccurrences/{event_id1}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*i5506137a778a6d29902fbe0ba56e713c88f67fb5e5406ca00949a8d80e7ebad4.CountRequestBuilder) {
    return i5506137a778a6d29902fbe0ba56e713c88f67fb5e5406ca00949a8d80e7ebad4.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
