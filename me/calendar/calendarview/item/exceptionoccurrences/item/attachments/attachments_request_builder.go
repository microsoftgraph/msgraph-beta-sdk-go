...
import (
    ...
    i8679103ce3166ef789d0285f7c62405104886706abb15fff6a79c5d413ee29a2 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendar/calendarview/item/exceptionoccurrences/item/attachments/count"
    if15d367cd22ac04a4ca34412b8a5db245f779b358ddba0c8bfb014ad65ef41ad "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendar/calendarview/item/exceptionoccurrences/item/attachments/createuploadsession"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendar/calendarView/{event_id}/exceptionOccurrences/{event_id1}/attachments{?top,skip,filter,count,orderby,select,expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*i8679103ce3166ef789d0285f7c62405104886706abb15fff6a79c5d413ee29a2.CountRequestBuilder) {
    return i8679103ce3166ef789d0285f7c62405104886706abb15fff6a79c5d413ee29a2.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*if15d367cd22ac04a4ca34412b8a5db245f779b358ddba0c8bfb014ad65ef41ad.CreateUploadSessionRequestBuilder) {
    return if15d367cd22ac04a4ca34412b8a5db245f779b358ddba0c8bfb014ad65ef41ad.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
