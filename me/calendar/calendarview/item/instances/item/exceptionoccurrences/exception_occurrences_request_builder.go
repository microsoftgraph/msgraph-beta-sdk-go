...
import (
    ...
    i3a0958d1cd664beade88e8b63a7dc70a3b407e51b731df217c088873fc95b841 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendar/calendarview/item/instances/item/exceptionoccurrences/delta"
    i8503baee8d0c5b174ff7f10084e4db9507d547edbd37e0ce9fd7e429fc1b792d "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendar/calendarview/item/instances/item/exceptionoccurrences/count"
)
...
func NewExceptionOccurrencesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ExceptionOccurrencesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendar/calendarView/{event_id}/instances/{event_id1}/exceptionOccurrences{?top,skip,filter,count,orderby,select,expand}";
...
func (m *ExceptionOccurrencesRequestBuilder) Count()(*i8503baee8d0c5b174ff7f10084e4db9507d547edbd37e0ce9fd7e429fc1b792d.CountRequestBuilder) {
    return i8503baee8d0c5b174ff7f10084e4db9507d547edbd37e0ce9fd7e429fc1b792d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ExceptionOccurrencesRequestBuilder) Delta()(*i3a0958d1cd664beade88e8b63a7dc70a3b407e51b731df217c088873fc95b841.DeltaRequestBuilder) {
    return i3a0958d1cd664beade88e8b63a7dc70a3b407e51b731df217c088873fc95b841.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
