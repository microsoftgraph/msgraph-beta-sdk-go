...
// CreateUploadSessionRequestBuilder builds and executes requests for operations under \me\calendar\calendarView\{event-id}\attachments\microsoft.graph.createUploadSession
