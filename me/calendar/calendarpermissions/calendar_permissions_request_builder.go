...
// CreatePostRequestInformationWithRequestConfiguration create a calendarPermission resource to specify the identity and role of the user with whom the specified calendar is being shared or delegated.
