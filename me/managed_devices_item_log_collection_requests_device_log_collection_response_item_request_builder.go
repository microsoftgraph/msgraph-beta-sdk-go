...
func (m *ManagedDevicesItemLogCollectionRequestsDeviceLogCollectionResponseItemRequestBuilder) MicrosoftGraphCreateDownloadUrl()(*ManagedDevicesItemLogCollectionRequestsItemMicrosoftGraphCreateDownloadUrlRequestBuilder) {
    return NewManagedDevicesItemLogCollectionRequestsItemMicrosoftGraphCreateDownloadUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// ToDeleteRequestInformation delete navigation property logCollectionRequests for me
...
// ToPatchRequestInformation update the navigation property logCollectionRequests in me
