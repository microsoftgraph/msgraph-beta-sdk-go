...
func (m *MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceRequestBuilder) Commands()(*MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceCommandsRequestBuilder) {
    return NewMeAuthenticationWindowsHelloForBusinessMethodsItemDeviceCommandsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CommandsById provides operations to manage the commands property of the microsoft.graph.device entity.
func (m *MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceRequestBuilder) CommandsById(id string)(*MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceCommandsCommandItemRequestBuilder) {
    ...
    return NewMeAuthenticationWindowsHelloForBusinessMethodsItemDeviceCommandsCommandItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Deviceable, requestConfiguration *MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceRequestBuilder) Get(ctx context.Context, requestConfiguration *MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Deviceable, error) {
...
func (m *MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceRequestBuilder) UsageRights()(*MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceUsageRightsRequestBuilder) {
    return NewMeAuthenticationWindowsHelloForBusinessMethodsItemDeviceUsageRightsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// UsageRightsById provides operations to manage the usageRights property of the microsoft.graph.device entity.
func (m *MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceRequestBuilder) UsageRightsById(id string)(*MeAuthenticationWindowsHelloForBusinessMethodsItemDeviceUsageRightsUsageRightItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewMeAuthenticationWindowsHelloForBusinessMethodsItemDeviceUsageRightsUsageRightItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
