...
// DrivesItemItemsItemPermissionsItemRevokeGrantsPostRequestBody 
...
func (m *DrivesItemItemsItemPermissionsItemRevokeGrantsPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *DrivesItemItemsItemPermissionsItemRevokeGrantsPostRequestBody) GetGrantees()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveRecipientable) {
    return m.grantees
}
...
func (m *DrivesItemItemsItemPermissionsItemRevokeGrantsPostRequestBody) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetGrantees sets the grantees property value. The grantees property
func (m *DrivesItemItemsItemPermissionsItemRevokeGrantsPostRequestBody) SetGrantees(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveRecipientable)() {
    m.grantees = value
}
