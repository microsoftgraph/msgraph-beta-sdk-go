...
func (m *MeCalendarsItemEventsEventItemRequestBuilder) ExceptionOccurrences()(*MeCalendarsItemEventsItemExceptionOccurrencesRequestBuilder) {
    return NewMeCalendarsItemEventsItemExceptionOccurrencesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *MeCalendarsItemEventsEventItemRequestBuilder) ExceptionOccurrencesById(id string)(*MeCalendarsItemEventsItemExceptionOccurrencesEventItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewMeCalendarsItemEventsItemExceptionOccurrencesEventItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *MeCalendarsItemEventsEventItemRequestBuilder) Get(ctx context.Context, requestConfiguration *MeCalendarsItemEventsEventItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Eventable, error) {
