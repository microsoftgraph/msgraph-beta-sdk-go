...
func (m *InformationProtectionRequestBuilder) MicrosoftGraphDecryptBuffer()(*InformationProtectionMicrosoftGraphDecryptBufferRequestBuilder) {
    return NewInformationProtectionMicrosoftGraphDecryptBufferRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEncryptBuffer provides operations to call the encryptBuffer method.
func (m *InformationProtectionRequestBuilder) MicrosoftGraphEncryptBuffer()(*InformationProtectionMicrosoftGraphEncryptBufferRequestBuilder) {
    return NewInformationProtectionMicrosoftGraphEncryptBufferRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSignDigest provides operations to call the signDigest method.
func (m *InformationProtectionRequestBuilder) MicrosoftGraphSignDigest()(*InformationProtectionMicrosoftGraphSignDigestRequestBuilder) {
    return NewInformationProtectionMicrosoftGraphSignDigestRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphVerifySignature provides operations to call the verifySignature method.
func (m *InformationProtectionRequestBuilder) MicrosoftGraphVerifySignature()(*InformationProtectionMicrosoftGraphVerifySignatureRequestBuilder) {
    return NewInformationProtectionMicrosoftGraphVerifySignatureRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
