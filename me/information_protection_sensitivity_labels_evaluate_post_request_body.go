...
// InformationProtectionSensitivityLabelsEvaluatePostRequestBody provides operations to call the evaluate method.
...
func (m *InformationProtectionSensitivityLabelsEvaluatePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *InformationProtectionSensitivityLabelsEvaluatePostRequestBody) SetAdditionalData(value map[string]interface{})() {
