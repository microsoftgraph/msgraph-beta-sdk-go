...
// PendingAccessReviewInstancesItemDecisionsItemInstanceStagesItemDecisionsItemInsightsCountRequestBuilderGetQueryParameters get the number of the resource
type PendingAccessReviewInstancesItemDecisionsItemInstanceStagesItemDecisionsItemInsightsCountRequestBuilderGetQueryParameters struct {
...
type PendingAccessReviewInstancesItemDecisionsItemInstanceStagesItemDecisionsItemInsightsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *PendingAccessReviewInstancesItemDecisionsItemInstanceStagesItemDecisionsItemInsightsCountRequestBuilderGetQueryParameters
}
...
func NewPendingAccessReviewInstancesItemDecisionsItemInstanceStagesItemDecisionsItemInsightsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PendingAccessReviewInstancesItemDecisionsItemInstanceStagesItemDecisionsItemInsightsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did1}/insights/$count{?%24search,%24filter}";
