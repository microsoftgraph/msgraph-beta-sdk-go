...
func (m *CalendarCalendarViewItemInstancesItemExceptionOccurrencesItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*CalendarCalendarViewItemInstancesItemExceptionOccurrencesItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilder) {
    return NewCalendarCalendarViewItemInstancesItemExceptionOccurrencesItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
