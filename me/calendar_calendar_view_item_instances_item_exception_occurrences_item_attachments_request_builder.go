...
func (m *CalendarCalendarViewItemInstancesItemExceptionOccurrencesItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*CalendarCalendarViewItemInstancesItemExceptionOccurrencesItemAttachmentsMicrosoftGraphCreateUploadSessionRequestBuilder) {
    return NewCalendarCalendarViewItemInstancesItemExceptionOccurrencesItemAttachmentsMicrosoftGraphCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
