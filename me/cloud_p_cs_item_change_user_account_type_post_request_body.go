...
// CloudPCsItemChangeUserAccountTypePostRequestBody 
...
func (m *CloudPCsItemChangeUserAccountTypePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CloudPCsItemChangeUserAccountTypePostRequestBody) SetAdditionalData(value map[string]any)() {
