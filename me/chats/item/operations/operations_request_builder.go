...
import (
    ...
    iabcac6fb866cab551167df7cf4ffe61f653abcbc67302d4a708f632c9d95e03e "github.com/microsoftgraph/msgraph-beta-sdk-go/me/chats/item/operations/count"
)
...
func NewOperationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OperationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/chats/{chat_id}/operations{?top,skip,search,filter,count,orderby,select,expand}";
