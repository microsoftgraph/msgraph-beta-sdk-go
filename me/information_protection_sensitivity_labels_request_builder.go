...
func (m *InformationProtectionSensitivityLabelsRequestBuilder) MicrosoftGraphEvaluate()(*InformationProtectionSensitivityLabelsMicrosoftGraphEvaluateRequestBuilder) {
    return NewInformationProtectionSensitivityLabelsMicrosoftGraphEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
