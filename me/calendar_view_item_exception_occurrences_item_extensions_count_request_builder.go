...
// CalendarViewItemExceptionOccurrencesItemExtensionsCountRequestBuilderGetQueryParameters get the number of the resource
type CalendarViewItemExceptionOccurrencesItemExtensionsCountRequestBuilderGetQueryParameters struct {
...
type CalendarViewItemExceptionOccurrencesItemExtensionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *CalendarViewItemExceptionOccurrencesItemExtensionsCountRequestBuilderGetQueryParameters
}
...
func NewCalendarViewItemExceptionOccurrencesItemExtensionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CalendarViewItemExceptionOccurrencesItemExtensionsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/extensions/$count{?%24filter}";
