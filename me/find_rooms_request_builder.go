...
func (m *FindRoomsRequestBuilder) Get(ctx context.Context, requestConfiguration *FindRoomsRequestBuilderGetRequestConfiguration)(FindRoomsResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateFindRoomsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *FindRoomsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *FindRoomsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
