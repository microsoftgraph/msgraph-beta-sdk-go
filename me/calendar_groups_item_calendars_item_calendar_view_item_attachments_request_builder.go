...
func (m *CalendarGroupsItemCalendarsItemCalendarViewItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*CalendarGroupsItemCalendarsItemCalendarViewItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilder) {
    return NewCalendarGroupsItemCalendarsItemCalendarViewItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
