...
type FindMeetingTimesResponse struct {
    ...
    meetingTimeSuggestionsResult i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MeetingTimeSuggestionsResultable;
}
...
func (m *FindMeetingTimesResponse) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["meetingTimeSuggestionsResult"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateMeetingTimeSuggestionsResultFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMeetingTimeSuggestionsResult(val.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MeetingTimeSuggestionsResultable))
        }
        return nil
    }
    return res
...
func (m *FindMeetingTimesResponse) GetMeetingTimeSuggestionsResult()(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MeetingTimeSuggestionsResultable) {
    if m == nil {
        return nil
    } else {
...
func (m *FindMeetingTimesResponse) SetMeetingTimeSuggestionsResult(value i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MeetingTimeSuggestionsResultable)() {
    if m != nil {
...
type FindMeetingTimesResponseable interface {
    ...
    GetMeetingTimeSuggestionsResult()(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MeetingTimeSuggestionsResultable)
    SetMeetingTimeSuggestionsResult(value i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MeetingTimeSuggestionsResultable)()
}
