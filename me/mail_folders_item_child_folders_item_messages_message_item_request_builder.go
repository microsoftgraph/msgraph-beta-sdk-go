...
func (m *MailFoldersItemChildFoldersItemMessagesMessageItemRequestBuilder) MicrosoftGraphUnsubscribe()(*MailFoldersItemChildFoldersItemMessagesItemMicrosoftGraphUnsubscribeRequestBuilder) {
    return NewMailFoldersItemChildFoldersItemMessagesItemMicrosoftGraphUnsubscribeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
