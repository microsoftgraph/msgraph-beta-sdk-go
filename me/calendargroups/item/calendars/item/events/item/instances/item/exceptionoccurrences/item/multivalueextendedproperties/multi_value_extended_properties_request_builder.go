...
import (
    ...
    ie94462cf6dd2856559dbf65b01d73a0954e8d2f77f422242ea0a30acf4af74a6 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendargroups/item/calendars/item/events/item/instances/item/exceptionoccurrences/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/events/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*ie94462cf6dd2856559dbf65b01d73a0954e8d2f77f422242ea0a30acf4af74a6.CountRequestBuilder) {
    return ie94462cf6dd2856559dbf65b01d73a0954e8d2f77f422242ea0a30acf4af74a6.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
