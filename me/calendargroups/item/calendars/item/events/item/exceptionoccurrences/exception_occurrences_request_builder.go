...
// ExceptionOccurrencesRequestBuilder builds and executes requests for operations under \me\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\events\{event-id}\exceptionOccurrences
...
type ExceptionOccurrencesRequestBuilderGetOptions struct {
    ...
    Q *ExceptionOccurrencesRequestBuilderGetQueryParameters;
...
// Delta builds and executes requests for operations under \me\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\events\{event-id}\exceptionOccurrences\microsoft.graph.delta()
...
func (m *ExceptionOccurrencesRequestBuilder) Get(options *ExceptionOccurrencesRequestBuilderGetOptions)(*ExceptionOccurrencesResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewExceptionOccurrencesResponse() }, nil)
    if err != nil {
        return nil, err
    }
