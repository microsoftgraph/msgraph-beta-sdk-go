...
import (
    ...
    i60fd4d9cb7c92505056612a6e8947d55118a2049f36fb926e64b9abc5ad6cafe "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendargroups/item/calendars/item/events/item/exceptionoccurrences/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/events/{event_id}/exceptionOccurrences/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i60fd4d9cb7c92505056612a6e8947d55118a2049f36fb926e64b9abc5ad6cafe.CountRequestBuilder) {
    return i60fd4d9cb7c92505056612a6e8947d55118a2049f36fb926e64b9abc5ad6cafe.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
