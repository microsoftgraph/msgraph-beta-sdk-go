...
import (
    ...
    i3d52e2d49d7222eecff1f3043da3fd1575f649b18b67829181d3281b0a08d761 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendargroups/item/calendars/item/events/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/events/{event_id}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*i3d52e2d49d7222eecff1f3043da3fd1575f649b18b67829181d3281b0a08d761.CountRequestBuilder) {
    return i3d52e2d49d7222eecff1f3043da3fd1575f649b18b67829181d3281b0a08d761.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
