...
import (
    ...
    if4b59fd27d4e4bd50a44ad797703a5f8eb5bddbea9bfeaa4e3c393fa6dd7c6da "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendargroups/item/calendars/item/calendarview/item/instances/item/exceptionoccurrences/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/calendarView/{event_id}/instances/{event_id1}/exceptionOccurrences/{event_id2}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*if4b59fd27d4e4bd50a44ad797703a5f8eb5bddbea9bfeaa4e3c393fa6dd7c6da.CountRequestBuilder) {
    return if4b59fd27d4e4bd50a44ad797703a5f8eb5bddbea9bfeaa4e3c393fa6dd7c6da.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
