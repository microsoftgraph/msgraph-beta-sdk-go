...
func NewDrivesItemItemsItemCreateUploadSessionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemItemsItemCreateUploadSessionRequestBuilder) {
    m := &DrivesItemItemsItemCreateUploadSessionRequestBuilder{
    }
...
func NewDrivesItemItemsItemCreateUploadSessionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemItemsItemCreateUploadSessionRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemItemsItemCreateUploadSessionRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DrivesItemItemsItemCreateUploadSessionRequestBuilder) CreatePostRequestInformation(ctx context.Context, body DrivesItemItemsItemCreateUploadSessionPostRequestBodyable, requestConfiguration *DrivesItemItemsItemCreateUploadSessionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemItemsItemCreateUploadSessionRequestBuilder) Post(ctx context.Context, body DrivesItemItemsItemCreateUploadSessionPostRequestBodyable, requestConfiguration *DrivesItemItemsItemCreateUploadSessionRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UploadSessionable, error) {
