...
// SecurityInformationProtectionSensitivityLabelsExtractContentLabelPostRequestBody 
...
func (m *SecurityInformationProtectionSensitivityLabelsExtractContentLabelPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *SecurityInformationProtectionSensitivityLabelsExtractContentLabelPostRequestBody) SetAdditionalData(value map[string]any)() {
