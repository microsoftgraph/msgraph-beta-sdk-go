...
func (m *InformationProtectionEncryptBufferPostRequestBody) GetLabelId()(*UUID) {
    return m.labelId
}
...
func (m *InformationProtectionEncryptBufferPostRequestBody) SetLabelId(value *UUID)() {
    m.labelId = value
}
