...
// InstancesRequestBuilder builds and executes requests for operations under \me\calendarView\{event-id}\instances
...
// Delta builds and executes requests for operations under \me\calendarView\{event-id}\instances\microsoft.graph.delta()
