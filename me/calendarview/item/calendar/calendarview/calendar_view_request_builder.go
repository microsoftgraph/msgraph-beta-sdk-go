...
import (
    ...
    i46360ff59a7b4ed63d654d622fdf049ae3d5034cbeb8f199ece54c98c1a880cc "github.com/microsoftgraph/msgraph-beta-sdk-go/me/calendarview/item/calendar/calendarview/delta"
)

// calendarViewRequestBuilder builds and executes requests for operations under \me\calendarView\{event-id}\calendar\calendarView
...
func NewCalendarViewRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CalendarViewRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarView/{event_id}/calendar/calendarView{?top,skip,filter,count,orderby,select}";
...
// Delta builds and executes requests for operations under \me\calendarView\{event-id}\calendar\calendarView\microsoft.graph.delta()
func (m *CalendarViewRequestBuilder) Delta()(*i46360ff59a7b4ed63d654d622fdf049ae3d5034cbeb8f199ece54c98c1a880cc.DeltaRequestBuilder) {
    return i46360ff59a7b4ed63d654d622fdf049ae3d5034cbeb8f199ece54c98c1a880cc.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
