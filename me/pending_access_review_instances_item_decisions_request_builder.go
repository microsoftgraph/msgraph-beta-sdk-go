...
func (m *PendingAccessReviewInstancesItemDecisionsRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*PendingAccessReviewInstancesItemDecisionsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilder) {
    return NewPendingAccessReviewInstancesItemDecisionsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
// MicrosoftGraphRecordAllDecisions provides operations to call the recordAllDecisions method.
func (m *PendingAccessReviewInstancesItemDecisionsRequestBuilder) MicrosoftGraphRecordAllDecisions()(*PendingAccessReviewInstancesItemDecisionsMicrosoftGraphRecordAllDecisionsRequestBuilder) {
    return NewPendingAccessReviewInstancesItemDecisionsMicrosoftGraphRecordAllDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
