...
// ParentRequestBuilderDeleteOptions options for Delete
type ParentRequestBuilderDeleteOptions struct {
    // Request headers
...
// ParentRequestBuilderPatchOptions options for Patch
type ParentRequestBuilderPatchOptions struct {
    // 
...
func NewParentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ParentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/security/informationProtection/sensitivityLabels/{sensitivityLabel_id}/parent{?select,expand}";
...
func (m *ParentRequestBuilder) CreateDeleteRequestInformation(options *ParentRequestBuilderDeleteOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ParentRequestBuilder) CreateGetRequestInformation(options *ParentRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ParentRequestBuilder) CreatePatchRequestInformation(options *ParentRequestBuilderPatchOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ParentRequestBuilder) Delete(options *ParentRequestBuilderDeleteOptions)(error) {
...
func (m *ParentRequestBuilder) Get(options *ParentRequestBuilderGetOptions)(i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.SensitivityLabelable, error) {
...
func (m *ParentRequestBuilder) Patch(options *ParentRequestBuilderPatchOptions)(error) {
