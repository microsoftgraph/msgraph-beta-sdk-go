...
// DrivesItemRootInvitePostRequestBody 
...
func (m *DrivesItemRootInvitePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *DrivesItemRootInvitePostRequestBody) GetRecipients()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveRecipientable) {
    return m.recipients
}
...
func (m *DrivesItemRootInvitePostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *DrivesItemRootInvitePostRequestBody) SetRecipients(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveRecipientable)() {
    m.recipients = value
}
