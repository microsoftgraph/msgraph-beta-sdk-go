...
func (m *DevicesItemRegisteredOwnersRequestBuilder) MicrosoftGraphEndpoint()(*DevicesItemRegisteredOwnersMicrosoftGraphEndpointRequestBuilder) {
    return NewDevicesItemRegisteredOwnersMicrosoftGraphEndpointRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *DevicesItemRegisteredOwnersRequestBuilder) MicrosoftGraphServicePrincipal()(*DevicesItemRegisteredOwnersMicrosoftGraphServicePrincipalRequestBuilder) {
    return NewDevicesItemRegisteredOwnersMicrosoftGraphServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *DevicesItemRegisteredOwnersRequestBuilder) MicrosoftGraphUser()(*DevicesItemRegisteredOwnersMicrosoftGraphUserRequestBuilder) {
    return NewDevicesItemRegisteredOwnersMicrosoftGraphUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
