...
// InformationProtectionThreatAssessmentRequestsCountRequestBuilderGetQueryParameters get the number of the resource
type InformationProtectionThreatAssessmentRequestsCountRequestBuilderGetQueryParameters struct {
...
type InformationProtectionThreatAssessmentRequestsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *InformationProtectionThreatAssessmentRequestsCountRequestBuilderGetQueryParameters
}
...
func NewInformationProtectionThreatAssessmentRequestsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InformationProtectionThreatAssessmentRequestsCountRequestBuilder) {
    m := &InformationProtectionThreatAssessmentRequestsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/me/informationProtection/threatAssessmentRequests/$count{?%24search,%24filter}";
...
func NewInformationProtectionThreatAssessmentRequestsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InformationProtectionThreatAssessmentRequestsCountRequestBuilder) {
    ...
    return NewInformationProtectionThreatAssessmentRequestsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *InformationProtectionThreatAssessmentRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *InformationProtectionThreatAssessmentRequestsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *InformationProtectionThreatAssessmentRequestsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *InformationProtectionThreatAssessmentRequestsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
