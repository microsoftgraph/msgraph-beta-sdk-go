...
// DevicesItemTransitiveMemberOfDeviceCountRequestBuilderGetQueryParameters get the number of the resource
type DevicesItemTransitiveMemberOfDeviceCountRequestBuilderGetQueryParameters struct {
...
type DevicesItemTransitiveMemberOfDeviceCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *DevicesItemTransitiveMemberOfDeviceCountRequestBuilderGetQueryParameters
}
...
func (m *DevicesItemTransitiveMemberOfDeviceCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DevicesItemTransitiveMemberOfDeviceCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
