...
func (m *BulkReprovisionCloudPcRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body BulkReprovisionCloudPcRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action bulkReprovisionCloudPc
func (m *BulkReprovisionCloudPcRequestBuilder) PostWithResponseHandler(body BulkReprovisionCloudPcRequestBodyable, requestConfiguration *BulkReprovisionCloudPcRequestBuilderPostRequestConfiguration)(error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action bulkReprovisionCloudPc
func (m *BulkReprovisionCloudPcRequestBuilder) PostWithResponseHandler(body BulkReprovisionCloudPcRequestBodyable, requestConfiguration *BulkReprovisionCloudPcRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
