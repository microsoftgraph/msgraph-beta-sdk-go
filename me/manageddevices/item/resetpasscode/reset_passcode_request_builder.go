...
func (m *ResetPasscodeRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *ResetPasscodeRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// Post reset passcode
func (m *ResetPasscodeRequestBuilder) Post(ctx context.Context, requestConfiguration *ResetPasscodeRequestBuilderPostRequestConfiguration)(error) {
