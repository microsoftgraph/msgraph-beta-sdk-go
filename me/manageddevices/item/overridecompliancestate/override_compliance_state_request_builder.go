...
// Builds and executes requests for operations under \me\managedDevices\{managedDevice-id}\microsoft.graph.overrideComplianceState
...
func NewOverrideComplianceStateRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OverrideComplianceStateRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/me/managedDevices/{managedDevice_id}/microsoft.graph.overrideComplianceState";
