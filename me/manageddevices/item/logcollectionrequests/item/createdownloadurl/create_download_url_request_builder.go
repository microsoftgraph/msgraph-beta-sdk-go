...
// Builds and executes requests for operations under \me\managedDevices\{managedDevice-id}\logCollectionRequests\{deviceLogCollectionResponse-id}\microsoft.graph.createDownloadUrl
