...
// DeviceLogCollectionResponseRequestBuilder builds and executes requests for operations under \me\managedDevices\{managedDevice-id}\logCollectionRequests\{deviceLogCollectionResponse-id}
...
type DeviceLogCollectionResponseRequestBuilderGetOptions struct {
    ...
    Q *DeviceLogCollectionResponseRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
func NewDeviceLogCollectionResponseRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DeviceLogCollectionResponseRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/managedDevices/{managedDevice_id}/logCollectionRequests/{deviceLogCollectionResponse_id}{?select,expand}";
