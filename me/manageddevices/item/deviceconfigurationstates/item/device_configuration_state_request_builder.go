...
// DeviceConfigurationStateRequestBuilder builds and executes requests for operations under \me\managedDevices\{managedDevice-id}\deviceConfigurationStates\{deviceConfigurationState-id}
