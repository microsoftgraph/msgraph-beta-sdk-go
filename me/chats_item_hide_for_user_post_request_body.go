...
// ChatsItemHideForUserPostRequestBody 
...
func (m *ChatsItemHideForUserPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ChatsItemHideForUserPostRequestBody) GetUser()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkUserIdentityable) {
    return m.user
}
...
func (m *ChatsItemHideForUserPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ChatsItemHideForUserPostRequestBody) SetUser(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkUserIdentityable)() {
    m.user = value
}
