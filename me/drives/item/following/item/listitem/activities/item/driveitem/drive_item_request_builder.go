...
import (
    ...
    icd5e2a66b32198c29ef843e46eb021fbcb7fdf470a5adb45d9c81b64d8cd3b63 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/drives/item/following/item/listitem/activities/item/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*icd5e2a66b32198c29ef843e46eb021fbcb7fdf470a5adb45d9c81b64d8cd3b63.ContentRequestBuilder) {
    return icd5e2a66b32198c29ef843e46eb021fbcb7fdf470a5adb45d9c81b64d8cd3b63.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
