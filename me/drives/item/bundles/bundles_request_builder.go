...
import (
    ...
    i5cb2757f42f7d6deffcaa569e9b8e47a5e5ff9a677479727026157f09adca79a "github.com/microsoftgraph/msgraph-beta-sdk-go/me/drives/item/bundles/count"
)
...
func NewBundlesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BundlesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *BundlesRequestBuilder) Count()(*i5cb2757f42f7d6deffcaa569e9b8e47a5e5ff9a677479727026157f09adca79a.CountRequestBuilder) {
...
// CreatePostRequestInformation create new navigation property to bundles for me
...
// Post create new navigation property to bundles for me
