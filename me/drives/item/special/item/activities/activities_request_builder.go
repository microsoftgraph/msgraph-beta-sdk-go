...
import (
    ...
    icc1cfae22b12f9192c5ccf6444cd22072794eb629c876fa78d759a0a5d8c3d1c "github.com/microsoftgraph/msgraph-beta-sdk-go/me/drives/item/special/item/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/special/{driveItem_id}/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*icc1cfae22b12f9192c5ccf6444cd22072794eb629c876fa78d759a0a5d8c3d1c.CountRequestBuilder) {
    return icc1cfae22b12f9192c5ccf6444cd22072794eb629c876fa78d759a0a5d8c3d1c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
