...
import (
    ...
    ib249e36e6e514a2d5a36872ce87edf8a9a0bdbde35251ce87c3511a7d6045b6e "github.com/microsoftgraph/msgraph-beta-sdk-go/me/drives/item/special/item/listitem/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/special/{driveItem_id}/listItem/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*ib249e36e6e514a2d5a36872ce87edf8a9a0bdbde35251ce87c3511a7d6045b6e.CountRequestBuilder) {
    return ib249e36e6e514a2d5a36872ce87edf8a9a0bdbde35251ce87c3511a7d6045b6e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
