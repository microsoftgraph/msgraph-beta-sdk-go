...
import (
    ...
    id2ee6e85f546a00b3239db12d3a195c9c63b1d74a16be6a48d7fd112ac74845f "github.com/microsoftgraph/msgraph-beta-sdk-go/me/drives/item/special/item/children/item/content"
)
...
func NewDriveItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/special/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
...
func (m *DriveItemItemRequestBuilder) Content()(*id2ee6e85f546a00b3239db12d3a195c9c63b1d74a16be6a48d7fd112ac74845f.ContentRequestBuilder) {
    return id2ee6e85f546a00b3239db12d3a195c9c63b1d74a16be6a48d7fd112ac74845f.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
