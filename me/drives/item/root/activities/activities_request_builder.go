...
import (
    ...
    i1f6ff935dd66047960b9fc46c19ab7a74c65521a440eec284eb8efa7b12954ee "github.com/microsoftgraph/msgraph-beta-sdk-go/me/drives/item/root/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/root/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i1f6ff935dd66047960b9fc46c19ab7a74c65521a440eec284eb8efa7b12954ee.CountRequestBuilder) {
    return i1f6ff935dd66047960b9fc46c19ab7a74c65521a440eec284eb8efa7b12954ee.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
