...
import (
    ...
    i2b53a8a636a44c2aca0c2da289ee94e83d0bdbe18f86ab48483bbc6e478ff4ed "github.com/microsoftgraph/msgraph-beta-sdk-go/me/drives/item/root/listitem/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/root/listItem/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i2b53a8a636a44c2aca0c2da289ee94e83d0bdbe18f86ab48483bbc6e478ff4ed.CountRequestBuilder) {
    return i2b53a8a636a44c2aca0c2da289ee94e83d0bdbe18f86ab48483bbc6e478ff4ed.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
