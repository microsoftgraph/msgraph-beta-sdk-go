...
import (
    ...
    i97767a348db5f224631d1529701323016ad7c4ca6de32e29beaad16fe0833dcd "github.com/microsoftgraph/msgraph-beta-sdk-go/me/drives/item/items/item/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive_id}/items/{driveItem_id}/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i97767a348db5f224631d1529701323016ad7c4ca6de32e29beaad16fe0833dcd.CountRequestBuilder) {
    return i97767a348db5f224631d1529701323016ad7c4ca6de32e29beaad16fe0833dcd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
