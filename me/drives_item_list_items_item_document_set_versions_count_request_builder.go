...
// DrivesItemListItemsItemDocumentSetVersionsCountRequestBuilderGetQueryParameters get the number of the resource
type DrivesItemListItemsItemDocumentSetVersionsCountRequestBuilderGetQueryParameters struct {
...
type DrivesItemListItemsItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *DrivesItemListItemsItemDocumentSetVersionsCountRequestBuilderGetQueryParameters
}
...
func NewDrivesItemListItemsItemDocumentSetVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListItemsItemDocumentSetVersionsCountRequestBuilder) {
    m := &DrivesItemListItemsItemDocumentSetVersionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions/$count{?%24search,%24filter}";
...
func NewDrivesItemListItemsItemDocumentSetVersionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListItemsItemDocumentSetVersionsCountRequestBuilder) {
    ...
    return NewDrivesItemListItemsItemDocumentSetVersionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *DrivesItemListItemsItemDocumentSetVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemListItemsItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *DrivesItemListItemsItemDocumentSetVersionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemListItemsItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
