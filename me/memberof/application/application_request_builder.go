...
import (
    ...
    i1a220f95fd729eb6157ecbf4940e1b238c8a6e12daff7ec4143e95e9c778f5ce "github.com/microsoftgraph/msgraph-beta-sdk-go/me/memberof/application/count"
)
...
func NewApplicationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApplicationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/memberOf/microsoft.graph.application{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ApplicationRequestBuilder) Count()(*i1a220f95fd729eb6157ecbf4940e1b238c8a6e12daff7ec4143e95e9c778f5ce.CountRequestBuilder) {
    return i1a220f95fd729eb6157ecbf4940e1b238c8a6e12daff7ec4143e95e9c778f5ce.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
