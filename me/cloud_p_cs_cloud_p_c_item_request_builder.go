...
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphChangeUserAccountType()(*CloudPCsItemMicrosoftGraphChangeUserAccountTypeRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphChangeUserAccountTypeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEndGracePeriod provides operations to call the endGracePeriod method.
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphEndGracePeriod()(*CloudPCsItemMicrosoftGraphEndGracePeriodRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphEndGracePeriodRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetCloudPcConnectivityHistory provides operations to call the getCloudPcConnectivityHistory method.
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphGetCloudPcConnectivityHistory()(*CloudPCsItemMicrosoftGraphGetCloudPcConnectivityHistoryRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphGetCloudPcConnectivityHistoryRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetCloudPcLaunchInfo provides operations to call the getCloudPcLaunchInfo method.
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphGetCloudPcLaunchInfo()(*CloudPCsItemMicrosoftGraphGetCloudPcLaunchInfoRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphGetCloudPcLaunchInfoRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetShiftWorkCloudPcAccessState provides operations to call the getShiftWorkCloudPcAccessState method.
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphGetShiftWorkCloudPcAccessState()(*CloudPCsItemMicrosoftGraphGetShiftWorkCloudPcAccessStateRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphGetShiftWorkCloudPcAccessStateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetSupportedCloudPcRemoteActions provides operations to call the getSupportedCloudPcRemoteActions method.
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphGetSupportedCloudPcRemoteActions()(*CloudPCsItemMicrosoftGraphGetSupportedCloudPcRemoteActionsRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphGetSupportedCloudPcRemoteActionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphReboot provides operations to call the reboot method.
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphReboot()(*CloudPCsItemMicrosoftGraphRebootRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphRebootRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRename provides operations to call the rename method.
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphRename()(*CloudPCsItemMicrosoftGraphRenameRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphRenameRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphReprovision provides operations to call the reprovision method.
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphReprovision()(*CloudPCsItemMicrosoftGraphReprovisionRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphReprovisionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRestore provides operations to call the restore method.
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphRestore()(*CloudPCsItemMicrosoftGraphRestoreRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphRestoreRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRetryPartnerAgentInstallation provides operations to call the retryPartnerAgentInstallation method.
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphRetryPartnerAgentInstallation()(*CloudPCsItemMicrosoftGraphRetryPartnerAgentInstallationRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphRetryPartnerAgentInstallationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphTroubleshoot provides operations to call the troubleshoot method.
func (m *CloudPCsCloudPCItemRequestBuilder) MicrosoftGraphTroubleshoot()(*CloudPCsItemMicrosoftGraphTroubleshootRequestBuilder) {
    return NewCloudPCsItemMicrosoftGraphTroubleshootRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
