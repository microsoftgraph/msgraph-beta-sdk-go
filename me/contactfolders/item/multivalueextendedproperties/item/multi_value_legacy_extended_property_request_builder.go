...
// MultiValueLegacyExtendedPropertyRequestBuilder builds and executes requests for operations under \me\contactFolders\{contactFolder-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
