...
// MultiValueLegacyExtendedPropertyItemRequestBuilder builds and executes requests for operations under \me\contactFolders\{contactFolder-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
...
// CreateDeleteRequestInformation the collection of multi-value extended properties defined for the contactFolder. Read-only. Nullable.
...
// CreatePatchRequestInformation the collection of multi-value extended properties defined for the contactFolder. Read-only. Nullable.
...
// Delete the collection of multi-value extended properties defined for the contactFolder. Read-only. Nullable.
...
// Patch the collection of multi-value extended properties defined for the contactFolder. Read-only. Nullable.
