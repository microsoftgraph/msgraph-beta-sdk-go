...
import (
    ...
    ie5399ae2fd9d1931e04708ad9fd09c18aac95032a9731a3d1a3289646ef2e6d6 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/contactfolders/item/contacts/item/photo/value"
)

// PhotoRequestBuilder builds and executes requests for operations under \me\contactFolders\{contactFolder-id}\contacts\{contact-id}\photo
...
func NewPhotoRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PhotoRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/contactFolders/{contactFolder_id}/contacts/{contact_id}/photo{?select}";
...
func (m *PhotoRequestBuilder) Content()(*ie5399ae2fd9d1931e04708ad9fd09c18aac95032a9731a3d1a3289646ef2e6d6.ContentRequestBuilder) {
    return ie5399ae2fd9d1931e04708ad9fd09c18aac95032a9731a3d1a3289646ef2e6d6.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
