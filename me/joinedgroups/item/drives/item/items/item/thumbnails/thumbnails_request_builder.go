...
import (
    ...
    if9dfc6739daf5bd4398f1a7f952d429c7799308616e67d10c1e07cf0fc9205c2 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/drives/item/items/item/thumbnails/count"
)
...
func NewThumbnailsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThumbnailsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/thumbnails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ThumbnailsRequestBuilder) Count()(*if9dfc6739daf5bd4398f1a7f952d429c7799308616e67d10c1e07cf0fc9205c2.CountRequestBuilder) {
    return if9dfc6739daf5bd4398f1a7f952d429c7799308616e67d10c1e07cf0fc9205c2.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
