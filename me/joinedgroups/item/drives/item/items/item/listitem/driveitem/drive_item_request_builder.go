...
import (
    ...
    if5a396e0552d696acf61bb531d9df33c5fc8b0710de0daec6092c8c314631538 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/drives/item/items/item/listitem/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/driveItem{?%24select,%24expand}";
...
func (m *DriveItemRequestBuilder) Content()(*if5a396e0552d696acf61bb531d9df33c5fc8b0710de0daec6092c8c314631538.ContentRequestBuilder) {
    return if5a396e0552d696acf61bb531d9df33c5fc8b0710de0daec6092c8c314631538.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
