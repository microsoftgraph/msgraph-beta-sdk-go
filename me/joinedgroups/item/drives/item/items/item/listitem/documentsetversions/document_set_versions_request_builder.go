...
import (
    ...
    i98f3a1ffde571ef500ef0c0a0328d8ca88942ef024335ea4ef5b2eb1e4c47dcb "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/drives/item/items/item/listitem/documentsetversions/count"
)
...
func NewDocumentSetVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DocumentSetVersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DocumentSetVersionsRequestBuilder) Count()(*i98f3a1ffde571ef500ef0c0a0328d8ca88942ef024335ea4ef5b2eb1e4c47dcb.CountRequestBuilder) {
    return i98f3a1ffde571ef500ef0c0a0328d8ca88942ef024335ea4ef5b2eb1e4c47dcb.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
