...
import (
    ...
    i73ee2a3a5a1329b06230270bb7695248efcddcaa9f285cb92c021bed0d397e7e "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/drives/item/items/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*i73ee2a3a5a1329b06230270bb7695248efcddcaa9f285cb92c021bed0d397e7e.CountRequestBuilder) {
    return i73ee2a3a5a1329b06230270bb7695248efcddcaa9f285cb92c021bed0d397e7e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
