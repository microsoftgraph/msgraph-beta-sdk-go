...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/versions/{driveItemVersion%2Did}/content";
...
// CreateGetRequestInformation get content for the navigation property versions from me
...
// CreateGetRequestInformationWithRequestConfiguration get content for the navigation property versions from me
...
// CreatePutRequestInformation update content for the navigation property versions in me
...
// CreatePutRequestInformationWithRequestConfiguration update content for the navigation property versions in me
...
// Get get content for the navigation property versions from me
func (m *ContentRequestBuilder) Get()([]byte, error) {
    return m.GetWithRequestConfigurationAndResponseHandler(nil, nil);
}
// GetWithRequestConfigurationAndResponseHandler get content for the navigation property versions from me
...
// Put update content for the navigation property versions in me
func (m *ContentRequestBuilder) Put(body []byte)(error) {
    return m.PutWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PutWithRequestConfigurationAndResponseHandler update content for the navigation property versions in me
