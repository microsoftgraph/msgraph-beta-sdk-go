...
import (
    ...
    i1f3f02d735a0a080dbd5558129b35fd2e45504d17e2ed311d2a689b45dc011fb "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/drives/item/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i1f3f02d735a0a080dbd5558129b35fd2e45504d17e2ed311d2a689b45dc011fb.CountRequestBuilder) {
    return i1f3f02d735a0a080dbd5558129b35fd2e45504d17e2ed311d2a689b45dc011fb.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
