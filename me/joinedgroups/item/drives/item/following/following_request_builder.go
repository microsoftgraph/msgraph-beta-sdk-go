...
import (
    ...
    i6503f226ea4a47f0388b4720cf648fa2cf710c4795523cb0e2aaea47095b4f74 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/drives/item/following/count"
)
...
func NewFollowingRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FollowingRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/following{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *FollowingRequestBuilder) Count()(*i6503f226ea4a47f0388b4720cf648fa2cf710c4795523cb0e2aaea47095b4f74.CountRequestBuilder) {
    return i6503f226ea4a47f0388b4720cf648fa2cf710c4795523cb0e2aaea47095b4f74.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
