...
import (
    ...
    i9218ba87172f6aa97d9f10f3ec2dd8f05ab1ad76ff5ea35fbfd9107a71909155 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/drives/item/bundles/count"
)
...
func NewBundlesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BundlesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/drives/{drive%2Did}/bundles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *BundlesRequestBuilder) Count()(*i9218ba87172f6aa97d9f10f3ec2dd8f05ab1ad76ff5ea35fbfd9107a71909155.CountRequestBuilder) {
    return i9218ba87172f6aa97d9f10f3ec2dd8f05ab1ad76ff5ea35fbfd9107a71909155.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
