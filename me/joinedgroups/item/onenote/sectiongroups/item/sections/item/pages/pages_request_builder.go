...
import (
    ...
    i35ade9f9dc5bbf13d304161f62d2b672151ff61ddecbdf2108076e17b42bd92e "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/onenote/sectiongroups/item/sections/item/pages/count"
)
...
func NewPagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PagesRequestBuilder) Count()(*i35ade9f9dc5bbf13d304161f62d2b672151ff61ddecbdf2108076e17b42bd92e.CountRequestBuilder) {
    return i35ade9f9dc5bbf13d304161f62d2b672151ff61ddecbdf2108076e17b42bd92e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
