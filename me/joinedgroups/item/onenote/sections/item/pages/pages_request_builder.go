...
import (
    ...
    i376f1c8be4a154cc1dd7842c6feed42630d0d88ddc051c74d0fefd40873d17d3 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/onenote/sections/item/pages/count"
)
...
func NewPagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/sections/{onenoteSection%2Did}/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PagesRequestBuilder) Count()(*i376f1c8be4a154cc1dd7842c6feed42630d0d88ddc051c74d0fefd40873d17d3.CountRequestBuilder) {
    return i376f1c8be4a154cc1dd7842c6feed42630d0d88ddc051c74d0fefd40873d17d3.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
