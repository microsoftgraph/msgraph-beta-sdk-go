...
import (
    ...
    i586f79d3f6ed6d494319adf27d54646f3a242c7252d275fc41e0036d7650c72f "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/onenote/notebooks/item/sectiongroups/item/sections/count"
)
...
func NewSectionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SectionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SectionsRequestBuilder) Count()(*i586f79d3f6ed6d494319adf27d54646f3a242c7252d275fc41e0036d7650c72f.CountRequestBuilder) {
    return i586f79d3f6ed6d494319adf27d54646f3a242c7252d275fc41e0036d7650c72f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
