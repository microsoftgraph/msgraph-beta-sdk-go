...
import (
    ...
    i3eb589a4331a4ac6d44ab6f220d1a47a300310a0dd72a817a83bae2bdca29d0e "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/events/item/instances/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*i3eb589a4331a4ac6d44ab6f220d1a47a300310a0dd72a817a83bae2bdca29d0e.CountRequestBuilder) {
    return i3eb589a4331a4ac6d44ab6f220d1a47a300310a0dd72a817a83bae2bdca29d0e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
