...
import (
    ...
    i1e806df61dd2bd26184f6c4002e4842ec83f4d0b8d4f915f112baf7e03167e55 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/events/item/instances/item/exceptionoccurrences/item/attachments/createuploadsession"
    i2fe177f42c941832a110da85a8514140d5d2d45e602dcc0eb8b15a402b8e07b3 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/events/item/instances/item/exceptionoccurrences/item/attachments/count"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*i2fe177f42c941832a110da85a8514140d5d2d45e602dcc0eb8b15a402b8e07b3.CountRequestBuilder) {
    return i2fe177f42c941832a110da85a8514140d5d2d45e602dcc0eb8b15a402b8e07b3.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*i1e806df61dd2bd26184f6c4002e4842ec83f4d0b8d4f915f112baf7e03167e55.CreateUploadSessionRequestBuilder) {
    return i1e806df61dd2bd26184f6c4002e4842ec83f4d0b8d4f915f112baf7e03167e55.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
