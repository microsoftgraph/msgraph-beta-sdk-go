...
import (
    ...
    i353b19d6af46e395cd8f902d0f2025fcb4d2512d0135bb822047574612679c17 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/events/item/instances/item/exceptionoccurrences/delta"
    if5f52cc13b5602c1d1ce3f8ed6b68babcc8350f9045b47a1d0f163fb1a3eded6 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/events/item/instances/item/exceptionoccurrences/count"
)
...
func NewExceptionOccurrencesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExceptionOccurrencesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExceptionOccurrencesRequestBuilder) Count()(*if5f52cc13b5602c1d1ce3f8ed6b68babcc8350f9045b47a1d0f163fb1a3eded6.CountRequestBuilder) {
    return if5f52cc13b5602c1d1ce3f8ed6b68babcc8350f9045b47a1d0f163fb1a3eded6.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ExceptionOccurrencesRequestBuilder) Delta()(*i353b19d6af46e395cd8f902d0f2025fcb4d2512d0135bb822047574612679c17.DeltaRequestBuilder) {
    return i353b19d6af46e395cd8f902d0f2025fcb4d2512d0135bb822047574612679c17.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
