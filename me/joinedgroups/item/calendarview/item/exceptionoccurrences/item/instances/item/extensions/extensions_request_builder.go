...
import (
    ...
    ibe8f44d82d6312d0ee90553ed068333ef0012df58c0e72f65b72cd6beecff581 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/calendarview/item/exceptionoccurrences/item/instances/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*ibe8f44d82d6312d0ee90553ed068333ef0012df58c0e72f65b72cd6beecff581.CountRequestBuilder) {
    return ibe8f44d82d6312d0ee90553ed068333ef0012df58c0e72f65b72cd6beecff581.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
