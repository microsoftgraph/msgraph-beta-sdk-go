...
import (
    ...
    ib79e98a820c3d0960386bc39e5445f6ea93b7e0d4fd717c8bfac7da69dfd9230 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/calendarview/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendarView/{event%2Did}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*ib79e98a820c3d0960386bc39e5445f6ea93b7e0d4fd717c8bfac7da69dfd9230.CountRequestBuilder) {
    return ib79e98a820c3d0960386bc39e5445f6ea93b7e0d4fd717c8bfac7da69dfd9230.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
