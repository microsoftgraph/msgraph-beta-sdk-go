...
import (
    ...
    i2cb10d26e555724a1903580a43fdd123a2052f79ffc08ca6339f5beabcedf0d9 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/threads/item/posts/item/inreplyto/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/inReplyTo/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*i2cb10d26e555724a1903580a43fdd123a2052f79ffc08ca6339f5beabcedf0d9.CountRequestBuilder) {
    return i2cb10d26e555724a1903580a43fdd123a2052f79ffc08ca6339f5beabcedf0d9.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
