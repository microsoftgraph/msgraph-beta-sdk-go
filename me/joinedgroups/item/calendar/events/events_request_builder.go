...
import (
    ...
    i57d496e4432363f092c1946d6d763cb829ffc1dfa031722270e60a2354029160 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/calendar/events/count"
    ie691319d30ddd30c56732e2e56d16d3a1d8092b85d4a6bd216d7cbc7297e197d "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/calendar/events/delta"
)
...
func NewEventsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EventsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
...
func (m *EventsRequestBuilder) Count()(*i57d496e4432363f092c1946d6d763cb829ffc1dfa031722270e60a2354029160.CountRequestBuilder) {
    return i57d496e4432363f092c1946d6d763cb829ffc1dfa031722270e60a2354029160.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *EventsRequestBuilder) Delta()(*ie691319d30ddd30c56732e2e56d16d3a1d8092b85d4a6bd216d7cbc7297e197d.DeltaRequestBuilder) {
    return ie691319d30ddd30c56732e2e56d16d3a1d8092b85d4a6bd216d7cbc7297e197d.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
