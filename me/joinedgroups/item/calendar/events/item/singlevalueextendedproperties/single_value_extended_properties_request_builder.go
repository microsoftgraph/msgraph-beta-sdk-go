...
import (
    ...
    ied91052242ef5b9a3b9fcdb1150c623e5622c40be65c062006e3a37a8e1f016f "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/calendar/events/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*ied91052242ef5b9a3b9fcdb1150c623e5622c40be65c062006e3a37a8e1f016f.CountRequestBuilder) {
    return ied91052242ef5b9a3b9fcdb1150c623e5622c40be65c062006e3a37a8e1f016f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
