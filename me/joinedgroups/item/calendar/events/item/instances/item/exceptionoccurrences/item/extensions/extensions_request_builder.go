...
import (
    ...
    i576abf9751aa23ec151db5eeabbbad92d7454264ee5f002705266120a604ba12 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/calendar/events/item/instances/item/exceptionoccurrences/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*i576abf9751aa23ec151db5eeabbbad92d7454264ee5f002705266120a604ba12.CountRequestBuilder) {
    return i576abf9751aa23ec151db5eeabbbad92d7454264ee5f002705266120a604ba12.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
