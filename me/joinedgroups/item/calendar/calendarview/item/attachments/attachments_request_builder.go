...
import (
    ...
    i8d0e42e5e77cceb7c1d87a4ca0d1d593a66abe58bcd51325c1313240a2e7448e "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/calendar/calendarview/item/attachments/createuploadsession"
    ida5c3d8b52983299d717232c0a25cf0337f7fb44d5bbb525304c501371ff8d95 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/calendar/calendarview/item/attachments/count"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*ida5c3d8b52983299d717232c0a25cf0337f7fb44d5bbb525304c501371ff8d95.CountRequestBuilder) {
    return ida5c3d8b52983299d717232c0a25cf0337f7fb44d5bbb525304c501371ff8d95.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*i8d0e42e5e77cceb7c1d87a4ca0d1d593a66abe58bcd51325c1313240a2e7448e.CreateUploadSessionRequestBuilder) {
    return i8d0e42e5e77cceb7c1d87a4ca0d1d593a66abe58bcd51325c1313240a2e7448e.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
