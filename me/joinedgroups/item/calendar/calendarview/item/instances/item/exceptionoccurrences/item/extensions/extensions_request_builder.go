...
import (
    ...
    i1e020972e3037a829df6664a16facaaf5559960d8bd98fffb8769a55be1d21df "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/calendar/calendarview/item/instances/item/exceptionoccurrences/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*i1e020972e3037a829df6664a16facaaf5559960d8bd98fffb8769a55be1d21df.CountRequestBuilder) {
    return i1e020972e3037a829df6664a16facaaf5559960d8bd98fffb8769a55be1d21df.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
