...
import (
    ...
    i2c84c617dce25865561aa775ac449ec6c662f3bd6837e2d0656d8bbed0b8424e "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/calendar/calendarview/item/exceptionoccurrences/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i2c84c617dce25865561aa775ac449ec6c662f3bd6837e2d0656d8bbed0b8424e.CountRequestBuilder) {
    return i2c84c617dce25865561aa775ac449ec6c662f3bd6837e2d0656d8bbed0b8424e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
