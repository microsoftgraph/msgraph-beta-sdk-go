...
import (
    ...
    i1fb9d5cef333df4af58e6c1d4189ed349cea65b933aecf274bd2dbc66de1df07 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/calendar/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/calendar/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i1fb9d5cef333df4af58e6c1d4189ed349cea65b933aecf274bd2dbc66de1df07.CountRequestBuilder) {
    return i1fb9d5cef333df4af58e6c1d4189ed349cea65b933aecf274bd2dbc66de1df07.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
