...
import (
    ...
    iade9b5218053dbe09984dce7216627feb8dddef1bf2e7b5c4d89e7d5555fadab "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/planner/plans/item/buckets/count"
)
...
func NewBucketsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BucketsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *BucketsRequestBuilder) Count()(*iade9b5218053dbe09984dce7216627feb8dddef1bf2e7b5c4d89e7d5555fadab.CountRequestBuilder) {
    return iade9b5218053dbe09984dce7216627feb8dddef1bf2e7b5c4d89e7d5555fadab.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to buckets for me
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to buckets for me
...
// Post create new navigation property to buckets for me
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to buckets for me
