...
import (
    ...
    iaef7c2513d7dee908acdf4a67add973e7c6dd50760090c81d3ebf8c11f3497a1 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/planner/plans/item/buckets/item/tasks"
    i540b643e393164e74e7a6106a065be76b5007368ca9ccde7ca4586ded19e103a "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/planner/plans/item/buckets/item/tasks/item"
)
...
func NewPlannerBucketItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PlannerBucketItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}{?%24select,%24expand}";
...
func (m *PlannerBucketItemRequestBuilder) Tasks()(*iaef7c2513d7dee908acdf4a67add973e7c6dd50760090c81d3ebf8c11f3497a1.TasksRequestBuilder) {
    return iaef7c2513d7dee908acdf4a67add973e7c6dd50760090c81d3ebf8c11f3497a1.NewTasksRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// TasksById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.me.joinedGroups.item.planner.plans.item.buckets.item.tasks.item collection
func (m *PlannerBucketItemRequestBuilder) TasksById(id string)(*i540b643e393164e74e7a6106a065be76b5007368ca9ccde7ca4586ded19e103a.PlannerTaskItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i540b643e393164e74e7a6106a065be76b5007368ca9ccde7ca4586ded19e103a.NewPlannerTaskItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
