...
import (
    ...
    if290bf16c33d94ebed3c39d06721c5909c728dc5c497c8c91dafb83b6b8490f7 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/planner/plans/item/buckets/item/tasks/count"
)
...
func NewTasksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TasksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *TasksRequestBuilder) Count()(*if290bf16c33d94ebed3c39d06721c5909c728dc5c497c8c91dafb83b6b8490f7.CountRequestBuilder) {
    return if290bf16c33d94ebed3c39d06721c5909c728dc5c497c8c91dafb83b6b8490f7.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
