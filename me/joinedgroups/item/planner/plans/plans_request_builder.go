...
import (
    ...
    i774f272cc6801e203a0285c6d7ae09024cc10df8e2c655d3a9d8e4d35da7dcfa "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/planner/plans/count"
)
...
func NewPlansRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PlansRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/planner/plans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PlansRequestBuilder) Count()(*i774f272cc6801e203a0285c6d7ae09024cc10df8e2c655d3a9d8e4d35da7dcfa.CountRequestBuilder) {
    return i774f272cc6801e203a0285c6d7ae09024cc10df8e2c655d3a9d8e4d35da7dcfa.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
