...
import (
    ...
    i77881e6501b8f9ac22e26cc9231f03247a0dc3844ba322233e9a2b6bedbc2345 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/termstore/sets/item/children/item/relations"
    ia74fd869366b9b9614ecffa02617fe81ebc88c314d95c4356c99c78ca1ae1b87 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/termstore/sets/item/children/item/children"
    ie15720916b56a1f7cf6b89130cbeed22bdcfc1e202516cbabb169ca1ea4772a3 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/termstore/sets/item/children/item/set"
    i1d32a2040b9e554ad10ae1fe03f5a700c8bd1e91c0934d5fef87aa5312d7268d "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/termstore/sets/item/children/item/children/item"
    i5bf80e955218fe1b31eada6651a5a240ce516bdc1cd43ee8036c1fb5987e15db "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/termstore/sets/item/children/item/relations/item"
)
...
func (m *TermItemRequestBuilder) Children()(*ia74fd869366b9b9614ecffa02617fe81ebc88c314d95c4356c99c78ca1ae1b87.ChildrenRequestBuilder) {
    return ia74fd869366b9b9614ecffa02617fe81ebc88c314d95c4356c99c78ca1ae1b87.NewChildrenRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ChildrenById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.me.joinedGroups.item.sites.item.termStore.sets.item.children.item.children.item collection
func (m *TermItemRequestBuilder) ChildrenById(id string)(*i1d32a2040b9e554ad10ae1fe03f5a700c8bd1e91c0934d5fef87aa5312d7268d.TermItemRequestBuilder) {
    ...
    return i1d32a2040b9e554ad10ae1fe03f5a700c8bd1e91c0934d5fef87aa5312d7268d.NewTermItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func NewTermItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TermItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}{?%24select,%24expand}";
    urlTplParams := make(map[string]string)
...
func (m *TermItemRequestBuilder) Relations()(*i77881e6501b8f9ac22e26cc9231f03247a0dc3844ba322233e9a2b6bedbc2345.RelationsRequestBuilder) {
    return i77881e6501b8f9ac22e26cc9231f03247a0dc3844ba322233e9a2b6bedbc2345.NewRelationsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// RelationsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.me.joinedGroups.item.sites.item.termStore.sets.item.children.item.relations.item collection
func (m *TermItemRequestBuilder) RelationsById(id string)(*i5bf80e955218fe1b31eada6651a5a240ce516bdc1cd43ee8036c1fb5987e15db.RelationItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i5bf80e955218fe1b31eada6651a5a240ce516bdc1cd43ee8036c1fb5987e15db.NewRelationItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
// Set the set property
func (m *TermItemRequestBuilder) Set()(*ie15720916b56a1f7cf6b89130cbeed22bdcfc1e202516cbabb169ca1ea4772a3.SetRequestBuilder) {
    return ie15720916b56a1f7cf6b89130cbeed22bdcfc1e202516cbabb169ca1ea4772a3.NewSetRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
