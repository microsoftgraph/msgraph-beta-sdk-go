...
import (
    ...
    i150252db93c6dd4ee25a2f14915824c4f99a76a3d805ac82a4efe0a3efafe788 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/termstore/sets/item/parentgroup/sets/item/terms/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/{term%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ChildrenRequestBuilder) Count()(*i150252db93c6dd4ee25a2f14915824c4f99a76a3d805ac82a4efe0a3efafe788.CountRequestBuilder) {
    return i150252db93c6dd4ee25a2f14915824c4f99a76a3d805ac82a4efe0a3efafe788.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
