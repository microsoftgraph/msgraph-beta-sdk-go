...
import (
    ...
    i80855fd21560efe2ac3e5504fc3ac4e72a914512636099ba430fb8b5d2f253c8 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/termstore/sets/item/terms/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *RelationsRequestBuilder) Count()(*i80855fd21560efe2ac3e5504fc3ac4e72a914512636099ba430fb8b5d2f253c8.CountRequestBuilder) {
    return i80855fd21560efe2ac3e5504fc3ac4e72a914512636099ba430fb8b5d2f253c8.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
