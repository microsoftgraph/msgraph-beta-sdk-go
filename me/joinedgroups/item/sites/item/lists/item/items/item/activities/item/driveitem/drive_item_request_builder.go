...
import (
    ...
    iccc9bea300e3cd56e3a72d7842fc5b8acbbdf70eba1e42bbecc40c4281633209 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/lists/item/items/item/activities/item/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}";
...
func (m *DriveItemRequestBuilder) Content()(*iccc9bea300e3cd56e3a72d7842fc5b8acbbdf70eba1e42bbecc40c4281633209.ContentRequestBuilder) {
    return iccc9bea300e3cd56e3a72d7842fc5b8acbbdf70eba1e42bbecc40c4281633209.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
