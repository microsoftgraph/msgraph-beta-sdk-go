...
import (
    ...
    iaebf854fb9a1b5fe8a78fa12204cfbf367b21e4d70a9d0708063e0197132a5ea "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/contenttypes/item/basetypes/count"
)
...
func NewBaseTypesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BaseTypesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/baseTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *BaseTypesRequestBuilder) Count()(*iaebf854fb9a1b5fe8a78fa12204cfbf367b21e4d70a9d0708063e0197132a5ea.CountRequestBuilder) {
    return iaebf854fb9a1b5fe8a78fa12204cfbf367b21e4d70a9d0708063e0197132a5ea.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
