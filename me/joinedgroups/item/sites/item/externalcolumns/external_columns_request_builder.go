...
import (
    ...
    if99aa3bab7c3123eb3c2ee08ebf95d2aba54d9c495357326ab8d8155b63582c1 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/externalcolumns/count"
)
...
func NewExternalColumnsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExternalColumnsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/externalColumns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExternalColumnsRequestBuilder) Count()(*if99aa3bab7c3123eb3c2ee08ebf95d2aba54d9c495357326ab8d8155b63582c1.CountRequestBuilder) {
    return if99aa3bab7c3123eb3c2ee08ebf95d2aba54d9c495357326ab8d8155b63582c1.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ExternalColumnsRequestBuilder) Get()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ColumnDefinitionCollectionResponseable, error) {
