...
import (
    ...
    i1039b68dae2bf587a1c7c6011da0921159754ac01ed7a3d1c71c904b3bdf656a "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/sites/count"
)
...
func NewSitesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SitesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/sites{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SitesRequestBuilder) Count()(*i1039b68dae2bf587a1c7c6011da0921159754ac01ed7a3d1c71c904b3bdf656a.CountRequestBuilder) {
    return i1039b68dae2bf587a1c7c6011da0921159754ac01ed7a3d1c71c904b3bdf656a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
