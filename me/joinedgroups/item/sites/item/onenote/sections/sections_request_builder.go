...
import (
    ...
    i1443ba8e1f004804a246905e2c59a15b56253fa1db0979508f94cd376eaebc85 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/onenote/sections/count"
)
...
func NewSectionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SectionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/sections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SectionsRequestBuilder) Count()(*i1443ba8e1f004804a246905e2c59a15b56253fa1db0979508f94cd376eaebc85.CountRequestBuilder) {
    return i1443ba8e1f004804a246905e2c59a15b56253fa1db0979508f94cd376eaebc85.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
