...
import (
    ...
    i881ca60b5bb48fb77afd994ef48f2fe45f17242dfb782826b9a9d8e0957ff5b6 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/onenote/resources/count"
)
...
func NewResourcesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ResourcesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/resources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ResourcesRequestBuilder) Count()(*i881ca60b5bb48fb77afd994ef48f2fe45f17242dfb782826b9a9d8e0957ff5b6.CountRequestBuilder) {
    return i881ca60b5bb48fb77afd994ef48f2fe45f17242dfb782826b9a9d8e0957ff5b6.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
