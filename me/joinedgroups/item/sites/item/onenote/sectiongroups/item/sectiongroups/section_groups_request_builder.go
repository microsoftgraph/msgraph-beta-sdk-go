...
import (
    ...
    if7c812d211663543c1ffd4eaeeb493e1cdb4511f3e889bb1b63558522467adcd "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/onenote/sectiongroups/item/sectiongroups/count"
)
...
func NewSectionGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SectionGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SectionGroupsRequestBuilder) Count()(*if7c812d211663543c1ffd4eaeeb493e1cdb4511f3e889bb1b63558522467adcd.CountRequestBuilder) {
    return if7c812d211663543c1ffd4eaeeb493e1cdb4511f3e889bb1b63558522467adcd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
