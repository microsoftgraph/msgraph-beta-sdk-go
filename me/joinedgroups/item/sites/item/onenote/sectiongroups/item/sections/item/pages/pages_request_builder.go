...
import (
    ...
    i457bff782e869f6486fe6003d4b91a18747c58a284331689829abcb6f279eebe "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/item/onenote/sectiongroups/item/sections/item/pages/count"
)
...
func NewPagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PagesRequestBuilder) Count()(*i457bff782e869f6486fe6003d4b91a18747c58a284331689829abcb6f279eebe.CountRequestBuilder) {
    return i457bff782e869f6486fe6003d4b91a18747c58a284331689829abcb6f279eebe.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
