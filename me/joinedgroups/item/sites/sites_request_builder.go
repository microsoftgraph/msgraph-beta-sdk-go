...
import (
    ...
    ib78b19cad66924e6652ac7de3ba4023ba711bea47cc3368d0b7729cd2be843be "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/sites/count"
)
...
func NewSitesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SitesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/sites{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SitesRequestBuilder) Count()(*ib78b19cad66924e6652ac7de3ba4023ba711bea47cc3368d0b7729cd2be843be.CountRequestBuilder) {
    return ib78b19cad66924e6652ac7de3ba4023ba711bea47cc3368d0b7729cd2be843be.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to sites for me
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to sites for me
...
// Post create new navigation property to sites for me
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to sites for me
