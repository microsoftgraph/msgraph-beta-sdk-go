...
import (
    ...
    ic45210dfa695ee7e86a8e37deecec06a698752413c624bc8ea5a8419d84259a7 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/members/count"
)
...
func NewMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *MembersRequestBuilder) Count()(*ic45210dfa695ee7e86a8e37deecec06a698752413c624bc8ea5a8419d84259a7.CountRequestBuilder) {
    return ic45210dfa695ee7e86a8e37deecec06a698752413c624bc8ea5a8419d84259a7.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
