...
import (
    ...
    iffdedce74f1ec42415d67f93ed38a148fa69d29f46fbbfda32cd001545acb10b "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/approleassignments/count"
)
...
func NewAppRoleAssignmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AppRoleAssignmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/appRoleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AppRoleAssignmentsRequestBuilder) Count()(*iffdedce74f1ec42415d67f93ed38a148fa69d29f46fbbfda32cd001545acb10b.CountRequestBuilder) {
    return iffdedce74f1ec42415d67f93ed38a148fa69d29f46fbbfda32cd001545acb10b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
