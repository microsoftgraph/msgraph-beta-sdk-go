...
func NewAppRoleAssignmentItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AppRoleAssignmentItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/appRoleAssignments/{appRoleAssignment%2Did}{?%24select,%24expand}";
...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property appRoleAssignments for me
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property appRoleAssignments in me
