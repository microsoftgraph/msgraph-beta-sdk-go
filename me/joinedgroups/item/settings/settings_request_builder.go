...
import (
    ...
    if80bce1f00480547083fd412716dbfcd0fc936b5605d0c6439b9b4a897301709 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/settings/count"
)
...
func NewSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SettingsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/settings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SettingsRequestBuilder) Count()(*if80bce1f00480547083fd412716dbfcd0fc936b5605d0c6439b9b4a897301709.CountRequestBuilder) {
    return if80bce1f00480547083fd412716dbfcd0fc936b5605d0c6439b9b4a897301709.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to settings for me
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to settings for me
...
// Post create new navigation property to settings for me
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to settings for me
