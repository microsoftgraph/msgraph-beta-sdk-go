...
import (
    ...
    i8224ba73e348e46dc86c81cfe26c9e097fe11aba3c82ec05a8a3c5ea52e99dfd "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/owners/count"
)
...
func NewOwnersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OwnersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *OwnersRequestBuilder) Count()(*i8224ba73e348e46dc86c81cfe26c9e097fe11aba3c82ec05a8a3c5ea52e99dfd.CountRequestBuilder) {
    return i8224ba73e348e46dc86c81cfe26c9e097fe11aba3c82ec05a8a3c5ea52e99dfd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
