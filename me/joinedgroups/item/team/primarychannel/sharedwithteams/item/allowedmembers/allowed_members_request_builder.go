...
import (
    ...
    ibabd8e8cb6dd6cc35704fd43dc4958938272af7a1e69196daf1cae2fe33fd623 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/primarychannel/sharedwithteams/item/allowedmembers/count"
)
...
func NewAllowedMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AllowedMembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AllowedMembersRequestBuilder) Count()(*ibabd8e8cb6dd6cc35704fd43dc4958938272af7a1e69196daf1cae2fe33fd623.CountRequestBuilder) {
    return ibabd8e8cb6dd6cc35704fd43dc4958938272af7a1e69196daf1cae2fe33fd623.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
