...
import (
    ...
    ibf0d8dd05b266d2f13fecb1c27dd10a29cbd792e60a33fac6c94a6010407799e "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/members/count"
    ic360375d5b8c037a54d67a940e7755d024229639cb751a1fcae5f46751dffef3 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/members/add"
)
...
func (m *MembersRequestBuilder) Add()(*ic360375d5b8c037a54d67a940e7755d024229639cb751a1fcae5f46751dffef3.AddRequestBuilder) {
    return ic360375d5b8c037a54d67a940e7755d024229639cb751a1fcae5f46751dffef3.NewAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *MembersRequestBuilder) Count()(*ibf0d8dd05b266d2f13fecb1c27dd10a29cbd792e60a33fac6c94a6010407799e.CountRequestBuilder) {
    return ibf0d8dd05b266d2f13fecb1c27dd10a29cbd792e60a33fac6c94a6010407799e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
