...
import (
    ...
    i094fedef890bedbc3974f43ce39e8a6a66102eb9fd357ee8d3928146f5767b28 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/allchannels/count"
)
...
func NewAllChannelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AllChannelsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/allChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AllChannelsRequestBuilder) Count()(*i094fedef890bedbc3974f43ce39e8a6a66102eb9fd357ee8d3928146f5767b28.CountRequestBuilder) {
    return i094fedef890bedbc3974f43ce39e8a6a66102eb9fd357ee8d3928146f5767b28.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
