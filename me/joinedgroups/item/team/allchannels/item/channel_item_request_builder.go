...
// ChannelItemRequestBuilder provides operations to manage the allChannels property of the microsoft.graph.team entity.
...
// ChannelItemRequestBuilderGetQueryParameters list of channels either hosted in or shared with the team (incoming channels).
...
func NewChannelItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChannelItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/allChannels/{channel%2Did}{?%24select,%24expand}";
