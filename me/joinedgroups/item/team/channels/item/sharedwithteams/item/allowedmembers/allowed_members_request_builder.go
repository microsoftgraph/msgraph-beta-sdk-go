...
import (
    ...
    i2264a7e4a03306a411e206d30383999ea7bed03e78a0875a8cdc6d9c686b743a "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/channels/item/sharedwithteams/item/allowedmembers/count"
)
...
func NewAllowedMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AllowedMembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AllowedMembersRequestBuilder) Count()(*i2264a7e4a03306a411e206d30383999ea7bed03e78a0875a8cdc6d9c686b743a.CountRequestBuilder) {
    return i2264a7e4a03306a411e206d30383999ea7bed03e78a0875a8cdc6d9c686b743a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
