...
import (
    ...
    i9963e9385350763ea36adf8643d677e06c609e3ac3683a5fc9df618152bf1718 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/channels/item/members/count"
    if2891b4cd54f107d2f085806d652b69ab2b6c01916935f19a1653f47b21efa91 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/channels/item/members/add"
)
...
func (m *MembersRequestBuilder) Add()(*if2891b4cd54f107d2f085806d652b69ab2b6c01916935f19a1653f47b21efa91.AddRequestBuilder) {
    return if2891b4cd54f107d2f085806d652b69ab2b6c01916935f19a1653f47b21efa91.NewAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *MembersRequestBuilder) Count()(*i9963e9385350763ea36adf8643d677e06c609e3ac3683a5fc9df618152bf1718.CountRequestBuilder) {
    return i9963e9385350763ea36adf8643d677e06c609e3ac3683a5fc9df618152bf1718.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
