...
import (
    ...
    ibdeb8ac70bd8120f7580453d28c7eff30e0d2881ca7223dc92cf932980acb212 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/channels/item/messages/item/replies/item/hostedcontents/count"
)
...
func NewHostedContentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*HostedContentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *HostedContentsRequestBuilder) Count()(*ibdeb8ac70bd8120f7580453d28c7eff30e0d2881ca7223dc92cf932980acb212.CountRequestBuilder) {
    return ibdeb8ac70bd8120f7580453d28c7eff30e0d2881ca7223dc92cf932980acb212.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to hostedContents for me
