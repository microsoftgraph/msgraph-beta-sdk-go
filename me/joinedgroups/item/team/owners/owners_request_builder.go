...
import (
    ...
    i4bac797844276811cad68b97dc7e44ba830edb7bee21f81f45677bf154a40ce8 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/owners/count"
)
...
func NewOwnersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OwnersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *OwnersRequestBuilder) Count()(*i4bac797844276811cad68b97dc7e44ba830edb7bee21f81f45677bf154a40ce8.CountRequestBuilder) {
    return i4bac797844276811cad68b97dc7e44ba830edb7bee21f81f45677bf154a40ce8.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *OwnersRequestBuilder) Get()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserCollectionResponseable, error) {
