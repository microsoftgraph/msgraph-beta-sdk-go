...
// ChannelItemRequestBuilder provides operations to manage the incomingChannels property of the microsoft.graph.team entity.
...
// ChannelItemRequestBuilderGetQueryParameters get incomingChannels from me
...
func NewChannelItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ChannelItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/incomingChannels/{channel%2Did}{?%24select,%24expand}";
