...
import (
    ...
    icc45fcc377db96c14fbc77a80c9adf1a67918d7752a08696153dc3b3d53cf094 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/incomingchannels/count"
)
...
// IncomingChannelsRequestBuilderGetQueryParameters get incomingChannels from me
...
// IncomingChannelsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type IncomingChannelsRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
func NewIncomingChannelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IncomingChannelsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *IncomingChannelsRequestBuilder) Count()(*icc45fcc377db96c14fbc77a80c9adf1a67918d7752a08696153dc3b3d53cf094.CountRequestBuilder) {
    return icc45fcc377db96c14fbc77a80c9adf1a67918d7752a08696153dc3b3d53cf094.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get incomingChannels from me
...
// CreateGetRequestInformationWithRequestConfiguration get incomingChannels from me
...
// Get get incomingChannels from me
...
// GetWithRequestConfigurationAndResponseHandler get incomingChannels from me
func (m *IncomingChannelsRequestBuilder) GetWithRequestConfigurationAndResponseHandler(requestConfiguration *IncomingChannelsRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ChannelCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateChannelCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping)
    if err != nil {
        return nil, err
    }
