...
import (
    ...
    i23c4fb42ef365bdc3ef584d7cabdd4dac8ea8ec94f1cf58e37a24bdc54c67bec "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/schedule/timesoff/count"
)
...
func NewTimesOffRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TimesOffRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/schedule/timesOff{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
...
func (m *TimesOffRequestBuilder) Count()(*i23c4fb42ef365bdc3ef584d7cabdd4dac8ea8ec94f1cf58e37a24bdc54c67bec.CountRequestBuilder) {
    return i23c4fb42ef365bdc3ef584d7cabdd4dac8ea8ec94f1cf58e37a24bdc54c67bec.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to timesOff for me
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to timesOff for me
...
// Post create new navigation property to timesOff for me
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to timesOff for me
