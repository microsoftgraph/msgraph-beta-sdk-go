...
import (
    ...
    i33182d520eab33adab01e44061197cfeb265b0b3635747d717c133599955bff7 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/schedule/swapshiftschangerequests/count"
)
...
// SwapShiftsChangeRequestsRequestBuilderGetQueryParameters get swapShiftsChangeRequests from me
...
// SwapShiftsChangeRequestsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type SwapShiftsChangeRequestsRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
// SwapShiftsChangeRequestsRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type SwapShiftsChangeRequestsRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers map[string]string
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func NewSwapShiftsChangeRequestsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SwapShiftsChangeRequestsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/schedule/swapShiftsChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func NewSwapShiftsChangeRequestsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SwapShiftsChangeRequestsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSwapShiftsChangeRequestsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count the count property
func (m *SwapShiftsChangeRequestsRequestBuilder) Count()(*i33182d520eab33adab01e44061197cfeb265b0b3635747d717c133599955bff7.CountRequestBuilder) {
    return i33182d520eab33adab01e44061197cfeb265b0b3635747d717c133599955bff7.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get swapShiftsChangeRequests from me
...
// CreateGetRequestInformationWithRequestConfiguration get swapShiftsChangeRequests from me
...
// CreatePostRequestInformation create new navigation property to swapShiftsChangeRequests for me
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to swapShiftsChangeRequests for me
...
// GetWithRequestConfigurationAndResponseHandler get swapShiftsChangeRequests from me
func (m *SwapShiftsChangeRequestsRequestBuilder) GetWithRequestConfigurationAndResponseHandler(requestConfiguration *SwapShiftsChangeRequestsRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SwapShiftsChangeRequestCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateSwapShiftsChangeRequestCollectionResponseFromDiscriminatorValue, responseHandler, errorMapping)
    if err != nil {
        return nil, err
    }
...
// Post create new navigation property to swapShiftsChangeRequests for me
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to swapShiftsChangeRequests for me
