...
import (
    ...
    ia4b11496ad69ef97d0f3906fc8827c841bbb717feda0e3b2361a718b7920caec "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/team/permissiongrants/count"
)
...
func NewPermissionGrantsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissionGrantsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/team/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PermissionGrantsRequestBuilder) Count()(*ia4b11496ad69ef97d0f3906fc8827c841bbb717feda0e3b2361a718b7920caec.CountRequestBuilder) {
    return ia4b11496ad69ef97d0f3906fc8827c841bbb717feda0e3b2361a718b7920caec.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
