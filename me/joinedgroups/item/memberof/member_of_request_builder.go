...
import (
    ...
    i019dd464db6850c9224768192956f9812744ed2ee628f50dcdb6393bcd92160b "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/memberof/count"
)
...
func NewMemberOfRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MemberOfRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *MemberOfRequestBuilder) Count()(*i019dd464db6850c9224768192956f9812744ed2ee628f50dcdb6393bcd92160b.CountRequestBuilder) {
    return i019dd464db6850c9224768192956f9812744ed2ee628f50dcdb6393bcd92160b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
