...
import (
    ...
    i520a831245ad30c23807a695fd10053d15a4d578932ab9c91b284cda257e7557 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/acceptedsenders/count"
)
...
func NewAcceptedSendersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AcceptedSendersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/acceptedSenders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
...
func (m *AcceptedSendersRequestBuilder) Count()(*i520a831245ad30c23807a695fd10053d15a4d578932ab9c91b284cda257e7557.CountRequestBuilder) {
    return i520a831245ad30c23807a695fd10053d15a4d578932ab9c91b284cda257e7557.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
