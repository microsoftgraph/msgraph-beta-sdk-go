...
import (
    ...
    i7840f5f8cc933bfa0f0c4d100e7444e6a808b5dd663e51a1acf8c2692e2d1ca4 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/transitivemembers/count"
)
...
// TransitiveMembersRequestBuilderGetQueryParameters get transitiveMembers from me
...
func NewTransitiveMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TransitiveMembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/transitiveMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *TransitiveMembersRequestBuilder) Count()(*i7840f5f8cc933bfa0f0c4d100e7444e6a808b5dd663e51a1acf8c2692e2d1ca4.CountRequestBuilder) {
    return i7840f5f8cc933bfa0f0c4d100e7444e6a808b5dd663e51a1acf8c2692e2d1ca4.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get transitiveMembers from me
...
// CreateGetRequestInformationWithRequestConfiguration get transitiveMembers from me
...
// Get get transitiveMembers from me
...
// GetWithRequestConfigurationAndResponseHandler get transitiveMembers from me
