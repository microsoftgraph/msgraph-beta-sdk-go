...
import (
    ...
    iff33f7963c0262cd525bea070c2ba35cfdaf28c9ca282698498ef7a1d2ddb182 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/joinedgroups/item/conversations/item/threads/item/posts/count"
)
...
func NewPostsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PostsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PostsRequestBuilder) Count()(*iff33f7963c0262cd525bea070c2ba35cfdaf28c9ca282698498ef7a1d2ddb182.CountRequestBuilder) {
    return iff33f7963c0262cd525bea070c2ba35cfdaf28c9ca282698498ef7a1d2ddb182.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to posts for me
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to posts for me
...
// Post create new navigation property to posts for me
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to posts for me
