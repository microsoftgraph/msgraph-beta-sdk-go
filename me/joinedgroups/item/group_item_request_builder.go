...
// GroupItemRequestBuilder builds and executes requests for operations under \me\joinedGroups\{group-id}
...
func NewGroupItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GroupItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedGroups/{group_id}{?select}";
...
func (m *GroupItemRequestBuilder) Get(options *GroupItemRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Group, error) {
