...
// OutlookTaskGroupsItemTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilderGetQueryParameters get the number of the resource
type OutlookTaskGroupsItemTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilderGetQueryParameters struct {
...
type OutlookTaskGroupsItemTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *OutlookTaskGroupsItemTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilderGetQueryParameters
}
...
func NewOutlookTaskGroupsItemTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OutlookTaskGroupsItemTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders/{outlookTaskFolder%2Did}/tasks/{outlookTask%2Did}/singleValueExtendedProperties/$count{?%24search,%24filter}";
...
func (m *OutlookTaskGroupsItemTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *OutlookTaskGroupsItemTaskFoldersItemTasksItemSingleValueExtendedPropertiesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
