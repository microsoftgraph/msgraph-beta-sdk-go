...
func (m *FindRoomsWithRoomListRequestBuilder) Get(ctx context.Context, requestConfiguration *FindRoomsWithRoomListRequestBuilderGetRequestConfiguration)(FindRoomsWithRoomListResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateFindRoomsWithRoomListResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *FindRoomsWithRoomListRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *FindRoomsWithRoomListRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
