...
import (
    ...
    id330d07f2d74f520660e36d88ff798b8b744ec90c1924df42fe5f2c88d3ee102 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/pendingaccessreviewinstances/item/decisions/item/insights/count"
)
...
func NewInsightsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InsightsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/insights{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *InsightsRequestBuilder) Count()(*id330d07f2d74f520660e36d88ff798b8b744ec90c1924df42fe5f2c88d3ee102.CountRequestBuilder) {
    return id330d07f2d74f520660e36d88ff798b8b744ec90c1924df42fe5f2c88d3ee102.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
