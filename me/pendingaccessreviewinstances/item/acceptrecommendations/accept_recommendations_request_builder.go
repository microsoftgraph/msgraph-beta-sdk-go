...
// Builds and executes requests for operations under \me\pendingAccessReviewInstances\{accessReviewInstance-id}\microsoft.graph.acceptRecommendations
...
func NewAcceptRecommendationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AcceptRecommendationsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/me/pendingAccessReviewInstances/{accessReviewInstance_id}/microsoft.graph.acceptRecommendations";
