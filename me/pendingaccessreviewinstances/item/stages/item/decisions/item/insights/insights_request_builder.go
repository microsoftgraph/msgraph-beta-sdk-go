...
import (
    ...
    id69313f22abcf3b35a97aee6215cf90671479a26aec7fc9a638af1ced01e473b "github.com/microsoftgraph/msgraph-beta-sdk-go/me/pendingaccessreviewinstances/item/stages/item/decisions/item/insights/count"
)
...
func NewInsightsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*InsightsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance_id}/stages/{accessReviewStage_id}/decisions/{accessReviewInstanceDecisionItem_id}/insights{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *InsightsRequestBuilder) Count()(*id69313f22abcf3b35a97aee6215cf90671479a26aec7fc9a638af1ced01e473b.CountRequestBuilder) {
    return id69313f22abcf3b35a97aee6215cf90671479a26aec7fc9a638af1ced01e473b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
