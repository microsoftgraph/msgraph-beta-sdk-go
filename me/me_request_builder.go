...
func (m *MeRequestBuilder) AppConsentRequestsForApprovalById(id string)(*AppConsentRequestItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *MeRequestBuilder) AppRoleAssignedResourcesById(id string)(*ServicePrincipalItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *MeRequestBuilder) ApprovalsById(id string)(*ApprovalItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *MeRequestBuilder) CloudPCsById(id string)(*CloudPCItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewCloudPCItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *MeRequestBuilder) DeviceEnrollmentConfigurationsById(id string)(*DeviceEnrollmentConfigurationItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *MeRequestBuilder) DevicesById(id string)(*DeviceItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewDeviceItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *MeRequestBuilder) MobileAppIntentAndStatesById(id string)(*MobileAppIntentAndStateItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewMobileAppIntentAndStateItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *MeRequestBuilder) MobileAppTroubleshootingEventsById(id string)(*MobileAppTroubleshootingEventItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *MeRequestBuilder) NotificationsById(id string)(*NotificationItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewNotificationItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *MeRequestBuilder) PendingAccessReviewInstancesById(id string)(*AccessReviewInstanceItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *MeRequestBuilder) TransitiveReportsById(id string)(*DirectoryObjectItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *MeRequestBuilder) UsageRightsById(id string)(*UsageRightItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *MeRequestBuilder) WindowsInformationProtectionDeviceRegistrationsById(id string)(*WindowsInformationProtectionDeviceRegistrationItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
