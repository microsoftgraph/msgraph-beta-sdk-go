...
func (m *DevicesItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphApplication()(*DevicesItemTransitiveMemberOfItemMicrosoftGraphApplicationRequestBuilder) {
    return NewDevicesItemTransitiveMemberOfItemMicrosoftGraphApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDevice casts the previous resource to device.
func (m *DevicesItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphDevice()(*DevicesItemTransitiveMemberOfItemMicrosoftGraphDeviceRequestBuilder) {
    return NewDevicesItemTransitiveMemberOfItemMicrosoftGraphDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGroup casts the previous resource to group.
func (m *DevicesItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphGroup()(*DevicesItemTransitiveMemberOfItemMicrosoftGraphGroupRequestBuilder) {
    return NewDevicesItemTransitiveMemberOfItemMicrosoftGraphGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphOrgContact casts the previous resource to orgContact.
func (m *DevicesItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphOrgContact()(*DevicesItemTransitiveMemberOfItemMicrosoftGraphOrgContactRequestBuilder) {
    return NewDevicesItemTransitiveMemberOfItemMicrosoftGraphOrgContactRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *DevicesItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphServicePrincipal()(*DevicesItemTransitiveMemberOfItemMicrosoftGraphServicePrincipalRequestBuilder) {
    return NewDevicesItemTransitiveMemberOfItemMicrosoftGraphServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *DevicesItemTransitiveMemberOfDirectoryObjectItemRequestBuilder) MicrosoftGraphUser()(*DevicesItemTransitiveMemberOfItemMicrosoftGraphUserRequestBuilder) {
    return NewDevicesItemTransitiveMemberOfItemMicrosoftGraphUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
