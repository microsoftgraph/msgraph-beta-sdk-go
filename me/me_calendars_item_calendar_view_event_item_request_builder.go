...
func (m *MeCalendarsItemCalendarViewEventItemRequestBuilder) ExceptionOccurrences()(*MeCalendarsItemCalendarViewItemExceptionOccurrencesRequestBuilder) {
    return NewMeCalendarsItemCalendarViewItemExceptionOccurrencesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *MeCalendarsItemCalendarViewEventItemRequestBuilder) ExceptionOccurrencesById(id string)(*MeCalendarsItemCalendarViewItemExceptionOccurrencesEventItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewMeCalendarsItemCalendarViewItemExceptionOccurrencesEventItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *MeCalendarsItemCalendarViewEventItemRequestBuilder) Get(ctx context.Context, requestConfiguration *MeCalendarsItemCalendarViewEventItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Eventable, error) {
