...
func (m *JoinedGroupsRequestBuilder) MicrosoftGraphDelta()(*JoinedGroupsMicrosoftGraphDeltaRequestBuilder) {
    return NewJoinedGroupsMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateDynamicMembership provides operations to call the evaluateDynamicMembership method.
func (m *JoinedGroupsRequestBuilder) MicrosoftGraphEvaluateDynamicMembership()(*JoinedGroupsMicrosoftGraphEvaluateDynamicMembershipRequestBuilder) {
    return NewJoinedGroupsMicrosoftGraphEvaluateDynamicMembershipRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetByIds provides operations to call the getByIds method.
func (m *JoinedGroupsRequestBuilder) MicrosoftGraphGetByIds()(*JoinedGroupsMicrosoftGraphGetByIdsRequestBuilder) {
    return NewJoinedGroupsMicrosoftGraphGetByIdsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetUserOwnedObjects provides operations to call the getUserOwnedObjects method.
func (m *JoinedGroupsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*JoinedGroupsMicrosoftGraphGetUserOwnedObjectsRequestBuilder) {
    return NewJoinedGroupsMicrosoftGraphGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphValidateProperties provides operations to call the validateProperties method.
func (m *JoinedGroupsRequestBuilder) MicrosoftGraphValidateProperties()(*JoinedGroupsMicrosoftGraphValidatePropertiesRequestBuilder) {
    return NewJoinedGroupsMicrosoftGraphValidatePropertiesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
