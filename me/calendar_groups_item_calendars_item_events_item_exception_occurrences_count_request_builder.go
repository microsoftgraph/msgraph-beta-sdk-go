...
// CalendarGroupsItemCalendarsItemEventsItemExceptionOccurrencesCountRequestBuilderGetQueryParameters get the number of the resource
type CalendarGroupsItemCalendarsItemEventsItemExceptionOccurrencesCountRequestBuilderGetQueryParameters struct {
...
type CalendarGroupsItemCalendarsItemEventsItemExceptionOccurrencesCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *CalendarGroupsItemCalendarsItemEventsItemExceptionOccurrencesCountRequestBuilderGetQueryParameters
}
...
func NewCalendarGroupsItemCalendarsItemEventsItemExceptionOccurrencesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CalendarGroupsItemCalendarsItemEventsItemExceptionOccurrencesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/exceptionOccurrences/$count{?%24filter}";
