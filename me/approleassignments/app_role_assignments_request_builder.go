...
// CreatePostRequestInformationWithRequestConfiguration use this API to assign an app role to a user. To grant an app role assignment to a user, you need three identifiers:
