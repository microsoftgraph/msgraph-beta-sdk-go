...
func (m *MobileAppTroubleshootingEventsItemAppLogCollectionRequestsAppLogCollectionRequestItemRequestBuilder) MicrosoftGraphCreateDownloadUrl()(*MobileAppTroubleshootingEventsItemAppLogCollectionRequestsItemMicrosoftGraphCreateDownloadUrlRequestBuilder) {
    return NewMobileAppTroubleshootingEventsItemAppLogCollectionRequestsItemMicrosoftGraphCreateDownloadUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
