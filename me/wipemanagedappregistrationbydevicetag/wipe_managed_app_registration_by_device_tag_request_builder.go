...
// WipeManagedAppRegistrationByDeviceTagRequestBuilder builds and executes requests for operations under \me\microsoft.graph.wipeManagedAppRegistrationByDeviceTag
