...
func (m *OutlookSupportedTimeZonesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *OutlookSupportedTimeZonesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OutlookSupportedTimeZonesRequestBuilder) Get(ctx context.Context, requestConfiguration *OutlookSupportedTimeZonesRequestBuilderGetRequestConfiguration)(OutlookSupportedTimeZonesResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateOutlookSupportedTimeZonesResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
