...
func (m *DevicesItemMemberOfRequestBuilder) MicrosoftGraphApplication()(*DevicesItemMemberOfMicrosoftGraphApplicationApplicationRequestBuilder) {
    return NewDevicesItemMemberOfMicrosoftGraphApplicationApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDevice casts the previous resource to device.
func (m *DevicesItemMemberOfRequestBuilder) MicrosoftGraphDevice()(*DevicesItemMemberOfMicrosoftGraphDeviceDeviceRequestBuilder) {
    return NewDevicesItemMemberOfMicrosoftGraphDeviceDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGroup casts the previous resource to group.
func (m *DevicesItemMemberOfRequestBuilder) MicrosoftGraphGroup()(*DevicesItemMemberOfMicrosoftGraphGroupGroupRequestBuilder) {
    return NewDevicesItemMemberOfMicrosoftGraphGroupGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphOrgContact casts the previous resource to orgContact.
func (m *DevicesItemMemberOfRequestBuilder) MicrosoftGraphOrgContact()(*DevicesItemMemberOfMicrosoftGraphOrgContactOrgContactRequestBuilder) {
    return NewDevicesItemMemberOfMicrosoftGraphOrgContactOrgContactRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *DevicesItemMemberOfRequestBuilder) MicrosoftGraphServicePrincipal()(*DevicesItemMemberOfMicrosoftGraphServicePrincipalServicePrincipalRequestBuilder) {
    return NewDevicesItemMemberOfMicrosoftGraphServicePrincipalServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *DevicesItemMemberOfRequestBuilder) MicrosoftGraphUser()(*DevicesItemMemberOfMicrosoftGraphUserUserRequestBuilder) {
    return NewDevicesItemMemberOfMicrosoftGraphUserUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
