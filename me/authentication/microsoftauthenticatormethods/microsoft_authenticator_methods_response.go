...
// MicrosoftAuthenticatorMethodsResponse 
...
// NewMicrosoftAuthenticatorMethodsResponse instantiates a new microsoftAuthenticatorMethodsResponse and sets the default values.
