...
import (
    ...
    i0b18ca140113999e0eab2cd49ea8e16de4e815cd348309d5284dea8c1f732c48 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/authentication/microsoftauthenticatormethods/item/device/memberof/device/count"
)
...
func NewDeviceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DeviceRequestBuilder) Count()(*i0b18ca140113999e0eab2cd49ea8e16de4e815cd348309d5284dea8c1f732c48.CountRequestBuilder) {
    return i0b18ca140113999e0eab2cd49ea8e16de4e815cd348309d5284dea8c1f732c48.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
