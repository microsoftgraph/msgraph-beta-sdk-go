...
import (
    ...
    i778d0e4c6ed538abcab287f231d035958148e087ddf46bc72b851c0950a6e4b7 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/authentication/windowshelloforbusinessmethods/item/device/memberof/serviceprincipal/count"
)
...
func NewServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ServicePrincipalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ServicePrincipalRequestBuilder) Count()(*i778d0e4c6ed538abcab287f231d035958148e087ddf46bc72b851c0950a6e4b7.CountRequestBuilder) {
    return i778d0e4c6ed538abcab287f231d035958148e087ddf46bc72b851c0950a6e4b7.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
