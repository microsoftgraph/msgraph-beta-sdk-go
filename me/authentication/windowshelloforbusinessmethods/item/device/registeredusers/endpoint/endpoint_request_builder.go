...
import (
    ...
    i34d35adf36f13b4fa1082844fe74d1b29decdb85b351f6a707193fc8e4fa266b "github.com/microsoftgraph/msgraph-beta-sdk-go/me/authentication/windowshelloforbusinessmethods/item/device/registeredusers/endpoint/count"
)
...
func NewEndpointRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EndpointRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredUsers/microsoft.graph.endpoint{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *EndpointRequestBuilder) Count()(*i34d35adf36f13b4fa1082844fe74d1b29decdb85b351f6a707193fc8e4fa266b.CountRequestBuilder) {
    return i34d35adf36f13b4fa1082844fe74d1b29decdb85b351f6a707193fc8e4fa266b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
