...
// Builds and executes requests for operations under \me\authentication\operations
...
func NewOperationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OperationsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/me/authentication/operations{?top,skip,search,filter,count,orderby,select,expand}";
