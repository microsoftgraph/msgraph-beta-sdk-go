...
type PhoneMethodsRequestBuilderGetOptions struct {
    ...
    Q *PhoneMethodsRequestBuilderGetQueryParameters;
...
func NewPhoneMethodsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PhoneMethodsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/authentication/phoneMethods{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PhoneMethodsRequestBuilder) Get(options *PhoneMethodsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PhoneAuthenticationMethodCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreatePhoneAuthenticationMethodCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PhoneAuthenticationMethodCollectionResponseable), nil
}
// Post create new navigation property to phoneMethods for me
func (m *PhoneMethodsRequestBuilder) Post(options *PhoneMethodsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PhoneAuthenticationMethodable, error) {
