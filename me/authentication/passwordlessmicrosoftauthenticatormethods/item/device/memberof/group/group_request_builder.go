...
import (
    ...
    i85702a45cf74ed21753c7facd9312f762646a93d9994a9f56b0507187b592075 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/authentication/passwordlessmicrosoftauthenticatormethods/item/device/memberof/group/count"
)
...
func NewGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.group{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
...
func (m *GroupRequestBuilder) Count()(*i85702a45cf74ed21753c7facd9312f762646a93d9994a9f56b0507187b592075.CountRequestBuilder) {
    return i85702a45cf74ed21753c7facd9312f762646a93d9994a9f56b0507187b592075.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
