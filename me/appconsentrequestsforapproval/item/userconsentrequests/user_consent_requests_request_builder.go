...
// UserConsentRequestsRequestBuilder builds and executes requests for operations under \me\appConsentRequestsForApproval\{appConsentRequest-id}\userConsentRequests
...
func NewUserConsentRequestsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UserConsentRequestsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/appConsentRequestsForApproval/{appConsentRequest_id}/userConsentRequests{?top,skip,search,filter,count,orderby,select,expand}";
...
// FilterByCurrentUserWithOn builds and executes requests for operations under \me\appConsentRequestsForApproval\{appConsentRequest-id}\userConsentRequests\microsoft.graph.filterByCurrentUser(on={on})
