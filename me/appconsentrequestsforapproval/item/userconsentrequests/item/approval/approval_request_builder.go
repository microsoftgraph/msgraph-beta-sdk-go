...
// Builds and executes requests for operations under \me\appConsentRequestsForApproval\{appConsentRequest-id}\userConsentRequests\{userConsentRequest-id}\approval
...
func NewApprovalRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ApprovalRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/me/appConsentRequestsForApproval/{appConsentRequest_id}/userConsentRequests/{userConsentRequest_id}/approval{?select,expand}";
...
func (m *ApprovalRequestBuilder) StepsById(id string)(*i5d52076e1e2824e38e9ff8f8f0226ae0fdf93e7031774cec6b0d39489bff6682.ApprovalStepRequestBuilder) {
    ...
    return i5d52076e1e2824e38e9ff8f8f0226ae0fdf93e7031774cec6b0d39489bff6682.NewApprovalStepRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
