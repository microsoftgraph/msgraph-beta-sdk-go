...
func (m *MeDrivesItemItemsDriveItemItemRequestBuilder) Activities()(*MeDrivesItemItemsItemActivitiesRequestBuilder) {
    return NewMeDrivesItemItemsItemActivitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ActivitiesById provides operations to manage the activities property of the microsoft.graph.driveItem entity.
func (m *MeDrivesItemItemsDriveItemItemRequestBuilder) ActivitiesById(id string)(*MeDrivesItemItemsItemActivitiesItemActivityOLDItemRequestBuilder) {
    ...
    return NewMeDrivesItemItemsItemActivitiesItemActivityOLDItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *MeDrivesItemItemsDriveItemItemRequestBuilder) AssignSensitivityLabel()(*MeDrivesItemItemsItemAssignSensitivityLabelRequestBuilder) {
    return NewMeDrivesItemItemsItemAssignSensitivityLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *MeDrivesItemItemsDriveItemItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, requestConfiguration *MeDrivesItemItemsDriveItemItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *MeDrivesItemItemsDriveItemItemRequestBuilder) ExtractSensitivityLabels()(*MeDrivesItemItemsItemExtractSensitivityLabelsRequestBuilder) {
    return NewMeDrivesItemItemsItemExtractSensitivityLabelsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *MeDrivesItemItemsDriveItemItemRequestBuilder) Get(ctx context.Context, requestConfiguration *MeDrivesItemItemsDriveItemItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
