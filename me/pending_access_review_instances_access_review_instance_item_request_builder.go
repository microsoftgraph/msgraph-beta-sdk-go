...
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphAcceptRecommendations()(*PendingAccessReviewInstancesItemMicrosoftGraphAcceptRecommendationsRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphAcceptRecommendationsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyDecisions provides operations to call the applyDecisions method.
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphApplyDecisions()(*PendingAccessReviewInstancesItemMicrosoftGraphApplyDecisionsRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphApplyDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBatchRecordDecisions provides operations to call the batchRecordDecisions method.
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphBatchRecordDecisions()(*PendingAccessReviewInstancesItemMicrosoftGraphBatchRecordDecisionsRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphBatchRecordDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphResetDecisions provides operations to call the resetDecisions method.
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphResetDecisions()(*PendingAccessReviewInstancesItemMicrosoftGraphResetDecisionsRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphResetDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSendReminder provides operations to call the sendReminder method.
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphSendReminder()(*PendingAccessReviewInstancesItemMicrosoftGraphSendReminderRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphSendReminderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphStop provides operations to call the stop method.
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphStop()(*PendingAccessReviewInstancesItemMicrosoftGraphStopRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphStopRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
