...
func NewPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, accessReviewInstanceId *string)(*PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) {
...
func NewPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) {
    ...
    return NewPendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) ContactedReviewersById(id string)(*PendingAccessReviewInstancesItemContactedReviewersAccessReviewReviewerItemRequestBuilder) {
    ...
    idPtr := &id
    return NewPendingAccessReviewInstancesItemContactedReviewersAccessReviewReviewerItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) DecisionsById(id string)(*PendingAccessReviewInstancesItemDecisionsAccessReviewInstanceDecisionItemItemRequestBuilder) {
    ...
    idPtr := &id
    return NewPendingAccessReviewInstancesItemDecisionsAccessReviewInstanceDecisionItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphAcceptRecommendations()(*PendingAccessReviewInstancesItemMicrosoftGraphAcceptRecommendationsAcceptRecommendationsRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphAcceptRecommendationsAcceptRecommendationsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphApplyDecisions provides operations to call the applyDecisions method.
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphApplyDecisions()(*PendingAccessReviewInstancesItemMicrosoftGraphApplyDecisionsApplyDecisionsRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphApplyDecisionsApplyDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBatchRecordDecisions provides operations to call the batchRecordDecisions method.
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphBatchRecordDecisions()(*PendingAccessReviewInstancesItemMicrosoftGraphBatchRecordDecisionsBatchRecordDecisionsRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphBatchRecordDecisionsBatchRecordDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphResetDecisions provides operations to call the resetDecisions method.
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphResetDecisions()(*PendingAccessReviewInstancesItemMicrosoftGraphResetDecisionsResetDecisionsRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphResetDecisionsResetDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSendReminder provides operations to call the sendReminder method.
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphSendReminder()(*PendingAccessReviewInstancesItemMicrosoftGraphSendReminderSendReminderRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphSendReminderSendReminderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphStop provides operations to call the stop method.
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) MicrosoftGraphStop()(*PendingAccessReviewInstancesItemMicrosoftGraphStopStopRequestBuilder) {
    return NewPendingAccessReviewInstancesItemMicrosoftGraphStopStopRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *PendingAccessReviewInstancesAccessReviewInstanceItemRequestBuilder) StagesById(id string)(*PendingAccessReviewInstancesItemStagesAccessReviewStageItemRequestBuilder) {
    ...
    idPtr := &id
    return NewPendingAccessReviewInstancesItemStagesAccessReviewStageItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
