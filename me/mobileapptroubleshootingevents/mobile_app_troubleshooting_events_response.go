...
// MobileAppTroubleshootingEventsResponse 
...
// NewMobileAppTroubleshootingEventsResponse instantiates a new mobileAppTroubleshootingEventsResponse and sets the default values.
