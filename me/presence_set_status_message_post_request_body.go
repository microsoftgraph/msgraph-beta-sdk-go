...
// PresenceSetStatusMessagePostRequestBody provides operations to call the setStatusMessage method.
...
func (m *PresenceSetStatusMessagePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *PresenceSetStatusMessagePostRequestBody) SetAdditionalData(value map[string]interface{})() {
