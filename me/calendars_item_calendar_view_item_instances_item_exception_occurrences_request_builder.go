...
func (m *CalendarsItemCalendarViewItemInstancesItemExceptionOccurrencesRequestBuilder) MicrosoftGraphDelta()(*CalendarsItemCalendarViewItemInstancesItemExceptionOccurrencesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewCalendarsItemCalendarViewItemInstancesItemExceptionOccurrencesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
