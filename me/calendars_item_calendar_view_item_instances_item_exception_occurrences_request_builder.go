...
func (m *CalendarsItemCalendarViewItemInstancesItemExceptionOccurrencesRequestBuilder) MicrosoftGraphDelta()(*CalendarsItemCalendarViewItemInstancesItemExceptionOccurrencesMicrosoftGraphDeltaRequestBuilder) {
    return NewCalendarsItemCalendarViewItemInstancesItemExceptionOccurrencesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
