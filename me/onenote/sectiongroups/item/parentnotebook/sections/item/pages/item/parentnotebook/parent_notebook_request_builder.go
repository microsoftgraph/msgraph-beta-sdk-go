...
import (
    ...
    idbdddc2b774c4950e1b602a80a6fa9d4e95da4da9e2ea8ec52df45a3bf8d6e43 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/sectiongroups/item/parentnotebook/sections/item/pages/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/me/onenote/sectionGroups/{sectionGroup_id}/parentNotebook/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*idbdddc2b774c4950e1b602a80a6fa9d4e95da4da9e2ea8ec52df45a3bf8d6e43.CopyNotebookRequestBuilder) {
    return idbdddc2b774c4950e1b602a80a6fa9d4e95da4da9e2ea8ec52df45a3bf8d6e43.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the page.  Read-only.
// Parameters:
