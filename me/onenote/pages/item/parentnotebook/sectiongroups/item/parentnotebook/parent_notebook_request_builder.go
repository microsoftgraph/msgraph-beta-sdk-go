...
import (
    ...
    i58c22d2656abafa8ccf5c114369a25b14ee39ce96616f5ad0f15a60453f94fab "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/pages/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)

// parentNotebookRequestBuilder builds and executes requests for operations under \me\onenote\pages\{onenotePage-id}\parentNotebook\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i58c22d2656abafa8ccf5c114369a25b14ee39ce96616f5ad0f15a60453f94fab.CopyNotebookRequestBuilder) {
    return i58c22d2656abafa8ccf5c114369a25b14ee39ce96616f5ad0f15a60453f94fab.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
