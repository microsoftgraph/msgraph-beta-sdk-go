...
import (
    ...
    i14ff61fde1eed1a73609ec340692155dcbb236995303e358e0118232b6cae7fc "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/pages/item/parentsection/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \me\onenote\pages\{onenotePage-id}\parentSection\parentNotebook\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/onenote/pages/{onenotePage_id}/parentSection/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i14ff61fde1eed1a73609ec340692155dcbb236995303e358e0118232b6cae7fc.CopyNotebookRequestBuilder) {
    return i14ff61fde1eed1a73609ec340692155dcbb236995303e358e0118232b6cae7fc.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
