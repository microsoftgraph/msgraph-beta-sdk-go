...
import (
    ...
    ic7de5dffe618b678eec73d6c34f47fe4473fcc3b33c00aa1355014e37d1a273b "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/sections/item/parentnotebook/sectiongroups/item/sections/item/copytosectiongroup"
    ic8ae3c41df1a760cacef4b6b60a6bf3010c8334e0e12c6a0f97a2dfac5cc6fd7 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/sections/item/parentnotebook/sectiongroups/item/sections/item/copytonotebook"
)

// onenoteSectionRequestBuilder builds and executes requests for operations under \me\onenote\sections\{onenoteSection-id}\parentNotebook\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id1}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/onenote/sections/{onenoteSection_id}/parentNotebook/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id1}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*ic8ae3c41df1a760cacef4b6b60a6bf3010c8334e0e12c6a0f97a2dfac5cc6fd7.CopyToNotebookRequestBuilder) {
    return ic8ae3c41df1a760cacef4b6b60a6bf3010c8334e0e12c6a0f97a2dfac5cc6fd7.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*ic7de5dffe618b678eec73d6c34f47fe4473fcc3b33c00aa1355014e37d1a273b.CopyToSectionGroupRequestBuilder) {
    return ic7de5dffe618b678eec73d6c34f47fe4473fcc3b33c00aa1355014e37d1a273b.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
