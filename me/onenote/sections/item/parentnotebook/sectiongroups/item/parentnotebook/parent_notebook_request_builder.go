...
import (
    ...
    i9679ba02dccc5b336efd58af640d013cdd736660173477c4e1e075a634307f13 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/sections/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/me/onenote/sections/{onenoteSection_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i9679ba02dccc5b336efd58af640d013cdd736660173477c4e1e075a634307f13.CopyNotebookRequestBuilder) {
    return i9679ba02dccc5b336efd58af640d013cdd736660173477c4e1e075a634307f13.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the section group. Read-only.
// Parameters:
