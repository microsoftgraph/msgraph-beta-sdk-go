...
import (
    ...
    i36943c0cd1e2f10c1bd9ac173f666c960cc66b4d76b69e6335e09338a3a42ebd "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/sections/item/parentnotebook/sections"
    i6e0d0e9e77dbd40ed7b2c436332d001fee129105a66c5737f131aec01a42b316 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/sections/item/parentnotebook/sectiongroups"
    i825d4bc98c6eb7924d1bc6c199a3449ef454b1c7f46a9143b40aa8915619d01d "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/sections/item/parentnotebook/copynotebook"
    i586e3cd370d6d1a410d4b45ecf7f0b7b6316cc6ef7f9855551ed764a360d17be "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/sections/item/parentnotebook/sectiongroups/item"
    ie2ac5a3afb0f5c80ef3816d3528abd380e0b5eebf4327a95f8e86d1e6e1a4e3a "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/sections/item/parentnotebook/sections/item"
)

// parentNotebookRequestBuilder builds and executes requests for operations under \me\onenote\sections\{onenoteSection-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/onenote/sections/{onenoteSection_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i825d4bc98c6eb7924d1bc6c199a3449ef454b1c7f46a9143b40aa8915619d01d.CopyNotebookRequestBuilder) {
    return i825d4bc98c6eb7924d1bc6c199a3449ef454b1c7f46a9143b40aa8915619d01d.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ParentNotebookRequestBuilder) SectionGroups()(*i6e0d0e9e77dbd40ed7b2c436332d001fee129105a66c5737f131aec01a42b316.SectionGroupsRequestBuilder) {
    return i6e0d0e9e77dbd40ed7b2c436332d001fee129105a66c5737f131aec01a42b316.NewSectionGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionGroupsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.me.onenote.sections.item.parentNotebook.sectionGroups.item collection
func (m *ParentNotebookRequestBuilder) SectionGroupsById(id string)(*i586e3cd370d6d1a410d4b45ecf7f0b7b6316cc6ef7f9855551ed764a360d17be.SectionGroupRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i586e3cd370d6d1a410d4b45ecf7f0b7b6316cc6ef7f9855551ed764a360d17be.NewSectionGroupRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
func (m *ParentNotebookRequestBuilder) Sections()(*i36943c0cd1e2f10c1bd9ac173f666c960cc66b4d76b69e6335e09338a3a42ebd.SectionsRequestBuilder) {
    return i36943c0cd1e2f10c1bd9ac173f666c960cc66b4d76b69e6335e09338a3a42ebd.NewSectionsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.me.onenote.sections.item.parentNotebook.sections.item collection
func (m *ParentNotebookRequestBuilder) SectionsById(id string)(*ie2ac5a3afb0f5c80ef3816d3528abd380e0b5eebf4327a95f8e86d1e6e1a4e3a.OnenoteSectionRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return ie2ac5a3afb0f5c80ef3816d3528abd380e0b5eebf4327a95f8e86d1e6e1a4e3a.NewOnenoteSectionRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
