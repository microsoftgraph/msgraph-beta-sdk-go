...
import (
    ...
    iae0dea90bac33ec51313527104b24980bdc1f50266ada573642b08de379dcc64 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/notebooks/item/sections/item/parentsectiongroup/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/me/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/parentSectionGroup/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*iae0dea90bac33ec51313527104b24980bdc1f50266ada573642b08de379dcc64.CopyNotebookRequestBuilder) {
    return iae0dea90bac33ec51313527104b24980bdc1f50266ada573642b08de379dcc64.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The notebook that contains the section group. Read-only.
// Parameters:
