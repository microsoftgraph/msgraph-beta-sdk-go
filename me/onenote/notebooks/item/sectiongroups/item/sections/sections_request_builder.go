...
import (
    ...
    iebd4ef6e6d93e40b53e3017b85bc733d3bd5c445dec37909a5ff7138514e8ae4 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/notebooks/item/sectiongroups/item/sections/count"
)
...
func NewSectionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SectionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SectionsRequestBuilder) Count()(*iebd4ef6e6d93e40b53e3017b85bc733d3bd5c445dec37909a5ff7138514e8ae4.CountRequestBuilder) {
    return iebd4ef6e6d93e40b53e3017b85bc733d3bd5c445dec37909a5ff7138514e8ae4.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
