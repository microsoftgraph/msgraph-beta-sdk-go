...
import (
    ...
    if447aa916a0a9a06b8e794ff23e19f9d49699fcc356117341f5c750ef21f783b "github.com/microsoftgraph/msgraph-beta-sdk-go/me/onenote/notebooks/item/sectiongroups/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/me/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*if447aa916a0a9a06b8e794ff23e19f9d49699fcc356117341f5c750ef21f783b.CopyNotebookRequestBuilder) {
    return if447aa916a0a9a06b8e794ff23e19f9d49699fcc356117341f5c750ef21f783b.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
