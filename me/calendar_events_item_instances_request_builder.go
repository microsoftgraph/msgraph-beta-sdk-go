...
// CalendarEventsItemInstancesRequestBuilderGetQueryParameters get the instances (occurrences) of an event for a specified time range.  If the event is a `seriesMaster` type, this returns theoccurrences and exceptions of the event in the specified time range.
...
func (m *CalendarEventsItemInstancesRequestBuilder) Get(ctx context.Context, requestConfiguration *CalendarEventsItemInstancesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.EventCollectionResponseable, error) {
...
func (m *CalendarEventsItemInstancesRequestBuilder) MicrosoftGraphDelta()(*CalendarEventsItemInstancesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewCalendarEventsItemInstancesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
