...
// DrivesItemListContentTypesItemColumnLinksCountRequestBuilderGetQueryParameters get the number of the resource
type DrivesItemListContentTypesItemColumnLinksCountRequestBuilderGetQueryParameters struct {
...
type DrivesItemListContentTypesItemColumnLinksCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *DrivesItemListContentTypesItemColumnLinksCountRequestBuilderGetQueryParameters
}
...
func NewDrivesItemListContentTypesItemColumnLinksCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListContentTypesItemColumnLinksCountRequestBuilder) {
    m := &DrivesItemListContentTypesItemColumnLinksCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnLinks/$count{?%24search,%24filter}";
...
func NewDrivesItemListContentTypesItemColumnLinksCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListContentTypesItemColumnLinksCountRequestBuilder) {
    ...
    return NewDrivesItemListContentTypesItemColumnLinksCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *DrivesItemListContentTypesItemColumnLinksCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemListContentTypesItemColumnLinksCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *DrivesItemListContentTypesItemColumnLinksCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemListContentTypesItemColumnLinksCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
