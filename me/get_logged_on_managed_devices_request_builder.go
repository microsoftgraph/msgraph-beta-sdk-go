...
// GetLoggedOnManagedDevicesRequestBuilderGetQueryParameters invoke function getLoggedOnManagedDevices
type GetLoggedOnManagedDevicesRequestBuilderGetQueryParameters struct {
...
type GetLoggedOnManagedDevicesRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *GetLoggedOnManagedDevicesRequestBuilderGetQueryParameters
}
...
func (m *GetLoggedOnManagedDevicesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GetLoggedOnManagedDevicesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetLoggedOnManagedDevicesRequestBuilder) Get(ctx context.Context, requestConfiguration *GetLoggedOnManagedDevicesRequestBuilderGetRequestConfiguration)(GetLoggedOnManagedDevicesResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGetLoggedOnManagedDevicesResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
