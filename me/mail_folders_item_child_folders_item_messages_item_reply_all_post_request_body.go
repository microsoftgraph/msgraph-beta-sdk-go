...
// MailFoldersItemChildFoldersItemMessagesItemReplyAllPostRequestBody 
...
func (m *MailFoldersItemChildFoldersItemMessagesItemReplyAllPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *MailFoldersItemChildFoldersItemMessagesItemReplyAllPostRequestBody) GetMessage()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Messageable) {
    return m.message
}
...
func (m *MailFoldersItemChildFoldersItemMessagesItemReplyAllPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *MailFoldersItemChildFoldersItemMessagesItemReplyAllPostRequestBody) SetMessage(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Messageable)() {
    m.message = value
}
