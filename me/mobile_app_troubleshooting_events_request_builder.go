...
func (m *MobileAppTroubleshootingEventsRequestBuilder) Count()(*MobileAppTroubleshootingEventsCountRequestBuilder) {
    return NewMobileAppTroubleshootingEventsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// ToPostRequestInformation create new navigation property to mobileAppTroubleshootingEvents for me
