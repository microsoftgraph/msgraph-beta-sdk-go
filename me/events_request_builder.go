...
func (m *EventsRequestBuilder) MicrosoftGraphDelta()(*EventsMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewEventsMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
