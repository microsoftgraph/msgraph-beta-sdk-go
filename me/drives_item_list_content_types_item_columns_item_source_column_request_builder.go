...
// DrivesItemListContentTypesItemColumnsItemSourceColumnRequestBuilderGetQueryParameters the source column for content type column.
...
func NewDrivesItemListContentTypesItemColumnsItemSourceColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListContentTypesItemColumnsItemSourceColumnRequestBuilder) {
    m := &DrivesItemListContentTypesItemColumnsItemSourceColumnRequestBuilder{
    }
...
func NewDrivesItemListContentTypesItemColumnsItemSourceColumnRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListContentTypesItemColumnsItemSourceColumnRequestBuilder) {
    ...
    return NewDrivesItemListContentTypesItemColumnsItemSourceColumnRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation the source column for content type column.
func (m *DrivesItemListContentTypesItemColumnsItemSourceColumnRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemListContentTypesItemColumnsItemSourceColumnRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemListContentTypesItemColumnsItemSourceColumnRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemListContentTypesItemColumnsItemSourceColumnRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ColumnDefinitionable, error) {
