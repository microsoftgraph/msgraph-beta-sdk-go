...
// CalendarEventsItemExceptionOccurrencesItemAcceptPostRequestBody 
...
func (m *CalendarEventsItemExceptionOccurrencesItemAcceptPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CalendarEventsItemExceptionOccurrencesItemAcceptPostRequestBody) SetAdditionalData(value map[string]any)() {
