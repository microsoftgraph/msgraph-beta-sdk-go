...
func (m *JoinedTeamsRequestBuilder) Count()(*JoinedTeamsCountRequestBuilder) {
    return NewJoinedTeamsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *JoinedTeamsRequestBuilder) Get(ctx context.Context, requestConfiguration *JoinedTeamsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateTeamCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *JoinedTeamsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *JoinedTeamsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
