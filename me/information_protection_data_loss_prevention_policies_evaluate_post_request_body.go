...
// InformationProtectionDataLossPreventionPoliciesEvaluatePostRequestBody 
...
func (m *InformationProtectionDataLossPreventionPoliciesEvaluatePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *InformationProtectionDataLossPreventionPoliciesEvaluatePostRequestBody) SetAdditionalData(value map[string]any)() {
