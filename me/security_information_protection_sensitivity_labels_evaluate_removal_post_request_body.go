...
// SecurityInformationProtectionSensitivityLabelsEvaluateRemovalPostRequestBody 
...
func (m *SecurityInformationProtectionSensitivityLabelsEvaluateRemovalPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *SecurityInformationProtectionSensitivityLabelsEvaluateRemovalPostRequestBody) SetAdditionalData(value map[string]any)() {
