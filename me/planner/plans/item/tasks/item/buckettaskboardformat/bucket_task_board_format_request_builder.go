...
func (m *BucketTaskBoardFormatRequestBuilder) Delete(ctx context.Context, requestConfiguration *BucketTaskBoardFormatRequestBuilderDeleteRequestConfiguration)(error) {
