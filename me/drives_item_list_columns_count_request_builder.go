...
// DrivesItemListColumnsCountRequestBuilderGetQueryParameters get the number of the resource
type DrivesItemListColumnsCountRequestBuilderGetQueryParameters struct {
...
type DrivesItemListColumnsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *DrivesItemListColumnsCountRequestBuilderGetQueryParameters
}
...
func NewDrivesItemListColumnsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListColumnsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/columns/$count{?%24search,%24filter}";
...
func (m *DrivesItemListColumnsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemListColumnsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
