...
func (m *TodoListsItemTasksTodoTaskItemRequestBuilder) AttachmentsById(id string)(*TodoListsItemTasksItemAttachmentsAttachmentBaseItemRequestBuilder) {
    ...
    idPtr := &id
    return NewTodoListsItemTasksItemAttachmentsAttachmentBaseItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *TodoListsItemTasksTodoTaskItemRequestBuilder) AttachmentSessionsById(id string)(*TodoListsItemTasksItemAttachmentSessionsAttachmentSessionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewTodoListsItemTasksItemAttachmentSessionsAttachmentSessionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *TodoListsItemTasksTodoTaskItemRequestBuilder) ChecklistItemsById(id string)(*TodoListsItemTasksItemChecklistItemsChecklistItemItemRequestBuilder) {
    ...
    idPtr := &id
    return NewTodoListsItemTasksItemChecklistItemsChecklistItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewTodoListsItemTasksTodoTaskItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, todoTaskId *string)(*TodoListsItemTasksTodoTaskItemRequestBuilder) {
...
func NewTodoListsItemTasksTodoTaskItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TodoListsItemTasksTodoTaskItemRequestBuilder) {
    ...
    return NewTodoListsItemTasksTodoTaskItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *TodoListsItemTasksTodoTaskItemRequestBuilder) ExtensionsById(id string)(*TodoListsItemTasksItemExtensionsExtensionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewTodoListsItemTasksItemExtensionsExtensionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *TodoListsItemTasksTodoTaskItemRequestBuilder) LinkedResourcesById(id string)(*TodoListsItemTasksItemLinkedResourcesLinkedResourceItemRequestBuilder) {
    ...
    idPtr := &id
    return NewTodoListsItemTasksItemLinkedResourcesLinkedResourceItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
