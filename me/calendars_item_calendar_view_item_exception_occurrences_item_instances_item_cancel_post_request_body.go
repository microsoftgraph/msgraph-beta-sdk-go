...
func (m *CalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesItemCancelPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CalendarsItemCalendarViewItemExceptionOccurrencesItemInstancesItemCancelPostRequestBody) SetAdditionalData(value map[string]any)() {
