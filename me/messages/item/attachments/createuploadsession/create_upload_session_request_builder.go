...
// CreateUploadSessionRequestBuilder builds and executes requests for operations under \me\messages\{message-id}\attachments\microsoft.graph.createUploadSession
