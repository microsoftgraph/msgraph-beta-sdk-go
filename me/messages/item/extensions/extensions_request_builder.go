...
import (
    ...
    id97962f05d8024117f298aba6c4efa491fc83242ba8192dd6e449d8226115775 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/messages/item/extensions/count"
)

// ExtensionsRequestBuilder provides operations to manage the extensions property of the microsoft.graph.message entity.
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/messages/{message%2Did}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*id97962f05d8024117f298aba6c4efa491fc83242ba8192dd6e449d8226115775.CountRequestBuilder) {
    return id97962f05d8024117f298aba6c4efa491fc83242ba8192dd6e449d8226115775.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
