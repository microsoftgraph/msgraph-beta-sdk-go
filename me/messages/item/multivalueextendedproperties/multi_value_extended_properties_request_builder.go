...
import (
    ...
    if9411758bfe47f5688b3b2f4d1370bb69f63682d8a100878d0969b0872824af3 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/messages/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/messages/{message_id}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*if9411758bfe47f5688b3b2f4d1370bb69f63682d8a100878d0969b0872824af3.CountRequestBuilder) {
    return if9411758bfe47f5688b3b2f4d1370bb69f63682d8a100878d0969b0872824af3.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
