...
import (
    ...
    id4e957ca9d3a103d1e93be2f23975e17bbefc9cb9d67d1f39923a00915b1d387 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/windowsinformationprotectiondeviceregistrations/count"
)
...
func NewWindowsInformationProtectionDeviceRegistrationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsInformationProtectionDeviceRegistrationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/windowsInformationProtectionDeviceRegistrations{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
