...
// RefRequestBuilder builds and executes requests for operations under \me\windowsInformationProtectionDeviceRegistrations\$ref
...
// RefRequestBuilderGetQueryParameters zero or more WIP device registrations that belong to the user.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/windowsInformationProtectionDeviceRegistrations/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation zero or more WIP device registrations that belong to the user.
...
// Post zero or more WIP device registrations that belong to the user.
