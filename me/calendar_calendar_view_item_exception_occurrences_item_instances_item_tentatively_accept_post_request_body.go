...
// CalendarCalendarViewItemExceptionOccurrencesItemInstancesItemTentativelyAcceptPostRequestBody provides operations to call the tentativelyAccept method.
...
func (m *CalendarCalendarViewItemExceptionOccurrencesItemInstancesItemTentativelyAcceptPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *CalendarCalendarViewItemExceptionOccurrencesItemInstancesItemTentativelyAcceptPostRequestBody) SetAdditionalData(value map[string]interface{})() {
