...
// ManagedDevicesItemGetFileVaultKeyResponse provides operations to call the getFileVaultKey method.
...
func (m *ManagedDevicesItemGetFileVaultKeyResponse) GetAdditionalData()(map[string]interface{}) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ManagedDevicesItemGetFileVaultKeyResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ManagedDevicesItemGetFileVaultKeyResponse) GetValue()(*string) {
    return m.value
}
// Serialize serializes information the current object
func (m *ManagedDevicesItemGetFileVaultKeyResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ManagedDevicesItemGetFileVaultKeyResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetValue sets the value property value. The value property
func (m *ManagedDevicesItemGetFileVaultKeyResponse) SetValue(value *string)() {
    m.value = value
}
