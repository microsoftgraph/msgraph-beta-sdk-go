...
func (m *ManagedDevicesItemGetFileVaultKeyResponse) GetAdditionalData()(map[string]any) {
...
func (m *ManagedDevicesItemGetFileVaultKeyResponse) SetAdditionalData(value map[string]any)() {
