...
// DrivesItemListContentTypesItemBaseTypesCountRequestBuilderGetQueryParameters get the number of the resource
type DrivesItemListContentTypesItemBaseTypesCountRequestBuilderGetQueryParameters struct {
...
type DrivesItemListContentTypesItemBaseTypesCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *DrivesItemListContentTypesItemBaseTypesCountRequestBuilderGetQueryParameters
}
...
func NewDrivesItemListContentTypesItemBaseTypesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListContentTypesItemBaseTypesCountRequestBuilder) {
    m := &DrivesItemListContentTypesItemBaseTypesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/baseTypes/$count{?%24search,%24filter}";
...
func NewDrivesItemListContentTypesItemBaseTypesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemListContentTypesItemBaseTypesCountRequestBuilder) {
    ...
    return NewDrivesItemListContentTypesItemBaseTypesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *DrivesItemListContentTypesItemBaseTypesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DrivesItemListContentTypesItemBaseTypesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *DrivesItemListContentTypesItemBaseTypesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DrivesItemListContentTypesItemBaseTypesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
