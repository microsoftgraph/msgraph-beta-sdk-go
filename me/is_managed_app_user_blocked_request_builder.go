...
func (m *IsManagedAppUserBlockedRequestBuilder) Get(ctx context.Context, requestConfiguration *IsManagedAppUserBlockedRequestBuilderGetRequestConfiguration)(IsManagedAppUserBlockedResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateIsManagedAppUserBlockedResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *IsManagedAppUserBlockedRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *IsManagedAppUserBlockedRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
