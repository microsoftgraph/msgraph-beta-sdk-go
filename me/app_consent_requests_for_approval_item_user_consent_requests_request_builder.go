...
func (m *AppConsentRequestsForApprovalItemUserConsentRequestsRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*AppConsentRequestsForApprovalItemUserConsentRequestsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilder) {
    return NewAppConsentRequestsForApprovalItemUserConsentRequestsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
