...
// ExtensionsRequestBuilder builds and executes requests for operations under \me\tasks\alltasks\{baseTask-id}\parentList\extensions
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/tasks/alltasks/{baseTask_id}/parentList/extensions{?top,skip,search,filter,count,orderby,select,expand}";
