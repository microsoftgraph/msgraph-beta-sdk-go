...
import (
    ...
    i7da6ad6fb626b46116d30f6ff1b6142a815783b63fec788d0f5f1d0857a903a5 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/tasks/alltasks/item/parentlist/tasks/item/move"
)

// BaseTaskRequestBuilder builds and executes requests for operations under \me\tasks\alltasks\{baseTask-id}\parentList\tasks\{baseTask-id1}
...
func NewBaseTaskRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BaseTaskRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/tasks/alltasks/{baseTask_id}/parentList/tasks/{baseTask_id1}{?select,expand}";
...
func (m *BaseTaskRequestBuilder) Move()(*i7da6ad6fb626b46116d30f6ff1b6142a815783b63fec788d0f5f1d0857a903a5.MoveRequestBuilder) {
    return i7da6ad6fb626b46116d30f6ff1b6142a815783b63fec788d0f5f1d0857a903a5.NewMoveRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
