...
import (
    ...
    i85d2fc5b2e31693debb5c767073d4543394af0f96f2db42ef6fc25e08e16882f "github.com/microsoftgraph/msgraph-beta-sdk-go/me/tasks/alltasks/item/parentlist/tasks/delta"
)

// TasksRequestBuilder builds and executes requests for operations under \me\tasks\alltasks\{baseTask-id}\parentList\tasks
...
func NewTasksRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TasksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/tasks/alltasks/{baseTask_id}/parentList/tasks{?top,skip,search,filter,count,orderby,select,expand}";
...
// Delta builds and executes requests for operations under \me\tasks\alltasks\{baseTask-id}\parentList\tasks\microsoft.graph.delta()
func (m *TasksRequestBuilder) Delta()(*i85d2fc5b2e31693debb5c767073d4543394af0f96f2db42ef6fc25e08e16882f.DeltaRequestBuilder) {
    return i85d2fc5b2e31693debb5c767073d4543394af0f96f2db42ef6fc25e08e16882f.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *TasksRequestBuilder) Post(options *TasksRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.BaseTask, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewBaseTask() }, nil)
    if err != nil {
        return nil, err
    }
