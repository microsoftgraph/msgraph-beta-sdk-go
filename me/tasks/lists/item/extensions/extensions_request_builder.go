...
import (
    ...
    ia76547ee36a285be87c01e84d15bf78b936eae690615de6dbddc19111a3acfef "github.com/microsoftgraph/msgraph-beta-sdk-go/me/tasks/lists/item/extensions/count"
)
...
func NewExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExtensionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/tasks/lists/{baseTaskList%2Did}/extensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExtensionsRequestBuilder) Count()(*ia76547ee36a285be87c01e84d15bf78b936eae690615de6dbddc19111a3acfef.CountRequestBuilder) {
    return ia76547ee36a285be87c01e84d15bf78b936eae690615de6dbddc19111a3acfef.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
