...
func (m *InformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateApplication()(*InformationProtectionPolicyLabelsMicrosoftGraphEvaluateApplicationEvaluateApplicationRequestBuilder) {
    return NewInformationProtectionPolicyLabelsMicrosoftGraphEvaluateApplicationEvaluateApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateClassificationResults provides operations to call the evaluateClassificationResults method.
func (m *InformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateClassificationResults()(*InformationProtectionPolicyLabelsMicrosoftGraphEvaluateClassificationResultsEvaluateClassificationResultsRequestBuilder) {
    return NewInformationProtectionPolicyLabelsMicrosoftGraphEvaluateClassificationResultsEvaluateClassificationResultsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateRemoval provides operations to call the evaluateRemoval method.
func (m *InformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateRemoval()(*InformationProtectionPolicyLabelsMicrosoftGraphEvaluateRemovalEvaluateRemovalRequestBuilder) {
    return NewInformationProtectionPolicyLabelsMicrosoftGraphEvaluateRemovalEvaluateRemovalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphExtractLabel provides operations to call the extractLabel method.
func (m *InformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphExtractLabel()(*InformationProtectionPolicyLabelsMicrosoftGraphExtractLabelExtractLabelRequestBuilder) {
    return NewInformationProtectionPolicyLabelsMicrosoftGraphExtractLabelExtractLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
