...
func (m *DevicesRequestBuilder) MicrosoftGraphDelta()(*DevicesMicrosoftGraphDeltaRequestBuilder) {
    return NewDevicesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetByIds provides operations to call the getByIds method.
func (m *DevicesRequestBuilder) MicrosoftGraphGetByIds()(*DevicesMicrosoftGraphGetByIdsRequestBuilder) {
    return NewDevicesMicrosoftGraphGetByIdsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetUserOwnedObjects provides operations to call the getUserOwnedObjects method.
func (m *DevicesRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*DevicesMicrosoftGraphGetUserOwnedObjectsRequestBuilder) {
    return NewDevicesMicrosoftGraphGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphValidateProperties provides operations to call the validateProperties method.
func (m *DevicesRequestBuilder) MicrosoftGraphValidateProperties()(*DevicesMicrosoftGraphValidatePropertiesRequestBuilder) {
    return NewDevicesMicrosoftGraphValidatePropertiesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
