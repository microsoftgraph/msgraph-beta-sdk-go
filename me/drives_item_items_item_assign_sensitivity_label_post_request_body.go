...
func (m *DrivesItemItemsItemAssignSensitivityLabelPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *DrivesItemItemsItemAssignSensitivityLabelPostRequestBody) SetAdditionalData(value map[string]any)() {
