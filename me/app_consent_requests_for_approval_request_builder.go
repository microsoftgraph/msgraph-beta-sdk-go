...
func (m *AppConsentRequestsForApprovalRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*AppConsentRequestsForApprovalMicrosoftGraphFilterByCurrentUserWithOnRequestBuilder) {
    return NewAppConsentRequestsForApprovalMicrosoftGraphFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
