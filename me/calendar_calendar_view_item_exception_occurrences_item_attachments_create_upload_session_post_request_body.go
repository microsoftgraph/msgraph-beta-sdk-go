...
// CalendarCalendarViewItemExceptionOccurrencesItemAttachmentsCreateUploadSessionPostRequestBody 
...
func (m *CalendarCalendarViewItemExceptionOccurrencesItemAttachmentsCreateUploadSessionPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CalendarCalendarViewItemExceptionOccurrencesItemAttachmentsCreateUploadSessionPostRequestBody) SetAdditionalData(value map[string]any)() {
