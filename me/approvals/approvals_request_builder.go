...
// Builds and executes requests for operations under \me\approvals
...
// Builds and executes requests for operations under \me\approvals\microsoft.graph.filterByCurrentUser(on={on})
// Parameters:
//  - on : Usage: on={on}
