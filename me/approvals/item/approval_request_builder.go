...
// ApprovalRequestBuilder builds and executes requests for operations under \me\approvals\{approval-id}
...
// ApprovalRequestBuilderGetQueryParameters get approvals from me
...
func NewApprovalRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ApprovalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/approvals/{approval_id}{?select,expand}";
