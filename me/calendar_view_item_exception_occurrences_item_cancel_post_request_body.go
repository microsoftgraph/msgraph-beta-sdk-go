...
// CalendarViewItemExceptionOccurrencesItemCancelPostRequestBody provides operations to call the cancel method.
...
func (m *CalendarViewItemExceptionOccurrencesItemCancelPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *CalendarViewItemExceptionOccurrencesItemCancelPostRequestBody) SetAdditionalData(value map[string]interface{})() {
