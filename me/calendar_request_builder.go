...
func (m *CalendarRequestBuilder) CalendarPermissionsById(id string)(*CalendarCalendarPermissionsCalendarPermissionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewCalendarCalendarPermissionsCalendarPermissionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *CalendarRequestBuilder) CalendarViewById(id string)(*CalendarCalendarViewEventItemRequestBuilder) {
    ...
    idPtr := &id
    return NewCalendarCalendarViewEventItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *CalendarRequestBuilder) EventsById(id string)(*CalendarEventsEventItemRequestBuilder) {
    ...
    idPtr := &id
    return NewCalendarEventsEventItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *CalendarRequestBuilder) MicrosoftGraphAllowedCalendarSharingRolesWithUser(user *string)(*CalendarMicrosoftGraphAllowedCalendarSharingRolesWithUserAllowedCalendarSharingRolesWithUserRequestBuilder) {
    return NewCalendarMicrosoftGraphAllowedCalendarSharingRolesWithUserAllowedCalendarSharingRolesWithUserRequestBuilderInternal(m.pathParameters, m.requestAdapter, user)
}
// MicrosoftGraphGetSchedule provides operations to call the getSchedule method.
func (m *CalendarRequestBuilder) MicrosoftGraphGetSchedule()(*CalendarMicrosoftGraphGetScheduleGetScheduleRequestBuilder) {
    return NewCalendarMicrosoftGraphGetScheduleGetScheduleRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *CalendarRequestBuilder) MultiValueExtendedPropertiesById(id string)(*CalendarMultiValueExtendedPropertiesMultiValueLegacyExtendedPropertyItemRequestBuilder) {
    ...
    idPtr := &id
    return NewCalendarMultiValueExtendedPropertiesMultiValueLegacyExtendedPropertyItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *CalendarRequestBuilder) SingleValueExtendedPropertiesById(id string)(*CalendarSingleValueExtendedPropertiesSingleValueLegacyExtendedPropertyItemRequestBuilder) {
    ...
    idPtr := &id
    return NewCalendarSingleValueExtendedPropertiesSingleValueLegacyExtendedPropertyItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
