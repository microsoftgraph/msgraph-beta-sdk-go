...
func (m *InformationProtectionSensitivityLabelsItemSublabelsRequestBuilder) MicrosoftGraphEvaluate()(*InformationProtectionSensitivityLabelsItemSublabelsMicrosoftGraphEvaluateRequestBuilder) {
    return NewInformationProtectionSensitivityLabelsItemSublabelsMicrosoftGraphEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
