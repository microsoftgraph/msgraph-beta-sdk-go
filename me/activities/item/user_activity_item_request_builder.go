...
// UserActivityItemRequestBuilder builds and executes requests for operations under \me\activities\{userActivity-id}
...
type UserActivityItemRequestBuilderGetOptions struct {
    ...
    Q *UserActivityItemRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
func NewUserActivityItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UserActivityItemRequestBuilder) {
    m := &UserActivityItemRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/me/activities/{userActivity_id}{?select,expand}";
...
func NewUserActivityItemRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UserActivityItemRequestBuilder) {
...
func (m *UserActivityItemRequestBuilder) CreateGetRequestInformation(options *UserActivityItemRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
