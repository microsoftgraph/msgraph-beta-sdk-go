...
func (m *MailFoldersItemMessagesMessageItemRequestBuilder) MentionsById(id string)(*MailFoldersItemMessagesItemMentionsMentionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewMailFoldersItemMessagesItemMentionsMentionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *MailFoldersItemMessagesMessageItemRequestBuilder) MicrosoftGraphUnsubscribe()(*MailFoldersItemMessagesItemMicrosoftGraphUnsubscribeUnsubscribeRequestBuilder) {
    return NewMailFoldersItemMessagesItemMicrosoftGraphUnsubscribeUnsubscribeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
