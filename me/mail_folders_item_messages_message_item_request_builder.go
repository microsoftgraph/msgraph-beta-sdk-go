...
func (m *MailFoldersItemMessagesMessageItemRequestBuilder) MicrosoftGraphUnsubscribe()(*MailFoldersItemMessagesItemMicrosoftGraphUnsubscribeRequestBuilder) {
    return NewMailFoldersItemMessagesItemMicrosoftGraphUnsubscribeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
