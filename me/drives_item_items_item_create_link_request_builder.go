...
func NewDrivesItemItemsItemCreateLinkRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemItemsItemCreateLinkRequestBuilder) {
    m := &DrivesItemItemsItemCreateLinkRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.createLink";
...
func NewDrivesItemItemsItemCreateLinkRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DrivesItemItemsItemCreateLinkRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDrivesItemItemsItemCreateLinkRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DrivesItemItemsItemCreateLinkRequestBuilder) CreatePostRequestInformation(ctx context.Context, body DrivesItemItemsItemCreateLinkPostRequestBodyable, requestConfiguration *DrivesItemItemsItemCreateLinkRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DrivesItemItemsItemCreateLinkRequestBuilder) Post(ctx context.Context, body DrivesItemItemsItemCreateLinkPostRequestBodyable, requestConfiguration *DrivesItemItemsItemCreateLinkRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Permissionable, error) {
