...
// MultiValueLegacyExtendedPropertyItemRequestBuilder builds and executes requests for operations under \me\contacts\{contact-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
