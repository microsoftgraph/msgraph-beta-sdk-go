...
// CreatePostRequestInformation the collection of open extensions defined for the contact. Nullable.
...
// Post the collection of open extensions defined for the contact. Nullable.
