...
// ExtensionsRequestBuilder builds and executes requests for operations under \me\contacts\{contact-id}\extensions
...
// CreatePostRequestInformation the collection of open extensions defined for the contact. Read-only. Nullable.
...
// Post the collection of open extensions defined for the contact. Read-only. Nullable.
