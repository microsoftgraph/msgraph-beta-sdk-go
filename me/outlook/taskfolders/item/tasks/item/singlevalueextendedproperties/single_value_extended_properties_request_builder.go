...
import (
    ...
    ia943d45a1ae96dae5ac2de45560fc53bb822ca2b2594c7ae4b4f595e1d2baa42 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/outlook/taskfolders/item/tasks/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/outlook/taskFolders/{outlookTaskFolder_id}/tasks/{outlookTask_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*ia943d45a1ae96dae5ac2de45560fc53bb822ca2b2594c7ae4b4f595e1d2baa42.CountRequestBuilder) {
    return ia943d45a1ae96dae5ac2de45560fc53bb822ca2b2594c7ae4b4f595e1d2baa42.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
