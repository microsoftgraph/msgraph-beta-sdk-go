...
import (
    ...
    iba7b11fc2ba025e92b0f970acfe44baaac2a8a1d58c6c9c1b60daaa03b04c281 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/outlook/tasks/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/outlook/tasks/{outlookTask_id}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*iba7b11fc2ba025e92b0f970acfe44baaac2a8a1d58c6c9c1b60daaa03b04c281.CountRequestBuilder) {
    return iba7b11fc2ba025e92b0f970acfe44baaac2a8a1d58c6c9c1b60daaa03b04c281.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
