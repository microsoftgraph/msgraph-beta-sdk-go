...
import (
    ...
    ia9d32de5c946d2e74f7da82a43072da49a3b0b9849fecffff8c1b9e26e2394e0 "github.com/microsoftgraph/msgraph-beta-sdk-go/me/outlook/taskgroups/item/taskfolders/item/tasks/count"
)
...
func NewTasksRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TasksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup_id}/taskFolders/{outlookTaskFolder_id}/tasks{?top,skip,filter,count,orderby,select}";
...
func (m *TasksRequestBuilder) Count()(*ia9d32de5c946d2e74f7da82a43072da49a3b0b9849fecffff8c1b9e26e2394e0.CountRequestBuilder) {
    return ia9d32de5c946d2e74f7da82a43072da49a3b0b9849fecffff8c1b9e26e2394e0.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
