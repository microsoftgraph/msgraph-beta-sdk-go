...
// MultiValueExtendedPropertiesRequestBuilder builds and executes requests for operations under \me\outlook\taskGroups\{outlookTaskGroup-id}\taskFolders\{outlookTaskFolder-id}\tasks\{outlookTask-id}\multiValueExtendedProperties
...
// CreatePostRequestInformation the collection of multi-value extended properties defined for the task. Read-only. Nullable.
...
// Post the collection of multi-value extended properties defined for the task. Read-only. Nullable.
