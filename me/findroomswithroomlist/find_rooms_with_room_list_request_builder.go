...
func (m *FindRoomsWithRoomListRequestBuilder) CreateGetRequestInformationWithRequestConfiguration()(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *FindRoomsWithRoomListRequestBuilder) GetWithResponseHandler(requestConfiguration *FindRoomsWithRoomListRequestBuilderGetRequestConfiguration)(FindRoomsWithRoomListResponseable, error) {
    return m.GetWithResponseHandler(requestConfiguration, nil);
}
// GetWithResponseHandler invoke function findRooms
func (m *FindRoomsWithRoomListRequestBuilder) GetWithResponseHandler(requestConfiguration *FindRoomsWithRoomListRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(FindRoomsWithRoomListResponseable, error) {
