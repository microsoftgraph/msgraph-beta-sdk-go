...
// FindRoomsWithRoomListRequestBuilderGetQueryParameters invoke function findRooms
type FindRoomsWithRoomListRequestBuilderGetQueryParameters struct {
...
type FindRoomsWithRoomListRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *FindRoomsWithRoomListRequestBuilderGetQueryParameters
}
...
func (m *FindRoomsWithRoomListRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *FindRoomsWithRoomListRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
