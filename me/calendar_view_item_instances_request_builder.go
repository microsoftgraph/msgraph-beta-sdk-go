...
func (m *CalendarViewItemInstancesRequestBuilder) MicrosoftGraphDelta()(*CalendarViewItemInstancesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewCalendarViewItemInstancesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
