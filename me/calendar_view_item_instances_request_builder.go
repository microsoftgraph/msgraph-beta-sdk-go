...
func (m *CalendarViewItemInstancesRequestBuilder) MicrosoftGraphDelta()(*CalendarViewItemInstancesMicrosoftGraphDeltaRequestBuilder) {
    return NewCalendarViewItemInstancesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
