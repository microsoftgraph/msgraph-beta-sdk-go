...
// Attachment_v2ItemRequestBuilderGetQueryParameters get attachments from me
...
func NewAttachment_v2ItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*Attachment_v2ItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/attachments/{attachment_v2%2Did}{?%24select}";
...
func (m *Attachment_v2ItemRequestBuilder) Content()(*i51c400addf6be18b191d2d6466e4cb09241d5cfe1a74d1655dd02032bad89daa.ContentRequestBuilder) {
