...
// NewUsersItemAssignmentsItemSubmissionsItemSubmittedResourcesItemDependentResourcesCountRequestBuilderInternal instantiates a new UsersItemAssignmentsItemSubmissionsItemSubmittedResourcesItemDependentResourcesCountRequestBuilder and sets the default values.
...
// NewUsersItemAssignmentsItemSubmissionsItemSubmittedResourcesItemDependentResourcesCountRequestBuilder instantiates a new UsersItemAssignmentsItemSubmissionsItemSubmittedResourcesItemDependentResourcesCountRequestBuilder and sets the default values.
