...
func (m *MeAssignmentsItemCategoriesRequestBuilder) MicrosoftGraphDelta()(*MeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewMeAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
