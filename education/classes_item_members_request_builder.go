...
// ClassesItemMembersRequestBuilderGetQueryParameters retrieves the teachers and students for a class. Note that if the delegated token is used, members can only be seen by other members of the class.
...
// ByEducationUserIdString gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.education.classes.item.members.item collection
func (m *ClassesItemMembersRequestBuilder) ByEducationUserIdString(educationUserId string)(*ClassesItemMembersEducationUserItemRequestBuilder) {
