...
// ClassesRequestBuilderGetQueryParameters retrieve a list of all class objects.  This API is supported in the following national cloud deployments.
...
// Get retrieve a list of all class objects.  This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve a list of all class objects.  This API is supported in the following national cloud deployments.
