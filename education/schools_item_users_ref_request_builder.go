...
// SchoolsItemUsersRefRequestBuilderGetQueryParameters retrieve a list of users at a school. This API is supported in the following national cloud deployments.
