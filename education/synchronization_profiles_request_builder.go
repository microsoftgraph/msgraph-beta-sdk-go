...
// ByEducationSynchronizationProfileIdString provides operations to manage the synchronizationProfiles property of the microsoft.graph.educationRoot entity.
func (m *SynchronizationProfilesRequestBuilder) ByEducationSynchronizationProfileIdString(educationSynchronizationProfileId string)(*SynchronizationProfilesEducationSynchronizationProfileItemRequestBuilder) {
