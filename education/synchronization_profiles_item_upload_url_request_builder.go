...
func (m *SynchronizationProfilesItemUploadUrlRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SynchronizationProfilesItemUploadUrlRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SynchronizationProfilesItemUploadUrlRequestBuilder) Get(ctx context.Context, requestConfiguration *SynchronizationProfilesItemUploadUrlRequestBuilderGetRequestConfiguration)(SynchronizationProfilesItemUploadUrlResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateSynchronizationProfilesItemUploadUrlResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
