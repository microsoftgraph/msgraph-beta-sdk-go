...
func (m *MeRequestBuilder) AssignmentsById(id string)(*MeAssignmentsEducationAssignmentItemRequestBuilder) {
    ...
    idPtr := &id
    return NewMeAssignmentsEducationAssignmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *MeRequestBuilder) ClassesById(id string)(*MeClassesEducationClassItemRequestBuilder) {
    ...
    idPtr := &id
    return NewMeClassesEducationClassItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *MeRequestBuilder) Get(ctx context.Context, requestConfiguration *MeRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.EducationUserable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateEducationUserFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *MeRequestBuilder) RubricsById(id string)(*MeRubricsEducationRubricItemRequestBuilder) {
    ...
    idPtr := &id
    return NewMeRubricsEducationRubricItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *MeRequestBuilder) SchoolsById(id string)(*MeSchoolsEducationSchoolItemRequestBuilder) {
    ...
    idPtr := &id
    return NewMeSchoolsEducationSchoolItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *MeRequestBuilder) TaughtClassesById(id string)(*MeTaughtClassesEducationClassItemRequestBuilder) {
    ...
    idPtr := &id
    return NewMeTaughtClassesEducationClassItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
