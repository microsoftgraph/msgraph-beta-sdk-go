...
// SchoolsItemClassesRefRequestBuilderGetQueryParameters retrieve a list of classes owned by a school. This API is supported in the following national cloud deployments.
