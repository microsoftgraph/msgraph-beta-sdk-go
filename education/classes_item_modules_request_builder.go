...
// ByEducationModuleIdString provides operations to manage the modules property of the microsoft.graph.educationClass entity.
func (m *ClassesItemModulesRequestBuilder) ByEducationModuleIdString(educationModuleId string)(*ClassesItemModulesEducationModuleItemRequestBuilder) {
