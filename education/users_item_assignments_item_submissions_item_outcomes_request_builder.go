...
func (m *UsersItemAssignmentsItemSubmissionsItemOutcomesRequestBuilder) ByEducationOutcomeIdString(educationOutcomeId string)(*UsersItemAssignmentsItemSubmissionsItemOutcomesEducationOutcomeItemRequestBuilder) {
