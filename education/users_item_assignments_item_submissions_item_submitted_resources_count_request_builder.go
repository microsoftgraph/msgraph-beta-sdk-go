...
func (m *UsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
