...
import (
    ...
    i9bb7824922aba6baf26f718a1eeb73f964a5720234a5e7db29af877def1fb285 "github.com/microsoftgraph/msgraph-beta-sdk-go/education/users/item/assignments/item/resources/count"
)
...
func NewResourcesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ResourcesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/education/users/{educationUser_id}/assignments/{educationAssignment_id}/resources{?top,skip,search,filter,count,orderby,select,expand}";
