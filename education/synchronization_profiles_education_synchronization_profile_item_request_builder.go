...
func (m *SynchronizationProfilesEducationSynchronizationProfileItemRequestBuilder) MicrosoftGraphPause()(*SynchronizationProfilesItemMicrosoftGraphPauseRequestBuilder) {
    return NewSynchronizationProfilesItemMicrosoftGraphPauseRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphReset provides operations to call the reset method.
func (m *SynchronizationProfilesEducationSynchronizationProfileItemRequestBuilder) MicrosoftGraphReset()(*SynchronizationProfilesItemMicrosoftGraphResetRequestBuilder) {
    return NewSynchronizationProfilesItemMicrosoftGraphResetRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphResume provides operations to call the resume method.
func (m *SynchronizationProfilesEducationSynchronizationProfileItemRequestBuilder) MicrosoftGraphResume()(*SynchronizationProfilesItemMicrosoftGraphResumeRequestBuilder) {
    return NewSynchronizationProfilesItemMicrosoftGraphResumeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphStart provides operations to call the start method.
func (m *SynchronizationProfilesEducationSynchronizationProfileItemRequestBuilder) MicrosoftGraphStart()(*SynchronizationProfilesItemMicrosoftGraphStartRequestBuilder) {
    return NewSynchronizationProfilesItemMicrosoftGraphStartRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUploadUrl provides operations to call the uploadUrl method.
func (m *SynchronizationProfilesEducationSynchronizationProfileItemRequestBuilder) MicrosoftGraphUploadUrl()(*SynchronizationProfilesItemMicrosoftGraphUploadUrlRequestBuilder) {
    return NewSynchronizationProfilesItemMicrosoftGraphUploadUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
