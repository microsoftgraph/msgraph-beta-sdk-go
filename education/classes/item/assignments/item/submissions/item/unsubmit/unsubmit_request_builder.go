...
// CreatePostRequestInformationWithRequestConfiguration indicate that a student wants to work on the submitted assignment after it was turned in.  This method changes the status of the submission from `submitted` to `working`. During the submit process, all the resources are copied from **submittedResources** to  **workingResources**. The teacher will be looking at the working resources list for grading. A teacher can also unsubmit a student's assignment on their behalf.
...
func (m *UnsubmitRequestBuilder) Post(ctx context.Context, requestConfiguration *UnsubmitRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.EducationSubmissionable, error) {
