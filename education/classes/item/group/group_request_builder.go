...
func NewGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GroupRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/education/classes/{educationClass_id}/group{?select,expand}";
...
func (m *GroupRequestBuilder) Ref()(*if4a5ff7c1911dd542040b9571db3f86e2691101fb514727cbce955e6532e89dd.RefRequestBuilder) {
    return if4a5ff7c1911dd542040b9571db3f86e2691101fb514727cbce955e6532e89dd.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
