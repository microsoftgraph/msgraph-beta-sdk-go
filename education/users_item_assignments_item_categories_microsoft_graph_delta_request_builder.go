...
func NewUsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder) {
    m := &UsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder{
    }
...
func NewUsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder) {
    ...
    return NewUsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilderInternal(urlParams, requestAdapter)
}
// Get invoke function delta
func (m *UsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *UsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilderGetRequestConfiguration)(UsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateUsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(UsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponseable), nil
}
// ToGetRequestInformation invoke function delta
func (m *UsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UsersItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
