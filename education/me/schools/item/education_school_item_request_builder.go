...
// EducationSchoolItemRequestBuilder provides operations to manage the schools property of the microsoft.graph.educationUser entity.
...
// EducationSchoolItemRequestBuilderGetQueryParameters schools to which the user belongs. Nullable.
