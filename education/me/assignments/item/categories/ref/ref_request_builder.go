...
// RefRequestBuilderGetQueryParameters when set, enables users to easily find assignments of a given type.  Read-only. Nullable.
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property ref to categories for education
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property ref to categories for education
