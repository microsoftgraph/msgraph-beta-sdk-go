...
func NewUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UserRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/education/me/user{?select,expand}";
...
func (m *UserRequestBuilder) Ref()(*id8d6444df86b27c8fa770548bcdfbd50486526229e07b171bf4656ddfd4ee6bc.RefRequestBuilder) {
    return id8d6444df86b27c8fa770548bcdfbd50486526229e07b171bf4656ddfd4ee6bc.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
