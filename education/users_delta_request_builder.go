...
// NewUsersDeltaRequestBuilderInternal instantiates a new UsersDeltaRequestBuilder and sets the default values.
func NewUsersDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UsersDeltaRequestBuilder) {
    m := &UsersDeltaRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/education/users/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewUsersDeltaRequestBuilder instantiates a new UsersDeltaRequestBuilder and sets the default values.
...
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/educationuser-delta?view=graph-rest-beta
...
func (m *UsersDeltaRequestBuilder) WithUrl(rawUrl string)(*UsersDeltaRequestBuilder) {
    return NewUsersDeltaRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
