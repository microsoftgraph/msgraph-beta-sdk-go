...
func NewUsersItemAssignmentsItemMicrosoftGraphPublishRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UsersItemAssignmentsItemMicrosoftGraphPublishRequestBuilder) {
    m := &UsersItemAssignmentsItemMicrosoftGraphPublishRequestBuilder{
    }
...
func NewUsersItemAssignmentsItemMicrosoftGraphPublishRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UsersItemAssignmentsItemMicrosoftGraphPublishRequestBuilder) {
    ...
    return NewUsersItemAssignmentsItemMicrosoftGraphPublishRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *UsersItemAssignmentsItemMicrosoftGraphPublishRequestBuilder) Post(ctx context.Context, requestConfiguration *UsersItemAssignmentsItemMicrosoftGraphPublishRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.EducationAssignmentable, error) {
...
func (m *UsersItemAssignmentsItemMicrosoftGraphPublishRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *UsersItemAssignmentsItemMicrosoftGraphPublishRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
