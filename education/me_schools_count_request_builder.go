...
func NewMeSchoolsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MeSchoolsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/education/me/schools/$count";
...
func (m *MeSchoolsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *MeSchoolsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
