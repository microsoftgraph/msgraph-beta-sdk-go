...
func (m *ClassesItemAssignmentSettingsGradingCategoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ClassesItemAssignmentSettingsGradingCategoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
