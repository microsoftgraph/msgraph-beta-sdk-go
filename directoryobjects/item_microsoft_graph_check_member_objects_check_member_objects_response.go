...
func NewItemMicrosoftGraphCheckMemberObjectsCheckMemberObjectsResponse()(*ItemMicrosoftGraphCheckMemberObjectsCheckMemberObjectsResponse) {
    m := &ItemMicrosoftGraphCheckMemberObjectsCheckMemberObjectsResponse{
...
func CreateItemMicrosoftGraphCheckMemberObjectsCheckMemberObjectsResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemMicrosoftGraphCheckMemberObjectsCheckMemberObjectsResponse(), nil
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemMicrosoftGraphCheckMemberObjectsCheckMemberObjectsResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemMicrosoftGraphCheckMemberObjectsCheckMemberObjectsResponse) GetValue()([]string) {
    return m.value
}
// Serialize serializes information the current object
func (m *ItemMicrosoftGraphCheckMemberObjectsCheckMemberObjectsResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ItemMicrosoftGraphCheckMemberObjectsCheckMemberObjectsResponse) SetValue(value []string)() {
    m.value = value
}
