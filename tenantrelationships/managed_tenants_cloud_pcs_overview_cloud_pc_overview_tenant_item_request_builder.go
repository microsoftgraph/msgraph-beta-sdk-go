...
func NewManagedTenantsCloudPcsOverviewCloudPcOverviewTenantItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedTenantsCloudPcsOverviewCloudPcOverviewTenantItemRequestBuilder) {
    m := &ManagedTenantsCloudPcsOverviewCloudPcOverviewTenantItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/cloudPcsOverview/{cloudPcOverview%2DtenantId}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *ManagedTenantsCloudPcsOverviewCloudPcOverviewTenantItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedTenantsCloudPcsOverviewCloudPcOverviewTenantItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
...
// ToGetRequestInformation overview of cloud PC information across managed tenants.
