...
func (m *TenantsDetailedInformationRequestBuilder) Get(options *TenantsDetailedInformationRequestBuilderGetOptions)(i5c2592132064055aae424492b066923068e6d9a29d4565707b3591c21983fe01.TenantDetailedInformationCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i5c2592132064055aae424492b066923068e6d9a29d4565707b3591c21983fe01.CreateTenantDetailedInformationCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i5c2592132064055aae424492b066923068e6d9a29d4565707b3591c21983fe01.TenantDetailedInformationCollectionResponseable), nil
}
// Post create new navigation property to tenantsDetailedInformation for tenantRelationships
func (m *TenantsDetailedInformationRequestBuilder) Post(options *TenantsDetailedInformationRequestBuilderPostOptions)(i5c2592132064055aae424492b066923068e6d9a29d4565707b3591c21983fe01.TenantDetailedInformationable, error) {
