...
type TenantsDetailedInformationRequestBuilderGetOptions struct {
    ...
    Q *TenantsDetailedInformationRequestBuilderGetQueryParameters;
...
func NewTenantsDetailedInformationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TenantsDetailedInformationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/tenantRelationships/managedTenants/tenantsDetailedInformation{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *TenantsDetailedInformationRequestBuilder) Get(options *TenantsDetailedInformationRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.TenantDetailedInformationCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateTenantDetailedInformationCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.TenantDetailedInformationCollectionResponseable), nil
}
// Post create new navigation property to tenantsDetailedInformation for tenantRelationships
func (m *TenantsDetailedInformationRequestBuilder) Post(options *TenantsDetailedInformationRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.TenantDetailedInformationable, error) {
