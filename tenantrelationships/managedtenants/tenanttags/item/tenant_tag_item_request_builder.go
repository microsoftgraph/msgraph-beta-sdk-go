...
// TenantTagItemRequestBuilder builds and executes requests for operations under \tenantRelationships\managedTenants\tenantTags\{tenantTag-id}
...
// TenantTagItemRequestBuilderDeleteOptions options for Delete
type TenantTagItemRequestBuilderDeleteOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// TenantTagItemRequestBuilderGetOptions options for Get
type TenantTagItemRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
    // Request query parameters
    Q *TenantTagItemRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
// TenantTagItemRequestBuilderPatchOptions options for Patch
type TenantTagItemRequestBuilderPatchOptions struct {
    // 
...
func NewTenantTagItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TenantTagItemRequestBuilder) {
...
func NewTenantTagItemRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TenantTagItemRequestBuilder) {
...
func (m *TenantTagItemRequestBuilder) CreateDeleteRequestInformation(options *TenantTagItemRequestBuilderDeleteOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *TenantTagItemRequestBuilder) CreateGetRequestInformation(options *TenantTagItemRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *TenantTagItemRequestBuilder) CreatePatchRequestInformation(options *TenantTagItemRequestBuilderPatchOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *TenantTagItemRequestBuilder) Delete(options *TenantTagItemRequestBuilderDeleteOptions)(error) {
...
func (m *TenantTagItemRequestBuilder) Get(options *TenantTagItemRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.TenantTag, error) {
...
func (m *TenantTagItemRequestBuilder) Patch(options *TenantTagItemRequestBuilderPatchOptions)(error) {
