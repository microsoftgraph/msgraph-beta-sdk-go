...
func (m *ChangeDeploymentStatusRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body ChangeDeploymentStatusRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreatePostRequestInformationWithRequestConfiguration(body, nil);
}
// CreatePostRequestInformationWithRequestConfiguration invoke action changeDeploymentStatus
func (m *ChangeDeploymentStatusRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body ChangeDeploymentStatusRequestBodyable, requestConfiguration *ChangeDeploymentStatusRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action changeDeploymentStatus
func (m *ChangeDeploymentStatusRequestBuilder) PostWithResponseHandler(body ChangeDeploymentStatusRequestBodyable, requestConfiguration *ChangeDeploymentStatusRequestBuilderPostRequestConfiguration)(i72d786f54cc0bb289c971b085dd642b2fc3af6394328682e69783fd7e229b582.ManagementActionDeploymentStatusable, error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action changeDeploymentStatus
func (m *ChangeDeploymentStatusRequestBuilder) PostWithResponseHandler(body ChangeDeploymentStatusRequestBodyable, requestConfiguration *ChangeDeploymentStatusRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(i72d786f54cc0bb289c971b085dd642b2fc3af6394328682e69783fd7e229b582.ManagementActionDeploymentStatusable, error) {
    requestInfo, err := m.CreatePostRequestInformationWithRequestConfiguration(body, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, i72d786f54cc0bb289c971b085dd642b2fc3af6394328682e69783fd7e229b582.CreateManagementActionDeploymentStatusFromDiscriminatorValue, responseHandler, nil)
    if err != nil {
        return nil, err
    }
