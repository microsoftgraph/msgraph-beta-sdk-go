...
// Builds and executes requests for operations under \tenantRelationships\managedTenants\managementTemplateCollections\{managementTemplateCollection-id}\managementTemplates\$ref
...
// Get ref of managementTemplates from tenantRelationships
...
// Create new navigation property ref to managementTemplates for tenantRelationships
// Parameters:
//  - options : Options for the request
