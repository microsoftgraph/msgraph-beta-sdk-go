...
// RefRequestBuilder builds and executes requests for operations under \tenantRelationships\managedTenants\managementTemplateCollections\{managementTemplateCollection-id}\managementTemplates\$ref
...
// RefRequestBuilderGetQueryParameters get ref of managementTemplates from tenantRelationships
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateCollections/{managementTemplateCollection_id}/managementTemplates/$ref{?top,skip,search,filter,count,orderby}";
...
// CreateGetRequestInformation get ref of managementTemplates from tenantRelationships
...
// CreatePostRequestInformation create new navigation property ref to managementTemplates for tenantRelationships
...
// Get get ref of managementTemplates from tenantRelationships
...
// Post create new navigation property ref to managementTemplates for tenantRelationships
