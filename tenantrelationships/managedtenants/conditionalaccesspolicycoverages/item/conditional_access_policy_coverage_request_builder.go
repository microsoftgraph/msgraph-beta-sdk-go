...
type ConditionalAccessPolicyCoverageRequestBuilderGetOptions struct {
    ...
    Q *ConditionalAccessPolicyCoverageRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
func (m *ConditionalAccessPolicyCoverageRequestBuilder) Get(options *ConditionalAccessPolicyCoverageRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ConditionalAccessPolicyCoverage, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewConditionalAccessPolicyCoverage() }, nil)
    if err != nil {
        return nil, err
    }
