...
// RefRequestBuilder builds and executes requests for operations under \tenantRelationships\managedTenants\managementTemplateSteps\{managementTemplateStep-id}\versions\$ref
...
// RefRequestBuilderGetQueryParameters get ref of versions from tenantRelationships
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateSteps/{managementTemplateStep_id}/versions/$ref{?top,skip,search,filter,count,orderby}";
...
// CreateGetRequestInformation get ref of versions from tenantRelationships
...
// CreatePostRequestInformation create new navigation property ref to versions for tenantRelationships
...
// Get get ref of versions from tenantRelationships
...
// Post create new navigation property ref to versions for tenantRelationships
