...
// RefRequestBuilder builds and executes requests for operations under \tenantRelationships\managedTenants\managementTemplateSteps\{managementTemplateStep-id}\managementTemplate\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateSteps/{managementTemplateStep_id}/managementTemplate/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property managementTemplate for tenantRelationships
...
// CreateGetRequestInformation get ref of managementTemplate from tenantRelationships
...
// CreatePutRequestInformation update the ref of navigation property managementTemplate in tenantRelationships
...
// Delete delete ref of navigation property managementTemplate for tenantRelationships
...
// Get get ref of managementTemplate from tenantRelationships
...
// Put update the ref of navigation property managementTemplate in tenantRelationships
