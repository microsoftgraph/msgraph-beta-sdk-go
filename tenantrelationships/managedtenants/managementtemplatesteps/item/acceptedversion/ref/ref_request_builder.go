...
// RefRequestBuilder builds and executes requests for operations under \tenantRelationships\managedTenants\managementTemplateSteps\{managementTemplateStep-id}\acceptedVersion\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateSteps/{managementTemplateStep_id}/acceptedVersion/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property acceptedVersion for tenantRelationships
...
// CreateGetRequestInformation get ref of acceptedVersion from tenantRelationships
...
// CreatePutRequestInformation update the ref of navigation property acceptedVersion in tenantRelationships
...
// Delete delete ref of navigation property acceptedVersion for tenantRelationships
...
// Get get ref of acceptedVersion from tenantRelationships
...
// Put update the ref of navigation property acceptedVersion in tenantRelationships
