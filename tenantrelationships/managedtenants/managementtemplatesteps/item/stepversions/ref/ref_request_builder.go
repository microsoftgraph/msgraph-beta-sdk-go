...
// Builds and executes requests for operations under \tenantRelationships\managedTenants\managementTemplateSteps\{managementTemplateStep-id}\stepVersions\$ref
...
// Get ref of stepVersions from tenantRelationships
...
// Create new navigation property ref to stepVersions for tenantRelationships
// Parameters:
//  - options : Options for the request
