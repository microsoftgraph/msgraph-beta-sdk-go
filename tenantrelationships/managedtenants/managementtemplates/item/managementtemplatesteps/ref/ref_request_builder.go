...
// RefRequestBuilder builds and executes requests for operations under \tenantRelationships\managedTenants\managementTemplates\{managementTemplate-id}\managementTemplateSteps\$ref
...
// RefRequestBuilderGetQueryParameters get ref of managementTemplateSteps from tenantRelationships
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managementTemplates/{managementTemplate_id}/managementTemplateSteps/$ref{?top,skip,search,filter,count,orderby}";
...
// CreateGetRequestInformation get ref of managementTemplateSteps from tenantRelationships
...
// CreatePostRequestInformation create new navigation property ref to managementTemplateSteps for tenantRelationships
...
// Get get ref of managementTemplateSteps from tenantRelationships
...
// Post create new navigation property ref to managementTemplateSteps for tenantRelationships
