...
// Builds and executes requests for operations under \tenantRelationships\managedTenants\managementTemplates\{managementTemplate-id}\managementTemplateCollections\$ref
...
// Get ref of managementTemplateCollections from tenantRelationships
...
// Create new navigation property ref to managementTemplateCollections for tenantRelationships
// Parameters:
//  - options : Options for the request
