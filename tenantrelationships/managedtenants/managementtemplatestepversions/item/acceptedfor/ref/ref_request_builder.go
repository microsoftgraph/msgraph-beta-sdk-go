...
// RefRequestBuilder builds and executes requests for operations under \tenantRelationships\managedTenants\managementTemplateStepVersions\{managementTemplateStepVersion-id}\acceptedFor\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateStepVersions/{managementTemplateStepVersion_id}/acceptedFor/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property acceptedFor for tenantRelationships
...
// CreateGetRequestInformation get ref of acceptedFor from tenantRelationships
...
// CreatePutRequestInformation update the ref of navigation property acceptedFor in tenantRelationships
...
// Delete delete ref of navigation property acceptedFor for tenantRelationships
...
// Get get ref of acceptedFor from tenantRelationships
...
// Put update the ref of navigation property acceptedFor in tenantRelationships
