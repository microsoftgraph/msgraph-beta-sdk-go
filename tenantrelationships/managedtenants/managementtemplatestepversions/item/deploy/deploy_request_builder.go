...
// Builds and executes requests for operations under \tenantRelationships\managedTenants\managementTemplateStepVersions\{managementTemplateStepVersion-id}\microsoft.graph.managedTenants.deploy
...
// Union type wrapper for classes managementTemplateStepDeployment
...
// Gets the managementTemplateStepDeployment property value. Union type representation for type managementTemplateStepDeployment
...
// Sets the managementTemplateStepDeployment property value. Union type representation for type managementTemplateStepDeployment
// Parameters:
//  - value : Value to set for the managementTemplateStepDeployment property.
...
func NewDeployRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DeployRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateStepVersions/{managementTemplateStepVersion_id}/microsoft.graph.managedTenants.deploy";
...
func (m *DeployRequestBuilder) Post(options *DeployRequestBuilderPostOptions)(*DeployResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewDeployResponse() }, nil)
    if err != nil {
        return nil, err
    }
