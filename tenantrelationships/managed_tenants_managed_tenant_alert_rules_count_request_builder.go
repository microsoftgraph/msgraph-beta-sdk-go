...
func (m *ManagedTenantsManagedTenantAlertRulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedTenantsManagedTenantAlertRulesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
