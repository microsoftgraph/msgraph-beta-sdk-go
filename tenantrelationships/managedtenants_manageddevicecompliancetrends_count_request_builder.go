...
// NewManagedtenantsManageddevicecompliancetrendsCountRequestBuilderInternal instantiates a new ManagedtenantsManageddevicecompliancetrendsCountRequestBuilder and sets the default values.
func NewManagedtenantsManageddevicecompliancetrendsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedtenantsManageddevicecompliancetrendsCountRequestBuilder) {
    m := &ManagedtenantsManageddevicecompliancetrendsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managedDeviceComplianceTrends/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewManagedtenantsManageddevicecompliancetrendsCountRequestBuilder instantiates a new ManagedtenantsManageddevicecompliancetrendsCountRequestBuilder and sets the default values.
...
func (m *ManagedtenantsManageddevicecompliancetrendsCountRequestBuilder) WithUrl(rawUrl string)(*ManagedtenantsManageddevicecompliancetrendsCountRequestBuilder) {
    return NewManagedtenantsManageddevicecompliancetrendsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
