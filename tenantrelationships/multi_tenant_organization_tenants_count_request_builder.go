...
func (m *MultiTenantOrganizationTenantsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MultiTenantOrganizationTenantsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
