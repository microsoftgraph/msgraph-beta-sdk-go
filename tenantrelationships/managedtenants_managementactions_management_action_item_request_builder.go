...
func (m *ManagedtenantsManagementactionsManagementActionItemRequestBuilder) MicrosoftGraphManagedTenantsApply()(*ManagedtenantsManagementactionsItemMicrosoftgraphmanagedtenantsapplyMicrosoftGraphManagedTenantsApplyRequestBuilder) {
    return NewManagedtenantsManagementactionsItemMicrosoftgraphmanagedtenantsapplyMicrosoftGraphManagedTenantsApplyRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
