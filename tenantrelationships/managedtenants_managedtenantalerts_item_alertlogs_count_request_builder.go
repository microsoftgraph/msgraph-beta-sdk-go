...
// NewManagedtenantsManagedtenantalertsItemAlertlogsCountRequestBuilderInternal instantiates a new ManagedtenantsManagedtenantalertsItemAlertlogsCountRequestBuilder and sets the default values.
func NewManagedtenantsManagedtenantalertsItemAlertlogsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedtenantsManagedtenantalertsItemAlertlogsCountRequestBuilder) {
    m := &ManagedtenantsManagedtenantalertsItemAlertlogsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managedTenantAlerts/{managedTenantAlert%2Did}/alertLogs/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewManagedtenantsManagedtenantalertsItemAlertlogsCountRequestBuilder instantiates a new ManagedtenantsManagedtenantalertsItemAlertlogsCountRequestBuilder and sets the default values.
