...
func (m *ManagedTenantsManagedDeviceCompliancesManagedDeviceComplianceItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedTenantsManagedDeviceCompliancesManagedDeviceComplianceItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
