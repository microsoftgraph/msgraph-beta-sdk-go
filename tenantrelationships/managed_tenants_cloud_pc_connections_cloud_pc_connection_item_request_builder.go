...
func (m *ManagedTenantsCloudPcConnectionsCloudPcConnectionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedTenantsCloudPcConnectionsCloudPcConnectionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
