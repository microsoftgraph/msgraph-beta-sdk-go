...
// NewManagedTenantsManagementTemplateStepVersionsItemTemplateStepRequestBuilderInternal instantiates a new ManagedTenantsManagementTemplateStepVersionsItemTemplateStepRequestBuilder and sets the default values.
...
// NewManagedTenantsManagementTemplateStepVersionsItemTemplateStepRequestBuilder instantiates a new ManagedTenantsManagementTemplateStepVersionsItemTemplateStepRequestBuilder and sets the default values.
...
func (m *ManagedTenantsManagementTemplateStepVersionsItemTemplateStepRequestBuilder) WithUrl(rawUrl string)(*ManagedTenantsManagementTemplateStepVersionsItemTemplateStepRequestBuilder) {
    return NewManagedTenantsManagementTemplateStepVersionsItemTemplateStepRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
