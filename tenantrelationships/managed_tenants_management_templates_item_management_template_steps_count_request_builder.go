...
// NewManagedTenantsManagementTemplatesItemManagementTemplateStepsCountRequestBuilderInternal instantiates a new ManagedTenantsManagementTemplatesItemManagementTemplateStepsCountRequestBuilder and sets the default values.
func NewManagedTenantsManagementTemplatesItemManagementTemplateStepsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedTenantsManagementTemplatesItemManagementTemplateStepsCountRequestBuilder) {
    m := &ManagedTenantsManagementTemplatesItemManagementTemplateStepsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managementTemplates/{managementTemplate%2Did}/managementTemplateSteps/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewManagedTenantsManagementTemplatesItemManagementTemplateStepsCountRequestBuilder instantiates a new ManagedTenantsManagementTemplatesItemManagementTemplateStepsCountRequestBuilder and sets the default values.
...
func (m *ManagedTenantsManagementTemplatesItemManagementTemplateStepsCountRequestBuilder) WithUrl(rawUrl string)(*ManagedTenantsManagementTemplatesItemManagementTemplateStepsCountRequestBuilder) {
    return NewManagedTenantsManagementTemplatesItemManagementTemplateStepsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
