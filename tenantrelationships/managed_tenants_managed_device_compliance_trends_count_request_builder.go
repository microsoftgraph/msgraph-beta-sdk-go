...
func (m *ManagedTenantsManagedDeviceComplianceTrendsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedTenantsManagedDeviceComplianceTrendsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
