...
func NewManagedTenantsMyRolesMyRoleTenantItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, myRoleTenantId *string)(*ManagedTenantsMyRolesMyRoleTenantItemRequestBuilder) {
...
func NewManagedTenantsMyRolesMyRoleTenantItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedTenantsMyRolesMyRoleTenantItemRequestBuilder) {
    ...
    return NewManagedTenantsMyRolesMyRoleTenantItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
