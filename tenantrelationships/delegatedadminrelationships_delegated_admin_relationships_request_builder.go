...
func (m *DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder) ByDelegatedAdminRelationshipId(delegatedAdminRelationshipId string)(*DelegatedadminrelationshipsDelegatedAdminRelationshipItemRequestBuilder) {
...
func NewDelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder) {
    m := &DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder{
...
func NewDelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder) {
    ...
    return NewDelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *DelegatedadminrelationshipsCountRequestBuilder when successful
func (m *DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder) Count()(*DelegatedadminrelationshipsCountRequestBuilder) {
...
func (m *DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder) Get(ctx context.Context, requestConfiguration *DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DelegatedAdminRelationshipCollectionResponseable, error) {
...
func (m *DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DelegatedAdminRelationshipable, requestConfiguration *DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DelegatedAdminRelationshipable, error) {
...
func (m *DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DelegatedAdminRelationshipable, requestConfiguration *DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder) WithUrl(rawUrl string)(*DelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder) {
    return NewDelegatedadminrelationshipsDelegatedAdminRelationshipsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
