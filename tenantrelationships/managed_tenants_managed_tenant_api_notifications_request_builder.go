...
// NewManagedTenantsManagedTenantApiNotificationsRequestBuilderInternal instantiates a new ManagedTenantsManagedTenantApiNotificationsRequestBuilder and sets the default values.
...
// NewManagedTenantsManagedTenantApiNotificationsRequestBuilder instantiates a new ManagedTenantsManagedTenantApiNotificationsRequestBuilder and sets the default values.
...
func (m *ManagedTenantsManagedTenantApiNotificationsRequestBuilder) ToPostRequestInformation(ctx context.Context, body i72d786f54cc0bb289c971b085dd642b2fc3af6394328682e69783fd7e229b582.ManagedTenantApiNotificationable, requestConfiguration *ManagedTenantsManagedTenantApiNotificationsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.POST, "{+baseurl}/tenantRelationships/managedTenants/managedTenantApiNotifications", m.BaseRequestBuilder.PathParameters)
    if requestConfiguration != nil {
        requestInfo.Headers.AddAll(requestConfiguration.Headers)
        requestInfo.AddRequestOptions(requestConfiguration.Options)
    }
...
// returns a *ManagedTenantsManagedTenantApiNotificationsRequestBuilder when successful
func (m *ManagedTenantsManagedTenantApiNotificationsRequestBuilder) WithUrl(rawUrl string)(*ManagedTenantsManagedTenantApiNotificationsRequestBuilder) {
    return NewManagedTenantsManagedTenantApiNotificationsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
