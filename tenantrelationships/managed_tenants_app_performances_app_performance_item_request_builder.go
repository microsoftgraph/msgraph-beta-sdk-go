...
func (m *ManagedTenantsAppPerformancesAppPerformanceItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedTenantsAppPerformancesAppPerformanceItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
