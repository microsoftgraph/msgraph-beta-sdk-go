...
func NewManagedTenantsTenantGroupsTenantGroupItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, tenantGroupId *string)(*ManagedTenantsTenantGroupsTenantGroupItemRequestBuilder) {
...
func NewManagedTenantsTenantGroupsTenantGroupItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedTenantsTenantGroupsTenantGroupItemRequestBuilder) {
    ...
    return NewManagedTenantsTenantGroupsTenantGroupItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
