...
// ManagedTenantsTenantsRequestBuilderGetQueryParameters get a list of the tenant objects and their properties. This API is supported in the following national cloud deployments.
...
// NewManagedTenantsTenantsRequestBuilderInternal instantiates a new TenantsRequestBuilder and sets the default values.
func NewManagedTenantsTenantsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedTenantsTenantsRequestBuilder) {
    m := &ManagedTenantsTenantsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/tenants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewManagedTenantsTenantsRequestBuilder instantiates a new TenantsRequestBuilder and sets the default values.
...
// Get get a list of the tenant objects and their properties. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get a list of the tenant objects and their properties. This API is supported in the following national cloud deployments.
