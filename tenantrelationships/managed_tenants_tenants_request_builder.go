...
// ByTenantIdString provides operations to manage the tenants property of the microsoft.graph.managedTenants.managedTenant entity.
func (m *ManagedTenantsTenantsRequestBuilder) ByTenantIdString(tenantId string)(*ManagedTenantsTenantsTenantItemRequestBuilder) {
