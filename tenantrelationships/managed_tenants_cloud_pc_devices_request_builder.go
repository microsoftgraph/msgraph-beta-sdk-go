...
// ByCloudPcDeviceIdString provides operations to manage the cloudPcDevices property of the microsoft.graph.managedTenants.managedTenant entity.
func (m *ManagedTenantsCloudPcDevicesRequestBuilder) ByCloudPcDeviceIdString(cloudPcDeviceId string)(*ManagedTenantsCloudPcDevicesCloudPcDeviceItemRequestBuilder) {
