...
func (m *ManagedTenantsManagedTenantAlertsRequestBuilder) Count()(*ManagedTenantsManagedTenantAlertsCountRequestBuilder) {
    return NewManagedTenantsManagedTenantAlertsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get managedTenantAlerts from tenantRelationships
func (m *ManagedTenantsManagedTenantAlertsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ManagedTenantsManagedTenantAlertsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
