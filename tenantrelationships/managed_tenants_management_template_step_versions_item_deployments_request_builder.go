...
func (m *ManagedTenantsManagementTemplateStepVersionsItemDeploymentsRequestBuilder) Count()(*ManagedTenantsManagementTemplateStepVersionsItemDeploymentsCountRequestBuilder) {
    return NewManagedTenantsManagementTemplateStepVersionsItemDeploymentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get deployments from tenantRelationships
func (m *ManagedTenantsManagementTemplateStepVersionsItemDeploymentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ManagedTenantsManagementTemplateStepVersionsItemDeploymentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
