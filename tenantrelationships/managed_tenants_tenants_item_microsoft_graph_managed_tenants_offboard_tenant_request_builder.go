...
// NewManagedTenantsTenantsItemMicrosoftGraphManagedTenantsOffboardTenantRequestBuilderInternal instantiates a new ManagedTenantsTenantsItemMicrosoftGraphManagedTenantsOffboardTenantRequestBuilder and sets the default values.
...
// NewManagedTenantsTenantsItemMicrosoftGraphManagedTenantsOffboardTenantRequestBuilder instantiates a new ManagedTenantsTenantsItemMicrosoftGraphManagedTenantsOffboardTenantRequestBuilder and sets the default values.
...
// Post carries out the appropriate procedures to remove a managed tenant from the multitenant management platform. No relationships, such as commerce and delegate administrative privileges, will be impacted. The only change made by invoking this action is the tenant will be deprovisioned from the multitenant management platform.
...
// ToPostRequestInformation carries out the appropriate procedures to remove a managed tenant from the multitenant management platform. No relationships, such as commerce and delegate administrative privileges, will be impacted. The only change made by invoking this action is the tenant will be deprovisioned from the multitenant management platform.
...
func (m *ManagedTenantsTenantsItemMicrosoftGraphManagedTenantsOffboardTenantRequestBuilder) WithUrl(rawUrl string)(*ManagedTenantsTenantsItemMicrosoftGraphManagedTenantsOffboardTenantRequestBuilder) {
    return NewManagedTenantsTenantsItemMicrosoftGraphManagedTenantsOffboardTenantRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
