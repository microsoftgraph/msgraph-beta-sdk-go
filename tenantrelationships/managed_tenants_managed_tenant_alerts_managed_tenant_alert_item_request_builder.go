...
func (m *ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
...
// ManagedTenantsAddUserInputLog provides operations to call the addUserInputLog method.
func (m *ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilder) ManagedTenantsAddUserInputLog()(*ManagedTenantsManagedTenantAlertsItemManagedTenantsAddUserInputLogRequestBuilder) {
    return NewManagedTenantsManagedTenantAlertsItemManagedTenantsAddUserInputLogRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
