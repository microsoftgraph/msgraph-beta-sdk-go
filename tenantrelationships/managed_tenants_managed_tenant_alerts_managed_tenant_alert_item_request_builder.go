...
func (m *ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilder) AlertLogsById(id string)(*ManagedTenantsManagedTenantAlertsItemAlertLogsManagedTenantAlertLogItemRequestBuilder) {
    ...
    idPtr := &id
    return NewManagedTenantsManagedTenantAlertsItemAlertLogsManagedTenantAlertLogItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilder) ApiNotificationsById(id string)(*ManagedTenantsManagedTenantAlertsItemApiNotificationsManagedTenantApiNotificationItemRequestBuilder) {
    ...
    idPtr := &id
    return NewManagedTenantsManagedTenantAlertsItemApiNotificationsManagedTenantApiNotificationItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, managedTenantAlertId *string)(*ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilder) {
...
func NewManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilder) {
    ...
    return NewManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilder) EmailNotificationsById(id string)(*ManagedTenantsManagedTenantAlertsItemEmailNotificationsManagedTenantEmailNotificationItemRequestBuilder) {
    ...
    idPtr := &id
    return NewManagedTenantsManagedTenantAlertsItemEmailNotificationsManagedTenantEmailNotificationItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilder) MicrosoftGraphManagedTenantsAddUserInputLog()(*ManagedTenantsManagedTenantAlertsItemMicrosoftGraphManagedTenantsAddUserInputLogAddUserInputLogRequestBuilder) {
    return NewManagedTenantsManagedTenantAlertsItemMicrosoftGraphManagedTenantsAddUserInputLogAddUserInputLogRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
