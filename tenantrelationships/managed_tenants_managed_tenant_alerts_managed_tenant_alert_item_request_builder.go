...
func (m *ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilder) AddUserInputLog()(*ManagedTenantsManagedTenantAlertsItemAddUserInputLogRequestBuilder) {
    return NewManagedTenantsManagedTenantAlertsItemAddUserInputLogRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *ManagedTenantsManagedTenantAlertsManagedTenantAlertItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
