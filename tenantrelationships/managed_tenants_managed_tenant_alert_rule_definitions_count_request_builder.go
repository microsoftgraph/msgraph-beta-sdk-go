...
func (m *ManagedTenantsManagedTenantAlertRuleDefinitionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedTenantsManagedTenantAlertRuleDefinitionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
