...
// NewManagedtenantsManagementtemplatestepsItemVersionsCountRequestBuilderInternal instantiates a new ManagedtenantsManagementtemplatestepsItemVersionsCountRequestBuilder and sets the default values.
func NewManagedtenantsManagementtemplatestepsItemVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedtenantsManagementtemplatestepsItemVersionsCountRequestBuilder) {
    m := &ManagedtenantsManagementtemplatestepsItemVersionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managementTemplateSteps/{managementTemplateStep%2Did}/versions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewManagedtenantsManagementtemplatestepsItemVersionsCountRequestBuilder instantiates a new ManagedtenantsManagementtemplatestepsItemVersionsCountRequestBuilder and sets the default values.
...
func (m *ManagedtenantsManagementtemplatestepsItemVersionsCountRequestBuilder) WithUrl(rawUrl string)(*ManagedtenantsManagementtemplatestepsItemVersionsCountRequestBuilder) {
    return NewManagedtenantsManagementtemplatestepsItemVersionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
