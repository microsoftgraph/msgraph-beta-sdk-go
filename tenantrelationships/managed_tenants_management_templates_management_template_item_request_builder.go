...
func (m *ManagedTenantsManagementTemplatesManagementTemplateItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedTenantsManagementTemplatesManagementTemplateItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
