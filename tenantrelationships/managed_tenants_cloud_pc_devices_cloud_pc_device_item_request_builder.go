...
func (m *ManagedTenantsCloudPcDevicesCloudPcDeviceItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedTenantsCloudPcDevicesCloudPcDeviceItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
