...
func (m *ManagedtenantsManagementtemplatestepsManagementTemplateStepItemRequestBuilder) AcceptedVersion()(*ManagedtenantsManagementtemplatestepsItemAcceptedversionAcceptedVersionRequestBuilder) {
    return NewManagedtenantsManagementtemplatestepsItemAcceptedversionAcceptedVersionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ManagedtenantsManagementtemplatestepsManagementTemplateStepItemRequestBuilder) ManagementTemplate()(*ManagedtenantsManagementtemplatestepsItemManagementtemplateManagementTemplateRequestBuilder) {
    return NewManagedtenantsManagementtemplatestepsItemManagementtemplateManagementTemplateRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
