...
func (m *ManagedTenantsManagedTenantAlertRulesItemAlertsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedTenantsManagedTenantAlertRulesItemAlertsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
