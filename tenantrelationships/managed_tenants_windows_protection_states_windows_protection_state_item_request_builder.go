...
// ManagedTenantsWindowsProtectionStatesWindowsProtectionStateItemRequestBuilderGetQueryParameters read the properties and relationships of a windowsProtectionState object. This API is supported in the following national cloud deployments.
...
func NewManagedTenantsWindowsProtectionStatesWindowsProtectionStateItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedTenantsWindowsProtectionStatesWindowsProtectionStateItemRequestBuilder) {
    m := &ManagedTenantsWindowsProtectionStatesWindowsProtectionStateItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/windowsProtectionStates/{windowsProtectionState%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get read the properties and relationships of a windowsProtectionState object. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation read the properties and relationships of a windowsProtectionState object. This API is supported in the following national cloud deployments.
