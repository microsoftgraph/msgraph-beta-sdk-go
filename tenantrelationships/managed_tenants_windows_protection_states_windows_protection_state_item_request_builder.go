...
func (m *ManagedTenantsWindowsProtectionStatesWindowsProtectionStateItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedTenantsWindowsProtectionStatesWindowsProtectionStateItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
