...
func (m *ManagedTenantsManagedTenantEmailNotificationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedTenantsManagedTenantEmailNotificationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
