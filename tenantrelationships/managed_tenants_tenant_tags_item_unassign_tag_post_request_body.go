...
// ManagedTenantsTenantTagsItemUnassignTagPostRequestBody 
...
func (m *ManagedTenantsTenantTagsItemUnassignTagPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ManagedTenantsTenantTagsItemUnassignTagPostRequestBody) SetAdditionalData(value map[string]any)() {
