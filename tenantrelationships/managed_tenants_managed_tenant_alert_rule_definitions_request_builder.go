...
// ByManagedTenantAlertRuleDefinitionIdString provides operations to manage the managedTenantAlertRuleDefinitions property of the microsoft.graph.managedTenants.managedTenant entity.
func (m *ManagedTenantsManagedTenantAlertRuleDefinitionsRequestBuilder) ByManagedTenantAlertRuleDefinitionIdString(managedTenantAlertRuleDefinitionId string)(*ManagedTenantsManagedTenantAlertRuleDefinitionsManagedTenantAlertRuleDefinitionItemRequestBuilder) {
