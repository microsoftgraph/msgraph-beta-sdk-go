...
func (m *ManagedTenantsManagedTenantTicketingEndpointsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedTenantsManagedTenantTicketingEndpointsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
