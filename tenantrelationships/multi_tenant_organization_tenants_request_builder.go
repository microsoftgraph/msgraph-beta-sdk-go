...
// ByMultiTenantOrganizationMemberIdString provides operations to manage the tenants property of the microsoft.graph.multiTenantOrganization entity.
func (m *MultiTenantOrganizationTenantsRequestBuilder) ByMultiTenantOrganizationMemberIdString(multiTenantOrganizationMemberId string)(*MultiTenantOrganizationTenantsMultiTenantOrganizationMemberItemRequestBuilder) {
