...
// NewManagedtenantsManagedtenantalertrulesItemAlertsCountRequestBuilderInternal instantiates a new ManagedtenantsManagedtenantalertrulesItemAlertsCountRequestBuilder and sets the default values.
func NewManagedtenantsManagedtenantalertrulesItemAlertsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedtenantsManagedtenantalertrulesItemAlertsCountRequestBuilder) {
    m := &ManagedtenantsManagedtenantalertrulesItemAlertsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managedTenantAlertRules/{managedTenantAlertRule%2Did}/alerts/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewManagedtenantsManagedtenantalertrulesItemAlertsCountRequestBuilder instantiates a new ManagedtenantsManagedtenantalertrulesItemAlertsCountRequestBuilder and sets the default values.
