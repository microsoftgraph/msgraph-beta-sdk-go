...
func (m *ManagedTenantsDeviceAppPerformancesDeviceAppPerformanceItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedTenantsDeviceAppPerformancesDeviceAppPerformanceItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
