...
func (m *DelegatedadmincustomersDelegatedAdminCustomersRequestBuilder) ByDelegatedAdminCustomerId(delegatedAdminCustomerId string)(*DelegatedadmincustomersDelegatedAdminCustomerItemRequestBuilder) {
...
func NewDelegatedadmincustomersDelegatedAdminCustomersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DelegatedadmincustomersDelegatedAdminCustomersRequestBuilder) {
    m := &DelegatedadmincustomersDelegatedAdminCustomersRequestBuilder{
...
func NewDelegatedadmincustomersDelegatedAdminCustomersRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DelegatedadmincustomersDelegatedAdminCustomersRequestBuilder) {
    ...
    return NewDelegatedadmincustomersDelegatedAdminCustomersRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *DelegatedadmincustomersCountRequestBuilder when successful
func (m *DelegatedadmincustomersDelegatedAdminCustomersRequestBuilder) Count()(*DelegatedadmincustomersCountRequestBuilder) {
...
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/tenantrelationship-list-delegatedadmincustomers?view=graph-rest-beta
func (m *DelegatedadmincustomersDelegatedAdminCustomersRequestBuilder) Get(ctx context.Context, requestConfiguration *DelegatedadmincustomersDelegatedAdminCustomersRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DelegatedAdminCustomerCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDelegatedAdminCustomerCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *DelegatedadmincustomersDelegatedAdminCustomersRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DelegatedAdminCustomerable, requestConfiguration *DelegatedadmincustomersDelegatedAdminCustomersRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DelegatedAdminCustomerable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDelegatedAdminCustomerFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *DelegatedadmincustomersDelegatedAdminCustomersRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DelegatedadmincustomersDelegatedAdminCustomersRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *DelegatedadmincustomersDelegatedAdminCustomersRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DelegatedAdminCustomerable, requestConfiguration *DelegatedadmincustomersDelegatedAdminCustomersRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DelegatedadmincustomersDelegatedAdminCustomersRequestBuilder) WithUrl(rawUrl string)(*DelegatedadmincustomersDelegatedAdminCustomersRequestBuilder) {
    return NewDelegatedadmincustomersDelegatedAdminCustomersRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
