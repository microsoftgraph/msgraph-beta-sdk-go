...
// NewManagedTenantsManagementTemplateCollectionsItemManagementTemplatesRequestBuilderInternal instantiates a new ManagedTenantsManagementTemplateCollectionsItemManagementTemplatesRequestBuilder and sets the default values.
...
// NewManagedTenantsManagementTemplateCollectionsItemManagementTemplatesRequestBuilder instantiates a new ManagedTenantsManagementTemplateCollectionsItemManagementTemplatesRequestBuilder and sets the default values.
...
// returns a *ManagedTenantsManagementTemplateCollectionsItemManagementTemplatesRequestBuilder when successful
func (m *ManagedTenantsManagementTemplateCollectionsItemManagementTemplatesRequestBuilder) WithUrl(rawUrl string)(*ManagedTenantsManagementTemplateCollectionsItemManagementTemplatesRequestBuilder) {
    return NewManagedTenantsManagementTemplateCollectionsItemManagementTemplatesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
