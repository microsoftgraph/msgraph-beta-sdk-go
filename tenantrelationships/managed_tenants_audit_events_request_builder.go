...
// ByAuditEventIdString provides operations to manage the auditEvents property of the microsoft.graph.managedTenants.managedTenant entity.
func (m *ManagedTenantsAuditEventsRequestBuilder) ByAuditEventIdString(auditEventId string)(*ManagedTenantsAuditEventsAuditEventItemRequestBuilder) {
