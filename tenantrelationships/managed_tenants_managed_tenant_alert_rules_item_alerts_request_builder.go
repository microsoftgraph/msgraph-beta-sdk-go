...
// ByManagedTenantAlertIdString provides operations to manage the alerts property of the microsoft.graph.managedTenants.managedTenantAlertRule entity.
func (m *ManagedTenantsManagedTenantAlertRulesItemAlertsRequestBuilder) ByManagedTenantAlertIdString(managedTenantAlertId string)(*ManagedTenantsManagedTenantAlertRulesItemAlertsManagedTenantAlertItemRequestBuilder) {
...
// NewManagedTenantsManagedTenantAlertRulesItemAlertsRequestBuilderInternal instantiates a new AlertsRequestBuilder and sets the default values.
func NewManagedTenantsManagedTenantAlertRulesItemAlertsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedTenantsManagedTenantAlertRulesItemAlertsRequestBuilder) {
    m := &ManagedTenantsManagedTenantAlertRulesItemAlertsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/managedTenantAlertRules/{managedTenantAlertRule%2Did}/alerts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewManagedTenantsManagedTenantAlertRulesItemAlertsRequestBuilder instantiates a new AlertsRequestBuilder and sets the default values.
