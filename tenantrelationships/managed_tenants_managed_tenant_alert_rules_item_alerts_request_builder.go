...
func (m *ManagedTenantsManagedTenantAlertRulesItemAlertsRequestBuilder) Count()(*ManagedTenantsManagedTenantAlertRulesItemAlertsCountRequestBuilder) {
    return NewManagedTenantsManagedTenantAlertRulesItemAlertsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get alerts from tenantRelationships
func (m *ManagedTenantsManagedTenantAlertRulesItemAlertsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ManagedTenantsManagedTenantAlertRulesItemAlertsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
