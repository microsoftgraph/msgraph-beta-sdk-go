...
func (m *ManagedTenantsManagementTemplatesRequestBuilder) Count()(*ManagedTenantsManagementTemplatesCountRequestBuilder) {
    return NewManagedTenantsManagementTemplatesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of the managementTemplate objects and their properties.
func (m *ManagedTenantsManagementTemplatesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ManagedTenantsManagementTemplatesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
