...
func (m *TenantRelationshipsRequestBuilder) MicrosoftGraphFindTenantInformationByDomainNameWithDomainName(domainName *string)(*MicrosoftGraphFindTenantInformationByDomainNameWithDomainNameRequestBuilder) {
    return NewMicrosoftGraphFindTenantInformationByDomainNameWithDomainNameRequestBuilderInternal(m.pathParameters, m.requestAdapter, domainName)
}
...
func (m *TenantRelationshipsRequestBuilder) MicrosoftGraphFindTenantInformationByTenantIdWithTenantId(tenantId *string)(*MicrosoftGraphFindTenantInformationByTenantIdWithTenantIdRequestBuilder) {
    return NewMicrosoftGraphFindTenantInformationByTenantIdWithTenantIdRequestBuilderInternal(m.pathParameters, m.requestAdapter, tenantId)
}
