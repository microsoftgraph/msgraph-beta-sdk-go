...
// ByManagementTemplateStepVersionIdString provides operations to manage the managementTemplateStepVersions property of the microsoft.graph.managedTenants.managedTenant entity.
func (m *ManagedTenantsManagementTemplateStepVersionsRequestBuilder) ByManagementTemplateStepVersionIdString(managementTemplateStepVersionId string)(*ManagedTenantsManagementTemplateStepVersionsManagementTemplateStepVersionItemRequestBuilder) {
