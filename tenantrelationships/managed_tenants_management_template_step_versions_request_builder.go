...
func (m *ManagedTenantsManagementTemplateStepVersionsRequestBuilder) Count()(*ManagedTenantsManagementTemplateStepVersionsCountRequestBuilder) {
    return NewManagedTenantsManagementTemplateStepVersionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get managementTemplateStepVersions from tenantRelationships
func (m *ManagedTenantsManagementTemplateStepVersionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ManagedTenantsManagementTemplateStepVersionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
