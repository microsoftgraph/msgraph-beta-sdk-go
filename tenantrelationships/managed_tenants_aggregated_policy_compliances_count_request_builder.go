...
func (m *ManagedTenantsAggregatedPolicyCompliancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedTenantsAggregatedPolicyCompliancesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
