...
// NewManagedTenantsAggregatedPolicyCompliancesCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewManagedTenantsAggregatedPolicyCompliancesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedTenantsAggregatedPolicyCompliancesCountRequestBuilder) {
    m := &ManagedTenantsAggregatedPolicyCompliancesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tenantRelationships/managedTenants/aggregatedPolicyCompliances/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewManagedTenantsAggregatedPolicyCompliancesCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
