...
func (m *ManagedTenantsManagementIntentsManagementIntentItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedTenantsManagementIntentsManagementIntentItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
