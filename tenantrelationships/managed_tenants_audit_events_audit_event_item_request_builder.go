...
func (m *ManagedTenantsAuditEventsAuditEventItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedTenantsAuditEventsAuditEventItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
