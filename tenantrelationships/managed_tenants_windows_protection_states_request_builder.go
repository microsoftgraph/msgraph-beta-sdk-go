...
// ByWindowsProtectionStateIdString provides operations to manage the windowsProtectionStates property of the microsoft.graph.managedTenants.managedTenant entity.
func (m *ManagedTenantsWindowsProtectionStatesRequestBuilder) ByWindowsProtectionStateIdString(windowsProtectionStateId string)(*ManagedTenantsWindowsProtectionStatesWindowsProtectionStateItemRequestBuilder) {
