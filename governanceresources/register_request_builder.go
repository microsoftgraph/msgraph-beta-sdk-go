...
func NewRegisterRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RegisterRequestBuilder) {
    m := &RegisterRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/governanceResources/register", pathParameters),
    }
    return m
}
...
func (m *RegisterRequestBuilder) ToPostRequestInformation(ctx context.Context, body RegisterPostRequestBodyable, requestConfiguration *RegisterRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RegisterRequestBuilder) WithUrl(rawUrl string)(*RegisterRequestBuilder) {
    return NewRegisterRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
