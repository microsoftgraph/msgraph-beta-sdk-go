...
func (m *ItemRoleAssignmentsRequestBuilder) MicrosoftGraphExport()(*ItemRoleAssignmentsMicrosoftGraphExportExportRequestBuilder) {
    return NewItemRoleAssignmentsMicrosoftGraphExportExportRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
