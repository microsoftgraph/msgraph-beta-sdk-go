...
func (m *ItemRoleAssignmentsRequestBuilder) MicrosoftGraphExport()(*ItemRoleAssignmentsMicrosoftGraphExportRequestBuilder) {
    return NewItemRoleAssignmentsMicrosoftGraphExportRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
