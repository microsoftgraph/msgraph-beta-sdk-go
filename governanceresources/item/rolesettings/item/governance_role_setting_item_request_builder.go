...
// DeleteWithResponseHandler delete navigation property roleSettings for governanceResources
...
// PatchWithResponseHandler update the navigation property roleSettings in governanceResources
