...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property roleDefinition for governanceResources
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property roleDefinition in governanceResources
