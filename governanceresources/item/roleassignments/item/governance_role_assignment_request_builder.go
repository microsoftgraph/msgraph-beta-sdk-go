...
// GovernanceRoleAssignmentRequestBuilder builds and executes requests for operations under \governanceResources\{governanceResource-id}\roleAssignments\{governanceRoleAssignment-id}
...
// GovernanceRoleAssignmentRequestBuilderGetQueryParameters the collection of role assignments for the resource.
