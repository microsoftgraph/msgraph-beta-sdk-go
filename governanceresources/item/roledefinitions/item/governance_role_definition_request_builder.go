...
// GovernanceRoleDefinitionRequestBuilder builds and executes requests for operations under \governanceResources\{governanceResource-id}\roleDefinitions\{governanceRoleDefinition-id}
...
// GovernanceRoleDefinitionRequestBuilderGetQueryParameters the collection of role defintions for the resource.
