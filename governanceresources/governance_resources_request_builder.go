...
func (m *GovernanceResourcesRequestBuilder) MicrosoftGraphRegister()(*MicrosoftGraphRegisterRequestBuilder) {
    return NewMicrosoftGraphRegisterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
