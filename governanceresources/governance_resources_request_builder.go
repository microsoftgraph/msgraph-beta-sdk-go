...
func (m *GovernanceResourcesRequestBuilder) MicrosoftGraphRegister()(*MicrosoftGraphRegisterRegisterRequestBuilder) {
    return NewMicrosoftGraphRegisterRegisterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
