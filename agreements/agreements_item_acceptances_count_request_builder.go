...
func NewAgreementsItemAcceptancesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AgreementsItemAcceptancesCountRequestBuilder) {
    m := &AgreementsItemAcceptancesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/agreements/{agreement%2Did}/acceptances/$count";
...
func NewAgreementsItemAcceptancesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AgreementsItemAcceptancesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewAgreementsItemAcceptancesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *AgreementsItemAcceptancesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *AgreementsItemAcceptancesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AgreementsItemAcceptancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AgreementsItemAcceptancesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
