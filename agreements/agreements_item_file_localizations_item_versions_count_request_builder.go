...
func NewAgreementsItemFileLocalizationsItemVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AgreementsItemFileLocalizationsItemVersionsCountRequestBuilder) {
    m := &AgreementsItemFileLocalizationsItemVersionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/agreements/{agreement%2Did}/file/localizations/{agreementFileLocalization%2Did}/versions/$count";
...
func NewAgreementsItemFileLocalizationsItemVersionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AgreementsItemFileLocalizationsItemVersionsCountRequestBuilder) {
    ...
    return NewAgreementsItemFileLocalizationsItemVersionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *AgreementsItemFileLocalizationsItemVersionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *AgreementsItemFileLocalizationsItemVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AgreementsItemFileLocalizationsItemVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AgreementsItemFileLocalizationsItemVersionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
