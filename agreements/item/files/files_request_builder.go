...
type FilesRequestBuilderGetOptions struct {
    ...
    Q *FilesRequestBuilderGetQueryParameters;
...
func NewFilesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FilesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/agreements/{agreement_id}/files{?top,skip,search,filter,count,orderby,select,expand}";
...
// CreatePostRequestInformation pDFs linked to this agreement. Note: This property is in the process of being deprecated. Use the  file property instead.
...
func (m *FilesRequestBuilder) Get(options *FilesRequestBuilderGetOptions)(*FilesResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewFilesResponse() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*FilesResponse), nil
}
// Post pDFs linked to this agreement. Note: This property is in the process of being deprecated. Use the  file property instead.
func (m *FilesRequestBuilder) Post(options *FilesRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AgreementFileLocalization, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewAgreementFileLocalization() }, nil)
    if err != nil {
        return nil, err
    }
