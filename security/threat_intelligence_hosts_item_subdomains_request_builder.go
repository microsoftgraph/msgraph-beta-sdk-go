...
// ThreatIntelligenceHostsItemSubdomainsRequestBuilderGetQueryParameters get the list of subdomain resources associated with a host. This API is supported in the following national cloud deployments.
...
// Get get the list of subdomain resources associated with a host. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get the list of subdomain resources associated with a host. This API is supported in the following national cloud deployments.
