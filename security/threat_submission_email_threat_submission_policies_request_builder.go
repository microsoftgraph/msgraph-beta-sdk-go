...
// ByEmailThreatSubmissionPolicyIdString provides operations to manage the emailThreatSubmissionPolicies property of the microsoft.graph.security.threatSubmissionRoot entity.
func (m *ThreatSubmissionEmailThreatSubmissionPoliciesRequestBuilder) ByEmailThreatSubmissionPolicyIdString(emailThreatSubmissionPolicyId string)(*ThreatSubmissionEmailThreatSubmissionPoliciesEmailThreatSubmissionPolicyItemRequestBuilder) {
