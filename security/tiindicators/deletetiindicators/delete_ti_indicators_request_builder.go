...
// CreatePostRequestInformation delete multiple threat intelligence (TI) indicators in one request instead of multiple requests.
func (m *DeleteTiIndicatorsRequestBuilder) CreatePostRequestInformation(ctx context.Context, body DeleteTiIndicatorsPostRequestBodyable, requestConfiguration *DeleteTiIndicatorsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DeleteTiIndicatorsRequestBuilder) Post(ctx context.Context, body DeleteTiIndicatorsPostRequestBodyable, requestConfiguration *DeleteTiIndicatorsRequestBuilderPostRequestConfiguration)(DeleteTiIndicatorsResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateDeleteTiIndicatorsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
