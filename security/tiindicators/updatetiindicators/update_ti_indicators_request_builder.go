...
func (m *UpdateTiIndicatorsRequestBuilder) CreatePostRequestInformation(ctx context.Context, body UpdateTiIndicatorsPostRequestBodyable, requestConfiguration *UpdateTiIndicatorsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UpdateTiIndicatorsRequestBuilder) Post(ctx context.Context, body UpdateTiIndicatorsPostRequestBodyable, requestConfiguration *UpdateTiIndicatorsRequestBuilderPostRequestConfiguration)(UpdateTiIndicatorsResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateUpdateTiIndicatorsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
