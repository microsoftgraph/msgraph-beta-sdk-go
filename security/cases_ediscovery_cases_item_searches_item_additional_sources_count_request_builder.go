...
func (m *CasesEdiscoveryCasesItemSearchesItemAdditionalSourcesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemSearchesItemAdditionalSourcesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
