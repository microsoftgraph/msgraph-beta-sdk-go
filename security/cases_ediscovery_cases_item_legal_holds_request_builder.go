...
func (m *CasesEdiscoveryCasesItemLegalHoldsRequestBuilder) Count()(*CasesEdiscoveryCasesItemLegalHoldsCountRequestBuilder) {
    return NewCasesEdiscoveryCasesItemLegalHoldsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of the ediscoveryHoldPolicy objects and their properties.
func (m *CasesEdiscoveryCasesItemLegalHoldsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemLegalHoldsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
