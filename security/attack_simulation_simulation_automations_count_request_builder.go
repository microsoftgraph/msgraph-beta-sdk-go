...
func (m *AttackSimulationSimulationAutomationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttackSimulationSimulationAutomationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
