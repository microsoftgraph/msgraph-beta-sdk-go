...
// ThreatSubmissionEmailThreatsEmailThreatSubmissionItemRequestBuilderGetQueryParameters read the properties and relationships of an emailThreatSubmission object. This API is supported in the following national cloud deployments.
...
// Get read the properties and relationships of an emailThreatSubmission object. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation read the properties and relationships of an emailThreatSubmission object. This API is supported in the following national cloud deployments.
