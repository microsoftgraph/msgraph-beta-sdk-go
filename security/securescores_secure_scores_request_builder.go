...
// SecurescoresSecureScoresRequestBuilderGetQueryParameters retrieve the properties and relationships of a secureScores object.
...
func (m *SecurescoresSecureScoresRequestBuilder) Get(ctx context.Context, requestConfiguration *SecurescoresSecureScoresRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SecureScoreCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateSecureScoreCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *SecurescoresSecureScoresRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SecureScoreable, requestConfiguration *SecurescoresSecureScoresRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SecureScoreable, error) {
