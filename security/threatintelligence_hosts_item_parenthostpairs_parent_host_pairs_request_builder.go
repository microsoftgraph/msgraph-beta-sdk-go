...
// ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilderGetQueryParameters get the list of hostPair resources associated with a specified host, where that host is the *child* and has an incoming pairing with a *parent*.
...
// Get get the list of hostPair resources associated with a specified host, where that host is the *child* and has an incoming pairing with a *parent*.
...
func (m *ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatintelligenceHostsItemParenthostpairsParentHostPairsRequestBuilderGetRequestConfiguration)(i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.HostPairCollectionResponseable, error) {
...
// ToGetRequestInformation get the list of hostPair resources associated with a specified host, where that host is the *child* and has an incoming pairing with a *parent*.
