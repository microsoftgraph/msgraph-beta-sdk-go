...
func (m *ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder) ByPassiveDnsRecordId(passiveDnsRecordId string)(*ThreatintelligencePassivednsrecordsPassiveDnsRecordItemRequestBuilder) {
...
func NewThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder) {
    m := &ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder{
...
func NewThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder) {
    ...
    return NewThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ThreatintelligencePassivednsrecordsCountRequestBuilder when successful
func (m *ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder) Count()(*ThreatintelligencePassivednsrecordsCountRequestBuilder) {
...
func (m *ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilderGetRequestConfiguration)(i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.PassiveDnsRecordCollectionResponseable, error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder) Post(ctx context.Context, body i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.PassiveDnsRecordable, requestConfiguration *ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilderPostRequestConfiguration)(i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.PassiveDnsRecordable, error) {
...
func (m *ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder) ToPostRequestInformation(ctx context.Context, body i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.PassiveDnsRecordable, requestConfiguration *ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder) WithUrl(rawUrl string)(*ThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder) {
    return NewThreatintelligencePassivednsrecordsPassiveDnsRecordsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
