...
func (m *UpdateAlertsRequestBuilder) Post(body UpdateAlertsPostRequestBodyable)(UpdateAlertsResponseable, error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action updateAlerts
func (m *UpdateAlertsRequestBuilder) PostWithRequestConfigurationAndResponseHandler(body UpdateAlertsPostRequestBodyable, requestConfiguration *UpdateAlertsRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(UpdateAlertsResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateUpdateAlertsResponseFromDiscriminatorValue, responseHandler, errorMapping)
    if err != nil {
        return nil, err
    }
