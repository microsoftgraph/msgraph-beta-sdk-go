...
func (m *ThreatIntelligenceArticlesArticleItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ThreatIntelligenceArticlesArticleItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
