...
func (m *AttackSimulationPayloadsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttackSimulationPayloadsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
