...
func NewThreatIntelligenceHostsItemSubdomainsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatIntelligenceHostsItemSubdomainsCountRequestBuilder) {
    m := &ThreatIntelligenceHostsItemSubdomainsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/subdomains/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewThreatIntelligenceHostsItemSubdomainsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatIntelligenceHostsItemSubdomainsCountRequestBuilder) {
    ...
    return NewThreatIntelligenceHostsItemSubdomainsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ThreatIntelligenceHostsItemSubdomainsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemSubdomainsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ThreatIntelligenceHostsItemSubdomainsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemSubdomainsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ThreatIntelligenceHostsItemSubdomainsCountRequestBuilder when successful
func (m *ThreatIntelligenceHostsItemSubdomainsCountRequestBuilder) WithUrl(rawUrl string)(*ThreatIntelligenceHostsItemSubdomainsCountRequestBuilder) {
    return NewThreatIntelligenceHostsItemSubdomainsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
