...
// Delete delete a userSource object associated with an ediscoveryHoldPolicy.
...
// ToDeleteRequestInformation delete a userSource object associated with an ediscoveryHoldPolicy.
