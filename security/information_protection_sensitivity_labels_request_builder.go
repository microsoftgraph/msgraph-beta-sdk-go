...
// InformationProtectionSensitivityLabelsRequestBuilderGetQueryParameters read the Microsoft Purview Information Protection labels for the user or organization.
...
// NewInformationProtectionSensitivityLabelsRequestBuilderInternal instantiates a new InformationProtectionSensitivityLabelsRequestBuilder and sets the default values.
...
// NewInformationProtectionSensitivityLabelsRequestBuilder instantiates a new InformationProtectionSensitivityLabelsRequestBuilder and sets the default values.
...
// returns a *InformationProtectionSensitivityLabelsMicrosoftGraphSecurityEvaluateRemovalRequestBuilder when successful
...
// returns a *InformationProtectionSensitivityLabelsMicrosoftGraphSecurityExtractContentLabelRequestBuilder when successful
...
// returns a *InformationProtectionSensitivityLabelsRequestBuilder when successful
func (m *InformationProtectionSensitivityLabelsRequestBuilder) WithUrl(rawUrl string)(*InformationProtectionSensitivityLabelsRequestBuilder) {
    return NewInformationProtectionSensitivityLabelsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
