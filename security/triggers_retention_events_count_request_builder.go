...
func (m *TriggersRetentionEventsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TriggersRetentionEventsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
