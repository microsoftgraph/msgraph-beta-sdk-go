...
// IdentitiesSensorsSensorItemRequestBuilder provides operations to manage the sensors property of the microsoft.graph.security.identityContainer entity.
type IdentitiesSensorsSensorItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// IdentitiesSensorsSensorItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type IdentitiesSensorsSensorItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// IdentitiesSensorsSensorItemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type IdentitiesSensorsSensorItemRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *IdentitiesSensorsSensorItemRequestBuilderGetQueryParameters
}
// IdentitiesSensorsSensorItemRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type IdentitiesSensorsSensorItemRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewIdentitiesSensorsSensorItemRequestBuilderInternal instantiates a new IdentitiesSensorsSensorItemRequestBuilder and sets the default values.
func NewIdentitiesSensorsSensorItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IdentitiesSensorsSensorItemRequestBuilder) {
    m := &IdentitiesSensorsSensorItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/identities/sensors/{sensor%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewIdentitiesSensorsSensorItemRequestBuilder instantiates a new IdentitiesSensorsSensorItemRequestBuilder and sets the default values.
func NewIdentitiesSensorsSensorItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IdentitiesSensorsSensorItemRequestBuilder) {
...
func (m *IdentitiesSensorsSensorItemRequestBuilder) WithUrl(rawUrl string)(*IdentitiesSensorsSensorItemRequestBuilder) {
    return NewIdentitiesSensorsSensorItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
