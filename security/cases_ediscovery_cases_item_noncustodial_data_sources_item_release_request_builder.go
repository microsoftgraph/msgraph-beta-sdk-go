...
func NewCasesEdiscoveryCasesItemNoncustodialDataSourcesItemReleaseRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemNoncustodialDataSourcesItemReleaseRequestBuilder) {
    m := &CasesEdiscoveryCasesItemNoncustodialDataSourcesItemReleaseRequestBuilder{
    }
...
func NewCasesEdiscoveryCasesItemNoncustodialDataSourcesItemReleaseRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemNoncustodialDataSourcesItemReleaseRequestBuilder) {
    ...
    return NewCasesEdiscoveryCasesItemNoncustodialDataSourcesItemReleaseRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *CasesEdiscoveryCasesItemNoncustodialDataSourcesItemReleaseRequestBuilder) Post(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemNoncustodialDataSourcesItemReleaseRequestBuilderPostRequestConfiguration)(error) {
...
func (m *CasesEdiscoveryCasesItemNoncustodialDataSourcesItemReleaseRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemNoncustodialDataSourcesItemReleaseRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
