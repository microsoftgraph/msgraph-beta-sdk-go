...
// InformationProtectionSensitivityLabelsEvaluateApplicationPostRequestBody 
...
func (m *InformationProtectionSensitivityLabelsEvaluateApplicationPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *InformationProtectionSensitivityLabelsEvaluateApplicationPostRequestBody) SetAdditionalData(value map[string]any)() {
