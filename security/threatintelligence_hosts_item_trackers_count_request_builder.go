...
func NewThreatintelligenceHostsItemTrackersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceHostsItemTrackersCountRequestBuilder) {
    m := &ThreatintelligenceHostsItemTrackersCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/trackers/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewThreatintelligenceHostsItemTrackersCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceHostsItemTrackersCountRequestBuilder) {
    ...
    return NewThreatintelligenceHostsItemTrackersCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ThreatintelligenceHostsItemTrackersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatintelligenceHostsItemTrackersCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ThreatintelligenceHostsItemTrackersCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatintelligenceHostsItemTrackersCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ThreatintelligenceHostsItemTrackersCountRequestBuilder) WithUrl(rawUrl string)(*ThreatintelligenceHostsItemTrackersCountRequestBuilder) {
    return NewThreatintelligenceHostsItemTrackersCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
