...
func (m *SecurityActionsSecurityActionItemRequestBuilder) Get(ctx context.Context, requestConfiguration *SecurityActionsSecurityActionItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SecurityActionable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateSecurityActionFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *SecurityActionsSecurityActionItemRequestBuilder) MicrosoftGraphCancelSecurityAction()(*SecurityActionsItemMicrosoftGraphCancelSecurityActionRequestBuilder) {
    return NewSecurityActionsItemMicrosoftGraphCancelSecurityActionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
