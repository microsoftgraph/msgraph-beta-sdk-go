...
func (m *InformationProtectionSensitivityLabelsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *InformationProtectionSensitivityLabelsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
