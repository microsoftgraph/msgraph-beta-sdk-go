...
// NewThreatsubmissionEmailthreatsubmissionpoliciesCountRequestBuilderInternal instantiates a new ThreatsubmissionEmailthreatsubmissionpoliciesCountRequestBuilder and sets the default values.
func NewThreatsubmissionEmailthreatsubmissionpoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatsubmissionEmailthreatsubmissionpoliciesCountRequestBuilder) {
    m := &ThreatsubmissionEmailthreatsubmissionpoliciesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/threatSubmission/emailThreatSubmissionPolicies/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewThreatsubmissionEmailthreatsubmissionpoliciesCountRequestBuilder instantiates a new ThreatsubmissionEmailthreatsubmissionpoliciesCountRequestBuilder and sets the default values.
