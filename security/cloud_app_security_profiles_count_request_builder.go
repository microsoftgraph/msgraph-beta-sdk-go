...
func (m *CloudAppSecurityProfilesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CloudAppSecurityProfilesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
