...
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/tiindicators-list?view=graph-rest-1.0
func (m *TiIndicatorsRequestBuilder) Get(ctx context.Context, requestConfiguration *TiIndicatorsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TiIndicatorCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateTiIndicatorCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphDeleteTiIndicators provides operations to call the deleteTiIndicators method.
func (m *TiIndicatorsRequestBuilder) MicrosoftGraphDeleteTiIndicators()(*TiIndicatorsMicrosoftGraphDeleteTiIndicatorsDeleteTiIndicatorsRequestBuilder) {
    return NewTiIndicatorsMicrosoftGraphDeleteTiIndicatorsDeleteTiIndicatorsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDeleteTiIndicatorsByExternalId provides operations to call the deleteTiIndicatorsByExternalId method.
func (m *TiIndicatorsRequestBuilder) MicrosoftGraphDeleteTiIndicatorsByExternalId()(*TiIndicatorsMicrosoftGraphDeleteTiIndicatorsByExternalIdDeleteTiIndicatorsByExternalIdRequestBuilder) {
    return NewTiIndicatorsMicrosoftGraphDeleteTiIndicatorsByExternalIdDeleteTiIndicatorsByExternalIdRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSubmitTiIndicators provides operations to call the submitTiIndicators method.
func (m *TiIndicatorsRequestBuilder) MicrosoftGraphSubmitTiIndicators()(*TiIndicatorsMicrosoftGraphSubmitTiIndicatorsSubmitTiIndicatorsRequestBuilder) {
    return NewTiIndicatorsMicrosoftGraphSubmitTiIndicatorsSubmitTiIndicatorsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUpdateTiIndicators provides operations to call the updateTiIndicators method.
func (m *TiIndicatorsRequestBuilder) MicrosoftGraphUpdateTiIndicators()(*TiIndicatorsMicrosoftGraphUpdateTiIndicatorsUpdateTiIndicatorsRequestBuilder) {
    return NewTiIndicatorsMicrosoftGraphUpdateTiIndicatorsUpdateTiIndicatorsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Post create a new tiIndicator object.
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/tiindicators-post?view=graph-rest-1.0
func (m *TiIndicatorsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TiIndicatorable, requestConfiguration *TiIndicatorsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TiIndicatorable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateTiIndicatorFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
