...
// UserSourceItemRequestBuilder provides operations to manage the userSources property of the microsoft.graph.security.ediscoveryHoldPolicy entity.
...
// UserSourceItemRequestBuilderGetQueryParameters data sources that represent Exchange mailboxes.
