...
// RunRequestBuilderGetQueryParameters invoke function run
type RunRequestBuilderGetQueryParameters struct {
...
type RunRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *RunRequestBuilderGetQueryParameters
}
...
func (m *RunRequestBuilder) Get(ctx context.Context, requestConfiguration *RunRequestBuilderGetRequestConfiguration)(RunResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateRunResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
