...
// CreatePostRequestInformationWithRequestConfiguration initiate an export from a **reviewSet** query.  For details, see Export documents from a review set in eDiscovery (Premium).
