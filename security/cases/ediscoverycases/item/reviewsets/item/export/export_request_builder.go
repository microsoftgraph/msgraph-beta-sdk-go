...
// CreatePostRequestInformationWithRequestConfiguration initiate an export from a **reviewSet**.  For details, see Export documents from a review set in eDiscovery (Premium).
