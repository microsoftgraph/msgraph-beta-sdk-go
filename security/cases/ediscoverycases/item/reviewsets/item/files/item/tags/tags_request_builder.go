...
import (
    ...
    i89aad5d3bbd836e994e6fc70aa1990daeff19d2eb03c89888f1aa71bfdd972c1 "github.com/microsoftgraph/msgraph-beta-sdk-go/security/cases/ediscoverycases/item/reviewsets/item/files/item/tags/count"
)

// TagsRequestBuilder provides operations to manage the tags property of the microsoft.graph.security.ediscoveryFile entity.
...
// TagsRequestBuilderGetQueryParameters tags associated with the file.
...
func NewTagsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TagsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/files/{ediscoveryFile%2Did}/tags{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *TagsRequestBuilder) Count()(*i89aad5d3bbd836e994e6fc70aa1990daeff19d2eb03c89888f1aa71bfdd972c1.CountRequestBuilder) {
    return i89aad5d3bbd836e994e6fc70aa1990daeff19d2eb03c89888f1aa71bfdd972c1.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
