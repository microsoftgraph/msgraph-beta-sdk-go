...
// CreateGetRequestInformationWithRequestConfiguration custodians associated with the file.
...
// GetWithRequestConfigurationAndResponseHandler custodians associated with the file.
