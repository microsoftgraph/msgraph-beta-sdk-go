...
func NewCasesEdiscoveryCasesItemCustodiansItemReleaseRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemCustodiansItemReleaseRequestBuilder) {
    m := &CasesEdiscoveryCasesItemCustodiansItemReleaseRequestBuilder{
    }
...
func NewCasesEdiscoveryCasesItemCustodiansItemReleaseRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemCustodiansItemReleaseRequestBuilder) {
    ...
    return NewCasesEdiscoveryCasesItemCustodiansItemReleaseRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation release a custodian from a case. For details, see Release a custodian from a case.
func (m *CasesEdiscoveryCasesItemCustodiansItemReleaseRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemCustodiansItemReleaseRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CasesEdiscoveryCasesItemCustodiansItemReleaseRequestBuilder) Post(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemCustodiansItemReleaseRequestBuilderPostRequestConfiguration)(error) {
