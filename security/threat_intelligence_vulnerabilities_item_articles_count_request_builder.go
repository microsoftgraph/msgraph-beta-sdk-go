...
func (m *ThreatIntelligenceVulnerabilitiesItemArticlesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceVulnerabilitiesItemArticlesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
