...
func (m *AttackSimulationEndUserNotificationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttackSimulationEndUserNotificationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
