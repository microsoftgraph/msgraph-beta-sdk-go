...
func NewAttackSimulationEndUserNotificationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttackSimulationEndUserNotificationsCountRequestBuilder) {
    m := &AttackSimulationEndUserNotificationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/attackSimulation/endUserNotifications/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewAttackSimulationEndUserNotificationsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttackSimulationEndUserNotificationsCountRequestBuilder) {
    ...
    return NewAttackSimulationEndUserNotificationsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *AttackSimulationEndUserNotificationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttackSimulationEndUserNotificationsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *AttackSimulationEndUserNotificationsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AttackSimulationEndUserNotificationsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AttackSimulationEndUserNotificationsCountRequestBuilder) WithUrl(rawUrl string)(*AttackSimulationEndUserNotificationsCountRequestBuilder) {
    return NewAttackSimulationEndUserNotificationsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
