...
// ByLandingPageDetailIdString provides operations to manage the details property of the microsoft.graph.landingPage entity.
func (m *AttackSimulationLandingPagesItemDetailsRequestBuilder) ByLandingPageDetailIdString(landingPageDetailId string)(*AttackSimulationLandingPagesItemDetailsLandingPageDetailItemRequestBuilder) {
