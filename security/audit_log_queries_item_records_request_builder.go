...
// AuditLogQueriesItemRecordsRequestBuilderGetQueryParameters get records from security
...
// NewAuditLogQueriesItemRecordsRequestBuilderInternal instantiates a new RecordsRequestBuilder and sets the default values.
func NewAuditLogQueriesItemRecordsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AuditLogQueriesItemRecordsRequestBuilder) {
    m := &AuditLogQueriesItemRecordsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/auditLog/queries/{auditLogQuery%2Did}/records{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewAuditLogQueriesItemRecordsRequestBuilder instantiates a new RecordsRequestBuilder and sets the default values.
...
// ToGetRequestInformation get records from security
