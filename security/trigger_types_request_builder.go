...
func (m *TriggerTypesRequestBuilder) Get(ctx context.Context, requestConfiguration *TriggerTypesRequestBuilderGetRequestConfiguration)(i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.TriggerTypesRootable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.CreateTriggerTypesRootFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *TriggerTypesRequestBuilder) RetentionEventTypesById(id string)(*TriggerTypesRetentionEventTypesRetentionEventTypeItemRequestBuilder) {
    ...
    idPtr := &id
    return NewTriggerTypesRetentionEventTypesRetentionEventTypeItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
