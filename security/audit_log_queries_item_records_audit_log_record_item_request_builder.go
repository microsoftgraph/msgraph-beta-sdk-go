...
// AuditLogQueriesItemRecordsAuditLogRecordItemRequestBuilderGetQueryParameters get records from security
...
// NewAuditLogQueriesItemRecordsAuditLogRecordItemRequestBuilderInternal instantiates a new AuditLogRecordItemRequestBuilder and sets the default values.
func NewAuditLogQueriesItemRecordsAuditLogRecordItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AuditLogQueriesItemRecordsAuditLogRecordItemRequestBuilder) {
    m := &AuditLogQueriesItemRecordsAuditLogRecordItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/auditLog/queries/{auditLogQuery%2Did}/records/{auditLogRecord%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewAuditLogQueriesItemRecordsAuditLogRecordItemRequestBuilder instantiates a new AuditLogRecordItemRequestBuilder and sets the default values.
