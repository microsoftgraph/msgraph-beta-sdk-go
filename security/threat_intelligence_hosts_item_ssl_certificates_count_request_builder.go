...
func (m *ThreatIntelligenceHostsItemSslCertificatesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemSslCertificatesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
