...
func (m *AttackSimulationLandingPagesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttackSimulationLandingPagesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
