...
func (m *ThreatIntelligenceHostsItemChildHostPairsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemChildHostPairsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
