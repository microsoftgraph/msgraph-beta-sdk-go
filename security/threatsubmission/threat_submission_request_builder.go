...
func (m *ThreatSubmissionRequestBuilder) Delete()(error) {
    return m.DeleteWithRequestConfigurationAndResponseHandler(nil, nil);
}
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property threatSubmission for security
func (m *ThreatSubmissionRequestBuilder) DeleteWithRequestConfigurationAndResponseHandler(requestConfiguration *ThreatSubmissionRequestBuilderDeleteRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property threatSubmission in security
