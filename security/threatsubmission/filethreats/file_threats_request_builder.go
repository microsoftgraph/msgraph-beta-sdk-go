...
import (
    ...
    ia0f480270b5c21167e675ce8755717a14b83a3cd94cf6ae1f7ffa203256ac772 "github.com/microsoftgraph/msgraph-beta-sdk-go/security/threatsubmission/filethreats/count"
)
...
// FileThreatsRequestBuilderGetQueryParameters get fileThreats from security
...
func NewFileThreatsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileThreatsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/security/threatSubmission/fileThreats{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// CreateGetRequestInformationWithRequestConfiguration get fileThreats from security
...
// CreatePostRequestInformation create new navigation property to fileThreats for security
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to fileThreats for security
...
func (m *FileThreatsRequestBuilder) Get(ctx context.Context, requestConfiguration *FileThreatsRequestBuilderGetRequestConfiguration)(i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.FileThreatSubmissionCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.CreateFileThreatSubmissionCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
