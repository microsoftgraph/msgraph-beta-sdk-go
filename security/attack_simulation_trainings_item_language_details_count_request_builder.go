...
func (m *AttackSimulationTrainingsItemLanguageDetailsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttackSimulationTrainingsItemLanguageDetailsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
