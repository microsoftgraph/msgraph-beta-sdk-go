...
func (m *AttackSimulationTrainingsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttackSimulationTrainingsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
