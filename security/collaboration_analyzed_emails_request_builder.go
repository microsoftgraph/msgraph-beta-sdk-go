...
// CollaborationAnalyzedEmailsRequestBuilderGetQueryParameters get analyzedEmails from security
...
// NewCollaborationAnalyzedEmailsRequestBuilderInternal instantiates a new AnalyzedEmailsRequestBuilder and sets the default values.
func NewCollaborationAnalyzedEmailsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CollaborationAnalyzedEmailsRequestBuilder) {
    m := &CollaborationAnalyzedEmailsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/collaboration/analyzedEmails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewCollaborationAnalyzedEmailsRequestBuilder instantiates a new AnalyzedEmailsRequestBuilder and sets the default values.
