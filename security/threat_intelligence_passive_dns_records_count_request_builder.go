...
func (m *ThreatIntelligencePassiveDnsRecordsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligencePassiveDnsRecordsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
