...
// CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilderGetQueryParameters get the number of the resource
type CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilderGetQueryParameters struct {
...
type CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilderGetQueryParameters
}
// NewCasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilderInternal instantiates a new CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilder and sets the default values.
func NewCasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilder) {
    m := &CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/legalHolds/{ediscoveryHoldPolicy%2Did}/siteSources/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewCasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilder instantiates a new CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilder and sets the default values.
...
func (m *CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilder) WithUrl(rawUrl string)(*CasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilder) {
    return NewCasesEdiscoveryCasesItemLegalHoldsItemSiteSourcesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
