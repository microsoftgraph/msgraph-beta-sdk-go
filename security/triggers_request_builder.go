...
func (m *TriggersRequestBuilder) Get(ctx context.Context, requestConfiguration *TriggersRequestBuilderGetRequestConfiguration)(i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.TriggersRootable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.CreateTriggersRootFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *TriggersRequestBuilder) RetentionEventsById(id string)(*TriggersRetentionEventsRetentionEventItemRequestBuilder) {
    ...
    idPtr := &id
    return NewTriggersRetentionEventsRetentionEventItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
