...
// InformationProtectionSensitivityLabelsEvaluateRemovalPostRequestBody 
...
func (m *InformationProtectionSensitivityLabelsEvaluateRemovalPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *InformationProtectionSensitivityLabelsEvaluateRemovalPostRequestBody) SetAdditionalData(value map[string]any)() {
