...
func (m *InformationProtectionSensitivityLabelsItemParentRequestBuilder) Delete(ctx context.Context, requestConfiguration *InformationProtectionSensitivityLabelsItemParentRequestBuilderDeleteRequestConfiguration)([]byte, error) {
