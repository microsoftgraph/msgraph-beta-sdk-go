...
// CollaborationAnalyzedEmailsAnalyzedEmailItemRequestBuilderGetQueryParameters get analyzedEmails from security
...
// NewCollaborationAnalyzedEmailsAnalyzedEmailItemRequestBuilderInternal instantiates a new AnalyzedEmailItemRequestBuilder and sets the default values.
func NewCollaborationAnalyzedEmailsAnalyzedEmailItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CollaborationAnalyzedEmailsAnalyzedEmailItemRequestBuilder) {
    m := &CollaborationAnalyzedEmailsAnalyzedEmailItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/collaboration/analyzedEmails/{analyzedEmail%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewCollaborationAnalyzedEmailsAnalyzedEmailItemRequestBuilder instantiates a new AnalyzedEmailItemRequestBuilder and sets the default values.
...
// Get get analyzedEmails from security
...
// ToGetRequestInformation get analyzedEmails from security
