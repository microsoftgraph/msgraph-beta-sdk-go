...
// ThreatIntelligenceHostsRequestBuilderGetQueryParameters refers to microsoft.graph.security.host objects that Microsoft Threat Intelligence has observed.Note: List retrieval is not yet supported.
