...
func (m *ThreatIntelligenceArticlesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceArticlesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
