...
func (m *ThreatIntelligenceHostsItemPassiveDnsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemPassiveDnsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
