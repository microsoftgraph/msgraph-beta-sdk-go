...
func (m *CasesEdiscoveryCasesItemSearchesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemSearchesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
