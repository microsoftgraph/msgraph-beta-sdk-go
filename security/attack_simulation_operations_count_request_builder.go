...
func (m *AttackSimulationOperationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttackSimulationOperationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
