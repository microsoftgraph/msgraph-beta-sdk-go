...
func NewCasesEdiscoveryCasesItemCustodiansApplyHoldRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemCustodiansApplyHoldRequestBuilder) {
    m := &CasesEdiscoveryCasesItemCustodiansApplyHoldRequestBuilder{
    }
...
func NewCasesEdiscoveryCasesItemCustodiansApplyHoldRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemCustodiansApplyHoldRequestBuilder) {
    ...
    return NewCasesEdiscoveryCasesItemCustodiansApplyHoldRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *CasesEdiscoveryCasesItemCustodiansApplyHoldRequestBuilder) CreatePostRequestInformation(ctx context.Context, body CasesEdiscoveryCasesItemCustodiansApplyHoldPostRequestBodyable, requestConfiguration *CasesEdiscoveryCasesItemCustodiansApplyHoldRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CasesEdiscoveryCasesItemCustodiansApplyHoldRequestBuilder) Post(ctx context.Context, body CasesEdiscoveryCasesItemCustodiansApplyHoldPostRequestBodyable, requestConfiguration *CasesEdiscoveryCasesItemCustodiansApplyHoldRequestBuilderPostRequestConfiguration)(error) {
