...
func (m *CasesEdiscoveryCasesItemNoncustodialDataSourcesEdiscoveryNoncustodialDataSourceItemRequestBuilder) SecurityApplyHold()(*CasesEdiscoveryCasesItemNoncustodialDataSourcesItemSecurityApplyHoldRequestBuilder) {
    return NewCasesEdiscoveryCasesItemNoncustodialDataSourcesItemSecurityApplyHoldRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *CasesEdiscoveryCasesItemNoncustodialDataSourcesEdiscoveryNoncustodialDataSourceItemRequestBuilder) SecurityRelease()(*CasesEdiscoveryCasesItemNoncustodialDataSourcesItemSecurityReleaseRequestBuilder) {
    return NewCasesEdiscoveryCasesItemNoncustodialDataSourcesItemSecurityReleaseRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *CasesEdiscoveryCasesItemNoncustodialDataSourcesEdiscoveryNoncustodialDataSourceItemRequestBuilder) SecurityRemoveHold()(*CasesEdiscoveryCasesItemNoncustodialDataSourcesItemSecurityRemoveHoldRequestBuilder) {
    return NewCasesEdiscoveryCasesItemNoncustodialDataSourcesItemSecurityRemoveHoldRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *CasesEdiscoveryCasesItemNoncustodialDataSourcesEdiscoveryNoncustodialDataSourceItemRequestBuilder) SecurityUpdateIndex()(*CasesEdiscoveryCasesItemNoncustodialDataSourcesItemSecurityUpdateIndexRequestBuilder) {
    return NewCasesEdiscoveryCasesItemNoncustodialDataSourcesItemSecurityUpdateIndexRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
