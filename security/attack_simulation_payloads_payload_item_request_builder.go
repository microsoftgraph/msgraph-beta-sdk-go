...
func (m *AttackSimulationPayloadsPayloadItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *AttackSimulationPayloadsPayloadItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
