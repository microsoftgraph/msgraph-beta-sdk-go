...
// RefRequestBuilder builds and executes requests for operations under \security\incidents\{incident-id}\alerts\$ref
...
// RefRequestBuilderGetQueryParameters get ref of alerts from security
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/security/incidents/{incident_id}/alerts/$ref{?top,skip,search,filter,count,orderby}";
...
// CreateGetRequestInformation get ref of alerts from security
...
// CreatePostRequestInformation create new navigation property ref to alerts for security
...
// Get get ref of alerts from security
...
// Post create new navigation property ref to alerts for security
