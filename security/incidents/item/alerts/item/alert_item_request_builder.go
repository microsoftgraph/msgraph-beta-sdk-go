...
// AlertItemRequestBuilder provides operations to manage the alerts property of the microsoft.graph.security.incident entity.
...
// AlertItemRequestBuilderGetQueryParameters the list of related alerts. Supports $expand.
