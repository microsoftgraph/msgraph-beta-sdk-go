...
func (m *LabelsDepartmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *LabelsDepartmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
