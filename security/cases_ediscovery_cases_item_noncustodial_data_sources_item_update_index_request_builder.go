...
func NewCasesEdiscoveryCasesItemNoncustodialDataSourcesItemUpdateIndexRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemNoncustodialDataSourcesItemUpdateIndexRequestBuilder) {
    m := &CasesEdiscoveryCasesItemNoncustodialDataSourcesItemUpdateIndexRequestBuilder{
    }
...
func NewCasesEdiscoveryCasesItemNoncustodialDataSourcesItemUpdateIndexRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemNoncustodialDataSourcesItemUpdateIndexRequestBuilder) {
    ...
    return NewCasesEdiscoveryCasesItemNoncustodialDataSourcesItemUpdateIndexRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation trigger an indexOperation
func (m *CasesEdiscoveryCasesItemNoncustodialDataSourcesItemUpdateIndexRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemNoncustodialDataSourcesItemUpdateIndexRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CasesEdiscoveryCasesItemNoncustodialDataSourcesItemUpdateIndexRequestBuilder) Post(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemNoncustodialDataSourcesItemUpdateIndexRequestBuilderPostRequestConfiguration)(error) {
