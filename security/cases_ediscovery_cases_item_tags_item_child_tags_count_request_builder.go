...
func (m *CasesEdiscoveryCasesItemTagsItemChildTagsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemTagsItemChildTagsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
