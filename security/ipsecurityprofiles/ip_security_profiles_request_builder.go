...
type IpSecurityProfilesRequestBuilderGetOptions struct {
    ...
    Q *IpSecurityProfilesRequestBuilderGetQueryParameters;
...
func (m *IpSecurityProfilesRequestBuilder) Get(options *IpSecurityProfilesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.IpSecurityProfileCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateIpSecurityProfileCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.IpSecurityProfileCollectionResponseable), nil
}
// Post create new navigation property to ipSecurityProfiles for security
func (m *IpSecurityProfilesRequestBuilder) Post(options *IpSecurityProfilesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.IpSecurityProfileable, error) {
