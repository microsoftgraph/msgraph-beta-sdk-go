...
// NewLabelsRetentionLabelsItemDescriptorsAuthorityTemplateRequestBuilderInternal instantiates a new AuthorityTemplateRequestBuilder and sets the default values.
func NewLabelsRetentionLabelsItemDescriptorsAuthorityTemplateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LabelsRetentionLabelsItemDescriptorsAuthorityTemplateRequestBuilder) {
    m := &LabelsRetentionLabelsItemDescriptorsAuthorityTemplateRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}/descriptors/authorityTemplate{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewLabelsRetentionLabelsItemDescriptorsAuthorityTemplateRequestBuilder instantiates a new AuthorityTemplateRequestBuilder and sets the default values.
