...
// SubjectRightsRequestsItemNotesRequestBuilderGetQueryParameters get the list of authored notes associated with a subject rights request.  This API is supported in the following national cloud deployments.
...
// Get get the list of authored notes associated with a subject rights request.  This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get the list of authored notes associated with a subject rights request.  This API is supported in the following national cloud deployments.
