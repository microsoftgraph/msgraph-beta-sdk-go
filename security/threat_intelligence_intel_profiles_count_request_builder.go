...
func (m *ThreatIntelligenceIntelProfilesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceIntelProfilesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
