...
func NewThreatintelligenceVulnerabilitiesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceVulnerabilitiesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewThreatintelligenceVulnerabilitiesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ThreatintelligenceVulnerabilitiesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatintelligenceVulnerabilitiesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ThreatintelligenceVulnerabilitiesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatintelligenceVulnerabilitiesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ThreatintelligenceVulnerabilitiesCountRequestBuilder) WithUrl(rawUrl string)(*ThreatintelligenceVulnerabilitiesCountRequestBuilder) {
    return NewThreatintelligenceVulnerabilitiesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
