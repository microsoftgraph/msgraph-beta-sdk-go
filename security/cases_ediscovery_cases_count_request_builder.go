...
func (m *CasesEdiscoveryCasesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
