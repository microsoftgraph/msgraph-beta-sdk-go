...
// DeleteWithResponseHandler delete navigation property sensitivityLabels for security
...
// PatchWithResponseHandler update the navigation property sensitivityLabels in security
