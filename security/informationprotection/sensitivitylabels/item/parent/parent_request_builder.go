...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property parent for security
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property parent in security
