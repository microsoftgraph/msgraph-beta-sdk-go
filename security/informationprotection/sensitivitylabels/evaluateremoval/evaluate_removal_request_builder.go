...
// EvaluateRemovalRequestBuilder builds and executes requests for operations under \security\informationProtection\sensitivityLabels\microsoft.graph.security.evaluateRemoval
