...
// NewCasesEdiscoverycasesItemLegalholdsItemSitesourcesItemSiteRequestBuilderInternal instantiates a new CasesEdiscoverycasesItemLegalholdsItemSitesourcesItemSiteRequestBuilder and sets the default values.
func NewCasesEdiscoverycasesItemLegalholdsItemSitesourcesItemSiteRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoverycasesItemLegalholdsItemSitesourcesItemSiteRequestBuilder) {
    m := &CasesEdiscoverycasesItemLegalholdsItemSitesourcesItemSiteRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/legalHolds/{ediscoveryHoldPolicy%2Did}/siteSources/{siteSource%2Did}/site{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewCasesEdiscoverycasesItemLegalholdsItemSitesourcesItemSiteRequestBuilder instantiates a new CasesEdiscoverycasesItemLegalholdsItemSitesourcesItemSiteRequestBuilder and sets the default values.
