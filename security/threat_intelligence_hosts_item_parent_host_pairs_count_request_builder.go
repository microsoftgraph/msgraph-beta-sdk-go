...
func (m *ThreatIntelligenceHostsItemParentHostPairsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemParentHostPairsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
