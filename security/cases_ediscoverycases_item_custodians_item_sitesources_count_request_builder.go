...
func NewCasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilder) {
    m := &CasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/siteSources/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewCasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilder) {
    ...
    return NewCasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *CasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *CasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *CasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilder) WithUrl(rawUrl string)(*CasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilder) {
    return NewCasesEdiscoverycasesItemCustodiansItemSitesourcesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
