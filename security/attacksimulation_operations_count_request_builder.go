...
func NewAttacksimulationOperationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttacksimulationOperationsCountRequestBuilder) {
    m := &AttacksimulationOperationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/attackSimulation/operations/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewAttacksimulationOperationsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttacksimulationOperationsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewAttacksimulationOperationsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *AttacksimulationOperationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttacksimulationOperationsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *AttacksimulationOperationsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AttacksimulationOperationsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AttacksimulationOperationsCountRequestBuilder) WithUrl(rawUrl string)(*AttacksimulationOperationsCountRequestBuilder) {
    return NewAttacksimulationOperationsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
