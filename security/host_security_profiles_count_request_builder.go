...
func (m *HostSecurityProfilesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *HostSecurityProfilesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
