...
// ByEndUserNotificationDetailIdString provides operations to manage the details property of the microsoft.graph.endUserNotification entity.
func (m *AttackSimulationEndUserNotificationsItemDetailsRequestBuilder) ByEndUserNotificationDetailIdString(endUserNotificationDetailId string)(*AttackSimulationEndUserNotificationsItemDetailsEndUserNotificationDetailItemRequestBuilder) {
