...
// Delete delete a unifiedGroupSource object associated with an ediscoveryCustodian.
...
// ToDeleteRequestInformation delete a unifiedGroupSource object associated with an ediscoveryCustodian.
