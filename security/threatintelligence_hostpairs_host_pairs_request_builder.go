...
func (m *ThreatintelligenceHostpairsHostPairsRequestBuilder) ByHostPairId(hostPairId string)(*ThreatintelligenceHostpairsHostPairItemRequestBuilder) {
...
func NewThreatintelligenceHostpairsHostPairsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceHostpairsHostPairsRequestBuilder) {
    m := &ThreatintelligenceHostpairsHostPairsRequestBuilder{
...
func NewThreatintelligenceHostpairsHostPairsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceHostpairsHostPairsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewThreatintelligenceHostpairsHostPairsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ThreatintelligenceHostpairsCountRequestBuilder when successful
func (m *ThreatintelligenceHostpairsHostPairsRequestBuilder) Count()(*ThreatintelligenceHostpairsCountRequestBuilder) {
...
func (m *ThreatintelligenceHostpairsHostPairsRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatintelligenceHostpairsHostPairsRequestBuilderGetRequestConfiguration)(i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.HostPairCollectionResponseable, error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ThreatintelligenceHostpairsHostPairsRequestBuilder) Post(ctx context.Context, body i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.HostPairable, requestConfiguration *ThreatintelligenceHostpairsHostPairsRequestBuilderPostRequestConfiguration)(i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.HostPairable, error) {
...
func (m *ThreatintelligenceHostpairsHostPairsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatintelligenceHostpairsHostPairsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *ThreatintelligenceHostpairsHostPairsRequestBuilder) ToPostRequestInformation(ctx context.Context, body i084fa7ab3bba802bf5cc3b408e230cc64c167a57976e0d42c37e17154afd5b78.HostPairable, requestConfiguration *ThreatintelligenceHostpairsHostPairsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ThreatintelligenceHostpairsHostPairsRequestBuilder) WithUrl(rawUrl string)(*ThreatintelligenceHostpairsHostPairsRequestBuilder) {
    return NewThreatintelligenceHostpairsHostPairsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
