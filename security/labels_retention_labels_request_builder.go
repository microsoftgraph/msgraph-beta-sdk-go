...
// LabelsRetentionLabelsRequestBuilderGetQueryParameters get retentionLabels from security
...
// ToPostRequestInformation create new navigation property to retentionLabels for security
