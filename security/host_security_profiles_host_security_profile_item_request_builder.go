...
func (m *HostSecurityProfilesHostSecurityProfileItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *HostSecurityProfilesHostSecurityProfileItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
