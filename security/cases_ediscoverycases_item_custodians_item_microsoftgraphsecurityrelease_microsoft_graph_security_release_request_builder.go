...
func NewCasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilder) {
    m := &CasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilder{
...
func NewCasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilder) {
    ...
    return NewCasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *CasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilder) Post(ctx context.Context, requestConfiguration *CasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilderPostRequestConfiguration)(error) {
...
func (m *CasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *CasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilder) WithUrl(rawUrl string)(*CasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilder) {
    return NewCasesEdiscoverycasesItemCustodiansItemMicrosoftgraphsecurityreleaseMicrosoftGraphSecurityReleaseRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
