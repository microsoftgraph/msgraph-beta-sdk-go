...
func (m *ThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilderGetRequestConfiguration)(*int64, error) {
