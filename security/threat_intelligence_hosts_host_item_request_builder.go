...
// ThreatIntelligenceHostsHostItemRequestBuilderGetQueryParameters refers to host objects that Microsoft Threat Intelligence has observed.Note: List retrieval is not yet supported.
