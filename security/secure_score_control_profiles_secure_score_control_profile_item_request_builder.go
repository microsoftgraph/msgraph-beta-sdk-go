...
func (m *SecureScoreControlProfilesSecureScoreControlProfileItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *SecureScoreControlProfilesSecureScoreControlProfileItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
