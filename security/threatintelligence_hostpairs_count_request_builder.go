...
func NewThreatintelligenceHostpairsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceHostpairsCountRequestBuilder) {
    m := &ThreatintelligenceHostpairsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/threatIntelligence/hostPairs/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewThreatintelligenceHostpairsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatintelligenceHostpairsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewThreatintelligenceHostpairsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ThreatintelligenceHostpairsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatintelligenceHostpairsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ThreatintelligenceHostpairsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatintelligenceHostpairsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ThreatintelligenceHostpairsCountRequestBuilder) WithUrl(rawUrl string)(*ThreatintelligenceHostpairsCountRequestBuilder) {
    return NewThreatintelligenceHostpairsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
