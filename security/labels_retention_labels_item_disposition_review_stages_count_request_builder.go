...
// NewLabelsRetentionLabelsItemDispositionReviewStagesCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewLabelsRetentionLabelsItemDispositionReviewStagesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LabelsRetentionLabelsItemDispositionReviewStagesCountRequestBuilder) {
    m := &LabelsRetentionLabelsItemDispositionReviewStagesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}/dispositionReviewStages/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewLabelsRetentionLabelsItemDispositionReviewStagesCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
