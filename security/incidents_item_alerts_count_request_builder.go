...
func NewIncidentsItemAlertsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IncidentsItemAlertsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewIncidentsItemAlertsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *IncidentsItemAlertsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *IncidentsItemAlertsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *IncidentsItemAlertsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *IncidentsItemAlertsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *IncidentsItemAlertsCountRequestBuilder) WithUrl(rawUrl string)(*IncidentsItemAlertsCountRequestBuilder) {
    return NewIncidentsItemAlertsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
