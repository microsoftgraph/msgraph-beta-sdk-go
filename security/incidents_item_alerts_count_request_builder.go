...
func (m *IncidentsItemAlertsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *IncidentsItemAlertsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
