...
type FileSecurityProfilesRequestBuilderGetOptions struct {
    ...
    Q *FileSecurityProfilesRequestBuilderGetQueryParameters;
...
func (m *FileSecurityProfilesRequestBuilder) Get(options *FileSecurityProfilesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.FileSecurityProfileCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateFileSecurityProfileCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.FileSecurityProfileCollectionResponseable), nil
}
// Post create new navigation property to fileSecurityProfiles for security
func (m *FileSecurityProfilesRequestBuilder) Post(options *FileSecurityProfilesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.FileSecurityProfileable, error) {
