...
// SecureScoreControlProfilesRequestBuilderGetQueryParameters retrieves a list of secureScoreControlProfile objects for a tenant. This API is supported in the following national cloud deployments.
...
func NewSecureScoreControlProfilesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SecureScoreControlProfilesRequestBuilder) {
    m := &SecureScoreControlProfilesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/secureScoreControlProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get retrieves a list of secureScoreControlProfile objects for a tenant. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieves a list of secureScoreControlProfile objects for a tenant. This API is supported in the following national cloud deployments.
