...
// SecureScoreControlProfilesRequestBuilderGetQueryParameters retrieves a list of secureScoreControlProfile objects for a tenant. This API is available in the following national cloud deployments.
...
// Get retrieves a list of secureScoreControlProfile objects for a tenant. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieves a list of secureScoreControlProfile objects for a tenant. This API is available in the following national cloud deployments.
