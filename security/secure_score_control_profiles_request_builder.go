...
// BySecureScoreControlProfileIdString provides operations to manage the secureScoreControlProfiles property of the microsoft.graph.security entity.
func (m *SecureScoreControlProfilesRequestBuilder) BySecureScoreControlProfileIdString(secureScoreControlProfileId string)(*SecureScoreControlProfilesSecureScoreControlProfileItemRequestBuilder) {
