...
func (m *InformationProtectionLabelPolicySettingsRequestBuilder) Delete(ctx context.Context, requestConfiguration *InformationProtectionLabelPolicySettingsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
