...
func (m *AttackSimulationOperationsAttackSimulationOperationItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *AttackSimulationOperationsAttackSimulationOperationItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
