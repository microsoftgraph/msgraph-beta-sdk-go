...
type DomainSecurityProfilesRequestBuilderGetOptions struct {
    ...
    Q *DomainSecurityProfilesRequestBuilderGetQueryParameters;
...
func (m *DomainSecurityProfilesRequestBuilder) Get(options *DomainSecurityProfilesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DomainSecurityProfileCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateDomainSecurityProfileCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DomainSecurityProfileCollectionResponseable), nil
}
// Post create new navigation property to domainSecurityProfiles for security
func (m *DomainSecurityProfilesRequestBuilder) Post(options *DomainSecurityProfilesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DomainSecurityProfileable, error) {
