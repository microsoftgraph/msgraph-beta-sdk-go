...
func (m *PrivilegedOperationEventItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *PrivilegedOperationEventItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
