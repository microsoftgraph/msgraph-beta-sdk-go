...
// ThreatSubmissionEmailThreatsEmailThreatSubmissionItemRequestBuilderGetQueryParameters get emailThreats from threatSubmission
...
// NewThreatSubmissionEmailThreatsEmailThreatSubmissionItemRequestBuilderInternal instantiates a new EmailThreatSubmissionItemRequestBuilder and sets the default values.
func NewThreatSubmissionEmailThreatsEmailThreatSubmissionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatSubmissionEmailThreatsEmailThreatSubmissionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/threatSubmission/emailThreats/{emailThreatSubmission%2Did}{?%24select,%24expand}";
...
// NewThreatSubmissionEmailThreatsEmailThreatSubmissionItemRequestBuilder instantiates a new EmailThreatSubmissionItemRequestBuilder and sets the default values.
...
// CreateDeleteRequestInformation delete navigation property emailThreats for threatSubmission
func (m *ThreatSubmissionEmailThreatsEmailThreatSubmissionItemRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *ThreatSubmissionEmailThreatsEmailThreatSubmissionItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// CreateGetRequestInformation get emailThreats from threatSubmission
func (m *ThreatSubmissionEmailThreatsEmailThreatSubmissionItemRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ThreatSubmissionEmailThreatsEmailThreatSubmissionItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
// CreatePatchRequestInformation update the navigation property emailThreats in threatSubmission
...
// Delete delete navigation property emailThreats for threatSubmission
...
// Patch update the navigation property emailThreats in threatSubmission
