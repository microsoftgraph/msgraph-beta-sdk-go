...
func (m *UrlThreatsUrlThreatSubmissionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *UrlThreatsUrlThreatSubmissionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
