...
// EmailThreatsRequestBuilderGetQueryParameters get a list of the emailThreatSubmission objects and their properties. This API is available in the following national cloud deployments.
...
func (m *EmailThreatsRequestBuilder) ByEmailThreatSubmissionId(emailThreatSubmissionId string)(*EmailThreatsEmailThreatSubmissionItemRequestBuilder) {
...
func NewEmailThreatsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EmailThreatsRequestBuilder) {
    m := &EmailThreatsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/threatSubmission/emailThreats{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get get a list of the emailThreatSubmission objects and their properties. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create a new emailThreatSubmission object. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get a list of the emailThreatSubmission objects and their properties. This API is available in the following national cloud deployments.
...
// ToPostRequestInformation create a new emailThreatSubmission object. This API is available in the following national cloud deployments.
...
func (m *EmailThreatsRequestBuilder) WithUrl(rawUrl string)(*EmailThreatsRequestBuilder) {
    return NewEmailThreatsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
