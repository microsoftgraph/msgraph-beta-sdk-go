...
func (m *ThreatSubmissionUrlThreatsRequestBuilder) Count()(*ThreatSubmissionUrlThreatsCountRequestBuilder) {
    return NewThreatSubmissionUrlThreatsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of the urlThreatSubmission objects and their properties.
func (m *ThreatSubmissionUrlThreatsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ThreatSubmissionUrlThreatsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
