...
import (
    ...
    i85d7605a880454a44a191a9f6afe84d0391e968726256037a10c0efafae46495 "github.com/microsoftgraph/msgraph-beta-sdk-go/devices/item/registeredusers/ref"
)

// RegisteredUsersRequestBuilder builds and executes requests for operations under \devices\{device-id}\registeredUsers
...
func NewRegisteredUsersRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RegisteredUsersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/devices/{device_id}/registeredUsers{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RegisteredUsersRequestBuilder) Get(options *RegisteredUsersRequestBuilderGetOptions)(*RegisteredUsersResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewRegisteredUsersResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*RegisteredUsersResponse), nil
}
func (m *RegisteredUsersRequestBuilder) Ref()(*i85d7605a880454a44a191a9f6afe84d0391e968726256037a10c0efafae46495.RefRequestBuilder) {
    return i85d7605a880454a44a191a9f6afe84d0391e968726256037a10c0efafae46495.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
