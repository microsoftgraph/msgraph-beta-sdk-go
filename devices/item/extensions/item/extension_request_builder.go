...
// ExtensionRequestBuilder builds and executes requests for operations under \devices\{device-id}\extensions\{extension-id}
...
// ExtensionRequestBuilderGetQueryParameters the collection of open extensions defined for the device. Read-only. Nullable.
...
func NewExtensionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ExtensionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/devices/{device_id}/extensions/{extension_id}{?select,expand}";
...
// CreateDeleteRequestInformation the collection of open extensions defined for the device. Read-only. Nullable.
...
// CreatePatchRequestInformation the collection of open extensions defined for the device. Read-only. Nullable.
...
// Delete the collection of open extensions defined for the device. Read-only. Nullable.
...
// Patch the collection of open extensions defined for the device. Read-only. Nullable.
