...
// ItemUsageRightsRequestBuilderGetQueryParameters retrieve a list of usageRight objects for a given device. This API is available in the following national cloud deployments.
...
// NewItemUsageRightsRequestBuilderInternal instantiates a new UsageRightsRequestBuilder and sets the default values.
func NewItemUsageRightsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemUsageRightsRequestBuilder) {
    m := &ItemUsageRightsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/devices/{device%2Did}/usageRights{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemUsageRightsRequestBuilder instantiates a new UsageRightsRequestBuilder and sets the default values.
...
// Get retrieve a list of usageRight objects for a given device. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve a list of usageRight objects for a given device. This API is available in the following national cloud deployments.
