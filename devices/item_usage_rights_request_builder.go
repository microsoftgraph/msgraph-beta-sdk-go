...
func (m *ItemUsageRightsRequestBuilder) Count()(*ItemUsageRightsCountRequestBuilder) {
    return NewItemUsageRightsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation retrieve a list of usageRight objects for a given device.
func (m *ItemUsageRightsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemUsageRightsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
