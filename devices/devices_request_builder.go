...
// DevicesRequestBuilderGetQueryParameters retrieve a list of devices registered in the directory.  This API is available in the following national cloud deployments.
...
// Get retrieve a list of devices registered in the directory.  This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
func (m *DevicesRequestBuilder) GetUserOwnedObjects()(*GetUserOwnedObjectsRequestBuilder) {
...
// Post create a new device. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve a list of devices registered in the directory.  This API is available in the following national cloud deployments.
...
// ToPostRequestInformation create a new device. This API is available in the following national cloud deployments.
