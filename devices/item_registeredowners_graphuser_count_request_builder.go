...
func NewItemRegisteredownersGraphuserCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredownersGraphuserCountRequestBuilder) {
    m := &ItemRegisteredownersGraphuserCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredOwners/graph.user/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewItemRegisteredownersGraphuserCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredownersGraphuserCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemRegisteredownersGraphuserCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemRegisteredownersGraphuserCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredownersGraphuserCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemRegisteredownersGraphuserCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredownersGraphuserCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRegisteredownersGraphuserCountRequestBuilder) WithUrl(rawUrl string)(*ItemRegisteredownersGraphuserCountRequestBuilder) {
    return NewItemRegisteredownersGraphuserCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
