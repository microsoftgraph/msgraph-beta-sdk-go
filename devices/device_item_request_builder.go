...
func (m *DeviceItemRequestBuilder) CommandsById(id string)(*CommandItemRequestBuilder) {
...
func (m *DeviceItemRequestBuilder) UsageRightsById(id string)(*UsageRightItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
