...
func NewItemRegisteredusersGraphuserGraphUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredusersGraphuserGraphUserRequestBuilder) {
    m := &ItemRegisteredusersGraphuserGraphUserRequestBuilder{
...
func NewItemRegisteredusersGraphuserGraphUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredusersGraphuserGraphUserRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemRegisteredusersGraphuserGraphUserRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ItemRegisteredusersGraphuserCountRequestBuilder when successful
func (m *ItemRegisteredusersGraphuserGraphUserRequestBuilder) Count()(*ItemRegisteredusersGraphuserCountRequestBuilder) {
...
func (m *ItemRegisteredusersGraphuserGraphUserRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredusersGraphuserGraphUserRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserCollectionResponseable, error) {
...
func (m *ItemRegisteredusersGraphuserGraphUserRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredusersGraphuserGraphUserRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRegisteredusersGraphuserGraphUserRequestBuilder) WithUrl(rawUrl string)(*ItemRegisteredusersGraphuserGraphUserRequestBuilder) {
    return NewItemRegisteredusersGraphuserGraphUserRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
