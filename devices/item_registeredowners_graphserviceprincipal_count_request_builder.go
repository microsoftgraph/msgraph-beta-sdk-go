...
func NewItemRegisteredownersGraphserviceprincipalCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredownersGraphserviceprincipalCountRequestBuilder) {
    m := &ItemRegisteredownersGraphserviceprincipalCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredOwners/graph.servicePrincipal/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewItemRegisteredownersGraphserviceprincipalCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredownersGraphserviceprincipalCountRequestBuilder) {
    ...
    return NewItemRegisteredownersGraphserviceprincipalCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemRegisteredownersGraphserviceprincipalCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredownersGraphserviceprincipalCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemRegisteredownersGraphserviceprincipalCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredownersGraphserviceprincipalCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemRegisteredownersGraphserviceprincipalCountRequestBuilder) WithUrl(rawUrl string)(*ItemRegisteredownersGraphserviceprincipalCountRequestBuilder) {
    return NewItemRegisteredownersGraphserviceprincipalCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
