...
func (m *ItemTransitiveMemberOfCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTransitiveMemberOfCountRequestBuilderGetRequestConfiguration)(*int64, error) {
