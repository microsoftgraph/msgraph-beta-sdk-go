...
func (m *ItemRegisteredOwnersRequestBuilder) MicrosoftGraphEndpoint()(*ItemRegisteredOwnersMicrosoftGraphEndpointEndpointRequestBuilder) {
    return NewItemRegisteredOwnersMicrosoftGraphEndpointEndpointRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *ItemRegisteredOwnersRequestBuilder) MicrosoftGraphServicePrincipal()(*ItemRegisteredOwnersMicrosoftGraphServicePrincipalServicePrincipalRequestBuilder) {
    return NewItemRegisteredOwnersMicrosoftGraphServicePrincipalServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *ItemRegisteredOwnersRequestBuilder) MicrosoftGraphUser()(*ItemRegisteredOwnersMicrosoftGraphUserUserRequestBuilder) {
    return NewItemRegisteredOwnersMicrosoftGraphUserUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
