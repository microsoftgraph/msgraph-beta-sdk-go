...
// ItemMemberOfRequestBuilderGetQueryParameters get groups and administrative units that the device is a direct member of. This operation is not transitive.
