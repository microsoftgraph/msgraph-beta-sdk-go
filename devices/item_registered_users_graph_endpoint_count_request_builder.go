...
func (m *ItemRegisteredUsersGraphEndpointCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredUsersGraphEndpointCountRequestBuilderGetRequestConfiguration)(*int64, error) {
