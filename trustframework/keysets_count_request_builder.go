...
// NewKeysetsCountRequestBuilderInternal instantiates a new KeysetsCountRequestBuilder and sets the default values.
func NewKeysetsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*KeysetsCountRequestBuilder) {
    m := &KeysetsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/trustFramework/keySets/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewKeysetsCountRequestBuilder instantiates a new KeysetsCountRequestBuilder and sets the default values.
