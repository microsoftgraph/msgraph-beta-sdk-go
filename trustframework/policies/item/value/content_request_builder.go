...
// ContentRequestBuilder provides operations to manage the media for the trustFramework entity.
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/trustFramework/policies/{trustFrameworkPolicy%2Did}/$value";
...
// CreateGetRequestInformation get media content for the navigation property policies from trustFramework
...
// CreateGetRequestInformationWithRequestConfiguration get media content for the navigation property policies from trustFramework
...
// CreatePutRequestInformation update media content for the navigation property policies in trustFramework
...
// CreatePutRequestInformationWithRequestConfiguration update media content for the navigation property policies in trustFramework
...
// GetWithRequestConfigurationAndResponseHandler get media content for the navigation property policies from trustFramework
...
// PutWithRequestConfigurationAndResponseHandler update media content for the navigation property policies in trustFramework
