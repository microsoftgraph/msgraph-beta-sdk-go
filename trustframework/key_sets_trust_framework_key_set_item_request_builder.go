...
func NewKeySetsTrustFrameworkKeySetItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, trustFrameworkKeySetId *string)(*KeySetsTrustFrameworkKeySetItemRequestBuilder) {
...
func NewKeySetsTrustFrameworkKeySetItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*KeySetsTrustFrameworkKeySetItemRequestBuilder) {
    ...
    return NewKeySetsTrustFrameworkKeySetItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *KeySetsTrustFrameworkKeySetItemRequestBuilder) MicrosoftGraphGenerateKey()(*KeySetsItemMicrosoftGraphGenerateKeyGenerateKeyRequestBuilder) {
    return NewKeySetsItemMicrosoftGraphGenerateKeyGenerateKeyRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetActiveKey provides operations to call the getActiveKey method.
func (m *KeySetsTrustFrameworkKeySetItemRequestBuilder) MicrosoftGraphGetActiveKey()(*KeySetsItemMicrosoftGraphGetActiveKeyGetActiveKeyRequestBuilder) {
    return NewKeySetsItemMicrosoftGraphGetActiveKeyGetActiveKeyRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUploadCertificate provides operations to call the uploadCertificate method.
func (m *KeySetsTrustFrameworkKeySetItemRequestBuilder) MicrosoftGraphUploadCertificate()(*KeySetsItemMicrosoftGraphUploadCertificateUploadCertificateRequestBuilder) {
    return NewKeySetsItemMicrosoftGraphUploadCertificateUploadCertificateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUploadPkcs12 provides operations to call the uploadPkcs12 method.
func (m *KeySetsTrustFrameworkKeySetItemRequestBuilder) MicrosoftGraphUploadPkcs12()(*KeySetsItemMicrosoftGraphUploadPkcs12UploadPkcs12RequestBuilder) {
    return NewKeySetsItemMicrosoftGraphUploadPkcs12UploadPkcs12RequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUploadSecret provides operations to call the uploadSecret method.
func (m *KeySetsTrustFrameworkKeySetItemRequestBuilder) MicrosoftGraphUploadSecret()(*KeySetsItemMicrosoftGraphUploadSecretUploadSecretRequestBuilder) {
    return NewKeySetsItemMicrosoftGraphUploadSecretUploadSecretRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
