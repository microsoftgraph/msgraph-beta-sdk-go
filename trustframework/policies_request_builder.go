...
// PoliciesRequestBuilderGetQueryParameters retrieve a list of trustFrameworkPolicies in the tenant/directory. This API is supported in the following national cloud deployments.
...
func NewPoliciesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PoliciesRequestBuilder) {
    m := &PoliciesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/trustFramework/policies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get retrieve a list of trustFrameworkPolicies in the tenant/directory. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve a list of trustFrameworkPolicies in the tenant/directory. This API is supported in the following national cloud deployments.
