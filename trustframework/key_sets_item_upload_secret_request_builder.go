...
// NewKeySetsItemUploadSecretRequestBuilderInternal instantiates a new KeySetsItemUploadSecretRequestBuilder and sets the default values.
...
// NewKeySetsItemUploadSecretRequestBuilder instantiates a new KeySetsItemUploadSecretRequestBuilder and sets the default values.
...
// ToPostRequestInformation upload a plain text secret to a trustFrameworkKeyset. Examples of secrets are application secrets in Microsoft Entra ID, Google, Facebook, or any other identity provider. his method returns trustFrameworkKey.
