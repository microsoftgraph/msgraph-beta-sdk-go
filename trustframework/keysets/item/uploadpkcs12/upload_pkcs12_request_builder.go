...
func (m *UploadPkcs12RequestBuilder) CreatePostRequestInformation(body UploadPkcs12PostRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreatePostRequestInformationWithRequestConfiguration(body, nil);
}
// CreatePostRequestInformationWithRequestConfiguration invoke action uploadPkcs12
func (m *UploadPkcs12RequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body UploadPkcs12PostRequestBodyable, requestConfiguration *UploadPkcs12RequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UploadPkcs12RequestBuilder) Post(body UploadPkcs12PostRequestBodyable)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TrustFrameworkKeyable, error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action uploadPkcs12
func (m *UploadPkcs12RequestBuilder) PostWithRequestConfigurationAndResponseHandler(body UploadPkcs12PostRequestBodyable, requestConfiguration *UploadPkcs12RequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TrustFrameworkKeyable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateTrustFrameworkKeyFromDiscriminatorValue, responseHandler, errorMapping)
    if err != nil {
        return nil, err
    }
