...
// Builds and executes requests for operations under \trustFramework\keySets\{trustFrameworkKeySet-id}\microsoft.graph.uploadCertificate
...
type UploadCertificateRequestBuilderPostOptions struct {
    // 
    Body *UploadCertificateRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// Parameters:
//  - options : Options for the request
func (m *UploadCertificateRequestBuilder) Post(options *UploadCertificateRequestBuilderPostOptions)(*UploadCertificateResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewUploadCertificateResponse() }, nil)
    if err != nil {
        return nil, err
    }
