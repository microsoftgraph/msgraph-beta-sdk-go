...
func (m *UploadCertificateRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body UploadCertificateRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreatePostRequestInformationWithRequestConfiguration(body, nil);
}
// CreatePostRequestInformationWithRequestConfiguration invoke action uploadCertificate
func (m *UploadCertificateRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body UploadCertificateRequestBodyable, requestConfiguration *UploadCertificateRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action uploadCertificate
func (m *UploadCertificateRequestBuilder) PostWithResponseHandler(body UploadCertificateRequestBodyable, requestConfiguration *UploadCertificateRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TrustFrameworkKeyable, error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action uploadCertificate
func (m *UploadCertificateRequestBuilder) PostWithResponseHandler(body UploadCertificateRequestBodyable, requestConfiguration *UploadCertificateRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TrustFrameworkKeyable, error) {
