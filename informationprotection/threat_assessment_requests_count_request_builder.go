...
func (m *ThreatAssessmentRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatAssessmentRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
