...
type SublabelsRequestBuilderGetOptions struct {
    ...
    Q *SublabelsRequestBuilderGetQueryParameters;
...
func NewSublabelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SublabelsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/informationProtection/sensitivityLabels/{sensitivityLabel_id}/sublabels{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SublabelsRequestBuilder) Get(options *SublabelsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.SensitivityLabelCollectionResponseable, error) {
...
func (m *SublabelsRequestBuilder) Post(options *SublabelsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.SensitivityLabelable, error) {
