...
func (m *InformationProtectionRequestBuilder) MicrosoftGraphDecryptBuffer()(*MicrosoftGraphDecryptBufferRequestBuilder) {
    return NewMicrosoftGraphDecryptBufferRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEncryptBuffer provides operations to call the encryptBuffer method.
func (m *InformationProtectionRequestBuilder) MicrosoftGraphEncryptBuffer()(*MicrosoftGraphEncryptBufferRequestBuilder) {
    return NewMicrosoftGraphEncryptBufferRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSignDigest provides operations to call the signDigest method.
func (m *InformationProtectionRequestBuilder) MicrosoftGraphSignDigest()(*MicrosoftGraphSignDigestRequestBuilder) {
    return NewMicrosoftGraphSignDigestRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphVerifySignature provides operations to call the verifySignature method.
func (m *InformationProtectionRequestBuilder) MicrosoftGraphVerifySignature()(*MicrosoftGraphVerifySignatureRequestBuilder) {
    return NewMicrosoftGraphVerifySignatureRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
