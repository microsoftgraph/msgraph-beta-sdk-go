...
type RecoveryKeysRequestBuilderGetOptions struct {
    ...
    Q *RecoveryKeysRequestBuilderGetQueryParameters;
...
func (m *RecoveryKeysRequestBuilder) Get(options *RecoveryKeysRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.BitlockerRecoveryKeyCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateBitlockerRecoveryKeyCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.BitlockerRecoveryKeyCollectionResponseable), nil
}
// Post create new navigation property to recoveryKeys for informationProtection
func (m *RecoveryKeysRequestBuilder) Post(options *RecoveryKeysRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.BitlockerRecoveryKeyable, error) {
