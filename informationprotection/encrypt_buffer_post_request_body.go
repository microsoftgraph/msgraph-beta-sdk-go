...
func (m *EncryptBufferPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *EncryptBufferPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *EncryptBufferPostRequestBody) GetLabelId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID) {
...
func (m *EncryptBufferPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *EncryptBufferPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *EncryptBufferPostRequestBody) SetLabelId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)() {
    err := m.GetBackingStore().Set("labelId", value)
    if err != nil {
        panic(err)
    }
}
// EncryptBufferPostRequestBodyable 
type EncryptBufferPostRequestBodyable interface {
