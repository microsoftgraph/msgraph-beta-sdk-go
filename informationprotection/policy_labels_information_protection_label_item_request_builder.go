...
func (m *PolicyLabelsInformationProtectionLabelItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *PolicyLabelsInformationProtectionLabelItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
