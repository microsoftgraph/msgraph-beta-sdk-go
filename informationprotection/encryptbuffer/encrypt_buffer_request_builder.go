...
func (m *EncryptBufferRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body EncryptBufferRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreatePostRequestInformationWithRequestConfiguration(body, nil);
}
// CreatePostRequestInformationWithRequestConfiguration invoke action encryptBuffer
func (m *EncryptBufferRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body EncryptBufferRequestBodyable, requestConfiguration *EncryptBufferRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action encryptBuffer
func (m *EncryptBufferRequestBuilder) PostWithResponseHandler(body EncryptBufferRequestBodyable, requestConfiguration *EncryptBufferRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.BufferEncryptionResultable, error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action encryptBuffer
func (m *EncryptBufferRequestBuilder) PostWithResponseHandler(body EncryptBufferRequestBodyable, requestConfiguration *EncryptBufferRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.BufferEncryptionResultable, error) {
