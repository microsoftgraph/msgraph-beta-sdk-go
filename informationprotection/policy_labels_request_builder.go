...
// PolicyLabelsRequestBuilderGetQueryParameters get a collection of information protection labels available to the user or to the organization.
...
func (m *PolicyLabelsRequestBuilder) MicrosoftGraphEvaluateApplication()(*PolicyLabelsMicrosoftGraphEvaluateApplicationRequestBuilder) {
    return NewPolicyLabelsMicrosoftGraphEvaluateApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateClassificationResults provides operations to call the evaluateClassificationResults method.
func (m *PolicyLabelsRequestBuilder) MicrosoftGraphEvaluateClassificationResults()(*PolicyLabelsMicrosoftGraphEvaluateClassificationResultsRequestBuilder) {
    return NewPolicyLabelsMicrosoftGraphEvaluateClassificationResultsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateRemoval provides operations to call the evaluateRemoval method.
func (m *PolicyLabelsRequestBuilder) MicrosoftGraphEvaluateRemoval()(*PolicyLabelsMicrosoftGraphEvaluateRemovalRequestBuilder) {
    return NewPolicyLabelsMicrosoftGraphEvaluateRemovalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphExtractLabel provides operations to call the extractLabel method.
func (m *PolicyLabelsRequestBuilder) MicrosoftGraphExtractLabel()(*PolicyLabelsMicrosoftGraphExtractLabelRequestBuilder) {
    return NewPolicyLabelsMicrosoftGraphExtractLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
