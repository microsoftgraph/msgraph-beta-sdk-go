...
func (m *DataLossPreventionPoliciesRequestBuilder) MicrosoftGraphEvaluate()(*DataLossPreventionPoliciesMicrosoftGraphEvaluateRequestBuilder) {
    return NewDataLossPreventionPoliciesMicrosoftGraphEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
