...
// RoleInfoRequestBuilder builds and executes requests for operations under \privilegedRoleAssignments\{privilegedRoleAssignment-id}\roleInfo
...
// CreateDeleteRequestInformation read-only. Nullable. The associated role information.
...
// CreatePatchRequestInformation read-only. Nullable. The associated role information.
...
// Delete read-only. Nullable. The associated role information.
...
// Patch read-only. Nullable. The associated role information.
