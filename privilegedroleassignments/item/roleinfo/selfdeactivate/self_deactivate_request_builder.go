...
// SelfDeactivateRequestBuilder provides operations to call the selfDeactivate method.
...
// SelfDeactivateRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type SelfDeactivateRequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func NewSelfDeactivateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SelfDeactivateRequestBuilder) {
...
// NewSelfDeactivateRequestBuilder instantiates a new SelfDeactivateRequestBuilder and sets the default values.
func NewSelfDeactivateRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SelfDeactivateRequestBuilder) {
...
func (m *SelfDeactivateRequestBuilder) Post()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrivilegedRoleAssignmentable, error) {
    return m.PostWithRequestConfigurationAndResponseHandler(nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action selfDeactivate
func (m *SelfDeactivateRequestBuilder) PostWithRequestConfigurationAndResponseHandler(requestConfiguration *SelfDeactivateRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrivilegedRoleAssignmentable, error) {
