...
// NewItemRoleInfoSelfDeactivateRequestBuilderInternal instantiates a new ItemRoleInfoSelfDeactivateRequestBuilder and sets the default values.
func NewItemRoleInfoSelfDeactivateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRoleInfoSelfDeactivateRequestBuilder) {
    m := &ItemRoleInfoSelfDeactivateRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo/selfDeactivate", pathParameters),
    }
    return m
}
// NewItemRoleInfoSelfDeactivateRequestBuilder instantiates a new ItemRoleInfoSelfDeactivateRequestBuilder and sets the default values.
...
func (m *ItemRoleInfoSelfDeactivateRequestBuilder) WithUrl(rawUrl string)(*ItemRoleInfoSelfDeactivateRequestBuilder) {
    return NewItemRoleInfoSelfDeactivateRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
