...
// GetWithRequestConfigurationAndResponseHandler get entities from privilegedRoleAssignments
...
// PostWithRequestConfigurationAndResponseHandler add new entity to privilegedRoleAssignments
