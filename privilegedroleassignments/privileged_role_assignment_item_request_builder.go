...
func NewPrivilegedRoleAssignmentItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, privilegedRoleAssignmentId *string)(*PrivilegedRoleAssignmentItemRequestBuilder) {
...
func NewPrivilegedRoleAssignmentItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedRoleAssignmentItemRequestBuilder) {
    ...
    return NewPrivilegedRoleAssignmentItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
// MicrosoftGraphMakeEligible provides operations to call the makeEligible method.
func (m *PrivilegedRoleAssignmentItemRequestBuilder) MicrosoftGraphMakeEligible()(*ItemMicrosoftGraphMakeEligibleMakeEligibleRequestBuilder) {
    return NewItemMicrosoftGraphMakeEligibleMakeEligibleRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphMakePermanent provides operations to call the makePermanent method.
func (m *PrivilegedRoleAssignmentItemRequestBuilder) MicrosoftGraphMakePermanent()(*ItemMicrosoftGraphMakePermanentMakePermanentRequestBuilder) {
    return NewItemMicrosoftGraphMakePermanentMakePermanentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
