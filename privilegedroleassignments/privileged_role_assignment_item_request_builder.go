...
func (m *PrivilegedRoleAssignmentItemRequestBuilder) MicrosoftGraphMakeEligible()(*ItemMicrosoftGraphMakeEligibleRequestBuilder) {
    return NewItemMicrosoftGraphMakeEligibleRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphMakePermanent provides operations to call the makePermanent method.
func (m *PrivilegedRoleAssignmentItemRequestBuilder) MicrosoftGraphMakePermanent()(*ItemMicrosoftGraphMakePermanentRequestBuilder) {
    return NewItemMicrosoftGraphMakePermanentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
