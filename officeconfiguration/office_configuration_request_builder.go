...
func (m *OfficeConfigurationRequestBuilder) ClientConfigurationsById(id string)(*ClientConfigurationsOfficeClientConfigurationItemRequestBuilder) {
    ...
    idPtr := &id
    return NewClientConfigurationsOfficeClientConfigurationItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *OfficeConfigurationRequestBuilder) Get(ctx context.Context, requestConfiguration *OfficeConfigurationRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OfficeConfigurationable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateOfficeConfigurationFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
