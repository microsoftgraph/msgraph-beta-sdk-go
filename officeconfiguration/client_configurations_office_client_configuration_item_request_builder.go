...
func (m *ClientConfigurationsOfficeClientConfigurationItemRequestBuilder) MicrosoftGraphAssign()(*ClientConfigurationsItemMicrosoftGraphAssignRequestBuilder) {
    return NewClientConfigurationsItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
