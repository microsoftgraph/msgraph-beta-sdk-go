...
func (m *ClientConfigurationsOfficeClientConfigurationItemRequestBuilder) AssignmentsById(id string)(*ClientConfigurationsItemAssignmentsOfficeClientConfigurationAssignmentItemRequestBuilder) {
    ...
    idPtr := &id
    return NewClientConfigurationsItemAssignmentsOfficeClientConfigurationAssignmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewClientConfigurationsOfficeClientConfigurationItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, officeClientConfigurationId *string)(*ClientConfigurationsOfficeClientConfigurationItemRequestBuilder) {
    ...
    if officeClientConfigurationId != nil {
...
func NewClientConfigurationsOfficeClientConfigurationItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ClientConfigurationsOfficeClientConfigurationItemRequestBuilder) {
    ...
    return NewClientConfigurationsOfficeClientConfigurationItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ClientConfigurationsOfficeClientConfigurationItemRequestBuilder) MicrosoftGraphAssign()(*ClientConfigurationsItemMicrosoftGraphAssignAssignRequestBuilder) {
    return NewClientConfigurationsItemMicrosoftGraphAssignAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
