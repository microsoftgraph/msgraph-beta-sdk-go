...
func (m *ClientConfigurationsItemAssignPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *ClientConfigurationsItemAssignPostRequestBody) GetOfficeConfigurationAssignments()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OfficeClientConfigurationAssignmentable) {
    val, err := m.GetBackingStore().Get("officeConfigurationAssignments")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ClientConfigurationsItemAssignPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *ClientConfigurationsItemAssignPostRequestBody) SetOfficeConfigurationAssignments(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OfficeClientConfigurationAssignmentable)() {
    err := m.GetBackingStore().Set("officeConfigurationAssignments", value)
    if err != nil {
        panic(err)
    }
}
// ClientConfigurationsItemAssignPostRequestBodyable 
type ClientConfigurationsItemAssignPostRequestBodyable interface {
