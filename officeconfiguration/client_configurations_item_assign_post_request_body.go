...
// ClientConfigurationsItemAssignPostRequestBody provides operations to call the assign method.
...
func (m *ClientConfigurationsItemAssignPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ClientConfigurationsItemAssignPostRequestBody) SetAdditionalData(value map[string]interface{})() {
