...
func NewItemDomainNameReferencesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDomainNameReferencesCountRequestBuilder) {
    m := &ItemDomainNameReferencesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/domains/{domain%2Did}/domainNameReferences/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func (m *ItemDomainNameReferencesCountRequestBuilder) WithUrl(rawUrl string)(*ItemDomainNameReferencesCountRequestBuilder) {
    return NewItemDomainNameReferencesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
