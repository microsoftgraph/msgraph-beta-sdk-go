...
func (m *ItemFederationConfigurationCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemFederationConfigurationCountRequestBuilderGetRequestConfiguration)(*int64, error) {
