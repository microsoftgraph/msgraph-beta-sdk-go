...
import (
    ...
    ia7ac7d76266829146bfdd36c3c5ca1c83508112784505fda1e4c37fccee83e8a "github.com/microsoftgraph/msgraph-beta-sdk-go/domains/item/domainnamereferences/ref"
)
...
func NewDomainNameReferencesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DomainNameReferencesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/domains/{domain_id}/domainNameReferences{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *DomainNameReferencesRequestBuilder) Ref()(*ia7ac7d76266829146bfdd36c3c5ca1c83508112784505fda1e4c37fccee83e8a.RefRequestBuilder) {
    return ia7ac7d76266829146bfdd36c3c5ca1c83508112784505fda1e4c37fccee83e8a.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
