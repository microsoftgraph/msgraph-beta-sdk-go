...
func (m *DomainsDomainItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Domainable, requestConfiguration *DomainsDomainItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *DomainsDomainItemRequestBuilder) Get(ctx context.Context, requestConfiguration *DomainsDomainItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Domainable, error) {
...
func (m *DomainsDomainItemRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Domainable, requestConfiguration *DomainsDomainItemRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Domainable, error) {
...
func (m *DomainsDomainItemRequestBuilder) Promote()(*DomainsItemPromoteRequestBuilder) {
    return NewDomainsItemPromoteRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DomainsDomainItemRequestBuilder) SharedEmailDomainInvitations()(*DomainsItemSharedEmailDomainInvitationsRequestBuilder) {
    return NewDomainsItemSharedEmailDomainInvitationsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DomainsDomainItemRequestBuilder) SharedEmailDomainInvitationsById(id string)(*DomainsItemSharedEmailDomainInvitationsSharedEmailDomainInvitationItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewDomainsItemSharedEmailDomainInvitationsSharedEmailDomainInvitationItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
