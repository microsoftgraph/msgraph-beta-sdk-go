...
// NewItemSharedEmailDomainInvitationsRequestBuilder instantiates a new SharedEmailDomainInvitationsRequestBuilder and sets the default values.
...
func (m *ItemSharedEmailDomainInvitationsRequestBuilder) Count()(*ItemSharedEmailDomainInvitationsCountRequestBuilder) {
    return NewItemSharedEmailDomainInvitationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get sharedEmailDomainInvitations from domains
func (m *ItemSharedEmailDomainInvitationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemSharedEmailDomainInvitationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
