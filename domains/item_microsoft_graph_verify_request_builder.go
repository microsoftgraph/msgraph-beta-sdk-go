...
func NewItemMicrosoftGraphVerifyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphVerifyRequestBuilder) {
    m := &ItemMicrosoftGraphVerifyRequestBuilder{
    }
...
func NewItemMicrosoftGraphVerifyRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphVerifyRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemMicrosoftGraphVerifyRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemMicrosoftGraphVerifyRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemMicrosoftGraphVerifyRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Domainable, error) {
...
func (m *ItemMicrosoftGraphVerifyRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *ItemMicrosoftGraphVerifyRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
