...
func (m *ItemSharedEmailDomainInvitationsSharedEmailDomainInvitationItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemSharedEmailDomainInvitationsSharedEmailDomainInvitationItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
