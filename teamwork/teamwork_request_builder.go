...
func (m *TeamworkRequestBuilder) DeletedTeamsById(id string)(*DeletedTeamsDeletedTeamItemRequestBuilder) {
    ...
    idPtr := &id
    return NewDeletedTeamsDeletedTeamItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *TeamworkRequestBuilder) DevicesById(id string)(*DevicesTeamworkDeviceItemRequestBuilder) {
    ...
    idPtr := &id
    return NewDevicesTeamworkDeviceItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
// Get get teamwork
...
func (m *TeamworkRequestBuilder) TeamTemplatesById(id string)(*TeamTemplatesTeamTemplateItemRequestBuilder) {
    ...
    idPtr := &id
    return NewTeamTemplatesTeamTemplateItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
