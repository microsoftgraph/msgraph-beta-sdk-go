...
// TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsRequestBuilderGetQueryParameters retrieve the list of channels in this team. This API is supported in the following national cloud deployments.
