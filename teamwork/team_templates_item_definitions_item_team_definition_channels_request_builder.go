...
// NewTeamTemplatesItemDefinitionsItemTeamDefinitionChannelsRequestBuilder instantiates a new ChannelsRequestBuilder and sets the default values.
...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsRequestBuilder) Count()(*TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsCountRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionChannelsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsRequestBuilder) MicrosoftGraphAllMessages()(*TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsMicrosoftGraphAllMessagesAllMessagesRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionChannelsMicrosoftGraphAllMessagesAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetAllMessages provides operations to call the getAllMessages method.
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsRequestBuilder) MicrosoftGraphGetAllMessages()(*TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionChannelsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
