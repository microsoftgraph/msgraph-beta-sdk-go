...
func (m *DeletedTeamsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedTeamsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
