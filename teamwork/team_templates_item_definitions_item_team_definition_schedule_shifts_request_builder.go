...
// TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleShiftsRequestBuilderGetQueryParameters get the list of shift instances in a schedule. This API is available in the following national cloud deployments.
