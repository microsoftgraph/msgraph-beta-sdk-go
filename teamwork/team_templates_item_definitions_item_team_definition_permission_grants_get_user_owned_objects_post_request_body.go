...
// TeamTemplatesItemDefinitionsItemTeamDefinitionPermissionGrantsGetUserOwnedObjectsPostRequestBody provides operations to call the getUserOwnedObjects method.
...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionPermissionGrantsGetUserOwnedObjectsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionPermissionGrantsGetUserOwnedObjectsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
