...
// DevicesRequestBuilderGetQueryParameters get a list of all Microsoft Teams-enabled devices provisioned for a tenant. This API is available in the following national cloud deployments.
...
// Get get a list of all Microsoft Teams-enabled devices provisioned for a tenant. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get a list of all Microsoft Teams-enabled devices provisioned for a tenant. This API is available in the following national cloud deployments.
