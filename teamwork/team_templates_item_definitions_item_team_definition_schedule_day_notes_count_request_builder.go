...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleDayNotesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleDayNotesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
