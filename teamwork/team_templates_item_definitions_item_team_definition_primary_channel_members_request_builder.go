...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionPrimaryChannelMembersRequestBuilder) MicrosoftGraphAdd()(*TeamTemplatesItemDefinitionsItemTeamDefinitionPrimaryChannelMembersMicrosoftGraphAddRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionPrimaryChannelMembersMicrosoftGraphAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
