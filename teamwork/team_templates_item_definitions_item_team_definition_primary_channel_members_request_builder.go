...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionPrimaryChannelMembersRequestBuilder) MicrosoftGraphAdd()(*TeamTemplatesItemDefinitionsItemTeamDefinitionPrimaryChannelMembersMicrosoftGraphAddAddRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionPrimaryChannelMembersMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
