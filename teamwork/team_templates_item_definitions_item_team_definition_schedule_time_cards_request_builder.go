...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsRequestBuilder) MicrosoftGraphClockIn()(*TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsMicrosoftGraphClockInClockInRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsMicrosoftGraphClockInClockInRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
