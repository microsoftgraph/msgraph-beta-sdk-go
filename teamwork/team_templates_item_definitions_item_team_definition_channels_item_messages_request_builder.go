...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMessagesRequestBuilder) MicrosoftGraphDelta()(*TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMessagesMicrosoftGraphDeltaRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMessagesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
