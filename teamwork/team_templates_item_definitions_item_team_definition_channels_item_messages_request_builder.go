...
// TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMessagesRequestBuilderGetQueryParameters a collection of all the messages in the channel. Nullable.
...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMessagesRequestBuilder) ForwardToChat()(*TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMessagesForwardToChatRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMessagesForwardToChatRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMessagesRequestBuilder) ReplyWithQuote()(*TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMessagesReplyWithQuoteRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMessagesReplyWithQuoteRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
