...
// DeletedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody provides operations to call the setReaction method.
...
func (m *DeletedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *DeletedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
