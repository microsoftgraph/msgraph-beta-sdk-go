...
// TeamTemplatesItemDefinitionsItemTeamDefinitionPermissionGrantsItemCheckMemberGroupsPostRequestBody provides operations to call the checkMemberGroups method.
