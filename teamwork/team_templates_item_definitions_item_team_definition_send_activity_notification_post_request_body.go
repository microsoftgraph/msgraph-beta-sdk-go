...
// returns a *string when successful
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionSendActivityNotificationPostRequestBody) GetIconId()(*string) {
...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionSendActivityNotificationPostRequestBody) SetIconId(value *string)() {
