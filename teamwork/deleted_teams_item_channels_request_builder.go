...
func (m *DeletedTeamsItemChannelsRequestBuilder) MicrosoftGraphAllMessages()(*DeletedTeamsItemChannelsMicrosoftGraphAllMessagesRequestBuilder) {
    return NewDeletedTeamsItemChannelsMicrosoftGraphAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
