...
// OpenShiftsRequestBuilderGetQueryParameters get openShifts from teamwork
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to openShifts for teamwork
