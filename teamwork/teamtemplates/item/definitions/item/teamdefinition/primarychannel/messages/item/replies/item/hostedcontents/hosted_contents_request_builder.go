...
import (
    ...
    i113d6c19e21e616be7daa6586b8800c9e5878e8d4caa13dc7c127c080bb093cf "github.com/microsoftgraph/msgraph-beta-sdk-go/teamwork/teamtemplates/item/definitions/item/teamdefinition/primarychannel/messages/item/replies/item/hostedcontents/count"
)
...
func NewHostedContentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*HostedContentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *HostedContentsRequestBuilder) Count()(*i113d6c19e21e616be7daa6586b8800c9e5878e8d4caa13dc7c127c080bb093cf.CountRequestBuilder) {
    return i113d6c19e21e616be7daa6586b8800c9e5878e8d4caa13dc7c127c080bb093cf.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
