...
import (
    ...
    i2eada79f347a27dcfaef1a41818f6c114c89ef9d65b9a0ba079a4f65903687d8 "github.com/microsoftgraph/msgraph-beta-sdk-go/teamwork/teamtemplates/item/definitions/item/teamdefinition/primarychannel/sharedwithteams/item/allowedmembers/count"
)
...
func NewAllowedMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AllowedMembersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AllowedMembersRequestBuilder) Count()(*i2eada79f347a27dcfaef1a41818f6c114c89ef9d65b9a0ba079a4f65903687d8.CountRequestBuilder) {
    return i2eada79f347a27dcfaef1a41818f6c114c89ef9d65b9a0ba079a4f65903687d8.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AllowedMembersRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *AllowedMembersRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
