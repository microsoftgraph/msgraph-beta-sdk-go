...
func NewDeletedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder) {
    m := &DeletedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder{
    }
...
func NewDeletedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder) {
    ...
    return NewDeletedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilderInternal(urlParams, requestAdapter)
}
// Get invoke function delta
func (m *DeletedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilderGetRequestConfiguration)(DeletedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaDeltaResponseable, error) {
...
func (m *DeletedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
