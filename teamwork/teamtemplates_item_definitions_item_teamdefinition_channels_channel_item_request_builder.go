...
func (m *TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsChannelItemRequestBuilder) CompleteMigration()(*TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemCompletemigrationCompleteMigrationRequestBuilder) {
    return NewTeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemCompletemigrationCompleteMigrationRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsChannelItemRequestBuilder) DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName()(*TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemDoesuserhaveaccessuseriduseridtenantidtenantiduserprincipalnameuserprincipalnameDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder) {
    return NewTeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemDoesuserhaveaccessuseriduseridtenantidtenantiduserprincipalnameuserprincipalnameDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsChannelItemRequestBuilder) FilesFolder()(*TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemFilesfolderFilesFolderRequestBuilder) {
    return NewTeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemFilesfolderFilesFolderRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsChannelItemRequestBuilder) ProvisionEmail()(*TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemProvisionemailProvisionEmailRequestBuilder) {
    return NewTeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemProvisionemailProvisionEmailRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsChannelItemRequestBuilder) RemoveEmail()(*TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemRemoveemailRemoveEmailRequestBuilder) {
    return NewTeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemRemoveemailRemoveEmailRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsChannelItemRequestBuilder) SharedWithTeams()(*TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemSharedwithteamsSharedWithTeamsRequestBuilder) {
    return NewTeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemSharedwithteamsSharedWithTeamsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
