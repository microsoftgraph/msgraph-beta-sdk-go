...
func (m *TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemSharedwithteamsSharedWithChannelTeamInfoItemRequestBuilder) AllowedMembers()(*TeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemSharedwithteamsItemAllowedmembersAllowedMembersRequestBuilder) {
    return NewTeamtemplatesItemDefinitionsItemTeamdefinitionChannelsItemSharedwithteamsItemAllowedmembersAllowedMembersRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
