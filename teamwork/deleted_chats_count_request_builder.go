...
func (m *DeletedChatsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedChatsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
