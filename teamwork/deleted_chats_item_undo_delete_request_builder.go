...
// Post restore a  deletedChat to an active chat. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation restore a  deletedChat to an active chat. This API is available in the following national cloud deployments.
