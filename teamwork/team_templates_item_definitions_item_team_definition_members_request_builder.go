...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionMembersRequestBuilder) MicrosoftGraphAdd()(*TeamTemplatesItemDefinitionsItemTeamDefinitionMembersMicrosoftGraphAddRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionMembersMicrosoftGraphAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
