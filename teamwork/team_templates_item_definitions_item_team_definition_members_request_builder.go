...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionMembersRequestBuilder) MicrosoftGraphAdd()(*TeamTemplatesItemDefinitionsItemTeamDefinitionMembersMicrosoftGraphAddAddRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionMembersMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
