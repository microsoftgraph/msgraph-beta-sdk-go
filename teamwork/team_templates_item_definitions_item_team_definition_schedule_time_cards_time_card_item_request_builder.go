...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphClockOut()(*TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphClockOutRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphClockOutRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphConfirm provides operations to call the confirm method.
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphConfirm()(*TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphConfirmRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphConfirmRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEndBreak provides operations to call the endBreak method.
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphEndBreak()(*TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphEndBreakRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphEndBreakRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphStartBreak provides operations to call the startBreak method.
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphStartBreak()(*TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphStartBreakRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphStartBreakRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
