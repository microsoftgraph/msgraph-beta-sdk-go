...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleRequestBuilder) MicrosoftGraphShare()(*TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleMicrosoftGraphShareRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleMicrosoftGraphShareRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
