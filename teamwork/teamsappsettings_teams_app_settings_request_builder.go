...
// TeamsappsettingsTeamsAppSettingsRequestBuilderGetQueryParameters read the properties and relationships of a teamsAppSettings object.
...
func NewTeamsappsettingsTeamsAppSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamsappsettingsTeamsAppSettingsRequestBuilder) {
    m := &TeamsappsettingsTeamsAppSettingsRequestBuilder{
...
func NewTeamsappsettingsTeamsAppSettingsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamsappsettingsTeamsAppSettingsRequestBuilder) {
    ...
    return NewTeamsappsettingsTeamsAppSettingsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *TeamsappsettingsTeamsAppSettingsRequestBuilder) Get(ctx context.Context, requestConfiguration *TeamsappsettingsTeamsAppSettingsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamsAppSettingsable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateTeamsAppSettingsFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *TeamsappsettingsTeamsAppSettingsRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamsAppSettingsable, requestConfiguration *TeamsappsettingsTeamsAppSettingsRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamsAppSettingsable, error) {
...
func (m *TeamsappsettingsTeamsAppSettingsRequestBuilder) WithUrl(rawUrl string)(*TeamsappsettingsTeamsAppSettingsRequestBuilder) {
    return NewTeamsappsettingsTeamsAppSettingsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
