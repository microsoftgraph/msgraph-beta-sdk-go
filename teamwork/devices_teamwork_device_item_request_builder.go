...
func (m *DevicesTeamworkDeviceItemRequestBuilder) Get(ctx context.Context, requestConfiguration *DevicesTeamworkDeviceItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkDeviceable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateTeamworkDeviceFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *DevicesTeamworkDeviceItemRequestBuilder) MicrosoftGraphRestart()(*DevicesItemMicrosoftGraphRestartRequestBuilder) {
    return NewDevicesItemMicrosoftGraphRestartRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRunDiagnostics provides operations to call the runDiagnostics method.
func (m *DevicesTeamworkDeviceItemRequestBuilder) MicrosoftGraphRunDiagnostics()(*DevicesItemMicrosoftGraphRunDiagnosticsRequestBuilder) {
    return NewDevicesItemMicrosoftGraphRunDiagnosticsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUpdateSoftware provides operations to call the updateSoftware method.
func (m *DevicesTeamworkDeviceItemRequestBuilder) MicrosoftGraphUpdateSoftware()(*DevicesItemMicrosoftGraphUpdateSoftwareRequestBuilder) {
    return NewDevicesItemMicrosoftGraphUpdateSoftwareRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// ToGetRequestInformation the Teams devices provisioned for the tenant.
