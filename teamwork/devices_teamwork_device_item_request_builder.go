...
func (m *DevicesTeamworkDeviceItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *DevicesTeamworkDeviceItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
