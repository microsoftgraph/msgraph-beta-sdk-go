...
// ByWorkforceIntegrationIdString provides operations to manage the workforceIntegrations property of the microsoft.graph.teamwork entity.
func (m *WorkforceIntegrationsRequestBuilder) ByWorkforceIntegrationIdString(workforceIntegrationId string)(*WorkforceIntegrationsWorkforceIntegrationItemRequestBuilder) {
