...
func (m *DeletedTeamsItemChannelsItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphSetReaction()(*DeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSetReactionRequestBuilder) {
    return NewDeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *DeletedTeamsItemChannelsItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphUnsetReaction()(*DeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphUnsetReactionRequestBuilder) {
    return NewDeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphUnsetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
