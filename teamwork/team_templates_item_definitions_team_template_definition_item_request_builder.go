...
// TeamTemplatesItemDefinitionsTeamTemplateDefinitionItemRequestBuilderGetQueryParameters read the properties and relationships of a teamTemplateDefinition object. This API is available in the following national cloud deployments.
...
func NewTeamTemplatesItemDefinitionsTeamTemplateDefinitionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamTemplatesItemDefinitionsTeamTemplateDefinitionItemRequestBuilder) {
    m := &TeamTemplatesItemDefinitionsTeamTemplateDefinitionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get read the properties and relationships of a teamTemplateDefinition object. This API is available in the following national cloud deployments.
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/teamtemplatedefinition-get?view=graph-rest-1.0
...
func (m *TeamTemplatesItemDefinitionsTeamTemplateDefinitionItemRequestBuilder) TeamDefinition()(*TeamTemplatesItemDefinitionsItemTeamDefinitionRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// ToGetRequestInformation read the properties and relationships of a teamTemplateDefinition object. This API is available in the following national cloud deployments.
