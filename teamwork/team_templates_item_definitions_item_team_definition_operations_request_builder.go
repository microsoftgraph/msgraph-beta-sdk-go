...
// NewTeamTemplatesItemDefinitionsItemTeamDefinitionOperationsRequestBuilderInternal instantiates a new OperationsRequestBuilder and sets the default values.
...
// NewTeamTemplatesItemDefinitionsItemTeamDefinitionOperationsRequestBuilder instantiates a new OperationsRequestBuilder and sets the default values.
...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionOperationsRequestBuilder) Count()(*TeamTemplatesItemDefinitionsItemTeamDefinitionOperationsCountRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionOperationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the async operations that ran or are running on this team.
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionOperationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *TeamTemplatesItemDefinitionsItemTeamDefinitionOperationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
