...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionPrimaryChannelMessagesRequestBuilder) MicrosoftGraphDelta()(*TeamTemplatesItemDefinitionsItemTeamDefinitionPrimaryChannelMessagesMicrosoftGraphDeltaRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionPrimaryChannelMessagesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
