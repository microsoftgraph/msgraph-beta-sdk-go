...
// TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleShareRequestBuilder provides operations to call the share method.
type TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleShareRequestBuilder struct {
...
// TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleShareRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleShareRequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleShareRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleShareRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/microsoft.graph.share";
...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleShareRequestBuilder) Post(ctx context.Context, body TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleSharePostRequestBodyable, requestConfiguration *TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleShareRequestBuilderPostRequestConfiguration)(error) {
