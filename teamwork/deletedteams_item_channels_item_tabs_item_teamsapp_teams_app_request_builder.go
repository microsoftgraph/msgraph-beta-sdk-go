...
// DeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilderGetQueryParameters the application that is linked to the tab.
...
func NewDeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilder) {
    m := &DeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilder{
...
func NewDeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilder) {
    ...
    return NewDeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilderInternal(urlParams, requestAdapter)
}
// Get the application that is linked to the tab.
// returns a TeamsAppable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *DeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamsAppable, error) {
...
func (m *DeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilder) WithUrl(rawUrl string)(*DeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilder) {
    return NewDeletedteamsItemChannelsItemTabsItemTeamsappTeamsAppRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
