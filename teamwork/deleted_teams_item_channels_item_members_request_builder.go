...
func (m *DeletedTeamsItemChannelsItemMembersRequestBuilder) MicrosoftGraphAdd()(*DeletedTeamsItemChannelsItemMembersMicrosoftGraphAddAddRequestBuilder) {
    return NewDeletedTeamsItemChannelsItemMembersMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
