...
// NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsClockInRequestBuilderInternal instantiates a new TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsClockInRequestBuilder and sets the default values.
...
// NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsClockInRequestBuilder instantiates a new TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsClockInRequestBuilder and sets the default values.
...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsClockInRequestBuilder) WithUrl(rawUrl string)(*TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsClockInRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleTimeCardsClockInRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
