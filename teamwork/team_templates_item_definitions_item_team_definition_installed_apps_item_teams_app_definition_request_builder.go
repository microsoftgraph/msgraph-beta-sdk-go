...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionInstalledAppsItemTeamsAppDefinitionRequestBuilder) WithUrl(rawUrl string)(*TeamTemplatesItemDefinitionsItemTeamDefinitionInstalledAppsItemTeamsAppDefinitionRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionInstalledAppsItemTeamsAppDefinitionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
