...
// DeletedChatsDeletedChatItemRequestBuilderGetQueryParameters read the properties and relationships of a deletedChat object. This API is supported in the following national cloud deployments.
...
// NewDeletedChatsDeletedChatItemRequestBuilderInternal instantiates a new DeletedChatItemRequestBuilder and sets the default values.
func NewDeletedChatsDeletedChatItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedChatsDeletedChatItemRequestBuilder) {
    m := &DeletedChatsDeletedChatItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teamwork/deletedChats/{deletedChat%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewDeletedChatsDeletedChatItemRequestBuilder instantiates a new DeletedChatItemRequestBuilder and sets the default values.
...
func (m *DeletedChatsDeletedChatItemRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeletedChatable, requestConfiguration *DeletedChatsDeletedChatItemRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeletedChatable, error) {
