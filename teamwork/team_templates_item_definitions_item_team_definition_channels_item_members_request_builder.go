...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMembersRequestBuilder) Remove()(*TeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMembersRemoveRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionChannelsItemMembersRemoveRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
