...
func NewDeletedTeamsItemChannelsItemMessagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsItemMessagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DeletedTeamsItemChannelsItemMessagesRequestBuilder) MicrosoftGraphDelta()(*DeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewDeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
