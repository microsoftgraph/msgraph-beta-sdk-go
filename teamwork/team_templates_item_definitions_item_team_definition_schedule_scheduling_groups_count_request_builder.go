...
// NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleSchedulingGroupsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleSchedulingGroupsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleSchedulingGroupsCountRequestBuilder) {
    m := &TeamTemplatesItemDefinitionsItemTeamDefinitionScheduleSchedulingGroupsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/schedulingGroups/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewTeamTemplatesItemDefinitionsItemTeamDefinitionScheduleSchedulingGroupsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
