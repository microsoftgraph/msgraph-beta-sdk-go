...
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionRequestBuilder) MicrosoftGraphArchive()(*TeamTemplatesItemDefinitionsItemTeamDefinitionMicrosoftGraphArchiveRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionMicrosoftGraphArchiveRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphClone provides operations to call the clone method.
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionRequestBuilder) MicrosoftGraphClone()(*TeamTemplatesItemDefinitionsItemTeamDefinitionMicrosoftGraphCloneRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionMicrosoftGraphCloneRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCompleteMigration provides operations to call the completeMigration method.
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionRequestBuilder) MicrosoftGraphCompleteMigration()(*TeamTemplatesItemDefinitionsItemTeamDefinitionMicrosoftGraphCompleteMigrationRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionMicrosoftGraphCompleteMigrationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSendActivityNotification provides operations to call the sendActivityNotification method.
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionRequestBuilder) MicrosoftGraphSendActivityNotification()(*TeamTemplatesItemDefinitionsItemTeamDefinitionMicrosoftGraphSendActivityNotificationRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionMicrosoftGraphSendActivityNotificationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnarchive provides operations to call the unarchive method.
func (m *TeamTemplatesItemDefinitionsItemTeamDefinitionRequestBuilder) MicrosoftGraphUnarchive()(*TeamTemplatesItemDefinitionsItemTeamDefinitionMicrosoftGraphUnarchiveRequestBuilder) {
    return NewTeamTemplatesItemDefinitionsItemTeamDefinitionMicrosoftGraphUnarchiveRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
