...
func (m *ItemCreateLinkPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemCreateLinkPostRequestBody) GetRecipients()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveRecipientable) {
    return m.recipients
}
...
func (m *ItemCreateLinkPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ItemCreateLinkPostRequestBody) SetRecipients(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveRecipientable)() {
    m.recipients = value
}
