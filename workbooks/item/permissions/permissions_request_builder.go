...
// PermissionsRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\permissions
...
// CreatePostRequestInformation the set of permissions for the item. Read-only. Nullable.
...
func (m *PermissionsRequestBuilder) Get(options *PermissionsRequestBuilderGetOptions)(*PermissionsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewPermissionsResponse() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*PermissionsResponse), nil
}
// Post the set of permissions for the item. Read-only. Nullable.
func (m *PermissionsRequestBuilder) Post(options *PermissionsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Permission, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewPermission() }, nil)
    if err != nil {
        return nil, err
    }
