...
func NewPermissionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PermissionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/permissions/{permission_id}{?select,expand}";
...
func (m *PermissionRequestBuilder) RevokeGrants()(*i444f9b90bf907ea4b59894eb60588a42ef38ce2d7617ab3e9213ea49cf7fd7a6.RevokeGrantsRequestBuilder) {
