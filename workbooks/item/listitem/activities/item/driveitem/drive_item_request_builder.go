...
import (
    ...
    ieb08e66281e972e7288d6855f4b9fabbae9dd9459e70715fa29df46c8b15a7c3 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/listitem/activities/item/driveitem/content"
)

// driveItemRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\listItem\activities\{itemActivityOLD-id}\driveItem
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*ieb08e66281e972e7288d6855f4b9fabbae9dd9459e70715fa29df46c8b15a7c3.ContentRequestBuilder) {
    return ieb08e66281e972e7288d6855f4b9fabbae9dd9459e70715fa29df46c8b15a7c3.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
