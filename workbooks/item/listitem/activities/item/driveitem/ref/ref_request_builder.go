...
// RefRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\listItem\activities\{itemActivityOLD-id}\driveItem\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property driveItem for workbooks
...
// CreateGetRequestInformation get ref of driveItem from workbooks
...
// CreatePutRequestInformation update the ref of navigation property driveItem in workbooks
...
// Delete delete ref of navigation property driveItem for workbooks
...
// Get get ref of driveItem from workbooks
...
// Put update the ref of navigation property driveItem in workbooks
