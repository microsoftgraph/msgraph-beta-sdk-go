...
// DeleteWithResponseHandler delete navigation property activities for workbooks
...
// PatchWithResponseHandler update the navigation property activities in workbooks
