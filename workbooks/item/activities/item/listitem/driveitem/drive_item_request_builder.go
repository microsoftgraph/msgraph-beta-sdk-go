...
import (
    ...
    iad241370a01528e05e8b1dd5f59dc4193da53e42d7aba66b407ca6e24c894f43 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/activities/item/listitem/driveitem/content"
)

// DriveItemRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\activities\{itemActivityOLD-id}\listItem\driveItem
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/activities/{itemActivityOLD_id}/listItem/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*iad241370a01528e05e8b1dd5f59dc4193da53e42d7aba66b407ca6e24c894f43.ContentRequestBuilder) {
    return iad241370a01528e05e8b1dd5f59dc4193da53e42d7aba66b407ca6e24c894f43.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
