...
import (
    ...
    ic30d9446ea7cbf31aff61040b10f3f541983b6e057a219f52d69bc02812494cc "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/activities/item/listitem/analytics/ref"
)

// AnalyticsRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\activities\{itemActivityOLD-id}\listItem\analytics
...
func NewAnalyticsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AnalyticsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/activities/{itemActivityOLD_id}/listItem/analytics{?select,expand}";
...
func (m *AnalyticsRequestBuilder) Ref()(*ic30d9446ea7cbf31aff61040b10f3f541983b6e057a219f52d69bc02812494cc.RefRequestBuilder) {
    return ic30d9446ea7cbf31aff61040b10f3f541983b6e057a219f52d69bc02812494cc.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
