...
// activitiesRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\activities\{itemActivityOLD-id}\listItem\activities
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/activities/{itemActivityOLD_id}/listItem/activities{?top,skip,search,filter,count,orderby,select,expand}";
