...
import (
    ...
    i895dba4b0f49096b7366e3e01504f359d0a2b6bb3753a2ac5a72a0fb6196f994 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/activities/item/listitem/versions/item/fields"
    ibb90720ceb41f980e92a95898dad38c67a8f0bb4592f932a8e3b2e3c464dd262 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/activities/item/listitem/versions/item/restoreversion"
)

// ListItemVersionRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\activities\{itemActivityOLD-id}\listItem\versions\{listItemVersion-id}
...
func NewListItemVersionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ListItemVersionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/activities/{itemActivityOLD_id}/listItem/versions/{listItemVersion_id}{?select,expand}";
...
func (m *ListItemVersionRequestBuilder) Fields()(*i895dba4b0f49096b7366e3e01504f359d0a2b6bb3753a2ac5a72a0fb6196f994.FieldsRequestBuilder) {
    return i895dba4b0f49096b7366e3e01504f359d0a2b6bb3753a2ac5a72a0fb6196f994.NewFieldsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ListItemVersionRequestBuilder) RestoreVersion()(*ibb90720ceb41f980e92a95898dad38c67a8f0bb4592f932a8e3b2e3c464dd262.RestoreVersionRequestBuilder) {
    return ibb90720ceb41f980e92a95898dad38c67a8f0bb4592f932a8e3b2e3c464dd262.NewRestoreVersionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
