...
// Builds and executes requests for operations under \workbooks\{driveItem-id}\activities\{itemActivityOLD-id}\listItem\versions\{listItemVersion-id}\microsoft.graph.restoreVersion
