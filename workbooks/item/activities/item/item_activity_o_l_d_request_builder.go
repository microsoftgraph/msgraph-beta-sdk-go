...
import (
    ...
    i3613166bce60a3cabbe76ba8ab7da37a4da864aa8cef6a1ee3972b59218c431a "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/activities/item/driveitem"
    i4e948f29e1cdddf70ae82baabea716830bdb6b6fad5c0c024f42fa8dce636899 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/activities/item/listitem"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\activities\{itemActivityOLD-id}
...
func NewItemActivityOLDRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ItemActivityOLDRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/activities/{itemActivityOLD_id}{?select,expand}";
...
func (m *ItemActivityOLDRequestBuilder) DriveItem()(*i3613166bce60a3cabbe76ba8ab7da37a4da864aa8cef6a1ee3972b59218c431a.DriveItemRequestBuilder) {
    return i3613166bce60a3cabbe76ba8ab7da37a4da864aa8cef6a1ee3972b59218c431a.NewDriveItemRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The list of recent activities that took place on this item.
// Parameters:
//  - options : Options for the request
...
func (m *ItemActivityOLDRequestBuilder) ListItem()(*i4e948f29e1cdddf70ae82baabea716830bdb6b6fad5c0c024f42fa8dce636899.ListItemRequestBuilder) {
    return i4e948f29e1cdddf70ae82baabea716830bdb6b6fad5c0c024f42fa8dce636899.NewListItemRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The list of recent activities that took place on this item.
// Parameters:
//  - options : Options for the request
