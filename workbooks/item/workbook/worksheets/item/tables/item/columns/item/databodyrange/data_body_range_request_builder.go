...
// DataBodyRangeRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\tables\{workbookTable-id}\columns\{workbookTableColumn-id}\microsoft.graph.dataBodyRange()
...
// DataBodyRangeRequestBuilderGetOptions options for Get
type DataBodyRangeRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// DataBodyRangeResponse union type wrapper for classes workbookRange
...
// NewDataBodyRangeResponse instantiates a new dataBodyRangeResponse and sets the default values.
...
// NewDataBodyRangeRequestBuilderInternal instantiates a new DataBodyRangeRequestBuilder and sets the default values.
func NewDataBodyRangeRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DataBodyRangeRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/tables/{workbookTable_id}/columns/{workbookTableColumn_id}/microsoft.graph.dataBodyRange()";
...
// NewDataBodyRangeRequestBuilder instantiates a new DataBodyRangeRequestBuilder and sets the default values.
...
// CreateGetRequestInformation invoke function dataBodyRange
func (m *DataBodyRangeRequestBuilder) CreateGetRequestInformation(options *DataBodyRangeRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *DataBodyRangeRequestBuilder) Get(options *DataBodyRangeRequestBuilderGetOptions)(*DataBodyRangeResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewDataBodyRangeResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
