...
// HeaderRowRangeRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\tables\{workbookTable-id}\columns\{workbookTableColumn-id}\microsoft.graph.headerRowRange()
...
// HeaderRowRangeRequestBuilderGetOptions options for Get
...
// HeaderRowRangeResponse union type wrapper for classes workbookRange
...
// NewHeaderRowRangeResponse instantiates a new headerRowRangeResponse and sets the default values.
...
func (m *HeaderRowRangeResponse) GetWorkbookRange()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookRange) {
    if m == nil {
        return nil
    } else {
...
func (m *HeaderRowRangeResponse) SetWorkbookRange(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookRange)() {
    if m != nil {
        m.workbookRange = value
    }
}
// NewHeaderRowRangeRequestBuilderInternal instantiates a new HeaderRowRangeRequestBuilder and sets the default values.
func NewHeaderRowRangeRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HeaderRowRangeRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/tables/{workbookTable_id}/columns/{workbookTableColumn_id}/microsoft.graph.headerRowRange()";
...
// NewHeaderRowRangeRequestBuilder instantiates a new HeaderRowRangeRequestBuilder and sets the default values.
...
// CreateGetRequestInformation invoke function headerRowRange
...
func (m *HeaderRowRangeRequestBuilder) Get(options *HeaderRowRangeRequestBuilderGetOptions)(*HeaderRowRangeResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewHeaderRowRangeResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*HeaderRowRangeResponse), nil
}
