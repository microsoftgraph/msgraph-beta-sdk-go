...
// CellWithRowWithColumnRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\pivotTables\{workbookPivotTable-id}\worksheet\microsoft.graph.cell(row={row},column={column})
...
// CellWithRowWithColumnRequestBuilderGetOptions options for Get
type CellWithRowWithColumnRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// CellWithRowWithColumnResponse union type wrapper for classes workbookRange
...
// NewCellWithRowWithColumnResponse instantiates a new cellWithRowWithColumnResponse and sets the default values.
...
// NewCellWithRowWithColumnRequestBuilderInternal instantiates a new CellWithRowWithColumnRequestBuilder and sets the default values.
func NewCellWithRowWithColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter, row *int32, column *int32)(*CellWithRowWithColumnRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/pivotTables/{workbookPivotTable_id}/worksheet/microsoft.graph.cell(row={row},column={column})";
...
// NewCellWithRowWithColumnRequestBuilder instantiates a new CellWithRowWithColumnRequestBuilder and sets the default values.
...
// CreateGetRequestInformation invoke function cell
...
func (m *CellWithRowWithColumnRequestBuilder) Get(options *CellWithRowWithColumnRequestBuilderGetOptions)(*CellWithRowWithColumnResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewCellWithRowWithColumnResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
