...
import (
    ...
    i125645dad1352e204046cbe12451ae3487c582bde303dd54ee701fb7348baf8d "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/legend/format"
)
...
func NewLegendRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LegendRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/legend{?select,expand}";
...
func (m *LegendRequestBuilder) Format()(*i125645dad1352e204046cbe12451ae3487c582bde303dd54ee701fb7348baf8d.FormatRequestBuilder) {
    return i125645dad1352e204046cbe12451ae3487c582bde303dd54ee701fb7348baf8d.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the legend for the chart. Read-only.
// Parameters:
//  - options : Options for the request
