...
import (
    ...
    i02ee68bca28f40f619fdd95e3f16da0e9f6ca5a8b62a4279b6f13f5360cd4d1d "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/title/format/fill"
    i061d14c25edb4461eb067fe49cd438aee414ca62ea70998cee32a62ef9888b39 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/title/format/font"
)
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Fill()(*i02ee68bca28f40f619fdd95e3f16da0e9f6ca5a8b62a4279b6f13f5360cd4d1d.FillRequestBuilder) {
    return i02ee68bca28f40f619fdd95e3f16da0e9f6ca5a8b62a4279b6f13f5360cd4d1d.NewFillRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *FormatRequestBuilder) Font()(*i061d14c25edb4461eb067fe49cd438aee414ca62ea70998cee32a62ef9888b39.FontRequestBuilder) {
    return i061d14c25edb4461eb067fe49cd438aee414ca62ea70998cee32a62ef9888b39.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of a chart title, which includes fill and font formatting. Read-only.
// Parameters:
//  - options : Options for the request
