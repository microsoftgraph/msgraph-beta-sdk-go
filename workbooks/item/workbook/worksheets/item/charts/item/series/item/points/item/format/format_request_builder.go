...
import (
    ...
    ic4c5c2fde5dec480853beddc3784bef48329b1e02ece73a69358d60d43e438f3 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/series/item/points/item/format/fill"
)
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/series/{workbookChartSeries_id}/points/{workbookChartPoint_id}/format{?select,expand}";
...
func (m *FormatRequestBuilder) Fill()(*ic4c5c2fde5dec480853beddc3784bef48329b1e02ece73a69358d60d43e438f3.FillRequestBuilder) {
    return ic4c5c2fde5dec480853beddc3784bef48329b1e02ece73a69358d60d43e438f3.NewFillRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Encapsulates the format properties chart point. Read-only.
// Parameters:
//  - options : Options for the request
