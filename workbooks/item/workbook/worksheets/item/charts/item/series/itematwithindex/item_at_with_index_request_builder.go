...
// ItemAtWithIndexRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\series\microsoft.graph.itemAt(index={index})
...
// ItemAtWithIndexResponse union type wrapper for classes workbookChartSeries
type ItemAtWithIndexResponse struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]interface{};
    // Union type representation for type workbookChartSeries
    workbookChartSeries *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookChartSeries;
}
...
// GetWorkbookChartSeries gets the workbookChartSeries property value. Union type representation for type workbookChartSeries
func (m *ItemAtWithIndexResponse) GetWorkbookChartSeries()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookChartSeries) {
    if m == nil {
        return nil
    } else {
        return m.workbookChartSeries
    }
}
...
func (m *ItemAtWithIndexResponse) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["workbookChartSeries"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewWorkbookChartSeries() })
        if err != nil {
            return err
        }
        if val != nil {
            m.SetWorkbookChartSeries(val.(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookChartSeries))
        }
        return nil
    }
    return res
...
func (m *ItemAtWithIndexResponse) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
        err := writer.WriteObjectValue("workbookChartSeries", m.GetWorkbookChartSeries())
        if err != nil {
            return err
        }
    }
...
// SetWorkbookChartSeries sets the workbookChartSeries property value. Union type representation for type workbookChartSeries
func (m *ItemAtWithIndexResponse) SetWorkbookChartSeries(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookChartSeries)() {
    if m != nil {
        m.workbookChartSeries = value
    }
}
...
func NewItemAtWithIndexRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter, index *int32)(*ItemAtWithIndexRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/series/microsoft.graph.itemAt(index={index})";
