...
// Union type wrapper for classes workbookChartSeries
...
// Gets the workbookChartSeries property value. Union type representation for type workbookChartSeries
...
// Sets the workbookChartSeries property value. Union type representation for type workbookChartSeries
// Parameters:
//  - value : Value to set for the workbookChartSeries property.
...
func NewItemAtWithIndexRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter, index *int32)(*ItemAtWithIndexRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/series/microsoft.graph.itemAt(index={index})";
