...
import (
    ...
    ib6157c9004fd972693f80003b8af8e20569b6b9676f640e1deccd8f1c3f1ed45 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/series/item/points/itematwithindex"
    idbb5dd9e5e68b34267abea01037cecacbc6d35071c24e82e455df848c4119d28 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/series/item/points/count"
)

// pointsRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\series\{workbookChartSeries-id}\points
...
func NewPointsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PointsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/series/{workbookChartSeries_id}/points{?top,skip,search,filter,count,orderby,select,expand}";
...
// Count builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\series\{workbookChartSeries-id}\points\microsoft.graph.count()
func (m *PointsRequestBuilder) Count()(*idbb5dd9e5e68b34267abea01037cecacbc6d35071c24e82e455df848c4119d28.CountRequestBuilder) {
    return idbb5dd9e5e68b34267abea01037cecacbc6d35071c24e82e455df848c4119d28.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// ItemAtWithIndex builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\series\{workbookChartSeries-id}\points\microsoft.graph.itemAt(index={index})
func (m *PointsRequestBuilder) ItemAtWithIndex(index *int32)(*ib6157c9004fd972693f80003b8af8e20569b6b9676f640e1deccd8f1c3f1ed45.ItemAtWithIndexRequestBuilder) {
    return ib6157c9004fd972693f80003b8af8e20569b6b9676f640e1deccd8f1c3f1ed45.NewItemAtWithIndexRequestBuilderInternal(m.pathParameters, m.requestAdapter, index);
}
// Post represents a collection of all points in the series. Read-only.
func (m *PointsRequestBuilder) Post(options *PointsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookChartPoint, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewWorkbookChartPoint() }, nil)
    if err != nil {
        return nil, err
    }
