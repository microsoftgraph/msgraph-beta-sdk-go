...
func NewWorkbookChartSeriesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*WorkbookChartSeriesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/series/{workbookChartSeries_id}{?select,expand}";
...
func (m *WorkbookChartSeriesRequestBuilder) Format()(*i679e1a23ae8101271b086945106565db71dac22ffbce8fbcbadf020600524c22.FormatRequestBuilder) {
...
func (m *WorkbookChartSeriesRequestBuilder) Points()(*i67c1fe7dc83f235455070efaa3ef6fe1f8777cc3077d2ed6ea2310725e2b2a66.PointsRequestBuilder) {
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.workbooks.item.workbook.worksheets.item.charts.item.series.item.points.item collection
// Parameters:
//  - id : Unique identifier of the item
func (m *WorkbookChartSeriesRequestBuilder) PointsById(id string)(*i436a265ec364831ffb984916332cfc673542f792106e63e39e1aa14defdd4701.WorkbookChartPointRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i436a265ec364831ffb984916332cfc673542f792106e63e39e1aa14defdd4701.NewWorkbookChartPointRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
