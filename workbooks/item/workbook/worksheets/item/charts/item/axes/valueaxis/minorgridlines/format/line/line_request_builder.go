...
import (
    ...
    id4bdc0c64caf3020fb77031124db0a3077391ae3f3e175c7968396453839c1b9 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/axes/valueaxis/minorgridlines/format/line/clear"
)

// LineRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\axes\valueAxis\minorGridlines\format\line
...
func (m *LineRequestBuilder) Clear()(*id4bdc0c64caf3020fb77031124db0a3077391ae3f3e175c7968396453839c1b9.ClearRequestBuilder) {
    return id4bdc0c64caf3020fb77031124db0a3077391ae3f3e175c7968396453839c1b9.NewClearRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewLineRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LineRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/axes/valueAxis/minorGridlines/format/line{?select,expand}";
