...
import (
    ...
    i666cf03e26d9fa49db9fd51a9ecb61157533d74d69b4a400c711a2916f84784c "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/axes/seriesaxis/minorgridlines/format/line"
)

// FormatRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\charts\{workbookChart-id}\axes\seriesAxis\minorGridlines\format
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/axes/seriesAxis/minorGridlines/format{?select,expand}";
...
func (m *FormatRequestBuilder) Line()(*i666cf03e26d9fa49db9fd51a9ecb61157533d74d69b4a400c711a2916f84784c.LineRequestBuilder) {
    return i666cf03e26d9fa49db9fd51a9ecb61157533d74d69b4a400c711a2916f84784c.NewLineRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
