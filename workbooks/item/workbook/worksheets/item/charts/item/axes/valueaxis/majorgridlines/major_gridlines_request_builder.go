...
import (
    ...
    i2e4356e499d5129203369f620d051990ac93ed27ca088963f1231827fd8ccb72 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/axes/valueaxis/majorgridlines/format"
)
...
func NewMajorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MajorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/axes/valueAxis/majorGridlines{?select,expand}";
...
func (m *MajorGridlinesRequestBuilder) Format()(*i2e4356e499d5129203369f620d051990ac93ed27ca088963f1231827fd8ccb72.FormatRequestBuilder) {
    return i2e4356e499d5129203369f620d051990ac93ed27ca088963f1231827fd8ccb72.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Returns a gridlines object that represents the major gridlines for the specified axis. Read-only.
// Parameters:
//  - options : Options for the request
