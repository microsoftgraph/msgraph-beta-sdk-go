...
import (
    ...
    i7f42081a5fec0a8d13f94c04403d0c126db4c1854333e510764568f4348337e1 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/worksheets/item/charts/item/axes/valueaxis/minorgridlines/format"
)
...
func NewMinorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MinorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/charts/{workbookChart_id}/axes/valueAxis/minorGridlines{?select,expand}";
...
func (m *MinorGridlinesRequestBuilder) Format()(*i7f42081a5fec0a8d13f94c04403d0c126db4c1854333e510764568f4348337e1.FormatRequestBuilder) {
    return i7f42081a5fec0a8d13f94c04403d0c126db4c1854333e510764568f4348337e1.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Returns a Gridlines object that represents the minor gridlines for the specified axis. Read-only.
// Parameters:
//  - options : Options for the request
