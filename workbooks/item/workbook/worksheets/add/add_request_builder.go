...
// AddRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\microsoft.graph.add
...
// AddResponse union type wrapper for classes workbookWorksheet
type AddResponse struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]interface{};
    // Union type representation for type workbookWorksheet
...
// GetWorkbookWorksheet gets the workbookWorksheet property value. Union type representation for type workbookWorksheet
...
// SetWorkbookWorksheet sets the workbookWorksheet property value. Union type representation for type workbookWorksheet
...
func NewAddRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AddRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/microsoft.graph.add";
