...
import (
    ...
    i9412efae50e158e4c45770b4201876d691e3e378ffcddc8be79115bb45db123e "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/tables/item/rows/item/range_escaped"
)

// WorkbookTableRowItemRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\rows\{workbookTableRow-id}
...
func NewWorkbookTableRowItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*WorkbookTableRowItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/rows/{workbookTableRow_id}{?select,expand}";
...
func (m *WorkbookTableRowItemRequestBuilder) Range_escaped()(*i9412efae50e158e4c45770b4201876d691e3e378ffcddc8be79115bb45db123e.RangeRequestBuilder) {
    return i9412efae50e158e4c45770b4201876d691e3e378ffcddc8be79115bb45db123e.NewRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
