...
func (m *AddRequestBody) GetIndex()(*int32) {
    if m == nil {
        return nil
    } else {
        return m.index
...
func (m *AddRequestBody) GetValues()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.values
...
func (m *AddRequestBody) SetIndex(value *int32)() {
    if m != nil {
        m.index = value
    }
}
...
func (m *AddRequestBody) SetValues(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.values = value
    }
}
