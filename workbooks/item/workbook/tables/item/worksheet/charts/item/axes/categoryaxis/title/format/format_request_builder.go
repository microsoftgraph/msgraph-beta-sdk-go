...
import (
    ...
    iaaefde2ae1efe963c4d4cb7761db1f7baec9ce562d25a1aa81dc13564d59c669 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/categoryaxis/title/format/font"
)
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/categoryAxis/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Font()(*iaaefde2ae1efe963c4d4cb7761db1f7baec9ce562d25a1aa81dc13564d59c669.FontRequestBuilder) {
    return iaaefde2ae1efe963c4d4cb7761db1f7baec9ce562d25a1aa81dc13564d59c669.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart axis title. Read-only.
// Parameters:
//  - options : Options for the request
