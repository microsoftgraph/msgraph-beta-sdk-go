...
import (
    ...
    i699724752c52e3a32939d5262d8e275da15b591d39c8b434af138d5f7e0164a6 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/categoryaxis/majorgridlines/format"
)

// MajorGridlinesRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\worksheet\charts\{workbookChart-id}\axes\categoryAxis\majorGridlines
...
func NewMajorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MajorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/categoryAxis/majorGridlines{?select,expand}";
...
func (m *MajorGridlinesRequestBuilder) Format()(*i699724752c52e3a32939d5262d8e275da15b591d39c8b434af138d5f7e0164a6.FormatRequestBuilder) {
    return i699724752c52e3a32939d5262d8e275da15b591d39c8b434af138d5f7e0164a6.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
