...
import (
    ...
    i4076c19470e83e8e16fea574100b77ba0a2ec3e330a083e46d5b8cd44d74991e "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/categoryaxis/minorgridlines/format/line"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\worksheet\charts\{workbookChart-id}\axes\categoryAxis\minorGridlines\format
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/categoryAxis/minorGridlines/format{?select,expand}";
...
func (m *FormatRequestBuilder) Line()(*i4076c19470e83e8e16fea574100b77ba0a2ec3e330a083e46d5b8cd44d74991e.LineRequestBuilder) {
    return i4076c19470e83e8e16fea574100b77ba0a2ec3e330a083e46d5b8cd44d74991e.NewLineRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart gridlines. Read-only.
// Parameters:
//  - options : Options for the request
