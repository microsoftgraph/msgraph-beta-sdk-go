...
import (
    ...
    i91cfbe24526d9f831c3b9e558fbc3d0806f87f87a11b01875aa1d37fbff528a4 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/valueaxis/majorgridlines/format"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\worksheet\charts\{workbookChart-id}\axes\valueAxis\majorGridlines
...
func NewMajorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MajorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/valueAxis/majorGridlines{?select,expand}";
...
func (m *MajorGridlinesRequestBuilder) Format()(*i91cfbe24526d9f831c3b9e558fbc3d0806f87f87a11b01875aa1d37fbff528a4.FormatRequestBuilder) {
    return i91cfbe24526d9f831c3b9e558fbc3d0806f87f87a11b01875aa1d37fbff528a4.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Returns a gridlines object that represents the major gridlines for the specified axis. Read-only.
// Parameters:
//  - options : Options for the request
