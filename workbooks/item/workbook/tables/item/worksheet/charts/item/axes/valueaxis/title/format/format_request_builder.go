...
import (
    ...
    i70f42010a0297d1af5f1824aad99b92f3def2a1da07dfa1638baefbe3630273c "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/valueaxis/title/format/font"
)
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/valueAxis/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Font()(*i70f42010a0297d1af5f1824aad99b92f3def2a1da07dfa1638baefbe3630273c.FontRequestBuilder) {
    return i70f42010a0297d1af5f1824aad99b92f3def2a1da07dfa1638baefbe3630273c.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart axis title. Read-only.
// Parameters:
//  - options : Options for the request
