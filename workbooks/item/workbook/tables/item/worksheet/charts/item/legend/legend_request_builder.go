...
import (
    ...
    ia7b9709fb2cac93cbe6f35eea607410e2a94efa517b37b85c3a0b69a1497d6b2 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/legend/format"
)
...
func NewLegendRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LegendRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/legend{?select,expand}";
...
func (m *LegendRequestBuilder) Format()(*ia7b9709fb2cac93cbe6f35eea607410e2a94efa517b37b85c3a0b69a1497d6b2.FormatRequestBuilder) {
    return ia7b9709fb2cac93cbe6f35eea607410e2a94efa517b37b85c3a0b69a1497d6b2.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the legend for the chart. Read-only.
// Parameters:
//  - options : Options for the request
