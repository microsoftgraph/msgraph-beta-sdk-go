...
import (
    ...
    id025bbcf3e53960c904289e7ab88dc964b8f954a13147b6883e89d26af094762 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/valueaxis/minorgridlines/format"
)
...
func NewMinorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MinorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/valueAxis/minorGridlines{?select,expand}";
...
func (m *MinorGridlinesRequestBuilder) Format()(*id025bbcf3e53960c904289e7ab88dc964b8f954a13147b6883e89d26af094762.FormatRequestBuilder) {
    return id025bbcf3e53960c904289e7ab88dc964b8f954a13147b6883e89d26af094762.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Returns a Gridlines object that represents the minor gridlines for the specified axis. Read-only.
// Parameters:
//  - options : Options for the request
