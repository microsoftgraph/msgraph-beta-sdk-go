...
import (
    ...
    ibca7d87ee6f9acea18c0a045c6a0c306463ac10afdf06bc693bd25330aedc981 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/axes/valueaxis/majorgridlines/format/line"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\worksheet\charts\{workbookChart-id}\axes\valueAxis\majorGridlines\format
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/axes/valueAxis/majorGridlines/format{?select,expand}";
...
func (m *FormatRequestBuilder) Line()(*ibca7d87ee6f9acea18c0a045c6a0c306463ac10afdf06bc693bd25330aedc981.LineRequestBuilder) {
    return ibca7d87ee6f9acea18c0a045c6a0c306463ac10afdf06bc693bd25330aedc981.NewLineRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart gridlines. Read-only.
// Parameters:
//  - options : Options for the request
