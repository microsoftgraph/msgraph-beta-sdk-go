...
import (
    ...
    ieaf23283eb11d3ed29bfbcad95cfa6b579292fc79a146f13d55eaa574947847b "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/title/format/font"
    ifec2f4cc76e8c4901525d1ed2ea07e0fe4ee256bbfec9531cdaca059e2134a50 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/tables/item/worksheet/charts/item/title/format/fill"
)
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts/{workbookChart_id}/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Fill()(*ifec2f4cc76e8c4901525d1ed2ea07e0fe4ee256bbfec9531cdaca059e2134a50.FillRequestBuilder) {
    return ifec2f4cc76e8c4901525d1ed2ea07e0fe4ee256bbfec9531cdaca059e2134a50.NewFillRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *FormatRequestBuilder) Font()(*ieaf23283eb11d3ed29bfbcad95cfa6b579292fc79a146f13d55eaa574947847b.FontRequestBuilder) {
    return ieaf23283eb11d3ed29bfbcad95cfa6b579292fc79a146f13d55eaa574947847b.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of a chart title, which includes fill and font formatting. Read-only.
// Parameters:
//  - options : Options for the request
