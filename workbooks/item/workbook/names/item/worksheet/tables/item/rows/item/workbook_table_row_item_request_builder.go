...
// WorkbookTableRowItemRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\tables\{workbookTable-id}\rows\{workbookTableRow-id}
...
func (m *WorkbookTableRowItemRequestBuilder) Range_escaped()(*idcf565cc1cdf39d5129a10603e38d4b258383564bd7fb94dfecda3dfe20be641.RangeRequestBuilder) {
