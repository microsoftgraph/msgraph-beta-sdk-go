...
import (
    ...
    i1e86938ff1e04453bd867e153f363decc433c034e3b5d127be4a41bb7575ff36 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/names/item/worksheet/charts/item/axes/categoryaxis/majorgridlines/format"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\charts\{workbookChart-id}\axes\categoryAxis\majorGridlines
...
func NewMajorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MajorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/axes/categoryAxis/majorGridlines{?select,expand}";
...
func (m *MajorGridlinesRequestBuilder) Format()(*i1e86938ff1e04453bd867e153f363decc433c034e3b5d127be4a41bb7575ff36.FormatRequestBuilder) {
    return i1e86938ff1e04453bd867e153f363decc433c034e3b5d127be4a41bb7575ff36.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Returns a gridlines object that represents the major gridlines for the specified axis. Read-only.
// Parameters:
//  - options : Options for the request
