...
import (
    ...
    i2762cc0cff87e13ce35bf3aaad07169f379ee66fc901b1a767340b1b8f3d15cf "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/names/item/worksheet/charts/item/axes/categoryaxis/minorgridlines/format"
)
...
func NewMinorGridlinesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MinorGridlinesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/axes/categoryAxis/minorGridlines{?select,expand}";
...
func (m *MinorGridlinesRequestBuilder) Format()(*i2762cc0cff87e13ce35bf3aaad07169f379ee66fc901b1a767340b1b8f3d15cf.FormatRequestBuilder) {
    return i2762cc0cff87e13ce35bf3aaad07169f379ee66fc901b1a767340b1b8f3d15cf.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Returns a Gridlines object that represents the minor gridlines for the specified axis. Read-only.
// Parameters:
//  - options : Options for the request
