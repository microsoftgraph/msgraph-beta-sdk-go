...
func NewDataLabelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DataLabelsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/dataLabels{?select,expand}";
...
func (m *DataLabelsRequestBuilder) Format()(*i4ec748499eb32e211daac3bd10aac074e3792bbe138604363493ab315f50c4d7.FormatRequestBuilder) {
    return i4ec748499eb32e211daac3bd10aac074e3792bbe138604363493ab315f50c4d7.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
