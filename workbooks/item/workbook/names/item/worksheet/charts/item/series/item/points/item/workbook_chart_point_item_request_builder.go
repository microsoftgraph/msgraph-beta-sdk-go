...
import (
    ...
    i2fb041d9d18754bb5e8ada5d36cb253e983631e6d994cf3a283300e561178cc8 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/names/item/worksheet/charts/item/series/item/points/item/format"
)

// WorkbookChartPointItemRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\charts\{workbookChart-id}\series\{workbookChartSeries-id}\points\{workbookChartPoint-id}
...
func NewWorkbookChartPointItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*WorkbookChartPointItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/series/{workbookChartSeries_id}/points/{workbookChartPoint_id}{?select,expand}";
...
func (m *WorkbookChartPointItemRequestBuilder) Format()(*i2fb041d9d18754bb5e8ada5d36cb253e983631e6d994cf3a283300e561178cc8.FormatRequestBuilder) {
    return i2fb041d9d18754bb5e8ada5d36cb253e983631e6d994cf3a283300e561178cc8.NewFormatRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Get represents a collection of all points in the series. Read-only.
func (m *WorkbookChartPointItemRequestBuilder) Get(options *WorkbookChartPointItemRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookChartPoint, error) {
