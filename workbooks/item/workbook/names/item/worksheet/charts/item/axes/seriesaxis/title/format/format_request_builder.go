...
import (
    ...
    ia5cffa45ea4504f99384158781323f50c93ae7c173a168219accd05b66436080 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/names/item/worksheet/charts/item/axes/seriesaxis/title/format/font"
)

// Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\charts\{workbookChart-id}\axes\seriesAxis\title\format
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/axes/seriesAxis/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Font()(*ia5cffa45ea4504f99384158781323f50c93ae7c173a168219accd05b66436080.FontRequestBuilder) {
    return ia5cffa45ea4504f99384158781323f50c93ae7c173a168219accd05b66436080.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart axis title. Read-only.
// Parameters:
//  - options : Options for the request
