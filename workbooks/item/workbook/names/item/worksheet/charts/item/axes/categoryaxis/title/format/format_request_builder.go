...
import (
    ...
    id93da2167e1ebac928a333e5d8751b0b4989261c8d65f35bf8a021b4495ac1d8 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/names/item/worksheet/charts/item/axes/categoryaxis/title/format/font"
)
...
func NewFormatRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FormatRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/axes/categoryAxis/title/format{?select,expand}";
...
func (m *FormatRequestBuilder) Font()(*id93da2167e1ebac928a333e5d8751b0b4989261c8d65f35bf8a021b4495ac1d8.FontRequestBuilder) {
    return id93da2167e1ebac928a333e5d8751b0b4989261c8d65f35bf8a021b4495ac1d8.NewFontRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Represents the formatting of chart axis title. Read-only.
// Parameters:
//  - options : Options for the request
