...
func NewWorkbookNamedItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*WorkbookNamedItemItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/names/{workbookNamedItem_id1}{?select,expand}";
...
// Range_escaped builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\names\{workbookNamedItem-id1}\microsoft.graph.range()
func (m *WorkbookNamedItemItemRequestBuilder) Range_escaped()(*ice9036719e7d4f4aa44e6d56410d26512d5a129f6635b44f90718419b4f96b11.RangeRequestBuilder) {
    return ice9036719e7d4f4aa44e6d56410d26512d5a129f6635b44f90718419b4f96b11.NewRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
