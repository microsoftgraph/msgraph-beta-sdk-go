...
import (
    ...
    i741c0b67d0389e1cfab49378288cc4259f52166768d1a6ca75ea1d9f276e55fe "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/names/item/worksheet/names/add"
    i877e2507580cb474470f1e8ccaa43c71ce3cf7c80a30bce53cce84c206e89fb6 "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/workbook/names/item/worksheet/names/addformulalocal"
)
...
func (m *NamesRequestBuilder) Add()(*i741c0b67d0389e1cfab49378288cc4259f52166768d1a6ca75ea1d9f276e55fe.AddRequestBuilder) {
    return i741c0b67d0389e1cfab49378288cc4259f52166768d1a6ca75ea1d9f276e55fe.NewAddRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *NamesRequestBuilder) AddFormulaLocal()(*i877e2507580cb474470f1e8ccaa43c71ce3cf7c80a30bce53cce84c206e89fb6.AddFormulaLocalRequestBuilder) {
    return i877e2507580cb474470f1e8ccaa43c71ce3cf7c80a30bce53cce84c206e89fb6.NewAddFormulaLocalRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewNamesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*NamesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/names{?top,skip,search,filter,count,orderby,select,expand}";
