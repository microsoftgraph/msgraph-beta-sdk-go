...
// Quartile_IncRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.quartile_Inc
...
// Quartile_IncRequestBuilderPostOptions options for Post
type Quartile_IncRequestBuilderPostOptions struct {
    // 
    Body *Quartile_IncRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// Quartile_IncResponse union type wrapper for classes workbookFunctionResult
...
// NewQuartile_IncResponse instantiates a new quartile_IncResponse and sets the default values.
...
// NewQuartile_IncRequestBuilderInternal instantiates a new Quartile_IncRequestBuilder and sets the default values.
func NewQuartile_IncRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Quartile_IncRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.quartile_Inc";
...
// NewQuartile_IncRequestBuilder instantiates a new Quartile_IncRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action quartile_Inc
func (m *Quartile_IncRequestBuilder) CreatePostRequestInformation(options *Quartile_IncRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *Quartile_IncRequestBuilder) Post(options *Quartile_IncRequestBuilderPostOptions)(*Quartile_IncResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewQuartile_IncResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
