...
// OddRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.odd
...
// OddRequestBuilderPostOptions options for Post
type OddRequestBuilderPostOptions struct {
    // 
    Body *OddRequestBody;
    // Request headers
    H map[string]string;
...
// OddResponse union type wrapper for classes workbookFunctionResult
...
// NewOddResponse instantiates a new oddResponse and sets the default values.
...
// NewOddRequestBuilderInternal instantiates a new OddRequestBuilder and sets the default values.
func NewOddRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OddRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.odd";
...
// NewOddRequestBuilder instantiates a new OddRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action odd
...
func (m *OddRequestBuilder) Post(options *OddRequestBuilderPostOptions)(*OddResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewOddResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
