...
// GcdRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.gcd
...
// GcdRequestBuilderPostOptions options for Post
type GcdRequestBuilderPostOptions struct {
    // 
    Body *GcdRequestBody;
    // Request headers
    H map[string]string;
...
// GcdResponse union type wrapper for classes workbookFunctionResult
...
// NewGcdResponse instantiates a new gcdResponse and sets the default values.
...
// NewGcdRequestBuilderInternal instantiates a new GcdRequestBuilder and sets the default values.
func NewGcdRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GcdRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.gcd";
...
// NewGcdRequestBuilder instantiates a new GcdRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action gcd
...
func (m *GcdRequestBuilder) Post(options *GcdRequestBuilderPostOptions)(*GcdResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGcdResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
