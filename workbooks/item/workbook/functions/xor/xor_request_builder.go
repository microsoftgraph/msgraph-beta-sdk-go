...
// XorRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.xor
...
// XorRequestBuilderPostOptions options for Post
type XorRequestBuilderPostOptions struct {
    // 
    Body *XorRequestBody;
    // Request headers
    H map[string]string;
...
// XorResponse union type wrapper for classes workbookFunctionResult
...
// NewXorResponse instantiates a new xorResponse and sets the default values.
...
// NewXorRequestBuilderInternal instantiates a new XorRequestBuilder and sets the default values.
func NewXorRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*XorRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.xor";
...
// NewXorRequestBuilder instantiates a new XorRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action xor
...
func (m *XorRequestBuilder) Post(options *XorRequestBuilderPostOptions)(*XorResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewXorResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
