...
// BitxorRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.bitxor
...
// BitxorRequestBuilderPostOptions options for Post
type BitxorRequestBuilderPostOptions struct {
    // 
    Body *BitxorRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// BitxorResponse union type wrapper for classes workbookFunctionResult
...
// NewBitxorResponse instantiates a new bitxorResponse and sets the default values.
...
func (m *BitxorResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *BitxorResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewBitxorRequestBuilderInternal instantiates a new BitxorRequestBuilder and sets the default values.
func NewBitxorRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BitxorRequestBuilder) {
    m := &BitxorRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.bitxor";
...
// NewBitxorRequestBuilder instantiates a new BitxorRequestBuilder and sets the default values.
func NewBitxorRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BitxorRequestBuilder) {
    ...
    return NewBitxorRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action bitxor
...
func (m *BitxorRequestBuilder) Post(options *BitxorRequestBuilderPostOptions)(*BitxorResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewBitxorResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*BitxorResponse), nil
}
