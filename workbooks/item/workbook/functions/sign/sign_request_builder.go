...
// SignRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.sign
...
// SignRequestBuilderPostOptions options for Post
type SignRequestBuilderPostOptions struct {
    // 
...
// SignResponse union type wrapper for classes workbookFunctionResult
...
// NewSignResponse instantiates a new signResponse and sets the default values.
...
// NewSignRequestBuilderInternal instantiates a new SignRequestBuilder and sets the default values.
func NewSignRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SignRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.sign";
...
// NewSignRequestBuilder instantiates a new SignRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action sign
...
func (m *SignRequestBuilder) Post(options *SignRequestBuilderPostOptions)(*SignResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewSignResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
