...
// BahtTextRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.bahtText
...
// BahtTextRequestBuilderPostOptions options for Post
...
// BahtTextResponse union type wrapper for classes workbookFunctionResult
...
// NewBahtTextResponse instantiates a new bahtTextResponse and sets the default values.
...
// NewBahtTextRequestBuilderInternal instantiates a new BahtTextRequestBuilder and sets the default values.
func NewBahtTextRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BahtTextRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.bahtText";
...
// NewBahtTextRequestBuilder instantiates a new BahtTextRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action bahtText
...
func (m *BahtTextRequestBuilder) Post(options *BahtTextRequestBuilderPostOptions)(*BahtTextResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewBahtTextResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
