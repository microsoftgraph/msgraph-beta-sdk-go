...
// ChooseRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.choose
...
// ChooseRequestBuilderPostOptions options for Post
type ChooseRequestBuilderPostOptions struct {
    // 
...
// ChooseResponse union type wrapper for classes workbookFunctionResult
...
// NewChooseResponse instantiates a new chooseResponse and sets the default values.
...
// NewChooseRequestBuilderInternal instantiates a new ChooseRequestBuilder and sets the default values.
func NewChooseRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChooseRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.choose";
...
// NewChooseRequestBuilder instantiates a new ChooseRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action choose
...
func (m *ChooseRequestBuilder) Post(options *ChooseRequestBuilderPostOptions)(*ChooseResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewChooseResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
