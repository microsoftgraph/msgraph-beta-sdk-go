...
// PiRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.pi
...
// PiRequestBuilderPostOptions options for Post
type PiRequestBuilderPostOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// PiResponse union type wrapper for classes workbookFunctionResult
...
// NewPiResponse instantiates a new piResponse and sets the default values.
...
func (m *PiResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *PiResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewPiRequestBuilderInternal instantiates a new PiRequestBuilder and sets the default values.
func NewPiRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PiRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.pi";
...
// NewPiRequestBuilder instantiates a new PiRequestBuilder and sets the default values.
func NewPiRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PiRequestBuilder) {
    ...
    return NewPiRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action pi
...
func (m *PiRequestBuilder) Post(options *PiRequestBuilderPostOptions)(*PiResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewPiResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*PiResponse), nil
}
