...
func (m *ChiSq_DistRequestBody) GetCumulative()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.cumulative
...
func (m *ChiSq_DistRequestBody) GetDegFreedom()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.degFreedom
...
func (m *ChiSq_DistRequestBody) GetX()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.x
...
func (m *ChiSq_DistRequestBody) SetCumulative(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.cumulative = value
    }
}
// SetDegFreedom sets the degFreedom property value. 
func (m *ChiSq_DistRequestBody) SetDegFreedom(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.degFreedom = value
    }
}
// SetX sets the x property value. 
func (m *ChiSq_DistRequestBody) SetX(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.x = value
    }
}
