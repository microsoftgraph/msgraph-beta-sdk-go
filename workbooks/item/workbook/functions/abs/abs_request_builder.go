...
// AbsRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.abs
...
// AbsRequestBuilderPostOptions options for Post
...
// AbsResponse union type wrapper for classes workbookFunctionResult
...
// NewAbsResponse instantiates a new absResponse and sets the default values.
...
// NewAbsRequestBuilderInternal instantiates a new AbsRequestBuilder and sets the default values.
func NewAbsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AbsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.abs";
...
// NewAbsRequestBuilder instantiates a new AbsRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action abs
...
func (m *AbsRequestBuilder) Post(options *AbsRequestBuilderPostOptions)(*AbsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewAbsResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
