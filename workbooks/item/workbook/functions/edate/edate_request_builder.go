...
// EdateRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.edate
...
// EdateRequestBuilderPostOptions options for Post
type EdateRequestBuilderPostOptions struct {
    // 
    Body *EdateRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// EdateResponse union type wrapper for classes workbookFunctionResult
...
// NewEdateResponse instantiates a new edateResponse and sets the default values.
...
// NewEdateRequestBuilderInternal instantiates a new EdateRequestBuilder and sets the default values.
func NewEdateRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*EdateRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.edate";
...
// NewEdateRequestBuilder instantiates a new EdateRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action edate
func (m *EdateRequestBuilder) CreatePostRequestInformation(options *EdateRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *EdateRequestBuilder) Post(options *EdateRequestBuilderPostOptions)(*EdateResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewEdateResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
