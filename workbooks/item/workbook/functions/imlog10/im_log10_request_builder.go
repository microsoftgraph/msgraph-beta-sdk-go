...
// ImLog10RequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.imLog10
...
// ImLog10RequestBuilderPostOptions options for Post
...
// ImLog10Response union type wrapper for classes workbookFunctionResult
...
// NewImLog10Response instantiates a new imLog10Response and sets the default values.
...
// NewImLog10RequestBuilderInternal instantiates a new ImLog10RequestBuilder and sets the default values.
...
// NewImLog10RequestBuilder instantiates a new ImLog10RequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action imLog10
...
func (m *ImLog10RequestBuilder) Post(options *ImLog10RequestBuilderPostOptions)(*ImLog10Response, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewImLog10Response() }, nil, nil)
    if err != nil {
        return nil, err
    }
