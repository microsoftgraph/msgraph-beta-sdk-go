...
// StDevARequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.stDevA
...
// StDevARequestBuilderPostOptions options for Post
type StDevARequestBuilderPostOptions struct {
    // 
    Body *StDevARequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// StDevAResponse union type wrapper for classes workbookFunctionResult
...
// NewStDevAResponse instantiates a new stDevAResponse and sets the default values.
...
func (m *StDevAResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *StDevAResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewStDevARequestBuilderInternal instantiates a new StDevARequestBuilder and sets the default values.
func NewStDevARequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*StDevARequestBuilder) {
    m := &StDevARequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.stDevA";
...
// NewStDevARequestBuilder instantiates a new StDevARequestBuilder and sets the default values.
func NewStDevARequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*StDevARequestBuilder) {
    ...
    return NewStDevARequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action stDevA
...
func (m *StDevARequestBuilder) Post(options *StDevARequestBuilderPostOptions)(*StDevAResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewStDevAResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*StDevAResponse), nil
}
