...
// Iso_CeilingRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.iso_Ceiling
...
// Iso_CeilingRequestBuilderPostOptions options for Post
type Iso_CeilingRequestBuilderPostOptions struct {
    // 
    Body *Iso_CeilingRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// Iso_CeilingResponse union type wrapper for classes workbookFunctionResult
...
// NewIso_CeilingResponse instantiates a new iso_CeilingResponse and sets the default values.
func NewIso_CeilingResponse()(*Iso_CeilingResponse) {
    m := &Iso_CeilingResponse{
    }
...
func (m *Iso_CeilingResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *Iso_CeilingResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewIso_CeilingRequestBuilderInternal instantiates a new Iso_CeilingRequestBuilder and sets the default values.
func NewIso_CeilingRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Iso_CeilingRequestBuilder) {
    m := &Iso_CeilingRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.iso_Ceiling";
...
// NewIso_CeilingRequestBuilder instantiates a new Iso_CeilingRequestBuilder and sets the default values.
func NewIso_CeilingRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Iso_CeilingRequestBuilder) {
    ...
    return NewIso_CeilingRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action iso_Ceiling
...
func (m *Iso_CeilingRequestBuilder) Post(options *Iso_CeilingRequestBuilderPostOptions)(*Iso_CeilingResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewIso_CeilingResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*Iso_CeilingResponse), nil
}
