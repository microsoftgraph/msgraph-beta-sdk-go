...
// CschRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.csch
...
// CschRequestBuilderPostOptions options for Post
...
// CschResponse union type wrapper for classes workbookFunctionResult
...
// NewCschResponse instantiates a new cschResponse and sets the default values.
...
// NewCschRequestBuilderInternal instantiates a new CschRequestBuilder and sets the default values.
func NewCschRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CschRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.csch";
...
// NewCschRequestBuilder instantiates a new CschRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action csch
...
func (m *CschRequestBuilder) Post(options *CschRequestBuilderPostOptions)(*CschResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewCschResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
