...
// RriRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.rri
...
// RriRequestBuilderPostOptions options for Post
type RriRequestBuilderPostOptions struct {
    // 
    Body *RriRequestBody;
    // Request headers
    H map[string]string;
...
// RriResponse union type wrapper for classes workbookFunctionResult
...
// NewRriResponse instantiates a new rriResponse and sets the default values.
...
// NewRriRequestBuilderInternal instantiates a new RriRequestBuilder and sets the default values.
func NewRriRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RriRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.rri";
...
// NewRriRequestBuilder instantiates a new RriRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action rri
...
func (m *RriRequestBuilder) Post(options *RriRequestBuilderPostOptions)(*RriResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewRriResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
