...
// WorkDay_IntlRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.workDay_Intl
...
// WorkDay_IntlRequestBuilderPostOptions options for Post
type WorkDay_IntlRequestBuilderPostOptions struct {
    // 
    Body *WorkDay_IntlRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// WorkDay_IntlResponse union type wrapper for classes workbookFunctionResult
...
// NewWorkDay_IntlResponse instantiates a new workDay_IntlResponse and sets the default values.
func NewWorkDay_IntlResponse()(*WorkDay_IntlResponse) {
    m := &WorkDay_IntlResponse{
    }
...
func (m *WorkDay_IntlResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkDay_IntlResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewWorkDay_IntlRequestBuilderInternal instantiates a new WorkDay_IntlRequestBuilder and sets the default values.
func NewWorkDay_IntlRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*WorkDay_IntlRequestBuilder) {
    m := &WorkDay_IntlRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.workDay_Intl";
...
// NewWorkDay_IntlRequestBuilder instantiates a new WorkDay_IntlRequestBuilder and sets the default values.
func NewWorkDay_IntlRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*WorkDay_IntlRequestBuilder) {
    ...
    return NewWorkDay_IntlRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action workDay_Intl
...
func (m *WorkDay_IntlRequestBuilder) Post(options *WorkDay_IntlRequestBuilderPostOptions)(*WorkDay_IntlResponse, error) {
    ...
    return res.(*WorkDay_IntlResponse), nil
}
