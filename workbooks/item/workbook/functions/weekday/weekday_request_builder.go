...
// WeekdayRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.weekday
...
// WeekdayRequestBuilderPostOptions options for Post
...
// WeekdayResponse union type wrapper for classes workbookFunctionResult
...
// NewWeekdayResponse instantiates a new weekdayResponse and sets the default values.
...
// NewWeekdayRequestBuilderInternal instantiates a new WeekdayRequestBuilder and sets the default values.
func NewWeekdayRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*WeekdayRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.weekday";
...
// NewWeekdayRequestBuilder instantiates a new WeekdayRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action weekday
...
func (m *WeekdayRequestBuilder) Post(options *WeekdayRequestBuilderPostOptions)(*WeekdayResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewWeekdayResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
