...
// TrimMeanRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.trimMean
...
// TrimMeanRequestBuilderPostOptions options for Post
type TrimMeanRequestBuilderPostOptions struct {
    // 
    Body *TrimMeanRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// TrimMeanResponse union type wrapper for classes workbookFunctionResult
...
// NewTrimMeanResponse instantiates a new trimMeanResponse and sets the default values.
...
func (m *TrimMeanResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *TrimMeanResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewTrimMeanRequestBuilderInternal instantiates a new TrimMeanRequestBuilder and sets the default values.
func NewTrimMeanRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TrimMeanRequestBuilder) {
    m := &TrimMeanRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.trimMean";
...
// NewTrimMeanRequestBuilder instantiates a new TrimMeanRequestBuilder and sets the default values.
func NewTrimMeanRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TrimMeanRequestBuilder) {
    ...
    return NewTrimMeanRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action trimMean
...
func (m *TrimMeanRequestBuilder) Post(options *TrimMeanRequestBuilderPostOptions)(*TrimMeanResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewTrimMeanResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*TrimMeanResponse), nil
}
