...
type PercentRank_ExcRequestBuilderPostOptions struct {
    // 
    Body *PercentRank_ExcRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func (m *PercentRank_ExcRequestBuilder) Post(options *PercentRank_ExcRequestBuilderPostOptions)(*PercentRank_ExcResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewPercentRank_ExcResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
