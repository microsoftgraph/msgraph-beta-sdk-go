...
// NewNorm_S_InvRequestBody instantiates a new norm_S_InvRequestBody and sets the default values.
func NewNorm_S_InvRequestBody()(*Norm_S_InvRequestBody) {
    m := &Norm_S_InvRequestBody{
    }
...
func (m *Norm_S_InvRequestBody) GetProbability()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
...
func (m *Norm_S_InvRequestBody) SetProbability(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.probability = value
    }
}
