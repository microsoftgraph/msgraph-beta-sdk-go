...
// NewBin2HexRequestBody instantiates a new bin2HexRequestBody and sets the default values.
func NewBin2HexRequestBody()(*Bin2HexRequestBody) {
    m := &Bin2HexRequestBody{
    }
...
func (m *Bin2HexRequestBody) GetNumber()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.number
...
func (m *Bin2HexRequestBody) GetPlaces()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.places
...
func (m *Bin2HexRequestBody) SetNumber(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.number = value
    }
}
// SetPlaces sets the places property value. 
func (m *Bin2HexRequestBody) SetPlaces(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.places = value
    }
}
