...
// GeStepRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.geStep
...
// GeStepRequestBuilderPostOptions options for Post
type GeStepRequestBuilderPostOptions struct {
    // 
    Body *GeStepRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// GeStepResponse union type wrapper for classes workbookFunctionResult
...
// NewGeStepResponse instantiates a new geStepResponse and sets the default values.
...
func (m *GeStepResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *GeStepResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewGeStepRequestBuilderInternal instantiates a new GeStepRequestBuilder and sets the default values.
func NewGeStepRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GeStepRequestBuilder) {
    m := &GeStepRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.geStep";
...
// NewGeStepRequestBuilder instantiates a new GeStepRequestBuilder and sets the default values.
func NewGeStepRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GeStepRequestBuilder) {
    ...
    return NewGeStepRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action geStep
...
func (m *GeStepRequestBuilder) Post(options *GeStepRequestBuilderPostOptions)(*GeStepResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGeStepResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*GeStepResponse), nil
}
