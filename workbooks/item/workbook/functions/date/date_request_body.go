...
// NewDateRequestBody instantiates a new dateRequestBody and sets the default values.
...
// GetMonth gets the month property value. 
...
// GetYear gets the year property value. 
