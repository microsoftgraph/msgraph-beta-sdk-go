...
// StDevPARequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.stDevPA
...
// StDevPARequestBuilderPostOptions options for Post
type StDevPARequestBuilderPostOptions struct {
    // 
    Body *StDevPARequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// StDevPAResponse union type wrapper for classes workbookFunctionResult
...
// NewStDevPAResponse instantiates a new stDevPAResponse and sets the default values.
...
func (m *StDevPAResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *StDevPAResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewStDevPARequestBuilderInternal instantiates a new StDevPARequestBuilder and sets the default values.
func NewStDevPARequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*StDevPARequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.stDevPA";
...
// NewStDevPARequestBuilder instantiates a new StDevPARequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action stDevPA
func (m *StDevPARequestBuilder) CreatePostRequestInformation(options *StDevPARequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *StDevPARequestBuilder) Post(options *StDevPARequestBuilderPostOptions)(*StDevPAResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewStDevPAResponse() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*StDevPAResponse), nil
}
