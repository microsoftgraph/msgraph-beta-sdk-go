...
// NewCountRequestBody instantiates a new countRequestBody and sets the default values.
...
func (m *CountRequestBody) GetValues()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.values
...
func (m *CountRequestBody) SetValues(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.values = value
    }
}
