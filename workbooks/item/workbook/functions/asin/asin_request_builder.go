...
// AsinRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.asin
...
// AsinRequestBuilderPostOptions options for Post
...
// AsinResponse union type wrapper for classes workbookFunctionResult
...
// NewAsinResponse instantiates a new asinResponse and sets the default values.
...
// NewAsinRequestBuilderInternal instantiates a new AsinRequestBuilder and sets the default values.
func NewAsinRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AsinRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.asin";
...
// NewAsinRequestBuilder instantiates a new AsinRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action asin
...
func (m *AsinRequestBuilder) Post(options *AsinRequestBuilderPostOptions)(*AsinResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewAsinResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
