...
// Binom_DistRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.binom_Dist
...
// Binom_DistRequestBuilderPostOptions options for Post
type Binom_DistRequestBuilderPostOptions struct {
    // 
    Body *Binom_DistRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// Binom_DistResponse union type wrapper for classes workbookFunctionResult
...
// NewBinom_DistResponse instantiates a new binom_DistResponse and sets the default values.
func NewBinom_DistResponse()(*Binom_DistResponse) {
    m := &Binom_DistResponse{
    }
...
func (m *Binom_DistResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *Binom_DistResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewBinom_DistRequestBuilderInternal instantiates a new Binom_DistRequestBuilder and sets the default values.
func NewBinom_DistRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Binom_DistRequestBuilder) {
    m := &Binom_DistRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.binom_Dist";
...
// NewBinom_DistRequestBuilder instantiates a new Binom_DistRequestBuilder and sets the default values.
func NewBinom_DistRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Binom_DistRequestBuilder) {
    ...
    return NewBinom_DistRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action binom_Dist
...
func (m *Binom_DistRequestBuilder) Post(options *Binom_DistRequestBuilderPostOptions)(*Binom_DistResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewBinom_DistResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*Binom_DistResponse), nil
}
