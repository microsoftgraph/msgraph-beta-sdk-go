...
// NewBinom_DistRequestBody instantiates a new binom_DistRequestBody and sets the default values.
func NewBinom_DistRequestBody()(*Binom_DistRequestBody) {
    m := &Binom_DistRequestBody{
    }
...
func (m *Binom_DistRequestBody) GetCumulative()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.cumulative
...
func (m *Binom_DistRequestBody) GetNumberS()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.numberS
...
func (m *Binom_DistRequestBody) GetProbabilityS()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
...
func (m *Binom_DistRequestBody) GetTrials()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.trials
...
func (m *Binom_DistRequestBody) SetCumulative(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.cumulative = value
    }
}
// SetNumberS sets the numberS property value. 
func (m *Binom_DistRequestBody) SetNumberS(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.numberS = value
    }
}
// SetProbabilityS sets the probabilityS property value. 
func (m *Binom_DistRequestBody) SetProbabilityS(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.probabilityS = value
    }
}
// SetTrials sets the trials property value. 
func (m *Binom_DistRequestBody) SetTrials(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.trials = value
    }
}
