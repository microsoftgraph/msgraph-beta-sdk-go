...
func (m *NetworkDays_IntlRequestBody) GetEndDate()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.endDate
...
func (m *NetworkDays_IntlRequestBody) GetHolidays()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.holidays
...
func (m *NetworkDays_IntlRequestBody) GetStartDate()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.startDate
...
func (m *NetworkDays_IntlRequestBody) GetWeekend()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.weekend
...
func (m *NetworkDays_IntlRequestBody) SetEndDate(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.endDate = value
    }
}
// SetHolidays sets the holidays property value. 
func (m *NetworkDays_IntlRequestBody) SetHolidays(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.holidays = value
    }
}
// SetStartDate sets the startDate property value. 
func (m *NetworkDays_IntlRequestBody) SetStartDate(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.startDate = value
    }
}
// SetWeekend sets the weekend property value. 
func (m *NetworkDays_IntlRequestBody) SetWeekend(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.weekend = value
    }
}
