...
// NewPriceRequestBody instantiates a new priceRequestBody and sets the default values.
func NewPriceRequestBody()(*PriceRequestBody) {
    m := &PriceRequestBody{
    }
...
func (m *PriceRequestBody) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PriceRequestBody) GetBasis()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.basis
...
func (m *PriceRequestBody) GetFrequency()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.frequency
...
func (m *PriceRequestBody) GetMaturity()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.maturity
...
func (m *PriceRequestBody) GetRate()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.rate
...
func (m *PriceRequestBody) GetRedemption()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.redemption
...
func (m *PriceRequestBody) GetSettlement()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.settlement
...
func (m *PriceRequestBody) GetYld()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.yld
...
func (m *PriceRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *PriceRequestBody) IsNil()(bool) {
    return m == nil
}
// Serialize serializes information the current object
func (m *PriceRequestBody) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
...
func (m *PriceRequestBody) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetBasis sets the basis property value. 
func (m *PriceRequestBody) SetBasis(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.basis = value
}
// SetFrequency sets the frequency property value. 
func (m *PriceRequestBody) SetFrequency(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.frequency = value
}
// SetMaturity sets the maturity property value. 
func (m *PriceRequestBody) SetMaturity(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.maturity = value
}
// SetRate sets the rate property value. 
func (m *PriceRequestBody) SetRate(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.rate = value
}
// SetRedemption sets the redemption property value. 
func (m *PriceRequestBody) SetRedemption(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.redemption = value
}
// SetSettlement sets the settlement property value. 
func (m *PriceRequestBody) SetSettlement(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.settlement = value
}
// SetYld sets the yld property value. 
func (m *PriceRequestBody) SetYld(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.yld = value
}
