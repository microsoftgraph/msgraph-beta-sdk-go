...
// GaussRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.gauss
...
// GaussRequestBuilderPostOptions options for Post
type GaussRequestBuilderPostOptions struct {
    // 
    Body *GaussRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// GaussResponse union type wrapper for classes workbookFunctionResult
...
// NewGaussResponse instantiates a new gaussResponse and sets the default values.
...
// NewGaussRequestBuilderInternal instantiates a new GaussRequestBuilder and sets the default values.
func NewGaussRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GaussRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.gauss";
...
// NewGaussRequestBuilder instantiates a new GaussRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action gauss
...
func (m *GaussRequestBuilder) Post(options *GaussRequestBuilderPostOptions)(*GaussResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGaussResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
