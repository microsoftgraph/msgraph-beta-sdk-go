...
// NewImArgumentRequestBody instantiates a new imArgumentRequestBody and sets the default values.
func NewImArgumentRequestBody()(*ImArgumentRequestBody) {
    m := &ImArgumentRequestBody{
    }
...
func (m *ImArgumentRequestBody) GetInumber()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.inumber
...
func (m *ImArgumentRequestBody) SetInumber(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.inumber = value
    }
}
