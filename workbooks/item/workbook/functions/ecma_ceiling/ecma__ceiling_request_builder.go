...
// Ecma_CeilingRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.ecma_Ceiling
...
// Ecma_CeilingRequestBuilderPostOptions options for Post
type Ecma_CeilingRequestBuilderPostOptions struct {
    // 
    Body *Ecma_CeilingRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// Ecma_CeilingResponse union type wrapper for classes workbookFunctionResult
...
// NewEcma_CeilingResponse instantiates a new ecma_CeilingResponse and sets the default values.
...
func (m *Ecma_CeilingResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *Ecma_CeilingResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewEcma_CeilingRequestBuilderInternal instantiates a new Ecma_CeilingRequestBuilder and sets the default values.
func NewEcma_CeilingRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Ecma_CeilingRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.ecma_Ceiling";
...
// NewEcma_CeilingRequestBuilder instantiates a new Ecma_CeilingRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action ecma_Ceiling
func (m *Ecma_CeilingRequestBuilder) CreatePostRequestInformation(options *Ecma_CeilingRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *Ecma_CeilingRequestBuilder) Post(options *Ecma_CeilingRequestBuilderPostOptions)(*Ecma_CeilingResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewEcma_CeilingResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
