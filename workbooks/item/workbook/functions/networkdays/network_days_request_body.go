...
// NewNetworkDaysRequestBody instantiates a new networkDaysRequestBody and sets the default values.
func NewNetworkDaysRequestBody()(*NetworkDaysRequestBody) {
    m := &NetworkDaysRequestBody{
    }
...
func (m *NetworkDaysRequestBody) GetEndDate()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.endDate
...
func (m *NetworkDaysRequestBody) GetHolidays()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.holidays
...
func (m *NetworkDaysRequestBody) GetStartDate()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.startDate
...
func (m *NetworkDaysRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *NetworkDaysRequestBody) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
...
func (m *NetworkDaysRequestBody) SetEndDate(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.endDate = value
}
// SetHolidays sets the holidays property value. 
func (m *NetworkDaysRequestBody) SetHolidays(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.holidays = value
}
// SetStartDate sets the startDate property value. 
func (m *NetworkDaysRequestBody) SetStartDate(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.startDate = value
}
