...
// LargeRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.large
...
// LargeRequestBuilderPostOptions options for Post
type LargeRequestBuilderPostOptions struct {
    // 
...
// LargeResponse union type wrapper for classes workbookFunctionResult
...
// NewLargeResponse instantiates a new largeResponse and sets the default values.
...
// NewLargeRequestBuilderInternal instantiates a new LargeRequestBuilder and sets the default values.
func NewLargeRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LargeRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.large";
...
// NewLargeRequestBuilder instantiates a new LargeRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action large
func (m *LargeRequestBuilder) CreatePostRequestInformation(options *LargeRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *LargeRequestBuilder) Post(options *LargeRequestBuilderPostOptions)(*LargeResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewLargeResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
