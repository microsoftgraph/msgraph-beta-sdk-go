...
func (m *FindBRequestBody) GetFindText()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.findText
...
func (m *FindBRequestBody) GetStartNum()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.startNum
...
func (m *FindBRequestBody) GetWithinText()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.withinText
...
func (m *FindBRequestBody) SetFindText(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.findText = value
    }
}
// SetStartNum sets the startNum property value. 
func (m *FindBRequestBody) SetStartNum(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.startNum = value
    }
}
// SetWithinText sets the withinText property value. 
func (m *FindBRequestBody) SetWithinText(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.withinText = value
    }
}
