...
// Options for Post
type MaxARequestBuilderPostOptions struct {
    // 
    Body *MaxARequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func (m *MaxARequestBuilder) Post(options *MaxARequestBuilderPostOptions)(*MaxAResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewMaxAResponse() }, nil)
    if err != nil {
        return nil, err
    }
