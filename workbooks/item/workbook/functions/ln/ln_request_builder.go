...
// LnRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.ln
...
// LnRequestBuilderPostOptions options for Post
type LnRequestBuilderPostOptions struct {
    // 
    Body *LnRequestBody;
    // Request headers
    H map[string]string;
...
// LnResponse union type wrapper for classes workbookFunctionResult
...
// NewLnResponse instantiates a new lnResponse and sets the default values.
...
// NewLnRequestBuilderInternal instantiates a new LnRequestBuilder and sets the default values.
func NewLnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LnRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.ln";
...
// NewLnRequestBuilder instantiates a new LnRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action ln
...
func (m *LnRequestBuilder) Post(options *LnRequestBuilderPostOptions)(*LnResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewLnResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
