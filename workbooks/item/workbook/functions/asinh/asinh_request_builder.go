...
// AsinhRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.asinh
...
// AsinhRequestBuilderPostOptions options for Post
type AsinhRequestBuilderPostOptions struct {
    // 
    Body *AsinhRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// AsinhResponse union type wrapper for classes workbookFunctionResult
...
// NewAsinhResponse instantiates a new asinhResponse and sets the default values.
...
func (m *AsinhResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *AsinhResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewAsinhRequestBuilderInternal instantiates a new AsinhRequestBuilder and sets the default values.
func NewAsinhRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AsinhRequestBuilder) {
    m := &AsinhRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.asinh";
...
// NewAsinhRequestBuilder instantiates a new AsinhRequestBuilder and sets the default values.
func NewAsinhRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AsinhRequestBuilder) {
    ...
    return NewAsinhRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action asinh
...
func (m *AsinhRequestBuilder) Post(options *AsinhRequestBuilderPostOptions)(*AsinhResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewAsinhResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*AsinhResponse), nil
}
