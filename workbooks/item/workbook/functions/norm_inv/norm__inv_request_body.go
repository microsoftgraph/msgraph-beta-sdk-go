...
// NewNorm_InvRequestBody instantiates a new norm_InvRequestBody and sets the default values.
...
func (m *Norm_InvRequestBody) GetMean()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.mean
...
func (m *Norm_InvRequestBody) GetProbability()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
...
func (m *Norm_InvRequestBody) GetStandardDev()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
