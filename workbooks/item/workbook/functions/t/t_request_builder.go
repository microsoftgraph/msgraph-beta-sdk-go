...
// TRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.t
...
// TRequestBuilderPostOptions options for Post
type TRequestBuilderPostOptions struct {
    // 
    Body *TRequestBody;
    // Request headers
    H map[string]string;
...
// TResponse union type wrapper for classes workbookFunctionResult
...
// NewTResponse instantiates a new tResponse and sets the default values.
...
func (m *TResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *TResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewTRequestBuilderInternal instantiates a new TRequestBuilder and sets the default values.
func NewTRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.t";
...
// NewTRequestBuilder instantiates a new TRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action t
func (m *TRequestBuilder) CreatePostRequestInformation(options *TRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *TRequestBuilder) Post(options *TRequestBuilderPostOptions)(*TResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewTResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
