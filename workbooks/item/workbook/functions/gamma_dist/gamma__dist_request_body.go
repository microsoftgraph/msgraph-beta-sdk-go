...
// gamma_DistRequestBody 
type Gamma_DistRequestBody struct {
...
// NewGamma_DistRequestBody instantiates a new gamma_DistRequestBody and sets the default values.
func NewGamma_DistRequestBody()(*Gamma_DistRequestBody) {
    m := &Gamma_DistRequestBody{
    }
    m.SetAdditionalData(make(map[string]interface{}));
    return m
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *Gamma_DistRequestBody) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Gamma_DistRequestBody) GetAlpha()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.alpha
...
func (m *Gamma_DistRequestBody) GetBeta()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.beta
...
func (m *Gamma_DistRequestBody) GetCumulative()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.cumulative
...
func (m *Gamma_DistRequestBody) GetX()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.x
...
func (m *Gamma_DistRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *Gamma_DistRequestBody) IsNil()(bool) {
    return m == nil
}
// Serialize serializes information the current object
func (m *Gamma_DistRequestBody) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
...
func (m *Gamma_DistRequestBody) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetAlpha sets the alpha property value. 
func (m *Gamma_DistRequestBody) SetAlpha(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.alpha = value
}
// SetBeta sets the beta property value. 
func (m *Gamma_DistRequestBody) SetBeta(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.beta = value
}
// SetCumulative sets the cumulative property value. 
func (m *Gamma_DistRequestBody) SetCumulative(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.cumulative = value
}
// SetX sets the x property value. 
func (m *Gamma_DistRequestBody) SetX(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    m.x = value
}
