...
// Bin2DecRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.bin2Dec
...
// Bin2DecRequestBuilderPostOptions options for Post
type Bin2DecRequestBuilderPostOptions struct {
    // 
    Body *Bin2DecRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// Bin2DecResponse union type wrapper for classes workbookFunctionResult
...
// NewBin2DecResponse instantiates a new bin2DecResponse and sets the default values.
...
// NewBin2DecRequestBuilderInternal instantiates a new Bin2DecRequestBuilder and sets the default values.
func NewBin2DecRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Bin2DecRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.bin2Dec";
...
// NewBin2DecRequestBuilder instantiates a new Bin2DecRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action bin2Dec
func (m *Bin2DecRequestBuilder) CreatePostRequestInformation(options *Bin2DecRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *Bin2DecRequestBuilder) Post(options *Bin2DecRequestBuilderPostOptions)(*Bin2DecResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewBin2DecResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
