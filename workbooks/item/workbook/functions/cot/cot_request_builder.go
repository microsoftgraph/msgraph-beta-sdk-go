...
// Options for Post
type CotRequestBuilderPostOptions struct {
    // 
    Body *CotRequestBody;
    // Request headers
    H map[string]string;
...
func (m *CotRequestBuilder) Post(options *CotRequestBuilderPostOptions)(*CotResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewCotResponse() }, nil)
    if err != nil {
        return nil, err
    }
