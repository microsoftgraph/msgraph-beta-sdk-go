...
// DbcsRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.dbcs
...
// DbcsRequestBuilderPostOptions options for Post
...
// DbcsResponse union type wrapper for classes workbookFunctionResult
...
// NewDbcsResponse instantiates a new dbcsResponse and sets the default values.
...
// NewDbcsRequestBuilderInternal instantiates a new DbcsRequestBuilder and sets the default values.
func NewDbcsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DbcsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.dbcs";
...
// NewDbcsRequestBuilder instantiates a new DbcsRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action dbcs
...
func (m *DbcsRequestBuilder) Post(options *DbcsRequestBuilderPostOptions)(*DbcsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewDbcsResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
