...
// NewTbillYieldRequestBody instantiates a new tbillYieldRequestBody and sets the default values.
func NewTbillYieldRequestBody()(*TbillYieldRequestBody) {
    m := &TbillYieldRequestBody{
    }
...
func (m *TbillYieldRequestBody) GetMaturity()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.maturity
...
func (m *TbillYieldRequestBody) GetPr()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.pr
...
func (m *TbillYieldRequestBody) GetSettlement()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.settlement
