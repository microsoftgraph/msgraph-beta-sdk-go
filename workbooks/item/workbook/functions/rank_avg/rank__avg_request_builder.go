...
// Rank_AvgRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.rank_Avg
...
// Rank_AvgRequestBuilderPostOptions options for Post
...
// Rank_AvgResponse union type wrapper for classes workbookFunctionResult
...
// NewRank_AvgResponse instantiates a new rank_AvgResponse and sets the default values.
...
// NewRank_AvgRequestBuilderInternal instantiates a new Rank_AvgRequestBuilder and sets the default values.
func NewRank_AvgRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*Rank_AvgRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.rank_Avg";
...
// NewRank_AvgRequestBuilder instantiates a new Rank_AvgRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action rank_Avg
...
func (m *Rank_AvgRequestBuilder) Post(options *Rank_AvgRequestBuilderPostOptions)(*Rank_AvgResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewRank_AvgResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
