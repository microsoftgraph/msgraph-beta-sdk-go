...
// ImExpRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.imExp
...
// ImExpRequestBuilderPostOptions options for Post
...
// ImExpResponse union type wrapper for classes workbookFunctionResult
...
// NewImExpResponse instantiates a new imExpResponse and sets the default values.
...
// NewImExpRequestBuilderInternal instantiates a new ImExpRequestBuilder and sets the default values.
...
// NewImExpRequestBuilder instantiates a new ImExpRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action imExp
...
func (m *ImExpRequestBuilder) Post(options *ImExpRequestBuilderPostOptions)(*ImExpResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewImExpResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
