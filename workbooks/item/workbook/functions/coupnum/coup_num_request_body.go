...
// NewCoupNumRequestBody instantiates a new coupNumRequestBody and sets the default values.
func NewCoupNumRequestBody()(*CoupNumRequestBody) {
    m := &CoupNumRequestBody{
    }
...
func (m *CoupNumRequestBody) GetBasis()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.basis
...
func (m *CoupNumRequestBody) GetFrequency()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.frequency
...
func (m *CoupNumRequestBody) GetMaturity()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.maturity
...
func (m *CoupNumRequestBody) GetSettlement()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.settlement
...
func (m *CoupNumRequestBody) SetBasis(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.basis = value
    }
}
// SetFrequency sets the frequency property value. 
func (m *CoupNumRequestBody) SetFrequency(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.frequency = value
    }
}
// SetMaturity sets the maturity property value. 
func (m *CoupNumRequestBody) SetMaturity(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.maturity = value
    }
}
// SetSettlement sets the settlement property value. 
func (m *CoupNumRequestBody) SetSettlement(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.settlement = value
    }
}
