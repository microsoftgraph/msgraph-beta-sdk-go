...
// T_Inv_2TRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.t_Inv_2T
...
// T_Inv_2TRequestBuilderPostOptions options for Post
type T_Inv_2TRequestBuilderPostOptions struct {
    // 
    Body *T_Inv_2TRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// T_Inv_2TResponse union type wrapper for classes workbookFunctionResult
...
// NewT_Inv_2TResponse instantiates a new t_Inv_2TResponse and sets the default values.
...
// NewT_Inv_2TRequestBuilderInternal instantiates a new T_Inv_2TRequestBuilder and sets the default values.
func NewT_Inv_2TRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*T_Inv_2TRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.t_Inv_2T";
...
// NewT_Inv_2TRequestBuilder instantiates a new T_Inv_2TRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action t_Inv_2T
