...
// NewUsdollarRequestBody instantiates a new usdollarRequestBody and sets the default values.
func NewUsdollarRequestBody()(*UsdollarRequestBody) {
    m := &UsdollarRequestBody{
    }
...
func (m *UsdollarRequestBody) GetDecimals()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.decimals
...
func (m *UsdollarRequestBody) GetNumber()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.number
...
func (m *UsdollarRequestBody) SetDecimals(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.decimals = value
    }
}
// SetNumber sets the number property value. 
func (m *UsdollarRequestBody) SetNumber(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.number = value
    }
}
