...
// NewPowerRequestBody instantiates a new powerRequestBody and sets the default values.
...
// GetPower gets the power property value. 
...
// SetPower sets the power property value. 
