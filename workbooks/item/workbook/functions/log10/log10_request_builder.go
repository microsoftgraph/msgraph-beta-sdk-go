...
func (m *Log10RequestBuilder) CreatePostRequestInformation(options *Log10RequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
// Parameters:
//  - options : Options for the request
func (m *Log10RequestBuilder) Post(options *Log10RequestBuilderPostOptions)(*Log10Response, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewLog10Response() }, nil)
    if err != nil {
        return nil, err
    }
