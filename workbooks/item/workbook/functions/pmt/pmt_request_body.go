...
// NewPmtRequestBody instantiates a new pmtRequestBody and sets the default values.
...
func (m *PmtRequestBody) GetFv()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.fv
...
func (m *PmtRequestBody) GetNper()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.nper
...
func (m *PmtRequestBody) GetPv()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.pv
...
func (m *PmtRequestBody) GetRate()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
        return m.rate
...
func (m *PmtRequestBody) GetType_escaped()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json) {
    if m == nil {
        return nil
    } else {
...
func (m *PmtRequestBody) SetFv(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.fv = value
    }
}
// SetNper sets the nper property value. 
func (m *PmtRequestBody) SetNper(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.nper = value
    }
}
// SetPv sets the pv property value. 
func (m *PmtRequestBody) SetPv(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.pv = value
    }
}
// SetRate sets the rate property value. 
func (m *PmtRequestBody) SetRate(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
        m.rate = value
    }
}
// SetType_escaped sets the type_escaped property value. 
func (m *PmtRequestBody) SetType_escaped(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Json)() {
    if m != nil {
