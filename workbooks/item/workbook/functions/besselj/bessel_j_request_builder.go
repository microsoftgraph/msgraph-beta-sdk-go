...
// BesselJRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\functions\microsoft.graph.besselJ
...
// BesselJRequestBuilderPostOptions options for Post
type BesselJRequestBuilderPostOptions struct {
    // 
    Body *BesselJRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// BesselJResponse union type wrapper for classes workbookFunctionResult
...
// NewBesselJResponse instantiates a new besselJResponse and sets the default values.
...
func (m *BesselJResponse) GetWorkbookFunctionResult()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult) {
    if m == nil {
        return nil
    } else {
...
func (m *BesselJResponse) SetWorkbookFunctionResult(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WorkbookFunctionResult)() {
    if m != nil {
        m.workbookFunctionResult = value
    }
}
// NewBesselJRequestBuilderInternal instantiates a new BesselJRequestBuilder and sets the default values.
func NewBesselJRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BesselJRequestBuilder) {
    m := &BesselJRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/functions/microsoft.graph.besselJ";
...
// NewBesselJRequestBuilder instantiates a new BesselJRequestBuilder and sets the default values.
func NewBesselJRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BesselJRequestBuilder) {
    ...
    return NewBesselJRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation invoke action besselJ
...
func (m *BesselJRequestBuilder) Post(options *BesselJRequestBuilderPostOptions)(*BesselJResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewBesselJResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*BesselJResponse), nil
}
