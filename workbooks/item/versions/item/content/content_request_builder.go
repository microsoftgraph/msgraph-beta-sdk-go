...
// GetWithResponseHandler get content for the navigation property versions from workbooks
...
// PutWithResponseHandler update content for the navigation property versions in workbooks
