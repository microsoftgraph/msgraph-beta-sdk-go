...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property versions for workbooks
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property versions in workbooks
