...
func NewDriveItemVersionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemVersionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/versions/{driveItemVersion%2Did}{?%24select,%24expand}";
...
// CreateDeleteRequestInformationWithRequestConfiguration delete navigation property versions for workbooks
...
// CreatePatchRequestInformationWithRequestConfiguration update the navigation property versions in workbooks
...
// DeleteWithResponseHandler delete navigation property versions for workbooks
...
// PatchWithResponseHandler update the navigation property versions in workbooks
