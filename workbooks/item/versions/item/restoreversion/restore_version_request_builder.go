...
func NewRestoreVersionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RestoreVersionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/versions/{driveItemVersion%2Did}/microsoft.graph.restoreVersion";
...
// CreatePostRequestInformationWithRequestConfiguration restore a previous version of a DriveItem to be the current version. This will create a new version with the contents of the previous version, but preserves all existing versions of the file.
...
func (m *RestoreVersionRequestBuilder) Post(ctx context.Context, requestConfiguration *RestoreVersionRequestBuilderPostRequestConfiguration)(error) {
