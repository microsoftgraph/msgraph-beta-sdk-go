...
func NewDriveItemVersionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemVersionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/versions/{driveItemVersion_id}{?select,expand}";
...
func (m *DriveItemVersionRequestBuilder) Content()(*id4b926af3cd2cdb02d0fb7b0357c1be3b3a9997a3c006f0ff4e8455060f554eb.ContentRequestBuilder) {
...
// Parameters:
//  - options : Options for the request
func (m *DriveItemVersionRequestBuilder) Get(options *DriveItemVersionRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DriveItemVersion, error) {
...
func (m *DriveItemVersionRequestBuilder) RestoreVersion()(*i0c836360ba9f1680580d6f72f33ac661f7adc9ff91ee77a2d62cbf248c47d7e0.RestoreVersionRequestBuilder) {
