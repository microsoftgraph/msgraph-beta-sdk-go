...
import (
    ...
    ib1c8e169d927f214eb606c00c44e0065fee13f62c70db037f719124f22a309fe "github.com/microsoftgraph/msgraph-beta-sdk-go/workbooks/item/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*ib1c8e169d927f214eb606c00c44e0065fee13f62c70db037f719124f22a309fe.CountRequestBuilder) {
    return ib1c8e169d927f214eb606c00c44e0065fee13f62c70db037f719124f22a309fe.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to subscriptions for workbooks
...
// PostWithResponseHandler create new navigation property to subscriptions for workbooks
