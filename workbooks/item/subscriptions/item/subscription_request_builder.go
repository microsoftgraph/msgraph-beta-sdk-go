...
// SubscriptionRequestBuilder builds and executes requests for operations under \workbooks\{driveItem-id}\subscriptions\{subscription-id}
...
// SubscriptionRequestBuilderGetQueryParameters the set of subscriptions on the item. Only supported on the root of a drive.
...
func NewSubscriptionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SubscriptionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem_id}/subscriptions/{subscription_id}{?select,expand}";
...
// CreateDeleteRequestInformation the set of subscriptions on the item. Only supported on the root of a drive.
...
// CreatePatchRequestInformation the set of subscriptions on the item. Only supported on the root of a drive.
...
// Delete the set of subscriptions on the item. Only supported on the root of a drive.
...
func (m *SubscriptionRequestBuilder) Get(options *SubscriptionRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Subscription, error) {
...
// Patch the set of subscriptions on the item. Only supported on the root of a drive.
