...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/workbooks/{driveItem_id}/children/{driveItem_id1}{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i9870032e42f8e96d93380bc354563e7e5a7eced59860a0c92fb7199838e572cb.ContentRequestBuilder) {
    return i9870032e42f8e96d93380bc354563e7e5a7eced59860a0c92fb7199838e572cb.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Collection containing Item objects for the immediate children of Item. Only items representing folders have children. Read-only. Nullable.
// Parameters:
