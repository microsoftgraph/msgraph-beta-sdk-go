...
func (m *InviteRequestBody) GetRecipients()([]i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DriveRecipientable) {
    if m == nil {
        return nil
    } else {
        return m.recipients
...
func (m *InviteRequestBody) SetRecipients(value []i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DriveRecipientable)() {
    if m != nil {
        m.recipients = value
    }
}
