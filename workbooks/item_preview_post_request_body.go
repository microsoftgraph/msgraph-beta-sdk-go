...
func (m *ItemPreviewPostRequestBody) GetAllowEdit()(*bool) {
    return m.allowEdit
}
// GetChromeless gets the chromeless property value. The chromeless property
func (m *ItemPreviewPostRequestBody) GetChromeless()(*bool) {
    return m.chromeless
}
...
func (m *ItemPreviewPostRequestBody) GetViewer()(*string) {
    return m.viewer
}
...
func (m *ItemPreviewPostRequestBody) SetAllowEdit(value *bool)() {
    m.allowEdit = value
}
// SetChromeless sets the chromeless property value. The chromeless property
func (m *ItemPreviewPostRequestBody) SetChromeless(value *bool)() {
    m.chromeless = value
}
...
func (m *ItemPreviewPostRequestBody) SetViewer(value *string)() {
    m.viewer = value
}
