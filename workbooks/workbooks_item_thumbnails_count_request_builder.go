...
func NewWorkbooksItemThumbnailsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemThumbnailsCountRequestBuilder) {
    m := &WorkbooksItemThumbnailsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/thumbnails/$count";
...
func NewWorkbooksItemThumbnailsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WorkbooksItemThumbnailsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewWorkbooksItemThumbnailsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *WorkbooksItemThumbnailsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *WorkbooksItemThumbnailsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *WorkbooksItemThumbnailsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WorkbooksItemThumbnailsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
