...
func (m *DriveItemItemRequestBuilder) Activities()(*ItemActivitiesRequestBuilder) {
...
func (m *DriveItemItemRequestBuilder) ActivitiesById(id string)(*ItemActivitiesItemActivityOLDItemRequestBuilder) {
    ...
    return NewItemActivitiesItemActivityOLDItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *DriveItemItemRequestBuilder) AssignSensitivityLabel()(*ItemAssignSensitivityLabelRequestBuilder) {
    return NewItemAssignSensitivityLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DriveItemItemRequestBuilder) ExtractSensitivityLabels()(*ItemExtractSensitivityLabelsRequestBuilder) {
    return NewItemExtractSensitivityLabelsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
