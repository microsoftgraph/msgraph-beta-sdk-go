...
func NewItemInviteRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInviteRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemInviteRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemInviteRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ItemInvitePostRequestBodyable, requestConfiguration *ItemInviteRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemInviteRequestBuilder) Post(ctx context.Context, body ItemInvitePostRequestBodyable, requestConfiguration *ItemInviteRequestBuilderPostRequestConfiguration)(ItemInviteResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateItemInviteResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ItemInviteResponseable), nil
}
