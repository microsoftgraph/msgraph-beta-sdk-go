...
func (m *WorkbooksDriveItemItemRequestBuilder) Activities()(*WorkbooksItemActivitiesRequestBuilder) {
    return NewWorkbooksItemActivitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ActivitiesById provides operations to manage the activities property of the microsoft.graph.driveItem entity.
func (m *WorkbooksDriveItemItemRequestBuilder) ActivitiesById(id string)(*WorkbooksItemActivitiesItemActivityOLDItemRequestBuilder) {
    ...
    return NewWorkbooksItemActivitiesItemActivityOLDItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *WorkbooksDriveItemItemRequestBuilder) AssignSensitivityLabel()(*WorkbooksItemAssignSensitivityLabelRequestBuilder) {
    return NewWorkbooksItemAssignSensitivityLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *WorkbooksDriveItemItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, requestConfiguration *WorkbooksDriveItemItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *WorkbooksDriveItemItemRequestBuilder) ExtractSensitivityLabels()(*WorkbooksItemExtractSensitivityLabelsRequestBuilder) {
    return NewWorkbooksItemExtractSensitivityLabelsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *WorkbooksDriveItemItemRequestBuilder) Get(ctx context.Context, requestConfiguration *WorkbooksDriveItemItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
