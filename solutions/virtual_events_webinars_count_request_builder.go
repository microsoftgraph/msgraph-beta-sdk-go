...
// NewVirtualEventsWebinarsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewVirtualEventsWebinarsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsWebinarsCountRequestBuilder) {
    m := &VirtualEventsWebinarsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewVirtualEventsWebinarsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
func NewVirtualEventsWebinarsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsWebinarsCountRequestBuilder) {
    ...
    return NewVirtualEventsWebinarsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *VirtualEventsWebinarsCountRequestBuilder) WithUrl(rawUrl string)(*VirtualEventsWebinarsCountRequestBuilder) {
    return NewVirtualEventsWebinarsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
