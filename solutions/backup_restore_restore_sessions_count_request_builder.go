...
func (m *BackupRestoreRestoreSessionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreRestoreSessionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
