...
// BookingBusinessesRequestBuilderGetQueryParameters a collection of businesses in Microsoft Bookings. Read-only. Nullable.
...
// Get a collection of businesses in Microsoft Bookings. Read-only. Nullable.
