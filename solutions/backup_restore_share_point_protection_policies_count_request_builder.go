...
func (m *BackupRestoreSharePointProtectionPoliciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreSharePointProtectionPoliciesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
