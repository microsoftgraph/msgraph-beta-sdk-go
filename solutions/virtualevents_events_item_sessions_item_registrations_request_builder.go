...
// VirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder provides operations to manage the registrations property of the microsoft.graph.virtualEventSession entity.
...
// VirtualeventsEventsItemSessionsItemRegistrationsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type VirtualeventsEventsItemSessionsItemRegistrationsRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
func (m *VirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder) ByVirtualEventRegistrationId(virtualEventRegistrationId string)(*VirtualeventsEventsItemSessionsItemRegistrationsVirtualEventRegistrationItemRequestBuilder) {
    ...
    return NewVirtualeventsEventsItemSessionsItemRegistrationsVirtualEventRegistrationItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
// NewVirtualeventsEventsItemSessionsItemRegistrationsRequestBuilderInternal instantiates a new VirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder and sets the default values.
func NewVirtualeventsEventsItemSessionsItemRegistrationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder) {
    m := &VirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/registrations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewVirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder instantiates a new VirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder and sets the default values.
func NewVirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewVirtualeventsEventsItemSessionsItemRegistrationsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *VirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder) WithUrl(rawUrl string)(*VirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder) {
    return NewVirtualeventsEventsItemSessionsItemRegistrationsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
