...
func (m *VirtualEventsTownhallsItemSessionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEventsTownhallsItemSessionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
