...
// NewVirtualEventsWebinarsItemRegistrationsItemSessionsWithJoinWebUrlRequestBuilderInternal instantiates a new SessionsWithJoinWebUrlRequestBuilder and sets the default values.
func NewVirtualEventsWebinarsItemRegistrationsItemSessionsWithJoinWebUrlRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, joinWebUrl *string)(*VirtualEventsWebinarsItemRegistrationsItemSessionsWithJoinWebUrlRequestBuilder) {
    m := &VirtualEventsWebinarsItemRegistrationsItemSessionsWithJoinWebUrlRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions(joinWebUrl='{joinWebUrl}'){?%24select,%24expand}", pathParameters),
    }
    if joinWebUrl != nil {
...
// NewVirtualEventsWebinarsItemRegistrationsItemSessionsWithJoinWebUrlRequestBuilder instantiates a new SessionsWithJoinWebUrlRequestBuilder and sets the default values.
