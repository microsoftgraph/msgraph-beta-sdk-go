...
func (m *BackupRestoreExchangeProtectionPoliciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreExchangeProtectionPoliciesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
