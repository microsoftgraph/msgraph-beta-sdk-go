...
func (m *VirtualEventsTownhallsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEventsTownhallsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
