...
type VirtualEventsTownhallsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *VirtualEventsTownhallsCountRequestBuilderGetQueryParameters
}
// NewVirtualEventsTownhallsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewVirtualEventsTownhallsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsTownhallsCountRequestBuilder) {
    m := &VirtualEventsTownhallsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewVirtualEventsTownhallsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
func NewVirtualEventsTownhallsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsTownhallsCountRequestBuilder) {
    ...
    return NewVirtualEventsTownhallsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *VirtualEventsTownhallsCountRequestBuilder) WithUrl(rawUrl string)(*VirtualEventsTownhallsCountRequestBuilder) {
    return NewVirtualEventsTownhallsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
