...
func (m *BackupRestoreMailboxProtectionUnitsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreMailboxProtectionUnitsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
