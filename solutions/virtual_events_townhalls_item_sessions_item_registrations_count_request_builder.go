...
func (m *VirtualEventsTownhallsItemSessionsItemRegistrationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEventsTownhallsItemSessionsItemRegistrationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
