...
// NewVirtualEventsTownhallsItemSessionsItemRegistrationsCountRequestBuilderInternal instantiates a new VirtualEventsTownhallsItemSessionsItemRegistrationsCountRequestBuilder and sets the default values.
func NewVirtualEventsTownhallsItemSessionsItemRegistrationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsTownhallsItemSessionsItemRegistrationsCountRequestBuilder) {
    m := &VirtualEventsTownhallsItemSessionsItemRegistrationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/registrations/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewVirtualEventsTownhallsItemSessionsItemRegistrationsCountRequestBuilder instantiates a new VirtualEventsTownhallsItemSessionsItemRegistrationsCountRequestBuilder and sets the default values.
