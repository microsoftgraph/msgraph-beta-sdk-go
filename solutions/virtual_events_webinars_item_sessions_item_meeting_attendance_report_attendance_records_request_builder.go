...
// VirtualEventsWebinarsItemSessionsItemMeetingAttendanceReportAttendanceRecordsRequestBuilderGetQueryParameters get a list of attendanceRecord objects and their properties. This API is available in the following national cloud deployments.
...
func (m *VirtualEventsWebinarsItemSessionsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder) ByAttendanceRecordId(attendanceRecordId string)(*VirtualEventsWebinarsItemSessionsItemMeetingAttendanceReportAttendanceRecordsAttendanceRecordItemRequestBuilder) {
...
func (m *VirtualEventsWebinarsItemSessionsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder) WithUrl(rawUrl string)(*VirtualEventsWebinarsItemSessionsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder) {
    return NewVirtualEventsWebinarsItemSessionsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
