...
func (m *BackupRestoreProtectionUnitsGraphMailboxProtectionUnitCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreProtectionUnitsGraphMailboxProtectionUnitCountRequestBuilderGetRequestConfiguration)(*int64, error) {
