...
func (m *VirtualEventsEventsItemSessionsItemRegistrationRegistrantsRequestBuilder) ByMeetingRegistrantBaseId(meetingRegistrantBaseId string)(*VirtualEventsEventsItemSessionsItemRegistrationRegistrantsMeetingRegistrantBaseItemRequestBuilder) {
...
func (m *VirtualEventsEventsItemSessionsItemRegistrationRegistrantsRequestBuilder) WithUrl(rawUrl string)(*VirtualEventsEventsItemSessionsItemRegistrationRegistrantsRequestBuilder) {
    return NewVirtualEventsEventsItemSessionsItemRegistrationRegistrantsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
