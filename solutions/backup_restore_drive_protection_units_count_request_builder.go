...
func (m *BackupRestoreDriveProtectionUnitsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreDriveProtectionUnitsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
