...
func (m *VirtualEventsEventsItemSessionsItemPresentersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEventsEventsItemSessionsItemPresentersCountRequestBuilderGetRequestConfiguration)(*int64, error) {
