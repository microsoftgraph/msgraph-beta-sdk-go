...
func (m *VirtualEventsWebinarsItemSessionsItemRegistrationRegistrantsRequestBuilder) ByMeetingRegistrantBaseId(meetingRegistrantBaseId string)(*VirtualEventsWebinarsItemSessionsItemRegistrationRegistrantsMeetingRegistrantBaseItemRequestBuilder) {
...
func (m *VirtualEventsWebinarsItemSessionsItemRegistrationRegistrantsRequestBuilder) WithUrl(rawUrl string)(*VirtualEventsWebinarsItemSessionsItemRegistrationRegistrantsRequestBuilder) {
    return NewVirtualEventsWebinarsItemSessionsItemRegistrationRegistrantsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
