...
// BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilderGetQueryParameters get the number of the resource
type BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilderGetQueryParameters struct {
...
type BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilderGetQueryParameters
}
// NewBusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilderInternal instantiates a new BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilder and sets the default values.
func NewBusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilder) {
    m := &BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/planConfiguration/localizations/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewBusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilder instantiates a new BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilder and sets the default values.
...
func (m *BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilder) WithUrl(rawUrl string)(*BusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilder) {
    return NewBusinessScenariosItemPlannerPlanConfigurationLocalizationsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
