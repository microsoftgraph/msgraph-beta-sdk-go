...
func (m *BackupRestoreSiteInclusionRulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreSiteInclusionRulesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
