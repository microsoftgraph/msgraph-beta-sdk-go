...
func (m *BackupRestoreServiceAppsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreServiceAppsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
