...
func (m *BackupRestoreExchangeProtectionPoliciesItemMailboxInclusionRulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreExchangeProtectionPoliciesItemMailboxInclusionRulesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
