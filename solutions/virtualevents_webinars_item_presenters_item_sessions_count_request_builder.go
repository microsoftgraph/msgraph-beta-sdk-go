...
// NewVirtualeventsWebinarsItemPresentersItemSessionsCountRequestBuilderInternal instantiates a new VirtualeventsWebinarsItemPresentersItemSessionsCountRequestBuilder and sets the default values.
func NewVirtualeventsWebinarsItemPresentersItemSessionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualeventsWebinarsItemPresentersItemSessionsCountRequestBuilder) {
    m := &VirtualeventsWebinarsItemPresentersItemSessionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/presenters/{virtualEventPresenter%2Did}/sessions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewVirtualeventsWebinarsItemPresentersItemSessionsCountRequestBuilder instantiates a new VirtualeventsWebinarsItemPresentersItemSessionsCountRequestBuilder and sets the default values.
