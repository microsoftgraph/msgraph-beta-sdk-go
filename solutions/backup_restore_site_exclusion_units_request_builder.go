...
// BackupRestoreSiteExclusionUnitsRequestBuilder provides operations to manage the siteExclusionUnits property of the microsoft.graph.backupRestoreRoot entity.
...
// BackupRestoreSiteExclusionUnitsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type BackupRestoreSiteExclusionUnitsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreSiteExclusionUnitsRequestBuilderGetQueryParameters
}
// BackupRestoreSiteExclusionUnitsRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type BackupRestoreSiteExclusionUnitsRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// BySiteExclusionUnitId provides operations to manage the siteExclusionUnits property of the microsoft.graph.backupRestoreRoot entity.
// returns a *BackupRestoreSiteExclusionUnitsSiteExclusionUnitItemRequestBuilder when successful
func (m *BackupRestoreSiteExclusionUnitsRequestBuilder) BySiteExclusionUnitId(siteExclusionUnitId string)(*BackupRestoreSiteExclusionUnitsSiteExclusionUnitItemRequestBuilder) {
    ...
    return NewBackupRestoreSiteExclusionUnitsSiteExclusionUnitItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
...
// NewBackupRestoreSiteExclusionUnitsRequestBuilder instantiates a new BackupRestoreSiteExclusionUnitsRequestBuilder and sets the default values.
func NewBackupRestoreSiteExclusionUnitsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreSiteExclusionUnitsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewBackupRestoreSiteExclusionUnitsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *BackupRestoreSiteExclusionUnitsCountRequestBuilder when successful
...
// Post create new navigation property to siteExclusionUnits for solutions
// returns a SiteExclusionUnitable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *BackupRestoreSiteExclusionUnitsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SiteExclusionUnitable, requestConfiguration *BackupRestoreSiteExclusionUnitsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SiteExclusionUnitable, error) {
...
// returns a *BackupRestoreSiteExclusionUnitsRequestBuilder when successful
func (m *BackupRestoreSiteExclusionUnitsRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreSiteExclusionUnitsRequestBuilder) {
    return NewBackupRestoreSiteExclusionUnitsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
