...
func (m *BusinessScenariosItemPlannerRequestBuilder) MicrosoftGraphGetPlan()(*BusinessScenariosItemPlannerMicrosoftGraphGetPlanRequestBuilder) {
    return NewBusinessScenariosItemPlannerMicrosoftGraphGetPlanRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
