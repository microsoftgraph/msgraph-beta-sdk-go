...
func (m *BusinessScenariosItemPlannerRequestBuilder) Delete(ctx context.Context, requestConfiguration *BusinessScenariosItemPlannerRequestBuilderDeleteRequestConfiguration)([]byte, error) {
