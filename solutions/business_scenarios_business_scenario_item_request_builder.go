...
func (m *BusinessScenariosBusinessScenarioItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *BusinessScenariosBusinessScenarioItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
