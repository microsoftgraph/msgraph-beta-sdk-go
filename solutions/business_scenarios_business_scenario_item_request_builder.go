...
// BusinessScenariosBusinessScenarioItemRequestBuilderGetQueryParameters read the properties and relationships of a businessScenario object. This API is available in the following national cloud deployments.
...
// Delete delete a businessScenario object. The deletion of a scenario causes all data associated with the scenario to be deleted. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Get read the properties and relationships of a businessScenario object. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Patch update the properties of a businessScenario object. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToDeleteRequestInformation delete a businessScenario object. The deletion of a scenario causes all data associated with the scenario to be deleted. This API is available in the following national cloud deployments.
...
// ToGetRequestInformation read the properties and relationships of a businessScenario object. This API is available in the following national cloud deployments.
...
// ToPatchRequestInformation update the properties of a businessScenario object. This API is available in the following national cloud deployments.
