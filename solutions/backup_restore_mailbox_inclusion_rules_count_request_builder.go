...
func (m *BackupRestoreMailboxInclusionRulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreMailboxInclusionRulesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
