...
// VirtualeventsWebinarsGetbyuserrolewithroleGetByUserRoleWithRoleRequestBuilderGetQueryParameters get a list of virtualEventWebinar objects where the signed-in user is either the organizer or a coorganizer.
