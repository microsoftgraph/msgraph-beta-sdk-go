...
func (m *BackupRestoreExchangeProtectionPoliciesItemMailboxProtectionUnitsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreExchangeProtectionPoliciesItemMailboxProtectionUnitsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
