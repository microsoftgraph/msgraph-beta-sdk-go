...
func (m *BookingBusinessesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BookingBusinessesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
