...
func (m *BackupRestoreProtectionUnitsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreProtectionUnitsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
