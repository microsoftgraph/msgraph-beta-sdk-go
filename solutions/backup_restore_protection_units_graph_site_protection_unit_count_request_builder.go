...
func (m *BackupRestoreProtectionUnitsGraphSiteProtectionUnitCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreProtectionUnitsGraphSiteProtectionUnitCountRequestBuilderGetRequestConfiguration)(*int64, error) {
