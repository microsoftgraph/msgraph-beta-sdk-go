...
// returns a *VirtualeventsEventsItemPresentersItemSessionswithjoinweburlSessionsWithJoinWebUrlRequestBuilder when successful
func (m *VirtualeventsEventsItemPresentersVirtualEventPresenterItemRequestBuilder) SessionsWithJoinWebUrl(joinWebUrl *string)(*VirtualeventsEventsItemPresentersItemSessionswithjoinweburlSessionsWithJoinWebUrlRequestBuilder) {
    return NewVirtualeventsEventsItemPresentersItemSessionswithjoinweburlSessionsWithJoinWebUrlRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, joinWebUrl)
}
