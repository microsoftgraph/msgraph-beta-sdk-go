...
func (m *BookingCurrenciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BookingCurrenciesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
