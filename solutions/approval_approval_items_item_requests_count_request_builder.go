...
func (m *ApprovalApprovalItemsItemRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ApprovalApprovalItemsItemRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
