...
type BackuprestoreServiceappsItemActivateRequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func NewBackuprestoreServiceappsItemActivateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackuprestoreServiceappsItemActivateRequestBuilder) {
    m := &BackuprestoreServiceappsItemActivateRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/serviceApps/{serviceApp%2Did}/activate", pathParameters),
    }
    return m
}
...
func NewBackuprestoreServiceappsItemActivateRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackuprestoreServiceappsItemActivateRequestBuilder) {
    ...
    return NewBackuprestoreServiceappsItemActivateRequestBuilderInternal(urlParams, requestAdapter)
}
// Post activate a serviceApp.
...
func (m *BackuprestoreServiceappsItemActivateRequestBuilder) Post(ctx context.Context, requestConfiguration *BackuprestoreServiceappsItemActivateRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ServiceAppable, error) {
...
// ToPostRequestInformation activate a serviceApp.
// returns a *RequestInformation when successful
func (m *BackuprestoreServiceappsItemActivateRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *BackuprestoreServiceappsItemActivateRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *BackuprestoreServiceappsItemActivateRequestBuilder) WithUrl(rawUrl string)(*BackuprestoreServiceappsItemActivateRequestBuilder) {
    return NewBackuprestoreServiceappsItemActivateRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
