...
// NewVirtualEventsTownhallsItemSessionsItemRegistrationsRequestBuilderInternal instantiates a new RegistrationsRequestBuilder and sets the default values.
func NewVirtualEventsTownhallsItemSessionsItemRegistrationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsTownhallsItemSessionsItemRegistrationsRequestBuilder) {
    m := &VirtualEventsTownhallsItemSessionsItemRegistrationsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/registrations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewVirtualEventsTownhallsItemSessionsItemRegistrationsRequestBuilder instantiates a new RegistrationsRequestBuilder and sets the default values.
