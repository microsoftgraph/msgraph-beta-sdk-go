...
func (m *VirtualEventsWebinarsItemRegistrationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEventsWebinarsItemRegistrationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
