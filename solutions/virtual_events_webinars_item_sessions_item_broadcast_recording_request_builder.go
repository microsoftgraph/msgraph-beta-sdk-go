...
func (m *VirtualEventsWebinarsItemSessionsItemBroadcastRecordingRequestBuilder) WithUrl(rawUrl string)(*VirtualEventsWebinarsItemSessionsItemBroadcastRecordingRequestBuilder) {
    return NewVirtualEventsWebinarsItemSessionsItemBroadcastRecordingRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
