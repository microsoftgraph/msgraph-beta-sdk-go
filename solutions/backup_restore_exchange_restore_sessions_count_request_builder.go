...
func (m *BackupRestoreExchangeRestoreSessionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreExchangeRestoreSessionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
