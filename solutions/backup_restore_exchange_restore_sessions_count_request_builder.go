...
type BackupRestoreExchangeRestoreSessionsCountRequestBuilderGetQueryParameters struct {
...
type BackupRestoreExchangeRestoreSessionsCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreExchangeRestoreSessionsCountRequestBuilderGetQueryParameters
}
...
func NewBackupRestoreExchangeRestoreSessionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreExchangeRestoreSessionsCountRequestBuilder) {
    m := &BackupRestoreExchangeRestoreSessionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/exchangeRestoreSessions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewBackupRestoreExchangeRestoreSessionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreExchangeRestoreSessionsCountRequestBuilder) {
    ...
    return NewBackupRestoreExchangeRestoreSessionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreExchangeRestoreSessionsCountRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreExchangeRestoreSessionsCountRequestBuilder) {
    return NewBackupRestoreExchangeRestoreSessionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
