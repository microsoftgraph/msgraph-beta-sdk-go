...
// VirtualEventsWebinarsItemRegistrationsRequestBuilderGetQueryParameters get a list of all registration records of a webinar. This API is available in the following national cloud deployments.
...
// NewVirtualEventsWebinarsItemRegistrationsRequestBuilderInternal instantiates a new RegistrationsRequestBuilder and sets the default values.
func NewVirtualEventsWebinarsItemRegistrationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsWebinarsItemRegistrationsRequestBuilder) {
    m := &VirtualEventsWebinarsItemRegistrationsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewVirtualEventsWebinarsItemRegistrationsRequestBuilder instantiates a new RegistrationsRequestBuilder and sets the default values.
...
// Get get a list of all registration records of a webinar. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get a list of all registration records of a webinar. This API is available in the following national cloud deployments.
