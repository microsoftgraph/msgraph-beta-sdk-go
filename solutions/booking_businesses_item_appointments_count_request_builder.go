...
func (m *BookingBusinessesItemAppointmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *BookingBusinessesItemAppointmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
