...
func (m *BusinessFlowTemplateItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *BusinessFlowTemplateItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
