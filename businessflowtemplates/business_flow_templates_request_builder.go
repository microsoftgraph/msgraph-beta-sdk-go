...
// BusinessFlowTemplatesRequestBuilderGetQueryParameters in the Azure AD access reviews feature, list all the businessFlowTemplate objects. This API is available in the following national cloud deployments.
...
// Get in the Azure AD access reviews feature, list all the businessFlowTemplate objects. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation in the Azure AD access reviews feature, list all the businessFlowTemplate objects. This API is available in the following national cloud deployments.
