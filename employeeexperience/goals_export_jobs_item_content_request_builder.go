...
// GoalsExportJobsItemContentRequestBuilder provides operations to manage the media for the employeeExperience entity.
type GoalsExportJobsItemContentRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// GoalsExportJobsItemContentRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type GoalsExportJobsItemContentRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// GoalsExportJobsItemContentRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type GoalsExportJobsItemContentRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// GoalsExportJobsItemContentRequestBuilderPutRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type GoalsExportJobsItemContentRequestBuilderPutRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
// Delete the content of the goalsExportJob.
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GoalsExportJobsItemContentRequestBuilder) Delete(ctx context.Context, requestConfiguration *GoalsExportJobsItemContentRequestBuilderDeleteRequestConfiguration)(error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GoalsExportJobsItemContentRequestBuilder) Get(ctx context.Context, requestConfiguration *GoalsExportJobsItemContentRequestBuilderGetRequestConfiguration)([]byte, error) {
...
// ToDeleteRequestInformation the content of the goalsExportJob.
// returns a *RequestInformation when successful
func (m *GoalsExportJobsItemContentRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *GoalsExportJobsItemContentRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
