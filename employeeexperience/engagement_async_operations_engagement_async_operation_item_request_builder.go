...
// NewEngagementAsyncOperationsEngagementAsyncOperationItemRequestBuilderInternal instantiates a new EngagementAsyncOperationItemRequestBuilder and sets the default values.
func NewEngagementAsyncOperationsEngagementAsyncOperationItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EngagementAsyncOperationsEngagementAsyncOperationItemRequestBuilder) {
    m := &EngagementAsyncOperationsEngagementAsyncOperationItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/employeeExperience/engagementAsyncOperations/{engagementAsyncOperation%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewEngagementAsyncOperationsEngagementAsyncOperationItemRequestBuilder instantiates a new EngagementAsyncOperationItemRequestBuilder and sets the default values.
