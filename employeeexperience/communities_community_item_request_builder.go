...
// NewCommunitiesCommunityItemRequestBuilderInternal instantiates a new CommunityItemRequestBuilder and sets the default values.
func NewCommunitiesCommunityItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunitiesCommunityItemRequestBuilder) {
    m := &CommunitiesCommunityItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/employeeExperience/communities/{community%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewCommunitiesCommunityItemRequestBuilder instantiates a new CommunityItemRequestBuilder and sets the default values.
