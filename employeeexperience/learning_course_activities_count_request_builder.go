...
func (m *LearningCourseActivitiesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *LearningCourseActivitiesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
