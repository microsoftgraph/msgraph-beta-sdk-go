...
// RolesItemMembersItemUserRequestBuilder provides operations to manage the user property of the microsoft.graph.engagementRoleMember entity.
...
type RolesItemMembersItemUserRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *RolesItemMembersItemUserRequestBuilderGetQueryParameters
}
// NewRolesItemMembersItemUserRequestBuilderInternal instantiates a new RolesItemMembersItemUserRequestBuilder and sets the default values.
func NewRolesItemMembersItemUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RolesItemMembersItemUserRequestBuilder) {
    m := &RolesItemMembersItemUserRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/employeeExperience/roles/{engagementRole%2Did}/members/{engagementRoleMember%2Did}/user{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewRolesItemMembersItemUserRequestBuilder instantiates a new RolesItemMembersItemUserRequestBuilder and sets the default values.
...
func (m *RolesItemMembersItemUserRequestBuilder) MailboxSettings()(*RolesItemMembersItemUserMailboxSettingsRequestBuilder) {
    return NewRolesItemMembersItemUserMailboxSettingsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// ServiceProvisioningErrors the serviceProvisioningErrors property
// returns a *RolesItemMembersItemUserServiceProvisioningErrorsRequestBuilder when successful
...
func (m *RolesItemMembersItemUserRequestBuilder) WithUrl(rawUrl string)(*RolesItemMembersItemUserRequestBuilder) {
    return NewRolesItemMembersItemUserRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
