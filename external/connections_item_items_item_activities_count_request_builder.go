...
func (m *ConnectionsItemItemsItemActivitiesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConnectionsItemItemsItemActivitiesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
