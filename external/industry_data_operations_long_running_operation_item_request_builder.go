...
// IndustryDataOperationsLongRunningOperationItemRequestBuilderGetQueryParameters set of ephemeral operations that the system runs currently. Read-only.
...
func (m *IndustryDataOperationsLongRunningOperationItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *IndustryDataOperationsLongRunningOperationItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
