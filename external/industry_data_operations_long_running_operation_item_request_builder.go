...
// IndustryDataOperationsLongRunningOperationItemRequestBuilderGetQueryParameters read the properties and relationships of a fileValidateOperation object. This API is available in the following national cloud deployments.
...
// NewIndustryDataOperationsLongRunningOperationItemRequestBuilderInternal instantiates a new LongRunningOperationItemRequestBuilder and sets the default values.
func NewIndustryDataOperationsLongRunningOperationItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IndustryDataOperationsLongRunningOperationItemRequestBuilder) {
    m := &IndustryDataOperationsLongRunningOperationItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/external/industryData/operations/{longRunningOperation%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewIndustryDataOperationsLongRunningOperationItemRequestBuilder instantiates a new LongRunningOperationItemRequestBuilder and sets the default values.
...
// Get read the properties and relationships of a fileValidateOperation object. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation read the properties and relationships of a fileValidateOperation object. This API is available in the following national cloud deployments.
