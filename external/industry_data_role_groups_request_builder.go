...
// ByRoleGroupIdString provides operations to manage the roleGroups property of the microsoft.graph.industryData.industryDataRoot entity.
func (m *IndustryDataRoleGroupsRequestBuilder) ByRoleGroupIdString(roleGroupId string)(*IndustryDataRoleGroupsRoleGroupItemRequestBuilder) {
