...
// ConnectionsExternalConnectionItemRequestBuilderGetQueryParameters retrieve the properties and relationships of an externalConnection. This API is supported in the following national cloud deployments.
...
// Delete delete an externalConnection. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// Get retrieve the properties and relationships of an externalConnection. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// Patch update the properties of an externalConnection. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToDeleteRequestInformation delete an externalConnection. This API is supported in the following national cloud deployments.
...
// ToGetRequestInformation retrieve the properties and relationships of an externalConnection. This API is supported in the following national cloud deployments.
...
// ToPatchRequestInformation update the properties of an externalConnection. This API is supported in the following national cloud deployments.
