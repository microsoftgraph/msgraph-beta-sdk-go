...
func NewIndustryDataSourceSystemsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IndustryDataSourceSystemsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/external/industryData/sourceSystems{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *IndustryDataSourceSystemsRequestBuilder) Count()(*IndustryDataSourceSystemsCountRequestBuilder) {
    return NewIndustryDataSourceSystemsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get get a list of the sourceSystemDefinition objects and their properties.
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/industrydata-sourcesystemdefinition-list?view=graph-rest-1.0
func (m *IndustryDataSourceSystemsRequestBuilder) Get(ctx context.Context, requestConfiguration *IndustryDataSourceSystemsRequestBuilderGetRequestConfiguration)(id2b46acaed365d10a0a4cc89e0aa6f2f76ad54e2147428aee709d25e554da66a.SourceSystemDefinitionCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, id2b46acaed365d10a0a4cc89e0aa6f2f76ad54e2147428aee709d25e554da66a.CreateSourceSystemDefinitionCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/industrydata-sourcesystemdefinition-post?view=graph-rest-1.0
