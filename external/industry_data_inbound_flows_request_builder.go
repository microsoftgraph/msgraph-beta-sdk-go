...
// IndustryDataInboundFlowsRequestBuilderGetQueryParameters get a list of the inboundFileFlow objects and their properties. This API is available in the following national cloud deployments.
...
// NewIndustryDataInboundFlowsRequestBuilderInternal instantiates a new InboundFlowsRequestBuilder and sets the default values.
func NewIndustryDataInboundFlowsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IndustryDataInboundFlowsRequestBuilder) {
    m := &IndustryDataInboundFlowsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/external/industryData/inboundFlows{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewIndustryDataInboundFlowsRequestBuilder instantiates a new InboundFlowsRequestBuilder and sets the default values.
...
// Get get a list of the inboundFileFlow objects and their properties. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create a new inboundFileFlow object. The following prerequisite resources are required when you create an inboundFileFlow: This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get a list of the inboundFileFlow objects and their properties. This API is available in the following national cloud deployments.
...
// ToPostRequestInformation create a new inboundFileFlow object. The following prerequisite resources are required when you create an inboundFileFlow: This API is available in the following national cloud deployments.
