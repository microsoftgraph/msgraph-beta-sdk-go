...
func (m *IndustryDataRunsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *IndustryDataRunsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
