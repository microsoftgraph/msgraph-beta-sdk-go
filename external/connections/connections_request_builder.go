...
// CreateGetRequestInformationWithRequestConfiguration retrieve a list of externalConnections.
...
// CreatePostRequestInformationWithRequestConfiguration create a new externalConnection.
