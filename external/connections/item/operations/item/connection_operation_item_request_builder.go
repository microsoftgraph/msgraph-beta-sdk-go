...
// DeleteWithResponseHandler delete navigation property operations for external
...
// PatchWithResponseHandler update the navigation property operations in external
