...
// GroupsRequestBuilderGetQueryParameters get groups from external
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to groups for external
