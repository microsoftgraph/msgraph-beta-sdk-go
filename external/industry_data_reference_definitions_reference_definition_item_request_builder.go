...
func (m *IndustryDataReferenceDefinitionsReferenceDefinitionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *IndustryDataReferenceDefinitionsReferenceDefinitionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
