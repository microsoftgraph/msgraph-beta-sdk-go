...
// ConnectionsItemSchemaRequestBuilderGetQueryParameters retrieve the properties of a schema for an externalConnection. This API is available in the following national cloud deployments.
...
// Patch update the properties of a schema for an externalConnection. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPatchRequestInformation update the properties of a schema for an externalConnection. This API is available in the following national cloud deployments.
