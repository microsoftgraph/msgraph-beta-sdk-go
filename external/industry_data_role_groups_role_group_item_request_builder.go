...
func (m *IndustryDataRoleGroupsRoleGroupItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *IndustryDataRoleGroupsRoleGroupItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
