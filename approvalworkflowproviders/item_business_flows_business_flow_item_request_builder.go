...
func (m *ItemBusinessFlowsBusinessFlowItemRequestBuilder) MicrosoftGraphRecordDecisions()(*ItemBusinessFlowsItemMicrosoftGraphRecordDecisionsRequestBuilder) {
    return NewItemBusinessFlowsItemMicrosoftGraphRecordDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
