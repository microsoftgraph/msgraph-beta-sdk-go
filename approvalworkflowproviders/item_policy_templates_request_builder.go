...
// NewItemPolicyTemplatesRequestBuilderInternal instantiates a new PolicyTemplatesRequestBuilder and sets the default values.
...
// NewItemPolicyTemplatesRequestBuilder instantiates a new PolicyTemplatesRequestBuilder and sets the default values.
...
func (m *ItemPolicyTemplatesRequestBuilder) Count()(*ItemPolicyTemplatesCountRequestBuilder) {
    return NewItemPolicyTemplatesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get policyTemplates from approvalWorkflowProviders
func (m *ItemPolicyTemplatesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemPolicyTemplatesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
