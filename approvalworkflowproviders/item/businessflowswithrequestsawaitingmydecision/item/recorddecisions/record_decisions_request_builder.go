...
// RecordDecisionsRequestBuilder builds and executes requests for operations under \approvalWorkflowProviders\{approvalWorkflowProvider-id}\businessFlowsWithRequestsAwaitingMyDecision\{businessFlow-id}\microsoft.graph.recordDecisions
