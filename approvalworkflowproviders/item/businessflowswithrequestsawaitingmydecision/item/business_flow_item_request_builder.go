...
// BusinessFlowItemRequestBuilderDeleteOptions options for Delete
type BusinessFlowItemRequestBuilderDeleteOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// BusinessFlowItemRequestBuilderGetOptions options for Get
type BusinessFlowItemRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
    // Request query parameters
    Q *BusinessFlowItemRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
// BusinessFlowItemRequestBuilderPatchOptions options for Patch
type BusinessFlowItemRequestBuilderPatchOptions struct {
    // 
...
func NewBusinessFlowItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BusinessFlowItemRequestBuilder) {
    m := &BusinessFlowItemRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider_id}/businessFlowsWithRequestsAwaitingMyDecision/{businessFlow_id}{?select,expand}";
...
func NewBusinessFlowItemRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*BusinessFlowItemRequestBuilder) {
...
func (m *BusinessFlowItemRequestBuilder) CreateDeleteRequestInformation(options *BusinessFlowItemRequestBuilderDeleteOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *BusinessFlowItemRequestBuilder) CreateGetRequestInformation(options *BusinessFlowItemRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *BusinessFlowItemRequestBuilder) CreatePatchRequestInformation(options *BusinessFlowItemRequestBuilderPatchOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *BusinessFlowItemRequestBuilder) Delete(options *BusinessFlowItemRequestBuilderDeleteOptions)(error) {
...
func (m *BusinessFlowItemRequestBuilder) Get(options *BusinessFlowItemRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.BusinessFlowable, error) {
...
func (m *BusinessFlowItemRequestBuilder) Patch(options *BusinessFlowItemRequestBuilderPatchOptions)(error) {
