...
func (m *ItemBusinessFlowsWithRequestsAwaitingMyDecisionBusinessFlowItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemBusinessFlowsWithRequestsAwaitingMyDecisionBusinessFlowItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
