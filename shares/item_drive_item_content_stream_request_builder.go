...
// ItemDriveItemContentStreamRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemDriveItemContentStreamRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
func (m *ItemDriveItemContentStreamRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemDriveItemContentStreamRequestBuilderDeleteRequestConfiguration)(error) {
...
func (m *ItemDriveItemContentStreamRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemDriveItemContentStreamRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
