...
func NewSharesItemListColumnsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListColumnsCountRequestBuilder) {
    m := &SharesItemListColumnsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/columns/$count";
...
func NewSharesItemListColumnsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListColumnsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSharesItemListColumnsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *SharesItemListColumnsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SharesItemListColumnsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SharesItemListColumnsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemListColumnsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
