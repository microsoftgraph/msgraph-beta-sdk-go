...
func (m *SharesItemListItemRequestBuilder) Activities()(*SharesItemListItemActivitiesRequestBuilder) {
    return NewSharesItemListItemActivitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ActivitiesById provides operations to manage the activities property of the microsoft.graph.listItem entity.
func (m *SharesItemListItemRequestBuilder) ActivitiesById(id string)(*SharesItemListItemActivitiesItemActivityOLDItemRequestBuilder) {
    ...
    return NewSharesItemListItemActivitiesItemActivityOLDItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *SharesItemListItemRequestBuilder) CreateLink()(*SharesItemListItemCreateLinkRequestBuilder) {
    return NewSharesItemListItemCreateLinkRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreatePatchRequestInformation update the navigation property listItem in shares
func (m *SharesItemListItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ListItemable, requestConfiguration *SharesItemListItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *SharesItemListItemRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemListItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ListItemable, error) {
