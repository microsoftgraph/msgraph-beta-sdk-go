...
func NewSharesItemListContentTypesItemUnpublishRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListContentTypesItemUnpublishRequestBuilder) {
    m := &SharesItemListContentTypesItemUnpublishRequestBuilder{
    }
...
func NewSharesItemListContentTypesItemUnpublishRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListContentTypesItemUnpublishRequestBuilder) {
    ...
    return NewSharesItemListContentTypesItemUnpublishRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation unpublish a [contentType][] from a content type hub site.
func (m *SharesItemListContentTypesItemUnpublishRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *SharesItemListContentTypesItemUnpublishRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SharesItemListContentTypesItemUnpublishRequestBuilder) Post(ctx context.Context, requestConfiguration *SharesItemListContentTypesItemUnpublishRequestBuilderPostRequestConfiguration)(error) {
