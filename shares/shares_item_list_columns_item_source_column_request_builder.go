...
// SharesItemListColumnsItemSourceColumnRequestBuilderGetQueryParameters the source column for content type column.
...
func NewSharesItemListColumnsItemSourceColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListColumnsItemSourceColumnRequestBuilder) {
    m := &SharesItemListColumnsItemSourceColumnRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}";
...
func NewSharesItemListColumnsItemSourceColumnRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListColumnsItemSourceColumnRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSharesItemListColumnsItemSourceColumnRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation the source column for content type column.
func (m *SharesItemListColumnsItemSourceColumnRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SharesItemListColumnsItemSourceColumnRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SharesItemListColumnsItemSourceColumnRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemListColumnsItemSourceColumnRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ColumnDefinitionable, error) {
