...
func (m *ItemListContenttypesItemColumnsColumnDefinitionItemRequestBuilder) SourceColumn()(*ItemListContenttypesItemColumnsItemSourcecolumnSourceColumnRequestBuilder) {
    return NewItemListContenttypesItemColumnsItemSourcecolumnSourceColumnRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
