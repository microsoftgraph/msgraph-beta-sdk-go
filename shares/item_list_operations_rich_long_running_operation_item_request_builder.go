...
// ItemListOperationsRichLongRunningOperationItemRequestBuilderGetQueryParameters the collection of long running operations for the list.
...
func NewItemListOperationsRichLongRunningOperationItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListOperationsRichLongRunningOperationItemRequestBuilder) {
    m := &ItemListOperationsRichLongRunningOperationItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/operations/{richLongRunningOperation%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *ItemListOperationsRichLongRunningOperationItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemListOperationsRichLongRunningOperationItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
