...
func NewSharesItemListContentTypesItemColumnPositionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListContentTypesItemColumnPositionsCountRequestBuilder) {
    m := &SharesItemListContentTypesItemColumnPositionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/columnPositions/$count";
...
func NewSharesItemListContentTypesItemColumnPositionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListContentTypesItemColumnPositionsCountRequestBuilder) {
    ...
    return NewSharesItemListContentTypesItemColumnPositionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *SharesItemListContentTypesItemColumnPositionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SharesItemListContentTypesItemColumnPositionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SharesItemListContentTypesItemColumnPositionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemListContentTypesItemColumnPositionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
