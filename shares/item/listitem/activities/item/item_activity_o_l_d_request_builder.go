...
// Builds and executes requests for operations under \shares\{sharedDriveItem-id}\listItem\activities\{itemActivityOLD-id}
...
func NewItemActivityOLDRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ItemActivityOLDRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/shares/{sharedDriveItem_id}/listItem/activities/{itemActivityOLD_id}{?select,expand}";
...
func (m *ItemActivityOLDRequestBuilder) DriveItem()(*ie3eab8855f016c6955d913461dfcba96883f9d4d2e66a3f3c730f0a03a29c79b.DriveItemRequestBuilder) {
...
func (m *ItemActivityOLDRequestBuilder) ListItem()(*i8a6b98f5bdc806d7b1a30226a1ce5a583b76652204cd15f7b9fff8cf5ba03a45.ListItemRequestBuilder) {
