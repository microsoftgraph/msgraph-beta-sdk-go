...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property activities for shares
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property activities in shares
