...
// DeleteWithResponseHandler delete navigation property activities for shares
...
// PatchWithResponseHandler update the navigation property activities in shares
