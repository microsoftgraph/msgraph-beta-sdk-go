...
import (
    ...
    ifa05255ee3fdd16fdc632376e85d447f66823d1edc721a4a1174d2faf0e831db "github.com/microsoftgraph/msgraph-beta-sdk-go/shares/item/listitem/driveitem/content"
)

// driveItemRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\listItem\driveItem
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/listItem/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*ifa05255ee3fdd16fdc632376e85d447f66823d1edc721a4a1174d2faf0e831db.ContentRequestBuilder) {
    return ifa05255ee3fdd16fdc632376e85d447f66823d1edc721a4a1174d2faf0e831db.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
