...
import (
    ...
    i0ae4e798a3c3ebb9c32181103c2d0515b628101464529310e438116be20bff80 "github.com/microsoftgraph/msgraph-beta-sdk-go/shares/item/list/activities/item/listitem/driveitem/content"
)

// DriveItemRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\activities\{itemActivityOLD-id}\listItem\driveItem
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/activities/{itemActivityOLD_id}/listItem/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i0ae4e798a3c3ebb9c32181103c2d0515b628101464529310e438116be20bff80.ContentRequestBuilder) {
    return i0ae4e798a3c3ebb9c32181103c2d0515b628101464529310e438116be20bff80.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
