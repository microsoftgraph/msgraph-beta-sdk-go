...
// ContentTypesRequestBuilderGetQueryParameters get contentTypes from shares
...
func NewContentTypesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ContentTypesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// CreateGetRequestInformationWithRequestConfiguration get contentTypes from shares
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to contentTypes for shares
...
// GetWithRequestConfigurationAndResponseHandler get contentTypes from shares
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to contentTypes for shares
