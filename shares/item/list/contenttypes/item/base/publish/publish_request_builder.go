...
// Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\contentTypes\{contentType-id}\base\microsoft.graph.publish
...
// Parameters:
//  - options : Options for the request
func (m *PublishRequestBuilder) Post(options *PublishRequestBuilderPostOptions)(error) {
