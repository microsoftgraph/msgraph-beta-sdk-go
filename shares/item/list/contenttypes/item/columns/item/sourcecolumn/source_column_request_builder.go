...
import (
    ...
    ib52952f025c50c5872abecdb159ac8831fa0c5ee2c1fb43a8f74d0e571821630 "github.com/microsoftgraph/msgraph-beta-sdk-go/shares/item/list/contenttypes/item/columns/item/sourcecolumn/ref"
)

// SourceColumnRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\contentTypes\{contentType-id}\columns\{columnDefinition-id}\sourceColumn
...
func NewSourceColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SourceColumnRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/contentTypes/{contentType_id}/columns/{columnDefinition_id}/sourceColumn{?select,expand}";
...
func (m *SourceColumnRequestBuilder) Ref()(*ib52952f025c50c5872abecdb159ac8831fa0c5ee2c1fb43a8f74d0e571821630.RefRequestBuilder) {
    return ib52952f025c50c5872abecdb159ac8831fa0c5ee2c1fb43a8f74d0e571821630.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
