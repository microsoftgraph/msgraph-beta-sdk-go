...
// DeleteWithResponseHandler delete navigation property contentTypes for shares
...
// PatchWithResponseHandler update the navigation property contentTypes in shares
