...
// DeleteWithResponseHandler delete navigation property list for shares
...
// GetWithResponseHandler used to access the underlying list
...
// PatchWithResponseHandler update the navigation property list in shares
