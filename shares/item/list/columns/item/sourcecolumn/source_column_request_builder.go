...
import (
    ...
    ic73645b28e39c10ea374df1aa24ec08db7cb142d5c2f7c39c266f92d1b08f7c0 "github.com/microsoftgraph/msgraph-beta-sdk-go/shares/item/list/columns/item/sourcecolumn/ref"
)

// SourceColumnRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\columns\{columnDefinition-id}\sourceColumn
...
func NewSourceColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SourceColumnRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/columns/{columnDefinition_id}/sourceColumn{?select,expand}";
...
func (m *SourceColumnRequestBuilder) Ref()(*ic73645b28e39c10ea374df1aa24ec08db7cb142d5c2f7c39c266f92d1b08f7c0.RefRequestBuilder) {
    return ic73645b28e39c10ea374df1aa24ec08db7cb142d5c2f7c39c266f92d1b08f7c0.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
