...
// ColumnsRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\columns
...
// CreatePostRequestInformation the collection of field definitions for this list.
...
// Post the collection of field definitions for this list.
func (m *ColumnsRequestBuilder) Post(options *ColumnsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ColumnDefinition, error) {
