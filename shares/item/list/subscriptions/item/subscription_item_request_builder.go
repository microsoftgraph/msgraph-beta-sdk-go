...
// DeleteWithResponseHandler delete navigation property subscriptions for shares
...
// PatchWithResponseHandler update the navigation property subscriptions in shares
