...
import (
    ...
    iee4cff418e3bb2ed06aedf6c5c74e736b78be3f16ae6e01dc95ff94f771571e0 "github.com/microsoftgraph/msgraph-beta-sdk-go/shares/item/list/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*iee4cff418e3bb2ed06aedf6c5c74e736b78be3f16ae6e01dc95ff94f771571e0.CountRequestBuilder) {
    return iee4cff418e3bb2ed06aedf6c5c74e736b78be3f16ae6e01dc95ff94f771571e0.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to subscriptions for shares
...
// PostWithResponseHandler create new navigation property to subscriptions for shares
