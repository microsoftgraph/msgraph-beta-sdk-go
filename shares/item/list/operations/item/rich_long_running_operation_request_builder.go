...
// RichLongRunningOperationRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\operations\{richLongRunningOperation-id}
...
// RichLongRunningOperationRequestBuilderGetQueryParameters get operations from shares
