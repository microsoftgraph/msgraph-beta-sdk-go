...
import (
    ...
    ie0559bbdef62c426c31be983c4a66f8f588854f782b065b6767513049cd01439 "github.com/microsoftgraph/msgraph-beta-sdk-go/shares/item/list/items/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *VersionsRequestBuilder) Count()(*ie0559bbdef62c426c31be983c4a66f8f588854f782b065b6767513049cd01439.CountRequestBuilder) {
    return ie0559bbdef62c426c31be983c4a66f8f588854f782b065b6767513049cd01439.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to versions for shares
...
// PostWithResponseHandler create new navigation property to versions for shares
