...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property versions for shares
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property versions in shares
