...
import (
    ...
    i7ea2c4e1ac1adc1673ed81045717ae5fd8dd44203e97875384e6b35b088adca5 "github.com/microsoftgraph/msgraph-beta-sdk-go/shares/item/list/items/item/activities/item/listitem"
    if3feaf51d0da33ae64f3a6aa41dff8ff6461e230c73d3bcbea825ee0fdb610ca "github.com/microsoftgraph/msgraph-beta-sdk-go/shares/item/list/items/item/activities/item/driveitem"
)

// ItemActivityOLDRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\items\{listItem-id}\activities\{itemActivityOLD-id}
...
func NewItemActivityOLDRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ItemActivityOLDRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/items/{listItem_id}/activities/{itemActivityOLD_id}{?select,expand}";
...
func (m *ItemActivityOLDRequestBuilder) DriveItem()(*if3feaf51d0da33ae64f3a6aa41dff8ff6461e230c73d3bcbea825ee0fdb610ca.DriveItemRequestBuilder) {
    return if3feaf51d0da33ae64f3a6aa41dff8ff6461e230c73d3bcbea825ee0fdb610ca.NewDriveItemRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemActivityOLDRequestBuilder) ListItem()(*i7ea2c4e1ac1adc1673ed81045717ae5fd8dd44203e97875384e6b35b088adca5.ListItemRequestBuilder) {
    return i7ea2c4e1ac1adc1673ed81045717ae5fd8dd44203e97875384e6b35b088adca5.NewListItemRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
