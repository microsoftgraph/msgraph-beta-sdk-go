...
// CreatePostRequestInformation create new navigation property to documentSetVersions for shares
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to documentSetVersions for shares
