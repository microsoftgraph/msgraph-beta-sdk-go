...
// DriveItemRequestBuilder builds and executes requests for operations under \shares\{sharedDriveItem-id}\driveItem
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/driveItem{?select,expand}";
...
// CreatePatchRequestInformation used to access the underlying driveItem
...
// Patch used to access the underlying driveItem
