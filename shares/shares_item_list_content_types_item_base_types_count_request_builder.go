...
func NewSharesItemListContentTypesItemBaseTypesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListContentTypesItemBaseTypesCountRequestBuilder) {
    m := &SharesItemListContentTypesItemBaseTypesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/baseTypes/$count";
...
func NewSharesItemListContentTypesItemBaseTypesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemListContentTypesItemBaseTypesCountRequestBuilder) {
    ...
    return NewSharesItemListContentTypesItemBaseTypesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *SharesItemListContentTypesItemBaseTypesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SharesItemListContentTypesItemBaseTypesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SharesItemListContentTypesItemBaseTypesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemListContentTypesItemBaseTypesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
