...
func NewSharesItemRootContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemRootContentRequestBuilder) {
    m := &SharesItemRootContentRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/root/content";
...
func NewSharesItemRootContentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemRootContentRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSharesItemRootContentRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation the content stream, if the item represents a file.
func (m *SharesItemRootContentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SharesItemRootContentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SharesItemRootContentRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *SharesItemRootContentRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *SharesItemRootContentRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemRootContentRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *SharesItemRootContentRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *SharesItemRootContentRequestBuilderPutRequestConfiguration)(error) {
