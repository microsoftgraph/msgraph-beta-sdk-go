...
func (m *ItemPermissionRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemPermissionRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Permissionable, error) {
...
func (m *ItemPermissionRequestBuilder) MicrosoftGraphRevokeGrants()(*ItemPermissionMicrosoftGraphRevokeGrantsRevokeGrantsRequestBuilder) {
    return NewItemPermissionMicrosoftGraphRevokeGrantsRevokeGrantsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemPermissionRequestBuilder) ToPatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Permissionable, requestConfiguration *ItemPermissionRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
