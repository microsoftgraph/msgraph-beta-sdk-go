...
func (m *ItemPermissionRequestBuilder) MicrosoftGraphRevokeGrants()(*ItemPermissionMicrosoftGraphRevokeGrantsRequestBuilder) {
    return NewItemPermissionMicrosoftGraphRevokeGrantsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
