...
func (m *ItemListItemRequestBuilder) Activities()(*ItemListItemActivitiesRequestBuilder) {
    return NewItemListItemActivitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ActivitiesById provides operations to manage the activities property of the microsoft.graph.listItem entity.
func (m *ItemListItemRequestBuilder) ActivitiesById(id string)(*ItemListItemActivitiesItemActivityOLDItemRequestBuilder) {
    ...
    return NewItemListItemActivitiesItemActivityOLDItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
// Analytics provides operations to manage the analytics property of the microsoft.graph.listItem entity.
func (m *ItemListItemRequestBuilder) Analytics()(*ItemListItemAnalyticsRequestBuilder) {
    return NewItemListItemAnalyticsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewItemListItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListItemRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemListItemRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateLink provides operations to call the createLink method.
func (m *ItemListItemRequestBuilder) CreateLink()(*ItemListItemCreateLinkRequestBuilder) {
    return NewItemListItemCreateLinkRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Delete delete navigation property listItem for shares
func (m *ItemListItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemListItemRequestBuilderDeleteRequestConfiguration)(error) {
...
func (m *ItemListItemRequestBuilder) DocumentSetVersions()(*ItemListItemDocumentSetVersionsRequestBuilder) {
...
func (m *ItemListItemRequestBuilder) DriveItem()(*ItemListItemDriveItemRequestBuilder) {
    return NewItemListItemDriveItemRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Fields provides operations to manage the fields property of the microsoft.graph.listItem entity.
func (m *ItemListItemRequestBuilder) Fields()(*ItemListItemFieldsRequestBuilder) {
    return NewItemListItemFieldsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Get used to access the underlying listItem
func (m *ItemListItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ListItemable, error) {
...
func (m *ItemListItemRequestBuilder) GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval(endDateTime *string, interval *string, startDateTime *string)(*ItemListItemGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder) {
    return NewItemListItemGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilderInternal(m.pathParameters, m.requestAdapter, endDateTime, interval, startDateTime);
}
// Patch update the navigation property listItem in shares
func (m *ItemListItemRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ListItemable, requestConfiguration *ItemListItemRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ListItemable, error) {
...
// ToDeleteRequestInformation delete navigation property listItem for shares
func (m *ItemListItemRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemListItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemListItemRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemListItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
// ToPatchRequestInformation update the navigation property listItem in shares
func (m *ItemListItemRequestBuilder) ToPatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ListItemable, requestConfiguration *ItemListItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ItemListItemRequestBuilder) Versions()(*ItemListItemVersionsRequestBuilder) {
