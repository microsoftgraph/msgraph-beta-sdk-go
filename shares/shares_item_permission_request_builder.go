...
func NewSharesItemPermissionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemPermissionRequestBuilder) {
    m := &SharesItemPermissionRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/permission{?%24select,%24expand}";
...
func NewSharesItemPermissionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemPermissionRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSharesItemPermissionRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateDeleteRequestInformation delete navigation property permission for shares
func (m *SharesItemPermissionRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *SharesItemPermissionRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SharesItemPermissionRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SharesItemPermissionRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *SharesItemPermissionRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Permissionable, requestConfiguration *SharesItemPermissionRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *SharesItemPermissionRequestBuilder) Delete(ctx context.Context, requestConfiguration *SharesItemPermissionRequestBuilderDeleteRequestConfiguration)(error) {
...
func (m *SharesItemPermissionRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemPermissionRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Permissionable, error) {
...
func (m *SharesItemPermissionRequestBuilder) Grant()(*SharesItemPermissionGrantRequestBuilder) {
    return NewSharesItemPermissionGrantRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *SharesItemPermissionRequestBuilder) RevokeGrants()(*SharesItemPermissionRevokeGrantsRequestBuilder) {
    return NewSharesItemPermissionRevokeGrantsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
