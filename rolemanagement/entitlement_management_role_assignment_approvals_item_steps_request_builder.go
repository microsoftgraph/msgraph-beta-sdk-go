...
func (m *EntitlementManagementRoleAssignmentApprovalsItemStepsRequestBuilder) Count()(*EntitlementManagementRoleAssignmentApprovalsItemStepsCountRequestBuilder) {
    return NewEntitlementManagementRoleAssignmentApprovalsItemStepsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *EntitlementManagementRoleAssignmentApprovalsItemStepsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementManagementRoleAssignmentApprovalsItemStepsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
