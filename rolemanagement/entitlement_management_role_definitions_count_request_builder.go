...
func (m *EntitlementManagementRoleDefinitionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementRoleDefinitionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
