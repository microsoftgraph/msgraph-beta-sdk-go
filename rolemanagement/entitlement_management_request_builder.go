...
func (m *EntitlementManagementRequestBuilder) ResourceNamespacesById(id string)(*UnifiedRbacResourceNamespaceItemRequestBuilder) {
    urlTplParams := make(map[string]string)
...
func (m *EntitlementManagementRequestBuilder) RoleAssignmentApprovalsById(id string)(*ApprovalItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *EntitlementManagementRequestBuilder) TransitiveRoleAssignmentsById(id string)(*UnifiedRoleAssignmentItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
