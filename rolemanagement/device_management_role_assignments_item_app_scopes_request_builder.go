...
// ByAppScopeIdString provides operations to manage the appScopes property of the microsoft.graph.unifiedRoleAssignmentMultiple entity.
func (m *DeviceManagementRoleAssignmentsItemAppScopesRequestBuilder) ByAppScopeIdString(appScopeId string)(*DeviceManagementRoleAssignmentsItemAppScopesAppScopeItemRequestBuilder) {
