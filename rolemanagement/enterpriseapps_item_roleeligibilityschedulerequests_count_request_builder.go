...
// NewEnterpriseappsItemRoleeligibilityschedulerequestsCountRequestBuilderInternal instantiates a new EnterpriseappsItemRoleeligibilityschedulerequestsCountRequestBuilder and sets the default values.
func NewEnterpriseappsItemRoleeligibilityschedulerequestsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EnterpriseappsItemRoleeligibilityschedulerequestsCountRequestBuilder) {
    m := &EnterpriseappsItemRoleeligibilityschedulerequestsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleRequests/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewEnterpriseappsItemRoleeligibilityschedulerequestsCountRequestBuilder instantiates a new EnterpriseappsItemRoleeligibilityschedulerequestsCountRequestBuilder and sets the default values.
