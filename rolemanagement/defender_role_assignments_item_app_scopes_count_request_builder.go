...
func (m *DefenderRoleAssignmentsItemAppScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DefenderRoleAssignmentsItemAppScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
