...
func (m *CloudPCRoleAssignmentsItemPrincipalsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CloudPCRoleAssignmentsItemPrincipalsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
