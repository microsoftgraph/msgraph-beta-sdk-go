...
// NewEnterpriseAppsItemResourceNamespacesCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewEnterpriseAppsItemResourceNamespacesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EnterpriseAppsItemResourceNamespacesCountRequestBuilder) {
    m := &EnterpriseAppsItemResourceNamespacesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/resourceNamespaces/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewEnterpriseAppsItemResourceNamespacesCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
