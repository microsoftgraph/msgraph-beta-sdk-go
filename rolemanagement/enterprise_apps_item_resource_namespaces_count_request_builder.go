...
func (m *EnterpriseAppsItemResourceNamespacesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EnterpriseAppsItemResourceNamespacesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
