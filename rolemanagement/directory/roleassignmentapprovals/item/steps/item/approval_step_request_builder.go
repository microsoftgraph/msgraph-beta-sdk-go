...
// ApprovalStepRequestBuilder builds and executes requests for operations under \roleManagement\directory\roleAssignmentApprovals\{approval-id}\steps\{approvalStep-id}
...
// ApprovalStepRequestBuilderGetQueryParameters get steps from roleManagement
