...
import (
    ...
    id81d300535230e7ebd52140bc1b359318999938b12d58d2169e0db0437e9753b "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/directory/roleassignmentapprovals/item/steps/count"
)
...
func NewStepsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*StepsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentApprovals/{approval_id}/steps{?top,skip,search,filter,count,orderby,select,expand}";
