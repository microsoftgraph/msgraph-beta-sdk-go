...
func NewAppScopeRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AppScopeRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest_id}/appScope{?select,expand}";
...
func (m *AppScopeRequestBuilder) Ref()(*i09ffd7877381400effa3a1360eb778bac4dfa59de2f3620f88565de8c9e50525.RefRequestBuilder) {
    return i09ffd7877381400effa3a1360eb778bac4dfa59de2f3620f88565de8c9e50525.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
