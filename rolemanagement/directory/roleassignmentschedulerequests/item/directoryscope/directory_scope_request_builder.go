...
import (
    ...
    i3f87a0ab21fc1054da11e5a50807833dfce475da19c82a2e9250cbd14493513d "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/directory/roleassignmentschedulerequests/item/directoryscope/ref"
)

// DirectoryScopeRequestBuilder builds and executes requests for operations under \roleManagement\directory\roleAssignmentScheduleRequests\{unifiedRoleAssignmentScheduleRequest-id}\directoryScope
...
func NewDirectoryScopeRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DirectoryScopeRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest_id}/directoryScope{?select,expand}";
...
func (m *DirectoryScopeRequestBuilder) Ref()(*i3f87a0ab21fc1054da11e5a50807833dfce475da19c82a2e9250cbd14493513d.RefRequestBuilder) {
    return i3f87a0ab21fc1054da11e5a50807833dfce475da19c82a2e9250cbd14493513d.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
