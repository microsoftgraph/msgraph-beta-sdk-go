...
// RefRequestBuilder builds and executes requests for operations under \roleManagement\directory\roleAssignmentScheduleRequests\{unifiedRoleAssignmentScheduleRequest-id}\targetSchedule\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest_id}/targetSchedule/$ref";
...
// CreateDeleteRequestInformation property indicating the schedule for an eligible role assignment.
...
// CreatePutRequestInformation property indicating the schedule for an eligible role assignment.
...
// Delete property indicating the schedule for an eligible role assignment.
...
// Put property indicating the schedule for an eligible role assignment.
