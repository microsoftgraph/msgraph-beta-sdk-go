...
import (
    ...
    i1e496a1188f5069ea4fa213d9e581bc9df38b2378a5d8ced39a4b122eddb61f2 "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/directory/transitiveroleassignments/item/directoryscope/ref"
)

// DirectoryScopeRequestBuilder builds and executes requests for operations under \roleManagement\directory\transitiveRoleAssignments\{unifiedRoleAssignment-id}\directoryScope
...
func NewDirectoryScopeRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DirectoryScopeRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment_id}/directoryScope{?select,expand}";
...
func (m *DirectoryScopeRequestBuilder) Ref()(*i1e496a1188f5069ea4fa213d9e581bc9df38b2378a5d8ced39a4b122eddb61f2.RefRequestBuilder) {
    return i1e496a1188f5069ea4fa213d9e581bc9df38b2378a5d8ced39a4b122eddb61f2.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
