...
import (
    ...
    idda17e302ba0da51c3f2f9b0774d51b6fa1937f63150979d42f5653718b20ee2 "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/directory/transitiveroleassignments/item/principal/ref"
)

// PrincipalRequestBuilder builds and executes requests for operations under \roleManagement\directory\transitiveRoleAssignments\{unifiedRoleAssignment-id}\principal
...
func NewPrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PrincipalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment_id}/principal{?select,expand}";
...
func (m *PrincipalRequestBuilder) Ref()(*idda17e302ba0da51c3f2f9b0774d51b6fa1937f63150979d42f5653718b20ee2.RefRequestBuilder) {
    return idda17e302ba0da51c3f2f9b0774d51b6fa1937f63150979d42f5653718b20ee2.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
