...
import (
    ...
    i70434b66a157495881529d79d49b9dec22be413149d496f06a973485e390fb30 "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/directory/transitiveroleassignments/item/roledefinition/ref"
)

// RoleDefinitionRequestBuilder builds and executes requests for operations under \roleManagement\directory\transitiveRoleAssignments\{unifiedRoleAssignment-id}\roleDefinition
...
func NewRoleDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RoleDefinitionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment_id}/roleDefinition{?select,expand}";
...
func (m *RoleDefinitionRequestBuilder) Ref()(*i70434b66a157495881529d79d49b9dec22be413149d496f06a973485e390fb30.RefRequestBuilder) {
    return i70434b66a157495881529d79d49b9dec22be413149d496f06a973485e390fb30.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
