...
// UnifiedRbacResourceNamespaceItemRequestBuilder builds and executes requests for operations under \roleManagement\directory\resourceNamespaces\{unifiedRbacResourceNamespace-id}
