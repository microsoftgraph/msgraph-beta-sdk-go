...
func (m *DirectoryRoleEligibilitySchedulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleEligibilitySchedulesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
