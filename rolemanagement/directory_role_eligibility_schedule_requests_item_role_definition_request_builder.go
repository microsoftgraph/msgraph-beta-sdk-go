...
// NewDirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilderInternal instantiates a new DirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilder and sets the default values.
func NewDirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilder) {
    m := &DirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/roleDefinition{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewDirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilder instantiates a new DirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilder and sets the default values.
...
func (m *DirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UnifiedRoleDefinitionable, error) {
...
func (m *DirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilder) WithUrl(rawUrl string)(*DirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilder) {
    return NewDirectoryRoleEligibilityScheduleRequestsItemRoleDefinitionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
