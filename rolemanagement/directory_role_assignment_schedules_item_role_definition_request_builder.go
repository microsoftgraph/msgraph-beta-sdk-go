...
// NewDirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilderInternal instantiates a new DirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder and sets the default values.
func NewDirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder) {
    m := &DirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}/roleDefinition{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewDirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder instantiates a new DirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder and sets the default values.
func NewDirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder) {
    ...
    return NewDirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UnifiedRoleDefinitionable, error) {
...
func (m *DirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder) WithUrl(rawUrl string)(*DirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder) {
    return NewDirectoryRoleAssignmentSchedulesItemRoleDefinitionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
