...
func (m *DirectoryRequestBuilder) RoleAssignmentApprovals()(*DirectoryRoleassignmentapprovalsRoleAssignmentApprovalsRequestBuilder) {
    return NewDirectoryRoleassignmentapprovalsRoleAssignmentApprovalsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a * when successful
func (m *DirectoryRequestBuilder) RoleScheduleInstancesdirectoryScopeIdDirectoryScopeIdAppScopeIdAppScopeIdPrincipalIdPrincipalIdRoleDefinitionIdRoleDefinitionId()(*) {
    return (m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a * when successful
func (m *DirectoryRequestBuilder) RoleSchedulesdirectoryScopeIdDirectoryScopeIdAppScopeIdAppScopeIdPrincipalIdPrincipalIdRoleDefinitionIdRoleDefinitionId()(*) {
    return (m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *DirectoryRequestBuilder) TransitiveRoleAssignments()(*DirectoryTransitiveroleassignmentsTransitiveRoleAssignmentsRequestBuilder) {
    return NewDirectoryTransitiveroleassignmentsTransitiveRoleAssignmentsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
