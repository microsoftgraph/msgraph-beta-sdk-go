...
func NewEntitlementmanagementResourcenamespacesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcenamespacesCountRequestBuilder) {
    m := &EntitlementmanagementResourcenamespacesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewEntitlementmanagementResourcenamespacesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcenamespacesCountRequestBuilder) {
    ...
    return NewEntitlementmanagementResourcenamespacesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementmanagementResourcenamespacesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementmanagementResourcenamespacesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *EntitlementmanagementResourcenamespacesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementmanagementResourcenamespacesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementmanagementResourcenamespacesCountRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementResourcenamespacesCountRequestBuilder) {
    return NewEntitlementmanagementResourcenamespacesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
