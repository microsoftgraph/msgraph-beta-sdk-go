...
func (m *EntitlementManagementResourceNamespacesRequestBuilder) Count()(*EntitlementManagementResourceNamespacesCountRequestBuilder) {
    return NewEntitlementManagementResourceNamespacesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of the unifiedRbacResourceNamespace objects and their properties.
func (m *EntitlementManagementResourceNamespacesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementManagementResourceNamespacesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
