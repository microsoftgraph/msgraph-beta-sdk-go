...
func (m *DirectoryRoleAssignmentApprovalsRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*DirectoryRoleAssignmentApprovalsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilder) {
    return NewDirectoryRoleAssignmentApprovalsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
