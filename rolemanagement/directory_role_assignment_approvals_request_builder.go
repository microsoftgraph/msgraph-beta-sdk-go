...
// NewDirectoryRoleAssignmentApprovalsRequestBuilderInternal instantiates a new RoleAssignmentApprovalsRequestBuilder and sets the default values.
func NewDirectoryRoleAssignmentApprovalsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleAssignmentApprovalsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentApprovals{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewDirectoryRoleAssignmentApprovalsRequestBuilder instantiates a new RoleAssignmentApprovalsRequestBuilder and sets the default values.
...
func (m *DirectoryRoleAssignmentApprovalsRequestBuilder) Count()(*DirectoryRoleAssignmentApprovalsCountRequestBuilder) {
    return NewDirectoryRoleAssignmentApprovalsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get roleAssignmentApprovals from roleManagement
func (m *DirectoryRoleAssignmentApprovalsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRoleAssignmentApprovalsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRoleAssignmentApprovalsRequestBuilder) FilterByCurrentUserWithOn(on *string)(*DirectoryRoleAssignmentApprovalsFilterByCurrentUserWithOnRequestBuilder) {
    return NewDirectoryRoleAssignmentApprovalsFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on);
}
