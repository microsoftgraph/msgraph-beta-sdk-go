...
import (
    ...
    i37fa644627caea76181cdfce2f9518d21f6d114a1018c438aea0c127ccb38959 "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/cloudpc/resourcenamespaces/item/resourceactions/count"
)
...
func NewResourceActionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ResourceActionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/cloudPC/resourceNamespaces/{unifiedRbacResourceNamespace_id}/resourceActions{?top,skip,search,filter,count,orderby,select,expand}";
