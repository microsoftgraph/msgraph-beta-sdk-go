...
func (m *EntitlementManagementRoleEligibilityScheduleRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementRoleEligibilityScheduleRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
