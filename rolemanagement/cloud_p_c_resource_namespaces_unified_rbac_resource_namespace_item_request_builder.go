...
func (m *CloudPCResourceNamespacesUnifiedRbacResourceNamespaceItemRequestBuilder) MicrosoftGraphImportResourceActions()(*CloudPCResourceNamespacesItemMicrosoftGraphImportResourceActionsRequestBuilder) {
    return NewCloudPCResourceNamespacesItemMicrosoftGraphImportResourceActionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
