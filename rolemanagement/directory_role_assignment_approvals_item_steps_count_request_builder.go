...
func (m *DirectoryRoleAssignmentApprovalsItemStepsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleAssignmentApprovalsItemStepsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
