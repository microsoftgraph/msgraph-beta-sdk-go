...
import (
    ...
    ie26f80e0d7bf88d6cf15d5fbf27e91c68485157c7e87b9ed79291a9b5013fa77 "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/devicemanagement/roledefinitions/count"
)

// RoleDefinitionsRequestBuilder provides operations to manage the roleDefinitions property of the microsoft.graph.rbacApplicationMultiple entity.
...
func NewRoleDefinitionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RoleDefinitionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/deviceManagement/roleDefinitions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RoleDefinitionsRequestBuilder) Count()(*ie26f80e0d7bf88d6cf15d5fbf27e91c68485157c7e87b9ed79291a9b5013fa77.CountRequestBuilder) {
    return ie26f80e0d7bf88d6cf15d5fbf27e91c68485157c7e87b9ed79291a9b5013fa77.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
