...
// UnifiedRoleDefinitionItemRequestBuilder builds and executes requests for operations under \roleManagement\deviceManagement\roleDefinitions\{unifiedRoleDefinition-id}
