...
func (m *DeviceManagementResourceNamespacesUnifiedRbacResourceNamespaceItemRequestBuilder) MicrosoftGraphImportResourceActions()(*DeviceManagementResourceNamespacesItemMicrosoftGraphImportResourceActionsRequestBuilder) {
    return NewDeviceManagementResourceNamespacesItemMicrosoftGraphImportResourceActionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
