...
func (m *DefenderResourceNamespacesItemResourceActionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DefenderResourceNamespacesItemResourceActionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
