...
// NewDeviceManagementResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilderInternal instantiates a new DeviceManagementResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilder and sets the default values.
func NewDeviceManagementResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceManagementResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilder) {
    m := &DeviceManagementResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/deviceManagement/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}/authenticationContext{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewDeviceManagementResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilder instantiates a new DeviceManagementResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilder and sets the default values.
