...
func (m *CloudPCRoleAssignmentsItemDirectoryScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CloudPCRoleAssignmentsItemDirectoryScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
