...
// ExchangeCustomAppScopesCustomAppScopeItemRequestBuilder provides operations to manage the customAppScopes property of the microsoft.graph.unifiedRbacApplication entity.
type ExchangeCustomAppScopesCustomAppScopeItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ExchangeCustomAppScopesCustomAppScopeItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ExchangeCustomAppScopesCustomAppScopeItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// ExchangeCustomAppScopesCustomAppScopeItemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ExchangeCustomAppScopesCustomAppScopeItemRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ExchangeCustomAppScopesCustomAppScopeItemRequestBuilderGetQueryParameters
}
// ExchangeCustomAppScopesCustomAppScopeItemRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ExchangeCustomAppScopesCustomAppScopeItemRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
// NewExchangeCustomAppScopesCustomAppScopeItemRequestBuilder instantiates a new ExchangeCustomAppScopesCustomAppScopeItemRequestBuilder and sets the default values.
func NewExchangeCustomAppScopesCustomAppScopeItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExchangeCustomAppScopesCustomAppScopeItemRequestBuilder) {
...
func (m *ExchangeCustomAppScopesCustomAppScopeItemRequestBuilder) ToPatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CustomAppScopeable, requestConfiguration *ExchangeCustomAppScopesCustomAppScopeItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.PATCH, "{+baseurl}/roleManagement/exchange/customAppScopes/{customAppScope%2Did}", m.BaseRequestBuilder.PathParameters)
    if requestConfiguration != nil {
        requestInfo.Headers.AddAll(requestConfiguration.Headers)
        requestInfo.AddRequestOptions(requestConfiguration.Options)
    }
...
func (m *ExchangeCustomAppScopesCustomAppScopeItemRequestBuilder) WithUrl(rawUrl string)(*ExchangeCustomAppScopesCustomAppScopeItemRequestBuilder) {
    return NewExchangeCustomAppScopesCustomAppScopeItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
