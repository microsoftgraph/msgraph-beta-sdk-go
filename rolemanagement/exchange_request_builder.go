...
func NewExchangeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExchangeRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/exchange{?%24select,%24expand}";
...
func (m *ExchangeRequestBuilder) Get(ctx context.Context, requestConfiguration *ExchangeRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UnifiedRbacApplicationable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateUnifiedRbacApplicationFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ExchangeRequestBuilder) ResourceNamespaces()(*ExchangeResourceNamespacesRequestBuilder) {
    return NewExchangeResourceNamespacesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ExchangeRequestBuilder) ResourceNamespacesById(id string)(*ExchangeResourceNamespacesUnifiedRbacResourceNamespaceItemRequestBuilder) {
    ...
    return NewExchangeResourceNamespacesUnifiedRbacResourceNamespaceItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
...
func (m *ExchangeRequestBuilder) RoleAssignments()(*ExchangeRoleAssignmentsRequestBuilder) {
    return NewExchangeRoleAssignmentsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ExchangeRequestBuilder) RoleAssignmentsById(id string)(*ExchangeRoleAssignmentsUnifiedRoleAssignmentItemRequestBuilder) {
    ...
    return NewExchangeRoleAssignmentsUnifiedRoleAssignmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
...
func (m *ExchangeRequestBuilder) RoleDefinitions()(*ExchangeRoleDefinitionsRequestBuilder) {
    return NewExchangeRoleDefinitionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ExchangeRequestBuilder) RoleDefinitionsById(id string)(*ExchangeRoleDefinitionsUnifiedRoleDefinitionItemRequestBuilder) {
    ...
    return NewExchangeRoleDefinitionsUnifiedRoleDefinitionItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
...
func (m *ExchangeRequestBuilder) TransitiveRoleAssignments()(*ExchangeTransitiveRoleAssignmentsRequestBuilder) {
    return NewExchangeTransitiveRoleAssignmentsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ExchangeRequestBuilder) TransitiveRoleAssignmentsById(id string)(*ExchangeTransitiveRoleAssignmentsUnifiedRoleAssignmentItemRequestBuilder) {
    ...
    return NewExchangeTransitiveRoleAssignmentsUnifiedRoleAssignmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
