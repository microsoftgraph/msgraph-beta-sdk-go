...
// ExchangeRoleDefinitionsItemInheritsPermissionsFromRequestBuilderGetQueryParameters read-only collection of role definitions that the given role definition inherits from. Only Azure AD built-in roles support this attribute.
...
func NewExchangeRoleDefinitionsItemInheritsPermissionsFromRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExchangeRoleDefinitionsItemInheritsPermissionsFromRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/exchange/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ExchangeRoleDefinitionsItemInheritsPermissionsFromRequestBuilder) Count()(*ExchangeRoleDefinitionsItemInheritsPermissionsFromCountRequestBuilder) {
    return NewExchangeRoleDefinitionsItemInheritsPermissionsFromCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
