...
// NewEnterpriseAppsItemRoleAssignmentSchedulesItemAppScopeRequestBuilderInternal instantiates a new EnterpriseAppsItemRoleAssignmentSchedulesItemAppScopeRequestBuilder and sets the default values.
...
// NewEnterpriseAppsItemRoleAssignmentSchedulesItemAppScopeRequestBuilder instantiates a new EnterpriseAppsItemRoleAssignmentSchedulesItemAppScopeRequestBuilder and sets the default values.
...
func (m *EnterpriseAppsItemRoleAssignmentSchedulesItemAppScopeRequestBuilder) WithUrl(rawUrl string)(*EnterpriseAppsItemRoleAssignmentSchedulesItemAppScopeRequestBuilder) {
    return NewEnterpriseAppsItemRoleAssignmentSchedulesItemAppScopeRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
