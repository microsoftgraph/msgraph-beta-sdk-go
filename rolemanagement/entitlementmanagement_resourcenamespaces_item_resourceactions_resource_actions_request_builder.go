...
// EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilderGetQueryParameters operations that an authorized principal is allowed to perform.
...
func (m *EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder) ByUnifiedRbacResourceActionId(unifiedRbacResourceActionId string)(*EntitlementmanagementResourcenamespacesItemResourceactionsUnifiedRbacResourceActionItemRequestBuilder) {
...
func NewEntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder) {
    m := &EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder{
...
func NewEntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder) {
    ...
    return NewEntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *EntitlementmanagementResourcenamespacesItemResourceactionsCountRequestBuilder when successful
func (m *EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder) Count()(*EntitlementmanagementResourcenamespacesItemResourceactionsCountRequestBuilder) {
...
func (m *EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UnifiedRbacResourceActionCollectionResponseable, error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UnifiedRbacResourceActionable, requestConfiguration *EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UnifiedRbacResourceActionable, error) {
...
func (m *EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UnifiedRbacResourceActionable, requestConfiguration *EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder) {
    return NewEntitlementmanagementResourcenamespacesItemResourceactionsResourceActionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
