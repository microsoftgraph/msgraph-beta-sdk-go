...
// DirectoryRoleAssignmentApprovalsItemStepsRequestBuilderGetQueryParameters in Azure AD entitlement management, lists the approvalStep objects associated with an approval object.  This call can be made by an approver, providing the identifier of the access package assignment request.
...
func (m *DirectoryRoleAssignmentApprovalsItemStepsRequestBuilder) Count()(*DirectoryRoleAssignmentApprovalsItemStepsCountRequestBuilder) {
    return NewDirectoryRoleAssignmentApprovalsItemStepsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DirectoryRoleAssignmentApprovalsItemStepsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRoleAssignmentApprovalsItemStepsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
