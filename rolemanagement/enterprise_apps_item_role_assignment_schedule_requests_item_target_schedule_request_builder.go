...
// EnterpriseAppsItemRoleAssignmentScheduleRequestsItemTargetScheduleRequestBuilderGetQueryParameters the schedule for an eligible role assignment that is referenced through the targetScheduleId property. Supports $expand and $select nested in $expand.
...
// NewEnterpriseAppsItemRoleAssignmentScheduleRequestsItemTargetScheduleRequestBuilderInternal instantiates a new EnterpriseAppsItemRoleAssignmentScheduleRequestsItemTargetScheduleRequestBuilder and sets the default values.
...
// NewEnterpriseAppsItemRoleAssignmentScheduleRequestsItemTargetScheduleRequestBuilder instantiates a new EnterpriseAppsItemRoleAssignmentScheduleRequestsItemTargetScheduleRequestBuilder and sets the default values.
