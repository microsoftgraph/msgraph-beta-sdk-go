...
func (m *DeviceManagementResourceNamespacesItemResourceActionsRequestBuilder) ByUnifiedRbacResourceActionIdString(unifiedRbacResourceActionId string)(*DeviceManagementResourceNamespacesItemResourceActionsUnifiedRbacResourceActionItemRequestBuilder) {
