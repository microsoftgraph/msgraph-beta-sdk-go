...
import (
    ...
    ia33bad535db14ddbbe010ee890da113362cd828917056ce97dfb9dd32ca0dada "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/entitlementmanagement/transitiveroleassignments/item/roledefinition/ref"
)

// RoleDefinitionRequestBuilder builds and executes requests for operations under \roleManagement\entitlementManagement\transitiveRoleAssignments\{unifiedRoleAssignment-id}\roleDefinition
...
func NewRoleDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RoleDefinitionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment_id}/roleDefinition{?select,expand}";
...
func (m *RoleDefinitionRequestBuilder) Ref()(*ia33bad535db14ddbbe010ee890da113362cd828917056ce97dfb9dd32ca0dada.RefRequestBuilder) {
    return ia33bad535db14ddbbe010ee890da113362cd828917056ce97dfb9dd32ca0dada.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
