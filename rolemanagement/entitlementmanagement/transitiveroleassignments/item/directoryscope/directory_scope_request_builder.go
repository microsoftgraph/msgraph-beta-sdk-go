...
import (
    ...
    i69285b527e8e1aced99b5292fd29a49149e7dd4f97454c2ac5fe6d4a62888273 "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/entitlementmanagement/transitiveroleassignments/item/directoryscope/ref"
)

// DirectoryScopeRequestBuilder builds and executes requests for operations under \roleManagement\entitlementManagement\transitiveRoleAssignments\{unifiedRoleAssignment-id}\directoryScope
...
func NewDirectoryScopeRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DirectoryScopeRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment_id}/directoryScope{?select,expand}";
...
func (m *DirectoryScopeRequestBuilder) Ref()(*i69285b527e8e1aced99b5292fd29a49149e7dd4f97454c2ac5fe6d4a62888273.RefRequestBuilder) {
    return i69285b527e8e1aced99b5292fd29a49149e7dd4f97454c2ac5fe6d4a62888273.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
