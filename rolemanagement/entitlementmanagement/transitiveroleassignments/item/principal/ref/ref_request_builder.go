...
// RefRequestBuilder builds and executes requests for operations under \roleManagement\entitlementManagement\transitiveRoleAssignments\{unifiedRoleAssignment-id}\principal\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment_id}/principal/$ref";
...
// CreateDeleteRequestInformation referencing the assigned principal. Read-only. Supports $expand.
...
// CreatePutRequestInformation referencing the assigned principal. Read-only. Supports $expand.
...
// Delete referencing the assigned principal. Read-only. Supports $expand.
...
// Put referencing the assigned principal. Read-only. Supports $expand.
