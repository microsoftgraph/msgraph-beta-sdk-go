...
import (
    ...
    i3449f1e92e8bd3641a923850527b5ca673cde1fb1f31d2f2f78550997d7a969e "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/entitlementmanagement/transitiveroleassignments/item/principal/ref"
)

// PrincipalRequestBuilder builds and executes requests for operations under \roleManagement\entitlementManagement\transitiveRoleAssignments\{unifiedRoleAssignment-id}\principal
...
func NewPrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PrincipalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment_id}/principal{?select,expand}";
...
func (m *PrincipalRequestBuilder) Ref()(*i3449f1e92e8bd3641a923850527b5ca673cde1fb1f31d2f2f78550997d7a969e.RefRequestBuilder) {
    return i3449f1e92e8bd3641a923850527b5ca673cde1fb1f31d2f2f78550997d7a969e.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
