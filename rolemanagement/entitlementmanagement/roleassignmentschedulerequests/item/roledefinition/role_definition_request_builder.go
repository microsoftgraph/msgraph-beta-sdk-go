...
import (
    ...
    i1f5619710c0000ff7d2d1a0e5587e5a2fe39ada1beaf465bb4746de1c068889a "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/entitlementmanagement/roleassignmentschedulerequests/item/roledefinition/ref"
)

// Builds and executes requests for operations under \roleManagement\entitlementManagement\roleAssignmentScheduleRequests\{unifiedRoleAssignmentScheduleRequest-id}\roleDefinition
...
func NewRoleDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RoleDefinitionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/roleManagement/entitlementManagement/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest_id}/roleDefinition{?select,expand}";
...
func (m *RoleDefinitionRequestBuilder) Ref()(*i1f5619710c0000ff7d2d1a0e5587e5a2fe39ada1beaf465bb4746de1c068889a.RefRequestBuilder) {
    return i1f5619710c0000ff7d2d1a0e5587e5a2fe39ada1beaf465bb4746de1c068889a.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
