...
import (
    ...
    iddfb74d7b7e74a184a833260ecbba7220dded6b81cd6dccae06aebc2e68625e1 "github.com/microsoftgraph/msgraph-beta-sdk-go/rolemanagement/entitlementmanagement/resourcenamespaces/item/resourceactions/item/resourcescope"
)

// UnifiedRbacResourceActionRequestBuilder builds and executes requests for operations under \roleManagement\entitlementManagement\resourceNamespaces\{unifiedRbacResourceNamespace-id}\resourceActions\{unifiedRbacResourceAction-id}
...
func NewUnifiedRbacResourceActionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UnifiedRbacResourceActionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/{unifiedRbacResourceNamespace_id}/resourceActions/{unifiedRbacResourceAction_id}{?select,expand}";
...
func (m *UnifiedRbacResourceActionRequestBuilder) ResourceScope()(*iddfb74d7b7e74a184a833260ecbba7220dded6b81cd6dccae06aebc2e68625e1.ResourceScopeRequestBuilder) {
