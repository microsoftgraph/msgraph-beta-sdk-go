...
// roleEligibilityScheduleRequestsRequestBuilder builds and executes requests for operations under \roleManagement\entitlementManagement\roleEligibilityScheduleRequests
...
// FilterByCurrentUserWithOn builds and executes requests for operations under \roleManagement\entitlementManagement\roleEligibilityScheduleRequests\microsoft.graph.filterByCurrentUser(on={on})
