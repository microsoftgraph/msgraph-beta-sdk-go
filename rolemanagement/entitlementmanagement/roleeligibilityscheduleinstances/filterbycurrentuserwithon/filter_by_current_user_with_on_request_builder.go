...
// FilterByCurrentUserWithOnRequestBuilder builds and executes requests for operations under \roleManagement\entitlementManagement\roleEligibilityScheduleInstances\microsoft.graph.filterByCurrentUser(on={on})
