...
// Builds and executes requests for operations under \roleManagement\entitlementManagement\roleEligibilityScheduleInstances
...
// Builds and executes requests for operations under \roleManagement\entitlementManagement\roleEligibilityScheduleInstances\microsoft.graph.filterByCurrentUser(on={on})
// Parameters:
//  - on : Usage: on={on}
...
func (m *RoleEligibilityScheduleInstancesRequestBuilder) Get(options *RoleEligibilityScheduleInstancesRequestBuilderGetOptions)(*RoleEligibilityScheduleInstancesResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewRoleEligibilityScheduleInstancesResponse() }, nil)
    if err != nil {
        return nil, err
    }
