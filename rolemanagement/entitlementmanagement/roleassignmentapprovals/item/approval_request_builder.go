...
// Builds and executes requests for operations under \roleManagement\entitlementManagement\roleAssignmentApprovals\{approval-id}
...
func NewApprovalRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ApprovalRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/roleManagement/entitlementManagement/roleAssignmentApprovals/{approval_id}{?select,expand}";
...
func (m *ApprovalRequestBuilder) Steps()(*i8dd71458c88d7d4aaa37475c42e4d9836b143a8ff6cec63445d51edde225251c.StepsRequestBuilder) {
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.roleManagement.entitlementManagement.roleAssignmentApprovals.item.steps.item collection
// Parameters:
//  - id : Unique identifier of the item
func (m *ApprovalRequestBuilder) StepsById(id string)(*i205b8ec0cfa1cc329c6ee2dea699ac1b4a920eb84807e1496c980b9b9632bff0.ApprovalStepRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i205b8ec0cfa1cc329c6ee2dea699ac1b4a920eb84807e1496c980b9b9632bff0.NewApprovalStepRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
