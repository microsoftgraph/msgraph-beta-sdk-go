...
// ExchangeCustomAppScopesRequestBuilderGetQueryParameters workload-specific scope object that represents the resources for which the principal has been granted access.
