...
func (m *EntitlementManagementResourceNamespacesUnifiedRbacResourceNamespaceItemRequestBuilder) MicrosoftGraphImportResourceActions()(*EntitlementManagementResourceNamespacesItemMicrosoftGraphImportResourceActionsRequestBuilder) {
    return NewEntitlementManagementResourceNamespacesItemMicrosoftGraphImportResourceActionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
