...
// NewEnterpriseAppsItemRoleAssignmentApprovalsItemStepsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewEnterpriseAppsItemRoleAssignmentApprovalsItemStepsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EnterpriseAppsItemRoleAssignmentApprovalsItemStepsCountRequestBuilder) {
    m := &EnterpriseAppsItemRoleAssignmentApprovalsItemStepsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentApprovals/{approval%2Did}/steps/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewEnterpriseAppsItemRoleAssignmentApprovalsItemStepsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
