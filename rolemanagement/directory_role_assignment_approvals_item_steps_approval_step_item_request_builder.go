...
func NewDirectoryRoleAssignmentApprovalsItemStepsApprovalStepItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleAssignmentApprovalsItemStepsApprovalStepItemRequestBuilder) {
    m := &DirectoryRoleAssignmentApprovalsItemStepsApprovalStepItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignmentApprovals/{approval%2Did}/steps/{approvalStep%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *DirectoryRoleAssignmentApprovalsItemStepsApprovalStepItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *DirectoryRoleAssignmentApprovalsItemStepsApprovalStepItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
