...
// NewEnterpriseAppsItemRoleAssignmentScheduleInstancesItemRoleDefinitionRequestBuilderInternal instantiates a new EnterpriseAppsItemRoleAssignmentScheduleInstancesItemRoleDefinitionRequestBuilder and sets the default values.
...
// NewEnterpriseAppsItemRoleAssignmentScheduleInstancesItemRoleDefinitionRequestBuilder instantiates a new EnterpriseAppsItemRoleAssignmentScheduleInstancesItemRoleDefinitionRequestBuilder and sets the default values.
...
// returns a *EnterpriseAppsItemRoleAssignmentScheduleInstancesItemRoleDefinitionRequestBuilder when successful
func (m *EnterpriseAppsItemRoleAssignmentScheduleInstancesItemRoleDefinitionRequestBuilder) WithUrl(rawUrl string)(*EnterpriseAppsItemRoleAssignmentScheduleInstancesItemRoleDefinitionRequestBuilder) {
    return NewEnterpriseAppsItemRoleAssignmentScheduleInstancesItemRoleDefinitionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
