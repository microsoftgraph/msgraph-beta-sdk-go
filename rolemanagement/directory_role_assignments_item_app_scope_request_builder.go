...
// DirectoryRoleAssignmentsItemAppScopeRequestBuilderGetQueryParameters details of the app specific scope when the assignment scope is app specific. Containment entity.
