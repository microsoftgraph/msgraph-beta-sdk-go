...
func (m *DirectoryRoleEligibilityScheduleInstancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleEligibilityScheduleInstancesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
