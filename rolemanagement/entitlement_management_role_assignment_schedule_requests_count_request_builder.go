...
func (m *EntitlementManagementRoleAssignmentScheduleRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementRoleAssignmentScheduleRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
