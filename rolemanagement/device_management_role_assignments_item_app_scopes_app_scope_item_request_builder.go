...
func (m *DeviceManagementRoleAssignmentsItemAppScopesAppScopeItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *DeviceManagementRoleAssignmentsItemAppScopesAppScopeItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
