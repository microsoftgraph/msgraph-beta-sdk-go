...
func (m *DirectoryRoleDefinitionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleDefinitionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
