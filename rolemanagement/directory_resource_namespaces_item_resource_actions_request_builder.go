...
func (m *DirectoryResourceNamespacesItemResourceActionsRequestBuilder) Count()(*DirectoryResourceNamespacesItemResourceActionsCountRequestBuilder) {
    return NewDirectoryResourceNamespacesItemResourceActionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of the unifiedRbacResourceAction objects and their properties.
func (m *DirectoryResourceNamespacesItemResourceActionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryResourceNamespacesItemResourceActionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
