...
// EntitlementManagementResourceNamespacesItemResourceActionsRequestBuilderGetQueryParameters operations that an authorized principal are allowed to perform.
