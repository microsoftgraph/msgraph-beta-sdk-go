...
func NewRoleManagementDirectoryRoleEligibilityScheduleInstancesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementDirectoryRoleEligibilityScheduleInstancesCountRequestBuilder) {
    m := &RoleManagementDirectoryRoleEligibilityScheduleInstancesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/roleManagement/directory/roleEligibilityScheduleInstances/$count";
...
func NewRoleManagementDirectoryRoleEligibilityScheduleInstancesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementDirectoryRoleEligibilityScheduleInstancesCountRequestBuilder) {
    ...
    return NewRoleManagementDirectoryRoleEligibilityScheduleInstancesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *RoleManagementDirectoryRoleEligibilityScheduleInstancesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *RoleManagementDirectoryRoleEligibilityScheduleInstancesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RoleManagementDirectoryRoleEligibilityScheduleInstancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *RoleManagementDirectoryRoleEligibilityScheduleInstancesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
