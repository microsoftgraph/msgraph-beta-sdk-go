...
// NewCloudPCResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilderInternal instantiates a new AuthenticationContextRequestBuilder and sets the default values.
func NewCloudPCResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CloudPCResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilder) {
    m := &CloudPCResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/cloudPC/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}/authenticationContext{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewCloudPCResourceNamespacesItemResourceActionsItemAuthenticationContextRequestBuilder instantiates a new AuthenticationContextRequestBuilder and sets the default values.
