...
// EnterpriseAppsItemRoleAssignmentsItemPrincipalRequestBuilderGetQueryParameters referencing the assigned principal. Read-only. Supports $expand except for the Exchange provider.
...
// NewEnterpriseAppsItemRoleAssignmentsItemPrincipalRequestBuilderInternal instantiates a new EnterpriseAppsItemRoleAssignmentsItemPrincipalRequestBuilder and sets the default values.
...
// NewEnterpriseAppsItemRoleAssignmentsItemPrincipalRequestBuilder instantiates a new EnterpriseAppsItemRoleAssignmentsItemPrincipalRequestBuilder and sets the default values.
