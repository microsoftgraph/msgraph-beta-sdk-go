...
func (m *DirectoryRoleAssignmentApprovalsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleAssignmentApprovalsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
