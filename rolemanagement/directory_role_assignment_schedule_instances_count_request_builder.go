...
func (m *DirectoryRoleAssignmentScheduleInstancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleAssignmentScheduleInstancesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
