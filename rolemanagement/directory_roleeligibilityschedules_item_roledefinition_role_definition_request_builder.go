...
func NewDirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilder) {
    m := &DirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilder{
...
func NewDirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilder) {
    ...
    return NewDirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UnifiedRoleDefinitionable, error) {
...
func (m *DirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilder) WithUrl(rawUrl string)(*DirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilder) {
    return NewDirectoryRoleeligibilityschedulesItemRoledefinitionRoleDefinitionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
