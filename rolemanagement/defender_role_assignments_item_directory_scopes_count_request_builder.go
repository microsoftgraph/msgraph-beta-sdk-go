...
func (m *DefenderRoleAssignmentsItemDirectoryScopesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DefenderRoleAssignmentsItemDirectoryScopesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
