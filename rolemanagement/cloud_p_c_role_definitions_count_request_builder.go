...
func (m *CloudPCRoleDefinitionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CloudPCRoleDefinitionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
