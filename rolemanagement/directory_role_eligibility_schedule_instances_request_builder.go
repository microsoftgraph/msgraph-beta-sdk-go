...
// DirectoryRoleEligibilityScheduleInstancesRequestBuilderGetQueryParameters get a list of the unifiedRoleEligibilityScheduleInstance objects and their properties. This API is available in the following national cloud deployments.
