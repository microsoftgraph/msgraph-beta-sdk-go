...
// NewCloudpcRoleassignmentsItemPrincipalsDirectoryObjectItemRequestBuilderInternal instantiates a new CloudpcRoleassignmentsItemPrincipalsDirectoryObjectItemRequestBuilder and sets the default values.
func NewCloudpcRoleassignmentsItemPrincipalsDirectoryObjectItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CloudpcRoleassignmentsItemPrincipalsDirectoryObjectItemRequestBuilder) {
    m := &CloudpcRoleassignmentsItemPrincipalsDirectoryObjectItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/principals/{directoryObject%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewCloudpcRoleassignmentsItemPrincipalsDirectoryObjectItemRequestBuilder instantiates a new CloudpcRoleassignmentsItemPrincipalsDirectoryObjectItemRequestBuilder and sets the default values.
