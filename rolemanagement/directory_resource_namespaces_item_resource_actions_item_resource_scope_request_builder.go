...
func (m *DirectoryResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilder) Delete(ctx context.Context, requestConfiguration *DirectoryResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilderDeleteRequestConfiguration)([]byte, error) {
