...
// EnterpriseAppsItemResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilder provides operations to manage the resourceScope property of the microsoft.graph.unifiedRbacResourceAction entity.
type EnterpriseAppsItemResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// EnterpriseAppsItemResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type EnterpriseAppsItemResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// EnterpriseAppsItemResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilderGetQueryParameters get resourceScope from roleManagement
type EnterpriseAppsItemResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilderGetQueryParameters struct {
    // Expand related entities
    Expand []string `uriparametername:"%24expand"`
    // Select properties to be returned
    Select []string `uriparametername:"%24select"`
}
// EnterpriseAppsItemResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type EnterpriseAppsItemResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *EnterpriseAppsItemResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilderGetQueryParameters
}
// EnterpriseAppsItemResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type EnterpriseAppsItemResourceNamespacesItemResourceActionsItemResourceScopeRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
