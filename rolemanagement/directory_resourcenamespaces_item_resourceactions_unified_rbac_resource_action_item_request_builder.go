...
func (m *DirectoryResourcenamespacesItemResourceactionsUnifiedRbacResourceActionItemRequestBuilder) AuthenticationContext()(*DirectoryResourcenamespacesItemResourceactionsItemAuthenticationcontextAuthenticationContextRequestBuilder) {
    return NewDirectoryResourcenamespacesItemResourceactionsItemAuthenticationcontextAuthenticationContextRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *DirectoryResourcenamespacesItemResourceactionsUnifiedRbacResourceActionItemRequestBuilder) ResourceScope()(*DirectoryResourcenamespacesItemResourceactionsItemResourcescopeResourceScopeRequestBuilder) {
    return NewDirectoryResourcenamespacesItemResourceactionsItemResourcescopeResourceScopeRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
