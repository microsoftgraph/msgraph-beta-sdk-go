...
// ItemRoledefinitionRoleDefinitionRequestBuilder provides operations to manage the roleDefinition property of the microsoft.graph.governanceRoleSetting entity.
...
// ItemRoledefinitionRoleDefinitionRequestBuilderGetQueryParameters read-only. The role definition that is enforced with this role setting.
...
func NewItemRoledefinitionRoleDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRoledefinitionRoleDefinitionRequestBuilder) {
    m := &ItemRoledefinitionRoleDefinitionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}/roleDefinition{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
// ToDeleteRequestInformation delete navigation property roleDefinition for governanceRoleSettings
...
// ToPatchRequestInformation update the navigation property roleDefinition in governanceRoleSettings
// returns a *RequestInformation when successful
