...
// RoleDefinitionRequestBuilder builds and executes requests for operations under \governanceRoleSettings\{governanceRoleSetting-id}\roleDefinition
...
// CreateDeleteRequestInformation read-only. The role definition that is enforced with this role setting.
...
// CreatePatchRequestInformation read-only. The role definition that is enforced with this role setting.
...
// Delete read-only. The role definition that is enforced with this role setting.
...
// Patch read-only. The role definition that is enforced with this role setting.
