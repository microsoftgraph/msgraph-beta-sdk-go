...
import (
    ...
    i70a925c7fc4dff855fdd993fd2e351091670c4ff8f4af8a0d1c133769a967314 "github.com/microsoftgraph/msgraph-beta-sdk-go/governancerolesettings/item/resource/ref"
)

// ResourceRequestBuilder builds and executes requests for operations under \governanceRoleSettings\{governanceRoleSetting-id}\resource
...
func NewResourceRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ResourceRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/governanceRoleSettings/{governanceRoleSetting_id}/resource{?select,expand}";
...
func (m *ResourceRequestBuilder) Ref()(*i70a925c7fc4dff855fdd993fd2e351091670c4ff8f4af8a0d1c133769a967314.RefRequestBuilder) {
    return i70a925c7fc4dff855fdd993fd2e351091670c4ff8f4af8a0d1c133769a967314.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
