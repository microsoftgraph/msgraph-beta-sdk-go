...
// ResourceRequestBuilder provides operations to manage the resource property of the microsoft.graph.governanceRoleSetting entity.
...
// ResourceRequestBuilderGetQueryParameters read-only. The associated resource for this role setting.
...
func NewResourceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ResourceRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}/resource{?%24select,%24expand}";
...
// CreateGetRequestInformationWithRequestConfiguration read-only. The associated resource for this role setting.
...
func (m *ResourceRequestBuilder) Get()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GovernanceResourceable, error) {
    return m.GetWithRequestConfigurationAndResponseHandler(nil, nil);
}
// GetWithRequestConfigurationAndResponseHandler read-only. The associated resource for this role setting.
func (m *ResourceRequestBuilder) GetWithRequestConfigurationAndResponseHandler(requestConfiguration *ResourceRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GovernanceResourceable, error) {
