...
// RefRequestBuilder builds and executes requests for operations under \governanceRoleSettings\{governanceRoleSetting-id}\resource\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/governanceRoleSettings/{governanceRoleSetting_id}/resource/$ref";
...
// CreatePutRequestInformation read-only. The associated resource for this role setting.
...
// Put read-only. The associated resource for this role setting.
