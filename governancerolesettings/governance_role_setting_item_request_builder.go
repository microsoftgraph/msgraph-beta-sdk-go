...
func (m *GovernanceRoleSettingItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *GovernanceRoleSettingItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
