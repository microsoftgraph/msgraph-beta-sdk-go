...
// SubjectrightsrequestsItemNotesRequestBuilderGetQueryParameters get the list of authored notes associated with a subject rights request. 
...
// ToGetRequestInformation get the list of authored notes associated with a subject rights request. 
// Deprecated: The subject rights request API under Privacy is deprecated and will stop working on  March 22, 2025. Please use the new API under Security. as of 2022-02/PrivacyDeprecate
