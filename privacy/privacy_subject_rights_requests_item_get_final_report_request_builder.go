...
func NewPrivacySubjectRightsRequestsItemGetFinalReportRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivacySubjectRightsRequestsItemGetFinalReportRequestBuilder) {
    m := &PrivacySubjectRightsRequestsItemGetFinalReportRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/privacy/subjectRightsRequests/{subjectRightsRequest%2Did}/microsoft.graph.getFinalReport()";
...
func NewPrivacySubjectRightsRequestsItemGetFinalReportRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivacySubjectRightsRequestsItemGetFinalReportRequestBuilder) {
    ...
    return NewPrivacySubjectRightsRequestsItemGetFinalReportRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation invoke function getFinalReport
func (m *PrivacySubjectRightsRequestsItemGetFinalReportRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *PrivacySubjectRightsRequestsItemGetFinalReportRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PrivacySubjectRightsRequestsItemGetFinalReportRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivacySubjectRightsRequestsItemGetFinalReportRequestBuilderGetRequestConfiguration)([]byte, error) {
