...
func (m *GetFinalAttachmentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GetFinalAttachmentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetFinalAttachmentRequestBuilder) Get(ctx context.Context, requestConfiguration *GetFinalAttachmentRequestBuilderGetRequestConfiguration)([]byte, error) {
