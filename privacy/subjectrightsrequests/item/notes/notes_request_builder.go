...
import (
    ...
    i2891832a5a79e054cb34d0fe8244ba9928f24da06389b806184229473faa0425 "github.com/microsoftgraph/msgraph-beta-sdk-go/privacy/subjectrightsrequests/item/notes/count"
)
...
type NotesRequestBuilderPostOptions struct {
    // 
    Body i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AuthoredNoteable;
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
...
func (m *NotesRequestBuilder) Count()(*i2891832a5a79e054cb34d0fe8244ba9928f24da06389b806184229473faa0425.CountRequestBuilder) {
    return i2891832a5a79e054cb34d0fe8244ba9928f24da06389b806184229473faa0425.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *NotesRequestBuilder) Get(options *NotesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AuthoredNoteCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateAuthoredNoteCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AuthoredNoteCollectionResponseable), nil
}
// Post create new navigation property to notes for privacy
func (m *NotesRequestBuilder) Post(options *NotesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AuthoredNoteable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateAuthoredNoteFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AuthoredNoteable), nil
}
