...
func NewTeamRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TeamRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/privacy/subjectRightsRequests/{subjectRightsRequest_id}/team{?select,expand}";
...
func (m *TeamRequestBuilder) Ref()(*ib0916a0fe7812894da9633632f9c11526d90a576835816d9fa83a7b5a2e264fa.RefRequestBuilder) {
    return ib0916a0fe7812894da9633632f9c11526d90a576835816d9fa83a7b5a2e264fa.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
