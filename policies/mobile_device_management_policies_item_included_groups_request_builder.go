...
// MobileDeviceManagementPoliciesItemIncludedGroupsRequestBuilderGetQueryParameters microsoft Entra groups under the scope of the mobility management application if appliesTo is selected
...
// NewMobileDeviceManagementPoliciesItemIncludedGroupsRequestBuilderInternal instantiates a new MobileDeviceManagementPoliciesItemIncludedGroupsRequestBuilder and sets the default values.
...
// NewMobileDeviceManagementPoliciesItemIncludedGroupsRequestBuilder instantiates a new MobileDeviceManagementPoliciesItemIncludedGroupsRequestBuilder and sets the default values.
...
func (m *MobileDeviceManagementPoliciesItemIncludedGroupsRequestBuilder) WithUrl(rawUrl string)(*MobileDeviceManagementPoliciesItemIncludedGroupsRequestBuilder) {
    return NewMobileDeviceManagementPoliciesItemIncludedGroupsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
