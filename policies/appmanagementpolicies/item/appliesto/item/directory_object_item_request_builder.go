...
// DirectoryObjectItemRequestBuilder provides operations to manage the appliesTo property of the microsoft.graph.appManagementPolicy entity.
...
// DirectoryObjectItemRequestBuilderGetQueryParameters get appliesTo from policies
...
func NewDirectoryObjectItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DirectoryObjectItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/policies/appManagementPolicies/{appManagementPolicy_id}/appliesTo/{directoryObject_id}{?select,expand}";
