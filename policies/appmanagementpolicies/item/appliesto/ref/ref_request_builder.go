...
// RefRequestBuilder builds and executes requests for operations under \policies\appManagementPolicies\{appManagementPolicy-id}\appliesTo\$ref
...
// RefRequestBuilderGetQueryParameters collection of application and service principals to which a policy is applied.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/policies/appManagementPolicies/{appManagementPolicy_id}/appliesTo/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation collection of application and service principals to which a policy is applied.
...
// Post collection of application and service principals to which a policy is applied.
