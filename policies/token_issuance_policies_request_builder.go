...
func (m *TokenIssuancePoliciesRequestBuilder) Count()(*TokenIssuancePoliciesCountRequestBuilder) {
    return NewTokenIssuancePoliciesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
