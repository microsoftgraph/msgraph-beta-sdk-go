...
// NewServicePrincipalCreationPoliciesItemExcludesRequestBuilderInternal instantiates a new ExcludesRequestBuilder and sets the default values.
...
// NewServicePrincipalCreationPoliciesItemExcludesRequestBuilder instantiates a new ExcludesRequestBuilder and sets the default values.
...
func (m *ServicePrincipalCreationPoliciesItemExcludesRequestBuilder) Count()(*ServicePrincipalCreationPoliciesItemExcludesCountRequestBuilder) {
    return NewServicePrincipalCreationPoliciesItemExcludesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get excludes from policies
func (m *ServicePrincipalCreationPoliciesItemExcludesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ServicePrincipalCreationPoliciesItemExcludesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
