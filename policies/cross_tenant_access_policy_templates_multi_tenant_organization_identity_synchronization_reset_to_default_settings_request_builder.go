...
// NewCrossTenantAccessPolicyTemplatesMultiTenantOrganizationIdentitySynchronizationResetToDefaultSettingsRequestBuilderInternal instantiates a new ResetToDefaultSettingsRequestBuilder and sets the default values.
...
// NewCrossTenantAccessPolicyTemplatesMultiTenantOrganizationIdentitySynchronizationResetToDefaultSettingsRequestBuilder instantiates a new ResetToDefaultSettingsRequestBuilder and sets the default values.
...
// ToPostRequestInformation reset the cross-tenant access policy template with user synchronization settings for a multi-tenant organization to the default values. In its reset state, the template has no impact on user synchronization settings, other than that unconfigured user synchronization settings are created if needed, for every multi-tenant organization tenant.
