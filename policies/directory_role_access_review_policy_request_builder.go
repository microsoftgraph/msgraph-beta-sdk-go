...
func (m *DirectoryRoleAccessReviewPolicyRequestBuilder) Delete(ctx context.Context, requestConfiguration *DirectoryRoleAccessReviewPolicyRequestBuilderDeleteRequestConfiguration)([]byte, error) {
