...
func (m *B2cAuthenticationMethodsPolicyRequestBuilder) Delete(ctx context.Context, requestConfiguration *B2cAuthenticationMethodsPolicyRequestBuilderDeleteRequestConfiguration)([]byte, error) {
