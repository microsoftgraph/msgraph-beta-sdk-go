...
// UnifiedRoleManagementPolicyRuleItemRequestBuilder builds and executes requests for operations under \policies\roleManagementPolicies\{unifiedRoleManagementPolicy-id}\rules\{unifiedRoleManagementPolicyRule-id}
...
// UnifiedRoleManagementPolicyRuleItemRequestBuilderGetQueryParameters the collection of rules like approval rule, expiration rule, etc.
