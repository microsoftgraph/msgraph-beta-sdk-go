...
// UnifiedRoleManagementPolicyRuleRequestBuilder builds and executes requests for operations under \policies\roleManagementPolicies\{unifiedRoleManagementPolicy-id}\rules\{unifiedRoleManagementPolicyRule-id}
...
type UnifiedRoleManagementPolicyRuleRequestBuilderGetOptions struct {
    ...
    Q *UnifiedRoleManagementPolicyRuleRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
// UnifiedRoleManagementPolicyRuleRequestBuilderGetQueryParameters the collection of rules like approval rule, expiration rule, etc.
...
// CreateDeleteRequestInformation the collection of rules like approval rule, expiration rule, etc.
...
// CreatePatchRequestInformation the collection of rules like approval rule, expiration rule, etc.
...
// Delete the collection of rules like approval rule, expiration rule, etc.
...
// Patch the collection of rules like approval rule, expiration rule, etc.
