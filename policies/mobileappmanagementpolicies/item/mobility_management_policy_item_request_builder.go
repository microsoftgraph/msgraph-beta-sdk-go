...
// DeleteWithResponseHandler delete navigation property mobileAppManagementPolicies for policies
...
// PatchWithResponseHandler update the navigation property mobileAppManagementPolicies in policies
