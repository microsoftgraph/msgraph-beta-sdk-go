...
// MobileAppManagementPoliciesRequestBuilderGetOptions options for Get
type MobileAppManagementPoliciesRequestBuilderGetOptions struct {
    // Request headers
...
func NewMobileAppManagementPoliciesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileAppManagementPoliciesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/policies/mobileAppManagementPolicies{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MobileAppManagementPoliciesRequestBuilder) CreateGetRequestInformation(options *MobileAppManagementPoliciesRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *MobileAppManagementPoliciesRequestBuilder) CreatePostRequestInformation(options *MobileAppManagementPoliciesRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *MobileAppManagementPoliciesRequestBuilder) Get(options *MobileAppManagementPoliciesRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MobilityManagementPolicyCollectionResponseable, error) {
...
func (m *MobileAppManagementPoliciesRequestBuilder) Post(options *MobileAppManagementPoliciesRequestBuilderPostOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MobilityManagementPolicyable, error) {
