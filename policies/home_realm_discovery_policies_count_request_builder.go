...
func NewHomeRealmDiscoveryPoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*HomeRealmDiscoveryPoliciesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/policies/homeRealmDiscoveryPolicies/$count";
...
func (m *HomeRealmDiscoveryPoliciesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *HomeRealmDiscoveryPoliciesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
