...
func (m *HomeRealmDiscoveryPoliciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *HomeRealmDiscoveryPoliciesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
