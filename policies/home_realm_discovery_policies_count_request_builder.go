...
func NewHomeRealmDiscoveryPoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*HomeRealmDiscoveryPoliciesCountRequestBuilder) {
    m := &HomeRealmDiscoveryPoliciesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/policies/homeRealmDiscoveryPolicies/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
...
func NewHomeRealmDiscoveryPoliciesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*HomeRealmDiscoveryPoliciesCountRequestBuilder) {
    ...
    return NewHomeRealmDiscoveryPoliciesCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *HomeRealmDiscoveryPoliciesCountRequestBuilder) WithUrl(rawUrl string)(*HomeRealmDiscoveryPoliciesCountRequestBuilder) {
    return NewHomeRealmDiscoveryPoliciesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
