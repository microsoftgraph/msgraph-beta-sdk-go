...
func NewPermissionGrantPoliciesItemExcludesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissionGrantPoliciesItemExcludesCountRequestBuilder) {
    m := &PermissionGrantPoliciesItemExcludesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/excludes/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func (m *PermissionGrantPoliciesItemExcludesCountRequestBuilder) WithUrl(rawUrl string)(*PermissionGrantPoliciesItemExcludesCountRequestBuilder) {
    return NewPermissionGrantPoliciesItemExcludesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
