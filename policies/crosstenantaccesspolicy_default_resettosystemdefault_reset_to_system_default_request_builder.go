...
func NewCrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilder) {
    m := &CrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilder{
...
func NewCrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilder) {
    ...
    return NewCrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *CrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilder) Post(ctx context.Context, requestConfiguration *CrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilderPostRequestConfiguration)(error) {
...
func (m *CrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *CrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilder) WithUrl(rawUrl string)(*CrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilder) {
    return NewCrosstenantaccesspolicyDefaultResettosystemdefaultResetToSystemDefaultRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
