...
func NewClaimsMappingPoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ClaimsMappingPoliciesCountRequestBuilder) {
    m := &ClaimsMappingPoliciesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/policies/claimsMappingPolicies/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
...
func NewClaimsMappingPoliciesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ClaimsMappingPoliciesCountRequestBuilder) {
    ...
    return NewClaimsMappingPoliciesCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ClaimsMappingPoliciesCountRequestBuilder) WithUrl(rawUrl string)(*ClaimsMappingPoliciesCountRequestBuilder) {
    return NewClaimsMappingPoliciesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
