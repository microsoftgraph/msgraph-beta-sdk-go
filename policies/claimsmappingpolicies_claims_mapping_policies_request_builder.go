...
func (m *ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder) ByClaimsMappingPolicyId(claimsMappingPolicyId string)(*ClaimsmappingpoliciesClaimsMappingPolicyItemRequestBuilder) {
...
func NewClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder) {
    m := &ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder{
...
func NewClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder) {
    ...
    return NewClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ClaimsmappingpoliciesCountRequestBuilder when successful
func (m *ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder) Count()(*ClaimsmappingpoliciesCountRequestBuilder) {
...
func (m *ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder) Get(ctx context.Context, requestConfiguration *ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ClaimsMappingPolicyCollectionResponseable, error) {
...
func (m *ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ClaimsMappingPolicyable, requestConfiguration *ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ClaimsMappingPolicyable, error) {
...
func (m *ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ClaimsMappingPolicyable, requestConfiguration *ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder) WithUrl(rawUrl string)(*ClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder) {
    return NewClaimsmappingpoliciesClaimsMappingPoliciesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
