...
// PermissionGrantPoliciesItemExcludesRequestBuilderGetQueryParameters retrieve the condition sets that are *excluded* in a permissionGrantPolicy. This API is supported in the following national cloud deployments.
...
// Get retrieve the condition sets that are *excluded* in a permissionGrantPolicy. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve the condition sets that are *excluded* in a permissionGrantPolicy. This API is supported in the following national cloud deployments.
