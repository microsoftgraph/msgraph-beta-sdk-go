...
func (m *MobileappmanagementpoliciesMobilityManagementPolicyItemRequestBuilder) IncludedGroups()(*MobileappmanagementpoliciesItemIncludedgroupsIncludedGroupsRequestBuilder) {
    return NewMobileappmanagementpoliciesItemIncludedgroupsIncludedGroupsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
