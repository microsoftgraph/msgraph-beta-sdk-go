...
// RefRequestBuilderGetQueryParameters azure AD groups under the scope of the mobility management application if appliesTo is selected
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property ref to includedGroups for policies
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property ref to includedGroups for policies
