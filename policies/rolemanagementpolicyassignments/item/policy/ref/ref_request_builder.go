...
// RefRequestBuilder builds and executes requests for operations under \policies\roleManagementPolicyAssignments\{unifiedRoleManagementPolicyAssignment-id}\policy\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/policies/roleManagementPolicyAssignments/{unifiedRoleManagementPolicyAssignment_id}/policy/$ref";
...
// CreateDeleteRequestInformation the policy for the assignment.
...
// CreatePutRequestInformation the policy for the assignment.
...
// Delete the policy for the assignment.
...
// Put the policy for the assignment.
