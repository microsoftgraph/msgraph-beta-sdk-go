...
func NewPolicyRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PolicyRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/policies/roleManagementPolicyAssignments/{unifiedRoleManagementPolicyAssignment_id}/policy{?select,expand}";
...
func (m *PolicyRequestBuilder) Ref()(*i2d902abbb955b903dfdca754159c8c4f690ddd6cb70c7955924d4450b3dedaf5.RefRequestBuilder) {
    return i2d902abbb955b903dfdca754159c8c4f690ddd6cb70c7955924d4450b3dedaf5.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
