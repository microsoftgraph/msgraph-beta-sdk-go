...
func NewTokenissuancepoliciesItemAppliestoCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TokenissuancepoliciesItemAppliestoCountRequestBuilder) {
    m := &TokenissuancepoliciesItemAppliestoCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/policies/tokenIssuancePolicies/{tokenIssuancePolicy%2Did}/appliesTo/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewTokenissuancepoliciesItemAppliestoCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TokenissuancepoliciesItemAppliestoCountRequestBuilder) {
    ...
    return NewTokenissuancepoliciesItemAppliestoCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *TokenissuancepoliciesItemAppliestoCountRequestBuilder) WithUrl(rawUrl string)(*TokenissuancepoliciesItemAppliestoCountRequestBuilder) {
    return NewTokenissuancepoliciesItemAppliestoCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
