...
func (m *DeletedItemsCrossTenantPartnersCrossTenantAccessPolicyConfigurationPartnerTenantItemRequestBuilder) ServiceProviderConstraints()(*DeletedItemsCrossTenantPartnersItemServiceProviderConstraintsRequestBuilder) {
    return NewDeletedItemsCrossTenantPartnersItemServiceProviderConstraintsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
