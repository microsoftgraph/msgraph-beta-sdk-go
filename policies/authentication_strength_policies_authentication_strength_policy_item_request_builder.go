...
func (m *AuthenticationStrengthPoliciesAuthenticationStrengthPolicyItemRequestBuilder) MicrosoftGraphUpdateAllowedCombinations()(*AuthenticationStrengthPoliciesItemMicrosoftGraphUpdateAllowedCombinationsRequestBuilder) {
    return NewAuthenticationStrengthPoliciesItemMicrosoftGraphUpdateAllowedCombinationsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUsage provides operations to call the usage method.
func (m *AuthenticationStrengthPoliciesAuthenticationStrengthPolicyItemRequestBuilder) MicrosoftGraphUsage()(*AuthenticationStrengthPoliciesItemMicrosoftGraphUsageRequestBuilder) {
    return NewAuthenticationStrengthPoliciesItemMicrosoftGraphUsageRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
