...
// MobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilderGetQueryParameters errors published by a federated service describing a non-transient, service-specific error regarding the properties or link from a group object.
type MobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilderGetQueryParameters struct {
...
// MobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type MobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *MobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilderGetQueryParameters
}
// NewMobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilderInternal instantiates a new ServiceProvisioningErrorsRequestBuilder and sets the default values.
...
// NewMobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilder instantiates a new ServiceProvisioningErrorsRequestBuilder and sets the default values.
func NewMobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilder) {
    ...
    return NewMobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *MobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilder) Count()(*MobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsCountRequestBuilder) {
...
func (m *MobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilder) WithUrl(rawUrl string)(*MobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilder) {
    return NewMobileDeviceManagementPoliciesItemIncludedGroupsItemServiceProvisioningErrorsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
