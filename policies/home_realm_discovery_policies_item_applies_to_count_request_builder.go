...
func (m *HomeRealmDiscoveryPoliciesItemAppliesToCountRequestBuilder) Get(ctx context.Context, requestConfiguration *HomeRealmDiscoveryPoliciesItemAppliesToCountRequestBuilderGetRequestConfiguration)(*int64, error) {
