...
// PermissionGrantConditionSetRequestBuilder builds and executes requests for operations under \policies\permissionGrantPolicies\{permissionGrantPolicy-id}\includes\{permissionGrantConditionSet-id}
...
// PermissionGrantConditionSetRequestBuilderGetQueryParameters condition sets which are included in this permission grant policy. Automatically expanded on GET.
