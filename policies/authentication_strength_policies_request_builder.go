...
func (m *AuthenticationStrengthPoliciesRequestBuilder) MicrosoftGraphFindByMethodModeWithAuthenticationMethodModes(authenticationMethodModes *string)(*AuthenticationStrengthPoliciesMicrosoftGraphFindByMethodModeWithAuthenticationMethodModesRequestBuilder) {
    return NewAuthenticationStrengthPoliciesMicrosoftGraphFindByMethodModeWithAuthenticationMethodModesRequestBuilderInternal(m.pathParameters, m.requestAdapter, authenticationMethodModes)
}
