...
func (m *AuthenticationStrengthPoliciesRequestBuilder) Count()(*AuthenticationStrengthPoliciesCountRequestBuilder) {
    return NewAuthenticationStrengthPoliciesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *AuthenticationStrengthPoliciesRequestBuilder) MicrosoftGraphFindByMethodModeWithAuthenticationMethodModes(authenticationMethodModes *string)(*AuthenticationStrengthPoliciesMicrosoftGraphFindByMethodModeWithAuthenticationMethodModesFindByMethodModeWithAuthenticationMethodModesRequestBuilder) {
    return NewAuthenticationStrengthPoliciesMicrosoftGraphFindByMethodModeWithAuthenticationMethodModesFindByMethodModeWithAuthenticationMethodModesRequestBuilderInternal(m.pathParameters, m.requestAdapter, authenticationMethodModes)
}
