...
func (m *CrossTenantAccessPolicyPartnersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CrossTenantAccessPolicyPartnersCountRequestBuilderGetRequestConfiguration)(*int64, error) {
