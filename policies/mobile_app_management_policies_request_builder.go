...
// MobileAppManagementPoliciesRequestBuilderGetQueryParameters the policy that defines autoenrollment configuration for a mobility management (MDM or MAM) application.
