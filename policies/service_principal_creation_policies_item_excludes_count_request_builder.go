...
// NewServicePrincipalCreationPoliciesItemExcludesCountRequestBuilderInternal instantiates a new ServicePrincipalCreationPoliciesItemExcludesCountRequestBuilder and sets the default values.
func NewServicePrincipalCreationPoliciesItemExcludesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ServicePrincipalCreationPoliciesItemExcludesCountRequestBuilder) {
    m := &ServicePrincipalCreationPoliciesItemExcludesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/policies/servicePrincipalCreationPolicies/{servicePrincipalCreationPolicy%2Did}/excludes/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewServicePrincipalCreationPoliciesItemExcludesCountRequestBuilder instantiates a new ServicePrincipalCreationPoliciesItemExcludesCountRequestBuilder and sets the default values.
