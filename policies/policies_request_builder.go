...
// returns a *AccessReviewPolicyRequestBuilder when successful
...
// returns a *MobileAppManagementPoliciesRequestBuilder when successful
...
func (m *PoliciesRequestBuilder) PermissionGrantPreApprovalPolicies()(*PermissionGrantPreApprovalPoliciesRequestBuilder) {
    return NewPermissionGrantPreApprovalPoliciesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
