...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property appliesTo for policies
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property appliesTo in policies
