...
func NewDirectoryObjectItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DirectoryObjectItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/policies/featureRolloutPolicies/{featureRolloutPolicy_id}/appliesTo/{directoryObject_id}{?select,expand}";
...
// CreateDeleteRequestInformation nullable. Specifies a list of directoryObjects that feature is enabled for.
...
// CreatePatchRequestInformation nullable. Specifies a list of directoryObjects that feature is enabled for.
...
// Delete nullable. Specifies a list of directoryObjects that feature is enabled for.
...
func (m *DirectoryObjectItemRequestBuilder) Get(options *DirectoryObjectItemRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DirectoryObject, error) {
...
// Patch nullable. Specifies a list of directoryObjects that feature is enabled for.
