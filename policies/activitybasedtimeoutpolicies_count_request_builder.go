...
func NewActivitybasedtimeoutpoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ActivitybasedtimeoutpoliciesCountRequestBuilder) {
    m := &ActivitybasedtimeoutpoliciesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/policies/activityBasedTimeoutPolicies/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func (m *ActivitybasedtimeoutpoliciesCountRequestBuilder) WithUrl(rawUrl string)(*ActivitybasedtimeoutpoliciesCountRequestBuilder) {
    return NewActivitybasedtimeoutpoliciesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
