...
func NewAuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody()(*AuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody) {
    m := &AuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateAuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateAuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewAuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *AuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *AuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody) GetAllowedCombinations()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AuthenticationMethodModes) {
...
func (m *AuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *AuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *AuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *AuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *AuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody) SetAllowedCombinations(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AuthenticationMethodModes)() {
...
func (m *AuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
type AuthenticationstrengthpoliciesItemUpdateallowedcombinationsUpdateAllowedCombinationsPostRequestBodyable interface {
