...
func (m *FeatureRolloutPoliciesItemAppliesToRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*FeatureRolloutPoliciesItemAppliesToMicrosoftGraphGetUserOwnedObjectsRequestBuilder) {
    return NewFeatureRolloutPoliciesItemAppliesToMicrosoftGraphGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
