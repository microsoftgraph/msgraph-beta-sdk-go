...
func (m *FeatureRolloutPoliciesItemAppliesToRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*FeatureRolloutPoliciesItemAppliesToMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilder) {
    return NewFeatureRolloutPoliciesItemAppliesToMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
