...
func (m *SearchRequestBuilder) AcronymsById(id string)(*AcronymsAcronymItemRequestBuilder) {
    ...
    idPtr := &id
    return NewAcronymsAcronymItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *SearchRequestBuilder) BookmarksById(id string)(*BookmarksBookmarkItemRequestBuilder) {
    ...
    idPtr := &id
    return NewBookmarksBookmarkItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *SearchRequestBuilder) QnasById(id string)(*QnasQnaItemRequestBuilder) {
    ...
    idPtr := &id
    return NewQnasQnaItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
