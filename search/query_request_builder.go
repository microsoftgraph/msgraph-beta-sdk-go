...
// Post run a specified search query. Search results are provided in the response. This API is available in the following national cloud deployments.
...
// PostAsQueryPostResponse run a specified search query. Search results are provided in the response. This API is available in the following national cloud deployments.
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/search-query?view=graph-rest-1.0
...
// ToPostRequestInformation run a specified search query. Search results are provided in the response. This API is available in the following national cloud deployments.
