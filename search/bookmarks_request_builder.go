...
// ByBookmarkIdString provides operations to manage the bookmarks property of the microsoft.graph.searchEntity entity.
func (m *BookmarksRequestBuilder) ByBookmarkIdString(bookmarkId string)(*BookmarksBookmarkItemRequestBuilder) {
