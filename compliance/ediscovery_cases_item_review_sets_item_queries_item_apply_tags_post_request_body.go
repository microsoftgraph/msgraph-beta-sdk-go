...
func (m *EdiscoveryCasesItemReviewSetsItemQueriesItemApplyTagsPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *EdiscoveryCasesItemReviewSetsItemQueriesItemApplyTagsPostRequestBody) SetAdditionalData(value map[string]any)() {
