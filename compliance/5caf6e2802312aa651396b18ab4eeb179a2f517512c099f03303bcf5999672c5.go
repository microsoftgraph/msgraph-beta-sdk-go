...
// EdiscoveryCasesItemLegalHoldsItemUnifiedGroupSourcesItemGroupServiceProvisioningErrorsRequestBuilderGetQueryParameters errors published by a federated service describing a non-transient, service-specific error regarding the properties or link from a group object.
...
// NewEdiscoveryCasesItemLegalHoldsItemUnifiedGroupSourcesItemGroupServiceProvisioningErrorsRequestBuilderInternal instantiates a new EdiscoveryCasesItemLegalHoldsItemUnifiedGroupSourcesItemGroupServiceProvisioningErrorsRequestBuilder and sets the default values.
...
// NewEdiscoveryCasesItemLegalHoldsItemUnifiedGroupSourcesItemGroupServiceProvisioningErrorsRequestBuilder instantiates a new EdiscoveryCasesItemLegalHoldsItemUnifiedGroupSourcesItemGroupServiceProvisioningErrorsRequestBuilder and sets the default values.
