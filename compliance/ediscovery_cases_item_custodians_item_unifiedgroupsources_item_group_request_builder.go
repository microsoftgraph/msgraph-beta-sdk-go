...
func (m *EdiscoveryCasesItemCustodiansItemUnifiedgroupsourcesItemGroupRequestBuilder) ServiceProvisioningErrors()(*EdiscoveryCasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) {
    return NewEdiscoveryCasesItemCustodiansItemUnifiedgroupsourcesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
