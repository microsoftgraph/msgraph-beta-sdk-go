...
func NewEdiscoveryCasesItemReviewSetsReviewSetItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, reviewSetId *string)(*EdiscoveryCasesItemReviewSetsReviewSetItemRequestBuilder) {
...
func NewEdiscoveryCasesItemReviewSetsReviewSetItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EdiscoveryCasesItemReviewSetsReviewSetItemRequestBuilder) {
    ...
    return NewEdiscoveryCasesItemReviewSetsReviewSetItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *EdiscoveryCasesItemReviewSetsReviewSetItemRequestBuilder) MicrosoftGraphEdiscoveryAddToReviewSet()(*EdiscoveryCasesItemReviewSetsItemMicrosoftGraphEdiscoveryAddToReviewSetAddToReviewSetRequestBuilder) {
    return NewEdiscoveryCasesItemReviewSetsItemMicrosoftGraphEdiscoveryAddToReviewSetAddToReviewSetRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEdiscoveryExport provides operations to call the export method.
func (m *EdiscoveryCasesItemReviewSetsReviewSetItemRequestBuilder) MicrosoftGraphEdiscoveryExport()(*EdiscoveryCasesItemReviewSetsItemMicrosoftGraphEdiscoveryExportExportRequestBuilder) {
    return NewEdiscoveryCasesItemReviewSetsItemMicrosoftGraphEdiscoveryExportExportRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *EdiscoveryCasesItemReviewSetsReviewSetItemRequestBuilder) QueriesById(id string)(*EdiscoveryCasesItemReviewSetsItemQueriesReviewSetQueryItemRequestBuilder) {
    ...
    idPtr := &id
    return NewEdiscoveryCasesItemReviewSetsItemQueriesReviewSetQueryItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
