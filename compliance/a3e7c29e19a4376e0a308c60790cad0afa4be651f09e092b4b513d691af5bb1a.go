...
func (m *EdiscoveryCasesItemOperationsMicrosoftGraphEdiscoveryCaseExportOperationCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EdiscoveryCasesItemOperationsMicrosoftGraphEdiscoveryCaseExportOperationCountRequestBuilderGetRequestConfiguration)(*int64, error) {
