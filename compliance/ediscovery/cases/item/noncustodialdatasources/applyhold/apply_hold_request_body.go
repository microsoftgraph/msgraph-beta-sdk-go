...
func NewApplyHoldRequestBody()(*ApplyHoldRequestBody) {
    m := &ApplyHoldRequestBody{
    }
...
func (m *ApplyHoldRequestBody) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ApplyHoldRequestBody) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
