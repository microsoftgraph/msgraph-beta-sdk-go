...
// ApplyTagsRequestBuilderPostOptions options for Post
type ApplyTagsRequestBuilderPostOptions struct {
    // 
    Body ApplyTagsRequestBodyable
    // Request headers
...
func (m *ApplyTagsRequestBuilder) CreatePostRequestInformation(options *ApplyTagsRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
