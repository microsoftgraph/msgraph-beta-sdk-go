...
// OperationsRequestBuilder builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\operations
...
// CreatePostRequestInformation returns a list of case operation objects for this case. Nullable.
...
// Post returns a list of case operation objects for this case. Nullable.
func (m *OperationsRequestBuilder) Post(options *OperationsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CaseOperation, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewCaseOperation() }, nil, nil)
    if err != nil {
        return nil, err
    }
