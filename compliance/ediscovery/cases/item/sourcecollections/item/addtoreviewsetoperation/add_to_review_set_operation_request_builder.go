...
func (m *AddToReviewSetOperationRequestBuilder) CreateGetRequestInformation(options *AddToReviewSetOperationRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AddToReviewSetOperationRequestBuilder) Get(options *AddToReviewSetOperationRequestBuilderGetOptions)(ic154d683aa4025ee28853b9c1a3c35cd1f093a1c4542feba4c07682e2752db13.AddToReviewSetOperationable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ic154d683aa4025ee28853b9c1a3c35cd1f093a1c4542feba4c07682e2752db13.CreateAddToReviewSetOperationFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
