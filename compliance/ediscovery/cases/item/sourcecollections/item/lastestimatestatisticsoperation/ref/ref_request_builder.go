...
// RefRequestBuilder builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\sourceCollections\{sourceCollection-id}\lastEstimateStatisticsOperation\$ref
...
// CreateDeleteRequestInformation the last estimate operation associated with the sourceCollection.
...
// CreatePutRequestInformation the last estimate operation associated with the sourceCollection.
...
// Delete the last estimate operation associated with the sourceCollection.
...
// Put the last estimate operation associated with the sourceCollection.
