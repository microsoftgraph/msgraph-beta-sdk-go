...
// RefRequestBuilder builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\sourceCollections\{sourceCollection-id}\custodianSources\$ref
...
// RefRequestBuilderGetQueryParameters custodian sources that are included in the sourceCollection.
...
// CreatePostRequestInformation custodian sources that are included in the sourceCollection.
...
// Post custodian sources that are included in the sourceCollection.
