...
// ParentRequestBuilder provides operations to manage the parent property of the microsoft.graph.ediscovery.tag entity.
...
func (m *ParentRequestBuilder) Get(options *ParentRequestBuilderGetOptions)(ic154d683aa4025ee28853b9c1a3c35cd1f093a1c4542feba4c07682e2752db13.Tagable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ic154d683aa4025ee28853b9c1a3c35cd1f093a1c4542feba4c07682e2752db13.CreateTagFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
