...
// RefRequestBuilder builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\tags\{tag-id}\parent\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/tags/{tag_id}/parent/$ref";
...
// CreateDeleteRequestInformation returns the parent tag of the specified tag.
...
// CreatePutRequestInformation returns the parent tag of the specified tag.
...
// Delete returns the parent tag of the specified tag.
...
// Put returns the parent tag of the specified tag.
