...
// RefRequestBuilder builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\tags\{tag-id}\childTags\$ref
...
// RefRequestBuilderGetQueryParameters returns the tags that are a child of a tag.
...
// CreatePostRequestInformation returns the tags that are a child of a tag.
...
// Post returns the tags that are a child of a tag.
