...
func (m *ApplyHoldRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ApplyHoldPostRequestBodyable, requestConfiguration *ApplyHoldRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ApplyHoldRequestBuilder) Post(ctx context.Context, body ApplyHoldPostRequestBodyable, requestConfiguration *ApplyHoldRequestBuilderPostRequestConfiguration)(error) {
