...
// RefRequestBuilder builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\legalHolds\{legalHold-id}\unifiedGroupSources\{unifiedGroupSource-id}\group\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/legalHolds/{legalHold_id}/unifiedGroupSources/{unifiedGroupSource_id}/group/$ref";
...
// CreateDeleteRequestInformation the group associated with the unifiedGroupSource.
...
// CreatePutRequestInformation the group associated with the unifiedGroupSource.
...
// Delete the group associated with the unifiedGroupSource.
...
// Put the group associated with the unifiedGroupSource.
