...
import (
    ...
    i35f1fc44555d8ecc0541a46ebc42318122a95afaec0c1bf8e35c5e19a59ed0f9 "github.com/microsoftgraph/msgraph-beta-sdk-go/compliance/ediscovery/cases/item/legalholds/item/unifiedgroupsources/item/group/ref"
)

// groupRequestBuilder builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\legalHolds\{legalHold-id}\unifiedGroupSources\{unifiedGroupSource-id}\group
...
func NewGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/legalHolds/{legalHold_id}/unifiedGroupSources/{unifiedGroupSource_id}/group{?select,expand}";
...
func (m *GroupRequestBuilder) Ref()(*i35f1fc44555d8ecc0541a46ebc42318122a95afaec0c1bf8e35c5e19a59ed0f9.RefRequestBuilder) {
    return i35f1fc44555d8ecc0541a46ebc42318122a95afaec0c1bf8e35c5e19a59ed0f9.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
