...
// RefRequestBuilder builds and executes requests for operations under \compliance\ediscovery\cases\{case-id}\legalHolds\{legalHold-id}\siteSources\{siteSource-id}\site\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/compliance/ediscovery/cases/{case_id}/legalHolds/{legalHold_id}/siteSources/{siteSource_id}/site/$ref";
...
// CreateDeleteRequestInformation the SharePoint site associated with the siteSource.
...
// CreatePutRequestInformation the SharePoint site associated with the siteSource.
...
// Delete the SharePoint site associated with the siteSource.
...
// Put the SharePoint site associated with the siteSource.
