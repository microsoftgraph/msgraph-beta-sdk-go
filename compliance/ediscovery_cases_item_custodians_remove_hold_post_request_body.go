...
func (m *EdiscoveryCasesItemCustodiansRemoveHoldPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *EdiscoveryCasesItemCustodiansRemoveHoldPostRequestBody) SetAdditionalData(value map[string]any)() {
