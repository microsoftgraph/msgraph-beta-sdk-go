...
// NewEdiscoveryCasesItemTagsItemChildTagsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewEdiscoveryCasesItemTagsItemChildTagsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EdiscoveryCasesItemTagsItemChildTagsCountRequestBuilder) {
    m := &EdiscoveryCasesItemTagsItemChildTagsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/tags/{tag%2Did}/childTags/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewEdiscoveryCasesItemTagsItemChildTagsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
