...
// RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilderGetQueryParameters get a list of the alert incidents. The alert incidents are a collection of any following type that is derived from the unifiedRoleManagementAlertIncident object: This API is available in the following national cloud deployments.
...
// RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilderGetQueryParameters
}
// RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func (m *RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilder) ByUnifiedRoleManagementAlertIncidentId(unifiedRoleManagementAlertIncidentId string)(*RoleManagementAlertsAlertsItemAlertIncidentsUnifiedRoleManagementAlertIncidentItemRequestBuilder) {
...
func NewRoleManagementAlertsAlertsItemAlertIncidentsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewRoleManagementAlertsAlertsItemAlertIncidentsRequestBuilderInternal(urlParams, requestAdapter)
}
...
// Get get a list of the alert incidents. The alert incidents are a collection of any following type that is derived from the unifiedRoleManagementAlertIncident object: This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get a list of the alert incidents. The alert incidents are a collection of any following type that is derived from the unifiedRoleManagementAlertIncident object: This API is available in the following national cloud deployments.
...
func (m *RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilder) WithUrl(rawUrl string)(*RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilder) {
    return NewRoleManagementAlertsAlertsItemAlertIncidentsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
