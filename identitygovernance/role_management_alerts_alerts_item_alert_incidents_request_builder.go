...
// RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilderGetQueryParameters represents the incidents of this type of alert that have been triggered in Privileged Identity Management (PIM) for Microsoft Entra roles in the tenant. Supports $expand.
...
// NewRoleManagementAlertsAlertsItemAlertIncidentsRequestBuilderInternal instantiates a new RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilder and sets the default values.
...
// NewRoleManagementAlertsAlertsItemAlertIncidentsRequestBuilder instantiates a new RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilder and sets the default values.
