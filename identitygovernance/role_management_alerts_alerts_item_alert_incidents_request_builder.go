...
// ByUnifiedRoleManagementAlertIncidentIdString provides operations to manage the alertIncidents property of the microsoft.graph.unifiedRoleManagementAlert entity.
func (m *RoleManagementAlertsAlertsItemAlertIncidentsRequestBuilder) ByUnifiedRoleManagementAlertIncidentIdString(unifiedRoleManagementAlertIncidentId string)(*RoleManagementAlertsAlertsItemAlertIncidentsUnifiedRoleManagementAlertIncidentItemRequestBuilder) {
