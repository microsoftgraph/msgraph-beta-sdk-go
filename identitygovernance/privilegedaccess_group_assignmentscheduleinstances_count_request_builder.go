...
func NewPrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilder) {
    m := &PrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleInstances/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewPrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilder) {
    ...
    return NewPrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *PrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *PrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *PrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilder) WithUrl(rawUrl string)(*PrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilder) {
    return NewPrivilegedaccessGroupAssignmentscheduleinstancesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
