...
// AccessReviewsDecisionsRecordAllDecisionsPostRequestBody provides operations to call the recordAllDecisions method.
...
func (m *AccessReviewsDecisionsRecordAllDecisionsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *AccessReviewsDecisionsRecordAllDecisionsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
