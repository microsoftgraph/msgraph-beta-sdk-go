...
// NewEntitlementManagementSubjectsRequestBuilder instantiates a new SubjectsRequestBuilder and sets the default values.
...
func (m *EntitlementManagementSubjectsRequestBuilder) Count()(*EntitlementManagementSubjectsCountRequestBuilder) {
    return NewEntitlementManagementSubjectsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get subjects from identityGovernance
func (m *EntitlementManagementSubjectsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementManagementSubjectsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
