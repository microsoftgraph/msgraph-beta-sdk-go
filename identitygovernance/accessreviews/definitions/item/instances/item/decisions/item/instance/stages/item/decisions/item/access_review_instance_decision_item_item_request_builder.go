...
import (
    ...
    i958918af2f40ba6b7ed544108cef86f44af75aa87f871221917a95b78e8dcee4 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/accessreviews/definitions/item/instances/item/decisions/item/instance/stages/item/decisions/item/insights"
    i17bfe4cc6b2aa566beec0af4b6810c7665cd94db75b3aabdc7818335aaad3e46 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/accessreviews/definitions/item/instances/item/decisions/item/instance/stages/item/decisions/item/insights/item"
)
...
func NewAccessReviewInstanceDecisionItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessReviewInstanceDecisionItemItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition_id}/instances/{accessReviewInstance_id}/decisions/{accessReviewInstanceDecisionItem_id}/instance/stages/{accessReviewStage_id}/decisions/{accessReviewInstanceDecisionItem_id1}{?select,expand}";
...
func (m *AccessReviewInstanceDecisionItemItemRequestBuilder) Insights()(*i958918af2f40ba6b7ed544108cef86f44af75aa87f871221917a95b78e8dcee4.InsightsRequestBuilder) {
    return i958918af2f40ba6b7ed544108cef86f44af75aa87f871221917a95b78e8dcee4.NewInsightsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// InsightsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.identityGovernance.accessReviews.definitions.item.instances.item.decisions.item.instance.stages.item.decisions.item.insights.item collection
func (m *AccessReviewInstanceDecisionItemItemRequestBuilder) InsightsById(id string)(*i17bfe4cc6b2aa566beec0af4b6810c7665cd94db75b3aabdc7818335aaad3e46.GovernanceInsightItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i17bfe4cc6b2aa566beec0af4b6810c7665cd94db75b3aabdc7818335aaad3e46.NewGovernanceInsightItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
