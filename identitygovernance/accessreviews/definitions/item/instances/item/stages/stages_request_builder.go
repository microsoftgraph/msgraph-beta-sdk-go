...
import (
    ...
    ifca96c8144d548fbfe6e0fe5e70cbdc5aa36673bc5a91d8c105d0cfc6eafae91 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/accessreviews/definitions/item/instances/item/stages/filterbycurrentuserwithon"
)

// StagesRequestBuilder builds and executes requests for operations under \identityGovernance\accessReviews\definitions\{accessReviewScheduleDefinition-id}\instances\{accessReviewInstance-id}\stages
...
// StagesRequestBuilderGetQueryParameters get stages from identityGovernance
...
func NewStagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*StagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition_id}/instances/{accessReviewInstance_id}/stages{?top,skip,search,filter,count,orderby,select,expand}";
...
// FilterByCurrentUserWithOn builds and executes requests for operations under \identityGovernance\accessReviews\definitions\{accessReviewScheduleDefinition-id}\instances\{accessReviewInstance-id}\stages\microsoft.graph.filterByCurrentUser(on={on})
func (m *StagesRequestBuilder) FilterByCurrentUserWithOn(on *string)(*ifca96c8144d548fbfe6e0fe5e70cbdc5aa36673bc5a91d8c105d0cfc6eafae91.FilterByCurrentUserWithOnRequestBuilder) {
    return ifca96c8144d548fbfe6e0fe5e70cbdc5aa36673bc5a91d8c105d0cfc6eafae91.NewFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on);
}
...
func (m *StagesRequestBuilder) Post(options *StagesRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AccessReviewStage, error) {
