...
// DeleteWithResponseHandler delete navigation property stages for identityGovernance
...
// PatchWithResponseHandler update the navigation property stages in identityGovernance
