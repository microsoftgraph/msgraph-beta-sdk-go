...
import (
    ...
    i5ba8819a85127cd1d659724717620f2a3b2d85a557ea05b7a0359464bad18d1a "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/accessreviews/decisions/item/instance/contactedreviewers/count"
)
...
func NewContactedReviewersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ContactedReviewersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem_id}/instance/contactedReviewers{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ContactedReviewersRequestBuilder) Count()(*i5ba8819a85127cd1d659724717620f2a3b2d85a557ea05b7a0359464bad18d1a.CountRequestBuilder) {
    return i5ba8819a85127cd1d659724717620f2a3b2d85a557ea05b7a0359464bad18d1a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
