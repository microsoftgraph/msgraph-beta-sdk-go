...
// RecordAllDecisionsRequestBuilder builds and executes requests for operations under \identityGovernance\accessReviews\decisions\microsoft.graph.recordAllDecisions
