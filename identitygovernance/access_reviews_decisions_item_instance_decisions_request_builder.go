...
func NewAccessReviewsDecisionsItemInstanceDecisionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AccessReviewsDecisionsItemInstanceDecisionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/decisions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AccessReviewsDecisionsItemInstanceDecisionsRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*AccessReviewsDecisionsItemInstanceDecisionsMicrosoftGraphFilterByCurrentUserWithOnFilterByCurrentUserWithOnRequestBuilder) {
    return NewAccessReviewsDecisionsItemInstanceDecisionsMicrosoftGraphFilterByCurrentUserWithOnFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
// MicrosoftGraphRecordAllDecisions provides operations to call the recordAllDecisions method.
func (m *AccessReviewsDecisionsItemInstanceDecisionsRequestBuilder) MicrosoftGraphRecordAllDecisions()(*AccessReviewsDecisionsItemInstanceDecisionsMicrosoftGraphRecordAllDecisionsRecordAllDecisionsRequestBuilder) {
    return NewAccessReviewsDecisionsItemInstanceDecisionsMicrosoftGraphRecordAllDecisionsRecordAllDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
