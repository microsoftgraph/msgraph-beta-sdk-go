...
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/entitlementmanagement-list-accesspackageassignments?view=graph-rest-1.0
...
func (m *EntitlementManagementAccessPackageAssignmentsRequestBuilder) MicrosoftGraphAdditionalAccess()(*EntitlementManagementAccessPackageAssignmentsMicrosoftGraphAdditionalAccessRequestBuilder) {
    return NewEntitlementManagementAccessPackageAssignmentsMicrosoftGraphAdditionalAccessRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *EntitlementManagementAccessPackageAssignmentsRequestBuilder) MicrosoftGraphAdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageId(accessPackageId *string, incompatibleAccessPackageId *string)(*EntitlementManagementAccessPackageAssignmentsMicrosoftGraphAdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder) {
    return NewEntitlementManagementAccessPackageAssignmentsMicrosoftGraphAdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilderInternal(m.pathParameters, m.requestAdapter, accessPackageId, incompatibleAccessPackageId)
}
// MicrosoftGraphFilterByCurrentUserWithOn provides operations to call the filterByCurrentUser method.
func (m *EntitlementManagementAccessPackageAssignmentsRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*EntitlementManagementAccessPackageAssignmentsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilder) {
    return NewEntitlementManagementAccessPackageAssignmentsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
