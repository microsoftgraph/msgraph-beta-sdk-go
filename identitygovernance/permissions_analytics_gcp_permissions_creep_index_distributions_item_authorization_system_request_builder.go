...
// PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilder provides operations to manage the authorizationSystem property of the microsoft.graph.permissionsCreepIndexDistribution entity.
type PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilderGetQueryParameters represents an authorization system onboarded to Permissions Management.
type PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilderGetQueryParameters struct {
    // Expand related entities
    Expand []string `uriparametername:"%24expand"`
    // Select properties to be returned
    Select []string `uriparametername:"%24select"`
}
// PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilderGetQueryParameters
}
// NewPermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilderInternal instantiates a new PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilder and sets the default values.
...
// NewPermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilder instantiates a new PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilder and sets the default values.
func NewPermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsItemAuthorizationSystemRequestBuilder) {
