...
// TermsOfUseAgreementsRequestBuilderGetQueryParameters represents a tenant's customizable terms of use agreement that's created and managed with Azure Active Directory (Azure AD).
...
// ToPostRequestInformation create new navigation property to agreements for identityGovernance
