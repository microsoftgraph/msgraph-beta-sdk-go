...
func (m *AccessReviewsDecisionsItemInstanceStagesItemDecisionsRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*AccessReviewsDecisionsItemInstanceStagesItemDecisionsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilder) {
    return NewAccessReviewsDecisionsItemInstanceStagesItemDecisionsMicrosoftGraphFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
// MicrosoftGraphRecordAllDecisions provides operations to call the recordAllDecisions method.
func (m *AccessReviewsDecisionsItemInstanceStagesItemDecisionsRequestBuilder) MicrosoftGraphRecordAllDecisions()(*AccessReviewsDecisionsItemInstanceStagesItemDecisionsMicrosoftGraphRecordAllDecisionsRequestBuilder) {
    return NewAccessReviewsDecisionsItemInstanceStagesItemDecisionsMicrosoftGraphRecordAllDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
