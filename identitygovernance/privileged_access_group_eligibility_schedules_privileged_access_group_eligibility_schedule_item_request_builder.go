...
// PrivilegedAccessGroupEligibilitySchedulesPrivilegedAccessGroupEligibilityScheduleItemRequestBuilderGetQueryParameters the eligibility schedules to activate a just-in-time access.
