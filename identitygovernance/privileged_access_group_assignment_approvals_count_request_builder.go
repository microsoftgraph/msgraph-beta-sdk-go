...
// NewPrivilegedAccessGroupAssignmentApprovalsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewPrivilegedAccessGroupAssignmentApprovalsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedAccessGroupAssignmentApprovalsCountRequestBuilder) {
    m := &PrivilegedAccessGroupAssignmentApprovalsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentApprovals/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewPrivilegedAccessGroupAssignmentApprovalsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
