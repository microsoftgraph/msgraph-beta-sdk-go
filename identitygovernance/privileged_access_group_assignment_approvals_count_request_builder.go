...
func (m *PrivilegedAccessGroupAssignmentApprovalsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivilegedAccessGroupAssignmentApprovalsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
