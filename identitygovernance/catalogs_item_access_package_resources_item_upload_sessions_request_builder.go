...
// CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder provides operations to manage the uploadSessions property of the microsoft.graph.accessPackageResource entity.
...
// CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilderGetQueryParameters
}
// CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func (m *CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder) ByCustomDataProvidedResourceUploadSessionId(customDataProvidedResourceUploadSessionId string)(*CatalogsItemAccessPackageResourcesItemUploadSessionsCustomDataProvidedResourceUploadSessionItemRequestBuilder) {
    ...
    return NewCatalogsItemAccessPackageResourcesItemUploadSessionsCustomDataProvidedResourceUploadSessionItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
// NewCatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilderInternal instantiates a new CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder and sets the default values.
func NewCatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder) {
    m := &CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "", pathParameters),
    }
    return m
}
// NewCatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder instantiates a new CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder and sets the default values.
func NewCatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder) {
    ...
    return NewCatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *CatalogsItemAccessPackageResourcesItemUploadSessionsCountRequestBuilder when successful
...
func (m *CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.GET, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/accessPackageResources/{accessPackageResource%2Did}/uploadSessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", m.BaseRequestBuilder.PathParameters)
...
func (m *CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CustomDataProvidedResourceUploadSessionable, requestConfiguration *CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.POST, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/accessPackageResources/{accessPackageResource%2Did}/uploadSessions", m.BaseRequestBuilder.PathParameters)
    if requestConfiguration != nil {
        requestInfo.Headers.AddAll(requestConfiguration.Headers)
        requestInfo.AddRequestOptions(requestConfiguration.Options)
    }
...
func (m *CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder) WithUrl(rawUrl string)(*CatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder) {
    return NewCatalogsItemAccessPackageResourcesItemUploadSessionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
