...
func (m *PermissionsanalyticsAwsPermissionscreepindexdistributionsPermissionsCreepIndexDistributionItemRequestBuilder) AuthorizationSystem()(*PermissionsanalyticsAwsPermissionscreepindexdistributionsItemAuthorizationsystemAuthorizationSystemRequestBuilder) {
    return NewPermissionsanalyticsAwsPermissionscreepindexdistributionsItemAuthorizationsystemAuthorizationSystemRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// NewPermissionsanalyticsAwsPermissionscreepindexdistributionsPermissionsCreepIndexDistributionItemRequestBuilderInternal instantiates a new PermissionsanalyticsAwsPermissionscreepindexdistributionsPermissionsCreepIndexDistributionItemRequestBuilder and sets the default values.
...
// NewPermissionsanalyticsAwsPermissionscreepindexdistributionsPermissionsCreepIndexDistributionItemRequestBuilder instantiates a new PermissionsanalyticsAwsPermissionscreepindexdistributionsPermissionsCreepIndexDistributionItemRequestBuilder and sets the default values.
