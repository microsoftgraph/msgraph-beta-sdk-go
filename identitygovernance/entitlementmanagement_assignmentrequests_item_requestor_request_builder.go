...
func (m *EntitlementmanagementAssignmentrequestsItemRequestorRequestBuilder) ConnectedOrganization()(*EntitlementmanagementAssignmentrequestsItemRequestorConnectedorganizationConnectedOrganizationRequestBuilder) {
    return NewEntitlementmanagementAssignmentrequestsItemRequestorConnectedorganizationConnectedOrganizationRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
