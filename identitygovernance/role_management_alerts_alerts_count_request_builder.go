...
func (m *RoleManagementAlertsAlertsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *RoleManagementAlertsAlertsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
