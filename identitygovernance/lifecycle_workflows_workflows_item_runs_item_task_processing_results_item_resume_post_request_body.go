...
// LifecycleWorkflowsWorkflowsItemRunsItemTaskProcessingResultsItemResumePostRequestBody 
...
func (m *LifecycleWorkflowsWorkflowsItemRunsItemTaskProcessingResultsItemResumePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *LifecycleWorkflowsWorkflowsItemRunsItemTaskProcessingResultsItemResumePostRequestBody) SetAdditionalData(value map[string]any)() {
