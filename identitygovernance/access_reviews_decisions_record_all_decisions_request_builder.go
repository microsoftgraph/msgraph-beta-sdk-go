...
// NewAccessReviewsDecisionsRecordAllDecisionsRequestBuilderInternal instantiates a new AccessReviewsDecisionsRecordAllDecisionsRequestBuilder and sets the default values.
...
// NewAccessReviewsDecisionsRecordAllDecisionsRequestBuilder instantiates a new AccessReviewsDecisionsRecordAllDecisionsRequestBuilder and sets the default values.
...
func (m *AccessReviewsDecisionsRecordAllDecisionsRequestBuilder) WithUrl(rawUrl string)(*AccessReviewsDecisionsRecordAllDecisionsRequestBuilder) {
    return NewAccessReviewsDecisionsRecordAllDecisionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
