...
func (m *EntitlementmanagementAccesspackageresourcesItemAccesspackageresourcerolesAccessPackageResourceRoleItemRequestBuilder) AccessPackageResource()(*EntitlementmanagementAccesspackageresourcesItemAccesspackageresourcerolesItemAccesspackageresourceAccessPackageResourceRequestBuilder) {
    return NewEntitlementmanagementAccesspackageresourcesItemAccesspackageresourcerolesItemAccesspackageresourceAccessPackageResourceRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
