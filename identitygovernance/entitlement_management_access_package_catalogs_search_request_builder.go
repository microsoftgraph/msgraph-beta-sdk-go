...
// NewEntitlementManagementAccessPackageCatalogsSearchRequestBuilderInternal instantiates a new EntitlementManagementAccessPackageCatalogsSearchRequestBuilder and sets the default values.
func NewEntitlementManagementAccessPackageCatalogsSearchRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementAccessPackageCatalogsSearchRequestBuilder) {
    m := &EntitlementManagementAccessPackageCatalogsSearchRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageCatalogs/Search(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewEntitlementManagementAccessPackageCatalogsSearchRequestBuilder instantiates a new EntitlementManagementAccessPackageCatalogsSearchRequestBuilder and sets the default values.
