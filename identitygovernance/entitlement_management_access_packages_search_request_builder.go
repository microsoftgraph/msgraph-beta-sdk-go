...
// NewEntitlementManagementAccessPackagesSearchRequestBuilderInternal instantiates a new SearchRequestBuilder and sets the default values.
...
// NewEntitlementManagementAccessPackagesSearchRequestBuilder instantiates a new SearchRequestBuilder and sets the default values.
...
func (m *EntitlementManagementAccessPackagesSearchRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementManagementAccessPackagesSearchRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementManagementAccessPackagesSearchRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementAccessPackagesSearchRequestBuilderGetRequestConfiguration)(EntitlementManagementAccessPackagesSearchResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateEntitlementManagementAccessPackagesSearchResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
