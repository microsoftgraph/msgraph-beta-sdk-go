...
// LifecycleWorkflowsWorkflowsItemActivatePostRequestBody 
...
func (m *LifecycleWorkflowsWorkflowsItemActivatePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *LifecycleWorkflowsWorkflowsItemActivatePostRequestBody) SetAdditionalData(value map[string]any)() {
