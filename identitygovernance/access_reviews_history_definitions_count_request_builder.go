...
func (m *AccessReviewsHistoryDefinitionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AccessReviewsHistoryDefinitionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
