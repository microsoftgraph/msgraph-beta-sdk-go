...
// EntitlementManagementConnectedOrganizationsItemInternalSponsorsGetUserOwnedObjectsPostRequestBody provides operations to call the getUserOwnedObjects method.
...
func (m *EntitlementManagementConnectedOrganizationsItemInternalSponsorsGetUserOwnedObjectsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *EntitlementManagementConnectedOrganizationsItemInternalSponsorsGetUserOwnedObjectsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
