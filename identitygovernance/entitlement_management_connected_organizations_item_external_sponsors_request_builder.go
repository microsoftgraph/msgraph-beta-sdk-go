...
func (m *EntitlementManagementConnectedOrganizationsItemExternalSponsorsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*EntitlementManagementConnectedOrganizationsItemExternalSponsorsMicrosoftGraphGetUserOwnedObjectsRequestBuilder) {
    return NewEntitlementManagementConnectedOrganizationsItemExternalSponsorsMicrosoftGraphGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
