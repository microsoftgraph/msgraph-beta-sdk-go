...
// PermissionsAnalyticsAzurePermissionsCreepIndexDistributionsRequestBuilderGetQueryParameters represents the Permissions Creep Index (PCI) for the authorization system. PCI distribution chart shows the classification of human and nonhuman identities based on the PCI score in three buckets (low, medium, high).
...
// NewPermissionsAnalyticsAzurePermissionsCreepIndexDistributionsRequestBuilderInternal instantiates a new PermissionsAnalyticsAzurePermissionsCreepIndexDistributionsRequestBuilder and sets the default values.
...
// NewPermissionsAnalyticsAzurePermissionsCreepIndexDistributionsRequestBuilder instantiates a new PermissionsAnalyticsAzurePermissionsCreepIndexDistributionsRequestBuilder and sets the default values.
...
// returns a *PermissionsAnalyticsAzurePermissionsCreepIndexDistributionsCountRequestBuilder when successful
