...
// EntitlementManagementSettingsRequestBuilderGetQueryParameters represents the settings that control the behavior of Microsoft Entra entitlement management.
...
// Get represents the settings that control the behavior of Microsoft Entra entitlement management.
...
// ToGetRequestInformation represents the settings that control the behavior of Microsoft Entra entitlement management.
// returns a *RequestInformation when successful
