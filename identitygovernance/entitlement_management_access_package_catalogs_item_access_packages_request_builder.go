...
func (m *EntitlementManagementAccessPackageCatalogsItemAccessPackagesRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*EntitlementManagementAccessPackageCatalogsItemAccessPackagesMicrosoftGraphFilterByCurrentUserWithOnRequestBuilder) {
    return NewEntitlementManagementAccessPackageCatalogsItemAccessPackagesMicrosoftGraphFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
// MicrosoftGraphSearch provides operations to call the Search method.
func (m *EntitlementManagementAccessPackageCatalogsItemAccessPackagesRequestBuilder) MicrosoftGraphSearch()(*EntitlementManagementAccessPackageCatalogsItemAccessPackagesMicrosoftGraphSearchRequestBuilder) {
    return NewEntitlementManagementAccessPackageCatalogsItemAccessPackagesMicrosoftGraphSearchRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
