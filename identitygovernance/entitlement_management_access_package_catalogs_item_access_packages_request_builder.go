...
// NewEntitlementManagementAccessPackageCatalogsItemAccessPackagesRequestBuilderInternal instantiates a new AccessPackagesRequestBuilder and sets the default values.
...
func (m *EntitlementManagementAccessPackageCatalogsItemAccessPackagesRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*EntitlementManagementAccessPackageCatalogsItemAccessPackagesMicrosoftGraphFilterByCurrentUserWithOnFilterByCurrentUserWithOnRequestBuilder) {
    return NewEntitlementManagementAccessPackageCatalogsItemAccessPackagesMicrosoftGraphFilterByCurrentUserWithOnFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
// MicrosoftGraphSearch provides operations to call the Search method.
func (m *EntitlementManagementAccessPackageCatalogsItemAccessPackagesRequestBuilder) MicrosoftGraphSearch()(*EntitlementManagementAccessPackageCatalogsItemAccessPackagesMicrosoftGraphSearchSearchRequestBuilder) {
    return NewEntitlementManagementAccessPackageCatalogsItemAccessPackagesMicrosoftGraphSearchSearchRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
