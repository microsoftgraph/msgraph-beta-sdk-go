...
func (m *EntitlementManagementConnectedOrganizationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementConnectedOrganizationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
