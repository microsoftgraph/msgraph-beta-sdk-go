...
func (m *PrivilegedAccessGroupAssignmentScheduleRequestsPrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilder) MicrosoftGraphCancel()(*PrivilegedAccessGroupAssignmentScheduleRequestsItemMicrosoftGraphCancelRequestBuilder) {
    return NewPrivilegedAccessGroupAssignmentScheduleRequestsItemMicrosoftGraphCancelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
