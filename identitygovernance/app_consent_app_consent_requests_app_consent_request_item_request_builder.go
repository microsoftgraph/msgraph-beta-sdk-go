...
// AppConsentAppConsentRequestsAppConsentRequestItemRequestBuilderGetQueryParameters a collection of appConsentRequest objects representing apps for which admin consent has been requested by one or more users.
