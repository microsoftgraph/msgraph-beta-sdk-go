...
import (
    ...
    i27b6eda364956199b41833a976393d7e86ee57a7439a08bae848ac970a46c81a "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/lifecycleworkflows/workflows/item/taskreports/count"
    iede3b7bb85a89dbc96fcde8e7daa97f6fa78369fbdfb3c31255e89c903a8c84f "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/lifecycleworkflows/workflows/item/taskreports/summarywithstartdatetimewithenddatetime"
)
...
func (m *TaskReportsRequestBuilder) Count()(*i27b6eda364956199b41833a976393d7e86ee57a7439a08bae848ac970a46c81a.CountRequestBuilder) {
    return i27b6eda364956199b41833a976393d7e86ee57a7439a08bae848ac970a46c81a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of the taskReport objects and their properties.
func (m *TaskReportsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *TaskReportsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *TaskReportsRequestBuilder) Get(ctx context.Context, requestConfiguration *TaskReportsRequestBuilderGetRequestConfiguration)(i45fdec8a8c1f65ca74c5cf52921d432ad02ee300dbbd24b25f33cc8ecf6a1a91.TaskReportCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, i45fdec8a8c1f65ca74c5cf52921d432ad02ee300dbbd24b25f33cc8ecf6a1a91.CreateTaskReportCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *TaskReportsRequestBuilder) Post(ctx context.Context, body i45fdec8a8c1f65ca74c5cf52921d432ad02ee300dbbd24b25f33cc8ecf6a1a91.TaskReportable, requestConfiguration *TaskReportsRequestBuilderPostRequestConfiguration)(i45fdec8a8c1f65ca74c5cf52921d432ad02ee300dbbd24b25f33cc8ecf6a1a91.TaskReportable, error) {
...
func (m *TaskReportsRequestBuilder) SummaryWithStartDateTimeWithEndDateTime(endDateTime *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time, startDateTime *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)(*iede3b7bb85a89dbc96fcde8e7daa97f6fa78369fbdfb3c31255e89c903a8c84f.SummaryWithStartDateTimeWithEndDateTimeRequestBuilder) {
    return iede3b7bb85a89dbc96fcde8e7daa97f6fa78369fbdfb3c31255e89c903a8c84f.NewSummaryWithStartDateTimeWithEndDateTimeRequestBuilderInternal(m.pathParameters, m.requestAdapter, endDateTime, startDateTime);
}
