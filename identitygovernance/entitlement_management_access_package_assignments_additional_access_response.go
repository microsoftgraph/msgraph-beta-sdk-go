...
// EntitlementManagementAccessPackageAssignmentsAdditionalAccessResponse provides operations to call the additionalAccess method.
...
func (m *EntitlementManagementAccessPackageAssignmentsAdditionalAccessResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *EntitlementManagementAccessPackageAssignmentsAdditionalAccessResponse) GetValue()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AccessPackageAssignmentable) {
    return m.value
}
// Serialize serializes information the current object
func (m *EntitlementManagementAccessPackageAssignmentsAdditionalAccessResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *EntitlementManagementAccessPackageAssignmentsAdditionalAccessResponse) SetValue(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AccessPackageAssignmentable)() {
    m.value = value
}
