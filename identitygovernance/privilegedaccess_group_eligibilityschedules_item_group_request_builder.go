...
func NewPrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilder) {
    m := &PrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilitySchedules/{privilegedAccessGroupEligibilitySchedule%2Did}/group{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
func NewPrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilder) {
    ...
    return NewPrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *PrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Groupable, error) {
...
func (m *PrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilder) ServiceProvisioningErrors()(*PrivilegedaccessGroupEligibilityschedulesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) {
    return NewPrivilegedaccessGroupEligibilityschedulesItemGroupServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *PrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilder) WithUrl(rawUrl string)(*PrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilder) {
    return NewPrivilegedaccessGroupEligibilityschedulesItemGroupRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
