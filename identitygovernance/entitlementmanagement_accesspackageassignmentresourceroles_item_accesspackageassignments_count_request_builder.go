...
// EntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilderGetQueryParameters get the number of the resource
type EntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilderGetQueryParameters struct {
...
type EntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *EntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilderGetQueryParameters
}
// NewEntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilderInternal instantiates a new EntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilder and sets the default values.
...
// NewEntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilder instantiates a new EntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilder and sets the default values.
...
func (m *EntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilder) WithUrl(rawUrl string)(*EntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilder) {
    return NewEntitlementmanagementAccesspackageassignmentresourcerolesItemAccesspackageassignmentsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
