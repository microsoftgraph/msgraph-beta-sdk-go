...
// PermissionsAnalyticsAwsPermissionsCreepIndexDistributionsRequestBuilderGetQueryParameters get permissionsCreepIndexDistributions from identityGovernance
...
// NewPermissionsAnalyticsAwsPermissionsCreepIndexDistributionsRequestBuilderInternal instantiates a new PermissionsCreepIndexDistributionsRequestBuilder and sets the default values.
func NewPermissionsAnalyticsAwsPermissionsCreepIndexDistributionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissionsAnalyticsAwsPermissionsCreepIndexDistributionsRequestBuilder) {
    m := &PermissionsAnalyticsAwsPermissionsCreepIndexDistributionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/aws/permissionsCreepIndexDistributions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewPermissionsAnalyticsAwsPermissionsCreepIndexDistributionsRequestBuilder instantiates a new PermissionsCreepIndexDistributionsRequestBuilder and sets the default values.
