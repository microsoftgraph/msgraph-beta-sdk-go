...
// PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsRequestBuilderGetQueryParameters represents the Permissions Creep Index (PCI) for the authorization system. PCI distribution chart shows the classification of human and nonhuman identities based on the PCI score in three buckets (low, medium, high).
...
// NewPermissionsAnalyticsGcpPermissionsCreepIndexDistributionsRequestBuilderInternal instantiates a new PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsRequestBuilder and sets the default values.
...
// NewPermissionsAnalyticsGcpPermissionsCreepIndexDistributionsRequestBuilder instantiates a new PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsRequestBuilder and sets the default values.
...
// returns a *PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsRequestBuilder when successful
