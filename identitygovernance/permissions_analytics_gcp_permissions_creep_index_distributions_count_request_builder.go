...
// NewPermissionsAnalyticsGcpPermissionsCreepIndexDistributionsCountRequestBuilderInternal instantiates a new PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsCountRequestBuilder and sets the default values.
func NewPermissionsAnalyticsGcpPermissionsCreepIndexDistributionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsCountRequestBuilder) {
    m := &PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/gcp/permissionsCreepIndexDistributions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewPermissionsAnalyticsGcpPermissionsCreepIndexDistributionsCountRequestBuilder instantiates a new PermissionsAnalyticsGcpPermissionsCreepIndexDistributionsCountRequestBuilder and sets the default values.
