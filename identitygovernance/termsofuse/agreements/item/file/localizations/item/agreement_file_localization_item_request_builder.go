...
// DeleteWithResponseHandler delete navigation property localizations for identityGovernance
...
// PatchWithResponseHandler update the navigation property localizations in identityGovernance
