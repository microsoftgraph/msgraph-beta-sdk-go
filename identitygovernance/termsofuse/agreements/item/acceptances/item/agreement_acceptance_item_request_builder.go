...
// DeleteWithResponseHandler delete navigation property acceptances for identityGovernance
...
// PatchWithResponseHandler update the navigation property acceptances in identityGovernance
