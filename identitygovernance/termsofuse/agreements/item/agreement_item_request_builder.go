...
// DeleteWithResponseHandler delete navigation property agreements for identityGovernance
...
// PatchWithResponseHandler update the navigation property agreements in identityGovernance
