...
func NewTermsofuseAgreementsItemFileLocalizationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TermsofuseAgreementsItemFileLocalizationsCountRequestBuilder) {
    m := &TermsofuseAgreementsItemFileLocalizationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/file/localizations/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewTermsofuseAgreementsItemFileLocalizationsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TermsofuseAgreementsItemFileLocalizationsCountRequestBuilder) {
    ...
    return NewTermsofuseAgreementsItemFileLocalizationsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *TermsofuseAgreementsItemFileLocalizationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TermsofuseAgreementsItemFileLocalizationsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *TermsofuseAgreementsItemFileLocalizationsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *TermsofuseAgreementsItemFileLocalizationsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *TermsofuseAgreementsItemFileLocalizationsCountRequestBuilder) WithUrl(rawUrl string)(*TermsofuseAgreementsItemFileLocalizationsCountRequestBuilder) {
    return NewTermsofuseAgreementsItemFileLocalizationsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
