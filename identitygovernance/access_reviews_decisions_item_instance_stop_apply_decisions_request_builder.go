...
// NewAccessReviewsDecisionsItemInstanceStopApplyDecisionsRequestBuilderInternal instantiates a new AccessReviewsDecisionsItemInstanceStopApplyDecisionsRequestBuilder and sets the default values.
...
// NewAccessReviewsDecisionsItemInstanceStopApplyDecisionsRequestBuilder instantiates a new AccessReviewsDecisionsItemInstanceStopApplyDecisionsRequestBuilder and sets the default values.
...
// returns a *AccessReviewsDecisionsItemInstanceStopApplyDecisionsRequestBuilder when successful
func (m *AccessReviewsDecisionsItemInstanceStopApplyDecisionsRequestBuilder) WithUrl(rawUrl string)(*AccessReviewsDecisionsItemInstanceStopApplyDecisionsRequestBuilder) {
    return NewAccessReviewsDecisionsItemInstanceStopApplyDecisionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
