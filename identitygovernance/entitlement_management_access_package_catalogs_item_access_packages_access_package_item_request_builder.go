...
func (m *EntitlementManagementAccessPackageCatalogsItemAccessPackagesAccessPackageItemRequestBuilder) MicrosoftGraphGetApplicablePolicyRequirements()(*EntitlementManagementAccessPackageCatalogsItemAccessPackagesItemMicrosoftGraphGetApplicablePolicyRequirementsRequestBuilder) {
    return NewEntitlementManagementAccessPackageCatalogsItemAccessPackagesItemMicrosoftGraphGetApplicablePolicyRequirementsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphMoveToCatalog provides operations to call the moveToCatalog method.
func (m *EntitlementManagementAccessPackageCatalogsItemAccessPackagesAccessPackageItemRequestBuilder) MicrosoftGraphMoveToCatalog()(*EntitlementManagementAccessPackageCatalogsItemAccessPackagesItemMicrosoftGraphMoveToCatalogRequestBuilder) {
    return NewEntitlementManagementAccessPackageCatalogsItemAccessPackagesItemMicrosoftGraphMoveToCatalogRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
