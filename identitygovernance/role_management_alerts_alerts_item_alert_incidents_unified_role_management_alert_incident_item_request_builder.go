...
// RoleManagementAlertsAlertsItemAlertIncidentsUnifiedRoleManagementAlertIncidentItemRequestBuilderGetQueryParameters get alertIncidents from identityGovernance
...
func (m *RoleManagementAlertsAlertsItemAlertIncidentsUnifiedRoleManagementAlertIncidentItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *RoleManagementAlertsAlertsItemAlertIncidentsUnifiedRoleManagementAlertIncidentItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
