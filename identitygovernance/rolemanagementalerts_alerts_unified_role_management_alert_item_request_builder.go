...
func (m *RolemanagementalertsAlertsUnifiedRoleManagementAlertItemRequestBuilder) AlertConfiguration()(*RolemanagementalertsAlertsItemAlertconfigurationAlertConfigurationRequestBuilder) {
    return NewRolemanagementalertsAlertsItemAlertconfigurationAlertConfigurationRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *RolemanagementalertsAlertsUnifiedRoleManagementAlertItemRequestBuilder) AlertDefinition()(*RolemanagementalertsAlertsItemAlertdefinitionAlertDefinitionRequestBuilder) {
    return NewRolemanagementalertsAlertsItemAlertdefinitionAlertDefinitionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *RolemanagementalertsAlertsUnifiedRoleManagementAlertItemRequestBuilder) AlertIncidents()(*RolemanagementalertsAlertsItemAlertincidentsAlertIncidentsRequestBuilder) {
    return NewRolemanagementalertsAlertsItemAlertincidentsAlertIncidentsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
