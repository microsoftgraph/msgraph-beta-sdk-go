...
// PrivilegedAccessGroupAssignmentSchedulesItemPrincipalRequestBuilderGetQueryParameters get principal from identityGovernance
...
func NewPrivilegedAccessGroupAssignmentSchedulesItemPrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedAccessGroupAssignmentSchedulesItemPrincipalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentSchedules/{privilegedAccessGroupAssignmentSchedule%2Did}/principal{?%24select,%24expand}";
...
// NewPrivilegedAccessGroupAssignmentSchedulesItemPrincipalRequestBuilder instantiates a new PrincipalRequestBuilder and sets the default values.
