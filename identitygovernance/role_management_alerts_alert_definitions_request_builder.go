...
// RoleManagementAlertsAlertDefinitionsRequestBuilderGetQueryParameters defines an alert, its impact, and measures to mitigate or prevent it.
...
// NewRoleManagementAlertsAlertDefinitionsRequestBuilderInternal instantiates a new RoleManagementAlertsAlertDefinitionsRequestBuilder and sets the default values.
...
// NewRoleManagementAlertsAlertDefinitionsRequestBuilder instantiates a new RoleManagementAlertsAlertDefinitionsRequestBuilder and sets the default values.
...
// returns a *RoleManagementAlertsAlertDefinitionsRequestBuilder when successful
