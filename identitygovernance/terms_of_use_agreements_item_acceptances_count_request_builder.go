...
func (m *TermsOfUseAgreementsItemAcceptancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TermsOfUseAgreementsItemAcceptancesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
