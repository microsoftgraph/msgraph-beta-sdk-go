...
func (m *EntitlementManagementAccessPackageAssignmentResourceRolesRequestBuilder) MicrosoftGraphMy()(*EntitlementManagementAccessPackageAssignmentResourceRolesMicrosoftGraphMyRequestBuilder) {
    return NewEntitlementManagementAccessPackageAssignmentResourceRolesMicrosoftGraphMyRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
