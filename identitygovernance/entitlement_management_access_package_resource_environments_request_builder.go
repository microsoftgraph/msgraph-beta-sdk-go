...
// ByAccessPackageResourceEnvironmentIdString provides operations to manage the accessPackageResourceEnvironments property of the microsoft.graph.entitlementManagement entity.
func (m *EntitlementManagementAccessPackageResourceEnvironmentsRequestBuilder) ByAccessPackageResourceEnvironmentIdString(accessPackageResourceEnvironmentId string)(*EntitlementManagementAccessPackageResourceEnvironmentsAccessPackageResourceEnvironmentItemRequestBuilder) {
...
// NewEntitlementManagementAccessPackageResourceEnvironmentsRequestBuilderInternal instantiates a new AccessPackageResourceEnvironmentsRequestBuilder and sets the default values.
func NewEntitlementManagementAccessPackageResourceEnvironmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementAccessPackageResourceEnvironmentsRequestBuilder) {
    m := &EntitlementManagementAccessPackageResourceEnvironmentsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResourceEnvironments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewEntitlementManagementAccessPackageResourceEnvironmentsRequestBuilder instantiates a new AccessPackageResourceEnvironmentsRequestBuilder and sets the default values.
