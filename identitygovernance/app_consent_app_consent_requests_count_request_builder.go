...
func (m *AppConsentAppConsentRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AppConsentAppConsentRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
