...
// IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageItemRequestBuilderGetQueryParameters represents access package objects.
...
func (m *IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageItemRequestBuilder) AccessPackageAssignmentPolicies()(*IdentityGovernanceEntitlementManagementAccessPackagesItemAccessPackageAssignmentPoliciesRequestBuilder) {
    return NewIdentityGovernanceEntitlementManagementAccessPackagesItemAccessPackageAssignmentPoliciesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageItemRequestBuilder) AccessPackageAssignmentPoliciesById(id string)(*IdentityGovernanceEntitlementManagementAccessPackagesItemAccessPackageAssignmentPoliciesAccessPackageAssignmentPolicyItemRequestBuilder) {
    ...
    return NewIdentityGovernanceEntitlementManagementAccessPackagesItemAccessPackageAssignmentPoliciesAccessPackageAssignmentPolicyItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageItemRequestBuilder) AccessPackageCatalog()(*IdentityGovernanceEntitlementManagementAccessPackagesItemAccessPackageCatalogRequestBuilder) {
    return NewIdentityGovernanceEntitlementManagementAccessPackagesItemAccessPackageCatalogRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageItemRequestBuilder) AccessPackageResourceRoleScopes()(*IdentityGovernanceEntitlementManagementAccessPackagesItemAccessPackageResourceRoleScopesRequestBuilder) {
    return NewIdentityGovernanceEntitlementManagementAccessPackagesItemAccessPackageResourceRoleScopesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageItemRequestBuilder) AccessPackageResourceRoleScopesById(id string)(*IdentityGovernanceEntitlementManagementAccessPackagesItemAccessPackageResourceRoleScopesAccessPackageResourceRoleScopeItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewIdentityGovernanceEntitlementManagementAccessPackagesItemAccessPackageResourceRoleScopesAccessPackageResourceRoleScopeItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AccessPackageable, requestConfiguration *IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *IdentityGovernanceEntitlementManagementAccessPackagesAccessPackageItemRequestBuilder) MoveToCatalog()(*IdentityGovernanceEntitlementManagementAccessPackagesItemMoveToCatalogRequestBuilder) {
    return NewIdentityGovernanceEntitlementManagementAccessPackagesItemMoveToCatalogRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
