...
// PermissionsAnalyticsGcpFindingsFindingItemRequestBuilderGetQueryParameters get findings from identityGovernance
...
// NewPermissionsAnalyticsGcpFindingsFindingItemRequestBuilderInternal instantiates a new FindingItemRequestBuilder and sets the default values.
func NewPermissionsAnalyticsGcpFindingsFindingItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissionsAnalyticsGcpFindingsFindingItemRequestBuilder) {
    m := &PermissionsAnalyticsGcpFindingsFindingItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/permissionsAnalytics/gcp/findings/{finding%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewPermissionsAnalyticsGcpFindingsFindingItemRequestBuilder instantiates a new FindingItemRequestBuilder and sets the default values.
