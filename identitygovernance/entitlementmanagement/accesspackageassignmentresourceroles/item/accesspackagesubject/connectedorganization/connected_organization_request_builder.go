...
import (
    ...
    iaf3d5f872793263f90f79765909b12967a0b566325918c639a888c86ad101c75 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentresourceroles/item/accesspackagesubject/connectedorganization/ref"
)

// ConnectedOrganizationRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentResourceRoles\{accessPackageAssignmentResourceRole-id}\accessPackageSubject\connectedOrganization
...
func NewConnectedOrganizationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ConnectedOrganizationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole_id}/accessPackageSubject/connectedOrganization{?select,expand}";
...
func (m *ConnectedOrganizationRequestBuilder) Ref()(*iaf3d5f872793263f90f79765909b12967a0b566325918c639a888c86ad101c75.RefRequestBuilder) {
    return iaf3d5f872793263f90f79765909b12967a0b566325918c639a888c86ad101c75.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
