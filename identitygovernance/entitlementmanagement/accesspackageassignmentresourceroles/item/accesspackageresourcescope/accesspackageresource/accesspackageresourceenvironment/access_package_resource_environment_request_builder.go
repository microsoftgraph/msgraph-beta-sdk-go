...
import (
    ...
    idbc70f9a81013ce02caf34d2fc36c8b7177ce214575ad907e4efcb4e335c7e53 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentresourceroles/item/accesspackageresourcescope/accesspackageresource/accesspackageresourceenvironment/ref"
)

// AccessPackageResourceEnvironmentRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentResourceRoles\{accessPackageAssignmentResourceRole-id}\accessPackageResourceScope\accessPackageResource\accessPackageResourceEnvironment
...
func NewAccessPackageResourceEnvironmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageResourceEnvironmentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole_id}/accessPackageResourceScope/accessPackageResource/accessPackageResourceEnvironment{?select,expand}";
...
func (m *AccessPackageResourceEnvironmentRequestBuilder) Ref()(*idbc70f9a81013ce02caf34d2fc36c8b7177ce214575ad907e4efcb4e335c7e53.RefRequestBuilder) {
    return idbc70f9a81013ce02caf34d2fc36c8b7177ce214575ad907e4efcb4e335c7e53.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
