...
import (
    ...
    ida0457ceb92d623bc695353e999f224e8a092eb9dcfb5e044b92c9b68e4bceb6 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentresourceroles/item/accesspackageassignments/item/accesspackage/accesspackagecatalog/ref"
)

// AccessPackageCatalogRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentResourceRoles\{accessPackageAssignmentResourceRole-id}\accessPackageAssignments\{accessPackageAssignment-id}\accessPackage\accessPackageCatalog
...
func NewAccessPackageCatalogRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageCatalogRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole_id}/accessPackageAssignments/{accessPackageAssignment_id}/accessPackage/accessPackageCatalog{?select,expand}";
...
func (m *AccessPackageCatalogRequestBuilder) Ref()(*ida0457ceb92d623bc695353e999f224e8a092eb9dcfb5e044b92c9b68e4bceb6.RefRequestBuilder) {
    return ida0457ceb92d623bc695353e999f224e8a092eb9dcfb5e044b92c9b68e4bceb6.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
