...
import (
    ...
    i47691f0a952d79619a9300ed867951497c4cc44608f0fa21cf41b22a930d2eb5 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentresourceroles/item/accesspackageassignments/item/target/connectedorganization/ref"
)

// ConnectedOrganizationRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentResourceRoles\{accessPackageAssignmentResourceRole-id}\accessPackageAssignments\{accessPackageAssignment-id}\target\connectedOrganization
...
func NewConnectedOrganizationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ConnectedOrganizationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole_id}/accessPackageAssignments/{accessPackageAssignment_id}/target/connectedOrganization{?select,expand}";
...
func (m *ConnectedOrganizationRequestBuilder) Ref()(*i47691f0a952d79619a9300ed867951497c4cc44608f0fa21cf41b22a930d2eb5.RefRequestBuilder) {
    return i47691f0a952d79619a9300ed867951497c4cc44608f0fa21cf41b22a930d2eb5.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
