...
import (
    ...
    i9aab7381806dfd4f16e0b5a8a1cce4767cfd693b69111d141a1db019fe2117f8 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentresourceroles/item/accesspackageassignments/item/accesspackageassignmentrequests/item/accesspackageassignment/reprocess"
)

// AccessPackageAssignmentRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentResourceRoles\{accessPackageAssignmentResourceRole-id}\accessPackageAssignments\{accessPackageAssignment-id}\accessPackageAssignmentRequests\{accessPackageAssignmentRequest-id}\accessPackageAssignment
...
func NewAccessPackageAssignmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageAssignmentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole_id}/accessPackageAssignments/{accessPackageAssignment_id}/accessPackageAssignmentRequests/{accessPackageAssignmentRequest_id}/accessPackageAssignment{?select,expand}";
...
func (m *AccessPackageAssignmentRequestBuilder) Reprocess()(*i9aab7381806dfd4f16e0b5a8a1cce4767cfd693b69111d141a1db019fe2117f8.ReprocessRequestBuilder) {
    return i9aab7381806dfd4f16e0b5a8a1cce4767cfd693b69111d141a1db019fe2117f8.NewReprocessRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
