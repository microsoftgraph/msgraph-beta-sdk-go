...
import (
    ...
    i282b066b377e2398f608ea8bc992168ecac378fefea8bcd107f597b54034e04e "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentresourceroles/item/accesspackageassignments/item/accesspackageassignmentpolicy/customextensionhandlers/ref"
)

// CustomExtensionHandlersRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentResourceRoles\{accessPackageAssignmentResourceRole-id}\accessPackageAssignments\{accessPackageAssignment-id}\accessPackageAssignmentPolicy\customExtensionHandlers
...
func NewCustomExtensionHandlersRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CustomExtensionHandlersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole_id}/accessPackageAssignments/{accessPackageAssignment_id}/accessPackageAssignmentPolicy/customExtensionHandlers{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *CustomExtensionHandlersRequestBuilder) Ref()(*i282b066b377e2398f608ea8bc992168ecac378fefea8bcd107f597b54034e04e.RefRequestBuilder) {
    return i282b066b377e2398f608ea8bc992168ecac378fefea8bcd107f597b54034e04e.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
