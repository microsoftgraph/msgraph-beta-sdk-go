...
import (
    ...
    i8b2df9942adc88928868488859b0476e1b576fe18f8691f3066fea796864d4e7 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentpolicies/item/accesspackagecatalog/accesspackages/filterbycurrentuserwithon"
    ib219ba9a52396bb4f9a5ca8240328a511f14e5ace860e40601debbe61d66c700 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentpolicies/item/accesspackagecatalog/accesspackages/search"
)

// AccessPackagesRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\accessPackageCatalog\accessPackages
...
func NewAccessPackagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy_id}/accessPackageCatalog/accessPackages{?top,skip,search,filter,count,orderby,select,expand}";
...
// FilterByCurrentUserWithOn builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\accessPackageCatalog\accessPackages\microsoft.graph.filterByCurrentUser(on={on})
func (m *AccessPackagesRequestBuilder) FilterByCurrentUserWithOn(on *string)(*i8b2df9942adc88928868488859b0476e1b576fe18f8691f3066fea796864d4e7.FilterByCurrentUserWithOnRequestBuilder) {
    return i8b2df9942adc88928868488859b0476e1b576fe18f8691f3066fea796864d4e7.NewFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on);
}
...
// Search builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\accessPackageCatalog\accessPackages\microsoft.graph.Search()
func (m *AccessPackagesRequestBuilder) Search()(*ib219ba9a52396bb4f9a5ca8240328a511f14e5ace860e40601debbe61d66c700.SearchRequestBuilder) {
    return ib219ba9a52396bb4f9a5ca8240328a511f14e5ace860e40601debbe61d66c700.NewSearchRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
