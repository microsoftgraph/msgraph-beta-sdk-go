...
import (
    ...
    ica1c7067c35e57e70813b7bcf9354bc3886ce8bef5e8ac369dffd727a489d384 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentpolicies/item/accesspackagecatalog/accesspackages/item/accesspackagecatalog/ref"
)

// AccessPackageCatalogRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\accessPackageCatalog\accessPackages\{accessPackage-id}\accessPackageCatalog
...
func NewAccessPackageCatalogRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageCatalogRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy_id}/accessPackageCatalog/accessPackages/{accessPackage_id}/accessPackageCatalog{?select,expand}";
...
func (m *AccessPackageCatalogRequestBuilder) Ref()(*ica1c7067c35e57e70813b7bcf9354bc3886ce8bef5e8ac369dffd727a489d384.RefRequestBuilder) {
    return ica1c7067c35e57e70813b7bcf9354bc3886ce8bef5e8ac369dffd727a489d384.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
