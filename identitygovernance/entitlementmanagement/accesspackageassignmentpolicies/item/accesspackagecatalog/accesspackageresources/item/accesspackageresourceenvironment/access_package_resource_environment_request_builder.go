...
import (
    ...
    ic4b184e9946cd45050dfff98d7c6edc8afda83c2a5d2719cd9802dda5f11baf2 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentpolicies/item/accesspackagecatalog/accesspackageresources/item/accesspackageresourceenvironment/ref"
)

// AccessPackageResourceEnvironmentRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\accessPackageCatalog\accessPackageResources\{accessPackageResource-id}\accessPackageResourceEnvironment
...
func NewAccessPackageResourceEnvironmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageResourceEnvironmentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy_id}/accessPackageCatalog/accessPackageResources/{accessPackageResource_id}/accessPackageResourceEnvironment{?select,expand}";
...
func (m *AccessPackageResourceEnvironmentRequestBuilder) Ref()(*ic4b184e9946cd45050dfff98d7c6edc8afda83c2a5d2719cd9802dda5f11baf2.RefRequestBuilder) {
    return ic4b184e9946cd45050dfff98d7c6edc8afda83c2a5d2719cd9802dda5f11baf2.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
