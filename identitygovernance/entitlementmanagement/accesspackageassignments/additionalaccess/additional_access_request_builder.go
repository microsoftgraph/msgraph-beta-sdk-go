...
// AdditionalAccessRequestBuilderGetOptions options for Get
type AdditionalAccessRequestBuilderGetOptions struct {
    // Request headers
...
func (m *AdditionalAccessRequestBuilder) CreateGetRequestInformation(options *AdditionalAccessRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AdditionalAccessRequestBuilder) Get(options *AdditionalAccessRequestBuilderGetOptions)(AdditionalAccessResponseable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateAdditionalAccessResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
