...
// Builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignments\{accessPackageAssignment-id}\accessPackage\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\accessPackageCatalog\accessPackages\{accessPackage-id}
...
func NewAccessPackageRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment_id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy_id}/accessPackageCatalog/accessPackages/{accessPackage_id}{?select,expand}";
...
func (m *AccessPackageRequestBuilder) GetApplicablePolicyRequirements()(*idbdd03d2512cd81c86c2ea61098e9008fa317dacb043a4397b1b926a858b9871.GetApplicablePolicyRequirementsRequestBuilder) {
    return idbdd03d2512cd81c86c2ea61098e9008fa317dacb043a4397b1b926a858b9871.NewGetApplicablePolicyRequirementsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// The access packages in this catalog. Read-only. Nullable.
// Parameters:
//  - options : Options for the request
