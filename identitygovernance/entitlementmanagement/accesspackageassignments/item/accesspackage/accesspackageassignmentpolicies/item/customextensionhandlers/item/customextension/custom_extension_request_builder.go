...
type CustomExtensionRequestBuilderGetOptions struct {
    ...
    Q *CustomExtensionRequestBuilderGetQueryParameters;
...
func NewCustomExtensionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CustomExtensionRequestBuilder) {
    m := &CustomExtensionRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment_id}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy_id}/customExtensionHandlers/{customExtensionHandler_id}/customExtension{?select,expand}";
...
func NewCustomExtensionRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CustomExtensionRequestBuilder) {
...
func (m *CustomExtensionRequestBuilder) CreateGetRequestInformation(options *CustomExtensionRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *CustomExtensionRequestBuilder) Get(options *CustomExtensionRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CustomAccessPackageWorkflowExtensionable, error) {
