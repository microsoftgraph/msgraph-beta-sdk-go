...
import (
    ...
    i54598eee7b701e2025f424604b2ffb3305f898923e5910307b85e5ebadbc8ae9 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignments/item/accesspackageassignmentpolicy/accesspackagecatalog/accesspackages/item/accesspackagecatalog/ref"
)

// accessPackageCatalogRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignments\{accessPackageAssignment-id}\accessPackageAssignmentPolicy\accessPackageCatalog\accessPackages\{accessPackage-id}\accessPackageCatalog
...
func NewAccessPackageCatalogRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageCatalogRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment_id}/accessPackageAssignmentPolicy/accessPackageCatalog/accessPackages/{accessPackage_id}/accessPackageCatalog{?select,expand}";
...
func (m *AccessPackageCatalogRequestBuilder) Ref()(*i54598eee7b701e2025f424604b2ffb3305f898923e5910307b85e5ebadbc8ae9.RefRequestBuilder) {
    return i54598eee7b701e2025f424604b2ffb3305f898923e5910307b85e5ebadbc8ae9.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
