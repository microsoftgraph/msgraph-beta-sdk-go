...
import (
    ...
    if39c6c6966f589962a9c8568b96b1d9d64282c8072943b0714c09a74031347f7 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignments/item/target/connectedorganization/ref"
)

// ConnectedOrganizationRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignments\{accessPackageAssignment-id}\target\connectedOrganization
...
func NewConnectedOrganizationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ConnectedOrganizationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment_id}/target/connectedOrganization{?select,expand}";
...
func (m *ConnectedOrganizationRequestBuilder) Ref()(*if39c6c6966f589962a9c8568b96b1d9d64282c8072943b0714c09a74031347f7.RefRequestBuilder) {
    return if39c6c6966f589962a9c8568b96b1d9d64282c8072943b0714c09a74031347f7.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
