...
import (
    ...
    ib1bfb44629b8b1d845d96fff4d3057c34a536a5ca396285423e1a5132f200db1 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackages/item/accesspackageassignmentpolicies/item/customextensionhandlers/ref"
)

// CustomExtensionHandlersRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackages\{accessPackage-id}\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\customExtensionHandlers
...
func NewCustomExtensionHandlersRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CustomExtensionHandlersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage_id}/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy_id}/customExtensionHandlers{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *CustomExtensionHandlersRequestBuilder) Ref()(*ib1bfb44629b8b1d845d96fff4d3057c34a536a5ca396285423e1a5132f200db1.RefRequestBuilder) {
    return ib1bfb44629b8b1d845d96fff4d3057c34a536a5ca396285423e1a5132f200db1.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
