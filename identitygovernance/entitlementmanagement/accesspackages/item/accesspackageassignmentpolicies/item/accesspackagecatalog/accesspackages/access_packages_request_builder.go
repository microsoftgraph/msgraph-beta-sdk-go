...
import (
    ...
    i374aca0ab5d353a7ef1a7fd21b49d09f0e1936f6b744e4970c09402b4bfdda16 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackages/item/accesspackageassignmentpolicies/item/accesspackagecatalog/accesspackages/search"
...
// Builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackages\{accessPackage-id}\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\accessPackageCatalog\accessPackages
...
func NewAccessPackagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackagesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/identityGovernance/entitlementManagement/accessPackages/{accessPackage_id}/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy_id}/accessPackageCatalog/accessPackages{?top,skip,search,filter,count,orderby,select,expand}";
...
// Builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackages\{accessPackage-id}\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\accessPackageCatalog\accessPackages\microsoft.graph.filterByCurrentUser(on={on})
// Parameters:
//  - on : Usage: on={on}
func (m *AccessPackagesRequestBuilder) FilterByCurrentUserWithOn(on *string)(*ibf87fde98cdbaf56f2d0afce37ba8ffa66b030762139c3e53b38f614c84c789e.FilterByCurrentUserWithOnRequestBuilder) {
    return ibf87fde98cdbaf56f2d0afce37ba8ffa66b030762139c3e53b38f614c84c789e.NewFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on);
}
// The access packages in this catalog. Read-only. Nullable.
// Parameters:
//  - options : Options for the request
...
// Builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackages\{accessPackage-id}\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\accessPackageCatalog\accessPackages\microsoft.graph.Search()
func (m *AccessPackagesRequestBuilder) Search()(*i374aca0ab5d353a7ef1a7fd21b49d09f0e1936f6b744e4970c09402b4bfdda16.SearchRequestBuilder) {
    return i374aca0ab5d353a7ef1a7fd21b49d09f0e1936f6b744e4970c09402b4bfdda16.NewSearchRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
