...
import (
    ...
    iaee2402e27d0d52f34e3a40aa7b3c35aa5db166c30d16efd6e9ae9fa5c2c855b "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageresources/item/accesspackageresourcescopes/item/accesspackageresource/accesspackageresourceroles/item/accesspackageresource/accesspackageresourceenvironment"
)
...
func (m *AccessPackageResourceRequestBuilder) AccessPackageResourceEnvironment()(*iaee2402e27d0d52f34e3a40aa7b3c35aa5db166c30d16efd6e9ae9fa5c2c855b.AccessPackageResourceEnvironmentRequestBuilder) {
    return iaee2402e27d0d52f34e3a40aa7b3c35aa5db166c30d16efd6e9ae9fa5c2c855b.NewAccessPackageResourceEnvironmentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewAccessPackageResourceRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageResourceRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResources/{accessPackageResource_id}/accessPackageResourceScopes/{accessPackageResourceScope_id}/accessPackageResource/accessPackageResourceRoles/{accessPackageResourceRole_id}/accessPackageResource{?select,expand}";
