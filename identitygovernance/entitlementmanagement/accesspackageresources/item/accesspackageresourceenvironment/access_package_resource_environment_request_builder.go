...
import (
    ...
    i1536230f76b48f795afed78f31f1573ca43796ff986e4ed1527bcc5d09c9d385 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageresources/item/accesspackageresourceenvironment/ref"
)

// AccessPackageResourceEnvironmentRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageResources\{accessPackageResource-id}\accessPackageResourceEnvironment
...
func NewAccessPackageResourceEnvironmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageResourceEnvironmentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResources/{accessPackageResource_id}/accessPackageResourceEnvironment{?select,expand}";
...
func (m *AccessPackageResourceEnvironmentRequestBuilder) Ref()(*i1536230f76b48f795afed78f31f1573ca43796ff986e4ed1527bcc5d09c9d385.RefRequestBuilder) {
    return i1536230f76b48f795afed78f31f1573ca43796ff986e4ed1527bcc5d09c9d385.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
