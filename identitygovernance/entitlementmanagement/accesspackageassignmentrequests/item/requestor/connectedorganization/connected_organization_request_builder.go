...
import (
    ...
    i741af1eb515d1df7ff592ac3e611ca58fe088ee3d6b22ee1787b3c9caadebafb "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentrequests/item/requestor/connectedorganization/ref"
)

// ConnectedOrganizationRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentRequests\{accessPackageAssignmentRequest-id}\requestor\connectedOrganization
...
func NewConnectedOrganizationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ConnectedOrganizationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentRequests/{accessPackageAssignmentRequest_id}/requestor/connectedOrganization{?select,expand}";
...
func (m *ConnectedOrganizationRequestBuilder) Ref()(*i741af1eb515d1df7ff592ac3e611ca58fe088ee3d6b22ee1787b3c9caadebafb.RefRequestBuilder) {
    return i741af1eb515d1df7ff592ac3e611ca58fe088ee3d6b22ee1787b3c9caadebafb.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
