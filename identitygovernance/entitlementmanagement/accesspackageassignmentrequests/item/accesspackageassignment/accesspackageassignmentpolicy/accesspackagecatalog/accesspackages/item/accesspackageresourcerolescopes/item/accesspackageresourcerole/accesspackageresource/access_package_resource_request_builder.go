...
func (m *AccessPackageResourceRequestBuilder) AccessPackageResourceEnvironment()(*ic75b80851c7b62fbfa077af6bbdd5bf867531708888ad1c37c948ba1300fea64.AccessPackageResourceEnvironmentRequestBuilder) {
    return ic75b80851c7b62fbfa077af6bbdd5bf867531708888ad1c37c948ba1300fea64.NewAccessPackageResourceEnvironmentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *AccessPackageResourceRequestBuilder) AccessPackageResourceRoles()(*i099384fcb0149d081f1ccbd2895c5050fc2c5e0bd946328d08574dc6e7bed785.AccessPackageResourceRolesRequestBuilder) {
    return i099384fcb0149d081f1ccbd2895c5050fc2c5e0bd946328d08574dc6e7bed785.NewAccessPackageResourceRolesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AccessPackageResourceRequestBuilder) AccessPackageResourceRolesById(id string)(*i292e2c1988f13ff69ebfe317ee189df25371656e65bc84d5ba595b8105aa6347.AccessPackageResourceRoleRequestBuilder) {
    ...
    return i292e2c1988f13ff69ebfe317ee189df25371656e65bc84d5ba595b8105aa6347.NewAccessPackageResourceRoleRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
func (m *AccessPackageResourceRequestBuilder) AccessPackageResourceScopes()(*i1e62d36322dbf22671f4868b79f88a215e9c3dec4c0ab1240091f6d407c80bf3.AccessPackageResourceScopesRequestBuilder) {
    return i1e62d36322dbf22671f4868b79f88a215e9c3dec4c0ab1240091f6d407c80bf3.NewAccessPackageResourceScopesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// AccessPackageResourceScopesById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.identityGovernance.entitlementManagement.accessPackageAssignmentRequests.item.accessPackageAssignment.accessPackageAssignmentPolicy.accessPackageCatalog.accessPackages.item.accessPackageResourceRoleScopes.item.accessPackageResourceRole.accessPackageResource.accessPackageResourceScopes.item collection
func (m *AccessPackageResourceRequestBuilder) AccessPackageResourceScopesById(id string)(*ia5a91d8ed5d540a0e3c1434edab86d174cdd059894c571495a44529bb874912e.AccessPackageResourceScopeRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return ia5a91d8ed5d540a0e3c1434edab86d174cdd059894c571495a44529bb874912e.NewAccessPackageResourceScopeRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
