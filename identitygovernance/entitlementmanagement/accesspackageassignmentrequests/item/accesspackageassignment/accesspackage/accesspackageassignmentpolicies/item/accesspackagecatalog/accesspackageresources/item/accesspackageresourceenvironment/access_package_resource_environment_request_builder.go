...
func NewAccessPackageResourceEnvironmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageResourceEnvironmentRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/identityGovernance/entitlementManagement/accessPackageAssignmentRequests/{accessPackageAssignmentRequest_id}/accessPackageAssignment/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy_id}/accessPackageCatalog/accessPackageResources/{accessPackageResource_id}/accessPackageResourceEnvironment{?select,expand}";
...
func (m *AccessPackageResourceEnvironmentRequestBuilder) Ref()(*i886fe634542924ed20a1ea8478a056ff21216823ca906a65e48b1ccac24ba3b8.RefRequestBuilder) {
    return i886fe634542924ed20a1ea8478a056ff21216823ca906a65e48b1ccac24ba3b8.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
