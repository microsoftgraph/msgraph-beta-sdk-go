...
import (
    ...
    i6ec67f02382456fb6624a91962fa44b0002f6b336725f87a0b7aaf040d8682ff "github.com/microsoftgraph/msgraph-beta-sdk-"
)
...
func NewAccessPackageResourceEnvironmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageResourceEnvironmentRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/identityGovernance/entitlementManagement/accessPackageAssignmentRequests/{accessPackageAssignmentRequest_id}/accessPackageAssignment/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy_id}/accessPackageCatalog/accessPackageResourceScopes/{accessPackageResourceScope_id}/accessPackageResource/accessPackageResourceEnvironment{?select,expand}";
...
func (m *AccessPackageResourceEnvironmentRequestBuilder) Ref()(*i6ec67f02382456fb6624a91962fa44b0002f6b336725f87a0b7aaf040d8682ff.RefRequestBuilder) {
    return i6ec67f02382456fb6624a91962fa44b0002f6b336725f87a0b7aaf040d8682ff.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
