...
import (
    ...
    i8b2c6d5ace64a634976dc020c0819c5aae5195b260b1a4c5e932c7db09c51183 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentrequests/item/accesspackage/getapplicablepolicyrequirements"
    i9cc8a898eaad1e23734e8472dd66d22eadbdf0068ab01f736f659fed04db4856 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackageassignmentrequests/item/accesspackage/ref"
)

// accessPackageRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentRequests\{accessPackageAssignmentRequest-id}\accessPackage
...
func NewAccessPackageRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentRequests/{accessPackageAssignmentRequest_id}/accessPackage{?select,expand}";
...
func (m *AccessPackageRequestBuilder) GetApplicablePolicyRequirements()(*i8b2c6d5ace64a634976dc020c0819c5aae5195b260b1a4c5e932c7db09c51183.GetApplicablePolicyRequirementsRequestBuilder) {
    return i8b2c6d5ace64a634976dc020c0819c5aae5195b260b1a4c5e932c7db09c51183.NewGetApplicablePolicyRequirementsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *AccessPackageRequestBuilder) Ref()(*i9cc8a898eaad1e23734e8472dd66d22eadbdf0068ab01f736f659fed04db4856.RefRequestBuilder) {
    return i9cc8a898eaad1e23734e8472dd66d22eadbdf0068ab01f736f659fed04db4856.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
