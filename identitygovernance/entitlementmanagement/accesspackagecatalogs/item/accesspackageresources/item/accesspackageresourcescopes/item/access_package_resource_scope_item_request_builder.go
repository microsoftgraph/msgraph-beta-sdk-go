...
import (
    ...
    i1a43158164c7f1c54ba0a8f598ddb0893bc7e6470920bc9cdb96b37f3d1a3e26 "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackagecatalogs/item/accesspackageresources/item/accesspackageresourcescopes/item/accesspackageresource"
)

// AccessPackageResourceScopeItemRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageCatalogs\{accessPackageCatalog-id}\accessPackageResources\{accessPackageResource-id}\accessPackageResourceScopes\{accessPackageResourceScope-id}
...
func (m *AccessPackageResourceScopeItemRequestBuilder) AccessPackageResource()(*i1a43158164c7f1c54ba0a8f598ddb0893bc7e6470920bc9cdb96b37f3d1a3e26.AccessPackageResourceRequestBuilder) {
    return i1a43158164c7f1c54ba0a8f598ddb0893bc7e6470920bc9cdb96b37f3d1a3e26.NewAccessPackageResourceRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func NewAccessPackageResourceScopeItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessPackageResourceScopeItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog_id}/accessPackageResources/{accessPackageResource_id}/accessPackageResourceScopes/{accessPackageResourceScope_id}{?select,expand}";
