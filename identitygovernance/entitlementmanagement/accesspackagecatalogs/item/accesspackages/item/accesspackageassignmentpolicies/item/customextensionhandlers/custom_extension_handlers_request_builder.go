...
import (
    ...
    i4b4dbc8b5c1d57fe6230c11b2f9efe38f5c3270c87fee73b93062248e51dddcf "github.com/microsoftgraph/msgraph-beta-sdk-go/identitygovernance/entitlementmanagement/accesspackagecatalogs/item/accesspackages/item/accesspackageassignmentpolicies/item/customextensionhandlers/ref"
)

// CustomExtensionHandlersRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageCatalogs\{accessPackageCatalog-id}\accessPackages\{accessPackage-id}\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\customExtensionHandlers
...
func NewCustomExtensionHandlersRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CustomExtensionHandlersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog_id}/accessPackages/{accessPackage_id}/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy_id}/customExtensionHandlers{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *CustomExtensionHandlersRequestBuilder) Ref()(*i4b4dbc8b5c1d57fe6230c11b2f9efe38f5c3270c87fee73b93062248e51dddcf.RefRequestBuilder) {
    return i4b4dbc8b5c1d57fe6230c11b2f9efe38f5c3270c87fee73b93062248e51dddcf.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
