...
// RefRequestBuilder builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageCatalogs\{accessPackageCatalog-id}\accessPackages\{accessPackage-id}\accessPackageAssignmentPolicies\{accessPackageAssignmentPolicy-id}\customExtensionHandlers\$ref
...
// RefRequestBuilderGetQueryParameters get ref of customExtensionHandlers from identityGovernance
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog_id}/accessPackages/{accessPackage_id}/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy_id}/customExtensionHandlers/$ref{?top,skip,search,filter,count,orderby}";
...
// CreateGetRequestInformation get ref of customExtensionHandlers from identityGovernance
...
// CreatePostRequestInformation create new navigation property ref to customExtensionHandlers for identityGovernance
...
// Get get ref of customExtensionHandlers from identityGovernance
...
// Post create new navigation property ref to customExtensionHandlers for identityGovernance
