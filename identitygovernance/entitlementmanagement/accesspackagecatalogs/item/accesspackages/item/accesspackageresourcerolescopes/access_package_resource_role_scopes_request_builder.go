...
type AccessPackageResourceRoleScopesRequestBuilderGetOptions struct {
    ...
    Q *AccessPackageResourceRoleScopesRequestBuilderGetQueryParameters;
...
// Get nullable.
func (m *AccessPackageResourceRoleScopesRequestBuilder) Get(options *AccessPackageResourceRoleScopesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AccessPackageResourceRoleScopeCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateAccessPackageResourceRoleScopeCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AccessPackageResourceRoleScopeCollectionResponseable), nil
}
// Post create new navigation property to accessPackageResourceRoleScopes for identityGovernance
func (m *AccessPackageResourceRoleScopesRequestBuilder) Post(options *AccessPackageResourceRoleScopesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AccessPackageResourceRoleScopeable, error) {
