...
// RefRequestBuilderGetQueryParameters the  access packages whose assigned users are ineligible to be assigned this access package.
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property ref to incompatibleAccessPackages for identityGovernance
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property ref to incompatibleAccessPackages for identityGovernance
