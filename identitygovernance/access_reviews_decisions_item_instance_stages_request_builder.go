...
// AccessReviewsDecisionsItemInstanceStagesRequestBuilderGetQueryParameters retrieve the stages in a multi-stage access review instance. This API is supported in the following national cloud deployments.
