...
// PermissionsManagementScheduledPermissionsApprovalsItemStepsApprovalStepItemRequestBuilderGetQueryParameters retrieve the properties of an approvalStep object.
