...
func (m *IdentityGovernanceEntitlementManagementConnectedOrganizationsItemInternalSponsorsRequestBuilder) GetUserOwnedObjects()(*IdentityGovernanceEntitlementManagementConnectedOrganizationsItemInternalSponsorsGetUserOwnedObjectsRequestBuilder) {
    return NewIdentityGovernanceEntitlementManagementConnectedOrganizationsItemInternalSponsorsGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
