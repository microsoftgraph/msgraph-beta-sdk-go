...
// AccessReviewsDecisionsRequestBuilderGetQueryParameters represents an Azure AD access review decision on an instance of a review.
...
func (m *AccessReviewsDecisionsRequestBuilder) Count()(*AccessReviewsDecisionsCountRequestBuilder) {
    return NewAccessReviewsDecisionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *AccessReviewsDecisionsRequestBuilder) MicrosoftGraphFilterByCurrentUserWithOn(on *string)(*AccessReviewsDecisionsMicrosoftGraphFilterByCurrentUserWithOnFilterByCurrentUserWithOnRequestBuilder) {
    return NewAccessReviewsDecisionsMicrosoftGraphFilterByCurrentUserWithOnFilterByCurrentUserWithOnRequestBuilderInternal(m.pathParameters, m.requestAdapter, on)
}
// MicrosoftGraphRecordAllDecisions provides operations to call the recordAllDecisions method.
func (m *AccessReviewsDecisionsRequestBuilder) MicrosoftGraphRecordAllDecisions()(*AccessReviewsDecisionsMicrosoftGraphRecordAllDecisionsRecordAllDecisionsRequestBuilder) {
    return NewAccessReviewsDecisionsMicrosoftGraphRecordAllDecisionsRecordAllDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
