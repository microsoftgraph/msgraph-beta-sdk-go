...
func (m *PermissionsAnalyticsAwsPermissionsCreepIndexDistributionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PermissionsAnalyticsAwsPermissionsCreepIndexDistributionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
