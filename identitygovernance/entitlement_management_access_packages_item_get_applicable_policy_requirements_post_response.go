...
func (m *EntitlementManagementAccessPackagesItemGetApplicablePolicyRequirementsPostResponse) GetValue()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AccessPackageAssignmentRequestRequirementsable) {
    val, err := m.GetBackingStore().Get("value")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AccessPackageAssignmentRequestRequirementsable)
    }
    return nil
}
...
func (m *EntitlementManagementAccessPackagesItemGetApplicablePolicyRequirementsPostResponse) SetValue(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AccessPackageAssignmentRequestRequirementsable)() {
...
type EntitlementManagementAccessPackagesItemGetApplicablePolicyRequirementsPostResponseable interface {
    ...
    GetValue()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AccessPackageAssignmentRequestRequirementsable)
    SetValue(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AccessPackageAssignmentRequestRequirementsable)()
}
