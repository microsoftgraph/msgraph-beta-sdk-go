...
// LifecycleWorkflowsWorkflowTemplatesItemTasksItemTaskProcessingResultsItemResumePostRequestBody provides operations to call the resume method.
...
func (m *LifecycleWorkflowsWorkflowTemplatesItemTasksItemTaskProcessingResultsItemResumePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *LifecycleWorkflowsWorkflowTemplatesItemTasksItemTaskProcessingResultsItemResumePostRequestBody) SetAdditionalData(value map[string]interface{})() {
