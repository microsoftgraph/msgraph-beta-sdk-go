...
func (m *AccessReviewsDefinitionsItemInstancesItemDecisionsItemInsightsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AccessReviewsDefinitionsItemInstancesItemDecisionsItemInsightsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
