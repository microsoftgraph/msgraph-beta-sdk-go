...
func (m *AccessReviewsDefinitionsItemInstancesItemDecisionsRequestBuilder) MicrosoftGraphRecordAllDecisions()(*AccessReviewsDefinitionsItemInstancesItemDecisionsMicrosoftGraphRecordAllDecisionsRequestBuilder) {
    return NewAccessReviewsDefinitionsItemInstancesItemDecisionsMicrosoftGraphRecordAllDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
