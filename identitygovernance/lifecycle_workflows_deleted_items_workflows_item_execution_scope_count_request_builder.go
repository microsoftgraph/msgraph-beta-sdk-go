...
func (m *LifecycleWorkflowsDeletedItemsWorkflowsItemExecutionScopeCountRequestBuilder) Get(ctx context.Context, requestConfiguration *LifecycleWorkflowsDeletedItemsWorkflowsItemExecutionScopeCountRequestBuilderGetRequestConfiguration)(*int64, error) {
