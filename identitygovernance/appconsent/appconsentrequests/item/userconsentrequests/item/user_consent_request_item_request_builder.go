...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property userConsentRequests for identityGovernance
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property userConsentRequests in identityGovernance
