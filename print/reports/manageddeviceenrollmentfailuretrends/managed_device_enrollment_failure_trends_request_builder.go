...
func (m *ManagedDeviceEnrollmentFailureTrendsRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedDeviceEnrollmentFailureTrendsRequestBuilderGetRequestConfiguration)([]byte, error) {
