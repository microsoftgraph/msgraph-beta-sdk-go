...
import (
    ...
    ie2562a8a7e5af05944f22af11e8509533addbeea0d0fc84365b2ac7cb9ca41fb "github.com/microsoftgraph/msgraph-beta-sdk-go/print/reports/dailyprintusage/count"
)
...
// DailyPrintUsageRequestBuilderGetQueryParameters get dailyPrintUsage from print
...
func NewDailyPrintUsageRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DailyPrintUsageRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/reports/dailyPrintUsage{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DailyPrintUsageRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DailyPrintUsageRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// CreatePostRequestInformation create new navigation property to dailyPrintUsage for print
...
// Post create new navigation property to dailyPrintUsage for print
