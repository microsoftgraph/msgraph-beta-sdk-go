...
func NewGetAzureADUserFeatureUsageRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetAzureADUserFeatureUsageRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/reports/microsoft.graph.getAzureADUserFeatureUsage()";
...
func (m *GetAzureADUserFeatureUsageRequestBuilder) Get(ctx context.Context, requestConfiguration *GetAzureADUserFeatureUsageRequestBuilderGetRequestConfiguration)(GetAzureADUserFeatureUsageResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGetAzureADUserFeatureUsageResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
