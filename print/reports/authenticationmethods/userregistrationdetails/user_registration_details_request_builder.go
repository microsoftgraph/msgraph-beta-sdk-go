...
// UserRegistrationDetailsRequestBuilderGetOptions options for Get
type UserRegistrationDetailsRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
    // Request query parameters
    Q *UserRegistrationDetailsRequestBuilderGetQueryParameters;
...
// UserRegistrationDetailsRequestBuilderPostOptions options for Post
type UserRegistrationDetailsRequestBuilderPostOptions struct {
    // 
...
func NewUserRegistrationDetailsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UserRegistrationDetailsRequestBuilder) {
    m := &UserRegistrationDetailsRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/print/reports/authenticationMethods/userRegistrationDetails{?top,skip,search,filter,count,orderby,select,expand}";
...
func NewUserRegistrationDetailsRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UserRegistrationDetailsRequestBuilder) {
...
func (m *UserRegistrationDetailsRequestBuilder) Get(options *UserRegistrationDetailsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserRegistrationDetailsCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateUserRegistrationDetailsCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserRegistrationDetailsCollectionResponseable), nil
}
// Post create new navigation property to userRegistrationDetails for print
func (m *UserRegistrationDetailsRequestBuilder) Post(options *UserRegistrationDetailsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserRegistrationDetailsable, error) {
