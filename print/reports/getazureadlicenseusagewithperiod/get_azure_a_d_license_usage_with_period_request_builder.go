...
func NewGetAzureADLicenseUsageWithPeriodRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, period *string)(*GetAzureADLicenseUsageWithPeriodRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/reports/microsoft.graph.getAzureADLicenseUsage(period='{period}')";
...
func (m *GetAzureADLicenseUsageWithPeriodRequestBuilder) Get(ctx context.Context, requestConfiguration *GetAzureADLicenseUsageWithPeriodRequestBuilderGetRequestConfiguration)(GetAzureADLicenseUsageWithPeriodResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGetAzureADLicenseUsageWithPeriodResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
