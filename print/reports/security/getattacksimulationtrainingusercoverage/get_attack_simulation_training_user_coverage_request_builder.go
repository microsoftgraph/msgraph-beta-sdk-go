...
func NewGetAttackSimulationTrainingUserCoverageRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GetAttackSimulationTrainingUserCoverageRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/reports/security/microsoft.graph.getAttackSimulationTrainingUserCoverage()";
...
func (m *GetAttackSimulationTrainingUserCoverageRequestBuilder) GetWithRequestConfigurationAndResponseHandler(requestConfiguration *GetAttackSimulationTrainingUserCoverageRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(GetAttackSimulationTrainingUserCoverageResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetAttackSimulationTrainingUserCoverageResponseFromDiscriminatorValue, responseHandler, errorMapping)
    if err != nil {
        return nil, err
    }
