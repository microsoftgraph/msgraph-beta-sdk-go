...
// GetAttackSimulationTrainingUserCoverageResponse provides operations to call the getAttackSimulationTrainingUserCoverage method.
...
func (m *GetAttackSimulationTrainingUserCoverageResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *GetAttackSimulationTrainingUserCoverageResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["value"] = i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.SetCollectionOfObjectValues(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateAttackSimulationTrainingUserCoverageFromDiscriminatorValue , m.SetValue)
    return res
}
...
func (m *GetAttackSimulationTrainingUserCoverageResponse) SetAdditionalData(value map[string]interface{})() {
