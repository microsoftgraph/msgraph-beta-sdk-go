...
// RefRequestBuilder builds and executes requests for operations under \print\printerShares\{printerShare-id}\printer\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/printerShares/{printerShare_id}/printer/$ref";
...
// CreateDeleteRequestInformation the printer that this printer share is related to.
...
// CreatePutRequestInformation the printer that this printer share is related to.
...
// Delete the printer that this printer share is related to.
...
// Put the printer that this printer share is related to.
