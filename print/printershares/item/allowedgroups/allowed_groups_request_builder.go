...
// Builds and executes requests for operations under \print\printerShares\{printerShare-id}\allowedGroups
...
func NewAllowedGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AllowedGroupsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/print/printerShares/{printerShare_id}/allowedGroups{?top,skip,search,filter,count,orderby,select,expand}";
