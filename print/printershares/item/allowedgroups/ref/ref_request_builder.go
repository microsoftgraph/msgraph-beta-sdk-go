...
// RefRequestBuilder provides operations to manage the collection of print entities.
...
// RefRequestBuilderGetQueryParameters the groups whose users have access to print using the printer.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedGroups/$ref{?%24top,%24skip,%24search,%24filter,%24count,%24orderby}";
...
// CreatePostRequestInformation create new navigation property ref to allowedGroups for print
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property ref to allowedGroups for print
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property ref to allowedGroups for print
