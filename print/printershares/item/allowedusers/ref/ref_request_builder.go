...
// RefRequestBuilderGetQueryParameters the users who have access to print using the printer.
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property ref to allowedUsers for print
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property ref to allowedUsers for print
