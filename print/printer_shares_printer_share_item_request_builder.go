...
func (m *PrinterSharesPrinterShareItemRequestBuilder) AllowedGroupsById(id string)(*PrinterSharesItemAllowedGroupsGroupItemRequestBuilder) {
    ...
    idPtr := &id
    return NewPrinterSharesItemAllowedGroupsGroupItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *PrinterSharesPrinterShareItemRequestBuilder) AllowedUsersById(id string)(*PrinterSharesItemAllowedUsersUserItemRequestBuilder) {
    ...
    idPtr := &id
    return NewPrinterSharesItemAllowedUsersUserItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewPrinterSharesPrinterShareItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, printerShareId *string)(*PrinterSharesPrinterShareItemRequestBuilder) {
...
func NewPrinterSharesPrinterShareItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrinterSharesPrinterShareItemRequestBuilder) {
    ...
    return NewPrinterSharesPrinterShareItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
