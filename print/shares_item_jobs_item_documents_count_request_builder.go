...
func (m *SharesItemJobsItemDocumentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemJobsItemDocumentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
