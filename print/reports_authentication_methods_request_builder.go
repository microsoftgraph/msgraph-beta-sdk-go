...
func (m *ReportsAuthenticationMethodsRequestBuilder) Delete(ctx context.Context, requestConfiguration *ReportsAuthenticationMethodsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
