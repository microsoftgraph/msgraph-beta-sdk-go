...
func (m *ReportsAuthenticationMethodsRequestBuilder) MicrosoftGraphUsersRegisteredByFeature()(*ReportsAuthenticationMethodsMicrosoftGraphUsersRegisteredByFeatureRequestBuilder) {
    return NewReportsAuthenticationMethodsMicrosoftGraphUsersRegisteredByFeatureRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ReportsAuthenticationMethodsRequestBuilder) MicrosoftGraphUsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRoles(includedUserRoles *string, includedUserTypes *string)(*ReportsAuthenticationMethodsMicrosoftGraphUsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRolesRequestBuilder) {
    return NewReportsAuthenticationMethodsMicrosoftGraphUsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRolesRequestBuilderInternal(m.pathParameters, m.requestAdapter, includedUserRoles, includedUserTypes)
}
// MicrosoftGraphUsersRegisteredByMethod provides operations to call the usersRegisteredByMethod method.
func (m *ReportsAuthenticationMethodsRequestBuilder) MicrosoftGraphUsersRegisteredByMethod()(*ReportsAuthenticationMethodsMicrosoftGraphUsersRegisteredByMethodRequestBuilder) {
    return NewReportsAuthenticationMethodsMicrosoftGraphUsersRegisteredByMethodRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ReportsAuthenticationMethodsRequestBuilder) MicrosoftGraphUsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRoles(includedUserRoles *string, includedUserTypes *string)(*ReportsAuthenticationMethodsMicrosoftGraphUsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilder) {
    return NewReportsAuthenticationMethodsMicrosoftGraphUsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilderInternal(m.pathParameters, m.requestAdapter, includedUserRoles, includedUserTypes)
}
