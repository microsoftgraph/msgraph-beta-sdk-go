...
// NewSharesItemJobsItemTasksItemDefinitionRequestBuilderInternal instantiates a new DefinitionRequestBuilder and sets the default values.
func NewSharesItemJobsItemTasksItemDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemJobsItemTasksItemDefinitionRequestBuilder) {
    m := &SharesItemJobsItemTasksItemDefinitionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}/definition{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewSharesItemJobsItemTasksItemDefinitionRequestBuilder instantiates a new DefinitionRequestBuilder and sets the default values.
...
func (m *SharesItemJobsItemTasksItemDefinitionRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemJobsItemTasksItemDefinitionRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrintTaskDefinitionable, error) {
