...
// ByUserIdString gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.print.shares.item.allowedUsers.item collection
func (m *SharesItemAllowedUsersRequestBuilder) ByUserIdString(userId string)(*SharesItemAllowedUsersUserItemRequestBuilder) {
