...
// ReportsDailyPrintUsageByPrinterCountRequestBuilderGetQueryParameters get the number of the resource
type ReportsDailyPrintUsageByPrinterCountRequestBuilderGetQueryParameters struct {
...
type ReportsDailyPrintUsageByPrinterCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ReportsDailyPrintUsageByPrinterCountRequestBuilderGetQueryParameters
}
...
func NewReportsDailyPrintUsageByPrinterCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ReportsDailyPrintUsageByPrinterCountRequestBuilder) {
    m := &ReportsDailyPrintUsageByPrinterCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/print/reports/dailyPrintUsageByPrinter/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
...
func (m *ReportsDailyPrintUsageByPrinterCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ReportsDailyPrintUsageByPrinterCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
