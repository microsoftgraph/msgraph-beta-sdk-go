...
func (m *PrintersRequestBuilder) Get(ctx context.Context, requestConfiguration *PrintersRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrinterCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreatePrinterCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *PrintersRequestBuilder) MicrosoftGraphCreate()(*PrintersMicrosoftGraphCreateCreateRequestBuilder) {
    return NewPrintersMicrosoftGraphCreateCreateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
