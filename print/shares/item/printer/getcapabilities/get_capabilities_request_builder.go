...
// GetCapabilitiesRequestBuilder builds and executes requests for operations under \print\shares\{printerShare-id}\printer\microsoft.graph.getCapabilities()
...
func NewGetCapabilitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GetCapabilitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/shares/{printerShare_id}/printer/microsoft.graph.getCapabilities()";
...
func (m *GetCapabilitiesRequestBuilder) Get(options *GetCapabilitiesRequestBuilderGetOptions)(*GetCapabilitiesResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGetCapabilitiesResponse() }, nil)
    if err != nil {
        return nil, err
    }
