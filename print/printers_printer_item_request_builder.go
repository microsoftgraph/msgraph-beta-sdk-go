...
func (m *PrintersPrinterItemRequestBuilder) MicrosoftGraphGetCapabilities()(*PrintersItemMicrosoftGraphGetCapabilitiesRequestBuilder) {
    return NewPrintersItemMicrosoftGraphGetCapabilitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphResetDefaults provides operations to call the resetDefaults method.
func (m *PrintersPrinterItemRequestBuilder) MicrosoftGraphResetDefaults()(*PrintersItemMicrosoftGraphResetDefaultsRequestBuilder) {
    return NewPrintersItemMicrosoftGraphResetDefaultsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
