...
func (m *PrintersPrinterItemRequestBuilder) ConnectorsById(id string)(*PrintersItemConnectorsPrintConnectorItemRequestBuilder) {
    ...
    idPtr := &id
    return NewPrintersItemConnectorsPrintConnectorItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
// MicrosoftGraphGetCapabilities provides operations to call the getCapabilities method.
func (m *PrintersPrinterItemRequestBuilder) MicrosoftGraphGetCapabilities()(*PrintersItemMicrosoftGraphGetCapabilitiesGetCapabilitiesRequestBuilder) {
    return NewPrintersItemMicrosoftGraphGetCapabilitiesGetCapabilitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphResetDefaults provides operations to call the resetDefaults method.
func (m *PrintersPrinterItemRequestBuilder) MicrosoftGraphResetDefaults()(*PrintersItemMicrosoftGraphResetDefaultsResetDefaultsRequestBuilder) {
    return NewPrintersItemMicrosoftGraphResetDefaultsResetDefaultsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *PrintersPrinterItemRequestBuilder) SharesById(id string)(*PrintersItemSharesPrinterShareItemRequestBuilder) {
    ...
    idPtr := &id
    return NewPrintersItemSharesPrinterShareItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *PrintersPrinterItemRequestBuilder) TaskTriggersById(id string)(*PrintersItemTaskTriggersPrintTaskTriggerItemRequestBuilder) {
    ...
    idPtr := &id
    return NewPrintersItemTaskTriggersPrintTaskTriggerItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
