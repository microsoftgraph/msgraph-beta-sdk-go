...
// ReportsGetOffice365GroupsActivityStorageWithPeriodResponse 
...
func (m *ReportsGetOffice365GroupsActivityStorageWithPeriodResponse) GetValue()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Office365GroupsActivityStorageable) {
    val, err := m.GetBackingStore().Get("value")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Office365GroupsActivityStorageable)
    }
    return nil
}
...
func (m *ReportsGetOffice365GroupsActivityStorageWithPeriodResponse) SetValue(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Office365GroupsActivityStorageable)() {
    err := m.GetBackingStore().Set("value", value)
    if err != nil {
        panic(err)
    }
}
// ReportsGetOffice365GroupsActivityStorageWithPeriodResponseable 
type ReportsGetOffice365GroupsActivityStorageWithPeriodResponseable interface {
