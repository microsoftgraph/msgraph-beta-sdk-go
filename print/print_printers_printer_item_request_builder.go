...
func (m *PrintPrintersPrinterItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Printerable, requestConfiguration *PrintPrintersPrinterItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *PrintPrintersPrinterItemRequestBuilder) Get(ctx context.Context, requestConfiguration *PrintPrintersPrinterItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Printerable, error) {
...
func (m *PrintPrintersPrinterItemRequestBuilder) GetCapabilities()(*PrintPrintersItemGetCapabilitiesRequestBuilder) {
    return NewPrintPrintersItemGetCapabilitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Patch update the navigation property printers in print
func (m *PrintPrintersPrinterItemRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Printerable, requestConfiguration *PrintPrintersPrinterItemRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Printerable, error) {
...
func (m *PrintPrintersPrinterItemRequestBuilder) ResetDefaults()(*PrintPrintersItemResetDefaultsRequestBuilder) {
    return NewPrintPrintersItemResetDefaultsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *PrintPrintersPrinterItemRequestBuilder) Share()(*PrintPrintersItemShareRequestBuilder) {
    return NewPrintPrintersItemShareRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
