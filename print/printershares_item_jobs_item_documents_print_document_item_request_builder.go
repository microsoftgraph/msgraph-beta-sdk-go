...
func (m *PrintersharesItemJobsItemDocumentsPrintDocumentItemRequestBuilder) CreateUploadSession()(*PrintersharesItemJobsItemDocumentsItemCreateuploadsessionCreateUploadSessionRequestBuilder) {
    return NewPrintersharesItemJobsItemDocumentsItemCreateuploadsessionCreateUploadSessionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
