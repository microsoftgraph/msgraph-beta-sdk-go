...
func (m *SharesItemJobsItemTasksCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemJobsItemTasksCountRequestBuilderGetRequestConfiguration)(*int64, error) {
