...
func (m *SharesItemAllowedUsersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemAllowedUsersCountRequestBuilderGetRequestConfiguration)(*int64, error) {
