...
func (m *PrintersItemJobsItemStartRequestBuilder) Post(ctx context.Context, requestConfiguration *PrintersItemJobsItemStartRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrintJobStatusable, error) {
...
func (m *PrintersItemJobsItemStartRequestBuilder) WithUrl(rawUrl string)(*PrintersItemJobsItemStartRequestBuilder) {
    return NewPrintersItemJobsItemStartRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
