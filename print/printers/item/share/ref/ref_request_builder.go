...
// RefRequestBuilder builds and executes requests for operations under \print\printers\{printer-id}\share\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/print/printers/{printer_id}/share/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property share for print
...
// CreateGetRequestInformation get ref of share from print
...
// CreatePutRequestInformation update the ref of navigation property share in print
...
// Delete delete ref of navigation property share for print
...
// Get get ref of share from print
...
// Put update the ref of navigation property share in print
