...
func (m *PrinterSharesItemAllowedUsersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PrinterSharesItemAllowedUsersCountRequestBuilderGetRequestConfiguration)(*int64, error) {
