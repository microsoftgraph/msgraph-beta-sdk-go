...
// ReportsSecurityRequestBuilderGetQueryParameters provides the ability to launch a realistic simulated phishing attack that organizations can learn from.
...
func (m *ReportsSecurityRequestBuilder) Get(ctx context.Context, requestConfiguration *ReportsSecurityRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SecurityReportsRootable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateSecurityReportsRootFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ReportsSecurityRequestBuilder) MicrosoftGraphGetAttackSimulationRepeatOffenders()(*ReportsSecurityMicrosoftGraphGetAttackSimulationRepeatOffendersGetAttackSimulationRepeatOffendersRequestBuilder) {
    return NewReportsSecurityMicrosoftGraphGetAttackSimulationRepeatOffendersGetAttackSimulationRepeatOffendersRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ReportsSecurityRequestBuilder) MicrosoftGraphGetAttackSimulationSimulationUserCoverage()(*ReportsSecurityMicrosoftGraphGetAttackSimulationSimulationUserCoverageGetAttackSimulationSimulationUserCoverageRequestBuilder) {
    return NewReportsSecurityMicrosoftGraphGetAttackSimulationSimulationUserCoverageGetAttackSimulationSimulationUserCoverageRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ReportsSecurityRequestBuilder) MicrosoftGraphGetAttackSimulationTrainingUserCoverage()(*ReportsSecurityMicrosoftGraphGetAttackSimulationTrainingUserCoverageGetAttackSimulationTrainingUserCoverageRequestBuilder) {
    return NewReportsSecurityMicrosoftGraphGetAttackSimulationTrainingUserCoverageGetAttackSimulationTrainingUserCoverageRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// ToDeleteRequestInformation delete navigation property security for print
func (m *ReportsSecurityRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *ReportsSecurityRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ReportsSecurityRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ReportsSecurityRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
// ToPatchRequestInformation update the navigation property security in print
func (m *ReportsSecurityRequestBuilder) ToPatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SecurityReportsRootable, requestConfiguration *ReportsSecurityRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
