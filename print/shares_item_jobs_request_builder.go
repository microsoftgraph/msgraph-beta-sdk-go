...
// NewSharesItemJobsRequestBuilderInternal instantiates a new JobsRequestBuilder and sets the default values.
...
// NewSharesItemJobsRequestBuilder instantiates a new JobsRequestBuilder and sets the default values.
