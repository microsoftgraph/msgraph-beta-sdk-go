...
// ReportsDailyPrintUsageSummariesByPrinterCountRequestBuilderGetQueryParameters get the number of the resource
type ReportsDailyPrintUsageSummariesByPrinterCountRequestBuilderGetQueryParameters struct {
...
type ReportsDailyPrintUsageSummariesByPrinterCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ReportsDailyPrintUsageSummariesByPrinterCountRequestBuilderGetQueryParameters
}
...
func NewReportsDailyPrintUsageSummariesByPrinterCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ReportsDailyPrintUsageSummariesByPrinterCountRequestBuilder) {
    m := &ReportsDailyPrintUsageSummariesByPrinterCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/print/reports/dailyPrintUsageSummariesByPrinter/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
