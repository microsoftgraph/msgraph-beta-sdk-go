...
// PrintersItemConnectorsRequestBuilderGetQueryParameters retrieve a list of connectors associated with the printer. This API is available in the following national cloud deployments.
...
// Get retrieve a list of connectors associated with the printer. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve a list of connectors associated with the printer. This API is available in the following national cloud deployments.
