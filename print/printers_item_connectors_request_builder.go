...
// PrintersItemConnectorsRequestBuilderGetQueryParameters retrieve a list of connectors associated with the printer.
...
// ToGetRequestInformation retrieve a list of connectors associated with the printer.
