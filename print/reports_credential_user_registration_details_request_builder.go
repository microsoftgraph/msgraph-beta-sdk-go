...
func (m *ReportsCredentialUserRegistrationDetailsRequestBuilder) Count()(*ReportsCredentialUserRegistrationDetailsCountRequestBuilder) {
    return NewReportsCredentialUserRegistrationDetailsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of credentialUserRegistrationDetails objects for a given tenant.
func (m *ReportsCredentialUserRegistrationDetailsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ReportsCredentialUserRegistrationDetailsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ReportsCredentialUserRegistrationDetailsRequestBuilder) Get(ctx context.Context, requestConfiguration *ReportsCredentialUserRegistrationDetailsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CredentialUserRegistrationDetailsCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateCredentialUserRegistrationDetailsCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
