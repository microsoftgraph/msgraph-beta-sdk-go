...
// NewPrintersItemShareRequestBuilderInternal instantiates a new PrintersItemShareRequestBuilder and sets the default values.
func NewPrintersItemShareRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrintersItemShareRequestBuilder) {
    m := &PrintersItemShareRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/share{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewPrintersItemShareRequestBuilder instantiates a new PrintersItemShareRequestBuilder and sets the default values.
