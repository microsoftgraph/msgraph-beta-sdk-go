...
// NewAlertrulesAlertRuleItemRequestBuilderInternal instantiates a new AlertrulesAlertRuleItemRequestBuilder and sets the default values.
func NewAlertrulesAlertRuleItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AlertrulesAlertRuleItemRequestBuilder) {
    m := &AlertrulesAlertRuleItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/monitoring/alertRules/{alertRule%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewAlertrulesAlertRuleItemRequestBuilder instantiates a new AlertrulesAlertRuleItemRequestBuilder and sets the default values.
...
// ToDeleteRequestInformation delete navigation property alertRules for monitoring
// returns a *RequestInformation when successful
func (m *AlertrulesAlertRuleItemRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *AlertrulesAlertRuleItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// ToPatchRequestInformation update the navigation property alertRules in monitoring
// returns a *RequestInformation when successful
...
func (m *AlertrulesAlertRuleItemRequestBuilder) WithUrl(rawUrl string)(*AlertrulesAlertRuleItemRequestBuilder) {
    return NewAlertrulesAlertRuleItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
