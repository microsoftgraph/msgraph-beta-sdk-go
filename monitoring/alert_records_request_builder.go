...
func (m *AlertRecordsRequestBuilder) MicrosoftGraphDeviceManagementGetPortalNotifications()(*AlertRecordsMicrosoftGraphDeviceManagementGetPortalNotificationsGetPortalNotificationsRequestBuilder) {
    return NewAlertRecordsMicrosoftGraphDeviceManagementGetPortalNotificationsGetPortalNotificationsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
