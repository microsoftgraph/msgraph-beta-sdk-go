...
// AlertRulesRequestBuilderGetQueryParameters get a list of the alertRule objects and their properties. This API is available in the following national cloud deployments.
