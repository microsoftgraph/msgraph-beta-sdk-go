...
func (m *AlertRulesAlertRuleItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *AlertRulesAlertRuleItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
