...
func (m *ItemSynchronizationRequestBuilder) MicrosoftGraphAcquireAccessToken()(*ItemSynchronizationMicrosoftGraphAcquireAccessTokenRequestBuilder) {
    return NewItemSynchronizationMicrosoftGraphAcquireAccessTokenRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphPing provides operations to call the Ping method.
func (m *ItemSynchronizationRequestBuilder) MicrosoftGraphPing()(*ItemSynchronizationMicrosoftGraphPingRequestBuilder) {
    return NewItemSynchronizationMicrosoftGraphPingRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
