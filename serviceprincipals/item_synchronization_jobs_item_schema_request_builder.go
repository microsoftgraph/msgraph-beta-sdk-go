...
func (m *ItemSynchronizationJobsItemSchemaRequestBuilder) DirectoriesById(id string)(*ItemSynchronizationJobsItemSchemaDirectoriesDirectoryDefinitionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemSynchronizationJobsItemSchemaDirectoriesDirectoryDefinitionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemSynchronizationJobsItemSchemaRequestBuilder) MicrosoftGraphFilterOperators()(*ItemSynchronizationJobsItemSchemaMicrosoftGraphFilterOperatorsFilterOperatorsRequestBuilder) {
    return NewItemSynchronizationJobsItemSchemaMicrosoftGraphFilterOperatorsFilterOperatorsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphFunctions provides operations to call the functions method.
func (m *ItemSynchronizationJobsItemSchemaRequestBuilder) MicrosoftGraphFunctions()(*ItemSynchronizationJobsItemSchemaMicrosoftGraphFunctionsFunctionsRequestBuilder) {
    return NewItemSynchronizationJobsItemSchemaMicrosoftGraphFunctionsFunctionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphParseExpression provides operations to call the parseExpression method.
func (m *ItemSynchronizationJobsItemSchemaRequestBuilder) MicrosoftGraphParseExpression()(*ItemSynchronizationJobsItemSchemaMicrosoftGraphParseExpressionParseExpressionRequestBuilder) {
    return NewItemSynchronizationJobsItemSchemaMicrosoftGraphParseExpressionParseExpressionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
