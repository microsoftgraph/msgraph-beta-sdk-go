...
// ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsRequestBuilder provides operations to call the filterOperators method.
...
// ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsRequestBuilderGetQueryParameters
}
...
func NewItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/microsoft.graph.filterOperators(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
...
func (m *ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsRequestBuilderGetRequestConfiguration)(ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsFilterOperatorsResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsFilterOperatorsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsFilterOperatorsResponseable), nil
}
// ToGetRequestInformation invoke function filterOperators
func (m *ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
