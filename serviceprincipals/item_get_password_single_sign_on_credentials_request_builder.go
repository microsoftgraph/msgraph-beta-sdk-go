...
// Post get a list of single sign-on credentials using a password for a user or group. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation get a list of single sign-on credentials using a password for a user or group. This API is supported in the following national cloud deployments.
