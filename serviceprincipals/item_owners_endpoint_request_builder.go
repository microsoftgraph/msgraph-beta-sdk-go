...
func NewItemOwnersEndpointRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersEndpointRequestBuilder) {
    m := &ItemOwnersEndpointRequestBuilder{
    }
...
func NewItemOwnersEndpointRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersEndpointRequestBuilder) {
    ...
    return NewItemOwnersEndpointRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ItemOwnersEndpointRequestBuilder) Count()(*ItemOwnersEndpointCountRequestBuilder) {
    return NewItemOwnersEndpointCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemOwnersEndpointRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemOwnersEndpointRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemOwnersEndpointRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnersEndpointRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.EndpointCollectionResponseable, error) {
