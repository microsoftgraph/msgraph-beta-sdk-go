...
func (m *ItemSynchronizationMicrosoftGraphAcquireAccessTokenAcquireAccessTokenPostRequestBody) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCredentials gets the credentials property value. The credentials property
func (m *ItemSynchronizationMicrosoftGraphAcquireAccessTokenAcquireAccessTokenPostRequestBody) GetCredentials()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SynchronizationSecretKeyStringValuePairable) {
...
func (m *ItemSynchronizationMicrosoftGraphAcquireAccessTokenAcquireAccessTokenPostRequestBody) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCredentials sets the credentials property value. The credentials property
func (m *ItemSynchronizationMicrosoftGraphAcquireAccessTokenAcquireAccessTokenPostRequestBody) SetCredentials(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SynchronizationSecretKeyStringValuePairable)() {
    m.credentials = value
}
