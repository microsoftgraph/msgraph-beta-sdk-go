...
// ItemDeletePasswordSingleSignOnCredentialsPostRequestBody provides operations to call the deletePasswordSingleSignOnCredentials method.
...
func (m *ItemDeletePasswordSingleSignOnCredentialsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemDeletePasswordSingleSignOnCredentialsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
