...
func NewItemOwnersMicrosoftGraphUserCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersMicrosoftGraphUserCountRequestBuilder) {
    m := &ItemOwnersMicrosoftGraphUserCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/microsoft.graph.user/$count{?%24search,%24filter}";
...
func NewItemOwnersMicrosoftGraphUserCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersMicrosoftGraphUserCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemOwnersMicrosoftGraphUserCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemOwnersMicrosoftGraphUserCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnersMicrosoftGraphUserCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemOwnersMicrosoftGraphUserCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemOwnersMicrosoftGraphUserCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
