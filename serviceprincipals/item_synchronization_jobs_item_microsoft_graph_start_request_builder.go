...
// ItemSynchronizationJobsItemMicrosoftGraphStartRequestBuilder provides operations to call the start method.
...
// ItemSynchronizationJobsItemMicrosoftGraphStartRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSynchronizationJobsItemMicrosoftGraphStartRequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func (m *ItemSynchronizationJobsItemMicrosoftGraphStartRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemSynchronizationJobsItemMicrosoftGraphStartRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemSynchronizationJobsItemMicrosoftGraphStartRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *ItemSynchronizationJobsItemMicrosoftGraphStartRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
