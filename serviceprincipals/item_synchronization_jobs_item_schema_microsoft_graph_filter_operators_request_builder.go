...
// ItemSynchronizationJobsItemSchemaMicrosoftGraphFilterOperatorsRequestBuilder provides operations to call the filterOperators method.
...
// ItemSynchronizationJobsItemSchemaMicrosoftGraphFilterOperatorsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSynchronizationJobsItemSchemaMicrosoftGraphFilterOperatorsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemSynchronizationJobsItemSchemaMicrosoftGraphFilterOperatorsRequestBuilderGetQueryParameters
}
...
func (m *ItemSynchronizationJobsItemSchemaMicrosoftGraphFilterOperatorsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSynchronizationJobsItemSchemaMicrosoftGraphFilterOperatorsRequestBuilderGetRequestConfiguration)(ItemSynchronizationJobsItemSchemaMicrosoftGraphFilterOperatorsFilterOperatorsResponseable, error) {
...
func (m *ItemSynchronizationJobsItemSchemaMicrosoftGraphFilterOperatorsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSynchronizationJobsItemSchemaMicrosoftGraphFilterOperatorsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
