...
func (m *ServicePrincipalItemRequestBuilder) MicrosoftGraphCreatePasswordSingleSignOnCredentials()(*ItemMicrosoftGraphCreatePasswordSingleSignOnCredentialsRequestBuilder) {
    return NewItemMicrosoftGraphCreatePasswordSingleSignOnCredentialsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ServicePrincipalItemRequestBuilder) MicrosoftGraphDeletePasswordSingleSignOnCredentials()(*ItemMicrosoftGraphDeletePasswordSingleSignOnCredentialsRequestBuilder) {
    return NewItemMicrosoftGraphDeletePasswordSingleSignOnCredentialsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ServicePrincipalItemRequestBuilder) MicrosoftGraphGetPasswordSingleSignOnCredentials()(*ItemMicrosoftGraphGetPasswordSingleSignOnCredentialsRequestBuilder) {
    return NewItemMicrosoftGraphGetPasswordSingleSignOnCredentialsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ServicePrincipalItemRequestBuilder) MicrosoftGraphUpdatePasswordSingleSignOnCredentials()(*ItemMicrosoftGraphUpdatePasswordSingleSignOnCredentialsRequestBuilder) {
    return NewItemMicrosoftGraphUpdatePasswordSingleSignOnCredentialsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
