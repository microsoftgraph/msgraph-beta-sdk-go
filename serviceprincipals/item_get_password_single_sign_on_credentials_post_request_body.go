...
// ItemGetPasswordSingleSignOnCredentialsPostRequestBody provides operations to call the getPasswordSingleSignOnCredentials method.
...
func (m *ItemGetPasswordSingleSignOnCredentialsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemGetPasswordSingleSignOnCredentialsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
