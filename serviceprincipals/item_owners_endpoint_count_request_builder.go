...
// ItemOwnersEndpointCountRequestBuilderGetQueryParameters get the number of the resource
type ItemOwnersEndpointCountRequestBuilderGetQueryParameters struct {
...
type ItemOwnersEndpointCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemOwnersEndpointCountRequestBuilderGetQueryParameters
}
...
func NewItemOwnersEndpointCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersEndpointCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/microsoft.graph.endpoint/$count{?%24search,%24filter}";
