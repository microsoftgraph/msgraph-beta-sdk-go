...
func (m *ItemSynchronizationTemplatesItemSchemaRequestBuilder) DirectoriesById(id string)(*ItemSynchronizationTemplatesItemSchemaDirectoriesDirectoryDefinitionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemSynchronizationTemplatesItemSchemaDirectoriesDirectoryDefinitionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemSynchronizationTemplatesItemSchemaRequestBuilder) MicrosoftGraphFilterOperators()(*ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsFilterOperatorsRequestBuilder) {
    return NewItemSynchronizationTemplatesItemSchemaMicrosoftGraphFilterOperatorsFilterOperatorsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphFunctions provides operations to call the functions method.
func (m *ItemSynchronizationTemplatesItemSchemaRequestBuilder) MicrosoftGraphFunctions()(*ItemSynchronizationTemplatesItemSchemaMicrosoftGraphFunctionsFunctionsRequestBuilder) {
    return NewItemSynchronizationTemplatesItemSchemaMicrosoftGraphFunctionsFunctionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphParseExpression provides operations to call the parseExpression method.
func (m *ItemSynchronizationTemplatesItemSchemaRequestBuilder) MicrosoftGraphParseExpression()(*ItemSynchronizationTemplatesItemSchemaMicrosoftGraphParseExpressionParseExpressionRequestBuilder) {
    return NewItemSynchronizationTemplatesItemSchemaMicrosoftGraphParseExpressionParseExpressionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
