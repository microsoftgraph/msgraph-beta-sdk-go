...
func (m *ItemSynchronizationJobsItemMicrosoftGraphRestartRestartPostRequestBody) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCriteria gets the criteria property value. The criteria property
func (m *ItemSynchronizationJobsItemMicrosoftGraphRestartRestartPostRequestBody) GetCriteria()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SynchronizationJobRestartCriteriaable) {
    return m.criteria
}
...
func (m *ItemSynchronizationJobsItemMicrosoftGraphRestartRestartPostRequestBody) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCriteria sets the criteria property value. The criteria property
func (m *ItemSynchronizationJobsItemMicrosoftGraphRestartRestartPostRequestBody) SetCriteria(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SynchronizationJobRestartCriteriaable)() {
    m.criteria = value
}
