...
// AppManagementPolicyItemRequestBuilder provides operations to manage the appManagementPolicies property of the microsoft.graph.servicePrincipal entity.
...
// AppManagementPolicyItemRequestBuilderGetQueryParameters the appManagementPolicy applied to this service principal.
