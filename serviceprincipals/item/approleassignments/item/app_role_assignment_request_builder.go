...
// AppRoleAssignmentRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\appRoleAssignments\{appRoleAssignment-id}
...
// AppRoleAssignmentRequestBuilderDeleteOptions options for Delete
type AppRoleAssignmentRequestBuilderDeleteOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// AppRoleAssignmentRequestBuilderGetOptions options for Get
type AppRoleAssignmentRequestBuilderGetOptions struct {
    ...
    Q *AppRoleAssignmentRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
// AppRoleAssignmentRequestBuilderGetQueryParameters app role assignment for another app or service, granted to this service principal. Supports $expand.
...
// AppRoleAssignmentRequestBuilderPatchOptions options for Patch
type AppRoleAssignmentRequestBuilderPatchOptions struct {
    // 
...
func NewAppRoleAssignmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AppRoleAssignmentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal_id}/appRoleAssignments/{appRoleAssignment_id}{?select,expand}";
...
// CreateDeleteRequestInformation app role assignment for another app or service, granted to this service principal. Supports $expand.
...
// CreatePatchRequestInformation app role assignment for another app or service, granted to this service principal. Supports $expand.
...
// Delete app role assignment for another app or service, granted to this service principal. Supports $expand.
...
func (m *AppRoleAssignmentRequestBuilder) Get(options *AppRoleAssignmentRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AppRoleAssignment, error) {
...
// Patch app role assignment for another app or service, granted to this service principal. Supports $expand.
