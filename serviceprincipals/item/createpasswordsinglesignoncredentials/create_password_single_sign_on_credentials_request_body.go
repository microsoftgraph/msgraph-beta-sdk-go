...
// NewCreatePasswordSingleSignOnCredentialsRequestBody instantiates a new createPasswordSingleSignOnCredentialsRequestBody and sets the default values.
...
func CreateCreatePasswordSingleSignOnCredentialsRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
...
func (m *CreatePasswordSingleSignOnCredentialsRequestBody) GetCredentials()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Credentialable) {
    if m == nil {
        return nil
    } else {
...
func (m *CreatePasswordSingleSignOnCredentialsRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *CreatePasswordSingleSignOnCredentialsRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *CreatePasswordSingleSignOnCredentialsRequestBody) SetCredentials(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Credentialable)() {
    if m != nil {
        m.credentials = value
    }
}
