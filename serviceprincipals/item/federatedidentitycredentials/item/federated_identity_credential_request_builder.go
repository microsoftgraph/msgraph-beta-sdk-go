...
// FederatedIdentityCredentialRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\federatedIdentityCredentials\{federatedIdentityCredential-id}
...
// FederatedIdentityCredentialRequestBuilderGetQueryParameters get federatedIdentityCredentials from servicePrincipals
