...
// GetWithRequestConfigurationAndResponseHandler get licenseDetails from servicePrincipals
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to licenseDetails for servicePrincipals
