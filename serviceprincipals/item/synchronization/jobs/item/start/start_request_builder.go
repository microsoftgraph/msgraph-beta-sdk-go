...
// Builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\synchronization\jobs\{synchronizationJob-id}\microsoft.graph.start
...
// Parameters:
//  - options : Options for the request
func (m *StartRequestBuilder) Post(options *StartRequestBuilderPostOptions)(error) {
