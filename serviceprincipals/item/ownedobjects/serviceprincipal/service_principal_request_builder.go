...
import (
    ...
    i45a35b074e18d6084627181ccacdaaf4fa6fada0d63971ef1f2d78219cdadd3e "github.com/microsoftgraph/msgraph-beta-sdk-go/serviceprincipals/item/ownedobjects/serviceprincipal/count"
)
...
func NewServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ServicePrincipalRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ServicePrincipalRequestBuilder) Count()(*i45a35b074e18d6084627181ccacdaaf4fa6fada0d63971ef1f2d78219cdadd3e.CountRequestBuilder) {
    return i45a35b074e18d6084627181ccacdaaf4fa6fada0d63971ef1f2d78219cdadd3e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
