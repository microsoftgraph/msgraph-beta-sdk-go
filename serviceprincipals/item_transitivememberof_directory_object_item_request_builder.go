...
func NewItemTransitivememberofDirectoryObjectItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTransitivememberofDirectoryObjectItemRequestBuilder) {
    m := &ItemTransitivememberofDirectoryObjectItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
// returns a *ItemTransitivememberofItemGraphdirectoryroleGraphDirectoryRoleRequestBuilder when successful
func (m *ItemTransitivememberofDirectoryObjectItemRequestBuilder) GraphDirectoryRole()(*ItemTransitivememberofItemGraphdirectoryroleGraphDirectoryRoleRequestBuilder) {
    return NewItemTransitivememberofItemGraphdirectoryroleGraphDirectoryRoleRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
