...
func (m *ItemOwnedObjectsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedObjectsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
