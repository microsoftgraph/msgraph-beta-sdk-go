...
// AdministrativeUnitsItemMembersDeviceCountRequestBuilderGetQueryParameters get the number of the resource
type AdministrativeUnitsItemMembersDeviceCountRequestBuilderGetQueryParameters struct {
...
type AdministrativeUnitsItemMembersDeviceCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *AdministrativeUnitsItemMembersDeviceCountRequestBuilderGetQueryParameters
}
...
func NewAdministrativeUnitsItemMembersDeviceCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersDeviceCountRequestBuilder) {
    m := &AdministrativeUnitsItemMembersDeviceCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.device/$count{?%24search,%24filter}";
...
func NewAdministrativeUnitsItemMembersDeviceCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersDeviceCountRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersDeviceCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *AdministrativeUnitsItemMembersDeviceCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersDeviceCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *AdministrativeUnitsItemMembersDeviceCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersDeviceCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
