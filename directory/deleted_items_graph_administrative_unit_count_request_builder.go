...
// NewDeletedItemsGraphAdministrativeUnitCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewDeletedItemsGraphAdministrativeUnitCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsGraphAdministrativeUnitCountRequestBuilder) {
    m := &DeletedItemsGraphAdministrativeUnitCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/directory/deletedItems/graph.administrativeUnit/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewDeletedItemsGraphAdministrativeUnitCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
