...
func NewAdministrativeUnitsItemMembersMicrosoftGraphApplicationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphApplicationRequestBuilder) {
    m := &AdministrativeUnitsItemMembersMicrosoftGraphApplicationRequestBuilder{
    }
...
func NewAdministrativeUnitsItemMembersMicrosoftGraphApplicationRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphApplicationRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersMicrosoftGraphApplicationRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *AdministrativeUnitsItemMembersMicrosoftGraphApplicationRequestBuilder) Count()(*AdministrativeUnitsItemMembersMicrosoftGraphApplicationCountRequestBuilder) {
...
func (m *AdministrativeUnitsItemMembersMicrosoftGraphApplicationRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphApplicationRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ApplicationCollectionResponseable, error) {
...
func (m *AdministrativeUnitsItemMembersMicrosoftGraphApplicationRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphApplicationRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
