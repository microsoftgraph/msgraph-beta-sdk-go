...
// RecommendationsItemImpactedResourcesRequestBuilder provides operations to manage the impactedResources property of the microsoft.graph.recommendation entity.
...
// RecommendationsItemImpactedResourcesRequestBuilderGetQueryParameters get impactedResources from directory
...
// NewRecommendationsItemImpactedResourcesRequestBuilderInternal instantiates a new ImpactedResourcesRequestBuilder and sets the default values.
func NewRecommendationsItemImpactedResourcesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RecommendationsItemImpactedResourcesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/directory/recommendations/{recommendation%2Did}/impactedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewRecommendationsItemImpactedResourcesRequestBuilder instantiates a new ImpactedResourcesRequestBuilder and sets the default values.
...
func (m *RecommendationsItemImpactedResourcesRequestBuilder) Count()(*RecommendationsItemImpactedResourcesCountRequestBuilder) {
    return NewRecommendationsItemImpactedResourcesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get impactedResources from directory
func (m *RecommendationsItemImpactedResourcesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *RecommendationsItemImpactedResourcesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RecommendationsItemImpactedResourcesRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RecommendationResourceable, requestConfiguration *RecommendationsItemImpactedResourcesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *RecommendationsItemImpactedResourcesRequestBuilder) Get(ctx context.Context, requestConfiguration *RecommendationsItemImpactedResourcesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RecommendationResourceCollectionResponseable, error) {
