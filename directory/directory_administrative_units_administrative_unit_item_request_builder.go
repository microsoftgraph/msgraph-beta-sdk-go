...
func (m *DirectoryAdministrativeUnitsAdministrativeUnitItemRequestBuilder) CheckMemberGroups()(*DirectoryAdministrativeUnitsItemCheckMemberGroupsRequestBuilder) {
    return NewDirectoryAdministrativeUnitsItemCheckMemberGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CheckMemberObjects provides operations to call the checkMemberObjects method.
func (m *DirectoryAdministrativeUnitsAdministrativeUnitItemRequestBuilder) CheckMemberObjects()(*DirectoryAdministrativeUnitsItemCheckMemberObjectsRequestBuilder) {
    return NewDirectoryAdministrativeUnitsItemCheckMemberObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DirectoryAdministrativeUnitsAdministrativeUnitItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AdministrativeUnitable, requestConfiguration *DirectoryAdministrativeUnitsAdministrativeUnitItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *DirectoryAdministrativeUnitsAdministrativeUnitItemRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryAdministrativeUnitsAdministrativeUnitItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AdministrativeUnitable, error) {
...
func (m *DirectoryAdministrativeUnitsAdministrativeUnitItemRequestBuilder) GetMemberGroups()(*DirectoryAdministrativeUnitsItemGetMemberGroupsRequestBuilder) {
    return NewDirectoryAdministrativeUnitsItemGetMemberGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// GetMemberObjects provides operations to call the getMemberObjects method.
func (m *DirectoryAdministrativeUnitsAdministrativeUnitItemRequestBuilder) GetMemberObjects()(*DirectoryAdministrativeUnitsItemGetMemberObjectsRequestBuilder) {
    return NewDirectoryAdministrativeUnitsItemGetMemberObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DirectoryAdministrativeUnitsAdministrativeUnitItemRequestBuilder) Restore()(*DirectoryAdministrativeUnitsItemRestoreRequestBuilder) {
    return NewDirectoryAdministrativeUnitsItemRestoreRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
