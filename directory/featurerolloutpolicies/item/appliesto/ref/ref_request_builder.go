...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property ref to appliesTo for directory
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property ref to appliesTo for directory
