...
// DeleteWithResponseHandler delete navigation property appliesTo for directory
...
// PatchWithResponseHandler update the navigation property appliesTo in directory
