...
func NewDirectoryObjectItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryObjectItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy%2Did}/appliesTo/{directoryObject%2Did}{?%24select,%24expand}";
...
// CreateDeleteRequestInformation delete navigation property appliesTo for directory
...
// CreateDeleteRequestInformationWithRequestConfiguration delete navigation property appliesTo for directory
...
// CreatePatchRequestInformation update the navigation property appliesTo in directory
...
// CreatePatchRequestInformationWithRequestConfiguration update the navigation property appliesTo in directory
...
// Delete delete navigation property appliesTo for directory
func (m *DirectoryObjectItemRequestBuilder) Delete()(error) {
    return m.DeleteWithRequestConfigurationAndResponseHandler(nil, nil);
}
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property appliesTo for directory
...
// Patch update the navigation property appliesTo in directory
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property appliesTo in directory
