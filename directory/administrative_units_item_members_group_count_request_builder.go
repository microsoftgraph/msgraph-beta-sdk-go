...
// AdministrativeUnitsItemMembersGroupCountRequestBuilderGetQueryParameters get the number of the resource
type AdministrativeUnitsItemMembersGroupCountRequestBuilderGetQueryParameters struct {
...
type AdministrativeUnitsItemMembersGroupCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *AdministrativeUnitsItemMembersGroupCountRequestBuilderGetQueryParameters
}
...
func NewAdministrativeUnitsItemMembersGroupCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersGroupCountRequestBuilder) {
    m := &AdministrativeUnitsItemMembersGroupCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.group/$count{?%24search,%24filter}";
...
func NewAdministrativeUnitsItemMembersGroupCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersGroupCountRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersGroupCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *AdministrativeUnitsItemMembersGroupCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersGroupCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *AdministrativeUnitsItemMembersGroupCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersGroupCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
