...
func (m *DeletedItemsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedItemsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
