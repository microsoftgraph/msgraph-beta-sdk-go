...
// NewRecommendationsItemImpactedResourcesItemDismissRequestBuilderInternal instantiates a new DismissRequestBuilder and sets the default values.
...
// NewRecommendationsItemImpactedResourcesItemDismissRequestBuilder instantiates a new DismissRequestBuilder and sets the default values.
...
// Post dismiss an impactedResources object and update its status to dismissed. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation dismiss an impactedResources object and update its status to dismissed. This API is available in the following national cloud deployments.
