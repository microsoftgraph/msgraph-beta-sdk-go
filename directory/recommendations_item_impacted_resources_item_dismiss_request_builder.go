...
// Post dismiss an impactedResources object and update its status to dismissed. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation dismiss an impactedResources object and update its status to dismissed. This API is supported in the following national cloud deployments.
