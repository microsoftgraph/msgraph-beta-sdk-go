...
// NewRecommendationsItemCompleteRequestBuilderInternal instantiates a new RecommendationsItemCompleteRequestBuilder and sets the default values.
...
// NewRecommendationsItemCompleteRequestBuilder instantiates a new RecommendationsItemCompleteRequestBuilder and sets the default values.
...
// ToPostRequestInformation complete a recommendation object and update its status to completedByUser.
