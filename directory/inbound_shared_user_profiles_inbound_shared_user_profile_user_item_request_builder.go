...
func (m *InboundSharedUserProfilesInboundSharedUserProfileUserItemRequestBuilder) MicrosoftGraphExportPersonalData()(*InboundSharedUserProfilesItemMicrosoftGraphExportPersonalDataRequestBuilder) {
    return NewInboundSharedUserProfilesItemMicrosoftGraphExportPersonalDataRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRemovePersonalData provides operations to call the removePersonalData method.
func (m *InboundSharedUserProfilesInboundSharedUserProfileUserItemRequestBuilder) MicrosoftGraphRemovePersonalData()(*InboundSharedUserProfilesItemMicrosoftGraphRemovePersonalDataRequestBuilder) {
    return NewInboundSharedUserProfilesItemMicrosoftGraphRemovePersonalDataRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
