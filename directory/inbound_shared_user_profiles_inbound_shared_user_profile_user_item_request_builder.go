...
// InboundSharedUserProfilesInboundSharedUserProfileUserItemRequestBuilderGetQueryParameters a collection of external Azure AD users whose profile data has been shared with the Azure AD tenant. Nullable.
...
func (m *InboundSharedUserProfilesInboundSharedUserProfileUserItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *InboundSharedUserProfilesInboundSharedUserProfileUserItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
