...
func (m *SharedEmailDomainsSharedEmailDomainItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *SharedEmailDomainsSharedEmailDomainItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
