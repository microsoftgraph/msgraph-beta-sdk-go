...
func (m *OnPremisesSynchronizationCountRequestBuilder) Get(ctx context.Context, requestConfiguration *OnPremisesSynchronizationCountRequestBuilderGetRequestConfiguration)(*int64, error) {
