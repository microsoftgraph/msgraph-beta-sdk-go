...
// NewSharedEmailDomainsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewSharedEmailDomainsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharedEmailDomainsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/directory/sharedEmailDomains/$count";
...
// NewSharedEmailDomainsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
...
func (m *SharedEmailDomainsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SharedEmailDomainsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
