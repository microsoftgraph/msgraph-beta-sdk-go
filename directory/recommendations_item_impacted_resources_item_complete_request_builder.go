...
func NewRecommendationsItemImpactedResourcesItemCompleteRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RecommendationsItemImpactedResourcesItemCompleteRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/directory/recommendations/{recommendation%2Did}/impactedResources/{recommendationResource%2Did}/microsoft.graph.complete";
...
func (m *RecommendationsItemImpactedResourcesItemCompleteRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *RecommendationsItemImpactedResourcesItemCompleteRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RecommendationsItemImpactedResourcesItemCompleteRequestBuilder) Post(ctx context.Context, requestConfiguration *RecommendationsItemImpactedResourcesItemCompleteRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RecommendationResourceable, error) {
