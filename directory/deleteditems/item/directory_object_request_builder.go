...
// DirectoryObjectRequestBuilder builds and executes requests for operations under \directory\deletedItems\{directoryObject-id}
...
// DirectoryObjectRequestBuilderGetQueryParameters recently deleted items. Read-only. Nullable.
...
func NewDirectoryObjectRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DirectoryObjectRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/directory/deletedItems/{directoryObject_id}{?select,expand}";
...
// CreateDeleteRequestInformation recently deleted items. Read-only. Nullable.
...
// CreatePatchRequestInformation recently deleted items. Read-only. Nullable.
...
// Delete recently deleted items. Read-only. Nullable.
...
// Patch recently deleted items. Read-only. Nullable.
