...
func NewDeletedItemsMicrosoftGraphApplicationCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsMicrosoftGraphApplicationCountRequestBuilder) {
    m := &DeletedItemsMicrosoftGraphApplicationCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/directory/deletedItems/microsoft.graph.application/$count{?%24search,%24filter}";
...
func NewDeletedItemsMicrosoftGraphApplicationCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsMicrosoftGraphApplicationCountRequestBuilder) {
    ...
    return NewDeletedItemsMicrosoftGraphApplicationCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *DeletedItemsMicrosoftGraphApplicationCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedItemsMicrosoftGraphApplicationCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *DeletedItemsMicrosoftGraphApplicationCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DeletedItemsMicrosoftGraphApplicationCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
