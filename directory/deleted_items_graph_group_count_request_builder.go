...
func (m *DeletedItemsGraphGroupCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedItemsGraphGroupCountRequestBuilderGetRequestConfiguration)(*int64, error) {
