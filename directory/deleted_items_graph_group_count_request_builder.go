...
// NewDeletedItemsGraphGroupCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewDeletedItemsGraphGroupCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsGraphGroupCountRequestBuilder) {
    m := &DeletedItemsGraphGroupCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/directory/deletedItems/graph.group/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewDeletedItemsGraphGroupCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
func NewDeletedItemsGraphGroupCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsGraphGroupCountRequestBuilder) {
    ...
    return NewDeletedItemsGraphGroupCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DeletedItemsGraphGroupCountRequestBuilder) WithUrl(rawUrl string)(*DeletedItemsGraphGroupCountRequestBuilder) {
    return NewDeletedItemsGraphGroupCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
