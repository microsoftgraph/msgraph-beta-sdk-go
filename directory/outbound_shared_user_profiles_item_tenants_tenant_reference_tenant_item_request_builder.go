...
func (m *OutboundSharedUserProfilesItemTenantsTenantReferenceTenantItemRequestBuilder) Get(ctx context.Context, requestConfiguration *OutboundSharedUserProfilesItemTenantsTenantReferenceTenantItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TenantReferenceable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateTenantReferenceFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *OutboundSharedUserProfilesItemTenantsTenantReferenceTenantItemRequestBuilder) MicrosoftGraphRemovePersonalData()(*OutboundSharedUserProfilesItemTenantsItemMicrosoftGraphRemovePersonalDataRequestBuilder) {
    return NewOutboundSharedUserProfilesItemTenantsItemMicrosoftGraphRemovePersonalDataRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
