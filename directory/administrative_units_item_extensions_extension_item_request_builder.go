...
func NewAdministrativeUnitsItemExtensionsExtensionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemExtensionsExtensionItemRequestBuilder) {
    m := &AdministrativeUnitsItemExtensionsExtensionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/extensions/{extension%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *AdministrativeUnitsItemExtensionsExtensionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *AdministrativeUnitsItemExtensionsExtensionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
