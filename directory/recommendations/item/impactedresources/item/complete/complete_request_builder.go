...
// CompleteRequestBuilder builds and executes requests for operations under \directory\recommendations\{recommendation-id}\impactedResources\{recommendationResource-id}\microsoft.graph.complete
...
// CompleteResponse union type wrapper for classes recommendationResource
...
func (m *CompleteResponse) GetRecommendationResource()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.RecommendationResource) {
    if m == nil {
        return nil
    } else {
...
func (m *CompleteResponse) SetRecommendationResource(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.RecommendationResource)() {
    if m != nil {
...
func NewCompleteRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CompleteRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/directory/recommendations/{recommendation_id}/impactedResources/{recommendationResource_id}/microsoft.graph.complete";
...
func (m *CompleteRequestBuilder) Post(options *CompleteRequestBuilderPostOptions)(*CompleteResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewCompleteResponse() }, nil)
    if err != nil {
        return nil, err
    }
