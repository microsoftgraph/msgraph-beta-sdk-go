...
// ReactivateRequestBuilder builds and executes requests for operations under \directory\recommendations\{recommendation-id}\impactedResources\{recommendationResource-id}\microsoft.graph.reactivate
...
func (m *ReactivateResponse) GetRecommendationResource()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.RecommendationResource) {
    if m == nil {
        return nil
    } else {
...
func (m *ReactivateResponse) SetRecommendationResource(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.RecommendationResource)() {
    if m != nil {
...
func (m *ReactivateRequestBuilder) Post(options *ReactivateRequestBuilderPostOptions)(*ReactivateResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewReactivateResponse() }, nil)
    if err != nil {
        return nil, err
    }
