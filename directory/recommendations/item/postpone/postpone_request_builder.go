...
// PostponeRequestBuilder builds and executes requests for operations under \directory\recommendations\{recommendation-id}\microsoft.graph.postpone
...
func (m *PostponeResponse) GetRecommendation()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Recommendation) {
    if m == nil {
        return nil
    } else {
...
func (m *PostponeResponse) SetRecommendation(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Recommendation)() {
    if m != nil {
...
func NewPostponeRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PostponeRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/directory/recommendations/{recommendation_id}/microsoft.graph.postpone";
...
func (m *PostponeRequestBuilder) Post(options *PostponeRequestBuilderPostOptions)(*PostponeResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewPostponeResponse() }, nil)
    if err != nil {
        return nil, err
    }
