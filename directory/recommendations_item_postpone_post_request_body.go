...
// RecommendationsItemPostponePostRequestBody provides operations to call the postpone method.
...
func (m *RecommendationsItemPostponePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *RecommendationsItemPostponePostRequestBody) SetAdditionalData(value map[string]interface{})() {
