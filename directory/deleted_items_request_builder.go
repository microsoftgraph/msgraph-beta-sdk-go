...
func (m *DeletedItemsRequestBuilder) GetUserOwnedObjects()(*DeletedItemsGetUserOwnedObjectsRequestBuilder) {
    return NewDeletedItemsGetUserOwnedObjectsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
