...
func (m *DeletedItemsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*DeletedItemsMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilder) {
    return NewDeletedItemsMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
