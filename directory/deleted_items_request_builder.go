...
func (m *DeletedItemsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*DeletedItemsMicrosoftGraphGetUserOwnedObjectsRequestBuilder) {
    return NewDeletedItemsMicrosoftGraphGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
