...
// AvailableProviderTypesRequestBuilder builds and executes requests for operations under \directory\federationConfigurations\microsoft.graph.availableProviderTypes()
