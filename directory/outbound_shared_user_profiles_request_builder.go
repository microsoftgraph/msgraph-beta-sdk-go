...
// OutboundSharedUserProfilesRequestBuilderGetQueryParameters retrieve the properties of all outboundSharedUserProfiles. This API is available in the following national cloud deployments.
...
func (m *OutboundSharedUserProfilesRequestBuilder) ByOutboundSharedUserProfileUserId(outboundSharedUserProfileUserId string)(*OutboundSharedUserProfilesOutboundSharedUserProfileUserItemRequestBuilder) {
...
func NewOutboundSharedUserProfilesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OutboundSharedUserProfilesRequestBuilder) {
    m := &OutboundSharedUserProfilesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/directory/outboundSharedUserProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get retrieve the properties of all outboundSharedUserProfiles. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve the properties of all outboundSharedUserProfiles. This API is available in the following national cloud deployments.
...
func (m *OutboundSharedUserProfilesRequestBuilder) WithUrl(rawUrl string)(*OutboundSharedUserProfilesRequestBuilder) {
    return NewOutboundSharedUserProfilesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
