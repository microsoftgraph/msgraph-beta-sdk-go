...
func (m *AdministrativeUnitsRequestBuilder) MicrosoftGraphGetByIds()(*AdministrativeUnitsMicrosoftGraphGetByIdsGetByIdsRequestBuilder) {
    return NewAdministrativeUnitsMicrosoftGraphGetByIdsGetByIdsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetUserOwnedObjects provides operations to call the getUserOwnedObjects method.
func (m *AdministrativeUnitsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*AdministrativeUnitsMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilder) {
    return NewAdministrativeUnitsMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphValidateProperties provides operations to call the validateProperties method.
func (m *AdministrativeUnitsRequestBuilder) MicrosoftGraphValidateProperties()(*AdministrativeUnitsMicrosoftGraphValidatePropertiesValidatePropertiesRequestBuilder) {
    return NewAdministrativeUnitsMicrosoftGraphValidatePropertiesValidatePropertiesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
