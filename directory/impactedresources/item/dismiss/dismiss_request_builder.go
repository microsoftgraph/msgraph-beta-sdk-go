...
// DismissRequestBuilder builds and executes requests for operations under \directory\impactedResources\{recommendationResource-id}\microsoft.graph.dismiss
...
func (m *DismissResponse) GetRecommendationResource()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.RecommendationResource) {
    if m == nil {
        return nil
    } else {
...
func (m *DismissResponse) SetRecommendationResource(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.RecommendationResource)() {
    if m != nil {
