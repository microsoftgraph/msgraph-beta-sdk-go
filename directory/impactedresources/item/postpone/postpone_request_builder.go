...
// PostponeRequestBuilder builds and executes requests for operations under \directory\impactedResources\{recommendationResource-id}\microsoft.graph.postpone
