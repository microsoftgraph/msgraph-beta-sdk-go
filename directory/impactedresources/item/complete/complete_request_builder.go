...
// CompleteRequestBuilder builds and executes requests for operations under \directory\impactedResources\{recommendationResource-id}\microsoft.graph.complete
...
func NewCompleteRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CompleteRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/directory/impactedResources/{recommendationResource_id}/microsoft.graph.complete";
