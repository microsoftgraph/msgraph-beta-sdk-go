...
func (m *PendingExternalUserProfilesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PendingExternalUserProfilesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
