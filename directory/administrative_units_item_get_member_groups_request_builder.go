...
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/directoryobject-getmembergroups?view=graph-rest-1.0
func (m *AdministrativeUnitsItemGetMemberGroupsRequestBuilder) PostAsGetMemberGroupsPostResponse(ctx context.Context, body AdministrativeUnitsItemGetMemberGroupsPostRequestBodyable, requestConfiguration *AdministrativeUnitsItemGetMemberGroupsRequestBuilderPostRequestConfiguration)(AdministrativeUnitsItemGetMemberGroupsPostResponseable, error) {
    requestInfo, err := m.ToPostRequestInformation(ctx, body, requestConfiguration);
    if err != nil {
        return nil, err
    }
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateAdministrativeUnitsItemGetMemberGroupsPostResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(AdministrativeUnitsItemGetMemberGroupsPostResponseable), nil
}
...
func (m *AdministrativeUnitsItemGetMemberGroupsRequestBuilder) WithUrl(rawUrl string)(*AdministrativeUnitsItemGetMemberGroupsRequestBuilder) {
    return NewAdministrativeUnitsItemGetMemberGroupsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
