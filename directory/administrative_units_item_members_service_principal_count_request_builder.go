...
// AdministrativeUnitsItemMembersServicePrincipalCountRequestBuilderGetQueryParameters get the number of the resource
type AdministrativeUnitsItemMembersServicePrincipalCountRequestBuilderGetQueryParameters struct {
...
type AdministrativeUnitsItemMembersServicePrincipalCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *AdministrativeUnitsItemMembersServicePrincipalCountRequestBuilderGetQueryParameters
}
...
func (m *AdministrativeUnitsItemMembersServicePrincipalCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersServicePrincipalCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
