...
func NewDeletedItemsMicrosoftGraphUserCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsMicrosoftGraphUserCountRequestBuilder) {
    m := &DeletedItemsMicrosoftGraphUserCountRequestBuilder{
    }
...
func NewDeletedItemsMicrosoftGraphUserCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsMicrosoftGraphUserCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDeletedItemsMicrosoftGraphUserCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *DeletedItemsMicrosoftGraphUserCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedItemsMicrosoftGraphUserCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *DeletedItemsMicrosoftGraphUserCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DeletedItemsMicrosoftGraphUserCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
