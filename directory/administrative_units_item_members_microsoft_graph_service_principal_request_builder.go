...
func NewAdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalRequestBuilder) {
    m := &AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalRequestBuilder{
    }
...
func NewAdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalRequestBuilder) Count()(*AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder) {
    return NewAdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get get the items of type microsoft.graph.servicePrincipal in the microsoft.graph.directoryObject collection
func (m *AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ServicePrincipalCollectionResponseable, error) {
...
func (m *AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
