...
// OutboundSharedUserProfilesItemTenantsRequestBuilderGetQueryParameters the collection of external Azure AD tenants that the user has shared profile data with. Read-only.
