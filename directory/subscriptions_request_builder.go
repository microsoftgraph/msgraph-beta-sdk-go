...
// ByCompanySubscriptionIdString provides operations to manage the subscriptions property of the microsoft.graph.directory entity.
func (m *SubscriptionsRequestBuilder) ByCompanySubscriptionIdString(companySubscriptionId string)(*SubscriptionsCompanySubscriptionItemRequestBuilder) {
