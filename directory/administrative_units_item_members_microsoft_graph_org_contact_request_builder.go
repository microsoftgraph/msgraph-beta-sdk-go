...
func NewAdministrativeUnitsItemMembersMicrosoftGraphOrgContactRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphOrgContactRequestBuilder) {
    m := &AdministrativeUnitsItemMembersMicrosoftGraphOrgContactRequestBuilder{
    }
...
func NewAdministrativeUnitsItemMembersMicrosoftGraphOrgContactRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphOrgContactRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersMicrosoftGraphOrgContactRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *AdministrativeUnitsItemMembersMicrosoftGraphOrgContactRequestBuilder) Count()(*AdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilder) {
    return NewAdministrativeUnitsItemMembersMicrosoftGraphOrgContactCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get get the items of type microsoft.graph.orgContact in the microsoft.graph.directoryObject collection
func (m *AdministrativeUnitsItemMembersMicrosoftGraphOrgContactRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphOrgContactRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OrgContactCollectionResponseable, error) {
...
func (m *AdministrativeUnitsItemMembersMicrosoftGraphOrgContactRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphOrgContactRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
