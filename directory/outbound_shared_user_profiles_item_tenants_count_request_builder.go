...
// NewOutboundSharedUserProfilesItemTenantsCountRequestBuilderInternal instantiates a new OutboundSharedUserProfilesItemTenantsCountRequestBuilder and sets the default values.
func NewOutboundSharedUserProfilesItemTenantsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OutboundSharedUserProfilesItemTenantsCountRequestBuilder) {
    m := &OutboundSharedUserProfilesItemTenantsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/directory/outboundSharedUserProfiles/{outboundSharedUserProfile%2DuserId}/tenants/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewOutboundSharedUserProfilesItemTenantsCountRequestBuilder instantiates a new OutboundSharedUserProfilesItemTenantsCountRequestBuilder and sets the default values.
