...
func (m *OutboundSharedUserProfilesItemTenantsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *OutboundSharedUserProfilesItemTenantsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
