...
func (m *CertificateAuthoritiesCertificateBasedApplicationConfigurationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CertificateAuthoritiesCertificateBasedApplicationConfigurationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
