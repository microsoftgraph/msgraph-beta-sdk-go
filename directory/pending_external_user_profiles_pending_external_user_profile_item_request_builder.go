...
// PendingExternalUserProfilesPendingExternalUserProfileItemRequestBuilderGetQueryParameters collection of pending external user profiles representing collaborators in the directory that are unredeemed.
...
// Delete delete navigation property pendingExternalUserProfiles for directory
...
// Get collection of pending external user profiles representing collaborators in the directory that are unredeemed.
...
// Patch update the navigation property pendingExternalUserProfiles in directory
// returns a PendingExternalUserProfileable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
...
// ToDeleteRequestInformation delete navigation property pendingExternalUserProfiles for directory
...
// ToGetRequestInformation collection of pending external user profiles representing collaborators in the directory that are unredeemed.
// returns a *RequestInformation when successful
...
// ToPatchRequestInformation update the navigation property pendingExternalUserProfiles in directory
// returns a *RequestInformation when successful
