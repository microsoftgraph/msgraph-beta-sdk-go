...
func NewAdministrativeUnitsItemMembersMicrosoftGraphApplicationCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphApplicationCountRequestBuilder) {
    m := &AdministrativeUnitsItemMembersMicrosoftGraphApplicationCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.application/$count{?%24search,%24filter}";
...
func NewAdministrativeUnitsItemMembersMicrosoftGraphApplicationCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphApplicationCountRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersMicrosoftGraphApplicationCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *AdministrativeUnitsItemMembersMicrosoftGraphApplicationCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphApplicationCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *AdministrativeUnitsItemMembersMicrosoftGraphApplicationCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphApplicationCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
