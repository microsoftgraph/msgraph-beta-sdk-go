...
// AttributeSetsRequestBuilder builds and executes requests for operations under \directory\attributeSets
...
func (m *AttributeSetsRequestBuilder) Get(options *AttributeSetsRequestBuilderGetOptions)(*AttributeSetsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewAttributeSetsResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
...
func (m *AttributeSetsRequestBuilder) Post(options *AttributeSetsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AttributeSet, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewAttributeSet() }, nil, nil)
    if err != nil {
        return nil, err
    }
