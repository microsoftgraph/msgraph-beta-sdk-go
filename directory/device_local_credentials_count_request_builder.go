...
func (m *DeviceLocalCredentialsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceLocalCredentialsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
