...
func NewAdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder) {
    m := &AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
...
func NewAdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphServicePrincipalCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
