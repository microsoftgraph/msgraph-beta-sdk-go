...
// InboundSharedUserProfilesItemExportPersonalDataPostRequestBody provides operations to call the exportPersonalData method.
...
func (m *InboundSharedUserProfilesItemExportPersonalDataPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *InboundSharedUserProfilesItemExportPersonalDataPostRequestBody) SetAdditionalData(value map[string]interface{})() {
