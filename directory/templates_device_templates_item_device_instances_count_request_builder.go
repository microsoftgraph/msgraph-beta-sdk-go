...
func (m *TemplatesDeviceTemplatesItemDeviceInstancesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TemplatesDeviceTemplatesItemDeviceInstancesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
