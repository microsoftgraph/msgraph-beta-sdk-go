...
// Post create a request to remove the personal data for an outboundSharedUserProfile. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation create a request to remove the personal data for an outboundSharedUserProfile. This API is available in the following national cloud deployments.
