...
// NewAdministrativeUnitsItemMembersGraphApplicationCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewAdministrativeUnitsItemMembersGraphApplicationCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersGraphApplicationCountRequestBuilder) {
    m := &AdministrativeUnitsItemMembersGraphApplicationCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/graph.application/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewAdministrativeUnitsItemMembersGraphApplicationCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
func NewAdministrativeUnitsItemMembersGraphApplicationCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersGraphApplicationCountRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersGraphApplicationCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *AdministrativeUnitsItemMembersGraphApplicationCountRequestBuilder) WithUrl(rawUrl string)(*AdministrativeUnitsItemMembersGraphApplicationCountRequestBuilder) {
    return NewAdministrativeUnitsItemMembersGraphApplicationCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
