...
// NewDeletedItemsGraphApplicationCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewDeletedItemsGraphApplicationCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsGraphApplicationCountRequestBuilder) {
    m := &DeletedItemsGraphApplicationCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/directory/deletedItems/graph.application/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewDeletedItemsGraphApplicationCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
func NewDeletedItemsGraphApplicationCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsGraphApplicationCountRequestBuilder) {
    ...
    return NewDeletedItemsGraphApplicationCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DeletedItemsGraphApplicationCountRequestBuilder) WithUrl(rawUrl string)(*DeletedItemsGraphApplicationCountRequestBuilder) {
    return NewDeletedItemsGraphApplicationCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
