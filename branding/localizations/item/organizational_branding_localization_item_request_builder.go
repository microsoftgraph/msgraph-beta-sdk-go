...
// DeleteWithResponseHandler delete navigation property localizations for branding
...
// PatchWithResponseHandler update the navigation property localizations in branding
