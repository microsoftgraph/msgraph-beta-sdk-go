...
func (m *LocalizationsItemSquareLogoDarkRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *LocalizationsItemSquareLogoDarkRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *LocalizationsItemSquareLogoDarkRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *LocalizationsItemSquareLogoDarkRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *LocalizationsItemSquareLogoDarkRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *LocalizationsItemSquareLogoDarkRequestBuilderPutRequestConfiguration)(error) {
