...
func NewLocalizationsItemBackgroundImageRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LocalizationsItemBackgroundImageRequestBuilder) {
    m := &LocalizationsItemBackgroundImageRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/branding/localizations/{organizationalBrandingLocalization%2Did}/backgroundImage";
...
func NewLocalizationsItemBackgroundImageRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LocalizationsItemBackgroundImageRequestBuilder) {
    ...
    return NewLocalizationsItemBackgroundImageRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *LocalizationsItemBackgroundImageRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *LocalizationsItemBackgroundImageRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *LocalizationsItemBackgroundImageRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *LocalizationsItemBackgroundImageRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *LocalizationsItemBackgroundImageRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *LocalizationsItemBackgroundImageRequestBuilderPutRequestConfiguration)(error) {
