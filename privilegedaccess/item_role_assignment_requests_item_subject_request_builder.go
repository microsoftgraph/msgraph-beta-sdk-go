...
func (m *ItemRoleAssignmentRequestsItemSubjectRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemRoleAssignmentRequestsItemSubjectRequestBuilderDeleteRequestConfiguration)([]byte, error) {
