...
// returns a *ItemResourcesItemRoledefinitionsItemRolesettingRoleSettingRequestBuilder when successful
func (m *ItemResourcesItemRoledefinitionsGovernanceRoleDefinitionItemRequestBuilder) RoleSetting()(*ItemResourcesItemRoledefinitionsItemRolesettingRoleSettingRequestBuilder) {
    return NewItemResourcesItemRoledefinitionsItemRolesettingRoleSettingRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
