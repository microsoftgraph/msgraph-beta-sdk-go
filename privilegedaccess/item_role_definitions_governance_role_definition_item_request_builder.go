...
func NewItemRoleDefinitionsGovernanceRoleDefinitionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRoleDefinitionsGovernanceRoleDefinitionItemRequestBuilder) {
    m := &ItemRoleDefinitionsGovernanceRoleDefinitionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleDefinitions/{governanceRoleDefinition%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *ItemRoleDefinitionsGovernanceRoleDefinitionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemRoleDefinitionsGovernanceRoleDefinitionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
...
func (m *ItemRoleDefinitionsGovernanceRoleDefinitionItemRequestBuilder) RoleSetting()(*ItemRoleDefinitionsItemRoleSettingRequestBuilder) {
    return NewItemRoleDefinitionsItemRoleSettingRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
