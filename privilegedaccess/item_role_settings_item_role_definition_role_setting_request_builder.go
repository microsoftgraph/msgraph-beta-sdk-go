...
// NewItemRoleSettingsItemRoleDefinitionRoleSettingRequestBuilderInternal instantiates a new RoleSettingRequestBuilder and sets the default values.
func NewItemRoleSettingsItemRoleDefinitionRoleSettingRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRoleSettingsItemRoleDefinitionRoleSettingRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleSettings/{governanceRoleSetting%2Did}/roleDefinition/roleSetting{?%24select,%24expand}";
...
// NewItemRoleSettingsItemRoleDefinitionRoleSettingRequestBuilder instantiates a new RoleSettingRequestBuilder and sets the default values.
...
func (m *ItemRoleSettingsItemRoleDefinitionRoleSettingRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemRoleSettingsItemRoleDefinitionRoleSettingRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
