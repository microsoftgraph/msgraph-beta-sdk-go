...
// NewItemRoleAssignmentsItemRoleDefinitionRoleSettingRequestBuilderInternal instantiates a new ItemRoleAssignmentsItemRoleDefinitionRoleSettingRequestBuilder and sets the default values.
func NewItemRoleAssignmentsItemRoleDefinitionRoleSettingRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRoleAssignmentsItemRoleDefinitionRoleSettingRequestBuilder) {
    m := &ItemRoleAssignmentsItemRoleDefinitionRoleSettingRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments/{governanceRoleAssignment%2Did}/roleDefinition/roleSetting{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemRoleAssignmentsItemRoleDefinitionRoleSettingRequestBuilder instantiates a new ItemRoleAssignmentsItemRoleDefinitionRoleSettingRequestBuilder and sets the default values.
