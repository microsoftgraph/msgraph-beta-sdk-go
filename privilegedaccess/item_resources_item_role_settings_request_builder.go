...
func NewItemResourcesItemRoleSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemResourcesItemRoleSettingsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleSettings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewItemResourcesItemRoleSettingsRequestBuilder instantiates a new RoleSettingsRequestBuilder and sets the default values.
...
func (m *ItemResourcesItemRoleSettingsRequestBuilder) Count()(*ItemResourcesItemRoleSettingsCountRequestBuilder) {
    return NewItemResourcesItemRoleSettingsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the collection of role settings for the resource.
func (m *ItemResourcesItemRoleSettingsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemResourcesItemRoleSettingsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
