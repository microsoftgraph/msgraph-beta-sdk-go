...
// PrivilegedAccessRequestBuilderPostOptions options for Post
type PrivilegedAccessRequestBuilderPostOptions struct {
    // 
...
func NewPrivilegedAccessRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedAccessRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/privilegedAccess{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PrivilegedAccessRequestBuilder) CreateGetRequestInformation(options *PrivilegedAccessRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PrivilegedAccessRequestBuilder) CreatePostRequestInformation(options *PrivilegedAccessRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *PrivilegedAccessRequestBuilder) Get(options *PrivilegedAccessRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrivilegedAccessCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreatePrivilegedAccessCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
...
func (m *PrivilegedAccessRequestBuilder) Post(options *PrivilegedAccessRequestBuilderPostOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrivilegedAccessable, error) {
