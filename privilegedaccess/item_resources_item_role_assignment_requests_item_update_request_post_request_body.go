...
// ItemResourcesItemRoleAssignmentRequestsItemUpdateRequestPostRequestBody provides operations to call the updateRequest method.
...
func (m *ItemResourcesItemRoleAssignmentRequestsItemUpdateRequestPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemResourcesItemRoleAssignmentRequestsItemUpdateRequestPostRequestBody) SetAdditionalData(value map[string]interface{})() {
