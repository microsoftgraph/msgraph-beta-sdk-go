...
// NewItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRequestBuilderInternal instantiates a new RoleDefinitionRequestBuilder and sets the default values.
func NewItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/roleDefinition{?%24select,%24expand}";
...
// NewItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRequestBuilder instantiates a new RoleDefinitionRequestBuilder and sets the default values.
...
func (m *ItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRequestBuilder) Resource()(*ItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionResourceRequestBuilder) {
    return NewItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionResourceRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRequestBuilder) RoleSetting()(*ItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRoleSettingRequestBuilder) {
    return NewItemResourcesItemRoleAssignmentRequestsItemRoleDefinitionRoleSettingRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
