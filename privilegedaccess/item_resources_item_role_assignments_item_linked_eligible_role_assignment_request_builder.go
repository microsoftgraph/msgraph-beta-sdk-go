...
// ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder provides operations to manage the linkedEligibleRoleAssignment property of the microsoft.graph.governanceRoleAssignment entity.
type ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder struct {
...
type ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilderGetQueryParameters
}
// NewItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilderInternal instantiates a new ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder and sets the default values.
func NewItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder) {
    m := &ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder{
...
// NewItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder instantiates a new ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder and sets the default values.
func NewItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilderInternal(urlParams, requestAdapter)
}
...
// returns a *ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder when successful
func (m *ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder) WithUrl(rawUrl string)(*ItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder) {
    return NewItemResourcesItemRoleAssignmentsItemLinkedEligibleRoleAssignmentRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
