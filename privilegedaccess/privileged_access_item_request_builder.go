...
func NewPrivilegedAccessItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, privilegedAccessId *string)(*PrivilegedAccessItemRequestBuilder) {
...
func NewPrivilegedAccessItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedAccessItemRequestBuilder) {
    ...
    return NewPrivilegedAccessItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *PrivilegedAccessItemRequestBuilder) ResourcesById(id string)(*ItemResourcesGovernanceResourceItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemResourcesGovernanceResourceItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
