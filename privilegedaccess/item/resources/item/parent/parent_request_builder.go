...
// ParentRequestBuilder provides operations to manage the parent property of the microsoft.graph.governanceResource entity.
...
// CreateGetRequestInformationWithRequestConfiguration read-only. The parent resource. for pimforazurerbac scenario, it can represent the subscription the resource belongs to.
...
// GetWithResponseHandler read-only. The parent resource. for pimforazurerbac scenario, it can represent the subscription the resource belongs to.
func (m *ParentRequestBuilder) GetWithResponseHandler(requestConfiguration *ParentRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GovernanceResourceable, error) {
