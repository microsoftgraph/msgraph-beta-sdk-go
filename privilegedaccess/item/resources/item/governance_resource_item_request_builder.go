...
// DeleteWithResponseHandler delete navigation property resources for privilegedAccess
...
// PatchWithResponseHandler update the navigation property resources in privilegedAccess
