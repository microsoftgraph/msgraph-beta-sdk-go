...
// DeleteWithResponseHandler delete navigation property roleSettings for privilegedAccess
...
// PatchWithResponseHandler update the navigation property roleSettings in privilegedAccess
