...
import (
    ...
    i7db60865513db7f2e19b141694a8b186aab2c87aa5728b1f3fd7ce90f23acbd4 "github.com/microsoftgraph/msgraph-beta-sdk-go/privilegedaccess/item/resources/item/rolesettings/count"
)
...
func NewRoleSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RoleSettingsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess_id}/resources/{governanceResource_id}/roleSettings{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RoleSettingsRequestBuilder) Count()(*i7db60865513db7f2e19b141694a8b186aab2c87aa5728b1f3fd7ce90f23acbd4.CountRequestBuilder) {
    return i7db60865513db7f2e19b141694a8b186aab2c87aa5728b1f3fd7ce90f23acbd4.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
