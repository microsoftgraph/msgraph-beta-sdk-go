...
// ResourceRequestBuilder provides operations to manage the resource property of the microsoft.graph.governanceRoleAssignmentRequest entity.
...
// ResourceRequestBuilderGetQueryParameters read-only. The resource that the request aims to.
...
// CreateGetRequestInformationWithRequestConfiguration read-only. The resource that the request aims to.
...
// GetWithRequestConfigurationAndResponseHandler read-only. The resource that the request aims to.
