...
import (
    ...
    i2916862aecc89b6548bbc801b8829aef92b9198d36b4576dac024c7781d37d66 "github.com/microsoftgraph/msgraph-beta-sdk-go/privilegedaccess/item/resources/item/roledefinitions/count"
)
...
func NewRoleDefinitionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RoleDefinitionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess_id}/resources/{governanceResource_id}/roleDefinitions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RoleDefinitionsRequestBuilder) Count()(*i2916862aecc89b6548bbc801b8829aef92b9198d36b4576dac024c7781d37d66.CountRequestBuilder) {
    return i2916862aecc89b6548bbc801b8829aef92b9198d36b4576dac024c7781d37d66.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
