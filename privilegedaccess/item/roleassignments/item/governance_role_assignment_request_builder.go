...
// GovernanceRoleAssignmentRequestBuilder builds and executes requests for operations under \privilegedAccess\{privilegedAccess-id}\roleAssignments\{governanceRoleAssignment-id}
...
// GovernanceRoleAssignmentRequestBuilderGetQueryParameters a collection of role assignments for the provider.
...
func NewGovernanceRoleAssignmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GovernanceRoleAssignmentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess_id}/roleAssignments/{governanceRoleAssignment_id}{?select,expand}";
