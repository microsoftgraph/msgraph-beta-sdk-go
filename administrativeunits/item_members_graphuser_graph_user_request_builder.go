...
type ItemMembersGraphuserGraphUserRequestBuilderGetQueryParameters struct {
...
type ItemMembersGraphuserGraphUserRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemMembersGraphuserGraphUserRequestBuilderGetQueryParameters
}
...
func NewItemMembersGraphuserGraphUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersGraphuserGraphUserRequestBuilder) {
    m := &ItemMembersGraphuserGraphUserRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/graph.user{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
...
func NewItemMembersGraphuserGraphUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersGraphuserGraphUserRequestBuilder) {
    ...
    return NewItemMembersGraphuserGraphUserRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemMembersGraphuserGraphUserRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMembersGraphuserGraphUserRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserCollectionResponseable, error) {
...
func (m *ItemMembersGraphuserGraphUserRequestBuilder) WithUrl(rawUrl string)(*ItemMembersGraphuserGraphUserRequestBuilder) {
    return NewItemMembersGraphuserGraphUserRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
