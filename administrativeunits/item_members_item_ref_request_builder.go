...
// ItemMembersItemRefRequestBuilder provides operations to manage the collection of administrativeUnit entities.
...
// ItemMembersItemRefRequestBuilderDeleteQueryParameters delete ref of navigation property members for administrativeUnits
...
func NewItemMembersItemRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersItemRefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/$ref{?%40id*}";
...
// CreateDeleteRequestInformation delete ref of navigation property members for administrativeUnits
func (m *ItemMembersItemRefRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemMembersItemRefRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
