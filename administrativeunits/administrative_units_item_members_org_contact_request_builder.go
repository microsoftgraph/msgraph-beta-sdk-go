...
func NewAdministrativeUnitsItemMembersOrgContactRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersOrgContactRequestBuilder) {
    m := &AdministrativeUnitsItemMembersOrgContactRequestBuilder{
    }
...
func NewAdministrativeUnitsItemMembersOrgContactRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersOrgContactRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersOrgContactRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *AdministrativeUnitsItemMembersOrgContactRequestBuilder) Count()(*AdministrativeUnitsItemMembersOrgContactCountRequestBuilder) {
    return NewAdministrativeUnitsItemMembersOrgContactCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AdministrativeUnitsItemMembersOrgContactRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersOrgContactRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AdministrativeUnitsItemMembersOrgContactRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersOrgContactRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OrgContactCollectionResponseable, error) {
