...
func NewAdministrativeUnitsItemMembersOrgContactCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersOrgContactCountRequestBuilder) {
    m := &AdministrativeUnitsItemMembersOrgContactCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.orgContact/$count";
...
func NewAdministrativeUnitsItemMembersOrgContactCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersOrgContactCountRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersOrgContactCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *AdministrativeUnitsItemMembersOrgContactCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersOrgContactCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AdministrativeUnitsItemMembersOrgContactCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersOrgContactCountRequestBuilderGetRequestConfiguration)(*int32, error) {
