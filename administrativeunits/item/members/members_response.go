...
func (m *MembersResponse) GetValue()([]i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DirectoryObject) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *MembersResponse) SetValue(value []i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DirectoryObject)() {
    if m != nil {
        m.value = value
    }
}
