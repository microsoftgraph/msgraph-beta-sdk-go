...
// Builds and executes requests for operations under \administrativeUnits\{administrativeUnit-id}\scopedRoleMembers\{scopedRoleMembership-id}
...
func NewScopedRoleMembershipRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ScopedRoleMembershipRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/administrativeUnits/{administrativeUnit_id}/scopedRoleMembers/{scopedRoleMembership_id}{?select,expand}";
