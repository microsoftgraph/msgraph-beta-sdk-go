...
// Builds and executes requests for operations under \administrativeUnits\{administrativeUnit-id}\scopedRoleMembers
...
func NewScopedRoleMembersRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ScopedRoleMembersRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/administrativeUnits/{administrativeUnit_id}/scopedRoleMembers{?top,skip,search,filter,count,orderby,select,expand}";
