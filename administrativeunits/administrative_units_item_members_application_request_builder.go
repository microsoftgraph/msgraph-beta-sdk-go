...
func NewAdministrativeUnitsItemMembersApplicationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersApplicationRequestBuilder) {
    m := &AdministrativeUnitsItemMembersApplicationRequestBuilder{
    }
...
func NewAdministrativeUnitsItemMembersApplicationRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersApplicationRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersApplicationRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *AdministrativeUnitsItemMembersApplicationRequestBuilder) Count()(*AdministrativeUnitsItemMembersApplicationCountRequestBuilder) {
    return NewAdministrativeUnitsItemMembersApplicationCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AdministrativeUnitsItemMembersApplicationRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersApplicationRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AdministrativeUnitsItemMembersApplicationRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersApplicationRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ApplicationCollectionResponseable, error) {
