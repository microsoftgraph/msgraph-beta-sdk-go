...
func NewItemMembersMicrosoftGraphUserCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersMicrosoftGraphUserCountRequestBuilder) {
    m := &ItemMembersMicrosoftGraphUserCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.user/$count{?%24search,%24filter}";
...
func NewItemMembersMicrosoftGraphUserCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersMicrosoftGraphUserCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemMembersMicrosoftGraphUserCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemMembersMicrosoftGraphUserCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMembersMicrosoftGraphUserCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemMembersMicrosoftGraphUserCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemMembersMicrosoftGraphUserCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
