...
func NewItemMembersMicrosoftGraphGroupCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersMicrosoftGraphGroupCountRequestBuilder) {
    m := &ItemMembersMicrosoftGraphGroupCountRequestBuilder{
    }
...
func NewItemMembersMicrosoftGraphGroupCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersMicrosoftGraphGroupCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemMembersMicrosoftGraphGroupCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemMembersMicrosoftGraphGroupCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMembersMicrosoftGraphGroupCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemMembersMicrosoftGraphGroupCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemMembersMicrosoftGraphGroupCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
