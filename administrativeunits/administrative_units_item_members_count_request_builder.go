...
func NewAdministrativeUnitsItemMembersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/$count";
...
func (m *AdministrativeUnitsItemMembersCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
