...
// returns a *ItemTermstoreSetsItemTermsItemRelationsItemFromtermFromTermRequestBuilder when successful
func (m *ItemTermstoreSetsItemTermsItemRelationsRelationItemRequestBuilder) FromTerm()(*ItemTermstoreSetsItemTermsItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewItemTermstoreSetsItemTermsItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *ItemTermstoreSetsItemTermsItemRelationsItemTotermToTermRequestBuilder when successful
func (m *ItemTermstoreSetsItemTermsItemRelationsRelationItemRequestBuilder) ToTerm()(*ItemTermstoreSetsItemTermsItemRelationsItemTotermToTermRequestBuilder) {
    return NewItemTermstoreSetsItemTermsItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
