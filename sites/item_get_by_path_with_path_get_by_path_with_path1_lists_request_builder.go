...
// ItemGetByPathWithPathGetByPathWithPath1ListsRequestBuilderGetQueryParameters the collection of lists under this site.
...
// NewItemGetByPathWithPathGetByPathWithPath1ListsRequestBuilderInternal instantiates a new ItemGetByPathWithPathGetByPathWithPath1ListsRequestBuilder and sets the default values.
func NewItemGetByPathWithPathGetByPathWithPath1ListsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGetByPathWithPathGetByPathWithPath1ListsRequestBuilder) {
    m := &ItemGetByPathWithPathGetByPathWithPath1ListsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')/lists{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemGetByPathWithPathGetByPathWithPath1ListsRequestBuilder instantiates a new ItemGetByPathWithPathGetByPathWithPath1ListsRequestBuilder and sets the default values.
...
func (m *ItemGetByPathWithPathGetByPathWithPath1ListsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGetByPathWithPathGetByPathWithPath1ListsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ListCollectionResponseable, error) {
