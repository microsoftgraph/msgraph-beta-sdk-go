...
// NewItemInformationProtectionDataLossPreventionPoliciesEvaluateRequestBuilderInternal instantiates a new ItemInformationProtectionDataLossPreventionPoliciesEvaluateRequestBuilder and sets the default values.
func NewItemInformationProtectionDataLossPreventionPoliciesEvaluateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInformationProtectionDataLossPreventionPoliciesEvaluateRequestBuilder) {
    m := &ItemInformationProtectionDataLossPreventionPoliciesEvaluateRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/dataLossPreventionPolicies/evaluate", pathParameters),
    }
    return m
}
// NewItemInformationProtectionDataLossPreventionPoliciesEvaluateRequestBuilder instantiates a new ItemInformationProtectionDataLossPreventionPoliciesEvaluateRequestBuilder and sets the default values.
