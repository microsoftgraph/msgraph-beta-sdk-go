...
// ItemGetByPathWithPathGetByPathWithPath1DrivesRequestBuilder provides operations to manage the drives property of the microsoft.graph.site entity.
type ItemGetByPathWithPathGetByPathWithPath1DrivesRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemGetByPathWithPathGetByPathWithPath1DrivesRequestBuilderGetQueryParameters the collection of drives (document libraries) under this site.
type ItemGetByPathWithPathGetByPathWithPath1DrivesRequestBuilderGetQueryParameters struct {
...
// ItemGetByPathWithPathGetByPathWithPath1DrivesRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemGetByPathWithPathGetByPathWithPath1DrivesRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
func (m *ItemGetByPathWithPathGetByPathWithPath1DrivesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGetByPathWithPathGetByPathWithPath1DrivesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveCollectionResponseable, error) {
