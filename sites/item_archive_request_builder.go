...
func NewItemArchiveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemArchiveRequestBuilder) {
    m := &ItemArchiveRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/archive", pathParameters),
    }
    return m
}
...
func (m *ItemArchiveRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemArchiveRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemArchiveRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *ItemArchiveRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
