...
// NewItemRecycleBinLastModifiedByUserServiceProvisioningErrorsCountRequestBuilderInternal instantiates a new ItemRecycleBinLastModifiedByUserServiceProvisioningErrorsCountRequestBuilder and sets the default values.
func NewItemRecycleBinLastModifiedByUserServiceProvisioningErrorsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRecycleBinLastModifiedByUserServiceProvisioningErrorsCountRequestBuilder) {
    m := &ItemRecycleBinLastModifiedByUserServiceProvisioningErrorsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/recycleBin/lastModifiedByUser/serviceProvisioningErrors/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemRecycleBinLastModifiedByUserServiceProvisioningErrorsCountRequestBuilder instantiates a new ItemRecycleBinLastModifiedByUserServiceProvisioningErrorsCountRequestBuilder and sets the default values.
