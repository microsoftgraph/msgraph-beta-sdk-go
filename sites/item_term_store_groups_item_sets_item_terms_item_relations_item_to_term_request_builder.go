...
// NewItemTermStoreGroupsItemSetsItemTermsItemRelationsItemToTermRequestBuilderInternal instantiates a new ItemTermStoreGroupsItemSetsItemTermsItemRelationsItemToTermRequestBuilder and sets the default values.
...
// NewItemTermStoreGroupsItemSetsItemTermsItemRelationsItemToTermRequestBuilder instantiates a new ItemTermStoreGroupsItemSetsItemTermsItemRelationsItemToTermRequestBuilder and sets the default values.
...
func (m *ItemTermStoreGroupsItemSetsItemTermsItemRelationsItemToTermRequestBuilder) WithUrl(rawUrl string)(*ItemTermStoreGroupsItemSetsItemTermsItemRelationsItemToTermRequestBuilder) {
    return NewItemTermStoreGroupsItemSetsItemTermsItemRelationsItemToTermRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
