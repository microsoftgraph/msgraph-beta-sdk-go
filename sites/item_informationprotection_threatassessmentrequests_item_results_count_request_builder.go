...
// NewItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilderInternal instantiates a new ItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilder and sets the default values.
func NewItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilder) {
    m := &ItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}/results/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilder instantiates a new ItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilder and sets the default values.
...
func (m *ItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilder) WithUrl(rawUrl string)(*ItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilder) {
    return NewItemInformationprotectionThreatassessmentrequestsItemResultsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
