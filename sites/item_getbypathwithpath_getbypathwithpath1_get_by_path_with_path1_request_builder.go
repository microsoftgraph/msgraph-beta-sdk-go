...
func (m *ItemGetbypathwithpathGetbypathwithpath1GetByPathWithPath1RequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGetbypathwithpathGetbypathwithpath1GetByPathWithPath1RequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Siteable, error) {
...
func (m *ItemGetbypathwithpathGetbypathwithpath1GetByPathWithPath1RequestBuilder) InformationProtection()(*ItemGetbypathwithpathGetbypathwithpath1InformationprotectionInformationProtectionRequestBuilder) {
    return NewItemGetbypathwithpathGetbypathwithpath1InformationprotectionInformationProtectionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemGetbypathwithpathGetbypathwithpath1GetByPathWithPath1RequestBuilder) RecycleBin()(*ItemGetbypathwithpathGetbypathwithpath1RecyclebinRecycleBinRequestBuilder) {
    return NewItemGetbypathwithpathGetbypathwithpath1RecyclebinRecycleBinRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
