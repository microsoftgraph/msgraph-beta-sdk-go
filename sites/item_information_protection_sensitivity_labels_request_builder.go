...
func (m *ItemInformationProtectionSensitivityLabelsRequestBuilder) MicrosoftGraphEvaluate()(*ItemInformationProtectionSensitivityLabelsMicrosoftGraphEvaluateRequestBuilder) {
    return NewItemInformationProtectionSensitivityLabelsMicrosoftGraphEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
