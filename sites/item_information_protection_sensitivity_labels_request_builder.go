...
func (m *ItemInformationProtectionSensitivityLabelsRequestBuilder) MicrosoftGraphEvaluate()(*ItemInformationProtectionSensitivityLabelsMicrosoftGraphEvaluateEvaluateRequestBuilder) {
    return NewItemInformationProtectionSensitivityLabelsMicrosoftGraphEvaluateEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
