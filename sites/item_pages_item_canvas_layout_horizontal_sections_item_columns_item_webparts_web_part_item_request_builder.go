...
func (m *ItemPagesItemCanvasLayoutHorizontalSectionsItemColumnsItemWebpartsWebPartItemRequestBuilder) MicrosoftGraphGetPositionOfWebPart()(*ItemPagesItemCanvasLayoutHorizontalSectionsItemColumnsItemWebpartsItemMicrosoftGraphGetPositionOfWebPartRequestBuilder) {
    return NewItemPagesItemCanvasLayoutHorizontalSectionsItemColumnsItemWebpartsItemMicrosoftGraphGetPositionOfWebPartRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
