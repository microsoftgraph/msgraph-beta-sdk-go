...
func (m *ItemPagesItemCanvasLayoutVerticalSectionWebpartsWebPartItemRequestBuilder) MicrosoftGraphGetPositionOfWebPart()(*ItemPagesItemCanvasLayoutVerticalSectionWebpartsItemMicrosoftGraphGetPositionOfWebPartRequestBuilder) {
    return NewItemPagesItemCanvasLayoutVerticalSectionWebpartsItemMicrosoftGraphGetPositionOfWebPartRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
