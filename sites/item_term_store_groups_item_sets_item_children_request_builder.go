...
// ItemTermStoreGroupsItemSetsItemChildrenRequestBuilderGetQueryParameters get the first level children of a [set] or [term] resource using the children navigation property.
...
// NewItemTermStoreGroupsItemSetsItemChildrenRequestBuilderInternal instantiates a new ChildrenRequestBuilder and sets the default values.
...
// NewItemTermStoreGroupsItemSetsItemChildrenRequestBuilder instantiates a new ChildrenRequestBuilder and sets the default values.
...
func (m *ItemTermStoreGroupsItemSetsItemChildrenRequestBuilder) Count()(*ItemTermStoreGroupsItemSetsItemChildrenCountRequestBuilder) {
    return NewItemTermStoreGroupsItemSetsItemChildrenCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemTermStoreGroupsItemSetsItemChildrenRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTermStoreGroupsItemSetsItemChildrenRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
