...
// NewItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilderInternal instantiates a new ItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilder and sets the default values.
func NewItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilder) {
    m := &ItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/evaluate", pathParameters),
    }
    return m
}
// NewItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilder instantiates a new ItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilder and sets the default values.
...
func (m *ItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemInformationProtectionSensitivityLabelsItemSublabelsEvaluatePostRequestBodyable, requestConfiguration *ItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilder) WithUrl(rawUrl string)(*ItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilder) {
    return NewItemInformationProtectionSensitivityLabelsItemSublabelsEvaluateRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
