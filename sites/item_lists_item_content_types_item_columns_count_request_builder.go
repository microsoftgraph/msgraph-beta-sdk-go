...
func (m *ItemListsItemContentTypesItemColumnsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListsItemContentTypesItemColumnsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
