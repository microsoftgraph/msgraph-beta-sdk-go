...
func (m *ItemPermissionsPermissionItemRequestBuilder) MicrosoftGraphRevokeGrants()(*ItemPermissionsItemMicrosoftGraphRevokeGrantsRequestBuilder) {
    return NewItemPermissionsItemMicrosoftGraphRevokeGrantsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
