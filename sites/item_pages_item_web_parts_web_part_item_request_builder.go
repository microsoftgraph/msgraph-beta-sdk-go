...
func (m *ItemPagesItemWebPartsWebPartItemRequestBuilder) MicrosoftGraphGetPositionOfWebPart()(*ItemPagesItemWebPartsItemMicrosoftGraphGetPositionOfWebPartRequestBuilder) {
    return NewItemPagesItemWebPartsItemMicrosoftGraphGetPositionOfWebPartRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
