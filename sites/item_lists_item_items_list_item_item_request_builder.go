...
func (m *ItemListsItemItemsListItemItemRequestBuilder) MicrosoftGraphCreateLink()(*ItemListsItemItemsItemMicrosoftGraphCreateLinkRequestBuilder) {
    return NewItemListsItemItemsItemMicrosoftGraphCreateLinkRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
