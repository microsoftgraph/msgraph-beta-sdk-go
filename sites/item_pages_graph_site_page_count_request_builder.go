...
// NewItemPagesGraphSitePageCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemPagesGraphSitePageCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPagesGraphSitePageCountRequestBuilder) {
    m := &ItemPagesGraphSitePageCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/graph.sitePage/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewItemPagesGraphSitePageCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
