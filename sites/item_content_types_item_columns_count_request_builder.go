...
// NewItemContentTypesItemColumnsCountRequestBuilderInternal instantiates a new ItemContentTypesItemColumnsCountRequestBuilder and sets the default values.
func NewItemContentTypesItemColumnsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemContentTypesItemColumnsCountRequestBuilder) {
    m := &ItemContentTypesItemColumnsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columns/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemContentTypesItemColumnsCountRequestBuilder instantiates a new ItemContentTypesItemColumnsCountRequestBuilder and sets the default values.
...
func (m *ItemContentTypesItemColumnsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemContentTypesItemColumnsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemContentTypesItemColumnsCountRequestBuilder when successful
func (m *ItemContentTypesItemColumnsCountRequestBuilder) WithUrl(rawUrl string)(*ItemContentTypesItemColumnsCountRequestBuilder) {
    return NewItemContentTypesItemColumnsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
