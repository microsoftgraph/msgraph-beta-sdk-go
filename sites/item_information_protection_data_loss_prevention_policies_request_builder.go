...
func (m *ItemInformationProtectionDataLossPreventionPoliciesRequestBuilder) MicrosoftGraphEvaluate()(*ItemInformationProtectionDataLossPreventionPoliciesMicrosoftGraphEvaluateEvaluateRequestBuilder) {
    return NewItemInformationProtectionDataLossPreventionPoliciesMicrosoftGraphEvaluateEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
