...
func (m *ItemInformationProtectionDataLossPreventionPoliciesRequestBuilder) MicrosoftGraphEvaluate()(*ItemInformationProtectionDataLossPreventionPoliciesMicrosoftGraphEvaluateRequestBuilder) {
    return NewItemInformationProtectionDataLossPreventionPoliciesMicrosoftGraphEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
