...
func (m *SiteItemRequestBuilder) ColumnsById(id string)(*ItemColumnsColumnDefinitionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemColumnsColumnDefinitionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
// NewSiteItemRequestBuilderInternal instantiates a new SiteItemRequestBuilder and sets the default values.
func NewSiteItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, siteId *string)(*SiteItemRequestBuilder) {
...
func NewSiteItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SiteItemRequestBuilder) {
    ...
    return NewSiteItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *SiteItemRequestBuilder) ContentTypesById(id string)(*ItemContentTypesContentTypeItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemContentTypesContentTypeItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *SiteItemRequestBuilder) DrivesById(id string)(*ItemDrivesDriveItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemDrivesDriveItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *SiteItemRequestBuilder) ExternalColumnsById(id string)(*ItemExternalColumnsColumnDefinitionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemExternalColumnsColumnDefinitionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *SiteItemRequestBuilder) ItemsById(id string)(*ItemItemsBaseItemItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemItemsBaseItemItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *SiteItemRequestBuilder) ListsById(id string)(*ItemListsListItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemListsListItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *SiteItemRequestBuilder) OperationsById(id string)(*ItemOperationsRichLongRunningOperationItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemOperationsRichLongRunningOperationItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *SiteItemRequestBuilder) PagesById(id string)(*ItemPagesSitePageItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemPagesSitePageItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *SiteItemRequestBuilder) PermissionsById(id string)(*ItemPermissionsPermissionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemPermissionsPermissionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *SiteItemRequestBuilder) SitesById(id string)(*ItemSitesSiteItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemSitesSiteItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
