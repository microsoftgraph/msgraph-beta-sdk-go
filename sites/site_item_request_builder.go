...
func (m *SiteItemRequestBuilder) Archive()(*ItemArchiveRequestBuilder) {
...
func (m *SiteItemRequestBuilder) ContentModels()(*ItemContentModelsRequestBuilder) {
    return NewItemContentModelsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *SiteItemRequestBuilder) DocumentProcessingJobs()(*ItemDocumentProcessingJobsRequestBuilder) {
    return NewItemDocumentProcessingJobsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *SiteItemRequestBuilder) PageTemplates()(*ItemPageTemplatesRequestBuilder) {
    return NewItemPageTemplatesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *ItemRecycleBinRequestBuilder when successful
func (m *SiteItemRequestBuilder) RecycleBin()(*ItemRecycleBinRequestBuilder) {
    return NewItemRecycleBinRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *SiteItemRequestBuilder) Unarchive()(*ItemUnarchiveRequestBuilder) {
