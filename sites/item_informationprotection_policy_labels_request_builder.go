...
func (m *ItemInformationprotectionPolicyLabelsRequestBuilder) EvaluateApplication()(*ItemInformationprotectionPolicyLabelsEvaluateapplicationEvaluateApplicationRequestBuilder) {
    return NewItemInformationprotectionPolicyLabelsEvaluateapplicationEvaluateApplicationRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemInformationprotectionPolicyLabelsRequestBuilder) EvaluateClassificationResults()(*ItemInformationprotectionPolicyLabelsEvaluateclassificationresultsEvaluateClassificationResultsRequestBuilder) {
    return NewItemInformationprotectionPolicyLabelsEvaluateclassificationresultsEvaluateClassificationResultsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemInformationprotectionPolicyLabelsRequestBuilder) EvaluateRemoval()(*ItemInformationprotectionPolicyLabelsEvaluateremovalEvaluateRemovalRequestBuilder) {
    return NewItemInformationprotectionPolicyLabelsEvaluateremovalEvaluateRemovalRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemInformationprotectionPolicyLabelsRequestBuilder) ExtractLabel()(*ItemInformationprotectionPolicyLabelsExtractlabelExtractLabelRequestBuilder) {
    return NewItemInformationprotectionPolicyLabelsExtractlabelExtractLabelRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
