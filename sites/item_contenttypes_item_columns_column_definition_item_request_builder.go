...
func (m *ItemContenttypesItemColumnsColumnDefinitionItemRequestBuilder) SourceColumn()(*ItemContenttypesItemColumnsItemSourcecolumnSourceColumnRequestBuilder) {
    return NewItemContenttypesItemColumnsItemSourcecolumnSourceColumnRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
