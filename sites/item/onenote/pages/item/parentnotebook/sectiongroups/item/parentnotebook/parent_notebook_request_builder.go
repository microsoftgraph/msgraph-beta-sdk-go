...
import (
    ...
    i4330d5e53d7b06bd0526fd36cd4d8c3b6c05ea87e7d43fa539422fcac3e3e794 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/onenote/pages/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/sites/{site_id}/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i4330d5e53d7b06bd0526fd36cd4d8c3b6c05ea87e7d43fa539422fcac3e3e794.CopyNotebookRequestBuilder) {
    return i4330d5e53d7b06bd0526fd36cd4d8c3b6c05ea87e7d43fa539422fcac3e3e794.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
