...
import (
    ...
    ia2cc1a9e33f5d94bef8876f88f7e8edd5698c84d53c9f4f668cf4e0391d868d0 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/onenote/pages/item/parentsection/parentnotebook/sections/item/copytonotebook"
    if4bc6e03e45efd648ab899af5360079de46bb068bc084ac7f9fd6fecb104cd08 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/onenote/pages/item/parentsection/parentnotebook/sections/item/copytosectiongroup"
)

// OnenoteSectionRequestBuilder builds and executes requests for operations under \sites\{site-id}\onenote\pages\{onenotePage-id}\parentSection\parentNotebook\sections\{onenoteSection-id}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/pages/{onenotePage_id}/parentSection/parentNotebook/sections/{onenoteSection_id}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*ia2cc1a9e33f5d94bef8876f88f7e8edd5698c84d53c9f4f668cf4e0391d868d0.CopyToNotebookRequestBuilder) {
    return ia2cc1a9e33f5d94bef8876f88f7e8edd5698c84d53c9f4f668cf4e0391d868d0.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*if4bc6e03e45efd648ab899af5360079de46bb068bc084ac7f9fd6fecb104cd08.CopyToSectionGroupRequestBuilder) {
    return if4bc6e03e45efd648ab899af5360079de46bb068bc084ac7f9fd6fecb104cd08.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
