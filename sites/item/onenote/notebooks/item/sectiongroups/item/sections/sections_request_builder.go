...
// CreatePostRequestInformation create new navigation property to sections for sites
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to sections for sites
