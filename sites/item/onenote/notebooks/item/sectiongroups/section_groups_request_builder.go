...
// CreatePostRequestInformation create new navigation property to sectionGroups for sites
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to sectionGroups for sites
