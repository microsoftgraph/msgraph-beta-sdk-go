...
import (
    ...
    i48c762dc5ad504f05a7e6d9a601a243616ccac0c9db45d8fb3a13e8a6d100241 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/onenote/notebooks/item/sections/item/pages/count"
)
...
func NewPagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *PagesRequestBuilder) Count()(*i48c762dc5ad504f05a7e6d9a601a243616ccac0c9db45d8fb3a13e8a6d100241.CountRequestBuilder) {
    return i48c762dc5ad504f05a7e6d9a601a243616ccac0c9db45d8fb3a13e8a6d100241.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// PostWithResponseHandler create new navigation property to pages for sites
