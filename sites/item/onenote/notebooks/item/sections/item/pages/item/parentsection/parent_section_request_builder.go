...
import (
    ...
    i534425e02c276efcd4eba80ef979be23e5e130dd486bb277324b5fe51a4a4fd0 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/onenote/notebooks/item/sections/item/pages/item/parentsection/copytonotebook"
    if801d8a02d840d29fa30c130604a098a20bc81b0b9389ea78ae9a65156801f08 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/onenote/notebooks/item/sections/item/pages/item/parentsection/copytosectiongroup"
)
...
func NewParentSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentSectionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/sites/{site_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}/parentSection{?select,expand}";
...
func (m *ParentSectionRequestBuilder) CopyToNotebook()(*i534425e02c276efcd4eba80ef979be23e5e130dd486bb277324b5fe51a4a4fd0.CopyToNotebookRequestBuilder) {
    return i534425e02c276efcd4eba80ef979be23e5e130dd486bb277324b5fe51a4a4fd0.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *ParentSectionRequestBuilder) CopyToSectionGroup()(*if801d8a02d840d29fa30c130604a098a20bc81b0b9389ea78ae9a65156801f08.CopyToSectionGroupRequestBuilder) {
    return if801d8a02d840d29fa30c130604a098a20bc81b0b9389ea78ae9a65156801f08.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
