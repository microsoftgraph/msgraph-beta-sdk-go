...
import (
    ...
    icbb275cddaf691180b81c85bad8aeac66cc878bdea9c3e96be4b1e5a8f0e8c72 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/onenote/sections/item/parentnotebook/sectiongroups/item/sections/item/copytosectiongroup"
    ied05fc87d4230377e920c752ef6be3ffb2b7e7317a4dc59ca841c936381be0c1 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/onenote/sections/item/parentnotebook/sectiongroups/item/sections/item/copytonotebook"
)

// OnenoteSectionRequestBuilder builds and executes requests for operations under \sites\{site-id}\onenote\sections\{onenoteSection-id}\parentNotebook\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id1}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/sections/{onenoteSection_id}/parentNotebook/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id1}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*ied05fc87d4230377e920c752ef6be3ffb2b7e7317a4dc59ca841c936381be0c1.CopyToNotebookRequestBuilder) {
    return ied05fc87d4230377e920c752ef6be3ffb2b7e7317a4dc59ca841c936381be0c1.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*icbb275cddaf691180b81c85bad8aeac66cc878bdea9c3e96be4b1e5a8f0e8c72.CopyToSectionGroupRequestBuilder) {
    return icbb275cddaf691180b81c85bad8aeac66cc878bdea9c3e96be4b1e5a8f0e8c72.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
