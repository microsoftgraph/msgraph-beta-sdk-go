...
import (
    ...
    i51dc0aac296e52d0cd73f535ee455578a2dcdbfcc0c25bf8429649211410abd2 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/onenote/sections/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \sites\{site-id}\onenote\sections\{onenoteSection-id}\parentNotebook\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/sections/{onenoteSection_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*i51dc0aac296e52d0cd73f535ee455578a2dcdbfcc0c25bf8429649211410abd2.CopyNotebookRequestBuilder) {
    return i51dc0aac296e52d0cd73f535ee455578a2dcdbfcc0c25bf8429649211410abd2.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
