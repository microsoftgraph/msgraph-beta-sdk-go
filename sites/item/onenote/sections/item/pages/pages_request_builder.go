...
import (
    ...
    i04d91a607e42a8671c24553676befebc759cbbeac54c2ada18b7454e65b2ec79 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/onenote/sections/item/pages/count"
)
...
func NewPagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/sections/{onenoteSection_id}/pages{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PagesRequestBuilder) Count()(*i04d91a607e42a8671c24553676befebc759cbbeac54c2ada18b7454e65b2ec79.CountRequestBuilder) {
    return i04d91a607e42a8671c24553676befebc759cbbeac54c2ada18b7454e65b2ec79.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
