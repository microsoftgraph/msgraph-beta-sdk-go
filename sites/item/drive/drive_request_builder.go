...
// DriveRequestBuilder provides operations to manage the drive property of the microsoft.graph.site entity.
...
// DriveRequestBuilderGetQueryParameters the default drive (document library) for this site.
...
// CreateGetRequestInformationWithRequestConfiguration the default drive (document library) for this site.
...
// GetWithResponseHandler the default drive (document library) for this site.
