...
// driveRequestBuilder builds and executes requests for operations under \sites\{site-id}\drives\{drive-id}
...
// driveRequestBuilderGetQueryParameters the collection of drives (document libraries) under this site.
...
// CreateDeleteRequestInformation the collection of drives (document libraries) under this site.
...
// CreatePatchRequestInformation the collection of drives (document libraries) under this site.
...
// Delete the collection of drives (document libraries) under this site.
...
// Patch the collection of drives (document libraries) under this site.
