...
import (
    ...
    i742af2cc411bab5d540eff85a19f51867e6c66a2a36fbdba5a93a38a2174f8dd "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/termstore/sets/item/terms/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/terms/{term_id}/children/{term_id1}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*i742af2cc411bab5d540eff85a19f51867e6c66a2a36fbdba5a93a38a2174f8dd.CountRequestBuilder) {
    return i742af2cc411bab5d540eff85a19f51867e6c66a2a36fbdba5a93a38a2174f8dd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
