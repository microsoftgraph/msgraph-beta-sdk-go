...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property terms for sites
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property terms in sites
