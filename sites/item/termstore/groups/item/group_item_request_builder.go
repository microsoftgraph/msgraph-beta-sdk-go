...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property groups for sites
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property groups in sites
