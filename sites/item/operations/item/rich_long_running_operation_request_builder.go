...
// RichLongRunningOperationRequestBuilder builds and executes requests for operations under \sites\{site-id}\operations\{richLongRunningOperation-id}
...
func NewRichLongRunningOperationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RichLongRunningOperationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/operations/{richLongRunningOperation_id}{?select,expand}";
