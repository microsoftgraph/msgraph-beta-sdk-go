...
// RichLongRunningOperationRequestBuilder builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\operations\{richLongRunningOperation-id}
