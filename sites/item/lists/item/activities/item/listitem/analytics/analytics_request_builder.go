...
import (
    ...
    iba02f589d94bbe6687da04ebb17f4a427330cdff24ac5705a58c8bea40917867 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/lists/item/activities/item/listitem/analytics/ref"
)

// AnalyticsRequestBuilder builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\activities\{itemActivityOLD-id}\listItem\analytics
...
func NewAnalyticsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AnalyticsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/activities/{itemActivityOLD_id}/listItem/analytics{?select,expand}";
...
func (m *AnalyticsRequestBuilder) Ref()(*iba02f589d94bbe6687da04ebb17f4a427330cdff24ac5705a58c8bea40917867.RefRequestBuilder) {
    return iba02f589d94bbe6687da04ebb17f4a427330cdff24ac5705a58c8bea40917867.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
