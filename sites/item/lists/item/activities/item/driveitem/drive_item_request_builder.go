...
import (
    ...
    i1dba5190078ffda9bc022b6163c1fbb622ae6dcd23ea5c6999e033d188430556 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/lists/item/activities/item/driveitem/content"
)

// DriveItemRequestBuilder builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\activities\{itemActivityOLD-id}\driveItem
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i1dba5190078ffda9bc022b6163c1fbb622ae6dcd23ea5c6999e033d188430556.ContentRequestBuilder) {
    return i1dba5190078ffda9bc022b6163c1fbb622ae6dcd23ea5c6999e033d188430556.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
