...
func NewColumnDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ColumnDefinitionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/sites/{site_id}/lists/{list_id}/contentTypes/{contentType_id}/columns/{columnDefinition_id}{?select,expand}";
...
func (m *ColumnDefinitionRequestBuilder) SourceColumn()(*iad10a6bffe9a7061ce2b43b9dff01d5333eefd451482c1e4ec021aa4b12190cd.SourceColumnRequestBuilder) {
