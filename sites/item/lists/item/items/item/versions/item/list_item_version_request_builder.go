...
func NewListItemVersionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ListItemVersionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/sites/{site_id}/lists/{list_id}/items/{listItem_id}/versions/{listItemVersion_id}{?select,expand}";
...
func (m *ListItemVersionRequestBuilder) Fields()(*icc3762ebeb4d61e6b9acd20fd1965f1919994fc6f9aeeae16d1d3155406ceb0b.FieldsRequestBuilder) {
...
func (m *ListItemVersionRequestBuilder) RestoreVersion()(*i5903647e7399511251133cf734b71eb59e802c16dafaf8b00a5104e1e3ea25cd.RestoreVersionRequestBuilder) {
