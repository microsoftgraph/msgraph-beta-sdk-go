...
import (
    ...
    i59091a55a6b7a01c5ff56b0a126a10baf41c149c321a8de393a6bcb12c25a673 "github.com/microsoftgraph/msgraph-beta-sdk-go/sites/item/lists/item/items/item/activities/item/driveitem/content"
)

// driveItemRequestBuilder builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\items\{listItem-id}\activities\{itemActivityOLD-id}\driveItem
...
// driveItemRequestBuilderGetQueryParameters get driveItem from sites
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/items/{listItem_id}/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i59091a55a6b7a01c5ff56b0a126a10baf41c149c321a8de393a6bcb12c25a673.ContentRequestBuilder) {
    return i59091a55a6b7a01c5ff56b0a126a10baf41c149c321a8de393a6bcb12c25a673.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateDeleteRequestInformation delete navigation property driveItem for sites
...
// CreatePatchRequestInformation update the navigation property driveItem in sites
...
// Delete delete navigation property driveItem for sites
...
// Patch update the navigation property driveItem in sites
