...
// RefRequestBuilder builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\items\{listItem-id}\activities\{itemActivityOLD-id}\listItem\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/items/{listItem_id}/activities/{itemActivityOLD_id}/listItem/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property listItem for sites
...
// CreateGetRequestInformation get ref of listItem from sites
...
// CreatePutRequestInformation update the ref of navigation property listItem in sites
...
// Delete delete ref of navigation property listItem for sites
...
// Get get ref of listItem from sites
...
// Put update the ref of navigation property listItem in sites
