...
func NewColumnDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ColumnDefinitionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/sites/{site_id}/lists/{list_id}/columns/{columnDefinition_id}{?select,expand}";
...
func (m *ColumnDefinitionRequestBuilder) SourceColumn()(*i0bdd952949e7f656f38dcaadf77207a0739e8926d2bbc27084716a120d767b55.SourceColumnRequestBuilder) {
