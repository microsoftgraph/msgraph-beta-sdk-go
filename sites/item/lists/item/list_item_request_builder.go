...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property lists for sites
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property lists in sites
