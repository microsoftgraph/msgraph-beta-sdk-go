...
// ItemGetByPathWithPathItemsRequestBuilderGetQueryParameters used to address any item contained in this site. This collection cannot be enumerated.
...
// NewItemGetByPathWithPathItemsRequestBuilderInternal instantiates a new ItemsRequestBuilder and sets the default values.
func NewItemGetByPathWithPathItemsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGetByPathWithPathItemsRequestBuilder) {
    m := &ItemGetByPathWithPathItemsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemGetByPathWithPathItemsRequestBuilder instantiates a new ItemsRequestBuilder and sets the default values.
...
func (m *ItemGetByPathWithPathItemsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGetByPathWithPathItemsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.BaseItemCollectionResponseable, error) {
