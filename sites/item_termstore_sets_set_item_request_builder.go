...
func (m *ItemTermstoreSetsSetItemRequestBuilder) ParentGroup()(*ItemTermstoreSetsItemParentgroupParentGroupRequestBuilder) {
    return NewItemTermstoreSetsItemParentgroupParentGroupRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
