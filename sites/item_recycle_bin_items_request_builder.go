...
// ItemRecycleBinItemsRequestBuilderGetQueryParameters get a list of recycleBinItems under the specified site. This API is available in the following national cloud deployments.
