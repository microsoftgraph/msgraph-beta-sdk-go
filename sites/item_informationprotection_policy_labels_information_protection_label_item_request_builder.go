...
// NewItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilderInternal instantiates a new ItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilder and sets the default values.
func NewItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilder) {
    m := &ItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/policy/labels/{informationProtectionLabel%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilder instantiates a new ItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilder and sets the default values.
...
// ToDeleteRequestInformation delete navigation property labels for sites
// Deprecated: This API will no longer be accessible, please see microsoft.graph.security.informationProtection APIs. as of 2021-02/Beta_SensitivityLabels
...
// ToPatchRequestInformation update the navigation property labels in sites
// Deprecated: This API will no longer be accessible, please see microsoft.graph.security.informationProtection APIs. as of 2021-02/Beta_SensitivityLabels
// returns a *RequestInformation when successful
...
func (m *ItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilder) WithUrl(rawUrl string)(*ItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilder) {
    return NewItemInformationprotectionPolicyLabelsInformationProtectionLabelItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
