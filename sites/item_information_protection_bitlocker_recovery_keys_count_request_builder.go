...
// NewItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilderInternal instantiates a new ItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilder and sets the default values.
func NewItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilder) {
    m := &ItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/informationProtection/bitlocker/recoveryKeys/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilder instantiates a new ItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilder and sets the default values.
...
func (m *ItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilder) WithUrl(rawUrl string)(*ItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilder) {
    return NewItemInformationProtectionBitlockerRecoveryKeysCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
