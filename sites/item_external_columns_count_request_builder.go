...
// NewItemExternalColumnsCountRequestBuilderInternal instantiates a new ItemExternalColumnsCountRequestBuilder and sets the default values.
func NewItemExternalColumnsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemExternalColumnsCountRequestBuilder) {
    m := &ItemExternalColumnsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/externalColumns/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemExternalColumnsCountRequestBuilder instantiates a new ItemExternalColumnsCountRequestBuilder and sets the default values.
...
func (m *ItemExternalColumnsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemExternalColumnsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemExternalColumnsCountRequestBuilder) WithUrl(rawUrl string)(*ItemExternalColumnsCountRequestBuilder) {
    return NewItemExternalColumnsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
