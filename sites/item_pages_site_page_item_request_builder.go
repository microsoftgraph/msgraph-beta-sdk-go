...
func (m *ItemPagesSitePageItemRequestBuilder) MicrosoftGraphGetWebPartsByPosition()(*ItemPagesItemMicrosoftGraphGetWebPartsByPositionRequestBuilder) {
    return NewItemPagesItemMicrosoftGraphGetWebPartsByPositionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphPublish provides operations to call the publish method.
func (m *ItemPagesSitePageItemRequestBuilder) MicrosoftGraphPublish()(*ItemPagesItemMicrosoftGraphPublishRequestBuilder) {
    return NewItemPagesItemMicrosoftGraphPublishRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
