...
func (m *ItemInformationProtectionRequestBuilder) MicrosoftGraphDecryptBuffer()(*ItemInformationProtectionMicrosoftGraphDecryptBufferRequestBuilder) {
    return NewItemInformationProtectionMicrosoftGraphDecryptBufferRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEncryptBuffer provides operations to call the encryptBuffer method.
func (m *ItemInformationProtectionRequestBuilder) MicrosoftGraphEncryptBuffer()(*ItemInformationProtectionMicrosoftGraphEncryptBufferRequestBuilder) {
    return NewItemInformationProtectionMicrosoftGraphEncryptBufferRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSignDigest provides operations to call the signDigest method.
func (m *ItemInformationProtectionRequestBuilder) MicrosoftGraphSignDigest()(*ItemInformationProtectionMicrosoftGraphSignDigestRequestBuilder) {
    return NewItemInformationProtectionMicrosoftGraphSignDigestRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphVerifySignature provides operations to call the verifySignature method.
func (m *ItemInformationProtectionRequestBuilder) MicrosoftGraphVerifySignature()(*ItemInformationProtectionMicrosoftGraphVerifySignatureRequestBuilder) {
    return NewItemInformationProtectionMicrosoftGraphVerifySignatureRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
