...
// Get search across a SharePoint tenant for sites][] that match keywords provided. The only property that works for sorting is createdDateTime. The search filter is a free text search that uses multiple properties when retrieving the search results. This API is supported in the following [national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation search across a SharePoint tenant for sites][] that match keywords provided. The only property that works for sorting is createdDateTime. The search filter is a free text search that uses multiple properties when retrieving the search results. This API is supported in the following [national cloud deployments.
