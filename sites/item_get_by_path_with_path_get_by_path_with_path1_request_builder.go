...
func (m *ItemGetByPathWithPathGetByPathWithPath1RequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGetByPathWithPathGetByPathWithPath1RequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Siteable, error) {
...
func (m *ItemGetByPathWithPathGetByPathWithPath1RequestBuilder) InformationProtection()(*ItemGetByPathWithPathGetByPathWithPath1InformationProtectionRequestBuilder) {
    return NewItemGetByPathWithPathGetByPathWithPath1InformationProtectionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemGetByPathWithPathGetByPathWithPath1RequestBuilder) RecycleBin()(*ItemGetByPathWithPathGetByPathWithPath1RecycleBinRequestBuilder) {
    return NewItemGetByPathWithPathGetByPathWithPath1RecycleBinRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
