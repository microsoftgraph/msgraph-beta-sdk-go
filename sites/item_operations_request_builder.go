...
// ItemOperationsRequestBuilderGetQueryParameters get the list of richLongRunningOperations associated with a site. This API is available in the following national cloud deployments.
...
// Get get the list of richLongRunningOperations associated with a site. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get the list of richLongRunningOperations associated with a site. This API is available in the following national cloud deployments.
