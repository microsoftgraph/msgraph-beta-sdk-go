...
// ItemPagesBaseSitePageItemRequestBuilderGetQueryParameters get the metadata for a baseSitePage][] in the site pages [list][] in a [site][]. This API is available in the following [national cloud deployments.
...
// NewItemPagesBaseSitePageItemRequestBuilderInternal instantiates a new BaseSitePageItemRequestBuilder and sets the default values.
func NewItemPagesBaseSitePageItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPagesBaseSitePageItemRequestBuilder) {
    m := &ItemPagesBaseSitePageItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/pages/{baseSitePage%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemPagesBaseSitePageItemRequestBuilder instantiates a new BaseSitePageItemRequestBuilder and sets the default values.
