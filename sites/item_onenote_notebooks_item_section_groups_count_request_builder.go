...
func (m *ItemOnenoteNotebooksItemSectionGroupsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOnenoteNotebooksItemSectionGroupsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
