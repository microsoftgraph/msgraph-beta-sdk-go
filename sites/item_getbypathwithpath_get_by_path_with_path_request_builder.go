...
func (m *ItemGetbypathwithpathGetByPathWithPathRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGetbypathwithpathGetByPathWithPathRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Siteable, error) {
...
func (m *ItemGetbypathwithpathGetByPathWithPathRequestBuilder) InformationProtection()(*ItemGetbypathwithpathInformationprotectionInformationProtectionRequestBuilder) {
    return NewItemGetbypathwithpathInformationprotectionInformationProtectionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemGetbypathwithpathGetByPathWithPathRequestBuilder) RecycleBin()(*ItemGetbypathwithpathRecyclebinRecycleBinRequestBuilder) {
    return NewItemGetbypathwithpathRecyclebinRecycleBinRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
