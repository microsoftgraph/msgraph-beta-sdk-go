...
func (m *ItemPermissionGrantsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*ItemPermissionGrantsMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilder) {
    return NewItemPermissionGrantsMicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
