...
func (m *ItemScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphClockOut()(*ItemScheduleTimeCardsItemMicrosoftGraphClockOutRequestBuilder) {
    return NewItemScheduleTimeCardsItemMicrosoftGraphClockOutRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphConfirm provides operations to call the confirm method.
func (m *ItemScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphConfirm()(*ItemScheduleTimeCardsItemMicrosoftGraphConfirmRequestBuilder) {
    return NewItemScheduleTimeCardsItemMicrosoftGraphConfirmRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEndBreak provides operations to call the endBreak method.
func (m *ItemScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphEndBreak()(*ItemScheduleTimeCardsItemMicrosoftGraphEndBreakRequestBuilder) {
    return NewItemScheduleTimeCardsItemMicrosoftGraphEndBreakRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphStartBreak provides operations to call the startBreak method.
func (m *ItemScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphStartBreak()(*ItemScheduleTimeCardsItemMicrosoftGraphStartBreakRequestBuilder) {
    return NewItemScheduleTimeCardsItemMicrosoftGraphStartBreakRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
