...
func NewItemChannelsItemMembersAddRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemChannelsItemMembersAddRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/members/microsoft.graph.add";
...
func (m *ItemChannelsItemMembersAddRequestBuilder) Post(ctx context.Context, body ItemChannelsItemMembersAddPostRequestBodyable, requestConfiguration *ItemChannelsItemMembersAddRequestBuilderPostRequestConfiguration)(ItemChannelsItemMembersAddResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateItemChannelsItemMembersAddResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
