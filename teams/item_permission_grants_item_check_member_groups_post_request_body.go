...
// ItemPermissionGrantsItemCheckMemberGroupsPostRequestBody provides operations to call the checkMemberGroups method.
...
func (m *ItemPermissionGrantsItemCheckMemberGroupsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemPermissionGrantsItemCheckMemberGroupsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
