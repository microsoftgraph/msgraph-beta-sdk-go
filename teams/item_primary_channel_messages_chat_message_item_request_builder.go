...
func (m *ItemPrimaryChannelMessagesChatMessageItemRequestBuilder) MicrosoftGraphSetReaction()(*ItemPrimaryChannelMessagesItemMicrosoftGraphSetReactionRequestBuilder) {
    return NewItemPrimaryChannelMessagesItemMicrosoftGraphSetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemPrimaryChannelMessagesChatMessageItemRequestBuilder) MicrosoftGraphUnsetReaction()(*ItemPrimaryChannelMessagesItemMicrosoftGraphUnsetReactionRequestBuilder) {
    return NewItemPrimaryChannelMessagesItemMicrosoftGraphUnsetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
