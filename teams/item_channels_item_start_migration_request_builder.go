...
// ItemChannelsItemStartMigrationRequestBuilder provides operations to call the startMigration method.
type ItemChannelsItemStartMigrationRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemChannelsItemStartMigrationRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemChannelsItemStartMigrationRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewItemChannelsItemStartMigrationRequestBuilderInternal instantiates a new ItemChannelsItemStartMigrationRequestBuilder and sets the default values.
func NewItemChannelsItemStartMigrationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemChannelsItemStartMigrationRequestBuilder) {
    m := &ItemChannelsItemStartMigrationRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/startMigration", pathParameters),
    }
    return m
}
// NewItemChannelsItemStartMigrationRequestBuilder instantiates a new ItemChannelsItemStartMigrationRequestBuilder and sets the default values.
func NewItemChannelsItemStartMigrationRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemChannelsItemStartMigrationRequestBuilder) {
...
func (m *ItemChannelsItemStartMigrationRequestBuilder) WithUrl(rawUrl string)(*ItemChannelsItemStartMigrationRequestBuilder) {
    return NewItemChannelsItemStartMigrationRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
