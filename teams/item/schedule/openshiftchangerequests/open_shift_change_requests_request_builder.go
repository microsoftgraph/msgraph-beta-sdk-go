...
// GetWithRequestConfigurationAndResponseHandler get openShiftChangeRequests from teams
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to openShiftChangeRequests for teams
