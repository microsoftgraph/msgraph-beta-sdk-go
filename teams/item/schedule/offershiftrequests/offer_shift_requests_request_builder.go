...
// GetWithRequestConfigurationAndResponseHandler get offerShiftRequests from teams
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to offerShiftRequests for teams
