...
func (m *StartBreakRequestBody) GetNotes()(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ItemBody) {
    if m == nil {
        return nil
    } else {
        return m.notes
...
func (m *StartBreakRequestBody) IsNil()(bool) {
    return m == nil
}
...
func (m *StartBreakRequestBody) SetNotes(value *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ItemBody)() {
    if m != nil {
        m.notes = value
    }
}
