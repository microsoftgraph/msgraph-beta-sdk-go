...
// OperationsRequestBuilder builds and executes requests for operations under \teams\{team-id}\operations
...
// CreatePostRequestInformation the async operations that ran or are running on this team.
...
// Post the async operations that ran or are running on this team.
func (m *OperationsRequestBuilder) Post(options *OperationsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.TeamsAsyncOperation, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewTeamsAsyncOperation() }, nil, nil)
    if err != nil {
        return nil, err
    }
