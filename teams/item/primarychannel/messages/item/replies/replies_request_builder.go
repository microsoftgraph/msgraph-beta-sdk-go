...
// CreatePostRequestInformation create new navigation property to replies for teams
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to replies for teams
