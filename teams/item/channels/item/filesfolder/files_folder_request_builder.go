...
import (
    ...
    iedae026d81e654559c4b06f50501126105175eb67551a905c3b597f3019af33e "github.com/microsoftgraph/msgraph-beta-sdk-go/teams/item/channels/item/filesfolder/content"
)
...
func NewFilesFolderRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FilesFolderRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/teams/{team_id}/channels/{channel_id}/filesFolder{?select,expand}";
