...
type ProvisionEmailResponse struct {
    ...
    provisionChannelEmailResult i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ProvisionChannelEmailResultable;
}
...
func (m *ProvisionEmailResponse) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["provisionChannelEmailResult"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateProvisionChannelEmailResultFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetProvisionChannelEmailResult(val.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ProvisionChannelEmailResultable))
        }
        return nil
    }
    return res
...
func (m *ProvisionEmailResponse) GetProvisionChannelEmailResult()(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ProvisionChannelEmailResultable) {
    if m == nil {
        return nil
    } else {
...
func (m *ProvisionEmailResponse) SetProvisionChannelEmailResult(value i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ProvisionChannelEmailResultable)() {
    if m != nil {
