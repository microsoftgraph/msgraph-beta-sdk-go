...
// Builds and executes requests for operations under \teams\{team-id}\channels\{channel-id}\members\microsoft.graph.add
...
// Parameters:
//  - options : Options for the request
func (m *AddRequestBuilder) Post(options *AddRequestBuilderPostOptions)([]Add, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewAdd() }, nil)
    if err != nil {
        return nil, err
    }
