...
// ResourceSpecificPermissionGrantItemRequestBuilder builds and executes requests for operations under \teams\{team-id}\permissionGrants\{resourceSpecificPermissionGrant-id}
