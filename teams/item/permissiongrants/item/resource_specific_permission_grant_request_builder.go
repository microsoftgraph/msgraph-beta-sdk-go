...
// ResourceSpecificPermissionGrantRequestBuilder builds and executes requests for operations under \teams\{team-id}\permissionGrants\{resourceSpecificPermissionGrant-id}
...
// ResourceSpecificPermissionGrantRequestBuilderGetQueryParameters a collection of permissions granted to apps to access the team.
...
func NewResourceSpecificPermissionGrantRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ResourceSpecificPermissionGrantRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team_id}/permissionGrants/{resourceSpecificPermissionGrant_id}{?select,expand}";
...
// CreateDeleteRequestInformation a collection of permissions granted to apps to access the team.
...
// CreatePatchRequestInformation a collection of permissions granted to apps to access the team.
...
// Delete a collection of permissions granted to apps to access the team.
...
func (m *ResourceSpecificPermissionGrantRequestBuilder) Get(options *ResourceSpecificPermissionGrantRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ResourceSpecificPermissionGrant, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewResourceSpecificPermissionGrant() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ResourceSpecificPermissionGrant), nil
}
// Patch a collection of permissions granted to apps to access the team.
