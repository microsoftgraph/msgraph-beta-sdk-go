...
// Builds and executes requests for operations under \teams\{team-id}\owners
...
func NewOwnersRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OwnersRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/teams/{team_id}/owners{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *OwnersRequestBuilder) Ref()(*if3ecebfdc71cec5fbad59a978fc8721ddba920b2bcca9a8c35b01dae2cf55fc9.RefRequestBuilder) {
    return if3ecebfdc71cec5fbad59a978fc8721ddba920b2bcca9a8c35b01dae2cf55fc9.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
