...
type TagsRequestBuilderGetOptions struct {
    ...
    Q *TagsRequestBuilderGetQueryParameters;
...
func NewTagsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TagsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team_id}/tags{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *TagsRequestBuilder) Get(options *TagsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.TeamworkTagCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateTeamworkTagCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.TeamworkTagCollectionResponseable), nil
}
// Post create new navigation property to tags for teams
func (m *TagsRequestBuilder) Post(options *TagsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.TeamworkTagable, error) {
