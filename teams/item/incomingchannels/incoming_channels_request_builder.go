...
// CreateGetRequestInformationWithRequestConfiguration get incomingChannels from teams
...
// GetWithRequestConfigurationAndResponseHandler get incomingChannels from teams
