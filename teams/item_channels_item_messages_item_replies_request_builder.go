...
func (m *ItemChannelsItemMessagesItemRepliesRequestBuilder) MicrosoftGraphDelta()(*ItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemChannelsItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
