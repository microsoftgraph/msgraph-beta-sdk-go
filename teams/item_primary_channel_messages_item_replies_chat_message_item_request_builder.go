...
func (m *ItemPrimaryChannelMessagesItemRepliesChatMessageItemRequestBuilder) MicrosoftGraphSetReaction()(*ItemPrimaryChannelMessagesItemRepliesItemMicrosoftGraphSetReactionRequestBuilder) {
    return NewItemPrimaryChannelMessagesItemRepliesItemMicrosoftGraphSetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemPrimaryChannelMessagesItemRepliesChatMessageItemRequestBuilder) MicrosoftGraphUnsetReaction()(*ItemPrimaryChannelMessagesItemRepliesItemMicrosoftGraphUnsetReactionRequestBuilder) {
    return NewItemPrimaryChannelMessagesItemRepliesItemMicrosoftGraphUnsetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
