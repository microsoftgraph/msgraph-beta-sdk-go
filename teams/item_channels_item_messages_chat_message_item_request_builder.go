...
func (m *ItemChannelsItemMessagesChatMessageItemRequestBuilder) HostedContentsById(id string)(*ItemChannelsItemMessagesItemHostedContentsChatMessageHostedContentItemRequestBuilder) {
    ...
    return NewItemChannelsItemMessagesItemHostedContentsChatMessageHostedContentItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
// MicrosoftGraphSetReaction provides operations to call the setReaction method.
func (m *ItemChannelsItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphSetReaction()(*ItemChannelsItemMessagesItemMicrosoftGraphSetReactionRequestBuilder) {
    return NewItemChannelsItemMessagesItemMicrosoftGraphSetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSoftDelete provides operations to call the softDelete method.
func (m *ItemChannelsItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphSoftDelete()(*ItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder) {
    return NewItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUndoSoftDelete provides operations to call the undoSoftDelete method.
func (m *ItemChannelsItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphUndoSoftDelete()(*ItemChannelsItemMessagesItemMicrosoftGraphUndoSoftDeleteRequestBuilder) {
    return NewItemChannelsItemMessagesItemMicrosoftGraphUndoSoftDeleteRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnsetReaction provides operations to call the unsetReaction method.
func (m *ItemChannelsItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphUnsetReaction()(*ItemChannelsItemMessagesItemMicrosoftGraphUnsetReactionRequestBuilder) {
    return NewItemChannelsItemMessagesItemMicrosoftGraphUnsetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemChannelsItemMessagesChatMessageItemRequestBuilder) RepliesById(id string)(*ItemChannelsItemMessagesItemRepliesChatMessageItemRequestBuilder) {
    ...
    return NewItemChannelsItemMessagesItemRepliesChatMessageItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
