...
func (m *ItemChannelsRequestBuilder) MicrosoftGraphAllMessages()(*ItemChannelsMicrosoftGraphAllMessagesAllMessagesRequestBuilder) {
    return NewItemChannelsMicrosoftGraphAllMessagesAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
