...
// ItemTemplateDefinitionRequestBuilder provides operations to manage the templateDefinition property of the microsoft.graph.team entity.
type ItemTemplateDefinitionRequestBuilder struct {
...
type ItemTemplateDefinitionRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemTemplateDefinitionRequestBuilderGetQueryParameters
}
// NewItemTemplateDefinitionRequestBuilderInternal instantiates a new TemplateDefinitionRequestBuilder and sets the default values.
func NewItemTemplateDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTemplateDefinitionRequestBuilder) {
    m := &ItemTemplateDefinitionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teams/{team%2Did}/templateDefinition{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemTemplateDefinitionRequestBuilder instantiates a new TemplateDefinitionRequestBuilder and sets the default values.
func NewItemTemplateDefinitionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTemplateDefinitionRequestBuilder) {
...
func (m *ItemTemplateDefinitionRequestBuilder) WithUrl(rawUrl string)(*ItemTemplateDefinitionRequestBuilder) {
    return NewItemTemplateDefinitionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
