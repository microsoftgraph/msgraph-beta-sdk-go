...
func (m *ItemChannelsItemMessagesRequestBuilder) MicrosoftGraphDelta()(*ItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
