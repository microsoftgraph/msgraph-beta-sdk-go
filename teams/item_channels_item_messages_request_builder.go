...
func (m *ItemChannelsItemMessagesRequestBuilder) MicrosoftGraphDelta()(*ItemChannelsItemMessagesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemChannelsItemMessagesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
