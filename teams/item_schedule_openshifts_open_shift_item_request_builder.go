...
// NewItemScheduleOpenshiftsOpenShiftItemRequestBuilderInternal instantiates a new ItemScheduleOpenshiftsOpenShiftItemRequestBuilder and sets the default values.
func NewItemScheduleOpenshiftsOpenShiftItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemScheduleOpenshiftsOpenShiftItemRequestBuilder) {
    m := &ItemScheduleOpenshiftsOpenShiftItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teams/{team%2Did}/schedule/openShifts/{openShift%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemScheduleOpenshiftsOpenShiftItemRequestBuilder instantiates a new ItemScheduleOpenshiftsOpenShiftItemRequestBuilder and sets the default values.
func NewItemScheduleOpenshiftsOpenShiftItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemScheduleOpenshiftsOpenShiftItemRequestBuilder) {
...
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/openshift-delete?view=graph-rest-beta
...
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/openshift-get?view=graph-rest-beta
func (m *ItemScheduleOpenshiftsOpenShiftItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemScheduleOpenshiftsOpenShiftItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OpenShiftable, error) {
...
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/openshift-update?view=graph-rest-beta
func (m *ItemScheduleOpenshiftsOpenShiftItemRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OpenShiftable, requestConfiguration *ItemScheduleOpenshiftsOpenShiftItemRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OpenShiftable, error) {
...
func (m *ItemScheduleOpenshiftsOpenShiftItemRequestBuilder) WithUrl(rawUrl string)(*ItemScheduleOpenshiftsOpenShiftItemRequestBuilder) {
    return NewItemScheduleOpenshiftsOpenShiftItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
