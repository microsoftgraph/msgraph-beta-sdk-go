...
func (m *ItemChannelsItemMembersRequestBuilder) MicrosoftGraphAdd()(*ItemChannelsItemMembersMicrosoftGraphAddAddRequestBuilder) {
    return NewItemChannelsItemMembersMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
