...
// NewItemScheduleTimeCardsItemEndBreakRequestBuilderInternal instantiates a new EndBreakRequestBuilder and sets the default values.
func NewItemScheduleTimeCardsItemEndBreakRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemScheduleTimeCardsItemEndBreakRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team%2Did}/schedule/timeCards/{timeCard%2Did}/endBreak";
...
// NewItemScheduleTimeCardsItemEndBreakRequestBuilder instantiates a new EndBreakRequestBuilder and sets the default values.
