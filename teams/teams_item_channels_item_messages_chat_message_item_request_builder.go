...
func (m *TeamsItemChannelsItemMessagesChatMessageItemRequestBuilder) Get(ctx context.Context, requestConfiguration *TeamsItemChannelsItemMessagesChatMessageItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ChatMessageable, error) {
...
func (m *TeamsItemChannelsItemMessagesChatMessageItemRequestBuilder) SetReaction()(*TeamsItemChannelsItemMessagesItemSetReactionRequestBuilder) {
    return NewTeamsItemChannelsItemMessagesItemSetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SoftDelete provides operations to call the softDelete method.
func (m *TeamsItemChannelsItemMessagesChatMessageItemRequestBuilder) SoftDelete()(*TeamsItemChannelsItemMessagesItemSoftDeleteRequestBuilder) {
    return NewTeamsItemChannelsItemMessagesItemSoftDeleteRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// UndoSoftDelete provides operations to call the undoSoftDelete method.
func (m *TeamsItemChannelsItemMessagesChatMessageItemRequestBuilder) UndoSoftDelete()(*TeamsItemChannelsItemMessagesItemUndoSoftDeleteRequestBuilder) {
    return NewTeamsItemChannelsItemMessagesItemUndoSoftDeleteRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// UnsetReaction provides operations to call the unsetReaction method.
func (m *TeamsItemChannelsItemMessagesChatMessageItemRequestBuilder) UnsetReaction()(*TeamsItemChannelsItemMessagesItemUnsetReactionRequestBuilder) {
    return NewTeamsItemChannelsItemMessagesItemUnsetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
