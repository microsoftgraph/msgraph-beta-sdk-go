...
func NewItemScheduleOpenShiftsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemScheduleOpenShiftsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teams/{team%2Did}/schedule/openShifts/$count";
...
func (m *ItemScheduleOpenShiftsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemScheduleOpenShiftsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
