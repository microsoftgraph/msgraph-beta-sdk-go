...
// ItemInstalledAppsRequestBuilderGetQueryParameters the apps installed in this team.
...
// ToPostRequestInformation create new navigation property to installedApps for teams
