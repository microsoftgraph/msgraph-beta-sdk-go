...
func NewItemPrimarychannelMembersAddPostRequestBody()(*ItemPrimarychannelMembersAddPostRequestBody) {
    m := &ItemPrimarychannelMembersAddPostRequestBody{
    }
...
func (m *ItemPrimarychannelMembersAddPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemPrimarychannelMembersAddPostRequestBody) GetValues()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ConversationMemberable) {
...
func (m *ItemPrimarychannelMembersAddPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetValues() != nil {
...
func (m *ItemPrimarychannelMembersAddPostRequestBody) SetValues(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ConversationMemberable)() {
    err := m.GetBackingStore().Set("values", value)
    if err != nil {
        panic(err)
    }
}
type ItemPrimarychannelMembersAddPostRequestBodyable interface {
