...
func NewGovernanceRoleAssignmentItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, governanceRoleAssignmentId *string)(*GovernanceRoleAssignmentItemRequestBuilder) {
...
func NewGovernanceRoleAssignmentItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GovernanceRoleAssignmentItemRequestBuilder) {
    ...
    return NewGovernanceRoleAssignmentItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *GovernanceRoleAssignmentItemRequestBuilder) LinkedEligibleRoleAssignment()(*ItemLinkedEligibleRoleAssignmentRequestBuilder) {
    return NewItemLinkedEligibleRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
