...
// RefRequestBuilder builds and executes requests for operations under \governanceRoleAssignments\{governanceRoleAssignment-id}\resource\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment_id}/resource/$ref";
...
// CreateDeleteRequestInformation read-only. The resource associated with the role assignment.
...
// CreatePutRequestInformation read-only. The resource associated with the role assignment.
...
// Delete read-only. The resource associated with the role assignment.
...
// Put read-only. The resource associated with the role assignment.
