...
// CreatePatchRequestInformation read-only. The resource associated with the role assignment.
...
// Patch read-only. The resource associated with the role assignment.
