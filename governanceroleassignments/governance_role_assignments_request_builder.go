...
func (m *GovernanceRoleAssignmentsRequestBuilder) MicrosoftGraphExport()(*MicrosoftGraphExportExportRequestBuilder) {
    return NewMicrosoftGraphExportExportRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
