...
func (m *GovernanceRoleAssignmentsRequestBuilder) MicrosoftGraphExport()(*MicrosoftGraphExportRequestBuilder) {
    return NewMicrosoftGraphExportRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
