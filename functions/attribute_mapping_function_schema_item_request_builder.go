...
func (m *AttributeMappingFunctionSchemaItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *AttributeMappingFunctionSchemaItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
