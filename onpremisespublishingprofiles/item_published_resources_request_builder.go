...
func (m *ItemPublishedResourcesRequestBuilder) WithUrl(rawUrl string)(*ItemPublishedResourcesRequestBuilder) {
    return NewItemPublishedResourcesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
