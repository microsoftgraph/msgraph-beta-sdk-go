...
func (m *ItemPublishedResourcesPublishedResourceItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemPublishedResourcesPublishedResourceItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
