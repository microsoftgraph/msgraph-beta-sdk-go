...
// ItemAgentGroupsRequestBuilderGetQueryParameters retrieve a list of onPremisesAgentGroup objects. This API is supported in the following national cloud deployments.
...
// Get retrieve a list of onPremisesAgentGroup objects. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create a new onPremisesAgentGroup object. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve a list of onPremisesAgentGroup objects. This API is supported in the following national cloud deployments.
...
// ToPostRequestInformation create a new onPremisesAgentGroup object. This API is supported in the following national cloud deployments.
