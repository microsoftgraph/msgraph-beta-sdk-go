...
func (m *ItemAgentGroupsItemPublishedResourcesItemAgentGroupsItemRefRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemAgentGroupsItemPublishedResourcesItemAgentGroupsItemRefRequestBuilderDeleteRequestConfiguration)([]byte, error) {
