...
// RefRequestBuilderGetQueryParameters the connectorGroup that the connector is a member of. Read-only.
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property ref to memberOf for onPremisesPublishingProfiles
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property ref to memberOf for onPremisesPublishingProfiles
