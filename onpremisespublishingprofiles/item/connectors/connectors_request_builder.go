...
// ConnectorsRequestBuilder builds and executes requests for operations under \onPremisesPublishingProfiles\{onPremisesPublishingProfile-id}\connectors
...
// CreatePostRequestInformation list of existing connector objects for applications published through Application Proxy. Read-only. Nullable.
...
func (m *ConnectorsRequestBuilder) Get(options *ConnectorsRequestBuilderGetOptions)(*ConnectorsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewConnectorsResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*ConnectorsResponse), nil
}
// Post list of existing connector objects for applications published through Application Proxy. Read-only. Nullable.
func (m *ConnectorsRequestBuilder) Post(options *ConnectorsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Connector, error) {
