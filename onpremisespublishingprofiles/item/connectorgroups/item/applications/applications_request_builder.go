...
func NewApplicationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ApplicationsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/onPremisesPublishingProfiles/{onPremisesPublishingProfile_id}/connectorGroups/{connectorGroup_id}/applications{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ApplicationsRequestBuilder) Ref()(*i51136f236db8af53634b48bdfab7c30b71f2bf4930424884620db4e02363dd1f.RefRequestBuilder) {
    return i51136f236db8af53634b48bdfab7c30b71f2bf4930424884620db4e02363dd1f.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
