...
// AgentsRequestBuilder builds and executes requests for operations under \onPremisesPublishingProfiles\{onPremisesPublishingProfile-id}\agents
...
// CreatePostRequestInformation list of existing onPremisesAgent objects. Read-only. Nullable.
...
// Post list of existing onPremisesAgent objects. Read-only. Nullable.
