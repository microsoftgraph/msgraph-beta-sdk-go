...
import (
    ...
    ica7496b68708ee8e39b4750c28ca190a868636763162186b603b1868832cbd90 "github.com/microsoftgraph/msgraph-beta-sdk-go/onpremisespublishingprofiles/item/agents/count"
)

// AgentsRequestBuilder provides operations to manage the agents property of the microsoft.graph.onPremisesPublishingProfile entity.
...
// AgentsRequestBuilderGetQueryParameters list of existing onPremisesAgent objects. Read-only. Nullable.
...
func NewAgentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AgentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile_id}/agents{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *AgentsRequestBuilder) Count()(*ica7496b68708ee8e39b4750c28ca190a868636763162186b603b1868832cbd90.CountRequestBuilder) {
    return ica7496b68708ee8e39b4750c28ca190a868636763162186b603b1868832cbd90.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
