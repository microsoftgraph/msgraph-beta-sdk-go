...
// AgentsRequestBuilderGetQueryParameters retrieve a list of onPremisesAgent objects.
...
// CreateGetRequestInformationWithRequestConfiguration retrieve a list of onPremisesAgent objects.
