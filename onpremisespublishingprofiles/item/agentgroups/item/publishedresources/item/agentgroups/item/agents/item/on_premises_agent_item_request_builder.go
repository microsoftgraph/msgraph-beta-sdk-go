...
import (
    ...
    ie9e4451316873b30d0e3b0d217b7ba5b813e2192770a0d73d11c58b64b069b76 "github.com/microsoftgraph/msgraph-beta-sdk-go/onpremisespublishingprofiles/item/agentgroups/item/publishedresources/item/agentgroups/item/agents/item/agentgroups"
    i012b6278b052be8c16a961cee43fb6a107ac96d835044999e958fc89ae22bdc7 "github.com/microsoftgraph/msgraph-beta-sdk-go/onpremisespublishingprofiles/item/agentgroups/item/publishedresources/item/agentgroups/item/agents/item/agentgroups/item"
)
...
func (m *OnPremisesAgentItemRequestBuilder) AgentGroups()(*ie9e4451316873b30d0e3b0d217b7ba5b813e2192770a0d73d11c58b64b069b76.AgentGroupsRequestBuilder) {
    return ie9e4451316873b30d0e3b0d217b7ba5b813e2192770a0d73d11c58b64b069b76.NewAgentGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// AgentGroupsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.onPremisesPublishingProfiles.item.agentGroups.item.publishedResources.item.agentGroups.item.agents.item.agentGroups.item collection
func (m *OnPremisesAgentItemRequestBuilder) AgentGroupsById(id string)(*i012b6278b052be8c16a961cee43fb6a107ac96d835044999e958fc89ae22bdc7.OnPremisesAgentGroupItemRequestBuilder) {
    ...
    return i012b6278b052be8c16a961cee43fb6a107ac96d835044999e958fc89ae22bdc7.NewOnPremisesAgentGroupItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func NewOnPremisesAgentItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnPremisesAgentItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups/{onPremisesAgentGroup%2Did1}/agents/{onPremisesAgent%2Did}{?%24select,%24expand}";
    urlTplParams := make(map[string]string)
...
func (m *OnPremisesAgentItemRequestBuilder) CreateDeleteRequestInformation(options *OnPremisesAgentItemRequestBuilderDeleteOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OnPremisesAgentItemRequestBuilder) CreateGetRequestInformation(options *OnPremisesAgentItemRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *OnPremisesAgentItemRequestBuilder) CreatePatchRequestInformation(options *OnPremisesAgentItemRequestBuilderPatchOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *OnPremisesAgentItemRequestBuilder) Get(options *OnPremisesAgentItemRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OnPremisesAgentable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateOnPremisesAgentFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
