...
import (
    ...
    if751137daa4c6801fb50b36e9eadb14cc72967a6e28c8625a224654a950a2a21 "github.com/microsoftgraph/msgraph-beta-sdk-go/onpremisespublishingprofiles/item/agentgroups/item/publishedresources/item/agentgroups/item/agents/count"
)
...
func NewAgentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AgentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups/{onPremisesAgentGroup%2Did1}/agents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AgentsRequestBuilder) Count()(*if751137daa4c6801fb50b36e9eadb14cc72967a6e28c8625a224654a950a2a21.CountRequestBuilder) {
    return if751137daa4c6801fb50b36e9eadb14cc72967a6e28c8625a224654a950a2a21.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
