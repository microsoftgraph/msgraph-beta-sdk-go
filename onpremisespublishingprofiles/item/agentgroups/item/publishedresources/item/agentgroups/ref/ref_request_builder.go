...
// RefRequestBuilder provides operations to manage the collection of onPremisesPublishingProfile entities.
...
// RefRequestBuilderGetQueryParameters list of onPremisesAgentGroups that a publishedResource is assigned to. Read-only. Nullable.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups/$ref{?%24top,%24skip,%24search,%24filter,%24count,%24orderby}";
...
// CreatePostRequestInformation create new navigation property ref to agentGroups for onPremisesPublishingProfiles
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property ref to agentGroups for onPremisesPublishingProfiles
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property ref to agentGroups for onPremisesPublishingProfiles
