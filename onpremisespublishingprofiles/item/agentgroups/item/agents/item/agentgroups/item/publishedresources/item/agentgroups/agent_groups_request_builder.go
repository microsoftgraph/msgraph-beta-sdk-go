...
import (
    ...
    idc67211a4d26a23fbb6f72aca7423e29f61d4d29b573edbf491857022482608f "github.com/microsoftgraph/msgraph-beta-sdk-go/onpremisespublishingprofiles/item/agentgroups/item/agents/item/agentgroups/item/publishedresources/item/agentgroups/count"
)
...
func NewAgentGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AgentGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/agents/{onPremisesAgent%2Did}/agentGroups/{onPremisesAgentGroup%2Did1}/publishedResources/{publishedResource%2Did}/agentGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AgentGroupsRequestBuilder) Count()(*idc67211a4d26a23fbb6f72aca7423e29f61d4d29b573edbf491857022482608f.CountRequestBuilder) {
    return idc67211a4d26a23fbb6f72aca7423e29f61d4d29b573edbf491857022482608f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
