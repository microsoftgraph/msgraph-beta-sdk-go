...
import (
    ...
    i794d788563c08760cd018ce716f018163b9117dd947dfbf5c3e8cc1a075a8a3d "github.com/microsoftgraph/msgraph-beta-sdk-go/onpremisespublishingprofiles/item/publishedresources/item/agentgroups/item/agents/count"
)
...
func NewAgentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AgentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/publishedResources/{publishedResource%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/agents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *AgentsRequestBuilder) Count()(*i794d788563c08760cd018ce716f018163b9117dd947dfbf5c3e8cc1a075a8a3d.CountRequestBuilder) {
    return i794d788563c08760cd018ce716f018163b9117dd947dfbf5c3e8cc1a075a8a3d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
