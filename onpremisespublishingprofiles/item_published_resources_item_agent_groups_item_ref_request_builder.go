...
func (m *ItemPublishedResourcesItemAgentGroupsItemRefRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemPublishedResourcesItemAgentGroupsItemRefRequestBuilderDeleteRequestConfiguration)([]byte, error) {
