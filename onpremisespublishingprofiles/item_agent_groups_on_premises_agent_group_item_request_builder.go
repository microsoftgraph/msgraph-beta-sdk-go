...
func (m *ItemAgentGroupsOnPremisesAgentGroupItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemAgentGroupsOnPremisesAgentGroupItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
