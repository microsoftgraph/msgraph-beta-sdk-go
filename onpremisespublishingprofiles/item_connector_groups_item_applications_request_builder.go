...
func (m *ItemConnectorGroupsItemApplicationsRequestBuilder) Count()(*ItemConnectorGroupsItemApplicationsCountRequestBuilder) {
    return NewItemConnectorGroupsItemApplicationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get applications from onPremisesPublishingProfiles
func (m *ItemConnectorGroupsItemApplicationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemConnectorGroupsItemApplicationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
