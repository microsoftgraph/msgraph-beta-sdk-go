...
func (m *ItemAgentsItemAgentGroupsItemRefRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemAgentsItemAgentGroupsItemRefRequestBuilderDeleteRequestConfiguration)([]byte, error) {
