...
func (m *ItemAgentsOnPremisesAgentItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemAgentsOnPremisesAgentItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
