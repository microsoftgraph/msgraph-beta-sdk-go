...
func (m *ItemAgentGroupsItemPublishedResourcesItemAgentGroupsRequestBuilder) Count()(*ItemAgentGroupsItemPublishedResourcesItemAgentGroupsCountRequestBuilder) {
    return NewItemAgentGroupsItemPublishedResourcesItemAgentGroupsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list of onPremisesAgentGroups that a publishedResource is assigned to. Read-only. Nullable.
func (m *ItemAgentGroupsItemPublishedResourcesItemAgentGroupsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemAgentGroupsItemPublishedResourcesItemAgentGroupsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemAgentGroupsItemPublishedResourcesItemAgentGroupsRequestBuilder) Ref()(*ItemAgentGroupsItemPublishedResourcesItemAgentGroupsRefRequestBuilder) {
    return NewItemAgentGroupsItemPublishedResourcesItemAgentGroupsRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
