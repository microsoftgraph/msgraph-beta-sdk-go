...
// NewItemAgentGroupsItemAgentsRequestBuilderInternal instantiates a new AgentsRequestBuilder and sets the default values.
...
// NewItemAgentGroupsItemAgentsRequestBuilder instantiates a new AgentsRequestBuilder and sets the default values.
...
func (m *ItemAgentGroupsItemAgentsRequestBuilder) Count()(*ItemAgentGroupsItemAgentsCountRequestBuilder) {
    return NewItemAgentGroupsItemAgentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list of onPremisesAgent that are assigned to an onPremisesAgentGroup. Read-only. Nullable.
func (m *ItemAgentGroupsItemAgentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemAgentGroupsItemAgentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
