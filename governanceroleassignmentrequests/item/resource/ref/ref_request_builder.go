...
// RefRequestBuilder builds and executes requests for operations under \governanceRoleAssignmentRequests\{governanceRoleAssignmentRequest-id}\resource\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequest_id}/resource/$ref";
...
// CreateDeleteRequestInformation read-only. The resource that the request aims to.
...
// CreatePutRequestInformation read-only. The resource that the request aims to.
...
// Delete read-only. The resource that the request aims to.
...
// Put read-only. The resource that the request aims to.
