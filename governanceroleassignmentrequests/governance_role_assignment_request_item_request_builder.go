...
func (m *GovernanceRoleAssignmentRequestItemRequestBuilder) MicrosoftGraphCancel()(*ItemMicrosoftGraphCancelRequestBuilder) {
...
func (m *GovernanceRoleAssignmentRequestItemRequestBuilder) MicrosoftGraphUpdateRequest()(*ItemMicrosoftGraphUpdateRequestRequestBuilder) {
    return NewItemMicrosoftGraphUpdateRequestRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
