...
// NewItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilderInternal instantiates a new ItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilder and sets the default values.
func NewItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilder) {
    m := &ItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/threatAssessmentRequests/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilder instantiates a new ItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilder and sets the default values.
...
func (m *ItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilder) {
    return NewItemSitesItemInformationprotectionThreatassessmentrequestsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
