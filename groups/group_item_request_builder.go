...
func (m *GroupItemRequestBuilder) MicrosoftGraphEvaluateDynamicMembership()(*ItemMicrosoftGraphEvaluateDynamicMembershipEvaluateDynamicMembershipRequestBuilder) {
    return NewItemMicrosoftGraphEvaluateDynamicMembershipEvaluateDynamicMembershipRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *GroupItemRequestBuilder) SettingsById(id string)(*ItemSettingsDirectorySettingItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemSettingsDirectorySettingItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
