...
func (m *GroupItemRequestBuilder) DeletePasswordSingleSignOnCredentials()(*ItemDeletepasswordsinglesignoncredentialsDeletePasswordSingleSignOnCredentialsRequestBuilder) {
...
func (m *GroupItemRequestBuilder) EvaluateDynamicMembership()(*ItemEvaluatedynamicmembershipEvaluateDynamicMembershipRequestBuilder) {
    return NewItemEvaluatedynamicmembershipEvaluateDynamicMembershipRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *GroupItemRequestBuilder) GetPasswordSingleSignOnCredentials()(*ItemGetpasswordsinglesignoncredentialsGetPasswordSingleSignOnCredentialsRequestBuilder) {
