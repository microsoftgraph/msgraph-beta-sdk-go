...
func (m *GroupItemRequestBuilder) MicrosoftGraphEvaluateDynamicMembership()(*ItemMicrosoftGraphEvaluateDynamicMembershipRequestBuilder) {
    return NewItemMicrosoftGraphEvaluateDynamicMembershipRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
