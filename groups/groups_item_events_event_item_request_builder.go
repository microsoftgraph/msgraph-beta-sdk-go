...
// GroupsItemEventsEventItemRequestBuilderGetQueryParameters the group's events.
...
func (m *GroupsItemEventsEventItemRequestBuilder) ExceptionOccurrences()(*GroupsItemEventsItemExceptionOccurrencesRequestBuilder) {
    return NewGroupsItemEventsItemExceptionOccurrencesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *GroupsItemEventsEventItemRequestBuilder) ExceptionOccurrencesById(id string)(*GroupsItemEventsItemExceptionOccurrencesEventItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewGroupsItemEventsItemExceptionOccurrencesEventItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *GroupsItemEventsEventItemRequestBuilder) Get(ctx context.Context, requestConfiguration *GroupsItemEventsEventItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Eventable, error) {
...
func (m *GroupsItemEventsEventItemRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Eventable, requestConfiguration *GroupsItemEventsEventItemRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Eventable, error) {
