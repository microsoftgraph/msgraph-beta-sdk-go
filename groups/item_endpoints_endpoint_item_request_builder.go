...
// ItemEndpointsEndpointItemRequestBuilderGetQueryParameters retrieve the properties and relationships of a specific endpoint object. This API is supported in the following national cloud deployments.
...
// Get retrieve the properties and relationships of a specific endpoint object. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve the properties and relationships of a specific endpoint object. This API is supported in the following national cloud deployments.
