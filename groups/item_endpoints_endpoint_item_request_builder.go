...
// ItemEndpointsEndpointItemRequestBuilderGetQueryParameters retrieve the properties and relationships of a specific endpoint object. This API is available in the following national cloud deployments.
...
func NewItemEndpointsEndpointItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemEndpointsEndpointItemRequestBuilder) {
    m := &ItemEndpointsEndpointItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/endpoints/{endpoint%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get retrieve the properties and relationships of a specific endpoint object. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve the properties and relationships of a specific endpoint object. This API is available in the following national cloud deployments.
