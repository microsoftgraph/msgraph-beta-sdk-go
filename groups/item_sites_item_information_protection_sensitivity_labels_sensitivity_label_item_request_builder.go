...
func (m *ItemSitesItemInformationProtectionSensitivityLabelsSensitivityLabelItemRequestBuilder) Rights()(*ItemSitesItemInformationProtectionSensitivityLabelsItemRightsRequestBuilder) {
    return NewItemSitesItemInformationProtectionSensitivityLabelsItemRightsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
