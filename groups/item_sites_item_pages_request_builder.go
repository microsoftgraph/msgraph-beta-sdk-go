...
// Get get the collection of baseSitePage][] objects from the site pages [list][] in a [site][]. All pages in the site are returned (with pagination). Sort alphabetically by name in ascending order. The following table lists the available subtypes. This API is supported in the following [national cloud deployments.
// [Find more info here]
// 
...
// Post create a new sitePage][] in the site pages [list][] in a [site][]. This API is supported in the following [national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation create a new sitePage][] in the site pages [list][] in a [site][]. This API is supported in the following [national cloud deployments.
