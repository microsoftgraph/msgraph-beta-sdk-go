...
// ItemTeamAllChannelsRequestBuilderGetQueryParameters list of channels either hosted in or shared with the team (incoming channels).
...
// NewItemTeamAllChannelsRequestBuilderInternal instantiates a new ItemTeamAllChannelsRequestBuilder and sets the default values.
func NewItemTeamAllChannelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamAllChannelsRequestBuilder) {
    m := &ItemTeamAllChannelsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/allChannels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemTeamAllChannelsRequestBuilder instantiates a new ItemTeamAllChannelsRequestBuilder and sets the default values.
...
// returns a *ItemTeamAllChannelsCountRequestBuilder when successful
