...
// ItemTeamPermissionGrantsRequestBuilderGetQueryParameters list all resource-specific permission grants on the team. This list specifies the Azure AD apps that have access to the **team**, along with the corresponding kind of resource-specific access that each app has.
...
func (m *ItemTeamPermissionGrantsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamPermissionGrantsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ResourceSpecificPermissionGrantCollectionResponseable, error) {
...
func (m *ItemTeamPermissionGrantsRequestBuilder) MicrosoftGraphGetByIds()(*ItemTeamPermissionGrantsMicrosoftGraphGetByIdsRequestBuilder) {
    return NewItemTeamPermissionGrantsMicrosoftGraphGetByIdsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetUserOwnedObjects provides operations to call the getUserOwnedObjects method.
func (m *ItemTeamPermissionGrantsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*ItemTeamPermissionGrantsMicrosoftGraphGetUserOwnedObjectsRequestBuilder) {
    return NewItemTeamPermissionGrantsMicrosoftGraphGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphValidateProperties provides operations to call the validateProperties method.
func (m *ItemTeamPermissionGrantsRequestBuilder) MicrosoftGraphValidateProperties()(*ItemTeamPermissionGrantsMicrosoftGraphValidatePropertiesRequestBuilder) {
    return NewItemTeamPermissionGrantsMicrosoftGraphValidatePropertiesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
