...
func (m *ItemTeamPermissionGrantsRequestBuilder) ByResourceSpecificPermissionGrantIdString(resourceSpecificPermissionGrantId string)(*ItemTeamPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) {
...
func (m *ItemTeamPermissionGrantsRequestBuilder) GetUserOwnedObjects()(*ItemTeamPermissionGrantsGetUserOwnedObjectsRequestBuilder) {
    return NewItemTeamPermissionGrantsGetUserOwnedObjectsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
