...
// ItemSitesItemListsListItemRequestBuilderGetQueryParameters return the metadata for a list][]. This API is available in the following [national cloud deployments.
