...
func (m *ItemCalendarEventsItemInstancesItemExceptionOccurrencesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarEventsItemInstancesItemExceptionOccurrencesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemCalendarEventsItemInstancesItemExceptionOccurrencesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
