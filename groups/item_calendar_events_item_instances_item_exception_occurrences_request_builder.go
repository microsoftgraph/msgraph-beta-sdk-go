...
func (m *ItemCalendarEventsItemInstancesItemExceptionOccurrencesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemCalendarEventsItemInstancesItemExceptionOccurrencesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemCalendarEventsItemInstancesItemExceptionOccurrencesRequestBuilder) Delta()(*ItemCalendarEventsItemInstancesItemExceptionOccurrencesDeltaRequestBuilder) {
    return NewItemCalendarEventsItemInstancesItemExceptionOccurrencesDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
