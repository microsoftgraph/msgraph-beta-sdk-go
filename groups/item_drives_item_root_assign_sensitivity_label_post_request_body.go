...
// ItemDrivesItemRootAssignSensitivityLabelPostRequestBody 
...
func (m *ItemDrivesItemRootAssignSensitivityLabelPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemDrivesItemRootAssignSensitivityLabelPostRequestBody) SetAdditionalData(value map[string]any)() {
