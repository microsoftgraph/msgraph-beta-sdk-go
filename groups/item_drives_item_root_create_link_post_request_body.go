...
func (m *ItemDrivesItemRootCreateLinkPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemDrivesItemRootCreateLinkPostRequestBody) GetRecipients()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveRecipientable) {
    return m.recipients
}
...
func (m *ItemDrivesItemRootCreateLinkPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ItemDrivesItemRootCreateLinkPostRequestBody) SetRecipients(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveRecipientable)() {
    m.recipients = value
}
