...
func (m *GroupsGroupItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Groupable, requestConfiguration *GroupsGroupItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *GroupsGroupItemRequestBuilder) Endpoints()(*GroupsItemEndpointsRequestBuilder) {
    return NewGroupsItemEndpointsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// EndpointsById provides operations to manage the endpoints property of the microsoft.graph.group entity.
func (m *GroupsGroupItemRequestBuilder) EndpointsById(id string)(*GroupsItemEndpointsEndpointItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewGroupsItemEndpointsEndpointItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
// EvaluateDynamicMembership provides operations to call the evaluateDynamicMembership method.
func (m *GroupsGroupItemRequestBuilder) EvaluateDynamicMembership()(*GroupsItemEvaluateDynamicMembershipRequestBuilder) {
    return NewGroupsItemEvaluateDynamicMembershipRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *GroupsGroupItemRequestBuilder) Get(ctx context.Context, requestConfiguration *GroupsGroupItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Groupable, error) {
...
func (m *GroupsGroupItemRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Groupable, requestConfiguration *GroupsGroupItemRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Groupable, error) {
...
func (m *GroupsGroupItemRequestBuilder) SettingsById(id string)(*GroupsItemSettingsDirectorySettingItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewGroupsItemSettingsDirectorySettingItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
