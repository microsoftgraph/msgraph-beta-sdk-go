...
// ToDeleteRequestInformation delete navigation property thumbnails for groups
...
// ToPatchRequestInformation update the navigation property thumbnails in groups
