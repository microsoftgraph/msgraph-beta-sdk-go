...
func (m *ItemTeamScheduleTimeCardsRequestBuilder) MicrosoftGraphClockIn()(*ItemTeamScheduleTimeCardsMicrosoftGraphClockInRequestBuilder) {
    return NewItemTeamScheduleTimeCardsMicrosoftGraphClockInRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
