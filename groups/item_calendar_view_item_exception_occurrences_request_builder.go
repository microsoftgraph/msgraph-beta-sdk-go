...
func (m *ItemCalendarViewItemExceptionOccurrencesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarViewItemExceptionOccurrencesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemCalendarViewItemExceptionOccurrencesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
