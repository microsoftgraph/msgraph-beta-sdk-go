...
func (m *ItemCalendarViewItemExceptionOccurrencesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarViewItemExceptionOccurrencesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemCalendarViewItemExceptionOccurrencesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
