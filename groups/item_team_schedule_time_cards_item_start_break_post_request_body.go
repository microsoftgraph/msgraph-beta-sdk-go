...
// ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody provides operations to call the startBreak method.
...
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) GetAtApprovedLocation()(*bool) {
...
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) GetNotes()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ItemBodyable) {
    return m.notes
}
...
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) SetAtApprovedLocation(value *bool)() {
    m.atApprovedLocation = value
}
// SetNotes sets the notes property value. The notes property
func (m *ItemTeamScheduleTimeCardsItemStartBreakPostRequestBody) SetNotes(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ItemBodyable)() {
    m.notes = value
}
