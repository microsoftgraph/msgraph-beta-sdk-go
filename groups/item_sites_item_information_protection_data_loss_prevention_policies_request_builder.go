...
func (m *ItemSitesItemInformationProtectionDataLossPreventionPoliciesRequestBuilder) MicrosoftGraphEvaluate()(*ItemSitesItemInformationProtectionDataLossPreventionPoliciesMicrosoftGraphEvaluateRequestBuilder) {
    return NewItemSitesItemInformationProtectionDataLossPreventionPoliciesMicrosoftGraphEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
