...
func (m *ItemSitesItemInformationProtectionDataLossPreventionPoliciesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemInformationProtectionDataLossPreventionPoliciesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DataLossPreventionPolicyCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDataLossPreventionPolicyCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemSitesItemInformationProtectionDataLossPreventionPoliciesRequestBuilder) MicrosoftGraphEvaluate()(*ItemSitesItemInformationProtectionDataLossPreventionPoliciesMicrosoftGraphEvaluateEvaluateRequestBuilder) {
    return NewItemSitesItemInformationProtectionDataLossPreventionPoliciesMicrosoftGraphEvaluateEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
