...
// NewItemTeamTagsCountRequestBuilderInternal instantiates a new ItemTeamTagsCountRequestBuilder and sets the default values.
func NewItemTeamTagsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamTagsCountRequestBuilder) {
    m := &ItemTeamTagsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/tags/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemTeamTagsCountRequestBuilder instantiates a new ItemTeamTagsCountRequestBuilder and sets the default values.
...
func (m *ItemTeamTagsCountRequestBuilder) WithUrl(rawUrl string)(*ItemTeamTagsCountRequestBuilder) {
    return NewItemTeamTagsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
