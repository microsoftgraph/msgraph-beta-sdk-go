...
// NewItemTeamScheduleTimeCardsItemStartBreakRequestBuilderInternal instantiates a new StartBreakRequestBuilder and sets the default values.
func NewItemTeamScheduleTimeCardsItemStartBreakRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamScheduleTimeCardsItemStartBreakRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/team/schedule/timeCards/{timeCard%2Did}/startBreak";
...
// NewItemTeamScheduleTimeCardsItemStartBreakRequestBuilder instantiates a new StartBreakRequestBuilder and sets the default values.
