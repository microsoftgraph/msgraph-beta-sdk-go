...
func (m *ItemEventsItemInstancesItemExceptionOccurrencesRequestBuilder) MicrosoftGraphDelta()(*ItemEventsItemInstancesItemExceptionOccurrencesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemEventsItemInstancesItemExceptionOccurrencesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
