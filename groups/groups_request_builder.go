...
func (m *GroupsRequestBuilder) EvaluateDynamicMembership()(*GroupsEvaluateDynamicMembershipRequestBuilder) {
    return NewGroupsEvaluateDynamicMembershipRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *GroupsRequestBuilder) GetUserOwnedObjects()(*GroupsGetUserOwnedObjectsRequestBuilder) {
    return NewGroupsGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
