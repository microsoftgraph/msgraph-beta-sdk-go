...
func (m *GroupsRequestBuilder) MicrosoftGraphEvaluateDynamicMembership()(*MicrosoftGraphEvaluateDynamicMembershipRequestBuilder) {
    return NewMicrosoftGraphEvaluateDynamicMembershipRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *GroupsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*MicrosoftGraphGetUserOwnedObjectsRequestBuilder) {
