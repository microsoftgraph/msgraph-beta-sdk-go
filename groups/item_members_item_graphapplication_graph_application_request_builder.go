...
type ItemMembersItemGraphapplicationGraphApplicationRequestBuilderGetQueryParameters struct {
...
type ItemMembersItemGraphapplicationGraphApplicationRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemMembersItemGraphapplicationGraphApplicationRequestBuilderGetQueryParameters
}
...
func NewItemMembersItemGraphapplicationGraphApplicationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersItemGraphapplicationGraphApplicationRequestBuilder) {
    m := &ItemMembersItemGraphapplicationGraphApplicationRequestBuilder{
...
func NewItemMembersItemGraphapplicationGraphApplicationRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersItemGraphapplicationGraphApplicationRequestBuilder) {
    ...
    return NewItemMembersItemGraphapplicationGraphApplicationRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemMembersItemGraphapplicationGraphApplicationRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMembersItemGraphapplicationGraphApplicationRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Applicationable, error) {
...
func (m *ItemMembersItemGraphapplicationGraphApplicationRequestBuilder) WithUrl(rawUrl string)(*ItemMembersItemGraphapplicationGraphApplicationRequestBuilder) {
    return NewItemMembersItemGraphapplicationGraphApplicationRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
