...
// NewItemSitesItemGetByPathWithPathGetByPathWithPath1RecycleBinRequestBuilderInternal instantiates a new RecycleBinRequestBuilder and sets the default values.
func NewItemSitesItemGetByPathWithPathGetByPathWithPath1RecycleBinRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemGetByPathWithPathGetByPathWithPath1RecycleBinRequestBuilder) {
    m := &ItemSitesItemGetByPathWithPathGetByPathWithPath1RecycleBinRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')/recycleBin{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemSitesItemGetByPathWithPathGetByPathWithPath1RecycleBinRequestBuilder instantiates a new RecycleBinRequestBuilder and sets the default values.
