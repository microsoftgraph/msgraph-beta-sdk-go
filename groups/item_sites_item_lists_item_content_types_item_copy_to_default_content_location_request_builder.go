...
// NewItemSitesItemListsItemContentTypesItemCopyToDefaultContentLocationRequestBuilderInternal instantiates a new ItemSitesItemListsItemContentTypesItemCopyToDefaultContentLocationRequestBuilder and sets the default values.
...
// NewItemSitesItemListsItemContentTypesItemCopyToDefaultContentLocationRequestBuilder instantiates a new ItemSitesItemListsItemContentTypesItemCopyToDefaultContentLocationRequestBuilder and sets the default values.
...
func (m *ItemSitesItemListsItemContentTypesItemCopyToDefaultContentLocationRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemListsItemContentTypesItemCopyToDefaultContentLocationRequestBuilder) {
    return NewItemSitesItemListsItemContentTypesItemCopyToDefaultContentLocationRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
