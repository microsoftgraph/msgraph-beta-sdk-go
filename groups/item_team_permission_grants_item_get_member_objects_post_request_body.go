...
// ItemTeamPermissionGrantsItemGetMemberObjectsPostRequestBody provides operations to call the getMemberObjects method.
...
func (m *ItemTeamPermissionGrantsItemGetMemberObjectsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemTeamPermissionGrantsItemGetMemberObjectsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
