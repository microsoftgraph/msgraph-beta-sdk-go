...
func (m *ItemGroupLifecyclePoliciesRequestBuilder) MicrosoftGraphRenewGroup()(*ItemGroupLifecyclePoliciesMicrosoftGraphRenewGroupRequestBuilder) {
    return NewItemGroupLifecyclePoliciesMicrosoftGraphRenewGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
