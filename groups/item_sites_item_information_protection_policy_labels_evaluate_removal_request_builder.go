...
// NewItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalRequestBuilderInternal instantiates a new ItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalRequestBuilder and sets the default values.
...
// NewItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalRequestBuilder instantiates a new ItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalRequestBuilder and sets the default values.
...
// returns a ItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalResponseable when successful
...
// returns a ItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalPostResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/informationprotectionlabel-evaluateremoval?view=graph-rest-1.0
func (m *ItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalRequestBuilder) PostAsEvaluateRemovalPostResponse(ctx context.Context, body ItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalPostRequestBodyable, requestConfiguration *ItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalRequestBuilderPostRequestConfiguration)(ItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalPostResponseable, error) {
    requestInfo, err := m.ToPostRequestInformation(ctx, body, requestConfiguration);
    if err != nil {
        return nil, err
    }
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalPostResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalPostResponseable), nil
}
...
func (m *ItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalRequestBuilder) {
    return NewItemSitesItemInformationProtectionPolicyLabelsEvaluateRemovalRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
