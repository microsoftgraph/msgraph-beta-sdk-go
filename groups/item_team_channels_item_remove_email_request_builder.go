...
// NewItemTeamChannelsItemRemoveEmailRequestBuilderInternal instantiates a new ItemTeamChannelsItemRemoveEmailRequestBuilder and sets the default values.
func NewItemTeamChannelsItemRemoveEmailRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamChannelsItemRemoveEmailRequestBuilder) {
    m := &ItemTeamChannelsItemRemoveEmailRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/removeEmail", pathParameters),
    }
    return m
}
// NewItemTeamChannelsItemRemoveEmailRequestBuilder instantiates a new ItemTeamChannelsItemRemoveEmailRequestBuilder and sets the default values.
...
func (m *ItemTeamChannelsItemRemoveEmailRequestBuilder) WithUrl(rawUrl string)(*ItemTeamChannelsItemRemoveEmailRequestBuilder) {
    return NewItemTeamChannelsItemRemoveEmailRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
