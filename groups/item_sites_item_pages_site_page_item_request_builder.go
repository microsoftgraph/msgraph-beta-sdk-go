...
func (m *ItemSitesItemPagesSitePageItemRequestBuilder) MicrosoftGraphGetWebPartsByPosition()(*ItemSitesItemPagesItemMicrosoftGraphGetWebPartsByPositionRequestBuilder) {
    return NewItemSitesItemPagesItemMicrosoftGraphGetWebPartsByPositionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphPublish provides operations to call the publish method.
func (m *ItemSitesItemPagesSitePageItemRequestBuilder) MicrosoftGraphPublish()(*ItemSitesItemPagesItemMicrosoftGraphPublishRequestBuilder) {
    return NewItemSitesItemPagesItemMicrosoftGraphPublishRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
