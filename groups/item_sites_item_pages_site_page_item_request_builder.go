...
func NewItemSitesItemPagesSitePageItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, sitePageId *string)(*ItemSitesItemPagesSitePageItemRequestBuilder) {
...
func NewItemSitesItemPagesSitePageItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemPagesSitePageItemRequestBuilder) {
    ...
    return NewItemSitesItemPagesSitePageItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ItemSitesItemPagesSitePageItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemPagesSitePageItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SitePageable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateSitePageFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphGetWebPartsByPosition provides operations to call the getWebPartsByPosition method.
func (m *ItemSitesItemPagesSitePageItemRequestBuilder) MicrosoftGraphGetWebPartsByPosition()(*ItemSitesItemPagesItemMicrosoftGraphGetWebPartsByPositionGetWebPartsByPositionRequestBuilder) {
    return NewItemSitesItemPagesItemMicrosoftGraphGetWebPartsByPositionGetWebPartsByPositionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphPublish provides operations to call the publish method.
func (m *ItemSitesItemPagesSitePageItemRequestBuilder) MicrosoftGraphPublish()(*ItemSitesItemPagesItemMicrosoftGraphPublishPublishRequestBuilder) {
    return NewItemSitesItemPagesItemMicrosoftGraphPublishPublishRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemSitesItemPagesSitePageItemRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSitesItemPagesSitePageItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ItemSitesItemPagesSitePageItemRequestBuilder) WebPartsById(id string)(*ItemSitesItemPagesItemWebPartsWebPartItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemSitesItemPagesItemWebPartsWebPartItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
