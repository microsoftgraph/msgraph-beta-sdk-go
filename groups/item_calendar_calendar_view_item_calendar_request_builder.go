...
// NewItemCalendarCalendarViewItemCalendarRequestBuilderInternal instantiates a new ItemCalendarCalendarViewItemCalendarRequestBuilder and sets the default values.
func NewItemCalendarCalendarViewItemCalendarRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarCalendarViewItemCalendarRequestBuilder) {
    m := &ItemCalendarCalendarViewItemCalendarRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/calendar{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemCalendarCalendarViewItemCalendarRequestBuilder instantiates a new ItemCalendarCalendarViewItemCalendarRequestBuilder and sets the default values.
...
func (m *ItemCalendarCalendarViewItemCalendarRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCalendarCalendarViewItemCalendarRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Calendarable, error) {
