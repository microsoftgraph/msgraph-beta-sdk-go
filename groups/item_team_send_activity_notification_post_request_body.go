...
func (m *ItemTeamSendActivityNotificationPostRequestBody) GetTeamsAppId()(*string) {
...
func (m *ItemTeamSendActivityNotificationPostRequestBody) SetTeamsAppId(value *string)() {
