...
// NewItemCalendarEventsItemInstancesItemExceptionoccurrencesItemCancelRequestBuilderInternal instantiates a new ItemCalendarEventsItemInstancesItemExceptionoccurrencesItemCancelRequestBuilder and sets the default values.
func NewItemCalendarEventsItemInstancesItemExceptionoccurrencesItemCancelRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarEventsItemInstancesItemExceptionoccurrencesItemCancelRequestBuilder) {
    m := &ItemCalendarEventsItemInstancesItemExceptionoccurrencesItemCancelRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/cancel", pathParameters),
    }
    return m
}
// NewItemCalendarEventsItemInstancesItemExceptionoccurrencesItemCancelRequestBuilder instantiates a new ItemCalendarEventsItemInstancesItemExceptionoccurrencesItemCancelRequestBuilder and sets the default values.
...
func (m *ItemCalendarEventsItemInstancesItemExceptionoccurrencesItemCancelRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarEventsItemInstancesItemExceptionoccurrencesItemCancelRequestBuilder) {
    return NewItemCalendarEventsItemInstancesItemExceptionoccurrencesItemCancelRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
