...
// NewItemThreadsItemPostsItemInReplyToMentionsCountRequestBuilder instantiates a new ItemThreadsItemPostsItemInReplyToMentionsCountRequestBuilder and sets the default values.
