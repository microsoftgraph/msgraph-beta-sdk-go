...
func (m *GroupsItemCalendarCalendarViewEventItemRequestBuilder) ExceptionOccurrences()(*GroupsItemCalendarCalendarViewItemExceptionOccurrencesRequestBuilder) {
    return NewGroupsItemCalendarCalendarViewItemExceptionOccurrencesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *GroupsItemCalendarCalendarViewEventItemRequestBuilder) ExceptionOccurrencesById(id string)(*GroupsItemCalendarCalendarViewItemExceptionOccurrencesEventItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewGroupsItemCalendarCalendarViewItemExceptionOccurrencesEventItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *GroupsItemCalendarCalendarViewEventItemRequestBuilder) Get(ctx context.Context, requestConfiguration *GroupsItemCalendarCalendarViewEventItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Eventable, error) {
