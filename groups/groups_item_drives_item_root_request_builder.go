...
// GroupsItemDrivesItemRootRequestBuilderGetQueryParameters retrieve the metadata for a driveItem in a drive by file system path or ID.
...
func (m *GroupsItemDrivesItemRootRequestBuilder) Activities()(*GroupsItemDrivesItemRootActivitiesRequestBuilder) {
    return NewGroupsItemDrivesItemRootActivitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ActivitiesById provides operations to manage the activities property of the microsoft.graph.driveItem entity.
func (m *GroupsItemDrivesItemRootRequestBuilder) ActivitiesById(id string)(*GroupsItemDrivesItemRootActivitiesItemActivityOLDItemRequestBuilder) {
    ...
    return NewGroupsItemDrivesItemRootActivitiesItemActivityOLDItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *GroupsItemDrivesItemRootRequestBuilder) AssignSensitivityLabel()(*GroupsItemDrivesItemRootAssignSensitivityLabelRequestBuilder) {
    return NewGroupsItemDrivesItemRootAssignSensitivityLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *GroupsItemDrivesItemRootRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, requestConfiguration *GroupsItemDrivesItemRootRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *GroupsItemDrivesItemRootRequestBuilder) ExtractSensitivityLabels()(*GroupsItemDrivesItemRootExtractSensitivityLabelsRequestBuilder) {
    return NewGroupsItemDrivesItemRootExtractSensitivityLabelsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *GroupsItemDrivesItemRootRequestBuilder) Get(ctx context.Context, requestConfiguration *GroupsItemDrivesItemRootRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
...
func (m *GroupsItemDrivesItemRootRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, requestConfiguration *GroupsItemDrivesItemRootRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
