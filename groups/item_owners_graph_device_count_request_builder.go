...
func (m *ItemOwnersGraphDeviceCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnersGraphDeviceCountRequestBuilderGetRequestConfiguration)(*int64, error) {
