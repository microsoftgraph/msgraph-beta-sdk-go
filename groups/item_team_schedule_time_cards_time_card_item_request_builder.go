...
func (m *ItemTeamScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphClockOut()(*ItemTeamScheduleTimeCardsItemMicrosoftGraphClockOutRequestBuilder) {
    return NewItemTeamScheduleTimeCardsItemMicrosoftGraphClockOutRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphConfirm provides operations to call the confirm method.
func (m *ItemTeamScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphConfirm()(*ItemTeamScheduleTimeCardsItemMicrosoftGraphConfirmRequestBuilder) {
    return NewItemTeamScheduleTimeCardsItemMicrosoftGraphConfirmRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEndBreak provides operations to call the endBreak method.
func (m *ItemTeamScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphEndBreak()(*ItemTeamScheduleTimeCardsItemMicrosoftGraphEndBreakRequestBuilder) {
    return NewItemTeamScheduleTimeCardsItemMicrosoftGraphEndBreakRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphStartBreak provides operations to call the startBreak method.
func (m *ItemTeamScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphStartBreak()(*ItemTeamScheduleTimeCardsItemMicrosoftGraphStartBreakRequestBuilder) {
    return NewItemTeamScheduleTimeCardsItemMicrosoftGraphStartBreakRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
