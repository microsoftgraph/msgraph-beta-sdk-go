...
func (m *ItemCalendarEventsItemExceptionOccurrencesItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarEventsItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemCalendarEventsItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
