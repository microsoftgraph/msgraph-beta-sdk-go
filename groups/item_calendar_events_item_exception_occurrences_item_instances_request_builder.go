...
func (m *ItemCalendarEventsItemExceptionOccurrencesItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarEventsItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemCalendarEventsItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
