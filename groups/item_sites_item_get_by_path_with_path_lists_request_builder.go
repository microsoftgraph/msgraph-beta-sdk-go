...
// ItemSitesItemGetByPathWithPathListsRequestBuilderGetQueryParameters get the collection of [lists][] for a [site][]. Lists with the [system][] facet are hidden by default.To list them, include system in your $select statement.
...
// NewItemSitesItemGetByPathWithPathListsRequestBuilderInternal instantiates a new ListsRequestBuilder and sets the default values.
...
// NewItemSitesItemGetByPathWithPathListsRequestBuilder instantiates a new ListsRequestBuilder and sets the default values.
...
func (m *ItemSitesItemGetByPathWithPathListsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemGetByPathWithPathListsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ListCollectionResponseable, error) {
