...
// ItemTeamPermissionGrantsGetByIdsPostRequestBody provides operations to call the getByIds method.
...
func (m *ItemTeamPermissionGrantsGetByIdsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemTeamPermissionGrantsGetByIdsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
