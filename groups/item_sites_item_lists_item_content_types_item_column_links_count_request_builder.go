...
func (m *ItemSitesItemListsItemContentTypesItemColumnLinksCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemListsItemContentTypesItemColumnLinksCountRequestBuilderGetRequestConfiguration)(*int64, error) {
