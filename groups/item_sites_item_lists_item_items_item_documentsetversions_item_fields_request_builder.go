...
// NewItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilderInternal instantiates a new ItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder and sets the default values.
func NewItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder) {
    m := &ItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}/fields{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder instantiates a new ItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder and sets the default values.
...
// returns a FieldValueSetable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.FieldValueSetable, requestConfiguration *ItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.FieldValueSetable, error) {
...
func (m *ItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder) {
    return NewItemSitesItemListsItemItemsItemDocumentsetversionsItemFieldsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
