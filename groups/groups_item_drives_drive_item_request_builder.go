...
func (m *GroupsItemDrivesDriveItemRequestBuilder) Activities()(*GroupsItemDrivesItemActivitiesRequestBuilder) {
    return NewGroupsItemDrivesItemActivitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ActivitiesById provides operations to manage the activities property of the microsoft.graph.drive entity.
func (m *GroupsItemDrivesDriveItemRequestBuilder) ActivitiesById(id string)(*GroupsItemDrivesItemActivitiesItemActivityOLDItemRequestBuilder) {
    ...
    return NewGroupsItemDrivesItemActivitiesItemActivityOLDItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *GroupsItemDrivesDriveItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Driveable, requestConfiguration *GroupsItemDrivesDriveItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *GroupsItemDrivesDriveItemRequestBuilder) Get(ctx context.Context, requestConfiguration *GroupsItemDrivesDriveItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Driveable, error) {
