...
// NewItemCalendarEventsItemDismissReminderRequestBuilderInternal instantiates a new ItemCalendarEventsItemDismissReminderRequestBuilder and sets the default values.
...
// NewItemCalendarEventsItemDismissReminderRequestBuilder instantiates a new ItemCalendarEventsItemDismissReminderRequestBuilder and sets the default values.
...
func (m *ItemCalendarEventsItemDismissReminderRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarEventsItemDismissReminderRequestBuilder) {
    return NewItemCalendarEventsItemDismissReminderRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
