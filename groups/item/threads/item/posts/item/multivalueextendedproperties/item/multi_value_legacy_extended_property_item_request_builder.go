...
// MultiValueLegacyExtendedPropertyItemRequestBuilder builds and executes requests for operations under \groups\{group-id}\threads\{conversationThread-id}\posts\{post-id}\multiValueExtendedProperties\{multiValueLegacyExtendedProperty-id}
...
// CreateDeleteRequestInformation the collection of multi-value extended properties defined for the post. Read-only. Nullable.
...
// CreatePatchRequestInformation the collection of multi-value extended properties defined for the post. Read-only. Nullable.
...
// Delete the collection of multi-value extended properties defined for the post. Read-only. Nullable.
...
// Patch the collection of multi-value extended properties defined for the post. Read-only. Nullable.
