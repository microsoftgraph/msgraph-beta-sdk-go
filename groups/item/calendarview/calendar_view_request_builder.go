...
// CalendarViewRequestBuilder builds and executes requests for operations under \groups\{group-id}\calendarView
...
// CreatePostRequestInformation the calendar view for the calendar. Read-only.
...
// Delta builds and executes requests for operations under \groups\{group-id}\calendarView\microsoft.graph.delta()
...
// Post the calendar view for the calendar. Read-only.
