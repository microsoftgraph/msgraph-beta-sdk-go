...
import (
    ...
    if6fba2043fa25e0efcb9b9ce1762c24646eb0a096db0504e2ec72d8e3ff15d72 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/calendarview/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/calendarView/{event_id}/instances/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*if6fba2043fa25e0efcb9b9ce1762c24646eb0a096db0504e2ec72d8e3ff15d72.CountRequestBuilder) {
    return if6fba2043fa25e0efcb9b9ce1762c24646eb0a096db0504e2ec72d8e3ff15d72.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
