...
import (
    ...
    i074335d9113ad64a1e7ae59806b108da9d9e9d9c0df2d6793e613db14622a984 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/calendarview/item/calendar/calendarview/delta"
)
...
func NewCalendarViewRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CalendarViewRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/groups/{group_id}/calendarView/{event_id}/calendar/calendarView{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *CalendarViewRequestBuilder) Delta()(*i074335d9113ad64a1e7ae59806b108da9d9e9d9c0df2d6793e613db14622a984.DeltaRequestBuilder) {
    return i074335d9113ad64a1e7ae59806b108da9d9e9d9c0df2d6793e613db14622a984.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
