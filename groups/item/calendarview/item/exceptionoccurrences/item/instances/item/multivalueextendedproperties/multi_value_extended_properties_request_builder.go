...
import (
    ...
    i444bc0b373c353a295bad7a271b83b98bd888175145dc63cfc986efcb83966fd "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/calendarview/item/exceptionoccurrences/item/instances/item/multivalueextendedproperties/count"
)
...
func NewMultiValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MultiValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/calendarView/{event_id}/exceptionOccurrences/{event_id1}/instances/{event_id2}/multiValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MultiValueExtendedPropertiesRequestBuilder) Count()(*i444bc0b373c353a295bad7a271b83b98bd888175145dc63cfc986efcb83966fd.CountRequestBuilder) {
    return i444bc0b373c353a295bad7a271b83b98bd888175145dc63cfc986efcb83966fd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
