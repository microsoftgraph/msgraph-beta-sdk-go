...
import (
    ...
    i7212e546a2f107abe993c4044ba644ab4493f801e79e1dce786f42618740977e "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/calendarview/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/calendarView/{event_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i7212e546a2f107abe993c4044ba644ab4493f801e79e1dce786f42618740977e.CountRequestBuilder) {
    return i7212e546a2f107abe993c4044ba644ab4493f801e79e1dce786f42618740977e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
