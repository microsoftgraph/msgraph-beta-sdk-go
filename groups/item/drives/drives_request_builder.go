...
// DrivesRequestBuilder builds and executes requests for operations under \groups\{group-id}\drives
...
func NewDrivesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DrivesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives{?top,skip,search,filter,count,orderby,select,expand}";
...
// CreatePostRequestInformation the group's drives. Read-only.
...
// Post the group's drives. Read-only.
