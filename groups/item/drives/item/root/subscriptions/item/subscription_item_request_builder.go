...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property subscriptions for groups
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property subscriptions in groups
