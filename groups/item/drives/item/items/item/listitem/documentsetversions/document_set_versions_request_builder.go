...
// CreatePostRequestInformation create new navigation property to documentSetVersions for groups
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to documentSetVersions for groups
