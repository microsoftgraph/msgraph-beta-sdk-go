...
import (
    ...
    i4ece1763fc11615c990bd00013dd862ded5f82f56b7262215d902fbbcda261bf "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/drives/item/items/item/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/items/{driveItem_id}/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i4ece1763fc11615c990bd00013dd862ded5f82f56b7262215d902fbbcda261bf.CountRequestBuilder) {
    return i4ece1763fc11615c990bd00013dd862ded5f82f56b7262215d902fbbcda261bf.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
