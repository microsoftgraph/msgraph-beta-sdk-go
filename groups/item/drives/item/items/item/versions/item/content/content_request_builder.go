...
// GetWithResponseHandler get content for the navigation property versions from groups
...
// PutWithResponseHandler update content for the navigation property versions in groups
