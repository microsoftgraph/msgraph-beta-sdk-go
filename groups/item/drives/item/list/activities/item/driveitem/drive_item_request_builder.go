...
import (
    ...
    i2026d6ade8fbabb62932790266607361d83b1a8de8b001ee053cbc6a4672ebc0 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/drives/item/list/activities/item/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/list/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i2026d6ade8fbabb62932790266607361d83b1a8de8b001ee053cbc6a4672ebc0.ContentRequestBuilder) {
    return i2026d6ade8fbabb62932790266607361d83b1a8de8b001ee053cbc6a4672ebc0.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
