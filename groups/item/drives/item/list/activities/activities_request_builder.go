...
import (
    ...
    i77505d3d3c90a4ffe2ee377455884ba57f20569f502cf10cd0167dc196bcecac "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/drives/item/list/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/list/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i77505d3d3c90a4ffe2ee377455884ba57f20569f502cf10cd0167dc196bcecac.CountRequestBuilder) {
    return i77505d3d3c90a4ffe2ee377455884ba57f20569f502cf10cd0167dc196bcecac.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
