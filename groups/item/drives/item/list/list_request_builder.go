...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property list for groups
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property list in groups
