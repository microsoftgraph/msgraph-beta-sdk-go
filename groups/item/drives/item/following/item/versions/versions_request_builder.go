...
import (
    ...
    i7a1764640d5817bfabb18f09f40d40ff5266b598044301493226b24e5242b762 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/drives/item/following/item/versions/count"
)
...
func NewVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*VersionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/versions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *VersionsRequestBuilder) Count()(*i7a1764640d5817bfabb18f09f40d40ff5266b598044301493226b24e5242b762.CountRequestBuilder) {
    return i7a1764640d5817bfabb18f09f40d40ff5266b598044301493226b24e5242b762.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
