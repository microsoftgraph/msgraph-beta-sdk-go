...
import (
    ...
    if9843d4fca584a43ffc9f752de8464a51e58e80c226db4269316f594f3e633ae "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/drives/item/following/item/children/count"
)
...
func NewChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChildrenRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ChildrenRequestBuilder) Count()(*if9843d4fca584a43ffc9f752de8464a51e58e80c226db4269316f594f3e633ae.CountRequestBuilder) {
    return if9843d4fca584a43ffc9f752de8464a51e58e80c226db4269316f594f3e633ae.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ChildrenRequestBuilder) Get(options *ChildrenRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DriveItemCollectionResponseable, error) {
