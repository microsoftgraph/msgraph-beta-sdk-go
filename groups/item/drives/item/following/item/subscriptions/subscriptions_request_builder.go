...
import (
    ...
    id2eba5d50ffbe2d5f59f153d0bf13a437475db4d381e8db871c1d04f63cf6762 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/drives/item/following/item/subscriptions/count"
)
...
func (m *SubscriptionsRequestBuilder) Count()(*id2eba5d50ffbe2d5f59f153d0bf13a437475db4d381e8db871c1d04f63cf6762.CountRequestBuilder) {
    return id2eba5d50ffbe2d5f59f153d0bf13a437475db4d381e8db871c1d04f63cf6762.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
