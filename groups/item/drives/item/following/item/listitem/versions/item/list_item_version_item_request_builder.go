...
import (
    ...
    i8e93f8d63d8e1ab41604bb1de2f1311bcf581b996414aabb2b1b574e103203b1 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/drives/item/following/item/listitem/versions/item/fields"
    ic034f44bbb67304de733a4a3077087bf6ff5fe9b13bcf91cc804caed82ac0f7c "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/drives/item/following/item/listitem/versions/item/restoreversion"
)
...
type ListItemVersionItemRequestBuilderGetOptions struct {
    ...
    Q *ListItemVersionItemRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
func NewListItemVersionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ListItemVersionItemRequestBuilder) {
    m := &ListItemVersionItemRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/listItem/versions/{listItemVersion_id}{?select,expand}";
...
func NewListItemVersionItemRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ListItemVersionItemRequestBuilder) {
...
func (m *ListItemVersionItemRequestBuilder) CreateGetRequestInformation(options *ListItemVersionItemRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ListItemVersionItemRequestBuilder) Fields()(*i8e93f8d63d8e1ab41604bb1de2f1311bcf581b996414aabb2b1b574e103203b1.FieldsRequestBuilder) {
    return i8e93f8d63d8e1ab41604bb1de2f1311bcf581b996414aabb2b1b574e103203b1.NewFieldsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ListItemVersionItemRequestBuilder) RestoreVersion()(*ic034f44bbb67304de733a4a3077087bf6ff5fe9b13bcf91cc804caed82ac0f7c.RestoreVersionRequestBuilder) {
    return ic034f44bbb67304de733a4a3077087bf6ff5fe9b13bcf91cc804caed82ac0f7c.NewRestoreVersionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
