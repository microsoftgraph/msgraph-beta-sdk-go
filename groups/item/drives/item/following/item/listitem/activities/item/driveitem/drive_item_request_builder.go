...
import (
    ...
    i5b2609aedb2d017068653fd4b505342015cb1214522eec58b0e2c6e89b1b77ae "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/drives/item/following/item/listitem/activities/item/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i5b2609aedb2d017068653fd4b505342015cb1214522eec58b0e2c6e89b1b77ae.ContentRequestBuilder) {
    return i5b2609aedb2d017068653fd4b505342015cb1214522eec58b0e2c6e89b1b77ae.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
