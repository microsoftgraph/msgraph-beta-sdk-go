...
import (
    ...
    i107d6c518f21c0bb26b5dbb36befa0be4f68faa005d7a9fa4dea3296c6482be8 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/drives/item/following/item/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/following/{driveItem_id}/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i107d6c518f21c0bb26b5dbb36befa0be4f68faa005d7a9fa4dea3296c6482be8.CountRequestBuilder) {
    return i107d6c518f21c0bb26b5dbb36befa0be4f68faa005d7a9fa4dea3296c6482be8.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
