...
import (
    ...
    if5e1a6681aa98baeb1fa45734b9d330ab5632ec5282468301f56275b907e9f14 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/sites/item/items/count"
)
...
func NewItemsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ItemsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/items{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ItemsRequestBuilder) Count()(*if5e1a6681aa98baeb1fa45734b9d330ab5632ec5282468301f56275b907e9f14.CountRequestBuilder) {
    return if5e1a6681aa98baeb1fa45734b9d330ab5632ec5282468301f56275b907e9f14.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
