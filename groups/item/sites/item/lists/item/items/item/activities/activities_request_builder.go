...
import (
    ...
    ibc0d67f7666c02db6d01ef1ba507102ce9b6e2459d7678684a92e05e40736968 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/sites/item/lists/item/items/item/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/lists/{list_id}/items/{listItem_id}/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*ibc0d67f7666c02db6d01ef1ba507102ce9b6e2459d7678684a92e05e40736968.CountRequestBuilder) {
    return ibc0d67f7666c02db6d01ef1ba507102ce9b6e2459d7678684a92e05e40736968.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
