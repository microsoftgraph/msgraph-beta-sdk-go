...
// CreateGetRequestInformationWithRequestConfiguration get the list of group objects of a store
...
// CreatePostRequestInformationWithRequestConfiguration create a new group object.
