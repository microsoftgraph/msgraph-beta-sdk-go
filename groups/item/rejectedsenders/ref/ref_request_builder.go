...
// RefRequestBuilder provides operations to manage the collection of group entities.
...
// RefRequestBuilderGetQueryParameters the list of users or groups that are not allowed to create posts or calendar events in this group. Nullable
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property ref to rejectedSenders for groups
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property ref to rejectedSenders for groups
