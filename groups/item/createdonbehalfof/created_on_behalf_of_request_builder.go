...
func NewCreatedOnBehalfOfRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CreatedOnBehalfOfRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/groups/{group_id}/createdOnBehalfOf{?select,expand}";
...
func (m *CreatedOnBehalfOfRequestBuilder) Ref()(*iee6b02ab640dffed3108f226de18ee56e0649dbae05693720e1df697c0c5c377.RefRequestBuilder) {
    return iee6b02ab640dffed3108f226de18ee56e0649dbae05693720e1df697c0c5c377.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
