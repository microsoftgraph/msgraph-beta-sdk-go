...
import (
    ...
    i9cf764fe69be9faed5a8cead46a5ebeadbf5fcea3fd26ea60f57541d45fc7ce6 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/sectiongroups/item/sections/item/pages/count"
)
...
func NewPagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/pages{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PagesRequestBuilder) Count()(*i9cf764fe69be9faed5a8cead46a5ebeadbf5fcea3fd26ea60f57541d45fc7ce6.CountRequestBuilder) {
    return i9cf764fe69be9faed5a8cead46a5ebeadbf5fcea3fd26ea60f57541d45fc7ce6.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
