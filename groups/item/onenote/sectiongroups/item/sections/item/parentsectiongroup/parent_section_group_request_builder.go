...
import (
    ...
    i089a270dfe71f1865c53e8dd25b7b55179164ce098ee4feafb152205096463b8 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/sectiongroups/item/sections/item/parentsectiongroup/ref"
)

// ParentSectionGroupRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}\parentSectionGroup
...
func NewParentSectionGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentSectionGroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/parentSectionGroup{?select,expand}";
...
func (m *ParentSectionGroupRequestBuilder) Ref()(*i089a270dfe71f1865c53e8dd25b7b55179164ce098ee4feafb152205096463b8.RefRequestBuilder) {
    return i089a270dfe71f1865c53e8dd25b7b55179164ce098ee4feafb152205096463b8.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
