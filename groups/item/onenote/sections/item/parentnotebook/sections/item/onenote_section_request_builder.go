...
import (
    ...
    ibcc10e30128895fc424be06d42eebf2e8692c6797d54dcc5d075df71d67b5a0e "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/sections/item/parentnotebook/sections/item/copytosectiongroup"
    id4715827c28b41c746b9ab057319b23cd4522e20c275885f3b9108204e35a532 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/sections/item/parentnotebook/sections/item/copytonotebook"
)

// OnenoteSectionRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\sections\{onenoteSection-id}\parentNotebook\sections\{onenoteSection-id1}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/sections/{onenoteSection_id}/parentNotebook/sections/{onenoteSection_id1}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*id4715827c28b41c746b9ab057319b23cd4522e20c275885f3b9108204e35a532.CopyToNotebookRequestBuilder) {
    return id4715827c28b41c746b9ab057319b23cd4522e20c275885f3b9108204e35a532.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*ibcc10e30128895fc424be06d42eebf2e8692c6797d54dcc5d075df71d67b5a0e.CopyToSectionGroupRequestBuilder) {
    return ibcc10e30128895fc424be06d42eebf2e8692c6797d54dcc5d075df71d67b5a0e.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
