...
import (
    ...
    i60c8a60160469e2269f390c25519c3fe1c982e4f40527765995abf8272f942ac "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/pages/item/parentsection/parentsectiongroup/sections/item/copytonotebook"
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/groups/{group_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/sections/{onenoteSection_id}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*i60c8a60160469e2269f390c25519c3fe1c982e4f40527765995abf8272f942ac.CopyToNotebookRequestBuilder) {
    return i60c8a60160469e2269f390c25519c3fe1c982e4f40527765995abf8272f942ac.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*i993cf931bdc022f0d35764ff5ee0727552ae3090b5a19184a5401d00739d9120.CopyToSectionGroupRequestBuilder) {
    return i993cf931bdc022f0d35764ff5ee0727552ae3090b5a19184a5401d00739d9120.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
