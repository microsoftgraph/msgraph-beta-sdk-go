...
import (
    ...
    i6e6c70ca51a781024706f10df6361043d47529757874386d618537012178c1c2 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/pages/item/parentsection/parentsectiongroup/parentnotebook/sections/item/copytonotebook"
    if5a8593d76caa36f982535c9c66a714d40cc23fdb71fcaca660ecdac11e7854b "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/pages/item/parentsection/parentsectiongroup/parentnotebook/sections/item/copytosectiongroup"
)

// onenoteSectionRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\pages\{onenotePage-id}\parentSection\parentSectionGroup\parentNotebook\sections\{onenoteSection-id}
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/pages/{onenotePage_id}/parentSection/parentSectionGroup/parentNotebook/sections/{onenoteSection_id}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*i6e6c70ca51a781024706f10df6361043d47529757874386d618537012178c1c2.CopyToNotebookRequestBuilder) {
    return i6e6c70ca51a781024706f10df6361043d47529757874386d618537012178c1c2.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*if5a8593d76caa36f982535c9c66a714d40cc23fdb71fcaca660ecdac11e7854b.CopyToSectionGroupRequestBuilder) {
    return if5a8593d76caa36f982535c9c66a714d40cc23fdb71fcaca660ecdac11e7854b.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
