...
import (
    ...
    i29f99e444620b7f5d2fe6a67695a079283b545bcf7ba7103fc3f936f52b72a58 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/pages/item/parentsection/parentnotebook/sections/item/copytosectiongroup"
    ifff184dee3331de81bbade30fb55a625d8d056dc3d6a9cbc78a7351f81a6410b "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/pages/item/parentsection/parentnotebook/sections/item/copytonotebook"
)
...
func NewOnenoteSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*OnenoteSectionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/groups/{group_id}/onenote/pages/{onenotePage_id}/parentSection/parentNotebook/sections/{onenoteSection_id}{?select,expand}";
...
func (m *OnenoteSectionRequestBuilder) CopyToNotebook()(*ifff184dee3331de81bbade30fb55a625d8d056dc3d6a9cbc78a7351f81a6410b.CopyToNotebookRequestBuilder) {
    return ifff184dee3331de81bbade30fb55a625d8d056dc3d6a9cbc78a7351f81a6410b.NewCopyToNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *OnenoteSectionRequestBuilder) CopyToSectionGroup()(*i29f99e444620b7f5d2fe6a67695a079283b545bcf7ba7103fc3f936f52b72a58.CopyToSectionGroupRequestBuilder) {
    return i29f99e444620b7f5d2fe6a67695a079283b545bcf7ba7103fc3f936f52b72a58.NewCopyToSectionGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
