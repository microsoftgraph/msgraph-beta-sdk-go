...
import (
    ...
    ib3e1f7a8da3426bed10e7c867e2abb980012cbf74e202bfae6e471f648bbde12 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/pages/item/parentnotebook/sectiongroups/item/parentnotebook/copynotebook"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\pages\{onenotePage-id}\parentNotebook\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/pages/{onenotePage_id}/parentNotebook/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*ib3e1f7a8da3426bed10e7c867e2abb980012cbf74e202bfae6e471f648bbde12.CopyNotebookRequestBuilder) {
    return ib3e1f7a8da3426bed10e7c867e2abb980012cbf74e202bfae6e471f648bbde12.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
