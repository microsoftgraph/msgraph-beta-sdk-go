...
import (
    ...
    i95f43659a14f7d14d72aec1a8f19db72573295cc3482aa00d824a40be883ff3d "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/pages/item/parentnotebook/sectiongroups"
    ic3a7df742acb59c9743e9cb9cfe1fd6ae89b50975f34e3b9a0db57602d8297e9 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/pages/item/parentnotebook/sections"
    if469678cf8168b536ba6b1e741bb0f99621113a848bc7ce6a6edfc2b1571d543 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/pages/item/parentnotebook/copynotebook"
    i27a6a2f992c72da1cc3a4893cf957bf1c8a2989c621ad03838a350bfd30ef4c6 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/pages/item/parentnotebook/sections/item"
    i3ee26c3836d246d05e82a5d92f23a6383421881b72553d4d3cda800755f82a0e "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/pages/item/parentnotebook/sectiongroups/item"
)

// ParentNotebookRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\pages\{onenotePage-id}\parentNotebook
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*if469678cf8168b536ba6b1e741bb0f99621113a848bc7ce6a6edfc2b1571d543.CopyNotebookRequestBuilder) {
    return if469678cf8168b536ba6b1e741bb0f99621113a848bc7ce6a6edfc2b1571d543.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ParentNotebookRequestBuilder) SectionGroups()(*i95f43659a14f7d14d72aec1a8f19db72573295cc3482aa00d824a40be883ff3d.SectionGroupsRequestBuilder) {
    return i95f43659a14f7d14d72aec1a8f19db72573295cc3482aa00d824a40be883ff3d.NewSectionGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionGroupsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.groups.item.onenote.pages.item.parentNotebook.sectionGroups.item collection
func (m *ParentNotebookRequestBuilder) SectionGroupsById(id string)(*i3ee26c3836d246d05e82a5d92f23a6383421881b72553d4d3cda800755f82a0e.SectionGroupRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i3ee26c3836d246d05e82a5d92f23a6383421881b72553d4d3cda800755f82a0e.NewSectionGroupRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
func (m *ParentNotebookRequestBuilder) Sections()(*ic3a7df742acb59c9743e9cb9cfe1fd6ae89b50975f34e3b9a0db57602d8297e9.SectionsRequestBuilder) {
    return ic3a7df742acb59c9743e9cb9cfe1fd6ae89b50975f34e3b9a0db57602d8297e9.NewSectionsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.groups.item.onenote.pages.item.parentNotebook.sections.item collection
func (m *ParentNotebookRequestBuilder) SectionsById(id string)(*i27a6a2f992c72da1cc3a4893cf957bf1c8a2989c621ad03838a350bfd30ef4c6.OnenoteSectionRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i27a6a2f992c72da1cc3a4893cf957bf1c8a2989c621ad03838a350bfd30ef4c6.NewOnenoteSectionRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
