...
import (
    ...
    id32f63288df3dbc288284b8ba45a119dd44ebc96a3985c24118094415cfcb94f "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/notebooks/item/sections/item/parentsectiongroup/parentnotebook/copynotebook"
)
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/groups/{group_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/parentSectionGroup/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*id32f63288df3dbc288284b8ba45a119dd44ebc96a3985c24118094415cfcb94f.CopyNotebookRequestBuilder) {
    return id32f63288df3dbc288284b8ba45a119dd44ebc96a3985c24118094415cfcb94f.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
