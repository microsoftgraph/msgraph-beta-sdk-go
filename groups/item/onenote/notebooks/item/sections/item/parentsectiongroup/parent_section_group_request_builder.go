...
import (
    ...
    i0cc31b46a3984db16ef7e9d39ba5cbfd74a734e446bfecbf40caef14ae0deb7d "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/notebooks/item/sections/item/parentsectiongroup/sections"
    i11f7fa56018656772c9d794fda8c206fda0d63cf5056c6748b3bca3ea824c865 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/notebooks/item/sections/item/parentsectiongroup/sectiongroups"
    ia57d388e6cf7ee8bfcd3f9552485deb3312692903bfbe5b80540e4827d5712f7 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/notebooks/item/sections/item/parentsectiongroup/parentnotebook"
    i97b7c21ec2843c6286933d1c6e2f4301816eeb48dbfc463ae45b78a7be23efd3 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/notebooks/item/sections/item/parentsectiongroup/sections/item"
    ib38e82104b70eb428ff0c9e0876d3cd81fd6288ed6b0b36bbf04b64f8563d3f3 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/notebooks/item/sections/item/parentsectiongroup/sectiongroups/item"
)

// parentSectionGroupRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\notebooks\{notebook-id}\sections\{onenoteSection-id}\parentSectionGroup
...
func NewParentSectionGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentSectionGroupRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/parentSectionGroup{?select,expand}";
...
func (m *ParentSectionGroupRequestBuilder) ParentNotebook()(*ia57d388e6cf7ee8bfcd3f9552485deb3312692903bfbe5b80540e4827d5712f7.ParentNotebookRequestBuilder) {
    return ia57d388e6cf7ee8bfcd3f9552485deb3312692903bfbe5b80540e4827d5712f7.NewParentNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ParentSectionGroupRequestBuilder) SectionGroups()(*i11f7fa56018656772c9d794fda8c206fda0d63cf5056c6748b3bca3ea824c865.SectionGroupsRequestBuilder) {
    return i11f7fa56018656772c9d794fda8c206fda0d63cf5056c6748b3bca3ea824c865.NewSectionGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionGroupsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.groups.item.onenote.notebooks.item.sections.item.parentSectionGroup.sectionGroups.item collection
func (m *ParentSectionGroupRequestBuilder) SectionGroupsById(id string)(*ib38e82104b70eb428ff0c9e0876d3cd81fd6288ed6b0b36bbf04b64f8563d3f3.SectionGroupRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return ib38e82104b70eb428ff0c9e0876d3cd81fd6288ed6b0b36bbf04b64f8563d3f3.NewSectionGroupRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
func (m *ParentSectionGroupRequestBuilder) Sections()(*i0cc31b46a3984db16ef7e9d39ba5cbfd74a734e446bfecbf40caef14ae0deb7d.SectionsRequestBuilder) {
    return i0cc31b46a3984db16ef7e9d39ba5cbfd74a734e446bfecbf40caef14ae0deb7d.NewSectionsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SectionsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.groups.item.onenote.notebooks.item.sections.item.parentSectionGroup.sections.item collection
func (m *ParentSectionGroupRequestBuilder) SectionsById(id string)(*i97b7c21ec2843c6286933d1c6e2f4301816eeb48dbfc463ae45b78a7be23efd3.OnenoteSectionRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i97b7c21ec2843c6286933d1c6e2f4301816eeb48dbfc463ae45b78a7be23efd3.NewOnenoteSectionRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
