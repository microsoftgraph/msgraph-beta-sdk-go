...
import (
    ...
    i1e565c251468677db41c5243e5a7e22f944c4371f74ae4e9ff027b2126f55073 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/notebooks/item/sectiongroups/item/sections/count"
)
...
func NewSectionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SectionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SectionsRequestBuilder) Count()(*i1e565c251468677db41c5243e5a7e22f944c4371f74ae4e9ff027b2126f55073.CountRequestBuilder) {
    return i1e565c251468677db41c5243e5a7e22f944c4371f74ae4e9ff027b2126f55073.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
