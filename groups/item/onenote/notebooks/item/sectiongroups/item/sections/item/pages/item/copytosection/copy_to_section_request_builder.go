...
// CreatePostRequestInformationWithRequestConfiguration copy a page to a specific section. For copy operations, you follow an asynchronous calling pattern:  First call the Copy action, and then poll the operation endpoint for the result.
...
func (m *CopyToSectionRequestBuilder) Post(ctx context.Context, body CopyToSectionPostRequestBodyable, requestConfiguration *CopyToSectionRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OnenoteOperationable, error) {
