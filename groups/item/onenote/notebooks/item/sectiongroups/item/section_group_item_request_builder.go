...
// DeleteWithResponseHandler delete navigation property sectionGroups for groups
...
// PatchWithResponseHandler update the navigation property sectionGroups in groups
