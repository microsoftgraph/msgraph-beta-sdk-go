...
import (
    ...
    ia70b15ce132a7e3ca888b64b696b81fd7e3d914d01bab3fa8f7e744f8665f462 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/onenote/notebooks/item/sectiongroups/item/parentnotebook/copynotebook"
)

// parentNotebookRequestBuilder builds and executes requests for operations under \groups\{group-id}\onenote\notebooks\{notebook-id}\sectionGroups\{sectionGroup-id}\parentNotebook
...
func NewParentNotebookRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentNotebookRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/parentNotebook{?select,expand}";
...
func (m *ParentNotebookRequestBuilder) CopyNotebook()(*ia70b15ce132a7e3ca888b64b696b81fd7e3d914d01bab3fa8f7e744f8665f462.CopyNotebookRequestBuilder) {
    return ia70b15ce132a7e3ca888b64b696b81fd7e3d914d01bab3fa8f7e744f8665f462.NewCopyNotebookRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
