...
func (m *CopyNotebookRequestBuilder) CreatePostRequestInformation(ctx context.Context, body CopyNotebookPostRequestBodyable, requestConfiguration *CopyNotebookRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
