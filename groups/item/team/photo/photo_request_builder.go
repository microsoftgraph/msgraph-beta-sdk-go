...
import (
    ...
    i813d4599c68a99e90980a3d5b6acf1d7fe770ec30d57a39c812d15d855a02d33 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/team/photo/value"
)
...
func NewPhotoRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PhotoRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/team/photo{?select,expand}";
...
func (m *PhotoRequestBuilder) Content()(*i813d4599c68a99e90980a3d5b6acf1d7fe770ec30d57a39c812d15d855a02d33.ContentRequestBuilder) {
    return i813d4599c68a99e90980a3d5b6acf1d7fe770ec30d57a39c812d15d855a02d33.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
