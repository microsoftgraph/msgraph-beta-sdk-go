...
import (
    ...
    i21a28b733c9d423d52cbbc082b88cffa9a117be643ecd4c350e60e41b17961e2 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/team/owners/count"
)
...
func NewOwnersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OwnersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/team/owners{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *OwnersRequestBuilder) Count()(*i21a28b733c9d423d52cbbc082b88cffa9a117be643ecd4c350e60e41b17961e2.CountRequestBuilder) {
    return i21a28b733c9d423d52cbbc082b88cffa9a117be643ecd4c350e60e41b17961e2.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *OwnersRequestBuilder) Get(options *OwnersRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserCollectionResponseable, error) {
