...
import (
    ...
    i824d1bdb76844a47999c71fa180c0b7372bdb0fe2287ac670452cac0c4e70390 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/team/allchannels/count"
)
...
// AllChannelsRequestBuilderGetQueryParameters get allChannels from groups
...
func NewAllChannelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AllChannelsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/team/allChannels{?top,skip,search,filter,count,orderby,select,expand}";
...
// CreateGetRequestInformation get allChannels from groups
...
// Get get allChannels from groups
