...
import (
    ...
    i7fe1735f1198b59ef76a54571b0ab3cbc13fcd5ed5b76a8a9f8542504585c40c "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/team/tags/count"
)
...
func NewTagsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TagsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/team/tags{?top,skip,search,filter,count,orderby,select,expand}";
