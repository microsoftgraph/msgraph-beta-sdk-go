...
// DeleteWithResponseHandler delete navigation property installedApps for groups
...
// PatchWithResponseHandler update the navigation property installedApps in groups
