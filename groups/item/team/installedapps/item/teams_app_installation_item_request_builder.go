...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property installedApps for groups
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property installedApps in groups
