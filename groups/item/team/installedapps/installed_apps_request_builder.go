...
// CreatePostRequestInformation create new navigation property to installedApps for groups
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to installedApps for groups
