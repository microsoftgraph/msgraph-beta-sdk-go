...
// GetWithResponseHandler get swapShiftsChangeRequests from groups
...
// PostWithResponseHandler create new navigation property to swapShiftsChangeRequests for groups
