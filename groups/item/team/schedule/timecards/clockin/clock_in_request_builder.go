...
// ClockInRequestBuilderPostOptions options for Post
type ClockInRequestBuilderPostOptions struct {
    // 
    Body ClockInRequestBodyable;
    // Request headers
    H map[string]string;
    // Request options
...
// ClockInResponse union type wrapper for classes timeCard
...
// NewClockInResponse instantiates a new clockInResponse and sets the default values.
...
func CreateClockInResponseFromDiscriminatorValue(parseNode i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable, error) {
    return NewClockInResponse(), nil
}
...
func (m *ClockInResponse) GetTimeCard()(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.TimeCardable) {
    if m == nil {
        return nil
    } else {
        return m.timeCard
...
func (m *ClockInResponse) SetTimeCard(value i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.TimeCardable)() {
    if m != nil {
        m.timeCard = value
    }
}
// ClockInResponseable 
type ClockInResponseable interface {
...
func NewClockInRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ClockInRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/team/schedule/timeCards/microsoft.graph.clockIn";
...
func (m *ClockInRequestBuilder) CreatePostRequestInformation(options *ClockInRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *ClockInRequestBuilder) Post(options *ClockInRequestBuilderPostOptions)(ClockInResponseable, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateClockInResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(ClockInResponseable), nil
}
