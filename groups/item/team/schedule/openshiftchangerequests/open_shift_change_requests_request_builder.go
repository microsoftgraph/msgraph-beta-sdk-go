...
// GetWithResponseHandler get openShiftChangeRequests from groups
...
// PostWithResponseHandler create new navigation property to openShiftChangeRequests for groups
