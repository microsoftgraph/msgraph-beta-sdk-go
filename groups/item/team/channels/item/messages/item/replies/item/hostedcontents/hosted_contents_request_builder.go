...
import (
    ...
    i24274382e0133e43922b1972b4a7b5b1d06e94e92d3cd6cae17547bb32bdeeac "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/team/channels/item/messages/item/replies/item/hostedcontents/count"
)
...
func NewHostedContentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HostedContentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/team/channels/{channel_id}/messages/{chatMessage_id}/replies/{chatMessage_id1}/hostedContents{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *HostedContentsRequestBuilder) Count()(*i24274382e0133e43922b1972b4a7b5b1d06e94e92d3cd6cae17547bb32bdeeac.CountRequestBuilder) {
    return i24274382e0133e43922b1972b4a7b5b1d06e94e92d3cd6cae17547bb32bdeeac.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
