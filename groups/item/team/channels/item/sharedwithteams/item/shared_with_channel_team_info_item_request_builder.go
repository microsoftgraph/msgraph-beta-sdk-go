...
// DeleteWithResponseHandler delete navigation property sharedWithTeams for groups
...
// PatchWithResponseHandler update the navigation property sharedWithTeams in groups
