...
import (
    ...
    i5d12cf0044ad2c2bfb04307d215a516033dafd8fbe64cc04eb61c064de684d92 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/team/primarychannel/messages/item/replies/delta"
    ia8c6614ca711ba8beb3ce1b4bf38cf259d02d58a2bd445f3d9381281ebabd883 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/team/primarychannel/messages/item/replies/count"
)
...
func NewRepliesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RepliesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/team/primaryChannel/messages/{chatMessage_id}/replies{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RepliesRequestBuilder) Count()(*ia8c6614ca711ba8beb3ce1b4bf38cf259d02d58a2bd445f3d9381281ebabd883.CountRequestBuilder) {
    return ia8c6614ca711ba8beb3ce1b4bf38cf259d02d58a2bd445f3d9381281ebabd883.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *RepliesRequestBuilder) Delta()(*i5d12cf0044ad2c2bfb04307d215a516033dafd8fbe64cc04eb61c064de684d92.DeltaRequestBuilder) {
    return i5d12cf0044ad2c2bfb04307d215a516033dafd8fbe64cc04eb61c064de684d92.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
