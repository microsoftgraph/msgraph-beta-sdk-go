...
import (
    ...
    ic7716c5720cd4b5ccf22ffb0641a4d82ed52b1fe4c5de7100cd109d1dae880c4 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/team/primarychannel/messages/delta"
    id49e7fa578a9e09aa503ea90228a3b429920ca97ce3250dd1d8a4f2a1ea63b38 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/team/primarychannel/messages/count"
)
...
func NewMessagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MessagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/team/primaryChannel/messages{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *MessagesRequestBuilder) Count()(*id49e7fa578a9e09aa503ea90228a3b429920ca97ce3250dd1d8a4f2a1ea63b38.CountRequestBuilder) {
    return id49e7fa578a9e09aa503ea90228a3b429920ca97ce3250dd1d8a4f2a1ea63b38.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *MessagesRequestBuilder) Delta()(*ic7716c5720cd4b5ccf22ffb0641a4d82ed52b1fe4c5de7100cd109d1dae880c4.DeltaRequestBuilder) {
    return ic7716c5720cd4b5ccf22ffb0641a4d82ed52b1fe4c5de7100cd109d1dae880c4.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
