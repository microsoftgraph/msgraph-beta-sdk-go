...
// EventsRequestBuilder builds and executes requests for operations under \groups\{group-id}\events
...
// Delta builds and executes requests for operations under \groups\{group-id}\events\microsoft.graph.delta()
