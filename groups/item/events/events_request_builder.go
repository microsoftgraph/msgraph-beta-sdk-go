...
// EventsRequestBuilderGetQueryParameters retrieve a list of event objects.
...
// CreateGetRequestInformation retrieve a list of event objects.
...
// CreatePostRequestInformation use this API to create a new event.
