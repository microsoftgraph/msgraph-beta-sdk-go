...
import (
    ...
    icc17dd77c72c28185da297e347b0688ae4271fe83a2b4cc23f906022c1ecd11a "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/events/item/exceptionoccurrences/item/instances/item/attachments/createuploadsession"
    if4256a3601e4824e1c34dcd9cfc398940a2737bc912cf90f2dfe0f54774499a5 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/events/item/exceptionoccurrences/item/instances/item/attachments/count"
)
...
func NewAttachmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AttachmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/events/{event_id}/exceptionOccurrences/{event_id1}/instances/{event_id2}/attachments{?top,skip,filter,count,orderby,select,expand}";
...
func (m *AttachmentsRequestBuilder) Count()(*if4256a3601e4824e1c34dcd9cfc398940a2737bc912cf90f2dfe0f54774499a5.CountRequestBuilder) {
    return if4256a3601e4824e1c34dcd9cfc398940a2737bc912cf90f2dfe0f54774499a5.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttachmentsRequestBuilder) CreateUploadSession()(*icc17dd77c72c28185da297e347b0688ae4271fe83a2b4cc23f906022c1ecd11a.CreateUploadSessionRequestBuilder) {
    return icc17dd77c72c28185da297e347b0688ae4271fe83a2b4cc23f906022c1ecd11a.NewCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
