...
import (
    ...
    i50824c20e49c27e548c2ec0603a889c42e94cc0a18881aa296322c10e024a674 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/events/item/calendar/events/delta"
)

// EventsRequestBuilder builds and executes requests for operations under \groups\{group-id}\events\{event-id}\calendar\events
...
func NewEventsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*EventsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/events/{event_id}/calendar/events{?top,skip,filter,count,orderby,select}";
...
// Delta builds and executes requests for operations under \groups\{group-id}\events\{event-id}\calendar\events\microsoft.graph.delta()
func (m *EventsRequestBuilder) Delta()(*i50824c20e49c27e548c2ec0603a889c42e94cc0a18881aa296322c10e024a674.DeltaRequestBuilder) {
    return i50824c20e49c27e548c2ec0603a889c42e94cc0a18881aa296322c10e024a674.NewDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
