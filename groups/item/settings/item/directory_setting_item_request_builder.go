...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property settings for groups
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property settings in groups
