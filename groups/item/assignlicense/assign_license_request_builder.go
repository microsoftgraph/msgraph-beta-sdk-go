...
func (m *AssignLicenseResponse) GetGroup()(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Groupable) {
    if m == nil {
        return nil
    } else {
        return m.group
...
func (m *AssignLicenseResponse) SetGroup(value i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Groupable)() {
    if m != nil {
        m.group = value
    }
}
