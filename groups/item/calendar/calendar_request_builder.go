...
// DeleteWithResponseHandler delete navigation property calendar for groups
...
// GetWithResponseHandler the group's calendar. Read-only.
...
// PatchWithResponseHandler update the navigation property calendar in groups
