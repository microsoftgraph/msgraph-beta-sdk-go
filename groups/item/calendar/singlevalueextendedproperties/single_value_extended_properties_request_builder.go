...
import (
    ...
    if547d818f011df3325d69ddd4f17763fcac0d693830ebd075de71830f2f4ae6e "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/calendar/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/calendar/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*if547d818f011df3325d69ddd4f17763fcac0d693830ebd075de71830f2f4ae6e.CountRequestBuilder) {
    return if547d818f011df3325d69ddd4f17763fcac0d693830ebd075de71830f2f4ae6e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
