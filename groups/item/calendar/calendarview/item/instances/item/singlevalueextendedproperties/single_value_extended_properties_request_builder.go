...
import (
    ...
    ic2e4a7a7b7a4359c6131bc457126d914cad07bde3182d4c4ff0da7b483914952 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/calendar/calendarview/item/instances/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/calendar/calendarView/{event_id}/instances/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*ic2e4a7a7b7a4359c6131bc457126d914cad07bde3182d4c4ff0da7b483914952.CountRequestBuilder) {
    return ic2e4a7a7b7a4359c6131bc457126d914cad07bde3182d4c4ff0da7b483914952.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
