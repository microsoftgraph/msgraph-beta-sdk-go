...
// DeleteWithResponseHandler delete navigation property calendarView for groups
...
// PatchWithResponseHandler update the navigation property calendarView in groups
