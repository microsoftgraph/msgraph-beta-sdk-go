...
import (
    ...
    i8cc645a745672ed9e7f4f7b69e3ac2256712d4eb0b1d11dbf00daaa01ca67b85 "github.com/microsoftgraph/msgraph-beta-sdk-go/groups/item/calendar/calendarview/item/exceptionoccurrences/item/singlevalueextendedproperties/count"
)
...
func NewSingleValueExtendedPropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SingleValueExtendedPropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{group_id}/calendar/calendarView/{event_id}/exceptionOccurrences/{event_id1}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SingleValueExtendedPropertiesRequestBuilder) Count()(*i8cc645a745672ed9e7f4f7b69e3ac2256712d4eb0b1d11dbf00daaa01ca67b85.CountRequestBuilder) {
    return i8cc645a745672ed9e7f4f7b69e3ac2256712d4eb0b1d11dbf00daaa01ca67b85.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
