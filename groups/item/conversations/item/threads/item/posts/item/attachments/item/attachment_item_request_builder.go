...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property attachments for groups
...
// GetWithRequestConfigurationAndResponseHandler the collection of fileAttachment, itemAttachment, and referenceAttachment attachments for the post. Read-only. Nullable. Supports $expand.
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property attachments in groups
