...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property singleValueExtendedProperties for groups
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property singleValueExtendedProperties in groups
