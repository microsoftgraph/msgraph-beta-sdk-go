...
// ExtensionsRequestBuilder builds and executes requests for operations under \groups\{group-id}\conversations\{conversation-id}\threads\{conversationThread-id}\posts\{post-id}\extensions
...
// CreatePostRequestInformation the collection of open extensions defined for the post. Read-only. Nullable. Supports $expand.
...
func (m *ExtensionsRequestBuilder) Get(options *ExtensionsRequestBuilderGetOptions)(*ExtensionsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewExtensionsResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*ExtensionsResponse), nil
}
// Post the collection of open extensions defined for the post. Read-only. Nullable. Supports $expand.
