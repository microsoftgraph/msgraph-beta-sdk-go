...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property plans for groups
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property plans in groups
