...
// CreatePostRequestInformation create new navigation property to tasks for groups
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to tasks for groups
