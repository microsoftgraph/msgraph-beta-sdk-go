...
// ExtensionRequestBuilder builds and executes requests for operations under \groups\{group-id}\extensions\{extension-id}
...
// ExtensionRequestBuilderGetQueryParameters the collection of open extensions defined for the group. Read-only. Nullable.
