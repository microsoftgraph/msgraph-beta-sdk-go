...
// returns a *ItemSitesItemTermstoreGroupsItemSetsItemParentgroupParentGroupRequestBuilder when successful
func (m *ItemSitesItemTermstoreGroupsItemSetsSetItemRequestBuilder) ParentGroup()(*ItemSitesItemTermstoreGroupsItemSetsItemParentgroupParentGroupRequestBuilder) {
    return NewItemSitesItemTermstoreGroupsItemSetsItemParentgroupParentGroupRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
