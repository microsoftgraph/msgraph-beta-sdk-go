...
func (m *ItemTeamPrimaryChannelMessagesChatMessageItemRequestBuilder) MicrosoftGraphSetReaction()(*ItemTeamPrimaryChannelMessagesItemMicrosoftGraphSetReactionRequestBuilder) {
    return NewItemTeamPrimaryChannelMessagesItemMicrosoftGraphSetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemTeamPrimaryChannelMessagesChatMessageItemRequestBuilder) MicrosoftGraphUnsetReaction()(*ItemTeamPrimaryChannelMessagesItemMicrosoftGraphUnsetReactionRequestBuilder) {
    return NewItemTeamPrimaryChannelMessagesItemMicrosoftGraphUnsetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
