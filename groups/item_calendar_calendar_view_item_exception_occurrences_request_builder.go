...
func (m *ItemCalendarCalendarViewItemExceptionOccurrencesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarCalendarViewItemExceptionOccurrencesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemCalendarCalendarViewItemExceptionOccurrencesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
