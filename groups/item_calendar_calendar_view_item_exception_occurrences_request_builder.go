...
func (m *ItemCalendarCalendarViewItemExceptionOccurrencesRequestBuilder) Count()(*ItemCalendarCalendarViewItemExceptionOccurrencesCountRequestBuilder) {
    return NewItemCalendarCalendarViewItemExceptionOccurrencesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get exceptionOccurrences from groups
func (m *ItemCalendarCalendarViewItemExceptionOccurrencesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemCalendarCalendarViewItemExceptionOccurrencesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemCalendarCalendarViewItemExceptionOccurrencesRequestBuilder) Delta()(*ItemCalendarCalendarViewItemExceptionOccurrencesDeltaRequestBuilder) {
    return NewItemCalendarCalendarViewItemExceptionOccurrencesDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
