...
func (m *ItemTeamChannelsRequestBuilder) MicrosoftGraphAllMessages()(*ItemTeamChannelsMicrosoftGraphAllMessagesAllMessagesRequestBuilder) {
    return NewItemTeamChannelsMicrosoftGraphAllMessagesAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
