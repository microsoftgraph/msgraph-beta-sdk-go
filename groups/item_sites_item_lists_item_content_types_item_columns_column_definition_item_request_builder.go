...
// ItemSitesItemListsItemContentTypesItemColumnsColumnDefinitionItemRequestBuilderGetQueryParameters retrieve the metadata for a site][], [list][] or [contentType][] [column][columnDefinition]. This API is supported in the following [national cloud deployments.
...
// Delete remove a column][columndefinition] from a [site][], [list][] or [content type][contentType]. This API is supported in the following [national cloud deployments.
// [Find more info here]
// 
...
// Get retrieve the metadata for a site][], [list][] or [contentType][] [column][columnDefinition]. This API is supported in the following [national cloud deployments.
// [Find more info here]
// 
...
// Patch update a site][], [list][] or [content type][contentType] [column][columnDefinition]. This API is supported in the following [national cloud deployments.
// [Find more info here]
// 
...
// ToDeleteRequestInformation remove a column][columndefinition] from a [site][], [list][] or [content type][contentType]. This API is supported in the following [national cloud deployments.
...
// ToGetRequestInformation retrieve the metadata for a site][], [list][] or [contentType][] [column][columnDefinition]. This API is supported in the following [national cloud deployments.
...
// ToPatchRequestInformation update a site][], [list][] or [content type][contentType] [column][columnDefinition]. This API is supported in the following [national cloud deployments.
