...
// ItemEventsItemExceptionOccurrencesItemInstancesItemCancelPostRequestBody provides operations to call the cancel method.
...
func (m *ItemEventsItemExceptionOccurrencesItemInstancesItemCancelPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemEventsItemExceptionOccurrencesItemInstancesItemCancelPostRequestBody) SetAdditionalData(value map[string]interface{})() {
