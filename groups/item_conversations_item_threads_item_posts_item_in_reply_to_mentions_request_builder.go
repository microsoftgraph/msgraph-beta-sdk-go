...
// NewItemConversationsItemThreadsItemPostsItemInReplyToMentionsRequestBuilderInternal instantiates a new MentionsRequestBuilder and sets the default values.
...
// NewItemConversationsItemThreadsItemPostsItemInReplyToMentionsRequestBuilder instantiates a new MentionsRequestBuilder and sets the default values.
...
func (m *ItemConversationsItemThreadsItemPostsItemInReplyToMentionsRequestBuilder) Count()(*ItemConversationsItemThreadsItemPostsItemInReplyToMentionsCountRequestBuilder) {
    return NewItemConversationsItemThreadsItemPostsItemInReplyToMentionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get mentions from groups
func (m *ItemConversationsItemThreadsItemPostsItemInReplyToMentionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemConversationsItemThreadsItemPostsItemInReplyToMentionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
