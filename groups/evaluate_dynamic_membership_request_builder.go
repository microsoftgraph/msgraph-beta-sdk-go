...
func (m *EvaluateDynamicMembershipRequestBuilder) WithUrl(rawUrl string)(*EvaluateDynamicMembershipRequestBuilder) {
    return NewEvaluateDynamicMembershipRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
