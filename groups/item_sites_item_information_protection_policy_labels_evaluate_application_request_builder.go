...
// NewItemSitesItemInformationProtectionPolicyLabelsEvaluateApplicationRequestBuilderInternal instantiates a new ItemSitesItemInformationProtectionPolicyLabelsEvaluateApplicationRequestBuilder and sets the default values.
...
// NewItemSitesItemInformationProtectionPolicyLabelsEvaluateApplicationRequestBuilder instantiates a new ItemSitesItemInformationProtectionPolicyLabelsEvaluateApplicationRequestBuilder and sets the default values.
...
// returns a ItemSitesItemInformationProtectionPolicyLabelsEvaluateApplicationResponseable when successful
...
// returns a ItemSitesItemInformationProtectionPolicyLabelsEvaluateApplicationPostResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/informationprotectionlabel-evaluateapplication?view=graph-rest-1.0
