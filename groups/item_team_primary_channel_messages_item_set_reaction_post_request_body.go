...
// ItemTeamPrimaryChannelMessagesItemSetReactionPostRequestBody provides operations to call the setReaction method.
...
// NewItemTeamPrimaryChannelMessagesItemSetReactionPostRequestBody instantiates a new ItemTeamPrimaryChannelMessagesItemSetReactionPostRequestBody and sets the default values.
...
func (m *ItemTeamPrimaryChannelMessagesItemSetReactionPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemTeamPrimaryChannelMessagesItemSetReactionPostRequestBody) GetReactionType()(*string) {
    return m.reactionType
}
// Serialize serializes information the current object
func (m *ItemTeamPrimaryChannelMessagesItemSetReactionPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemTeamPrimaryChannelMessagesItemSetReactionPostRequestBody) SetReactionType(value *string)() {
