...
// NewItemMembersWithLicenseErrorsGraphOrgContactRequestBuilderInternal instantiates a new ItemMembersWithLicenseErrorsGraphOrgContactRequestBuilder and sets the default values.
func NewItemMembersWithLicenseErrorsGraphOrgContactRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersWithLicenseErrorsGraphOrgContactRequestBuilder) {
    m := &ItemMembersWithLicenseErrorsGraphOrgContactRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/graph.orgContact{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemMembersWithLicenseErrorsGraphOrgContactRequestBuilder instantiates a new ItemMembersWithLicenseErrorsGraphOrgContactRequestBuilder and sets the default values.
...
// returns a *ItemMembersWithLicenseErrorsGraphOrgContactCountRequestBuilder when successful
...
func (m *ItemMembersWithLicenseErrorsGraphOrgContactRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMembersWithLicenseErrorsGraphOrgContactRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OrgContactCollectionResponseable, error) {
