...
func NewItemMembersMicrosoftGraphDeviceCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersMicrosoftGraphDeviceCountRequestBuilder) {
    m := &ItemMembersMicrosoftGraphDeviceCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/groups/{group%2Did}/members/microsoft.graph.device/$count{?%24search,%24filter}";
...
func NewItemMembersMicrosoftGraphDeviceCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersMicrosoftGraphDeviceCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemMembersMicrosoftGraphDeviceCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *ItemMembersMicrosoftGraphDeviceCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMembersMicrosoftGraphDeviceCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemMembersMicrosoftGraphDeviceCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemMembersMicrosoftGraphDeviceCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
