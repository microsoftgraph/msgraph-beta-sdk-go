...
// NewItemSitesItemTermStoreSetsItemRelationsCountRequestBuilderInternal instantiates a new ItemSitesItemTermStoreSetsItemRelationsCountRequestBuilder and sets the default values.
func NewItemSitesItemTermStoreSetsItemRelationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemTermStoreSetsItemRelationsCountRequestBuilder) {
    m := &ItemSitesItemTermStoreSetsItemRelationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/relations/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemSitesItemTermStoreSetsItemRelationsCountRequestBuilder instantiates a new ItemSitesItemTermStoreSetsItemRelationsCountRequestBuilder and sets the default values.
...
func (m *ItemSitesItemTermStoreSetsItemRelationsCountRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemTermStoreSetsItemRelationsCountRequestBuilder) {
    return NewItemSitesItemTermStoreSetsItemRelationsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
