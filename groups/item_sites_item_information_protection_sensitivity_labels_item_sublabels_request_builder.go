...
func (m *ItemSitesItemInformationProtectionSensitivityLabelsItemSublabelsRequestBuilder) ComputeInheritanceWithLabelIdsWithLocaleWithContentFormats(contentFormats *string, labelIds *string, locale *string)(*ItemSitesItemInformationProtectionSensitivityLabelsItemSublabelsComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilder) {
    return NewItemSitesItemInformationProtectionSensitivityLabelsItemSublabelsComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, contentFormats, labelIds, locale)
}
...
func (m *ItemSitesItemInformationProtectionSensitivityLabelsItemSublabelsRequestBuilder) ComputeRightsAndInheritance()(*ItemSitesItemInformationProtectionSensitivityLabelsItemSublabelsComputeRightsAndInheritanceRequestBuilder) {
    return NewItemSitesItemInformationProtectionSensitivityLabelsItemSublabelsComputeRightsAndInheritanceRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
