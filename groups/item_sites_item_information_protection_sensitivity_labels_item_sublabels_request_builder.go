...
func (m *ItemSitesItemInformationProtectionSensitivityLabelsItemSublabelsRequestBuilder) MicrosoftGraphEvaluate()(*ItemSitesItemInformationProtectionSensitivityLabelsItemSublabelsMicrosoftGraphEvaluateRequestBuilder) {
    return NewItemSitesItemInformationProtectionSensitivityLabelsItemSublabelsMicrosoftGraphEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
