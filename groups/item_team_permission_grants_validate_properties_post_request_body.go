...
// ItemTeamPermissionGrantsValidatePropertiesPostRequestBody provides operations to call the validateProperties method.
...
func (m *ItemTeamPermissionGrantsValidatePropertiesPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemTeamPermissionGrantsValidatePropertiesPostRequestBody) GetOnBehalfOfUserId()(*UUID) {
...
func (m *ItemTeamPermissionGrantsValidatePropertiesPostRequestBody) SetAdditionalData(value map[string]interface{})() {
...
func (m *ItemTeamPermissionGrantsValidatePropertiesPostRequestBody) SetOnBehalfOfUserId(value *UUID)() {
