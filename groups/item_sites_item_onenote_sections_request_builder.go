...
// ItemSitesItemOnenoteSectionsRequestBuilderGetQueryParameters retrieve a list of section objects. This API is supported in the following national cloud deployments.
