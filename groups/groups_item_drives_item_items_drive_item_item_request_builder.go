...
func (m *GroupsItemDrivesItemItemsDriveItemItemRequestBuilder) Activities()(*GroupsItemDrivesItemItemsItemActivitiesRequestBuilder) {
    return NewGroupsItemDrivesItemItemsItemActivitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ActivitiesById provides operations to manage the activities property of the microsoft.graph.driveItem entity.
func (m *GroupsItemDrivesItemItemsDriveItemItemRequestBuilder) ActivitiesById(id string)(*GroupsItemDrivesItemItemsItemActivitiesItemActivityOLDItemRequestBuilder) {
    ...
    return NewGroupsItemDrivesItemItemsItemActivitiesItemActivityOLDItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *GroupsItemDrivesItemItemsDriveItemItemRequestBuilder) AssignSensitivityLabel()(*GroupsItemDrivesItemItemsItemAssignSensitivityLabelRequestBuilder) {
    return NewGroupsItemDrivesItemItemsItemAssignSensitivityLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *GroupsItemDrivesItemItemsDriveItemItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, requestConfiguration *GroupsItemDrivesItemItemsDriveItemItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *GroupsItemDrivesItemItemsDriveItemItemRequestBuilder) ExtractSensitivityLabels()(*GroupsItemDrivesItemItemsItemExtractSensitivityLabelsRequestBuilder) {
    return NewGroupsItemDrivesItemItemsItemExtractSensitivityLabelsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *GroupsItemDrivesItemItemsDriveItemItemRequestBuilder) Get(ctx context.Context, requestConfiguration *GroupsItemDrivesItemItemsDriveItemItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
