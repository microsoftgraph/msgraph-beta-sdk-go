...
func (m *ItemSitesItemTermStoreGroupsItemSetsItemParentGroupRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemSitesItemTermStoreGroupsItemSetsItemParentGroupRequestBuilderDeleteRequestConfiguration)([]byte, error) {
