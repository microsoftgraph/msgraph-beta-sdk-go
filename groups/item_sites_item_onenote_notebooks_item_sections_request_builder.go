...
// ItemSitesItemOnenoteNotebooksItemSectionsRequestBuilderGetQueryParameters retrieve a list of section objects from the specified notebook. This API is supported in the following national cloud deployments.
...
// Get retrieve a list of section objects from the specified notebook. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create a new section in the specified notebook. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve a list of section objects from the specified notebook. This API is supported in the following national cloud deployments.
...
// ToPostRequestInformation create a new section in the specified notebook. This API is supported in the following national cloud deployments.
