...
func (m *GroupsItemSitesSiteItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Siteable, requestConfiguration *GroupsItemSitesSiteItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *GroupsItemSitesSiteItemRequestBuilder) Get(ctx context.Context, requestConfiguration *GroupsItemSitesSiteItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Siteable, error) {
...
func (m *GroupsItemSitesSiteItemRequestBuilder) Pages()(*GroupsItemSitesItemPagesRequestBuilder) {
    return NewGroupsItemSitesItemPagesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// PagesById provides operations to manage the pages property of the microsoft.graph.site entity.
func (m *GroupsItemSitesSiteItemRequestBuilder) PagesById(id string)(*GroupsItemSitesItemPagesSitePageItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewGroupsItemSitesItemPagesSitePageItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
