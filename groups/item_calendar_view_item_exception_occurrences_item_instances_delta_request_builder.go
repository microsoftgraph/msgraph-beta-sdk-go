...
// NewItemCalendarViewItemExceptionOccurrencesItemInstancesDeltaRequestBuilderInternal instantiates a new DeltaRequestBuilder and sets the default values.
...
// NewItemCalendarViewItemExceptionOccurrencesItemInstancesDeltaRequestBuilder instantiates a new DeltaRequestBuilder and sets the default values.
...
func (m *ItemCalendarViewItemExceptionOccurrencesItemInstancesDeltaRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemCalendarViewItemExceptionOccurrencesItemInstancesDeltaRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemCalendarViewItemExceptionOccurrencesItemInstancesDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCalendarViewItemExceptionOccurrencesItemInstancesDeltaRequestBuilderGetRequestConfiguration)(ItemCalendarViewItemExceptionOccurrencesItemInstancesDeltaResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateItemCalendarViewItemExceptionOccurrencesItemInstancesDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
