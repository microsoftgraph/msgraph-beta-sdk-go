...
// ItemCalendarCalendarViewItemExceptionOccurrencesItemCancelPostRequestBody provides operations to call the cancel method.
...
func (m *ItemCalendarCalendarViewItemExceptionOccurrencesItemCancelPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemCalendarCalendarViewItemExceptionOccurrencesItemCancelPostRequestBody) SetAdditionalData(value map[string]interface{})() {
