...
// NewItemTeamAllChannelsChannelItemRequestBuilderInternal instantiates a new ItemTeamAllChannelsChannelItemRequestBuilder and sets the default values.
func NewItemTeamAllChannelsChannelItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamAllChannelsChannelItemRequestBuilder) {
    m := &ItemTeamAllChannelsChannelItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/allChannels/{channel%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemTeamAllChannelsChannelItemRequestBuilder instantiates a new ItemTeamAllChannelsChannelItemRequestBuilder and sets the default values.
...
// returns a *ItemTeamAllChannelsChannelItemRequestBuilder when successful
func (m *ItemTeamAllChannelsChannelItemRequestBuilder) WithUrl(rawUrl string)(*ItemTeamAllChannelsChannelItemRequestBuilder) {
    return NewItemTeamAllChannelsChannelItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
