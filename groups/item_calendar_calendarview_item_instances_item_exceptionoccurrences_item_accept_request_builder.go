...
// NewItemCalendarCalendarviewItemInstancesItemExceptionoccurrencesItemAcceptRequestBuilderInternal instantiates a new ItemCalendarCalendarviewItemInstancesItemExceptionoccurrencesItemAcceptRequestBuilder and sets the default values.
func NewItemCalendarCalendarviewItemInstancesItemExceptionoccurrencesItemAcceptRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarCalendarviewItemInstancesItemExceptionoccurrencesItemAcceptRequestBuilder) {
    m := &ItemCalendarCalendarviewItemInstancesItemExceptionoccurrencesItemAcceptRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/accept", pathParameters),
    }
    return m
}
// NewItemCalendarCalendarviewItemInstancesItemExceptionoccurrencesItemAcceptRequestBuilder instantiates a new ItemCalendarCalendarviewItemInstancesItemExceptionoccurrencesItemAcceptRequestBuilder and sets the default values.
