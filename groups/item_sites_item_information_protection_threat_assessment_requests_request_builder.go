...
// ByThreatAssessmentRequestIdString provides operations to manage the threatAssessmentRequests property of the microsoft.graph.informationProtection entity.
func (m *ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder) ByThreatAssessmentRequestIdString(threatAssessmentRequestId string)(*ItemSitesItemInformationProtectionThreatAssessmentRequestsThreatAssessmentRequestItemRequestBuilder) {
