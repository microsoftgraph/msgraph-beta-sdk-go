...
// ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilderGetQueryParameters get threatAssessmentRequests from groups
...
func (m *ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder) ByThreatAssessmentRequestId(threatAssessmentRequestId string)(*ItemSitesItemInformationProtectionThreatAssessmentRequestsThreatAssessmentRequestItemRequestBuilder) {
...
// NewItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilderInternal instantiates a new ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder and sets the default values.
func NewItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder) {
    m := &ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/threatAssessmentRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder instantiates a new ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder and sets the default values.
...
// returns a *ItemSitesItemInformationProtectionThreatAssessmentRequestsCountRequestBuilder when successful
func (m *ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder) Count()(*ItemSitesItemInformationProtectionThreatAssessmentRequestsCountRequestBuilder) {
    return NewItemSitesItemInformationProtectionThreatAssessmentRequestsCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// Post create new navigation property to threatAssessmentRequests for groups
...
func (m *ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// ToPostRequestInformation create new navigation property to threatAssessmentRequests for groups
// returns a *RequestInformation when successful
func (m *ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ThreatAssessmentRequestable, requestConfiguration *ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder) {
    return NewItemSitesItemInformationProtectionThreatAssessmentRequestsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
