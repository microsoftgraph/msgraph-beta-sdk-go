...
// returns a *ItemTeamOwnersUserItemRequestBuilder when successful
func (m *ItemTeamOwnersRequestBuilder) ByUserId(userId string)(*ItemTeamOwnersUserItemRequestBuilder) {
    ...
    return NewItemTeamOwnersUserItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
// NewItemTeamOwnersRequestBuilderInternal instantiates a new ItemTeamOwnersRequestBuilder and sets the default values.
func NewItemTeamOwnersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamOwnersRequestBuilder) {
    m := &ItemTeamOwnersRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/owners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemTeamOwnersRequestBuilder instantiates a new ItemTeamOwnersRequestBuilder and sets the default values.
...
func (m *ItemTeamOwnersRequestBuilder) Count()(*ItemTeamOwnersCountRequestBuilder) {
    return NewItemTeamOwnersCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *ItemTeamOwnersRequestBuilder when successful
func (m *ItemTeamOwnersRequestBuilder) WithUrl(rawUrl string)(*ItemTeamOwnersRequestBuilder) {
    return NewItemTeamOwnersRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
