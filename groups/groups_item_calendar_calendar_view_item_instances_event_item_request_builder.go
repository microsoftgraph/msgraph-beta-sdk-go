...
func (m *GroupsItemCalendarCalendarViewItemInstancesEventItemRequestBuilder) ExceptionOccurrences()(*GroupsItemCalendarCalendarViewItemInstancesItemExceptionOccurrencesRequestBuilder) {
    return NewGroupsItemCalendarCalendarViewItemInstancesItemExceptionOccurrencesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *GroupsItemCalendarCalendarViewItemInstancesEventItemRequestBuilder) ExceptionOccurrencesById(id string)(*GroupsItemCalendarCalendarViewItemInstancesItemExceptionOccurrencesEventItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewGroupsItemCalendarCalendarViewItemInstancesItemExceptionOccurrencesEventItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *GroupsItemCalendarCalendarViewItemInstancesEventItemRequestBuilder) Get(ctx context.Context, requestConfiguration *GroupsItemCalendarCalendarViewItemInstancesEventItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Eventable, error) {
