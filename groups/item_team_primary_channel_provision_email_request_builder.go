...
// NewItemTeamPrimaryChannelProvisionEmailRequestBuilderInternal instantiates a new ItemTeamPrimaryChannelProvisionEmailRequestBuilder and sets the default values.
...
// NewItemTeamPrimaryChannelProvisionEmailRequestBuilder instantiates a new ItemTeamPrimaryChannelProvisionEmailRequestBuilder and sets the default values.
...
func (m *ItemTeamPrimaryChannelProvisionEmailRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemTeamPrimaryChannelProvisionEmailRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ProvisionChannelEmailResultable, error) {
...
func (m *ItemTeamPrimaryChannelProvisionEmailRequestBuilder) WithUrl(rawUrl string)(*ItemTeamPrimaryChannelProvisionEmailRequestBuilder) {
    return NewItemTeamPrimaryChannelProvisionEmailRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
