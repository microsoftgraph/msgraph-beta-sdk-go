...
// ItemSitesItemListsItemItemsItemPermissionsPermissionItemRequestBuilderGetQueryParameters get permissions from groups
...
func (m *ItemSitesItemListsItemItemsItemPermissionsPermissionItemRequestBuilder) RevokeGrants()(*ItemSitesItemListsItemItemsItemPermissionsItemRevokegrantsRevokeGrantsRequestBuilder) {
    return NewItemSitesItemListsItemItemsItemPermissionsItemRevokegrantsRevokeGrantsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
