...
func (m *ItemSitesItemListsItemItemsRequestBuilder) MicrosoftGraphDelta()(*ItemSitesItemListsItemItemsMicrosoftGraphDeltaRequestBuilder) {
    return NewItemSitesItemListsItemItemsMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDeltaWithToken provides operations to call the delta method.
func (m *ItemSitesItemListsItemItemsRequestBuilder) MicrosoftGraphDeltaWithToken(token *string)(*ItemSitesItemListsItemItemsMicrosoftGraphDeltaWithTokenRequestBuilder) {
    return NewItemSitesItemListsItemItemsMicrosoftGraphDeltaWithTokenRequestBuilderInternal(m.pathParameters, m.requestAdapter, token)
}
