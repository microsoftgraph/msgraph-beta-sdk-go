...
func (m *ItemTeamPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) MicrosoftGraphCheckMemberGroups()(*ItemTeamPermissionGrantsItemMicrosoftGraphCheckMemberGroupsRequestBuilder) {
    return NewItemTeamPermissionGrantsItemMicrosoftGraphCheckMemberGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCheckMemberObjects provides operations to call the checkMemberObjects method.
func (m *ItemTeamPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) MicrosoftGraphCheckMemberObjects()(*ItemTeamPermissionGrantsItemMicrosoftGraphCheckMemberObjectsRequestBuilder) {
    return NewItemTeamPermissionGrantsItemMicrosoftGraphCheckMemberObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetMemberGroups provides operations to call the getMemberGroups method.
func (m *ItemTeamPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) MicrosoftGraphGetMemberGroups()(*ItemTeamPermissionGrantsItemMicrosoftGraphGetMemberGroupsRequestBuilder) {
    return NewItemTeamPermissionGrantsItemMicrosoftGraphGetMemberGroupsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetMemberObjects provides operations to call the getMemberObjects method.
func (m *ItemTeamPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) MicrosoftGraphGetMemberObjects()(*ItemTeamPermissionGrantsItemMicrosoftGraphGetMemberObjectsRequestBuilder) {
    return NewItemTeamPermissionGrantsItemMicrosoftGraphGetMemberObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRestore provides operations to call the restore method.
func (m *ItemTeamPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) MicrosoftGraphRestore()(*ItemTeamPermissionGrantsItemMicrosoftGraphRestoreRequestBuilder) {
    return NewItemTeamPermissionGrantsItemMicrosoftGraphRestoreRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
