...
func (m *ItemSitesItemPagesItemWebPartsWebPartItemRequestBuilder) MicrosoftGraphGetPositionOfWebPart()(*ItemSitesItemPagesItemWebPartsItemMicrosoftGraphGetPositionOfWebPartRequestBuilder) {
    return NewItemSitesItemPagesItemWebPartsItemMicrosoftGraphGetPositionOfWebPartRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
