...
// NewItemSitesItemPagesGraphSitePageRequestBuilderInternal instantiates a new GraphSitePageRequestBuilder and sets the default values.
func NewItemSitesItemPagesGraphSitePageRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemPagesGraphSitePageRequestBuilder) {
    m := &ItemSitesItemPagesGraphSitePageRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/graph.sitePage{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemSitesItemPagesGraphSitePageRequestBuilder instantiates a new GraphSitePageRequestBuilder and sets the default values.
...
func (m *ItemSitesItemPagesGraphSitePageRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemPagesGraphSitePageRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SitePageCollectionResponseable, error) {
