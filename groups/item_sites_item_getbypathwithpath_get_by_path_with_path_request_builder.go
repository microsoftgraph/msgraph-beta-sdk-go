...
func (m *ItemSitesItemGetbypathwithpathGetByPathWithPathRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemGetbypathwithpathGetByPathWithPathRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Siteable, error) {
...
func (m *ItemSitesItemGetbypathwithpathGetByPathWithPathRequestBuilder) InformationProtection()(*ItemSitesItemGetbypathwithpathInformationprotectionInformationProtectionRequestBuilder) {
    return NewItemSitesItemGetbypathwithpathInformationprotectionInformationProtectionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemSitesItemGetbypathwithpathGetByPathWithPathRequestBuilder) RecycleBin()(*ItemSitesItemGetbypathwithpathRecyclebinRecycleBinRequestBuilder) {
    return NewItemSitesItemGetbypathwithpathRecyclebinRecycleBinRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
