...
// NewItemSitesItemPagesGraphSitePageCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemSitesItemPagesGraphSitePageCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemPagesGraphSitePageCountRequestBuilder) {
    m := &ItemSitesItemPagesGraphSitePageCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/graph.sitePage/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewItemSitesItemPagesGraphSitePageCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
