...
func (m *ItemConversationsItemThreadsItemPostsItemAttachmentsRequestBuilder) MicrosoftGraphCreateUploadSession()(*ItemConversationsItemThreadsItemPostsItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilder) {
    return NewItemConversationsItemThreadsItemPostsItemAttachmentsMicrosoftGraphCreateUploadSessionCreateUploadSessionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
