...
func (m *ItemTeamChannelsItemMessagesChatMessageItemRequestBuilder) HostedContentsById(id string)(*ItemTeamChannelsItemMessagesItemHostedContentsChatMessageHostedContentItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemTeamChannelsItemMessagesItemHostedContentsChatMessageHostedContentItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
// MicrosoftGraphSetReaction provides operations to call the setReaction method.
func (m *ItemTeamChannelsItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphSetReaction()(*ItemTeamChannelsItemMessagesItemMicrosoftGraphSetReactionSetReactionRequestBuilder) {
    return NewItemTeamChannelsItemMessagesItemMicrosoftGraphSetReactionSetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemTeamChannelsItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphUnsetReaction()(*ItemTeamChannelsItemMessagesItemMicrosoftGraphUnsetReactionUnsetReactionRequestBuilder) {
    return NewItemTeamChannelsItemMessagesItemMicrosoftGraphUnsetReactionUnsetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemTeamChannelsItemMessagesChatMessageItemRequestBuilder) RepliesById(id string)(*ItemTeamChannelsItemMessagesItemRepliesChatMessageItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemTeamChannelsItemMessagesItemRepliesChatMessageItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
