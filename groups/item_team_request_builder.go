...
func (m *ItemTeamRequestBuilder) OwnersById(id string)(*ItemTeamOwnersUserItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemTeamOwnersUserItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemTeamRequestBuilder) PermissionGrantsById(id string)(*ItemTeamPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemTeamPermissionGrantsResourceSpecificPermissionGrantItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
