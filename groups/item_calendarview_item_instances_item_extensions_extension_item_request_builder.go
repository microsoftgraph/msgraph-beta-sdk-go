...
// NewItemCalendarviewItemInstancesItemExtensionsExtensionItemRequestBuilderInternal instantiates a new ItemCalendarviewItemInstancesItemExtensionsExtensionItemRequestBuilder and sets the default values.
func NewItemCalendarviewItemInstancesItemExtensionsExtensionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarviewItemInstancesItemExtensionsExtensionItemRequestBuilder) {
    m := &ItemCalendarviewItemInstancesItemExtensionsExtensionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/extensions/{extension%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemCalendarviewItemInstancesItemExtensionsExtensionItemRequestBuilder instantiates a new ItemCalendarviewItemInstancesItemExtensionsExtensionItemRequestBuilder and sets the default values.
