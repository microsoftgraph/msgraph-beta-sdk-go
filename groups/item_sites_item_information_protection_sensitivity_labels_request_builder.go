...
func (m *ItemSitesItemInformationProtectionSensitivityLabelsRequestBuilder) ComputeInheritanceWithLabelIdsWithLocaleWithContentFormats(contentFormats *string, labelIds *string, locale *string)(*ItemSitesItemInformationProtectionSensitivityLabelsComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilder) {
    return NewItemSitesItemInformationProtectionSensitivityLabelsComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, contentFormats, labelIds, locale)
}
...
func (m *ItemSitesItemInformationProtectionSensitivityLabelsRequestBuilder) ComputeRightsAndInheritance()(*ItemSitesItemInformationProtectionSensitivityLabelsComputeRightsAndInheritanceRequestBuilder) {
    return NewItemSitesItemInformationProtectionSensitivityLabelsComputeRightsAndInheritanceRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
