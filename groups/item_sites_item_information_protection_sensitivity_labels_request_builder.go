...
func (m *ItemSitesItemInformationProtectionSensitivityLabelsRequestBuilder) MicrosoftGraphEvaluate()(*ItemSitesItemInformationProtectionSensitivityLabelsMicrosoftGraphEvaluateRequestBuilder) {
    return NewItemSitesItemInformationProtectionSensitivityLabelsMicrosoftGraphEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
