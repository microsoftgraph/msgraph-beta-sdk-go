...
// ItemSitesItemListsItemItemsItemActivitiesItemDriveItemContentRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSitesItemListsItemItemsItemActivitiesItemDriveItemContentRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// Delete delete content for the navigation property driveItem in groups
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemSitesItemListsItemItemsItemActivitiesItemDriveItemContentRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemSitesItemListsItemItemsItemActivitiesItemDriveItemContentRequestBuilderDeleteRequestConfiguration)(error) {
...
// ToDeleteRequestInformation delete content for the navigation property driveItem in groups
// returns a *RequestInformation when successful
func (m *ItemSitesItemListsItemItemsItemActivitiesItemDriveItemContentRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemSitesItemListsItemItemsItemActivitiesItemDriveItemContentRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
