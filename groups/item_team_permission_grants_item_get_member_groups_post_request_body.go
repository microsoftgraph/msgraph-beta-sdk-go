...
// ItemTeamPermissionGrantsItemGetMemberGroupsPostRequestBody provides operations to call the getMemberGroups method.
...
func (m *ItemTeamPermissionGrantsItemGetMemberGroupsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemTeamPermissionGrantsItemGetMemberGroupsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
