...
func (m *ItemSitesItemGetbypathwithpathGetbypathwithpath1GetByPathWithPath1RequestBuilder) InformationProtection()(*ItemSitesItemGetbypathwithpathGetbypathwithpath1InformationprotectionInformationProtectionRequestBuilder) {
    return NewItemSitesItemGetbypathwithpathGetbypathwithpath1InformationprotectionInformationProtectionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemSitesItemGetbypathwithpathGetbypathwithpath1GetByPathWithPath1RequestBuilder) RecycleBin()(*ItemSitesItemGetbypathwithpathGetbypathwithpath1RecyclebinRecycleBinRequestBuilder) {
    return NewItemSitesItemGetbypathwithpathGetbypathwithpath1RecyclebinRecycleBinRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
