...
func (m *ItemSitesItemListsItemItemsListItemItemRequestBuilder) MicrosoftGraphCreateLink()(*ItemSitesItemListsItemItemsItemMicrosoftGraphCreateLinkRequestBuilder) {
    return NewItemSitesItemListsItemItemsItemMicrosoftGraphCreateLinkRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
