...
// ItemSitesItemRecycleBinItemsRequestBuilderGetQueryParameters get a collection of recycleBinItem resources in the recyleBin of the specified SharePoint site. This API is available in the following national cloud deployments.
