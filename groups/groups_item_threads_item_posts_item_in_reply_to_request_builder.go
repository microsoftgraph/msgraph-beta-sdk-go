...
// GroupsItemThreadsItemPostsItemInReplyToRequestBuilderGetQueryParameters the earlier post that this post is replying to in the conversationThread. Read-only. Supports $expand.
...
func (m *GroupsItemThreadsItemPostsItemInReplyToRequestBuilder) Get(ctx context.Context, requestConfiguration *GroupsItemThreadsItemPostsItemInReplyToRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Postable, error) {
...
func (m *GroupsItemThreadsItemPostsItemInReplyToRequestBuilder) Mentions()(*GroupsItemThreadsItemPostsItemInReplyToMentionsRequestBuilder) {
    return NewGroupsItemThreadsItemPostsItemInReplyToMentionsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// MentionsById provides operations to manage the mentions property of the microsoft.graph.post entity.
func (m *GroupsItemThreadsItemPostsItemInReplyToRequestBuilder) MentionsById(id string)(*GroupsItemThreadsItemPostsItemInReplyToMentionsMentionItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewGroupsItemThreadsItemPostsItemInReplyToMentionsMentionItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
