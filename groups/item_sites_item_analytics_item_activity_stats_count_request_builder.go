...
// NewItemSitesItemAnalyticsItemActivityStatsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemSitesItemAnalyticsItemActivityStatsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemAnalyticsItemActivityStatsCountRequestBuilder) {
    m := &ItemSitesItemAnalyticsItemActivityStatsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics/itemActivityStats/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewItemSitesItemAnalyticsItemActivityStatsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
