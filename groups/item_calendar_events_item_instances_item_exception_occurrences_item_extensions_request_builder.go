...
func (m *ItemCalendarEventsItemInstancesItemExceptionOccurrencesItemExtensionsRequestBuilder) ByExtensionIdString(extensionId string)(*ItemCalendarEventsItemInstancesItemExceptionOccurrencesItemExtensionsExtensionItemRequestBuilder) {
...
// NewItemCalendarEventsItemInstancesItemExceptionOccurrencesItemExtensionsRequestBuilderInternal instantiates a new ExtensionsRequestBuilder and sets the default values.
...
// NewItemCalendarEventsItemInstancesItemExceptionOccurrencesItemExtensionsRequestBuilder instantiates a new ExtensionsRequestBuilder and sets the default values.
