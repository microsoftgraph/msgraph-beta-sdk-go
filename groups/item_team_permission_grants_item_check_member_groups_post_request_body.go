...
// ItemTeamPermissionGrantsItemCheckMemberGroupsPostRequestBody provides operations to call the checkMemberGroups method.
...
func (m *ItemTeamPermissionGrantsItemCheckMemberGroupsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemTeamPermissionGrantsItemCheckMemberGroupsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
