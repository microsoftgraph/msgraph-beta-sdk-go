...
func (m *ItemSitesRequestBuilder) MicrosoftGraphDelta()(*ItemSitesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemSitesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
