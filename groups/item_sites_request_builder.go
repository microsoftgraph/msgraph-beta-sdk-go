...
func (m *ItemSitesRequestBuilder) MicrosoftGraphDelta()(*ItemSitesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemSitesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
