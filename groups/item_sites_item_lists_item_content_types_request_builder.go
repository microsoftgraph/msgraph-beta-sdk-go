...
func (m *ItemSitesItemListsItemContentTypesRequestBuilder) MicrosoftGraphAddCopy()(*ItemSitesItemListsItemContentTypesMicrosoftGraphAddCopyAddCopyRequestBuilder) {
    return NewItemSitesItemListsItemContentTypesMicrosoftGraphAddCopyAddCopyRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphAddCopyFromContentTypeHub provides operations to call the addCopyFromContentTypeHub method.
func (m *ItemSitesItemListsItemContentTypesRequestBuilder) MicrosoftGraphAddCopyFromContentTypeHub()(*ItemSitesItemListsItemContentTypesMicrosoftGraphAddCopyFromContentTypeHubAddCopyFromContentTypeHubRequestBuilder) {
    return NewItemSitesItemListsItemContentTypesMicrosoftGraphAddCopyFromContentTypeHubAddCopyFromContentTypeHubRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetCompatibleHubContentTypes provides operations to call the getCompatibleHubContentTypes method.
func (m *ItemSitesItemListsItemContentTypesRequestBuilder) MicrosoftGraphGetCompatibleHubContentTypes()(*ItemSitesItemListsItemContentTypesMicrosoftGraphGetCompatibleHubContentTypesGetCompatibleHubContentTypesRequestBuilder) {
    return NewItemSitesItemListsItemContentTypesMicrosoftGraphGetCompatibleHubContentTypesGetCompatibleHubContentTypesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
