...
// NewItemSitesItemRecyclebinCreatedbyuserServiceprovisioningerrorsCountRequestBuilderInternal instantiates a new ItemSitesItemRecyclebinCreatedbyuserServiceprovisioningerrorsCountRequestBuilder and sets the default values.
func NewItemSitesItemRecyclebinCreatedbyuserServiceprovisioningerrorsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemRecyclebinCreatedbyuserServiceprovisioningerrorsCountRequestBuilder) {
    m := &ItemSitesItemRecyclebinCreatedbyuserServiceprovisioningerrorsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/createdByUser/serviceProvisioningErrors/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemSitesItemRecyclebinCreatedbyuserServiceprovisioningerrorsCountRequestBuilder instantiates a new ItemSitesItemRecyclebinCreatedbyuserServiceprovisioningerrorsCountRequestBuilder and sets the default values.
