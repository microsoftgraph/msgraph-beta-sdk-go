...
// NewItemTeamScheduleTimeCardsClockInPostRequestBody instantiates a new ItemTeamScheduleTimeCardsClockInPostRequestBody and sets the default values.
...
func CreateItemTeamScheduleTimeCardsClockInPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
...
func (m *ItemTeamScheduleTimeCardsClockInPostRequestBody) GetAtApprovedLocation()(*bool) {
...
func (m *ItemTeamScheduleTimeCardsClockInPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemTeamScheduleTimeCardsClockInPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemTeamScheduleTimeCardsClockInPostRequestBody) GetNotes()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ItemBodyable) {
...
func (m *ItemTeamScheduleTimeCardsClockInPostRequestBody) GetOnBehalfOfUserId()(*string) {
...
func (m *ItemTeamScheduleTimeCardsClockInPostRequestBody) SetAtApprovedLocation(value *bool)() {
...
func (m *ItemTeamScheduleTimeCardsClockInPostRequestBody) SetOnBehalfOfUserId(value *string)() {
    err := m.GetBackingStore().Set("onBehalfOfUserId", value)
    if err != nil {
        panic(err)
    }
}
// ItemTeamScheduleTimeCardsClockInPostRequestBodyable 
type ItemTeamScheduleTimeCardsClockInPostRequestBodyable interface {
