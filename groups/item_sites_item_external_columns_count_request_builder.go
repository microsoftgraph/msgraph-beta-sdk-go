...
// NewItemSitesItemExternalColumnsCountRequestBuilderInternal instantiates a new ItemSitesItemExternalColumnsCountRequestBuilder and sets the default values.
func NewItemSitesItemExternalColumnsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemExternalColumnsCountRequestBuilder) {
    m := &ItemSitesItemExternalColumnsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/externalColumns/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemSitesItemExternalColumnsCountRequestBuilder instantiates a new ItemSitesItemExternalColumnsCountRequestBuilder and sets the default values.
...
func (m *ItemSitesItemExternalColumnsCountRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemExternalColumnsCountRequestBuilder) {
    return NewItemSitesItemExternalColumnsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
