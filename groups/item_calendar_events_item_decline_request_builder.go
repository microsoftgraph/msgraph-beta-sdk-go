...
// NewItemCalendarEventsItemDeclineRequestBuilderInternal instantiates a new ItemCalendarEventsItemDeclineRequestBuilder and sets the default values.
func NewItemCalendarEventsItemDeclineRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarEventsItemDeclineRequestBuilder) {
    m := &ItemCalendarEventsItemDeclineRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/decline", pathParameters),
    }
    return m
}
// NewItemCalendarEventsItemDeclineRequestBuilder instantiates a new ItemCalendarEventsItemDeclineRequestBuilder and sets the default values.
