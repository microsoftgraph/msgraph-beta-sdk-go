...
// ItemConversationsItemThreadsItemReplyPostRequestBody provides operations to call the reply method.
...
func (m *ItemConversationsItemThreadsItemReplyPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemConversationsItemThreadsItemReplyPostRequestBody) GetPost()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Postable) {
    return m.post
}
...
func (m *ItemConversationsItemThreadsItemReplyPostRequestBody) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetPost sets the post property value. The Post property
func (m *ItemConversationsItemThreadsItemReplyPostRequestBody) SetPost(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Postable)() {
    m.post = value
}
