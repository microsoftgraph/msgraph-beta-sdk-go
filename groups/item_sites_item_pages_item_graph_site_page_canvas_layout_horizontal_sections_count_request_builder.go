...
func (m *ItemSitesItemPagesItemGraphSitePageCanvasLayoutHorizontalSectionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemPagesItemGraphSitePageCanvasLayoutHorizontalSectionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
