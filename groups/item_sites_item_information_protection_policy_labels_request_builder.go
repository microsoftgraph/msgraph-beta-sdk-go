...
func (m *ItemSitesItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateApplication()(*ItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateApplicationRequestBuilder) {
    return NewItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateClassificationResults provides operations to call the evaluateClassificationResults method.
func (m *ItemSitesItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateClassificationResults()(*ItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateClassificationResultsRequestBuilder) {
    return NewItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateClassificationResultsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateRemoval provides operations to call the evaluateRemoval method.
func (m *ItemSitesItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateRemoval()(*ItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateRemovalRequestBuilder) {
    return NewItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateRemovalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphExtractLabel provides operations to call the extractLabel method.
func (m *ItemSitesItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphExtractLabel()(*ItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphExtractLabelRequestBuilder) {
    return NewItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphExtractLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
