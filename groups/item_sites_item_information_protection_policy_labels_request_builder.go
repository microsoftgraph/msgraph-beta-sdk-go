...
func (m *ItemSitesItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateApplication()(*ItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateApplicationEvaluateApplicationRequestBuilder) {
    return NewItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateApplicationEvaluateApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateClassificationResults provides operations to call the evaluateClassificationResults method.
func (m *ItemSitesItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateClassificationResults()(*ItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateClassificationResultsEvaluateClassificationResultsRequestBuilder) {
    return NewItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateClassificationResultsEvaluateClassificationResultsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateRemoval provides operations to call the evaluateRemoval method.
func (m *ItemSitesItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphEvaluateRemoval()(*ItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateRemovalEvaluateRemovalRequestBuilder) {
    return NewItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphEvaluateRemovalEvaluateRemovalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphExtractLabel provides operations to call the extractLabel method.
func (m *ItemSitesItemInformationProtectionPolicyLabelsRequestBuilder) MicrosoftGraphExtractLabel()(*ItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphExtractLabelExtractLabelRequestBuilder) {
    return NewItemSitesItemInformationProtectionPolicyLabelsMicrosoftGraphExtractLabelExtractLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
