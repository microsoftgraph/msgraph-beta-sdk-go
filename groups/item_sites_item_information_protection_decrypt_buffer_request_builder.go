...
// NewItemSitesItemInformationProtectionDecryptBufferRequestBuilderInternal instantiates a new ItemSitesItemInformationProtectionDecryptBufferRequestBuilder and sets the default values.
...
// NewItemSitesItemInformationProtectionDecryptBufferRequestBuilder instantiates a new ItemSitesItemInformationProtectionDecryptBufferRequestBuilder and sets the default values.
...
func (m *ItemSitesItemInformationProtectionDecryptBufferRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemInformationProtectionDecryptBufferRequestBuilder) {
    return NewItemSitesItemInformationProtectionDecryptBufferRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
