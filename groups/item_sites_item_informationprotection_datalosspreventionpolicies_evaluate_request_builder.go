...
// NewItemSitesItemInformationprotectionDatalosspreventionpoliciesEvaluateRequestBuilderInternal instantiates a new ItemSitesItemInformationprotectionDatalosspreventionpoliciesEvaluateRequestBuilder and sets the default values.
...
// NewItemSitesItemInformationprotectionDatalosspreventionpoliciesEvaluateRequestBuilder instantiates a new ItemSitesItemInformationprotectionDatalosspreventionpoliciesEvaluateRequestBuilder and sets the default values.
...
func (m *ItemSitesItemInformationprotectionDatalosspreventionpoliciesEvaluateRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemInformationprotectionDatalosspreventionpoliciesEvaluateRequestBuilder) {
    return NewItemSitesItemInformationprotectionDatalosspreventionpoliciesEvaluateRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
