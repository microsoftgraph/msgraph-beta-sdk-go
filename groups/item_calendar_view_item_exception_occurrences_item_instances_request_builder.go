...
func (m *ItemCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder) Count()(*ItemCalendarViewItemExceptionOccurrencesItemInstancesCountRequestBuilder) {
    return NewItemCalendarViewItemExceptionOccurrencesItemInstancesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder) Delta()(*ItemCalendarViewItemExceptionOccurrencesItemInstancesDeltaRequestBuilder) {
    return NewItemCalendarViewItemExceptionOccurrencesItemInstancesDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
