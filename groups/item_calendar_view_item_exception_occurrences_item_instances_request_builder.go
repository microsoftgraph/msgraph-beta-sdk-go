...
func (m *ItemCalendarViewItemExceptionOccurrencesItemInstancesRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarViewItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemCalendarViewItemExceptionOccurrencesItemInstancesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
