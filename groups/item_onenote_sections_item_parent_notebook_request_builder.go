...
// NewItemOnenoteSectionsItemParentNotebookRequestBuilderInternal instantiates a new ItemOnenoteSectionsItemParentNotebookRequestBuilder and sets the default values.
...
// NewItemOnenoteSectionsItemParentNotebookRequestBuilder instantiates a new ItemOnenoteSectionsItemParentNotebookRequestBuilder and sets the default values.
...
func (m *ItemOnenoteSectionsItemParentNotebookRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOnenoteSectionsItemParentNotebookRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Notebookable, error) {
...
func (m *ItemOnenoteSectionsItemParentNotebookRequestBuilder) WithUrl(rawUrl string)(*ItemOnenoteSectionsItemParentNotebookRequestBuilder) {
    return NewItemOnenoteSectionsItemParentNotebookRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
