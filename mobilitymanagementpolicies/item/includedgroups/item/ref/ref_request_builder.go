...
// RefRequestBuilder provides operations to manage the collection of mobilityManagementPolicy entities.
...
// RefRequestBuilderDeleteQueryParameters delete ref of navigation property includedGroups for mobilityManagementPolicies
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/mobilityManagementPolicies/{mobilityManagementPolicy%2Did}/includedGroups/{group%2Did}/$ref{?%40id}";
...
// CreateDeleteRequestInformation delete ref of navigation property includedGroups for mobilityManagementPolicies
...
// CreateDeleteRequestInformationWithRequestConfiguration delete ref of navigation property includedGroups for mobilityManagementPolicies
...
// DeleteWithRequestConfigurationAndResponseHandler delete ref of navigation property includedGroups for mobilityManagementPolicies
