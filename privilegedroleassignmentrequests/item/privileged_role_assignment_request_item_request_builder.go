...
// PrivilegedRoleAssignmentRequestItemRequestBuilder builds and executes requests for operations under \privilegedRoleAssignmentRequests\{privilegedRoleAssignmentRequest-id}
...
// PrivilegedRoleAssignmentRequestItemRequestBuilderDeleteOptions options for Delete
type PrivilegedRoleAssignmentRequestItemRequestBuilderDeleteOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// PrivilegedRoleAssignmentRequestItemRequestBuilderGetOptions options for Get
type PrivilegedRoleAssignmentRequestItemRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
    // Request query parameters
    Q *PrivilegedRoleAssignmentRequestItemRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
// PrivilegedRoleAssignmentRequestItemRequestBuilderPatchOptions options for Patch
type PrivilegedRoleAssignmentRequestItemRequestBuilderPatchOptions struct {
    // 
...
func NewPrivilegedRoleAssignmentRequestItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PrivilegedRoleAssignmentRequestItemRequestBuilder) {
...
func NewPrivilegedRoleAssignmentRequestItemRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PrivilegedRoleAssignmentRequestItemRequestBuilder) {
...
func (m *PrivilegedRoleAssignmentRequestItemRequestBuilder) CreateDeleteRequestInformation(options *PrivilegedRoleAssignmentRequestItemRequestBuilderDeleteOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *PrivilegedRoleAssignmentRequestItemRequestBuilder) CreateGetRequestInformation(options *PrivilegedRoleAssignmentRequestItemRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *PrivilegedRoleAssignmentRequestItemRequestBuilder) CreatePatchRequestInformation(options *PrivilegedRoleAssignmentRequestItemRequestBuilderPatchOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *PrivilegedRoleAssignmentRequestItemRequestBuilder) Delete(options *PrivilegedRoleAssignmentRequestItemRequestBuilderDeleteOptions)(error) {
...
func (m *PrivilegedRoleAssignmentRequestItemRequestBuilder) Get(options *PrivilegedRoleAssignmentRequestItemRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PrivilegedRoleAssignmentRequest, error) {
...
func (m *PrivilegedRoleAssignmentRequestItemRequestBuilder) Patch(options *PrivilegedRoleAssignmentRequestItemRequestBuilderPatchOptions)(error) {
