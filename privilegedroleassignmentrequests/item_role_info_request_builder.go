...
// ItemRoleInfoRequestBuilder provides operations to manage the roleInfo property of the microsoft.graph.privilegedRoleAssignmentRequest entity.
type ItemRoleInfoRequestBuilder struct {
...
// ItemRoleInfoRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemRoleInfoRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// ItemRoleInfoRequestBuilderGetQueryParameters the roleInfo object of the role assignment request.
type ItemRoleInfoRequestBuilderGetQueryParameters struct {
    // Expand related entities
    Expand []string `uriparametername:"%24expand"`
    // Select properties to be returned
    Select []string `uriparametername:"%24select"`
}
// ItemRoleInfoRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemRoleInfoRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemRoleInfoRequestBuilderGetQueryParameters
}
// ItemRoleInfoRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemRoleInfoRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func (m *ItemRoleInfoRequestBuilder) AssignmentsById(id string)(*ItemRoleInfoAssignmentsPrivilegedRoleAssignmentItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemRoleInfoAssignmentsPrivilegedRoleAssignmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *ItemRoleInfoRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRoleInfoRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrivilegedRoleable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreatePrivilegedRoleFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphSelfActivate provides operations to call the selfActivate method.
func (m *ItemRoleInfoRequestBuilder) MicrosoftGraphSelfActivate()(*ItemRoleInfoMicrosoftGraphSelfActivateSelfActivateRequestBuilder) {
    return NewItemRoleInfoMicrosoftGraphSelfActivateSelfActivateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSelfDeactivate provides operations to call the selfDeactivate method.
func (m *ItemRoleInfoRequestBuilder) MicrosoftGraphSelfDeactivate()(*ItemRoleInfoMicrosoftGraphSelfDeactivateSelfDeactivateRequestBuilder) {
    return NewItemRoleInfoMicrosoftGraphSelfDeactivateSelfDeactivateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// ToGetRequestInformation the roleInfo object of the role assignment request.
