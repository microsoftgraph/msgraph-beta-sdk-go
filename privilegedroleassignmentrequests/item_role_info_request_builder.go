...
func (m *ItemRoleInfoRequestBuilder) MicrosoftGraphSelfActivate()(*ItemRoleInfoMicrosoftGraphSelfActivateRequestBuilder) {
    return NewItemRoleInfoMicrosoftGraphSelfActivateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSelfDeactivate provides operations to call the selfDeactivate method.
func (m *ItemRoleInfoRequestBuilder) MicrosoftGraphSelfDeactivate()(*ItemRoleInfoMicrosoftGraphSelfDeactivateRequestBuilder) {
    return NewItemRoleInfoMicrosoftGraphSelfDeactivateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
