...
// ItemRoleinfoAssignmentsPrivilegedRoleAssignmentItemRequestBuilderGetQueryParameters get assignments from privilegedRoleAssignmentRequests
...
func NewItemRoleinfoAssignmentsPrivilegedRoleAssignmentItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRoleinfoAssignmentsPrivilegedRoleAssignmentItemRequestBuilder) {
    m := &ItemRoleinfoAssignmentsPrivilegedRoleAssignmentItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/assignments/{privilegedRoleAssignment%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
// Get get assignments from privilegedRoleAssignmentRequests
...
// ToGetRequestInformation get assignments from privilegedRoleAssignmentRequests
