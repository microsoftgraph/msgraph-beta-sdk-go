...
func (m *PrivilegedRoleAssignmentRequestItemRequestBuilder) MicrosoftGraphCancel()(*ItemMicrosoftGraphCancelRequestBuilder) {
    return NewItemMicrosoftGraphCancelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
