...
// RefRequestBuilder builds and executes requests for operations under \governanceRoleDefinitions\{governanceRoleDefinition-id}\resource\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/governanceRoleDefinitions/{governanceRoleDefinition_id}/resource/$ref";
...
// CreatePutRequestInformation read-only. The associated resource for the role definition.
...
// Put read-only. The associated resource for the role definition.
