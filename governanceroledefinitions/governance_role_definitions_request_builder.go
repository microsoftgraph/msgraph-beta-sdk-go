...
// ByGovernanceRoleDefinitionId provides operations to manage the collection of governanceRoleDefinition entities.
// returns a *GovernanceRoleDefinitionItemRequestBuilder when successful
func (m *GovernanceRoleDefinitionsRequestBuilder) ByGovernanceRoleDefinitionId(governanceRoleDefinitionId string)(*GovernanceRoleDefinitionItemRequestBuilder) {
    ...
    return NewGovernanceRoleDefinitionItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
...
func NewGovernanceRoleDefinitionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GovernanceRoleDefinitionsRequestBuilder) {
    m := &GovernanceRoleDefinitionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/governanceRoleDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
...
func (m *GovernanceRoleDefinitionsRequestBuilder) Count()(*CountRequestBuilder) {
...
func (m *GovernanceRoleDefinitionsRequestBuilder) Get(ctx context.Context, requestConfiguration *GovernanceRoleDefinitionsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GovernanceRoleDefinitionCollectionResponseable, error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *GovernanceRoleDefinitionsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GovernanceRoleDefinitionable, requestConfiguration *GovernanceRoleDefinitionsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GovernanceRoleDefinitionable, error) {
...
// ToGetRequestInformation get entities from governanceRoleDefinitions
// returns a *RequestInformation when successful
func (m *GovernanceRoleDefinitionsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GovernanceRoleDefinitionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// ToPostRequestInformation add new entity to governanceRoleDefinitions
// returns a *RequestInformation when successful
func (m *GovernanceRoleDefinitionsRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GovernanceRoleDefinitionable, requestConfiguration *GovernanceRoleDefinitionsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.POST, "{+baseurl}/governanceRoleDefinitions", m.BaseRequestBuilder.PathParameters)
    if requestConfiguration != nil {
        requestInfo.Headers.AddAll(requestConfiguration.Headers)
        requestInfo.AddRequestOptions(requestConfiguration.Options)
    }
...
func (m *GovernanceRoleDefinitionsRequestBuilder) WithUrl(rawUrl string)(*GovernanceRoleDefinitionsRequestBuilder) {
    return NewGovernanceRoleDefinitionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
