...
// ByGovernanceRoleDefinitionIdString provides operations to manage the collection of governanceRoleDefinition entities.
func (m *GovernanceRoleDefinitionsRequestBuilder) ByGovernanceRoleDefinitionIdString(governanceRoleDefinitionId string)(*GovernanceRoleDefinitionItemRequestBuilder) {
