...
func NewPlacesRoomRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PlacesRoomRequestBuilder) {
    ...
    return NewPlacesRoomRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *PlacesRoomRequestBuilder) Count()(*PlacesRoomCountRequestBuilder) {
    return NewPlacesRoomCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *PlacesRoomRequestBuilder) Get(ctx context.Context, requestConfiguration *PlacesRoomRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RoomCollectionResponseable, error) {
