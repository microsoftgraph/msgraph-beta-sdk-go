...
func (m *ItemGraphRoomRequestBuilder) Children()(*ItemGraphRoomChildrenRequestBuilder) {
    return NewItemGraphRoomChildrenRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
