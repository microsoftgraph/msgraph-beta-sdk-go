...
func (m *ItemGraphRoomListWorkspacesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGraphRoomListWorkspacesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
