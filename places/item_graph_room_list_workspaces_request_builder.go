...
// NewItemGraphRoomListWorkspacesRequestBuilderInternal instantiates a new WorkspacesRequestBuilder and sets the default values.
func NewItemGraphRoomListWorkspacesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphRoomListWorkspacesRequestBuilder) {
    m := &ItemGraphRoomListWorkspacesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.roomList/workspaces{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemGraphRoomListWorkspacesRequestBuilder instantiates a new WorkspacesRequestBuilder and sets the default values.
