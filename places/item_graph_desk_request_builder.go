...
func (m *ItemGraphDeskRequestBuilder) CheckIns()(*ItemGraphDeskCheckInsRequestBuilder) {
    return NewItemGraphDeskCheckInsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemGraphDeskRequestBuilder) Children()(*ItemGraphDeskChildrenRequestBuilder) {
    return NewItemGraphDeskChildrenRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func NewItemGraphDeskRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphDeskRequestBuilder) {
    m := &ItemGraphDeskRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.desk{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemGraphDeskRequestBuilder instantiates a new ItemGraphDeskRequestBuilder and sets the default values.
func NewItemGraphDeskRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphDeskRequestBuilder) {
...
func (m *ItemGraphDeskRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGraphDeskRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Deskable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeskFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Deskable), nil
}
...
func (m *ItemGraphDeskRequestBuilder) WithUrl(rawUrl string)(*ItemGraphDeskRequestBuilder) {
    return NewItemGraphDeskRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
