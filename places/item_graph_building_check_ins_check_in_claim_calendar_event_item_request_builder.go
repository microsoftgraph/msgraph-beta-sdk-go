...
func NewItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder) {
    m := &ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.building/checkIns/{checkInClaim%2DcalendarEventId}", pathParameters),
    }
    return m
}
...
func NewItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder) {
    ...
    return NewItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilderInternal(urlParams, requestAdapter)
}
// Delete delete navigation property checkIns for places
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilderDeleteRequestConfiguration)(error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CheckInClaimable, error) {
...
// returns a CheckInClaimable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CheckInClaimable, requestConfiguration *ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CheckInClaimable, error) {
...
func (m *ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder) ToPatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CheckInClaimable, requestConfiguration *ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder) WithUrl(rawUrl string)(*ItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder) {
    return NewItemGraphBuildingCheckInsCheckInClaimCalendarEventItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
