...
type PlacesRequestBuilderGetOptions struct {
    ...
    Q *PlacesRequestBuilderGetQueryParameters;
...
func NewPlacesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PlacesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/places{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *PlacesRequestBuilder) Get(options *PlacesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PlaceCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreatePlaceCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PlaceCollectionResponseable), nil
}
// Post add new entity to places
func (m *PlacesRequestBuilder) Post(options *PlacesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Placeable, error) {
