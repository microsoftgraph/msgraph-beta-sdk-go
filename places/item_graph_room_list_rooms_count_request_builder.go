...
func (m *ItemGraphRoomListRoomsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGraphRoomListRoomsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
