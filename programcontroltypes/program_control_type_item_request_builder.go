...
func (m *ProgramControlTypeItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ProgramControlTypeItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
