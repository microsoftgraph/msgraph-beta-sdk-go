...
func (m *MonitoringRequestBuilder) AlertRecordsById(id string)(*MonitoringAlertRecordsAlertRecordItemRequestBuilder) {
    ...
    idPtr := &id
    return NewMonitoringAlertRecordsAlertRecordItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *MonitoringRequestBuilder) AlertRulesById(id string)(*MonitoringAlertRulesAlertRuleItemRequestBuilder) {
    ...
    idPtr := &id
    return NewMonitoringAlertRulesAlertRuleItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
