...
func (m *UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionCountRequestBuilderGetRequestConfiguration)(*int64, error) {
