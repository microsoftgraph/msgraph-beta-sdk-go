...
// NewRoleScopeTagsGetRoleScopeTagsByIdRequestBuilderInternal instantiates a new RoleScopeTagsGetRoleScopeTagsByIdRequestBuilder and sets the default values.
...
// NewRoleScopeTagsGetRoleScopeTagsByIdRequestBuilder instantiates a new RoleScopeTagsGetRoleScopeTagsByIdRequestBuilder and sets the default values.
...
// returns a RoleScopeTagsGetRoleScopeTagsByIdResponseable when successful
...
func (m *RoleScopeTagsGetRoleScopeTagsByIdRequestBuilder) PostAsGetRoleScopeTagsByIdPostResponse(ctx context.Context, body RoleScopeTagsGetRoleScopeTagsByIdPostRequestBodyable, requestConfiguration *RoleScopeTagsGetRoleScopeTagsByIdRequestBuilderPostRequestConfiguration)(RoleScopeTagsGetRoleScopeTagsByIdPostResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateRoleScopeTagsGetRoleScopeTagsByIdPostResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(RoleScopeTagsGetRoleScopeTagsByIdPostResponseable), nil
}
...
func (m *RoleScopeTagsGetRoleScopeTagsByIdRequestBuilder) WithUrl(rawUrl string)(*RoleScopeTagsGetRoleScopeTagsByIdRequestBuilder) {
    return NewRoleScopeTagsGetRoleScopeTagsByIdRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
