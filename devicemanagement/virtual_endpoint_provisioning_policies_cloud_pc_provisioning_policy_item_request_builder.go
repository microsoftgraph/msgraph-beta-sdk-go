...
func (m *VirtualEndpointProvisioningPoliciesCloudPcProvisioningPolicyItemRequestBuilder) MicrosoftGraphAssign()(*VirtualEndpointProvisioningPoliciesItemMicrosoftGraphAssignRequestBuilder) {
    return NewVirtualEndpointProvisioningPoliciesItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
