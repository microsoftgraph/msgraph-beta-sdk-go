...
// MonitoringAlertRecordsAlertRecordItemRequestBuilderGetQueryParameters read the properties and relationships of an alertRecord object. This API is supported in the following national cloud deployments.
