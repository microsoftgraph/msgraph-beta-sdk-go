...
// NewGroupPolicyDefinitionsItemNextVersionDefinitionPreviousVersionDefinitionPresentationsRequestBuilderInternal instantiates a new PresentationsRequestBuilder and sets the default values.
...
// NewGroupPolicyDefinitionsItemNextVersionDefinitionPreviousVersionDefinitionPresentationsRequestBuilder instantiates a new PresentationsRequestBuilder and sets the default values.
...
func (m *GroupPolicyDefinitionsItemNextVersionDefinitionPreviousVersionDefinitionPresentationsRequestBuilder) Count()(*GroupPolicyDefinitionsItemNextVersionDefinitionPreviousVersionDefinitionPresentationsCountRequestBuilder) {
    return NewGroupPolicyDefinitionsItemNextVersionDefinitionPreviousVersionDefinitionPresentationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
