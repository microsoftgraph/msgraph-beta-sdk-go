...
func (m *DeviceHealthScriptsRequestBuilder) MicrosoftGraphAreGlobalScriptsAvailable()(*DeviceHealthScriptsMicrosoftGraphAreGlobalScriptsAvailableRequestBuilder) {
    return NewDeviceHealthScriptsMicrosoftGraphAreGlobalScriptsAvailableRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEnableGlobalScripts provides operations to call the enableGlobalScripts method.
func (m *DeviceHealthScriptsRequestBuilder) MicrosoftGraphEnableGlobalScripts()(*DeviceHealthScriptsMicrosoftGraphEnableGlobalScriptsRequestBuilder) {
    return NewDeviceHealthScriptsMicrosoftGraphEnableGlobalScriptsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetRemediationSummary provides operations to call the getRemediationSummary method.
func (m *DeviceHealthScriptsRequestBuilder) MicrosoftGraphGetRemediationSummary()(*DeviceHealthScriptsMicrosoftGraphGetRemediationSummaryRequestBuilder) {
    return NewDeviceHealthScriptsMicrosoftGraphGetRemediationSummaryRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
