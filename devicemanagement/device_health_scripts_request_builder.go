...
func (m *DeviceHealthScriptsRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceHealthScriptsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceHealthScriptCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceHealthScriptCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphAreGlobalScriptsAvailable provides operations to call the areGlobalScriptsAvailable method.
func (m *DeviceHealthScriptsRequestBuilder) MicrosoftGraphAreGlobalScriptsAvailable()(*DeviceHealthScriptsMicrosoftGraphAreGlobalScriptsAvailableAreGlobalScriptsAvailableRequestBuilder) {
    return NewDeviceHealthScriptsMicrosoftGraphAreGlobalScriptsAvailableAreGlobalScriptsAvailableRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEnableGlobalScripts provides operations to call the enableGlobalScripts method.
func (m *DeviceHealthScriptsRequestBuilder) MicrosoftGraphEnableGlobalScripts()(*DeviceHealthScriptsMicrosoftGraphEnableGlobalScriptsEnableGlobalScriptsRequestBuilder) {
    return NewDeviceHealthScriptsMicrosoftGraphEnableGlobalScriptsEnableGlobalScriptsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetRemediationSummary provides operations to call the getRemediationSummary method.
func (m *DeviceHealthScriptsRequestBuilder) MicrosoftGraphGetRemediationSummary()(*DeviceHealthScriptsMicrosoftGraphGetRemediationSummaryGetRemediationSummaryRequestBuilder) {
    return NewDeviceHealthScriptsMicrosoftGraphGetRemediationSummaryGetRemediationSummaryRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
