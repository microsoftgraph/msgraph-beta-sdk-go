...
// NewManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilderInternal instantiates a new ManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder and sets the default values.
...
// NewManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder instantiates a new ManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder and sets the default values.
...
func (m *ManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder) WithUrl(rawUrl string)(*ManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder) {
    return NewManagedDevicesItemSendCustomNotificationToCompanyPortalRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
