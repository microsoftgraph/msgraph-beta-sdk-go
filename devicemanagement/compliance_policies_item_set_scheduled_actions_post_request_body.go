...
// CompliancePoliciesItemSetScheduledActionsPostRequestBody provides operations to call the setScheduledActions method.
...
func (m *CompliancePoliciesItemSetScheduledActionsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *CompliancePoliciesItemSetScheduledActionsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
