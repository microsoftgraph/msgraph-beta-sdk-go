...
func (m *RoleScopeTagsRoleScopeTagItemRequestBuilder) MicrosoftGraphAssign()(*RoleScopeTagsItemMicrosoftGraphAssignRequestBuilder) {
    return NewRoleScopeTagsItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
