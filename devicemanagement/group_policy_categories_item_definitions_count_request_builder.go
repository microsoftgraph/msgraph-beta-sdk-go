...
func (m *GroupPolicyCategoriesItemDefinitionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *GroupPolicyCategoriesItemDefinitionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
