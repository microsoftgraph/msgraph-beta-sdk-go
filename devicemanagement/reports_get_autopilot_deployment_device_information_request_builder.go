...
func (m *ReportsGetAutopilotDeploymentDeviceInformationRequestBuilder) WithUrl(rawUrl string)(*ReportsGetAutopilotDeploymentDeviceInformationRequestBuilder) {
    return NewReportsGetAutopilotDeploymentDeviceInformationRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
