...
// NewIntentsItemCompareWithTemplateIdRequestBuilderInternal instantiates a new IntentsItemCompareWithTemplateIdRequestBuilder and sets the default values.
...
// NewIntentsItemCompareWithTemplateIdRequestBuilder instantiates a new IntentsItemCompareWithTemplateIdRequestBuilder and sets the default values.
...
// returns a IntentsItemCompareWithTemplateIdResponseable when successful
...
// returns a IntentsItemCompareWithTemplateIdGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
