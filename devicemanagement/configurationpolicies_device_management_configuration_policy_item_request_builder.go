...
func (m *ConfigurationpoliciesDeviceManagementConfigurationPolicyItemRequestBuilder) ClearEnrollmentTimeDeviceMembershipTarget()(*ConfigurationpoliciesItemClearenrollmenttimedevicemembershiptargetClearEnrollmentTimeDeviceMembershipTargetRequestBuilder) {
    return NewConfigurationpoliciesItemClearenrollmenttimedevicemembershiptargetClearEnrollmentTimeDeviceMembershipTargetRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ConfigurationpoliciesDeviceManagementConfigurationPolicyItemRequestBuilder) RetrieveEnrollmentTimeDeviceMembershipTarget()(*ConfigurationpoliciesItemRetrieveenrollmenttimedevicemembershiptargetRetrieveEnrollmentTimeDeviceMembershipTargetRequestBuilder) {
    return NewConfigurationpoliciesItemRetrieveenrollmenttimedevicemembershiptargetRetrieveEnrollmentTimeDeviceMembershipTargetRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
