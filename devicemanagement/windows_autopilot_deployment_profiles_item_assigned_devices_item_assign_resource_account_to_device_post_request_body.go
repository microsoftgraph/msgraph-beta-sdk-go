...
// WindowsAutopilotDeploymentProfilesItemAssignedDevicesItemAssignResourceAccountToDevicePostRequestBody provides operations to call the assignResourceAccountToDevice method.
