...
// NewOperationApprovalPoliciesOperationApprovalPolicyItemRequestBuilderInternal instantiates a new OperationApprovalPolicyItemRequestBuilder and sets the default values.
func NewOperationApprovalPoliciesOperationApprovalPolicyItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OperationApprovalPoliciesOperationApprovalPolicyItemRequestBuilder) {
    m := &OperationApprovalPoliciesOperationApprovalPolicyItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/operationApprovalPolicies/{operationApprovalPolicy%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewOperationApprovalPoliciesOperationApprovalPolicyItemRequestBuilder instantiates a new OperationApprovalPolicyItemRequestBuilder and sets the default values.
