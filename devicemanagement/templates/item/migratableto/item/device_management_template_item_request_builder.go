...
// DeleteWithResponseHandler delete navigation property migratableTo for deviceManagement
...
// PatchWithResponseHandler update the navigation property migratableTo in deviceManagement
