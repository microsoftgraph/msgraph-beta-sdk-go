...
import (
    ...
    i718a4ae4a95066ca6f8f079a84fa2de4d80e5e8566a94f775f75be45b8974b4c "github.com/microsoftgraph/msgraph-beta-sdk-go/devicemanagement/templates/item/migratableto/item/settings/count"
)

// SettingsRequestBuilder provides operations to manage the settings property of the microsoft.graph.deviceManagementTemplate entity.
...
// SettingsRequestBuilderGetQueryParameters collection of all settings this template has
...
func NewSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SettingsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate_id}/migratableTo/{deviceManagementTemplate_id1}/settings{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SettingsRequestBuilder) Count()(*i718a4ae4a95066ca6f8f079a84fa2de4d80e5e8566a94f775f75be45b8974b4c.CountRequestBuilder) {
    return i718a4ae4a95066ca6f8f079a84fa2de4d80e5e8566a94f775f75be45b8974b4c.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
