...
// Builds and executes requests for operations under \deviceManagement\templates\{deviceManagementTemplate-id}\migratableTo\microsoft.graph.importOffice365DeviceConfigurationPolicies
...
func (m *ImportOffice365DeviceConfigurationPoliciesRequestBuilder) Post(options *ImportOffice365DeviceConfigurationPoliciesRequestBuilderPostOptions)([]ImportOffice365DeviceConfigurationPolicies, error) {
    ...
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewImportOffice365DeviceConfigurationPolicies() }, nil)
    if err != nil {
        return nil, err
    }
