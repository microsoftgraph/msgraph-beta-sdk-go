...
type RecommendedSettingsRequestBuilderGetOptions struct {
    ...
    Q *RecommendedSettingsRequestBuilderGetQueryParameters;
...
func NewRecommendedSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RecommendedSettingsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate_id}/categories/{deviceManagementTemplateSettingCategory_id}/recommendedSettings{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RecommendedSettingsRequestBuilder) Get(options *RecommendedSettingsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DeviceManagementSettingInstanceCollectionResponseable, error) {
...
func (m *RecommendedSettingsRequestBuilder) Post(options *RecommendedSettingsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DeviceManagementSettingInstanceable, error) {
