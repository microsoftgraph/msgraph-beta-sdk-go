...
// DeviceManagementSettingInstanceRequestBuilder builds and executes requests for operations under \deviceManagement\templates\{deviceManagementTemplate-id}\settings\{deviceManagementSettingInstance-id}
...
// DeviceManagementSettingInstanceRequestBuilderGetQueryParameters collection of all settings this template has
