...
// CompareWithTemplateIdRequestBuilder builds and executes requests for operations under \deviceManagement\templates\{deviceManagementTemplate-id}\microsoft.graph.compare(templateId='{templateId}')
