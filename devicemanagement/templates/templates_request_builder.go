...
func NewTemplatesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TemplatesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/templates{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *TemplatesRequestBuilder) Get(options *TemplatesRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementTemplateCollectionResponseable, error) {
...
func (m *TemplatesRequestBuilder) Post(options *TemplatesRequestBuilderPostOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementTemplateable, error) {
