...
func (m *UserExperienceAnalyticsBatteryHealthCapacityDetailsRequestBuilder) Delete(ctx context.Context, requestConfiguration *UserExperienceAnalyticsBatteryHealthCapacityDetailsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
