...
// NewAndroidDeviceOwnerEnrollmentProfilesItemRevokeTokenRequestBuilderInternal instantiates a new AndroidDeviceOwnerEnrollmentProfilesItemRevokeTokenRequestBuilder and sets the default values.
...
// NewAndroidDeviceOwnerEnrollmentProfilesItemRevokeTokenRequestBuilder instantiates a new AndroidDeviceOwnerEnrollmentProfilesItemRevokeTokenRequestBuilder and sets the default values.
...
func (m *AndroidDeviceOwnerEnrollmentProfilesItemRevokeTokenRequestBuilder) WithUrl(rawUrl string)(*AndroidDeviceOwnerEnrollmentProfilesItemRevokeTokenRequestBuilder) {
    return NewAndroidDeviceOwnerEnrollmentProfilesItemRevokeTokenRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
