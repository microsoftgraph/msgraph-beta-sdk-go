...
// GroupPolicyUploadedDefinitionFilesItemUpdateLanguageFilesPostRequestBody provides operations to call the updateLanguageFiles method.
...
func (m *GroupPolicyUploadedDefinitionFilesItemUpdateLanguageFilesPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *GroupPolicyUploadedDefinitionFilesItemUpdateLanguageFilesPostRequestBody) SetAdditionalData(value map[string]interface{})() {
