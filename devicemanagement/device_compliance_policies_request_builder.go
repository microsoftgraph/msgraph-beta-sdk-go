...
func (m *DeviceCompliancePoliciesRequestBuilder) MicrosoftGraphGetDevicesScheduledToRetire()(*DeviceCompliancePoliciesMicrosoftGraphGetDevicesScheduledToRetireRequestBuilder) {
    return NewDeviceCompliancePoliciesMicrosoftGraphGetDevicesScheduledToRetireRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetNoncompliantDevicesToRetire provides operations to call the getNoncompliantDevicesToRetire method.
func (m *DeviceCompliancePoliciesRequestBuilder) MicrosoftGraphGetNoncompliantDevicesToRetire()(*DeviceCompliancePoliciesMicrosoftGraphGetNoncompliantDevicesToRetireRequestBuilder) {
    return NewDeviceCompliancePoliciesMicrosoftGraphGetNoncompliantDevicesToRetireRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphHasPayloadLinks provides operations to call the hasPayloadLinks method.
func (m *DeviceCompliancePoliciesRequestBuilder) MicrosoftGraphHasPayloadLinks()(*DeviceCompliancePoliciesMicrosoftGraphHasPayloadLinksRequestBuilder) {
    return NewDeviceCompliancePoliciesMicrosoftGraphHasPayloadLinksRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *DeviceCompliancePoliciesRequestBuilder) MicrosoftGraphRefreshDeviceComplianceReportSummarization()(*DeviceCompliancePoliciesMicrosoftGraphRefreshDeviceComplianceReportSummarizationRequestBuilder) {
    return NewDeviceCompliancePoliciesMicrosoftGraphRefreshDeviceComplianceReportSummarizationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSetScheduledRetireState provides operations to call the setScheduledRetireState method.
func (m *DeviceCompliancePoliciesRequestBuilder) MicrosoftGraphSetScheduledRetireState()(*DeviceCompliancePoliciesMicrosoftGraphSetScheduledRetireStateRequestBuilder) {
    return NewDeviceCompliancePoliciesMicrosoftGraphSetScheduledRetireStateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphValidateComplianceScript provides operations to call the validateComplianceScript method.
func (m *DeviceCompliancePoliciesRequestBuilder) MicrosoftGraphValidateComplianceScript()(*DeviceCompliancePoliciesMicrosoftGraphValidateComplianceScriptRequestBuilder) {
    return NewDeviceCompliancePoliciesMicrosoftGraphValidateComplianceScriptRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
