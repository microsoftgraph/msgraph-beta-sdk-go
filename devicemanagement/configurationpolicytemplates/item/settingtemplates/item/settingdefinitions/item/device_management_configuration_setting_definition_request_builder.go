...
type DeviceManagementConfigurationSettingDefinitionRequestBuilderGetOptions struct {
    ...
    Q *DeviceManagementConfigurationSettingDefinitionRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
// DeviceManagementConfigurationSettingDefinitionRequestBuilderGetQueryParameters list of related Setting Definitions
...
func NewDeviceManagementConfigurationSettingDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DeviceManagementConfigurationSettingDefinitionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/configurationPolicyTemplates/{deviceManagementConfigurationPolicyTemplate_id}/settingTemplates/{deviceManagementConfigurationSettingTemplate_id}/settingDefinitions/{deviceManagementConfigurationSettingDefinition_id}{?select,expand}";
...
// CreateDeleteRequestInformation list of related Setting Definitions
...
// CreatePatchRequestInformation list of related Setting Definitions
...
// Delete list of related Setting Definitions
...
// Patch list of related Setting Definitions
