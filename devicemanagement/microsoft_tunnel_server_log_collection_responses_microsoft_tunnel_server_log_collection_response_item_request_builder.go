...
func (m *MicrosoftTunnelServerLogCollectionResponsesMicrosoftTunnelServerLogCollectionResponseItemRequestBuilder) MicrosoftGraphCreateDownloadUrl()(*MicrosoftTunnelServerLogCollectionResponsesItemMicrosoftGraphCreateDownloadUrlRequestBuilder) {
    return NewMicrosoftTunnelServerLogCollectionResponsesItemMicrosoftGraphCreateDownloadUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGenerateDownloadUrl provides operations to call the generateDownloadUrl method.
func (m *MicrosoftTunnelServerLogCollectionResponsesMicrosoftTunnelServerLogCollectionResponseItemRequestBuilder) MicrosoftGraphGenerateDownloadUrl()(*MicrosoftTunnelServerLogCollectionResponsesItemMicrosoftGraphGenerateDownloadUrlRequestBuilder) {
    return NewMicrosoftTunnelServerLogCollectionResponsesItemMicrosoftGraphGenerateDownloadUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
