...
func NewMicrosoftTunnelServerLogCollectionResponsesMicrosoftTunnelServerLogCollectionResponseItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, microsoftTunnelServerLogCollectionResponseId *string)(*MicrosoftTunnelServerLogCollectionResponsesMicrosoftTunnelServerLogCollectionResponseItemRequestBuilder) {
    ...
    if microsoftTunnelServerLogCollectionResponseId != nil {
...
func NewMicrosoftTunnelServerLogCollectionResponsesMicrosoftTunnelServerLogCollectionResponseItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MicrosoftTunnelServerLogCollectionResponsesMicrosoftTunnelServerLogCollectionResponseItemRequestBuilder) {
    ...
    return NewMicrosoftTunnelServerLogCollectionResponsesMicrosoftTunnelServerLogCollectionResponseItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *MicrosoftTunnelServerLogCollectionResponsesMicrosoftTunnelServerLogCollectionResponseItemRequestBuilder) MicrosoftGraphCreateDownloadUrl()(*MicrosoftTunnelServerLogCollectionResponsesItemMicrosoftGraphCreateDownloadUrlCreateDownloadUrlRequestBuilder) {
    return NewMicrosoftTunnelServerLogCollectionResponsesItemMicrosoftGraphCreateDownloadUrlCreateDownloadUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGenerateDownloadUrl provides operations to call the generateDownloadUrl method.
func (m *MicrosoftTunnelServerLogCollectionResponsesMicrosoftTunnelServerLogCollectionResponseItemRequestBuilder) MicrosoftGraphGenerateDownloadUrl()(*MicrosoftTunnelServerLogCollectionResponsesItemMicrosoftGraphGenerateDownloadUrlGenerateDownloadUrlRequestBuilder) {
    return NewMicrosoftTunnelServerLogCollectionResponsesItemMicrosoftGraphGenerateDownloadUrlGenerateDownloadUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
