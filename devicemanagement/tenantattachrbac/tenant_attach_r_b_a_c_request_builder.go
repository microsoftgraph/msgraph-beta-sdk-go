...
// TenantAttachRBACRequestBuilderDeleteOptions options for Delete
type TenantAttachRBACRequestBuilderDeleteOptions struct {
    // Request headers
...
// TenantAttachRBACRequestBuilderGetOptions options for Get
type TenantAttachRBACRequestBuilderGetOptions struct {
    // Request headers
    Headers map[string]string;
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption;
...
// TenantAttachRBACRequestBuilderPatchOptions options for Patch
type TenantAttachRBACRequestBuilderPatchOptions struct {
    // 
    Body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TenantAttachRBACable;
    // Request headers
    Headers map[string]string;
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption;
...
func NewTenantAttachRBACRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TenantAttachRBACRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/tenantAttachRBAC{?select,expand}";
...
func (m *TenantAttachRBACRequestBuilder) CreateDeleteRequestInformation(options *TenantAttachRBACRequestBuilderDeleteOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *TenantAttachRBACRequestBuilder) CreateGetRequestInformation(options *TenantAttachRBACRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *TenantAttachRBACRequestBuilder) CreatePatchRequestInformation(options *TenantAttachRBACRequestBuilderPatchOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *TenantAttachRBACRequestBuilder) Delete(options *TenantAttachRBACRequestBuilderDeleteOptions)(error) {
...
func (m *TenantAttachRBACRequestBuilder) Get(options *TenantAttachRBACRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TenantAttachRBACable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateTenantAttachRBACFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
...
func (m *TenantAttachRBACRequestBuilder) Patch(options *TenantAttachRBACRequestBuilderPatchOptions)(error) {
