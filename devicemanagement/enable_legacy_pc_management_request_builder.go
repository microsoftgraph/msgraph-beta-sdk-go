...
func (m *EnableLegacyPcManagementRequestBuilder) Post(ctx context.Context, requestConfiguration *EnableLegacyPcManagementRequestBuilderPostRequestConfiguration)(error) {
...
func (m *EnableLegacyPcManagementRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *EnableLegacyPcManagementRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EnableLegacyPcManagementRequestBuilder) WithUrl(rawUrl string)(*EnableLegacyPcManagementRequestBuilder) {
    return NewEnableLegacyPcManagementRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
