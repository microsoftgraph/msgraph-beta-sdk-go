...
func (m *WindowsAutopilotDeviceIdentitiesItemMicrosoftGraphUpdateDevicePropertiesUpdateDevicePropertiesPostRequestBody) GetDeviceAccountPassword()(*string) {
    return m.deviceAccountPassword
}
// GetDeviceAccountUpn gets the deviceAccountUpn property value. The deviceAccountUpn property
func (m *WindowsAutopilotDeviceIdentitiesItemMicrosoftGraphUpdateDevicePropertiesUpdateDevicePropertiesPostRequestBody) GetDeviceAccountUpn()(*string) {
...
func (m *WindowsAutopilotDeviceIdentitiesItemMicrosoftGraphUpdateDevicePropertiesUpdateDevicePropertiesPostRequestBody) GetDeviceFriendlyName()(*string) {
...
func (m *WindowsAutopilotDeviceIdentitiesItemMicrosoftGraphUpdateDevicePropertiesUpdateDevicePropertiesPostRequestBody) SetDeviceAccountPassword(value *string)() {
    m.deviceAccountPassword = value
}
// SetDeviceAccountUpn sets the deviceAccountUpn property value. The deviceAccountUpn property
func (m *WindowsAutopilotDeviceIdentitiesItemMicrosoftGraphUpdateDevicePropertiesUpdateDevicePropertiesPostRequestBody) SetDeviceAccountUpn(value *string)() {
    m.deviceAccountUpn = value
}
// SetDeviceFriendlyName sets the deviceFriendlyName property value. The deviceFriendlyName property
func (m *WindowsAutopilotDeviceIdentitiesItemMicrosoftGraphUpdateDevicePropertiesUpdateDevicePropertiesPostRequestBody) SetDeviceFriendlyName(value *string)() {
