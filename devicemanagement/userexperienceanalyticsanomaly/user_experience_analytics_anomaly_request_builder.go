...
import (
    ...
    i9ae3be36ee71f7f3fa549ad3ac100455a2cf5e5703ae07c9e321c455e927720b "github.com/microsoftgraph/msgraph-beta-sdk-go/devicemanagement/userexperienceanalyticsanomaly/count"
)
...
func NewUserExperienceAnalyticsAnomalyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserExperienceAnalyticsAnomalyRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsAnomaly{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *UserExperienceAnalyticsAnomalyRequestBuilder) Count()(*i9ae3be36ee71f7f3fa549ad3ac100455a2cf5e5703ae07c9e321c455e927720b.CountRequestBuilder) {
    return i9ae3be36ee71f7f3fa549ad3ac100455a2cf5e5703ae07c9e321c455e927720b.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the user experience analytics anomaly entity contains anomaly details.
func (m *UserExperienceAnalyticsAnomalyRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *UserExperienceAnalyticsAnomalyRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserExperienceAnalyticsAnomalyRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsAnomalyRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsAnomalyCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateUserExperienceAnalyticsAnomalyCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
