...
// NewConfigurationPoliciesItemReorderRequestBuilderInternal instantiates a new ReorderRequestBuilder and sets the default values.
func NewConfigurationPoliciesItemReorderRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConfigurationPoliciesItemReorderRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy%2Did}/reorder";
...
// NewConfigurationPoliciesItemReorderRequestBuilder instantiates a new ReorderRequestBuilder and sets the default values.
