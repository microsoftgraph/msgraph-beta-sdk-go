...
func NewUserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilder) {
    m := &UserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewUserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilder) {
    ...
    return NewUserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *UserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *UserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilder) {
    return NewUserexperienceanalyticsapphealthapplicationperformancebyosversionCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
