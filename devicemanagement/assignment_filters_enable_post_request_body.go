...
func (m *AssignmentFiltersEnablePostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *AssignmentFiltersEnablePostRequestBody) GetEnable()(*bool) {
    val, err := m.GetBackingStore().Get("enable")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *AssignmentFiltersEnablePostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *AssignmentFiltersEnablePostRequestBody) SetEnable(value *bool)() {
    err := m.GetBackingStore().Set("enable", value)
    if err != nil {
        panic(err)
    }
}
// AssignmentFiltersEnablePostRequestBodyable 
type AssignmentFiltersEnablePostRequestBodyable interface {
