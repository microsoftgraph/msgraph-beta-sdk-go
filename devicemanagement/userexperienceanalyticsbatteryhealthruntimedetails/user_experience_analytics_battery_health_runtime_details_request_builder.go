...
type UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilderPatchOptions struct {
    // 
    Body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsBatteryHealthRuntimeDetailsable
    // Request headers
    Headers map[string]string
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func (m *UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilder) CreateDeleteRequestInformation(options *UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilderDeleteOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilder) CreateGetRequestInformation(options *UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilder) CreatePatchRequestInformation(options *UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilderPatchOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilder) Get(options *UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsBatteryHealthRuntimeDetailsable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateUserExperienceAnalyticsBatteryHealthRuntimeDetailsFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
