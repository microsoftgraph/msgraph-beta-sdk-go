...
// DisconnectResponse provides operations to call the disconnect method.
...
// CreateDisconnectResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *DisconnectResponse) GetValue()(*bool) {
    return m.value
}
...
func (m *DisconnectResponse) SetValue(value *bool)() {
    m.value = value
}
