...
func (m *DisconnectRequestBuilder) Post(ctx context.Context, requestConfiguration *DisconnectRequestBuilderPostRequestConfiguration)(DisconnectResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateDisconnectResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
