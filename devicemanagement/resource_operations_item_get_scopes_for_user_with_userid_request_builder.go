...
// NewResourceOperationsItemGetScopesForUserWithUseridRequestBuilderInternal instantiates a new ResourceOperationsItemGetScopesForUserWithUseridRequestBuilder and sets the default values.
...
// NewResourceOperationsItemGetScopesForUserWithUseridRequestBuilder instantiates a new ResourceOperationsItemGetScopesForUserWithUseridRequestBuilder and sets the default values.
...
// returns a ResourceOperationsItemGetScopesForUserWithUseridGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
...
// returns a *ResourceOperationsItemGetScopesForUserWithUseridRequestBuilder when successful
