...
func (m *ResourceOperationsItemGetScopesForUserWithUseridRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ResourceOperationsItemGetScopesForUserWithUseridRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ResourceOperationsItemGetScopesForUserWithUseridRequestBuilder) Get(ctx context.Context, requestConfiguration *ResourceOperationsItemGetScopesForUserWithUseridRequestBuilderGetRequestConfiguration)(ResourceOperationsItemGetScopesForUserWithUseridResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateResourceOperationsItemGetScopesForUserWithUseridResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
