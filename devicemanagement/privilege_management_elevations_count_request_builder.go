...
func (m *PrivilegeManagementElevationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivilegeManagementElevationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
