...
func (m *IntentsItemUserStatesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *IntentsItemUserStatesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
