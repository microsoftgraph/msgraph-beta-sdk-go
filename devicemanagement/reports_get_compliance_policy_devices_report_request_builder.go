...
// NewReportsGetCompliancePolicyDevicesReportRequestBuilderInternal instantiates a new ReportsGetCompliancePolicyDevicesReportRequestBuilder and sets the default values.
...
// NewReportsGetCompliancePolicyDevicesReportRequestBuilder instantiates a new ReportsGetCompliancePolicyDevicesReportRequestBuilder and sets the default values.
...
func (m *ReportsGetCompliancePolicyDevicesReportRequestBuilder) WithUrl(rawUrl string)(*ReportsGetCompliancePolicyDevicesReportRequestBuilder) {
    return NewReportsGetCompliancePolicyDevicesReportRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
