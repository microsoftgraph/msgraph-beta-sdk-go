...
func (m *AssignmentFiltersRequestBuilder) Get(ctx context.Context, requestConfiguration *AssignmentFiltersRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceAndAppManagementAssignmentFilterCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceAndAppManagementAssignmentFilterCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *AssignmentFiltersRequestBuilder) MicrosoftGraphEnable()(*AssignmentFiltersMicrosoftGraphEnableEnableRequestBuilder) {
    return NewAssignmentFiltersMicrosoftGraphEnableEnableRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *AssignmentFiltersRequestBuilder) MicrosoftGraphGetPlatformSupportedPropertiesWithPlatform(platform *string)(*AssignmentFiltersMicrosoftGraphGetPlatformSupportedPropertiesWithPlatformGetPlatformSupportedPropertiesWithPlatformRequestBuilder) {
    return NewAssignmentFiltersMicrosoftGraphGetPlatformSupportedPropertiesWithPlatformGetPlatformSupportedPropertiesWithPlatformRequestBuilderInternal(m.pathParameters, m.requestAdapter, platform)
}
// MicrosoftGraphGetState provides operations to call the getState method.
func (m *AssignmentFiltersRequestBuilder) MicrosoftGraphGetState()(*AssignmentFiltersMicrosoftGraphGetStateGetStateRequestBuilder) {
    return NewAssignmentFiltersMicrosoftGraphGetStateGetStateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphValidateFilter provides operations to call the validateFilter method.
func (m *AssignmentFiltersRequestBuilder) MicrosoftGraphValidateFilter()(*AssignmentFiltersMicrosoftGraphValidateFilterValidateFilterRequestBuilder) {
    return NewAssignmentFiltersMicrosoftGraphValidateFilterValidateFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *AssignmentFiltersRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceAndAppManagementAssignmentFilterable, requestConfiguration *AssignmentFiltersRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceAndAppManagementAssignmentFilterable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceAndAppManagementAssignmentFilterFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
