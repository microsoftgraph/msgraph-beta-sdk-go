...
func (m *WindowsQualityUpdateProfilesItemAssignmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsQualityUpdateProfilesItemAssignmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
