...
// AppleUserInitiatedEnrollmentProfilesItemSetPriorityPostRequestBody provides operations to call the setPriority method.
...
func (m *AppleUserInitiatedEnrollmentProfilesItemSetPriorityPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *AppleUserInitiatedEnrollmentProfilesItemSetPriorityPostRequestBody) SetAdditionalData(value map[string]interface{})() {
