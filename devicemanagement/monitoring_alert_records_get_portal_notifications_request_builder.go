...
func (m *MonitoringAlertRecordsGetPortalNotificationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *MonitoringAlertRecordsGetPortalNotificationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *MonitoringAlertRecordsGetPortalNotificationsRequestBuilder) Get(ctx context.Context, requestConfiguration *MonitoringAlertRecordsGetPortalNotificationsRequestBuilderGetRequestConfiguration)(MonitoringAlertRecordsGetPortalNotificationsResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateMonitoringAlertRecordsGetPortalNotificationsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
