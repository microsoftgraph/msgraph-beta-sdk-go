...
func (m *ResourceOperationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ResourceOperationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
