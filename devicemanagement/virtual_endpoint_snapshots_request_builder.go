...
func (m *VirtualEndpointSnapshotsRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointSnapshotsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CloudPcSnapshotCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateCloudPcSnapshotCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *VirtualEndpointSnapshotsRequestBuilder) MicrosoftGraphGetStorageAccountsWithSubscriptionId(subscriptionId *string)(*VirtualEndpointSnapshotsMicrosoftGraphGetStorageAccountsWithSubscriptionIdRequestBuilder) {
    return NewVirtualEndpointSnapshotsMicrosoftGraphGetStorageAccountsWithSubscriptionIdRequestBuilderInternal(m.pathParameters, m.requestAdapter, subscriptionId)
}
// MicrosoftGraphGetSubscriptions provides operations to call the getSubscriptions method.
func (m *VirtualEndpointSnapshotsRequestBuilder) MicrosoftGraphGetSubscriptions()(*VirtualEndpointSnapshotsMicrosoftGraphGetSubscriptionsRequestBuilder) {
    return NewVirtualEndpointSnapshotsMicrosoftGraphGetSubscriptionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *VirtualEndpointSnapshotsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CloudPcSnapshotable, requestConfiguration *VirtualEndpointSnapshotsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CloudPcSnapshotable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateCloudPcSnapshotFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
