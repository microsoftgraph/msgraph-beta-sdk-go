...
// refRequestBuilder builds and executes requests for operations under \deviceManagement\userExperienceAnalyticsDeviceMetricHistory\{userExperienceAnalyticsMetricHistory-id}\userExperienceAnalyticsMetric\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsDeviceMetricHistory/{userExperienceAnalyticsMetricHistory_id}/userExperienceAnalyticsMetric/$ref";
...
// CreateDeleteRequestInformation user experience analytics metric.
...
// CreatePutRequestInformation user experience analytics metric.
...
// Delete user experience analytics metric.
...
// Put user experience analytics metric.
