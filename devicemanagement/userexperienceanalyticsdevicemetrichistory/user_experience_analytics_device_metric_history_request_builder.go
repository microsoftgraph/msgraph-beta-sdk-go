...
type UserExperienceAnalyticsDeviceMetricHistoryRequestBuilderGetOptions struct {
    ...
    Q *UserExperienceAnalyticsDeviceMetricHistoryRequestBuilderGetQueryParameters;
...
func (m *UserExperienceAnalyticsDeviceMetricHistoryRequestBuilder) Get(options *UserExperienceAnalyticsDeviceMetricHistoryRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserExperienceAnalyticsMetricHistoryCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateUserExperienceAnalyticsMetricHistoryCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserExperienceAnalyticsMetricHistoryCollectionResponseable), nil
}
// Post create new navigation property to userExperienceAnalyticsDeviceMetricHistory for deviceManagement
func (m *UserExperienceAnalyticsDeviceMetricHistoryRequestBuilder) Post(options *UserExperienceAnalyticsDeviceMetricHistoryRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserExperienceAnalyticsMetricHistoryable, error) {
