...
func (m *ZebraFotaArtifactsRequestBuilder) Count()(*ZebraFotaArtifactsCountRequestBuilder) {
    return NewZebraFotaArtifactsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the Collection of ZebraFotaArtifacts.
func (m *ZebraFotaArtifactsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ZebraFotaArtifactsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
