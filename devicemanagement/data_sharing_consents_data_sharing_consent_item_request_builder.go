...
func (m *DataSharingConsentsDataSharingConsentItemRequestBuilder) MicrosoftGraphConsentToDataSharing()(*DataSharingConsentsItemMicrosoftGraphConsentToDataSharingRequestBuilder) {
    return NewDataSharingConsentsItemMicrosoftGraphConsentToDataSharingRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
