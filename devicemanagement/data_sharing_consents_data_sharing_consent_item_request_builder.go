...
func (m *DataSharingConsentsDataSharingConsentItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *DataSharingConsentsDataSharingConsentItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
