...
// NewEmbeddedsimactivationcodepoolsItemAssignmentsCountRequestBuilderInternal instantiates a new EmbeddedsimactivationcodepoolsItemAssignmentsCountRequestBuilder and sets the default values.
func NewEmbeddedsimactivationcodepoolsItemAssignmentsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EmbeddedsimactivationcodepoolsItemAssignmentsCountRequestBuilder) {
    m := &EmbeddedsimactivationcodepoolsItemAssignmentsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/embeddedSIMActivationCodePools/{embeddedSIMActivationCodePool%2Did}/assignments/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewEmbeddedsimactivationcodepoolsItemAssignmentsCountRequestBuilder instantiates a new EmbeddedsimactivationcodepoolsItemAssignmentsCountRequestBuilder and sets the default values.
