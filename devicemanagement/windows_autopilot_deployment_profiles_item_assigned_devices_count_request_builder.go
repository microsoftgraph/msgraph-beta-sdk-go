...
func (m *WindowsAutopilotDeploymentProfilesItemAssignedDevicesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsAutopilotDeploymentProfilesItemAssignedDevicesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
