...
// DeviceManagementSettingInstanceRequestBuilder builds and executes requests for operations under \deviceManagement\intents\{deviceManagementIntent-id}\categories\{deviceManagementIntentSettingCategory-id}\settings\{deviceManagementSettingInstance-id}
