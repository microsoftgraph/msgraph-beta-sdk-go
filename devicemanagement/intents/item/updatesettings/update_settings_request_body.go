...
type UpdateSettingsRequestBody struct {
    ...
    // 
    settings []i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DeviceManagementSettingInstance;
}
...
func (m *UpdateSettingsRequestBody) GetSettings()([]i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DeviceManagementSettingInstance) {
    if m == nil {
        return nil
    } else {
        return m.settings
...
func (m *UpdateSettingsRequestBody) IsNil()(bool) {
    return m == nil
}
...
func (m *UpdateSettingsRequestBody) SetSettings(value []i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DeviceManagementSettingInstance)() {
    if m != nil {
        m.settings = value
    }
}
