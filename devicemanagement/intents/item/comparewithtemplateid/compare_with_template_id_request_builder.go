...
// CompareWithTemplateIdRequestBuilderGetQueryParameters invoke function compare
type CompareWithTemplateIdRequestBuilderGetQueryParameters struct {
...
type CompareWithTemplateIdRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *CompareWithTemplateIdRequestBuilderGetQueryParameters
}
...
func NewCompareWithTemplateIdRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, templateId *string)(*CompareWithTemplateIdRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/microsoft.graph.compare(templateId='{templateId}'){?%24top,%24skip,%24search,%24filter,%24count}";
...
func (m *CompareWithTemplateIdRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompareWithTemplateIdRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CompareWithTemplateIdRequestBuilder) Get(ctx context.Context, requestConfiguration *CompareWithTemplateIdRequestBuilderGetRequestConfiguration)(CompareWithTemplateIdResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateCompareWithTemplateIdResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
