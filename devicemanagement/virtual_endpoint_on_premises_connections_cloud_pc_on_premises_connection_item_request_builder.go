...
func (m *VirtualEndpointOnPremisesConnectionsCloudPcOnPremisesConnectionItemRequestBuilder) MicrosoftGraphRunHealthChecks()(*VirtualEndpointOnPremisesConnectionsItemMicrosoftGraphRunHealthChecksRequestBuilder) {
    return NewVirtualEndpointOnPremisesConnectionsItemMicrosoftGraphRunHealthChecksRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUpdateAdDomainPassword provides operations to call the updateAdDomainPassword method.
func (m *VirtualEndpointOnPremisesConnectionsCloudPcOnPremisesConnectionItemRequestBuilder) MicrosoftGraphUpdateAdDomainPassword()(*VirtualEndpointOnPremisesConnectionsItemMicrosoftGraphUpdateAdDomainPasswordRequestBuilder) {
    return NewVirtualEndpointOnPremisesConnectionsItemMicrosoftGraphUpdateAdDomainPasswordRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
