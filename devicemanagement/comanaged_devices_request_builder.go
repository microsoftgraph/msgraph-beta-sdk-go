...
func (m *ComanagedDevicesRequestBuilder) MicrosoftGraphAppDiagnosticsWithUpn(upn *string)(*ComanagedDevicesMicrosoftGraphAppDiagnosticsWithUpnRequestBuilder) {
    return NewComanagedDevicesMicrosoftGraphAppDiagnosticsWithUpnRequestBuilderInternal(m.pathParameters, m.requestAdapter, upn)
}
// MicrosoftGraphBulkReprovisionCloudPc provides operations to call the bulkReprovisionCloudPc method.
func (m *ComanagedDevicesRequestBuilder) MicrosoftGraphBulkReprovisionCloudPc()(*ComanagedDevicesMicrosoftGraphBulkReprovisionCloudPcRequestBuilder) {
    return NewComanagedDevicesMicrosoftGraphBulkReprovisionCloudPcRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBulkRestoreCloudPc provides operations to call the bulkRestoreCloudPc method.
func (m *ComanagedDevicesRequestBuilder) MicrosoftGraphBulkRestoreCloudPc()(*ComanagedDevicesMicrosoftGraphBulkRestoreCloudPcRequestBuilder) {
    return NewComanagedDevicesMicrosoftGraphBulkRestoreCloudPcRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBulkSetCloudPcReviewStatus provides operations to call the bulkSetCloudPcReviewStatus method.
func (m *ComanagedDevicesRequestBuilder) MicrosoftGraphBulkSetCloudPcReviewStatus()(*ComanagedDevicesMicrosoftGraphBulkSetCloudPcReviewStatusRequestBuilder) {
    return NewComanagedDevicesMicrosoftGraphBulkSetCloudPcReviewStatusRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDownloadAppDiagnostics provides operations to call the downloadAppDiagnostics method.
func (m *ComanagedDevicesRequestBuilder) MicrosoftGraphDownloadAppDiagnostics()(*ComanagedDevicesMicrosoftGraphDownloadAppDiagnosticsRequestBuilder) {
    return NewComanagedDevicesMicrosoftGraphDownloadAppDiagnosticsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphExecuteAction provides operations to call the executeAction method.
func (m *ComanagedDevicesRequestBuilder) MicrosoftGraphExecuteAction()(*ComanagedDevicesMicrosoftGraphExecuteActionRequestBuilder) {
    return NewComanagedDevicesMicrosoftGraphExecuteActionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphMoveDevicesToOU provides operations to call the moveDevicesToOU method.
func (m *ComanagedDevicesRequestBuilder) MicrosoftGraphMoveDevicesToOU()(*ComanagedDevicesMicrosoftGraphMoveDevicesToOURequestBuilder) {
    return NewComanagedDevicesMicrosoftGraphMoveDevicesToOURequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
