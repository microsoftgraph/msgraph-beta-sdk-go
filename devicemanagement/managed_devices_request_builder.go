...
func (m *ManagedDevicesRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedDevicesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ManagedDeviceCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateManagedDeviceCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphAppDiagnosticsWithUpn(upn *string)(*ManagedDevicesMicrosoftGraphAppDiagnosticsWithUpnAppDiagnosticsWithUpnRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphAppDiagnosticsWithUpnAppDiagnosticsWithUpnRequestBuilderInternal(m.pathParameters, m.requestAdapter, upn)
}
// MicrosoftGraphBulkReprovisionCloudPc provides operations to call the bulkReprovisionCloudPc method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphBulkReprovisionCloudPc()(*ManagedDevicesMicrosoftGraphBulkReprovisionCloudPcBulkReprovisionCloudPcRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphBulkReprovisionCloudPcBulkReprovisionCloudPcRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBulkRestoreCloudPc provides operations to call the bulkRestoreCloudPc method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphBulkRestoreCloudPc()(*ManagedDevicesMicrosoftGraphBulkRestoreCloudPcBulkRestoreCloudPcRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphBulkRestoreCloudPcBulkRestoreCloudPcRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphBulkSetCloudPcReviewStatus provides operations to call the bulkSetCloudPcReviewStatus method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphBulkSetCloudPcReviewStatus()(*ManagedDevicesMicrosoftGraphBulkSetCloudPcReviewStatusBulkSetCloudPcReviewStatusRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphBulkSetCloudPcReviewStatusBulkSetCloudPcReviewStatusRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDownloadAppDiagnostics provides operations to call the downloadAppDiagnostics method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphDownloadAppDiagnostics()(*ManagedDevicesMicrosoftGraphDownloadAppDiagnosticsDownloadAppDiagnosticsRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphDownloadAppDiagnosticsDownloadAppDiagnosticsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphExecuteAction provides operations to call the executeAction method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphExecuteAction()(*ManagedDevicesMicrosoftGraphExecuteActionExecuteActionRequestBuilder) {
    return NewManagedDevicesMicrosoftGraphExecuteActionExecuteActionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphMoveDevicesToOU provides operations to call the moveDevicesToOU method.
func (m *ManagedDevicesRequestBuilder) MicrosoftGraphMoveDevicesToOU()(*ManagedDevicesMicrosoftGraphMoveDevicesToOUMoveDevicesToOURequestBuilder) {
    return NewManagedDevicesMicrosoftGraphMoveDevicesToOUMoveDevicesToOURequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
