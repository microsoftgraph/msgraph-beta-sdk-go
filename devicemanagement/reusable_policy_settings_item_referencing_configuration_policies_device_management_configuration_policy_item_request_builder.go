...
func (m *ReusablePolicySettingsItemReferencingConfigurationPoliciesDeviceManagementConfigurationPolicyItemRequestBuilder) MicrosoftGraphAssign()(*ReusablePolicySettingsItemReferencingConfigurationPoliciesItemMicrosoftGraphAssignRequestBuilder) {
    return NewReusablePolicySettingsItemReferencingConfigurationPoliciesItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCreateCopy provides operations to call the createCopy method.
func (m *ReusablePolicySettingsItemReferencingConfigurationPoliciesDeviceManagementConfigurationPolicyItemRequestBuilder) MicrosoftGraphCreateCopy()(*ReusablePolicySettingsItemReferencingConfigurationPoliciesItemMicrosoftGraphCreateCopyRequestBuilder) {
    return NewReusablePolicySettingsItemReferencingConfigurationPoliciesItemMicrosoftGraphCreateCopyRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphReorder provides operations to call the reorder method.
func (m *ReusablePolicySettingsItemReferencingConfigurationPoliciesDeviceManagementConfigurationPolicyItemRequestBuilder) MicrosoftGraphReorder()(*ReusablePolicySettingsItemReferencingConfigurationPoliciesItemMicrosoftGraphReorderRequestBuilder) {
    return NewReusablePolicySettingsItemReferencingConfigurationPoliciesItemMicrosoftGraphReorderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
