...
func (m *DepOnboardingSettingsRequestBuilder) Get(ctx context.Context, requestConfiguration *DepOnboardingSettingsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DepOnboardingSettingCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDepOnboardingSettingCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphGetExpiringVppTokenCountWithExpiringBeforeDateTime provides operations to call the getExpiringVppTokenCount method.
func (m *DepOnboardingSettingsRequestBuilder) MicrosoftGraphGetExpiringVppTokenCountWithExpiringBeforeDateTime(expiringBeforeDateTime *string)(*DepOnboardingSettingsMicrosoftGraphGetExpiringVppTokenCountWithExpiringBeforeDateTimeGetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder) {
    return NewDepOnboardingSettingsMicrosoftGraphGetExpiringVppTokenCountWithExpiringBeforeDateTimeGetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilderInternal(m.pathParameters, m.requestAdapter, expiringBeforeDateTime)
}
