...
func (m *DepOnboardingSettingsRequestBuilder) MicrosoftGraphGetExpiringVppTokenCountWithExpiringBeforeDateTime(expiringBeforeDateTime *string)(*DepOnboardingSettingsMicrosoftGraphGetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder) {
    return NewDepOnboardingSettingsMicrosoftGraphGetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilderInternal(m.pathParameters, m.requestAdapter, expiringBeforeDateTime)
}
