...
// NewConfigurationPoliciesItemSettingsRequestBuilderInternal instantiates a new SettingsRequestBuilder and sets the default values.
...
// NewConfigurationPoliciesItemSettingsRequestBuilder instantiates a new SettingsRequestBuilder and sets the default values.
...
func (m *ConfigurationPoliciesItemSettingsRequestBuilder) Count()(*ConfigurationPoliciesItemSettingsCountRequestBuilder) {
    return NewConfigurationPoliciesItemSettingsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation policy settings
func (m *ConfigurationPoliciesItemSettingsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ConfigurationPoliciesItemSettingsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
