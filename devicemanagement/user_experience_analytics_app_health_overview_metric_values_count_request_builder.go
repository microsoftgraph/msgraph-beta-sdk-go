...
func (m *UserExperienceAnalyticsAppHealthOverviewMetricValuesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsAppHealthOverviewMetricValuesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
