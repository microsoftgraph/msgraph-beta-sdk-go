...
func (m *EmbeddedSIMActivationCodePoolsEmbeddedSIMActivationCodePoolItemRequestBuilder) MicrosoftGraphAssign()(*EmbeddedSIMActivationCodePoolsItemMicrosoftGraphAssignRequestBuilder) {
    return NewEmbeddedSIMActivationCodePoolsItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
