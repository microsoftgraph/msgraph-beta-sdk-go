...
func (m *RequestSignupUrlRequestBuilder) Post(body RequestSignupUrlPostRequestBodyable)(RequestSignupUrlResponseable, error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action requestSignupUrl
func (m *RequestSignupUrlRequestBuilder) PostWithRequestConfigurationAndResponseHandler(body RequestSignupUrlPostRequestBodyable, requestConfiguration *RequestSignupUrlRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(RequestSignupUrlResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateRequestSignupUrlResponseFromDiscriminatorValue, responseHandler, errorMapping)
    if err != nil {
        return nil, err
    }
