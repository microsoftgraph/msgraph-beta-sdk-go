...
func (m *RequestSignupUrlRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body RequestSignupUrlRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action requestSignupUrl
func (m *RequestSignupUrlRequestBuilder) PostWithResponseHandler(body RequestSignupUrlRequestBodyable, requestConfiguration *RequestSignupUrlRequestBuilderPostRequestConfiguration)(RequestSignupUrlResponseable, error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action requestSignupUrl
func (m *RequestSignupUrlRequestBuilder) PostWithResponseHandler(body RequestSignupUrlRequestBodyable, requestConfiguration *RequestSignupUrlRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(RequestSignupUrlResponseable, error) {
