...
func NewRequestSignupUrlResponse()(*RequestSignupUrlResponse) {
    m := &RequestSignupUrlResponse{
    }
...
func (m *RequestSignupUrlResponse) GetAdditionalData()(map[string]interface{}) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
func (m *RequestSignupUrlResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *RequestSignupUrlResponse) SetAdditionalData(value map[string]interface{})() {
