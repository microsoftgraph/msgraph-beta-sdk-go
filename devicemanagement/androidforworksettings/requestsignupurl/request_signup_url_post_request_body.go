...
// RequestSignupUrlPostRequestBody provides operations to call the requestSignupUrl method.
type RequestSignupUrlPostRequestBody struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]interface{}
    // The hostName property
    hostName *string
}
// NewRequestSignupUrlPostRequestBody instantiates a new requestSignupUrlPostRequestBody and sets the default values.
func NewRequestSignupUrlPostRequestBody()(*RequestSignupUrlPostRequestBody) {
    m := &RequestSignupUrlPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]interface{}));
    return m
}
// CreateRequestSignupUrlPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateRequestSignupUrlPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewRequestSignupUrlPostRequestBody(), nil
}
