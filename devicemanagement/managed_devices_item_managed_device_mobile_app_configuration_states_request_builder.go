...
// NewManagedDevicesItemManagedDeviceMobileAppConfigurationStatesRequestBuilderInternal instantiates a new ManagedDeviceMobileAppConfigurationStatesRequestBuilder and sets the default values.
...
// NewManagedDevicesItemManagedDeviceMobileAppConfigurationStatesRequestBuilder instantiates a new ManagedDeviceMobileAppConfigurationStatesRequestBuilder and sets the default values.
...
func (m *ManagedDevicesItemManagedDeviceMobileAppConfigurationStatesRequestBuilder) Count()(*ManagedDevicesItemManagedDeviceMobileAppConfigurationStatesCountRequestBuilder) {
    return NewManagedDevicesItemManagedDeviceMobileAppConfigurationStatesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation managed device mobile app configuration states for this device.
func (m *ManagedDevicesItemManagedDeviceMobileAppConfigurationStatesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ManagedDevicesItemManagedDeviceMobileAppConfigurationStatesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
