...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\deviceManagementScripts\{deviceManagementScript-id}\runSummary\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/deviceManagementScripts/{deviceManagementScript_id}/runSummary/$ref";
...
// CreateDeleteRequestInformation run summary for device management script.
...
// CreatePutRequestInformation run summary for device management script.
...
// Delete run summary for device management script.
...
// Put run summary for device management script.
