...
import (
    ...
    i077e68fa91eda3ea99d9a695931c230f129c22b25a30babd86f62eb3e0867bd8 "github.com/microsoftgraph/msgraph-beta-sdk-go/devicemanagement/devicemanagementscripts/item/userrunstates/item/devicerunstates/item/manageddevice"
)

// DeviceManagementScriptDeviceStateRequestBuilder builds and executes requests for operations under \deviceManagement\deviceManagementScripts\{deviceManagementScript-id}\userRunStates\{deviceManagementScriptUserState-id}\deviceRunStates\{deviceManagementScriptDeviceState-id}
...
func NewDeviceManagementScriptDeviceStateRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DeviceManagementScriptDeviceStateRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/deviceManagementScripts/{deviceManagementScript_id}/userRunStates/{deviceManagementScriptUserState_id}/deviceRunStates/{deviceManagementScriptDeviceState_id}{?select,expand}";
...
func (m *DeviceManagementScriptDeviceStateRequestBuilder) ManagedDevice()(*i077e68fa91eda3ea99d9a695931c230f129c22b25a30babd86f62eb3e0867bd8.ManagedDeviceRequestBuilder) {
    return i077e68fa91eda3ea99d9a695931c230f129c22b25a30babd86f62eb3e0867bd8.NewManagedDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
