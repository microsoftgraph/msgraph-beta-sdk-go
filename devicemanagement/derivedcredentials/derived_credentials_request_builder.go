...
func NewDerivedCredentialsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DerivedCredentialsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/derivedCredentials{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *DerivedCredentialsRequestBuilder) CreateGetRequestInformation(options *DerivedCredentialsRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DerivedCredentialsRequestBuilder) CreatePostRequestInformation(options *DerivedCredentialsRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *DerivedCredentialsRequestBuilder) Get(options *DerivedCredentialsRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementDerivedCredentialSettingsCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceManagementDerivedCredentialSettingsCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
...
func (m *DerivedCredentialsRequestBuilder) Post(options *DerivedCredentialsRequestBuilderPostOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementDerivedCredentialSettingsable, error) {
