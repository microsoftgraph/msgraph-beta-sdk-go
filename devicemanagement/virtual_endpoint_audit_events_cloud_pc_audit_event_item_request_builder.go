...
func (m *VirtualEndpointAuditEventsCloudPcAuditEventItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *VirtualEndpointAuditEventsCloudPcAuditEventItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
