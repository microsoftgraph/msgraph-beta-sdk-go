...
// DeviceConfigurationsGetTargetedUsersAndDevicesRequestBuilder provides operations to call the getTargetedUsersAndDevices method.
type DeviceConfigurationsGetTargetedUsersAndDevicesRequestBuilder struct {
...
// DeviceConfigurationsGetTargetedUsersAndDevicesRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type DeviceConfigurationsGetTargetedUsersAndDevicesRequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func (m *DeviceConfigurationsGetTargetedUsersAndDevicesRequestBuilder) Post(ctx context.Context, body DeviceConfigurationsGetTargetedUsersAndDevicesPostRequestBodyable, requestConfiguration *DeviceConfigurationsGetTargetedUsersAndDevicesRequestBuilderPostRequestConfiguration)(DeviceConfigurationsGetTargetedUsersAndDevicesResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateDeviceConfigurationsGetTargetedUsersAndDevicesResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
