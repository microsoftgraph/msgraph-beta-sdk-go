...
func (m *UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilder) Delete(ctx context.Context, requestConfiguration *UserExperienceAnalyticsBatteryHealthRuntimeDetailsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
