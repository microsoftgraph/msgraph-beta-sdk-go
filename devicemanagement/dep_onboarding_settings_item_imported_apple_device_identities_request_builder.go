...
func (m *DepOnboardingSettingsItemImportedAppleDeviceIdentitiesRequestBuilder) MicrosoftGraphImportAppleDeviceIdentityList()(*DepOnboardingSettingsItemImportedAppleDeviceIdentitiesMicrosoftGraphImportAppleDeviceIdentityListRequestBuilder) {
    return NewDepOnboardingSettingsItemImportedAppleDeviceIdentitiesMicrosoftGraphImportAppleDeviceIdentityListRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
