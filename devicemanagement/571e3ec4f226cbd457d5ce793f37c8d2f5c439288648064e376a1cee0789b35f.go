...
// Deprecated: This class is obsolete. Use ApplePushNotificationCertificateGenerateApplePushNotificationCertificateSigningRequestPostResponseable instead.
...
func NewApplePushNotificationCertificateGenerateApplePushNotificationCertificateSigningRequestResponse()(*ApplePushNotificationCertificateGenerateApplePushNotificationCertificateSigningRequestResponse) {
    m := &ApplePushNotificationCertificateGenerateApplePushNotificationCertificateSigningRequestResponse{
        ApplePushNotificationCertificateGenerateApplePushNotificationCertificateSigningRequestPostResponse: *NewApplePushNotificationCertificateGenerateApplePushNotificationCertificateSigningRequestPostResponse(),
    }
    return m
}
