...
// ChromeOSOnboardingSettingsConnectPostRequestBody provides operations to call the connect method.
...
func (m *ChromeOSOnboardingSettingsConnectPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ChromeOSOnboardingSettingsConnectPostRequestBody) SetAdditionalData(value map[string]interface{})() {
