...
// GetScopesForUserWithUseridRequestBuilderGetQueryParameters invoke function getScopesForUser
type GetScopesForUserWithUseridRequestBuilderGetQueryParameters struct {
...
type GetScopesForUserWithUseridRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *GetScopesForUserWithUseridRequestBuilderGetQueryParameters
}
...
func (m *GetScopesForUserWithUseridRequestBuilder) Get(ctx context.Context, requestConfiguration *GetScopesForUserWithUseridRequestBuilderGetRequestConfiguration)(GetScopesForUserWithUseridResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGetScopesForUserWithUseridResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
