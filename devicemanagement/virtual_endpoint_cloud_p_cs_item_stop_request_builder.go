...
// NewVirtualEndpointCloudPCsItemStopRequestBuilderInternal instantiates a new StopRequestBuilder and sets the default values.
...
// NewVirtualEndpointCloudPCsItemStopRequestBuilder instantiates a new StopRequestBuilder and sets the default values.
...
// Post stop a specific Cloud PC for a user. Currently, only Windows 365 Frontline Cloud PCs are supported. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation stop a specific Cloud PC for a user. Currently, only Windows 365 Frontline Cloud PCs are supported. This API is supported in the following national cloud deployments.
