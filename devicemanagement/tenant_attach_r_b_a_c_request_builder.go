...
func (m *TenantAttachRBACRequestBuilder) MicrosoftGraphEnable()(*TenantAttachRBACMicrosoftGraphEnableRequestBuilder) {
    return NewTenantAttachRBACMicrosoftGraphEnableRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetState provides operations to call the getState method.
func (m *TenantAttachRBACRequestBuilder) MicrosoftGraphGetState()(*TenantAttachRBACMicrosoftGraphGetStateRequestBuilder) {
    return NewTenantAttachRBACMicrosoftGraphGetStateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
