...
func (m *TenantAttachRBACRequestBuilder) Delete(ctx context.Context, requestConfiguration *TenantAttachRBACRequestBuilderDeleteRequestConfiguration)([]byte, error) {
