...
// NewWindowsAutopilotDeviceIdentitiesItemUnassignResourceAccountFromDeviceRequestBuilderInternal instantiates a new WindowsAutopilotDeviceIdentitiesItemUnassignResourceAccountFromDeviceRequestBuilder and sets the default values.
...
// NewWindowsAutopilotDeviceIdentitiesItemUnassignResourceAccountFromDeviceRequestBuilder instantiates a new WindowsAutopilotDeviceIdentitiesItemUnassignResourceAccountFromDeviceRequestBuilder and sets the default values.
...
func (m *WindowsAutopilotDeviceIdentitiesItemUnassignResourceAccountFromDeviceRequestBuilder) WithUrl(rawUrl string)(*WindowsAutopilotDeviceIdentitiesItemUnassignResourceAccountFromDeviceRequestBuilder) {
    return NewWindowsAutopilotDeviceIdentitiesItemUnassignResourceAccountFromDeviceRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
