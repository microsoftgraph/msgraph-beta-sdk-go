...
// NewReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilderInternal instantiates a new ReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder and sets the default values.
func NewReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder) {
    m := &ReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/reports/getWindowsUpdateAlertsPerPolicyPerDeviceReport", pathParameters),
    }
    return m
}
// NewReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder instantiates a new ReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder and sets the default values.
...
func (m *ReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder) WithUrl(rawUrl string)(*ReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder) {
    return NewReportsGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
