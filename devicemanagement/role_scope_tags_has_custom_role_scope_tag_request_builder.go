...
// NewRoleScopeTagsHasCustomRoleScopeTagRequestBuilderInternal instantiates a new RoleScopeTagsHasCustomRoleScopeTagRequestBuilder and sets the default values.
...
// NewRoleScopeTagsHasCustomRoleScopeTagRequestBuilder instantiates a new RoleScopeTagsHasCustomRoleScopeTagRequestBuilder and sets the default values.
...
// returns a RoleScopeTagsHasCustomRoleScopeTagGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
