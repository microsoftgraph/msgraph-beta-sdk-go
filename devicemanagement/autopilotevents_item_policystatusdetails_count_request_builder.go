...
// NewAutopiloteventsItemPolicystatusdetailsCountRequestBuilderInternal instantiates a new AutopiloteventsItemPolicystatusdetailsCountRequestBuilder and sets the default values.
func NewAutopiloteventsItemPolicystatusdetailsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AutopiloteventsItemPolicystatusdetailsCountRequestBuilder) {
    m := &AutopiloteventsItemPolicystatusdetailsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/autopilotEvents/{deviceManagementAutopilotEvent%2Did}/policyStatusDetails/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewAutopiloteventsItemPolicystatusdetailsCountRequestBuilder instantiates a new AutopiloteventsItemPolicystatusdetailsCountRequestBuilder and sets the default values.
...
// returns a *AutopiloteventsItemPolicystatusdetailsCountRequestBuilder when successful
