...
// VirtualEndpointSharedUseServicePlansRequestBuilderGetQueryParameters get a list of the cloudPcSharedUseServicePlan objects and their properties. This API is available in the following national cloud deployments.
...
// Get get a list of the cloudPcSharedUseServicePlan objects and their properties. This API is available in the following national cloud deployments.
// Deprecated: The sharedUseServicePlans property is deprecated and will not be supported starting Oct 8, 2023. This property will not be included as part of the API response. as of 2023-03/sharedUseServicePlans on 2023-06-08 and will be removed 2023-10-08
// [Find more info here]
// 
...
// ToGetRequestInformation get a list of the cloudPcSharedUseServicePlan objects and their properties. This API is available in the following national cloud deployments.
// Deprecated: The sharedUseServicePlans property is deprecated and will not be supported starting Oct 8, 2023. This property will not be included as part of the API response. as of 2023-03/sharedUseServicePlans on 2023-06-08 and will be removed 2023-10-08
