...
func (m *DeviceShellScriptsDeviceShellScriptItemRequestBuilder) AssignmentsById(id string)(*DeviceShellScriptsItemAssignmentsDeviceManagementScriptAssignmentItemRequestBuilder) {
    ...
    idPtr := &id
    return NewDeviceShellScriptsItemAssignmentsDeviceManagementScriptAssignmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewDeviceShellScriptsDeviceShellScriptItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, deviceShellScriptId *string)(*DeviceShellScriptsDeviceShellScriptItemRequestBuilder) {
...
func NewDeviceShellScriptsDeviceShellScriptItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceShellScriptsDeviceShellScriptItemRequestBuilder) {
    ...
    return NewDeviceShellScriptsDeviceShellScriptItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *DeviceShellScriptsDeviceShellScriptItemRequestBuilder) DeviceRunStatesById(id string)(*DeviceShellScriptsItemDeviceRunStatesDeviceManagementScriptDeviceStateItemRequestBuilder) {
    ...
    idPtr := &id
    return NewDeviceShellScriptsItemDeviceRunStatesDeviceManagementScriptDeviceStateItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *DeviceShellScriptsDeviceShellScriptItemRequestBuilder) GroupAssignmentsById(id string)(*DeviceShellScriptsItemGroupAssignmentsDeviceManagementScriptGroupAssignmentItemRequestBuilder) {
    ...
    idPtr := &id
    return NewDeviceShellScriptsItemGroupAssignmentsDeviceManagementScriptGroupAssignmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
// MicrosoftGraphAssign provides operations to call the assign method.
func (m *DeviceShellScriptsDeviceShellScriptItemRequestBuilder) MicrosoftGraphAssign()(*DeviceShellScriptsItemMicrosoftGraphAssignAssignRequestBuilder) {
    return NewDeviceShellScriptsItemMicrosoftGraphAssignAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *DeviceShellScriptsDeviceShellScriptItemRequestBuilder) UserRunStatesById(id string)(*DeviceShellScriptsItemUserRunStatesDeviceManagementScriptUserStateItemRequestBuilder) {
    ...
    idPtr := &id
    return NewDeviceShellScriptsItemUserRunStatesDeviceManagementScriptUserStateItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
