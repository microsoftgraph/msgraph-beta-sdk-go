...
// MonitoringAlertRulesRequestBuilderGetQueryParameters get a list of the alertRule objects and their properties. This API is available in the following national cloud deployments.
...
func NewMonitoringAlertRulesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MonitoringAlertRulesRequestBuilder) {
    m := &MonitoringAlertRulesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/monitoring/alertRules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get get a list of the alertRule objects and their properties. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create an alertRule object. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get a list of the alertRule objects and their properties. This API is available in the following national cloud deployments.
...
// ToPostRequestInformation create an alertRule object. This API is available in the following national cloud deployments.
...
func (m *MonitoringAlertRulesRequestBuilder) WithUrl(rawUrl string)(*MonitoringAlertRulesRequestBuilder) {
    return NewMonitoringAlertRulesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
