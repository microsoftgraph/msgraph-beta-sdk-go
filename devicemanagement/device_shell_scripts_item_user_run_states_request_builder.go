...
// ByDeviceManagementScriptUserStateIdString provides operations to manage the userRunStates property of the microsoft.graph.deviceShellScript entity.
func (m *DeviceShellScriptsItemUserRunStatesRequestBuilder) ByDeviceManagementScriptUserStateIdString(deviceManagementScriptUserStateId string)(*DeviceShellScriptsItemUserRunStatesDeviceManagementScriptUserStateItemRequestBuilder) {
...
func NewDeviceShellScriptsItemUserRunStatesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceShellScriptsItemUserRunStatesRequestBuilder) {
    m := &DeviceShellScriptsItemUserRunStatesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript%2Did}/userRunStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
