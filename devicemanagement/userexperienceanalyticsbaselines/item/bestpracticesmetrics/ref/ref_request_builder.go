...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\userExperienceAnalyticsBaselines\{userExperienceAnalyticsBaseline-id}\bestPracticesMetrics\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline_id}/bestPracticesMetrics/$ref";
...
// CreateDeleteRequestInformation the user experience analytics best practices metrics.
...
// CreatePutRequestInformation the user experience analytics best practices metrics.
...
// Delete the user experience analytics best practices metrics.
...
// Put the user experience analytics best practices metrics.
