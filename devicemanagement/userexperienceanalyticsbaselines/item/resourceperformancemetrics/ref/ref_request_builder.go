...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\userExperienceAnalyticsBaselines\{userExperienceAnalyticsBaseline-id}\resourcePerformanceMetrics\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline_id}/resourcePerformanceMetrics/$ref";
...
// CreateDeleteRequestInformation the user experience analytics resource performance metrics.
...
// CreatePutRequestInformation the user experience analytics resource performance metrics.
...
// Delete the user experience analytics resource performance metrics.
...
// Put the user experience analytics resource performance metrics.
