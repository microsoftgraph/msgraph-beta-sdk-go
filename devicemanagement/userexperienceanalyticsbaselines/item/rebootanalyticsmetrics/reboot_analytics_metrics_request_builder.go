...
// RebootAnalyticsMetricsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type RebootAnalyticsMetricsRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
// CreateGetRequestInformationWithRequestConfiguration the user experience analytics reboot analytics metrics.
func (m *RebootAnalyticsMetricsRequestBuilder) CreateGetRequestInformationWithRequestConfiguration()(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreateGetRequestInformationWithRequestConfiguration(nil);
}
// CreateGetRequestInformationWithRequestConfiguration the user experience analytics reboot analytics metrics.
func (m *RebootAnalyticsMetricsRequestBuilder) CreateGetRequestInformationWithRequestConfiguration(requestConfiguration *RebootAnalyticsMetricsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// GetWithResponseHandler the user experience analytics reboot analytics metrics.
func (m *RebootAnalyticsMetricsRequestBuilder) GetWithResponseHandler(requestConfiguration *RebootAnalyticsMetricsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsCategoryable, error) {
    return m.GetWithResponseHandler(requestConfiguration, nil);
}
// GetWithResponseHandler the user experience analytics reboot analytics metrics.
func (m *RebootAnalyticsMetricsRequestBuilder) GetWithResponseHandler(requestConfiguration *RebootAnalyticsMetricsRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsCategoryable, error) {
