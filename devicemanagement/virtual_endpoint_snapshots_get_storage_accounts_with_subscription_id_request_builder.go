...
func (m *VirtualEndpointSnapshotsGetStorageAccountsWithSubscriptionIdRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *VirtualEndpointSnapshotsGetStorageAccountsWithSubscriptionIdRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *VirtualEndpointSnapshotsGetStorageAccountsWithSubscriptionIdRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointSnapshotsGetStorageAccountsWithSubscriptionIdRequestBuilderGetRequestConfiguration)(VirtualEndpointSnapshotsGetStorageAccountsWithSubscriptionIdResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateVirtualEndpointSnapshotsGetStorageAccountsWithSubscriptionIdResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
