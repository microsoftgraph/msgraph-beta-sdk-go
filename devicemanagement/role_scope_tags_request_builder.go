...
func (m *RoleScopeTagsRequestBuilder) Count()(*RoleScopeTagsCountRequestBuilder) {
    return NewRoleScopeTagsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// MicrosoftGraphGetRoleScopeTagsById provides operations to call the getRoleScopeTagsById method.
func (m *RoleScopeTagsRequestBuilder) MicrosoftGraphGetRoleScopeTagsById()(*RoleScopeTagsMicrosoftGraphGetRoleScopeTagsByIdGetRoleScopeTagsByIdRequestBuilder) {
    return NewRoleScopeTagsMicrosoftGraphGetRoleScopeTagsByIdGetRoleScopeTagsByIdRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphHasCustomRoleScopeTag provides operations to call the hasCustomRoleScopeTag method.
func (m *RoleScopeTagsRequestBuilder) MicrosoftGraphHasCustomRoleScopeTag()(*RoleScopeTagsMicrosoftGraphHasCustomRoleScopeTagHasCustomRoleScopeTagRequestBuilder) {
    return NewRoleScopeTagsMicrosoftGraphHasCustomRoleScopeTagHasCustomRoleScopeTagRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *RoleScopeTagsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RoleScopeTagable, requestConfiguration *RoleScopeTagsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RoleScopeTagable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateRoleScopeTagFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
