...
func (m *RoleScopeTagsRequestBuilder) MicrosoftGraphGetRoleScopeTagsById()(*RoleScopeTagsMicrosoftGraphGetRoleScopeTagsByIdRequestBuilder) {
    return NewRoleScopeTagsMicrosoftGraphGetRoleScopeTagsByIdRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphHasCustomRoleScopeTag provides operations to call the hasCustomRoleScopeTag method.
func (m *RoleScopeTagsRequestBuilder) MicrosoftGraphHasCustomRoleScopeTag()(*RoleScopeTagsMicrosoftGraphHasCustomRoleScopeTagRequestBuilder) {
    return NewRoleScopeTagsMicrosoftGraphHasCustomRoleScopeTagRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
