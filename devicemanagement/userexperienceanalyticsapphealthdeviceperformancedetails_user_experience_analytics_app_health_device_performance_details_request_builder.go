...
func (m *UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder) ByUserExperienceAnalyticsAppHealthDevicePerformanceDetailsId(userExperienceAnalyticsAppHealthDevicePerformanceDetailsId string)(*UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsItemRequestBuilder) {
...
func NewUserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder) {
    m := &UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder{
...
func NewUserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder) {
    ...
    return NewUserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *UserexperienceanalyticsapphealthdeviceperformancedetailsCountRequestBuilder when successful
func (m *UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder) Count()(*UserexperienceanalyticsapphealthdeviceperformancedetailsCountRequestBuilder) {
...
func (m *UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionResponseable, error) {
...
func (m *UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder) {
    return NewUserexperienceanalyticsapphealthdeviceperformancedetailsUserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
