...
// NewManagedDevicesAppDiagnosticsWithUpnRequestBuilderInternal instantiates a new ManagedDevicesAppDiagnosticsWithUpnRequestBuilder and sets the default values.
...
// NewManagedDevicesAppDiagnosticsWithUpnRequestBuilder instantiates a new ManagedDevicesAppDiagnosticsWithUpnRequestBuilder and sets the default values.
...
// returns a ManagedDevicesAppDiagnosticsWithUpnResponseable when successful
...
// returns a ManagedDevicesAppDiagnosticsWithUpnGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ManagedDevicesAppDiagnosticsWithUpnRequestBuilder) GetAsAppDiagnosticsWithUpnGetResponse(ctx context.Context, requestConfiguration *ManagedDevicesAppDiagnosticsWithUpnRequestBuilderGetRequestConfiguration)(ManagedDevicesAppDiagnosticsWithUpnGetResponseable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateManagedDevicesAppDiagnosticsWithUpnGetResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ManagedDevicesAppDiagnosticsWithUpnGetResponseable), nil
}
...
func (m *ManagedDevicesAppDiagnosticsWithUpnRequestBuilder) WithUrl(rawUrl string)(*ManagedDevicesAppDiagnosticsWithUpnRequestBuilder) {
    return NewManagedDevicesAppDiagnosticsWithUpnRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
