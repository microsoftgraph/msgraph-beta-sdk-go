...
// UserExperienceAnalyticsNotAutopilotReadyDeviceResponse 
...
// NewUserExperienceAnalyticsNotAutopilotReadyDeviceResponse instantiates a new userExperienceAnalyticsNotAutopilotReadyDeviceResponse and sets the default values.
