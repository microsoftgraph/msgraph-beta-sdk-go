...
type ComanageddevicesExecuteactionExecuteActionPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewComanageddevicesExecuteactionExecuteActionPostRequestBody instantiates a new ComanageddevicesExecuteactionExecuteActionPostRequestBody and sets the default values.
func NewComanageddevicesExecuteactionExecuteActionPostRequestBody()(*ComanageddevicesExecuteactionExecuteActionPostRequestBody) {
    m := &ComanageddevicesExecuteactionExecuteActionPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateComanageddevicesExecuteactionExecuteActionPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateComanageddevicesExecuteactionExecuteActionPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewComanageddevicesExecuteactionExecuteActionPostRequestBody(), nil
}
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetActionName()(*ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ManagedDeviceRemoteAction) {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetCarrierUrl gets the carrierUrl property value. The carrierUrl property
// returns a *string when successful
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetCarrierUrl()(*string) {
...
// returns a *string when successful
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetDeprovisionReason()(*string) {
...
// returns a []string when successful
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetDeviceIds()([]string) {
...
// returns a *string when successful
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetDeviceName()(*string) {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetKeepEnrollmentData()(*bool) {
...
// returns a *bool when successful
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetKeepUserData()(*bool) {
...
// returns a *string when successful
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetNotificationBody()(*string) {
...
// returns a *string when successful
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetNotificationTitle()(*string) {
...
// returns a *string when successful
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetOrganizationalUnitPath()(*string) {
...
// returns a *bool when successful
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) GetPersistEsimDataPlan()(*bool) {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetActionName(value *ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ManagedDeviceRemoteAction)() {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetCarrierUrl sets the carrierUrl property value. The carrierUrl property
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetCarrierUrl(value *string)() {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetDeprovisionReason(value *string)() {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetDeviceIds(value []string)() {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetDeviceName(value *string)() {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetKeepEnrollmentData(value *bool)() {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetKeepUserData(value *bool)() {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetNotificationBody(value *string)() {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetNotificationTitle(value *string)() {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetOrganizationalUnitPath(value *string)() {
...
func (m *ComanageddevicesExecuteactionExecuteActionPostRequestBody) SetPersistEsimDataPlan(value *bool)() {
    err := m.GetBackingStore().Set("persistEsimDataPlan", value)
    if err != nil {
        panic(err)
    }
}
type ComanageddevicesExecuteactionExecuteActionPostRequestBodyable interface {
