...
// NewVirtualEndpointUserSettingsItemAssignRequestBuilderInternal instantiates a new AssignRequestBuilder and sets the default values.
...
// NewVirtualEndpointUserSettingsItemAssignRequestBuilder instantiates a new AssignRequestBuilder and sets the default values.
...
// Post assign a cloudPcUserSetting to user groups. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation assign a cloudPcUserSetting to user groups. This API is available in the following national cloud deployments.
