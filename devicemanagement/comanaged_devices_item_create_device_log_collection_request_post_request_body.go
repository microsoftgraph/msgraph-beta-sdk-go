...
// ComanagedDevicesItemCreateDeviceLogCollectionRequestPostRequestBody provides operations to call the createDeviceLogCollectionRequest method.
...
func (m *ComanagedDevicesItemCreateDeviceLogCollectionRequestPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ComanagedDevicesItemCreateDeviceLogCollectionRequestPostRequestBody) SetAdditionalData(value map[string]interface{})() {
