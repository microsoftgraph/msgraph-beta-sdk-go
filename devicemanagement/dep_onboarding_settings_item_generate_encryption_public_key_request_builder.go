...
// NewDepOnboardingSettingsItemGenerateEncryptionPublicKeyRequestBuilderInternal instantiates a new DepOnboardingSettingsItemGenerateEncryptionPublicKeyRequestBuilder and sets the default values.
...
// NewDepOnboardingSettingsItemGenerateEncryptionPublicKeyRequestBuilder instantiates a new DepOnboardingSettingsItemGenerateEncryptionPublicKeyRequestBuilder and sets the default values.
...
func (m *DepOnboardingSettingsItemGenerateEncryptionPublicKeyRequestBuilder) PostAsGenerateEncryptionPublicKeyPostResponse(ctx context.Context, requestConfiguration *DepOnboardingSettingsItemGenerateEncryptionPublicKeyRequestBuilderPostRequestConfiguration)(DepOnboardingSettingsItemGenerateEncryptionPublicKeyPostResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateDepOnboardingSettingsItemGenerateEncryptionPublicKeyPostResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(DepOnboardingSettingsItemGenerateEncryptionPublicKeyPostResponseable), nil
}
