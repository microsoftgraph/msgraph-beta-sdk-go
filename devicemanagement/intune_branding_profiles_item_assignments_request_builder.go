...
// NewIntuneBrandingProfilesItemAssignmentsRequestBuilderInternal instantiates a new AssignmentsRequestBuilder and sets the default values.
...
// NewIntuneBrandingProfilesItemAssignmentsRequestBuilder instantiates a new AssignmentsRequestBuilder and sets the default values.
...
func (m *IntuneBrandingProfilesItemAssignmentsRequestBuilder) Count()(*IntuneBrandingProfilesItemAssignmentsCountRequestBuilder) {
    return NewIntuneBrandingProfilesItemAssignmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the list of group assignments for the branding profile
func (m *IntuneBrandingProfilesItemAssignmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *IntuneBrandingProfilesItemAssignmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
