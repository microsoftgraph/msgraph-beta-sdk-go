...
func (m *WindowsAutopilotDeploymentProfilesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsAutopilotDeploymentProfilesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
