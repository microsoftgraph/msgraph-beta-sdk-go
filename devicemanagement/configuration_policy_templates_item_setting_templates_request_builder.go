...
func (m *ConfigurationPolicyTemplatesItemSettingTemplatesRequestBuilder) Count()(*ConfigurationPolicyTemplatesItemSettingTemplatesCountRequestBuilder) {
    return NewConfigurationPolicyTemplatesItemSettingTemplatesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation setting templates
func (m *ConfigurationPolicyTemplatesItemSettingTemplatesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ConfigurationPolicyTemplatesItemSettingTemplatesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
