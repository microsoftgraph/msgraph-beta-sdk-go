...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\managementConditionStatements\{managementConditionStatement-id}\managementConditions\$ref
...
// RefRequestBuilderGetQueryParameters the management conditions associated to the management condition statement.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/managementConditionStatements/{managementConditionStatement_id}/managementConditions/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the management conditions associated to the management condition statement.
...
// Post the management conditions associated to the management condition statement.
