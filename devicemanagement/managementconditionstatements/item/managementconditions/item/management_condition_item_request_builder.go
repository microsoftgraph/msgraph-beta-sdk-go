...
// ManagementConditionItemRequestBuilder provides operations to manage the managementConditions property of the microsoft.graph.managementConditionStatement entity.
...
// ManagementConditionItemRequestBuilderGetQueryParameters the management conditions associated to the management condition statement.
...
func NewManagementConditionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagementConditionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/managementConditionStatements/{managementConditionStatement%2Did}/managementConditions/{managementCondition%2Did}{?%24select,%24expand}";
...
// CreateGetRequestInformationWithRequestConfiguration the management conditions associated to the management condition statement.
...
// GetWithResponseHandler the management conditions associated to the management condition statement.
