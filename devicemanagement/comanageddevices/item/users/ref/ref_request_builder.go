...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\comanagedDevices\{managedDevice-id}\users\$ref
...
// RefRequestBuilderGetQueryParameters the primary users associated with the managed device.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice_id}/users/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the primary users associated with the managed device.
...
// Post the primary users associated with the managed device.
