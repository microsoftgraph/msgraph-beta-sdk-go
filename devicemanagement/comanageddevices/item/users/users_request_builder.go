...
import (
    ...
    ie02f4298c665be29fce8d03acc035e2779a4defcefcd8685e889c950f9c8f982 "github.com/microsoftgraph/msgraph-beta-sdk-go/devicemanagement/comanageddevices/item/users/ref"
)

// UsersRequestBuilder builds and executes requests for operations under \deviceManagement\comanagedDevices\{managedDevice-id}\users
...
func NewUsersRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UsersRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice_id}/users{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *UsersRequestBuilder) Ref()(*ie02f4298c665be29fce8d03acc035e2779a4defcefcd8685e889c950f9c8f982.RefRequestBuilder) {
    return ie02f4298c665be29fce8d03acc035e2779a4defcefcd8685e889c950f9c8f982.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
