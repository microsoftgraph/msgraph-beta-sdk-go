...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\comanagedDevices\{managedDevice-id}\detectedApps\$ref
...
// RefRequestBuilderGetQueryParameters all applications currently installed on the device
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice_id}/detectedApps/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation all applications currently installed on the device
...
// Post all applications currently installed on the device
