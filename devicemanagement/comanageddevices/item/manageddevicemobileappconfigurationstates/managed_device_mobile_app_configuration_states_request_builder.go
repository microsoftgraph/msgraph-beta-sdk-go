...
// ManagedDeviceMobileAppConfigurationStatesRequestBuilder builds and executes requests for operations under \deviceManagement\comanagedDevices\{managedDevice-id}\managedDeviceMobileAppConfigurationStates
