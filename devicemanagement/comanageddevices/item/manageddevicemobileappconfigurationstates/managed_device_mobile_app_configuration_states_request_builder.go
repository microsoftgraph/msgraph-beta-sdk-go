...
import (
    ...
    ic8cbfafa965a899e3068a7009bef8c7090c5b4f3da066363e78ac371d18a806a "github.com/microsoftgraph/msgraph-beta-sdk-go/devicemanagement/comanageddevices/item/manageddevicemobileappconfigurationstates/count"
)
...
func NewManagedDeviceMobileAppConfigurationStatesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ManagedDeviceMobileAppConfigurationStatesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice_id}/managedDeviceMobileAppConfigurationStates{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ManagedDeviceMobileAppConfigurationStatesRequestBuilder) Count()(*ic8cbfafa965a899e3068a7009bef8c7090c5b4f3da066363e78ac371d18a806a.CountRequestBuilder) {
    return ic8cbfafa965a899e3068a7009bef8c7090c5b4f3da066363e78ac371d18a806a.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
