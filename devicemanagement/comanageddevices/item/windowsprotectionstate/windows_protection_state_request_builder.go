...
// DeleteWithResponseHandler delete navigation property windowsProtectionState for deviceManagement
...
// PatchWithResponseHandler update the navigation property windowsProtectionState in deviceManagement
