...
// BulkReprovisionCloudPcRequestBuilder builds and executes requests for operations under \deviceManagement\comanagedDevices\microsoft.graph.bulkReprovisionCloudPc
