...
// NewGroupPolicyDefinitionsItemPresentationsRequestBuilderInternal instantiates a new PresentationsRequestBuilder and sets the default values.
func NewGroupPolicyDefinitionsItemPresentationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupPolicyDefinitionsItemPresentationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/presentations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewGroupPolicyDefinitionsItemPresentationsRequestBuilder instantiates a new PresentationsRequestBuilder and sets the default values.
...
func (m *GroupPolicyDefinitionsItemPresentationsRequestBuilder) Count()(*GroupPolicyDefinitionsItemPresentationsCountRequestBuilder) {
    return NewGroupPolicyDefinitionsItemPresentationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the group policy presentations associated with the definition.
func (m *GroupPolicyDefinitionsItemPresentationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GroupPolicyDefinitionsItemPresentationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
