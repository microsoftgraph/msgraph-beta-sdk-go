...
func (m *DeviceConfigurationRestrictedAppsViolationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceConfigurationRestrictedAppsViolationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
