...
// DeviceConfigurationRestrictedAppsViolationsCountRequestBuilder provides operations to count the resources in the collection.
type DeviceConfigurationRestrictedAppsViolationsCountRequestBuilder struct {
...
func NewDeviceConfigurationRestrictedAppsViolationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceConfigurationRestrictedAppsViolationsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/deviceConfigurationRestrictedAppsViolations/$count";
...
func (m *DeviceConfigurationRestrictedAppsViolationsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DeviceConfigurationRestrictedAppsViolationsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
