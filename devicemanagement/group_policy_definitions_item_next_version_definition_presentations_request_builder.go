...
// NewGroupPolicyDefinitionsItemNextVersionDefinitionPresentationsRequestBuilderInternal instantiates a new PresentationsRequestBuilder and sets the default values.
...
// NewGroupPolicyDefinitionsItemNextVersionDefinitionPresentationsRequestBuilder instantiates a new PresentationsRequestBuilder and sets the default values.
...
func (m *GroupPolicyDefinitionsItemNextVersionDefinitionPresentationsRequestBuilder) Count()(*GroupPolicyDefinitionsItemNextVersionDefinitionPresentationsCountRequestBuilder) {
    return NewGroupPolicyDefinitionsItemNextVersionDefinitionPresentationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the group policy presentations associated with the definition.
func (m *GroupPolicyDefinitionsItemNextVersionDefinitionPresentationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GroupPolicyDefinitionsItemNextVersionDefinitionPresentationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
