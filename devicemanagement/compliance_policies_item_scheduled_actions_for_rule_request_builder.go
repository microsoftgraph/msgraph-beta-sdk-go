...
// ByDeviceManagementComplianceScheduledActionForRuleIdString provides operations to manage the scheduledActionsForRule property of the microsoft.graph.deviceManagementCompliancePolicy entity.
func (m *CompliancePoliciesItemScheduledActionsForRuleRequestBuilder) ByDeviceManagementComplianceScheduledActionForRuleIdString(deviceManagementComplianceScheduledActionForRuleId string)(*CompliancePoliciesItemScheduledActionsForRuleDeviceManagementComplianceScheduledActionForRuleItemRequestBuilder) {
