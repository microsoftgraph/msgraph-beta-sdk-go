...
// NewGrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionCategoryRequestBuilderInternal instantiates a new GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionCategoryRequestBuilder and sets the default values.
func NewGrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionCategoryRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionCategoryRequestBuilder) {
    m := &GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionCategoryRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/previousVersionDefinition/category{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewGrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionCategoryRequestBuilder instantiates a new GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionCategoryRequestBuilder and sets the default values.
...
func (m *GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionCategoryRequestBuilder) WithUrl(rawUrl string)(*GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionCategoryRequestBuilder) {
    return NewGrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionCategoryRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
