...
// NewDevicecustomattributeshellscriptsItemDevicerunstatesDeviceManagementScriptDeviceStateItemRequestBuilderInternal instantiates a new DevicecustomattributeshellscriptsItemDevicerunstatesDeviceManagementScriptDeviceStateItemRequestBuilder and sets the default values.
...
// NewDevicecustomattributeshellscriptsItemDevicerunstatesDeviceManagementScriptDeviceStateItemRequestBuilder instantiates a new DevicecustomattributeshellscriptsItemDevicerunstatesDeviceManagementScriptDeviceStateItemRequestBuilder and sets the default values.
...
func (m *DevicecustomattributeshellscriptsItemDevicerunstatesDeviceManagementScriptDeviceStateItemRequestBuilder) ManagedDevice()(*DevicecustomattributeshellscriptsItemDevicerunstatesItemManageddeviceManagedDeviceRequestBuilder) {
    return NewDevicecustomattributeshellscriptsItemDevicerunstatesItemManageddeviceManagedDeviceRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
