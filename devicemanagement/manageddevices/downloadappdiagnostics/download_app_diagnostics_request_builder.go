...
func (m *DownloadAppDiagnosticsRequestBuilder) Post(ctx context.Context, body DownloadAppDiagnosticsPostRequestBodyable, requestConfiguration *DownloadAppDiagnosticsRequestBuilderPostRequestConfiguration)([]byte, error) {
