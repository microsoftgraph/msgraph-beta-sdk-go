...
func NewWipeRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WipeRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewWipeRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation wipe a device
func (m *WipeRequestBuilder) CreatePostRequestInformation(ctx context.Context, body WipePostRequestBodyable, requestConfiguration *WipeRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// Post wipe a device
func (m *WipeRequestBuilder) Post(ctx context.Context, body WipePostRequestBodyable, requestConfiguration *WipeRequestBuilderPostRequestConfiguration)(error) {
