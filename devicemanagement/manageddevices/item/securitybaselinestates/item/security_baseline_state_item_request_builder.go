...
// SecurityBaselineStateItemRequestBuilder builds and executes requests for operations under \deviceManagement\managedDevices\{managedDevice-id}\securityBaselineStates\{securityBaselineState-id}
