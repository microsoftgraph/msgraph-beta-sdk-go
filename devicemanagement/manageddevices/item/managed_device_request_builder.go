...
import (
    ...
    i93f4bea5a538abee7536484426104089a374b23388f646074ef17a26cd017b20 "github.com/microsoftgraph/msgraph-beta-sdk-go/devicemanagement/manageddevices/item/users/item"
...
func (m *ManagedDeviceRequestBuilder) UsersById(id string)(*i93f4bea5a538abee7536484426104089a374b23388f646074ef17a26cd017b20.UserRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i93f4bea5a538abee7536484426104089a374b23388f646074ef17a26cd017b20.NewUserRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
