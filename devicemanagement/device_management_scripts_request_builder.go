...
func (m *DeviceManagementScriptsRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceManagementScriptsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementScriptCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceManagementScriptCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *DeviceManagementScriptsRequestBuilder) MicrosoftGraphHasPayloadLinks()(*DeviceManagementScriptsMicrosoftGraphHasPayloadLinksRequestBuilder) {
    return NewDeviceManagementScriptsMicrosoftGraphHasPayloadLinksRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
