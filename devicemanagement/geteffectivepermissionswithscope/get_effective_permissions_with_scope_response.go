...
func (m *GetEffectivePermissionsWithScopeResponse) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetEffectivePermissionsWithScopeResponse) GetValue()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RolePermissionable) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *GetEffectivePermissionsWithScopeResponse) SetValue(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RolePermissionable)() {
    if m != nil {
        m.value = value
    }
}
