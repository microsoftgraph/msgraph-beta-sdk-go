...
func (m *DeviceManagementRequestBuilder) MicrosoftGraphEnableAndroidDeviceAdministratorEnrollment()(*MicrosoftGraphEnableAndroidDeviceAdministratorEnrollmentRequestBuilder) {
    return NewMicrosoftGraphEnableAndroidDeviceAdministratorEnrollmentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEnableLegacyPcManagement provides operations to call the enableLegacyPcManagement method.
func (m *DeviceManagementRequestBuilder) MicrosoftGraphEnableLegacyPcManagement()(*MicrosoftGraphEnableLegacyPcManagementRequestBuilder) {
    return NewMicrosoftGraphEnableLegacyPcManagementRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEnableUnlicensedAdminstrators provides operations to call the enableUnlicensedAdminstrators method.
func (m *DeviceManagementRequestBuilder) MicrosoftGraphEnableUnlicensedAdminstrators()(*MicrosoftGraphEnableUnlicensedAdminstratorsRequestBuilder) {
    return NewMicrosoftGraphEnableUnlicensedAdminstratorsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEvaluateAssignmentFilter provides operations to call the evaluateAssignmentFilter method.
func (m *DeviceManagementRequestBuilder) MicrosoftGraphEvaluateAssignmentFilter()(*MicrosoftGraphEvaluateAssignmentFilterRequestBuilder) {
    return NewMicrosoftGraphEvaluateAssignmentFilterRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetAssignedRoleDetails provides operations to call the getAssignedRoleDetails method.
func (m *DeviceManagementRequestBuilder) MicrosoftGraphGetAssignedRoleDetails()(*MicrosoftGraphGetAssignedRoleDetailsRequestBuilder) {
    return NewMicrosoftGraphGetAssignedRoleDetailsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetAssignmentFiltersStatusDetails provides operations to call the getAssignmentFiltersStatusDetails method.
func (m *DeviceManagementRequestBuilder) MicrosoftGraphGetAssignmentFiltersStatusDetails()(*MicrosoftGraphGetAssignmentFiltersStatusDetailsRequestBuilder) {
    return NewMicrosoftGraphGetAssignmentFiltersStatusDetailsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetComanagedDevicesSummary provides operations to call the getComanagedDevicesSummary method.
func (m *DeviceManagementRequestBuilder) MicrosoftGraphGetComanagedDevicesSummary()(*MicrosoftGraphGetComanagedDevicesSummaryRequestBuilder) {
    return NewMicrosoftGraphGetComanagedDevicesSummaryRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *DeviceManagementRequestBuilder) MicrosoftGraphGetComanagementEligibleDevicesSummary()(*MicrosoftGraphGetComanagementEligibleDevicesSummaryRequestBuilder) {
    return NewMicrosoftGraphGetComanagementEligibleDevicesSummaryRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetEffectivePermissions provides operations to call the getEffectivePermissions method.
func (m *DeviceManagementRequestBuilder) MicrosoftGraphGetEffectivePermissions()(*MicrosoftGraphGetEffectivePermissionsRequestBuilder) {
    return NewMicrosoftGraphGetEffectivePermissionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *DeviceManagementRequestBuilder) MicrosoftGraphGetRoleScopeTagsByIdsWithIds(ids *string)(*MicrosoftGraphGetRoleScopeTagsByIdsWithIdsRequestBuilder) {
    return NewMicrosoftGraphGetRoleScopeTagsByIdsWithIdsRequestBuilderInternal(m.pathParameters, m.requestAdapter, ids)
}
// MicrosoftGraphGetRoleScopeTagsByResourceWithResource provides operations to call the getRoleScopeTagsByResource method.
func (m *DeviceManagementRequestBuilder) MicrosoftGraphGetRoleScopeTagsByResourceWithResource(resource *string)(*MicrosoftGraphGetRoleScopeTagsByResourceWithResourceRequestBuilder) {
    return NewMicrosoftGraphGetRoleScopeTagsByResourceWithResourceRequestBuilderInternal(m.pathParameters, m.requestAdapter, resource)
}
...
func (m *DeviceManagementRequestBuilder) MicrosoftGraphGetSuggestedEnrollmentLimitWithEnrollmentType(enrollmentType *string)(*MicrosoftGraphGetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder) {
    return NewMicrosoftGraphGetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilderInternal(m.pathParameters, m.requestAdapter, enrollmentType)
}
// MicrosoftGraphScopedForResourceWithResource provides operations to call the scopedForResource method.
func (m *DeviceManagementRequestBuilder) MicrosoftGraphScopedForResourceWithResource(resource *string)(*MicrosoftGraphScopedForResourceWithResourceRequestBuilder) {
    return NewMicrosoftGraphScopedForResourceWithResourceRequestBuilderInternal(m.pathParameters, m.requestAdapter, resource)
}
...
func (m *DeviceManagementRequestBuilder) MicrosoftGraphSendCustomNotificationToCompanyPortal()(*MicrosoftGraphSendCustomNotificationToCompanyPortalRequestBuilder) {
    return NewMicrosoftGraphSendCustomNotificationToCompanyPortalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *DeviceManagementRequestBuilder) MicrosoftGraphUserExperienceAnalyticsSummarizedDeviceScopes()(*MicrosoftGraphUserExperienceAnalyticsSummarizedDeviceScopesRequestBuilder) {
    return NewMicrosoftGraphUserExperienceAnalyticsSummarizedDeviceScopesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *DeviceManagementRequestBuilder) MicrosoftGraphUserExperienceAnalyticsSummarizeWorkFromAnywhereDevices()(*MicrosoftGraphUserExperienceAnalyticsSummarizeWorkFromAnywhereDevicesRequestBuilder) {
    return NewMicrosoftGraphUserExperienceAnalyticsSummarizeWorkFromAnywhereDevicesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
