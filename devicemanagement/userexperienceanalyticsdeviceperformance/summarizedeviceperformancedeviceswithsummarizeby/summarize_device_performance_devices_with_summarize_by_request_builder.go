...
func (m *SummarizeDevicePerformanceDevicesWithSummarizeByRequestBuilder) Get()(SummarizeDevicePerformanceDevicesWithSummarizeByResponseable, error) {
    return m.GetWithRequestConfigurationAndResponseHandler(nil, nil);
}
// GetWithRequestConfigurationAndResponseHandler invoke function summarizeDevicePerformanceDevices
func (m *SummarizeDevicePerformanceDevicesWithSummarizeByRequestBuilder) GetWithRequestConfigurationAndResponseHandler(requestConfiguration *SummarizeDevicePerformanceDevicesWithSummarizeByRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(SummarizeDevicePerformanceDevicesWithSummarizeByResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateSummarizeDevicePerformanceDevicesWithSummarizeByResponseFromDiscriminatorValue, responseHandler, errorMapping)
    if err != nil {
        return nil, err
    }
