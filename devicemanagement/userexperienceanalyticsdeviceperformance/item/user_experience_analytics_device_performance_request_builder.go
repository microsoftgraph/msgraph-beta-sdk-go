...
// UserExperienceAnalyticsDevicePerformanceRequestBuilder builds and executes requests for operations under \deviceManagement\userExperienceAnalyticsDevicePerformance\{userExperienceAnalyticsDevicePerformance-id}
...
// UserExperienceAnalyticsDevicePerformanceRequestBuilderDeleteOptions options for Delete
type UserExperienceAnalyticsDevicePerformanceRequestBuilderDeleteOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// UserExperienceAnalyticsDevicePerformanceRequestBuilderPatchOptions options for Patch
type UserExperienceAnalyticsDevicePerformanceRequestBuilderPatchOptions struct {
    // 
...
func (m *UserExperienceAnalyticsDevicePerformanceRequestBuilder) CreateDeleteRequestInformation(options *UserExperienceAnalyticsDevicePerformanceRequestBuilderDeleteOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *UserExperienceAnalyticsDevicePerformanceRequestBuilder) CreatePatchRequestInformation(options *UserExperienceAnalyticsDevicePerformanceRequestBuilderPatchOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *UserExperienceAnalyticsDevicePerformanceRequestBuilder) Delete(options *UserExperienceAnalyticsDevicePerformanceRequestBuilderDeleteOptions)(error) {
...
func (m *UserExperienceAnalyticsDevicePerformanceRequestBuilder) Get(options *UserExperienceAnalyticsDevicePerformanceRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserExperienceAnalyticsDevicePerformance, error) {
...
func (m *UserExperienceAnalyticsDevicePerformanceRequestBuilder) Patch(options *UserExperienceAnalyticsDevicePerformanceRequestBuilderPatchOptions)(error) {
