...
// Builds and executes requests for operations under \deviceManagement\userExperienceAnalyticsDevicePerformance\{userExperienceAnalyticsDevicePerformance-id}
