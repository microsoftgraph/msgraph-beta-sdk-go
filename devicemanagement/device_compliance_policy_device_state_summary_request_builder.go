...
func (m *DeviceCompliancePolicyDeviceStateSummaryRequestBuilder) Delete(ctx context.Context, requestConfiguration *DeviceCompliancePolicyDeviceStateSummaryRequestBuilderDeleteRequestConfiguration)([]byte, error) {
