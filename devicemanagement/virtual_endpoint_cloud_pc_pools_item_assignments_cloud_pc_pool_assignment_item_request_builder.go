...
// VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilder provides operations to manage the assignments property of the microsoft.graph.cloudPcPool entity.
type VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilderGetQueryParameters
}
// VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
// NewVirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilder instantiates a new VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilder and sets the default values.
func NewVirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilder) {
...
// returns a CloudPcPoolAssignmentable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CloudPcPoolAssignmentable, requestConfiguration *VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CloudPcPoolAssignmentable, error) {
...
// returns a *RequestInformation when successful
func (m *VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilder) ToPatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CloudPcPoolAssignmentable, requestConfiguration *VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilder) WithUrl(rawUrl string)(*VirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilder) {
    return NewVirtualEndpointCloudPcPoolsItemAssignmentsCloudPcPoolAssignmentItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
