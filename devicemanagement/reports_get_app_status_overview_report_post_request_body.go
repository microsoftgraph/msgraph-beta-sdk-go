...
// ReportsGetAppStatusOverviewReportPostRequestBody provides operations to call the getAppStatusOverviewReport method.
...
func (m *ReportsGetAppStatusOverviewReportPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ReportsGetAppStatusOverviewReportPostRequestBody) SetAdditionalData(value map[string]interface{})() {
