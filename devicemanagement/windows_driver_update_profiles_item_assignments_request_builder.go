...
// NewWindowsDriverUpdateProfilesItemAssignmentsRequestBuilderInternal instantiates a new AssignmentsRequestBuilder and sets the default values.
...
// NewWindowsDriverUpdateProfilesItemAssignmentsRequestBuilder instantiates a new AssignmentsRequestBuilder and sets the default values.
...
func (m *WindowsDriverUpdateProfilesItemAssignmentsRequestBuilder) Count()(*WindowsDriverUpdateProfilesItemAssignmentsCountRequestBuilder) {
    return NewWindowsDriverUpdateProfilesItemAssignmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the list of group assignments of the profile.
func (m *WindowsDriverUpdateProfilesItemAssignmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *WindowsDriverUpdateProfilesItemAssignmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
