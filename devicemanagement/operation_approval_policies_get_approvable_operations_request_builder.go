...
// NewOperationApprovalPoliciesGetApprovableOperationsRequestBuilderInternal instantiates a new GetApprovableOperationsRequestBuilder and sets the default values.
func NewOperationApprovalPoliciesGetApprovableOperationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OperationApprovalPoliciesGetApprovableOperationsRequestBuilder) {
    m := &OperationApprovalPoliciesGetApprovableOperationsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/operationApprovalPolicies/getApprovableOperations(){?%24top,%24skip,%24search,%24filter,%24count}", pathParameters),
    }
    return m
}
// NewOperationApprovalPoliciesGetApprovableOperationsRequestBuilder instantiates a new GetApprovableOperationsRequestBuilder and sets the default values.
