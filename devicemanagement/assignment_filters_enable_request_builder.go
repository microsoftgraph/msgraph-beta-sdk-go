...
// NewAssignmentFiltersEnableRequestBuilderInternal instantiates a new EnableRequestBuilder and sets the default values.
func NewAssignmentFiltersEnableRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AssignmentFiltersEnableRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/assignmentFilters/enable";
...
// NewAssignmentFiltersEnableRequestBuilder instantiates a new EnableRequestBuilder and sets the default values.
