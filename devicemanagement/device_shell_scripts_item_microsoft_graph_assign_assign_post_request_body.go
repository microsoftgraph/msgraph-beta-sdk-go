...
// DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody 
type DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody struct {
...
// NewDeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody instantiates a new DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody and sets the default values.
func NewDeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody()(*DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) {
    m := &DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateDeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateDeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewDeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) GetDeviceManagementScriptAssignments()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementScriptAssignmentable) {
...
func (m *DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) GetDeviceManagementScriptGroupAssignments()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementScriptGroupAssignmentable) {
    return m.deviceManagementScriptGroupAssignments
}
// GetFieldDeserializers the deserialization information for the current model
func (m *DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) SetDeviceManagementScriptAssignments(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementScriptAssignmentable)() {
...
func (m *DeviceShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) SetDeviceManagementScriptGroupAssignments(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementScriptGroupAssignmentable)() {
