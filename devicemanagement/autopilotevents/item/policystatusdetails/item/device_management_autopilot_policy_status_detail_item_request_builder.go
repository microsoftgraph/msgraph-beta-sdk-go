...
type DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilderGetOptions struct {
    ...
    Q *DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
func NewDeviceManagementAutopilotPolicyStatusDetailItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilder) {
...
func NewDeviceManagementAutopilotPolicyStatusDetailItemRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilder) {
...
func (m *DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilder) CreateGetRequestInformation(options *DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
