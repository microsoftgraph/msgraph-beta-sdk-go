...
func (m *CertificateConnectorDetailsCertificateConnectorDetailsItemRequestBuilder) MicrosoftGraphGetHealthMetrics()(*CertificateConnectorDetailsItemMicrosoftGraphGetHealthMetricsRequestBuilder) {
    return NewCertificateConnectorDetailsItemMicrosoftGraphGetHealthMetricsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetHealthMetricTimeSeries provides operations to call the getHealthMetricTimeSeries method.
func (m *CertificateConnectorDetailsCertificateConnectorDetailsItemRequestBuilder) MicrosoftGraphGetHealthMetricTimeSeries()(*CertificateConnectorDetailsItemMicrosoftGraphGetHealthMetricTimeSeriesRequestBuilder) {
    return NewCertificateConnectorDetailsItemMicrosoftGraphGetHealthMetricTimeSeriesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
