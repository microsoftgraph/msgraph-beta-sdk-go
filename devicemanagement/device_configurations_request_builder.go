...
func (m *DeviceConfigurationsRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceConfigurationsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceConfigurationCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceConfigurationCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *DeviceConfigurationsRequestBuilder) MicrosoftGraphGetIosAvailableUpdateVersions()(*DeviceConfigurationsMicrosoftGraphGetIosAvailableUpdateVersionsGetIosAvailableUpdateVersionsRequestBuilder) {
    return NewDeviceConfigurationsMicrosoftGraphGetIosAvailableUpdateVersionsGetIosAvailableUpdateVersionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetTargetedUsersAndDevices provides operations to call the getTargetedUsersAndDevices method.
func (m *DeviceConfigurationsRequestBuilder) MicrosoftGraphGetTargetedUsersAndDevices()(*DeviceConfigurationsMicrosoftGraphGetTargetedUsersAndDevicesGetTargetedUsersAndDevicesRequestBuilder) {
    return NewDeviceConfigurationsMicrosoftGraphGetTargetedUsersAndDevicesGetTargetedUsersAndDevicesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphHasPayloadLinks provides operations to call the hasPayloadLinks method.
func (m *DeviceConfigurationsRequestBuilder) MicrosoftGraphHasPayloadLinks()(*DeviceConfigurationsMicrosoftGraphHasPayloadLinksHasPayloadLinksRequestBuilder) {
    return NewDeviceConfigurationsMicrosoftGraphHasPayloadLinksHasPayloadLinksRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
