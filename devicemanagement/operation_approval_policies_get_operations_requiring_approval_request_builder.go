...
// NewOperationApprovalPoliciesGetOperationsRequiringApprovalRequestBuilderInternal instantiates a new OperationApprovalPoliciesGetOperationsRequiringApprovalRequestBuilder and sets the default values.
func NewOperationApprovalPoliciesGetOperationsRequiringApprovalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OperationApprovalPoliciesGetOperationsRequiringApprovalRequestBuilder) {
    m := &OperationApprovalPoliciesGetOperationsRequiringApprovalRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/operationApprovalPolicies/getOperationsRequiringApproval(){?%24count,%24filter,%24search,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewOperationApprovalPoliciesGetOperationsRequiringApprovalRequestBuilder instantiates a new OperationApprovalPoliciesGetOperationsRequiringApprovalRequestBuilder and sets the default values.
...
// returns a OperationApprovalPoliciesGetOperationsRequiringApprovalResponseable when successful
...
// returns a OperationApprovalPoliciesGetOperationsRequiringApprovalGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
