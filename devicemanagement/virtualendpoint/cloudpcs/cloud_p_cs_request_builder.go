...
// GetWithRequestConfigurationAndResponseHandler cloud managed virtual desktops.
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to cloudPCs for deviceManagement
