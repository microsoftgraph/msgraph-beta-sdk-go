...
// GetSubscriptionsRequestBuilderGetQueryParameters invoke function getSubscriptions
type GetSubscriptionsRequestBuilderGetQueryParameters struct {
...
type GetSubscriptionsRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *GetSubscriptionsRequestBuilderGetQueryParameters
}
...
func (m *GetSubscriptionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GetSubscriptionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
