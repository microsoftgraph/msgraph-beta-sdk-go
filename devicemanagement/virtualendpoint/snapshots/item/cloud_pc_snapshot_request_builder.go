...
// CloudPcSnapshotRequestBuilder builds and executes requests for operations under \deviceManagement\virtualEndpoint\snapshots\{cloudPcSnapshot-id}
type CloudPcSnapshotRequestBuilder struct {
...
// CloudPcSnapshotRequestBuilderDeleteOptions options for Delete
type CloudPcSnapshotRequestBuilderDeleteOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// CloudPcSnapshotRequestBuilderGetOptions options for Get
type CloudPcSnapshotRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
    // Request query parameters
    Q *CloudPcSnapshotRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
// CloudPcSnapshotRequestBuilderPatchOptions options for Patch
type CloudPcSnapshotRequestBuilderPatchOptions struct {
    // 
    Body *i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CloudPcSnapshot;
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
...
// NewCloudPcSnapshotRequestBuilderInternal instantiates a new CloudPcSnapshotRequestBuilder and sets the default values.
func NewCloudPcSnapshotRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CloudPcSnapshotRequestBuilder) {
    m := &CloudPcSnapshotRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/snapshots/{cloudPcSnapshot_id}{?select,expand}";
...
// NewCloudPcSnapshotRequestBuilder instantiates a new CloudPcSnapshotRequestBuilder and sets the default values.
func NewCloudPcSnapshotRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CloudPcSnapshotRequestBuilder) {
