...
func (m *GetTotalAggregatedRemoteConnectionReportsRequestBuilder) CreatePostRequestInformation(body GetTotalAggregatedRemoteConnectionReportsPostRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreatePostRequestInformationWithRequestConfiguration(body, nil);
}
// CreatePostRequestInformationWithRequestConfiguration invoke action getTotalAggregatedRemoteConnectionReports
func (m *GetTotalAggregatedRemoteConnectionReportsRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body GetTotalAggregatedRemoteConnectionReportsPostRequestBodyable, requestConfiguration *GetTotalAggregatedRemoteConnectionReportsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
