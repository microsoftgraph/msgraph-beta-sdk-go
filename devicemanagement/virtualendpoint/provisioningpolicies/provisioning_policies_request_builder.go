...
type ProvisioningPoliciesRequestBuilderGetOptions struct {
    ...
    Q *ProvisioningPoliciesRequestBuilderGetQueryParameters;
...
func (m *ProvisioningPoliciesRequestBuilder) Get(options *ProvisioningPoliciesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CloudPcProvisioningPolicyCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateCloudPcProvisioningPolicyCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CloudPcProvisioningPolicyCollectionResponseable), nil
}
// Post create new navigation property to provisioningPolicies for deviceManagement
func (m *ProvisioningPoliciesRequestBuilder) Post(options *ProvisioningPoliciesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CloudPcProvisioningPolicyable, error) {
