...
// GetSourceImagesRequestBuilderGetQueryParameters invoke function getSourceImages
type GetSourceImagesRequestBuilderGetQueryParameters struct {
...
type GetSourceImagesRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *GetSourceImagesRequestBuilderGetQueryParameters
}
...
func (m *GetSourceImagesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GetSourceImagesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetSourceImagesRequestBuilder) Get(ctx context.Context, requestConfiguration *GetSourceImagesRequestBuilderGetRequestConfiguration)(GetSourceImagesResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGetSourceImagesResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
