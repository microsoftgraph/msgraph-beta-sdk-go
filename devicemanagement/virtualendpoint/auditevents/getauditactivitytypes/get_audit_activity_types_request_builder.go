...
// GetAuditActivityTypesRequestBuilderGetQueryParameters invoke function getAuditActivityTypes
type GetAuditActivityTypesRequestBuilderGetQueryParameters struct {
...
type GetAuditActivityTypesRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *GetAuditActivityTypesRequestBuilderGetQueryParameters
}
...
func (m *GetAuditActivityTypesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GetAuditActivityTypesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetAuditActivityTypesRequestBuilder) Get(ctx context.Context, requestConfiguration *GetAuditActivityTypesRequestBuilderGetRequestConfiguration)(GetAuditActivityTypesResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGetAuditActivityTypesResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
