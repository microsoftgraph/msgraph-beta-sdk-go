...
// ByUserExperienceAnalyticsAppHealthAppPerformanceByOSVersionIdString provides operations to manage the userExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion property of the microsoft.graph.deviceManagement entity.
func (m *UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionRequestBuilder) ByUserExperienceAnalyticsAppHealthAppPerformanceByOSVersionIdString(userExperienceAnalyticsAppHealthAppPerformanceByOSVersionId string)(*UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionUserExperienceAnalyticsAppHealthAppPerformanceByOSVersionItemRequestBuilder) {
