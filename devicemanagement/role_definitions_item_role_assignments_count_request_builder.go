...
func (m *RoleDefinitionsItemRoleAssignmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *RoleDefinitionsItemRoleAssignmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
