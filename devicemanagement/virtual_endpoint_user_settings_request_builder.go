...
// NewVirtualEndpointUserSettingsRequestBuilder instantiates a new UserSettingsRequestBuilder and sets the default values.
...
func (m *VirtualEndpointUserSettingsRequestBuilder) Count()(*VirtualEndpointUserSettingsCountRequestBuilder) {
    return NewVirtualEndpointUserSettingsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation retrieve a list of cloudPcUserSetting objects.
func (m *VirtualEndpointUserSettingsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *VirtualEndpointUserSettingsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
