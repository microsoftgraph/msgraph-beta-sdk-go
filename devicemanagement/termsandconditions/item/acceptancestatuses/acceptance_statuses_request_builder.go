...
func NewAcceptanceStatusesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AcceptanceStatusesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/deviceManagement/termsAndConditions/{termsAndConditions_id}/acceptanceStatuses{?top,skip,search,filter,count,orderby,select,expand}";
...
// Parameters:
//  - options : Options for the request
func (m *AcceptanceStatusesRequestBuilder) Post(options *AcceptanceStatusesRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.TermsAndConditionsAcceptanceStatus, error) {
