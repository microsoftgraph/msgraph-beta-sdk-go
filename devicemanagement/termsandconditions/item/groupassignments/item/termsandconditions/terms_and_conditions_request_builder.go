...
import (
    ...
    icc57832764f49af80644983276c499e8e13299f121c4c788871e2cbf3cfc928e "github.com/microsoftgraph/msgraph-beta-sdk-go/devicemanagement/termsandconditions/item/groupassignments/item/termsandconditions/ref"
)

// TermsAndConditionsRequestBuilder builds and executes requests for operations under \deviceManagement\termsAndConditions\{termsAndConditions-id}\groupAssignments\{termsAndConditionsGroupAssignment-id}\termsAndConditions
...
func NewTermsAndConditionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TermsAndConditionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions_id}/groupAssignments/{termsAndConditionsGroupAssignment_id}/termsAndConditions{?select,expand}";
...
func (m *TermsAndConditionsRequestBuilder) Ref()(*icc57832764f49af80644983276c499e8e13299f121c4c788871e2cbf3cfc928e.RefRequestBuilder) {
    return icc57832764f49af80644983276c499e8e13299f121c4c788871e2cbf3cfc928e.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
