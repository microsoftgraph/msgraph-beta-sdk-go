...
// ManagedDevicesBulkReprovisionCloudPcPostRequestBody provides operations to call the bulkReprovisionCloudPc method.
...
func (m *ManagedDevicesBulkReprovisionCloudPcPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ManagedDevicesBulkReprovisionCloudPcPostRequestBody) SetAdditionalData(value map[string]interface{})() {
