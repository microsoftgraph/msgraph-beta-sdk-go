...
func (m *GetAssignmentFiltersStatusDetailsRequestBuilder) WithUrl(rawUrl string)(*GetAssignmentFiltersStatusDetailsRequestBuilder) {
    return NewGetAssignmentFiltersStatusDetailsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
