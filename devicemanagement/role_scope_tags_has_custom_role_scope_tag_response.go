...
// RoleScopeTagsHasCustomRoleScopeTagResponse provides operations to call the hasCustomRoleScopeTag method.
...
func (m *RoleScopeTagsHasCustomRoleScopeTagResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *RoleScopeTagsHasCustomRoleScopeTagResponse) SetAdditionalData(value map[string]interface{})() {
