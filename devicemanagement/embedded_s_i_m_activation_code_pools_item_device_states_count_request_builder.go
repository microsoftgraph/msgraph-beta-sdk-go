...
func (m *EmbeddedSIMActivationCodePoolsItemDeviceStatesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EmbeddedSIMActivationCodePoolsItemDeviceStatesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
