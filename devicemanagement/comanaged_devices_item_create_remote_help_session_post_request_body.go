...
func (m *ComanagedDevicesItemCreateRemoteHelpSessionPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *ComanagedDevicesItemCreateRemoteHelpSessionPostRequestBody) GetSessionType()(*string) {
    val, err := m.GetBackingStore().Get("sessionType")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ComanagedDevicesItemCreateRemoteHelpSessionPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *ComanagedDevicesItemCreateRemoteHelpSessionPostRequestBody) SetSessionType(value *string)() {
    err := m.GetBackingStore().Set("sessionType", value)
    if err != nil {
        panic(err)
    }
}
// ComanagedDevicesItemCreateRemoteHelpSessionPostRequestBodyable 
type ComanagedDevicesItemCreateRemoteHelpSessionPostRequestBodyable interface {
