...
// ComanagedDevicesItemCreateRemoteHelpSessionPostRequestBody provides operations to call the createRemoteHelpSession method.
...
func (m *ComanagedDevicesItemCreateRemoteHelpSessionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ComanagedDevicesItemCreateRemoteHelpSessionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
