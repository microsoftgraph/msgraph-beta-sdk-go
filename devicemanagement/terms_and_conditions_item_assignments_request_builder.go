...
// ByTermsAndConditionsAssignmentIdString provides operations to manage the assignments property of the microsoft.graph.termsAndConditions entity.
func (m *TermsAndConditionsItemAssignmentsRequestBuilder) ByTermsAndConditionsAssignmentIdString(termsAndConditionsAssignmentId string)(*TermsAndConditionsItemAssignmentsTermsAndConditionsAssignmentItemRequestBuilder) {
