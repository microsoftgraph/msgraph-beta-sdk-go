...
func (m *ZebraFotaConnectorDisconnectRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *ZebraFotaConnectorDisconnectRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ZebraFotaConnectorDisconnectRequestBuilder) Post(ctx context.Context, requestConfiguration *ZebraFotaConnectorDisconnectRequestBuilderPostRequestConfiguration)(ZebraFotaConnectorDisconnectResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateZebraFotaConnectorDisconnectResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
