...
// ByUserPFXCertificateIdString provides operations to manage the userPfxCertificates property of the microsoft.graph.deviceManagement entity.
func (m *UserPfxCertificatesRequestBuilder) ByUserPFXCertificateIdString(userPFXCertificateId string)(*UserPfxCertificatesUserPFXCertificateItemRequestBuilder) {
