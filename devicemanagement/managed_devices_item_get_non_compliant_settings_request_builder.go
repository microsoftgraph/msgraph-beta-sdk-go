...
// NewManagedDevicesItemGetNonCompliantSettingsRequestBuilderInternal instantiates a new ManagedDevicesItemGetNonCompliantSettingsRequestBuilder and sets the default values.
...
// NewManagedDevicesItemGetNonCompliantSettingsRequestBuilder instantiates a new ManagedDevicesItemGetNonCompliantSettingsRequestBuilder and sets the default values.
...
// returns a ManagedDevicesItemGetNonCompliantSettingsResponseable when successful
...
// returns a ManagedDevicesItemGetNonCompliantSettingsGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
