...
// NewIntentsItemCategoriesItemSettingDefinitionsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewIntentsItemCategoriesItemSettingDefinitionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IntentsItemCategoriesItemSettingDefinitionsCountRequestBuilder) {
    m := &IntentsItemCategoriesItemSettingDefinitionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/categories/{deviceManagementIntentSettingCategory%2Did}/settingDefinitions/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewIntentsItemCategoriesItemSettingDefinitionsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
