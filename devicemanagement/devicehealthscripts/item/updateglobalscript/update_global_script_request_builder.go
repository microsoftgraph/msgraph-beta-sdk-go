...
func (m *UpdateGlobalScriptRequestBuilder) CreatePostRequestInformation(ctx context.Context, body UpdateGlobalScriptPostRequestBodyable, requestConfiguration *UpdateGlobalScriptRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UpdateGlobalScriptRequestBuilder) Post(ctx context.Context, body UpdateGlobalScriptPostRequestBodyable, requestConfiguration *UpdateGlobalScriptRequestBuilderPostRequestConfiguration)(UpdateGlobalScriptResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateUpdateGlobalScriptResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
