...
func (m *DeviceConfigurationsItemUserStatusesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceConfigurationsItemUserStatusesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
