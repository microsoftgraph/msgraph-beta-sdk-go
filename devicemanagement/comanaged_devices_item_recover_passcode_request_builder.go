...
// ComanagedDevicesItemRecoverPasscodeRequestBuilder provides operations to call the recoverPasscode method.
type ComanagedDevicesItemRecoverPasscodeRequestBuilder struct {
...
// ComanagedDevicesItemRecoverPasscodeRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ComanagedDevicesItemRecoverPasscodeRequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func (m *ComanagedDevicesItemRecoverPasscodeRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *ComanagedDevicesItemRecoverPasscodeRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
