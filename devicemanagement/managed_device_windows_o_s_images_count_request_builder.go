...
func (m *ManagedDeviceWindowsOSImagesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedDeviceWindowsOSImagesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
