...
func (m *WindowsDriverUpdateProfilesItemDriverInventoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsDriverUpdateProfilesItemDriverInventoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
