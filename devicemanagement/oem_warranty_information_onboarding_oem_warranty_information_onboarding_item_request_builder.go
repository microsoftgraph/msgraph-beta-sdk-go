...
func (m *OemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilder) MicrosoftGraphDisable()(*OemWarrantyInformationOnboardingItemMicrosoftGraphDisableRequestBuilder) {
    return NewOemWarrantyInformationOnboardingItemMicrosoftGraphDisableRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEnable provides operations to call the enable method.
func (m *OemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilder) MicrosoftGraphEnable()(*OemWarrantyInformationOnboardingItemMicrosoftGraphEnableRequestBuilder) {
    return NewOemWarrantyInformationOnboardingItemMicrosoftGraphEnableRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
