...
func NewOemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, oemWarrantyInformationOnboardingId *string)(*OemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilder) {
    ...
    if oemWarrantyInformationOnboardingId != nil {
...
func NewOemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilder) {
    ...
    return NewOemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *OemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilder) MicrosoftGraphDisable()(*OemWarrantyInformationOnboardingItemMicrosoftGraphDisableDisableRequestBuilder) {
    return NewOemWarrantyInformationOnboardingItemMicrosoftGraphDisableDisableRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEnable provides operations to call the enable method.
func (m *OemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilder) MicrosoftGraphEnable()(*OemWarrantyInformationOnboardingItemMicrosoftGraphEnableEnableRequestBuilder) {
    return NewOemWarrantyInformationOnboardingItemMicrosoftGraphEnableEnableRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
