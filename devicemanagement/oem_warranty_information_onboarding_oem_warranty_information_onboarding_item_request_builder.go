...
func (m *OemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *OemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
