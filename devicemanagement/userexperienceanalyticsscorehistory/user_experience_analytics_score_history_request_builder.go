...
import (
    ...
    ia80e1df779dac8351e2660637afeeff1a31d546134cf7e456d73b53ddec67b58 "github.com/microsoftgraph/msgraph-beta-sdk-go/devicemanagement/userexperienceanalyticsscorehistory/count"
)
...
func (m *UserExperienceAnalyticsScoreHistoryRequestBuilder) Get(options *UserExperienceAnalyticsScoreHistoryRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserExperienceAnalyticsScoreHistoryCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateUserExperienceAnalyticsScoreHistoryCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserExperienceAnalyticsScoreHistoryCollectionResponseable), nil
}
// Post create new navigation property to userExperienceAnalyticsScoreHistory for deviceManagement
func (m *UserExperienceAnalyticsScoreHistoryRequestBuilder) Post(options *UserExperienceAnalyticsScoreHistoryRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserExperienceAnalyticsScoreHistoryable, error) {
