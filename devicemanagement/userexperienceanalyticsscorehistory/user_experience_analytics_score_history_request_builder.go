...
// UserExperienceAnalyticsScoreHistoryRequestBuilder builds and executes requests for operations under \deviceManagement\userExperienceAnalyticsScoreHistory
...
type UserExperienceAnalyticsScoreHistoryRequestBuilderGetOptions struct {
    ...
    Q *UserExperienceAnalyticsScoreHistoryRequestBuilderGetQueryParameters;
...
// UserExperienceAnalyticsScoreHistoryRequestBuilderPostOptions options for Post
type UserExperienceAnalyticsScoreHistoryRequestBuilderPostOptions struct {
    // 
...
func NewUserExperienceAnalyticsScoreHistoryRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UserExperienceAnalyticsScoreHistoryRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsScoreHistory{?top,skip,search,filter,count,orderby,select,expand}";
...
// CreatePostRequestInformation user experience analytics device Startup Score History
func (m *UserExperienceAnalyticsScoreHistoryRequestBuilder) CreatePostRequestInformation(options *UserExperienceAnalyticsScoreHistoryRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *UserExperienceAnalyticsScoreHistoryRequestBuilder) Get(options *UserExperienceAnalyticsScoreHistoryRequestBuilderGetOptions)(*UserExperienceAnalyticsScoreHistoryResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewUserExperienceAnalyticsScoreHistoryResponse() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*UserExperienceAnalyticsScoreHistoryResponse), nil
}
// Post user experience analytics device Startup Score History
func (m *UserExperienceAnalyticsScoreHistoryRequestBuilder) Post(options *UserExperienceAnalyticsScoreHistoryRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserExperienceAnalyticsScoreHistory, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewUserExperienceAnalyticsScoreHistory() }, nil)
    if err != nil {
        return nil, err
    }
