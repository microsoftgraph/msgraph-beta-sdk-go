...
// ByGroupPolicyMigrationReportIdString provides operations to manage the groupPolicyMigrationReports property of the microsoft.graph.deviceManagement entity.
func (m *GroupPolicyMigrationReportsRequestBuilder) ByGroupPolicyMigrationReportIdString(groupPolicyMigrationReportId string)(*GroupPolicyMigrationReportsGroupPolicyMigrationReportItemRequestBuilder) {
