...
func (m *GroupPolicyMigrationReportsRequestBuilder) MicrosoftGraphCreateMigrationReport()(*GroupPolicyMigrationReportsMicrosoftGraphCreateMigrationReportCreateMigrationReportRequestBuilder) {
    return NewGroupPolicyMigrationReportsMicrosoftGraphCreateMigrationReportCreateMigrationReportRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
