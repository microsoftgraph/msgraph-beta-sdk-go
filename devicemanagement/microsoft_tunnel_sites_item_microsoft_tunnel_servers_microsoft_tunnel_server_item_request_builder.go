...
func (m *MicrosoftTunnelSitesItemMicrosoftTunnelServersMicrosoftTunnelServerItemRequestBuilder) MicrosoftGraphCreateServerLogCollectionRequest()(*MicrosoftTunnelSitesItemMicrosoftTunnelServersItemMicrosoftGraphCreateServerLogCollectionRequestRequestBuilder) {
    return NewMicrosoftTunnelSitesItemMicrosoftTunnelServersItemMicrosoftGraphCreateServerLogCollectionRequestRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *MicrosoftTunnelSitesItemMicrosoftTunnelServersMicrosoftTunnelServerItemRequestBuilder) MicrosoftGraphGenerateServerLogCollectionRequest()(*MicrosoftTunnelSitesItemMicrosoftTunnelServersItemMicrosoftGraphGenerateServerLogCollectionRequestRequestBuilder) {
    return NewMicrosoftTunnelSitesItemMicrosoftTunnelServersItemMicrosoftGraphGenerateServerLogCollectionRequestRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetHealthMetrics provides operations to call the getHealthMetrics method.
func (m *MicrosoftTunnelSitesItemMicrosoftTunnelServersMicrosoftTunnelServerItemRequestBuilder) MicrosoftGraphGetHealthMetrics()(*MicrosoftTunnelSitesItemMicrosoftTunnelServersItemMicrosoftGraphGetHealthMetricsRequestBuilder) {
    return NewMicrosoftTunnelSitesItemMicrosoftTunnelServersItemMicrosoftGraphGetHealthMetricsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetHealthMetricTimeSeries provides operations to call the getHealthMetricTimeSeries method.
func (m *MicrosoftTunnelSitesItemMicrosoftTunnelServersMicrosoftTunnelServerItemRequestBuilder) MicrosoftGraphGetHealthMetricTimeSeries()(*MicrosoftTunnelSitesItemMicrosoftTunnelServersItemMicrosoftGraphGetHealthMetricTimeSeriesRequestBuilder) {
    return NewMicrosoftTunnelSitesItemMicrosoftTunnelServersItemMicrosoftGraphGetHealthMetricTimeSeriesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
