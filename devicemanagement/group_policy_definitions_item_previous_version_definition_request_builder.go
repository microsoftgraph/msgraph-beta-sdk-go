...
func (m *GroupPolicyDefinitionsItemPreviousVersionDefinitionRequestBuilder) Delete(ctx context.Context, requestConfiguration *GroupPolicyDefinitionsItemPreviousVersionDefinitionRequestBuilderDeleteRequestConfiguration)([]byte, error) {
