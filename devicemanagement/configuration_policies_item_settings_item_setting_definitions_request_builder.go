...
func (m *ConfigurationPoliciesItemSettingsItemSettingDefinitionsRequestBuilder) Count()(*ConfigurationPoliciesItemSettingsItemSettingDefinitionsCountRequestBuilder) {
    return NewConfigurationPoliciesItemSettingsItemSettingDefinitionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list of related Setting Definitions. This property is read-only.
func (m *ConfigurationPoliciesItemSettingsItemSettingDefinitionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ConfigurationPoliciesItemSettingsItemSettingDefinitionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
