...
// NewUserExperienceAnalyticsAnomalyCorrelationGroupOverviewCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewUserExperienceAnalyticsAnomalyCorrelationGroupOverviewCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserExperienceAnalyticsAnomalyCorrelationGroupOverviewCountRequestBuilder) {
    m := &UserExperienceAnalyticsAnomalyCorrelationGroupOverviewCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAnomalyCorrelationGroupOverview/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewUserExperienceAnalyticsAnomalyCorrelationGroupOverviewCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
