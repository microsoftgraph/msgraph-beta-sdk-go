...
func (m *EmbeddedSIMActivationCodePoolsRequestBuilder) Count()(*EmbeddedSIMActivationCodePoolsCountRequestBuilder) {
    return NewEmbeddedSIMActivationCodePoolsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *EmbeddedSIMActivationCodePoolsRequestBuilder) Get(ctx context.Context, requestConfiguration *EmbeddedSIMActivationCodePoolsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.EmbeddedSIMActivationCodePoolCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateEmbeddedSIMActivationCodePoolCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
