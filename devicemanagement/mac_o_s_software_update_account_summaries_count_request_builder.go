...
func (m *MacOSSoftwareUpdateAccountSummariesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MacOSSoftwareUpdateAccountSummariesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
