...
func NewUserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilder) {
    m := &UserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsWorkFromAnywhereMetrics/{userExperienceAnalyticsWorkFromAnywhereMetric%2Did}/metricDevices/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewUserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilder) {
    ...
    return NewUserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *UserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *UserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilder) {
    return NewUserexperienceanalyticsworkfromanywheremetricsItemMetricdevicesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
