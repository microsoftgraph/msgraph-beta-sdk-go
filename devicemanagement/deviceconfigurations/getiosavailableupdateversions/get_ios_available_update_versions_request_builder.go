...
// GetIosAvailableUpdateVersionsRequestBuilderGetQueryParameters invoke function getIosAvailableUpdateVersions
type GetIosAvailableUpdateVersionsRequestBuilderGetQueryParameters struct {
...
type GetIosAvailableUpdateVersionsRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *GetIosAvailableUpdateVersionsRequestBuilderGetQueryParameters
}
...
func (m *GetIosAvailableUpdateVersionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GetIosAvailableUpdateVersionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetIosAvailableUpdateVersionsRequestBuilder) Get(ctx context.Context, requestConfiguration *GetIosAvailableUpdateVersionsRequestBuilderGetRequestConfiguration)(GetIosAvailableUpdateVersionsResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGetIosAvailableUpdateVersionsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
