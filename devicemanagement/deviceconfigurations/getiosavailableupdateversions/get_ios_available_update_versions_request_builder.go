...
func (m *GetIosAvailableUpdateVersionsRequestBuilder) CreateGetRequestInformationWithRequestConfiguration()(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// GetWithResponseHandler invoke function getIosAvailableUpdateVersions
func (m *GetIosAvailableUpdateVersionsRequestBuilder) GetWithResponseHandler(requestConfiguration *GetIosAvailableUpdateVersionsRequestBuilderGetRequestConfiguration)(GetIosAvailableUpdateVersionsResponseable, error) {
    return m.GetWithResponseHandler(requestConfiguration, nil);
}
// GetWithResponseHandler invoke function getIosAvailableUpdateVersions
func (m *GetIosAvailableUpdateVersionsRequestBuilder) GetWithResponseHandler(requestConfiguration *GetIosAvailableUpdateVersionsRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(GetIosAvailableUpdateVersionsResponseable, error) {
