...
type WindowsPrivacyAccessControlsRequestBuilderPostOptions struct {
    // 
    Body WindowsPrivacyAccessControlsRequestBodyable;
    // Request headers
...
func NewWindowsPrivacyAccessControlsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsPrivacyAccessControlsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration_id}/microsoft.graph.windowsPrivacyAccessControls";
...
func (m *WindowsPrivacyAccessControlsRequestBuilder) CreatePostRequestInformation(options *WindowsPrivacyAccessControlsRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
