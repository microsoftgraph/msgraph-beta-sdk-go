...
// AssignedAccessMultiModeProfilesRequestBuilder builds and executes requests for operations under \deviceManagement\deviceConfigurations\{deviceConfiguration-id}\groupAssignments\{deviceConfigurationGroupAssignment-id}\deviceConfiguration\microsoft.graph.assignedAccessMultiModeProfiles
...
type AssignedAccessMultiModeProfilesRequestBuilderPostOptions struct {
    // 
    Body *AssignedAccessMultiModeProfilesRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func NewAssignedAccessMultiModeProfilesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AssignedAccessMultiModeProfilesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration_id}/groupAssignments/{deviceConfigurationGroupAssignment_id}/deviceConfiguration/microsoft.graph.assignedAccessMultiModeProfiles";
