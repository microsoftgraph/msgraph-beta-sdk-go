...
func NewExchangeOnPremisesPolicyConditionalAccessSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExchangeOnPremisesPolicyConditionalAccessSettingsRequestBuilder) {
    m := &ExchangeOnPremisesPolicyConditionalAccessSettingsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/exchangeOnPremisesPolicy/conditionalAccessSettings{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *ExchangeOnPremisesPolicyConditionalAccessSettingsRequestBuilder) Delete(ctx context.Context, requestConfiguration *ExchangeOnPremisesPolicyConditionalAccessSettingsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
