...
// DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilderGetQueryParameters the list of scheduled action per rule for this compliance policy. This is a required property when creating any individual per-platform compliance policies.
...
func (m *DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder) ByDeviceComplianceScheduledActionForRuleId(deviceComplianceScheduledActionForRuleId string)(*DevicecompliancepoliciesItemScheduledactionsforruleDeviceComplianceScheduledActionForRuleItemRequestBuilder) {
...
func NewDevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder) {
    m := &DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder{
...
func NewDevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder) {
    ...
    return NewDevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *DevicecompliancepoliciesItemScheduledactionsforruleCountRequestBuilder when successful
func (m *DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder) Count()(*DevicecompliancepoliciesItemScheduledactionsforruleCountRequestBuilder) {
...
func (m *DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder) Get(ctx context.Context, requestConfiguration *DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceComplianceScheduledActionForRuleCollectionResponseable, error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceComplianceScheduledActionForRuleable, requestConfiguration *DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceComplianceScheduledActionForRuleable, error) {
...
func (m *DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder) WithUrl(rawUrl string)(*DevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder) {
    return NewDevicecompliancepoliciesItemScheduledactionsforruleScheduledActionsForRuleRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
