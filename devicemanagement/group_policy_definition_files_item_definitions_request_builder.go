...
// NewGroupPolicyDefinitionFilesItemDefinitionsRequestBuilderInternal instantiates a new GroupPolicyDefinitionFilesItemDefinitionsRequestBuilder and sets the default values.
func NewGroupPolicyDefinitionFilesItemDefinitionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupPolicyDefinitionFilesItemDefinitionsRequestBuilder) {
    m := &GroupPolicyDefinitionFilesItemDefinitionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitionFiles/{groupPolicyDefinitionFile%2Did}/definitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewGroupPolicyDefinitionFilesItemDefinitionsRequestBuilder instantiates a new GroupPolicyDefinitionFilesItemDefinitionsRequestBuilder and sets the default values.
...
func (m *GroupPolicyDefinitionFilesItemDefinitionsRequestBuilder) WithUrl(rawUrl string)(*GroupPolicyDefinitionFilesItemDefinitionsRequestBuilder) {
    return NewGroupPolicyDefinitionFilesItemDefinitionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
