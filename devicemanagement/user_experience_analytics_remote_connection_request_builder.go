...
func (m *UserExperienceAnalyticsRemoteConnectionRequestBuilder) MicrosoftGraphSummarizeDeviceRemoteConnectionWithSummarizeBy(summarizeBy *string)(*UserExperienceAnalyticsRemoteConnectionMicrosoftGraphSummarizeDeviceRemoteConnectionWithSummarizeBySummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder) {
    return NewUserExperienceAnalyticsRemoteConnectionMicrosoftGraphSummarizeDeviceRemoteConnectionWithSummarizeBySummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilderInternal(m.pathParameters, m.requestAdapter, summarizeBy)
}
