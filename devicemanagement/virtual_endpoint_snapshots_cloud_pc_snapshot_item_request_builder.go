...
func (m *VirtualEndpointSnapshotsCloudPcSnapshotItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *VirtualEndpointSnapshotsCloudPcSnapshotItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
