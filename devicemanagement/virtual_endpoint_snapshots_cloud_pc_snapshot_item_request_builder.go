...
// VirtualEndpointSnapshotsCloudPcSnapshotItemRequestBuilderGetQueryParameters read the properties and relationships of a cloudPcSnapshot object. This API is available in the following national cloud deployments.
...
// NewVirtualEndpointSnapshotsCloudPcSnapshotItemRequestBuilderInternal instantiates a new CloudPcSnapshotItemRequestBuilder and sets the default values.
func NewVirtualEndpointSnapshotsCloudPcSnapshotItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointSnapshotsCloudPcSnapshotItemRequestBuilder) {
    m := &VirtualEndpointSnapshotsCloudPcSnapshotItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/snapshots/{cloudPcSnapshot%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewVirtualEndpointSnapshotsCloudPcSnapshotItemRequestBuilder instantiates a new CloudPcSnapshotItemRequestBuilder and sets the default values.
...
// Get read the properties and relationships of a cloudPcSnapshot object. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation read the properties and relationships of a cloudPcSnapshot object. This API is available in the following national cloud deployments.
