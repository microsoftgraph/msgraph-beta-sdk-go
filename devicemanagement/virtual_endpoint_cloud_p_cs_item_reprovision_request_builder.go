...
// NewVirtualEndpointCloudPCsItemReprovisionRequestBuilderInternal instantiates a new ReprovisionRequestBuilder and sets the default values.
func NewVirtualEndpointCloudPCsItemReprovisionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointCloudPCsItemReprovisionRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/reprovision";
...
// NewVirtualEndpointCloudPCsItemReprovisionRequestBuilder instantiates a new ReprovisionRequestBuilder and sets the default values.
