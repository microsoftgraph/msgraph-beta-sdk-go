...
func (m *ReusablepolicysettingsItemReferencingconfigurationpoliciesDeviceManagementConfigurationPolicyItemRequestBuilder) AssignJustInTimeConfiguration()(*ReusablepolicysettingsItemReferencingconfigurationpoliciesItemAssignjustintimeconfigurationAssignJustInTimeConfigurationRequestBuilder) {
    return NewReusablepolicysettingsItemReferencingconfigurationpoliciesItemAssignjustintimeconfigurationAssignJustInTimeConfigurationRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ReusablepolicysettingsItemReferencingconfigurationpoliciesDeviceManagementConfigurationPolicyItemRequestBuilder) RetrieveJustInTimeConfiguration()(*ReusablepolicysettingsItemReferencingconfigurationpoliciesItemRetrievejustintimeconfigurationRetrieveJustInTimeConfigurationRequestBuilder) {
    return NewReusablepolicysettingsItemReferencingconfigurationpoliciesItemRetrievejustintimeconfigurationRetrieveJustInTimeConfigurationRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
