...
// NewComanagedDevicesItemResizeCloudPcRequestBuilderInternal instantiates a new ComanagedDevicesItemResizeCloudPcRequestBuilder and sets the default values.
...
// NewComanagedDevicesItemResizeCloudPcRequestBuilder instantiates a new ComanagedDevicesItemResizeCloudPcRequestBuilder and sets the default values.
...
func (m *ComanagedDevicesItemResizeCloudPcRequestBuilder) WithUrl(rawUrl string)(*ComanagedDevicesItemResizeCloudPcRequestBuilder) {
    return NewComanagedDevicesItemResizeCloudPcRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
