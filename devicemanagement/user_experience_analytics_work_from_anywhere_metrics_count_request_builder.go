...
func (m *UserExperienceAnalyticsWorkFromAnywhereMetricsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsWorkFromAnywhereMetricsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
