...
func (m *IntentsItemDeviceSettingStateSummariesDeviceManagementIntentDeviceSettingStateSummaryItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *IntentsItemDeviceSettingStateSummariesDeviceManagementIntentDeviceSettingStateSummaryItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
