...
func (m *DeviceHealthScriptsItemAssignmentsRequestBuilder) Count()(*DeviceHealthScriptsItemAssignmentsCountRequestBuilder) {
    return NewDeviceHealthScriptsItemAssignmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the list of group assignments for the device health script
func (m *DeviceHealthScriptsItemAssignmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DeviceHealthScriptsItemAssignmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
