...
func (m *DepOnboardingSettingsItemEnrollmentProfilesEnrollmentProfileItemRequestBuilder) Get(ctx context.Context, requestConfiguration *DepOnboardingSettingsItemEnrollmentProfilesEnrollmentProfileItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.EnrollmentProfileable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateEnrollmentProfileFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *DepOnboardingSettingsItemEnrollmentProfilesEnrollmentProfileItemRequestBuilder) MicrosoftGraphExportMobileConfig()(*DepOnboardingSettingsItemEnrollmentProfilesItemMicrosoftGraphExportMobileConfigRequestBuilder) {
    return NewDepOnboardingSettingsItemEnrollmentProfilesItemMicrosoftGraphExportMobileConfigRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSetDefaultProfile provides operations to call the setDefaultProfile method.
func (m *DepOnboardingSettingsItemEnrollmentProfilesEnrollmentProfileItemRequestBuilder) MicrosoftGraphSetDefaultProfile()(*DepOnboardingSettingsItemEnrollmentProfilesItemMicrosoftGraphSetDefaultProfileRequestBuilder) {
    return NewDepOnboardingSettingsItemEnrollmentProfilesItemMicrosoftGraphSetDefaultProfileRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUpdateDeviceProfileAssignment provides operations to call the updateDeviceProfileAssignment method.
func (m *DepOnboardingSettingsItemEnrollmentProfilesEnrollmentProfileItemRequestBuilder) MicrosoftGraphUpdateDeviceProfileAssignment()(*DepOnboardingSettingsItemEnrollmentProfilesItemMicrosoftGraphUpdateDeviceProfileAssignmentRequestBuilder) {
    return NewDepOnboardingSettingsItemEnrollmentProfilesItemMicrosoftGraphUpdateDeviceProfileAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
