...
// DepOnboardingSettingsItemGetEncryptionPublicKeyResponse provides operations to call the getEncryptionPublicKey method.
...
func (m *DepOnboardingSettingsItemGetEncryptionPublicKeyResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *DepOnboardingSettingsItemGetEncryptionPublicKeyResponse) SetAdditionalData(value map[string]interface{})() {
