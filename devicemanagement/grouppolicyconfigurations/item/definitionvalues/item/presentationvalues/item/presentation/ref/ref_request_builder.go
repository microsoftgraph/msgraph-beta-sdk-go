...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\groupPolicyConfigurations\{groupPolicyConfiguration-id}\definitionValues\{groupPolicyDefinitionValue-id}\presentationValues\{groupPolicyPresentationValue-id}\presentation\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/groupPolicyConfigurations/{groupPolicyConfiguration_id}/definitionValues/{groupPolicyDefinitionValue_id}/presentationValues/{groupPolicyPresentationValue_id}/presentation/$ref";
...
// CreateDeleteRequestInformation the group policy presentation associated with the presentation value.
...
// CreatePutRequestInformation the group policy presentation associated with the presentation value.
...
// Delete the group policy presentation associated with the presentation value.
...
// Put the group policy presentation associated with the presentation value.
