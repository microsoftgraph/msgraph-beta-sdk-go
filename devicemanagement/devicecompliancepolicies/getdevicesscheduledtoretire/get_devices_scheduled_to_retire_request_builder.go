...
// GetDevicesScheduledToRetireRequestBuilderGetQueryParameters invoke function getDevicesScheduledToRetire
type GetDevicesScheduledToRetireRequestBuilderGetQueryParameters struct {
...
type GetDevicesScheduledToRetireRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *GetDevicesScheduledToRetireRequestBuilderGetQueryParameters
}
...
func (m *GetDevicesScheduledToRetireRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GetDevicesScheduledToRetireRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetDevicesScheduledToRetireRequestBuilder) Get(ctx context.Context, requestConfiguration *GetDevicesScheduledToRetireRequestBuilderGetRequestConfiguration)(GetDevicesScheduledToRetireResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGetDevicesScheduledToRetireResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
