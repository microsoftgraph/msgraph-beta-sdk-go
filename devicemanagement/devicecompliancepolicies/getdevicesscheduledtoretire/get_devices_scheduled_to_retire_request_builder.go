...
// Builds and executes requests for operations under \deviceManagement\deviceCompliancePolicies\microsoft.graph.getDevicesScheduledToRetire
...
// Parameters:
//  - options : Options for the request
func (m *GetDevicesScheduledToRetireRequestBuilder) Post(options *GetDevicesScheduledToRetireRequestBuilderPostOptions)([]GetDevicesScheduledToRetire, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGetDevicesScheduledToRetire() }, nil)
    if err != nil {
        return nil, err
    }
