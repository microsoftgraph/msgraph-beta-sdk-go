...
// GetDevicesScheduledToRetireRequestBuilder builds and executes requests for operations under \deviceManagement\deviceCompliancePolicies\microsoft.graph.getDevicesScheduledToRetire
...
func (m *GetDevicesScheduledToRetireRequestBuilder) Post(options *GetDevicesScheduledToRetireRequestBuilderPostOptions)([]GetDevicesScheduledToRetire, error) {
    ...
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGetDevicesScheduledToRetire() }, nil, nil)
    if err != nil {
        return nil, err
    }
