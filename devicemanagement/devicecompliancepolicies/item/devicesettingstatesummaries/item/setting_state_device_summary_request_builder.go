...
// SettingStateDeviceSummaryRequestBuilder builds and executes requests for operations under \deviceManagement\deviceCompliancePolicies\{deviceCompliancePolicy-id}\deviceSettingStateSummaries\{settingStateDeviceSummary-id}
...
type SettingStateDeviceSummaryRequestBuilderGetOptions struct {
    ...
    Q *SettingStateDeviceSummaryRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
// SettingStateDeviceSummaryRequestBuilderGetQueryParameters compliance Setting State Device Summary
...
func NewSettingStateDeviceSummaryRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SettingStateDeviceSummaryRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy_id}/deviceSettingStateSummaries/{settingStateDeviceSummary_id}{?select,expand}";
...
// CreateDeleteRequestInformation compliance Setting State Device Summary
...
// CreatePatchRequestInformation compliance Setting State Device Summary
...
// Delete compliance Setting State Device Summary
...
func (m *SettingStateDeviceSummaryRequestBuilder) Get(options *SettingStateDeviceSummaryRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.SettingStateDeviceSummary, error) {
...
// Patch compliance Setting State Device Summary
