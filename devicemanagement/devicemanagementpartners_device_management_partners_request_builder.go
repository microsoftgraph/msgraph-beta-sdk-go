...
// DevicemanagementpartnersDeviceManagementPartnersRequestBuilderGetQueryParameters the list of Device Management Partners configured by the tenant.
...
func (m *DevicemanagementpartnersDeviceManagementPartnersRequestBuilder) ByDeviceManagementPartnerId(deviceManagementPartnerId string)(*DevicemanagementpartnersDeviceManagementPartnerItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.BaseRequestBuilder.PathParameters {
        urlTplParams[idx] = item
    }
    if deviceManagementPartnerId != "" {
...
func NewDevicemanagementpartnersDeviceManagementPartnersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DevicemanagementpartnersDeviceManagementPartnersRequestBuilder) {
    m := &DevicemanagementpartnersDeviceManagementPartnersRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/deviceManagementPartners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
...
func NewDevicemanagementpartnersDeviceManagementPartnersRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DevicemanagementpartnersDeviceManagementPartnersRequestBuilder) {
    ...
    return NewDevicemanagementpartnersDeviceManagementPartnersRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *DevicemanagementpartnersCountRequestBuilder when successful
func (m *DevicemanagementpartnersDeviceManagementPartnersRequestBuilder) Count()(*DevicemanagementpartnersCountRequestBuilder) {
...
func (m *DevicemanagementpartnersDeviceManagementPartnersRequestBuilder) Get(ctx context.Context, requestConfiguration *DevicemanagementpartnersDeviceManagementPartnersRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementPartnerCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceManagementPartnerCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *DevicemanagementpartnersDeviceManagementPartnersRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementPartnerable, requestConfiguration *DevicemanagementpartnersDeviceManagementPartnersRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementPartnerable, error) {
...
func (m *DevicemanagementpartnersDeviceManagementPartnersRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DevicemanagementpartnersDeviceManagementPartnersRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *DevicemanagementpartnersDeviceManagementPartnersRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementPartnerable, requestConfiguration *DevicemanagementpartnersDeviceManagementPartnersRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DevicemanagementpartnersDeviceManagementPartnersRequestBuilder) WithUrl(rawUrl string)(*DevicemanagementpartnersDeviceManagementPartnersRequestBuilder) {
    return NewDevicemanagementpartnersDeviceManagementPartnersRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
