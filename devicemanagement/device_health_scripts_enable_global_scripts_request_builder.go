...
// NewDeviceHealthScriptsEnableGlobalScriptsRequestBuilderInternal instantiates a new DeviceHealthScriptsEnableGlobalScriptsRequestBuilder and sets the default values.
...
// NewDeviceHealthScriptsEnableGlobalScriptsRequestBuilder instantiates a new DeviceHealthScriptsEnableGlobalScriptsRequestBuilder and sets the default values.
