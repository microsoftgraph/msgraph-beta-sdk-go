...
// NewManagedDevicesItemDetectedAppsRequestBuilderInternal instantiates a new ManagedDevicesItemDetectedAppsRequestBuilder and sets the default values.
func NewManagedDevicesItemDetectedAppsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedDevicesItemDetectedAppsRequestBuilder) {
    m := &ManagedDevicesItemDetectedAppsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/detectedApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewManagedDevicesItemDetectedAppsRequestBuilder instantiates a new ManagedDevicesItemDetectedAppsRequestBuilder and sets the default values.
