...
// VirtualEndpointOnPremisesConnectionsRequestBuilderGetQueryParameters list properties and relationships of the cloudPcOnPremisesConnection objects. This API is supported in the following national cloud deployments.
...
// Get list properties and relationships of the cloudPcOnPremisesConnection objects. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create a new cloudPcOnPremisesConnection object for provisioning Cloud PCs. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation list properties and relationships of the cloudPcOnPremisesConnection objects. This API is supported in the following national cloud deployments.
...
// ToPostRequestInformation create a new cloudPcOnPremisesConnection object for provisioning Cloud PCs. This API is supported in the following national cloud deployments.
