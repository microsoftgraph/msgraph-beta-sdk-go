...
// VirtualEndpointOnPremisesConnectionsRequestBuilderGetQueryParameters list properties and relationships of the cloudPcOnPremisesConnection objects. This API is available in the following national cloud deployments.
...
func NewVirtualEndpointOnPremisesConnectionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointOnPremisesConnectionsRequestBuilder) {
    m := &VirtualEndpointOnPremisesConnectionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/onPremisesConnections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewVirtualEndpointOnPremisesConnectionsRequestBuilder instantiates a new OnPremisesConnectionsRequestBuilder and sets the default values.
...
// Get list properties and relationships of the cloudPcOnPremisesConnection objects. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create a new cloudPcOnPremisesConnection object for provisioning Cloud PCs. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation list properties and relationships of the cloudPcOnPremisesConnection objects. This API is available in the following national cloud deployments.
...
// ToPostRequestInformation create a new cloudPcOnPremisesConnection object for provisioning Cloud PCs. This API is available in the following national cloud deployments.
