...
func (m *UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder) ByUserExperienceAnalyticsDeviceStartupHistoryId(userExperienceAnalyticsDeviceStartupHistoryId string)(*UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryItemRequestBuilder) {
...
func NewUserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder) {
    m := &UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder{
...
func NewUserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder) {
    ...
    return NewUserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *UserexperienceanalyticsdevicestartuphistoryCountRequestBuilder when successful
func (m *UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder) Count()(*UserexperienceanalyticsdevicestartuphistoryCountRequestBuilder) {
...
func (m *UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsDeviceStartupHistoryCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateUserExperienceAnalyticsDeviceStartupHistoryCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsDeviceStartupHistoryable, requestConfiguration *UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsDeviceStartupHistoryable, error) {
...
func (m *UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder) {
    return NewUserexperienceanalyticsdevicestartuphistoryUserExperienceAnalyticsDeviceStartupHistoryRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
