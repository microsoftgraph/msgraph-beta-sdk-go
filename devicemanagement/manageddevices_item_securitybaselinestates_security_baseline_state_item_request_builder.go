...
func (m *ManageddevicesItemSecuritybaselinestatesSecurityBaselineStateItemRequestBuilder) SettingStates()(*ManageddevicesItemSecuritybaselinestatesItemSettingstatesSettingStatesRequestBuilder) {
    return NewManageddevicesItemSecuritybaselinestatesItemSettingstatesSettingStatesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
