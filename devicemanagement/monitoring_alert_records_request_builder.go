...
func (m *MonitoringAlertRecordsRequestBuilder) MicrosoftGraphDeviceManagementGetPortalNotifications()(*MonitoringAlertRecordsMicrosoftGraphDeviceManagementGetPortalNotificationsGetPortalNotificationsRequestBuilder) {
    return NewMonitoringAlertRecordsMicrosoftGraphDeviceManagementGetPortalNotificationsGetPortalNotificationsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
