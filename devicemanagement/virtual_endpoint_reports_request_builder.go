...
func (m *VirtualEndpointReportsRequestBuilder) MicrosoftGraphGetDailyAggregatedRemoteConnectionReports()(*VirtualEndpointReportsMicrosoftGraphGetDailyAggregatedRemoteConnectionReportsRequestBuilder) {
    return NewVirtualEndpointReportsMicrosoftGraphGetDailyAggregatedRemoteConnectionReportsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *VirtualEndpointReportsRequestBuilder) MicrosoftGraphGetRealTimeRemoteConnectionLatencyWithCloudPcId(cloudPcId *string)(*VirtualEndpointReportsMicrosoftGraphGetRealTimeRemoteConnectionLatencyWithCloudPcIdRequestBuilder) {
    return NewVirtualEndpointReportsMicrosoftGraphGetRealTimeRemoteConnectionLatencyWithCloudPcIdRequestBuilderInternal(m.pathParameters, m.requestAdapter, cloudPcId)
}
...
func (m *VirtualEndpointReportsRequestBuilder) MicrosoftGraphGetRealTimeRemoteConnectionStatusWithCloudPcId(cloudPcId *string)(*VirtualEndpointReportsMicrosoftGraphGetRealTimeRemoteConnectionStatusWithCloudPcIdRequestBuilder) {
    return NewVirtualEndpointReportsMicrosoftGraphGetRealTimeRemoteConnectionStatusWithCloudPcIdRequestBuilderInternal(m.pathParameters, m.requestAdapter, cloudPcId)
}
...
func (m *VirtualEndpointReportsRequestBuilder) MicrosoftGraphGetRemoteConnectionHistoricalReports()(*VirtualEndpointReportsMicrosoftGraphGetRemoteConnectionHistoricalReportsRequestBuilder) {
    return NewVirtualEndpointReportsMicrosoftGraphGetRemoteConnectionHistoricalReportsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetSharedUseLicenseUsageReport provides operations to call the getSharedUseLicenseUsageReport method.
func (m *VirtualEndpointReportsRequestBuilder) MicrosoftGraphGetSharedUseLicenseUsageReport()(*VirtualEndpointReportsMicrosoftGraphGetSharedUseLicenseUsageReportRequestBuilder) {
    return NewVirtualEndpointReportsMicrosoftGraphGetSharedUseLicenseUsageReportRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *VirtualEndpointReportsRequestBuilder) MicrosoftGraphGetTotalAggregatedRemoteConnectionReports()(*VirtualEndpointReportsMicrosoftGraphGetTotalAggregatedRemoteConnectionReportsRequestBuilder) {
    return NewVirtualEndpointReportsMicrosoftGraphGetTotalAggregatedRemoteConnectionReportsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
