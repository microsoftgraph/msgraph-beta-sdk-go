...
// NewComanagedDevicesItemEnrollNowActionRequestBuilderInternal instantiates a new ComanagedDevicesItemEnrollNowActionRequestBuilder and sets the default values.
func NewComanagedDevicesItemEnrollNowActionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ComanagedDevicesItemEnrollNowActionRequestBuilder) {
    m := &ComanagedDevicesItemEnrollNowActionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/enrollNowAction", pathParameters),
    }
    return m
}
// NewComanagedDevicesItemEnrollNowActionRequestBuilder instantiates a new ComanagedDevicesItemEnrollNowActionRequestBuilder and sets the default values.
...
func (m *ComanagedDevicesItemEnrollNowActionRequestBuilder) WithUrl(rawUrl string)(*ComanagedDevicesItemEnrollNowActionRequestBuilder) {
    return NewComanagedDevicesItemEnrollNowActionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
