...
// ByNdesConnectorIdString provides operations to manage the ndesConnectors property of the microsoft.graph.deviceManagement entity.
func (m *NdesConnectorsRequestBuilder) ByNdesConnectorIdString(ndesConnectorId string)(*NdesConnectorsNdesConnectorItemRequestBuilder) {
