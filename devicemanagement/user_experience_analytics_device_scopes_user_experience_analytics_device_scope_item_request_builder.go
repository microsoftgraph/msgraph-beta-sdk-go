...
func (m *UserExperienceAnalyticsDeviceScopesUserExperienceAnalyticsDeviceScopeItemRequestBuilder) MicrosoftGraphTriggerDeviceScopeAction()(*UserExperienceAnalyticsDeviceScopesItemMicrosoftGraphTriggerDeviceScopeActionRequestBuilder) {
    return NewUserExperienceAnalyticsDeviceScopesItemMicrosoftGraphTriggerDeviceScopeActionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
