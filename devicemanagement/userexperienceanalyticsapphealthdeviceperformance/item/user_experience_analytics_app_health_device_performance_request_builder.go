...
// UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder builds and executes requests for operations under \deviceManagement\userExperienceAnalyticsAppHealthDevicePerformance\{userExperienceAnalyticsAppHealthDevicePerformance-id}
...
// UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderDeleteOptions options for Delete
type UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderDeleteOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderPatchOptions options for Patch
type UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderPatchOptions struct {
    // 
...
// CreateDeleteRequestInformation user experience analytics appHealth Device Performance
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder) CreateDeleteRequestInformation(options *UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderDeleteOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
// CreatePatchRequestInformation user experience analytics appHealth Device Performance
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder) CreatePatchRequestInformation(options *UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderPatchOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
// Delete user experience analytics appHealth Device Performance
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder) Delete(options *UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderDeleteOptions)(error) {
...
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder) Get(options *UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserExperienceAnalyticsAppHealthDevicePerformance, error) {
...
// Patch user experience analytics appHealth Device Performance
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder) Patch(options *UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderPatchOptions)(error) {
