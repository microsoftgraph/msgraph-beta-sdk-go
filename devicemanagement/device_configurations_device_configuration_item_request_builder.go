...
func (m *DeviceConfigurationsDeviceConfigurationItemRequestBuilder) MicrosoftGraphAssignedAccessMultiModeProfiles()(*DeviceConfigurationsItemMicrosoftGraphAssignedAccessMultiModeProfilesRequestBuilder) {
    return NewDeviceConfigurationsItemMicrosoftGraphAssignedAccessMultiModeProfilesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *DeviceConfigurationsDeviceConfigurationItemRequestBuilder) MicrosoftGraphWindowsPrivacyAccessControls()(*DeviceConfigurationsItemMicrosoftGraphWindowsPrivacyAccessControlsRequestBuilder) {
    return NewDeviceConfigurationsItemMicrosoftGraphWindowsPrivacyAccessControlsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
