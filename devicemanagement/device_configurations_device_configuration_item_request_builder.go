...
// returns a *DeviceConfigurationsItemAssignedAccessMultiModeProfilesRequestBuilder when successful
...
// returns a *DeviceConfigurationsItemGroupAssignmentsRequestBuilder when successful
