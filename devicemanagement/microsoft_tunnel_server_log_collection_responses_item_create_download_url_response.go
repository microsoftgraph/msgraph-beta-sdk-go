...
func (m *MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlResponse) GetAdditionalData()(map[string]any) {
...
func (m *MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlResponse) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetFieldDeserializers the deserialization information for the current model
func (m *MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlResponse) GetValue()(*string) {
...
func (m *MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlResponse) SetAdditionalData(value map[string]any)() {
...
func (m *MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlResponse) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetValue sets the value property value. The value property
func (m *MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlResponse) SetValue(value *string)() {
