...
// MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlResponse provides operations to call the createDownloadUrl method.
...
func (m *MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlResponse) SetAdditionalData(value map[string]interface{})() {
