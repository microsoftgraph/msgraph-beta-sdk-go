...
func (m *TemplatesItemMigratableToItemCategoriesItemRecommendedSettingsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TemplatesItemMigratableToItemCategoriesItemRecommendedSettingsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
