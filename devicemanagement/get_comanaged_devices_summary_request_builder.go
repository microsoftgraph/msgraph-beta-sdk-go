...
func (m *GetComanagedDevicesSummaryRequestBuilder) Get(ctx context.Context, requestConfiguration *GetComanagedDevicesSummaryRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ComanagedDevicesSummaryable, error) {
...
func (m *GetComanagedDevicesSummaryRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GetComanagedDevicesSummaryRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetComanagedDevicesSummaryRequestBuilder) WithUrl(rawUrl string)(*GetComanagedDevicesSummaryRequestBuilder) {
    return NewGetComanagedDevicesSummaryRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
