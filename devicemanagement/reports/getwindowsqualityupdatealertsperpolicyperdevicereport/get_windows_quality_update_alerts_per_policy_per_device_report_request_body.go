...
func (m *GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody) SetSelect_escpaped(value []string)() {
