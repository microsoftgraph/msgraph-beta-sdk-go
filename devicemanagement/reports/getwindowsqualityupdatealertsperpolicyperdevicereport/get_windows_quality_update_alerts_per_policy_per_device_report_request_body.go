...
// GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody provides operations to call the getWindowsQualityUpdateAlertsPerPolicyPerDeviceReport method.
...
// NewGetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody instantiates a new getWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody and sets the default values.
...
// CreateGetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody(), nil
}
...
func (m *GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBody) SetSelect(value []string)() {
    if m != nil {
