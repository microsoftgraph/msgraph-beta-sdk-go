...
func (m *GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action getWindowsQualityUpdateAlertsPerPolicyPerDeviceReport
func (m *GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBuilder) PostWithResponseHandler(body GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBodyable, requestConfiguration *GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportRequestBuilderPostRequestConfiguration)(GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportResponseable, error) {
