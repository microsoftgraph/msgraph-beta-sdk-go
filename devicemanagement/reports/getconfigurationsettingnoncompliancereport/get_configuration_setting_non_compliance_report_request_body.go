...
func (m *GetConfigurationSettingNonComplianceReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigurationSettingNonComplianceReportRequestBody) SetSelect_escpaped(value []string)() {
