...
func (m *GetNoncompliantDevicesAndSettingsReportRequestBuilder) CreatePostRequestInformation(body GetNoncompliantDevicesAndSettingsReportPostRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreatePostRequestInformationWithRequestConfiguration(body, nil);
}
// CreatePostRequestInformationWithRequestConfiguration invoke action getNoncompliantDevicesAndSettingsReport
func (m *GetNoncompliantDevicesAndSettingsReportRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body GetNoncompliantDevicesAndSettingsReportPostRequestBodyable, requestConfiguration *GetNoncompliantDevicesAndSettingsReportRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetNoncompliantDevicesAndSettingsReportRequestBuilder) Post(body GetNoncompliantDevicesAndSettingsReportPostRequestBodyable)([]byte, error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action getNoncompliantDevicesAndSettingsReport
func (m *GetNoncompliantDevicesAndSettingsReportRequestBuilder) PostWithRequestConfigurationAndResponseHandler(body GetNoncompliantDevicesAndSettingsReportPostRequestBodyable, requestConfiguration *GetNoncompliantDevicesAndSettingsReportRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)([]byte, error) {
