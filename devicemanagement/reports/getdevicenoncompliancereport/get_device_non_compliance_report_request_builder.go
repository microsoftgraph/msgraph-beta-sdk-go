...
type GetDeviceNonComplianceReportRequestBuilderPostOptions struct {
    // 
    Body *GetDeviceNonComplianceReportRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
// Parameters:
//  - options : Options for the request
func (m *GetDeviceNonComplianceReportRequestBuilder) Post(options *GetDeviceNonComplianceReportRequestBuilderPostOptions)([]byte, error) {
