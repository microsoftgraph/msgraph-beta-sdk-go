...
// GetWindowsQualityUpdateAlertSummaryReportRequestBuilderPostOptions options for Post
...
func (m *GetWindowsQualityUpdateAlertSummaryReportRequestBuilder) CreatePostRequestInformation(options *GetWindowsQualityUpdateAlertSummaryReportRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetWindowsQualityUpdateAlertSummaryReportRequestBuilder) Post(options *GetWindowsQualityUpdateAlertSummaryReportRequestBuilderPostOptions)(GetWindowsQualityUpdateAlertSummaryReportResponseable, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetWindowsQualityUpdateAlertSummaryReportResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
