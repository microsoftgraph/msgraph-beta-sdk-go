...
func (m *GetWindowsQualityUpdateAlertSummaryReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetWindowsQualityUpdateAlertSummaryReportRequestBody) SetSelect_escpaped(value []string)() {
