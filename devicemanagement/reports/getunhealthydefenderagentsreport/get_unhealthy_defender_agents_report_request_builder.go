...
// CreatePostRequestInformationWithRequestConfiguration invoke action getUnhealthyDefenderAgentsReport
func (m *GetUnhealthyDefenderAgentsReportRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body GetUnhealthyDefenderAgentsReportRequestBodyable, requestConfiguration *GetUnhealthyDefenderAgentsReportRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetUnhealthyDefenderAgentsReportRequestBuilder) PostWithResponseHandler(body GetUnhealthyDefenderAgentsReportRequestBodyable, requestConfiguration *GetUnhealthyDefenderAgentsReportRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(GetUnhealthyDefenderAgentsReportResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetUnhealthyDefenderAgentsReportResponseFromDiscriminatorValue, responseHandler, nil)
    if err != nil {
        return nil, err
    }
