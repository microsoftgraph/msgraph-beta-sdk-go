...
// GetUnhealthyDefenderAgentsReportRequestBody provides operations to call the getUnhealthyDefenderAgentsReport method.
...
// CreateGetUnhealthyDefenderAgentsReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetUnhealthyDefenderAgentsReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetUnhealthyDefenderAgentsReportRequestBody(), nil
}
...
func (m *GetUnhealthyDefenderAgentsReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetUnhealthyDefenderAgentsReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetUnhealthyDefenderAgentsReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetUnhealthyDefenderAgentsReportRequestBody) SetSelect(value []string)() {
    if m != nil {
