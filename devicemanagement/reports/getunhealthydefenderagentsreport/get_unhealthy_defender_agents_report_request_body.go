...
func (m *GetUnhealthyDefenderAgentsReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetUnhealthyDefenderAgentsReportRequestBody) SetSelect_escpaped(value []string)() {
