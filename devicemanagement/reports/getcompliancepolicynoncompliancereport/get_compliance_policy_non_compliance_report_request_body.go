...
func (m *GetCompliancePolicyNonComplianceReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetCompliancePolicyNonComplianceReportRequestBody) SetSelect_escpaped(value []string)() {
