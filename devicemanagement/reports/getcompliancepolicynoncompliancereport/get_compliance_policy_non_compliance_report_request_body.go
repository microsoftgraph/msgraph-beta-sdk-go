...
func (m *GetCompliancePolicyNonComplianceReportRequestBody) GetSelect_escaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetCompliancePolicyNonComplianceReportRequestBody) SetSelect_escaped(value []string)() {
