...
// GetConfigurationPolicyNonComplianceReportRequestBody provides operations to call the getConfigurationPolicyNonComplianceReport method.
...
// CreateGetConfigurationPolicyNonComplianceReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetConfigurationPolicyNonComplianceReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetConfigurationPolicyNonComplianceReportRequestBody(), nil
}
...
func (m *GetConfigurationPolicyNonComplianceReportRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetConfigurationPolicyNonComplianceReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigurationPolicyNonComplianceReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetConfigurationPolicyNonComplianceReportRequestBody) SetSelect(value []string)() {
    if m != nil {
