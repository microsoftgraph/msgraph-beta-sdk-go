...
func (m *GetConfigurationPolicyNonComplianceReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigurationPolicyNonComplianceReportRequestBody) SetSelect_escpaped(value []string)() {
