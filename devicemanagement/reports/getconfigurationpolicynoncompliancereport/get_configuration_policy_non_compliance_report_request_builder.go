...
func (m *GetConfigurationPolicyNonComplianceReportRequestBuilder) Post(ctx context.Context, body GetConfigurationPolicyNonComplianceReportPostRequestBodyable, requestConfiguration *GetConfigurationPolicyNonComplianceReportRequestBuilderPostRequestConfiguration)([]byte, error) {
