...
// GetUserInstallStatusReportRequestBody provides operations to call the getUserInstallStatusReport method.
...
// NewGetUserInstallStatusReportRequestBody instantiates a new getUserInstallStatusReportRequestBody and sets the default values.
...
// CreateGetUserInstallStatusReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetUserInstallStatusReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetUserInstallStatusReportRequestBody(), nil
}
...
func (m *GetUserInstallStatusReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetUserInstallStatusReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetUserInstallStatusReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetUserInstallStatusReportRequestBody) SetSelect(value []string)() {
    if m != nil {
