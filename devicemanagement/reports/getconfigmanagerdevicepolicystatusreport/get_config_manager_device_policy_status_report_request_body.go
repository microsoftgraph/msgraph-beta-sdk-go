...
func (m *GetConfigManagerDevicePolicyStatusReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigManagerDevicePolicyStatusReportRequestBody) SetSelect_escpaped(value []string)() {
