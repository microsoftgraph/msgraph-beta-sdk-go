...
func (m *GetConfigManagerDevicePolicyStatusReportRequestBuilder) Post(ctx context.Context, body GetConfigManagerDevicePolicyStatusReportPostRequestBodyable, requestConfiguration *GetConfigManagerDevicePolicyStatusReportRequestBuilderPostRequestConfiguration)([]byte, error) {
