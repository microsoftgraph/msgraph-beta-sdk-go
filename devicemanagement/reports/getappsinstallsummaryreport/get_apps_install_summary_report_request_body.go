...
// GetAppsInstallSummaryReportRequestBody provides operations to call the getAppsInstallSummaryReport method.
...
// NewGetAppsInstallSummaryReportRequestBody instantiates a new getAppsInstallSummaryReportRequestBody and sets the default values.
...
// CreateGetAppsInstallSummaryReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetAppsInstallSummaryReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetAppsInstallSummaryReportRequestBody(), nil
}
...
func (m *GetAppsInstallSummaryReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetAppsInstallSummaryReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetAppsInstallSummaryReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetAppsInstallSummaryReportRequestBody) SetSelect(value []string)() {
    if m != nil {
