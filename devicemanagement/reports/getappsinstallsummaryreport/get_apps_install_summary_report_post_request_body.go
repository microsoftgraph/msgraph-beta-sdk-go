...
// GetAppsInstallSummaryReportPostRequestBody provides operations to call the getAppsInstallSummaryReport method.
type GetAppsInstallSummaryReportPostRequestBody struct {
...
// NewGetAppsInstallSummaryReportPostRequestBody instantiates a new getAppsInstallSummaryReportPostRequestBody and sets the default values.
func NewGetAppsInstallSummaryReportPostRequestBody()(*GetAppsInstallSummaryReportPostRequestBody) {
    m := &GetAppsInstallSummaryReportPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]interface{}));
    return m
}
// CreateGetAppsInstallSummaryReportPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetAppsInstallSummaryReportPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetAppsInstallSummaryReportPostRequestBody(), nil
}
