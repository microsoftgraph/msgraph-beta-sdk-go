...
func (m *GetDeviceManagementIntentSettingsReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetDeviceManagementIntentSettingsReportRequestBody) SetSelect_escpaped(value []string)() {
