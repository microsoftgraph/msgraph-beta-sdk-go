...
// GetConfigurationSettingDetailsReportRequestBody provides operations to call the getConfigurationSettingDetailsReport method.
...
// NewGetConfigurationSettingDetailsReportRequestBody instantiates a new getConfigurationSettingDetailsReportRequestBody and sets the default values.
...
// CreateGetConfigurationSettingDetailsReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetConfigurationSettingDetailsReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetConfigurationSettingDetailsReportRequestBody(), nil
}
...
func (m *GetConfigurationSettingDetailsReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetConfigurationSettingDetailsReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigurationSettingDetailsReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetConfigurationSettingDetailsReportRequestBody) SetSelect(value []string)() {
    if m != nil {
