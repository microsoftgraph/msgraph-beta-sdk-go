...
// GetConfigurationSettingDetailsReportRequestBody 
...
func (m *GetConfigurationSettingDetailsReportRequestBody) GetSelect_escaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigurationSettingDetailsReportRequestBody) SetSelect_escaped(value []string)() {
