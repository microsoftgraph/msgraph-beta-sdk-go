...
func (m *GetConfigurationPolicyNonComplianceSummaryReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigurationPolicyNonComplianceSummaryReportRequestBody) SetSelect_escpaped(value []string)() {
