...
func (m *GetConfigurationPoliciesReportForDeviceRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigurationPoliciesReportForDeviceRequestBody) SetSelect_escpaped(value []string)() {
