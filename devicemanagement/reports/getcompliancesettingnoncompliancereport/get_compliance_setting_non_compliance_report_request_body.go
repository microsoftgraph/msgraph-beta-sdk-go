...
func (m *GetComplianceSettingNonComplianceReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetComplianceSettingNonComplianceReportRequestBody) SetSelect_escpaped(value []string)() {
