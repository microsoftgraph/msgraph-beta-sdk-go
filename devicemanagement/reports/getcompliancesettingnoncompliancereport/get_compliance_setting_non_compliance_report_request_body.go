...
// GetComplianceSettingNonComplianceReportRequestBody provides operations to call the getComplianceSettingNonComplianceReport method.
...
// NewGetComplianceSettingNonComplianceReportRequestBody instantiates a new getComplianceSettingNonComplianceReportRequestBody and sets the default values.
...
// CreateGetComplianceSettingNonComplianceReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetComplianceSettingNonComplianceReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetComplianceSettingNonComplianceReportRequestBody(), nil
}
...
func (m *GetComplianceSettingNonComplianceReportRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetComplianceSettingNonComplianceReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetComplianceSettingNonComplianceReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetComplianceSettingNonComplianceReportRequestBody) SetSelect(value []string)() {
    if m != nil {
