...
// GetRemoteAssistanceSessionsReportRequestBody provides operations to call the getRemoteAssistanceSessionsReport method.
...
// NewGetRemoteAssistanceSessionsReportRequestBody instantiates a new getRemoteAssistanceSessionsReportRequestBody and sets the default values.
...
// CreateGetRemoteAssistanceSessionsReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetRemoteAssistanceSessionsReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetRemoteAssistanceSessionsReportRequestBody(), nil
}
...
func (m *GetRemoteAssistanceSessionsReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetRemoteAssistanceSessionsReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetRemoteAssistanceSessionsReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetRemoteAssistanceSessionsReportRequestBody) SetSelect(value []string)() {
    if m != nil {
