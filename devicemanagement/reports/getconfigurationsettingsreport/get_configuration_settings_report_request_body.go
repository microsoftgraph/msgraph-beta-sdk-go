...
func (m *GetConfigurationSettingsReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigurationSettingsReportRequestBody) SetSelect_escpaped(value []string)() {
