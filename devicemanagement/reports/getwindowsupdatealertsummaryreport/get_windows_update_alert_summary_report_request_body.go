...
// GetWindowsUpdateAlertSummaryReportRequestBody provides operations to call the getWindowsUpdateAlertSummaryReport method.
...
// NewGetWindowsUpdateAlertSummaryReportRequestBody instantiates a new getWindowsUpdateAlertSummaryReportRequestBody and sets the default values.
...
// CreateGetWindowsUpdateAlertSummaryReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetWindowsUpdateAlertSummaryReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetWindowsUpdateAlertSummaryReportRequestBody(), nil
}
...
func (m *GetWindowsUpdateAlertSummaryReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetWindowsUpdateAlertSummaryReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetWindowsUpdateAlertSummaryReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetWindowsUpdateAlertSummaryReportRequestBody) SetSelect(value []string)() {
    if m != nil {
