...
func (m *GetWindowsUpdateAlertSummaryReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetWindowsUpdateAlertSummaryReportRequestBody) SetSelect_escpaped(value []string)() {
