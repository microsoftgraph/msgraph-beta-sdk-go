...
// Builds and executes requests for operations under \deviceManagement\reports\microsoft.graph.getWindowsUpdateAlertsPerPolicyPerDeviceReport
...
type GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilderPostOptions struct {
    // 
    Body *GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func NewGetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/deviceManagement/reports/microsoft.graph.getWindowsUpdateAlertsPerPolicyPerDeviceReport";
...
// Parameters:
//  - options : Options for the request
func (m *GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilder) Post(options *GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBuilderPostOptions)([]byte, error) {
