...
func (m *GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody) SetSelect_escpaped(value []string)() {
