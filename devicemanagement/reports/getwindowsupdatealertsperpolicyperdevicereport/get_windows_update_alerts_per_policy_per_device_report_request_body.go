...
// Instantiates a new getWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody and sets the default values.
...
func (m *GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody) GetSelect_escaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody) IsNil()(bool) {
    return m == nil
}
// Serializes information the current object
// Parameters:
//  - writer : Serialization writer to use to serialize this model
func (m *GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
...
func (m *GetWindowsUpdateAlertsPerPolicyPerDeviceReportRequestBody) SetSelect_escaped(value []string)() {
