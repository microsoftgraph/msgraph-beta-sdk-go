...
// getConfigurationPolicyDeviceSummaryReportRequestBody 
...
func (m *GetConfigurationPolicyDeviceSummaryReportRequestBody) GetSelect_escaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigurationPolicyDeviceSummaryReportRequestBody) SetSelect_escaped(value []string)() {
