...
// GetConfigurationPolicyDeviceSummaryReportRequestBody provides operations to call the getConfigurationPolicyDeviceSummaryReport method.
...
// NewGetConfigurationPolicyDeviceSummaryReportRequestBody instantiates a new getConfigurationPolicyDeviceSummaryReportRequestBody and sets the default values.
...
// CreateGetConfigurationPolicyDeviceSummaryReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetConfigurationPolicyDeviceSummaryReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetConfigurationPolicyDeviceSummaryReportRequestBody(), nil
}
...
func (m *GetConfigurationPolicyDeviceSummaryReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetConfigurationPolicyDeviceSummaryReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetConfigurationPolicyDeviceSummaryReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetConfigurationPolicyDeviceSummaryReportRequestBody) SetSelect(value []string)() {
    if m != nil {
