...
// GetFailedMobileAppsReportRequestBody provides operations to call the getFailedMobileAppsReport method.
...
// NewGetFailedMobileAppsReportRequestBody instantiates a new getFailedMobileAppsReportRequestBody and sets the default values.
...
// CreateGetFailedMobileAppsReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetFailedMobileAppsReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetFailedMobileAppsReportRequestBody(), nil
}
...
func (m *GetFailedMobileAppsReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetFailedMobileAppsReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetFailedMobileAppsReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetFailedMobileAppsReportRequestBody) SetSelect(value []string)() {
    if m != nil {
