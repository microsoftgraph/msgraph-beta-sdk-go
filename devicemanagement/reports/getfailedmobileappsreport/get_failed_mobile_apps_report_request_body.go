...
// GetFailedMobileAppsReportRequestBody 
...
func (m *GetFailedMobileAppsReportRequestBody) GetSelect_escaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetFailedMobileAppsReportRequestBody) SetSelect_escaped(value []string)() {
    if m != nil {
