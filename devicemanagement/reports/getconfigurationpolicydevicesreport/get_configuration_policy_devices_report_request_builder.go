...
func (m *GetConfigurationPolicyDevicesReportRequestBuilder) Post(ctx context.Context, body GetConfigurationPolicyDevicesReportPostRequestBodyable, requestConfiguration *GetConfigurationPolicyDevicesReportRequestBuilderPostRequestConfiguration)([]byte, error) {
