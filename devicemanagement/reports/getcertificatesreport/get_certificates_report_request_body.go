...
// GetCertificatesReportRequestBody 
...
func (m *GetCertificatesReportRequestBody) GetSelect_escaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetCertificatesReportRequestBody) SetSelect_escaped(value []string)() {
    if m != nil {
