...
// CreatePostRequestInformationWithRequestConfiguration invoke action getAllCertificatesReport
func (m *GetAllCertificatesReportRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body GetAllCertificatesReportRequestBodyable, requestConfiguration *GetAllCertificatesReportRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetAllCertificatesReportRequestBuilder) PostWithResponseHandler(body GetAllCertificatesReportRequestBodyable, requestConfiguration *GetAllCertificatesReportRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(GetAllCertificatesReportResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateGetAllCertificatesReportResponseFromDiscriminatorValue, responseHandler, nil)
    if err != nil {
        return nil, err
    }
