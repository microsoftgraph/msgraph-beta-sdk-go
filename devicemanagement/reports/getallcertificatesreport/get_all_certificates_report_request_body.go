...
// GetAllCertificatesReportRequestBody 
...
func (m *GetAllCertificatesReportRequestBody) GetSelect_escaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetAllCertificatesReportRequestBody) SetSelect_escaped(value []string)() {
    if m != nil {
