...
// GetAllCertificatesReportRequestBody provides operations to call the getAllCertificatesReport method.
...
// NewGetAllCertificatesReportRequestBody instantiates a new getAllCertificatesReportRequestBody and sets the default values.
...
// CreateGetAllCertificatesReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetAllCertificatesReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetAllCertificatesReportRequestBody(), nil
}
...
func (m *GetAllCertificatesReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetAllCertificatesReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetAllCertificatesReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetAllCertificatesReportRequestBody) SetSelect(value []string)() {
    if m != nil {
