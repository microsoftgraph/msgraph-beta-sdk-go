...
func (m *GetDeviceInstallStatusReportRequestBuilder) Post(body GetDeviceInstallStatusReportPostRequestBodyable)([]byte, error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action getDeviceInstallStatusReport
func (m *GetDeviceInstallStatusReportRequestBuilder) PostWithRequestConfigurationAndResponseHandler(body GetDeviceInstallStatusReportPostRequestBodyable, requestConfiguration *GetDeviceInstallStatusReportRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)([]byte, error) {
