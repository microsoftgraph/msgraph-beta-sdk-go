...
func (m *GetDeviceInstallStatusReportRequestBuilder) CreatePostRequestInformation(body GetDeviceInstallStatusReportRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetDeviceInstallStatusReportRequestBuilder) Post(body GetDeviceInstallStatusReportRequestBodyable)(GetDeviceInstallStatusReportResponseable, error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action getDeviceInstallStatusReport
func (m *GetDeviceInstallStatusReportRequestBuilder) PostWithRequestConfigurationAndResponseHandler(body GetDeviceInstallStatusReportRequestBodyable, requestConfiguration *GetDeviceInstallStatusReportRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(GetDeviceInstallStatusReportResponseable, error) {
