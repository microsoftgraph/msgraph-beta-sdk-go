...
func (m *GetDeviceInstallStatusReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetDeviceInstallStatusReportRequestBody) SetSelect_escpaped(value []string)() {
