...
// CreateGetCompliancePolicyNonComplianceSummaryReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetCompliancePolicyNonComplianceSummaryReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetCompliancePolicyNonComplianceSummaryReportRequestBody(), nil
}
...
func (m *GetCompliancePolicyNonComplianceSummaryReportRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetCompliancePolicyNonComplianceSummaryReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetCompliancePolicyNonComplianceSummaryReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetCompliancePolicyNonComplianceSummaryReportRequestBody) SetSelect(value []string)() {
    if m != nil {
