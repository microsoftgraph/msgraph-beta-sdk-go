...
func (m *GetCompliancePolicyNonComplianceSummaryReportRequestBody) GetSelect_escpaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetCompliancePolicyNonComplianceSummaryReportRequestBody) SetSelect_escpaped(value []string)() {
