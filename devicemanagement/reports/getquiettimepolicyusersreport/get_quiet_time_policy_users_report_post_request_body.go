...
// GetQuietTimePolicyUsersReportPostRequestBody provides operations to call the getQuietTimePolicyUsersReport method.
type GetQuietTimePolicyUsersReportPostRequestBody struct {
...
// NewGetQuietTimePolicyUsersReportPostRequestBody instantiates a new getQuietTimePolicyUsersReportPostRequestBody and sets the default values.
func NewGetQuietTimePolicyUsersReportPostRequestBody()(*GetQuietTimePolicyUsersReportPostRequestBody) {
    m := &GetQuietTimePolicyUsersReportPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]interface{}));
    return m
}
// CreateGetQuietTimePolicyUsersReportPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetQuietTimePolicyUsersReportPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetQuietTimePolicyUsersReportPostRequestBody(), nil
}
...
func (m *GetQuietTimePolicyUsersReportPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["skipToken"] = i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.SetStringValue(m.SetSkipToken)
