...
func (m *GetCompliancePoliciesReportForDeviceRequestBuilder) Post(body GetCompliancePoliciesReportForDevicePostRequestBodyable)([]byte, error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action getCompliancePoliciesReportForDevice
func (m *GetCompliancePoliciesReportForDeviceRequestBuilder) PostWithRequestConfigurationAndResponseHandler(body GetCompliancePoliciesReportForDevicePostRequestBodyable, requestConfiguration *GetCompliancePoliciesReportForDeviceRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)([]byte, error) {
