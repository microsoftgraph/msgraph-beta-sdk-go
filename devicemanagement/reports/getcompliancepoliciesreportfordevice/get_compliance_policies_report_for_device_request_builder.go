...
func (m *GetCompliancePoliciesReportForDeviceRequestBuilder) Post(ctx context.Context, body GetCompliancePoliciesReportForDevicePostRequestBodyable, requestConfiguration *GetCompliancePoliciesReportForDeviceRequestBuilderPostRequestConfiguration)([]byte, error) {
