...
func (m *GetUnhealthyFirewallReportRequestBuilder) Post(ctx context.Context, body GetUnhealthyFirewallReportPostRequestBodyable, requestConfiguration *GetUnhealthyFirewallReportRequestBuilderPostRequestConfiguration)([]byte, error) {
