...
// GetAppStatusOverviewReportRequestBody provides operations to call the getAppStatusOverviewReport method.
...
// NewGetAppStatusOverviewReportRequestBody instantiates a new getAppStatusOverviewReportRequestBody and sets the default values.
...
// CreateGetAppStatusOverviewReportRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateGetAppStatusOverviewReportRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetAppStatusOverviewReportRequestBody(), nil
}
...
func (m *GetAppStatusOverviewReportRequestBody) GetFieldDeserializers()(map[string]func(interface{}, i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetAppStatusOverviewReportRequestBody) GetSelect()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetAppStatusOverviewReportRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GetAppStatusOverviewReportRequestBody) SetSelect(value []string)() {
    if m != nil {
