...
// GetAppStatusOverviewReportRequestBody 
...
func (m *GetAppStatusOverviewReportRequestBody) GetSelect_escaped()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *GetAppStatusOverviewReportRequestBody) SetSelect_escaped(value []string)() {
    if m != nil {
