...
// NewReportsCachedReportConfigurationsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewReportsCachedReportConfigurationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ReportsCachedReportConfigurationsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/reports/cachedReportConfigurations/$count";
...
// NewReportsCachedReportConfigurationsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
...
func (m *ReportsCachedReportConfigurationsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ReportsCachedReportConfigurationsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
