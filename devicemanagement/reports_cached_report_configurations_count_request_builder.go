...
func (m *ReportsCachedReportConfigurationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ReportsCachedReportConfigurationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
