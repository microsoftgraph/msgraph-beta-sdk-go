...
func (m *ChromeosonboardingsettingsConnectPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *ChromeosonboardingsettingsConnectPostRequestBody) GetOwnerAccessToken()(*string) {
    val, err := m.GetBackingStore().Get("ownerAccessToken")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ChromeosonboardingsettingsConnectPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *ChromeosonboardingsettingsConnectPostRequestBody) SetOwnerAccessToken(value *string)() {
    err := m.GetBackingStore().Set("ownerAccessToken", value)
    if err != nil {
        panic(err)
    }
}
...
type ChromeosonboardingsettingsConnectPostRequestBodyable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackedModel
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetOwnerAccessToken()(*string)
    GetOwnerUserPrincipalName()(*string)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetOwnerAccessToken(value *string)()
