...
func (m *WindowsAutopilotDeploymentProfilesItemAssignedDevicesWindowsAutopilotDeviceIdentityItemRequestBuilder) MicrosoftGraphAssignResourceAccountToDevice()(*WindowsAutopilotDeploymentProfilesItemAssignedDevicesItemMicrosoftGraphAssignResourceAccountToDeviceRequestBuilder) {
    return NewWindowsAutopilotDeploymentProfilesItemAssignedDevicesItemMicrosoftGraphAssignResourceAccountToDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphAssignUserToDevice provides operations to call the assignUserToDevice method.
func (m *WindowsAutopilotDeploymentProfilesItemAssignedDevicesWindowsAutopilotDeviceIdentityItemRequestBuilder) MicrosoftGraphAssignUserToDevice()(*WindowsAutopilotDeploymentProfilesItemAssignedDevicesItemMicrosoftGraphAssignUserToDeviceRequestBuilder) {
    return NewWindowsAutopilotDeploymentProfilesItemAssignedDevicesItemMicrosoftGraphAssignUserToDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnassignResourceAccountFromDevice provides operations to call the unassignResourceAccountFromDevice method.
func (m *WindowsAutopilotDeploymentProfilesItemAssignedDevicesWindowsAutopilotDeviceIdentityItemRequestBuilder) MicrosoftGraphUnassignResourceAccountFromDevice()(*WindowsAutopilotDeploymentProfilesItemAssignedDevicesItemMicrosoftGraphUnassignResourceAccountFromDeviceRequestBuilder) {
    return NewWindowsAutopilotDeploymentProfilesItemAssignedDevicesItemMicrosoftGraphUnassignResourceAccountFromDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnassignUserFromDevice provides operations to call the unassignUserFromDevice method.
func (m *WindowsAutopilotDeploymentProfilesItemAssignedDevicesWindowsAutopilotDeviceIdentityItemRequestBuilder) MicrosoftGraphUnassignUserFromDevice()(*WindowsAutopilotDeploymentProfilesItemAssignedDevicesItemMicrosoftGraphUnassignUserFromDeviceRequestBuilder) {
    return NewWindowsAutopilotDeploymentProfilesItemAssignedDevicesItemMicrosoftGraphUnassignUserFromDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUpdateDeviceProperties provides operations to call the updateDeviceProperties method.
func (m *WindowsAutopilotDeploymentProfilesItemAssignedDevicesWindowsAutopilotDeviceIdentityItemRequestBuilder) MicrosoftGraphUpdateDeviceProperties()(*WindowsAutopilotDeploymentProfilesItemAssignedDevicesItemMicrosoftGraphUpdateDevicePropertiesRequestBuilder) {
    return NewWindowsAutopilotDeploymentProfilesItemAssignedDevicesItemMicrosoftGraphUpdateDevicePropertiesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
