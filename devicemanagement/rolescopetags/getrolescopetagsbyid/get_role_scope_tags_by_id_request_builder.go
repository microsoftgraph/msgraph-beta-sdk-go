...
func (m *GetRoleScopeTagsByIdRequestBuilder) Post(ctx context.Context, body GetRoleScopeTagsByIdPostRequestBodyable, requestConfiguration *GetRoleScopeTagsByIdRequestBuilderPostRequestConfiguration)(GetRoleScopeTagsByIdResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGetRoleScopeTagsByIdResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
