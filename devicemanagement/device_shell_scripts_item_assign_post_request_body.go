...
// DeviceShellScriptsItemAssignPostRequestBody provides operations to call the assign method.
...
func (m *DeviceShellScriptsItemAssignPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *DeviceShellScriptsItemAssignPostRequestBody) SetAdditionalData(value map[string]interface{})() {
