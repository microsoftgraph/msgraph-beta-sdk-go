...
// NewManagedDevicesItemActivateDeviceEsimRequestBuilderInternal instantiates a new ManagedDevicesItemActivateDeviceEsimRequestBuilder and sets the default values.
...
// NewManagedDevicesItemActivateDeviceEsimRequestBuilder instantiates a new ManagedDevicesItemActivateDeviceEsimRequestBuilder and sets the default values.
...
func (m *ManagedDevicesItemActivateDeviceEsimRequestBuilder) WithUrl(rawUrl string)(*ManagedDevicesItemActivateDeviceEsimRequestBuilder) {
    return NewManagedDevicesItemActivateDeviceEsimRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
