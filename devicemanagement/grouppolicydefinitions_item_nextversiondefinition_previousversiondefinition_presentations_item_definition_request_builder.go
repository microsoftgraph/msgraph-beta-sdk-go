...
// NewGrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsItemDefinitionRequestBuilderInternal instantiates a new GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsItemDefinitionRequestBuilder and sets the default values.
...
// NewGrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsItemDefinitionRequestBuilder instantiates a new GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsItemDefinitionRequestBuilder and sets the default values.
