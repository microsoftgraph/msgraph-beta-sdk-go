...
// NewDeviceCompliancePoliciesGetNoncompliantDevicesToRetireRequestBuilderInternal instantiates a new DeviceCompliancePoliciesGetNoncompliantDevicesToRetireRequestBuilder and sets the default values.
...
// NewDeviceCompliancePoliciesGetNoncompliantDevicesToRetireRequestBuilder instantiates a new DeviceCompliancePoliciesGetNoncompliantDevicesToRetireRequestBuilder and sets the default values.
...
func (m *DeviceCompliancePoliciesGetNoncompliantDevicesToRetireRequestBuilder) WithUrl(rawUrl string)(*DeviceCompliancePoliciesGetNoncompliantDevicesToRetireRequestBuilder) {
    return NewDeviceCompliancePoliciesGetNoncompliantDevicesToRetireRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
