...
// NewCertificateConnectorDetailsItemGetHealthMetricsRequestBuilderInternal instantiates a new CertificateConnectorDetailsItemGetHealthMetricsRequestBuilder and sets the default values.
...
// NewCertificateConnectorDetailsItemGetHealthMetricsRequestBuilder instantiates a new CertificateConnectorDetailsItemGetHealthMetricsRequestBuilder and sets the default values.
...
// returns a CertificateConnectorDetailsItemGetHealthMetricsResponseable when successful
...
// returns a CertificateConnectorDetailsItemGetHealthMetricsPostResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
