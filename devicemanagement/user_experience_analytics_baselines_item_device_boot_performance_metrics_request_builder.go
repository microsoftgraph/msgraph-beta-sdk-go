...
// UserExperienceAnalyticsBaselinesItemDeviceBootPerformanceMetricsRequestBuilderGetQueryParameters the user experience analytics device boot performance metrics.
...
func NewUserExperienceAnalyticsBaselinesItemDeviceBootPerformanceMetricsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserExperienceAnalyticsBaselinesItemDeviceBootPerformanceMetricsRequestBuilder) {
    m := &UserExperienceAnalyticsBaselinesItemDeviceBootPerformanceMetricsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline%2Did}/deviceBootPerformanceMetrics{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
// ToGetRequestInformation the user experience analytics device boot performance metrics.
