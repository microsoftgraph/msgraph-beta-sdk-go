...
func (m *DepOnboardingSettingsDepOnboardingSettingItemRequestBuilder) MicrosoftGraphGenerateEncryptionPublicKey()(*DepOnboardingSettingsItemMicrosoftGraphGenerateEncryptionPublicKeyRequestBuilder) {
    return NewDepOnboardingSettingsItemMicrosoftGraphGenerateEncryptionPublicKeyRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetEncryptionPublicKey provides operations to call the getEncryptionPublicKey method.
func (m *DepOnboardingSettingsDepOnboardingSettingItemRequestBuilder) MicrosoftGraphGetEncryptionPublicKey()(*DepOnboardingSettingsItemMicrosoftGraphGetEncryptionPublicKeyRequestBuilder) {
    return NewDepOnboardingSettingsItemMicrosoftGraphGetEncryptionPublicKeyRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphShareForSchoolDataSyncService provides operations to call the shareForSchoolDataSyncService method.
func (m *DepOnboardingSettingsDepOnboardingSettingItemRequestBuilder) MicrosoftGraphShareForSchoolDataSyncService()(*DepOnboardingSettingsItemMicrosoftGraphShareForSchoolDataSyncServiceRequestBuilder) {
    return NewDepOnboardingSettingsItemMicrosoftGraphShareForSchoolDataSyncServiceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *DepOnboardingSettingsDepOnboardingSettingItemRequestBuilder) MicrosoftGraphSyncWithAppleDeviceEnrollmentProgram()(*DepOnboardingSettingsItemMicrosoftGraphSyncWithAppleDeviceEnrollmentProgramRequestBuilder) {
    return NewDepOnboardingSettingsItemMicrosoftGraphSyncWithAppleDeviceEnrollmentProgramRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnshareForSchoolDataSyncService provides operations to call the unshareForSchoolDataSyncService method.
func (m *DepOnboardingSettingsDepOnboardingSettingItemRequestBuilder) MicrosoftGraphUnshareForSchoolDataSyncService()(*DepOnboardingSettingsItemMicrosoftGraphUnshareForSchoolDataSyncServiceRequestBuilder) {
    return NewDepOnboardingSettingsItemMicrosoftGraphUnshareForSchoolDataSyncServiceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUploadDepToken provides operations to call the uploadDepToken method.
func (m *DepOnboardingSettingsDepOnboardingSettingItemRequestBuilder) MicrosoftGraphUploadDepToken()(*DepOnboardingSettingsItemMicrosoftGraphUploadDepTokenRequestBuilder) {
    return NewDepOnboardingSettingsItemMicrosoftGraphUploadDepTokenRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
