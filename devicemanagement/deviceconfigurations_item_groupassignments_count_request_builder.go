...
// NewDeviceconfigurationsItemGroupassignmentsCountRequestBuilderInternal instantiates a new DeviceconfigurationsItemGroupassignmentsCountRequestBuilder and sets the default values.
func NewDeviceconfigurationsItemGroupassignmentsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceconfigurationsItemGroupassignmentsCountRequestBuilder) {
    m := &DeviceconfigurationsItemGroupassignmentsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/groupAssignments/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewDeviceconfigurationsItemGroupassignmentsCountRequestBuilder instantiates a new DeviceconfigurationsItemGroupassignmentsCountRequestBuilder and sets the default values.
