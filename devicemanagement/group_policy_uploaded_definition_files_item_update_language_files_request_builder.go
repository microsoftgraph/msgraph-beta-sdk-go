...
// NewGroupPolicyUploadedDefinitionFilesItemUpdateLanguageFilesRequestBuilderInternal instantiates a new UpdateLanguageFilesRequestBuilder and sets the default values.
func NewGroupPolicyUploadedDefinitionFilesItemUpdateLanguageFilesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupPolicyUploadedDefinitionFilesItemUpdateLanguageFilesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/groupPolicyUploadedDefinitionFiles/{groupPolicyUploadedDefinitionFile%2Did}/updateLanguageFiles";
...
// NewGroupPolicyUploadedDefinitionFilesItemUpdateLanguageFilesRequestBuilder instantiates a new UpdateLanguageFilesRequestBuilder and sets the default values.
