...
func (m *VirtualEndpointFrontLineServicePlansCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointFrontLineServicePlansCountRequestBuilderGetRequestConfiguration)(*int64, error) {
