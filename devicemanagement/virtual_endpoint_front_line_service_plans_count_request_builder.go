...
// NewVirtualEndpointFrontLineServicePlansCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewVirtualEndpointFrontLineServicePlansCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointFrontLineServicePlansCountRequestBuilder) {
    m := &VirtualEndpointFrontLineServicePlansCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/frontLineServicePlans/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewVirtualEndpointFrontLineServicePlansCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
