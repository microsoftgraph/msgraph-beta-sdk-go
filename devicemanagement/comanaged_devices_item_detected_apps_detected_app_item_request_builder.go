...
// ComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilder provides operations to manage the detectedApps property of the microsoft.graph.managedDevice entity.
type ComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilder struct {
...
// NewComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilderInternal instantiates a new ComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilder and sets the default values.
func NewComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilder) {
    m := &ComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/detectedApps/{detectedApp%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilder instantiates a new ComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilder and sets the default values.
...
func (m *ComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilder) WithUrl(rawUrl string)(*ComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilder) {
    return NewComanagedDevicesItemDetectedAppsDetectedAppItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
