...
func (m *VirtualEndpointUserSettingsCloudPcUserSettingItemRequestBuilder) MicrosoftGraphAssign()(*VirtualEndpointUserSettingsItemMicrosoftGraphAssignRequestBuilder) {
    return NewVirtualEndpointUserSettingsItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
