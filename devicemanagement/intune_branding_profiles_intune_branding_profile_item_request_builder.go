...
func (m *IntuneBrandingProfilesIntuneBrandingProfileItemRequestBuilder) MicrosoftGraphAssign()(*IntuneBrandingProfilesItemMicrosoftGraphAssignRequestBuilder) {
    return NewIntuneBrandingProfilesItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
