...
// returns a []string when successful
func (m *ReportsGetDevicePolicySettingsComplianceReportPostRequestBody) GetSelectEscaped()([]string) {
...
func (m *ReportsGetDevicePolicySettingsComplianceReportPostRequestBody) SetSelectEscaped(value []string)() {
