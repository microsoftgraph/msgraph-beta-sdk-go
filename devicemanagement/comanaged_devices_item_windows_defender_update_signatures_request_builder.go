...
// NewComanagedDevicesItemWindowsDefenderUpdateSignaturesRequestBuilderInternal instantiates a new ComanagedDevicesItemWindowsDefenderUpdateSignaturesRequestBuilder and sets the default values.
...
// NewComanagedDevicesItemWindowsDefenderUpdateSignaturesRequestBuilder instantiates a new ComanagedDevicesItemWindowsDefenderUpdateSignaturesRequestBuilder and sets the default values.
...
func (m *ComanagedDevicesItemWindowsDefenderUpdateSignaturesRequestBuilder) WithUrl(rawUrl string)(*ComanagedDevicesItemWindowsDefenderUpdateSignaturesRequestBuilder) {
    return NewComanagedDevicesItemWindowsDefenderUpdateSignaturesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
