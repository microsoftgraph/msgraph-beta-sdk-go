...
// NewManagedDevicesItemGetFileVaultKeyRequestBuilderInternal instantiates a new ManagedDevicesItemGetFileVaultKeyRequestBuilder and sets the default values.
...
// NewManagedDevicesItemGetFileVaultKeyRequestBuilder instantiates a new ManagedDevicesItemGetFileVaultKeyRequestBuilder and sets the default values.
...
// returns a ManagedDevicesItemGetFileVaultKeyResponseable when successful
...
// returns a ManagedDevicesItemGetFileVaultKeyGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
