...
// VirtualEndpointReportsGetRemoteConnectionHistoricalReportsPostRequestBody provides operations to call the getRemoteConnectionHistoricalReports method.
...
func (m *VirtualEndpointReportsGetRemoteConnectionHistoricalReportsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *VirtualEndpointReportsGetRemoteConnectionHistoricalReportsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
