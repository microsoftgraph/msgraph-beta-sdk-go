...
// DeviceHealthScriptsItemGetRemediationHistoryRequestBuilder provides operations to call the getRemediationHistory method.
type DeviceHealthScriptsItemGetRemediationHistoryRequestBuilder struct {
...
// DeviceHealthScriptsItemGetRemediationHistoryRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type DeviceHealthScriptsItemGetRemediationHistoryRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
func NewDeviceHealthScriptsItemGetRemediationHistoryRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceHealthScriptsItemGetRemediationHistoryRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/deviceHealthScripts/{deviceHealthScript%2Did}/getRemediationHistory()";
