...
// DeviceHealthScriptsItemUpdateGlobalScriptResponse provides operations to call the updateGlobalScript method.
...
func (m *DeviceHealthScriptsItemUpdateGlobalScriptResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *DeviceHealthScriptsItemUpdateGlobalScriptResponse) SetAdditionalData(value map[string]interface{})() {
