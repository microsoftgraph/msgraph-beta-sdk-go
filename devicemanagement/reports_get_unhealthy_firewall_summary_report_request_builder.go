...
// NewReportsGetUnhealthyFirewallSummaryReportRequestBuilderInternal instantiates a new ReportsGetUnhealthyFirewallSummaryReportRequestBuilder and sets the default values.
...
// NewReportsGetUnhealthyFirewallSummaryReportRequestBuilder instantiates a new ReportsGetUnhealthyFirewallSummaryReportRequestBuilder and sets the default values.
...
func (m *ReportsGetUnhealthyFirewallSummaryReportRequestBuilder) WithUrl(rawUrl string)(*ReportsGetUnhealthyFirewallSummaryReportRequestBuilder) {
    return NewReportsGetUnhealthyFirewallSummaryReportRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
