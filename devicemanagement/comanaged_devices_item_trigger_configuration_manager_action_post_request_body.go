...
// ComanagedDevicesItemTriggerConfigurationManagerActionPostRequestBody provides operations to call the triggerConfigurationManagerAction method.
...
func (m *ComanagedDevicesItemTriggerConfigurationManagerActionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ComanagedDevicesItemTriggerConfigurationManagerActionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
