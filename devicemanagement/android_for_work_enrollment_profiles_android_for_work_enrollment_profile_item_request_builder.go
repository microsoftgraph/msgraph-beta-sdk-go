...
func (m *AndroidForWorkEnrollmentProfilesAndroidForWorkEnrollmentProfileItemRequestBuilder) MicrosoftGraphCreateToken()(*AndroidForWorkEnrollmentProfilesItemMicrosoftGraphCreateTokenRequestBuilder) {
    return NewAndroidForWorkEnrollmentProfilesItemMicrosoftGraphCreateTokenRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRevokeToken provides operations to call the revokeToken method.
func (m *AndroidForWorkEnrollmentProfilesAndroidForWorkEnrollmentProfileItemRequestBuilder) MicrosoftGraphRevokeToken()(*AndroidForWorkEnrollmentProfilesItemMicrosoftGraphRevokeTokenRequestBuilder) {
    return NewAndroidForWorkEnrollmentProfilesItemMicrosoftGraphRevokeTokenRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
