...
// NewAndroidForWorkSettingsRequestSignupUrlRequestBuilderInternal instantiates a new AndroidForWorkSettingsRequestSignupUrlRequestBuilder and sets the default values.
...
// NewAndroidForWorkSettingsRequestSignupUrlRequestBuilder instantiates a new AndroidForWorkSettingsRequestSignupUrlRequestBuilder and sets the default values.
...
// returns a AndroidForWorkSettingsRequestSignupUrlPostResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
