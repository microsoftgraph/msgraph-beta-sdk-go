...
func NewUpdateLanguageFilesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UpdateLanguageFilesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/groupPolicyUploadedDefinitionFiles/{groupPolicyUploadedDefinitionFile_id}/microsoft.graph.updateLanguageFiles";
...
func (m *UpdateLanguageFilesRequestBuilder) CreatePostRequestInformation(options *UpdateLanguageFilesRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
