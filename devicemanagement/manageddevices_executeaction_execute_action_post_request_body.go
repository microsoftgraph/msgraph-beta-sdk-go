...
type ManageddevicesExecuteactionExecuteActionPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewManageddevicesExecuteactionExecuteActionPostRequestBody instantiates a new ManageddevicesExecuteactionExecuteActionPostRequestBody and sets the default values.
func NewManageddevicesExecuteactionExecuteActionPostRequestBody()(*ManageddevicesExecuteactionExecuteActionPostRequestBody) {
    m := &ManageddevicesExecuteactionExecuteActionPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateManageddevicesExecuteactionExecuteActionPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateManageddevicesExecuteactionExecuteActionPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewManageddevicesExecuteactionExecuteActionPostRequestBody(), nil
}
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetActionName()(*ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ManagedDeviceRemoteAction) {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetCarrierUrl gets the carrierUrl property value. The carrierUrl property
// returns a *string when successful
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetCarrierUrl()(*string) {
...
// returns a *string when successful
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetDeprovisionReason()(*string) {
...
// returns a []string when successful
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetDeviceIds()([]string) {
...
// returns a *string when successful
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetDeviceName()(*string) {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetKeepEnrollmentData()(*bool) {
...
// returns a *bool when successful
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetKeepUserData()(*bool) {
...
// returns a *string when successful
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetNotificationBody()(*string) {
...
// returns a *string when successful
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetNotificationTitle()(*string) {
...
// returns a *string when successful
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetOrganizationalUnitPath()(*string) {
...
// returns a *bool when successful
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) GetPersistEsimDataPlan()(*bool) {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetActionName(value *ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ManagedDeviceRemoteAction)() {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetCarrierUrl sets the carrierUrl property value. The carrierUrl property
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetCarrierUrl(value *string)() {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetDeprovisionReason(value *string)() {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetDeviceIds(value []string)() {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetDeviceName(value *string)() {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetKeepEnrollmentData(value *bool)() {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetKeepUserData(value *bool)() {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetNotificationBody(value *string)() {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetNotificationTitle(value *string)() {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetOrganizationalUnitPath(value *string)() {
...
func (m *ManageddevicesExecuteactionExecuteActionPostRequestBody) SetPersistEsimDataPlan(value *bool)() {
    err := m.GetBackingStore().Set("persistEsimDataPlan", value)
    if err != nil {
        panic(err)
    }
}
type ManageddevicesExecuteactionExecuteActionPostRequestBodyable interface {
