...
func (m *UserExperienceAnalyticsDeviceTimelineEventCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsDeviceTimelineEventCountRequestBuilderGetRequestConfiguration)(*int64, error) {
