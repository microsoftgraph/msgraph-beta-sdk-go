...
// ZebraFotaConnectorDisconnectResponse provides operations to call the disconnect method.
...
func (m *ZebraFotaConnectorDisconnectResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *ZebraFotaConnectorDisconnectResponse) SetAdditionalData(value map[string]interface{})() {
