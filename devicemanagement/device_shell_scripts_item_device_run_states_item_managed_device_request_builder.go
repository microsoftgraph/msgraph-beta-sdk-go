...
// NewDeviceShellScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilderInternal instantiates a new DeviceShellScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder and sets the default values.
...
// NewDeviceShellScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder instantiates a new DeviceShellScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder and sets the default values.
...
func (m *DeviceShellScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder) WithUrl(rawUrl string)(*DeviceShellScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder) {
    return NewDeviceShellScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
