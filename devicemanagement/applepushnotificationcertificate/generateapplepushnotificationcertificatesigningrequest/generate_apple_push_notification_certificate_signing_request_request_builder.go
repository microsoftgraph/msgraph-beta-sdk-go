...
func (m *GenerateApplePushNotificationCertificateSigningRequestRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *GenerateApplePushNotificationCertificateSigningRequestRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GenerateApplePushNotificationCertificateSigningRequestRequestBuilder) Post(ctx context.Context, requestConfiguration *GenerateApplePushNotificationCertificateSigningRequestRequestBuilderPostRequestConfiguration)(GenerateApplePushNotificationCertificateSigningRequestResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGenerateApplePushNotificationCertificateSigningRequestResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
