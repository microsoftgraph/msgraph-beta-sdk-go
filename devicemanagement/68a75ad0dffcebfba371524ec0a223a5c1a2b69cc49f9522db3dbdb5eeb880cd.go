...
func (m *DeviceCustomAttributeShellScriptsItemUserRunStatesItemDeviceRunStatesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceCustomAttributeShellScriptsItemUserRunStatesItemDeviceRunStatesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
