...
// Builds and executes requests for operations under \deviceManagement\microsoftTunnelConfigurations\{microsoftTunnelConfiguration-id}
...
func NewMicrosoftTunnelConfigurationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MicrosoftTunnelConfigurationRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/deviceManagement/microsoftTunnelConfigurations/{microsoftTunnelConfiguration_id}{?select,expand}";
