...
func (m *DeviceEnrollmentConfigurationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceEnrollmentConfigurationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
