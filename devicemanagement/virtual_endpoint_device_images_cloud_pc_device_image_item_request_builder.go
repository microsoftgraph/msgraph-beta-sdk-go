...
func (m *VirtualEndpointDeviceImagesCloudPcDeviceImageItemRequestBuilder) MicrosoftGraphReupload()(*VirtualEndpointDeviceImagesItemMicrosoftGraphReuploadRequestBuilder) {
    return NewVirtualEndpointDeviceImagesItemMicrosoftGraphReuploadRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
