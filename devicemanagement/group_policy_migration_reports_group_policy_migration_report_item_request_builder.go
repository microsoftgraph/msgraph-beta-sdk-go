...
func (m *GroupPolicyMigrationReportsGroupPolicyMigrationReportItemRequestBuilder) MicrosoftGraphUpdateScopeTags()(*GroupPolicyMigrationReportsItemMicrosoftGraphUpdateScopeTagsRequestBuilder) {
    return NewGroupPolicyMigrationReportsItemMicrosoftGraphUpdateScopeTagsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
