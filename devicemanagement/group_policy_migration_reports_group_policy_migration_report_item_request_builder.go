...
func (m *GroupPolicyMigrationReportsGroupPolicyMigrationReportItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *GroupPolicyMigrationReportsGroupPolicyMigrationReportItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
