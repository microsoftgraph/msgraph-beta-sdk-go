...
// WindowsAutopilotDeploymentProfilesHasPayloadLinksPostRequestBody provides operations to call the hasPayloadLinks method.
...
func (m *WindowsAutopilotDeploymentProfilesHasPayloadLinksPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *WindowsAutopilotDeploymentProfilesHasPayloadLinksPostRequestBody) SetAdditionalData(value map[string]interface{})() {
