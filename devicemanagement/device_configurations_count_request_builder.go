...
func (m *DeviceConfigurationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceConfigurationsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
