...
func (m *DeviceCompliancePoliciesItemUserStatusesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceCompliancePoliciesItemUserStatusesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
