...
func NewManageddevicesItemResetpasscodeResetPasscodeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManageddevicesItemResetpasscodeResetPasscodeRequestBuilder) {
    m := &ManageddevicesItemResetpasscodeResetPasscodeRequestBuilder{
...
func NewManageddevicesItemResetpasscodeResetPasscodeRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManageddevicesItemResetpasscodeResetPasscodeRequestBuilder) {
    ...
    return NewManageddevicesItemResetpasscodeResetPasscodeRequestBuilderInternal(urlParams, requestAdapter)
}
// Post reset passcode
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ManageddevicesItemResetpasscodeResetPasscodeRequestBuilder) Post(ctx context.Context, requestConfiguration *ManageddevicesItemResetpasscodeResetPasscodeRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ManageddevicesItemResetpasscodeResetPasscodeRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *ManageddevicesItemResetpasscodeResetPasscodeRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ManageddevicesItemResetpasscodeResetPasscodeRequestBuilder) WithUrl(rawUrl string)(*ManageddevicesItemResetpasscodeResetPasscodeRequestBuilder) {
    return NewManageddevicesItemResetpasscodeResetPasscodeRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
