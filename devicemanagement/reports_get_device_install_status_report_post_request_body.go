...
func (m *ReportsGetDeviceInstallStatusReportPostRequestBody) GetSelectEscaped()([]string) {
...
func (m *ReportsGetDeviceInstallStatusReportPostRequestBody) SetSelectEscaped(value []string)() {
