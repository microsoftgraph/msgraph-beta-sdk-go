...
// ReportsGetDeviceInstallStatusReportPostRequestBody provides operations to call the getDeviceInstallStatusReport method.
...
func CreateReportsGetDeviceInstallStatusReportPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewReportsGetDeviceInstallStatusReportPostRequestBody(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *ReportsGetDeviceInstallStatusReportPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ReportsGetDeviceInstallStatusReportPostRequestBody) SetAdditionalData(value map[string]interface{})() {
