...
func (m *ComanagedDevicesItemDeviceConfigurationStatesRequestBuilder) Count()(*ComanagedDevicesItemDeviceConfigurationStatesCountRequestBuilder) {
    return NewComanagedDevicesItemDeviceConfigurationStatesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation device configuration states for this device.
func (m *ComanagedDevicesItemDeviceConfigurationStatesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ComanagedDevicesItemDeviceConfigurationStatesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
