...
func (m *TemplateSettingsItemSettingDefinitionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *TemplateSettingsItemSettingDefinitionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
