...
func (m *GrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesGroupPolicyPresentationValueItemRequestBuilder) DefinitionValue()(*GrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemDefinitionvalueDefinitionValueRequestBuilder) {
    return NewGrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemDefinitionvalueDefinitionValueRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
