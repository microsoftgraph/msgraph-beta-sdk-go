...
// NewTemplatesItemCategoriesItemRecommendedSettingsCountRequestBuilderInternal instantiates a new TemplatesItemCategoriesItemRecommendedSettingsCountRequestBuilder and sets the default values.
...
// NewTemplatesItemCategoriesItemRecommendedSettingsCountRequestBuilder instantiates a new TemplatesItemCategoriesItemRecommendedSettingsCountRequestBuilder and sets the default values.
...
func (m *TemplatesItemCategoriesItemRecommendedSettingsCountRequestBuilder) WithUrl(rawUrl string)(*TemplatesItemCategoriesItemRecommendedSettingsCountRequestBuilder) {
    return NewTemplatesItemCategoriesItemRecommendedSettingsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
