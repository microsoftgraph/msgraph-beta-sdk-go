...
// VirtualEndpointRetrieveScopedPermissionsRequestBuilder provides operations to call the retrieveScopedPermissions method.
...
type VirtualEndpointRetrieveScopedPermissionsRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *VirtualEndpointRetrieveScopedPermissionsRequestBuilderGetQueryParameters
}
// NewVirtualEndpointRetrieveScopedPermissionsRequestBuilderInternal instantiates a new RetrieveScopedPermissionsRequestBuilder and sets the default values.
func NewVirtualEndpointRetrieveScopedPermissionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointRetrieveScopedPermissionsRequestBuilder) {
    m := &VirtualEndpointRetrieveScopedPermissionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/retrieveScopedPermissions(){?%24top,%24skip,%24search,%24filter,%24count}", pathParameters),
    }
    return m
}
// NewVirtualEndpointRetrieveScopedPermissionsRequestBuilder instantiates a new RetrieveScopedPermissionsRequestBuilder and sets the default values.
func NewVirtualEndpointRetrieveScopedPermissionsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointRetrieveScopedPermissionsRequestBuilder) {
...
func (m *VirtualEndpointRetrieveScopedPermissionsRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointRetrieveScopedPermissionsRequestBuilderGetRequestConfiguration)(VirtualEndpointRetrieveScopedPermissionsResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateVirtualEndpointRetrieveScopedPermissionsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *VirtualEndpointRetrieveScopedPermissionsRequestBuilder) GetAsRetrieveScopedPermissionsGetResponse(ctx context.Context, requestConfiguration *VirtualEndpointRetrieveScopedPermissionsRequestBuilderGetRequestConfiguration)(VirtualEndpointRetrieveScopedPermissionsGetResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateVirtualEndpointRetrieveScopedPermissionsGetResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *VirtualEndpointRetrieveScopedPermissionsRequestBuilder) WithUrl(rawUrl string)(*VirtualEndpointRetrieveScopedPermissionsRequestBuilder) {
    return NewVirtualEndpointRetrieveScopedPermissionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
