...
// NewTemplatesItemMigratableToItemSettingsRequestBuilderInternal instantiates a new SettingsRequestBuilder and sets the default values.
...
// NewTemplatesItemMigratableToItemSettingsRequestBuilder instantiates a new SettingsRequestBuilder and sets the default values.
...
func (m *TemplatesItemMigratableToItemSettingsRequestBuilder) Count()(*TemplatesItemMigratableToItemSettingsCountRequestBuilder) {
    return NewTemplatesItemMigratableToItemSettingsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation collection of all settings this template has
func (m *TemplatesItemMigratableToItemSettingsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *TemplatesItemMigratableToItemSettingsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
