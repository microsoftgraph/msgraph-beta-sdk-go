...
func NewDeviceconfigurationsItemUserstatusesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceconfigurationsItemUserstatusesCountRequestBuilder) {
    m := &DeviceconfigurationsItemUserstatusesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/userStatuses/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewDeviceconfigurationsItemUserstatusesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceconfigurationsItemUserstatusesCountRequestBuilder) {
    ...
    return NewDeviceconfigurationsItemUserstatusesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *DeviceconfigurationsItemUserstatusesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceconfigurationsItemUserstatusesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *DeviceconfigurationsItemUserstatusesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DeviceconfigurationsItemUserstatusesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DeviceconfigurationsItemUserstatusesCountRequestBuilder) WithUrl(rawUrl string)(*DeviceconfigurationsItemUserstatusesCountRequestBuilder) {
    return NewDeviceconfigurationsItemUserstatusesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
