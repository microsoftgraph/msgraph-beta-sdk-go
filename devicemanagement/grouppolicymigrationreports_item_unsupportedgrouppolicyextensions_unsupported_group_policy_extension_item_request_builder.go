...
// NewGrouppolicymigrationreportsItemUnsupportedgrouppolicyextensionsUnsupportedGroupPolicyExtensionItemRequestBuilderInternal instantiates a new GrouppolicymigrationreportsItemUnsupportedgrouppolicyextensionsUnsupportedGroupPolicyExtensionItemRequestBuilder and sets the default values.
...
// NewGrouppolicymigrationreportsItemUnsupportedgrouppolicyextensionsUnsupportedGroupPolicyExtensionItemRequestBuilder instantiates a new GrouppolicymigrationreportsItemUnsupportedgrouppolicyextensionsUnsupportedGroupPolicyExtensionItemRequestBuilder and sets the default values.
