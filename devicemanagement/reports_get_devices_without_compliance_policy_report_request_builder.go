...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportRequestBuilder) WithUrl(rawUrl string)(*ReportsGetDevicesWithoutCompliancePolicyReportRequestBuilder) {
    return NewReportsGetDevicesWithoutCompliancePolicyReportRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
