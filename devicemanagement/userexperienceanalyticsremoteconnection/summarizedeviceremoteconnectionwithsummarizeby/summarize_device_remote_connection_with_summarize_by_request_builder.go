...
// SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilderGetQueryParameters invoke function summarizeDeviceRemoteConnection
type SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilderGetQueryParameters struct {
...
type SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilderGetQueryParameters
}
...
func (m *SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder) Get(ctx context.Context, requestConfiguration *SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilderGetRequestConfiguration)(SummarizeDeviceRemoteConnectionWithSummarizeByResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateSummarizeDeviceRemoteConnectionWithSummarizeByResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
