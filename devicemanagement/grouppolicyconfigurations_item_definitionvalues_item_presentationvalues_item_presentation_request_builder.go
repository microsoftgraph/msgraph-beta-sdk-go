...
// NewGrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemPresentationRequestBuilderInternal instantiates a new GrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemPresentationRequestBuilder and sets the default values.
func NewGrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemPresentationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemPresentationRequestBuilder) {
    m := &GrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemPresentationRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyConfigurations/{groupPolicyConfiguration%2Did}/definitionValues/{groupPolicyDefinitionValue%2Did}/presentationValues/{groupPolicyPresentationValue%2Did}/presentation{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewGrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemPresentationRequestBuilder instantiates a new GrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemPresentationRequestBuilder and sets the default values.
...
// returns a *GrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemPresentationRequestBuilder when successful
func (m *GrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemPresentationRequestBuilder) WithUrl(rawUrl string)(*GrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemPresentationRequestBuilder) {
    return NewGrouppolicyconfigurationsItemDefinitionvaluesItemPresentationvaluesItemPresentationRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
