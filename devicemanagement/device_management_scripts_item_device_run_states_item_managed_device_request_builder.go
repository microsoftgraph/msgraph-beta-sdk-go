...
// NewDeviceManagementScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilderInternal instantiates a new DeviceManagementScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder and sets the default values.
...
// NewDeviceManagementScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder instantiates a new DeviceManagementScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder and sets the default values.
...
func (m *DeviceManagementScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DeviceManagementScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DeviceManagementScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder) WithUrl(rawUrl string)(*DeviceManagementScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder) {
    return NewDeviceManagementScriptsItemDeviceRunStatesItemManagedDeviceRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
