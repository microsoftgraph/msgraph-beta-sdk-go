...
func (m *VirtualEndpointCrossCloudGovernmentOrganizationMappingRequestBuilder) Delete(ctx context.Context, requestConfiguration *VirtualEndpointCrossCloudGovernmentOrganizationMappingRequestBuilderDeleteRequestConfiguration)([]byte, error) {
