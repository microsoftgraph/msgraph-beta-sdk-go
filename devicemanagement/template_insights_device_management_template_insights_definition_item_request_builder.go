...
// NewTemplateInsightsDeviceManagementTemplateInsightsDefinitionItemRequestBuilderInternal instantiates a new DeviceManagementTemplateInsightsDefinitionItemRequestBuilder and sets the default values.
func NewTemplateInsightsDeviceManagementTemplateInsightsDefinitionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TemplateInsightsDeviceManagementTemplateInsightsDefinitionItemRequestBuilder) {
    m := &TemplateInsightsDeviceManagementTemplateInsightsDefinitionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/templateInsights/{deviceManagementTemplateInsightsDefinition%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewTemplateInsightsDeviceManagementTemplateInsightsDefinitionItemRequestBuilder instantiates a new DeviceManagementTemplateInsightsDefinitionItemRequestBuilder and sets the default values.
