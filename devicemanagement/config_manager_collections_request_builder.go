...
func (m *ConfigManagerCollectionsRequestBuilder) MicrosoftGraphGetPolicySummaryWithPolicyId(policyId *string)(*ConfigManagerCollectionsMicrosoftGraphGetPolicySummaryWithPolicyIdRequestBuilder) {
    return NewConfigManagerCollectionsMicrosoftGraphGetPolicySummaryWithPolicyIdRequestBuilderInternal(m.pathParameters, m.requestAdapter, policyId)
}
