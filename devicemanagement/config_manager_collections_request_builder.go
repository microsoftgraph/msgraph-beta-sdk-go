...
func (m *ConfigManagerCollectionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ConfigManagerCollectionsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ConfigManagerCollectionCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateConfigManagerCollectionCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphGetPolicySummaryWithPolicyId provides operations to call the getPolicySummary method.
func (m *ConfigManagerCollectionsRequestBuilder) MicrosoftGraphGetPolicySummaryWithPolicyId(policyId *string)(*ConfigManagerCollectionsMicrosoftGraphGetPolicySummaryWithPolicyIdGetPolicySummaryWithPolicyIdRequestBuilder) {
    return NewConfigManagerCollectionsMicrosoftGraphGetPolicySummaryWithPolicyIdGetPolicySummaryWithPolicyIdRequestBuilderInternal(m.pathParameters, m.requestAdapter, policyId)
}
