...
// ByWindowsQualityUpdateProfileAssignmentIdString provides operations to manage the assignments property of the microsoft.graph.windowsQualityUpdateProfile entity.
func (m *WindowsQualityUpdateProfilesItemAssignmentsRequestBuilder) ByWindowsQualityUpdateProfileAssignmentIdString(windowsQualityUpdateProfileAssignmentId string)(*WindowsQualityUpdateProfilesItemAssignmentsWindowsQualityUpdateProfileAssignmentItemRequestBuilder) {
