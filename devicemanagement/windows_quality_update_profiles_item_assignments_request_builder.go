...
func (m *WindowsQualityUpdateProfilesItemAssignmentsRequestBuilder) Count()(*WindowsQualityUpdateProfilesItemAssignmentsCountRequestBuilder) {
    return NewWindowsQualityUpdateProfilesItemAssignmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the list of group assignments of the profile.
func (m *WindowsQualityUpdateProfilesItemAssignmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *WindowsQualityUpdateProfilesItemAssignmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
