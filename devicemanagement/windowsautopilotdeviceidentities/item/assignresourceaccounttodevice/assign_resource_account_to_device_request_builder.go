...
// AssignResourceAccountToDeviceRequestBuilder builds and executes requests for operations under \deviceManagement\windowsAutopilotDeviceIdentities\{windowsAutopilotDeviceIdentity-id}\microsoft.graph.assignResourceAccountToDevice
