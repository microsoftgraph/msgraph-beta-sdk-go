...
func (m *VirtualEndpointAuditEventsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *VirtualEndpointAuditEventsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *VirtualEndpointAuditEventsRequestBuilder) GetAuditActivityTypes()(*VirtualEndpointAuditEventsGetAuditActivityTypesRequestBuilder) {
    return NewVirtualEndpointAuditEventsGetAuditActivityTypesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
