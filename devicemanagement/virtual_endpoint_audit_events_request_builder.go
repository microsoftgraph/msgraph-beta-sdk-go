...
func (m *VirtualEndpointAuditEventsRequestBuilder) Count()(*VirtualEndpointAuditEventsCountRequestBuilder) {
    return NewVirtualEndpointAuditEventsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get list all the cloudPcAuditEvent objects for the tenant.
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/virtualendpoint-list-auditevents?view=graph-rest-1.0
func (m *VirtualEndpointAuditEventsRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointAuditEventsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CloudPcAuditEventCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateCloudPcAuditEventCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphGetAuditActivityTypes provides operations to call the getAuditActivityTypes method.
func (m *VirtualEndpointAuditEventsRequestBuilder) MicrosoftGraphGetAuditActivityTypes()(*VirtualEndpointAuditEventsMicrosoftGraphGetAuditActivityTypesGetAuditActivityTypesRequestBuilder) {
    return NewVirtualEndpointAuditEventsMicrosoftGraphGetAuditActivityTypesGetAuditActivityTypesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *VirtualEndpointAuditEventsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CloudPcAuditEventable, requestConfiguration *VirtualEndpointAuditEventsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CloudPcAuditEventable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateCloudPcAuditEventFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
