...
// VirtualEndpointAuditEventsRequestBuilderGetQueryParameters list all the cloudPcAuditEvent objects for the tenant. This API is available in the following national cloud deployments.
...
// Get list all the cloudPcAuditEvent objects for the tenant. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation list all the cloudPcAuditEvent objects for the tenant. This API is available in the following national cloud deployments.
