...
func (m *VirtualEndpointAuditEventsRequestBuilder) MicrosoftGraphGetAuditActivityTypes()(*VirtualEndpointAuditEventsMicrosoftGraphGetAuditActivityTypesRequestBuilder) {
    return NewVirtualEndpointAuditEventsMicrosoftGraphGetAuditActivityTypesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
