...
func (m *WindowsAutopilotDeviceIdentitiesWindowsAutopilotDeviceIdentityItemRequestBuilder) MicrosoftGraphAssignResourceAccountToDevice()(*WindowsAutopilotDeviceIdentitiesItemMicrosoftGraphAssignResourceAccountToDeviceRequestBuilder) {
    return NewWindowsAutopilotDeviceIdentitiesItemMicrosoftGraphAssignResourceAccountToDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *WindowsAutopilotDeviceIdentitiesWindowsAutopilotDeviceIdentityItemRequestBuilder) MicrosoftGraphUnassignResourceAccountFromDevice()(*WindowsAutopilotDeviceIdentitiesItemMicrosoftGraphUnassignResourceAccountFromDeviceRequestBuilder) {
    return NewWindowsAutopilotDeviceIdentitiesItemMicrosoftGraphUnassignResourceAccountFromDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
