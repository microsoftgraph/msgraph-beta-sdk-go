...
// GroupPolicyMigrationReportsCreateMigrationReportPostRequestBody provides operations to call the createMigrationReport method.
...
func (m *GroupPolicyMigrationReportsCreateMigrationReportPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *GroupPolicyMigrationReportsCreateMigrationReportPostRequestBody) SetAdditionalData(value map[string]interface{})() {
