...
func (m *ReusablePolicySettingsItemReferencingConfigurationPoliciesItemAssignmentsRequestBuilder) Count()(*ReusablePolicySettingsItemReferencingConfigurationPoliciesItemAssignmentsCountRequestBuilder) {
    return NewReusablePolicySettingsItemReferencingConfigurationPoliciesItemAssignmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation policy assignments
func (m *ReusablePolicySettingsItemReferencingConfigurationPoliciesItemAssignmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ReusablePolicySettingsItemReferencingConfigurationPoliciesItemAssignmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
