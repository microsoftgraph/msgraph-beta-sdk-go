...
func (m *SummarizeDeviceRegressionPerformanceWithSummarizeByRequestBuilder) Get(options *SummarizeDeviceRegressionPerformanceWithSummarizeByRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.UserExperienceAnalyticsRegressionSummaryable, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateUserExperienceAnalyticsRegressionSummaryFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
