...
// NewManageddevicesItemAssignmentfilterevaluationstatusdetailsCountRequestBuilderInternal instantiates a new ManageddevicesItemAssignmentfilterevaluationstatusdetailsCountRequestBuilder and sets the default values.
func NewManageddevicesItemAssignmentfilterevaluationstatusdetailsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManageddevicesItemAssignmentfilterevaluationstatusdetailsCountRequestBuilder) {
    m := &ManageddevicesItemAssignmentfilterevaluationstatusdetailsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/assignmentFilterEvaluationStatusDetails/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewManageddevicesItemAssignmentfilterevaluationstatusdetailsCountRequestBuilder instantiates a new ManageddevicesItemAssignmentfilterevaluationstatusdetailsCountRequestBuilder and sets the default values.
