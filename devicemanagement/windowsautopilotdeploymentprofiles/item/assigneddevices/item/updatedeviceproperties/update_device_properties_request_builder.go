...
// UpdateDevicePropertiesRequestBuilder builds and executes requests for operations under \deviceManagement\windowsAutopilotDeploymentProfiles\{windowsAutopilotDeploymentProfile-id}\assignedDevices\{windowsAutopilotDeviceIdentity-id}\microsoft.graph.updateDeviceProperties
...
// UpdateDevicePropertiesRequestBuilderPostOptions options for Post
type UpdateDevicePropertiesRequestBuilderPostOptions struct {
    // 
    Body *UpdateDevicePropertiesRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func NewUpdateDevicePropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UpdateDevicePropertiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/windowsAutopilotDeploymentProfiles/{windowsAutopilotDeploymentProfile_id}/assignedDevices/{windowsAutopilotDeviceIdentity_id}/microsoft.graph.updateDeviceProperties";
