...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\windowsAutopilotDeploymentProfiles\{windowsAutopilotDeploymentProfile-id}\assignedDevices\{windowsAutopilotDeviceIdentity-id}\deploymentProfile\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/windowsAutopilotDeploymentProfiles/{windowsAutopilotDeploymentProfile_id}/assignedDevices/{windowsAutopilotDeviceIdentity_id}/deploymentProfile/$ref";
...
// CreateDeleteRequestInformation deployment profile currently assigned to the Windows autopilot device.
...
// CreatePutRequestInformation deployment profile currently assigned to the Windows autopilot device.
...
// Delete deployment profile currently assigned to the Windows autopilot device.
...
// Put deployment profile currently assigned to the Windows autopilot device.
