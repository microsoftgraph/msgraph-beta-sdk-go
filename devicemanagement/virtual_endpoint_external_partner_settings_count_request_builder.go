...
func (m *VirtualEndpointExternalPartnerSettingsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointExternalPartnerSettingsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
