...
func (m *ManagedDevicesItemDeviceConfigurationStatesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedDevicesItemDeviceConfigurationStatesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
