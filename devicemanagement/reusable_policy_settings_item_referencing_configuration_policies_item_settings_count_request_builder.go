...
func (m *ReusablePolicySettingsItemReferencingConfigurationPoliciesItemSettingsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ReusablePolicySettingsItemReferencingConfigurationPoliciesItemSettingsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
