...
// NewWindowsFeatureUpdateProfilesItemAssignRequestBuilderInternal instantiates a new AssignRequestBuilder and sets the default values.
func NewWindowsFeatureUpdateProfilesItemAssignRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsFeatureUpdateProfilesItemAssignRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/windowsFeatureUpdateProfiles/{windowsFeatureUpdateProfile%2Did}/microsoft.graph.assign";
...
// NewWindowsFeatureUpdateProfilesItemAssignRequestBuilder instantiates a new AssignRequestBuilder and sets the default values.
