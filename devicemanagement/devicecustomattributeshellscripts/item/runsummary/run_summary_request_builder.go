...
import (
    ...
    i0517e22319a8ecee329584eab2e7811c065ba86de015afb4d313f596b898abb7 "github.com/microsoftgraph/msgraph-beta-sdk-go/devicemanagement/devicecustomattributeshellscripts/item/runsummary/ref"
)

// RunSummaryRequestBuilder builds and executes requests for operations under \deviceManagement\deviceCustomAttributeShellScripts\{deviceCustomAttributeShellScript-id}\runSummary
...
func NewRunSummaryRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RunSummaryRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScript_id}/runSummary{?select,expand}";
...
func (m *RunSummaryRequestBuilder) Ref()(*i0517e22319a8ecee329584eab2e7811c065ba86de015afb4d313f596b898abb7.RefRequestBuilder) {
    return i0517e22319a8ecee329584eab2e7811c065ba86de015afb4d313f596b898abb7.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
