...
import (
    ...
    i9cb7e2ceb4e37405d7a799e606f38557d2f2bc17c8154f2772cae80ee5ec4e30 "github.com/microsoftgraph/msgraph-beta-sdk-go/devicemanagement/devicecustomattributeshellscripts/item/devicerunstates/item/manageddevice"
)

// DeviceManagementScriptDeviceStateRequestBuilder builds and executes requests for operations under \deviceManagement\deviceCustomAttributeShellScripts\{deviceCustomAttributeShellScript-id}\deviceRunStates\{deviceManagementScriptDeviceState-id}
...
func NewDeviceManagementScriptDeviceStateRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DeviceManagementScriptDeviceStateRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScript_id}/deviceRunStates/{deviceManagementScriptDeviceState_id}{?select,expand}";
...
func (m *DeviceManagementScriptDeviceStateRequestBuilder) ManagedDevice()(*i9cb7e2ceb4e37405d7a799e606f38557d2f2bc17c8154f2772cae80ee5ec4e30.ManagedDeviceRequestBuilder) {
