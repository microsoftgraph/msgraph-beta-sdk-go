...
type DeviceCustomAttributeShellScriptsRequestBuilderGetOptions struct {
    ...
    Q *DeviceCustomAttributeShellScriptsRequestBuilderGetQueryParameters;
...
func (m *DeviceCustomAttributeShellScriptsRequestBuilder) Get(options *DeviceCustomAttributeShellScriptsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DeviceCustomAttributeShellScriptCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateDeviceCustomAttributeShellScriptCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DeviceCustomAttributeShellScriptCollectionResponseable), nil
}
// Post create new navigation property to deviceCustomAttributeShellScripts for deviceManagement
func (m *DeviceCustomAttributeShellScriptsRequestBuilder) Post(options *DeviceCustomAttributeShellScriptsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DeviceCustomAttributeShellScriptable, error) {
