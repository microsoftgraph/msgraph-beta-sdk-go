...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\groupPolicyDefinitions\{groupPolicyDefinition-id}\category\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition_id}/category/$ref";
...
// CreateDeleteRequestInformation the group policy category associated with the definition.
...
// CreatePutRequestInformation the group policy category associated with the definition.
...
// Delete the group policy category associated with the definition.
...
// Put the group policy category associated with the definition.
