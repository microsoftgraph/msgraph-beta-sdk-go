...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\groupPolicyDefinitions\{groupPolicyDefinition-id}\presentations\{groupPolicyPresentation-id}\definition\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition_id}/presentations/{groupPolicyPresentation_id}/definition/$ref";
...
// CreateDeleteRequestInformation the group policy definition associated with the presentation.
...
// CreatePutRequestInformation the group policy definition associated with the presentation.
...
// Delete the group policy definition associated with the presentation.
...
// Put the group policy definition associated with the presentation.
