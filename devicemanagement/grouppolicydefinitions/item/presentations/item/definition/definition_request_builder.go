...
func NewDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DefinitionRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition_id}/presentations/{groupPolicyPresentation_id}/definition{?select,expand}";
...
func (m *DefinitionRequestBuilder) Ref()(*ibf5d554bb8f9fefe6759dd4bed0cdb4cda760c11c166e9ff18bf2e4b633a2224.RefRequestBuilder) {
    return ibf5d554bb8f9fefe6759dd4bed0cdb4cda760c11c166e9ff18bf2e4b633a2224.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
