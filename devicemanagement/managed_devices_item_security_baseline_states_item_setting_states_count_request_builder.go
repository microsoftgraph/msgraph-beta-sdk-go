...
func (m *ManagedDevicesItemSecurityBaselineStatesItemSettingStatesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedDevicesItemSecurityBaselineStatesItemSettingStatesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
