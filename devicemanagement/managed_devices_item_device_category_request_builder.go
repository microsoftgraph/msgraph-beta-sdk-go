...
func (m *ManagedDevicesItemDeviceCategoryRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedDevicesItemDeviceCategoryRequestBuilderDeleteRequestConfiguration)([]byte, error) {
