...
func (m *UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilder) ByUserExperienceAnalyticsDeviceScoresId(userExperienceAnalyticsDeviceScoresId string)(*UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresItemRequestBuilder) {
...
func NewUserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilder) {
    m := &UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilder{
...
func NewUserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilder) {
    ...
    return NewUserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *UserexperienceanalyticsdevicescoresCountRequestBuilder when successful
func (m *UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilder) Count()(*UserexperienceanalyticsdevicescoresCountRequestBuilder) {
...
func (m *UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsDeviceScoresCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateUserExperienceAnalyticsDeviceScoresCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilder) {
    return NewUserexperienceanalyticsdevicescoresUserExperienceAnalyticsDeviceScoresRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
