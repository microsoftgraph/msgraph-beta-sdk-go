...
// GroupPolicyMigrationReportsCreateMigrationReportResponse provides operations to call the createMigrationReport method.
...
func (m *GroupPolicyMigrationReportsCreateMigrationReportResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *GroupPolicyMigrationReportsCreateMigrationReportResponse) SetAdditionalData(value map[string]interface{})() {
