...
func (m *DeviceHealthScriptsDeviceHealthScriptItemRequestBuilder) MicrosoftGraphAssign()(*DeviceHealthScriptsItemMicrosoftGraphAssignRequestBuilder) {
    return NewDeviceHealthScriptsItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *DeviceHealthScriptsDeviceHealthScriptItemRequestBuilder) MicrosoftGraphGetGlobalScriptHighestAvailableVersion()(*DeviceHealthScriptsItemMicrosoftGraphGetGlobalScriptHighestAvailableVersionRequestBuilder) {
    return NewDeviceHealthScriptsItemMicrosoftGraphGetGlobalScriptHighestAvailableVersionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetRemediationHistory provides operations to call the getRemediationHistory method.
func (m *DeviceHealthScriptsDeviceHealthScriptItemRequestBuilder) MicrosoftGraphGetRemediationHistory()(*DeviceHealthScriptsItemMicrosoftGraphGetRemediationHistoryRequestBuilder) {
    return NewDeviceHealthScriptsItemMicrosoftGraphGetRemediationHistoryRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUpdateGlobalScript provides operations to call the updateGlobalScript method.
func (m *DeviceHealthScriptsDeviceHealthScriptItemRequestBuilder) MicrosoftGraphUpdateGlobalScript()(*DeviceHealthScriptsItemMicrosoftGraphUpdateGlobalScriptRequestBuilder) {
    return NewDeviceHealthScriptsItemMicrosoftGraphUpdateGlobalScriptRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
