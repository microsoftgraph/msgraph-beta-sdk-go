...
func (m *DeviceHealthScriptsDeviceHealthScriptItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *DeviceHealthScriptsDeviceHealthScriptItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
