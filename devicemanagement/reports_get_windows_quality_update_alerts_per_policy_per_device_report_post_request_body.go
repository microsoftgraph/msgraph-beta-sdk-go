...
// ReportsGetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody provides operations to call the getWindowsQualityUpdateAlertsPerPolicyPerDeviceReport method.
...
func (m *ReportsGetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ReportsGetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody) SetAdditionalData(value map[string]interface{})() {
