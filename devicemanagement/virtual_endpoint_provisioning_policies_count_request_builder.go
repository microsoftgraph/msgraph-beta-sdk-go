...
func (m *VirtualEndpointProvisioningPoliciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointProvisioningPoliciesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
