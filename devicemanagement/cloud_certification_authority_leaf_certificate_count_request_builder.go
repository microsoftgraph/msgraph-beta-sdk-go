...
func (m *CloudCertificationAuthorityLeafCertificateCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CloudCertificationAuthorityLeafCertificateCountRequestBuilderGetRequestConfiguration)(*int64, error) {
