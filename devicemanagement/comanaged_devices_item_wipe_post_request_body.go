...
// ComanagedDevicesItemWipePostRequestBody provides operations to call the wipe method.
...
func (m *ComanagedDevicesItemWipePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ComanagedDevicesItemWipePostRequestBody) SetAdditionalData(value map[string]interface{})() {
