...
func NewComanagedDevicesItemWipePostRequestBody()(*ComanagedDevicesItemWipePostRequestBody) {
    ...
    keepEnrollmentDataValue := false
    m.SetKeepEnrollmentData(&keepEnrollmentDataValue)
    keepUserDataValue := false
    m.SetKeepUserData(&keepUserDataValue)
    persistEsimDataPlanValue := false
    m.SetPersistEsimDataPlan(&persistEsimDataPlanValue)
    useProtectedWipeValue := false
    m.SetUseProtectedWipe(&useProtectedWipeValue)
    return m
}
