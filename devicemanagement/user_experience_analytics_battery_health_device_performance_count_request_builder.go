...
func (m *UserExperienceAnalyticsBatteryHealthDevicePerformanceCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsBatteryHealthDevicePerformanceCountRequestBuilderGetRequestConfiguration)(*int64, error) {
