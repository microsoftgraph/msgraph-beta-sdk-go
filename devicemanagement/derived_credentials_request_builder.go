...
// ByDeviceManagementDerivedCredentialSettingsIdString provides operations to manage the derivedCredentials property of the microsoft.graph.deviceManagement entity.
func (m *DerivedCredentialsRequestBuilder) ByDeviceManagementDerivedCredentialSettingsIdString(deviceManagementDerivedCredentialSettingsId string)(*DerivedCredentialsDeviceManagementDerivedCredentialSettingsItemRequestBuilder) {
