...
func (m *DerivedCredentialsRequestBuilder) Count()(*DerivedCredentialsCountRequestBuilder) {
    return NewDerivedCredentialsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation collection of Derived credential settings associated with account.
func (m *DerivedCredentialsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DerivedCredentialsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
