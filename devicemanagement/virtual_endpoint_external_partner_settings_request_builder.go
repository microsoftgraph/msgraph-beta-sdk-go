...
// VirtualEndpointExternalPartnerSettingsRequestBuilderGetQueryParameters get a list of the cloudPcExternalPartnerSetting objects and their properties. This API is available in the following national cloud deployments.
...
// Get get a list of the cloudPcExternalPartnerSetting objects and their properties. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Post create a new cloudPcExternalPartnerSetting object. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get a list of the cloudPcExternalPartnerSetting objects and their properties. This API is available in the following national cloud deployments.
...
// ToPostRequestInformation create a new cloudPcExternalPartnerSetting object. This API is available in the following national cloud deployments.
