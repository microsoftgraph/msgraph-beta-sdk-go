...
func NewManageddevicesItemSyncdeviceSyncDeviceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManageddevicesItemSyncdeviceSyncDeviceRequestBuilder) {
    m := &ManageddevicesItemSyncdeviceSyncDeviceRequestBuilder{
...
func NewManageddevicesItemSyncdeviceSyncDeviceRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManageddevicesItemSyncdeviceSyncDeviceRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewManageddevicesItemSyncdeviceSyncDeviceRequestBuilderInternal(urlParams, requestAdapter)
}
// Post invoke action syncDevice
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ManageddevicesItemSyncdeviceSyncDeviceRequestBuilder) Post(ctx context.Context, requestConfiguration *ManageddevicesItemSyncdeviceSyncDeviceRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ManageddevicesItemSyncdeviceSyncDeviceRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *ManageddevicesItemSyncdeviceSyncDeviceRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ManageddevicesItemSyncdeviceSyncDeviceRequestBuilder) WithUrl(rawUrl string)(*ManageddevicesItemSyncdeviceSyncDeviceRequestBuilder) {
    return NewManageddevicesItemSyncdeviceSyncDeviceRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
