...
func (m *SendCustomNotificationToCompanyPortalRequestBuilder) WithUrl(rawUrl string)(*SendCustomNotificationToCompanyPortalRequestBuilder) {
    return NewSendCustomNotificationToCompanyPortalRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
