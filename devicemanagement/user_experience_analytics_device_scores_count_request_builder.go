...
func (m *UserExperienceAnalyticsDeviceScoresCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsDeviceScoresCountRequestBuilderGetRequestConfiguration)(*int64, error) {
