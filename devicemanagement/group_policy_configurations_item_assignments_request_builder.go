...
// NewGroupPolicyConfigurationsItemAssignmentsRequestBuilder instantiates a new AssignmentsRequestBuilder and sets the default values.
...
func (m *GroupPolicyConfigurationsItemAssignmentsRequestBuilder) Count()(*GroupPolicyConfigurationsItemAssignmentsCountRequestBuilder) {
    return NewGroupPolicyConfigurationsItemAssignmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the list of group assignments for the configuration.
func (m *GroupPolicyConfigurationsItemAssignmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GroupPolicyConfigurationsItemAssignmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
