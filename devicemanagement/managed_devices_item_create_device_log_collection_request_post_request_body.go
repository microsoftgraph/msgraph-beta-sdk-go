...
// ManagedDevicesItemCreateDeviceLogCollectionRequestPostRequestBody provides operations to call the createDeviceLogCollectionRequest method.
...
func (m *ManagedDevicesItemCreateDeviceLogCollectionRequestPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ManagedDevicesItemCreateDeviceLogCollectionRequestPostRequestBody) SetAdditionalData(value map[string]interface{})() {
