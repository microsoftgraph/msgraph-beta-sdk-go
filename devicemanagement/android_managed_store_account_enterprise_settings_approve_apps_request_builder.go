...
// NewAndroidManagedStoreAccountEnterpriseSettingsApproveAppsRequestBuilderInternal instantiates a new AndroidManagedStoreAccountEnterpriseSettingsApproveAppsRequestBuilder and sets the default values.
...
// NewAndroidManagedStoreAccountEnterpriseSettingsApproveAppsRequestBuilder instantiates a new AndroidManagedStoreAccountEnterpriseSettingsApproveAppsRequestBuilder and sets the default values.
...
func (m *AndroidManagedStoreAccountEnterpriseSettingsApproveAppsRequestBuilder) WithUrl(rawUrl string)(*AndroidManagedStoreAccountEnterpriseSettingsApproveAppsRequestBuilder) {
    return NewAndroidManagedStoreAccountEnterpriseSettingsApproveAppsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
