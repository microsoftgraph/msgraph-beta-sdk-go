...
// NewCompliancePoliciesItemAssignmentsRequestBuilderInternal instantiates a new AssignmentsRequestBuilder and sets the default values.
...
// NewCompliancePoliciesItemAssignmentsRequestBuilder instantiates a new AssignmentsRequestBuilder and sets the default values.
...
func (m *CompliancePoliciesItemAssignmentsRequestBuilder) Count()(*CompliancePoliciesItemAssignmentsCountRequestBuilder) {
    return NewCompliancePoliciesItemAssignmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation policy assignments
func (m *CompliancePoliciesItemAssignmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompliancePoliciesItemAssignmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
