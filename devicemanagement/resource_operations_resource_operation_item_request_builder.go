...
func (m *ResourceOperationsResourceOperationItemRequestBuilder) MicrosoftGraphGetScopesForUserWithUserid(userid *string)(*ResourceOperationsItemMicrosoftGraphGetScopesForUserWithUseridRequestBuilder) {
    return NewResourceOperationsItemMicrosoftGraphGetScopesForUserWithUseridRequestBuilderInternal(m.pathParameters, m.requestAdapter, userid)
}
