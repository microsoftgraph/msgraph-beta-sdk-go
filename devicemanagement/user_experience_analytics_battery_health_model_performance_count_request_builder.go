...
func (m *UserExperienceAnalyticsBatteryHealthModelPerformanceCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsBatteryHealthModelPerformanceCountRequestBuilderGetRequestConfiguration)(*int64, error) {
