...
// DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody 
type DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody struct {
...
// NewDeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody instantiates a new DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody and sets the default values.
func NewDeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody()(*DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) {
    m := &DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateDeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateDeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewDeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) GetDeviceManagementScriptAssignments()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementScriptAssignmentable) {
...
func (m *DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) GetDeviceManagementScriptGroupAssignments()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementScriptGroupAssignmentable) {
    return m.deviceManagementScriptGroupAssignments
}
// GetFieldDeserializers the deserialization information for the current model
func (m *DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) SetDeviceManagementScriptAssignments(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementScriptAssignmentable)() {
...
func (m *DeviceCustomAttributeShellScriptsItemMicrosoftGraphAssignAssignPostRequestBody) SetDeviceManagementScriptGroupAssignments(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementScriptGroupAssignmentable)() {
