...
// NewTemplatesItemMigratableToItemCategoriesRequestBuilderInternal instantiates a new CategoriesRequestBuilder and sets the default values.
...
// NewTemplatesItemMigratableToItemCategoriesRequestBuilder instantiates a new CategoriesRequestBuilder and sets the default values.
...
func (m *TemplatesItemMigratableToItemCategoriesRequestBuilder) Count()(*TemplatesItemMigratableToItemCategoriesCountRequestBuilder) {
    return NewTemplatesItemMigratableToItemCategoriesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation collection of setting categories within the template
func (m *TemplatesItemMigratableToItemCategoriesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *TemplatesItemMigratableToItemCategoriesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
