...
// ByGroupPolicyOperationIdString provides operations to manage the groupPolicyOperations property of the microsoft.graph.groupPolicyUploadedDefinitionFile entity.
func (m *GroupPolicyUploadedDefinitionFilesItemGroupPolicyOperationsRequestBuilder) ByGroupPolicyOperationIdString(groupPolicyOperationId string)(*GroupPolicyUploadedDefinitionFilesItemGroupPolicyOperationsGroupPolicyOperationItemRequestBuilder) {
