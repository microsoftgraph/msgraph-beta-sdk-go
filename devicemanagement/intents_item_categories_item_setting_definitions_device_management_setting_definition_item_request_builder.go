...
// NewIntentsItemCategoriesItemSettingDefinitionsDeviceManagementSettingDefinitionItemRequestBuilderInternal instantiates a new DeviceManagementSettingDefinitionItemRequestBuilder and sets the default values.
func NewIntentsItemCategoriesItemSettingDefinitionsDeviceManagementSettingDefinitionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IntentsItemCategoriesItemSettingDefinitionsDeviceManagementSettingDefinitionItemRequestBuilder) {
    m := &IntentsItemCategoriesItemSettingDefinitionsDeviceManagementSettingDefinitionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/categories/{deviceManagementIntentSettingCategory%2Did}/settingDefinitions/{deviceManagementSettingDefinition%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewIntentsItemCategoriesItemSettingDefinitionsDeviceManagementSettingDefinitionItemRequestBuilder instantiates a new DeviceManagementSettingDefinitionItemRequestBuilder and sets the default values.
