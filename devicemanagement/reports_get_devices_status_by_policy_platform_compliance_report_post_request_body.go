...
// NewReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody instantiates a new ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody and sets the default values.
func NewReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody()(*ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) {
    m := &ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody{
    }
...
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) GetSelect()([]string) {
...
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetFilter sets the filter property value. The filter property
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) SetFilter(value *string)() {
...
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) SetGroupBy(value []string)() {
...
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) SetOrderBy(value []string)() {
...
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) SetSearch(value *string)() {
...
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) SetSelect(value []string)() {
...
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) SetSessionId(value *string)() {
...
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) SetSkip(value *int32)() {
...
func (m *ReportsGetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody) SetTop(value *int32)() {
