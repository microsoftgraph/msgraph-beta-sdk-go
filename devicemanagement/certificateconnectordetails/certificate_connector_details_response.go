...
// CertificateConnectorDetailsResponse 
...
// NewCertificateConnectorDetailsResponse instantiates a new certificateConnectorDetailsResponse and sets the default values.
