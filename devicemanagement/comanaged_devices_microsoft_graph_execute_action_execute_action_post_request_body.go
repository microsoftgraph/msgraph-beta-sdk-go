...
// ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody 
type ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody struct {
...
// NewComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody instantiates a new ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody and sets the default values.
func NewComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody()(*ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) {
    m := &ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody(), nil
}
// GetActionName gets the actionName property value. The actionName property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetActionName()(*ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ManagedDeviceRemoteAction) {
    return m.actionName
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCarrierUrl gets the carrierUrl property value. The carrierUrl property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetCarrierUrl()(*string) {
    return m.carrierUrl
}
// GetDeprovisionReason gets the deprovisionReason property value. The deprovisionReason property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetDeprovisionReason()(*string) {
    return m.deprovisionReason
}
// GetDeviceIds gets the deviceIds property value. The deviceIds property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetDeviceIds()([]string) {
    return m.deviceIds
}
// GetDeviceName gets the deviceName property value. The deviceName property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetDeviceName()(*string) {
    return m.deviceName
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetKeepEnrollmentData()(*bool) {
    return m.keepEnrollmentData
}
// GetKeepUserData gets the keepUserData property value. The keepUserData property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetKeepUserData()(*bool) {
    return m.keepUserData
}
// GetNotificationBody gets the notificationBody property value. The notificationBody property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetNotificationBody()(*string) {
    return m.notificationBody
}
// GetNotificationTitle gets the notificationTitle property value. The notificationTitle property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetNotificationTitle()(*string) {
...
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetOrganizationalUnitPath()(*string) {
...
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) GetPersistEsimDataPlan()(*bool) {
    return m.persistEsimDataPlan
}
// Serialize serializes information the current object
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetActionName(value *ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ManagedDeviceRemoteAction)() {
    m.actionName = value
}
// SetAdditionalData sets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCarrierUrl sets the carrierUrl property value. The carrierUrl property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetCarrierUrl(value *string)() {
    m.carrierUrl = value
}
// SetDeprovisionReason sets the deprovisionReason property value. The deprovisionReason property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetDeprovisionReason(value *string)() {
    m.deprovisionReason = value
}
// SetDeviceIds sets the deviceIds property value. The deviceIds property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetDeviceIds(value []string)() {
    m.deviceIds = value
}
// SetDeviceName sets the deviceName property value. The deviceName property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetDeviceName(value *string)() {
    m.deviceName = value
}
// SetKeepEnrollmentData sets the keepEnrollmentData property value. The keepEnrollmentData property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetKeepEnrollmentData(value *bool)() {
    m.keepEnrollmentData = value
}
// SetKeepUserData sets the keepUserData property value. The keepUserData property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetKeepUserData(value *bool)() {
    m.keepUserData = value
}
// SetNotificationBody sets the notificationBody property value. The notificationBody property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetNotificationBody(value *string)() {
    m.notificationBody = value
}
// SetNotificationTitle sets the notificationTitle property value. The notificationTitle property
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetNotificationTitle(value *string)() {
...
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetOrganizationalUnitPath(value *string)() {
...
func (m *ComanagedDevicesMicrosoftGraphExecuteActionExecuteActionPostRequestBody) SetPersistEsimDataPlan(value *bool)() {
