...
func (m *GroupPolicyConfigurationsRequestBuilder) Count()(*GroupPolicyConfigurationsCountRequestBuilder) {
    return NewGroupPolicyConfigurationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *GroupPolicyConfigurationsRequestBuilder) Get(ctx context.Context, requestConfiguration *GroupPolicyConfigurationsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GroupPolicyConfigurationCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateGroupPolicyConfigurationCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
