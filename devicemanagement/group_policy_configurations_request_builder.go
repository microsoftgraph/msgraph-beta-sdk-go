...
// ByGroupPolicyConfigurationIdString provides operations to manage the groupPolicyConfigurations property of the microsoft.graph.deviceManagement entity.
func (m *GroupPolicyConfigurationsRequestBuilder) ByGroupPolicyConfigurationIdString(groupPolicyConfigurationId string)(*GroupPolicyConfigurationsGroupPolicyConfigurationItemRequestBuilder) {
...
func NewGroupPolicyConfigurationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupPolicyConfigurationsRequestBuilder) {
    m := &GroupPolicyConfigurationsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
