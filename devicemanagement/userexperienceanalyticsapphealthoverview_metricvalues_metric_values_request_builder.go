...
func (m *UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder) ByUserExperienceAnalyticsMetricId(userExperienceAnalyticsMetricId string)(*UserexperienceanalyticsapphealthoverviewMetricvaluesUserExperienceAnalyticsMetricItemRequestBuilder) {
...
func NewUserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder) {
    m := &UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder{
...
func NewUserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder) {
    ...
    return NewUserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *UserexperienceanalyticsapphealthoverviewMetricvaluesCountRequestBuilder when successful
func (m *UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder) Count()(*UserexperienceanalyticsapphealthoverviewMetricvaluesCountRequestBuilder) {
...
func (m *UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsMetricCollectionResponseable, error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsMetricable, requestConfiguration *UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsMetricable, error) {
...
func (m *UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsMetricable, requestConfiguration *UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder) {
    return NewUserexperienceanalyticsapphealthoverviewMetricvaluesMetricValuesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
