...
func NewTemplateSettingsDeviceManagementConfigurationSettingTemplateItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, deviceManagementConfigurationSettingTemplateId *string)(*TemplateSettingsDeviceManagementConfigurationSettingTemplateItemRequestBuilder) {
    ...
    if deviceManagementConfigurationSettingTemplateId != nil {
...
func NewTemplateSettingsDeviceManagementConfigurationSettingTemplateItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TemplateSettingsDeviceManagementConfigurationSettingTemplateItemRequestBuilder) {
    ...
    return NewTemplateSettingsDeviceManagementConfigurationSettingTemplateItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *TemplateSettingsDeviceManagementConfigurationSettingTemplateItemRequestBuilder) SettingDefinitionsById(id string)(*TemplateSettingsItemSettingDefinitionsDeviceManagementConfigurationSettingDefinitionItemRequestBuilder) {
    ...
    idPtr := &id
    return NewTemplateSettingsItemSettingDefinitionsDeviceManagementConfigurationSettingDefinitionItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
