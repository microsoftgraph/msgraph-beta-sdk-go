...
func (m *DeviceCompliancePoliciesItemUserStatusesRequestBuilder) Count()(*DeviceCompliancePoliciesItemUserStatusesCountRequestBuilder) {
    return NewDeviceCompliancePoliciesItemUserStatusesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list of DeviceComplianceUserStatus.
func (m *DeviceCompliancePoliciesItemUserStatusesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DeviceCompliancePoliciesItemUserStatusesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
