...
func NewDomainJoinConnectorsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DomainJoinConnectorsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/domainJoinConnectors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *DomainJoinConnectorsRequestBuilder) Count()(*DomainJoinConnectorsCountRequestBuilder) {
    return NewDomainJoinConnectorsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation a list of connector objects.
func (m *DomainJoinConnectorsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DomainJoinConnectorsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DomainJoinConnectorsRequestBuilder) Get(ctx context.Context, requestConfiguration *DomainJoinConnectorsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementDomainJoinConnectorCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceManagementDomainJoinConnectorCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
