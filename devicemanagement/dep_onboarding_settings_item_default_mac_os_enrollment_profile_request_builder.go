...
// NewDepOnboardingSettingsItemDefaultMacOsEnrollmentProfileRequestBuilderInternal instantiates a new DepOnboardingSettingsItemDefaultMacOsEnrollmentProfileRequestBuilder and sets the default values.
...
// NewDepOnboardingSettingsItemDefaultMacOsEnrollmentProfileRequestBuilder instantiates a new DepOnboardingSettingsItemDefaultMacOsEnrollmentProfileRequestBuilder and sets the default values.
...
func (m *DepOnboardingSettingsItemDefaultMacOsEnrollmentProfileRequestBuilder) WithUrl(rawUrl string)(*DepOnboardingSettingsItemDefaultMacOsEnrollmentProfileRequestBuilder) {
    return NewDepOnboardingSettingsItemDefaultMacOsEnrollmentProfileRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
