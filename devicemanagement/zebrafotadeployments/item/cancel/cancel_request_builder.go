...
func (m *CancelRequestBuilder) Post(ctx context.Context, requestConfiguration *CancelRequestBuilderPostRequestConfiguration)(CancelResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateCancelResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
