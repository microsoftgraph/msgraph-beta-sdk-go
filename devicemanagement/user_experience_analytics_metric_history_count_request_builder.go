...
func (m *UserExperienceAnalyticsMetricHistoryCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsMetricHistoryCountRequestBuilderGetRequestConfiguration)(*int64, error) {
