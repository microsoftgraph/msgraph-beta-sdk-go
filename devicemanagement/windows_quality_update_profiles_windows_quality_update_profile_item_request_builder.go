...
func (m *WindowsQualityUpdateProfilesWindowsQualityUpdateProfileItemRequestBuilder) MicrosoftGraphAssign()(*WindowsQualityUpdateProfilesItemMicrosoftGraphAssignRequestBuilder) {
    return NewWindowsQualityUpdateProfilesItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
