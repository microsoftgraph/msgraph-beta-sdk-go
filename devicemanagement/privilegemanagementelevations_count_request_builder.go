...
// NewPrivilegemanagementelevationsCountRequestBuilderInternal instantiates a new PrivilegemanagementelevationsCountRequestBuilder and sets the default values.
func NewPrivilegemanagementelevationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegemanagementelevationsCountRequestBuilder) {
    m := &PrivilegemanagementelevationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/privilegeManagementElevations/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewPrivilegemanagementelevationsCountRequestBuilder instantiates a new PrivilegemanagementelevationsCountRequestBuilder and sets the default values.
...
func (m *PrivilegemanagementelevationsCountRequestBuilder) WithUrl(rawUrl string)(*PrivilegemanagementelevationsCountRequestBuilder) {
    return NewPrivilegemanagementelevationsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
