...
func (m *ZebraFotaConnectorRequestBuilder) MicrosoftGraphApproveFotaApps()(*ZebraFotaConnectorMicrosoftGraphApproveFotaAppsRequestBuilder) {
    return NewZebraFotaConnectorMicrosoftGraphApproveFotaAppsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphConnect provides operations to call the connect method.
func (m *ZebraFotaConnectorRequestBuilder) MicrosoftGraphConnect()(*ZebraFotaConnectorMicrosoftGraphConnectRequestBuilder) {
    return NewZebraFotaConnectorMicrosoftGraphConnectRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDisconnect provides operations to call the disconnect method.
func (m *ZebraFotaConnectorRequestBuilder) MicrosoftGraphDisconnect()(*ZebraFotaConnectorMicrosoftGraphDisconnectRequestBuilder) {
    return NewZebraFotaConnectorMicrosoftGraphDisconnectRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphHasActiveDeployments provides operations to call the hasActiveDeployments method.
func (m *ZebraFotaConnectorRequestBuilder) MicrosoftGraphHasActiveDeployments()(*ZebraFotaConnectorMicrosoftGraphHasActiveDeploymentsRequestBuilder) {
    return NewZebraFotaConnectorMicrosoftGraphHasActiveDeploymentsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
