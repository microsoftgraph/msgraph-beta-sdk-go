...
func (m *ZebraFotaConnectorRequestBuilder) Get(ctx context.Context, requestConfiguration *ZebraFotaConnectorRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ZebraFotaConnectorable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateZebraFotaConnectorFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphApproveFotaApps provides operations to call the approveFotaApps method.
func (m *ZebraFotaConnectorRequestBuilder) MicrosoftGraphApproveFotaApps()(*ZebraFotaConnectorMicrosoftGraphApproveFotaAppsApproveFotaAppsRequestBuilder) {
    return NewZebraFotaConnectorMicrosoftGraphApproveFotaAppsApproveFotaAppsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphConnect provides operations to call the connect method.
func (m *ZebraFotaConnectorRequestBuilder) MicrosoftGraphConnect()(*ZebraFotaConnectorMicrosoftGraphConnectConnectRequestBuilder) {
    return NewZebraFotaConnectorMicrosoftGraphConnectConnectRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDisconnect provides operations to call the disconnect method.
func (m *ZebraFotaConnectorRequestBuilder) MicrosoftGraphDisconnect()(*ZebraFotaConnectorMicrosoftGraphDisconnectDisconnectRequestBuilder) {
    return NewZebraFotaConnectorMicrosoftGraphDisconnectDisconnectRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphHasActiveDeployments provides operations to call the hasActiveDeployments method.
func (m *ZebraFotaConnectorRequestBuilder) MicrosoftGraphHasActiveDeployments()(*ZebraFotaConnectorMicrosoftGraphHasActiveDeploymentsHasActiveDeploymentsRequestBuilder) {
    return NewZebraFotaConnectorMicrosoftGraphHasActiveDeploymentsHasActiveDeploymentsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
