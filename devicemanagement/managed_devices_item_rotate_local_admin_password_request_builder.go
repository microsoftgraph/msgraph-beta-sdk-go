...
// NewManagedDevicesItemRotateLocalAdminPasswordRequestBuilderInternal instantiates a new RotateLocalAdminPasswordRequestBuilder and sets the default values.
func NewManagedDevicesItemRotateLocalAdminPasswordRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedDevicesItemRotateLocalAdminPasswordRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/rotateLocalAdminPassword";
...
// NewManagedDevicesItemRotateLocalAdminPasswordRequestBuilder instantiates a new RotateLocalAdminPasswordRequestBuilder and sets the default values.
