...
// GetSupportedPropertiesRequestBuilderGetQueryParameters invoke function getSupportedProperties
type GetSupportedPropertiesRequestBuilderGetQueryParameters struct {
...
type GetSupportedPropertiesRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *GetSupportedPropertiesRequestBuilderGetQueryParameters
}
...
func (m *GetSupportedPropertiesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GetSupportedPropertiesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetSupportedPropertiesRequestBuilder) Get(ctx context.Context, requestConfiguration *GetSupportedPropertiesRequestBuilderGetRequestConfiguration)(GetSupportedPropertiesResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGetSupportedPropertiesResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
