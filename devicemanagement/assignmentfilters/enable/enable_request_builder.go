...
func (m *EnableRequestBuilder) CreatePostRequestInformation(body EnableRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EnableRequestBuilder) Post(body EnableRequestBodyable)(error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action enable
func (m *EnableRequestBuilder) PostWithRequestConfigurationAndResponseHandler(body EnableRequestBodyable, requestConfiguration *EnableRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
