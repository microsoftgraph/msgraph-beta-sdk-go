...
// ComanagedDevicesBulkSetCloudPcReviewStatusPostRequestBody provides operations to call the bulkSetCloudPcReviewStatus method.
...
func (m *ComanagedDevicesBulkSetCloudPcReviewStatusPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ComanagedDevicesBulkSetCloudPcReviewStatusPostRequestBody) SetAdditionalData(value map[string]interface{})() {
