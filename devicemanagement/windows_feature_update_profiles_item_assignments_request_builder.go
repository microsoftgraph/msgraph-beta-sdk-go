...
// NewWindowsFeatureUpdateProfilesItemAssignmentsRequestBuilderInternal instantiates a new AssignmentsRequestBuilder and sets the default values.
...
// NewWindowsFeatureUpdateProfilesItemAssignmentsRequestBuilder instantiates a new AssignmentsRequestBuilder and sets the default values.
...
func (m *WindowsFeatureUpdateProfilesItemAssignmentsRequestBuilder) Count()(*WindowsFeatureUpdateProfilesItemAssignmentsCountRequestBuilder) {
    return NewWindowsFeatureUpdateProfilesItemAssignmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the list of group assignments of the profile.
func (m *WindowsFeatureUpdateProfilesItemAssignmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *WindowsFeatureUpdateProfilesItemAssignmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
