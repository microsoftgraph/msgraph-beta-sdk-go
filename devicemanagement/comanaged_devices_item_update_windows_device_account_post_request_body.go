...
// ComanagedDevicesItemUpdateWindowsDeviceAccountPostRequestBody provides operations to call the updateWindowsDeviceAccount method.
...
func (m *ComanagedDevicesItemUpdateWindowsDeviceAccountPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ComanagedDevicesItemUpdateWindowsDeviceAccountPostRequestBody) SetAdditionalData(value map[string]interface{})() {
