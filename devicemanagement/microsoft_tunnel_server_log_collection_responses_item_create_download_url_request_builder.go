...
// NewMicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlRequestBuilderInternal instantiates a new MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlRequestBuilder and sets the default values.
...
// NewMicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlRequestBuilder instantiates a new MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlRequestBuilder and sets the default values.
...
// returns a MicrosoftTunnelServerLogCollectionResponsesItemCreateDownloadUrlPostResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
