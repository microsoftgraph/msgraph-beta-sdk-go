...
func (m *MicrosoftTunnelConfigurationsRequestBuilder) WithUrl(rawUrl string)(*MicrosoftTunnelConfigurationsRequestBuilder) {
    return NewMicrosoftTunnelConfigurationsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
