...
func (m *IntentsItemCategoriesItemSettingsDeviceManagementSettingInstanceItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *IntentsItemCategoriesItemSettingsDeviceManagementSettingInstanceItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
