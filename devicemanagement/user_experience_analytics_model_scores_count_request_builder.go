...
func (m *UserExperienceAnalyticsModelScoresCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsModelScoresCountRequestBuilderGetRequestConfiguration)(*int64, error) {
