...
// ComanagedDevicesExecuteActionPostRequestBody provides operations to call the executeAction method.
...
func (m *ComanagedDevicesExecuteActionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ComanagedDevicesExecuteActionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
