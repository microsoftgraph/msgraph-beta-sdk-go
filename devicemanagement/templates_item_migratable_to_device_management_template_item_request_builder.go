...
func (m *TemplatesItemMigratableToDeviceManagementTemplateItemRequestBuilder) MicrosoftGraphCompareWithTemplateId(templateId *string)(*TemplatesItemMigratableToItemMicrosoftGraphCompareWithTemplateIdRequestBuilder) {
    return NewTemplatesItemMigratableToItemMicrosoftGraphCompareWithTemplateIdRequestBuilderInternal(m.pathParameters, m.requestAdapter, templateId)
}
// MicrosoftGraphCreateInstance provides operations to call the createInstance method.
func (m *TemplatesItemMigratableToDeviceManagementTemplateItemRequestBuilder) MicrosoftGraphCreateInstance()(*TemplatesItemMigratableToItemMicrosoftGraphCreateInstanceRequestBuilder) {
    return NewTemplatesItemMigratableToItemMicrosoftGraphCreateInstanceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
