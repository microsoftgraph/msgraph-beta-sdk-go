...
func (m *ResourceAccessProfilesItemAssignmentsDeviceManagementResourceAccessProfileAssignmentItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ResourceAccessProfilesItemAssignmentsDeviceManagementResourceAccessProfileAssignmentItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
