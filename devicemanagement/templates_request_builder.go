...
func (m *TemplatesRequestBuilder) Count()(*TemplatesCountRequestBuilder) {
    return NewTemplatesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get the available templates
func (m *TemplatesRequestBuilder) Get(ctx context.Context, requestConfiguration *TemplatesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementTemplateCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceManagementTemplateCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphImportOffice365DeviceConfigurationPolicies provides operations to call the importOffice365DeviceConfigurationPolicies method.
func (m *TemplatesRequestBuilder) MicrosoftGraphImportOffice365DeviceConfigurationPolicies()(*TemplatesMicrosoftGraphImportOffice365DeviceConfigurationPoliciesImportOffice365DeviceConfigurationPoliciesRequestBuilder) {
    return NewTemplatesMicrosoftGraphImportOffice365DeviceConfigurationPoliciesImportOffice365DeviceConfigurationPoliciesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// ToPostRequestInformation create new navigation property to templates for deviceManagement
