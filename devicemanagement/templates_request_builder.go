...
func (m *TemplatesRequestBuilder) MicrosoftGraphImportOffice365DeviceConfigurationPolicies()(*TemplatesMicrosoftGraphImportOffice365DeviceConfigurationPoliciesRequestBuilder) {
    return NewTemplatesMicrosoftGraphImportOffice365DeviceConfigurationPoliciesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
