...
// UserExperienceAnalyticsAppHealthOverviewMetricValuesRequestBuilderGetQueryParameters the metric values for the user experience analytics category.
...
func (m *UserExperienceAnalyticsAppHealthOverviewMetricValuesRequestBuilder) Count()(*UserExperienceAnalyticsAppHealthOverviewMetricValuesCountRequestBuilder) {
    return NewUserExperienceAnalyticsAppHealthOverviewMetricValuesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *UserExperienceAnalyticsAppHealthOverviewMetricValuesRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsAppHealthOverviewMetricValuesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsMetricCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateUserExperienceAnalyticsMetricCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
