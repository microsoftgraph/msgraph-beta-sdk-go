...
func (m *WindowsDriverUpdateProfilesWindowsDriverUpdateProfileItemRequestBuilder) AssignmentsById(id string)(*WindowsDriverUpdateProfilesItemAssignmentsWindowsDriverUpdateProfileAssignmentItemRequestBuilder) {
    ...
    idPtr := &id
    return NewWindowsDriverUpdateProfilesItemAssignmentsWindowsDriverUpdateProfileAssignmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewWindowsDriverUpdateProfilesWindowsDriverUpdateProfileItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, windowsDriverUpdateProfileId *string)(*WindowsDriverUpdateProfilesWindowsDriverUpdateProfileItemRequestBuilder) {
    ...
    if windowsDriverUpdateProfileId != nil {
...
func NewWindowsDriverUpdateProfilesWindowsDriverUpdateProfileItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsDriverUpdateProfilesWindowsDriverUpdateProfileItemRequestBuilder) {
    ...
    return NewWindowsDriverUpdateProfilesWindowsDriverUpdateProfileItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *WindowsDriverUpdateProfilesWindowsDriverUpdateProfileItemRequestBuilder) DriverInventoriesById(id string)(*WindowsDriverUpdateProfilesItemDriverInventoriesWindowsDriverUpdateInventoryItemRequestBuilder) {
    ...
    idPtr := &id
    return NewWindowsDriverUpdateProfilesItemDriverInventoriesWindowsDriverUpdateInventoryItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *WindowsDriverUpdateProfilesWindowsDriverUpdateProfileItemRequestBuilder) MicrosoftGraphAssign()(*WindowsDriverUpdateProfilesItemMicrosoftGraphAssignAssignRequestBuilder) {
    return NewWindowsDriverUpdateProfilesItemMicrosoftGraphAssignAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphExecuteAction provides operations to call the executeAction method.
func (m *WindowsDriverUpdateProfilesWindowsDriverUpdateProfileItemRequestBuilder) MicrosoftGraphExecuteAction()(*WindowsDriverUpdateProfilesItemMicrosoftGraphExecuteActionExecuteActionRequestBuilder) {
    return NewWindowsDriverUpdateProfilesItemMicrosoftGraphExecuteActionExecuteActionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSyncInventory provides operations to call the syncInventory method.
func (m *WindowsDriverUpdateProfilesWindowsDriverUpdateProfileItemRequestBuilder) MicrosoftGraphSyncInventory()(*WindowsDriverUpdateProfilesItemMicrosoftGraphSyncInventorySyncInventoryRequestBuilder) {
    return NewWindowsDriverUpdateProfilesItemMicrosoftGraphSyncInventorySyncInventoryRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
