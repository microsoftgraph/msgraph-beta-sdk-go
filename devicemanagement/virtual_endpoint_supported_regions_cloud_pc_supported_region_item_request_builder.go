...
func NewVirtualEndpointSupportedRegionsCloudPcSupportedRegionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointSupportedRegionsCloudPcSupportedRegionItemRequestBuilder) {
    m := &VirtualEndpointSupportedRegionsCloudPcSupportedRegionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/supportedRegions/{cloudPcSupportedRegion%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *VirtualEndpointSupportedRegionsCloudPcSupportedRegionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *VirtualEndpointSupportedRegionsCloudPcSupportedRegionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
