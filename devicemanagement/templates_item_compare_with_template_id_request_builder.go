...
// TemplatesItemCompareWithTemplateIdRequestBuilder provides operations to call the compare method.
type TemplatesItemCompareWithTemplateIdRequestBuilder struct {
...
// TemplatesItemCompareWithTemplateIdRequestBuilderGetQueryParameters invoke function compare
type TemplatesItemCompareWithTemplateIdRequestBuilderGetQueryParameters struct {
...
// TemplatesItemCompareWithTemplateIdRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type TemplatesItemCompareWithTemplateIdRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
func (m *TemplatesItemCompareWithTemplateIdRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *TemplatesItemCompareWithTemplateIdRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *TemplatesItemCompareWithTemplateIdRequestBuilder) Get(ctx context.Context, requestConfiguration *TemplatesItemCompareWithTemplateIdRequestBuilderGetRequestConfiguration)(TemplatesItemCompareWithTemplateIdResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateTemplatesItemCompareWithTemplateIdResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
