...
// VirtualEndpointSupportedRegionsRequestBuilderGetQueryParameters list the supported regions that are available for creating Cloud PC connections. This API is supported in the following national cloud deployments.
...
// Get list the supported regions that are available for creating Cloud PC connections. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation list the supported regions that are available for creating Cloud PC connections. This API is supported in the following national cloud deployments.
