...
func (m *WindowsFeatureUpdateProfilesWindowsFeatureUpdateProfileItemRequestBuilder) MicrosoftGraphAssign()(*WindowsFeatureUpdateProfilesItemMicrosoftGraphAssignRequestBuilder) {
    return NewWindowsFeatureUpdateProfilesItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
