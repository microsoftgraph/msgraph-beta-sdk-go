...
func (m *VirtualEndpointOrganizationSettingsRequestBuilder) Delete(ctx context.Context, requestConfiguration *VirtualEndpointOrganizationSettingsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
