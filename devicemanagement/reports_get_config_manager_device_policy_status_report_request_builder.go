...
// NewReportsGetConfigManagerDevicePolicyStatusReportRequestBuilderInternal instantiates a new ReportsGetConfigManagerDevicePolicyStatusReportRequestBuilder and sets the default values.
...
// NewReportsGetConfigManagerDevicePolicyStatusReportRequestBuilder instantiates a new ReportsGetConfigManagerDevicePolicyStatusReportRequestBuilder and sets the default values.
...
func (m *ReportsGetConfigManagerDevicePolicyStatusReportRequestBuilder) WithUrl(rawUrl string)(*ReportsGetConfigManagerDevicePolicyStatusReportRequestBuilder) {
    return NewReportsGetConfigManagerDevicePolicyStatusReportRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
