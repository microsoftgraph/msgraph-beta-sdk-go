...
// GetAuditActivityTypesWithCategoryRequestBuilder builds and executes requests for operations under \deviceManagement\auditEvents\microsoft.graph.getAuditActivityTypes(category='{category}')
...
func (m *GetAuditActivityTypesWithCategoryRequestBuilder) Get(options *GetAuditActivityTypesWithCategoryRequestBuilderGetOptions)([]string, error) {
