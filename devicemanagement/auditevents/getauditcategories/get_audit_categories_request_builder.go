...
func (m *GetAuditCategoriesRequestBuilder) CreateGetRequestInformationWithRequestConfiguration()(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// GetWithResponseHandler invoke function getAuditCategories
func (m *GetAuditCategoriesRequestBuilder) GetWithResponseHandler(requestConfiguration *GetAuditCategoriesRequestBuilderGetRequestConfiguration)(GetAuditCategoriesResponseable, error) {
    return m.GetWithResponseHandler(requestConfiguration, nil);
}
// GetWithResponseHandler invoke function getAuditCategories
func (m *GetAuditCategoriesRequestBuilder) GetWithResponseHandler(requestConfiguration *GetAuditCategoriesRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(GetAuditCategoriesResponseable, error) {
