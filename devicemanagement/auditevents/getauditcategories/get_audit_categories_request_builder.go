...
// GetAuditCategoriesRequestBuilder builds and executes requests for operations under \deviceManagement\auditEvents\microsoft.graph.getAuditCategories()
...
func (m *GetAuditCategoriesRequestBuilder) Get(options *GetAuditCategoriesRequestBuilderGetOptions)([]string, error) {
