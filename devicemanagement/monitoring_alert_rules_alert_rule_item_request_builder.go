...
func (m *MonitoringAlertRulesAlertRuleItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *MonitoringAlertRulesAlertRuleItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
...
// ToPatchRequestInformation update the navigation property alertRules in deviceManagement
