...
// Builds and executes requests for operations under \deviceManagement\microsoftTunnelSites\{microsoftTunnelSite-id}\microsoftTunnelServers\{microsoftTunnelServer-id}\microsoft.graph.createServerLogCollectionRequest
...
// Union type wrapper for classes microsoftTunnelServerLogCollectionResponse
...
// Gets the microsoftTunnelServerLogCollectionResponse property value. Union type representation for type microsoftTunnelServerLogCollectionResponse
...
// Sets the microsoftTunnelServerLogCollectionResponse property value. Union type representation for type microsoftTunnelServerLogCollectionResponse
// Parameters:
//  - value : Value to set for the microsoftTunnelServerLogCollectionResponse property.
...
func (m *CreateServerLogCollectionRequestRequestBuilder) Post(options *CreateServerLogCollectionRequestRequestBuilderPostOptions)(*CreateServerLogCollectionRequestResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewCreateServerLogCollectionRequestResponse() }, nil)
    if err != nil {
        return nil, err
    }
