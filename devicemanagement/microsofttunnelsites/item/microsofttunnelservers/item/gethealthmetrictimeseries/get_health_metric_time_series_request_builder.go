...
// GetHealthMetricTimeSeriesRequestBuilder builds and executes requests for operations under \deviceManagement\microsoftTunnelSites\{microsoftTunnelSite-id}\microsoftTunnelServers\{microsoftTunnelServer-id}\microsoft.graph.getHealthMetricTimeSeries
