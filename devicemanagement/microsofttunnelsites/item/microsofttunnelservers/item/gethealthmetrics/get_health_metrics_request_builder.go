...
func (m *GetHealthMetricsRequestBuilder) CreatePostRequestInformation(ctx context.Context, body GetHealthMetricsPostRequestBodyable, requestConfiguration *GetHealthMetricsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GetHealthMetricsRequestBuilder) Post(ctx context.Context, body GetHealthMetricsPostRequestBodyable, requestConfiguration *GetHealthMetricsRequestBuilderPostRequestConfiguration)(GetHealthMetricsResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateGetHealthMetricsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
