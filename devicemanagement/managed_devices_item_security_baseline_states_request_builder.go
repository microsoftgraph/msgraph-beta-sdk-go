...
// NewManagedDevicesItemSecurityBaselineStatesRequestBuilderInternal instantiates a new SecurityBaselineStatesRequestBuilder and sets the default values.
...
// NewManagedDevicesItemSecurityBaselineStatesRequestBuilder instantiates a new SecurityBaselineStatesRequestBuilder and sets the default values.
...
func (m *ManagedDevicesItemSecurityBaselineStatesRequestBuilder) Count()(*ManagedDevicesItemSecurityBaselineStatesCountRequestBuilder) {
    return NewManagedDevicesItemSecurityBaselineStatesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation security baseline states for this device.
func (m *ManagedDevicesItemSecurityBaselineStatesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ManagedDevicesItemSecurityBaselineStatesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
