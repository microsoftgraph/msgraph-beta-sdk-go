...
func (m *NotificationMessageTemplatesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *NotificationMessageTemplatesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
