...
func (m *DepOnboardingSettingsItemEnrollmentProfilesRequestBuilder) Count()(*DepOnboardingSettingsItemEnrollmentProfilesCountRequestBuilder) {
    return NewDepOnboardingSettingsItemEnrollmentProfilesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the enrollment profiles.
func (m *DepOnboardingSettingsItemEnrollmentProfilesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DepOnboardingSettingsItemEnrollmentProfilesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
