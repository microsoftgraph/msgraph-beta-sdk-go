...
func (m *ChromeOSOnboardingSettingsRequestBuilder) MicrosoftGraphConnect()(*ChromeOSOnboardingSettingsMicrosoftGraphConnectRequestBuilder) {
    return NewChromeOSOnboardingSettingsMicrosoftGraphConnectRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDisconnect provides operations to call the disconnect method.
func (m *ChromeOSOnboardingSettingsRequestBuilder) MicrosoftGraphDisconnect()(*ChromeOSOnboardingSettingsMicrosoftGraphDisconnectRequestBuilder) {
    return NewChromeOSOnboardingSettingsMicrosoftGraphDisconnectRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
