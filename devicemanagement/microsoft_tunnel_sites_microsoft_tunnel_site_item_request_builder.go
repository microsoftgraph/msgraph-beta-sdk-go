...
func (m *MicrosoftTunnelSitesMicrosoftTunnelSiteItemRequestBuilder) Get(ctx context.Context, requestConfiguration *MicrosoftTunnelSitesMicrosoftTunnelSiteItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MicrosoftTunnelSiteable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateMicrosoftTunnelSiteFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *MicrosoftTunnelSitesMicrosoftTunnelSiteItemRequestBuilder) MicrosoftGraphRequestUpgrade()(*MicrosoftTunnelSitesItemMicrosoftGraphRequestUpgradeRequestBuilder) {
    return NewMicrosoftTunnelSitesItemMicrosoftGraphRequestUpgradeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
