...
func NewVirtualEndpointCloudPCsCloudPCItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, cloudPCId *string)(*VirtualEndpointCloudPCsCloudPCItemRequestBuilder) {
...
func NewVirtualEndpointCloudPCsCloudPCItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointCloudPCsCloudPCItemRequestBuilder) {
    ...
    return NewVirtualEndpointCloudPCsCloudPCItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphChangeUserAccountType()(*VirtualEndpointCloudPCsItemMicrosoftGraphChangeUserAccountTypeChangeUserAccountTypeRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphChangeUserAccountTypeChangeUserAccountTypeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEndGracePeriod provides operations to call the endGracePeriod method.
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphEndGracePeriod()(*VirtualEndpointCloudPCsItemMicrosoftGraphEndGracePeriodEndGracePeriodRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphEndGracePeriodEndGracePeriodRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetCloudPcConnectivityHistory provides operations to call the getCloudPcConnectivityHistory method.
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphGetCloudPcConnectivityHistory()(*VirtualEndpointCloudPCsItemMicrosoftGraphGetCloudPcConnectivityHistoryGetCloudPcConnectivityHistoryRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphGetCloudPcConnectivityHistoryGetCloudPcConnectivityHistoryRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetCloudPcLaunchInfo provides operations to call the getCloudPcLaunchInfo method.
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphGetCloudPcLaunchInfo()(*VirtualEndpointCloudPCsItemMicrosoftGraphGetCloudPcLaunchInfoGetCloudPcLaunchInfoRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphGetCloudPcLaunchInfoGetCloudPcLaunchInfoRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetShiftWorkCloudPcAccessState provides operations to call the getShiftWorkCloudPcAccessState method.
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphGetShiftWorkCloudPcAccessState()(*VirtualEndpointCloudPCsItemMicrosoftGraphGetShiftWorkCloudPcAccessStateGetShiftWorkCloudPcAccessStateRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphGetShiftWorkCloudPcAccessStateGetShiftWorkCloudPcAccessStateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetSupportedCloudPcRemoteActions provides operations to call the getSupportedCloudPcRemoteActions method.
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphGetSupportedCloudPcRemoteActions()(*VirtualEndpointCloudPCsItemMicrosoftGraphGetSupportedCloudPcRemoteActionsGetSupportedCloudPcRemoteActionsRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphGetSupportedCloudPcRemoteActionsGetSupportedCloudPcRemoteActionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphReboot provides operations to call the reboot method.
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphReboot()(*VirtualEndpointCloudPCsItemMicrosoftGraphRebootRebootRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphRebootRebootRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRename provides operations to call the rename method.
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphRename()(*VirtualEndpointCloudPCsItemMicrosoftGraphRenameRenameRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphRenameRenameRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphReprovision provides operations to call the reprovision method.
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphReprovision()(*VirtualEndpointCloudPCsItemMicrosoftGraphReprovisionReprovisionRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphReprovisionReprovisionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRestore provides operations to call the restore method.
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphRestore()(*VirtualEndpointCloudPCsItemMicrosoftGraphRestoreRestoreRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphRestoreRestoreRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRetryPartnerAgentInstallation provides operations to call the retryPartnerAgentInstallation method.
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphRetryPartnerAgentInstallation()(*VirtualEndpointCloudPCsItemMicrosoftGraphRetryPartnerAgentInstallationRetryPartnerAgentInstallationRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphRetryPartnerAgentInstallationRetryPartnerAgentInstallationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphTroubleshoot provides operations to call the troubleshoot method.
func (m *VirtualEndpointCloudPCsCloudPCItemRequestBuilder) MicrosoftGraphTroubleshoot()(*VirtualEndpointCloudPCsItemMicrosoftGraphTroubleshootTroubleshootRequestBuilder) {
    return NewVirtualEndpointCloudPCsItemMicrosoftGraphTroubleshootTroubleshootRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
