...
// NewTemplatesItemCategoriesCountRequestBuilderInternal instantiates a new TemplatesItemCategoriesCountRequestBuilder and sets the default values.
func NewTemplatesItemCategoriesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TemplatesItemCategoriesCountRequestBuilder) {
    m := &TemplatesItemCategoriesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/categories/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewTemplatesItemCategoriesCountRequestBuilder instantiates a new TemplatesItemCategoriesCountRequestBuilder and sets the default values.
