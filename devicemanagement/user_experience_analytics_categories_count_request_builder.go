...
func (m *UserExperienceAnalyticsCategoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsCategoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
