...
func NewDetectedappsItemManageddevicesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DetectedappsItemManageddevicesCountRequestBuilder) {
    m := &DetectedappsItemManageddevicesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/detectedApps/{detectedApp%2Did}/managedDevices/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewDetectedappsItemManageddevicesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DetectedappsItemManageddevicesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDetectedappsItemManageddevicesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *DetectedappsItemManageddevicesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DetectedappsItemManageddevicesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *DetectedappsItemManageddevicesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DetectedappsItemManageddevicesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DetectedappsItemManageddevicesCountRequestBuilder) WithUrl(rawUrl string)(*DetectedappsItemManageddevicesCountRequestBuilder) {
    return NewDetectedappsItemManageddevicesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
