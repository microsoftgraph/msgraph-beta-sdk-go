...
func (m *DeviceManagementScriptsItemAssignmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceManagementScriptsItemAssignmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
