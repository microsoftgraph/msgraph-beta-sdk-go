...
// AndroidForWorkSettingsRequestSignupUrlResponse provides operations to call the requestSignupUrl method.
...
func (m *AndroidForWorkSettingsRequestSignupUrlResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *AndroidForWorkSettingsRequestSignupUrlResponse) SetAdditionalData(value map[string]interface{})() {
