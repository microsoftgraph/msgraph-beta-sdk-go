...
func (m *AndroidDeviceOwnerEnrollmentProfilesAndroidDeviceOwnerEnrollmentProfileItemRequestBuilder) MicrosoftGraphCreateToken()(*AndroidDeviceOwnerEnrollmentProfilesItemMicrosoftGraphCreateTokenRequestBuilder) {
    return NewAndroidDeviceOwnerEnrollmentProfilesItemMicrosoftGraphCreateTokenRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRevokeToken provides operations to call the revokeToken method.
func (m *AndroidDeviceOwnerEnrollmentProfilesAndroidDeviceOwnerEnrollmentProfileItemRequestBuilder) MicrosoftGraphRevokeToken()(*AndroidDeviceOwnerEnrollmentProfilesItemMicrosoftGraphRevokeTokenRequestBuilder) {
    return NewAndroidDeviceOwnerEnrollmentProfilesItemMicrosoftGraphRevokeTokenRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
