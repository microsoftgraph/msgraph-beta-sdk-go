...
// GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilderGetQueryParameters get the number of the resource
type GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilderGetQueryParameters struct {
...
type GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilderGetQueryParameters
}
// NewGrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilderInternal instantiates a new GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilder and sets the default values.
func NewGrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilder) {
    m := &GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/previousVersionDefinition/presentations/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewGrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilder instantiates a new GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilder and sets the default values.
...
func (m *GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilder) WithUrl(rawUrl string)(*GrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilder) {
    return NewGrouppolicydefinitionsItemNextversiondefinitionPreviousversiondefinitionPresentationsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
