...
func (m *IntentsItemCategoriesItemSettingsRequestBuilder) Count()(*IntentsItemCategoriesItemSettingsCountRequestBuilder) {
    return NewIntentsItemCategoriesItemSettingsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the settings this category contains
func (m *IntentsItemCategoriesItemSettingsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *IntentsItemCategoriesItemSettingsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
