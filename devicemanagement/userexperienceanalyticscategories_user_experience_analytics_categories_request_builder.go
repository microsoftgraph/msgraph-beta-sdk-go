...
func (m *UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder) ByUserExperienceAnalyticsCategoryId(userExperienceAnalyticsCategoryId string)(*UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoryItemRequestBuilder) {
...
func NewUserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder) {
    m := &UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder{
...
func NewUserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder) {
    ...
    return NewUserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *UserexperienceanalyticscategoriesCountRequestBuilder when successful
func (m *UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder) Count()(*UserexperienceanalyticscategoriesCountRequestBuilder) {
...
func (m *UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsCategoryCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateUserExperienceAnalyticsCategoryCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsCategoryable, requestConfiguration *UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsCategoryable, error) {
...
func (m *UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder) {
    return NewUserexperienceanalyticscategoriesUserExperienceAnalyticsCategoriesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
