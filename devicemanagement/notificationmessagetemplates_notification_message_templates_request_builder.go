...
// NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilderGetQueryParameters the Notification Message Templates.
...
func (m *NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder) ByNotificationMessageTemplateId(notificationMessageTemplateId string)(*NotificationmessagetemplatesNotificationMessageTemplateItemRequestBuilder) {
...
func NewNotificationmessagetemplatesNotificationMessageTemplatesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder) {
    m := &NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder{
...
func NewNotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder) {
    ...
    return NewNotificationmessagetemplatesNotificationMessageTemplatesRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *NotificationmessagetemplatesCountRequestBuilder when successful
func (m *NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder) Count()(*NotificationmessagetemplatesCountRequestBuilder) {
...
func (m *NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder) Get(ctx context.Context, requestConfiguration *NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.NotificationMessageTemplateCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateNotificationMessageTemplateCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.NotificationMessageTemplateCollectionResponseable), nil
}
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.NotificationMessageTemplateable, requestConfiguration *NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.NotificationMessageTemplateable, error) {
...
func (m *NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.NotificationMessageTemplateable, requestConfiguration *NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder) WithUrl(rawUrl string)(*NotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder) {
    return NewNotificationmessagetemplatesNotificationMessageTemplatesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
