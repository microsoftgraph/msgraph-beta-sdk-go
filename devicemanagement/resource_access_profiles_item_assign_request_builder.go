...
// NewResourceAccessProfilesItemAssignRequestBuilderInternal instantiates a new ResourceAccessProfilesItemAssignRequestBuilder and sets the default values.
...
// NewResourceAccessProfilesItemAssignRequestBuilder instantiates a new ResourceAccessProfilesItemAssignRequestBuilder and sets the default values.
...
// returns a ResourceAccessProfilesItemAssignPostResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
