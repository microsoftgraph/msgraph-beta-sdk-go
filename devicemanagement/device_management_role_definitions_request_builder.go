...
// DeviceManagementRoleDefinitionsRequestBuilder provides operations to manage the roleDefinitions property of the microsoft.graph.deviceManagement entity.
...
// DeviceManagementRoleDefinitionsRequestBuilderGetQueryParameters the Role Definitions.
...
// NewDeviceManagementRoleDefinitionsRequestBuilderInternal instantiates a new RoleDefinitionsRequestBuilder and sets the default values.
...
// NewDeviceManagementRoleDefinitionsRequestBuilder instantiates a new RoleDefinitionsRequestBuilder and sets the default values.
...
func (m *DeviceManagementRoleDefinitionsRequestBuilder) Count()(*DeviceManagementRoleDefinitionsCountRequestBuilder) {
    return NewDeviceManagementRoleDefinitionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the Role Definitions.
func (m *DeviceManagementRoleDefinitionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DeviceManagementRoleDefinitionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DeviceManagementRoleDefinitionsRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceManagementRoleDefinitionsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RoleDefinitionCollectionResponseable, error) {
