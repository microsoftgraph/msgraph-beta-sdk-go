...
func (m *UserExperienceAnalyticsCategoriesRequestBuilder) Count()(*UserExperienceAnalyticsCategoriesCountRequestBuilder) {
    return NewUserExperienceAnalyticsCategoriesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *UserExperienceAnalyticsCategoriesRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsCategoriesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsCategoryCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateUserExperienceAnalyticsCategoryCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
