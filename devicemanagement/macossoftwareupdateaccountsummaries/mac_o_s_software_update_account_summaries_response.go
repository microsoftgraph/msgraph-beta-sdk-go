...
// MacOSSoftwareUpdateAccountSummariesResponse 
...
// NewMacOSSoftwareUpdateAccountSummariesResponse instantiates a new macOSSoftwareUpdateAccountSummariesResponse and sets the default values.
