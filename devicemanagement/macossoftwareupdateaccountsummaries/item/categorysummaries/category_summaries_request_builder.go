...
type CategorySummariesRequestBuilderGetOptions struct {
    ...
    Q *CategorySummariesRequestBuilderGetQueryParameters;
...
func NewCategorySummariesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CategorySummariesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/macOSSoftwareUpdateAccountSummaries/{macOSSoftwareUpdateAccountSummary_id}/categorySummaries{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *CategorySummariesRequestBuilder) Get(options *CategorySummariesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MacOSSoftwareUpdateCategorySummaryCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateMacOSSoftwareUpdateCategorySummaryCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MacOSSoftwareUpdateCategorySummaryCollectionResponseable), nil
}
// Post create new navigation property to categorySummaries for deviceManagement
func (m *CategorySummariesRequestBuilder) Post(options *CategorySummariesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MacOSSoftwareUpdateCategorySummaryable, error) {
