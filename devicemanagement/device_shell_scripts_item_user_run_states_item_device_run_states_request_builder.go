...
func (m *DeviceShellScriptsItemUserRunStatesItemDeviceRunStatesRequestBuilder) Count()(*DeviceShellScriptsItemUserRunStatesItemDeviceRunStatesCountRequestBuilder) {
    return NewDeviceShellScriptsItemUserRunStatesItemDeviceRunStatesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list of run states for this script across all devices of specific user.
func (m *DeviceShellScriptsItemUserRunStatesItemDeviceRunStatesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DeviceShellScriptsItemUserRunStatesItemDeviceRunStatesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
