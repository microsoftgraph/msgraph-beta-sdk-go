...
// ByCloudPcServicePlanIdString provides operations to manage the servicePlans property of the microsoft.graph.virtualEndpoint entity.
func (m *VirtualEndpointServicePlansRequestBuilder) ByCloudPcServicePlanIdString(cloudPcServicePlanId string)(*VirtualEndpointServicePlansCloudPcServicePlanItemRequestBuilder) {
