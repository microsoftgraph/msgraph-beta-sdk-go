...
// NewDeviceComplianceScriptsItemAssignmentsRequestBuilderInternal instantiates a new AssignmentsRequestBuilder and sets the default values.
...
// NewDeviceComplianceScriptsItemAssignmentsRequestBuilder instantiates a new AssignmentsRequestBuilder and sets the default values.
...
func (m *DeviceComplianceScriptsItemAssignmentsRequestBuilder) Count()(*DeviceComplianceScriptsItemAssignmentsCountRequestBuilder) {
    return NewDeviceComplianceScriptsItemAssignmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the list of group assignments for the device compliance script
func (m *DeviceComplianceScriptsItemAssignmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DeviceComplianceScriptsItemAssignmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
