...
func (m *ComanagedDevicesItemLogCollectionRequestsRequestBuilder) Count()(*ComanagedDevicesItemLogCollectionRequestsCountRequestBuilder) {
    return NewComanagedDevicesItemLogCollectionRequestsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list of log collection requests
func (m *ComanagedDevicesItemLogCollectionRequestsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ComanagedDevicesItemLogCollectionRequestsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
