...
func (m *AssignmentFiltersItemGetSupportedPropertiesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *AssignmentFiltersItemGetSupportedPropertiesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AssignmentFiltersItemGetSupportedPropertiesRequestBuilder) Get(ctx context.Context, requestConfiguration *AssignmentFiltersItemGetSupportedPropertiesRequestBuilderGetRequestConfiguration)(AssignmentFiltersItemGetSupportedPropertiesResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateAssignmentFiltersItemGetSupportedPropertiesResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
