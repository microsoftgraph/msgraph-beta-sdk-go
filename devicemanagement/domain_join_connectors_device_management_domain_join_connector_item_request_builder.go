...
func NewDomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, deviceManagementDomainJoinConnectorId *string)(*DomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilder) {
    ...
    if deviceManagementDomainJoinConnectorId != nil {
...
func NewDomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilder) {
    ...
    return NewDomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *DomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilder) Get(ctx context.Context, requestConfiguration *DomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementDomainJoinConnectorable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceManagementDomainJoinConnectorFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
