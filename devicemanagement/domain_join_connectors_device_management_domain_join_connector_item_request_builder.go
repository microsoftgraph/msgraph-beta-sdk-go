...
// NewDomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilderInternal instantiates a new DeviceManagementDomainJoinConnectorItemRequestBuilder and sets the default values.
func NewDomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/domainJoinConnectors/{deviceManagementDomainJoinConnector%2Did}{?%24select,%24expand}";
...
// NewDomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilder instantiates a new DeviceManagementDomainJoinConnectorItemRequestBuilder and sets the default values.
...
// CreateDeleteRequestInformation delete navigation property domainJoinConnectors for deviceManagement
func (m *DomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *DomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
// CreatePatchRequestInformation update the navigation property domainJoinConnectors in deviceManagement
...
func (m *DomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilder) Get(ctx context.Context, requestConfiguration *DomainJoinConnectorsDeviceManagementDomainJoinConnectorItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementDomainJoinConnectorable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceManagementDomainJoinConnectorFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
