...
// GroupPolicyDefinitionItemRequestBuilder provides operations to manage the definitions property of the microsoft.graph.groupPolicyDefinitionFile entity.
...
// GroupPolicyDefinitionItemRequestBuilderGetQueryParameters the group policy definitions associated with the file.
...
// CreateGetRequestInformationWithRequestConfiguration the group policy definitions associated with the file.
...
// GetWithRequestConfigurationAndResponseHandler the group policy definitions associated with the file.
