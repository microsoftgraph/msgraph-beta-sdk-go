...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\groupPolicyDefinitionFiles\{groupPolicyDefinitionFile-id}\definitions\$ref
...
// RefRequestBuilderGetQueryParameters the group policy definitions associated with the file.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/groupPolicyDefinitionFiles/{groupPolicyDefinitionFile_id}/definitions/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the group policy definitions associated with the file.
...
// Post the group policy definitions associated with the file.
