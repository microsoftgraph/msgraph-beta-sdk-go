...
// GroupPolicyDefinitionFileItemRequestBuilderDeleteOptions options for Delete
type GroupPolicyDefinitionFileItemRequestBuilderDeleteOptions struct {
    // Request headers
...
// GroupPolicyDefinitionFileItemRequestBuilderGetOptions options for Get
type GroupPolicyDefinitionFileItemRequestBuilderGetOptions struct {
    // Request headers
    Headers map[string]string;
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption;
...
func (m *GroupPolicyDefinitionFileItemRequestBuilder) CreateDeleteRequestInformation(options *GroupPolicyDefinitionFileItemRequestBuilderDeleteOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *GroupPolicyDefinitionFileItemRequestBuilder) CreateGetRequestInformation(options *GroupPolicyDefinitionFileItemRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *GroupPolicyDefinitionFileItemRequestBuilder) CreatePatchRequestInformation(options *GroupPolicyDefinitionFileItemRequestBuilderPatchOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *GroupPolicyDefinitionFileItemRequestBuilder) Get(options *GroupPolicyDefinitionFileItemRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GroupPolicyDefinitionFileable, error) {
