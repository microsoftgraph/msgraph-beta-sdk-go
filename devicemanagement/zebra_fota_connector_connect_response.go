...
// ZebraFotaConnectorConnectResponse provides operations to call the connect method.
...
func (m *ZebraFotaConnectorConnectResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *ZebraFotaConnectorConnectResponse) SetAdditionalData(value map[string]interface{})() {
