...
// VirtualEndpointDeviceImagesRequestBuilderGetQueryParameters the image resource on Cloud PC.
...
// ToPostRequestInformation create new navigation property to deviceImages for deviceManagement
