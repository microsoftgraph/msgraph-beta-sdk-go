...
func (m *VirtualEndpointDeviceImagesRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointDeviceImagesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CloudPcDeviceImageCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateCloudPcDeviceImageCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphGetSourceImages provides operations to call the getSourceImages method.
func (m *VirtualEndpointDeviceImagesRequestBuilder) MicrosoftGraphGetSourceImages()(*VirtualEndpointDeviceImagesMicrosoftGraphGetSourceImagesGetSourceImagesRequestBuilder) {
    return NewVirtualEndpointDeviceImagesMicrosoftGraphGetSourceImagesGetSourceImagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
