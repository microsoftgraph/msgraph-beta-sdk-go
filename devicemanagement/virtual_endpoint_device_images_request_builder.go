...
func (m *VirtualEndpointDeviceImagesRequestBuilder) MicrosoftGraphGetSourceImages()(*VirtualEndpointDeviceImagesMicrosoftGraphGetSourceImagesRequestBuilder) {
    return NewVirtualEndpointDeviceImagesMicrosoftGraphGetSourceImagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
