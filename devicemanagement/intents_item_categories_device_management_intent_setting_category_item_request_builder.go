...
func (m *IntentsItemCategoriesDeviceManagementIntentSettingCategoryItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *IntentsItemCategoriesDeviceManagementIntentSettingCategoryItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
