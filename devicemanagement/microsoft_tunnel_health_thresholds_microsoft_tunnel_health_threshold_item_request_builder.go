...
func (m *MicrosoftTunnelHealthThresholdsMicrosoftTunnelHealthThresholdItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *MicrosoftTunnelHealthThresholdsMicrosoftTunnelHealthThresholdItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
