...
// NewDeviceHealthScriptsAreGlobalScriptsAvailableRequestBuilderInternal instantiates a new DeviceHealthScriptsAreGlobalScriptsAvailableRequestBuilder and sets the default values.
...
// NewDeviceHealthScriptsAreGlobalScriptsAvailableRequestBuilder instantiates a new DeviceHealthScriptsAreGlobalScriptsAvailableRequestBuilder and sets the default values.
...
func (m *DeviceHealthScriptsAreGlobalScriptsAvailableRequestBuilder) WithUrl(rawUrl string)(*DeviceHealthScriptsAreGlobalScriptsAvailableRequestBuilder) {
    return NewDeviceHealthScriptsAreGlobalScriptsAvailableRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
