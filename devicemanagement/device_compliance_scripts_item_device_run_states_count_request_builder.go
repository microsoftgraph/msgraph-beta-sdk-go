...
func (m *DeviceComplianceScriptsItemDeviceRunStatesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceComplianceScriptsItemDeviceRunStatesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
