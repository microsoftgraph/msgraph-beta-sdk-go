...
// NewManagedDevicesItemInitiateMobileDeviceManagementKeyRecoveryRequestBuilderInternal instantiates a new ManagedDevicesItemInitiateMobileDeviceManagementKeyRecoveryRequestBuilder and sets the default values.
...
// NewManagedDevicesItemInitiateMobileDeviceManagementKeyRecoveryRequestBuilder instantiates a new ManagedDevicesItemInitiateMobileDeviceManagementKeyRecoveryRequestBuilder and sets the default values.
...
func (m *ManagedDevicesItemInitiateMobileDeviceManagementKeyRecoveryRequestBuilder) WithUrl(rawUrl string)(*ManagedDevicesItemInitiateMobileDeviceManagementKeyRecoveryRequestBuilder) {
    return NewManagedDevicesItemInitiateMobileDeviceManagementKeyRecoveryRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
