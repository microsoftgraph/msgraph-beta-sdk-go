...
// ByDeviceManagementConfigurationSettingDefinitionIdString provides operations to manage the reusableSettings property of the microsoft.graph.deviceManagement entity.
func (m *ReusableSettingsRequestBuilder) ByDeviceManagementConfigurationSettingDefinitionIdString(deviceManagementConfigurationSettingDefinitionId string)(*ReusableSettingsDeviceManagementConfigurationSettingDefinitionItemRequestBuilder) {
