...
func (m *ManagedDevicesItemMicrosoftGraphWipeWipePostRequestBody) GetUseProtectedWipe()(*bool) {
...
func (m *ManagedDevicesItemMicrosoftGraphWipeWipePostRequestBody) SetUseProtectedWipe(value *bool)() {
