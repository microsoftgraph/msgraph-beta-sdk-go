...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\managementConditions\{managementCondition-id}\managementConditionStatements\$ref
...
// RefRequestBuilderGetQueryParameters the management condition statements associated to the management condition.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/managementConditions/{managementCondition_id}/managementConditionStatements/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the management condition statements associated to the management condition.
...
// Post the management condition statements associated to the management condition.
