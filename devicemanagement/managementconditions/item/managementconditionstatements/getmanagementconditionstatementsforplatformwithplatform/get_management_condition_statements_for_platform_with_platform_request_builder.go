...
// getManagementConditionStatementsForPlatformWithPlatformRequestBuilder builds and executes requests for operations under \deviceManagement\managementConditions\{managementCondition-id}\managementConditionStatements\microsoft.graph.getManagementConditionStatementsForPlatform(platform={platform})
...
func (m *GetManagementConditionStatementsForPlatformWithPlatformRequestBuilder) Get(options *GetManagementConditionStatementsForPlatformWithPlatformRequestBuilderGetOptions)([]GetManagementConditionStatementsForPlatformWithPlatform, error) {
    ...
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewGetManagementConditionStatementsForPlatformWithPlatform() }, nil)
    if err != nil {
        return nil, err
    }
