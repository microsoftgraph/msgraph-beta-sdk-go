...
func NewManagementConditionStatementsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagementConditionStatementsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/managementConditions/{managementCondition%2Did}/managementConditionStatements{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// CreateGetRequestInformationWithRequestConfiguration the management condition statements associated to the management condition.
...
// GetWithResponseHandler the management condition statements associated to the management condition.
