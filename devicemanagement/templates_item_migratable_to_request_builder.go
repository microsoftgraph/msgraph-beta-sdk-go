...
// ByDeviceManagementTemplateId1String provides operations to manage the migratableTo property of the microsoft.graph.deviceManagementTemplate entity.
func (m *TemplatesItemMigratableToRequestBuilder) ByDeviceManagementTemplateId1String(deviceManagementTemplateId1 string)(*TemplatesItemMigratableToDeviceManagementTemplateItemRequestBuilder) {
