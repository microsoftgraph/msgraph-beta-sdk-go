...
func (m *TemplatesItemMigratableToRequestBuilder) MicrosoftGraphImportOffice365DeviceConfigurationPolicies()(*TemplatesItemMigratableToMicrosoftGraphImportOffice365DeviceConfigurationPoliciesRequestBuilder) {
    return NewTemplatesItemMigratableToMicrosoftGraphImportOffice365DeviceConfigurationPoliciesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
