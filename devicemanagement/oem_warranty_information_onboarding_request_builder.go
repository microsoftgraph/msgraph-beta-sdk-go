...
// ByOemWarrantyInformationOnboardingId provides operations to manage the oemWarrantyInformationOnboarding property of the microsoft.graph.deviceManagement entity.
func (m *OemWarrantyInformationOnboardingRequestBuilder) ByOemWarrantyInformationOnboardingId(oemWarrantyInformationOnboardingId string)(*OemWarrantyInformationOnboardingOemWarrantyInformationOnboardingItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.BaseRequestBuilder.PathParameters {
        urlTplParams[idx] = item
    }
    if oemWarrantyInformationOnboardingId != "" {
...
func NewOemWarrantyInformationOnboardingRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OemWarrantyInformationOnboardingRequestBuilder) {
    m := &OemWarrantyInformationOnboardingRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/oemWarrantyInformationOnboarding{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *OemWarrantyInformationOnboardingRequestBuilder) Count()(*OemWarrantyInformationOnboardingCountRequestBuilder) {
    return NewOemWarrantyInformationOnboardingCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *OemWarrantyInformationOnboardingRequestBuilder) Get(ctx context.Context, requestConfiguration *OemWarrantyInformationOnboardingRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OemWarrantyInformationOnboardingCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateOemWarrantyInformationOnboardingCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *OemWarrantyInformationOnboardingRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *OemWarrantyInformationOnboardingRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// ToPostRequestInformation create new navigation property to oemWarrantyInformationOnboarding for deviceManagement
