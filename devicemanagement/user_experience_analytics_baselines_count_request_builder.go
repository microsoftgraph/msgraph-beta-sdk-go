...
func (m *UserExperienceAnalyticsBaselinesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsBaselinesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
