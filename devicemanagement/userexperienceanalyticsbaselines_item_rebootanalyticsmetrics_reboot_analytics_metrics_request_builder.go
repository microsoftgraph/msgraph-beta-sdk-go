...
func NewUserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilder) {
    m := &UserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline%2Did}/rebootAnalyticsMetrics{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
func NewUserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilder) {
    ...
    return NewUserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *UserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilder) Get(ctx context.Context, requestConfiguration *UserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserExperienceAnalyticsCategoryable, error) {
...
func (m *UserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilder) WithUrl(rawUrl string)(*UserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilder) {
    return NewUserexperienceanalyticsbaselinesItemRebootanalyticsmetricsRebootAnalyticsMetricsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
