...
// ZebraFotaConnectorHasActiveDeploymentsResponse provides operations to call the hasActiveDeployments method.
...
func (m *ZebraFotaConnectorHasActiveDeploymentsResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *ZebraFotaConnectorHasActiveDeploymentsResponse) SetAdditionalData(value map[string]interface{})() {
