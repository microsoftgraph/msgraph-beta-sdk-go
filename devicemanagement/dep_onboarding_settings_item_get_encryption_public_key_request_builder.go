...
// NewDepOnboardingSettingsItemGetEncryptionPublicKeyRequestBuilderInternal instantiates a new DepOnboardingSettingsItemGetEncryptionPublicKeyRequestBuilder and sets the default values.
...
// NewDepOnboardingSettingsItemGetEncryptionPublicKeyRequestBuilder instantiates a new DepOnboardingSettingsItemGetEncryptionPublicKeyRequestBuilder and sets the default values.
...
// returns a DepOnboardingSettingsItemGetEncryptionPublicKeyResponseable when successful
...
// returns a DepOnboardingSettingsItemGetEncryptionPublicKeyGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
