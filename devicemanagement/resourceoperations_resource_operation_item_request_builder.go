...
func (m *ResourceoperationsResourceOperationItemRequestBuilder) GetScopesForUserWithUserid(userid *string)(*ResourceoperationsItemGetscopesforuserwithuseridGetScopesForUserWithUseridRequestBuilder) {
    return NewResourceoperationsItemGetscopesforuserwithuseridGetScopesForUserWithUseridRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, userid)
}
