...
// ChromeOSOnboardingSettingsRequestBuilder builds and executes requests for operations under \deviceManagement\chromeOSOnboardingSettings\{chromeOSOnboardingSettings-id}
...
// ChromeOSOnboardingSettingsRequestBuilderDeleteOptions options for Delete
type ChromeOSOnboardingSettingsRequestBuilderDeleteOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
func NewChromeOSOnboardingSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChromeOSOnboardingSettingsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/chromeOSOnboardingSettings/{chromeOSOnboardingSettings_id}{?select,expand}";
...
// CreateDeleteRequestInformation collection of ChromeOSOnboardingSettings settings associated with account.
func (m *ChromeOSOnboardingSettingsRequestBuilder) CreateDeleteRequestInformation(options *ChromeOSOnboardingSettingsRequestBuilderDeleteOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
// CreatePatchRequestInformation collection of ChromeOSOnboardingSettings settings associated with account.
func (m *ChromeOSOnboardingSettingsRequestBuilder) CreatePatchRequestInformation(options *ChromeOSOnboardingSettingsRequestBuilderPatchOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
// Delete collection of ChromeOSOnboardingSettings settings associated with account.
func (m *ChromeOSOnboardingSettingsRequestBuilder) Delete(options *ChromeOSOnboardingSettingsRequestBuilderDeleteOptions)(error) {
...
func (m *ChromeOSOnboardingSettingsRequestBuilder) Get(options *ChromeOSOnboardingSettingsRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ChromeOSOnboardingSettings, error) {
...
// Patch collection of ChromeOSOnboardingSettings settings associated with account.
func (m *ChromeOSOnboardingSettingsRequestBuilder) Patch(options *ChromeOSOnboardingSettingsRequestBuilderPatchOptions)(error) {
