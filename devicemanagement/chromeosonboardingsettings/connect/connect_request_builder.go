...
// Builds and executes requests for operations under \deviceManagement\chromeOSOnboardingSettings\microsoft.graph.connect
...
// Parameters:
//  - value : Value to set for the chromeOSOnboardingStatus property.
