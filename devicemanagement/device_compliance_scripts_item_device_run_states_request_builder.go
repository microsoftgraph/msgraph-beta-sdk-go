...
func (m *DeviceComplianceScriptsItemDeviceRunStatesRequestBuilder) Count()(*DeviceComplianceScriptsItemDeviceRunStatesCountRequestBuilder) {
    return NewDeviceComplianceScriptsItemDeviceRunStatesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list of run states for the device compliance script across all devices
func (m *DeviceComplianceScriptsItemDeviceRunStatesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DeviceComplianceScriptsItemDeviceRunStatesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
