...
func (m *ApplePushNotificationCertificateRequestBuilder) Get(ctx context.Context, requestConfiguration *ApplePushNotificationCertificateRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ApplePushNotificationCertificateable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateApplePushNotificationCertificateFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphDownloadApplePushNotificationCertificateSigningRequest provides operations to call the downloadApplePushNotificationCertificateSigningRequest method.
func (m *ApplePushNotificationCertificateRequestBuilder) MicrosoftGraphDownloadApplePushNotificationCertificateSigningRequest()(*ApplePushNotificationCertificateMicrosoftGraphDownloadApplePushNotificationCertificateSigningRequestDownloadApplePushNotificationCertificateSigningRequestRequestBuilder) {
    return NewApplePushNotificationCertificateMicrosoftGraphDownloadApplePushNotificationCertificateSigningRequestDownloadApplePushNotificationCertificateSigningRequestRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGenerateApplePushNotificationCertificateSigningRequest provides operations to call the generateApplePushNotificationCertificateSigningRequest method.
func (m *ApplePushNotificationCertificateRequestBuilder) MicrosoftGraphGenerateApplePushNotificationCertificateSigningRequest()(*ApplePushNotificationCertificateMicrosoftGraphGenerateApplePushNotificationCertificateSigningRequestGenerateApplePushNotificationCertificateSigningRequestRequestBuilder) {
    return NewApplePushNotificationCertificateMicrosoftGraphGenerateApplePushNotificationCertificateSigningRequestGenerateApplePushNotificationCertificateSigningRequestRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
