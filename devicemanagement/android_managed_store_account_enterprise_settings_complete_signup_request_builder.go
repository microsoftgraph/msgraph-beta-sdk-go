...
// NewAndroidManagedStoreAccountEnterpriseSettingsCompleteSignupRequestBuilderInternal instantiates a new AndroidManagedStoreAccountEnterpriseSettingsCompleteSignupRequestBuilder and sets the default values.
...
// NewAndroidManagedStoreAccountEnterpriseSettingsCompleteSignupRequestBuilder instantiates a new AndroidManagedStoreAccountEnterpriseSettingsCompleteSignupRequestBuilder and sets the default values.
...
func (m *AndroidManagedStoreAccountEnterpriseSettingsCompleteSignupRequestBuilder) WithUrl(rawUrl string)(*AndroidManagedStoreAccountEnterpriseSettingsCompleteSignupRequestBuilder) {
    return NewAndroidManagedStoreAccountEnterpriseSettingsCompleteSignupRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
