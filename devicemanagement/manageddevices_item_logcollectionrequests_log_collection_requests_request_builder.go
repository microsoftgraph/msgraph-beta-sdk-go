...
func (m *ManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilder) ByDeviceLogCollectionResponseId(deviceLogCollectionResponseId string)(*ManageddevicesItemLogcollectionrequestsDeviceLogCollectionResponseItemRequestBuilder) {
...
func NewManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilder) {
    m := &ManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilder{
...
func NewManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilder) {
    ...
    return NewManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ManageddevicesItemLogcollectionrequestsCountRequestBuilder when successful
func (m *ManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilder) Count()(*ManageddevicesItemLogcollectionrequestsCountRequestBuilder) {
...
func (m *ManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilder) Get(ctx context.Context, requestConfiguration *ManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceLogCollectionResponseCollectionResponseable, error) {
...
func (m *ManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilder) WithUrl(rawUrl string)(*ManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilder) {
    return NewManageddevicesItemLogcollectionrequestsLogCollectionRequestsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
