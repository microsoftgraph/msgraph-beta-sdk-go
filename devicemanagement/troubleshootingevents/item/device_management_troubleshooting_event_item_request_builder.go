...
// DeviceManagementTroubleshootingEventItemRequestBuilder builds and executes requests for operations under \deviceManagement\troubleshootingEvents\{deviceManagementTroubleshootingEvent-id}
