...
// DeleteWithResponseHandler delete navigation property troubleshootingEvents for deviceManagement
...
// PatchWithResponseHandler update the navigation property troubleshootingEvents in deviceManagement
