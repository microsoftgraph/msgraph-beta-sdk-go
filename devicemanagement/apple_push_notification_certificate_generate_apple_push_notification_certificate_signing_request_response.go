...
// ApplePushNotificationCertificateGenerateApplePushNotificationCertificateSigningRequestResponse provides operations to call the generateApplePushNotificationCertificateSigningRequest method.
...
func (m *ApplePushNotificationCertificateGenerateApplePushNotificationCertificateSigningRequestResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *ApplePushNotificationCertificateGenerateApplePushNotificationCertificateSigningRequestResponse) SetAdditionalData(value map[string]interface{})() {
