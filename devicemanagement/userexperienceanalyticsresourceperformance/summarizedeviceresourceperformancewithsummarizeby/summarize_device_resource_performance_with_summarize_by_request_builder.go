...
// SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilderGetQueryParameters invoke function summarizeDeviceResourcePerformance
type SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilderGetQueryParameters struct {
...
type SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilderGetQueryParameters
}
...
func (m *SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilder) Get(ctx context.Context, requestConfiguration *SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilderGetRequestConfiguration)(SummarizeDeviceResourcePerformanceWithSummarizeByResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateSummarizeDeviceResourcePerformanceWithSummarizeByResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
