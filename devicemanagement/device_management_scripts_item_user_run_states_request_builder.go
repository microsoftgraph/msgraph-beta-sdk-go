...
func (m *DeviceManagementScriptsItemUserRunStatesRequestBuilder) Count()(*DeviceManagementScriptsItemUserRunStatesCountRequestBuilder) {
    return NewDeviceManagementScriptsItemUserRunStatesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list of run states for this script across all users.
func (m *DeviceManagementScriptsItemUserRunStatesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DeviceManagementScriptsItemUserRunStatesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
