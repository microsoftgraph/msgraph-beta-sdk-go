...
type LocalizedNotificationMessagesRequestBuilderGetOptions struct {
    ...
    Q *LocalizedNotificationMessagesRequestBuilderGetQueryParameters;
...
func NewLocalizedNotificationMessagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*LocalizedNotificationMessagesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/notificationMessageTemplates/{notificationMessageTemplate_id}/localizedNotificationMessages{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *LocalizedNotificationMessagesRequestBuilder) Get(options *LocalizedNotificationMessagesRequestBuilderGetOptions)(*LocalizedNotificationMessagesResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewLocalizedNotificationMessagesResponse() }, nil)
    if err != nil {
        return nil, err
    }
