...
// DepOnboardingSettingsItemEnrollmentProfilesItemExportMobileConfigResponse provides operations to call the exportMobileConfig method.
...
func (m *DepOnboardingSettingsItemEnrollmentProfilesItemExportMobileConfigResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *DepOnboardingSettingsItemEnrollmentProfilesItemExportMobileConfigResponse) SetAdditionalData(value map[string]interface{})() {
