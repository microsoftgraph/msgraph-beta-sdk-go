...
func (m *ZebraFotaDeploymentsZebraFotaDeploymentItemRequestBuilder) MicrosoftGraphCancel()(*ZebraFotaDeploymentsItemMicrosoftGraphCancelRequestBuilder) {
    return NewZebraFotaDeploymentsItemMicrosoftGraphCancelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
