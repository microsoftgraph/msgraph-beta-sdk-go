...
func NewParentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ParentRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/deviceManagement/groupPolicyCategories/{groupPolicyCategory_id}/parent{?select,expand}";
...
func (m *ParentRequestBuilder) Ref()(*i393697226399cf670a93e7fbe15e9f895d2ed615e09bf4d24f847e104924282b.RefRequestBuilder) {
    return i393697226399cf670a93e7fbe15e9f895d2ed615e09bf4d24f847e104924282b.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
