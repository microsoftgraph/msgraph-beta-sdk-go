...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\groupPolicyCategories\{groupPolicyCategory-id}\definitions\$ref
...
// RefRequestBuilderGetQueryParameters the immediate GroupPolicyDefinition children of the category
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/groupPolicyCategories/{groupPolicyCategory_id}/definitions/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the immediate GroupPolicyDefinition children of the category
...
// Post the immediate GroupPolicyDefinition children of the category
