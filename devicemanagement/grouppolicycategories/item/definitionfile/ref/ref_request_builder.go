...
// RefRequestBuilder builds and executes requests for operations under \deviceManagement\groupPolicyCategories\{groupPolicyCategory-id}\definitionFile\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/groupPolicyCategories/{groupPolicyCategory_id}/definitionFile/$ref";
...
// CreateDeleteRequestInformation the id of the definition file the category came from
...
// CreatePutRequestInformation the id of the definition file the category came from
...
// Delete the id of the definition file the category came from
...
// Put the id of the definition file the category came from
