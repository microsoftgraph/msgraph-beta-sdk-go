...
// NewAndroidManagedStoreAccountEnterpriseSettingsRequestSignupUrlRequestBuilderInternal instantiates a new AndroidManagedStoreAccountEnterpriseSettingsRequestSignupUrlRequestBuilder and sets the default values.
...
// NewAndroidManagedStoreAccountEnterpriseSettingsRequestSignupUrlRequestBuilder instantiates a new AndroidManagedStoreAccountEnterpriseSettingsRequestSignupUrlRequestBuilder and sets the default values.
...
// returns a AndroidManagedStoreAccountEnterpriseSettingsRequestSignupUrlPostResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
