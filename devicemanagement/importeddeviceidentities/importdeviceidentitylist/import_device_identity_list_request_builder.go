...
func (m *ImportDeviceIdentityListRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ImportDeviceIdentityListPostRequestBodyable, requestConfiguration *ImportDeviceIdentityListRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ImportDeviceIdentityListRequestBuilder) Post(ctx context.Context, body ImportDeviceIdentityListPostRequestBodyable, requestConfiguration *ImportDeviceIdentityListRequestBuilderPostRequestConfiguration)(ImportDeviceIdentityListResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateImportDeviceIdentityListResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
