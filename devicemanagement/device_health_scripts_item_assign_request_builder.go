...
// NewDeviceHealthScriptsItemAssignRequestBuilderInternal instantiates a new AssignRequestBuilder and sets the default values.
func NewDeviceHealthScriptsItemAssignRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeviceHealthScriptsItemAssignRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/deviceHealthScripts/{deviceHealthScript%2Did}/assign";
...
// NewDeviceHealthScriptsItemAssignRequestBuilder instantiates a new AssignRequestBuilder and sets the default values.
