...
func (m *AndroidForWorkSettingsRequestBuilder) Get(ctx context.Context, requestConfiguration *AndroidForWorkSettingsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AndroidForWorkSettingsable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateAndroidForWorkSettingsFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *AndroidForWorkSettingsRequestBuilder) MicrosoftGraphCompleteSignup()(*AndroidForWorkSettingsMicrosoftGraphCompleteSignupCompleteSignupRequestBuilder) {
    return NewAndroidForWorkSettingsMicrosoftGraphCompleteSignupCompleteSignupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRequestSignupUrl provides operations to call the requestSignupUrl method.
func (m *AndroidForWorkSettingsRequestBuilder) MicrosoftGraphRequestSignupUrl()(*AndroidForWorkSettingsMicrosoftGraphRequestSignupUrlRequestSignupUrlRequestBuilder) {
    return NewAndroidForWorkSettingsMicrosoftGraphRequestSignupUrlRequestSignupUrlRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSyncApps provides operations to call the syncApps method.
func (m *AndroidForWorkSettingsRequestBuilder) MicrosoftGraphSyncApps()(*AndroidForWorkSettingsMicrosoftGraphSyncAppsSyncAppsRequestBuilder) {
    return NewAndroidForWorkSettingsMicrosoftGraphSyncAppsSyncAppsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnbind provides operations to call the unbind method.
func (m *AndroidForWorkSettingsRequestBuilder) MicrosoftGraphUnbind()(*AndroidForWorkSettingsMicrosoftGraphUnbindUnbindRequestBuilder) {
    return NewAndroidForWorkSettingsMicrosoftGraphUnbindUnbindRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
