...
func (m *AndroidForWorkSettingsRequestBuilder) Delete(ctx context.Context, requestConfiguration *AndroidForWorkSettingsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
