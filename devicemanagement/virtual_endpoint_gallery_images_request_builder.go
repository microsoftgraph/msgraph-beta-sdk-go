...
func (m *VirtualEndpointGalleryImagesRequestBuilder) Count()(*VirtualEndpointGalleryImagesCountRequestBuilder) {
    return NewVirtualEndpointGalleryImagesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation list the properties and relationships of the cloudPcGalleryImage objects.
func (m *VirtualEndpointGalleryImagesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *VirtualEndpointGalleryImagesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/virtualendpoint-list-galleryimages?view=graph-rest-1.0
