...
func (m *AppleUserInitiatedEnrollmentProfilesRequestBuilder) ByAppleUserInitiatedEnrollmentProfileId(appleUserInitiatedEnrollmentProfileId string)(*AppleUserInitiatedEnrollmentProfilesAppleUserInitiatedEnrollmentProfileItemRequestBuilder) {
...
func NewAppleUserInitiatedEnrollmentProfilesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AppleUserInitiatedEnrollmentProfilesRequestBuilder) {
    m := &AppleUserInitiatedEnrollmentProfilesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/appleUserInitiatedEnrollmentProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *AppleUserInitiatedEnrollmentProfilesRequestBuilder) Count()(*AppleUserInitiatedEnrollmentProfilesCountRequestBuilder) {
...
func (m *AppleUserInitiatedEnrollmentProfilesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AppleUserInitiatedEnrollmentProfilesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AppleUserInitiatedEnrollmentProfilesRequestBuilder) WithUrl(rawUrl string)(*AppleUserInitiatedEnrollmentProfilesRequestBuilder) {
    return NewAppleUserInitiatedEnrollmentProfilesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
