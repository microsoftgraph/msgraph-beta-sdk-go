...
func (m *AppleUserInitiatedEnrollmentProfilesRequestBuilder) Count()(*AppleUserInitiatedEnrollmentProfilesCountRequestBuilder) {
    return NewAppleUserInitiatedEnrollmentProfilesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AppleUserInitiatedEnrollmentProfilesRequestBuilder) Get(ctx context.Context, requestConfiguration *AppleUserInitiatedEnrollmentProfilesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AppleUserInitiatedEnrollmentProfileCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateAppleUserInitiatedEnrollmentProfileCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
