...
// ComanagedDevicesItemGetFileVaultKeyResponse provides operations to call the getFileVaultKey method.
...
func (m *ComanagedDevicesItemGetFileVaultKeyResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *ComanagedDevicesItemGetFileVaultKeyResponse) SetAdditionalData(value map[string]interface{})() {
