...
func (m *DeviceCompliancePoliciesItemDeviceStatusesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceCompliancePoliciesItemDeviceStatusesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
