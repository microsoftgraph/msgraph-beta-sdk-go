...
func (m *GroupPolicyConfigurationsGroupPolicyConfigurationItemRequestBuilder) MicrosoftGraphAssign()(*GroupPolicyConfigurationsItemMicrosoftGraphAssignRequestBuilder) {
    return NewGroupPolicyConfigurationsItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUpdateDefinitionValues provides operations to call the updateDefinitionValues method.
func (m *GroupPolicyConfigurationsGroupPolicyConfigurationItemRequestBuilder) MicrosoftGraphUpdateDefinitionValues()(*GroupPolicyConfigurationsItemMicrosoftGraphUpdateDefinitionValuesRequestBuilder) {
    return NewGroupPolicyConfigurationsItemMicrosoftGraphUpdateDefinitionValuesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
