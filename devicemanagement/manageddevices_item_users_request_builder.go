...
func NewManageddevicesItemUsersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManageddevicesItemUsersRequestBuilder) {
    m := &ManageddevicesItemUsersRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/users{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
...
func NewManageddevicesItemUsersRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManageddevicesItemUsersRequestBuilder) {
...
func (m *ManageddevicesItemUsersRequestBuilder) Get(ctx context.Context, requestConfiguration *ManageddevicesItemUsersRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.UserCollectionResponseable, error) {
...
func (m *ManageddevicesItemUsersRequestBuilder) WithUrl(rawUrl string)(*ManageddevicesItemUsersRequestBuilder) {
    return NewManageddevicesItemUsersRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
