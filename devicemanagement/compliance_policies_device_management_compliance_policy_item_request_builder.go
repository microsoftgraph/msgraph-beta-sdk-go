...
func (m *CompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilder) MicrosoftGraphAssign()(*CompliancePoliciesItemMicrosoftGraphAssignRequestBuilder) {
    return NewCompliancePoliciesItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSetScheduledActions provides operations to call the setScheduledActions method.
func (m *CompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilder) MicrosoftGraphSetScheduledActions()(*CompliancePoliciesItemMicrosoftGraphSetScheduledActionsRequestBuilder) {
    return NewCompliancePoliciesItemMicrosoftGraphSetScheduledActionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
