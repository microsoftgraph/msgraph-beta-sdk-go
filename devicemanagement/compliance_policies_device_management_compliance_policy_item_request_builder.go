...
func (m *CompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilder) AssignmentsById(id string)(*CompliancePoliciesItemAssignmentsDeviceManagementConfigurationPolicyAssignmentItemRequestBuilder) {
    ...
    idPtr := &id
    return NewCompliancePoliciesItemAssignmentsDeviceManagementConfigurationPolicyAssignmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewCompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, deviceManagementCompliancePolicyId *string)(*CompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilder) {
    ...
    if deviceManagementCompliancePolicyId != nil {
...
func NewCompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilder) {
    ...
    return NewCompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *CompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilder) Get(ctx context.Context, requestConfiguration *CompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceManagementCompliancePolicyable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceManagementCompliancePolicyFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *CompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilder) MicrosoftGraphAssign()(*CompliancePoliciesItemMicrosoftGraphAssignAssignRequestBuilder) {
    return NewCompliancePoliciesItemMicrosoftGraphAssignAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSetScheduledActions provides operations to call the setScheduledActions method.
func (m *CompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilder) MicrosoftGraphSetScheduledActions()(*CompliancePoliciesItemMicrosoftGraphSetScheduledActionsSetScheduledActionsRequestBuilder) {
    return NewCompliancePoliciesItemMicrosoftGraphSetScheduledActionsSetScheduledActionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *CompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilder) ScheduledActionsForRuleById(id string)(*CompliancePoliciesItemScheduledActionsForRuleDeviceManagementComplianceScheduledActionForRuleItemRequestBuilder) {
    ...
    idPtr := &id
    return NewCompliancePoliciesItemScheduledActionsForRuleDeviceManagementComplianceScheduledActionForRuleItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *CompliancePoliciesDeviceManagementCompliancePolicyItemRequestBuilder) SettingsById(id string)(*CompliancePoliciesItemSettingsDeviceManagementConfigurationSettingItemRequestBuilder) {
    ...
    idPtr := &id
    return NewCompliancePoliciesItemSettingsDeviceManagementConfigurationSettingItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
