...
func NewEmbeddedSIMActivationCodePoolsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EmbeddedSIMActivationCodePoolsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceManagement/embeddedSIMActivationCodePools{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *EmbeddedSIMActivationCodePoolsRequestBuilder) CreateGetRequestInformation(options *EmbeddedSIMActivationCodePoolsRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EmbeddedSIMActivationCodePoolsRequestBuilder) CreatePostRequestInformation(options *EmbeddedSIMActivationCodePoolsRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *EmbeddedSIMActivationCodePoolsRequestBuilder) Get(options *EmbeddedSIMActivationCodePoolsRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.EmbeddedSIMActivationCodePoolCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateEmbeddedSIMActivationCodePoolCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
...
func (m *EmbeddedSIMActivationCodePoolsRequestBuilder) Post(options *EmbeddedSIMActivationCodePoolsRequestBuilderPostOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.EmbeddedSIMActivationCodePoolable, error) {
