...
func (m *AssignRequestBuilder) PostWithResponseHandler(body AssignRequestBodyable, requestConfiguration *AssignRequestBuilderPostRequestConfiguration)(AssignResponseable, error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action assign
func (m *AssignRequestBuilder) PostWithResponseHandler(body AssignRequestBodyable, requestConfiguration *AssignRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(AssignResponseable, error) {
