...
func (m *ExchangeOnPremisesPoliciesRequestBuilder) Count()(*ExchangeOnPremisesPoliciesCountRequestBuilder) {
    return NewExchangeOnPremisesPoliciesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the list of Exchange On Premisis policies configured by the tenant.
func (m *ExchangeOnPremisesPoliciesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ExchangeOnPremisesPoliciesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
