...
// VirtualEndpointBulkActionsCloudPcBulkActionItemRequestBuilderGetQueryParameters get bulkActions from deviceManagement
...
// NewVirtualEndpointBulkActionsCloudPcBulkActionItemRequestBuilderInternal instantiates a new CloudPcBulkActionItemRequestBuilder and sets the default values.
func NewVirtualEndpointBulkActionsCloudPcBulkActionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointBulkActionsCloudPcBulkActionItemRequestBuilder) {
    m := &VirtualEndpointBulkActionsCloudPcBulkActionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/bulkActions/{cloudPcBulkAction%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewVirtualEndpointBulkActionsCloudPcBulkActionItemRequestBuilder instantiates a new CloudPcBulkActionItemRequestBuilder and sets the default values.
...
// Get get bulkActions from deviceManagement
...
// ToGetRequestInformation get bulkActions from deviceManagement
