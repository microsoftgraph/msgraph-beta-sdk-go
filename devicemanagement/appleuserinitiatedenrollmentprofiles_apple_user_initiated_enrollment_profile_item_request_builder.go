...
func (m *AppleuserinitiatedenrollmentprofilesAppleUserInitiatedEnrollmentProfileItemRequestBuilder) SetPriority()(*AppleuserinitiatedenrollmentprofilesItemSetprioritySetPriorityRequestBuilder) {
    return NewAppleuserinitiatedenrollmentprofilesItemSetprioritySetPriorityRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
