...
// NewRoleScopeTagsItemAssignmentsRoleScopeTagAutoAssignmentItemRequestBuilderInternal instantiates a new RoleScopeTagAutoAssignmentItemRequestBuilder and sets the default values.
func NewRoleScopeTagsItemAssignmentsRoleScopeTagAutoAssignmentItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, roleScopeTagAutoAssignmentId *string)(*RoleScopeTagsItemAssignmentsRoleScopeTagAutoAssignmentItemRequestBuilder) {
    ...
    if roleScopeTagAutoAssignmentId != nil {
...
// NewRoleScopeTagsItemAssignmentsRoleScopeTagAutoAssignmentItemRequestBuilder instantiates a new RoleScopeTagAutoAssignmentItemRequestBuilder and sets the default values.
func NewRoleScopeTagsItemAssignmentsRoleScopeTagAutoAssignmentItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleScopeTagsItemAssignmentsRoleScopeTagAutoAssignmentItemRequestBuilder) {
    ...
    return NewRoleScopeTagsItemAssignmentsRoleScopeTagAutoAssignmentItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *RoleScopeTagsItemAssignmentsRoleScopeTagAutoAssignmentItemRequestBuilder) Get(ctx context.Context, requestConfiguration *RoleScopeTagsItemAssignmentsRoleScopeTagAutoAssignmentItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RoleScopeTagAutoAssignmentable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateRoleScopeTagAutoAssignmentFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
