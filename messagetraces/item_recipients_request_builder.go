...
func (m *ItemRecipientsRequestBuilder) Count()(*ItemRecipientsCountRequestBuilder) {
    return NewItemRecipientsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get recipients from messageTraces
func (m *ItemRecipientsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemRecipientsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
