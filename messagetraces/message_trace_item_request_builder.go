...
func (m *MessageTraceItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *MessageTraceItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
