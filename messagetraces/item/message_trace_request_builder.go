...
import (
    ...
    i3ab3304bdff2112b7f44c4e3735f9f4f803cca87448b4d30efc2916bc2663f09 "github.com/microsoftgraph/msgraph-beta-sdk-go/messagetraces/item/recipients"
...
type MessageTraceRequestBuilderGetOptions struct {
    ...
    Q *MessageTraceRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
func NewMessageTraceRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MessageTraceRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/messageTraces/{messageTrace_id}{?select,expand}";
...
func (m *MessageTraceRequestBuilder) RecipientsById(id string)(*i784f8f4585fbe63e879909a57ff455aab4735d6d36dfefcca7b001c7d766c074.MessageRecipientRequestBuilder) {
    ...
    return i784f8f4585fbe63e879909a57ff455aab4735d6d36dfefcca7b001c7d766c074.NewMessageRecipientRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
