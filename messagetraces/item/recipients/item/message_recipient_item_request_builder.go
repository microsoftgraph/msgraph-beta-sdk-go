...
// DeleteWithResponseHandler delete navigation property recipients for messageTraces
...
// PatchWithResponseHandler update the navigation property recipients in messageTraces
