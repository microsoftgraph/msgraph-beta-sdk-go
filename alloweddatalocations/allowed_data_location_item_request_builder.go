...
func (m *AllowedDataLocationItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *AllowedDataLocationItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
