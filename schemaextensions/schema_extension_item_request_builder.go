...
// SchemaExtensionItemRequestBuilderGetQueryParameters get the properties of the specified schemaExtension definition. This API is available in the following national cloud deployments.
...
func NewSchemaExtensionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SchemaExtensionItemRequestBuilder) {
    m := &SchemaExtensionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/schemaExtensions/{schemaExtension%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get get the properties of the specified schemaExtension definition. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get the properties of the specified schemaExtension definition. This API is available in the following national cloud deployments.
