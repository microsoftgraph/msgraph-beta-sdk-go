...
func NewItemMicrosoftGraphCheckMemberGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphCheckMemberGroupsRequestBuilder) {
    m := &ItemMicrosoftGraphCheckMemberGroupsRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/directoryRoleTemplates/{directoryRoleTemplate%2Did}/microsoft.graph.checkMemberGroups";
...
func NewItemMicrosoftGraphCheckMemberGroupsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphCheckMemberGroupsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemMicrosoftGraphCheckMemberGroupsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemMicrosoftGraphCheckMemberGroupsRequestBuilder) Post(ctx context.Context, body ItemMicrosoftGraphCheckMemberGroupsCheckMemberGroupsPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphCheckMemberGroupsRequestBuilderPostRequestConfiguration)(ItemMicrosoftGraphCheckMemberGroupsCheckMemberGroupsResponseable, error) {
...
func (m *ItemMicrosoftGraphCheckMemberGroupsRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemMicrosoftGraphCheckMemberGroupsCheckMemberGroupsPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphCheckMemberGroupsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
