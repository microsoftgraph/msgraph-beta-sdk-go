...
// ItemProgramControlsRequestBuilderGetQueryParameters in the Microsoft Entra access reviews feature, list all the programControl objects, linked to a particular program. This API is available in the following national cloud deployments.
...
func NewItemProgramControlsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemProgramControlsRequestBuilder) {
    m := &ItemProgramControlsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/programControls/{programControl%2Did}/program/controls{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemProgramControlsRequestBuilder instantiates a new ControlsRequestBuilder and sets the default values.
...
// Get in the Microsoft Entra access reviews feature, list all the programControl objects, linked to a particular program. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation in the Microsoft Entra access reviews feature, list all the programControl objects, linked to a particular program. This API is available in the following national cloud deployments.
