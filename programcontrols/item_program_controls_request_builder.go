...
// ItemProgramControlsRequestBuilderGetQueryParameters in the Azure AD access reviews feature, list all the programControl objects, linked to a particular program.
...
func (m *ItemProgramControlsRequestBuilder) Count()(*ItemProgramControlsCountRequestBuilder) {
    return NewItemProgramControlsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemProgramControlsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemProgramControlsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/program-listcontrols?view=graph-rest-1.0
