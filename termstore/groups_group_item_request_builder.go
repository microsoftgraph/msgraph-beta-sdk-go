...
func (m *GroupsGroupItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *GroupsGroupItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
