...
// NewSetsItemParentGroupSetsItemTermsItemRelationsRequestBuilderInternal instantiates a new RelationsRequestBuilder and sets the default values.
...
// NewSetsItemParentGroupSetsItemTermsItemRelationsRequestBuilder instantiates a new RelationsRequestBuilder and sets the default values.
...
func (m *SetsItemParentGroupSetsItemTermsItemRelationsRequestBuilder) Count()(*SetsItemParentGroupSetsItemTermsItemRelationsCountRequestBuilder) {
    return NewSetsItemParentGroupSetsItemTermsItemRelationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation to indicate which terms are related to the current term as either pinned or reused.
func (m *SetsItemParentGroupSetsItemTermsItemRelationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *SetsItemParentGroupSetsItemTermsItemRelationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
