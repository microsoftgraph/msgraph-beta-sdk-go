...
// NewGroupsItemSetsItemChildrenRequestBuilderInternal instantiates a new GroupsItemSetsItemChildrenRequestBuilder and sets the default values.
func NewGroupsItemSetsItemChildrenRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupsItemSetsItemChildrenRequestBuilder) {
    m := &GroupsItemSetsItemChildrenRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/children{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewGroupsItemSetsItemChildrenRequestBuilder instantiates a new GroupsItemSetsItemChildrenRequestBuilder and sets the default values.
