...
// NewSetsItemParentGroupSetsItemTermsItemRelationsItemToTermRequestBuilderInternal instantiates a new SetsItemParentGroupSetsItemTermsItemRelationsItemToTermRequestBuilder and sets the default values.
...
// NewSetsItemParentGroupSetsItemTermsItemRelationsItemToTermRequestBuilder instantiates a new SetsItemParentGroupSetsItemTermsItemRelationsItemToTermRequestBuilder and sets the default values.
...
func (m *SetsItemParentGroupSetsItemTermsItemRelationsItemToTermRequestBuilder) WithUrl(rawUrl string)(*SetsItemParentGroupSetsItemTermsItemRelationsItemToTermRequestBuilder) {
    return NewSetsItemParentGroupSetsItemTermsItemRelationsItemToTermRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
