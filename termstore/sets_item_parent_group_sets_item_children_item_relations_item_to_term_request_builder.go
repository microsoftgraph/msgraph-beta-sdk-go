...
// NewSetsItemParentGroupSetsItemChildrenItemRelationsItemToTermRequestBuilderInternal instantiates a new SetsItemParentGroupSetsItemChildrenItemRelationsItemToTermRequestBuilder and sets the default values.
...
// NewSetsItemParentGroupSetsItemChildrenItemRelationsItemToTermRequestBuilder instantiates a new SetsItemParentGroupSetsItemChildrenItemRelationsItemToTermRequestBuilder and sets the default values.
...
func (m *SetsItemParentGroupSetsItemChildrenItemRelationsItemToTermRequestBuilder) WithUrl(rawUrl string)(*SetsItemParentGroupSetsItemChildrenItemRelationsItemToTermRequestBuilder) {
    return NewSetsItemParentGroupSetsItemChildrenItemRelationsItemToTermRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
