...
// NewSetsItemParentGroupSetsItemChildrenItemChildrenItemSetRequestBuilderInternal instantiates a new SetsItemParentGroupSetsItemChildrenItemChildrenItemSetRequestBuilder and sets the default values.
func NewSetsItemParentGroupSetsItemChildrenItemChildrenItemSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SetsItemParentGroupSetsItemChildrenItemChildrenItemSetRequestBuilder) {
    m := &SetsItemParentGroupSetsItemChildrenItemChildrenItemSetRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/{term%2Did1}/set{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewSetsItemParentGroupSetsItemChildrenItemChildrenItemSetRequestBuilder instantiates a new SetsItemParentGroupSetsItemChildrenItemChildrenItemSetRequestBuilder and sets the default values.
...
// returns a *SetsItemParentGroupSetsItemChildrenItemChildrenItemSetRequestBuilder when successful
func (m *SetsItemParentGroupSetsItemChildrenItemChildrenItemSetRequestBuilder) WithUrl(rawUrl string)(*SetsItemParentGroupSetsItemChildrenItemChildrenItemSetRequestBuilder) {
    return NewSetsItemParentGroupSetsItemChildrenItemChildrenItemSetRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
