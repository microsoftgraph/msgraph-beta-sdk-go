...
func (m *SetsItemParentGroupRequestBuilder) Delete(ctx context.Context, requestConfiguration *SetsItemParentGroupRequestBuilderDeleteRequestConfiguration)([]byte, error) {
