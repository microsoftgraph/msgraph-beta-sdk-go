...
// NewSetsItemChildrenItemChildrenItemRelationsItemToTermRequestBuilderInternal instantiates a new SetsItemChildrenItemChildrenItemRelationsItemToTermRequestBuilder and sets the default values.
...
// NewSetsItemChildrenItemChildrenItemRelationsItemToTermRequestBuilder instantiates a new SetsItemChildrenItemChildrenItemRelationsItemToTermRequestBuilder and sets the default values.
...
func (m *SetsItemChildrenItemChildrenItemRelationsItemToTermRequestBuilder) WithUrl(rawUrl string)(*SetsItemChildrenItemChildrenItemRelationsItemToTermRequestBuilder) {
    return NewSetsItemChildrenItemChildrenItemRelationsItemToTermRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
