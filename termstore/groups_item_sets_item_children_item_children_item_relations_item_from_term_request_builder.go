...
// NewGroupsItemSetsItemChildrenItemChildrenItemRelationsItemFromTermRequestBuilderInternal instantiates a new GroupsItemSetsItemChildrenItemChildrenItemRelationsItemFromTermRequestBuilder and sets the default values.
func NewGroupsItemSetsItemChildrenItemChildrenItemRelationsItemFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupsItemSetsItemChildrenItemChildrenItemRelationsItemFromTermRequestBuilder) {
    m := &GroupsItemSetsItemChildrenItemChildrenItemRelationsItemFromTermRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}/fromTerm{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewGroupsItemSetsItemChildrenItemChildrenItemRelationsItemFromTermRequestBuilder instantiates a new GroupsItemSetsItemChildrenItemChildrenItemRelationsItemFromTermRequestBuilder and sets the default values.
