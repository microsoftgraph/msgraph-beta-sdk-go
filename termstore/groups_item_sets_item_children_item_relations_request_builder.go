...
func (m *GroupsItemSetsItemChildrenItemRelationsRequestBuilder) Count()(*GroupsItemSetsItemChildrenItemRelationsCountRequestBuilder) {
    return NewGroupsItemSetsItemChildrenItemRelationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation to indicate which terms are related to the current term as either pinned or reused.
func (m *GroupsItemSetsItemChildrenItemRelationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *GroupsItemSetsItemChildrenItemRelationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
