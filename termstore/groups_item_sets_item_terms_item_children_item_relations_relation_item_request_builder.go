...
// NewGroupsItemSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilderInternal instantiates a new GroupsItemSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilder and sets the default values.
func NewGroupsItemSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*GroupsItemSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilder) {
    m := &GroupsItemSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewGroupsItemSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilder instantiates a new GroupsItemSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilder and sets the default values.
...
func (m *GroupsItemSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilder) FromTerm()(*GroupsItemSetsItemTermsItemChildrenItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewGroupsItemSetsItemTermsItemChildrenItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *GroupsItemSetsItemTermsItemChildrenItemRelationsRelationItemRequestBuilder) ToTerm()(*GroupsItemSetsItemTermsItemChildrenItemRelationsItemTotermToTermRequestBuilder) {
    return NewGroupsItemSetsItemTermsItemChildrenItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
