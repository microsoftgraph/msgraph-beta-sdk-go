...
import (
    ...
    ibd1cf0d1a808998cb4283947d195083992eb16864ae2d024790f302637476479 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/sets/item/relations/item/fromterm/ref"
)

// FromTermRequestBuilder builds and executes requests for operations under \termStore\sets\{set-id}\relations\{relation-id}\fromTerm
...
func NewFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FromTermRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/sets/{set_id}/relations/{relation_id}/fromTerm{?select,expand}";
...
func (m *FromTermRequestBuilder) Ref()(*ibd1cf0d1a808998cb4283947d195083992eb16864ae2d024790f302637476479.RefRequestBuilder) {
    return ibd1cf0d1a808998cb4283947d195083992eb16864ae2d024790f302637476479.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
