...
// Builds and executes requests for operations under \termStore\sets\{set-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/sets/{set_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*i2fcc62c950beb4c4299446e48c818ca4e40bea38e2a456b9b7c688f5c4cb5562.RefRequestBuilder) {
    return i2fcc62c950beb4c4299446e48c818ca4e40bea38e2a456b9b7c688f5c4cb5562.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
