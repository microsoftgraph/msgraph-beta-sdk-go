...
import (
    ...
    i6da2bb876f7b8180f4af785a6d629d8c1b503a4a4ede2dbc7c2381afea02cefd "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/sets/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/sets/{set%2Did}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *RelationsRequestBuilder) Count()(*i6da2bb876f7b8180f4af785a6d629d8c1b503a4a4ede2dbc7c2381afea02cefd.CountRequestBuilder) {
    return i6da2bb876f7b8180f4af785a6d629d8c1b503a4a4ede2dbc7c2381afea02cefd.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// GetWithResponseHandler indicates which terms have been pinned or reused directly under the set.
