...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property children for termStore
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property children in termStore
