...
import (
    ...
    i048f02a8dcfe6f817755fc291c61fcd9a11687b04412e44cba8c8df6e9fbf582 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/sets/item/parentgroup/sets/item/terms/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/sets/{set_id}/parentGroup/sets/{set_id1}/terms/{term_id}/children/{term_id1}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*i048f02a8dcfe6f817755fc291c61fcd9a11687b04412e44cba8c8df6e9fbf582.CountRequestBuilder) {
    return i048f02a8dcfe6f817755fc291c61fcd9a11687b04412e44cba8c8df6e9fbf582.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
