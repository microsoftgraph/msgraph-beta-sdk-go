...
import (
    ...
    ie8a3a699c713bed0ec5b30679dd86de2c956b117619aa3af1fc695dd5979950f "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/sets/item/parentgroup/sets/item/terms/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/sets/{set_id}/parentGroup/sets/{set_id1}/terms/{term_id}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*ie8a3a699c713bed0ec5b30679dd86de2c956b117619aa3af1fc695dd5979950f.CountRequestBuilder) {
    return ie8a3a699c713bed0ec5b30679dd86de2c956b117619aa3af1fc695dd5979950f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
