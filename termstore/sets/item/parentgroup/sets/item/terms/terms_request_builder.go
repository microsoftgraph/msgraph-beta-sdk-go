...
import (
    ...
    i3e33e45349974f7bbaf2a17556a14749df1de8dab601949619a813a42972dd00 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/sets/item/parentgroup/sets/item/terms/count"
)
...
func NewTermsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TermsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/sets/{set_id}/parentGroup/sets/{set_id1}/terms{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *TermsRequestBuilder) Count()(*i3e33e45349974f7bbaf2a17556a14749df1de8dab601949619a813a42972dd00.CountRequestBuilder) {
    return i3e33e45349974f7bbaf2a17556a14749df1de8dab601949619a813a42972dd00.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
