...
import (
    ...
    i9f8600e13075af2366ef6570aac4aed17f1687fec684375bfcc2462030f83a04 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/sets/item/children/item/relations/item/toterm/ref"
)

// Builds and executes requests for operations under \termStore\sets\{set-id}\children\{term-id}\relations\{relation-id}\toTerm
...
func NewToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ToTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/sets/{set_id}/children/{term_id}/relations/{relation_id}/toTerm{?select,expand}";
...
func (m *ToTermRequestBuilder) Ref()(*i9f8600e13075af2366ef6570aac4aed17f1687fec684375bfcc2462030f83a04.RefRequestBuilder) {
    return i9f8600e13075af2366ef6570aac4aed17f1687fec684375bfcc2462030f83a04.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
