...
import (
    ...
    ic736b321dd72cbe475b4b0a3da3148962ba98378695c008a127395cf4a2ba36b "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/sets/item/children/item/relations/item/fromterm/ref"
)

// FromTermRequestBuilder builds and executes requests for operations under \termStore\sets\{set-id}\children\{term-id}\relations\{relation-id}\fromTerm
...
func NewFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FromTermRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/sets/{set_id}/children/{term_id}/relations/{relation_id}/fromTerm{?select,expand}";
...
func (m *FromTermRequestBuilder) Ref()(*ic736b321dd72cbe475b4b0a3da3148962ba98378695c008a127395cf4a2ba36b.RefRequestBuilder) {
    return ic736b321dd72cbe475b4b0a3da3148962ba98378695c008a127395cf4a2ba36b.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
