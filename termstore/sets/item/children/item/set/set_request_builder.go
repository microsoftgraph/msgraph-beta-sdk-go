...
import (
    ...
    i4bf08e30a93ff865c23793e28f929c44147943316c9603442fdba61448f5fe30 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/sets/item/children/item/set/ref"
)

// Builds and executes requests for operations under \termStore\sets\{set-id}\children\{term-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/sets/{set_id}/children/{term_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*i4bf08e30a93ff865c23793e28f929c44147943316c9603442fdba61448f5fe30.RefRequestBuilder) {
    return i4bf08e30a93ff865c23793e28f929c44147943316c9603442fdba61448f5fe30.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
