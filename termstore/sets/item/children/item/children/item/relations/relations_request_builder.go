...
import (
    ...
    i168b48dd23ea6f3284c1962c5f26fedad74ef669bd424adfcdb45ce631575f4e "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/sets/item/children/item/children/item/relations/count"
)
...
func NewRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/sets/{set_id}/children/{term_id}/children/{term_id1}/relations{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *RelationsRequestBuilder) Count()(*i168b48dd23ea6f3284c1962c5f26fedad74ef669bd424adfcdb45ce631575f4e.CountRequestBuilder) {
    return i168b48dd23ea6f3284c1962c5f26fedad74ef669bd424adfcdb45ce631575f4e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
