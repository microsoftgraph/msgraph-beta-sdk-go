...
import (
    ...
    i9ca1edd726cce459d5ae00020e88cee37259dd64732ed99f765519777cf3b321 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/sets/item/terms/item/relations/item/fromterm/ref"
)

// FromTermRequestBuilder builds and executes requests for operations under \termStore\sets\{set-id}\terms\{term-id}\relations\{relation-id}\fromTerm
...
func NewFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FromTermRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/sets/{set_id}/terms/{term_id}/relations/{relation_id}/fromTerm{?select,expand}";
...
func (m *FromTermRequestBuilder) Ref()(*i9ca1edd726cce459d5ae00020e88cee37259dd64732ed99f765519777cf3b321.RefRequestBuilder) {
    return i9ca1edd726cce459d5ae00020e88cee37259dd64732ed99f765519777cf3b321.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
