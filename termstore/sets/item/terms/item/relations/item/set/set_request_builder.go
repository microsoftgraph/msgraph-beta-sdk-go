...
import (
    ...
    i44c904842de8025bb3adb75e888ed36c38686ca1978b1650260ed34cd5c0db14 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/sets/item/terms/item/relations/item/set/ref"
)

// Builds and executes requests for operations under \termStore\sets\{set-id}\terms\{term-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/sets/{set_id}/terms/{term_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*i44c904842de8025bb3adb75e888ed36c38686ca1978b1650260ed34cd5c0db14.RefRequestBuilder) {
    return i44c904842de8025bb3adb75e888ed36c38686ca1978b1650260ed34cd5c0db14.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
