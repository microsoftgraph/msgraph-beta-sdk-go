...
// NewSetsItemParentgroupSetsItemTermsCountRequestBuilderInternal instantiates a new SetsItemParentgroupSetsItemTermsCountRequestBuilder and sets the default values.
func NewSetsItemParentgroupSetsItemTermsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SetsItemParentgroupSetsItemTermsCountRequestBuilder) {
    m := &SetsItemParentgroupSetsItemTermsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewSetsItemParentgroupSetsItemTermsCountRequestBuilder instantiates a new SetsItemParentgroupSetsItemTermsCountRequestBuilder and sets the default values.
...
// returns a *SetsItemParentgroupSetsItemTermsCountRequestBuilder when successful
