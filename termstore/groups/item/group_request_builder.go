...
// Builds and executes requests for operations under \termStore\groups\{group-id}
...
func NewGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GroupRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/groups/{group_id}{?select,expand}";
...
func (m *GroupRequestBuilder) Sets()(*i2425ffbfb80a218f27445d567f31356b6cca64440d263769c315b7318a202beb.SetsRequestBuilder) {
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.termStore.groups.item.sets.item collection
// Parameters:
//  - id : Unique identifier of the item
func (m *GroupRequestBuilder) SetsById(id string)(*i34ff0def54196c2a26619dc8980b0dbec65b4a8ac07340a1ca1934211b31f4b7.SetRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i34ff0def54196c2a26619dc8980b0dbec65b4a8ac07340a1ca1934211b31f4b7.NewSetRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
