...
import (
    ...
    iea460ea086e40fb9127fa26086a5ed01b869f0d01ad8481b3e7990fdbba4aeee "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/count"
)
...
func NewSetsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/groups/{group_id}/sets{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *SetsRequestBuilder) Count()(*iea460ea086e40fb9127fa26086a5ed01b869f0d01ad8481b3e7990fdbba4aeee.CountRequestBuilder) {
    return iea460ea086e40fb9127fa26086a5ed01b869f0d01ad8481b3e7990fdbba4aeee.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
