...
import (
    ...
    i657cbbbb77019b60e30c07ce8adc79bbd6d32fd0f93a363f7cb65df6e666c156 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/relations/item/set/ref"
)

// Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/groups/{group_id}/sets/{set_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*i657cbbbb77019b60e30c07ce8adc79bbd6d32fd0f93a363f7cb65df6e666c156.RefRequestBuilder) {
    return i657cbbbb77019b60e30c07ce8adc79bbd6d32fd0f93a363f7cb65df6e666c156.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
