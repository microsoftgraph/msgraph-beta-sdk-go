...
import (
    ...
    ie048e66b90a5593037abff21579614cb1a89adab03a38e9e5d2478e9e7f23629 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/relations/item/toterm/ref"
)

// Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\relations\{relation-id}\toTerm
...
func NewToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ToTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/groups/{group_id}/sets/{set_id}/relations/{relation_id}/toTerm{?select,expand}";
...
func (m *ToTermRequestBuilder) Ref()(*ie048e66b90a5593037abff21579614cb1a89adab03a38e9e5d2478e9e7f23629.RefRequestBuilder) {
    return ie048e66b90a5593037abff21579614cb1a89adab03a38e9e5d2478e9e7f23629.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
