...
import (
    ...
    i4df664038819c16fde90abf554cb14a8aeb47be50ff0a57d9c46447e0e593261 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/relations/item/set"
    i8aee0d1ea9d443b0890f1fa20a9a58e3f5606019f8c93970dbc5ae58a826dc2d "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/relations/item/toterm"
    ibd29c7aabef448e3d7ea10cb9499600a384c2f4a6b4b00b0fd5abcf5fc9b0d99 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/relations/item/fromterm"
)

// RelationRequestBuilder builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\relations\{relation-id}
...
func NewRelationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RelationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/groups/{group_id}/sets/{set_id}/relations/{relation_id}{?select,expand}";
...
func (m *RelationRequestBuilder) FromTerm()(*ibd29c7aabef448e3d7ea10cb9499600a384c2f4a6b4b00b0fd5abcf5fc9b0d99.FromTermRequestBuilder) {
    return ibd29c7aabef448e3d7ea10cb9499600a384c2f4a6b4b00b0fd5abcf5fc9b0d99.NewFromTermRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *RelationRequestBuilder) Set()(*i4df664038819c16fde90abf554cb14a8aeb47be50ff0a57d9c46447e0e593261.SetRequestBuilder) {
    return i4df664038819c16fde90abf554cb14a8aeb47be50ff0a57d9c46447e0e593261.NewSetRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
func (m *RelationRequestBuilder) ToTerm()(*i8aee0d1ea9d443b0890f1fa20a9a58e3f5606019f8c93970dbc5ae58a826dc2d.ToTermRequestBuilder) {
    return i8aee0d1ea9d443b0890f1fa20a9a58e3f5606019f8c93970dbc5ae58a826dc2d.NewToTermRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
