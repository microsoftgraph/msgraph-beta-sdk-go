...
import (
    ...
    i3e397ec01f4ab80e2078f4183495bfc3443637899fea647439122b35bd087f1a "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/relations/item/fromterm/ref"
)

// FromTermRequestBuilder builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\relations\{relation-id}\fromTerm
...
func NewFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FromTermRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/groups/{group_id}/sets/{set_id}/relations/{relation_id}/fromTerm{?select,expand}";
...
func (m *FromTermRequestBuilder) Ref()(*i3e397ec01f4ab80e2078f4183495bfc3443637899fea647439122b35bd087f1a.RefRequestBuilder) {
    return i3e397ec01f4ab80e2078f4183495bfc3443637899fea647439122b35bd087f1a.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
