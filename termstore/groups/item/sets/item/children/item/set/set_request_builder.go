...
import (
    ...
    i129396cecb6481c59fc0732febdf6cf7c984c75ad6c228bcdd2ec046941f57e1 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/children/item/set/ref"
)

// Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\children\{term-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/groups/{group_id}/sets/{set_id}/children/{term_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*i129396cecb6481c59fc0732febdf6cf7c984c75ad6c228bcdd2ec046941f57e1.RefRequestBuilder) {
    return i129396cecb6481c59fc0732febdf6cf7c984c75ad6c228bcdd2ec046941f57e1.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
