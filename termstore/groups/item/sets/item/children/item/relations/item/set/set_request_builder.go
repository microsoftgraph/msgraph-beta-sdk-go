...
import (
    ...
    if9fceb500b993ba8431ea414d17ba0dce56493743b113a777cb46d751687336a "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/children/item/relations/item/set/ref"
)

// Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\children\{term-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/groups/{group_id}/sets/{set_id}/children/{term_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*if9fceb500b993ba8431ea414d17ba0dce56493743b113a777cb46d751687336a.RefRequestBuilder) {
    return if9fceb500b993ba8431ea414d17ba0dce56493743b113a777cb46d751687336a.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
