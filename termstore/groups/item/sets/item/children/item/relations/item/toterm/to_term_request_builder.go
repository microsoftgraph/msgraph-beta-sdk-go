...
import (
    ...
    i0dbb267acbd1ec3adbca7e981ee0a1249bffcd3542c3a5b69d2c99e3591e41f6 "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/children/item/relations/item/toterm/ref"
)

// Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\children\{term-id}\relations\{relation-id}\toTerm
...
func NewToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ToTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/groups/{group_id}/sets/{set_id}/children/{term_id}/relations/{relation_id}/toTerm{?select,expand}";
...
func (m *ToTermRequestBuilder) Ref()(*i0dbb267acbd1ec3adbca7e981ee0a1249bffcd3542c3a5b69d2c99e3591e41f6.RefRequestBuilder) {
    return i0dbb267acbd1ec3adbca7e981ee0a1249bffcd3542c3a5b69d2c99e3591e41f6.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
