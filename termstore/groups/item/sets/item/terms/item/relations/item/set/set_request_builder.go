...
import (
    ...
    if61bc98328b2587d34c9f98e0ddcd8034ea8f2428504f2919038e06799bdbd8c "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/terms/item/relations/item/set/ref"
)

// Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}\set
...
func NewSetRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SetRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/set{?select,expand}";
...
func (m *SetRequestBuilder) Ref()(*if61bc98328b2587d34c9f98e0ddcd8034ea8f2428504f2919038e06799bdbd8c.RefRequestBuilder) {
    return if61bc98328b2587d34c9f98e0ddcd8034ea8f2428504f2919038e06799bdbd8c.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
