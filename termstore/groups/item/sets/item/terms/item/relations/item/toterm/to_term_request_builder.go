...
import (
    ...
    ie7ec63baf71ea4e381ff914b005a5cd92d800265b33ff7bfcf9cdc42ffb622ed "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/terms/item/relations/item/toterm/ref"
)

// Builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}\toTerm
...
func NewToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ToTermRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/toTerm{?select,expand}";
...
func (m *ToTermRequestBuilder) Ref()(*ie7ec63baf71ea4e381ff914b005a5cd92d800265b33ff7bfcf9cdc42ffb622ed.RefRequestBuilder) {
    return ie7ec63baf71ea4e381ff914b005a5cd92d800265b33ff7bfcf9cdc42ffb622ed.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
