...
import (
    ...
    icfd9423b576b71effb2a3bc6f1cca85a9f6b50e8926915a6c4f9474b77883ddc "github.com/microsoftgraph/msgraph-beta-sdk-go/termstore/groups/item/sets/item/terms/item/relations/item/fromterm/ref"
)

// FromTermRequestBuilder builds and executes requests for operations under \termStore\groups\{group-id}\sets\{set-id}\terms\{term-id}\relations\{relation-id}\fromTerm
...
func NewFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*FromTermRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}/relations/{relation_id}/fromTerm{?select,expand}";
...
func (m *FromTermRequestBuilder) Get(options *FromTermRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Term, error) {
...
func (m *FromTermRequestBuilder) Ref()(*icfd9423b576b71effb2a3bc6f1cca85a9f6b50e8926915a6c4f9474b77883ddc.RefRequestBuilder) {
    return icfd9423b576b71effb2a3bc6f1cca85a9f6b50e8926915a6c4f9474b77883ddc.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
