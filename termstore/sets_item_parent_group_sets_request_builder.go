...
// SetsItemParentGroupSetsRequestBuilderGetQueryParameters get a list of the set objects and their properties. This API is supported in the following national cloud deployments.
