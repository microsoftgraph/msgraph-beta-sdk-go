...
// NewSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilderInternal instantiates a new SetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder and sets the default values.
func NewSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder) {
    m := &SetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder instantiates a new SetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder and sets the default values.
...
// returns a *SetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsItemFromtermFromTermRequestBuilder when successful
func (m *SetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder) FromTerm()(*SetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsItemFromtermFromTermRequestBuilder) {
    return NewSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsItemFromtermFromTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *SetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsItemTotermToTermRequestBuilder when successful
func (m *SetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder) ToTerm()(*SetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsItemTotermToTermRequestBuilder) {
    return NewSetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsItemTotermToTermRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// WithUrl returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
// returns a *SetsItemParentgroupSetsItemChildrenItemChildrenItemRelationsRelationItemRequestBuilder when successful
