...
// NewSetsItemTermsItemChildrenCountRequestBuilderInternal instantiates a new SetsItemTermsItemChildrenCountRequestBuilder and sets the default values.
func NewSetsItemTermsItemChildrenCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SetsItemTermsItemChildrenCountRequestBuilder) {
    m := &SetsItemTermsItemChildrenCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/children/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewSetsItemTermsItemChildrenCountRequestBuilder instantiates a new SetsItemTermsItemChildrenCountRequestBuilder and sets the default values.
