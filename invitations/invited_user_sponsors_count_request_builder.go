...
func (m *InvitedUserSponsorsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *InvitedUserSponsorsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
