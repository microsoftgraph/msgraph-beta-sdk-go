...
func NewMicrosoftGraphValidatePropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MicrosoftGraphValidatePropertiesRequestBuilder) {
    m := &MicrosoftGraphValidatePropertiesRequestBuilder{
    }
...
func NewMicrosoftGraphValidatePropertiesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MicrosoftGraphValidatePropertiesRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewMicrosoftGraphValidatePropertiesRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *MicrosoftGraphValidatePropertiesRequestBuilder) Post(ctx context.Context, body MicrosoftGraphValidatePropertiesValidatePropertiesPostRequestBodyable, requestConfiguration *MicrosoftGraphValidatePropertiesRequestBuilderPostRequestConfiguration)(error) {
...
func (m *MicrosoftGraphValidatePropertiesRequestBuilder) ToPostRequestInformation(ctx context.Context, body MicrosoftGraphValidatePropertiesValidatePropertiesPostRequestBodyable, requestConfiguration *MicrosoftGraphValidatePropertiesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
