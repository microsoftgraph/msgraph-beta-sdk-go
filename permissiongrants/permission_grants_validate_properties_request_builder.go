...
func NewPermissionGrantsValidatePropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissionGrantsValidatePropertiesRequestBuilder) {
    m := &PermissionGrantsValidatePropertiesRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/permissionGrants/microsoft.graph.validateProperties";
...
func NewPermissionGrantsValidatePropertiesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PermissionGrantsValidatePropertiesRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewPermissionGrantsValidatePropertiesRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *PermissionGrantsValidatePropertiesRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PermissionGrantsValidatePropertiesPostRequestBodyable, requestConfiguration *PermissionGrantsValidatePropertiesRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PermissionGrantsValidatePropertiesRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PermissionGrantsValidatePropertiesPostRequestBodyable, requestConfiguration *PermissionGrantsValidatePropertiesRequestBuilderPostRequestConfiguration)(error) {
