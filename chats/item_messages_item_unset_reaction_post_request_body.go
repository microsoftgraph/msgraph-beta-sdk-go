...
// ItemMessagesItemUnsetReactionPostRequestBody provides operations to call the unsetReaction method.
...
func (m *ItemMessagesItemUnsetReactionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMessagesItemUnsetReactionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
