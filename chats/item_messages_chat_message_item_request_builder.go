...
func (m *ItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphSetReaction()(*ItemMessagesItemMicrosoftGraphSetReactionRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphSetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemMessagesChatMessageItemRequestBuilder) MicrosoftGraphUnsetReaction()(*ItemMessagesItemMicrosoftGraphUnsetReactionRequestBuilder) {
    return NewItemMessagesItemMicrosoftGraphUnsetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
