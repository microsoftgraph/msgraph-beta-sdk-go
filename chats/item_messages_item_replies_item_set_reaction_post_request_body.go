...
// ItemMessagesItemRepliesItemSetReactionPostRequestBody provides operations to call the setReaction method.
...
func (m *ItemMessagesItemRepliesItemSetReactionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMessagesItemRepliesItemSetReactionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
