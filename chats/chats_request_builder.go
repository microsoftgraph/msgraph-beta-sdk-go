...
func (m *ChatsRequestBuilder) Get(ctx context.Context, requestConfiguration *ChatsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ChatCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateChatCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ChatsRequestBuilder) MicrosoftGraphAllMessages()(*MicrosoftGraphAllMessagesAllMessagesRequestBuilder) {
    return NewMicrosoftGraphAllMessagesAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetAllMessages provides operations to call the getAllMessages method.
func (m *ChatsRequestBuilder) MicrosoftGraphGetAllMessages()(*MicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilder) {
    return NewMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
