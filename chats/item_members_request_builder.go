...
// ItemMembersRequestBuilderGetQueryParameters a collection of all the members in the chat. Nullable.
...
// ToPostRequestInformation create new navigation property to members for chats
