...
func NewItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder) {
    m := &ItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder{
    }
...
func NewItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder) {
    ...
    return NewItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilderInternal(urlParams, requestAdapter)
}
// Get invoke function delta
func (m *ItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilderGetRequestConfiguration)(ItemMessagesItemRepliesMicrosoftGraphDeltaDeltaResponseable, error) {
...
func (m *ItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemMessagesItemRepliesMicrosoftGraphDeltaRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
