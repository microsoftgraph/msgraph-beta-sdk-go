...
// ItemOperationsRequestBuilderGetQueryParameters list all Teams async operations that ran or are running on the specified chat. This API is available in the following national cloud deployments.
