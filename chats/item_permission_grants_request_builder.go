...
func (m *ItemPermissionGrantsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*ItemPermissionGrantsMicrosoftGraphGetUserOwnedObjectsRequestBuilder) {
    return NewItemPermissionGrantsMicrosoftGraphGetUserOwnedObjectsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
