...
// ItemMarkChatReadForUserPostRequestBody provides operations to call the markChatReadForUser method.
...
func NewItemMarkChatReadForUserPostRequestBody()(*ItemMarkChatReadForUserPostRequestBody) {
    m := &ItemMarkChatReadForUserPostRequestBody{
    }
...
func (m *ItemMarkChatReadForUserPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMarkChatReadForUserPostRequestBody) GetTenantId()(*string) {
    return m.tenantId
}
// GetUser gets the user property value. The user property
func (m *ItemMarkChatReadForUserPostRequestBody) GetUser()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkUserIdentityable) {
    return m.user
}
...
func (m *ItemMarkChatReadForUserPostRequestBody) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetTenantId sets the tenantId property value. The tenantId property
func (m *ItemMarkChatReadForUserPostRequestBody) SetTenantId(value *string)() {
    m.tenantId = value
}
// SetUser sets the user property value. The user property
func (m *ItemMarkChatReadForUserPostRequestBody) SetUser(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkUserIdentityable)() {
    m.user = value
}
