...
func (m *ItemMessagesItemRepliesRequestBuilder) MicrosoftGraphDelta()(*ItemMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
