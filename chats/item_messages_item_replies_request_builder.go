...
func (m *ItemMessagesItemRepliesRequestBuilder) ByChatMessageId1(chatMessageId1 string)(*ItemMessagesItemRepliesChatMessageItemRequestBuilder) {
    ...
    return NewItemMessagesItemRepliesChatMessageItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
...
func NewItemMessagesItemRepliesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMessagesItemRepliesRequestBuilder) {
    m := &ItemMessagesItemRepliesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
...
func NewItemMessagesItemRepliesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMessagesItemRepliesRequestBuilder) {
    ...
    return NewItemMessagesItemRepliesRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemMessagesItemRepliesRequestBuilder) Count()(*ItemMessagesItemRepliesCountRequestBuilder) {
    return NewItemMessagesItemRepliesCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemMessagesItemRepliesRequestBuilder) ForwardToChat()(*ItemMessagesItemRepliesForwardToChatRequestBuilder) {
    return NewItemMessagesItemRepliesForwardToChatRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemMessagesItemRepliesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMessagesItemRepliesRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ChatMessageCollectionResponseable, error) {
...
func (m *ItemMessagesItemRepliesRequestBuilder) ReplyWithQuote()(*ItemMessagesItemRepliesReplyWithQuoteRequestBuilder) {
    return NewItemMessagesItemRepliesReplyWithQuoteRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *ItemMessagesItemRepliesRequestBuilder when successful
func (m *ItemMessagesItemRepliesRequestBuilder) WithUrl(rawUrl string)(*ItemMessagesItemRepliesRequestBuilder) {
    return NewItemMessagesItemRepliesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
