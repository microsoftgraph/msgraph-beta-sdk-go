...
func (m *ItemMessagesItemSetReactionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemMessagesItemSetReactionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
