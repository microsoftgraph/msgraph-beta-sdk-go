...
func NewItemMarkchatreadforuserMarkChatReadForUserPostRequestBody()(*ItemMarkchatreadforuserMarkChatReadForUserPostRequestBody) {
    m := &ItemMarkchatreadforuserMarkChatReadForUserPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemMarkchatreadforuserMarkChatReadForUserPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateItemMarkchatreadforuserMarkChatReadForUserPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemMarkchatreadforuserMarkChatReadForUserPostRequestBody(), nil
}
...
func (m *ItemMarkchatreadforuserMarkChatReadForUserPostRequestBody) GetTenantId()(*string) {
...
func (m *ItemMarkchatreadforuserMarkChatReadForUserPostRequestBody) GetUser()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkUserIdentityable) {
...
func (m *ItemMarkchatreadforuserMarkChatReadForUserPostRequestBody) SetTenantId(value *string)() {
...
func (m *ItemMarkchatreadforuserMarkChatReadForUserPostRequestBody) SetUser(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkUserIdentityable)() {
    err := m.GetBackingStore().Set("user", value)
    if err != nil {
        panic(err)
    }
}
type ItemMarkchatreadforuserMarkChatReadForUserPostRequestBodyable interface {
