...
func (m *ItemMessagesItemHostedContentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMessagesItemHostedContentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
