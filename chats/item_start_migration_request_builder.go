...
// ItemStartMigrationRequestBuilder provides operations to call the startMigration method.
type ItemStartMigrationRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemStartMigrationRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemStartMigrationRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewItemStartMigrationRequestBuilderInternal instantiates a new ItemStartMigrationRequestBuilder and sets the default values.
func NewItemStartMigrationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemStartMigrationRequestBuilder) {
    m := &ItemStartMigrationRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/chats/{chat%2Did}/startMigration", pathParameters),
    }
    return m
}
// NewItemStartMigrationRequestBuilder instantiates a new ItemStartMigrationRequestBuilder and sets the default values.
func NewItemStartMigrationRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemStartMigrationRequestBuilder) {
...
func (m *ItemStartMigrationRequestBuilder) WithUrl(rawUrl string)(*ItemStartMigrationRequestBuilder) {
    return NewItemStartMigrationRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
