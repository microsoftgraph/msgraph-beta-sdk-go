...
import (
    ...
    i17a4573784271ef9bb964da01a2257da91285804a1a8c4d37122cbb09c60ae67 "github.com/microsoftgraph/msgraph-beta-sdk-go/chats/item/installedapps/item/teamsapp/ref"
)
...
func NewTeamsAppRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TeamsAppRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/chats/{chat_id}/installedApps/{teamsAppInstallation_id}/teamsApp{?select,expand}";
...
func (m *TeamsAppRequestBuilder) CreateGetRequestInformation(q func (value *TeamsAppRequestBuilderGetQueryParameters) (err error), h func (value map[string]string) (err error), o []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    ...
    if q != nil {
        qParams := new(TeamsAppRequestBuilderGetQueryParameters)
        err := q(qParams)
        if err != nil {
            return nil, err
        }
...
func (m *TeamsAppRequestBuilder) Ref()(*i17a4573784271ef9bb964da01a2257da91285804a1a8c4d37122cbb09c60ae67.RefRequestBuilder) {
    return i17a4573784271ef9bb964da01a2257da91285804a1a8c4d37122cbb09c60ae67.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
