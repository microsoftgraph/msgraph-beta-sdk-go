...
// ResourceSpecificPermissionGrantItemRequestBuilder builds and executes requests for operations under \chats\{chat-id}\permissionGrants\{resourceSpecificPermissionGrant-id}
...
func NewResourceSpecificPermissionGrantItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ResourceSpecificPermissionGrantItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/chats/{chat_id}/permissionGrants/{resourceSpecificPermissionGrant_id}{?select,expand}";
...
// CreateDeleteRequestInformation a collection of permissions granted to apps for the chat.
...
// CreatePatchRequestInformation a collection of permissions granted to apps for the chat.
...
// Delete a collection of permissions granted to apps for the chat.
...
func (m *ResourceSpecificPermissionGrantItemRequestBuilder) Get(options *ResourceSpecificPermissionGrantItemRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ResourceSpecificPermissionGrant, error) {
...
// Patch a collection of permissions granted to apps for the chat.
