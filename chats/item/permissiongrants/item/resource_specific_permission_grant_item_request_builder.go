...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property permissionGrants for chats
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property permissionGrants in chats
