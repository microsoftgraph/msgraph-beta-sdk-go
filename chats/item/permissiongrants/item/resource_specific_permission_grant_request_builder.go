...
// Builds and executes requests for operations under \chats\{chat-id}\permissionGrants\{resourceSpecificPermissionGrant-id}
...
func NewResourceSpecificPermissionGrantRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ResourceSpecificPermissionGrantRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/chats/{chat_id}/permissionGrants/{resourceSpecificPermissionGrant_id}{?select,expand}";
