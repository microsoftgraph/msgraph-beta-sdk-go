...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to permissionGrants for chats
...
// PostWithResponseHandler create new navigation property to permissionGrants for chats
