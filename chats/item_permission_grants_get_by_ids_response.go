...
// ItemPermissionGrantsGetByIdsResponse provides operations to call the getByIds method.
...
func (m *ItemPermissionGrantsGetByIdsResponse) GetValue()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DirectoryObjectable) {
    return m.value
}
...
func (m *ItemPermissionGrantsGetByIdsResponse) SetValue(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DirectoryObjectable)() {
    m.value = value
}
