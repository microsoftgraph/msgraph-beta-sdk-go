...
func (m *ItemMessagesItemRepliesItemHostedContentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMessagesItemRepliesItemHostedContentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
