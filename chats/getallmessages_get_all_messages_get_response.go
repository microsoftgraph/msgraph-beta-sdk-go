...
func NewGetallmessagesGetAllMessagesGetResponse()(*GetallmessagesGetAllMessagesGetResponse) {
    m := &GetallmessagesGetAllMessagesGetResponse{
        BaseCollectionPaginationCountResponse: *ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.NewBaseCollectionPaginationCountResponse(),
    }
    return m
}
// CreateGetallmessagesGetAllMessagesGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateGetallmessagesGetAllMessagesGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGetallmessagesGetAllMessagesGetResponse(), nil
}
...
func (m *GetallmessagesGetAllMessagesGetResponse) GetValue()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ChatMessageable) {
...
func (m *GetallmessagesGetAllMessagesGetResponse) SetValue(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ChatMessageable)() {
    err := m.GetBackingStore().Set("value", value)
    if err != nil {
        panic(err)
    }
}
type GetallmessagesGetAllMessagesGetResponseable interface {
