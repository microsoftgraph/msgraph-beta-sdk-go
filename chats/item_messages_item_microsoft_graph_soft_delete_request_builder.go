...
func NewItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder) {
    m := &ItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder{
    }
...
func NewItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder) {
    ...
    return NewItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *ItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
