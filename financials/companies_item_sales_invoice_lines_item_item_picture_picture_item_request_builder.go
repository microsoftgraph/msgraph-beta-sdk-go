...
func NewCompaniesItemSalesInvoiceLinesItemItemPicturePictureItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemSalesInvoiceLinesItemItemPicturePictureItemRequestBuilder) {
    m := &CompaniesItemSalesInvoiceLinesItemItemPicturePictureItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoiceLines/{salesInvoiceLine%2Did}/item/picture/{picture%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *CompaniesItemSalesInvoiceLinesItemItemPicturePictureItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemSalesInvoiceLinesItemItemPicturePictureItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
