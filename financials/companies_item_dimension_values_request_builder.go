...
func (m *CompaniesItemDimensionValuesRequestBuilder) Count()(*CompaniesItemDimensionValuesCountRequestBuilder) {
    return NewCompaniesItemDimensionValuesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get dimensionValues from financials
func (m *CompaniesItemDimensionValuesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemDimensionValuesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
