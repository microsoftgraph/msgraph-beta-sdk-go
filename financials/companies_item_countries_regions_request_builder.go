...
func (m *CompaniesItemCountriesRegionsRequestBuilder) Count()(*CompaniesItemCountriesRegionsCountRequestBuilder) {
    return NewCompaniesItemCountriesRegionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get countriesRegions from financials
func (m *CompaniesItemCountriesRegionsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemCountriesRegionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
