...
// NewCompaniesItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilderInternal instantiates a new ContentRequestBuilder and sets the default values.
...
// NewCompaniesItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder instantiates a new ContentRequestBuilder and sets the default values.
...
func (m *CompaniesItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CompaniesItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *CompaniesItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilderPutRequestConfiguration)(error) {
