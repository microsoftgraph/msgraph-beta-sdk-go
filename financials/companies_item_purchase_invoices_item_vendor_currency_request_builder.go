...
func (m *CompaniesItemPurchaseInvoicesItemVendorCurrencyRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemPurchaseInvoicesItemVendorCurrencyRequestBuilderDeleteRequestConfiguration)([]byte, error) {
