...
// NewCompaniesItemSalesInvoicesItemSalesInvoiceLinesRequestBuilderInternal instantiates a new CompaniesItemSalesInvoicesItemSalesInvoiceLinesRequestBuilder and sets the default values.
...
// NewCompaniesItemSalesInvoicesItemSalesInvoiceLinesRequestBuilder instantiates a new CompaniesItemSalesInvoicesItemSalesInvoiceLinesRequestBuilder and sets the default values.
...
func (m *CompaniesItemSalesInvoicesItemSalesInvoiceLinesRequestBuilder) WithUrl(rawUrl string)(*CompaniesItemSalesInvoicesItemSalesInvoiceLinesRequestBuilder) {
    return NewCompaniesItemSalesInvoicesItemSalesInvoiceLinesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
