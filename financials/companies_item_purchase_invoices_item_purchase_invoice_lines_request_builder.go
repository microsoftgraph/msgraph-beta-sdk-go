...
// NewCompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesRequestBuilderInternal instantiates a new CompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesRequestBuilder and sets the default values.
...
// NewCompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesRequestBuilder instantiates a new CompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesRequestBuilder and sets the default values.
...
// returns a *CompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesRequestBuilder when successful
func (m *CompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesRequestBuilder) WithUrl(rawUrl string)(*CompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesRequestBuilder) {
    return NewCompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
