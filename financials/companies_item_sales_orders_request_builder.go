...
// NewCompaniesItemSalesOrdersRequestBuilderInternal instantiates a new SalesOrdersRequestBuilder and sets the default values.
...
// NewCompaniesItemSalesOrdersRequestBuilder instantiates a new SalesOrdersRequestBuilder and sets the default values.
...
func (m *CompaniesItemSalesOrdersRequestBuilder) Count()(*CompaniesItemSalesOrdersCountRequestBuilder) {
    return NewCompaniesItemSalesOrdersCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get salesOrders from financials
func (m *CompaniesItemSalesOrdersRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesOrdersRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
