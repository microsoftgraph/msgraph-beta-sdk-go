...
// NewCompaniesItemDimensionvaluesDimensionValueItemRequestBuilderInternal instantiates a new CompaniesItemDimensionvaluesDimensionValueItemRequestBuilder and sets the default values.
func NewCompaniesItemDimensionvaluesDimensionValueItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemDimensionvaluesDimensionValueItemRequestBuilder) {
    m := &CompaniesItemDimensionvaluesDimensionValueItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/dimensionValues/{dimensionValue%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewCompaniesItemDimensionvaluesDimensionValueItemRequestBuilder instantiates a new CompaniesItemDimensionvaluesDimensionValueItemRequestBuilder and sets the default values.
