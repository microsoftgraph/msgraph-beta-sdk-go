...
func (m *CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemItemCategoryRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemItemCategoryRequestBuilderDeleteRequestConfiguration)([]byte, error) {
