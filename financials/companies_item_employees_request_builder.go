...
// CompaniesItemEmployeesRequestBuilder provides operations to manage the employees property of the microsoft.graph.company entity.
type CompaniesItemEmployeesRequestBuilder struct {
...
// CompaniesItemEmployeesRequestBuilderGetQueryParameters get employees from financials
type CompaniesItemEmployeesRequestBuilderGetQueryParameters struct {
...
// CompaniesItemEmployeesRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type CompaniesItemEmployeesRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *CompaniesItemEmployeesRequestBuilderGetQueryParameters
}
// CompaniesItemEmployeesRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type CompaniesItemEmployeesRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func (m *CompaniesItemEmployeesRequestBuilder) Count()(*CompaniesItemEmployeesCountRequestBuilder) {
    return NewCompaniesItemEmployeesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get employees from financials
func (m *CompaniesItemEmployeesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemEmployeesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
