...
func (m *CompaniesItemJournalsJournalItemRequestBuilder) MicrosoftGraphPost()(*CompaniesItemJournalsItemMicrosoftGraphPostRequestBuilder) {
    return NewCompaniesItemJournalsItemMicrosoftGraphPostRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
