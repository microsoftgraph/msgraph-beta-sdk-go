...
func (m *CompaniesItemJournalsJournalItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemJournalsJournalItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
