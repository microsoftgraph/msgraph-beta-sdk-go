...
func (m *CompaniesItemJournalsJournalItemRequestBuilder) Account()(*CompaniesItemJournalsItemAccountRequestBuilder) {
    return NewCompaniesItemJournalsItemAccountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// NewCompaniesItemJournalsJournalItemRequestBuilderInternal instantiates a new CompaniesItemJournalsJournalItemRequestBuilder and sets the default values.
func NewCompaniesItemJournalsJournalItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemJournalsJournalItemRequestBuilder) {
    m := &CompaniesItemJournalsJournalItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewCompaniesItemJournalsJournalItemRequestBuilder instantiates a new CompaniesItemJournalsJournalItemRequestBuilder and sets the default values.
...
func (m *CompaniesItemJournalsJournalItemRequestBuilder) PostPath()(*CompaniesItemJournalsItemPostRequestBuilder) {
    return NewCompaniesItemJournalsItemPostRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *CompaniesItemJournalsJournalItemRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemJournalsJournalItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DELETE, "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}", m.BaseRequestBuilder.PathParameters)
...
func (m *CompaniesItemJournalsJournalItemRequestBuilder) ToPatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Journalable, requestConfiguration *CompaniesItemJournalsJournalItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.PATCH, "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}", m.BaseRequestBuilder.PathParameters)
    if requestConfiguration != nil {
        requestInfo.Headers.AddAll(requestConfiguration.Headers)
        requestInfo.AddRequestOptions(requestConfiguration.Options)
    }
...
func (m *CompaniesItemJournalsJournalItemRequestBuilder) WithUrl(rawUrl string)(*CompaniesItemJournalsJournalItemRequestBuilder) {
    return NewCompaniesItemJournalsJournalItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
