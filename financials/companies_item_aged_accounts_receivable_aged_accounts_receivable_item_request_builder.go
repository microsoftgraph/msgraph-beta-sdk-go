...
// NewCompaniesItemAgedAccountsReceivableAgedAccountsReceivableItemRequestBuilderInternal instantiates a new CompaniesItemAgedAccountsReceivableAgedAccountsReceivableItemRequestBuilder and sets the default values.
func NewCompaniesItemAgedAccountsReceivableAgedAccountsReceivableItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemAgedAccountsReceivableAgedAccountsReceivableItemRequestBuilder) {
    m := &CompaniesItemAgedAccountsReceivableAgedAccountsReceivableItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/agedAccountsReceivable/{agedAccountsReceivable%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewCompaniesItemAgedAccountsReceivableAgedAccountsReceivableItemRequestBuilder instantiates a new CompaniesItemAgedAccountsReceivableAgedAccountsReceivableItemRequestBuilder and sets the default values.
