...
func (m *CompaniesItemPurchaseinvoicesItemPurchaseinvoicelinesItemItemRequestBuilder) ItemCategory()(*CompaniesItemPurchaseinvoicesItemPurchaseinvoicelinesItemItemItemcategoryItemCategoryRequestBuilder) {
    return NewCompaniesItemPurchaseinvoicesItemPurchaseinvoicelinesItemItemItemcategoryItemCategoryRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
