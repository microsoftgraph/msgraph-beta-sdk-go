...
// NewCompaniesItemAgedAccountsReceivableRequestBuilder instantiates a new AgedAccountsReceivableRequestBuilder and sets the default values.
...
func (m *CompaniesItemAgedAccountsReceivableRequestBuilder) Count()(*CompaniesItemAgedAccountsReceivableCountRequestBuilder) {
    return NewCompaniesItemAgedAccountsReceivableCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get agedAccountsReceivable from financials
func (m *CompaniesItemAgedAccountsReceivableRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemAgedAccountsReceivableRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CompaniesItemAgedAccountsReceivableRequestBuilder) Get(ctx context.Context, requestConfiguration *CompaniesItemAgedAccountsReceivableRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AgedAccountsReceivableCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateAgedAccountsReceivableCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
