...
func (m *CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
