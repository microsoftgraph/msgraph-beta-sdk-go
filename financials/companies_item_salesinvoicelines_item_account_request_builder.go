...
// NewCompaniesItemSalesinvoicelinesItemAccountRequestBuilderInternal instantiates a new CompaniesItemSalesinvoicelinesItemAccountRequestBuilder and sets the default values.
func NewCompaniesItemSalesinvoicelinesItemAccountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemSalesinvoicelinesItemAccountRequestBuilder) {
    m := &CompaniesItemSalesinvoicelinesItemAccountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoiceLines/{salesInvoiceLine%2Did}/account{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewCompaniesItemSalesinvoicelinesItemAccountRequestBuilder instantiates a new CompaniesItemSalesinvoicelinesItemAccountRequestBuilder and sets the default values.
