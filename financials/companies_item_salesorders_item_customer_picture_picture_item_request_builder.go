...
// NewCompaniesItemSalesordersItemCustomerPicturePictureItemRequestBuilderInternal instantiates a new CompaniesItemSalesordersItemCustomerPicturePictureItemRequestBuilder and sets the default values.
func NewCompaniesItemSalesordersItemCustomerPicturePictureItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemSalesordersItemCustomerPicturePictureItemRequestBuilder) {
    m := &CompaniesItemSalesordersItemCustomerPicturePictureItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesOrders/{salesOrder%2Did}/customer/picture/{picture%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewCompaniesItemSalesordersItemCustomerPicturePictureItemRequestBuilder instantiates a new CompaniesItemSalesordersItemCustomerPicturePictureItemRequestBuilder and sets the default values.
