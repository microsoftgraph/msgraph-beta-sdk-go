...
func (m *CompaniesItemCustomerPaymentJournalsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CompaniesItemCustomerPaymentJournalsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
