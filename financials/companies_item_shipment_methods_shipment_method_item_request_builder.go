...
func NewCompaniesItemShipmentMethodsShipmentMethodItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemShipmentMethodsShipmentMethodItemRequestBuilder) {
    m := &CompaniesItemShipmentMethodsShipmentMethodItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/shipmentMethods/{shipmentMethod%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *CompaniesItemShipmentMethodsShipmentMethodItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemShipmentMethodsShipmentMethodItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
