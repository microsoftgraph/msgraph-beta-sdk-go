...
func NewCompaniesItemShipmentMethodsShipmentMethodItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, shipmentMethodId *string)(*CompaniesItemShipmentMethodsShipmentMethodItemRequestBuilder) {
...
func NewCompaniesItemShipmentMethodsShipmentMethodItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemShipmentMethodsShipmentMethodItemRequestBuilder) {
    ...
    return NewCompaniesItemShipmentMethodsShipmentMethodItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
