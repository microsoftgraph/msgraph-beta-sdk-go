...
func (m *CompaniesItemJournalsItemJournalLinesRequestBuilder) Count()(*CompaniesItemJournalsItemJournalLinesCountRequestBuilder) {
    return NewCompaniesItemJournalsItemJournalLinesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get journalLines from financials
func (m *CompaniesItemJournalsItemJournalLinesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemJournalsItemJournalLinesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
