...
func (m *CompaniesItemPurchaseInvoicesPurchaseInvoiceItemRequestBuilder) MicrosoftGraphPost()(*CompaniesItemPurchaseInvoicesItemMicrosoftGraphPostRequestBuilder) {
    return NewCompaniesItemPurchaseInvoicesItemMicrosoftGraphPostRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
