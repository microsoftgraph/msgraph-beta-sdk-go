...
func NewCompaniesItemSalesQuotesItemCurrencyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemSalesQuotesItemCurrencyRequestBuilder) {
    m := &CompaniesItemSalesQuotesItemCurrencyRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesQuotes/{salesQuote%2Did}/currency{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *CompaniesItemSalesQuotesItemCurrencyRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemSalesQuotesItemCurrencyRequestBuilderDeleteRequestConfiguration)([]byte, error) {
