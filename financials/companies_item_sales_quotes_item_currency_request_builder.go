...
// NewCompaniesItemSalesQuotesItemCurrencyRequestBuilderInternal instantiates a new CurrencyRequestBuilder and sets the default values.
...
// NewCompaniesItemSalesQuotesItemCurrencyRequestBuilder instantiates a new CurrencyRequestBuilder and sets the default values.
...
func (m *CompaniesItemSalesQuotesItemCurrencyRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesQuotesItemCurrencyRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CompaniesItemSalesQuotesItemCurrencyRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesQuotesItemCurrencyRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
