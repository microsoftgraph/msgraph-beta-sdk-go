...
// NewCompaniesItemJournalsItemJournalLinesItemAccountRequestBuilderInternal instantiates a new CompaniesItemJournalsItemJournalLinesItemAccountRequestBuilder and sets the default values.
func NewCompaniesItemJournalsItemJournalLinesItemAccountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemJournalsItemJournalLinesItemAccountRequestBuilder) {
    m := &CompaniesItemJournalsItemJournalLinesItemAccountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}/journalLines/{journalLine%2Did}/account{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewCompaniesItemJournalsItemJournalLinesItemAccountRequestBuilder instantiates a new CompaniesItemJournalsItemJournalLinesItemAccountRequestBuilder and sets the default values.
