...
func (m *CompaniesItemSalesQuotesItemCustomerPictureCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CompaniesItemSalesQuotesItemCustomerPictureCountRequestBuilderGetRequestConfiguration)(*int64, error) {
