...
func (m *CompaniesItemPurchaseInvoicesRequestBuilder) Count()(*CompaniesItemPurchaseInvoicesCountRequestBuilder) {
    return NewCompaniesItemPurchaseInvoicesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get purchaseInvoices from financials
func (m *CompaniesItemPurchaseInvoicesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemPurchaseInvoicesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
