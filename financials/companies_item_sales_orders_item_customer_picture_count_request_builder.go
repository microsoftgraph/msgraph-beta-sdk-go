...
func (m *CompaniesItemSalesOrdersItemCustomerPictureCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CompaniesItemSalesOrdersItemCustomerPictureCountRequestBuilderGetRequestConfiguration)(*int64, error) {
