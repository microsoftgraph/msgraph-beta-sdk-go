...
// CompaniesItemEmployeesItemPictureItemContentRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type CompaniesItemEmployeesItemPictureItemContentRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// NewCompaniesItemEmployeesItemPictureItemContentRequestBuilderInternal instantiates a new CompaniesItemEmployeesItemPictureItemContentRequestBuilder and sets the default values.
...
// NewCompaniesItemEmployeesItemPictureItemContentRequestBuilder instantiates a new CompaniesItemEmployeesItemPictureItemContentRequestBuilder and sets the default values.
...
func (m *CompaniesItemEmployeesItemPictureItemContentRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemEmployeesItemPictureItemContentRequestBuilderDeleteRequestConfiguration)(error) {
...
func (m *CompaniesItemEmployeesItemPictureItemContentRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemEmployeesItemPictureItemContentRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
