...
// CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// NewCompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilderInternal instantiates a new CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder and sets the default values.
func NewCompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder) {
    m := &CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/customerPaymentJournals/{customerPaymentJournal%2Did}/customerPayments/{customerPayment%2Did}/customer/picture/{picture%2Did}/content", pathParameters),
    }
    return m
}
// NewCompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder instantiates a new CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder and sets the default values.
...
func (m *CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilderDeleteRequestConfiguration)(error) {
...
func (m *CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder when successful
func (m *CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder) WithUrl(rawUrl string)(*CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder) {
    return NewCompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureItemContentRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
