...
func (m *CompaniesItemSalesquotesItemSalesquotelinesItemItemRequestBuilder) ItemCategory()(*CompaniesItemSalesquotesItemSalesquotelinesItemItemItemcategoryItemCategoryRequestBuilder) {
    return NewCompaniesItemSalesquotesItemSalesquotelinesItemItemItemcategoryItemCategoryRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
