...
// NewCompaniesItemAgedAccountsPayableAgedAccountsPayableItemRequestBuilderInternal instantiates a new AgedAccountsPayableItemRequestBuilder and sets the default values.
func NewCompaniesItemAgedAccountsPayableAgedAccountsPayableItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, agedAccountsPayableId *string)(*CompaniesItemAgedAccountsPayableAgedAccountsPayableItemRequestBuilder) {
...
func NewCompaniesItemAgedAccountsPayableAgedAccountsPayableItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemAgedAccountsPayableAgedAccountsPayableItemRequestBuilder) {
    ...
    return NewCompaniesItemAgedAccountsPayableAgedAccountsPayableItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *CompaniesItemAgedAccountsPayableAgedAccountsPayableItemRequestBuilder) Get(ctx context.Context, requestConfiguration *CompaniesItemAgedAccountsPayableAgedAccountsPayableItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AgedAccountsPayableable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateAgedAccountsPayableFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
