...
func (m *CompaniesItemSalesCreditMemoLinesItemItem_EscapedPictureCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CompaniesItemSalesCreditMemoLinesItemItem_EscapedPictureCountRequestBuilderGetRequestConfiguration)(*int64, error) {
