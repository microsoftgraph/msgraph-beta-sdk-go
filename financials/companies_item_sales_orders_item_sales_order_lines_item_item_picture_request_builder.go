...
// NewCompaniesItemSalesOrdersItemSalesOrderLinesItemItemPictureRequestBuilder instantiates a new PictureRequestBuilder and sets the default values.
...
func (m *CompaniesItemSalesOrdersItemSalesOrderLinesItemItemPictureRequestBuilder) Count()(*CompaniesItemSalesOrdersItemSalesOrderLinesItemItemPictureCountRequestBuilder) {
    return NewCompaniesItemSalesOrdersItemSalesOrderLinesItemItemPictureCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get picture from financials
func (m *CompaniesItemSalesOrdersItemSalesOrderLinesItemItemPictureRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesOrdersItemSalesOrderLinesItemItemPictureRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
