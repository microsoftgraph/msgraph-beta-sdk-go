...
// NewCompaniesItemCustomerPaymentsItemCustomerPictureRequestBuilderInternal instantiates a new PictureRequestBuilder and sets the default values.
func NewCompaniesItemCustomerPaymentsItemCustomerPictureRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemCustomerPaymentsItemCustomerPictureRequestBuilder) {
    m := &CompaniesItemCustomerPaymentsItemCustomerPictureRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/customerPayments/{customerPayment%2Did}/customer/picture{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewCompaniesItemCustomerPaymentsItemCustomerPictureRequestBuilder instantiates a new PictureRequestBuilder and sets the default values.
