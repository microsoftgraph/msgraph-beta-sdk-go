...
func (m *CompaniesItemSalesQuotesSalesQuoteItemRequestBuilder) MicrosoftGraphMakeInvoice()(*CompaniesItemSalesQuotesItemMicrosoftGraphMakeInvoiceRequestBuilder) {
    return NewCompaniesItemSalesQuotesItemMicrosoftGraphMakeInvoiceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSend provides operations to call the send method.
func (m *CompaniesItemSalesQuotesSalesQuoteItemRequestBuilder) MicrosoftGraphSend()(*CompaniesItemSalesQuotesItemMicrosoftGraphSendRequestBuilder) {
    return NewCompaniesItemSalesQuotesItemMicrosoftGraphSendRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
