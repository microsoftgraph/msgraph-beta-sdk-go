...
func NewCompaniesItemSalesQuotesSalesQuoteItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, salesQuoteId *string)(*CompaniesItemSalesQuotesSalesQuoteItemRequestBuilder) {
...
func NewCompaniesItemSalesQuotesSalesQuoteItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemSalesQuotesSalesQuoteItemRequestBuilder) {
    ...
    return NewCompaniesItemSalesQuotesSalesQuoteItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
// MicrosoftGraphMakeInvoice provides operations to call the makeInvoice method.
func (m *CompaniesItemSalesQuotesSalesQuoteItemRequestBuilder) MicrosoftGraphMakeInvoice()(*CompaniesItemSalesQuotesItemMicrosoftGraphMakeInvoiceMakeInvoiceRequestBuilder) {
    return NewCompaniesItemSalesQuotesItemMicrosoftGraphMakeInvoiceMakeInvoiceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSend provides operations to call the send method.
func (m *CompaniesItemSalesQuotesSalesQuoteItemRequestBuilder) MicrosoftGraphSend()(*CompaniesItemSalesQuotesItemMicrosoftGraphSendSendRequestBuilder) {
    return NewCompaniesItemSalesQuotesItemMicrosoftGraphSendSendRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *CompaniesItemSalesQuotesSalesQuoteItemRequestBuilder) SalesQuoteLinesById(id string)(*CompaniesItemSalesQuotesItemSalesQuoteLinesSalesQuoteLineItemRequestBuilder) {
    ...
    idPtr := &id
    return NewCompaniesItemSalesQuotesItemSalesQuoteLinesSalesQuoteLineItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
