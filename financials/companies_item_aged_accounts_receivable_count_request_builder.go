...
func (m *CompaniesItemAgedAccountsReceivableCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CompaniesItemAgedAccountsReceivableCountRequestBuilderGetRequestConfiguration)(*int64, error) {
