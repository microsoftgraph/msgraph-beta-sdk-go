...
func (m *CompaniesItemCustomersRequestBuilder) Count()(*CompaniesItemCustomersCountRequestBuilder) {
    return NewCompaniesItemCustomersCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get customers from financials
func (m *CompaniesItemCustomersRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemCustomersRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
