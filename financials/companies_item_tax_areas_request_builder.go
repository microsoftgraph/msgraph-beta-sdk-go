...
// NewCompaniesItemTaxAreasRequestBuilder instantiates a new TaxAreasRequestBuilder and sets the default values.
...
func (m *CompaniesItemTaxAreasRequestBuilder) Count()(*CompaniesItemTaxAreasCountRequestBuilder) {
    return NewCompaniesItemTaxAreasCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get taxAreas from financials
func (m *CompaniesItemTaxAreasRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemTaxAreasRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
