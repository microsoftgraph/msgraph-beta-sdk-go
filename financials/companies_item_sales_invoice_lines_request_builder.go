...
func (m *CompaniesItemSalesInvoiceLinesRequestBuilder) Count()(*CompaniesItemSalesInvoiceLinesCountRequestBuilder) {
    return NewCompaniesItemSalesInvoiceLinesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get salesInvoiceLines from financials
func (m *CompaniesItemSalesInvoiceLinesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesInvoiceLinesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
