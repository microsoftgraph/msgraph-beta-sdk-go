...
func (m *CompaniesItemSalesInvoicesItemSalesInvoiceLinesItemItem_EscapedPictureCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CompaniesItemSalesInvoicesItemSalesInvoiceLinesItemItem_EscapedPictureCountRequestBuilderGetRequestConfiguration)(*int64, error) {
