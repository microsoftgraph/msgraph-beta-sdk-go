...
// NewCompaniesItemJournalLinesRequestBuilderInternal instantiates a new JournalLinesRequestBuilder and sets the default values.
...
// NewCompaniesItemJournalLinesRequestBuilder instantiates a new JournalLinesRequestBuilder and sets the default values.
...
func (m *CompaniesItemJournalLinesRequestBuilder) Count()(*CompaniesItemJournalLinesCountRequestBuilder) {
    return NewCompaniesItemJournalLinesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get journalLines from financials
func (m *CompaniesItemJournalLinesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemJournalLinesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
