...
func (m *CompaniesItemSalesOrdersItemCustomerRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemSalesOrdersItemCustomerRequestBuilderDeleteRequestConfiguration)([]byte, error) {
