...
// NewCompaniesItemPictureRequestBuilderInternal instantiates a new PictureRequestBuilder and sets the default values.
...
// NewCompaniesItemPictureRequestBuilder instantiates a new PictureRequestBuilder and sets the default values.
...
func (m *CompaniesItemPictureRequestBuilder) Count()(*CompaniesItemPictureCountRequestBuilder) {
    return NewCompaniesItemPictureCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get picture from financials
func (m *CompaniesItemPictureRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemPictureRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
