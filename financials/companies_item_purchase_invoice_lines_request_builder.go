...
func (m *CompaniesItemPurchaseInvoiceLinesRequestBuilder) Count()(*CompaniesItemPurchaseInvoiceLinesCountRequestBuilder) {
    return NewCompaniesItemPurchaseInvoiceLinesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get purchaseInvoiceLines from financials
func (m *CompaniesItemPurchaseInvoiceLinesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemPurchaseInvoiceLinesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
