...
// GeneralLedgerEntryItemRequestBuilderDeleteOptions options for Delete
type GeneralLedgerEntryItemRequestBuilderDeleteOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// GeneralLedgerEntryItemRequestBuilderGetOptions options for Get
type GeneralLedgerEntryItemRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
    // Request query parameters
    Q *GeneralLedgerEntryItemRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
// GeneralLedgerEntryItemRequestBuilderPatchOptions options for Patch
type GeneralLedgerEntryItemRequestBuilderPatchOptions struct {
    // 
...
func NewGeneralLedgerEntryItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GeneralLedgerEntryItemRequestBuilder) {
...
func NewGeneralLedgerEntryItemRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*GeneralLedgerEntryItemRequestBuilder) {
...
func (m *GeneralLedgerEntryItemRequestBuilder) CreateDeleteRequestInformation(options *GeneralLedgerEntryItemRequestBuilderDeleteOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *GeneralLedgerEntryItemRequestBuilder) CreateGetRequestInformation(options *GeneralLedgerEntryItemRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *GeneralLedgerEntryItemRequestBuilder) CreatePatchRequestInformation(options *GeneralLedgerEntryItemRequestBuilderPatchOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *GeneralLedgerEntryItemRequestBuilder) Delete(options *GeneralLedgerEntryItemRequestBuilderDeleteOptions)(error) {
...
func (m *GeneralLedgerEntryItemRequestBuilder) Get(options *GeneralLedgerEntryItemRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.GeneralLedgerEntryable, error) {
...
func (m *GeneralLedgerEntryItemRequestBuilder) Patch(options *GeneralLedgerEntryItemRequestBuilderPatchOptions)(error) {
