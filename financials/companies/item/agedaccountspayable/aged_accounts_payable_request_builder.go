...
type AgedAccountsPayableRequestBuilderGetOptions struct {
    ...
    Q *AgedAccountsPayableRequestBuilderGetQueryParameters;
...
func (m *AgedAccountsPayableRequestBuilder) Get(options *AgedAccountsPayableRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AgedAccountsPayableCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateAgedAccountsPayableCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AgedAccountsPayableCollectionResponseable), nil
}
// Post create new navigation property to agedAccountsPayable for financials
func (m *AgedAccountsPayableRequestBuilder) Post(options *AgedAccountsPayableRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AgedAccountsPayableable, error) {
