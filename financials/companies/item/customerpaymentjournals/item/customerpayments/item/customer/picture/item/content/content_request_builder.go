...
// ContentRequestBuilder builds and executes requests for operations under \financials\companies\{company-id}\customerPaymentJournals\{customerPaymentJournal-id}\customerPayments\{customerPayment-id}\customer\picture\{picture-id}\content
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/financials/companies/{company_id}/customerPaymentJournals/{customerPaymentJournal_id}/customerPayments/{customerPayment_id}/customer/picture/{picture_id}/content";
...
// CreateGetRequestInformation get media content for the navigation property picture from financials
...
// CreatePutRequestInformation update media content for the navigation property picture in financials
...
// Get get media content for the navigation property picture from financials
...
// Put update media content for the navigation property picture in financials
