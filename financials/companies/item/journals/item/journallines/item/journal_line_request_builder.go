...
// JournalLineRequestBuilder builds and executes requests for operations under \financials\companies\{company-id}\journals\{journal-id}\journalLines\{journalLine-id}
