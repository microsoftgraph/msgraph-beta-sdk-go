...
type SalesQuotesRequestBuilderGetOptions struct {
    ...
    Q *SalesQuotesRequestBuilderGetQueryParameters;
...
func (m *SalesQuotesRequestBuilder) Get(options *SalesQuotesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.SalesQuoteCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateSalesQuoteCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.SalesQuoteCollectionResponseable), nil
}
// Post create new navigation property to salesQuotes for financials
func (m *SalesQuotesRequestBuilder) Post(options *SalesQuotesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.SalesQuoteable, error) {
