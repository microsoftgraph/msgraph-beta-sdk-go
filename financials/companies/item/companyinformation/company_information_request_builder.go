...
type CompanyInformationRequestBuilderGetOptions struct {
    ...
    Q *CompanyInformationRequestBuilderGetQueryParameters;
...
// CompanyInformationRequestBuilderPostOptions options for Post
type CompanyInformationRequestBuilderPostOptions struct {
    // 
...
func NewCompanyInformationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CompanyInformationRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/financials/companies/{company_id}/companyInformation{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *CompanyInformationRequestBuilder) CreatePostRequestInformation(options *CompanyInformationRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *CompanyInformationRequestBuilder) Get(options *CompanyInformationRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CompanyInformationCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateCompanyInformationCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CompanyInformationCollectionResponseable), nil
}
// Post create new navigation property to companyInformation for financials
func (m *CompanyInformationRequestBuilder) Post(options *CompanyInformationRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CompanyInformationable, error) {
