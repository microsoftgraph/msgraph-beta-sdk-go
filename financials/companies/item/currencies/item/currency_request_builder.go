...
// CurrencyRequestBuilder builds and executes requests for operations under \financials\companies\{company-id}\currencies\{currency-id}
...
// CurrencyRequestBuilderGetQueryParameters get currencies from financials
