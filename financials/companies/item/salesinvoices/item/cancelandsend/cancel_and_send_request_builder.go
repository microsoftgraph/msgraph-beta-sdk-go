...
func (m *CancelAndSendRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *CancelAndSendRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CancelAndSendRequestBuilder) Post(ctx context.Context, requestConfiguration *CancelAndSendRequestBuilderPostRequestConfiguration)(error) {
