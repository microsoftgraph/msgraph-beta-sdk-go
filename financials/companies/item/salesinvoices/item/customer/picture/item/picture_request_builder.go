...
import (
    ...
    icaac3f6c74c5328c4282630afeb80685014e291c232337a3330684752775bfee "github.com/microsoftgraph/msgraph-beta-sdk-go/financials/companies/item/salesinvoices/item/customer/picture/item/content"
)

// Builds and executes requests for operations under \financials\companies\{company-id}\salesInvoices\{salesInvoice-id}\customer\picture\{picture-id}
...
func NewPictureRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PictureRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/financials/companies/{company_id}/salesInvoices/{salesInvoice_id}/customer/picture/{picture_id}{?select,expand}";
...
func (m *PictureRequestBuilder) Content()(*icaac3f6c74c5328c4282630afeb80685014e291c232337a3330684752775bfee.ContentRequestBuilder) {
    return icaac3f6c74c5328c4282630afeb80685014e291c232337a3330684752775bfee.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
