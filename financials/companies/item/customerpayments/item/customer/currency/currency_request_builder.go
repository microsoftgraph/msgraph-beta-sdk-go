...
// Builds and executes requests for operations under \financials\companies\{company-id}\customerPayments\{customerPayment-id}\customer\currency
...
func NewCurrencyRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CurrencyRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/financials/companies/{company_id}/customerPayments/{customerPayment_id}/customer/currency{?select,expand}";
