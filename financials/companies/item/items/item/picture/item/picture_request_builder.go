...
// Builds and executes requests for operations under \financials\companies\{company-id}\items\{item-id}\picture\{picture-id}
...
func NewPictureRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PictureRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/financials/companies/{company_id}/items/{item_id}/picture/{picture_id}{?select,expand}";
...
func (m *PictureRequestBuilder) Content()(*id05bc0adb619c46044d3d723def6ff19151046c737981b16972cccac7ed76d62.ContentRequestBuilder) {
