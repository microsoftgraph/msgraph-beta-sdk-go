...
// customerRequestBuilder builds and executes requests for operations under \financials\companies\{company-id}\customers\{customer-id}
...
// customerRequestBuilderGetQueryParameters get customers from financials
