...
// Builds and executes requests for operations under \financials\companies\{company-id}\agedAccountsReceivable
...
type AgedAccountsReceivableRequestBuilderGetOptions struct {
    ...
    Q *AgedAccountsReceivableRequestBuilderGetQueryParameters;
...
// Parameters:
//  - options : Options for the request
func (m *AgedAccountsReceivableRequestBuilder) CreatePostRequestInformation(options *AgedAccountsReceivableRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *AgedAccountsReceivableRequestBuilder) Get(options *AgedAccountsReceivableRequestBuilderGetOptions)(*AgedAccountsReceivableResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewAgedAccountsReceivableResponse() }, nil)
    if err != nil {
        return nil, err
    }
...
func (m *AgedAccountsReceivableRequestBuilder) Post(options *AgedAccountsReceivableRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AgedAccountsReceivable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewAgedAccountsReceivable() }, nil)
    if err != nil {
        return nil, err
    }
