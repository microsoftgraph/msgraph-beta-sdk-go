...
// NewVendorsResponse instantiates a new vendorsResponse and sets the default values.
...
func (m *VendorsResponse) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *VendorsResponse) GetNextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *VendorsResponse) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *VendorsResponse) IsNil()(bool) {
    return m == nil
}
// Serialize serializes information the current object
func (m *VendorsResponse) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    {
...
func (m *VendorsResponse) SetAdditionalData(value map[string]interface{})() {
