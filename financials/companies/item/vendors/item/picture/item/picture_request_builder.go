...
// Builds and executes requests for operations under \financials\companies\{company-id}\vendors\{vendor-id}\picture\{picture-id}
...
func NewPictureRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PictureRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/financials/companies/{company_id}/vendors/{vendor_id}/picture/{picture_id}{?select,expand}";
...
func (m *PictureRequestBuilder) Content()(*i8c319285af6b7efb637be36e78dab63929a19469ea2dbccd09b6d6e58118ff8e.ContentRequestBuilder) {
