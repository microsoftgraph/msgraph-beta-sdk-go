...
// Builds and executes requests for operations under \financials\companies\{company-id}\employees\{employee-id}\picture\{picture-id}\content
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/financials/companies/{company_id}/employees/{employee_id}/picture/{picture_id}/content";
