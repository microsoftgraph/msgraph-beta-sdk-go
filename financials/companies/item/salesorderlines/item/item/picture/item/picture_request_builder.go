...
// Builds and executes requests for operations under \financials\companies\{company-id}\salesOrderLines\{salesOrderLine-id}\item\picture\{picture-id}
...
func NewPictureRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PictureRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/financials/companies/{company_id}/salesOrderLines/{salesOrderLine_id}/item/picture/{picture_id}{?select,expand}";
...
func (m *PictureRequestBuilder) Content()(*ia0cc4bf5c8466f3e970dfe4c0e2dcc924fa6f2c80324f790db0bbe33f50ddca7.ContentRequestBuilder) {
