...
type SalesOrderLinesRequestBuilderGetOptions struct {
    ...
    Q *SalesOrderLinesRequestBuilderGetQueryParameters;
...
func (m *SalesOrderLinesRequestBuilder) Get(options *SalesOrderLinesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.SalesOrderLineCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateSalesOrderLineCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.SalesOrderLineCollectionResponseable), nil
}
// Post create new navigation property to salesOrderLines for financials
func (m *SalesOrderLinesRequestBuilder) Post(options *SalesOrderLinesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.SalesOrderLineable, error) {
