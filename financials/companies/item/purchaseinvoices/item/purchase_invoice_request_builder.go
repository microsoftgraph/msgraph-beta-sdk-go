...
import (
	...
	i3fb5bc32c770342adde0a2d17ebc9e9b268c70b03539ff16e159521f4c713622 "github.com/microsoftgraph/msgraph-beta-sdk-go/financials/companies/item/purchaseinvoices/item/vendor_escaped"
...
func (m *PurchaseInvoiceRequestBuilder) Get(q func(value *PurchaseInvoiceRequestBuilderGetQueryParameters) (err error), h func(value map[string]string) (err error), o []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption, responseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler) (*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PurchaseInvoice, error) {
	...
	res, err := m.requestAdapter.SendAsync(*requestInfo, func() i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable {
		return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewPurchaseInvoice()
	}, responseHandler)
	if err != nil {
		return nil, err
	}
...
func (m *PurchaseInvoiceRequestBuilder) Vendor() *i3fb5bc32c770342adde0a2d17ebc9e9b268c70b03539ff16e159521f4c713622.VendorRequestBuilder {
	return i3fb5bc32c770342adde0a2d17ebc9e9b268c70b03539ff16e159521f4c713622.NewVendorRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
