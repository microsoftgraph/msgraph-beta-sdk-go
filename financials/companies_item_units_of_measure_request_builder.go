...
func (m *CompaniesItemUnitsOfMeasureRequestBuilder) Count()(*CompaniesItemUnitsOfMeasureCountRequestBuilder) {
    return NewCompaniesItemUnitsOfMeasureCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get unitsOfMeasure from financials
func (m *CompaniesItemUnitsOfMeasureRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemUnitsOfMeasureRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
