...
// returns a *CompaniesItemDimensionsDimensionItemRequestBuilder when successful
...
// NewCompaniesItemDimensionsRequestBuilderInternal instantiates a new CompaniesItemDimensionsRequestBuilder and sets the default values.
func NewCompaniesItemDimensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemDimensionsRequestBuilder) {
    m := &CompaniesItemDimensionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/dimensions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewCompaniesItemDimensionsRequestBuilder instantiates a new CompaniesItemDimensionsRequestBuilder and sets the default values.
...
// returns a DimensionCollectionResponseable when successful
