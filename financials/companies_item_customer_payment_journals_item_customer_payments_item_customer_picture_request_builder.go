...
// NewCompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureRequestBuilderInternal instantiates a new PictureRequestBuilder and sets the default values.
...
// NewCompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureRequestBuilder instantiates a new PictureRequestBuilder and sets the default values.
...
func (m *CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureRequestBuilder) Count()(*CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureCountRequestBuilder) {
    return NewCompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get picture from financials
func (m *CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemCustomerPaymentJournalsItemCustomerPaymentsItemCustomerPictureRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
