...
// CompaniesItemSalesQuoteLinesRequestBuilder provides operations to manage the salesQuoteLines property of the microsoft.graph.company entity.
type CompaniesItemSalesQuoteLinesRequestBuilder struct {
...
// CompaniesItemSalesQuoteLinesRequestBuilderGetQueryParameters get salesQuoteLines from financials
type CompaniesItemSalesQuoteLinesRequestBuilderGetQueryParameters struct {
...
// CompaniesItemSalesQuoteLinesRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type CompaniesItemSalesQuoteLinesRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
func (m *CompaniesItemSalesQuoteLinesRequestBuilder) Count()(*CompaniesItemSalesQuoteLinesCountRequestBuilder) {
    return NewCompaniesItemSalesQuoteLinesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get salesQuoteLines from financials
func (m *CompaniesItemSalesQuoteLinesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesQuoteLinesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
