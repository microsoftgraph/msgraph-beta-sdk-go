...
func (m *CompaniesItemCustomerpaymentjournalsCustomerPaymentJournalItemRequestBuilder) CustomerPayments()(*CompaniesItemCustomerpaymentjournalsItemCustomerpaymentsCustomerPaymentsRequestBuilder) {
    return NewCompaniesItemCustomerpaymentjournalsItemCustomerpaymentsCustomerPaymentsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
