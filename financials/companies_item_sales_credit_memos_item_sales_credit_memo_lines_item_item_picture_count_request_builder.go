...
// NewCompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureCountRequestBuilderInternal instantiates a new CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureCountRequestBuilder and sets the default values.
...
// NewCompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureCountRequestBuilder instantiates a new CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureCountRequestBuilder and sets the default values.
...
func (m *CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureCountRequestBuilder) WithUrl(rawUrl string)(*CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureCountRequestBuilder) {
    return NewCompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
