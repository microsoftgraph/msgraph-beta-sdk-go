...
func (m *CompaniesItemSalesQuoteLinesItemItem_EscapedPictureCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CompaniesItemSalesQuoteLinesItemItem_EscapedPictureCountRequestBuilderGetRequestConfiguration)(*int64, error) {
