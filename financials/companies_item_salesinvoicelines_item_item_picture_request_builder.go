...
// NewCompaniesItemSalesinvoicelinesItemItemPictureRequestBuilderInternal instantiates a new CompaniesItemSalesinvoicelinesItemItemPictureRequestBuilder and sets the default values.
func NewCompaniesItemSalesinvoicelinesItemItemPictureRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemSalesinvoicelinesItemItemPictureRequestBuilder) {
    m := &CompaniesItemSalesinvoicelinesItemItemPictureRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoiceLines/{salesInvoiceLine%2Did}/item/picture{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewCompaniesItemSalesinvoicelinesItemItemPictureRequestBuilder instantiates a new CompaniesItemSalesinvoicelinesItemItemPictureRequestBuilder and sets the default values.
