...
func NewCompaniesItemSalesInvoicesItemCustomerRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemSalesInvoicesItemCustomerRequestBuilder) {
    m := &CompaniesItemSalesInvoicesItemCustomerRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesInvoices/{salesInvoice%2Did}/customer{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *CompaniesItemSalesInvoicesItemCustomerRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemSalesInvoicesItemCustomerRequestBuilderDeleteRequestConfiguration)([]byte, error) {
...
func (m *CompaniesItemSalesInvoicesItemCustomerRequestBuilder) PictureById(id string)(*CompaniesItemSalesInvoicesItemCustomerPicturePictureItemRequestBuilder) {
    ...
    return NewCompaniesItemSalesInvoicesItemCustomerPicturePictureItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
