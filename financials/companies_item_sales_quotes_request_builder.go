...
func (m *CompaniesItemSalesQuotesRequestBuilder) Count()(*CompaniesItemSalesQuotesCountRequestBuilder) {
    return NewCompaniesItemSalesQuotesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get salesQuotes from financials
func (m *CompaniesItemSalesQuotesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesQuotesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
