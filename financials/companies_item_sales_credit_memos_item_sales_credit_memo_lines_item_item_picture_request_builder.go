...
// NewCompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureRequestBuilderInternal instantiates a new PictureRequestBuilder and sets the default values.
func NewCompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos/{salesCreditMemo%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}/item/picture{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewCompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureRequestBuilder instantiates a new PictureRequestBuilder and sets the default values.
...
func (m *CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureRequestBuilder) Count()(*CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureCountRequestBuilder) {
    return NewCompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get picture from financials
func (m *CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesCreditMemosItemSalesCreditMemoLinesItemItemPictureRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
