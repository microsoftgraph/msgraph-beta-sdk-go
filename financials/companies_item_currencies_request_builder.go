...
// NewCompaniesItemCurrenciesRequestBuilder instantiates a new CurrenciesRequestBuilder and sets the default values.
...
func (m *CompaniesItemCurrenciesRequestBuilder) Count()(*CompaniesItemCurrenciesCountRequestBuilder) {
    return NewCompaniesItemCurrenciesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get currencies from financials
func (m *CompaniesItemCurrenciesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemCurrenciesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
