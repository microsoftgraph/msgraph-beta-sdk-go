...
// NewCompaniesItemPurchaseInvoiceLinesCountRequestBuilderInternal instantiates a new CompaniesItemPurchaseInvoiceLinesCountRequestBuilder and sets the default values.
func NewCompaniesItemPurchaseInvoiceLinesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemPurchaseInvoiceLinesCountRequestBuilder) {
    m := &CompaniesItemPurchaseInvoiceLinesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoiceLines/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewCompaniesItemPurchaseInvoiceLinesCountRequestBuilder instantiates a new CompaniesItemPurchaseInvoiceLinesCountRequestBuilder and sets the default values.
...
func (m *CompaniesItemPurchaseInvoiceLinesCountRequestBuilder) WithUrl(rawUrl string)(*CompaniesItemPurchaseInvoiceLinesCountRequestBuilder) {
    return NewCompaniesItemPurchaseInvoiceLinesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
