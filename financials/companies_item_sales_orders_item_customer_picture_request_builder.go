...
// NewCompaniesItemSalesOrdersItemCustomerPictureRequestBuilderInternal instantiates a new PictureRequestBuilder and sets the default values.
...
// NewCompaniesItemSalesOrdersItemCustomerPictureRequestBuilder instantiates a new PictureRequestBuilder and sets the default values.
...
func (m *CompaniesItemSalesOrdersItemCustomerPictureRequestBuilder) Count()(*CompaniesItemSalesOrdersItemCustomerPictureCountRequestBuilder) {
    return NewCompaniesItemSalesOrdersItemCustomerPictureCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get picture from financials
func (m *CompaniesItemSalesOrdersItemCustomerPictureRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesOrdersItemCustomerPictureRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
