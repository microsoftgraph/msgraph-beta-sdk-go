...
func (m *CompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
