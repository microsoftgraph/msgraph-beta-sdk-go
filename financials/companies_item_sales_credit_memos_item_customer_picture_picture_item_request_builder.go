...
func NewCompaniesItemSalesCreditMemosItemCustomerPicturePictureItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, pictureId *string)(*CompaniesItemSalesCreditMemosItemCustomerPicturePictureItemRequestBuilder) {
    m := &CompaniesItemSalesCreditMemosItemCustomerPicturePictureItemRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos/{salesCreditMemo%2Did}/customer/picture/{picture%2Did}{?%24select,%24expand}";
...
func NewCompaniesItemSalesCreditMemosItemCustomerPicturePictureItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemSalesCreditMemosItemCustomerPicturePictureItemRequestBuilder) {
    ...
    return NewCompaniesItemSalesCreditMemosItemCustomerPicturePictureItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *CompaniesItemSalesCreditMemosItemCustomerPicturePictureItemRequestBuilder) Content()(*CompaniesItemSalesCreditMemosItemCustomerPictureItemContentRequestBuilder) {
    return NewCompaniesItemSalesCreditMemosItemCustomerPictureItemContentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
