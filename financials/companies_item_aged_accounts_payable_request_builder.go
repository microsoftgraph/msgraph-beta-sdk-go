...
func (m *CompaniesItemAgedAccountsPayableRequestBuilder) Count()(*CompaniesItemAgedAccountsPayableCountRequestBuilder) {
    return NewCompaniesItemAgedAccountsPayableCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get agedAccountsPayable from financials
func (m *CompaniesItemAgedAccountsPayableRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemAgedAccountsPayableRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
