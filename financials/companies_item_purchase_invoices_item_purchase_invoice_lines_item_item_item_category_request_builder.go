...
// NewCompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesItemItemItemCategoryRequestBuilderInternal instantiates a new ItemCategoryRequestBuilder and sets the default values.
func NewCompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesItemItemItemCategoryRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesItemItemItemCategoryRequestBuilder) {
    m := &CompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesItemItemItemCategoryRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoices/{purchaseInvoice%2Did}/purchaseInvoiceLines/{purchaseInvoiceLine%2Did}/item/itemCategory{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewCompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesItemItemItemCategoryRequestBuilder instantiates a new ItemCategoryRequestBuilder and sets the default values.
...
func (m *CompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesItemItemItemCategoryRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemPurchaseInvoicesItemPurchaseInvoiceLinesItemItemItemCategoryRequestBuilderDeleteRequestConfiguration)([]byte, error) {
