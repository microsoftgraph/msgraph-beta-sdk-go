...
// NewCompaniesItemSalesCreditMemoLinesItemItemRequestBuilderInternal instantiates a new ItemRequestBuilder and sets the default values.
...
// NewCompaniesItemSalesCreditMemoLinesItemItemRequestBuilder instantiates a new ItemRequestBuilder and sets the default values.
...
func (m *CompaniesItemSalesCreditMemoLinesItemItemRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesCreditMemoLinesItemItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CompaniesItemSalesCreditMemoLinesItemItemRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CompaniesItemSalesCreditMemoLinesItemItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *CompaniesItemSalesCreditMemoLinesItemItemRequestBuilder) ItemCategory()(*CompaniesItemSalesCreditMemoLinesItemItemItemCategoryRequestBuilder) {
    return NewCompaniesItemSalesCreditMemoLinesItemItemItemCategoryRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *CompaniesItemSalesCreditMemoLinesItemItemRequestBuilder) Picture()(*CompaniesItemSalesCreditMemoLinesItemItemPictureRequestBuilder) {
    return NewCompaniesItemSalesCreditMemoLinesItemItemPictureRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// PictureById provides operations to manage the picture property of the microsoft.graph.item entity.
func (m *CompaniesItemSalesCreditMemoLinesItemItemRequestBuilder) PictureById(id string)(*CompaniesItemSalesCreditMemoLinesItemItemPicturePictureItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return NewCompaniesItemSalesCreditMemoLinesItemItemPicturePictureItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
