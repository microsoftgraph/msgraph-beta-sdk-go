...
func NewCompaniesItemSalesCreditMemoLinesItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CompaniesItemSalesCreditMemoLinesItemItemRequestBuilder) {
    m := &CompaniesItemSalesCreditMemoLinesItemItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}/item{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *CompaniesItemSalesCreditMemoLinesItemItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *CompaniesItemSalesCreditMemoLinesItemItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
