...
// ByJobResponseBaseIdString provides operations to manage the evaluateDlpPoliciesJobs property of the microsoft.graph.dataClassificationService entity.
func (m *EvaluateDlpPoliciesJobsRequestBuilder) ByJobResponseBaseIdString(jobResponseBaseId string)(*EvaluateDlpPoliciesJobsJobResponseBaseItemRequestBuilder) {
