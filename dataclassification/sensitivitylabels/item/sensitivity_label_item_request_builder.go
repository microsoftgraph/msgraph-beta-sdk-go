...
// DeleteWithResponseHandler delete navigation property sensitivityLabels for dataClassification
...
// PatchWithResponseHandler update the navigation property sensitivityLabels in dataClassification
