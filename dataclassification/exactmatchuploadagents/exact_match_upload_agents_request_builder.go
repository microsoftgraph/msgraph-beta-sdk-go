...
type ExactMatchUploadAgentsRequestBuilderGetOptions struct {
    ...
    Q *ExactMatchUploadAgentsRequestBuilderGetQueryParameters;
...
func NewExactMatchUploadAgentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ExactMatchUploadAgentsRequestBuilder) {
...
func NewExactMatchUploadAgentsRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ExactMatchUploadAgentsRequestBuilder) {
...
func (m *ExactMatchUploadAgentsRequestBuilder) CreatePostRequestInformation(options *ExactMatchUploadAgentsRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ExactMatchUploadAgentsRequestBuilder) Get(options *ExactMatchUploadAgentsRequestBuilderGetOptions)(*ExactMatchUploadAgentsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewExactMatchUploadAgentsResponse() }, nil)
    if err != nil {
        return nil, err
    }
