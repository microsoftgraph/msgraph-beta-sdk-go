...
func (m *DataClassificationRequestBuilder) ClassifyExactMatches()(*ClassifyexactmatchesClassifyExactMatchesRequestBuilder) {
    return NewClassifyexactmatchesClassifyExactMatchesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// ClassifyFile provides operations to call the classifyFile method.
// returns a *ClassifyfileClassifyFileRequestBuilder when successful
func (m *DataClassificationRequestBuilder) ClassifyFile()(*ClassifyfileClassifyFileRequestBuilder) {
    return NewClassifyfileClassifyFileRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *DataClassificationRequestBuilder) ClassifyFileJobs()(*ClassifyfilejobsClassifyFileJobsRequestBuilder) {
    return NewClassifyfilejobsClassifyFileJobsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *DataClassificationRequestBuilder) ClassifyTextJobs()(*ClassifytextjobsClassifyTextJobsRequestBuilder) {
    return NewClassifytextjobsClassifyTextJobsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *DataClassificationRequestBuilder) EvaluateDlpPoliciesJobs()(*EvaluatedlppoliciesjobsEvaluateDlpPoliciesJobsRequestBuilder) {
    return NewEvaluatedlppoliciesjobsEvaluateDlpPoliciesJobsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *DataClassificationRequestBuilder) EvaluateLabelJobs()(*EvaluatelabeljobsEvaluateLabelJobsRequestBuilder) {
    return NewEvaluatelabeljobsEvaluateLabelJobsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *DataClassificationRequestBuilder) ExactMatchDataStores()(*ExactmatchdatastoresExactMatchDataStoresRequestBuilder) {
    return NewExactmatchdatastoresExactMatchDataStoresRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *DataClassificationRequestBuilder) ExactMatchUploadAgents()(*ExactmatchuploadagentsExactMatchUploadAgentsRequestBuilder) {
    return NewExactmatchuploadagentsExactMatchUploadAgentsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *DataClassificationRequestBuilder) SensitiveTypes()(*SensitivetypesSensitiveTypesRequestBuilder) {
    return NewSensitivetypesSensitiveTypesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *DataClassificationRequestBuilder) SensitivityLabels()(*SensitivitylabelsSensitivityLabelsRequestBuilder) {
