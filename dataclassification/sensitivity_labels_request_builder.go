...
func (m *SensitivityLabelsRequestBuilder) MicrosoftGraphEvaluate()(*SensitivityLabelsMicrosoftGraphEvaluateEvaluateRequestBuilder) {
    return NewSensitivityLabelsMicrosoftGraphEvaluateEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
