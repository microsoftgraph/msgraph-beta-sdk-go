...
// NewClassifyFileJobsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewClassifyFileJobsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ClassifyFileJobsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/dataClassification/classifyFileJobs/$count";
...
// NewClassifyFileJobsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
...
func (m *ClassifyFileJobsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ClassifyFileJobsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
