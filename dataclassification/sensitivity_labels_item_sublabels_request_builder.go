...
func (m *SensitivityLabelsItemSublabelsRequestBuilder) MicrosoftGraphEvaluate()(*SensitivityLabelsItemSublabelsMicrosoftGraphEvaluateEvaluateRequestBuilder) {
    return NewSensitivityLabelsItemSublabelsMicrosoftGraphEvaluateEvaluateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
