...
func (m *ExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
