...
func (m *ExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilder) MicrosoftGraphCancel()(*ExactMatchDataStoresItemSessionsItemMicrosoftGraphCancelRequestBuilder) {
    return NewExactMatchDataStoresItemSessionsItemMicrosoftGraphCancelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCommit provides operations to call the commit method.
func (m *ExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilder) MicrosoftGraphCommit()(*ExactMatchDataStoresItemSessionsItemMicrosoftGraphCommitRequestBuilder) {
    return NewExactMatchDataStoresItemSessionsItemMicrosoftGraphCommitRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRenew provides operations to call the renew method.
func (m *ExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilder) MicrosoftGraphRenew()(*ExactMatchDataStoresItemSessionsItemMicrosoftGraphRenewRequestBuilder) {
    return NewExactMatchDataStoresItemSessionsItemMicrosoftGraphRenewRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
