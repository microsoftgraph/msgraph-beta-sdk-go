...
func NewExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, exactMatchSessionId *string)(*ExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilder) {
...
func NewExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilder) {
    ...
    return NewExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilder) MicrosoftGraphCancel()(*ExactMatchDataStoresItemSessionsItemMicrosoftGraphCancelCancelRequestBuilder) {
    return NewExactMatchDataStoresItemSessionsItemMicrosoftGraphCancelCancelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCommit provides operations to call the commit method.
func (m *ExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilder) MicrosoftGraphCommit()(*ExactMatchDataStoresItemSessionsItemMicrosoftGraphCommitCommitRequestBuilder) {
    return NewExactMatchDataStoresItemSessionsItemMicrosoftGraphCommitCommitRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRenew provides operations to call the renew method.
func (m *ExactMatchDataStoresItemSessionsExactMatchSessionItemRequestBuilder) MicrosoftGraphRenew()(*ExactMatchDataStoresItemSessionsItemMicrosoftGraphRenewRenewRequestBuilder) {
    return NewExactMatchDataStoresItemSessionsItemMicrosoftGraphRenewRenewRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
