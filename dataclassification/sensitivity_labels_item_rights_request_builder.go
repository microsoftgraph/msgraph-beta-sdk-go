...
// SensitivityLabelsItemRightsRequestBuilderGetQueryParameters get rights from dataClassification
...
func NewSensitivityLabelsItemRightsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SensitivityLabelsItemRightsRequestBuilder) {
    m := &SensitivityLabelsItemRightsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/dataClassification/sensitivityLabels/{sensitivityLabel%2Did}/rights{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
// Get get rights from dataClassification
...
// ToGetRequestInformation get rights from dataClassification
