...
func (m *ExactmatchdatastoresItemSessionsExactMatchSessionItemRequestBuilder) UploadAgent()(*ExactmatchdatastoresItemSessionsItemUploadagentUploadAgentRequestBuilder) {
    return NewExactmatchdatastoresItemSessionsItemUploadagentUploadAgentRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
