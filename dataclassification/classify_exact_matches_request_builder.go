...
func (m *ClassifyExactMatchesRequestBuilder) WithUrl(rawUrl string)(*ClassifyExactMatchesRequestBuilder) {
    return NewClassifyExactMatchesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
