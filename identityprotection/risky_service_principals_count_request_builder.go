...
func (m *RiskyServicePrincipalsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *RiskyServicePrincipalsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
