...
func (m *RiskyServicePrincipalsItemHistoryCountRequestBuilder) Get(ctx context.Context, requestConfiguration *RiskyServicePrincipalsItemHistoryCountRequestBuilderGetRequestConfiguration)(*int64, error) {
