...
func (m *RiskDetectionsRiskDetectionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *RiskDetectionsRiskDetectionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
