...
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/riskyusers-get?view=graph-rest-1.0
func (m *RiskyUsersRequestBuilder) Get(ctx context.Context, requestConfiguration *RiskyUsersRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RiskyUserCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateRiskyUserCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *RiskyUsersRequestBuilder) MicrosoftGraphConfirmCompromised()(*RiskyUsersMicrosoftGraphConfirmCompromisedConfirmCompromisedRequestBuilder) {
    return NewRiskyUsersMicrosoftGraphConfirmCompromisedConfirmCompromisedRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDismiss provides operations to call the dismiss method.
func (m *RiskyUsersRequestBuilder) MicrosoftGraphDismiss()(*RiskyUsersMicrosoftGraphDismissDismissRequestBuilder) {
    return NewRiskyUsersMicrosoftGraphDismissDismissRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *RiskyUsersRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RiskyUserable, requestConfiguration *RiskyUsersRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.RiskyUserable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateRiskyUserFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
