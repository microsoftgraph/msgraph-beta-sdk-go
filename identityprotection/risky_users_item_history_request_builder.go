...
// RiskyUsersItemHistoryRequestBuilderGetQueryParameters get the risk history of a riskyUser resource. This API is supported in the following national cloud deployments.
