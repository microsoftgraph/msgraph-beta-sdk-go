...
// ServicePrincipalRiskDetectionsRequestBuilder builds and executes requests for operations under \identityProtection\servicePrincipalRiskDetections
...
// CreatePostRequestInformation represents information about detected at-risk service principals in an Azure AD tenant.
...
func (m *ServicePrincipalRiskDetectionsRequestBuilder) Get(options *ServicePrincipalRiskDetectionsRequestBuilderGetOptions)(*ServicePrincipalRiskDetectionsResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewServicePrincipalRiskDetectionsResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(*ServicePrincipalRiskDetectionsResponse), nil
}
// Post represents information about detected at-risk service principals in an Azure AD tenant.
func (m *ServicePrincipalRiskDetectionsRequestBuilder) Post(options *ServicePrincipalRiskDetectionsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ServicePrincipalRiskDetection, error) {
