...
func NewContractsItemGetMemberObjectsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ContractsItemGetMemberObjectsRequestBuilder) {
    m := &ContractsItemGetMemberObjectsRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/contracts/{contract%2Did}/microsoft.graph.getMemberObjects";
...
func (m *ContractsItemGetMemberObjectsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ContractsItemGetMemberObjectsPostRequestBodyable, requestConfiguration *ContractsItemGetMemberObjectsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ContractsItemGetMemberObjectsResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateContractsItemGetMemberObjectsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ContractsItemGetMemberObjectsResponseable), nil
}
