...
func NewItemMicrosoftGraphGetMemberGroupsGetMemberGroupsResponse()(*ItemMicrosoftGraphGetMemberGroupsGetMemberGroupsResponse) {
    m := &ItemMicrosoftGraphGetMemberGroupsGetMemberGroupsResponse{
...
func CreateItemMicrosoftGraphGetMemberGroupsGetMemberGroupsResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemMicrosoftGraphGetMemberGroupsGetMemberGroupsResponse(), nil
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemMicrosoftGraphGetMemberGroupsGetMemberGroupsResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemMicrosoftGraphGetMemberGroupsGetMemberGroupsResponse) GetValue()([]string) {
    return m.value
}
// Serialize serializes information the current object
func (m *ItemMicrosoftGraphGetMemberGroupsGetMemberGroupsResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ItemMicrosoftGraphGetMemberGroupsGetMemberGroupsResponse) SetValue(value []string)() {
    m.value = value
}
