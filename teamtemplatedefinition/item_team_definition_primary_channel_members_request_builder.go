...
func (m *ItemTeamDefinitionPrimaryChannelMembersRequestBuilder) MicrosoftGraphAdd()(*ItemTeamDefinitionPrimaryChannelMembersMicrosoftGraphAddAddRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMembersMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
