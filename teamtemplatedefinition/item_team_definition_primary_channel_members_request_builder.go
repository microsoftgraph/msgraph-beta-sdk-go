...
func (m *ItemTeamDefinitionPrimaryChannelMembersRequestBuilder) Remove()(*ItemTeamDefinitionPrimaryChannelMembersRemoveRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMembersRemoveRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
