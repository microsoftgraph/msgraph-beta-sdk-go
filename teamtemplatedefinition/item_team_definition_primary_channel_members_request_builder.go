...
func (m *ItemTeamDefinitionPrimaryChannelMembersRequestBuilder) MicrosoftGraphAdd()(*ItemTeamDefinitionPrimaryChannelMembersMicrosoftGraphAddRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMembersMicrosoftGraphAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
