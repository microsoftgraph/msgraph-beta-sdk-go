...
func (m *ItemTeamDefinitionScheduleOfferShiftRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamDefinitionScheduleOfferShiftRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
