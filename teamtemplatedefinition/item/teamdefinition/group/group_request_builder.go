...
// GroupRequestBuilder provides operations to manage the group property of the microsoft.graph.team entity.
...
// GroupRequestBuilderGetQueryParameters get group from teamTemplateDefinition
