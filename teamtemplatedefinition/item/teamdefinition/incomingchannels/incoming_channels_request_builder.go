...
import (
    ...
    ieaa121e9d7542c402cfc025c91b3dffde8d7e52ce6f4d1a678f942f81f5c1e9f "github.com/microsoftgraph/msgraph-beta-sdk-go/teamtemplatedefinition/item/teamdefinition/incomingchannels/count"
)
...
func NewIncomingChannelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IncomingChannelsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *IncomingChannelsRequestBuilder) Count()(*ieaa121e9d7542c402cfc025c91b3dffde8d7e52ce6f4d1a678f942f81f5c1e9f.CountRequestBuilder) {
    return ieaa121e9d7542c402cfc025c91b3dffde8d7e52ce6f4d1a678f942f81f5c1e9f.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get the list of incoming channels (channels shared with a team).
func (m *IncomingChannelsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *IncomingChannelsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
