...
import (
    ...
    i369d78dc0762c2bd7281fa4177f42f4fe5d30874c2ba9ce8ace77d6b8e48fbb4 "github.com/microsoftgraph/msgraph-beta-sdk-go/teamtemplatedefinition/item/teamdefinition/schedule/timesoff/count"
)
...
func NewTimesOffRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TimesOffRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timesOff{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
...
func (m *TimesOffRequestBuilder) Count()(*i369d78dc0762c2bd7281fa4177f42f4fe5d30874c2ba9ce8ace77d6b8e48fbb4.CountRequestBuilder) {
    return i369d78dc0762c2bd7281fa4177f42f4fe5d30874c2ba9ce8ace77d6b8e48fbb4.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
