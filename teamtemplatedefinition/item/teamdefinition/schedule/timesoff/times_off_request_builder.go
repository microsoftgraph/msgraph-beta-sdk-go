...
// CreatePostRequestInformation create new navigation property to timesOff for teamTemplateDefinition
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to timesOff for teamTemplateDefinition
