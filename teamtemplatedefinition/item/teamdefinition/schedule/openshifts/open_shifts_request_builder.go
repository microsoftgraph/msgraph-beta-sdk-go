...
import (
    ...
    i346df472d484d4e5026781b896cf031301f86d410166e583a073bffbbeb5f439 "github.com/microsoftgraph/msgraph-beta-sdk-go/teamtemplatedefinition/item/teamdefinition/schedule/openshifts/count"
)
...
// OpenShiftsRequestBuilderGetQueryParameters get openShifts from teamTemplateDefinition
...
func NewOpenShiftsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OpenShiftsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/openShifts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *OpenShiftsRequestBuilder) Count()(*i346df472d484d4e5026781b896cf031301f86d410166e583a073bffbbeb5f439.CountRequestBuilder) {
    return i346df472d484d4e5026781b896cf031301f86d410166e583a073bffbbeb5f439.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformation create new navigation property to openShifts for teamTemplateDefinition
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to openShifts for teamTemplateDefinition
