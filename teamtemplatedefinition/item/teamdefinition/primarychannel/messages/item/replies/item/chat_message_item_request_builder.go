...
// HostedContentsById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.teamTemplateDefinition.item.teamDefinition.primaryChannel.messages.item.replies.item.hostedContents.item collection
