...
// NewItemTeamDefinitionMembersAddRequestBuilderInternal instantiates a new AddRequestBuilder and sets the default values.
func NewItemTeamDefinitionMembersAddRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamDefinitionMembersAddRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/members/microsoft.graph.add";
...
// NewItemTeamDefinitionMembersAddRequestBuilder instantiates a new AddRequestBuilder and sets the default values.
...
func (m *ItemTeamDefinitionMembersAddRequestBuilder) Post(ctx context.Context, body ItemTeamDefinitionMembersAddPostRequestBodyable, requestConfiguration *ItemTeamDefinitionMembersAddRequestBuilderPostRequestConfiguration)(ItemTeamDefinitionMembersAddResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateItemTeamDefinitionMembersAddResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
