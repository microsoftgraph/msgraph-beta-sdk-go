...
// NewItemTeamDefinitionChannelsItemMessagesItemRepliesItemUnsetReactionRequestBuilderInternal instantiates a new ItemTeamDefinitionChannelsItemMessagesItemRepliesItemUnsetReactionRequestBuilder and sets the default values.
...
// NewItemTeamDefinitionChannelsItemMessagesItemRepliesItemUnsetReactionRequestBuilder instantiates a new ItemTeamDefinitionChannelsItemMessagesItemRepliesItemUnsetReactionRequestBuilder and sets the default values.
...
func (m *ItemTeamDefinitionChannelsItemMessagesItemRepliesItemUnsetReactionRequestBuilder) WithUrl(rawUrl string)(*ItemTeamDefinitionChannelsItemMessagesItemRepliesItemUnsetReactionRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesItemRepliesItemUnsetReactionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
