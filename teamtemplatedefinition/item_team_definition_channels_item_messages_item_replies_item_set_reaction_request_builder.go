...
// NewItemTeamDefinitionChannelsItemMessagesItemRepliesItemSetReactionRequestBuilderInternal instantiates a new ItemTeamDefinitionChannelsItemMessagesItemRepliesItemSetReactionRequestBuilder and sets the default values.
...
// NewItemTeamDefinitionChannelsItemMessagesItemRepliesItemSetReactionRequestBuilder instantiates a new ItemTeamDefinitionChannelsItemMessagesItemRepliesItemSetReactionRequestBuilder and sets the default values.
...
func (m *ItemTeamDefinitionChannelsItemMessagesItemRepliesItemSetReactionRequestBuilder) WithUrl(rawUrl string)(*ItemTeamDefinitionChannelsItemMessagesItemRepliesItemSetReactionRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesItemRepliesItemSetReactionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
