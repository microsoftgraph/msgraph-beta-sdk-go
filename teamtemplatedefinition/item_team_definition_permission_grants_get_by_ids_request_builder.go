...
func NewItemTeamDefinitionPermissionGrantsGetByIdsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamDefinitionPermissionGrantsGetByIdsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/permissionGrants/getByIds";
...
func (m *ItemTeamDefinitionPermissionGrantsGetByIdsRequestBuilder) Post(ctx context.Context, body ItemTeamDefinitionPermissionGrantsGetByIdsPostRequestBodyable, requestConfiguration *ItemTeamDefinitionPermissionGrantsGetByIdsRequestBuilderPostRequestConfiguration)(ItemTeamDefinitionPermissionGrantsGetByIdsResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateItemTeamDefinitionPermissionGrantsGetByIdsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
