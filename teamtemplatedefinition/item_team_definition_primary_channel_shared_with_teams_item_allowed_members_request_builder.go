...
// ItemTeamDefinitionPrimaryChannelSharedWithTeamsItemAllowedMembersRequestBuilderGetQueryParameters a collection of team members who have access to the shared channel.
...
func (m *ItemTeamDefinitionPrimaryChannelSharedWithTeamsItemAllowedMembersRequestBuilder) ByConversationMemberId(conversationMemberId string)(*ItemTeamDefinitionPrimaryChannelSharedWithTeamsItemAllowedMembersConversationMemberItemRequestBuilder) {
...
// NewItemTeamDefinitionPrimaryChannelSharedWithTeamsItemAllowedMembersRequestBuilderInternal instantiates a new ItemTeamDefinitionPrimaryChannelSharedWithTeamsItemAllowedMembersRequestBuilder and sets the default values.
...
// NewItemTeamDefinitionPrimaryChannelSharedWithTeamsItemAllowedMembersRequestBuilder instantiates a new ItemTeamDefinitionPrimaryChannelSharedWithTeamsItemAllowedMembersRequestBuilder and sets the default values.
