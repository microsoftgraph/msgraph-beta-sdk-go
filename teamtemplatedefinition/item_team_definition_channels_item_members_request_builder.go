...
func (m *ItemTeamDefinitionChannelsItemMembersRequestBuilder) MicrosoftGraphAdd()(*ItemTeamDefinitionChannelsItemMembersMicrosoftGraphAddRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMembersMicrosoftGraphAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
