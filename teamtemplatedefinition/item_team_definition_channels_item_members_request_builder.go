...
func (m *ItemTeamDefinitionChannelsItemMembersRequestBuilder) MicrosoftGraphAdd()(*ItemTeamDefinitionChannelsItemMembersMicrosoftGraphAddAddRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMembersMicrosoftGraphAddAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
