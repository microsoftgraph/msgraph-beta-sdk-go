...
func (m *ItemTeamdefinitionPrimarychannelMessagesChatMessageItemRequestBuilder) HostedContents()(*ItemTeamdefinitionPrimarychannelMessagesItemHostedcontentsHostedContentsRequestBuilder) {
    return NewItemTeamdefinitionPrimarychannelMessagesItemHostedcontentsHostedContentsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemTeamdefinitionPrimarychannelMessagesChatMessageItemRequestBuilder) SetReaction()(*ItemTeamdefinitionPrimarychannelMessagesItemSetreactionSetReactionRequestBuilder) {
    return NewItemTeamdefinitionPrimarychannelMessagesItemSetreactionSetReactionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// SoftDelete provides operations to call the softDelete method.
// returns a *ItemTeamdefinitionPrimarychannelMessagesItemSoftdeleteSoftDeleteRequestBuilder when successful
func (m *ItemTeamdefinitionPrimarychannelMessagesChatMessageItemRequestBuilder) SoftDelete()(*ItemTeamdefinitionPrimarychannelMessagesItemSoftdeleteSoftDeleteRequestBuilder) {
    return NewItemTeamdefinitionPrimarychannelMessagesItemSoftdeleteSoftDeleteRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemTeamdefinitionPrimarychannelMessagesChatMessageItemRequestBuilder) UndoSoftDelete()(*ItemTeamdefinitionPrimarychannelMessagesItemUndosoftdeleteUndoSoftDeleteRequestBuilder) {
    return NewItemTeamdefinitionPrimarychannelMessagesItemUndosoftdeleteUndoSoftDeleteRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// UnsetReaction provides operations to call the unsetReaction method.
// returns a *ItemTeamdefinitionPrimarychannelMessagesItemUnsetreactionUnsetReactionRequestBuilder when successful
func (m *ItemTeamdefinitionPrimarychannelMessagesChatMessageItemRequestBuilder) UnsetReaction()(*ItemTeamdefinitionPrimarychannelMessagesItemUnsetreactionUnsetReactionRequestBuilder) {
    return NewItemTeamdefinitionPrimarychannelMessagesItemUnsetreactionUnsetReactionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
