...
// ItemTeamDefinitionChannelsItemMessagesItemUnsetReactionPostRequestBody provides operations to call the unsetReaction method.
...
func (m *ItemTeamDefinitionChannelsItemMessagesItemUnsetReactionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemTeamDefinitionChannelsItemMessagesItemUnsetReactionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
