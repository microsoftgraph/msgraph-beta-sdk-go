...
// NewItemTeamdefinitionPrimarychannelMembersAddRequestBuilderInternal instantiates a new ItemTeamdefinitionPrimarychannelMembersAddRequestBuilder and sets the default values.
...
// NewItemTeamdefinitionPrimarychannelMembersAddRequestBuilder instantiates a new ItemTeamdefinitionPrimarychannelMembersAddRequestBuilder and sets the default values.
...
// returns a ItemTeamdefinitionPrimarychannelMembersAddResponseable when successful
...
// returns a ItemTeamdefinitionPrimarychannelMembersAddPostResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/conversationmembers-add?view=graph-rest-beta
