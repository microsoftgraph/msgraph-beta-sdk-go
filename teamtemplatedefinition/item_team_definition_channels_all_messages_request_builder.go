...
// NewItemTeamDefinitionChannelsAllMessagesRequestBuilderInternal instantiates a new ItemTeamDefinitionChannelsAllMessagesRequestBuilder and sets the default values.
...
// NewItemTeamDefinitionChannelsAllMessagesRequestBuilder instantiates a new ItemTeamDefinitionChannelsAllMessagesRequestBuilder and sets the default values.
...
// returns a ItemTeamDefinitionChannelsAllMessagesResponseable when successful
...
// returns a ItemTeamDefinitionChannelsAllMessagesGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
