...
// NewItemTeamDefinitionScheduleTimesOffRequestBuilderInternal instantiates a new TimesOffRequestBuilder and sets the default values.
...
// NewItemTeamDefinitionScheduleTimesOffRequestBuilder instantiates a new TimesOffRequestBuilder and sets the default values.
...
func (m *ItemTeamDefinitionScheduleTimesOffRequestBuilder) Count()(*ItemTeamDefinitionScheduleTimesOffCountRequestBuilder) {
    return NewItemTeamDefinitionScheduleTimesOffCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get the list of timeOff instances in a schedule.
func (m *ItemTeamDefinitionScheduleTimesOffRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTeamDefinitionScheduleTimesOffRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
