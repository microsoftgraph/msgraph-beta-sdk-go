...
func (m *ItemTeamDefinitionScheduleTimesOffRequestBuilder) ByTimeOffIdString(timeOffId string)(*ItemTeamDefinitionScheduleTimesOffTimeOffItemRequestBuilder) {
