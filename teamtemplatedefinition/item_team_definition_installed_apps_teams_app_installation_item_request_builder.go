...
func (m *ItemTeamDefinitionInstalledAppsTeamsAppInstallationItemRequestBuilder) MicrosoftGraphUpgrade()(*ItemTeamDefinitionInstalledAppsItemMicrosoftGraphUpgradeRequestBuilder) {
    return NewItemTeamDefinitionInstalledAppsItemMicrosoftGraphUpgradeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
