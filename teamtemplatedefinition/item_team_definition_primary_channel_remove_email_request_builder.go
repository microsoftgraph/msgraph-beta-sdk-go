...
// NewItemTeamDefinitionPrimaryChannelRemoveEmailRequestBuilderInternal instantiates a new ItemTeamDefinitionPrimaryChannelRemoveEmailRequestBuilder and sets the default values.
...
// NewItemTeamDefinitionPrimaryChannelRemoveEmailRequestBuilder instantiates a new ItemTeamDefinitionPrimaryChannelRemoveEmailRequestBuilder and sets the default values.
...
func (m *ItemTeamDefinitionPrimaryChannelRemoveEmailRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *ItemTeamDefinitionPrimaryChannelRemoveEmailRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemTeamDefinitionPrimaryChannelRemoveEmailRequestBuilder) WithUrl(rawUrl string)(*ItemTeamDefinitionPrimaryChannelRemoveEmailRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelRemoveEmailRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
