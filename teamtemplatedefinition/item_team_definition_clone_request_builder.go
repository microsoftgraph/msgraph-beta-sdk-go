...
// NewItemTeamDefinitionCloneRequestBuilderInternal instantiates a new CloneRequestBuilder and sets the default values.
...
// NewItemTeamDefinitionCloneRequestBuilder instantiates a new CloneRequestBuilder and sets the default values.
