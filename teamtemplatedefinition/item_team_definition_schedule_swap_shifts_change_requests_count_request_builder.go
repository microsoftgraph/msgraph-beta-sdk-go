...
func (m *ItemTeamDefinitionScheduleSwapShiftsChangeRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamDefinitionScheduleSwapShiftsChangeRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
