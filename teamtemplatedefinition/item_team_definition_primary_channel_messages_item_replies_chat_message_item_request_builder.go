...
func (m *ItemTeamDefinitionPrimaryChannelMessagesItemRepliesChatMessageItemRequestBuilder) MicrosoftGraphSetReaction()(*ItemTeamDefinitionPrimaryChannelMessagesItemRepliesItemMicrosoftGraphSetReactionRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMessagesItemRepliesItemMicrosoftGraphSetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSoftDelete provides operations to call the softDelete method.
func (m *ItemTeamDefinitionPrimaryChannelMessagesItemRepliesChatMessageItemRequestBuilder) MicrosoftGraphSoftDelete()(*ItemTeamDefinitionPrimaryChannelMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUndoSoftDelete provides operations to call the undoSoftDelete method.
func (m *ItemTeamDefinitionPrimaryChannelMessagesItemRepliesChatMessageItemRequestBuilder) MicrosoftGraphUndoSoftDelete()(*ItemTeamDefinitionPrimaryChannelMessagesItemRepliesItemMicrosoftGraphUndoSoftDeleteRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMessagesItemRepliesItemMicrosoftGraphUndoSoftDeleteRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnsetReaction provides operations to call the unsetReaction method.
func (m *ItemTeamDefinitionPrimaryChannelMessagesItemRepliesChatMessageItemRequestBuilder) MicrosoftGraphUnsetReaction()(*ItemTeamDefinitionPrimaryChannelMessagesItemRepliesItemMicrosoftGraphUnsetReactionRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMessagesItemRepliesItemMicrosoftGraphUnsetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
