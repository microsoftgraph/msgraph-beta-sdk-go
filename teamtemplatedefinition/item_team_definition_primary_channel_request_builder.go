...
func (m *ItemTeamDefinitionPrimaryChannelRequestBuilder) MicrosoftGraphCompleteMigration()(*ItemTeamDefinitionPrimaryChannelMicrosoftGraphCompleteMigrationRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMicrosoftGraphCompleteMigrationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemTeamDefinitionPrimaryChannelRequestBuilder) MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName()(*ItemTeamDefinitionPrimaryChannelMicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphProvisionEmail provides operations to call the provisionEmail method.
func (m *ItemTeamDefinitionPrimaryChannelRequestBuilder) MicrosoftGraphProvisionEmail()(*ItemTeamDefinitionPrimaryChannelMicrosoftGraphProvisionEmailRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMicrosoftGraphProvisionEmailRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphRemoveEmail provides operations to call the removeEmail method.
func (m *ItemTeamDefinitionPrimaryChannelRequestBuilder) MicrosoftGraphRemoveEmail()(*ItemTeamDefinitionPrimaryChannelMicrosoftGraphRemoveEmailRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMicrosoftGraphRemoveEmailRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
