...
// ItemTeamdefinitionOwnersUserItemRequestBuilder provides operations to manage the owners property of the microsoft.graph.team entity.
type ItemTeamdefinitionOwnersUserItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemTeamdefinitionOwnersUserItemRequestBuilderGetQueryParameters the list of this team's owners. Currently, when creating a team using application permissions, exactly one owner must be specified. When using user-delegated permissions, no owner can be specified (the current user is the owner). The owner must be specified as an object ID (GUID), not a UPN.
type ItemTeamdefinitionOwnersUserItemRequestBuilderGetQueryParameters struct {
    // Expand related entities
    Expand []string `uriparametername:"%24expand"`
    // Select properties to be returned
    Select []string `uriparametername:"%24select"`
}
// ItemTeamdefinitionOwnersUserItemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemTeamdefinitionOwnersUserItemRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
// NewItemTeamdefinitionOwnersUserItemRequestBuilderInternal instantiates a new ItemTeamdefinitionOwnersUserItemRequestBuilder and sets the default values.
func NewItemTeamdefinitionOwnersUserItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamdefinitionOwnersUserItemRequestBuilder) {
    m := &ItemTeamdefinitionOwnersUserItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/owners/{user%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemTeamdefinitionOwnersUserItemRequestBuilder instantiates a new ItemTeamdefinitionOwnersUserItemRequestBuilder and sets the default values.
...
// returns a *ItemTeamdefinitionOwnersItemMailboxsettingsMailboxSettingsRequestBuilder when successful
func (m *ItemTeamdefinitionOwnersUserItemRequestBuilder) MailboxSettings()(*ItemTeamdefinitionOwnersItemMailboxsettingsMailboxSettingsRequestBuilder) {
    return NewItemTeamdefinitionOwnersItemMailboxsettingsMailboxSettingsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemTeamdefinitionOwnersUserItemRequestBuilder) ServiceProvisioningErrors()(*ItemTeamdefinitionOwnersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilder) {
    return NewItemTeamdefinitionOwnersItemServiceprovisioningerrorsServiceProvisioningErrorsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
