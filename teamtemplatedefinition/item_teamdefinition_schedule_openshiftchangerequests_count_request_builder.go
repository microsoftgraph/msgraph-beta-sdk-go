...
// NewItemTeamdefinitionScheduleOpenshiftchangerequestsCountRequestBuilderInternal instantiates a new ItemTeamdefinitionScheduleOpenshiftchangerequestsCountRequestBuilder and sets the default values.
func NewItemTeamdefinitionScheduleOpenshiftchangerequestsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamdefinitionScheduleOpenshiftchangerequestsCountRequestBuilder) {
    m := &ItemTeamdefinitionScheduleOpenshiftchangerequestsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/openShiftChangeRequests/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemTeamdefinitionScheduleOpenshiftchangerequestsCountRequestBuilder instantiates a new ItemTeamdefinitionScheduleOpenshiftchangerequestsCountRequestBuilder and sets the default values.
