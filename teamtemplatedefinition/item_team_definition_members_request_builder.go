...
func (m *ItemTeamDefinitionMembersRequestBuilder) MicrosoftGraphAdd()(*ItemTeamDefinitionMembersMicrosoftGraphAddRequestBuilder) {
    return NewItemTeamDefinitionMembersMicrosoftGraphAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
