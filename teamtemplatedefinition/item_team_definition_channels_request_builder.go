...
func (m *ItemTeamDefinitionChannelsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamDefinitionChannelsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ChannelCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateChannelCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemTeamDefinitionChannelsRequestBuilder) MicrosoftGraphAllMessages()(*ItemTeamDefinitionChannelsMicrosoftGraphAllMessagesAllMessagesRequestBuilder) {
    return NewItemTeamDefinitionChannelsMicrosoftGraphAllMessagesAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGetAllMessages provides operations to call the getAllMessages method.
func (m *ItemTeamDefinitionChannelsRequestBuilder) MicrosoftGraphGetAllMessages()(*ItemTeamDefinitionChannelsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilder) {
    return NewItemTeamDefinitionChannelsMicrosoftGraphGetAllMessagesGetAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
