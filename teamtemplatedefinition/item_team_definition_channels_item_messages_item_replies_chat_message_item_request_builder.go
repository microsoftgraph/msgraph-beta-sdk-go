...
func (m *ItemTeamDefinitionChannelsItemMessagesItemRepliesChatMessageItemRequestBuilder) MicrosoftGraphSetReaction()(*ItemTeamDefinitionChannelsItemMessagesItemRepliesItemMicrosoftGraphSetReactionRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesItemRepliesItemMicrosoftGraphSetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSoftDelete provides operations to call the softDelete method.
func (m *ItemTeamDefinitionChannelsItemMessagesItemRepliesChatMessageItemRequestBuilder) MicrosoftGraphSoftDelete()(*ItemTeamDefinitionChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUndoSoftDelete provides operations to call the undoSoftDelete method.
func (m *ItemTeamDefinitionChannelsItemMessagesItemRepliesChatMessageItemRequestBuilder) MicrosoftGraphUndoSoftDelete()(*ItemTeamDefinitionChannelsItemMessagesItemRepliesItemMicrosoftGraphUndoSoftDeleteRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesItemRepliesItemMicrosoftGraphUndoSoftDeleteRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnsetReaction provides operations to call the unsetReaction method.
func (m *ItemTeamDefinitionChannelsItemMessagesItemRepliesChatMessageItemRequestBuilder) MicrosoftGraphUnsetReaction()(*ItemTeamDefinitionChannelsItemMessagesItemRepliesItemMicrosoftGraphUnsetReactionRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesItemRepliesItemMicrosoftGraphUnsetReactionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
