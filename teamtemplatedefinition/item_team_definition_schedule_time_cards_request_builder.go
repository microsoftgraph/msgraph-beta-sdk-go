...
func (m *ItemTeamDefinitionScheduleTimeCardsRequestBuilder) MicrosoftGraphClockIn()(*ItemTeamDefinitionScheduleTimeCardsMicrosoftGraphClockInRequestBuilder) {
    return NewItemTeamDefinitionScheduleTimeCardsMicrosoftGraphClockInRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
