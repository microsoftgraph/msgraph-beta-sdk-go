...
func (m *ItemTeamDefinitionRequestBuilder) AllChannelsById(id string)(*ChannelItemRequestBuilder) {
...
func (m *ItemTeamDefinitionRequestBuilder) Archive()(*ItemTeamDefinitionArchiveRequestBuilder) {
    return NewItemTeamDefinitionArchiveRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemTeamDefinitionRequestBuilder) ChannelsById(id string)(*ChannelItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *ItemTeamDefinitionRequestBuilder) Clone()(*ItemTeamDefinitionCloneRequestBuilder) {
    return NewItemTeamDefinitionCloneRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemTeamDefinitionRequestBuilder) CompleteMigration()(*ItemTeamDefinitionCompleteMigrationRequestBuilder) {
    return NewItemTeamDefinitionCompleteMigrationRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemTeamDefinitionRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemTeamDefinitionRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemTeamDefinitionRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTeamDefinitionRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ItemTeamDefinitionRequestBuilder) IncomingChannelsById(id string)(*ChannelItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *ItemTeamDefinitionRequestBuilder) InstalledAppsById(id string)(*TeamsAppInstallationItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *ItemTeamDefinitionRequestBuilder) MembersById(id string)(*ConversationMemberItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *ItemTeamDefinitionRequestBuilder) OperationsById(id string)(*TeamsAsyncOperationItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *ItemTeamDefinitionRequestBuilder) OwnersById(id string)(*UserItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *ItemTeamDefinitionRequestBuilder) PermissionGrantsById(id string)(*ResourceSpecificPermissionGrantItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewResourceSpecificPermissionGrantItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *ItemTeamDefinitionRequestBuilder) SendActivityNotification()(*ItemTeamDefinitionSendActivityNotificationRequestBuilder) {
    return NewItemTeamDefinitionSendActivityNotificationRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemTeamDefinitionRequestBuilder) TagsById(id string)(*TeamworkTagItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
...
func (m *ItemTeamDefinitionRequestBuilder) Unarchive()(*ItemTeamDefinitionUnarchiveRequestBuilder) {
    return NewItemTeamDefinitionUnarchiveRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
