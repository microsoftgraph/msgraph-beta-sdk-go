...
func (m *ItemTeamDefinitionRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemTeamDefinitionRequestBuilderDeleteRequestConfiguration)([]byte, error) {
