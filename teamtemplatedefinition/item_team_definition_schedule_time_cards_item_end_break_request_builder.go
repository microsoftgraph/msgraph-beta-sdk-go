...
// NewItemTeamDefinitionScheduleTimeCardsItemEndBreakRequestBuilderInternal instantiates a new EndBreakRequestBuilder and sets the default values.
func NewItemTeamDefinitionScheduleTimeCardsItemEndBreakRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamDefinitionScheduleTimeCardsItemEndBreakRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/{timeCard%2Did}/endBreak";
...
// NewItemTeamDefinitionScheduleTimeCardsItemEndBreakRequestBuilder instantiates a new EndBreakRequestBuilder and sets the default values.
