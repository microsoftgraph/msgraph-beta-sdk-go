...
func (m *ItemTeamDefinitionPrimaryChannelMessagesItemRepliesRequestBuilder) MicrosoftGraphDelta()(*ItemTeamDefinitionPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
