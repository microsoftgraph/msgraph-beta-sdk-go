...
func (m *ItemTeamDefinitionPrimaryChannelMessagesItemRepliesRequestBuilder) MicrosoftGraphDelta()(*ItemTeamDefinitionPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMessagesItemRepliesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
