...
func (m *ItemTeamDefinitionChannelsItemMessagesRequestBuilder) MicrosoftGraphDelta()(*ItemTeamDefinitionChannelsItemMessagesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
