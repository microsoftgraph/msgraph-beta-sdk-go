...
func (m *ItemTeamDefinitionChannelsItemMessagesRequestBuilder) MicrosoftGraphDelta()(*ItemTeamDefinitionChannelsItemMessagesMicrosoftGraphDeltaDeltaRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesMicrosoftGraphDeltaDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
