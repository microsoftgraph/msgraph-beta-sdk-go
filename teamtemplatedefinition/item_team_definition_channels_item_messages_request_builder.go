...
func (m *ItemTeamDefinitionChannelsItemMessagesRequestBuilder) Count()(*ItemTeamDefinitionChannelsItemMessagesCountRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemTeamDefinitionChannelsItemMessagesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTeamDefinitionChannelsItemMessagesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemTeamDefinitionChannelsItemMessagesRequestBuilder) Delta()(*ItemTeamDefinitionChannelsItemMessagesDeltaRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// Get retrieve the list of messages (without the replies) in a channel of a team. To get the replies for a message, call the list message replies or the get message reply API. This method supports federation. To list channel messages in application context, the request must be made from the tenant that the channel owner belongs to (represented by the **tenantId** property on the channel).
// [Find more info here]
// 
