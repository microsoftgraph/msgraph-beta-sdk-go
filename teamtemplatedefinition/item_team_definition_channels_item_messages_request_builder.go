...
// NewItemTeamDefinitionChannelsItemMessagesRequestBuilderInternal instantiates a new ItemTeamDefinitionChannelsItemMessagesRequestBuilder and sets the default values.
func NewItemTeamDefinitionChannelsItemMessagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamDefinitionChannelsItemMessagesRequestBuilder) {
    m := &ItemTeamDefinitionChannelsItemMessagesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/messages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemTeamDefinitionChannelsItemMessagesRequestBuilder instantiates a new ItemTeamDefinitionChannelsItemMessagesRequestBuilder and sets the default values.
...
func (m *ItemTeamDefinitionChannelsItemMessagesRequestBuilder) ForwardToChat()(*ItemTeamDefinitionChannelsItemMessagesForwardToChatRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesForwardToChatRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemTeamDefinitionChannelsItemMessagesRequestBuilder) ReplyWithQuote()(*ItemTeamDefinitionChannelsItemMessagesReplyWithQuoteRequestBuilder) {
    return NewItemTeamDefinitionChannelsItemMessagesReplyWithQuoteRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
