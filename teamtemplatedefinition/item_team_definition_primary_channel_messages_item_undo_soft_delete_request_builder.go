...
// NewItemTeamDefinitionPrimaryChannelMessagesItemUndoSoftDeleteRequestBuilderInternal instantiates a new ItemTeamDefinitionPrimaryChannelMessagesItemUndoSoftDeleteRequestBuilder and sets the default values.
...
// NewItemTeamDefinitionPrimaryChannelMessagesItemUndoSoftDeleteRequestBuilder instantiates a new ItemTeamDefinitionPrimaryChannelMessagesItemUndoSoftDeleteRequestBuilder and sets the default values.
...
func (m *ItemTeamDefinitionPrimaryChannelMessagesItemUndoSoftDeleteRequestBuilder) WithUrl(rawUrl string)(*ItemTeamDefinitionPrimaryChannelMessagesItemUndoSoftDeleteRequestBuilder) {
    return NewItemTeamDefinitionPrimaryChannelMessagesItemUndoSoftDeleteRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
