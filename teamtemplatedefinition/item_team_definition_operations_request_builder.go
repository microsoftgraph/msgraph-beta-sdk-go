...
// NewItemTeamDefinitionOperationsRequestBuilderInternal instantiates a new OperationsRequestBuilder and sets the default values.
...
// NewItemTeamDefinitionOperationsRequestBuilder instantiates a new OperationsRequestBuilder and sets the default values.
...
func (m *ItemTeamDefinitionOperationsRequestBuilder) Count()(*ItemTeamDefinitionOperationsCountRequestBuilder) {
    return NewItemTeamDefinitionOperationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the async operations that ran or are running on this team.
func (m *ItemTeamDefinitionOperationsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTeamDefinitionOperationsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
