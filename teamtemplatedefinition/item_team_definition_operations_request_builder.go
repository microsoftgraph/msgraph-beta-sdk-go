...
func (m *ItemTeamDefinitionOperationsRequestBuilder) ByTeamsAsyncOperationIdString(teamsAsyncOperationId string)(*ItemTeamDefinitionOperationsTeamsAsyncOperationItemRequestBuilder) {
...
func NewItemTeamDefinitionOperationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamDefinitionOperationsRequestBuilder) {
    m := &ItemTeamDefinitionOperationsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
