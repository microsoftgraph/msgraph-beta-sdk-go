...
func (m *ItemTeamDefinitionScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphClockOut()(*ItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphClockOutRequestBuilder) {
    return NewItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphClockOutRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphConfirm provides operations to call the confirm method.
func (m *ItemTeamDefinitionScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphConfirm()(*ItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphConfirmRequestBuilder) {
    return NewItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphConfirmRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEndBreak provides operations to call the endBreak method.
func (m *ItemTeamDefinitionScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphEndBreak()(*ItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphEndBreakRequestBuilder) {
    return NewItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphEndBreakRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphStartBreak provides operations to call the startBreak method.
func (m *ItemTeamDefinitionScheduleTimeCardsTimeCardItemRequestBuilder) MicrosoftGraphStartBreak()(*ItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphStartBreakRequestBuilder) {
    return NewItemTeamDefinitionScheduleTimeCardsItemMicrosoftGraphStartBreakRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
