...
// ItemTeamDefinitionScheduleTimeCardsItemClockOutPostRequestBody provides operations to call the clockOut method.
...
func (m *ItemTeamDefinitionScheduleTimeCardsItemClockOutPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemTeamDefinitionScheduleTimeCardsItemClockOutPostRequestBody) SetAdditionalData(value map[string]interface{})() {
