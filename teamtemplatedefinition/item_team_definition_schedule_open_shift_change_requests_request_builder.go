...
func (m *ItemTeamDefinitionScheduleOpenShiftChangeRequestsRequestBuilder) Count()(*ItemTeamDefinitionScheduleOpenShiftChangeRequestsCountRequestBuilder) {
    return NewItemTeamDefinitionScheduleOpenShiftChangeRequestsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation retrieve a list of openShiftChangeRequest objects in a team.
func (m *ItemTeamDefinitionScheduleOpenShiftChangeRequestsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTeamDefinitionScheduleOpenShiftChangeRequestsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
