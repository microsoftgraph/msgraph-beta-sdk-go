...
func (m *ItemTeamDefinitionScheduleShiftsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamDefinitionScheduleShiftsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
