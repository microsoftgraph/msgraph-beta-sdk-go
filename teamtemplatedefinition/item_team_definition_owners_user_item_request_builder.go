...
func (m *ItemTeamDefinitionOwnersUserItemRequestBuilder) MailboxSettings()(*ItemTeamDefinitionOwnersItemMailboxSettingsRequestBuilder) {
    return NewItemTeamDefinitionOwnersItemMailboxSettingsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// ServiceProvisioningErrors the serviceProvisioningErrors property
// returns a *ItemTeamDefinitionOwnersItemServiceProvisioningErrorsRequestBuilder when successful
func (m *ItemTeamDefinitionOwnersUserItemRequestBuilder) ServiceProvisioningErrors()(*ItemTeamDefinitionOwnersItemServiceProvisioningErrorsRequestBuilder) {
