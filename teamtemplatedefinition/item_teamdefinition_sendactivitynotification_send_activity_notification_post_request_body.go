...
type ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody instantiates a new ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody and sets the default values.
func NewItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody()(*ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) {
    m := &ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody(), nil
}
// GetActivityType gets the activityType property value. The activityType property
// returns a *string when successful
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) GetActivityType()(*string) {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetChainId gets the chainId property value. The chainId property
// returns a *int64 when successful
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) GetChainId()(*int64) {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) GetPreviewText()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ItemBodyable) {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) GetRecipient()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkNotificationRecipientable) {
...
// returns a *string when successful
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) GetTeamsAppId()(*string) {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) GetTemplateParameters()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.KeyValuePairable) {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) GetTopic()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkActivityTopicable) {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) SetActivityType(value *string)() {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetChainId sets the chainId property value. The chainId property
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) SetChainId(value *int64)() {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) SetPreviewText(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ItemBodyable)() {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) SetRecipient(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkNotificationRecipientable)() {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) SetTeamsAppId(value *string)() {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) SetTemplateParameters(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.KeyValuePairable)() {
...
func (m *ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBody) SetTopic(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.TeamworkActivityTopicable)() {
    err := m.GetBackingStore().Set("topic", value)
    if err != nil {
        panic(err)
    }
}
type ItemTeamdefinitionSendactivitynotificationSendActivityNotificationPostRequestBodyable interface {
