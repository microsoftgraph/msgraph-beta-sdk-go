...
func (m *ItemTeamDefinitionScheduleOpenShiftChangeRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamDefinitionScheduleOpenShiftChangeRequestsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
