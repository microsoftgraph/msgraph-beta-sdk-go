...
// NewItemTeamDefinitionPrimaryChannelMessagesItemRepliesCountRequestBuilderInternal instantiates a new ItemTeamDefinitionPrimaryChannelMessagesItemRepliesCountRequestBuilder and sets the default values.
func NewItemTeamDefinitionPrimaryChannelMessagesItemRepliesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamDefinitionPrimaryChannelMessagesItemRepliesCountRequestBuilder) {
    m := &ItemTeamDefinitionPrimaryChannelMessagesItemRepliesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/messages/{chatMessage%2Did}/replies/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemTeamDefinitionPrimaryChannelMessagesItemRepliesCountRequestBuilder instantiates a new ItemTeamDefinitionPrimaryChannelMessagesItemRepliesCountRequestBuilder and sets the default values.
