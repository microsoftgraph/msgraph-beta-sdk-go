...
// ItemTeamDefinitionInstalledAppsRequestBuilderGetQueryParameters retrieve the list of apps installed in the specified team. This API is supported in the following national cloud deployments.
