...
func (m *ItemTeamDefinitionInstalledAppsRequestBuilder) Count()(*ItemTeamDefinitionInstalledAppsCountRequestBuilder) {
    return NewItemTeamDefinitionInstalledAppsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation retrieve the list of apps installed in the specified team.
func (m *ItemTeamDefinitionInstalledAppsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTeamDefinitionInstalledAppsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
