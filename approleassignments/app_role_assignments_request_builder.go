...
func NewAppRoleAssignmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AppRoleAssignmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/appRoleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// CreateGetRequestInformationWithRequestConfiguration get entities from appRoleAssignments
...
// CreatePostRequestInformation add new entity to appRoleAssignments
...
// CreatePostRequestInformationWithRequestConfiguration add new entity to appRoleAssignments
...
// GetWithRequestConfigurationAndResponseHandler get entities from appRoleAssignments
...
// PostWithRequestConfigurationAndResponseHandler add new entity to appRoleAssignments
