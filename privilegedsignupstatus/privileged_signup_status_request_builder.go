...
func (m *PrivilegedSignupStatusRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivilegedSignupStatusRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrivilegedSignupStatusCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreatePrivilegedSignupStatusCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphCanSignUp provides operations to call the canSignUp method.
func (m *PrivilegedSignupStatusRequestBuilder) MicrosoftGraphCanSignUp()(*MicrosoftGraphCanSignUpCanSignUpRequestBuilder) {
    return NewMicrosoftGraphCanSignUpCanSignUpRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCompleteSetup provides operations to call the completeSetup method.
func (m *PrivilegedSignupStatusRequestBuilder) MicrosoftGraphCompleteSetup()(*MicrosoftGraphCompleteSetupCompleteSetupRequestBuilder) {
    return NewMicrosoftGraphCompleteSetupCompleteSetupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphIsSignedUp provides operations to call the isSignedUp method.
func (m *PrivilegedSignupStatusRequestBuilder) MicrosoftGraphIsSignedUp()(*MicrosoftGraphIsSignedUpIsSignedUpRequestBuilder) {
    return NewMicrosoftGraphIsSignedUpIsSignedUpRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSignUp provides operations to call the signUp method.
func (m *PrivilegedSignupStatusRequestBuilder) MicrosoftGraphSignUp()(*MicrosoftGraphSignUpSignUpRequestBuilder) {
    return NewMicrosoftGraphSignUpSignUpRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *PrivilegedSignupStatusRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *PrivilegedSignupStatusRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// ToPostRequestInformation add new entity to privilegedSignupStatus
func (m *PrivilegedSignupStatusRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrivilegedSignupStatusable, requestConfiguration *PrivilegedSignupStatusRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
