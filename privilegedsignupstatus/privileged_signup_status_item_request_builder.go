...
func (m *PrivilegedSignupStatusItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *PrivilegedSignupStatusItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
