...
func (m *FilestorageDeletedcontainersItemRecyclebinItemsRecycleBinItemItemRequestBuilder) CreatedByUser()(*FilestorageDeletedcontainersItemRecyclebinItemsItemCreatedbyuserCreatedByUserRequestBuilder) {
    return NewFilestorageDeletedcontainersItemRecyclebinItemsItemCreatedbyuserCreatedByUserRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *FilestorageDeletedcontainersItemRecyclebinItemsRecycleBinItemItemRequestBuilder) LastModifiedByUser()(*FilestorageDeletedcontainersItemRecyclebinItemsItemLastmodifiedbyuserLastModifiedByUserRequestBuilder) {
    return NewFilestorageDeletedcontainersItemRecyclebinItemsItemLastmodifiedbyuserLastModifiedByUserRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
