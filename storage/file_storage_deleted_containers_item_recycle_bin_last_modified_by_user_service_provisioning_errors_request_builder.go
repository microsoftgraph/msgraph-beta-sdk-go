...
// FileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilderGetQueryParameters errors published by a federated service describing a nontransient, service-specific error regarding the properties or link from a user object.
...
func NewFileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder) {
    m := &FileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder{
...
func NewFileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder) {
    ...
    return NewFileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *FileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder) Count()(*FileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsCountRequestBuilder) {
...
func (m *FileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder) WithUrl(rawUrl string)(*FileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder) {
    return NewFileStorageDeletedContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
