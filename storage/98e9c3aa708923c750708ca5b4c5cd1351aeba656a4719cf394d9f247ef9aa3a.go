...
// FileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsRequestBuilderGetQueryParameters errors published by a federated service describing a nontransient, service-specific error regarding the properties or link from a user object.
...
func NewFileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsRequestBuilder) {
    m := &FileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsRequestBuilder{
...
func NewFileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsRequestBuilder) {
    ...
    return NewFileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *FileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsRequestBuilder) Count()(*FileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsCountRequestBuilder) {
...
func (m *FileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsRequestBuilder) WithUrl(rawUrl string)(*FileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsRequestBuilder) {
    return NewFileStorageContainersItemRecycleBinItemsItemLastModifiedByUserServiceProvisioningErrorsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
