...
func (m *FileStorageDeletedContainersItemDriveListItemsItemVersionsListItemVersionItemRequestBuilder) RestoreVersion()(*FileStorageDeletedContainersItemDriveListItemsItemVersionsItemRestoreVersionRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveListItemsItemVersionsItemRestoreVersionRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
