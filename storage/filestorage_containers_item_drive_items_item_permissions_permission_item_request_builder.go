...
func (m *FilestorageContainersItemDriveItemsItemPermissionsPermissionItemRequestBuilder) RevokeGrants()(*FilestorageContainersItemDriveItemsItemPermissionsItemRevokegrantsRevokeGrantsRequestBuilder) {
    return NewFilestorageContainersItemDriveItemsItemPermissionsItemRevokegrantsRevokeGrantsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
