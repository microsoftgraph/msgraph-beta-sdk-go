...
func (m *FileStorageDeletedContainersItemDriveRootRequestBuilder) ContentStream()(*FileStorageDeletedContainersItemDriveRootContentStreamRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveRootContentStreamRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
