...
type FileStorageRequestBuilder struct {
...
func NewFileStorageRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageRequestBuilder) {
    m := &FileStorageRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/storage/fileStorage{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewFileStorageRequestBuilder instantiates a new FileStorageRequestBuilder and sets the default values.
func NewFileStorageRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewFileStorageRequestBuilderInternal(urlParams, requestAdapter)
}
// Containers provides operations to manage the containers property of the microsoft.graph.fileStorage entity.
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *FileStorageRequestBuilder) Get(ctx context.Context, requestConfiguration *FileStorageRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.FileStorageable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateFileStorageFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.FileStorageable), nil
}
// Patch update the navigation property fileStorage in storage
// returns a FileStorageable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *FileStorageRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.FileStorageable, requestConfiguration *FileStorageRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.FileStorageable, error) {
...
// ToDeleteRequestInformation delete navigation property fileStorage for storage
// returns a *RequestInformation when successful
func (m *FileStorageRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *FileStorageRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// ToGetRequestInformation get fileStorage from storage
// returns a *RequestInformation when successful
func (m *FileStorageRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *FileStorageRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// ToPatchRequestInformation update the navigation property fileStorage in storage
// returns a *RequestInformation when successful
...
func (m *FileStorageRequestBuilder) WithUrl(rawUrl string)(*FileStorageRequestBuilder) {
    return NewFileStorageRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
