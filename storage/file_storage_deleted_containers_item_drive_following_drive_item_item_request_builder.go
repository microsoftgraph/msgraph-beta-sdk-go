...
func (m *FileStorageDeletedContainersItemDriveFollowingDriveItemItemRequestBuilder) ContentStream()(*FileStorageDeletedContainersItemDriveFollowingItemContentStreamRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveFollowingItemContentStreamRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
