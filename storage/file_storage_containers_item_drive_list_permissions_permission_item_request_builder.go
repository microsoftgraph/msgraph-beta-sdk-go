...
// FileStorageContainersItemDriveListPermissionsPermissionItemRequestBuilderGetQueryParameters the set of permissions for the item. Read-only. Nullable.
...
func (m *FileStorageContainersItemDriveListPermissionsPermissionItemRequestBuilder) RevokeGrants()(*FileStorageContainersItemDriveListPermissionsItemRevokeGrantsRequestBuilder) {
    return NewFileStorageContainersItemDriveListPermissionsItemRevokeGrantsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
