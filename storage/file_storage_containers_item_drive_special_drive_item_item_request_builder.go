...
// returns a *FileStorageContainersItemDriveSpecialItemContentStreamRequestBuilder when successful
func (m *FileStorageContainersItemDriveSpecialDriveItemItemRequestBuilder) ContentStream()(*FileStorageContainersItemDriveSpecialItemContentStreamRequestBuilder) {
    return NewFileStorageContainersItemDriveSpecialItemContentStreamRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
