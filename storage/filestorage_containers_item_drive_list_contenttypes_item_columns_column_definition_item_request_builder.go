...
func (m *FilestorageContainersItemDriveListContenttypesItemColumnsColumnDefinitionItemRequestBuilder) SourceColumn()(*FilestorageContainersItemDriveListContenttypesItemColumnsItemSourcecolumnSourceColumnRequestBuilder) {
    return NewFilestorageContainersItemDriveListContenttypesItemColumnsItemSourcecolumnSourceColumnRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
