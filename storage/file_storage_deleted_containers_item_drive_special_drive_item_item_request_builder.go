...
func (m *FileStorageDeletedContainersItemDriveSpecialDriveItemItemRequestBuilder) ContentStream()(*FileStorageDeletedContainersItemDriveSpecialItemContentStreamRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveSpecialItemContentStreamRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
