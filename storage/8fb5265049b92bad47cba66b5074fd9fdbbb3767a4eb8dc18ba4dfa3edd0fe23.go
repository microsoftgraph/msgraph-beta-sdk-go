...
// FileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilderGetQueryParameters errors published by a federated service describing a nontransient, service-specific error regarding the properties or link from a user object.
...
func NewFileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder) {
    m := &FileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder{
...
func NewFileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder) {
    ...
    return NewFileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *FileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder) Count()(*FileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsCountRequestBuilder) {
...
func (m *FileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder) WithUrl(rawUrl string)(*FileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder) {
    return NewFileStorageContainersItemRecycleBinLastModifiedByUserServiceProvisioningErrorsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
