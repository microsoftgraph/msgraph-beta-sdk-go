...
func NewFileStorageDeletedContainersItemRecycleBinLastModifiedByUserMailboxSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageDeletedContainersItemRecycleBinLastModifiedByUserMailboxSettingsRequestBuilder) {
    m := &FileStorageDeletedContainersItemRecycleBinLastModifiedByUserMailboxSettingsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/recycleBin/lastModifiedByUser/mailboxSettings{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
func NewFileStorageDeletedContainersItemRecycleBinLastModifiedByUserMailboxSettingsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FileStorageDeletedContainersItemRecycleBinLastModifiedByUserMailboxSettingsRequestBuilder) {
    ...
    return NewFileStorageDeletedContainersItemRecycleBinLastModifiedByUserMailboxSettingsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *FileStorageDeletedContainersItemRecycleBinLastModifiedByUserMailboxSettingsRequestBuilder) WithUrl(rawUrl string)(*FileStorageDeletedContainersItemRecycleBinLastModifiedByUserMailboxSettingsRequestBuilder) {
    return NewFileStorageDeletedContainersItemRecycleBinLastModifiedByUserMailboxSettingsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
