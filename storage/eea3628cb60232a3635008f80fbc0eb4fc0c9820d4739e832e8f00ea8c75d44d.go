...
// FileStorageDeletedContainersItemDriveListItemsItemPermissionsPermissionItemRequestBuilderGetQueryParameters the set of permissions for the item. Read-only. Nullable.
...
// returns a *FileStorageDeletedContainersItemDriveListItemsItemPermissionsItemRevokeGrantsRequestBuilder when successful
func (m *FileStorageDeletedContainersItemDriveListItemsItemPermissionsPermissionItemRequestBuilder) RevokeGrants()(*FileStorageDeletedContainersItemDriveListItemsItemPermissionsItemRevokeGrantsRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveListItemsItemPermissionsItemRevokeGrantsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
