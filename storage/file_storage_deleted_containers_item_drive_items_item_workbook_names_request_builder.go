...
func (m *FileStorageDeletedContainersItemDriveItemsItemWorkbookNamesRequestBuilder) AddFormulaLocal()(*FileStorageDeletedContainersItemDriveItemsItemWorkbookNamesAddFormulaLocalRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveItemsItemWorkbookNamesAddFormulaLocalRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
