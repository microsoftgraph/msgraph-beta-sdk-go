...
func (m *FileStorageDeletedContainersItemDriveListItemsItemActivitiesItemActivityOLDItemRequestBuilder) DriveItem()(*FileStorageDeletedContainersItemDriveListItemsItemActivitiesItemDriveItemRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveListItemsItemActivitiesItemDriveItemRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *FileStorageDeletedContainersItemDriveListItemsItemActivitiesItemActivityOLDItemRequestBuilder) ListItem()(*FileStorageDeletedContainersItemDriveListItemsItemActivitiesItemListItemRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveListItemsItemActivitiesItemListItemRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
