...
func (m *FilestorageContainersItemDriveActivitiesItemActivityOLDItemRequestBuilder) DriveItem()(*FilestorageContainersItemDriveActivitiesItemDriveitemDriveItemRequestBuilder) {
    return NewFilestorageContainersItemDriveActivitiesItemDriveitemDriveItemRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *FilestorageContainersItemDriveActivitiesItemListitemListItemRequestBuilder when successful
func (m *FilestorageContainersItemDriveActivitiesItemActivityOLDItemRequestBuilder) ListItem()(*FilestorageContainersItemDriveActivitiesItemListitemListItemRequestBuilder) {
    return NewFilestorageContainersItemDriveActivitiesItemListitemListItemRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
