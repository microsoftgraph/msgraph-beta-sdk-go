...
// returns a *FileStorageContainersItemDriveBundlesItemContentStreamRequestBuilder when successful
func (m *FileStorageContainersItemDriveBundlesDriveItemItemRequestBuilder) ContentStream()(*FileStorageContainersItemDriveBundlesItemContentStreamRequestBuilder) {
    return NewFileStorageContainersItemDriveBundlesItemContentStreamRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
