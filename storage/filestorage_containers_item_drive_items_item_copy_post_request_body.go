...
type FilestorageContainersItemDriveItemsItemCopyPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewFilestorageContainersItemDriveItemsItemCopyPostRequestBody instantiates a new FilestorageContainersItemDriveItemsItemCopyPostRequestBody and sets the default values.
func NewFilestorageContainersItemDriveItemsItemCopyPostRequestBody()(*FilestorageContainersItemDriveItemsItemCopyPostRequestBody) {
    m := &FilestorageContainersItemDriveItemsItemCopyPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateFilestorageContainersItemDriveItemsItemCopyPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateFilestorageContainersItemDriveItemsItemCopyPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewFilestorageContainersItemDriveItemsItemCopyPostRequestBody(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *FilestorageContainersItemDriveItemsItemCopyPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *FilestorageContainersItemDriveItemsItemCopyPostRequestBody) GetName()(*string) {
...
func (m *FilestorageContainersItemDriveItemsItemCopyPostRequestBody) GetParentReference()(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ItemReferenceable) {
...
func (m *FilestorageContainersItemDriveItemsItemCopyPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *FilestorageContainersItemDriveItemsItemCopyPostRequestBody) SetParentReference(value ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ItemReferenceable)() {
    err := m.GetBackingStore().Set("parentReference", value)
    if err != nil {
        panic(err)
    }
}
type FilestorageContainersItemDriveItemsItemCopyPostRequestBodyable interface {
