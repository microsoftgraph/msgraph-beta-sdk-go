...
func (m *FileStorageDeletedContainersItemDriveItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesRequestBuilder) ItemAtWithIndex(index *int32)(*FileStorageDeletedContainersItemDriveItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveItemsItemWorkbookCommentsItemTaskCommentRepliesItemTaskChangesItemAtWithIndexRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, index)
}
