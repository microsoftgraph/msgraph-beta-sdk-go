...
func (m *FilestorageContainersItemDriveItemsDriveItemItemRequestBuilder) ContentStream()(*FilestorageContainersItemDriveItemsItemContentstreamContentStreamRequestBuilder) {
    return NewFilestorageContainersItemDriveItemsItemContentstreamContentStreamRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
