...
func (m *FileStorageDeletedContainersItemDriveItemsItemWorkbookCommentsItemRepliesItemTaskCommentTaskChangesRequestBuilder) ItemAtWithIndex(index *int32)(*FileStorageDeletedContainersItemDriveItemsItemWorkbookCommentsItemRepliesItemTaskCommentTaskChangesItemAtWithIndexRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveItemsItemWorkbookCommentsItemRepliesItemTaskCommentTaskChangesItemAtWithIndexRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, index)
}
