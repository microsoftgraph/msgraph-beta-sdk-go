...
func (m *FileStorageDeletedContainersItemDriveItemsItemAnalyticsRequestBuilder) AllTime()(*FileStorageDeletedContainersItemDriveItemsItemAnalyticsAllTimeRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveItemsItemAnalyticsAllTimeRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *FileStorageDeletedContainersItemDriveItemsItemAnalyticsRequestBuilder) ItemActivityStats()(*FileStorageDeletedContainersItemDriveItemsItemAnalyticsItemActivityStatsRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveItemsItemAnalyticsItemActivityStatsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *FileStorageDeletedContainersItemDriveItemsItemAnalyticsRequestBuilder) LastSevenDays()(*FileStorageDeletedContainersItemDriveItemsItemAnalyticsLastSevenDaysRequestBuilder) {
    return NewFileStorageDeletedContainersItemDriveItemsItemAnalyticsLastSevenDaysRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
