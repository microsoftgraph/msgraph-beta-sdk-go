...
import (
    ...
    icf0b14cca8aab372c5b50fe26865c1544a00be042bce8b6b6d983447fc995366 "github.com/microsoftgraph/msgraph-beta-sdk-go/planner/buckets/item/tasks"
    i047e53f169a088b215f8da8917a7b7c9e2a94af0f9a2dffadbbdc1cf758f30ff "github.com/microsoftgraph/msgraph-beta-sdk-go/planner/buckets/item/tasks/item"
)
...
type PlannerBucketItemRequestBuilderPatchOptions struct {
    // 
    Body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PlannerBucketable
    // Request headers
    Headers map[string]string
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func (m *PlannerBucketItemRequestBuilder) CreateDeleteRequestInformation(options *PlannerBucketItemRequestBuilderDeleteOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PlannerBucketItemRequestBuilder) CreateGetRequestInformation(options *PlannerBucketItemRequestBuilderGetOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *PlannerBucketItemRequestBuilder) CreatePatchRequestInformation(options *PlannerBucketItemRequestBuilderPatchOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *PlannerBucketItemRequestBuilder) Get(options *PlannerBucketItemRequestBuilderGetOptions)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PlannerBucketable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreatePlannerBucketFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
...
func (m *PlannerBucketItemRequestBuilder) Tasks()(*icf0b14cca8aab372c5b50fe26865c1544a00be042bce8b6b6d983447fc995366.TasksRequestBuilder) {
    return icf0b14cca8aab372c5b50fe26865c1544a00be042bce8b6b6d983447fc995366.NewTasksRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// TasksById gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go/.planner.buckets.item.tasks.item collection
func (m *PlannerBucketItemRequestBuilder) TasksById(id string)(*i047e53f169a088b215f8da8917a7b7c9e2a94af0f9a2dffadbbdc1cf758f30ff.PlannerTaskItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i047e53f169a088b215f8da8917a7b7c9e2a94af0f9a2dffadbbdc1cf758f30ff.NewPlannerTaskItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
