...
func NewPlannerBucketRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PlannerBucketRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/planner/buckets/{plannerBucket_id}{?select,expand}";
...
func (m *PlannerBucketRequestBuilder) Tasks()(*icf0b14cca8aab372c5b50fe26865c1544a00be042bce8b6b6d983447fc995366.TasksRequestBuilder) {
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.planner.buckets.item.tasks.item collection
// Parameters:
//  - id : Unique identifier of the item
func (m *PlannerBucketRequestBuilder) TasksById(id string)(*i047e53f169a088b215f8da8917a7b7c9e2a94af0f9a2dffadbbdc1cf758f30ff.PlannerTaskRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return i047e53f169a088b215f8da8917a7b7c9e2a94af0f9a2dffadbbdc1cf758f30ff.NewPlannerTaskRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
