...
// CreateGetRequestInformationWithRequestConfiguration retrieve a list of **plannerbucket** objects.
...
// CreatePostRequestInformationWithRequestConfiguration use this API to create a new **plannerBucket**.
