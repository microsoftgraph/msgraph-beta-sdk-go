...
func (m *BucketsItemTasksPlannerTaskItemRequestBuilder) Messages()(*BucketsItemTasksItemMessagesRequestBuilder) {
    return NewBucketsItemTasksItemMessagesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
