...
// PlannerPlanItemRequestBuilder provides operations to manage the plans property of the microsoft.graph.plannerRoster entity.
...
// PlannerPlanItemRequestBuilderGetQueryParameters retrieves the plans contained by the plannerRoster.
...
// GetWithResponseHandler retrieves the plans contained by the plannerRoster.
