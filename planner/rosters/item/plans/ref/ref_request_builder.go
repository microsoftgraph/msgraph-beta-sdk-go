...
// RefRequestBuilder builds and executes requests for operations under \planner\rosters\{plannerRoster-id}\plans\$ref
...
// RefRequestBuilderGetQueryParameters retrieves the plans contained by the plannerRoster.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/planner/rosters/{plannerRoster_id}/plans/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation retrieves the plans contained by the plannerRoster.
...
// Post retrieves the plans contained by the plannerRoster.
