...
// PlansRequestBuilderGetQueryParameters get the plannerPlans contained by the plannerRoster.
...
// CreateGetRequestInformationWithRequestConfiguration get the plannerPlans contained by the plannerRoster.
