...
// ByPlannerBucketIdString provides operations to manage the buckets property of the microsoft.graph.planner entity.
func (m *BucketsRequestBuilder) ByPlannerBucketIdString(plannerBucketId string)(*BucketsPlannerBucketItemRequestBuilder) {
