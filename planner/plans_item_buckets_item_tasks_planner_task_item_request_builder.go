...
func (m *PlansItemBucketsItemTasksPlannerTaskItemRequestBuilder) Messages()(*PlansItemBucketsItemTasksItemMessagesRequestBuilder) {
    return NewPlansItemBucketsItemTasksItemMessagesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
