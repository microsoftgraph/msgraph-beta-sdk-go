...
// PlansItemMoveToContainerRequestBuilder provides operations to call the moveToContainer method.
type PlansItemMoveToContainerRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// PlansItemMoveToContainerRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type PlansItemMoveToContainerRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewPlansItemMoveToContainerRequestBuilderInternal instantiates a new PlansItemMoveToContainerRequestBuilder and sets the default values.
func NewPlansItemMoveToContainerRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PlansItemMoveToContainerRequestBuilder) {
    m := &PlansItemMoveToContainerRequestBuilder{
...
// NewPlansItemMoveToContainerRequestBuilder instantiates a new PlansItemMoveToContainerRequestBuilder and sets the default values.
func NewPlansItemMoveToContainerRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PlansItemMoveToContainerRequestBuilder) {
...
func (m *PlansItemMoveToContainerRequestBuilder) WithUrl(rawUrl string)(*PlansItemMoveToContainerRequestBuilder) {
    return NewPlansItemMoveToContainerRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
