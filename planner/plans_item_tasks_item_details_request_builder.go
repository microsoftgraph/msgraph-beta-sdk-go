...
func (m *PlansItemTasksItemDetailsRequestBuilder) Delete(ctx context.Context, requestConfiguration *PlansItemTasksItemDetailsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
