...
func NewCertificateBasedAuthConfigurationItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, certificateBasedAuthConfigurationId *string)(*CertificateBasedAuthConfigurationItemRequestBuilder) {
...
func NewCertificateBasedAuthConfigurationItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CertificateBasedAuthConfigurationItemRequestBuilder) {
    ...
    return NewCertificateBasedAuthConfigurationItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
