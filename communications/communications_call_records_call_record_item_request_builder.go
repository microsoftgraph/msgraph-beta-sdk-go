...
func NewCommunicationsCallRecordsCallRecordItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallRecordsCallRecordItemRequestBuilder) {
    m := &CommunicationsCallRecordsCallRecordItemRequestBuilder{
    }
...
func NewCommunicationsCallRecordsCallRecordItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallRecordsCallRecordItemRequestBuilder) {
    ...
    return NewCommunicationsCallRecordsCallRecordItemRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateDeleteRequestInformation delete navigation property callRecords for communications
func (m *CommunicationsCallRecordsCallRecordItemRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *CommunicationsCallRecordsCallRecordItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsCallRecordsCallRecordItemRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CommunicationsCallRecordsCallRecordItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *CommunicationsCallRecordsCallRecordItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body iabe42a55de44a0960e4cc683a105812061defb936fe89e1bc4ab83c390c3839f.CallRecordable, requestConfiguration *CommunicationsCallRecordsCallRecordItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *CommunicationsCallRecordsCallRecordItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *CommunicationsCallRecordsCallRecordItemRequestBuilderDeleteRequestConfiguration)(error) {
...
func (m *CommunicationsCallRecordsCallRecordItemRequestBuilder) Get(ctx context.Context, requestConfiguration *CommunicationsCallRecordsCallRecordItemRequestBuilderGetRequestConfiguration)(iabe42a55de44a0960e4cc683a105812061defb936fe89e1bc4ab83c390c3839f.CallRecordable, error) {
...
func (m *CommunicationsCallRecordsCallRecordItemRequestBuilder) Patch(ctx context.Context, body iabe42a55de44a0960e4cc683a105812061defb936fe89e1bc4ab83c390c3839f.CallRecordable, requestConfiguration *CommunicationsCallRecordsCallRecordItemRequestBuilderPatchRequestConfiguration)(iabe42a55de44a0960e4cc683a105812061defb936fe89e1bc4ab83c390c3839f.CallRecordable, error) {
...
func (m *CommunicationsCallRecordsCallRecordItemRequestBuilder) Sessions()(*CommunicationsCallRecordsItemSessionsRequestBuilder) {
    return NewCommunicationsCallRecordsItemSessionsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// SessionsById provides operations to manage the sessions property of the microsoft.graph.callRecords.callRecord entity.
func (m *CommunicationsCallRecordsCallRecordItemRequestBuilder) SessionsById(id string)(*CommunicationsCallRecordsItemSessionsSessionItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    ...
    return NewCommunicationsCallRecordsItemSessionsSessionItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
