...
type AudioRoutingGroupsRequestBuilderGetOptions struct {
    ...
    Q *AudioRoutingGroupsRequestBuilderGetQueryParameters;
...
type AudioRoutingGroupsRequestBuilderPostOptions struct {
    // 
    Body i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AudioRoutingGroupable;
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
...
func NewAudioRoutingGroupsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AudioRoutingGroupsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/communications/calls/{call_id}/audioRoutingGroups{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *AudioRoutingGroupsRequestBuilder) Get(options *AudioRoutingGroupsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AudioRoutingGroupCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateAudioRoutingGroupCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AudioRoutingGroupCollectionResponseable), nil
}
// Post create new navigation property to audioRoutingGroups for communications
func (m *AudioRoutingGroupsRequestBuilder) Post(options *AudioRoutingGroupsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AudioRoutingGroupable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateAudioRoutingGroupFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AudioRoutingGroupable), nil
}
