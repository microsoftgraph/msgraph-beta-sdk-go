...
// DeleteWithResponseHandler delete navigation property participants for communications
...
// PatchWithResponseHandler update the navigation property participants in communications
