...
func (m *CallRecordsItemParticipants_v2CountRequestBuilder) Get(ctx context.Context, requestConfiguration *CallRecordsItemParticipants_v2CountRequestBuilderGetRequestConfiguration)(*int64, error) {
