...
// CallsItemMicrosoftGraphRecordRecordPostRequestBody 
type CallsItemMicrosoftGraphRecordRecordPostRequestBody struct {
...
// NewCallsItemMicrosoftGraphRecordRecordPostRequestBody instantiates a new CallsItemMicrosoftGraphRecordRecordPostRequestBody and sets the default values.
func NewCallsItemMicrosoftGraphRecordRecordPostRequestBody()(*CallsItemMicrosoftGraphRecordRecordPostRequestBody) {
    m := &CallsItemMicrosoftGraphRecordRecordPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateCallsItemMicrosoftGraphRecordRecordPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateCallsItemMicrosoftGraphRecordRecordPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewCallsItemMicrosoftGraphRecordRecordPostRequestBody(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetBargeInAllowed gets the bargeInAllowed property value. The bargeInAllowed property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) GetBargeInAllowed()(*bool) {
    return m.bargeInAllowed
}
// GetClientContext gets the clientContext property value. The clientContext property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) GetClientContext()(*string) {
    return m.clientContext
}
// GetFieldDeserializers the deserialization information for the current model
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) GetInitialSilenceTimeoutInSeconds()(*int32) {
...
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) GetMaxRecordDurationInSeconds()(*int32) {
...
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) GetMaxSilenceTimeoutInSeconds()(*int32) {
    return m.maxSilenceTimeoutInSeconds
}
// GetPlayBeep gets the playBeep property value. The playBeep property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) GetPlayBeep()(*bool) {
    return m.playBeep
}
// GetPrompts gets the prompts property value. The prompts property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) GetPrompts()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Promptable) {
    return m.prompts
}
// GetStopTones gets the stopTones property value. The stopTones property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) GetStopTones()([]string) {
    return m.stopTones
}
// GetStreamWhileRecording gets the streamWhileRecording property value. The streamWhileRecording property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) GetStreamWhileRecording()(*bool) {
    return m.streamWhileRecording
}
// Serialize serializes information the current object
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetBargeInAllowed sets the bargeInAllowed property value. The bargeInAllowed property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) SetBargeInAllowed(value *bool)() {
    m.bargeInAllowed = value
}
// SetClientContext sets the clientContext property value. The clientContext property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) SetClientContext(value *string)() {
...
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) SetInitialSilenceTimeoutInSeconds(value *int32)() {
...
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) SetMaxRecordDurationInSeconds(value *int32)() {
...
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) SetMaxSilenceTimeoutInSeconds(value *int32)() {
    m.maxSilenceTimeoutInSeconds = value
}
// SetPlayBeep sets the playBeep property value. The playBeep property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) SetPlayBeep(value *bool)() {
    m.playBeep = value
}
// SetPrompts sets the prompts property value. The prompts property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) SetPrompts(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Promptable)() {
    m.prompts = value
}
// SetStopTones sets the stopTones property value. The stopTones property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) SetStopTones(value []string)() {
    m.stopTones = value
}
// SetStreamWhileRecording sets the streamWhileRecording property value. The streamWhileRecording property
func (m *CallsItemMicrosoftGraphRecordRecordPostRequestBody) SetStreamWhileRecording(value *bool)() {
