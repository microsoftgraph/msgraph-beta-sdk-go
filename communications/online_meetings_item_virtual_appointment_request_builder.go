...
// OnlineMeetingsItemVirtualAppointmentRequestBuilderGetQueryParameters get virtualAppointment from communications
...
func NewOnlineMeetingsItemVirtualAppointmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsItemVirtualAppointmentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/virtualAppointment{?%24select,%24expand}";
...
// CreateDeleteRequestInformation delete navigation property virtualAppointment for communications
func (m *OnlineMeetingsItemVirtualAppointmentRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *OnlineMeetingsItemVirtualAppointmentRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// CreateGetRequestInformation get virtualAppointment from communications
func (m *OnlineMeetingsItemVirtualAppointmentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *OnlineMeetingsItemVirtualAppointmentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
// Delete delete navigation property virtualAppointment for communications
...
// Get get virtualAppointment from communications
...
// Patch update the navigation property virtualAppointment in communications
