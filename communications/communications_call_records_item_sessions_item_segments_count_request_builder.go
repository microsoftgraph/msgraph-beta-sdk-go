...
func NewCommunicationsCallRecordsItemSessionsItemSegmentsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallRecordsItemSessionsItemSegmentsCountRequestBuilder) {
    m := &CommunicationsCallRecordsItemSessionsItemSegmentsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/communications/callRecords/{callRecord%2Did}/sessions/{session%2Did}/segments/$count";
...
func NewCommunicationsCallRecordsItemSessionsItemSegmentsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallRecordsItemSessionsItemSegmentsCountRequestBuilder) {
    ...
    return NewCommunicationsCallRecordsItemSessionsItemSegmentsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *CommunicationsCallRecordsItemSessionsItemSegmentsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CommunicationsCallRecordsItemSessionsItemSegmentsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsCallRecordsItemSessionsItemSegmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CommunicationsCallRecordsItemSessionsItemSegmentsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
