...
func NewCommunicationsCallRecordsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallRecordsCountRequestBuilder) {
    m := &CommunicationsCallRecordsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/communications/callRecords/$count";
...
func NewCommunicationsCallRecordsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallRecordsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewCommunicationsCallRecordsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *CommunicationsCallRecordsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CommunicationsCallRecordsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsCallRecordsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CommunicationsCallRecordsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
