...
func NewCommunicationsCallsItemContentSharingSessionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemContentSharingSessionsCountRequestBuilder) {
    m := &CommunicationsCallsItemContentSharingSessionsCountRequestBuilder{
    }
...
func NewCommunicationsCallsItemContentSharingSessionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemContentSharingSessionsCountRequestBuilder) {
    ...
    return NewCommunicationsCallsItemContentSharingSessionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *CommunicationsCallsItemContentSharingSessionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CommunicationsCallsItemContentSharingSessionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsCallsItemContentSharingSessionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CommunicationsCallsItemContentSharingSessionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
