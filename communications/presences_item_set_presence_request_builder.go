...
// Post set the availability and activity status in a presence session of an application for a user. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation set the availability and activity status in a presence session of an application for a user. This API is available in the following national cloud deployments.
