...
// SegmentsRequestBuilder builds and executes requests for operations under \communications\callRecords\{callRecord-id}\sessions\{session-id}\segments
...
// CreatePostRequestInformation the list of segments involved in the session. Read-only. Nullable.
...
func (m *SegmentsRequestBuilder) Get(options *SegmentsRequestBuilderGetOptions)(*SegmentsResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewSegmentsResponse() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*SegmentsResponse), nil
}
// Post the list of segments involved in the session. Read-only. Nullable.
func (m *SegmentsRequestBuilder) Post(options *SegmentsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.Segment, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewSegment() }, nil)
    if err != nil {
        return nil, err
    }
