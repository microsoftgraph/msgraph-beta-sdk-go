...
// NewOnlineMeetingsItemRegistrationRegistrantsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewOnlineMeetingsItemRegistrationRegistrantsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsItemRegistrationRegistrantsCountRequestBuilder) {
    m := &OnlineMeetingsItemRegistrationRegistrantsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration/registrants/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewOnlineMeetingsItemRegistrationRegistrantsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
