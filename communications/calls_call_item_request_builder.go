...
func (m *CallsCallItemRequestBuilder) MicrosoftGraphRecord()(*CallsItemMicrosoftGraphRecordRequestBuilder) {
    return NewCallsItemMicrosoftGraphRecordRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
