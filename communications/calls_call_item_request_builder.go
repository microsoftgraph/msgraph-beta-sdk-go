...
// MicrosoftGraphRecord provides operations to call the record method.
func (m *CallsCallItemRequestBuilder) MicrosoftGraphRecord()(*CallsItemMicrosoftGraphRecordRecordRequestBuilder) {
    return NewCallsItemMicrosoftGraphRecordRecordRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
