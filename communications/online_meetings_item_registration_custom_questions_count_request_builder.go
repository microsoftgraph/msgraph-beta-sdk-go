...
// NewOnlineMeetingsItemRegistrationCustomQuestionsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewOnlineMeetingsItemRegistrationCustomQuestionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsItemRegistrationCustomQuestionsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration/customQuestions/$count";
...
// NewOnlineMeetingsItemRegistrationCustomQuestionsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
...
func (m *OnlineMeetingsItemRegistrationCustomQuestionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *OnlineMeetingsItemRegistrationCustomQuestionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
