...
func NewCommunicationsCallsItemAudioRoutingGroupsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemAudioRoutingGroupsCountRequestBuilder) {
    m := &CommunicationsCallsItemAudioRoutingGroupsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/communications/calls/{call%2Did}/audioRoutingGroups/$count";
...
func NewCommunicationsCallsItemAudioRoutingGroupsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemAudioRoutingGroupsCountRequestBuilder) {
    ...
    return NewCommunicationsCallsItemAudioRoutingGroupsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *CommunicationsCallsItemAudioRoutingGroupsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CommunicationsCallsItemAudioRoutingGroupsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsCallsItemAudioRoutingGroupsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CommunicationsCallsItemAudioRoutingGroupsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
