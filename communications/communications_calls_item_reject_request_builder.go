...
func NewCommunicationsCallsItemRejectRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemRejectRequestBuilder) {
    m := &CommunicationsCallsItemRejectRequestBuilder{
    }
...
func NewCommunicationsCallsItemRejectRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsCallsItemRejectRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewCommunicationsCallsItemRejectRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *CommunicationsCallsItemRejectRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CommunicationsCallsItemRejectPostRequestBodyable, requestConfiguration *CommunicationsCallsItemRejectRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsCallsItemRejectRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CommunicationsCallsItemRejectPostRequestBodyable, requestConfiguration *CommunicationsCallsItemRejectRequestBuilderPostRequestConfiguration)(error) {
