...
func NewCommunicationsPresencesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsPresencesCountRequestBuilder) {
    m := &CommunicationsPresencesCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/communications/presences/$count";
...
func NewCommunicationsPresencesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunicationsPresencesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewCommunicationsPresencesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *CommunicationsPresencesCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *CommunicationsPresencesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunicationsPresencesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CommunicationsPresencesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
