...
func (m *CallsItemMicrosoftGraphRedirectRedirectPostRequestBody) GetMaskCallee()(*bool) {
    return m.maskCallee
}
// GetMaskCaller gets the maskCaller property value. The maskCaller property
func (m *CallsItemMicrosoftGraphRedirectRedirectPostRequestBody) GetMaskCaller()(*bool) {
    return m.maskCaller
}
// GetTargetDisposition gets the targetDisposition property value. The targetDisposition property
func (m *CallsItemMicrosoftGraphRedirectRedirectPostRequestBody) GetTargetDisposition()(*ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CallDisposition) {
    return m.targetDisposition
}
// GetTargets gets the targets property value. The targets property
func (m *CallsItemMicrosoftGraphRedirectRedirectPostRequestBody) GetTargets()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.InvitationParticipantInfoable) {
    return m.targets
}
...
func (m *CallsItemMicrosoftGraphRedirectRedirectPostRequestBody) SetMaskCallee(value *bool)() {
    m.maskCallee = value
}
// SetMaskCaller sets the maskCaller property value. The maskCaller property
func (m *CallsItemMicrosoftGraphRedirectRedirectPostRequestBody) SetMaskCaller(value *bool)() {
    m.maskCaller = value
}
// SetTargetDisposition sets the targetDisposition property value. The targetDisposition property
func (m *CallsItemMicrosoftGraphRedirectRedirectPostRequestBody) SetTargetDisposition(value *ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CallDisposition)() {
    m.targetDisposition = value
}
// SetTargets sets the targets property value. The targets property
func (m *CallsItemMicrosoftGraphRedirectRedirectPostRequestBody) SetTargets(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.InvitationParticipantInfoable)() {
    m.targets = value
}
