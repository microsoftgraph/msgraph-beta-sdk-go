...
// CreateGetRequestInformationWithRequestConfiguration get the meetingAttendanceReport for an onlineMeeting. Each time an online meeting ends, an attendance report will be generated for that session.
