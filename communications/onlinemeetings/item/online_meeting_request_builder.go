...
func (m *OnlineMeetingRequestBuilder) Transcripts()(*ibf215dcedc685523e33219b91fd02247c51376f20991fc707be93a6e0640d955.TranscriptsRequestBuilder) {
...
func (m *OnlineMeetingRequestBuilder) TranscriptsById(id string)(*i1df49adb94e4624ec86cfc9e723c409892b4e3c93067331f6ac6280b4cd1c473.CallTranscriptRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return i1df49adb94e4624ec86cfc9e723c409892b4e3c93067331f6ac6280b4cd1c473.NewCallTranscriptRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
