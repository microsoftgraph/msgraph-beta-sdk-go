...
import (
    ...
    icdbfad1fb101bd5c7ebd038fb4c47972f690a9226294c5318d08afc91c4272c5 "github.com/microsoftgraph/msgraph-beta-sdk-go/communications/onlinemeetings/item/attendancereports/count"
)
...
func (m *AttendanceReportsRequestBuilder) Count()(*icdbfad1fb101bd5c7ebd038fb4c47972f690a9226294c5318d08afc91c4272c5.CountRequestBuilder) {
    return icdbfad1fb101bd5c7ebd038fb4c47972f690a9226294c5318d08afc91c4272c5.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *AttendanceReportsRequestBuilder) Get(options *AttendanceReportsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MeetingAttendanceReportCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateMeetingAttendanceReportCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MeetingAttendanceReportCollectionResponseable), nil
}
// Post create new navigation property to attendanceReports for communications
func (m *AttendanceReportsRequestBuilder) Post(options *AttendanceReportsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.MeetingAttendanceReportable, error) {
