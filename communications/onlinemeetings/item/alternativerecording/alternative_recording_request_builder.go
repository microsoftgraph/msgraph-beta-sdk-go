...
// Builds and executes requests for operations under \communications\onlineMeetings\{onlineMeeting-id}\alternativeRecording
...
func NewAlternativeRecordingRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AlternativeRecordingRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/communications/onlineMeetings/{onlineMeeting_id}/alternativeRecording";
