...
// RefRequestBuilder builds and executes requests for operations under \commands\{command-id}\responsepayload\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/commands/{command_id}/responsepayload/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property responsepayload for commands
...
// CreateGetRequestInformation get ref of responsepayload from commands
...
// CreatePutRequestInformation update the ref of navigation property responsepayload in commands
...
// Delete delete ref of navigation property responsepayload for commands
...
// Get get ref of responsepayload from commands
...
// Put update the ref of navigation property responsepayload in commands
