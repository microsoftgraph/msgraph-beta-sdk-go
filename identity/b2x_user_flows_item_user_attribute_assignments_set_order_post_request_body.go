...
// B2xUserFlowsItemUserAttributeAssignmentsSetOrderPostRequestBody provides operations to call the setOrder method.
...
func (m *B2xUserFlowsItemUserAttributeAssignmentsSetOrderPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *B2xUserFlowsItemUserAttributeAssignmentsSetOrderPostRequestBody) SetAdditionalData(value map[string]interface{})() {
