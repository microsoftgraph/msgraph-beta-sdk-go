...
// B2cuserflowsItemUserflowidentityprovidersIdentityProviderBaseItemRequestBuilderGetQueryParameters the identity providers included in the user flow.
...
// NewB2cuserflowsItemUserflowidentityprovidersIdentityProviderBaseItemRequestBuilderInternal instantiates a new B2cuserflowsItemUserflowidentityprovidersIdentityProviderBaseItemRequestBuilder and sets the default values.
func NewB2cuserflowsItemUserflowidentityprovidersIdentityProviderBaseItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*B2cuserflowsItemUserflowidentityprovidersIdentityProviderBaseItemRequestBuilder) {
    m := &B2cuserflowsItemUserflowidentityprovidersIdentityProviderBaseItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userFlowIdentityProviders/{identityProviderBase%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewB2cuserflowsItemUserflowidentityprovidersIdentityProviderBaseItemRequestBuilder instantiates a new B2cuserflowsItemUserflowidentityprovidersIdentityProviderBaseItemRequestBuilder and sets the default values.
