...
// NewCustomAuthenticationExtensionsItemValidateAuthenticationConfigurationRequestBuilderInternal instantiates a new ValidateAuthenticationConfigurationRequestBuilder and sets the default values.
...
// NewCustomAuthenticationExtensionsItemValidateAuthenticationConfigurationRequestBuilder instantiates a new ValidateAuthenticationConfigurationRequestBuilder and sets the default values.
...
// CreatePostRequestInformation invoke action validateAuthenticationConfiguration
func (m *CustomAuthenticationExtensionsItemValidateAuthenticationConfigurationRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *CustomAuthenticationExtensionsItemValidateAuthenticationConfigurationRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CustomAuthenticationExtensionsItemValidateAuthenticationConfigurationRequestBuilder) Post(ctx context.Context, requestConfiguration *CustomAuthenticationExtensionsItemValidateAuthenticationConfigurationRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AuthenticationConfigurationValidationable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateAuthenticationConfigurationValidationFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
