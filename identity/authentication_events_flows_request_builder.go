...
// AuthenticationEventsFlowsRequestBuilderGetQueryParameters get a collection of authentication events policies that are derived from authenticationEventsFlow. Only the externalUsersSelfServiceSignupEventsFlow object type is returned.
...
// ByAuthenticationEventsFlowIdString provides operations to manage the authenticationEventsFlows property of the microsoft.graph.identityContainer entity.
func (m *AuthenticationEventsFlowsRequestBuilder) ByAuthenticationEventsFlowIdString(authenticationEventsFlowId string)(*AuthenticationEventsFlowsAuthenticationEventsFlowItemRequestBuilder) {
