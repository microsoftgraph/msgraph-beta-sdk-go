...
// AuthenticationContextClassReferencesResponse 
...
// NewAuthenticationContextClassReferencesResponse instantiates a new authenticationContextClassReferencesResponse and sets the default values.
