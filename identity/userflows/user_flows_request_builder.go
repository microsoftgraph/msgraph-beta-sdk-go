...
// CreateGetRequestInformationWithRequestConfiguration retrieve a list of userflows.
...
// CreatePostRequestInformationWithRequestConfiguration create a new userFlow object.
