...
func (m *B2xUserFlowsItemLanguagesItemDefaultPagesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *B2xUserFlowsItemLanguagesItemDefaultPagesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
