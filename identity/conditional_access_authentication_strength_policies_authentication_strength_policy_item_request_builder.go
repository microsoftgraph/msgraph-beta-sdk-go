...
func (m *ConditionalAccessAuthenticationStrengthPoliciesAuthenticationStrengthPolicyItemRequestBuilder) CombinationConfigurationsById(id string)(*ConditionalAccessAuthenticationStrengthPoliciesItemCombinationConfigurationsAuthenticationCombinationConfigurationItemRequestBuilder) {
    ...
    idPtr := &id
    return NewConditionalAccessAuthenticationStrengthPoliciesItemCombinationConfigurationsAuthenticationCombinationConfigurationItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewConditionalAccessAuthenticationStrengthPoliciesAuthenticationStrengthPolicyItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, authenticationStrengthPolicyId *string)(*ConditionalAccessAuthenticationStrengthPoliciesAuthenticationStrengthPolicyItemRequestBuilder) {
...
func NewConditionalAccessAuthenticationStrengthPoliciesAuthenticationStrengthPolicyItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConditionalAccessAuthenticationStrengthPoliciesAuthenticationStrengthPolicyItemRequestBuilder) {
    ...
    return NewConditionalAccessAuthenticationStrengthPoliciesAuthenticationStrengthPolicyItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ConditionalAccessAuthenticationStrengthPoliciesAuthenticationStrengthPolicyItemRequestBuilder) MicrosoftGraphUpdateAllowedCombinations()(*ConditionalAccessAuthenticationStrengthPoliciesItemMicrosoftGraphUpdateAllowedCombinationsUpdateAllowedCombinationsRequestBuilder) {
    return NewConditionalAccessAuthenticationStrengthPoliciesItemMicrosoftGraphUpdateAllowedCombinationsUpdateAllowedCombinationsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUsage provides operations to call the usage method.
func (m *ConditionalAccessAuthenticationStrengthPoliciesAuthenticationStrengthPolicyItemRequestBuilder) MicrosoftGraphUsage()(*ConditionalAccessAuthenticationStrengthPoliciesItemMicrosoftGraphUsageUsageRequestBuilder) {
    return NewConditionalAccessAuthenticationStrengthPoliciesItemMicrosoftGraphUsageUsageRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
