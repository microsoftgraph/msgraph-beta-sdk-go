...
func (m *IdentityProvidersRequestBuilder) MicrosoftGraphAvailableProviderTypes()(*IdentityProvidersMicrosoftGraphAvailableProviderTypesAvailableProviderTypesRequestBuilder) {
    return NewIdentityProvidersMicrosoftGraphAvailableProviderTypesAvailableProviderTypesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// ToPostRequestInformation create an identity provider resource that is of the type specified in the request body. Among the types of providers derived from identityProviderBase, you can currently create a socialIdentityProvider resource in Azure AD. In Azure AD B2C, this operation can currently create a socialIdentityProvider, openIdConnectIdentityProvider, or an appleManagedIdentityProvider resource.
