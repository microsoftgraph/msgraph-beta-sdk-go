...
func NewUserFlowsIdentityUserFlowItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, identityUserFlowId *string)(*UserFlowsIdentityUserFlowItemRequestBuilder) {
...
func NewUserFlowsIdentityUserFlowItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserFlowsIdentityUserFlowItemRequestBuilder) {
    ...
    return NewUserFlowsIdentityUserFlowItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *UserFlowsIdentityUserFlowItemRequestBuilder) Get(ctx context.Context, requestConfiguration *UserFlowsIdentityUserFlowItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.IdentityUserFlowable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateIdentityUserFlowFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// ToDeleteRequestInformation delete navigation property userFlows for identity
...
// ToGetRequestInformation get userFlows from identity
