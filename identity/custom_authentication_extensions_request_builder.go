...
// CustomAuthenticationExtensionsRequestBuilderGetQueryParameters get customAuthenticationExtensions from identity
...
func (m *CustomAuthenticationExtensionsRequestBuilder) Count()(*CustomAuthenticationExtensionsCountRequestBuilder) {
    return NewCustomAuthenticationExtensionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *CustomAuthenticationExtensionsRequestBuilder) Get(ctx context.Context, requestConfiguration *CustomAuthenticationExtensionsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CustomAuthenticationExtensionCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateCustomAuthenticationExtensionCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *CustomAuthenticationExtensionsRequestBuilder) MicrosoftGraphValidateAuthenticationConfiguration()(*CustomAuthenticationExtensionsMicrosoftGraphValidateAuthenticationConfigurationValidateAuthenticationConfigurationRequestBuilder) {
    return NewCustomAuthenticationExtensionsMicrosoftGraphValidateAuthenticationConfigurationValidateAuthenticationConfigurationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
