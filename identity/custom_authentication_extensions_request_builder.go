...
// ByCustomAuthenticationExtensionIdString provides operations to manage the customAuthenticationExtensions property of the microsoft.graph.identityContainer entity.
func (m *CustomAuthenticationExtensionsRequestBuilder) ByCustomAuthenticationExtensionIdString(customAuthenticationExtensionId string)(*CustomAuthenticationExtensionsCustomAuthenticationExtensionItemRequestBuilder) {
