...
func (m *CustomAuthenticationExtensionsRequestBuilder) MicrosoftGraphValidateAuthenticationConfiguration()(*CustomAuthenticationExtensionsMicrosoftGraphValidateAuthenticationConfigurationRequestBuilder) {
    return NewCustomAuthenticationExtensionsMicrosoftGraphValidateAuthenticationConfigurationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
