...
func (m *B2cuserflowsB2cIdentityUserFlowItemRequestBuilder) IdentityProviders()(*B2cuserflowsItemIdentityprovidersIdentityProvidersRequestBuilder) {
    return NewB2cuserflowsItemIdentityprovidersIdentityProvidersRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *B2cuserflowsB2cIdentityUserFlowItemRequestBuilder) UserAttributeAssignments()(*B2cuserflowsItemUserattributeassignmentsUserAttributeAssignmentsRequestBuilder) {
    return NewB2cuserflowsItemUserattributeassignmentsUserAttributeAssignmentsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *B2cuserflowsB2cIdentityUserFlowItemRequestBuilder) UserFlowIdentityProviders()(*B2cuserflowsItemUserflowidentityprovidersUserFlowIdentityProvidersRequestBuilder) {
    return NewB2cuserflowsItemUserflowidentityprovidersUserFlowIdentityProvidersRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
