...
func (m *ConditionalAccessAuthenticationStrengthsPoliciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConditionalAccessAuthenticationStrengthsPoliciesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
