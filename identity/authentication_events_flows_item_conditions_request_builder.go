...
// AuthenticationEventsFlowsItemConditionsRequestBuilderGetQueryParameters the conditions representing the context of the authentication request that will be used to decide whether the events policy will be invoked.
...
// NewAuthenticationEventsFlowsItemConditionsRequestBuilder instantiates a new ConditionsRequestBuilder and sets the default values.
