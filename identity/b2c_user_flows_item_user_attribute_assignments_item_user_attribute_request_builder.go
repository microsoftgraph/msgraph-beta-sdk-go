...
// NewB2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilderInternal instantiates a new B2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilder and sets the default values.
func NewB2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*B2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilder) {
    m := &B2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments/{identityUserFlowAttributeAssignment%2Did}/userAttribute{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewB2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilder instantiates a new B2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilder and sets the default values.
...
func (m *B2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *B2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *B2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilder) WithUrl(rawUrl string)(*B2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilder) {
    return NewB2cUserFlowsItemUserAttributeAssignmentsItemUserAttributeRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
