...
func (m *ConditionalAccessAuthenticationStrengthsAuthenticationMethodModesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConditionalAccessAuthenticationStrengthsAuthenticationMethodModesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
