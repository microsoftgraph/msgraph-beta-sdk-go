...
func (m *IdentityRequestBuilder) AuthenticationEventListenersById(id string)(*AuthenticationEventListenerItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewAuthenticationEventListenerItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *IdentityRequestBuilder) B2cUserFlowsById(id string)(*B2cIdentityUserFlowItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewB2cIdentityUserFlowItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *IdentityRequestBuilder) CustomAuthenticationExtensionsById(id string)(*CustomAuthenticationExtensionItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewCustomAuthenticationExtensionItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
// Get get identity
...
func (m *IdentityRequestBuilder) UserFlowsById(id string)(*IdentityUserFlowItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewIdentityUserFlowItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
