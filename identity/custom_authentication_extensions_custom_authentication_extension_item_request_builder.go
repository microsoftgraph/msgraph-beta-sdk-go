...
func (m *CustomAuthenticationExtensionsCustomAuthenticationExtensionItemRequestBuilder) Get(ctx context.Context, requestConfiguration *CustomAuthenticationExtensionsCustomAuthenticationExtensionItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CustomAuthenticationExtensionable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateCustomAuthenticationExtensionFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *CustomAuthenticationExtensionsCustomAuthenticationExtensionItemRequestBuilder) MicrosoftGraphValidateAuthenticationConfiguration()(*CustomAuthenticationExtensionsItemMicrosoftGraphValidateAuthenticationConfigurationRequestBuilder) {
    return NewCustomAuthenticationExtensionsItemMicrosoftGraphValidateAuthenticationConfigurationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// ToDeleteRequestInformation delete navigation property customAuthenticationExtensions for identity
...
// ToGetRequestInformation get customAuthenticationExtensions from identity
