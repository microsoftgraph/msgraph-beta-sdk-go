...
func (m *B2cUserFlowsItemLanguagesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *B2cUserFlowsItemLanguagesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
