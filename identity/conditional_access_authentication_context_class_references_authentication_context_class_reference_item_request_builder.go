...
// Patch update the properties of an authenticationContextClassReference object. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPatchRequestInformation update the properties of an authenticationContextClassReference object. This API is supported in the following national cloud deployments.
