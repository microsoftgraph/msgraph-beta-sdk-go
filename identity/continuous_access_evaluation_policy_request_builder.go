...
func (m *ContinuousAccessEvaluationPolicyRequestBuilder) Delete(ctx context.Context, requestConfiguration *ContinuousAccessEvaluationPolicyRequestBuilderDeleteRequestConfiguration)([]byte, error) {
