...
func NewConditionalAccessAuthenticationStrengthPoliciesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConditionalAccessAuthenticationStrengthPoliciesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identity/conditionalAccess/authenticationStrength/policies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *ConditionalAccessAuthenticationStrengthPoliciesRequestBuilder) Count()(*ConditionalAccessAuthenticationStrengthPoliciesCountRequestBuilder) {
    return NewConditionalAccessAuthenticationStrengthPoliciesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ConditionalAccessAuthenticationStrengthPoliciesRequestBuilder) MicrosoftGraphFindByMethodModeWithAuthenticationMethodModes(authenticationMethodModes *string)(*ConditionalAccessAuthenticationStrengthPoliciesMicrosoftGraphFindByMethodModeWithAuthenticationMethodModesFindByMethodModeWithAuthenticationMethodModesRequestBuilder) {
    return NewConditionalAccessAuthenticationStrengthPoliciesMicrosoftGraphFindByMethodModeWithAuthenticationMethodModesFindByMethodModeWithAuthenticationMethodModesRequestBuilderInternal(m.pathParameters, m.requestAdapter, authenticationMethodModes)
}
