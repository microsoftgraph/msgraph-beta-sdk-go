...
func (m *ConditionalAccessAuthenticationStrengthPoliciesRequestBuilder) MicrosoftGraphFindByMethodModeWithAuthenticationMethodModes(authenticationMethodModes *string)(*ConditionalAccessAuthenticationStrengthPoliciesMicrosoftGraphFindByMethodModeWithAuthenticationMethodModesRequestBuilder) {
    return NewConditionalAccessAuthenticationStrengthPoliciesMicrosoftGraphFindByMethodModeWithAuthenticationMethodModesRequestBuilderInternal(m.pathParameters, m.requestAdapter, authenticationMethodModes)
}
