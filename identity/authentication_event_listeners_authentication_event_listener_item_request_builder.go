...
// AuthenticationEventListenersAuthenticationEventListenerItemRequestBuilderGetQueryParameters get authenticationEventListeners from identity
...
func NewAuthenticationEventListenersAuthenticationEventListenerItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AuthenticationEventListenersAuthenticationEventListenerItemRequestBuilder) {
    m := &AuthenticationEventListenersAuthenticationEventListenerItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identity/authenticationEventListeners/{authenticationEventListener%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Delete deletes an authenticationEventListener object. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// Patch update the properties of an authenticationEventListener object. You must specify the @odata.type property and the value of the authenticationEventListener object type to update. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToDeleteRequestInformation deletes an authenticationEventListener object. This API is available in the following national cloud deployments.
...
// ToPatchRequestInformation update the properties of an authenticationEventListener object. You must specify the @odata.type property and the value of the authenticationEventListener object type to update. This API is available in the following national cloud deployments.
