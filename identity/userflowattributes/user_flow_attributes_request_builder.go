...
type UserFlowAttributesRequestBuilderGetOptions struct {
    ...
    Q *UserFlowAttributesRequestBuilderGetQueryParameters;
...
func NewUserFlowAttributesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*UserFlowAttributesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identity/userFlowAttributes{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *UserFlowAttributesRequestBuilder) Get(options *UserFlowAttributesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.IdentityUserFlowAttributeCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateIdentityUserFlowAttributeCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.IdentityUserFlowAttributeCollectionResponseable), nil
}
// Post create new navigation property to userFlowAttributes for identity
func (m *UserFlowAttributesRequestBuilder) Post(options *UserFlowAttributesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.IdentityUserFlowAttributeable, error) {
