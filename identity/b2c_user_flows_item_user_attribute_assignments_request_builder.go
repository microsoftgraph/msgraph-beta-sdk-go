...
func (m *B2cUserFlowsItemUserAttributeAssignmentsRequestBuilder) MicrosoftGraphGetOrder()(*B2cUserFlowsItemUserAttributeAssignmentsMicrosoftGraphGetOrderGetOrderRequestBuilder) {
    return NewB2cUserFlowsItemUserAttributeAssignmentsMicrosoftGraphGetOrderGetOrderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSetOrder provides operations to call the setOrder method.
func (m *B2cUserFlowsItemUserAttributeAssignmentsRequestBuilder) MicrosoftGraphSetOrder()(*B2cUserFlowsItemUserAttributeAssignmentsMicrosoftGraphSetOrderSetOrderRequestBuilder) {
    return NewB2cUserFlowsItemUserAttributeAssignmentsMicrosoftGraphSetOrderSetOrderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
