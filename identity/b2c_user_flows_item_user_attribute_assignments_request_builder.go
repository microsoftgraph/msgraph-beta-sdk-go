...
func (m *B2cUserFlowsItemUserAttributeAssignmentsRequestBuilder) MicrosoftGraphGetOrder()(*B2cUserFlowsItemUserAttributeAssignmentsMicrosoftGraphGetOrderRequestBuilder) {
    return NewB2cUserFlowsItemUserAttributeAssignmentsMicrosoftGraphGetOrderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSetOrder provides operations to call the setOrder method.
func (m *B2cUserFlowsItemUserAttributeAssignmentsRequestBuilder) MicrosoftGraphSetOrder()(*B2cUserFlowsItemUserAttributeAssignmentsMicrosoftGraphSetOrderRequestBuilder) {
    return NewB2cUserFlowsItemUserAttributeAssignmentsMicrosoftGraphSetOrderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
