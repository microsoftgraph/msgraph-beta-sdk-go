...
func (m *AuthenticationEventsFlowsGraphExternalUsersSelfServiceSignUpEventsFlowCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AuthenticationEventsFlowsGraphExternalUsersSelfServiceSignUpEventsFlowCountRequestBuilderGetRequestConfiguration)(*int64, error) {
