...
func (m *ConditionalAccessAuthenticationStrengthsPoliciesAuthenticationStrengthPolicyItemRequestBuilder) CombinationConfigurationsById(id string)(*ConditionalAccessAuthenticationStrengthsPoliciesItemCombinationConfigurationsAuthenticationCombinationConfigurationItemRequestBuilder) {
    ...
    idPtr := &id
    return NewConditionalAccessAuthenticationStrengthsPoliciesItemCombinationConfigurationsAuthenticationCombinationConfigurationItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewConditionalAccessAuthenticationStrengthsPoliciesAuthenticationStrengthPolicyItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, authenticationStrengthPolicyId *string)(*ConditionalAccessAuthenticationStrengthsPoliciesAuthenticationStrengthPolicyItemRequestBuilder) {
...
func NewConditionalAccessAuthenticationStrengthsPoliciesAuthenticationStrengthPolicyItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConditionalAccessAuthenticationStrengthsPoliciesAuthenticationStrengthPolicyItemRequestBuilder) {
    ...
    return NewConditionalAccessAuthenticationStrengthsPoliciesAuthenticationStrengthPolicyItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *ConditionalAccessAuthenticationStrengthsPoliciesAuthenticationStrengthPolicyItemRequestBuilder) MicrosoftGraphUpdateAllowedCombinations()(*ConditionalAccessAuthenticationStrengthsPoliciesItemMicrosoftGraphUpdateAllowedCombinationsUpdateAllowedCombinationsRequestBuilder) {
    return NewConditionalAccessAuthenticationStrengthsPoliciesItemMicrosoftGraphUpdateAllowedCombinationsUpdateAllowedCombinationsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUsage provides operations to call the usage method.
func (m *ConditionalAccessAuthenticationStrengthsPoliciesAuthenticationStrengthPolicyItemRequestBuilder) MicrosoftGraphUsage()(*ConditionalAccessAuthenticationStrengthsPoliciesItemMicrosoftGraphUsageUsageRequestBuilder) {
    return NewConditionalAccessAuthenticationStrengthsPoliciesItemMicrosoftGraphUsageUsageRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
