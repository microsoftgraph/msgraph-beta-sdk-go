...
// NewB2cUserFlowsItemUserAttributeAssignmentsCountRequestBuilderInternal instantiates a new B2cUserFlowsItemUserAttributeAssignmentsCountRequestBuilder and sets the default values.
...
// NewB2cUserFlowsItemUserAttributeAssignmentsCountRequestBuilder instantiates a new B2cUserFlowsItemUserAttributeAssignmentsCountRequestBuilder and sets the default values.
...
func (m *B2cUserFlowsItemUserAttributeAssignmentsCountRequestBuilder) WithUrl(rawUrl string)(*B2cUserFlowsItemUserAttributeAssignmentsCountRequestBuilder) {
    return NewB2cUserFlowsItemUserAttributeAssignmentsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
