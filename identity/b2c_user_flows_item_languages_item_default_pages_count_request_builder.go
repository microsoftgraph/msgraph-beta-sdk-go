...
func (m *B2cUserFlowsItemLanguagesItemDefaultPagesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *B2cUserFlowsItemLanguagesItemDefaultPagesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
