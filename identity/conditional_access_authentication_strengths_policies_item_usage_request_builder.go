...
// NewConditionalAccessAuthenticationStrengthsPoliciesItemUsageRequestBuilderInternal instantiates a new UsageRequestBuilder and sets the default values.
func NewConditionalAccessAuthenticationStrengthsPoliciesItemUsageRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConditionalAccessAuthenticationStrengthsPoliciesItemUsageRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identity/conditionalAccess/authenticationStrengths/policies/{authenticationStrengthPolicy%2Did}/usage()";
...
// NewConditionalAccessAuthenticationStrengthsPoliciesItemUsageRequestBuilder instantiates a new UsageRequestBuilder and sets the default values.
