...
// NewAuthenticationEventsFlowsGraphExternalUsersSelfServiceSignUpEventsFlowCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewAuthenticationEventsFlowsGraphExternalUsersSelfServiceSignUpEventsFlowCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AuthenticationEventsFlowsGraphExternalUsersSelfServiceSignUpEventsFlowCountRequestBuilder) {
    m := &AuthenticationEventsFlowsGraphExternalUsersSelfServiceSignUpEventsFlowCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identity/authenticationEventsFlows/graph.externalUsersSelfServiceSignUpEventsFlow/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewAuthenticationEventsFlowsGraphExternalUsersSelfServiceSignUpEventsFlowCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
