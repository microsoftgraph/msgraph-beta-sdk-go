...
func (m *ConditionalAccessAuthenticationStrengthPoliciesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ConditionalAccessAuthenticationStrengthPoliciesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
