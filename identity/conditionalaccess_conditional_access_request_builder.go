...
func (m *ConditionalaccessConditionalAccessRequestBuilder) AuthenticationStrengths()(*ConditionalaccessAuthenticationstrengthsAuthenticationStrengthsRequestBuilder) {
    return NewConditionalaccessAuthenticationstrengthsAuthenticationStrengthsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ConditionalaccessConditionalAccessRequestBuilder) Evaluate()(*ConditionalaccessEvaluateRequestBuilder) {
