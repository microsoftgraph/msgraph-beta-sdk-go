...
type B2xUserFlowsRequestBuilderGetOptions struct {
    ...
    Q *B2xUserFlowsRequestBuilderGetQueryParameters;
...
func NewB2xUserFlowsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*B2xUserFlowsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identity/b2xUserFlows{?top,skip,search,filter,count,orderby,select,expand}";
...
// CreatePostRequestInformation represents entry point for B2X and self-service sign-up identity userflows.
...
func (m *B2xUserFlowsRequestBuilder) Get(options *B2xUserFlowsRequestBuilderGetOptions)(*B2xUserFlowsResponse, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewB2xUserFlowsResponse() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*B2xUserFlowsResponse), nil
}
// Post represents entry point for B2X and self-service sign-up identity userflows.
func (m *B2xUserFlowsRequestBuilder) Post(options *B2xUserFlowsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.B2xIdentityUserFlow, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewB2xIdentityUserFlow() }, nil)
    if err != nil {
        return nil, err
    }
