...
func (m *PrivilegedRoleItemRequestBuilder) Assignments()(*ItemAssignmentsRequestBuilder) {
    return NewItemAssignmentsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *PrivilegedRoleItemRequestBuilder) AssignmentsById(id string)(*ItemAssignmentsPrivilegedRoleAssignmentItemRequestBuilder) {
    ...
    idPtr := &id
    return NewItemAssignmentsPrivilegedRoleAssignmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func NewPrivilegedRoleItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, privilegedRoleId *string)(*PrivilegedRoleItemRequestBuilder) {
...
func NewPrivilegedRoleItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedRoleItemRequestBuilder) {
    ...
    return NewPrivilegedRoleItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
...
func (m *PrivilegedRoleItemRequestBuilder) MicrosoftGraphSelfActivate()(*ItemMicrosoftGraphSelfActivateSelfActivateRequestBuilder) {
    return NewItemMicrosoftGraphSelfActivateSelfActivateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSelfDeactivate provides operations to call the selfDeactivate method.
func (m *PrivilegedRoleItemRequestBuilder) MicrosoftGraphSelfDeactivate()(*ItemMicrosoftGraphSelfDeactivateSelfDeactivateRequestBuilder) {
    return NewItemMicrosoftGraphSelfDeactivateSelfDeactivateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *PrivilegedRoleItemRequestBuilder) Settings()(*ItemSettingsRequestBuilder) {
