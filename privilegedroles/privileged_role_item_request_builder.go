...
func (m *PrivilegedRoleItemRequestBuilder) MicrosoftGraphSelfActivate()(*ItemMicrosoftGraphSelfActivateRequestBuilder) {
    return NewItemMicrosoftGraphSelfActivateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSelfDeactivate provides operations to call the selfDeactivate method.
func (m *PrivilegedRoleItemRequestBuilder) MicrosoftGraphSelfDeactivate()(*ItemMicrosoftGraphSelfDeactivateRequestBuilder) {
    return NewItemMicrosoftGraphSelfDeactivateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
