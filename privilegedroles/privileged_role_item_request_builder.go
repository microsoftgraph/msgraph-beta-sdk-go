...
func (m *PrivilegedRoleItemRequestBuilder) AssignmentsById(id string)(*PrivilegedRoleAssignmentItemRequestBuilder) {
...
func (m *PrivilegedRoleItemRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *PrivilegedRoleItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PrivilegedRoleItemRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *PrivilegedRoleItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *PrivilegedRoleItemRequestBuilder) SelfActivate()(*ItemSelfActivateRequestBuilder) {
    return NewItemSelfActivateRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *PrivilegedRoleItemRequestBuilder) SelfDeactivate()(*ItemSelfDeactivateRequestBuilder) {
    return NewItemSelfDeactivateRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
