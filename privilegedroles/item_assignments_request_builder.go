...
// ItemAssignmentsRequestBuilder provides operations to manage the assignments property of the microsoft.graph.privilegedRole entity.
type ItemAssignmentsRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemAssignmentsRequestBuilderGetQueryParameters get assignments from privilegedRoles
...
// returns a *ItemAssignmentsPrivilegedRoleAssignmentItemRequestBuilder when successful
func (m *ItemAssignmentsRequestBuilder) ByPrivilegedRoleAssignmentId(privilegedRoleAssignmentId string)(*ItemAssignmentsPrivilegedRoleAssignmentItemRequestBuilder) {
...
func NewItemAssignmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAssignmentsRequestBuilder) {
    m := &ItemAssignmentsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/privilegedRoles/{privilegedRole%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
...
// returns a *ItemAssignmentsCountRequestBuilder when successful
...
// Get get assignments from privilegedRoles
...
// ToGetRequestInformation get assignments from privilegedRoles
