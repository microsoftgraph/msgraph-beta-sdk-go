...
// RefRequestBuilder builds and executes requests for operations under \privilegedRoles\{privilegedRole-id}\assignments\$ref
...
// RefRequestBuilderGetQueryParameters the assignments for this role. Read-only. Nullable.
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/privilegedRoles/{privilegedRole_id}/assignments/$ref{?top,skip,search,filter,count,orderby}";
...
// CreatePostRequestInformation the assignments for this role. Read-only. Nullable.
...
// Post the assignments for this role. Read-only. Nullable.
