...
// SelfDeactivateRequestBuilderPostOptions options for Post
type SelfDeactivateRequestBuilderPostOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// SelfDeactivateResponse union type wrapper for classes privilegedRoleAssignment
...
// NewSelfDeactivateResponse instantiates a new selfDeactivateResponse and sets the default values.
...
func CreateSelfDeactivateResponseFromDiscriminatorValue(parseNode i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable, error) {
    return NewSelfDeactivateResponse(), nil
}
...
func (m *SelfDeactivateResponse) GetPrivilegedRoleAssignment()(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PrivilegedRoleAssignmentable) {
    if m == nil {
        return nil
    } else {
...
func (m *SelfDeactivateResponse) SetPrivilegedRoleAssignment(value i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PrivilegedRoleAssignmentable)() {
    if m != nil {
...
func NewSelfDeactivateRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SelfDeactivateRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/privilegedRoles/{privilegedRole_id}/microsoft.graph.selfDeactivate";
...
func (m *SelfDeactivateRequestBuilder) CreatePostRequestInformation(options *SelfDeactivateRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *SelfDeactivateRequestBuilder) Post(options *SelfDeactivateRequestBuilderPostOptions)(SelfDeactivateResponseable, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, CreateSelfDeactivateResponseFromDiscriminatorValue, nil, nil)
    if err != nil {
        return nil, err
    }
    return res.(SelfDeactivateResponseable), nil
}
