...
// SelfDeactivateRequestBuilder builds and executes requests for operations under \privilegedRoles\{privilegedRole-id}\microsoft.graph.selfDeactivate
...
func (m *SelfDeactivateRequestBuilder) Post(options *SelfDeactivateRequestBuilderPostOptions)(*SelfDeactivateResponse, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewSelfDeactivateResponse() }, nil, nil)
    if err != nil {
        return nil, err
    }
