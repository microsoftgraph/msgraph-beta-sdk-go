...
// NewTeamsAppsItemAppDefinitionsItemDashboardCardsRequestBuilderInternal instantiates a new DashboardCardsRequestBuilder and sets the default values.
func NewTeamsAppsItemAppDefinitionsItemDashboardCardsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamsAppsItemAppDefinitionsItemDashboardCardsRequestBuilder) {
    m := &TeamsAppsItemAppDefinitionsItemDashboardCardsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/appCatalogs/teamsApps/{teamsApp%2Did}/appDefinitions/{teamsAppDefinition%2Did}/dashboardCards{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewTeamsAppsItemAppDefinitionsItemDashboardCardsRequestBuilder instantiates a new DashboardCardsRequestBuilder and sets the default values.
