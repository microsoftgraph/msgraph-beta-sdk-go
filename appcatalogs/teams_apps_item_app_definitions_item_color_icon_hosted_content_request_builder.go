...
// TeamsAppsItemAppDefinitionsItemColorIconHostedContentRequestBuilderGetQueryParameters retrieve the hosted content in an app's icon. This API is available in the following national cloud deployments.
...
// Get retrieve the hosted content in an app's icon. This API is available in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve the hosted content in an app's icon. This API is available in the following national cloud deployments.
