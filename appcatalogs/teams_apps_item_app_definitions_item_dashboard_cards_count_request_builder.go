...
// NewTeamsAppsItemAppDefinitionsItemDashboardCardsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewTeamsAppsItemAppDefinitionsItemDashboardCardsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamsAppsItemAppDefinitionsItemDashboardCardsCountRequestBuilder) {
    m := &TeamsAppsItemAppDefinitionsItemDashboardCardsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/appCatalogs/teamsApps/{teamsApp%2Did}/appDefinitions/{teamsAppDefinition%2Did}/dashboardCards/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewTeamsAppsItemAppDefinitionsItemDashboardCardsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
