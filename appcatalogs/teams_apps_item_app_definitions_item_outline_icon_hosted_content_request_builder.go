...
func (m *TeamsAppsItemAppDefinitionsItemOutlineIconHostedContentRequestBuilder) Delete(ctx context.Context, requestConfiguration *TeamsAppsItemAppDefinitionsItemOutlineIconHostedContentRequestBuilderDeleteRequestConfiguration)([]byte, error) {
