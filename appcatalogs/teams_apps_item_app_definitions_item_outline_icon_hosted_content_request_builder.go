...
func NewTeamsAppsItemAppDefinitionsItemOutlineIconHostedContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamsAppsItemAppDefinitionsItemOutlineIconHostedContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/appCatalogs/teamsApps/{teamsApp%2Did}/appDefinitions/{teamsAppDefinition%2Did}/outlineIcon/hostedContent{?%24select,%24expand}";
...
func (m *TeamsAppsItemAppDefinitionsItemOutlineIconHostedContentRequestBuilder) Content()(*TeamsAppsItemAppDefinitionsItemOutlineIconHostedContentValueContentRequestBuilder) {
    return NewTeamsAppsItemAppDefinitionsItemOutlineIconHostedContentValueContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateDeleteRequestInformation delete navigation property hostedContent for appCatalogs
func (m *TeamsAppsItemAppDefinitionsItemOutlineIconHostedContentRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *TeamsAppsItemAppDefinitionsItemOutlineIconHostedContentRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *TeamsAppsItemAppDefinitionsItemOutlineIconHostedContentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *TeamsAppsItemAppDefinitionsItemOutlineIconHostedContentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
