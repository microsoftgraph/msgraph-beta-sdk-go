...
// TeamsAppsItemAppDefinitionsItemColorIconRequestBuilderGetQueryParameters retrieve a Teams app icon associated with a specific definition of an app. This API is available in the following national cloud deployments.
...
func NewTeamsAppsItemAppDefinitionsItemColorIconRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TeamsAppsItemAppDefinitionsItemColorIconRequestBuilder) {
    m := &TeamsAppsItemAppDefinitionsItemColorIconRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/appCatalogs/teamsApps/{teamsApp%2Did}/appDefinitions/{teamsAppDefinition%2Did}/colorIcon{?%24select,%24expand}", pathParameters),
    }
    return m
}
