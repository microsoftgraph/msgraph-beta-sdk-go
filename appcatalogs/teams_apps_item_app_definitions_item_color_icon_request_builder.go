...
// NewTeamsAppsItemAppDefinitionsItemColorIconRequestBuilderInternal instantiates a new ColorIconRequestBuilder and sets the default values.
...
// NewTeamsAppsItemAppDefinitionsItemColorIconRequestBuilder instantiates a new ColorIconRequestBuilder and sets the default values.
...
func (m *TeamsAppsItemAppDefinitionsItemColorIconRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *TeamsAppsItemAppDefinitionsItemColorIconRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *TeamsAppsItemAppDefinitionsItemColorIconRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *TeamsAppsItemAppDefinitionsItemColorIconRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *TeamsAppsItemAppDefinitionsItemColorIconRequestBuilder) HostedContent()(*TeamsAppsItemAppDefinitionsItemColorIconHostedContentRequestBuilder) {
    return NewTeamsAppsItemAppDefinitionsItemColorIconHostedContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
