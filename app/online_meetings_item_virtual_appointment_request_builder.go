...
func NewOnlineMeetingsItemVirtualAppointmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsItemVirtualAppointmentRequestBuilder) {
    m := &OnlineMeetingsItemVirtualAppointmentRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/virtualAppointment{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *OnlineMeetingsItemVirtualAppointmentRequestBuilder) Delete(ctx context.Context, requestConfiguration *OnlineMeetingsItemVirtualAppointmentRequestBuilderDeleteRequestConfiguration)([]byte, error) {
...
// ToDeleteRequestInformation delete navigation property virtualAppointment for app
...
// ToGetRequestInformation get virtualAppointment from app
...
// ToPatchRequestInformation update the navigation property virtualAppointment in app
