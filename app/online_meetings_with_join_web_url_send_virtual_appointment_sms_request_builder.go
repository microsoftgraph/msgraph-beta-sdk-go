...
// NewOnlineMeetingsWithJoinWebUrlSendVirtualAppointmentSmsRequestBuilderInternal instantiates a new SendVirtualAppointmentSmsRequestBuilder and sets the default values.
func NewOnlineMeetingsWithJoinWebUrlSendVirtualAppointmentSmsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsWithJoinWebUrlSendVirtualAppointmentSmsRequestBuilder) {
    m := &OnlineMeetingsWithJoinWebUrlSendVirtualAppointmentSmsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/app/onlineMeetings(joinWebUrl='{joinWebUrl}')/sendVirtualAppointmentSms", pathParameters),
    }
    return m
}
// NewOnlineMeetingsWithJoinWebUrlSendVirtualAppointmentSmsRequestBuilder instantiates a new SendVirtualAppointmentSmsRequestBuilder and sets the default values.
