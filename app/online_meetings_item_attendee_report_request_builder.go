...
// Delete delete attendeeReport for the navigation property onlineMeetings in app
...
// ToDeleteRequestInformation delete attendeeReport for the navigation property onlineMeetings in app
