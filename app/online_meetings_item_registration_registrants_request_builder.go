...
// OnlineMeetingsItemRegistrationRegistrantsRequestBuilder provides operations to manage the registrants property of the microsoft.graph.meetingRegistrationBase entity.
type OnlineMeetingsItemRegistrationRegistrantsRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// OnlineMeetingsItemRegistrationRegistrantsRequestBuilderGetQueryParameters registrants of the online meeting.
type OnlineMeetingsItemRegistrationRegistrantsRequestBuilderGetQueryParameters struct {
...
// OnlineMeetingsItemRegistrationRegistrantsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type OnlineMeetingsItemRegistrationRegistrantsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *OnlineMeetingsItemRegistrationRegistrantsRequestBuilderGetQueryParameters
}
// OnlineMeetingsItemRegistrationRegistrantsRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type OnlineMeetingsItemRegistrationRegistrantsRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func (m *OnlineMeetingsItemRegistrationRegistrantsRequestBuilder) ByMeetingRegistrantBaseId(meetingRegistrantBaseId string)(*OnlineMeetingsItemRegistrationRegistrantsMeetingRegistrantBaseItemRequestBuilder) {
    ...
    return NewOnlineMeetingsItemRegistrationRegistrantsMeetingRegistrantBaseItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
// NewOnlineMeetingsItemRegistrationRegistrantsRequestBuilderInternal instantiates a new OnlineMeetingsItemRegistrationRegistrantsRequestBuilder and sets the default values.
func NewOnlineMeetingsItemRegistrationRegistrantsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsItemRegistrationRegistrantsRequestBuilder) {
    m := &OnlineMeetingsItemRegistrationRegistrantsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/registration/registrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewOnlineMeetingsItemRegistrationRegistrantsRequestBuilder instantiates a new OnlineMeetingsItemRegistrationRegistrantsRequestBuilder and sets the default values.
...
func (m *OnlineMeetingsItemRegistrationRegistrantsRequestBuilder) Count()(*OnlineMeetingsItemRegistrationRegistrantsCountRequestBuilder) {
...
// Post create new navigation property to registrants for app
...
// ToPostRequestInformation create new navigation property to registrants for app
// returns a *RequestInformation when successful
func (m *OnlineMeetingsItemRegistrationRegistrantsRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MeetingRegistrantBaseable, requestConfiguration *OnlineMeetingsItemRegistrationRegistrantsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformationWithMethodAndUrlTemplateAndPathParameters(i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.POST, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/registration/registrants", m.BaseRequestBuilder.PathParameters)
    if requestConfiguration != nil {
        requestInfo.Headers.AddAll(requestConfiguration.Headers)
        requestInfo.AddRequestOptions(requestConfiguration.Options)
    }
