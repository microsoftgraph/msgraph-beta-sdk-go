...
// MeetingAttendanceReportRequestBuilder builds and executes requests for operations under \app\onlineMeetings\{onlineMeeting-id}\attendanceReports\{meetingAttendanceReport-id}
...
func (m *MeetingAttendanceReportRequestBuilder) AttendanceRecords()(*i97d7be61c11f1bde6d49a1c7026fa5b1eaa2106b9a0deb117d6975e155b4d8d9.AttendanceRecordsRequestBuilder) {
...
func (m *MeetingAttendanceReportRequestBuilder) AttendanceRecordsById(id string)(*i4c89d62b9f9f52b4e0096d5e196b5487e2e87b339a8001722fdb0742d55a9697.AttendanceRecordRequestBuilder) {
    ...
    return i4c89d62b9f9f52b4e0096d5e196b5487e2e87b339a8001722fdb0742d55a9697.NewAttendanceRecordRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func NewMeetingAttendanceReportRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MeetingAttendanceReportRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/app/onlineMeetings/{onlineMeeting_id}/attendanceReports/{meetingAttendanceReport_id}{?select,expand}";
    urlTplParams := make(map[string]string)
