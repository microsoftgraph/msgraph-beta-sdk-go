...
// DeleteWithResponseHandler delete navigation property attendanceReports for app
...
// PatchWithResponseHandler update the navigation property attendanceReports in app
