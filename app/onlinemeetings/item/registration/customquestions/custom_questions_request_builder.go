...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to customQuestions for app
...
// PostWithResponseHandler create new navigation property to customQuestions for app
