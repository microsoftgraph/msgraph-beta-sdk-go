...
// Builds and executes requests for operations under \app\onlineMeetings\{onlineMeeting-id}\registration\customQuestions
...
func NewCustomQuestionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CustomQuestionsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/app/onlineMeetings/{onlineMeeting_id}/registration/customQuestions{?top,skip,search,filter,count,orderby,select,expand}";
