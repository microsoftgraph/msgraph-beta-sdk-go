...
// DeleteWithResponseHandler delete navigation property onlineMeetings for app
...
// PatchWithResponseHandler update the navigation property onlineMeetings in app
