...
// CreateGetRequestInformationWithRequestConfiguration a field representing the content of the transcript. Read-only.
...
// CreatePutRequestInformationWithRequestConfiguration a field representing the content of the transcript. Read-only.
...
// GetWithRequestConfigurationAndResponseHandler a field representing the content of the transcript. Read-only.
...
// PutWithRequestConfigurationAndResponseHandler a field representing the content of the transcript. Read-only.
