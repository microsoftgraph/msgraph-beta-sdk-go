...
// ContentRequestBuilder builds and executes requests for operations under \app\onlineMeetings\{onlineMeeting-id}\transcripts\{callTranscript-id}\content
...
func NewContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ContentRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/app/onlineMeetings/{onlineMeeting_id}/transcripts/{callTranscript_id}/content";
...
// CreateGetRequestInformation get media content for the navigation property transcripts from app
...
// CreatePutRequestInformation update media content for the navigation property transcripts in app
...
// Get get media content for the navigation property transcripts from app
...
// Put update media content for the navigation property transcripts in app
