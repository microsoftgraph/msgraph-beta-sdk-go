...
// ContentRequestBuilder provides operations to manage the media for the commsApplication entity.
...
// CreateGetRequestInformation get content for the navigation property transcripts from app
...
// CreateGetRequestInformationWithRequestConfiguration get content for the navigation property transcripts from app
...
// CreatePutRequestInformation update content for the navigation property transcripts in app
...
// CreatePutRequestInformationWithRequestConfiguration update content for the navigation property transcripts in app
...
// Get get content for the navigation property transcripts from app
func (m *ContentRequestBuilder) Get()([]byte, error) {
    return m.GetWithRequestConfigurationAndResponseHandler(nil, nil);
}
// GetWithRequestConfigurationAndResponseHandler get content for the navigation property transcripts from app
...
// Put update content for the navigation property transcripts in app
func (m *ContentRequestBuilder) Put(body []byte)(error) {
    return m.PutWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PutWithRequestConfigurationAndResponseHandler update content for the navigation property transcripts in app
