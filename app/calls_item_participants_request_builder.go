...
func (m *CallsItemParticipantsRequestBuilder) Get(ctx context.Context, requestConfiguration *CallsItemParticipantsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ParticipantCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateParticipantCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphMuteAll provides operations to call the muteAll method.
func (m *CallsItemParticipantsRequestBuilder) MicrosoftGraphMuteAll()(*CallsItemParticipantsMicrosoftGraphMuteAllMuteAllRequestBuilder) {
    return NewCallsItemParticipantsMicrosoftGraphMuteAllMuteAllRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
