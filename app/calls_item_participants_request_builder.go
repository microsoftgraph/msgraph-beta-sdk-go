...
func (m *CallsItemParticipantsRequestBuilder) MicrosoftGraphMuteAll()(*CallsItemParticipantsMicrosoftGraphMuteAllRequestBuilder) {
    return NewCallsItemParticipantsMicrosoftGraphMuteAllRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
