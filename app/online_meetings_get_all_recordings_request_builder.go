...
// NewOnlineMeetingsGetAllRecordingsRequestBuilderInternal instantiates a new OnlineMeetingsGetAllRecordingsRequestBuilder and sets the default values.
func NewOnlineMeetingsGetAllRecordingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsGetAllRecordingsRequestBuilder) {
    m := &OnlineMeetingsGetAllRecordingsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/app/onlineMeetings/getAllRecordings(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewOnlineMeetingsGetAllRecordingsRequestBuilder instantiates a new OnlineMeetingsGetAllRecordingsRequestBuilder and sets the default values.
...
// returns a OnlineMeetingsGetAllRecordingsGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
