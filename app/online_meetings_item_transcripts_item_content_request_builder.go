...
// OnlineMeetingsItemTranscriptsItemContentRequestBuilder provides operations to manage the media for the commsApplication entity.
...
// NewOnlineMeetingsItemTranscriptsItemContentRequestBuilderInternal instantiates a new ContentRequestBuilder and sets the default values.
...
func (m *OnlineMeetingsItemTranscriptsItemContentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *OnlineMeetingsItemTranscriptsItemContentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
