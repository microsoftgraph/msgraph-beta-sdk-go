...
// NewOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder instantiates a new AttendanceRecordsRequestBuilder and sets the default values.
...
func (m *OnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder) Count()(*OnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsCountRequestBuilder) {
    return NewOnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of attendanceRecord objects and their properties.
func (m *OnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *OnlineMeetingsItemMeetingAttendanceReportAttendanceRecordsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
