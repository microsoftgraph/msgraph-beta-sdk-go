...
// NewCallsItemParticipantsMuteAllRequestBuilderInternal instantiates a new CallsItemParticipantsMuteAllRequestBuilder and sets the default values.
...
// NewCallsItemParticipantsMuteAllRequestBuilder instantiates a new CallsItemParticipantsMuteAllRequestBuilder and sets the default values.
...
func (m *CallsItemParticipantsMuteAllRequestBuilder) WithUrl(rawUrl string)(*CallsItemParticipantsMuteAllRequestBuilder) {
    return NewCallsItemParticipantsMuteAllRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
