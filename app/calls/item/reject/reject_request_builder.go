...
func (m *RejectRequestBuilder) CreatePostRequestInformation(body RejectRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RejectRequestBuilder) Post(body RejectRequestBodyable)(error) {
    return m.PostWithRequestConfigurationAndResponseHandler(body, nil, nil);
}
// PostWithRequestConfigurationAndResponseHandler invoke action reject
func (m *RejectRequestBuilder) PostWithRequestConfigurationAndResponseHandler(body RejectRequestBodyable, requestConfiguration *RejectRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
