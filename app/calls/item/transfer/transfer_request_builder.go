...
func NewTransferRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TransferRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/app/calls/{call_id}/microsoft.graph.transfer";
...
func (m *TransferRequestBuilder) CreatePostRequestInformation(options *TransferRequestBuilderPostOptions)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
