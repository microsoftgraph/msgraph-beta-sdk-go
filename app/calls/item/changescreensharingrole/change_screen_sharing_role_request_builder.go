...
// ChangeScreenSharingRoleRequestBuilder builds and executes requests for operations under \app\calls\{call-id}\microsoft.graph.changeScreenSharingRole
...
func NewChangeScreenSharingRoleRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ChangeScreenSharingRoleRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/app/calls/{call_id}/microsoft.graph.changeScreenSharingRole";
