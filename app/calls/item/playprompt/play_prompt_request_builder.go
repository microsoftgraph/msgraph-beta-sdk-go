...
// PlayPromptRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type PlayPromptRequestBuilderPostRequestConfiguration struct {
    // Request headers
...
func (m *PlayPromptRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body PlayPromptRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action playPrompt
func (m *PlayPromptRequestBuilder) PostWithResponseHandler(body PlayPromptRequestBodyable, requestConfiguration *PlayPromptRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PlayPromptOperationable, error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action playPrompt
func (m *PlayPromptRequestBuilder) PostWithResponseHandler(body PlayPromptRequestBodyable, requestConfiguration *PlayPromptRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PlayPromptOperationable, error) {
    requestInfo, err := m.CreatePostRequestInformationWithRequestConfiguration(body, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreatePlayPromptOperationFromDiscriminatorValue, responseHandler, nil)
    if err != nil {
        return nil, err
    }
