...
// Builds and executes requests for operations under \app\calls\{call-id}\participants\{participant-id}\microsoft.graph.mute
...
func NewMuteRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*MuteRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/app/calls/{call_id}/participants/{participant_id}/microsoft.graph.mute";
