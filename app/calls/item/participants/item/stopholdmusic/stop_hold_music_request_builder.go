...
type StopHoldMusicResponse struct {
    ...
    stopHoldMusicOperation i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.StopHoldMusicOperationable;
}
...
func (m *StopHoldMusicResponse) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["stopHoldMusicOperation"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateStopHoldMusicOperationFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetStopHoldMusicOperation(val.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.StopHoldMusicOperationable))
        }
        return nil
    }
    return res
...
func (m *StopHoldMusicResponse) GetStopHoldMusicOperation()(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.StopHoldMusicOperationable) {
    if m == nil {
        return nil
    } else {
...
func (m *StopHoldMusicResponse) SetStopHoldMusicOperation(value i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.StopHoldMusicOperationable)() {
    if m != nil {
...
func NewStopHoldMusicRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*StopHoldMusicRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/app/calls/{call_id}/participants/{participant_id}/microsoft.graph.stopHoldMusic";
