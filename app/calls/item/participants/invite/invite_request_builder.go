...
// Builds and executes requests for operations under \app\calls\{call-id}\participants\microsoft.graph.invite
...
func NewInviteRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*InviteRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/app/calls/{call_id}/participants/microsoft.graph.invite";
