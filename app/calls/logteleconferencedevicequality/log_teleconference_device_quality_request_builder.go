...
// LogTeleconferenceDeviceQualityRequestBuilder builds and executes requests for operations under \app\calls\microsoft.graph.logTeleconferenceDeviceQuality
