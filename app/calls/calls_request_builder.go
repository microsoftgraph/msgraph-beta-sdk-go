...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to calls for app
...
// PostWithRequestConfigurationAndResponseHandler create new navigation property to calls for app
