...
// CallsLogTeleconferenceDeviceQualityPostRequestBody provides operations to call the logTeleconferenceDeviceQuality method.
...
func (m *CallsLogTeleconferenceDeviceQualityPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *CallsLogTeleconferenceDeviceQualityPostRequestBody) SetAdditionalData(value map[string]interface{})() {
