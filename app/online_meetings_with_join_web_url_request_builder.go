...
// OnlineMeetingsWithJoinWebUrlRequestBuilder provides operations to manage the onlineMeetings property of the microsoft.graph.commsApplication entity.
...
// OnlineMeetingsWithJoinWebUrlRequestBuilderGetQueryParameters get onlineMeetings from app
