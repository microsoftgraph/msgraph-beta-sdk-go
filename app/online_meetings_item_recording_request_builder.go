...
// Delete delete recording for the navigation property onlineMeetings in app
...
// ToDeleteRequestInformation delete recording for the navigation property onlineMeetings in app
