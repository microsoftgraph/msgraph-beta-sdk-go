...
// OnlineMeetingsItemRecordingRequestBuilder provides operations to manage the media for the commsApplication entity.
...
// NewOnlineMeetingsItemRecordingRequestBuilderInternal instantiates a new RecordingRequestBuilder and sets the default values.
...
// NewOnlineMeetingsItemRecordingRequestBuilder instantiates a new RecordingRequestBuilder and sets the default values.
...
func (m *OnlineMeetingsItemRecordingRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *OnlineMeetingsItemRecordingRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OnlineMeetingsItemRecordingRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *OnlineMeetingsItemRecordingRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *OnlineMeetingsItemRecordingRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *OnlineMeetingsItemRecordingRequestBuilderPutRequestConfiguration)(error) {
