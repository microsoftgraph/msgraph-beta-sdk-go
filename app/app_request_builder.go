...
func (m *AppRequestBuilder) CallsById(id string)(*CallsCallItemRequestBuilder) {
    ...
    idPtr := &id
    return NewCallsCallItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *AppRequestBuilder) Get(ctx context.Context, requestConfiguration *AppRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CommsApplicationable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateCommsApplicationFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *AppRequestBuilder) OnlineMeetingsById(id string)(*OnlineMeetingsOnlineMeetingItemRequestBuilder) {
    ...
    idPtr := &id
    return NewOnlineMeetingsOnlineMeetingItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
// Patch update app
