...
func NewCallsItemRecordPostRequestBody()(*CallsItemRecordPostRequestBody) {
    ...
    bargeInAllowedValue := false
    m.SetBargeInAllowed(&bargeInAllowedValue)
    playBeepValue := false
    m.SetPlayBeep(&playBeepValue)
    streamWhileRecordingValue := false
    m.SetStreamWhileRecording(&streamWhileRecordingValue)
    return m
}
