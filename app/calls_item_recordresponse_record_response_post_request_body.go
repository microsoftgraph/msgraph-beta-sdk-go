...
type CallsItemRecordresponseRecordResponsePostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewCallsItemRecordresponseRecordResponsePostRequestBody instantiates a new CallsItemRecordresponseRecordResponsePostRequestBody and sets the default values.
func NewCallsItemRecordresponseRecordResponsePostRequestBody()(*CallsItemRecordresponseRecordResponsePostRequestBody) {
    m := &CallsItemRecordresponseRecordResponsePostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateCallsItemRecordresponseRecordResponsePostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateCallsItemRecordresponseRecordResponsePostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewCallsItemRecordresponseRecordResponsePostRequestBody(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetBargeInAllowed gets the bargeInAllowed property value. The bargeInAllowed property
// returns a *bool when successful
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetBargeInAllowed()(*bool) {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetClientContext()(*string) {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetInitialSilenceTimeoutInSeconds()(*int32) {
...
// returns a *int32 when successful
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetMaxRecordDurationInSeconds()(*int32) {
...
// returns a *int32 when successful
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetMaxSilenceTimeoutInSeconds()(*int32) {
...
// returns a *bool when successful
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetPlayBeep()(*bool) {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetPrompts()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Promptable) {
...
// returns a []string when successful
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetStopTones()([]string) {
...
// returns a *bool when successful
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) GetStreamWhileRecording()(*bool) {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetBargeInAllowed sets the bargeInAllowed property value. The bargeInAllowed property
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) SetBargeInAllowed(value *bool)() {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) SetClientContext(value *string)() {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) SetInitialSilenceTimeoutInSeconds(value *int32)() {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) SetMaxRecordDurationInSeconds(value *int32)() {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) SetMaxSilenceTimeoutInSeconds(value *int32)() {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) SetPlayBeep(value *bool)() {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) SetPrompts(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.Promptable)() {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) SetStopTones(value []string)() {
...
func (m *CallsItemRecordresponseRecordResponsePostRequestBody) SetStreamWhileRecording(value *bool)() {
    err := m.GetBackingStore().Set("streamWhileRecording", value)
    if err != nil {
        panic(err)
    }
}
type CallsItemRecordresponseRecordResponsePostRequestBodyable interface {
