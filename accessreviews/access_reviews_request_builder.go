...
// AccessReviewsRequestBuilderGetQueryParameters get entities from accessReviews
...
// AccessReviewsRequestBuilderPostOptions options for Post
type AccessReviewsRequestBuilderPostOptions struct {
    // 
...
func NewAccessReviewsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessReviewsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/accessReviews{?top,skip,search,filter,count,orderby,select,expand}";
...
// CreateGetRequestInformation get entities from accessReviews
...
// CreatePostRequestInformation add new entity to accessReviews
func (m *AccessReviewsRequestBuilder) CreatePostRequestInformation(options *AccessReviewsRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
// Get get entities from accessReviews
func (m *AccessReviewsRequestBuilder) Get(options *AccessReviewsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AccessReviewCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateAccessReviewCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AccessReviewCollectionResponseable), nil
}
// Post add new entity to accessReviews
func (m *AccessReviewsRequestBuilder) Post(options *AccessReviewsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AccessReviewable, error) {
