...
func (m *ItemInstancesItemDecisionsAccessReviewDecisionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemInstancesItemDecisionsAccessReviewDecisionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
