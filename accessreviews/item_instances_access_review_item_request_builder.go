...
func (m *ItemInstancesAccessReviewItemRequestBuilder) MicrosoftGraphApplyDecisions()(*ItemInstancesItemMicrosoftGraphApplyDecisionsRequestBuilder) {
    return NewItemInstancesItemMicrosoftGraphApplyDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphResetDecisions provides operations to call the resetDecisions method.
func (m *ItemInstancesAccessReviewItemRequestBuilder) MicrosoftGraphResetDecisions()(*ItemInstancesItemMicrosoftGraphResetDecisionsRequestBuilder) {
    return NewItemInstancesItemMicrosoftGraphResetDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSendReminder provides operations to call the sendReminder method.
func (m *ItemInstancesAccessReviewItemRequestBuilder) MicrosoftGraphSendReminder()(*ItemInstancesItemMicrosoftGraphSendReminderRequestBuilder) {
    return NewItemInstancesItemMicrosoftGraphSendReminderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphStop provides operations to call the stop method.
func (m *ItemInstancesAccessReviewItemRequestBuilder) MicrosoftGraphStop()(*ItemInstancesItemMicrosoftGraphStopRequestBuilder) {
    return NewItemInstancesItemMicrosoftGraphStopRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
