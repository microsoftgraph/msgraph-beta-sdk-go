...
func NewItemInstancesItemMyDecisionsAccessReviewDecisionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInstancesItemMyDecisionsAccessReviewDecisionItemRequestBuilder) {
    m := &ItemInstancesItemMyDecisionsAccessReviewDecisionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}/myDecisions/{accessReviewDecision%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *ItemInstancesItemMyDecisionsAccessReviewDecisionItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemInstancesItemMyDecisionsAccessReviewDecisionItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
