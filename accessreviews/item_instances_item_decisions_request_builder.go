...
// NewItemInstancesItemDecisionsRequestBuilderInternal instantiates a new ItemInstancesItemDecisionsRequestBuilder and sets the default values.
func NewItemInstancesItemDecisionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInstancesItemDecisionsRequestBuilder) {
    m := &ItemInstancesItemDecisionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}/decisions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemInstancesItemDecisionsRequestBuilder instantiates a new ItemInstancesItemDecisionsRequestBuilder and sets the default values.
...
func (m *ItemInstancesItemDecisionsRequestBuilder) WithUrl(rawUrl string)(*ItemInstancesItemDecisionsRequestBuilder) {
    return NewItemInstancesItemDecisionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
