...
func (m *AccessReviewItemRequestBuilder) MicrosoftGraphApplyDecisions()(*ItemMicrosoftGraphApplyDecisionsRequestBuilder) {
    return NewItemMicrosoftGraphApplyDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphResetDecisions provides operations to call the resetDecisions method.
func (m *AccessReviewItemRequestBuilder) MicrosoftGraphResetDecisions()(*ItemMicrosoftGraphResetDecisionsRequestBuilder) {
    return NewItemMicrosoftGraphResetDecisionsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSendReminder provides operations to call the sendReminder method.
func (m *AccessReviewItemRequestBuilder) MicrosoftGraphSendReminder()(*ItemMicrosoftGraphSendReminderRequestBuilder) {
    return NewItemMicrosoftGraphSendReminderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphStop provides operations to call the stop method.
func (m *AccessReviewItemRequestBuilder) MicrosoftGraphStop()(*ItemMicrosoftGraphStopRequestBuilder) {
    return NewItemMicrosoftGraphStopRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
