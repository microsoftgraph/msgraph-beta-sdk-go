...
func NewDecisionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DecisionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/accessReviews/{accessReview_id}/decisions{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *DecisionsRequestBuilder) Get(options *DecisionsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AccessReviewDecisionCollectionResponseable, error) {
...
func (m *DecisionsRequestBuilder) Post(options *DecisionsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.AccessReviewDecisionable, error) {
