...
// Builds and executes requests for operations under \accessReviews\{accessReview-id}\instances\{accessReview-id1}
...
func NewAccessReviewRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AccessReviewRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/accessReviews/{accessReview_id}/instances/{accessReview_id1}{?select,expand}";
