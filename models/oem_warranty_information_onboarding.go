...
func (m *OemWarrantyInformationOnboarding) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *OemWarrantyInformationOnboarding) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
