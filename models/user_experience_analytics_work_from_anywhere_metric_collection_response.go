...
func (m *UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
