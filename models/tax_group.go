...
// TaxGroup provides operations to manage the collection of accessReview entities.
...
func (m *TaxGroup) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TaxGroup) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
