...
// TeamInfo provides operations to manage the collection of accessReview entities.
...
func (m *TeamInfo) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TeamInfo) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
