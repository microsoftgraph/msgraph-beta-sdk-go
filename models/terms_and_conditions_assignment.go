...
func (m *TermsAndConditionsAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TermsAndConditionsAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
