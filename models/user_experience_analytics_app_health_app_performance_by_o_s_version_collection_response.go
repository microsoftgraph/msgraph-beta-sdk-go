...
func (m *UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionCollectionResponse) SetOdataNextLink(value *string)() {
