...
func (m *MicrosoftAccountUserConversationMember) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MicrosoftAccountUserConversationMember) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
