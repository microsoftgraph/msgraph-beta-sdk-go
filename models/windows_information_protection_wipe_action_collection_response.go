...
func (m *WindowsInformationProtectionWipeActionCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *WindowsInformationProtectionWipeActionCollectionResponse) SetOdataNextLink(value *string)() {
