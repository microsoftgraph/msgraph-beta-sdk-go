...
// returns a *float64 when successful
func (m *Photo) GetOrientation()(*float64) {
...
func (m *Photo) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err := writer.WriteFloat64Value("orientation", m.GetOrientation())
        if err != nil {
            return err
        }
    }
...
func (m *Photo) SetOrientation(value *float64)() {
