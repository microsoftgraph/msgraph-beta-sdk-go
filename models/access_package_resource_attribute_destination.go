...
func NewAccessPackageResourceAttributeDestination()(*AccessPackageResourceAttributeDestination) {
    ...
    odatatypeValue := "#microsoft.graph.accessPackageResourceAttributeDestination";
...
func (m *AccessPackageResourceAttributeDestination) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessPackageResourceAttributeDestination) SetType(value *string)() {
    if m != nil {
