...
func (m *AndroidDeviceOwnerKioskModeApp) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceOwnerKioskModeApp) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
