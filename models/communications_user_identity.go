...
func (m *CommunicationsUserIdentity) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CommunicationsUserIdentity) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
