...
func (m *CommunicationsPhoneIdentity) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CommunicationsPhoneIdentity) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
