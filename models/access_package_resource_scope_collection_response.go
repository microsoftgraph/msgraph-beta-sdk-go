...
func (m *AccessPackageResourceScopeCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessPackageResourceScopeCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
