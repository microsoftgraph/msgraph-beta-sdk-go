...
func (m *AndroidManagedStoreAppConfigurationSchema) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidManagedStoreAppConfigurationSchema) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
