...
func (m *DeviceManagementConfigurationGroupSettingInstanceTemplate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationGroupSettingInstanceTemplate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
