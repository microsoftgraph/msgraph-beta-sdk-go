...
func NewMediaConfig()(*MediaConfig) {
    ...
    odatatypeValue := "#microsoft.graph.mediaConfig";
...
func (m *MediaConfig) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["removeFromDefaultAudioGroup"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
func (m *MediaConfig) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *MediaConfig) SetType(value *string)() {
    if m != nil {
