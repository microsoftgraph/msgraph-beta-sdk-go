...
func (m *DeviceAndAppManagementAssignedRoleDetails) GetAdditionalData()(map[string]any) {
...
func (m *DeviceAndAppManagementAssignedRoleDetails) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *DeviceAndAppManagementAssignedRoleDetails) GetRoleAssignmentIds()([]string) {
    val, err := m.GetBackingStore().Get("roleAssignmentIds")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *DeviceAndAppManagementAssignedRoleDetails) GetRoleDefinitionIds()([]string) {
    val, err := m.GetBackingStore().Get("roleDefinitionIds")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *DeviceAndAppManagementAssignedRoleDetails) SetAdditionalData(value map[string]any)() {
...
func (m *DeviceAndAppManagementAssignedRoleDetails) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *DeviceAndAppManagementAssignedRoleDetails) SetRoleAssignmentIds(value []string)() {
    err := m.GetBackingStore().Set("roleAssignmentIds", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *DeviceAndAppManagementAssignedRoleDetails) SetRoleDefinitionIds(value []string)() {
    err := m.GetBackingStore().Set("roleDefinitionIds", value)
    if err != nil {
        panic(err)
    }
}
