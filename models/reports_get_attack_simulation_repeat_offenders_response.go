...
func (m *ReportsGetAttackSimulationRepeatOffendersResponse) GetValue()([]AttackSimulationRepeatOffenderable) {
    return m.value
}
...
func (m *ReportsGetAttackSimulationRepeatOffendersResponse) SetValue(value []AttackSimulationRepeatOffenderable)() {
    m.value = value
}
