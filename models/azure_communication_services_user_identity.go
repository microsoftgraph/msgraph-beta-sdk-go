...
func (m *AzureCommunicationServicesUserIdentity) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AzureCommunicationServicesUserIdentity) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
