...
func NewCustomExtensionEndpointConfiguration()(*CustomExtensionEndpointConfiguration) {
    ...
    typeValue := "#microsoft.graph.customExtensionEndpointConfiguration";
    m.SetType(&typeValue);
    return m
}
...
func (m *CustomExtensionEndpointConfiguration) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *CustomExtensionEndpointConfiguration) SetType(value *string)() {
    if m != nil {
