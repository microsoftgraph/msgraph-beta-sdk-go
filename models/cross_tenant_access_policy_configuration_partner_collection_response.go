...
func (m *CrossTenantAccessPolicyConfigurationPartnerCollectionResponse) GetOdatanextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *CrossTenantAccessPolicyConfigurationPartnerCollectionResponse) SetOdatanextLink(value *string)() {
    if m != nil {
        m.nextLink = value
    }
}
