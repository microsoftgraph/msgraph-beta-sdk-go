...
func (m *UserExperienceAnalyticsModelScoresCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *UserExperienceAnalyticsModelScoresCollectionResponse) SetOdataNextLink(value *string)() {
