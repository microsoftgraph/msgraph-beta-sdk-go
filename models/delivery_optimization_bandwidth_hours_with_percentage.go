...
func (m *DeliveryOptimizationBandwidthHoursWithPercentage) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeliveryOptimizationBandwidthHoursWithPercentage) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
