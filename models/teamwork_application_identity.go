...
func (m *TeamworkApplicationIdentity) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TeamworkApplicationIdentity) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
