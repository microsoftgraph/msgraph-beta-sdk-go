...
func (m *UserExperienceAnalyticsResourcePerformanceCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *UserExperienceAnalyticsResourcePerformanceCollectionResponse) SetOdataNextLink(value *string)() {
