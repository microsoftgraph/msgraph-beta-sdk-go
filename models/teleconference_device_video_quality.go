...
func (m *TeleconferenceDeviceVideoQuality) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TeleconferenceDeviceVideoQuality) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
