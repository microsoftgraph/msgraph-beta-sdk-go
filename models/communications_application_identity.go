...
func (m *CommunicationsApplicationIdentity) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CommunicationsApplicationIdentity) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
