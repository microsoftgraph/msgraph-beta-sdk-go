...
func (m *MicrosoftTunnelHealthThreshold) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MicrosoftTunnelHealthThreshold) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
