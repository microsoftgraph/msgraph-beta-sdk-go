...
// DirectoryDefinition casts the previous resource to application.
...
func (m *DirectoryDefinition) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DirectoryDefinition) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
