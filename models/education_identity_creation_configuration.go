...
func (m *EducationIdentityCreationConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EducationIdentityCreationConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
