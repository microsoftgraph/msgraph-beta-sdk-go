...
// KeyRealValuePair_KeyRealValuePair_value composed type wrapper for classes float64, ReferenceNumeric, string
type KeyRealValuePair_KeyRealValuePair_value struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewKeyRealValuePair_KeyRealValuePair_value instantiates a new KeyRealValuePair_KeyRealValuePair_value and sets the default values.
func NewKeyRealValuePair_KeyRealValuePair_value()(*KeyRealValuePair_KeyRealValuePair_value) {
    m := &KeyRealValuePair_KeyRealValuePair_value{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    return m
}
// CreateKeyRealValuePair_KeyRealValuePair_valueFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateKeyRealValuePair_KeyRealValuePair_valueFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    result := NewKeyRealValuePair_KeyRealValuePair_value()
    if parseNode != nil {
...
func (m *KeyRealValuePair_KeyRealValuePair_value) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetDouble gets the double property value. Composed type representation for type float64
// returns a *float64 when successful
func (m *KeyRealValuePair_KeyRealValuePair_value) GetDouble()(*float64) {
...
func (m *KeyRealValuePair_KeyRealValuePair_value) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    return make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
}
// GetIsComposedType determines if the current object is a wrapper around a composed type
// returns a bool when successful
func (m *KeyRealValuePair_KeyRealValuePair_value) GetIsComposedType()(bool) {
    return true
}
...
func (m *KeyRealValuePair_KeyRealValuePair_value) GetReferenceNumeric()(*ReferenceNumeric) {
...
func (m *KeyRealValuePair_KeyRealValuePair_value) GetString()(*string) {
...
func (m *KeyRealValuePair_KeyRealValuePair_value) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *KeyRealValuePair_KeyRealValuePair_value) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetDouble sets the double property value. Composed type representation for type float64
func (m *KeyRealValuePair_KeyRealValuePair_value) SetDouble(value *float64)() {
...
func (m *KeyRealValuePair_KeyRealValuePair_value) SetReferenceNumeric(value *ReferenceNumeric)() {
...
func (m *KeyRealValuePair_KeyRealValuePair_value) SetString(value *string)() {
    err := m.GetBackingStore().Set("string", value)
    if err != nil {
        panic(err)
    }
}
type KeyRealValuePair_KeyRealValuePair_valueable interface {
...
func (m *KeyRealValuePair) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["value"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetValue(val.(*KeyRealValuePair_KeyRealValuePair_value))
        }
        return nil
    }
    return res
...
// returns a KeyRealValuePair_KeyRealValuePair_valueable when successful
func (m *KeyRealValuePair) GetValue()(KeyRealValuePair_KeyRealValuePair_valueable) {
    val, err := m.GetBackingStore().Get("value")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(KeyRealValuePair_KeyRealValuePair_valueable)
    }
    return nil
}
// Serialize serializes information the current object
...
func (m *KeyRealValuePair) SetValue(value KeyRealValuePair_KeyRealValuePair_valueable)() {
