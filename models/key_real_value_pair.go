...
// KeyRealValuePair a key-value pair with a string key and a typed value.
...
func (m *KeyRealValuePair) GetOdataType()(*string) {
...
func (m *KeyRealValuePair) SetOdataType(value *string)() {
