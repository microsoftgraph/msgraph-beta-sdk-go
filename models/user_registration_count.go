...
func (m *UserRegistrationCount) GetAdditionalData()(map[string]any) {
...
func (m *UserRegistrationCount) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *UserRegistrationCount) GetRegistrationCount()(*int64) {
    val, err := m.GetBackingStore().Get("registrationCount")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
// returns a *RegistrationStatusType when successful
func (m *UserRegistrationCount) GetRegistrationStatus()(*RegistrationStatusType) {
    val, err := m.GetBackingStore().Get("registrationStatus")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*RegistrationStatusType)
    }
    return nil
}
...
func (m *UserRegistrationCount) SetAdditionalData(value map[string]any)() {
...
func (m *UserRegistrationCount) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *UserRegistrationCount) SetRegistrationCount(value *int64)() {
    err := m.GetBackingStore().Set("registrationCount", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *UserRegistrationCount) SetRegistrationStatus(value *RegistrationStatusType)() {
    err := m.GetBackingStore().Set("registrationStatus", value)
    if err != nil {
        panic(err)
    }
}
