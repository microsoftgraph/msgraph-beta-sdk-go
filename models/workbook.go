...
// Workbook provides operations to manage the collection of accessReview entities.
...
func (m *Workbook) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Workbook) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
