...
func (m *DeviceManagementIntentSettingSecretConstraint) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementIntentSettingSecretConstraint) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
