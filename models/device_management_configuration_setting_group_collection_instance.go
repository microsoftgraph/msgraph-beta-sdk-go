...
func (m *DeviceManagementConfigurationSettingGroupCollectionInstance) GetOdataType()(*string) {
...
func (m *DeviceManagementConfigurationSettingGroupCollectionInstance) SetOdataType(value *string)() {
