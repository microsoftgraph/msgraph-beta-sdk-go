...
// DeviceComplianceDeviceStatus provides operations to manage the collection of accessReview entities.
...
func (m *DeviceComplianceDeviceStatus) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceComplianceDeviceStatus) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
