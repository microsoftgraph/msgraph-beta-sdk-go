...
func (m *ParticipantInfo) GetNonAnonymizedIdentity()(IdentitySetable) {
    val, err := m.GetBackingStore().Get("nonAnonymizedIdentity")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ParticipantInfo) GetPlatformId()(*string) {
    val, err := m.GetBackingStore().Get("platformId")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ParticipantInfo) SetNonAnonymizedIdentity(value IdentitySetable)() {
    err := m.GetBackingStore().Set("nonAnonymizedIdentity", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *ParticipantInfo) SetPlatformId(value *string)() {
    err := m.GetBackingStore().Set("platformId", value)
    if err != nil {
        panic(err)
    }
}
