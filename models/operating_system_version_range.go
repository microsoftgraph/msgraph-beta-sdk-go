...
func (m *OperatingSystemVersionRange) GetAdditionalData()(map[string]any) {
...
func (m *OperatingSystemVersionRange) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *OperatingSystemVersionRange) GetHighestVersion()(*string) {
    val, err := m.GetBackingStore().Get("highestVersion")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *OperatingSystemVersionRange) GetLowestVersion()(*string) {
    val, err := m.GetBackingStore().Get("lowestVersion")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *OperatingSystemVersionRange) SetAdditionalData(value map[string]any)() {
...
func (m *OperatingSystemVersionRange) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *OperatingSystemVersionRange) SetHighestVersion(value *string)() {
    err := m.GetBackingStore().Set("highestVersion", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *OperatingSystemVersionRange) SetLowestVersion(value *string)() {
    err := m.GetBackingStore().Set("lowestVersion", value)
    if err != nil {
        panic(err)
    }
}
...
// OperatingSystemVersionRangeable 
type OperatingSystemVersionRangeable interface {
