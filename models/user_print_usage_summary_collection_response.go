...
func (m *UserPrintUsageSummaryCollectionResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["value"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateUserPrintUsageSummaryFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]UserPrintUsageSummaryable, len(val))
            for i, v := range val {
                res[i] = v.(UserPrintUsageSummaryable)
            }
            m.SetValue(res)
        }
        return nil
...
func (m *UserPrintUsageSummaryCollectionResponse) GetValue()([]UserPrintUsageSummaryable) {
    ...
    if val != nil {
        return val.([]UserPrintUsageSummaryable)
    }
    return nil
}
...
// UserPrintUsageSummaryCollectionResponseable 
type UserPrintUsageSummaryCollectionResponseable interface {
    BaseCollectionPaginationCountResponseable
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetValue()([]UserPrintUsageSummaryable)
    SetValue(value []UserPrintUsageSummaryable)()
}
