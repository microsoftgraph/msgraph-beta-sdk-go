...
func (m *WindowsFeatureUpdateProfileCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *WindowsFeatureUpdateProfileCollectionResponse) SetOdataNextLink(value *string)() {
