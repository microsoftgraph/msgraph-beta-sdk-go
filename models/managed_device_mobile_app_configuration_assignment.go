...
func (m *ManagedDeviceMobileAppConfigurationAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ManagedDeviceMobileAppConfigurationAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
