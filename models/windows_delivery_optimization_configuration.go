...
func (m *WindowsDeliveryOptimizationConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsDeliveryOptimizationConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
