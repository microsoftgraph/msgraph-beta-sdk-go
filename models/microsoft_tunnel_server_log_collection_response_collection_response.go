...
func (m *MicrosoftTunnelServerLogCollectionResponseCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *MicrosoftTunnelServerLogCollectionResponseCollectionResponse) SetOdataNextLink(value *string)() {
