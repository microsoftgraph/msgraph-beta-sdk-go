...
func (m *GroupPolicyConfigurationAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *GroupPolicyConfigurationAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
