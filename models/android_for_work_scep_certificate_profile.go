...
func (m *AndroidForWorkScepCertificateProfile) GetCertificateStore()(*AndroidForWorkScepCertificateProfile_certificateStore) {
    val, err := m.GetBackingStore().Get("certificateStore")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*AndroidForWorkScepCertificateProfile_certificateStore)
    }
    return nil
}
...
func (m *AndroidForWorkScepCertificateProfile) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["certificateStore"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetCertificateStore(val.(*AndroidForWorkScepCertificateProfile_certificateStore))
        }
        return nil
    }
...
func (m *AndroidForWorkScepCertificateProfile) SetCertificateStore(value *AndroidForWorkScepCertificateProfile_certificateStore)() {
...
type AndroidForWorkScepCertificateProfileable interface {
    ...
    GetCertificateStore()(*AndroidForWorkScepCertificateProfile_certificateStore)
    ...
    SetCertificateStore(value *AndroidForWorkScepCertificateProfile_certificateStore)()
