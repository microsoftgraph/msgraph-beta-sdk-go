...
func (m *AndroidForWorkScepCertificateProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidForWorkScepCertificateProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
