...
func (m *DeviceAppManagementTaskCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceAppManagementTaskCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
