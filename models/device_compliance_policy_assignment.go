...
func (m *DeviceCompliancePolicyAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceCompliancePolicyAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
