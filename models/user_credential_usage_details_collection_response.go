...
func (m *UserCredentialUsageDetailsCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *UserCredentialUsageDetailsCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
