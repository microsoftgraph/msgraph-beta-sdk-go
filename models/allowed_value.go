...
// AllowedValue provides operations to manage the collection of accessReview entities.
...
func (m *AllowedValue) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AllowedValue) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
