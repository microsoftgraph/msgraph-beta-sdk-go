...
func (m *SmsAuthenticationMethodConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *SmsAuthenticationMethodConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
