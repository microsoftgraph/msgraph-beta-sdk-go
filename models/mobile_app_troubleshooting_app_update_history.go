...
func (m *MobileAppTroubleshootingAppUpdateHistory) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MobileAppTroubleshootingAppUpdateHistory) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
