...
// Device provides operations to manage the collection of accessReview entities.
type Device struct {
    DirectoryObject
...
func (m *Device) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Device) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
