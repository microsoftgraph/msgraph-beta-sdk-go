...
func (m *CommunicationsGuestIdentity) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CommunicationsGuestIdentity) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
