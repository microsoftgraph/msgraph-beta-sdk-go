...
func (m *AppleUserInitiatedEnrollmentProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AppleUserInitiatedEnrollmentProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
