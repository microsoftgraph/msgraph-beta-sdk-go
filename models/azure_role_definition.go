...
// GetAssignableScopes gets the assignableScopes property value. Scopes at which the Azure role can be assigned. Supports $filter and (eq).
...
// GetDisplayName gets the displayName property value. Name of the Azure role. Supports $filter and (eq,contains).
...
// GetExternalId gets the externalId property value. Identifier of an Azure role defined by Microsoft Azure. Alternate key. Supports $filter and eq.
...
// SetAssignableScopes sets the assignableScopes property value. Scopes at which the Azure role can be assigned. Supports $filter and (eq).
...
// SetDisplayName sets the displayName property value. Name of the Azure role. Supports $filter and (eq,contains).
...
// SetExternalId sets the externalId property value. Identifier of an Azure role defined by Microsoft Azure. Alternate key. Supports $filter and eq.
