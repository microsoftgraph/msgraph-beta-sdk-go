...
// Chat provides operations to manage the collection of accessReview entities.
type Chat struct {
    Entity
...
func (m *Chat) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Chat) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
