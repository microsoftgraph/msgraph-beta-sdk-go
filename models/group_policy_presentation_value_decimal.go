...
func (m *GroupPolicyPresentationValueDecimal) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *GroupPolicyPresentationValueDecimal) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
