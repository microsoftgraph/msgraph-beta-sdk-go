...
func (m *AndroidManagedStoreAppConfigurationSchemaCollectionResponse) GetOdatanextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *AndroidManagedStoreAppConfigurationSchemaCollectionResponse) SetOdatanextLink(value *string)() {
    if m != nil {
        m.nextLink = value
    }
}
