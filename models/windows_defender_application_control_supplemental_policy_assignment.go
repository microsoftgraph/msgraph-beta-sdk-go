...
func (m *WindowsDefenderApplicationControlSupplementalPolicyAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsDefenderApplicationControlSupplementalPolicyAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
