...
func (m *WindowsDefenderApplicationControlSupplementalPolicyAssignment) GetOdataType()(*string) {
...
func (m *WindowsDefenderApplicationControlSupplementalPolicyAssignment) SetOdataType(value *string)() {
