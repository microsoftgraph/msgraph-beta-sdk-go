...
func (m *UserLastSignInRecommendationInsightSetting) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserLastSignInRecommendationInsightSetting) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
