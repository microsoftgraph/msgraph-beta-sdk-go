...
func (m *IosStoreAppAssignmentSettings) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *IosStoreAppAssignmentSettings) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
