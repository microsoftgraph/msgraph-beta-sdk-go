...
func (m *DeviceManagementExchangeOnPremisesPolicyCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *DeviceManagementExchangeOnPremisesPolicyCollectionResponse) SetOdataNextLink(value *string)() {
