...
func (m *DelegatedAdminRelationshipRequest) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DelegatedAdminRelationshipRequest) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
