...
func (m *AccessReviewInstanceDecisionItemServicePrincipalTarget) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessReviewInstanceDecisionItemServicePrincipalTarget) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
