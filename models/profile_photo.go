...
// ProfilePhoto provides operations to manage the collection of accessReview entities.
...
func (m *ProfilePhoto) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ProfilePhoto) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
