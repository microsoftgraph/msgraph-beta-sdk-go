...
func (m *AndroidManagedStoreAccountEnterpriseSettings) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidManagedStoreAccountEnterpriseSettings) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
