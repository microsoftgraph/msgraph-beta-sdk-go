...
func (m *GovernanceNotificationPolicy) GetAdditionalData()(map[string]any) {
...
func (m *GovernanceNotificationPolicy) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *GovernanceNotificationPolicy) GetEnabledTemplateTypes()([]string) {
    val, err := m.GetBackingStore().Get("enabledTemplateTypes")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
// returns a []GovernanceNotificationTemplateable when successful
func (m *GovernanceNotificationPolicy) GetNotificationTemplates()([]GovernanceNotificationTemplateable) {
    ...
    if val != nil {
        return val.([]GovernanceNotificationTemplateable)
    }
    return nil
}
...
func (m *GovernanceNotificationPolicy) SetAdditionalData(value map[string]any)() {
...
func (m *GovernanceNotificationPolicy) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *GovernanceNotificationPolicy) SetEnabledTemplateTypes(value []string)() {
    err := m.GetBackingStore().Set("enabledTemplateTypes", value)
    if err != nil {
        panic(err)
    }
}
