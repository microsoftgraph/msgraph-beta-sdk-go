...
func (m *Windows10XCustomSubjectAlternativeName) GetAdditionalData()(map[string]any) {
...
func (m *Windows10XCustomSubjectAlternativeName) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *Windows10XCustomSubjectAlternativeName) GetSanType()(*SubjectAlternativeNameType) {
    val, err := m.GetBackingStore().Get("sanType")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *Windows10XCustomSubjectAlternativeName) SetAdditionalData(value map[string]any)() {
...
func (m *Windows10XCustomSubjectAlternativeName) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *Windows10XCustomSubjectAlternativeName) SetSanType(value *SubjectAlternativeNameType)() {
    err := m.GetBackingStore().Set("sanType", value)
    if err != nil {
        panic(err)
    }
}
// Windows10XCustomSubjectAlternativeNameable 
type Windows10XCustomSubjectAlternativeNameable interface {
    ...
    GetName()(*string)
    GetOdataType()(*string)
    GetSanType()(*SubjectAlternativeNameType)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetName(value *string)()
    SetOdataType(value *string)()
    SetSanType(value *SubjectAlternativeNameType)()
}
