...
// CaseSettings provides operations to manage the collection of accessReview entities.
...
func (m *CaseSettings) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CaseSettings) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
