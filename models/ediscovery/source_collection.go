...
func NewSourceCollection()(*SourceCollection) {
    ...
    odataTypeValue := "#microsoft.graph.ediscovery.sourceCollection";
...
func (m *SourceCollection) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["addToReviewSetOperation"] = i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.SetObjectValue(CreateAddToReviewSetOperationFromDiscriminatorValue , m.SetAddToReviewSetOperation)
    ...
    res["lastEstimateStatisticsOperation"] = i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.SetObjectValue(CreateEstimateStatisticsOperationFromDiscriminatorValue , m.SetLastEstimateStatisticsOperation)
    ...
    res["noncustodialSources"] = i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.SetCollectionOfObjectValues(CreateNoncustodialDataSourceFromDiscriminatorValue , m.SetNoncustodialSources)
    return res
}
