...
func (m *WindowsKioskWin32App) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
// GetEdgeKioskType gets the edgeKioskType property value. Edge kiosk type for Edge kiosk mode. Possible values are: publicBrowsing, fullScreen.
...
func (m *WindowsKioskWin32App) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
...
// SetEdgeKioskType sets the edgeKioskType property value. Edge kiosk type for Edge kiosk mode. Possible values are: publicBrowsing, fullScreen.
