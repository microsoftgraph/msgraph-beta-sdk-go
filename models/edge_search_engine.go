...
func (m *EdgeSearchEngine) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
// GetEdgeSearchEngineType gets the edgeSearchEngineType property value. Allows IT admins to set a predefined default search engine for MDM-Controlled devices. Possible values are: default, bing.
...
func (m *EdgeSearchEngine) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
        m.additionalData = value
    }
}
// SetEdgeSearchEngineType sets the edgeSearchEngineType property value. Allows IT admins to set a predefined default search engine for MDM-Controlled devices. Possible values are: default, bing.
