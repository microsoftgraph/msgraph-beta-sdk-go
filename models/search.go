...
func (m *Search) GetCreatedBy()(IdentitySetable) {
    if m == nil {
        return nil
    } else {
        return m.createdBy
...
func (m *Search) GetLastModifiedBy()(IdentitySetable) {
    if m == nil {
        return nil
    } else {
...
func (m *Search) SetCreatedBy(value IdentitySetable)() {
    if m != nil {
        m.createdBy = value
    }
}
...
func (m *Search) SetLastModifiedBy(value IdentitySetable)() {
    if m != nil {
