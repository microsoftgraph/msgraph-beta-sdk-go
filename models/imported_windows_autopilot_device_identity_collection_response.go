...
func (m *ImportedWindowsAutopilotDeviceIdentityCollectionResponse) GetOdatanextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *ImportedWindowsAutopilotDeviceIdentityCollectionResponse) SetOdatanextLink(value *string)() {
    if m != nil {
        m.nextLink = value
    }
}
