...
func (m *AccessReviewInactiveUsersQueryScope) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessReviewInactiveUsersQueryScope) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
