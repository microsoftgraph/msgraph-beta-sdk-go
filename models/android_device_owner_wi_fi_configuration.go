...
func (m *AndroidDeviceOwnerWiFiConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceOwnerWiFiConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
