...
func (m *UserExperienceAnalyticsCategory) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsCategory) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
