...
func (m *VpnServer) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *VpnServer) GetIsDefaultServer()(*bool) {
    val, err := m.GetBackingStore().Get("isDefaultServer")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *VpnServer) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *VpnServer) SetIsDefaultServer(value *bool)() {
    err := m.GetBackingStore().Set("isDefaultServer", value)
    if err != nil {
        panic(err)
    }
}
