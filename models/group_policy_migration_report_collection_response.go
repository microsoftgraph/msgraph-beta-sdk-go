...
func (m *GroupPolicyMigrationReportCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *GroupPolicyMigrationReportCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
