...
func (m *RotateBitLockerKeysDeviceActionResult) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *RotateBitLockerKeysDeviceActionResult) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
