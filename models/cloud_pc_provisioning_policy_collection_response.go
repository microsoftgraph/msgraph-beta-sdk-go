...
func (m *CloudPcProvisioningPolicyCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *CloudPcProvisioningPolicyCollectionResponse) SetOdataNextLink(value *string)() {
