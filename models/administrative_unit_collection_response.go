...
func (m *AdministrativeUnitCollectionResponse) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AdministrativeUnitCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
