...
func (m *ApplicationSignInDetailedSummaryCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *ApplicationSignInDetailedSummaryCollectionResponse) SetOdataNextLink(value *string)() {
