...
func (m *MicrosoftTunnelHealthThresholdCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *MicrosoftTunnelHealthThresholdCollectionResponse) SetOdataNextLink(value *string)() {
