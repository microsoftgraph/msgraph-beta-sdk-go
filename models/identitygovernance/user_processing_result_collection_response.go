...
func (m *UserProcessingResultCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *UserProcessingResultCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *UserProcessingResultCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *UserProcessingResultCollectionResponse) SetOdataNextLink(value *string)() {
