...
// TaskDefinition provides operations to manage the collection of accessReviewDecision entities.
...
func NewTaskDefinition()(*TaskDefinition) {
    ...
    odataTypeValue := "#microsoft.graph.identityGovernance.taskDefinition";
