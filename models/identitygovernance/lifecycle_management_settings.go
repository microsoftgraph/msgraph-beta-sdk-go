...
// LifecycleManagementSettings provides operations to manage the collection of accessReviewDecision entities.
...
func NewLifecycleManagementSettings()(*LifecycleManagementSettings) {
    ...
    odataTypeValue := "#microsoft.graph.identityGovernance.lifecycleManagementSettings";
