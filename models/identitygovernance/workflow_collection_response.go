...
func (m *WorkflowCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *WorkflowCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *WorkflowCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *WorkflowCollectionResponse) SetOdataNextLink(value *string)() {
