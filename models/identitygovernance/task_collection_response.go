...
func (m *TaskCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *TaskCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *TaskCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *TaskCollectionResponse) SetOdataNextLink(value *string)() {
