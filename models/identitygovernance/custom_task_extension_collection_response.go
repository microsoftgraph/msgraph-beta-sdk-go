...
func (m *CustomTaskExtensionCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *CustomTaskExtensionCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *CustomTaskExtensionCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *CustomTaskExtensionCollectionResponse) SetOdataNextLink(value *string)() {
