...
func (m *WorkflowTemplateCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *WorkflowTemplateCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *WorkflowTemplateCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *WorkflowTemplateCollectionResponse) SetOdataNextLink(value *string)() {
