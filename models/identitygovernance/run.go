...
// GetActivatedOnScope gets the activatedOnScope property value. The scope for which users the workflow runs. The possible values are: allUsers, failedUsers, unknownFutureValue.
...
// SetActivatedOnScope sets the activatedOnScope property value. The scope for which users the workflow runs. The possible values are: allUsers, failedUsers, unknownFutureValue.
