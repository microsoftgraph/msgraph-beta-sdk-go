...
func (m *DeviceManagementSettingBooleanConstraint) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementSettingBooleanConstraint) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
