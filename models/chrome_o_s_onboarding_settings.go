...
func (m *ChromeOSOnboardingSettings) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ChromeOSOnboardingSettings) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
