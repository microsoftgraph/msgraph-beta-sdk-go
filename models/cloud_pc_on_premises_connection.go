...
// GetSubscriptionId gets the subscriptionId property value. The ID of the target Azure subscription associated with your tenant.
// returns a *string when successful
...
// GetVirtualNetworkLocation gets the virtualNetworkLocation property value. Indicates the resource location of the virtual target network. Read-only, computed value.
// returns a *string when successful
...
// SetSubscriptionId sets the subscriptionId property value. The ID of the target Azure subscription associated with your tenant.
...
// SetVirtualNetworkLocation sets the virtualNetworkLocation property value. Indicates the resource location of the virtual target network. Read-only, computed value.
