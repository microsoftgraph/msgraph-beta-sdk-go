...
func (m *CloudPcOnPremisesConnection) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CloudPcOnPremisesConnection) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
