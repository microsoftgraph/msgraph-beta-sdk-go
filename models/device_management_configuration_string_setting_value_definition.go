...
func (m *DeviceManagementConfigurationStringSettingValueDefinition) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationStringSettingValueDefinition) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
