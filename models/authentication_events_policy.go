...
func (m *AuthenticationEventsPolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AuthenticationEventsPolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
