...
// DefaultUserRoleOverride casts the previous resource to application.
...
func (m *DefaultUserRoleOverride) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DefaultUserRoleOverride) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
