...
// InferenceData_InferenceData_confidenceScore composed type wrapper for classes float64, ReferenceNumeric, string
type InferenceData_InferenceData_confidenceScore struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewInferenceData_InferenceData_confidenceScore instantiates a new InferenceData_InferenceData_confidenceScore and sets the default values.
...
// CreateInferenceData_InferenceData_confidenceScoreFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateInferenceData_InferenceData_confidenceScoreFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    result := NewInferenceData_InferenceData_confidenceScore()
    if parseNode != nil {
...
func (m *InferenceData_InferenceData_confidenceScore) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetDouble gets the double property value. Composed type representation for type float64
// returns a *float64 when successful
func (m *InferenceData_InferenceData_confidenceScore) GetDouble()(*float64) {
...
func (m *InferenceData_InferenceData_confidenceScore) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    return make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
}
// GetIsComposedType determines if the current object is a wrapper around a composed type
// returns a bool when successful
func (m *InferenceData_InferenceData_confidenceScore) GetIsComposedType()(bool) {
    return true
}
...
func (m *InferenceData_InferenceData_confidenceScore) GetReferenceNumeric()(*ReferenceNumeric) {
...
func (m *InferenceData_InferenceData_confidenceScore) GetString()(*string) {
...
func (m *InferenceData_InferenceData_confidenceScore) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *InferenceData_InferenceData_confidenceScore) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetDouble sets the double property value. Composed type representation for type float64
func (m *InferenceData_InferenceData_confidenceScore) SetDouble(value *float64)() {
...
func (m *InferenceData_InferenceData_confidenceScore) SetReferenceNumeric(value *ReferenceNumeric)() {
...
func (m *InferenceData_InferenceData_confidenceScore) SetString(value *string)() {
    err := m.GetBackingStore().Set("string", value)
    if err != nil {
        panic(err)
    }
}
type InferenceData_InferenceData_confidenceScoreable interface {
...
// returns a InferenceData_InferenceData_confidenceScoreable when successful
func (m *InferenceData) GetConfidenceScore()(InferenceData_InferenceData_confidenceScoreable) {
    val, err := m.GetBackingStore().Get("confidenceScore")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(InferenceData_InferenceData_confidenceScoreable)
    }
    return nil
}
// GetFieldDeserializers the deserialization information for the current model
...
func (m *InferenceData) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["confidenceScore"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetConfidenceScore(val.(*InferenceData_InferenceData_confidenceScore))
        }
        return nil
    }
...
func (m *InferenceData) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
        err := writer.WriteObjectValue("confidenceScore", m.GetConfidenceScore())
        if err != nil {
            return err
        }
    }
...
func (m *InferenceData) SetConfidenceScore(value InferenceData_InferenceData_confidenceScoreable)() {
...
type InferenceDataable interface {
    ...
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetConfidenceScore()(InferenceData_InferenceData_confidenceScoreable)
    GetOdataType()(*string)
    GetUserHasVerifiedAccuracy()(*bool)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetConfidenceScore(value InferenceData_InferenceData_confidenceScoreable)()
