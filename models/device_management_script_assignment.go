...
func (m *DeviceManagementScriptAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementScriptAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
