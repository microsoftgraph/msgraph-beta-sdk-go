...
func (m *ImportedWindowsAutopilotDeviceIdentityUpload) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ImportedWindowsAutopilotDeviceIdentityUpload) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
