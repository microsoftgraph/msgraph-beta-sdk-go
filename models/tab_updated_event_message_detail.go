...
func (m *TabUpdatedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TabUpdatedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
