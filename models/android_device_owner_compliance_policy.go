...
func (m *AndroidDeviceOwnerCompliancePolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceOwnerCompliancePolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
