...
func (m *DlpEvaluationWindowsDevicesInput) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DlpEvaluationWindowsDevicesInput) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
