...
func (m *DeviceComplianceSettingState) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceComplianceSettingState) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
