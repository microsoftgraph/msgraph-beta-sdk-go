...
func (m *WindowsAppXAppAssignmentSettings) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsAppXAppAssignmentSettings) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
