...
func (m *Win32LobAppProductCodeDetection) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Win32LobAppProductCodeDetection) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
