...
func (m *DeviceHealthScriptHourlySchedule) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceHealthScriptHourlySchedule) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
