...
func (m *MacOSPkcsCertificateProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MacOSPkcsCertificateProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
