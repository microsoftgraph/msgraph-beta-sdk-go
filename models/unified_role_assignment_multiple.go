...
func (m *UnifiedRoleAssignmentMultiple) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UnifiedRoleAssignmentMultiple) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
