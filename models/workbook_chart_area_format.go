...
// WorkbookChartAreaFormat provides operations to manage the collection of accessReview entities.
...
func (m *WorkbookChartAreaFormat) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookChartAreaFormat) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
