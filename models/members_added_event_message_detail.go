...
func (m *MembersAddedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MembersAddedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
