...
func (m *DeletedTeamCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *DeletedTeamCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *DeletedTeamCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeletedTeamCollectionResponse) SetOdataNextLink(value *string)() {
