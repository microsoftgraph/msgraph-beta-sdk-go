...
// AccessReviewHistoryInstance provides operations to manage the collection of accessReview entities.
...
func (m *AccessReviewHistoryInstance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessReviewHistoryInstance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
