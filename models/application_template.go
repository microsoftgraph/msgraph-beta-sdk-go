...
// returns a InformationalUrlsable when successful
func (m *ApplicationTemplate) GetInformationalUrls()(InformationalUrlsable) {
    val, err := m.GetBackingStore().Get("informationalUrls")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
// returns a SupportedClaimConfigurationable when successful
func (m *ApplicationTemplate) GetSupportedClaimConfiguration()(SupportedClaimConfigurationable) {
    val, err := m.GetBackingStore().Get("supportedClaimConfiguration")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(SupportedClaimConfigurationable)
    }
    return nil
}
...
func (m *ApplicationTemplate) SetSupportedClaimConfiguration(value SupportedClaimConfigurationable)() {
    err := m.GetBackingStore().Set("supportedClaimConfiguration", value)
    if err != nil {
        panic(err)
    }
}
