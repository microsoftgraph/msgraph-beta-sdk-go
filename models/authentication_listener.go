...
// AuthenticationListener provides operations to manage the collection of accessReview entities.
...
func (m *AuthenticationListener) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AuthenticationListener) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
