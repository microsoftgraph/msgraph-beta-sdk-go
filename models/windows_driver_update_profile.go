...
func (m *WindowsDriverUpdateProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsDriverUpdateProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
