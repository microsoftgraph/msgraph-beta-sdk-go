...
func (m *WorkbooksItemCreateLinkPostRequestBody) GetRecipients()([]DriveRecipientable) {
    return m.recipients
}
...
func (m *WorkbooksItemCreateLinkPostRequestBody) SetRecipients(value []DriveRecipientable)() {
    m.recipients = value
}
