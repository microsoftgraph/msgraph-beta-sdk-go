...
func (m *Office365GroupsActivityGroupCounts) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Office365GroupsActivityGroupCounts) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
