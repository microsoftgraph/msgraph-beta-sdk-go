...
func (m *Bookmark) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Bookmark) GetPlatforms()([]string) {
    if m == nil {
        return nil
    } else {
        return m.platforms
...
func (m *Bookmark) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
...
func (m *Bookmark) SetPlatforms(value []string)() {
    if m != nil {
        m.platforms = value
    }
}
