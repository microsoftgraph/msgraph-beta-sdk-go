...
// WorkbookRangeFont provides operations to manage the collection of accessReview entities.
...
func (m *WorkbookRangeFont) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookRangeFont) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
