...
func (m *AndroidForWorkCertificateProfileBase) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidForWorkCertificateProfileBase) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
