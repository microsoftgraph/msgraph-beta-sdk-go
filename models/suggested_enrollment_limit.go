...
func (m *SuggestedEnrollmentLimit) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *SuggestedEnrollmentLimit) GetSuggestedDailyLimit()(*int32) {
    val, err := m.GetBackingStore().Get("suggestedDailyLimit")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *SuggestedEnrollmentLimit) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *SuggestedEnrollmentLimit) SetSuggestedDailyLimit(value *int32)() {
    err := m.GetBackingStore().Set("suggestedDailyLimit", value)
    if err != nil {
        panic(err)
    }
}
// SuggestedEnrollmentLimitable 
type SuggestedEnrollmentLimitable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackedModel
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetOdataType()(*string)
    GetSuggestedDailyLimit()(*int32)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetOdataType(value *string)()
    SetSuggestedDailyLimit(value *int32)()
}
