...
func (m *WindowsKioskSingleWin32App) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsKioskSingleWin32App) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
