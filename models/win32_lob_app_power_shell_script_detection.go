...
func (m *Win32LobAppPowerShellScriptDetection) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Win32LobAppPowerShellScriptDetection) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
