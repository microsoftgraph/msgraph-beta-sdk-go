...
func (m *DeviceManagementConfigurationSettingValueTemplateReference) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *DeviceManagementConfigurationSettingValueTemplateReference) GetUseTemplateDefault()(*bool) {
    val, err := m.GetBackingStore().Get("useTemplateDefault")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *DeviceManagementConfigurationSettingValueTemplateReference) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *DeviceManagementConfigurationSettingValueTemplateReference) SetUseTemplateDefault(value *bool)() {
    err := m.GetBackingStore().Set("useTemplateDefault", value)
    if err != nil {
        panic(err)
    }
}
