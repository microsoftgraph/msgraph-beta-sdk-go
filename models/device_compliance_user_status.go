...
// DeviceComplianceUserStatus provides operations to manage the collection of accessReview entities.
...
func (m *DeviceComplianceUserStatus) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceComplianceUserStatus) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
