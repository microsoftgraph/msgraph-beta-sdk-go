...
func (m *CallEndedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CallEndedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
