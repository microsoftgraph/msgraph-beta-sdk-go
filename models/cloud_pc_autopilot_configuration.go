...
// NewCloudPcAutopilotConfiguration instantiates a new CloudPcAutopilotConfiguration and sets the default values.
func NewCloudPcAutopilotConfiguration()(*CloudPcAutopilotConfiguration) {
    m := &CloudPcAutopilotConfiguration{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateCloudPcAutopilotConfigurationFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateCloudPcAutopilotConfigurationFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewCloudPcAutopilotConfiguration(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *CloudPcAutopilotConfiguration) GetAdditionalData()(map[string]any) {
...
func (m *CloudPcAutopilotConfiguration) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    res := make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
    res["applicationTimeoutInMinutes"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetInt32Value()
        if err != nil {
            return err
        }
        if val != nil {
            m.SetApplicationTimeoutInMinutes(val)
        }
        return nil
    }
    res["devicePreparationProfileId"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetStringValue()
        if err != nil {
            return err
        }
        if val != nil {
            m.SetDevicePreparationProfileId(val)
        }
        return nil
    }
    ...
    res["onFailureDeviceAccessDenied"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetBoolValue()
        if err != nil {
            return err
        }
        if val != nil {
            m.SetOnFailureDeviceAccessDenied(val)
        }
        return nil
    }
    return res
...
// returns a *string when successful
func (m *CloudPcAutopilotConfiguration) GetOdataType()(*string) {
...
func (m *CloudPcAutopilotConfiguration) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
        err := writer.WriteInt32Value("applicationTimeoutInMinutes", m.GetApplicationTimeoutInMinutes())
        if err != nil {
            return err
        }
    }
    {
        err := writer.WriteStringValue("devicePreparationProfileId", m.GetDevicePreparationProfileId())
        if err != nil {
            return err
        }
    }
    ...
    {
        err := writer.WriteBoolValue("onFailureDeviceAccessDenied", m.GetOnFailureDeviceAccessDenied())
        if err != nil {
            return err
        }
    }
...
func (m *CloudPcAutopilotConfiguration) SetAdditionalData(value map[string]any)() {
...
func (m *CloudPcAutopilotConfiguration) SetOdataType(value *string)() {
...
type CloudPcAutopilotConfigurationable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackedModel
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetApplicationTimeoutInMinutes()(*int32)
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetDevicePreparationProfileId()(*string)
    GetOdataType()(*string)
    GetOnFailureDeviceAccessDenied()(*bool)
    SetApplicationTimeoutInMinutes(value *int32)()
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetDevicePreparationProfileId(value *string)()
    SetOdataType(value *string)()
    SetOnFailureDeviceAccessDenied(value *bool)()
}
