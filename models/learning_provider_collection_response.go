...
func (m *LearningProviderCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *LearningProviderCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *LearningProviderCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *LearningProviderCollectionResponse) SetOdataNextLink(value *string)() {
