...
func (m *VppTokenRevokeLicensesActionResult) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *VppTokenRevokeLicensesActionResult) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
