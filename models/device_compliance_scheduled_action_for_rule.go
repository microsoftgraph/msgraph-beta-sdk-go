...
func (m *DeviceComplianceScheduledActionForRule) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceComplianceScheduledActionForRule) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
