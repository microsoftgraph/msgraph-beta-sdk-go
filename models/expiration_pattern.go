...
// GetTypeEscaped gets the type property value. The requestor's desired expiration pattern type.
// returns a *ExpirationPatternType when successful
...
// SetTypeEscaped sets the type property value. The requestor's desired expiration pattern type.
