...
// WorkbookRangeFormat provides operations to manage the collection of accessReview entities.
...
func (m *WorkbookRangeFormat) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookRangeFormat) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
