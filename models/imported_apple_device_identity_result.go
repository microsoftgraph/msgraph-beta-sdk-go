...
func (m *ImportedAppleDeviceIdentityResult) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ImportedAppleDeviceIdentityResult) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
