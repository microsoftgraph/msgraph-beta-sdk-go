...
// GetAllowOnPremUpdateOfOnPremisesObjectIdentifierEnabled gets the allowOnPremUpdateOfOnPremisesObjectIdentifierEnabled property value. When true, allows clients to update the onPremisesObjectIdentifier property for on-premises Active Directory synced objects.
...
func (m *OnPremisesDirectorySynchronizationFeature) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["allowOnPremUpdateOfOnPremisesObjectIdentifierEnabled"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetBoolValue()
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAllowOnPremUpdateOfOnPremisesObjectIdentifierEnabled(val)
        }
        return nil
    }
...
func (m *OnPremisesDirectorySynchronizationFeature) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
        err := writer.WriteBoolValue("allowOnPremUpdateOfOnPremisesObjectIdentifierEnabled", m.GetAllowOnPremUpdateOfOnPremisesObjectIdentifierEnabled())
        if err != nil {
            return err
        }
    }
...
// SetAllowOnPremUpdateOfOnPremisesObjectIdentifierEnabled sets the allowOnPremUpdateOfOnPremisesObjectIdentifierEnabled property value. When true, allows clients to update the onPremisesObjectIdentifier property for on-premises Active Directory synced objects.
...
type OnPremisesDirectorySynchronizationFeatureable interface {
    ...
    GetAllowOnPremUpdateOfOnPremisesObjectIdentifierEnabled()(*bool)
    ...
    SetAllowOnPremUpdateOfOnPremisesObjectIdentifierEnabled(value *bool)()
