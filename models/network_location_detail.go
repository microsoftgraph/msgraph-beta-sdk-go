...
func (m *NetworkLocationDetail) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["networkType"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseNetworkLocationDetail_networkType)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetNetworkType(val.(*NetworkLocationDetail_networkType))
        }
        return nil
    }
...
func (m *NetworkLocationDetail) GetNetworkType()(*NetworkLocationDetail_networkType) {
    val, err := m.GetBackingStore().Get("networkType")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*NetworkLocationDetail_networkType)
    }
    return nil
}
...
func (m *NetworkLocationDetail) SetNetworkType(value *NetworkLocationDetail_networkType)() {
...
type NetworkLocationDetailable interface {
    ...
    GetNetworkType()(*NetworkLocationDetail_networkType)
    GetOdataType()(*string)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetNetworkNames(value []string)()
    SetNetworkType(value *NetworkLocationDetail_networkType)()
