...
func (m *UserExperienceAnalyticsDeviceScope) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsDeviceScope) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
