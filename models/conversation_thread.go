...
// ConversationThread provides operations to manage the collection of accessReview entities.
...
func (m *ConversationThread) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ConversationThread) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
