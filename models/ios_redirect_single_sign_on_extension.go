...
func (m *IosRedirectSingleSignOnExtension) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *IosRedirectSingleSignOnExtension) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
