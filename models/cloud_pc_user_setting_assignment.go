...
// CloudPcUserSettingAssignment provides operations to manage the collection of accessReview entities.
...
func (m *CloudPcUserSettingAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CloudPcUserSettingAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
