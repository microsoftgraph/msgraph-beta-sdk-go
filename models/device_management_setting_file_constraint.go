...
func (m *DeviceManagementSettingFileConstraint) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementSettingFileConstraint) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
