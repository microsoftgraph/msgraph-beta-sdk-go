...
func (m *AndroidWorkProfileGmailEasConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidWorkProfileGmailEasConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
