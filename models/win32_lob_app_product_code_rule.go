...
func (m *Win32LobAppProductCodeRule) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
// GetProductVersionOperator gets the productVersionOperator property value. The product version comparison operator. Possible values are: notConfigured, equal, notEqual, greaterThan, greaterThanOrEqual, lessThan, lessThanOrEqual.
...
func (m *Win32LobAppProductCodeRule) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
...
// SetProductVersionOperator sets the productVersionOperator property value. The product version comparison operator. Possible values are: notConfigured, equal, notEqual, greaterThan, greaterThanOrEqual, lessThan, lessThanOrEqual.
