...
func (m *IosNotificationSettings) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["previewVisibility"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetPreviewVisibility(val.(*IosNotificationPreviewVisibility))
        }
        return nil
    }
...
// returns a *IosNotificationPreviewVisibility when successful
func (m *IosNotificationSettings) GetPreviewVisibility()(*IosNotificationPreviewVisibility) {
    val, err := m.GetBackingStore().Get("previewVisibility")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*IosNotificationPreviewVisibility)
    }
    return nil
}
...
func (m *IosNotificationSettings) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    if m.GetPreviewVisibility() != nil {
        cast := (*m.GetPreviewVisibility()).String()
        err := writer.WriteStringValue("previewVisibility", &cast)
        if err != nil {
            return err
        }
    }
...
func (m *IosNotificationSettings) SetPreviewVisibility(value *IosNotificationPreviewVisibility)() {
    err := m.GetBackingStore().Set("previewVisibility", value)
    if err != nil {
        panic(err)
    }
}
...
type IosNotificationSettingsable interface {
    ...
    GetEnabled()(*bool)
    GetOdataType()(*string)
    GetPreviewVisibility()(*IosNotificationPreviewVisibility)
    GetPublisher()(*string)
    ...
    SetPreviewVisibility(value *IosNotificationPreviewVisibility)()
