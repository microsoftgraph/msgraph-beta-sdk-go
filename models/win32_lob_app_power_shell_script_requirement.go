...
func (m *Win32LobAppPowerShellScriptRequirement) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Win32LobAppPowerShellScriptRequirement) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
