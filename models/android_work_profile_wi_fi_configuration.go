...
func (m *AndroidWorkProfileWiFiConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidWorkProfileWiFiConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
