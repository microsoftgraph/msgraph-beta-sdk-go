...
func (m *DeviceManagementSettingDefinitionCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *DeviceManagementSettingDefinitionCollectionResponse) SetOdataNextLink(value *string)() {
