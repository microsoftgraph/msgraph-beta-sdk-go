...
// ThreatAssessmentResult provides operations to manage the collection of accessReview entities.
...
func (m *ThreatAssessmentResult) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ThreatAssessmentResult) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
