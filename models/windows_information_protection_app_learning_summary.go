...
func (m *WindowsInformationProtectionAppLearningSummary) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsInformationProtectionAppLearningSummary) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
