...
// GetLanguage gets the language property value. The language code to be used when configuring the device. E.g. en-US. The default value is os-default. Supports: $select, $top, $skip. $Search, $orderBy and $filter are not supported. Read-Only. Starting from May 2024 this property will no longer be supported and will be marked as deprecated. Use locale instead.
// returns a *string when successful
...
func (m *WindowsAutopilotDeploymentProfile) GetOutOfBoxExperienceSettings()(OutOfBoxExperienceSettingsable) {
    val, err := m.GetBackingStore().Get("outOfBoxExperienceSettings")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *WindowsAutopilotDeploymentProfile) SetEnableWhiteGlove(value *bool)() {
    err := m.GetBackingStore().Set("enableWhiteGlove", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *WindowsAutopilotDeploymentProfile) SetEnrollmentStatusScreenSettings(value WindowsEnrollmentStatusScreenSettingsable)() {
    err := m.GetBackingStore().Set("enrollmentStatusScreenSettings", value)
    if err != nil {
        panic(err)
    }
}
// SetExtractHardwareHash sets the extractHardwareHash property value. Indicates whether the profile supports the extraction of hardware hash values and registration of the device into Windows Autopilot. When TRUE, indicates if hardware extraction and Windows Autopilot registration will happen on the next successful check-in. When FALSE, hardware hash extraction and Windows Autopilot registration will not happen. Default value is FALSE. Supports: $select, $top, $skip. $Search, $orderBy and $filter are not supported. Read-Only. Starting from May 2024 this property will no longer be supported and will be marked as deprecated. Use hardwareHashExtractionEnabled instead.
func (m *WindowsAutopilotDeploymentProfile) SetExtractHardwareHash(value *bool)() {
    err := m.GetBackingStore().Set("extractHardwareHash", value)
    if err != nil {
        panic(err)
    }
}
...
// SetOutOfBoxExperienceSettings sets the outOfBoxExperienceSettings property value. The Windows Autopilot Deployment Profile settings used by the Autopilot device for out-of-box experience. Supports: $select, $top, $skip. $Search, $orderBy and $filter are not supported. Read-Only. Starting from May 2024 this property will no longer be supported and will be marked as deprecated. Use outOfBoxExperienceSetting instead.
