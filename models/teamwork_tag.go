...
// GetDescription gets the description property value. Tag description as it appears to the user in Microsoft Teams. A teamworkTag can't have more than 200 teamworkTagMembers.
...
// GetDisplayName gets the displayName property value. Tag name as it appears to the user in Microsoft Teams.
...
// SetDescription sets the description property value. Tag description as it appears to the user in Microsoft Teams. A teamworkTag can't have more than 200 teamworkTagMembers.
...
// SetDisplayName sets the displayName property value. Tag name as it appears to the user in Microsoft Teams.
