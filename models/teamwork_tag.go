...
// TeamworkTag provides operations to manage the collection of accessReview entities.
...
func (m *TeamworkTag) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TeamworkTag) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
