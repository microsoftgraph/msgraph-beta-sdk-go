...
// PrivilegedRole provides operations to manage the collection of accessReview entities.
...
func (m *PrivilegedRole) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PrivilegedRole) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
