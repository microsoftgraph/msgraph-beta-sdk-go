...
func (m *ErrorDetail) GetAdditionalData()(map[string]any) {
...
func (m *ErrorDetail) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["resourceInstanceName"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetStringValue()
        if err != nil {
            return err
        }
        if val != nil {
            m.SetResourceInstanceName(val)
        }
        return nil
    }
...
// returns a *string when successful
func (m *ErrorDetail) GetOdataType()(*string) {
...
func (m *ErrorDetail) SetAdditionalData(value map[string]any)() {
...
func (m *ErrorDetail) SetOdataType(value *string)() {
...
type ErrorDetailable interface {
    ...
    SetResourceInstanceName(value *string)()
