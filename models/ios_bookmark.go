...
func (m *IosBookmark) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *IosBookmark) SetBookmarkFolder(value *string)() {
    err := m.GetBackingStore().Set("bookmarkFolder", value)
    if err != nil {
        panic(err)
    }
}
