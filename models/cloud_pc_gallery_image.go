...
func (m *CloudPcGalleryImage) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["status"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseCloudPcGalleryImage_status)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetStatus(val.(*CloudPcGalleryImage_status))
        }
        return nil
    }
    return res
...
func (m *CloudPcGalleryImage) GetStatus()(*CloudPcGalleryImage_status) {
    val, err := m.GetBackingStore().Get("status")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*CloudPcGalleryImage_status)
    }
    return nil
}
...
func (m *CloudPcGalleryImage) SetStatus(value *CloudPcGalleryImage_status)() {
...
type CloudPcGalleryImageable interface {
    ...
    GetStatus()(*CloudPcGalleryImage_status)
    ...
    SetStatus(value *CloudPcGalleryImage_status)()
}
