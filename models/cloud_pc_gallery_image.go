...
// SetOfferName sets the offerName property value. The offer name of this gallery image that is passed to ARM to retrieve the image resource. Read-only.
...
// SetPublisherName sets the publisherName property value. The publisher name of this gallery image that is passed to ARM to retrieve the image resource. Read-only.
...
// SetSkuName sets the skuName property value. The SKU name of this image that is passed to ARM to retrieve the image resource. Read-only.
