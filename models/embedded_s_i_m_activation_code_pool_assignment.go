...
func (m *EmbeddedSIMActivationCodePoolAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EmbeddedSIMActivationCodePoolAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
