...
func (m *WindowsInformationProtectionPolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsInformationProtectionPolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
