...
// GetAuthenticationFlows gets the authenticationFlows property value. Authentication flows included in the policy scope. For more information, see Conditional Access: Authentication flows.
...
// returns a ConditionalAccessDeviceStatesable when successful
func (m *ConditionalAccessConditionSet) GetDeviceStates()(ConditionalAccessDeviceStatesable) {
    ...
    if val != nil {
        return val.(ConditionalAccessDeviceStatesable)
    }
    return nil
}
...
// SetAuthenticationFlows sets the authenticationFlows property value. Authentication flows included in the policy scope. For more information, see Conditional Access: Authentication flows.
