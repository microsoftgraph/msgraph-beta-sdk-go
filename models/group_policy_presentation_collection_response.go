...
func (m *GroupPolicyPresentationCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *GroupPolicyPresentationCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
