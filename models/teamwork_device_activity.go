...
func (m *TeamworkDeviceActivity) GetActivePeripherals()(TeamworkActivePeripheralsable) {
    ...
    if val != nil {
        return val.(TeamworkActivePeripheralsable)
    }
    return nil
}
...
func (m *TeamworkDeviceActivity) GetOdataType()(*string) {
...
func (m *TeamworkDeviceActivity) SetActivePeripherals(value TeamworkActivePeripheralsable)() {
    err := m.GetBackingStore().Set("activePeripherals", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *TeamworkDeviceActivity) SetOdataType(value *string)() {
