...
// NewActionSummary instantiates a new actionSummary and sets the default values.
...
// CreateActionSummaryFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateActionSummaryFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewActionSummary(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *ActionSummary) GetAdditionalData()(map[string]any) {
...
func (m *ActionSummary) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    res := make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
    res["assigned"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
    ...
    res["exercised"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetInt32Value()
        if err != nil {
            return err
        }
...
func (m *ActionSummary) GetOdataType()(*string) {
...
func (m *ActionSummary) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
        err := writer.WriteInt32Value("assigned", m.GetAssigned())
        if err != nil {
            return err
        }
    }
    ...
    {
        err := writer.WriteInt32Value("exercised", m.GetExercised())
        if err != nil {
            return err
        }
    }
...
func (m *ActionSummary) SetAdditionalData(value map[string]any)() {
...
func (m *ActionSummary) SetOdataType(value *string)() {
...
// ActionSummaryable 
type ActionSummaryable interface {
    ...
    GetExercised()(*int32)
    GetOdataType()(*string)
    SetAssigned(value *int32)()
    SetAvailable(value *int32)()
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetExercised(value *int32)()
