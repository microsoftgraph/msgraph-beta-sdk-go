...
func (m *UserRegistrationDetailsCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *UserRegistrationDetailsCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
