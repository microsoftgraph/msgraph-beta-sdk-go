...
func (m *TeamsAppInstalledEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TeamsAppInstalledEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
