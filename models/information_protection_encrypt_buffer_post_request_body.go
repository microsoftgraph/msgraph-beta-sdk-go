...
// InformationProtectionEncryptBufferPostRequestBody provides operations to call the encryptBuffer method.
...
func (m *InformationProtectionEncryptBufferPostRequestBody) GetLabelId()(*string) {
    return m.labelId
}
...
func (m *InformationProtectionEncryptBufferPostRequestBody) SetLabelId(value *string)() {
    m.labelId = value
}
