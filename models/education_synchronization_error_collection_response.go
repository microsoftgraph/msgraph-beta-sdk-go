...
func (m *EducationSynchronizationErrorCollectionResponse) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EducationSynchronizationErrorCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *EducationSynchronizationErrorCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
        m.additionalData = value
    }
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EducationSynchronizationErrorCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
