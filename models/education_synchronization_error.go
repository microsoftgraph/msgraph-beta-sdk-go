...
func (m *EducationSynchronizationError) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EducationSynchronizationError) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
