...
func (m *UnmanagedDeviceDiscoveryTaskCollectionResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["value"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateUnmanagedDeviceDiscoveryTaskFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]UnmanagedDeviceDiscoveryTaskable, len(val))
            for i, v := range val {
                res[i] = v.(UnmanagedDeviceDiscoveryTaskable)
            }
            m.SetValue(res)
        }
        return nil
...
func (m *UnmanagedDeviceDiscoveryTaskCollectionResponse) GetValue()([]UnmanagedDeviceDiscoveryTaskable) {
    ...
    if val != nil {
        return val.([]UnmanagedDeviceDiscoveryTaskable)
    }
    return nil
}
...
// UnmanagedDeviceDiscoveryTaskCollectionResponseable 
type UnmanagedDeviceDiscoveryTaskCollectionResponseable interface {
    BaseCollectionPaginationCountResponseable
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetValue()([]UnmanagedDeviceDiscoveryTaskable)
    SetValue(value []UnmanagedDeviceDiscoveryTaskable)()
}
