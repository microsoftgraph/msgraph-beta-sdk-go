...
// InformationProtectionPolicy provides operations to manage the collection of accessReview entities.
...
func (m *InformationProtectionPolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *InformationProtectionPolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
