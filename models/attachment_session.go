...
// AttachmentSession provides operations to manage the collection of accessReview entities.
...
func (m *AttachmentSession) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AttachmentSession) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
