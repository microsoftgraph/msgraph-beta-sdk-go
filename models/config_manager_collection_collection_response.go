...
func (m *ConfigManagerCollectionCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *ConfigManagerCollectionCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
