...
type DeviceManagementable interface {
    ...
    GetOrganizationalMessageDetails()([]OrganizationalMessageDetailable)
    GetOrganizationalMessageGuidedContents()([]OrganizationalMessageGuidedContentable)
    ...
    GetUserExperienceAnalyticsRegressionSummary()(UserExperienceAnalyticsRegressionSummaryable)
    ...
    SetOrganizationalMessageDetails(value []OrganizationalMessageDetailable)()
    SetOrganizationalMessageGuidedContents(value []OrganizationalMessageGuidedContentable)()
    ...
    SetUserExperienceAnalyticsRegressionSummary(value UserExperienceAnalyticsRegressionSummaryable)()
