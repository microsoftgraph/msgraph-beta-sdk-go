...
// GetDashboardCards gets the dashboardCards property value. Dashboard cards specified in the Teams app manifest.
...
// SetDashboardCards sets the dashboardCards property value. Dashboard cards specified in the Teams app manifest.
