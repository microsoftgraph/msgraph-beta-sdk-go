...
func (m *CustomSecurityAttributeDefinitionCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *CustomSecurityAttributeDefinitionCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
