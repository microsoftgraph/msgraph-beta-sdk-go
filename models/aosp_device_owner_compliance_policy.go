...
func (m *AospDeviceOwnerCompliancePolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AospDeviceOwnerCompliancePolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
