...
func (m *DeviceManagementConfigurationExchangeOnlineSettingApplicability) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationExchangeOnlineSettingApplicability) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
