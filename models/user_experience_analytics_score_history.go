...
func (m *UserExperienceAnalyticsScoreHistory) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsScoreHistory) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
