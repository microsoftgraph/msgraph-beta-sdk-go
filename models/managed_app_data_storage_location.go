...
const (
    ...
    IMANAGE_MANAGEDAPPDATASTORAGELOCATION
    ...
    EGNYTE_MANAGEDAPPDATASTORAGELOCATION
    // Evolvable enumeration sentinel value. Do not use.
    UNKNOWNFUTUREVALUE_MANAGEDAPPDATASTORAGELOCATION
)

func (i ManagedAppDataStorageLocation) String() string {
    return []string{"oneDriveForBusiness", "sharePoint", "box", "localStorage", "photoLibrary", "iManage", "egnyte", "unknownFutureValue"}[i]
}
func ParseManagedAppDataStorageLocation(v string) (any, error) {
    ...
    switch v {
        ...
        case "iManage":
            result = IMANAGE_MANAGEDAPPDATASTORAGELOCATION
        case "egnyte":
            result = EGNYTE_MANAGEDAPPDATASTORAGELOCATION
        case "unknownFutureValue":
            result = UNKNOWNFUTUREVALUE_MANAGEDAPPDATASTORAGELOCATION
        default:
            return nil, nil
    }
    return &result, nil
