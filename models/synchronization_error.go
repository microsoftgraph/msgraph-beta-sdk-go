...
// GetTenantActionable gets the tenantActionable property value. The action to take to resolve the error.
...
// SetTenantActionable sets the tenantActionable property value. The action to take to resolve the error.
