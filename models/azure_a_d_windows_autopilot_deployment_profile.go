...
func (m *AzureADWindowsAutopilotDeploymentProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AzureADWindowsAutopilotDeploymentProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
