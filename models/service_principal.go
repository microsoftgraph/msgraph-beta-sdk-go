...
func (m *ServicePrincipal) GetErrorUrl()(*string) {
    val, err := m.GetBackingStore().Get("errorUrl")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
// GetOwners gets the owners property value. Directory objects that are owners of this servicePrincipal. The owners are a set of nonadmin users or servicePrincipals who are allowed to modify this object. Read-only. Nullable.  Supports $expand and $filter (/$count eq 0, /$count ne 0, /$count eq 1, /$count ne 1).
// returns a []DirectoryObjectable when successful
...
// returns a PasswordSingleSignOnSettingsable when successful
func (m *ServicePrincipal) GetPasswordSingleSignOnSettings()(PasswordSingleSignOnSettingsable) {
    val, err := m.GetBackingStore().Get("passwordSingleSignOnSettings")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ServicePrincipal) GetPublishedPermissionScopes()([]PermissionScopeable) {
    val, err := m.GetBackingStore().Get("publishedPermissionScopes")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ServicePrincipal) SetErrorUrl(value *string)() {
    err := m.GetBackingStore().Set("errorUrl", value)
    if err != nil {
        panic(err)
    }
}
...
// SetOwners sets the owners property value. Directory objects that are owners of this servicePrincipal. The owners are a set of nonadmin users or servicePrincipals who are allowed to modify this object. Read-only. Nullable.  Supports $expand and $filter (/$count eq 0, /$count ne 0, /$count eq 1, /$count ne 1).
...
func (m *ServicePrincipal) SetPasswordSingleSignOnSettings(value PasswordSingleSignOnSettingsable)() {
    err := m.GetBackingStore().Set("passwordSingleSignOnSettings", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *ServicePrincipal) SetPublishedPermissionScopes(value []PermissionScopeable)() {
    err := m.GetBackingStore().Set("publishedPermissionScopes", value)
    if err != nil {
        panic(err)
    }
}
