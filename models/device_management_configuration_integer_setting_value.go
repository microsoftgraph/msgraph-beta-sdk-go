...
func (m *DeviceManagementConfigurationIntegerSettingValue) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationIntegerSettingValue) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
