...
func (m *WindowsPhone81TrustedRootCertificate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsPhone81TrustedRootCertificate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
