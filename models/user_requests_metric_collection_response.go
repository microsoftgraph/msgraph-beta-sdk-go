...
func (m *UserRequestsMetricCollectionResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *UserRequestsMetricCollectionResponse) SetValue(value []UserRequestsMetricable)() {
...
type UserRequestsMetricCollectionResponseable interface {
    ...
    GetValue()([]UserRequestsMetricable)
    SetValue(value []UserRequestsMetricable)()
}
