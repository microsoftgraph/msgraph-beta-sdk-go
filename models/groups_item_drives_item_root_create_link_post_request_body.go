...
func (m *GroupsItemDrivesItemRootCreateLinkPostRequestBody) GetRecipients()([]DriveRecipientable) {
    return m.recipients
}
...
func (m *GroupsItemDrivesItemRootCreateLinkPostRequestBody) SetRecipients(value []DriveRecipientable)() {
    m.recipients = value
}
