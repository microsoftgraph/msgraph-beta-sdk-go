...
func (m *CommunicationsApplicationInstanceIdentity) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CommunicationsApplicationInstanceIdentity) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
