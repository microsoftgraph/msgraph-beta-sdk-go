...
func NewCustomExtensionAuthenticationConfiguration()(*CustomExtensionAuthenticationConfiguration) {
    ...
    odatatypeValue := "#microsoft.graph.customExtensionAuthenticationConfiguration";
...
func (m *CustomExtensionAuthenticationConfiguration) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *CustomExtensionAuthenticationConfiguration) SetType(value *string)() {
    if m != nil {
