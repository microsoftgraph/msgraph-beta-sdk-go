...
func (m *Credential) GetAdditionalData()(map[string]any) {
...
func (m *Credential) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
// GetTypeEscaped gets the type property value. The type for this credential. Valid values: username, password, or other.
// returns a *string when successful
func (m *Credential) GetTypeEscaped()(*string) {
...
func (m *Credential) SetAdditionalData(value map[string]any)() {
...
func (m *Credential) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
// SetTypeEscaped sets the type property value. The type for this credential. Valid values: username, password, or other.
func (m *Credential) SetTypeEscaped(value *string)() {
