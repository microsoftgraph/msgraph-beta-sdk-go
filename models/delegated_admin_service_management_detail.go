...
func (m *DelegatedAdminServiceManagementDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DelegatedAdminServiceManagementDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
