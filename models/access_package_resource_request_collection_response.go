...
func (m *AccessPackageResourceRequestCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessPackageResourceRequestCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
