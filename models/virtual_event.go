...
func (m *VirtualEvent) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["isRegistrationEnabled"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetBoolValue()
        if err != nil {
            return err
        }
        if val != nil {
            m.SetIsRegistrationEnabled(val)
        }
        return nil
    }
...
// GetIsRegistrationEnabled gets the isRegistrationEnabled property value. The isRegistrationEnabled property
...
// GetIsRegistrationRequired gets the isRegistrationRequired property value. Indicates whether attendee registration is enabled for the virtual event.
// returns a *bool when successful
...
func (m *VirtualEvent) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err = writer.WriteBoolValue("isRegistrationEnabled", m.GetIsRegistrationEnabled())
        if err != nil {
            return err
        }
    }
...
// SetIsRegistrationEnabled sets the isRegistrationEnabled property value. The isRegistrationEnabled property
func (m *VirtualEvent) SetIsRegistrationEnabled(value *bool)() {
    err := m.GetBackingStore().Set("isRegistrationEnabled", value)
    if err != nil {
        panic(err)
    }
}
// SetIsRegistrationRequired sets the isRegistrationRequired property value. Indicates whether attendee registration is enabled for the virtual event.
