...
func (m *AccessReviewInstanceDecisionItemServicePrincipalResource) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessReviewInstanceDecisionItemServicePrincipalResource) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
