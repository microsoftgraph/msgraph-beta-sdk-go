...
// GetLayout gets the layout property value. Possible values are: horizontal, diagonal.
...
// SetLayout sets the layout property value. Possible values are: horizontal, diagonal.
