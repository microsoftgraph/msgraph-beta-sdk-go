...
func (m *User) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["security"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(CreateSecurityFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetSecurity(val.(Securityable))
        }
        return nil
    }
...
func (m *User) GetSecurity()(Securityable) {
    if m == nil {
        return nil
    } else {
        return m.security
...
func (m *User) SetSecurity(value Securityable)() {
    if m != nil {
        m.security = value
    }
}
