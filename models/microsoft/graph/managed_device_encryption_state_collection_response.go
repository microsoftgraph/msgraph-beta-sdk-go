...
// ManagedDeviceEncryptionStateCollectionResponse provides operations to manage the managedDeviceEncryptionStates property of the microsoft.graph.deviceManagement entity.
...
func (m *ManagedDeviceEncryptionStateCollectionResponse) IsNil()(bool) {
    return m == nil
}
