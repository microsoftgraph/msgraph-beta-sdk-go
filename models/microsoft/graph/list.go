...
// List provides operations to manage the deviceManagement singleton.
type List struct {
    BaseItem
...
func (m *List) GetActivities()([]ItemActivityOLDable) {
    if m == nil {
        return nil
    } else {
        return m.activities
...
func (m *List) SetActivities(value []ItemActivityOLDable)() {
    if m != nil {
        m.activities = value
    }
}
