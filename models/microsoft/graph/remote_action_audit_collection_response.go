...
// RemoteActionAuditCollectionResponse provides operations to manage the remoteActionAudits property of the microsoft.graph.deviceManagement entity.
...
func (m *RemoteActionAuditCollectionResponse) IsNil()(bool) {
    return m == nil
}
