...
func (m *ManagedDeviceMobileAppConfigurationSettingState) GetErrorCode()(*int32) {
    if m == nil {
        return nil
    } else {
        return m.errorCode
...
func (m *ManagedDeviceMobileAppConfigurationSettingState) SetErrorCode(value *int32)() {
    if m != nil {
        m.errorCode = value
    }
}
