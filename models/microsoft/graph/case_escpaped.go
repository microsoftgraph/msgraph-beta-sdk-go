...
func NewCase_escpaped()(*Case_escpaped) {
    m := &Case_escpaped{
        Entity: *NewEntity(),
    }
    return m
}
func (m *Case_escpaped) GetClosedBy()(*IdentitySet) {
    if m == nil {
        return nil
    } else {
        return m.closedBy
...
func (m *Case_escpaped) GetClosedDateTime()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    if m == nil {
        return nil
    } else {
...
func (m *Case_escpaped) GetCreatedDateTime()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    if m == nil {
        return nil
    } else {
...
func (m *Case_escpaped) GetCustodians()([]Custodian) {
    if m == nil {
        return nil
    } else {
        return m.custodians
...
func (m *Case_escpaped) GetDescription()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *Case_escpaped) GetDisplayName()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *Case_escpaped) GetExternalId()(*string) {
    if m == nil {
        return nil
    } else {
        return m.externalId
...
func (m *Case_escpaped) GetLastModifiedBy()(*IdentitySet) {
    if m == nil {
        return nil
    } else {
...
func (m *Case_escpaped) GetLastModifiedDateTime()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    if m == nil {
        return nil
    } else {
...
func (m *Case_escpaped) GetLegalHolds()([]LegalHold) {
    if m == nil {
        return nil
    } else {
        return m.legalHolds
...
func (m *Case_escpaped) GetNoncustodialDataSources()([]NoncustodialDataSource) {
    if m == nil {
        return nil
    } else {
...
func (m *Case_escpaped) GetOperations()([]CaseOperation) {
    if m == nil {
        return nil
    } else {
        return m.operations
...
func (m *Case_escpaped) GetReviewSets()([]ReviewSet) {
    if m == nil {
        return nil
    } else {
        return m.reviewSets
...
func (m *Case_escpaped) GetSettings()(*Settings) {
    if m == nil {
        return nil
    } else {
        return m.settings
...
func (m *Case_escpaped) GetSourceCollections()([]SourceCollection) {
    if m == nil {
        return nil
    } else {
...
func (m *Case_escpaped) GetStatus()(*i2756dc8c91c60abdde0aa43bf23ca1c0a6ac9b630146e89b7184e174a72c2de3.CaseStatus) {
    if m == nil {
        return nil
    } else {
        return m.status
...
func (m *Case_escpaped) GetTags()([]Tag) {
    if m == nil {
        return nil
    } else {
        return m.tags
...
func (m *Case_escpaped) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
...
func (m *Case_escpaped) IsNil()(bool) {
    return m == nil
}
func (m *Case_escpaped) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
...
func (m *Case_escpaped) SetClosedBy(value *IdentitySet)() {
    m.closedBy = value
}
func (m *Case_escpaped) SetClosedDateTime(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.closedDateTime = value
}
func (m *Case_escpaped) SetCreatedDateTime(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.createdDateTime = value
}
func (m *Case_escpaped) SetCustodians(value []Custodian)() {
    m.custodians = value
}
func (m *Case_escpaped) SetDescription(value *string)() {
    m.description = value
}
func (m *Case_escpaped) SetDisplayName(value *string)() {
    m.displayName = value
}
func (m *Case_escpaped) SetExternalId(value *string)() {
    m.externalId = value
}
func (m *Case_escpaped) SetLastModifiedBy(value *IdentitySet)() {
    m.lastModifiedBy = value
}
func (m *Case_escpaped) SetLastModifiedDateTime(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.lastModifiedDateTime = value
}
func (m *Case_escpaped) SetLegalHolds(value []LegalHold)() {
    m.legalHolds = value
}
func (m *Case_escpaped) SetNoncustodialDataSources(value []NoncustodialDataSource)() {
    m.noncustodialDataSources = value
}
func (m *Case_escpaped) SetOperations(value []CaseOperation)() {
    m.operations = value
}
func (m *Case_escpaped) SetReviewSets(value []ReviewSet)() {
    m.reviewSets = value
}
func (m *Case_escpaped) SetSettings(value *Settings)() {
    m.settings = value
}
func (m *Case_escpaped) SetSourceCollections(value []SourceCollection)() {
    m.sourceCollections = value
}
func (m *Case_escpaped) SetStatus(value *i2756dc8c91c60abdde0aa43bf23ca1c0a6ac9b630146e89b7184e174a72c2de3.CaseStatus)() {
    m.status = value
}
func (m *Case_escpaped) SetTags(value []Tag)() {
    m.tags = value
}
