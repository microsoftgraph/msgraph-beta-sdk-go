...
// GetId gets the id property value. Identity of the contact within Azure Active Directory.
...
// SetId sets the id property value. Identity of the contact within Azure Active Directory.
