...
const (
    ...
    WINDOWSMANAGEMENTCLOUDAPI_MANAGEMENTAGENTTYPE
    INTUNEAOSP_MANAGEMENTAGENTTYPE
)

func (i ManagementAgentType) String() string {
    return []string{"EAS", "MDM", "EASMDM", "INTUNECLIENT", "EASINTUNECLIENT", "CONFIGURATIONMANAGERCLIENT", "CONFIGURATIONMANAGERCLIENTMDM", "CONFIGURATIONMANAGERCLIENTMDMEAS", "UNKNOWN", "JAMF", "GOOGLECLOUDDEVICEPOLICYCONTROLLER", "MICROSOFT365MANAGEDMDM", "WINDOWSMANAGEMENTCLOUDAPI", "INTUNEAOSP"}[i]
}
func ParseManagementAgentType(v string) (interface{}, error) {
    switch strings.ToUpper(v) {
        ...
        case "WINDOWSMANAGEMENTCLOUDAPI":
            return WINDOWSMANAGEMENTCLOUDAPI_MANAGEMENTAGENTTYPE, nil
        case "INTUNEAOSP":
