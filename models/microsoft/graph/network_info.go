...
type NetworkInfo struct {
    ...
    connectionType *if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.NetworkConnectionType;
    ...
    wifiBand *if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.WifiBand;
    ...
    wifiRadioType *if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.WifiRadioType;
...
func (m *NetworkInfo) GetConnectionType()(*if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.NetworkConnectionType) {
    if m == nil {
        return nil
    } else {
...
func (m *NetworkInfo) GetWifiBand()(*if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.WifiBand) {
    if m == nil {
        return nil
    } else {
        return m.wifiBand
...
func (m *NetworkInfo) GetWifiRadioType()(*if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.WifiRadioType) {
    if m == nil {
        return nil
    } else {
...
func (m *NetworkInfo) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["connectionType"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetEnumValue(if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.ParseNetworkConnectionType)
        if err != nil {
            return err
        }
        if val != nil {
    ...
    res["wifiBand"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetEnumValue(if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.ParseWifiBand)
        if err != nil {
            return err
        }
        if val != nil {
    ...
    res["wifiRadioType"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetEnumValue(if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.ParseWifiRadioType)
        if err != nil {
            return err
        }
        if val != nil {
...
func (m *NetworkInfo) SetConnectionType(value *if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.NetworkConnectionType)() {
    if m != nil {
...
func (m *NetworkInfo) SetWifiBand(value *if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.WifiBand)() {
    if m != nil {
        m.wifiBand = value
    }
}
...
func (m *NetworkInfo) SetWifiRadioType(value *if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.WifiRadioType)() {
    if m != nil {
