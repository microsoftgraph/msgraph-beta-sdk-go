...
// DeviceConfigurationSettingState provides operations to manage the compliance singleton.
...
func (m *DeviceConfigurationSettingState) GetSettingInstanceId()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceConfigurationSettingState) SetSettingInstanceId(value *string)() {
    if m != nil {
