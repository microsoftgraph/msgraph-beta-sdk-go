...
// StringKeyLongValuePair provides operations to manage the collection of application entities.
...
func CreateStringKeyLongValuePairFromDiscriminatorValue(parseNode i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable, error) {
...
func (m *StringKeyLongValuePair) GetValue()(*int32) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *StringKeyLongValuePair) SetValue(value *int32)() {
    if m != nil {
        m.value = value
    }
}
