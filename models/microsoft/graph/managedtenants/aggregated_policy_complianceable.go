...
type AggregatedPolicyComplianceable interface {
    ...
    GetNumberOfCompliantDevices()(*int32)
    GetNumberOfErrorDevices()(*int32)
    GetNumberOfNonCompliantDevices()(*int32)
    ...
    SetNumberOfCompliantDevices(value *int32)()
    SetNumberOfErrorDevices(value *int32)()
    SetNumberOfNonCompliantDevices(value *int32)()
