...
// TenantGroupCollectionResponse provides operations to manage the tenantGroups property of the microsoft.graph.managedTenants.managedTenant entity.
...
func (m *TenantGroupCollectionResponse) IsNil()(bool) {
    return m == nil
}
