...
func (m *ConditionalAccessRoot) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["authenticationContextClassReferences"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewAuthenticationContextClassReference() })
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]AuthenticationContextClassReference, len(val))
            for i, v := range val {
                res[i] = *(v.(*AuthenticationContextClassReference))
            }
