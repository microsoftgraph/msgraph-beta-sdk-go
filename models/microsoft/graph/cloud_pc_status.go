...
func (i CloudPcStatus) String() string {
    return []string{"NOTPROVISIONED", "PROVISIONING", "PROVISIONED", "INGRACEPERIOD", "DEPROVISIONING", "FAILED", "PROVISIONEDWITHWARNINGS", "RESIZING", "PENDINGPROVISION", "UNKNOWNFUTUREVALUE"}[i]
}
