...
func (i ConditionalAccessConditions) String() string {
    return []string{"NONE", "APPLICATION", "USERS", "DEVICEPLATFORM", "LOCATION", "CLIENTTYPE", "SIGNINRISK", "USERRISK", "TIME", "DEVICESTATE", "CLIENT", "IPADDRESSSEENBYAZUREAD", "IPADDRESSSEENBYRESOURCEPROVIDER", "UNKNOWNFUTUREVALUE"}[i]
}
