...
// SalesCreditMemoLineCollectionResponse provides operations to manage the salesCreditMemoLines property of the microsoft.graph.company entity.
...
func (m *SalesCreditMemoLineCollectionResponse) IsNil()(bool) {
    return m == nil
}
