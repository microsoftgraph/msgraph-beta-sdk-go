...
// GetStatusInfo gets the statusInfo property value. 
func (m *ProvisioningObjectSummary) GetStatusInfo()(*StatusBase) {
    if m == nil {
        return nil
    } else {
        return m.statusInfo
...
func (m *ProvisioningObjectSummary) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["statusInfo"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewStatusBase() })
        if err != nil {
            return err
        }
        if val != nil {
            m.SetStatusInfo(val.(*StatusBase))
        }
        return nil
    }
...
// SetStatusInfo sets the statusInfo property value. 
func (m *ProvisioningObjectSummary) SetStatusInfo(value *StatusBase)() {
    if m != nil {
        m.statusInfo = value
    }
}
