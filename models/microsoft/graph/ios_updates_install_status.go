...
func ParseIosUpdatesInstallStatus(v string) (interface{}, error) {
    switch strings.ToUpper(v) {
        ...
        case "TIMEOUT":
            return TIMEOUT_IOSUPDATESINSTALLSTATUS, nil
        case "MDMCLIENTCRASHED":
            return MDMCLIENTCRASHED_IOSUPDATESINSTALLSTATUS, nil
        case "SUCCESS":
