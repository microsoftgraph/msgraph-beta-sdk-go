...
func ParseDeviceEnrollmentType(v string) (interface{}, error) {
    switch strings.ToUpper(v) {
        ...
        case "AZUREADJOINUSINGAZUREVMEXTENSION":
            return AZUREADJOINUSINGAZUREVMEXTENSION_DEVICEENROLLMENTTYPE, nil
        case "ANDROIDENTERPRISEDEDICATEDDEVICE":
            return ANDROIDENTERPRISEDEDICATEDDEVICE_DEVICEENROLLMENTTYPE, nil
        case "ANDROIDENTERPRISEFULLYMANAGED":
            return ANDROIDENTERPRISEFULLYMANAGED_DEVICEENROLLMENTTYPE, nil
        case "ANDROIDENTERPRISECORPORATEWORKPROFILE":
            return ANDROIDENTERPRISECORPORATEWORKPROFILE_DEVICEENROLLMENTTYPE, nil
    }
