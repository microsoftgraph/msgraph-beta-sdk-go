...
// Office365ActiveUserCounts provides operations to call the getOffice365ActiveUserCounts method.
...
func CreateOffice365ActiveUserCountsFromDiscriminatorValue(parseNode i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable, error) {
...
func (m *Office365ActiveUserCounts) GetExchange()(*int32) {
    if m == nil {
        return nil
    } else {
        return m.exchange
...
func (m *Office365ActiveUserCounts) GetOffice365()(*int32) {
    if m == nil {
        return nil
    } else {
        return m.office365
...
func (m *Office365ActiveUserCounts) GetOneDrive()(*int32) {
    if m == nil {
        return nil
    } else {
        return m.oneDrive
...
func (m *Office365ActiveUserCounts) GetSharePoint()(*int32) {
    if m == nil {
        return nil
    } else {
        return m.sharePoint
...
func (m *Office365ActiveUserCounts) GetSkypeForBusiness()(*int32) {
    if m == nil {
        return nil
    } else {
...
func (m *Office365ActiveUserCounts) GetTeams()(*int32) {
    if m == nil {
        return nil
    } else {
        return m.teams
...
func (m *Office365ActiveUserCounts) GetYammer()(*int32) {
    if m == nil {
        return nil
    } else {
        return m.yammer
...
func (m *Office365ActiveUserCounts) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    ...
    {
        err = writer.WriteInt32Value("exchange", m.GetExchange())
        if err != nil {
            return err
        }
    }
    {
        err = writer.WriteInt32Value("office365", m.GetOffice365())
        if err != nil {
            return err
        }
    }
    {
        err = writer.WriteInt32Value("oneDrive", m.GetOneDrive())
        if err != nil {
            return err
        }
    }
    ...
    {
        err = writer.WriteInt32Value("sharePoint", m.GetSharePoint())
        if err != nil {
            return err
        }
    }
    {
        err = writer.WriteInt32Value("skypeForBusiness", m.GetSkypeForBusiness())
        if err != nil {
            return err
        }
    }
    ...
    {
        err = writer.WriteInt32Value("yammer", m.GetYammer())
        if err != nil {
            return err
        }
    }
...
func (m *Office365ActiveUserCounts) SetExchange(value *int32)() {
    if m != nil {
        m.exchange = value
    }
}
...
func (m *Office365ActiveUserCounts) SetOffice365(value *int32)() {
    if m != nil {
        m.office365 = value
    }
}
...
func (m *Office365ActiveUserCounts) SetOneDrive(value *int32)() {
    if m != nil {
        m.oneDrive = value
    }
}
...
func (m *Office365ActiveUserCounts) SetSharePoint(value *int32)() {
    if m != nil {
        m.sharePoint = value
    }
}
...
func (m *Office365ActiveUserCounts) SetSkypeForBusiness(value *int32)() {
    if m != nil {
...
func (m *Office365ActiveUserCounts) SetTeams(value *int32)() {
    if m != nil {
        m.teams = value
    }
}
...
func (m *Office365ActiveUserCounts) SetYammer(value *int32)() {
    if m != nil {
        m.yammer = value
    }
}
