...
// Set provides operations to manage the deviceManagement singleton.
type Set struct {
...
func (m *Set) GetProperties()([]i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.KeyValueable) {
    if m == nil {
        return nil
    } else {
        return m.properties
...
func (m *Set) SetProperties(value []i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.KeyValueable)() {
    if m != nil {
        m.properties = value
    }
}
