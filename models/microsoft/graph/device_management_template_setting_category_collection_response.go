...
// DeviceManagementTemplateSettingCategoryCollectionResponse provides operations to manage the categories property of the microsoft.graph.deviceManagementTemplate entity.
...
func (m *DeviceManagementTemplateSettingCategoryCollectionResponse) IsNil()(bool) {
    return m == nil
}
