...
// DeviceConfigurationDeviceOverview provides operations to manage the deviceManagement singleton.
...
func (m *DeviceConfigurationDeviceOverview) GetConflictCount()(*int32) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceConfigurationDeviceOverview) GetNotApplicablePlatformCount()(*int32) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceConfigurationDeviceOverview) SetConflictCount(value *int32)() {
    if m != nil {
...
func (m *DeviceConfigurationDeviceOverview) SetNotApplicablePlatformCount(value *int32)() {
    if m != nil {
