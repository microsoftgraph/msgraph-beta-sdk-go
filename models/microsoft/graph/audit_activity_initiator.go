...
func (m *AuditActivityInitiator) GetUser()(*AuditUserIdentity) {
    if m == nil {
        return nil
    } else {
        return m.user
...
func (m *AuditActivityInitiator) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["user"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewAuditUserIdentity() })
        if err != nil {
            return err
        }
        if val != nil {
            m.SetUser(val.(*AuditUserIdentity))
        }
        return nil
    }
    return res
...
func (m *AuditActivityInitiator) SetUser(value *AuditUserIdentity)() {
    if m != nil {
        m.user = value
    }
}
