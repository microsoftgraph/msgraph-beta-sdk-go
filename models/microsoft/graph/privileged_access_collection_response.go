...
// PrivilegedAccessCollectionResponse provides operations to manage the collection of privilegedAccess entities.
...
func (m *PrivilegedAccessCollectionResponse) IsNil()(bool) {
    return m == nil
}
