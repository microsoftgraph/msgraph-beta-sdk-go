...
func (m *Education) GetSynchronizationProfiles()([]EducationSynchronizationProfile) {
    if m == nil {
        return nil
    } else {
...
func (m *Education) SetSynchronizationProfiles(value []EducationSynchronizationProfile)() {
