...
type CallRecord struct {
    ...
    modalities []if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.Modality;
...
func (m *CallRecord) GetModalities()([]if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.Modality) {
    if m == nil {
        return nil
    } else {
        return m.modalities
...
func (m *CallRecord) GetType()(*if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.CallType) {
    if m == nil {
        return nil
    } else {
...
func (m *CallRecord) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["modalities"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetCollectionOfEnumValues(if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.ParseModality)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.Modality, len(val))
            for i, v := range val {
                res[i] = *(v.(*if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.Modality))
            }
            m.SetModalities(res)
        }
        return nil
    ...
    res["type"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        ...
        if val != nil {
            m.SetType(val.(*if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.CallType))
        }
        return nil
    }
...
func (m *CallRecord) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    ...
    if m.GetModalities() != nil {
        err = writer.WriteCollectionOfStringValues("modalities", if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.SerializeModality(m.GetModalities()))
        if err != nil {
            return err
        }
    }
...
func (m *CallRecord) SetModalities(value []if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.Modality)() {
    if m != nil {
        m.modalities = value
    }
}
...
func (m *CallRecord) SetType(value *if9792b9f78e4933d4010103471e3a29a1979828da75ed72eb040984ee8d10c0f.CallType)() {
    if m != nil {
