...
// MobilityManagementPolicyCollectionResponse provides operations to manage the collection of mobilityManagementPolicy entities.
...
func (m *MobilityManagementPolicyCollectionResponse) IsNil()(bool) {
    return m == nil
}
