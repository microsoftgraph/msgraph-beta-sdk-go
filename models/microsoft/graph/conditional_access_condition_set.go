...
func (m *ConditionalAccessConditionSet) GetDeviceStates()(*ConditionalAccessDeviceStates) {
    if m == nil {
        return nil
    } else {
...
func (m *ConditionalAccessConditionSet) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["clientApplications"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewConditionalAccessClientApplications() })
        if err != nil {
            return err
        }
        if val != nil {
            m.SetClientApplications(val.(*ConditionalAccessClientApplications))
        }
        return nil
    }
    ...
    res["deviceStates"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewConditionalAccessDeviceStates() })
        if err != nil {
            return err
        }
        if val != nil {
            m.SetDeviceStates(val.(*ConditionalAccessDeviceStates))
        }
        return nil
    }
...
func (m *ConditionalAccessConditionSet) SetDeviceStates(value *ConditionalAccessDeviceStates)() {
    if m != nil {
