...
// ParticipantInfo provides operations to manage the commsApplication singleton.
...
// GetPlatformId gets the platformId property value. The client platform ID of the participant. Read-only.
func (m *ParticipantInfo) GetPlatformId()(*string) {
    if m == nil {
        return nil
    } else {
        return m.platformId
...
func (m *ParticipantInfo) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    ...
    {
        err := writer.WriteStringValue("platformId", m.GetPlatformId())
        if err != nil {
            return err
        }
    }
...
// SetPlatformId sets the platformId property value. The client platform ID of the participant. Read-only.
func (m *ParticipantInfo) SetPlatformId(value *string)() {
    if m != nil {
        m.platformId = value
    }
}
