...
// UserExperienceAnalyticsBaselineCollectionResponse provides operations to manage the userExperienceAnalyticsBaselines property of the microsoft.graph.deviceManagement entity.
...
func (m *UserExperienceAnalyticsBaselineCollectionResponse) IsNil()(bool) {
    return m == nil
}
