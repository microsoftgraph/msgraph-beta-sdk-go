...
func (m *PlannerPlan) GetContainer()(*PlannerPlanContainer) {
    if m == nil {
        return nil
    } else {
        return m.container
...
func (m *PlannerPlan) GetContexts()(*PlannerPlanContextCollection) {
    if m == nil {
        return nil
    } else {
        return m.contexts
...
func (m *PlannerPlan) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["container"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewPlannerPlanContainer() })
        if err != nil {
            return err
        }
        if val != nil {
    ...
    res["contexts"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewPlannerPlanContextCollection() })
        if err != nil {
            return err
        }
        if val != nil {
...
func (m *PlannerPlan) SetContainer(value *PlannerPlanContainer)() {
    if m != nil {
        m.container = value
    }
}
...
func (m *PlannerPlan) SetContexts(value *PlannerPlanContextCollection)() {
    if m != nil {
        m.contexts = value
    }
}
