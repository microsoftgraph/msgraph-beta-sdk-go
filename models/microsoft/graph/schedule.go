...
// GetTimeCards gets the timeCards property value. 
...
// GetTimeClockSettings gets the timeClockSettings property value. 
...
func (m *Schedule) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["timeCards"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewTimeCard() })
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]TimeCard, len(val))
            for i, v := range val {
                res[i] = *(v.(*TimeCard))
            }
            m.SetTimeCards(res)
    ...
    res["timeClockSettings"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewTimeClockSettings() })
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTimeClockSettings(val.(*TimeClockSettings))
        }
        return nil
    }
...
func (m *Schedule) Serialize(writer i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.SerializationWriter)(error) {
    ...
    if m.GetTimeCards() != nil {
        cast := make([]i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable, len(m.GetTimeCards()))
...
// SetTimeCards sets the timeCards property value. 
...
// SetTimeClockSettings sets the timeClockSettings property value. 
