...
// DeviceManagementIntentDeviceStateCollectionResponse provides operations to manage the deviceStates property of the microsoft.graph.deviceManagementIntent entity.
...
func (m *DeviceManagementIntentDeviceStateCollectionResponse) IsNil()(bool) {
    return m == nil
}
