...
// CustomerPaymentJournalCollectionResponse provides operations to manage the customerPaymentJournals property of the microsoft.graph.company entity.
...
func (m *CustomerPaymentJournalCollectionResponse) IsNil()(bool) {
    return m == nil
}
