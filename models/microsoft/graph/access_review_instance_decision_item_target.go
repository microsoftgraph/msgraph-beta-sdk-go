...
// AccessReviewInstanceDecisionItemTarget provides operations to manage the deviceManagement singleton.
type AccessReviewInstanceDecisionItemTarget struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]interface{};
}
// NewAccessReviewInstanceDecisionItemTarget instantiates a new accessReviewInstanceDecisionItemTarget and sets the default values.
...
func CreateAccessReviewInstanceDecisionItemTargetFromDiscriminatorValue(parseNode i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable, error) {
    return NewAccessReviewInstanceDecisionItemTarget(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *AccessReviewInstanceDecisionItemTarget) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessReviewInstanceDecisionItemTarget) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
