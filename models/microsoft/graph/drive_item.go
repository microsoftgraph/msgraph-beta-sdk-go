...
func (m *DriveItem) GetActivities()([]ItemActivityOLD) {
    if m == nil {
        return nil
    } else {
        return m.activities
...
func (m *DriveItem) GetMedia()(*Media) {
    if m == nil {
        return nil
    } else {
        return m.media
...
func (m *DriveItem) GetPackage()(*Package) {
    if m == nil {
        return nil
    } else {
        return m.package
...
func (m *DriveItem) GetSource()(*DriveItemSource) {
    if m == nil {
        return nil
    } else {
        return m.source
...
func (m *DriveItem) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["media"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewMedia() })
        if err != nil {
            return err
        }
        if val != nil {
    ...
    res["source"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetObjectValue(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewDriveItemSource() })
        if err != nil {
            return err
        }
        if val != nil {
            m.SetSource(val.(*DriveItemSource))
        }
        return nil
    }
...
func (m *DriveItem) SetActivities(value []ItemActivityOLD)() {
    if m != nil {
        m.activities = value
    }
}
...
func (m *DriveItem) SetPackage(value *Package)() {
    if m != nil {
        m.package = value
    }
}
...
func (m *DriveItem) SetSource(value *DriveItemSource)() {
    if m != nil {
        m.source = value
    }
}
