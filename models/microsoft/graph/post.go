...
// GetMentions gets the mentions property value. 
func (m *Post) GetMentions()([]Mention) {
    if m == nil {
        return nil
    } else {
        return m.mentions
...
// SetMentions sets the mentions property value. 
func (m *Post) SetMentions(value []Mention)() {
    if m != nil {
        m.mentions = value
    }
}
