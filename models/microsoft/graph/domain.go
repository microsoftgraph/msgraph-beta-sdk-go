...
// GetSharedEmailDomainInvitations gets the sharedEmailDomainInvitations property value. 
func (m *Domain) GetSharedEmailDomainInvitations()([]SharedEmailDomainInvitation) {
    if m == nil {
        return nil
    } else {
...
func (m *Domain) GetFieldDeserializers()(map[string]func(interface{}, i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode)(error)) {
    ...
    res["sharedEmailDomainInvitations"] = func (o interface{}, n i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewSharedEmailDomainInvitation() })
        if err != nil {
            return err
        }
        if val != nil {
...
// SetSharedEmailDomainInvitations sets the sharedEmailDomainInvitations property value. 
func (m *Domain) SetSharedEmailDomainInvitations(value []SharedEmailDomainInvitation)() {
    if m != nil {
