...
// GetAppType gets the appType property value. The app type. Possible values are: unknown, store, desktop, aumId.
...
// GetStartLayoutTileSize gets the startLayoutTileSize property value. The app tile size for the start layout. Possible values are: hidden, small, medium, wide, large.
...
// SetAppType sets the appType property value. The app type. Possible values are: unknown, store, desktop, aumId.
...
// SetStartLayoutTileSize sets the startLayoutTileSize property value. The app tile size for the start layout. Possible values are: hidden, small, medium, wide, large.
