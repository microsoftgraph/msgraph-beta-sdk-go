...
func (m *IosLobAppProvisioningConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *IosLobAppProvisioningConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
