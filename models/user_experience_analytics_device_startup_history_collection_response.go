...
func (m *UserExperienceAnalyticsDeviceStartupHistoryCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsDeviceStartupHistoryCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
