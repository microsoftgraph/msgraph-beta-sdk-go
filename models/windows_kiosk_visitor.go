...
// WindowsKioskVisitor the user base class used to identify the account info for the kiosk configuration
...
func (m *WindowsKioskVisitor) GetOdataType()(*string) {
...
func (m *WindowsKioskVisitor) SetOdataType(value *string)() {
