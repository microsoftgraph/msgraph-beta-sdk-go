...
// SectionGroup provides operations to manage the collection of accessReview entities.
...
func (m *SectionGroup) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *SectionGroup) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
