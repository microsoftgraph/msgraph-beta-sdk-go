...
func (m *WindowsUpdateCatalogItemCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsUpdateCatalogItemCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
