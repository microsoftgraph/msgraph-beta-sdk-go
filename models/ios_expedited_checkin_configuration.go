...
func (m *IosExpeditedCheckinConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *IosExpeditedCheckinConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
