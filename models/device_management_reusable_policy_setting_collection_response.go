...
func (m *DeviceManagementReusablePolicySettingCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *DeviceManagementReusablePolicySettingCollectionResponse) SetOdataNextLink(value *string)() {
