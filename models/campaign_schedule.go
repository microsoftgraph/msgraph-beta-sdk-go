...
// NewCampaignSchedule instantiates a new CampaignSchedule and sets the default values.
func NewCampaignSchedule()(*CampaignSchedule) {
    m := &CampaignSchedule{
    }
...
// CreateCampaignScheduleFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateCampaignScheduleFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewCampaignSchedule(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *CampaignSchedule) GetAdditionalData()(map[string]any) {
...
func (m *CampaignSchedule) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["status"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseCampaignStatus)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetStatus(val.(*CampaignStatus))
        }
        return nil
    }
    return res
...
func (m *CampaignSchedule) GetOdataType()(*string) {
...
func (m *CampaignSchedule) GetStatus()(*CampaignStatus) {
    ...
    if val != nil {
        return val.(*CampaignStatus)
    }
    return nil
}
// Serialize serializes information the current object
func (m *CampaignSchedule) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *CampaignSchedule) SetAdditionalData(value map[string]any)() {
...
func (m *CampaignSchedule) SetOdataType(value *string)() {
...
type CampaignScheduleable interface {
    ...
    SetStatus(value *CampaignStatus)()
}
