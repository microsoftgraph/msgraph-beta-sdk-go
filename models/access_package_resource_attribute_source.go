...
func NewAccessPackageResourceAttributeSource()(*AccessPackageResourceAttributeSource) {
    ...
    typeValue := "#microsoft.graph.accessPackageResourceAttributeSource";
    m.SetType(&typeValue);
    return m
}
...
func (m *AccessPackageResourceAttributeSource) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessPackageResourceAttributeSource) SetType(value *string)() {
    if m != nil {
