...
// DeviceConfigurationUserOverview provides operations to manage the collection of accessReview entities.
...
func (m *DeviceConfigurationUserOverview) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceConfigurationUserOverview) GetConflictCount()(*int32) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceConfigurationUserOverview) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
...
func (m *DeviceConfigurationUserOverview) SetConflictCount(value *int32)() {
    if m != nil {
