...
func (m *DeviceManagementScriptAssignmentCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *DeviceManagementScriptAssignmentCollectionResponse) SetOdataNextLink(value *string)() {
