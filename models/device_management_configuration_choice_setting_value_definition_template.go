...
// returns a []DeviceManagementConfigurationOptionDefinitionTemplateable when successful
func (m *DeviceManagementConfigurationChoiceSettingValueDefinitionTemplate) GetAllowedOptions()([]DeviceManagementConfigurationOptionDefinitionTemplateable) {
    val, err := m.GetBackingStore().Get("allowedOptions")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.([]DeviceManagementConfigurationOptionDefinitionTemplateable)
    }
    return nil
}
// GetBackingStore gets the BackingStore property value. Stores model information.
// returns a BackingStore when successful
func (m *DeviceManagementConfigurationChoiceSettingValueDefinitionTemplate) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *DeviceManagementConfigurationChoiceSettingValueDefinitionTemplate) SetAllowedOptions(value []DeviceManagementConfigurationOptionDefinitionTemplateable)() {
    err := m.GetBackingStore().Set("allowedOptions", value)
    if err != nil {
        panic(err)
    }
}
// SetBackingStore sets the BackingStore property value. Stores model information.
func (m *DeviceManagementConfigurationChoiceSettingValueDefinitionTemplate) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
