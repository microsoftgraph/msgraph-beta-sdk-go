...
// DeviceComplianceUserOverview provides operations to manage the collection of accessReview entities.
...
func (m *DeviceComplianceUserOverview) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceComplianceUserOverview) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
