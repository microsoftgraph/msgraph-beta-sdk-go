...
func (m *RetentionEvent) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *RetentionEvent) GetCreatedBy()(IdentitySetable) {
    if m == nil {
        return nil
    } else {
        return m.createdBy
...
func (m *RetentionEvent) GetLastModifiedBy()(IdentitySetable) {
    if m == nil {
        return nil
    } else {
...
func (m *RetentionEvent) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
        m.additionalData = value
    }
}
// SetCreatedBy sets the createdBy property value. The user who created the retentionEvent.
func (m *RetentionEvent) SetCreatedBy(value IdentitySetable)() {
    if m != nil {
        m.createdBy = value
    }
}
...
func (m *RetentionEvent) SetLastModifiedBy(value IdentitySetable)() {
    if m != nil {
