...
func (m *AndroidDeviceOwnerKioskModeWeblink) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceOwnerKioskModeWeblink) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
