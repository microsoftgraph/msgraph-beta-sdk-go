...
func (m *CallStartedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CallStartedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
