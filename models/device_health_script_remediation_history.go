...
func (m *DeviceHealthScriptRemediationHistory) GetAdditionalData()(map[string]any) {
...
func (m *DeviceHealthScriptRemediationHistory) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
// returns a []DeviceHealthScriptRemediationHistoryDataable when successful
func (m *DeviceHealthScriptRemediationHistory) GetHistoryData()([]DeviceHealthScriptRemediationHistoryDataable) {
    val, err := m.GetBackingStore().Get("historyData")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *DeviceHealthScriptRemediationHistory) SetAdditionalData(value map[string]any)() {
...
func (m *DeviceHealthScriptRemediationHistory) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *DeviceHealthScriptRemediationHistory) SetHistoryData(value []DeviceHealthScriptRemediationHistoryDataable)() {
    err := m.GetBackingStore().Set("historyData", value)
    if err != nil {
        panic(err)
    }
}
...
type DeviceHealthScriptRemediationHistoryable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackedModel
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetHistoryData()([]DeviceHealthScriptRemediationHistoryDataable)
    GetLastModifiedDateTime()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    GetOdataType()(*string)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetHistoryData(value []DeviceHealthScriptRemediationHistoryDataable)()
