...
func (m *WindowsQualityUpdateProfileAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsQualityUpdateProfileAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
