...
func (m *MacOSCredentialSingleSignOnExtension) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MacOSCredentialSingleSignOnExtension) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
