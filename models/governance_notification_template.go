...
func (m *GovernanceNotificationTemplate) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *GovernanceNotificationTemplate) GetCulture()(*string) {
    val, err := m.GetBackingStore().Get("culture")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *GovernanceNotificationTemplate) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *GovernanceNotificationTemplate) SetCulture(value *string)() {
    err := m.GetBackingStore().Set("culture", value)
    if err != nil {
        panic(err)
    }
}
