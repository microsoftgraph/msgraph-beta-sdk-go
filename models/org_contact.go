...
func (m *OrgContact) GetOdataType()(*string) {
...
// GetServiceProvisioningErrors gets the serviceProvisioningErrors property value. Errors published by a federated service describing a non-transient, service-specific error regarding the properties or link from an orgContact object .  Supports $filter (eq, not, for isResolved and serviceInstance).
...
// GetTransitiveReports gets the transitiveReports property value. The transitive reports for a contact. Read-only.
func (m *OrgContact) GetTransitiveReports()([]DirectoryObjectable) {
...
func (m *OrgContact) SetOdataType(value *string)() {
...
// SetServiceProvisioningErrors sets the serviceProvisioningErrors property value. Errors published by a federated service describing a non-transient, service-specific error regarding the properties or link from an orgContact object .  Supports $filter (eq, not, for isResolved and serviceInstance).
...
// SetTransitiveReports sets the transitiveReports property value. The transitive reports for a contact. Read-only.
func (m *OrgContact) SetTransitiveReports(value []DirectoryObjectable)() {
