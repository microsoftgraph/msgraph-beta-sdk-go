...
func (m *Calendar) GetCalendarGroupId()(*string) {
    val, err := m.GetBackingStore().Get("calendarGroupId")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *Calendar) GetIsSharedWithMe()(*bool) {
    val, err := m.GetBackingStore().Get("isSharedWithMe")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *Calendar) SetCalendarGroupId(value *string)() {
    err := m.GetBackingStore().Set("calendarGroupId", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *Calendar) SetIsSharedWithMe(value *bool)() {
    err := m.GetBackingStore().Set("isSharedWithMe", value)
    if err != nil {
        panic(err)
    }
}
