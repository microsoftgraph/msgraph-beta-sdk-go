...
func (m *MacOSSoftwareUpdateStateSummaryCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *MacOSSoftwareUpdateStateSummaryCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
