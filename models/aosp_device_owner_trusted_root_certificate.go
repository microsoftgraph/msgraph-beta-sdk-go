...
func (m *AospDeviceOwnerTrustedRootCertificate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AospDeviceOwnerTrustedRootCertificate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
