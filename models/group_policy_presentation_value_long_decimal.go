...
func (m *GroupPolicyPresentationValueLongDecimal) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *GroupPolicyPresentationValueLongDecimal) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
