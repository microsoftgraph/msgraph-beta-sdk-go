...
func (m *AuthenticationCombinationConfigurationCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *AuthenticationCombinationConfigurationCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *AuthenticationCombinationConfigurationCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *AuthenticationCombinationConfigurationCollectionResponse) SetOdataNextLink(value *string)() {
