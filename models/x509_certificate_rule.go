...
// GetIssuerSubjectIdentifier gets the issuerSubjectIdentifier property value. The identifier of the certificate issuer.
// returns a *string when successful
...
// GetPolicyOidIdentifier gets the policyOidIdentifier property value. The identifier of the X.509 certificate policyOID.
// returns a *string when successful
...
// SetIssuerSubjectIdentifier sets the issuerSubjectIdentifier property value. The identifier of the certificate issuer.
...
// SetPolicyOidIdentifier sets the policyOidIdentifier property value. The identifier of the X.509 certificate policyOID.
