...
func (m *WindowsPhone81VpnConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsPhone81VpnConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
