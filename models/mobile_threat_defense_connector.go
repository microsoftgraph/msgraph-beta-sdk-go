...
// GetMacDeviceBlockedOnMissingPartnerData gets the macDeviceBlockedOnMissingPartnerData property value. For Mac, get or set whether Intune must receive data from the Mobile Threat Defense partner prior to marking a device compliant
func (m *MobileThreatDefenseConnector) GetMacDeviceBlockedOnMissingPartnerData()(*bool) {
    val, err := m.GetBackingStore().Get("macDeviceBlockedOnMissingPartnerData")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
// GetMacEnabled gets the macEnabled property value. For Mac, get or set whether data from the Mobile Threat Defense partner should be used during compliance evaluations
func (m *MobileThreatDefenseConnector) GetMacEnabled()(*bool) {
    val, err := m.GetBackingStore().Get("macEnabled")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *MobileThreatDefenseConnector) GetWindowsMobileApplicationManagementEnabled()(*bool) {
    val, err := m.GetBackingStore().Get("windowsMobileApplicationManagementEnabled")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
// SetMacDeviceBlockedOnMissingPartnerData sets the macDeviceBlockedOnMissingPartnerData property value. For Mac, get or set whether Intune must receive data from the Mobile Threat Defense partner prior to marking a device compliant
func (m *MobileThreatDefenseConnector) SetMacDeviceBlockedOnMissingPartnerData(value *bool)() {
    err := m.GetBackingStore().Set("macDeviceBlockedOnMissingPartnerData", value)
    if err != nil {
        panic(err)
    }
}
// SetMacEnabled sets the macEnabled property value. For Mac, get or set whether data from the Mobile Threat Defense partner should be used during compliance evaluations
func (m *MobileThreatDefenseConnector) SetMacEnabled(value *bool)() {
    err := m.GetBackingStore().Set("macEnabled", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *MobileThreatDefenseConnector) SetWindowsMobileApplicationManagementEnabled(value *bool)() {
    err := m.GetBackingStore().Set("windowsMobileApplicationManagementEnabled", value)
    if err != nil {
        panic(err)
    }
}
