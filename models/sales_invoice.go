...
// SalesInvoice provides operations to manage the collection of accessReview entities.
...
func (m *SalesInvoice) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *SalesInvoice) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
