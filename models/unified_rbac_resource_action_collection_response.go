...
func (m *UnifiedRbacResourceActionCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *UnifiedRbacResourceActionCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
