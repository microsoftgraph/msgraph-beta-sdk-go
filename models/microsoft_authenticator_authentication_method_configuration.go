...
func (m *MicrosoftAuthenticatorAuthenticationMethodConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MicrosoftAuthenticatorAuthenticationMethodConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
