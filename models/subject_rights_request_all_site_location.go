...
func (m *SubjectRightsRequestAllSiteLocation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *SubjectRightsRequestAllSiteLocation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
