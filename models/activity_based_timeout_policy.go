...
func (m *ActivityBasedTimeoutPolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ActivityBasedTimeoutPolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
