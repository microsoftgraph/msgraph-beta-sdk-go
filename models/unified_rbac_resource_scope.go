...
// UnifiedRbacResourceScope provides operations to manage the collection of accessReview entities.
...
func (m *UnifiedRbacResourceScope) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UnifiedRbacResourceScope) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
