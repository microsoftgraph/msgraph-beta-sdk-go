...
// EducationRubric provides operations to manage the collection of accessReview entities.
...
func (m *EducationRubric) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EducationRubric) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
