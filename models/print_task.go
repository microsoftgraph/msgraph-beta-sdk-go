...
// PrintTask provides operations to manage the collection of accessReview entities.
...
func (m *PrintTask) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PrintTask) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
