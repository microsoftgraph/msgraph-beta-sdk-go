...
func (m *ServiceAnnouncementAttachment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ServiceAnnouncementAttachment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
