...
func (m *TeamCreatedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TeamCreatedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
