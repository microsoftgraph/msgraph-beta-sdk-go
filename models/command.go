...
// Command provides operations to manage the collection of accessReview entities.
type Command struct {
    Entity
...
func (m *Command) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Command) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
