...
// DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody provides operations to call the assign method.
type DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody struct {
...
// NewDeviceManagementDeviceManagementScriptsItemAssignPostRequestBody instantiates a new DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody and sets the default values.
func NewDeviceManagementDeviceManagementScriptsItemAssignPostRequestBody()(*DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody) {
    m := &DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]interface{}));
    return m
}
// CreateDeviceManagementDeviceManagementScriptsItemAssignPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateDeviceManagementDeviceManagementScriptsItemAssignPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewDeviceManagementDeviceManagementScriptsItemAssignPostRequestBody(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody) GetDeviceManagementScriptAssignments()([]DeviceManagementScriptAssignmentable) {
...
func (m *DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody) GetDeviceManagementScriptGroupAssignments()([]DeviceManagementScriptGroupAssignmentable) {
    return m.deviceManagementScriptGroupAssignments
}
// GetFieldDeserializers the deserialization information for the current model
func (m *DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody) SetAdditionalData(value map[string]interface{})() {
...
func (m *DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody) SetDeviceManagementScriptAssignments(value []DeviceManagementScriptAssignmentable)() {
...
func (m *DeviceManagementDeviceManagementScriptsItemAssignPostRequestBody) SetDeviceManagementScriptGroupAssignments(value []DeviceManagementScriptGroupAssignmentable)() {
