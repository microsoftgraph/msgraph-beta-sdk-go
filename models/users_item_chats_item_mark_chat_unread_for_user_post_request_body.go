...
func (m *UsersItemChatsItemMarkChatUnreadForUserPostRequestBody) GetTenantId()(*string) {
    return m.tenantId
}
...
func (m *UsersItemChatsItemMarkChatUnreadForUserPostRequestBody) SetTenantId(value *string)() {
    m.tenantId = value
}
