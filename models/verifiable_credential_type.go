...
func (m *VerifiableCredentialType) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["issuers"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
func (m *VerifiableCredentialType) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
        err := writer.WriteStringValue("credentialType", m.GetCredentialType())
        if err != nil {
            return err
        }
    }
    if m.GetIssuers() != nil {
        err := writer.WriteCollectionOfStringValues("issuers", m.GetIssuers())
        if err != nil {
            return err
        }
    }
...
func (m *VerifiableCredentialType) SetAdditionalData(value map[string]any)() {
...
func (m *VerifiableCredentialType) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetCredentialType sets the credentialType property value. The type of credential issued, for example, BusinessCardCredential.
func (m *VerifiableCredentialType) SetCredentialType(value *string)() {
    err := m.GetBackingStore().Set("credentialType", value)
    if err != nil {
        panic(err)
    }
}
// SetIssuers sets the issuers property value. List of the accepted issuers authority as identified by the Microsoft Entra Verified ID service, for example, did:ion:EiAlrenrtD3Lsw0GlbzS1O2YFdy3Xtu8yo35W/<SNIP/>....
func (m *VerifiableCredentialType) SetIssuers(value []string)() {
    err := m.GetBackingStore().Set("issuers", value)
    if err != nil {
        panic(err)
    }
}
// SetOdataType sets the @odata.type property value. The OdataType property
func (m *VerifiableCredentialType) SetOdataType(value *string)() {
