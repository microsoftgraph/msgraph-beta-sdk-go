...
func (m *GroupPolicyPresentationText) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *GroupPolicyPresentationText) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
