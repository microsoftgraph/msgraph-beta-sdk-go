...
func (m *WindowsHelloForBusinessAuthenticationMethod) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsHelloForBusinessAuthenticationMethod) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
