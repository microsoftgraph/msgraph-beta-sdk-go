...
func (m *UsersItemChatsItemUnhideForUserPostRequestBody) GetTenantId()(*string) {
    return m.tenantId
}
...
func (m *UsersItemChatsItemUnhideForUserPostRequestBody) SetTenantId(value *string)() {
    m.tenantId = value
}
