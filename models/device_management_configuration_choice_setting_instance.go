...
func (m *DeviceManagementConfigurationChoiceSettingInstance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationChoiceSettingInstance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
