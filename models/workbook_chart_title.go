...
// WorkbookChartTitle provides operations to manage the collection of accessReview entities.
...
func (m *WorkbookChartTitle) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookChartTitle) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
