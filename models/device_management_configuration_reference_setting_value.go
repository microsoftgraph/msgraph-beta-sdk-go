...
func (m *DeviceManagementConfigurationReferenceSettingValue) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationReferenceSettingValue) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
