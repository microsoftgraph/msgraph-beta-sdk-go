...
func (m *ManagedDeviceMobileAppConfigurationState) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ManagedDeviceMobileAppConfigurationState) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
