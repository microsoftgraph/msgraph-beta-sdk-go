...
func (m *ManagedAllDeviceCertificateState) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ManagedAllDeviceCertificateState) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
