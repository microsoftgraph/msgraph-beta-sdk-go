...
// GetStatus gets the status property value. The possible values are: success, failure, skipped, warning, unknownFutureValue. Supports $filter (eq, contains).
...
// SetStatus sets the status property value. The possible values are: success, failure, skipped, warning, unknownFutureValue. Supports $filter (eq, contains).
