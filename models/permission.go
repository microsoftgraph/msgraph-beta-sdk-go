...
// Permission provides operations to manage the collection of accessReview entities.
...
func (m *Permission) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Permission) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
