...
// GetRoles gets the roles property value. The type of permission, for example, read. See the Roles property values section for the full list of roles. Read-only.
...
// SetRoles sets the roles property value. The type of permission, for example, read. See the Roles property values section for the full list of roles. Read-only.
