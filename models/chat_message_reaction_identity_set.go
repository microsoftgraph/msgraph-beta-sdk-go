...
func (m *ChatMessageReactionIdentitySet) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ChatMessageReactionIdentitySet) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
