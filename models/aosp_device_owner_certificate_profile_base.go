...
func (m *AospDeviceOwnerCertificateProfileBase) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AospDeviceOwnerCertificateProfileBase) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
