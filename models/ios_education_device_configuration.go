...
func (m *IosEducationDeviceConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *IosEducationDeviceConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
