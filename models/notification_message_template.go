...
func (m *NotificationMessageTemplate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *NotificationMessageTemplate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
