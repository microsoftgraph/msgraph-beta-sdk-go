...
// GetArtifactHitCount gets the artifactHitCount property value. The number of items that match the specified search criteria and were changed within the given time range.
...
// SetArtifactHitCount sets the artifactHitCount property value. The number of items that match the specified search criteria and were changed within the given time range.
