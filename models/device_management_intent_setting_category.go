...
func (m *DeviceManagementIntentSettingCategory) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementIntentSettingCategory) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
