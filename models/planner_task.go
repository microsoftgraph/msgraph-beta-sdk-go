...
// GetAppliedCategories gets the appliedCategories property value. The categories to which the task applies. See applied Categories for possible values.
...
// SetAppliedCategories sets the appliedCategories property value. The categories to which the task applies. See applied Categories for possible values.
