...
func (m *AttendeeAvailability) GetAvailability()(*AttendeeAvailability_availability) {
    val, err := m.GetBackingStore().Get("availability")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*AttendeeAvailability_availability)
    }
    return nil
}
...
func (m *AttendeeAvailability) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["availability"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseAttendeeAvailability_availability)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAvailability(val.(*AttendeeAvailability_availability))
        }
        return nil
    }
...
func (m *AttendeeAvailability) SetAvailability(value *AttendeeAvailability_availability)() {
...
type AttendeeAvailabilityable interface {
    ...
    GetAvailability()(*AttendeeAvailability_availability)
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetOdataType()(*string)
    SetAttendee(value AttendeeBaseable)()
    SetAvailability(value *AttendeeAvailability_availability)()
