...
type DriveExclusionUnit struct {
    ExclusionUnitBase
}
// NewDriveExclusionUnit instantiates a new DriveExclusionUnit and sets the default values.
func NewDriveExclusionUnit()(*DriveExclusionUnit) {
    m := &DriveExclusionUnit{
        ExclusionUnitBase: *NewExclusionUnitBase(),
    }
    odataTypeValue := "#microsoft.graph.driveExclusionUnit"
    m.SetOdataType(&odataTypeValue)
    return m
}
// CreateDriveExclusionUnitFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *DriveExclusionUnit) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *DriveExclusionUnit) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
type DriveExclusionUnitable interface {
