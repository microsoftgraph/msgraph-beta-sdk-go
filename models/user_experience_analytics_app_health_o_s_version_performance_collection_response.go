...
func (m *UserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
