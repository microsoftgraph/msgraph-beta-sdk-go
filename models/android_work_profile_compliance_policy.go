...
func (m *AndroidWorkProfileCompliancePolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidWorkProfileCompliancePolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
