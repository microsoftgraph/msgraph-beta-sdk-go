...
func (m *ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse) GetOdatanextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse) SetOdatanextLink(value *string)() {
    if m != nil {
        m.nextLink = value
    }
}
