...
// WorkbookWorksheetProtection provides operations to manage the collection of accessReview entities.
...
func (m *WorkbookWorksheetProtection) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookWorksheetProtection) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
