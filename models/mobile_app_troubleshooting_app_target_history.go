...
func (m *MobileAppTroubleshootingAppTargetHistory) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MobileAppTroubleshootingAppTargetHistory) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
