...
func (m *ChromeOSDeviceProperty) SetAdditionalData(value map[string]any)() {
...
func (m *ChromeOSDeviceProperty) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *ChromeOSDeviceProperty) SetUpdatable(value *bool)() {
    err := m.GetBackingStore().Set("updatable", value)
    if err != nil {
        panic(err)
    }
}
