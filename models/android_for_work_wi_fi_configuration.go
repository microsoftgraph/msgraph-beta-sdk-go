...
func (m *AndroidForWorkWiFiConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidForWorkWiFiConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
