...
func (m *AndroidForWorkGmailEasConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidForWorkGmailEasConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
