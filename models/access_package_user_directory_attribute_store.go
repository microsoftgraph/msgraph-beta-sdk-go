...
func (m *AccessPackageUserDirectoryAttributeStore) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessPackageUserDirectoryAttributeStore) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
