...
// UserTeamwork provides operations to manage the collection of accessReview entities.
...
func (m *UserTeamwork) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserTeamwork) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
