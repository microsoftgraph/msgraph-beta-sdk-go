...
func (m *TeamJoiningDisabledEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TeamJoiningDisabledEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
