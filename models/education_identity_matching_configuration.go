...
func (m *EducationIdentityMatchingConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EducationIdentityMatchingConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
