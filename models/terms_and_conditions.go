...
func (m *TermsAndConditions) GetGroupAssignments()([]TermsAndConditionsGroupAssignmentable) {
    ...
    if val != nil {
        return val.([]TermsAndConditionsGroupAssignmentable)
    }
    return nil
}
...
type TermsAndConditionsable interface {
    ...
    GetGroupAssignments()([]TermsAndConditionsGroupAssignmentable)
    ...
    SetGroupAssignments(value []TermsAndConditionsGroupAssignmentable)()
