...
func (m *MailboxSettings) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["userPurposeV2"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseMailboxSettings_userPurposeV2)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetUserPurposeV2(val.(*MailboxSettings_userPurposeV2))
        }
        return nil
    }
...
func (m *MailboxSettings) GetUserPurposeV2()(*MailboxSettings_userPurposeV2) {
    val, err := m.GetBackingStore().Get("userPurposeV2")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*MailboxSettings_userPurposeV2)
    }
    return nil
}
...
func (m *MailboxSettings) SetUserPurposeV2(value *MailboxSettings_userPurposeV2)() {
    err := m.GetBackingStore().Set("userPurposeV2", value)
    if err != nil {
        panic(err)
    }
}
...
type MailboxSettingsable interface {
    ...
    GetUserPurposeV2()(*MailboxSettings_userPurposeV2)
    ...
    SetUserPurposeV2(value *MailboxSettings_userPurposeV2)()
