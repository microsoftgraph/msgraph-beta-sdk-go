...
func (m *TeamTemplateDefinitionCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *TeamTemplateDefinitionCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *TeamTemplateDefinitionCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *TeamTemplateDefinitionCollectionResponse) SetOdataNextLink(value *string)() {
