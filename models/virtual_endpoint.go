...
// VirtualEndpoint provides operations to manage the collection of accessReview entities.
...
func (m *VirtualEndpoint) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *VirtualEndpoint) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
