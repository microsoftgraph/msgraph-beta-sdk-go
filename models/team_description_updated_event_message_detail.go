...
func (m *TeamDescriptionUpdatedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TeamDescriptionUpdatedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
