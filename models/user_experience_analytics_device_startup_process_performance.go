...
func (m *UserExperienceAnalyticsDeviceStartupProcessPerformance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsDeviceStartupProcessPerformance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
