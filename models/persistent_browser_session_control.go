...
func (m *PersistentBrowserSessionControl) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PersistentBrowserSessionControl) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
