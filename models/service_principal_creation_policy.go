...
func (m *ServicePrincipalCreationPolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ServicePrincipalCreationPolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
