...
func (m *DeviceManagementCompliancePolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementCompliancePolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
