...
func (m *WindowsDefenderScanActionResult) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsDefenderScanActionResult) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
