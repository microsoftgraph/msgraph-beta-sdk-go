...
// GetCreatedDateTime gets the createdDateTime property value. The date, time and timezone when the Service was created.
...
// GetLastUpdatedDateTime gets the lastUpdatedDateTime property value. The date, time and timezone when the Service  was last updated.
// returns a *Time when successful
...
// SetCreatedDateTime sets the createdDateTime property value. The date, time and timezone when the Service was created.
...
// SetLastUpdatedDateTime sets the lastUpdatedDateTime property value. The date, time and timezone when the Service  was last updated.
