...
func (m *UserExperienceAnalyticsDeviceStartupHistory) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsDeviceStartupHistory) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
