...
func (m *PrincipalResourceMembershipsScope) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PrincipalResourceMembershipsScope) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
