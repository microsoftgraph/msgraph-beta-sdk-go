...
func (m *ManagedAppPolicyDeploymentSummary) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ManagedAppPolicyDeploymentSummary) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
