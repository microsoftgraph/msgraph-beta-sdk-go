...
// GetChallenge gets the challenge property value. A Base64-encoded challenge generated by Microsoft Entra ID and sent back with the registration request to prevent replay attacks.
// returns a *string when successful
...
// SetChallenge sets the challenge property value. A Base64-encoded challenge generated by Microsoft Entra ID and sent back with the registration request to prevent replay attacks.
