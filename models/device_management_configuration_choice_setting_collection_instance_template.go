...
func (m *DeviceManagementConfigurationChoiceSettingCollectionInstanceTemplate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationChoiceSettingCollectionInstanceTemplate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
