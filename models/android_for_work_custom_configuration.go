...
func (m *AndroidForWorkCustomConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidForWorkCustomConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
