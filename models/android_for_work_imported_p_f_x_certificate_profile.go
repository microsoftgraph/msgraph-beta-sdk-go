...
func (m *AndroidForWorkImportedPFXCertificateProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidForWorkImportedPFXCertificateProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
