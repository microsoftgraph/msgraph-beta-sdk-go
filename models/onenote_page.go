...
// OnenotePage provides operations to manage the collection of accessReview entities.
...
func (m *OnenotePage) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *OnenotePage) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
