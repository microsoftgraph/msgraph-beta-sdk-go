...
// Item provides operations to manage the collection of accessReview entities.
type Item struct {
    Entity
...
func (m *Item) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Item) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
