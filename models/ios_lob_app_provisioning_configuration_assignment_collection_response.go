...
func (m *IosLobAppProvisioningConfigurationAssignmentCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *IosLobAppProvisioningConfigurationAssignmentCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
