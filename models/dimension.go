...
// Dimension provides operations to manage the collection of accessReview entities.
...
func (m *Dimension) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Dimension) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
