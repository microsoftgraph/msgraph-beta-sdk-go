...
func (m *KerberosSingleSignOnExtension) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *KerberosSingleSignOnExtension) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
