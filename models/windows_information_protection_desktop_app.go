...
func (m *WindowsInformationProtectionDesktopApp) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsInformationProtectionDesktopApp) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
