...
func (m *WindowsWiredNetworkConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsWiredNetworkConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
