...
func (m *IosLobAppProvisioningConfigurationPolicySetItem) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *IosLobAppProvisioningConfigurationPolicySetItem) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
