...
// WindowsKioskLocalGroup the user base class used to identify the account info for the kiosk configuration
...
func (m *WindowsKioskLocalGroup) GetOdataType()(*string) {
...
func (m *WindowsKioskLocalGroup) SetOdataType(value *string)() {
