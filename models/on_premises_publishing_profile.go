...
func (m *OnPremisesPublishingProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *OnPremisesPublishingProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
