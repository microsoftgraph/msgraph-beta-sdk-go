...
func (m *MachineLearningDetectedSensitiveContent) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MachineLearningDetectedSensitiveContent) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
