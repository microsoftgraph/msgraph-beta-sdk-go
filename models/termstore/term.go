...
// Term provides operations to manage the collection of accessReview entities.
type Term struct {
...
func (m *Term) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Term) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
