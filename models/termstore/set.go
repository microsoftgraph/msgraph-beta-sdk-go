...
// Set provides operations to manage the collection of accessReview entities.
type Set struct {
...
func (m *Set) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Set) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
