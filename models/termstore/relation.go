...
// Relation provides operations to manage the collection of accessReview entities.
...
func (m *Relation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Relation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
