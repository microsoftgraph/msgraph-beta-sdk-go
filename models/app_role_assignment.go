...
// AppRoleAssignment provides operations to manage the collection of accessReviewDecision entities.
...
func (m *AppRoleAssignment) GetAppRoleId()(*UUID) {
    return m.appRoleId
}
...
func (m *AppRoleAssignment) GetPrincipalId()(*UUID) {
...
func (m *AppRoleAssignment) GetResourceId()(*UUID) {
    return m.resourceId
}
...
func (m *AppRoleAssignment) SetAppRoleId(value *UUID)() {
    m.appRoleId = value
}
...
func (m *AppRoleAssignment) SetPrincipalId(value *UUID)() {
    m.principalId = value
}
...
func (m *AppRoleAssignment) SetResourceId(value *UUID)() {
    m.resourceId = value
}
