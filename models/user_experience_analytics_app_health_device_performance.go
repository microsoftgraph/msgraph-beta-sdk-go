...
func (m *UserExperienceAnalyticsAppHealthDevicePerformance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsAppHealthDevicePerformance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
