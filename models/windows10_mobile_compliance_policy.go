...
func (m *Windows10MobileCompliancePolicy) GetActiveFirewallRequired()(*bool) {
...
func (m *Windows10MobileCompliancePolicy) GetOdataType()(*string) {
...
func (m *Windows10MobileCompliancePolicy) GetValidOperatingSystemBuildRanges()([]OperatingSystemVersionRangeable) {
...
func (m *Windows10MobileCompliancePolicy) SetOdataType(value *string)() {
...
func (m *Windows10MobileCompliancePolicy) SetValidOperatingSystemBuildRanges(value []OperatingSystemVersionRangeable)() {
