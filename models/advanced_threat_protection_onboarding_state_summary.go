...
func (m *AdvancedThreatProtectionOnboardingStateSummary) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AdvancedThreatProtectionOnboardingStateSummary) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
