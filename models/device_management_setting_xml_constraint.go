...
func (m *DeviceManagementSettingXmlConstraint) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementSettingXmlConstraint) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
