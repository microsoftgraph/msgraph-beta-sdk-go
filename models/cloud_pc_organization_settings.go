...
func (m *CloudPcOrganizationSettings) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CloudPcOrganizationSettings) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
