...
func (m *TeamworkDeviceOperationCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *TeamworkDeviceOperationCollectionResponse) SetOdataNextLink(value *string)() {
