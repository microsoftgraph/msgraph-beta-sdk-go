...
func (m *DeviceConfigurationState) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceConfigurationState) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
...
func (m *DeviceConfigurationState) SetUserId(value *string)() {
    if m != nil {
        m.userId = value
    }
}
// SetUserPrincipalName sets the userPrincipalName property value. User Principal Name
func (m *DeviceConfigurationState) SetUserPrincipalName(value *string)() {
    if m != nil {
