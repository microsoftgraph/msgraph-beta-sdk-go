...
// WorkbookChartAxis provides operations to manage the collection of accessReview entities.
...
func (m *WorkbookChartAxis) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookChartAxis) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
