...
func (m *Windows10EnterpriseModernAppManagementConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Windows10EnterpriseModernAppManagementConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
