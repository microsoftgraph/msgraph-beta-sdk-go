...
func (m *AccessReviewInstanceDecisionItemAzureRoleResource) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessReviewInstanceDecisionItemAzureRoleResource) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
