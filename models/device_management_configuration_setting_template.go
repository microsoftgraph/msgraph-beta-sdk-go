...
func (m *DeviceManagementConfigurationSettingTemplate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationSettingTemplate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
