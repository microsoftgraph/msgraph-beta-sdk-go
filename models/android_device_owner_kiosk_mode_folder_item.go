...
func (m *AndroidDeviceOwnerKioskModeFolderItem) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceOwnerKioskModeFolderItem) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
