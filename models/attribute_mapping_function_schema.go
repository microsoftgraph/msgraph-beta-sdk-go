...
func (m *AttributeMappingFunctionSchema) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AttributeMappingFunctionSchema) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
