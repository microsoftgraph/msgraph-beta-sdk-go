...
func (m *DeviceConfigurationConflictSummary) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceConfigurationConflictSummary) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
