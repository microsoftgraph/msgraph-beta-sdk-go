...
func (m *CloudPCConnectivityIssueCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *CloudPCConnectivityIssueCollectionResponse) SetOdataNextLink(value *string)() {
