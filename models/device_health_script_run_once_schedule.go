...
func (m *DeviceHealthScriptRunOnceSchedule) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceHealthScriptRunOnceSchedule) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
