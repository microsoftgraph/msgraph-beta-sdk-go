...
func (m *CloudPcExternalPartnerSettingCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *CloudPcExternalPartnerSettingCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *CloudPcExternalPartnerSettingCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *CloudPcExternalPartnerSettingCollectionResponse) SetOdataNextLink(value *string)() {
