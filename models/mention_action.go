...
func (m *MentionAction) GetAdditionalData()(map[string]any) {
...
func (m *MentionAction) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *MentionAction) GetMentionees()([]IdentitySetable) {
    val, err := m.GetBackingStore().Get("mentionees")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *MentionAction) SetAdditionalData(value map[string]any)() {
...
func (m *MentionAction) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *MentionAction) SetMentionees(value []IdentitySetable)() {
    err := m.GetBackingStore().Set("mentionees", value)
    if err != nil {
        panic(err)
    }
}
...
// MentionActionable 
type MentionActionable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackedModel
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetMentionees()([]IdentitySetable)
    GetOdataType()(*string)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetMentionees(value []IdentitySetable)()
