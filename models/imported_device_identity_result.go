...
func (m *ImportedDeviceIdentityResult) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ImportedDeviceIdentityResult) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
