...
// PinnedChatMessageInfo provides operations to manage the collection of accessReview entities.
...
func (m *PinnedChatMessageInfo) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PinnedChatMessageInfo) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
