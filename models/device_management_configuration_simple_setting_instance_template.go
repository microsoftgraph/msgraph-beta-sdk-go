...
func (m *DeviceManagementConfigurationSimpleSettingInstanceTemplate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationSimpleSettingInstanceTemplate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
