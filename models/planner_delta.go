...
// PlannerDelta provides operations to manage the collection of accessReviewDecision entities.
...
func (m *PlannerDelta) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *PlannerDelta) SetType(value *string)() {
    if m != nil {
