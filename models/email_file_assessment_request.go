...
func (m *EmailFileAssessmentRequest) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EmailFileAssessmentRequest) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
