...
// WorkbookRangeSort provides operations to manage the collection of accessReview entities.
...
func (m *WorkbookRangeSort) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookRangeSort) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
