...
func (m *GroupMembershipGovernanceCriteria) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *GroupMembershipGovernanceCriteria) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
