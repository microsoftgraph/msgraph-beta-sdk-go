...
func (m *AndroidForWorkEnterpriseWiFiConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidForWorkEnterpriseWiFiConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
