...
// UserAppInstallStatus contains properties for the installation status for a user. This will be deprecated in May, 2023
...
// returns a []MobileAppInstallStatusable when successful
