...
func (m *SharedEmailDomainInvitation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *SharedEmailDomainInvitation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
