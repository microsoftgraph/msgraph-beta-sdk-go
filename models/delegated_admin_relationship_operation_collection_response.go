...
func (m *DelegatedAdminRelationshipOperationCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *DelegatedAdminRelationshipOperationCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
