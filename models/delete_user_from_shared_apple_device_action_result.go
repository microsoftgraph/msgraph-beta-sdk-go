...
func (m *DeleteUserFromSharedAppleDeviceActionResult) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeleteUserFromSharedAppleDeviceActionResult) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
