...
func (m *DeviceOperatingSystemSummary) GetAospUserAssociatedCount()(*int32) {
    val, err := m.GetBackingStore().Get("aospUserAssociatedCount")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *DeviceOperatingSystemSummary) GetAospUserlessCount()(*int32) {
    val, err := m.GetBackingStore().Get("aospUserlessCount")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *DeviceOperatingSystemSummary) GetChromeOSCount()(*int32) {
    val, err := m.GetBackingStore().Get("chromeOSCount")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *DeviceOperatingSystemSummary) GetLinuxCount()(*int32) {
    val, err := m.GetBackingStore().Get("linuxCount")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *DeviceOperatingSystemSummary) SetAospUserAssociatedCount(value *int32)() {
    err := m.GetBackingStore().Set("aospUserAssociatedCount", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *DeviceOperatingSystemSummary) SetAospUserlessCount(value *int32)() {
    err := m.GetBackingStore().Set("aospUserlessCount", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *DeviceOperatingSystemSummary) SetChromeOSCount(value *int32)() {
    err := m.GetBackingStore().Set("chromeOSCount", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *DeviceOperatingSystemSummary) SetLinuxCount(value *int32)() {
    err := m.GetBackingStore().Set("linuxCount", value)
    if err != nil {
        panic(err)
    }
}
