...
func (m *EstimateStatisticsOperation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EstimateStatisticsOperation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
