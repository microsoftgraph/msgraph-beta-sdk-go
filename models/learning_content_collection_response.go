...
func (m *LearningContentCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *LearningContentCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *LearningContentCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *LearningContentCollectionResponse) SetOdataNextLink(value *string)() {
