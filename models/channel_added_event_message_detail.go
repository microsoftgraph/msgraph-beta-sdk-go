...
func (m *ChannelAddedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ChannelAddedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
