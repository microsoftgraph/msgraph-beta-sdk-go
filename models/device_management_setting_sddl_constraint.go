...
func (m *DeviceManagementSettingSddlConstraint) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementSettingSddlConstraint) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
