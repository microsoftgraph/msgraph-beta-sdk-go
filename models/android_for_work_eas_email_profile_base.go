...
func (m *AndroidForWorkEasEmailProfileBase) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidForWorkEasEmailProfileBase) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
