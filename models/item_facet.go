...
// ItemFacet provides operations to manage the collection of accessReview entities.
...
func (m *ItemFacet) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ItemFacet) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
