...
// PrivilegedRoleAssignment provides operations to manage the collection of activityStatistics entities.
...
func NewPrivilegedRoleAssignment()(*PrivilegedRoleAssignment) {
    ...
    odataTypeValue := "#microsoft.graph.privilegedRoleAssignment";
