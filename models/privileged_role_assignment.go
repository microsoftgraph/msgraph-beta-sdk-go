...
// SetIsElevated sets the isElevated property value. The isElevated property
...
// SetResultMessage sets the resultMessage property value. The resultMessage property
