...
func (m *VersionAction) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *VersionAction) GetNewVersion()(*string) {
    val, err := m.GetBackingStore().Get("newVersion")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *VersionAction) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *VersionAction) SetNewVersion(value *string)() {
    err := m.GetBackingStore().Set("newVersion", value)
    if err != nil {
        panic(err)
    }
}
...
// VersionActionable 
type VersionActionable interface {
