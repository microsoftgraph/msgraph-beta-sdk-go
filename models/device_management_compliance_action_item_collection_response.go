...
func (m *DeviceManagementComplianceActionItemCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementComplianceActionItemCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
