...
func (m *WindowsUpdateActiveHoursInstall) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsUpdateActiveHoursInstall) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
