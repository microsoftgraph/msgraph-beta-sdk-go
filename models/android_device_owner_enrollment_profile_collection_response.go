...
func (m *AndroidDeviceOwnerEnrollmentProfileCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceOwnerEnrollmentProfileCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
