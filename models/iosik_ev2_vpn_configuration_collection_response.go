...
func (m *IosikEv2VpnConfigurationCollectionResponse) GetValue()([]IosikEv2VpnConfigurationable) {
    ...
    if val != nil {
        return val.([]IosikEv2VpnConfigurationable)
    }
    return nil
}
...
// IosikEv2VpnConfigurationCollectionResponseable 
type IosikEv2VpnConfigurationCollectionResponseable interface {
    BaseCollectionPaginationCountResponseable
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetValue()([]IosikEv2VpnConfigurationable)
    SetValue(value []IosikEv2VpnConfigurationable)()
}
