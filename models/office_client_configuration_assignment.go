...
func (m *OfficeClientConfigurationAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *OfficeClientConfigurationAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
