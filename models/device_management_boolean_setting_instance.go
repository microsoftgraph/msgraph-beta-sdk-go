...
func (m *DeviceManagementBooleanSettingInstance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementBooleanSettingInstance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
