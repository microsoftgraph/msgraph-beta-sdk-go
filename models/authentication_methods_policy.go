...
func (m *AuthenticationMethodsPolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AuthenticationMethodsPolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
