...
func (m *MacOSRedirectSingleSignOnExtension) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MacOSRedirectSingleSignOnExtension) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
