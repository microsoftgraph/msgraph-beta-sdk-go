...
func (m *UsersItemDrivesItemItemsItemPreviewPostRequestBody) GetAllowEdit()(*bool) {
    return m.allowEdit
}
// GetChromeless gets the chromeless property value. The chromeless property
func (m *UsersItemDrivesItemItemsItemPreviewPostRequestBody) GetChromeless()(*bool) {
    return m.chromeless
}
...
func (m *UsersItemDrivesItemItemsItemPreviewPostRequestBody) GetViewer()(*string) {
    return m.viewer
}
...
func (m *UsersItemDrivesItemItemsItemPreviewPostRequestBody) SetAllowEdit(value *bool)() {
    m.allowEdit = value
}
// SetChromeless sets the chromeless property value. The chromeless property
func (m *UsersItemDrivesItemItemsItemPreviewPostRequestBody) SetChromeless(value *bool)() {
    m.chromeless = value
}
...
func (m *UsersItemDrivesItemItemsItemPreviewPostRequestBody) SetViewer(value *string)() {
    m.viewer = value
}
