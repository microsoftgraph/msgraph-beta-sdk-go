...
func (m *AndroidDeviceComplianceLocalActionLockDevice) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceComplianceLocalActionLockDevice) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
