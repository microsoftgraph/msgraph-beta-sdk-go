...
func (m *ConditionalAccessSessionControls) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["globalSecureAccessFilteringProfile"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateGlobalSecureAccessFilteringProfileSessionControlFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetGlobalSecureAccessFilteringProfile(val.(GlobalSecureAccessFilteringProfileSessionControlable))
        }
        return nil
    }
...
// GetGlobalSecureAccessFilteringProfile gets the globalSecureAccessFilteringProfile property value. Session control to link to Global Secure Access security profiles or filtering profiles.
// returns a GlobalSecureAccessFilteringProfileSessionControlable when successful
func (m *ConditionalAccessSessionControls) GetGlobalSecureAccessFilteringProfile()(GlobalSecureAccessFilteringProfileSessionControlable) {
    val, err := m.GetBackingStore().Get("globalSecureAccessFilteringProfile")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(GlobalSecureAccessFilteringProfileSessionControlable)
    }
    return nil
}
...
func (m *ConditionalAccessSessionControls) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err := writer.WriteObjectValue("globalSecureAccessFilteringProfile", m.GetGlobalSecureAccessFilteringProfile())
        if err != nil {
            return err
        }
    }
...
// SetGlobalSecureAccessFilteringProfile sets the globalSecureAccessFilteringProfile property value. Session control to link to Global Secure Access security profiles or filtering profiles.
func (m *ConditionalAccessSessionControls) SetGlobalSecureAccessFilteringProfile(value GlobalSecureAccessFilteringProfileSessionControlable)() {
    err := m.GetBackingStore().Set("globalSecureAccessFilteringProfile", value)
    if err != nil {
        panic(err)
    }
}
...
type ConditionalAccessSessionControlsable interface {
    ...
    GetGlobalSecureAccessFilteringProfile()(GlobalSecureAccessFilteringProfileSessionControlable)
    GetOdataType()(*string)
    ...
    SetGlobalSecureAccessFilteringProfile(value GlobalSecureAccessFilteringProfileSessionControlable)()
