...
// WorkbookFilter provides operations to manage the collection of accessReview entities.
...
func (m *WorkbookFilter) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookFilter) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
