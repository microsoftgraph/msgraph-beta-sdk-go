...
func (m *DeviceManagementConfigurationSecretSettingValue) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
// GetValueState gets the valueState property value. Gets or sets a value indicating the encryption state of the Value property. Possible values are: invalid, notEncrypted, encryptedValueToken.
...
func (m *DeviceManagementConfigurationSecretSettingValue) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
...
// SetValueState sets the valueState property value. Gets or sets a value indicating the encryption state of the Value property. Possible values are: invalid, notEncrypted, encryptedValueToken.
