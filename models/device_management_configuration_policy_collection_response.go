...
func (m *DeviceManagementConfigurationPolicyCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationPolicyCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
