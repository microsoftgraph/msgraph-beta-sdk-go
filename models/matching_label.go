...
func (m *MatchingLabel) GetApplicationMode()(*MatchingLabel_applicationMode) {
    val, err := m.GetBackingStore().Get("applicationMode")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*MatchingLabel_applicationMode)
    }
    return nil
}
...
func (m *MatchingLabel) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["applicationMode"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseMatchingLabel_applicationMode)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetApplicationMode(val.(*MatchingLabel_applicationMode))
        }
        return nil
    }
...
func (m *MatchingLabel) SetApplicationMode(value *MatchingLabel_applicationMode)() {
...
type MatchingLabelable interface {
    ...
    GetApplicationMode()(*MatchingLabel_applicationMode)
    ...
    GetPriority()(*int32)
    GetToolTip()(*string)
    SetApplicationMode(value *MatchingLabel_applicationMode)()
