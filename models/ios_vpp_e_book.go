...
func (m *IosVppEBook) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *IosVppEBook) GetRoleScopeTagIds()([]string) {
    if m == nil {
        return nil
    } else {
...
func (m *IosVppEBook) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
...
func (m *IosVppEBook) SetRoleScopeTagIds(value []string)() {
    if m != nil {
