...
func (m *DeviceManagementConfigurationWindowsSettingApplicability) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
// GetRequiredAzureAdTrustType gets the requiredAzureAdTrustType property value. Required AzureAD trust type. Possible values are: none, azureAdJoined, addWorkAccount, mdmOnly.
...
func (m *DeviceManagementConfigurationWindowsSettingApplicability) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
...
// SetRequiredAzureAdTrustType sets the requiredAzureAdTrustType property value. Required AzureAD trust type. Possible values are: none, azureAdJoined, addWorkAccount, mdmOnly.
