...
func (m *Win32LobAppAssignmentSettings) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Win32LobAppAssignmentSettings) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
