...
func (m *DeviceHealthScriptDailySchedule) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceHealthScriptDailySchedule) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
