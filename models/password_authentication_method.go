...
func (m *PasswordAuthenticationMethod) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PasswordAuthenticationMethod) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
