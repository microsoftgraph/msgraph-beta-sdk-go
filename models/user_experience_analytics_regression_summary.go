...
func (m *UserExperienceAnalyticsRegressionSummary) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsRegressionSummary) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
