...
// ReportsGetAttackSimulationSimulationUserCoverageResponse provides operations to call the getAttackSimulationSimulationUserCoverage method.
...
func (m *ReportsGetAttackSimulationSimulationUserCoverageResponse) GetValue()([]AttackSimulationSimulationUserCoverageable) {
    return m.value
}
...
func (m *ReportsGetAttackSimulationSimulationUserCoverageResponse) SetValue(value []AttackSimulationSimulationUserCoverageable)() {
    m.value = value
}
