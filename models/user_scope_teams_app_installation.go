...
func (m *UserScopeTeamsAppInstallation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserScopeTeamsAppInstallation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
