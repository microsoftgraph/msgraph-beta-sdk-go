...
// UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore composed type wrapper for classes float64, ReferenceNumeric, string
type UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewUserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore instantiates a new UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore and sets the default values.
func NewUserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore()(*UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) {
    m := &UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    return m
}
// CreateUserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScoreFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateUserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScoreFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    result := NewUserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore()
    if parseNode != nil {
        mappingValueNode, err := parseNode.GetChildNode("")
        if err != nil {
            return nil, err
...
// GetBackingStore gets the BackingStore property value. Stores model information.
// returns a BackingStore when successful
func (m *UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetDouble gets the double property value. Composed type representation for type float64
// returns a *float64 when successful
func (m *UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) GetDouble()(*float64) {
    val, err := m.GetBackingStore().Get("double")
    if err != nil {
        panic(err)
    }
...
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    return make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
}
// GetIsComposedType determines if the current object is a wrapper around a composed type
// returns a bool when successful
func (m *UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) GetIsComposedType()(bool) {
    return true
}
// GetReferenceNumeric gets the ReferenceNumeric property value. Composed type representation for type ReferenceNumeric
// returns a *ReferenceNumeric when successful
func (m *UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) GetReferenceNumeric()(*ReferenceNumeric) {
    val, err := m.GetBackingStore().Get("referenceNumeric")
    if err != nil {
        panic(err)
    }
...
// GetString gets the string property value. Composed type representation for type string
// returns a *string when successful
func (m *UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) GetString()(*string) {
    val, err := m.GetBackingStore().Get("string")
    if err != nil {
        panic(err)
    }
...
// Serialize serializes information the current object
func (m *UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetReferenceNumeric() != nil {
        cast := (*m.GetReferenceNumeric()).String()
        err := writer.WriteStringValue("", &cast)
        if err != nil {
...
// SetBackingStore sets the BackingStore property value. Stores model information.
func (m *UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetDouble sets the double property value. Composed type representation for type float64
func (m *UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) SetDouble(value *float64)() {
    err := m.GetBackingStore().Set("double", value)
    if err != nil {
        panic(err)
    }
...
// SetReferenceNumeric sets the ReferenceNumeric property value. Composed type representation for type ReferenceNumeric
func (m *UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) SetReferenceNumeric(value *ReferenceNumeric)() {
    err := m.GetBackingStore().Set("referenceNumeric", value)
    if err != nil {
        panic(err)
    }
...
// SetString sets the string property value. Composed type representation for type string
func (m *UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore) SetString(value *string)() {
    err := m.GetBackingStore().Set("string", value)
    if err != nil {
        panic(err)
    }
...
type UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScoreable interface {
    ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackedModel
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetDouble()(*float64)
...
func (m *UserExperienceAnalyticsModelScores) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["meanResourceSpikeTimeScore"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetMeanResourceSpikeTimeScore(val.(*UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore))
        }
        return nil
    }
...
// GetMeanResourceSpikeTimeScore gets the meanResourceSpikeTimeScore property value. Indicates a calulated score indicating the health of the device's resource spike score . Valid values range from 0-100. Value -1 means associated score is unavailable. A higher score indicates a healthier device. Read-only. Valid values -1.79769313486232E+308 to 1.79769313486232E+308
// returns a UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScoreable when successful
func (m *UserExperienceAnalyticsModelScores) GetMeanResourceSpikeTimeScore()(UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScoreable) {
    val, err := m.GetBackingStore().Get("meanResourceSpikeTimeScore")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScoreable)
    }
    return nil
}
...
func (m *UserExperienceAnalyticsModelScores) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err = writer.WriteObjectValue("meanResourceSpikeTimeScore", m.GetMeanResourceSpikeTimeScore())
        if err != nil {
            return err
        }
    }
...
func (m *UserExperienceAnalyticsModelScores) SetMeanResourceSpikeTimeScore(value UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScoreable)() {
...
type UserExperienceAnalyticsModelScoresable interface {
    ...
    GetMeanResourceSpikeTimeScore()(UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScoreable)
    GetModel()(*string)
    ...
    SetMeanResourceSpikeTimeScore(value UserExperienceAnalyticsModelScores_UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScoreable)()
