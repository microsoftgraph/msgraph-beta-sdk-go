...
// returns a *float64 when successful
func (m *UserExperienceAnalyticsModelScores) GetMeanResourceSpikeTimeScore()(*float64) {
...
func (m *UserExperienceAnalyticsModelScores) SetMeanResourceSpikeTimeScore(value *float64)() {
