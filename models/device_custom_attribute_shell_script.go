...
func (m *DeviceCustomAttributeShellScript) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceCustomAttributeShellScript) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
