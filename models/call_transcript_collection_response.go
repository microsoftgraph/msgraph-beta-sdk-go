...
func (m *CallTranscriptCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *CallTranscriptCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *CallTranscriptCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *CallTranscriptCollectionResponse) SetOdataNextLink(value *string)() {
