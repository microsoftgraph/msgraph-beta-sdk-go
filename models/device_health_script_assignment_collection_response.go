...
func (m *DeviceHealthScriptAssignmentCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *DeviceHealthScriptAssignmentCollectionResponse) SetOdataNextLink(value *string)() {
