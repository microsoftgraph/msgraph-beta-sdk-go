...
func (m *WindowsFeatureUpdateProfileAssignmentCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *WindowsFeatureUpdateProfileAssignmentCollectionResponse) SetOdataNextLink(value *string)() {
