...
func (m *DeviceManagementCollectionSettingInstance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementCollectionSettingInstance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
