...
func (m *AndroidDeviceComplianceLocalActionLockDeviceWithPasscode) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceComplianceLocalActionLockDeviceWithPasscode) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
