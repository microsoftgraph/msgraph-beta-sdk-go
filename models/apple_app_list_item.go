...
// AppleAppListItem represents an app in the list of managed applications
...
func (m *AppleAppListItem) GetOdataType()(*string) {
...
func (m *AppleAppListItem) SetOdataType(value *string)() {
