...
func (m *AndroidCustomConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidCustomConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
