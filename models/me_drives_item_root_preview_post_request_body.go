...
func (m *MeDrivesItemRootPreviewPostRequestBody) GetAllowEdit()(*bool) {
    return m.allowEdit
}
// GetChromeless gets the chromeless property value. The chromeless property
func (m *MeDrivesItemRootPreviewPostRequestBody) GetChromeless()(*bool) {
    return m.chromeless
}
...
func (m *MeDrivesItemRootPreviewPostRequestBody) GetViewer()(*string) {
    return m.viewer
}
...
func (m *MeDrivesItemRootPreviewPostRequestBody) SetAllowEdit(value *bool)() {
    m.allowEdit = value
}
// SetChromeless sets the chromeless property value. The chromeless property
func (m *MeDrivesItemRootPreviewPostRequestBody) SetChromeless(value *bool)() {
    m.chromeless = value
}
...
func (m *MeDrivesItemRootPreviewPostRequestBody) SetViewer(value *string)() {
    m.viewer = value
}
