...
// AppConsentRequest provides operations to manage the collection of accessReview entities.
...
func (m *AppConsentRequest) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AppConsentRequest) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
