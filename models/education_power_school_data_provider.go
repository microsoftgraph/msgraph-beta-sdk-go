...
func (m *EducationPowerSchoolDataProvider) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EducationPowerSchoolDataProvider) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
