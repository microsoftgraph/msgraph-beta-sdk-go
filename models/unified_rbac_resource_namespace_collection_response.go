...
func (m *UnifiedRbacResourceNamespaceCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *UnifiedRbacResourceNamespaceCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
