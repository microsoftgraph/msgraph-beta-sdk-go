...
func (m *StrongAuthenticationDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *StrongAuthenticationDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
