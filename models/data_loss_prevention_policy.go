...
// DataLossPreventionPolicy provides operations to manage the collection of accessReview entities.
...
func (m *DataLossPreventionPolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DataLossPreventionPolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
