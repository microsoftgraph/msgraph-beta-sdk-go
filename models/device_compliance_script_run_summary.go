...
func (m *DeviceComplianceScriptRunSummary) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceComplianceScriptRunSummary) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
