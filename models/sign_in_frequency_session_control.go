...
// GetTypeEscaped gets the type property value. The possible values are: days, hours, or null if frequencyInterval is everyTime .
...
// SetTypeEscaped sets the type property value. The possible values are: days, hours, or null if frequencyInterval is everyTime .
