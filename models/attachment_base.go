...
// AttachmentBase provides operations to manage the collection of accessReviewDecision entities.
...
func (m *AttachmentBase) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *AttachmentBase) SetType(value *string)() {
    if m != nil {
