...
func (m *Win32LobAppRegistryRequirement) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Win32LobAppRegistryRequirement) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
