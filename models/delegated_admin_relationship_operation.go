...
func (m *DelegatedAdminRelationshipOperation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DelegatedAdminRelationshipOperation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
