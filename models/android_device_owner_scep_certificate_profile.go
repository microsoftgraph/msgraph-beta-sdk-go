...
func (m *AndroidDeviceOwnerScepCertificateProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceOwnerScepCertificateProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
