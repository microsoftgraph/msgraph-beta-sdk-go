...
func (m *UserExperienceAnalyticsMetricHistory) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsMetricHistory) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
