...
func (m *ChannelSetAsFavoriteByDefaultEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ChannelSetAsFavoriteByDefaultEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
