...
// GetAdhocCalls gets the adhocCalls property value. A collection of ad hoc calls in Teams.
...
// SetAdhocCalls sets the adhocCalls property value. A collection of ad hoc calls in Teams.
