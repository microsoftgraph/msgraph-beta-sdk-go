...
// GetDisplayName gets the displayName property value. Optional name given to the hardware OATH device.
...
// GetHardwareOathDevices gets the hardwareOathDevices property value. Exposes the hardware OATH method in the directory.
...
// SetDisplayName sets the displayName property value. Optional name given to the hardware OATH device.
...
// SetHardwareOathDevices sets the hardwareOathDevices property value. Exposes the hardware OATH method in the directory.
