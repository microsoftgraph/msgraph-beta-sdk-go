...
func (m *MicrosoftStoreForBusinessAppAssignmentSettings) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MicrosoftStoreForBusinessAppAssignmentSettings) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
