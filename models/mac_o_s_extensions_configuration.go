...
func (m *MacOSExtensionsConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MacOSExtensionsConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
