...
func (m *CloudAppSecuritySessionControl) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CloudAppSecuritySessionControl) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
