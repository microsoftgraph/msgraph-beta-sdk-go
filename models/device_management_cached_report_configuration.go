...
func (m *DeviceManagementCachedReportConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementCachedReportConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
