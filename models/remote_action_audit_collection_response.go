...
func (m *RemoteActionAuditCollectionResponse) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *RemoteActionAuditCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
