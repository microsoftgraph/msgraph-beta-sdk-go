...
// WorkbookChartAxisTitleFormat provides operations to manage the collection of accessReview entities.
...
func (m *WorkbookChartAxisTitleFormat) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookChartAxisTitleFormat) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
