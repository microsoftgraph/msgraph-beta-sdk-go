...
// DeviceManagementDeviceShellScriptsItemAssignPostRequestBody provides operations to call the assign method.
type DeviceManagementDeviceShellScriptsItemAssignPostRequestBody struct {
...
// NewDeviceManagementDeviceShellScriptsItemAssignPostRequestBody instantiates a new DeviceManagementDeviceShellScriptsItemAssignPostRequestBody and sets the default values.
func NewDeviceManagementDeviceShellScriptsItemAssignPostRequestBody()(*DeviceManagementDeviceShellScriptsItemAssignPostRequestBody) {
    m := &DeviceManagementDeviceShellScriptsItemAssignPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]interface{}));
    return m
}
// CreateDeviceManagementDeviceShellScriptsItemAssignPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateDeviceManagementDeviceShellScriptsItemAssignPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewDeviceManagementDeviceShellScriptsItemAssignPostRequestBody(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *DeviceManagementDeviceShellScriptsItemAssignPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *DeviceManagementDeviceShellScriptsItemAssignPostRequestBody) GetDeviceManagementScriptAssignments()([]DeviceManagementScriptAssignmentable) {
...
func (m *DeviceManagementDeviceShellScriptsItemAssignPostRequestBody) GetDeviceManagementScriptGroupAssignments()([]DeviceManagementScriptGroupAssignmentable) {
    return m.deviceManagementScriptGroupAssignments
}
// GetFieldDeserializers the deserialization information for the current model
func (m *DeviceManagementDeviceShellScriptsItemAssignPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *DeviceManagementDeviceShellScriptsItemAssignPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *DeviceManagementDeviceShellScriptsItemAssignPostRequestBody) SetAdditionalData(value map[string]interface{})() {
...
func (m *DeviceManagementDeviceShellScriptsItemAssignPostRequestBody) SetDeviceManagementScriptAssignments(value []DeviceManagementScriptAssignmentable)() {
...
func (m *DeviceManagementDeviceShellScriptsItemAssignPostRequestBody) SetDeviceManagementScriptGroupAssignments(value []DeviceManagementScriptGroupAssignmentable)() {
