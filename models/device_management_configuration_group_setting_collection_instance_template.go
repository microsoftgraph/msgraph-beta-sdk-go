...
func (m *DeviceManagementConfigurationGroupSettingCollectionInstanceTemplate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationGroupSettingCollectionInstanceTemplate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
