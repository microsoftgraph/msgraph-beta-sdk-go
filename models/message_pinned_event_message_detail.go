...
func (m *MessagePinnedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MessagePinnedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
