...
// UnifiedRoleDefinition provides operations to manage the collection of accessReview entities.
...
func (m *UnifiedRoleDefinition) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UnifiedRoleDefinition) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
