...
func (m *ComanagementEligibleDevice) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ComanagementEligibleDevice) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
