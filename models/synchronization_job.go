...
// SynchronizationJob casts the previous resource to application.
...
func (m *SynchronizationJob) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *SynchronizationJob) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
