...
func (m *DeviceEnrollmentPlatformRestriction) GetBlockedManufacturers()([]string) {
    val, err := m.GetBackingStore().Get("blockedManufacturers")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *DeviceEnrollmentPlatformRestriction) GetBlockedSkus()([]string) {
    val, err := m.GetBackingStore().Get("blockedSkus")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *DeviceEnrollmentPlatformRestriction) SetBlockedManufacturers(value []string)() {
    err := m.GetBackingStore().Set("blockedManufacturers", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *DeviceEnrollmentPlatformRestriction) SetBlockedSkus(value []string)() {
    err := m.GetBackingStore().Set("blockedSkus", value)
    if err != nil {
        panic(err)
    }
}
