...
func (m *BufferDecryptionResult) GetAdditionalData()(map[string]any) {
...
func (m *BufferDecryptionResult) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *BufferDecryptionResult) GetDecryptedBuffer()([]byte) {
    val, err := m.GetBackingStore().Get("decryptedBuffer")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *BufferDecryptionResult) SetAdditionalData(value map[string]any)() {
...
func (m *BufferDecryptionResult) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *BufferDecryptionResult) SetDecryptedBuffer(value []byte)() {
    err := m.GetBackingStore().Set("decryptedBuffer", value)
    if err != nil {
        panic(err)
    }
}
