...
func (m *DeviceComplianceActionItem) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceComplianceActionItem) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
