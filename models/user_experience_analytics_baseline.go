...
func (m *UserExperienceAnalyticsBaseline) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsBaseline) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
