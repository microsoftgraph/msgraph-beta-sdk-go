...
func (m *MentionsPreview) GetAdditionalData()(map[string]any) {
...
func (m *MentionsPreview) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *MentionsPreview) GetIsMentioned()(*bool) {
    val, err := m.GetBackingStore().Get("isMentioned")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *MentionsPreview) SetAdditionalData(value map[string]any)() {
...
func (m *MentionsPreview) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *MentionsPreview) SetIsMentioned(value *bool)() {
    err := m.GetBackingStore().Set("isMentioned", value)
    if err != nil {
        panic(err)
    }
}
