...
// TriggersRoot provides operations to manage the collection of accessReview entities.
...
func (m *TriggersRoot) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TriggersRoot) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
