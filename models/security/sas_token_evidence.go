...
// GetAllowedIpAddresses gets the allowedIpAddresses property value. All IP addresses that are accessible with this SAS. The default value is Allows all IP addresses.
...
// GetAllowedResourceTypes gets the allowedResourceTypes property value. All of the resource types accessible with this SAS.
// returns a []string when successful
...
// GetAllowedServices gets the allowedServices property value. All of the services that are accessible with this SAS.
// returns a []string when successful
...
// GetPermissions gets the permissions property value. All of the permissions granted to this SAS.
// returns a []string when successful
...
// GetProtocol gets the protocol property value. The protocol that is allowed for the SAS.
// returns a *string when successful
...
// GetSignatureHash gets the signatureHash property value. The SAS signature hash, which is the unique identifier for the SAS.
// returns a *string when successful
...
// GetSignedWith gets the signedWith property value. The storage key used to generate the SAS.
// returns a *string when successful
...
// SetAllowedIpAddresses sets the allowedIpAddresses property value. All IP addresses that are accessible with this SAS. The default value is Allows all IP addresses.
...
// SetAllowedResourceTypes sets the allowedResourceTypes property value. All of the resource types accessible with this SAS.
...
// SetAllowedServices sets the allowedServices property value. All of the services that are accessible with this SAS.
...
// SetPermissions sets the permissions property value. All of the permissions granted to this SAS.
...
// SetProtocol sets the protocol property value. The protocol that is allowed for the SAS.
...
// SetSignatureHash sets the signatureHash property value. The SAS signature hash, which is the unique identifier for the SAS.
...
// SetSignedWith sets the signedWith property value. The storage key used to generate the SAS.
