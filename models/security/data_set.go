...
// DataSet provides operations to manage the collection of accessReview entities.
type DataSet struct {
...
func (m *DataSet) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DataSet) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
