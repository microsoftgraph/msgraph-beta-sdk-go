...
// CreateAuthorityTemplateFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
// AuthorityTemplateable 
type AuthorityTemplateable interface {
