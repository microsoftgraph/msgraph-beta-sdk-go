...
func NewForceUserPasswordResetResponseAction()(*ForceUserPasswordResetResponseAction) {
    ...
    odataTypeValue := "#microsoft.graph.security.forceUserPasswordResetResponseAction"
...
func (m *ForceUserPasswordResetResponseAction) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["identifier"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseForceUserPasswordResetEntityIdentifier)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetIdentifier(val.(*ForceUserPasswordResetEntityIdentifier))
        }
        return nil
    }
    return res
...
func (m *ForceUserPasswordResetResponseAction) GetIdentifier()(*ForceUserPasswordResetEntityIdentifier) {
    ...
    if val != nil {
        return val.(*ForceUserPasswordResetEntityIdentifier)
    }
    return nil
}
// Serialize serializes information the current object
func (m *ForceUserPasswordResetResponseAction) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ForceUserPasswordResetResponseAction) SetIdentifier(value *ForceUserPasswordResetEntityIdentifier)() {
...
type ForceUserPasswordResetResponseActionable interface {
    ...
    ResponseActionable
    GetIdentifier()(*ForceUserPasswordResetEntityIdentifier)
    SetIdentifier(value *ForceUserPasswordResetEntityIdentifier)()
}
