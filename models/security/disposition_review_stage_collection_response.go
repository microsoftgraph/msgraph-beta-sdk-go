...
func (m *DispositionReviewStageCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *DispositionReviewStageCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *DispositionReviewStageCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DispositionReviewStageCollectionResponse) SetOdataNextLink(value *string)() {
