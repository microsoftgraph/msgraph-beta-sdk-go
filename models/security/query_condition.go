...
func (m *QueryCondition) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["queryText"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetStringValue()
        if err != nil {
            return err
        }
...
func (m *QueryCondition) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
    ...
    {
        err := writer.WriteStringValue("queryText", m.GetQueryText())
        if err != nil {
            return err
        }
    }
...
func (m *QueryCondition) SetAdditionalData(value map[string]any)() {
...
func (m *QueryCondition) SetOdataType(value *string)() {
