...
// CasesRoot provides operations to manage the collection of accessReview entities.
...
func (m *CasesRoot) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CasesRoot) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
