...
func NewHuntingRowResult()(*HuntingRowResult) {
    ...
    odataTypeValue := "#microsoft.graph.security.huntingRowResult";
...
func (m *HuntingRowResult) GetAdditionalData()(map[string]interface{}) {
...
func (m *HuntingRowResult) SetAdditionalData(value map[string]interface{})() {
