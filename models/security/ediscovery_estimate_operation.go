...
// EdiscoveryEstimateOperation provides operations to manage the collection of accessReview entities.
...
func (m *EdiscoveryEstimateOperation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EdiscoveryEstimateOperation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
