...
func (m *IncidentCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *IncidentCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *IncidentCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *IncidentCollectionResponse) SetOdataNextLink(value *string)() {
