...
// EdiscoveryCaseSettings provides operations to manage the collection of accessReview entities.
...
func (m *EdiscoveryCaseSettings) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EdiscoveryCaseSettings) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
