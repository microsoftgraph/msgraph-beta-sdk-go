...
func (m *EmailThreatSubmissionCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *EmailThreatSubmissionCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *EmailThreatSubmissionCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EmailThreatSubmissionCollectionResponse) SetOdataNextLink(value *string)() {
