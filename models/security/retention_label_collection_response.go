...
func (m *RetentionLabelCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *RetentionLabelCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *RetentionLabelCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *RetentionLabelCollectionResponse) SetOdataNextLink(value *string)() {
