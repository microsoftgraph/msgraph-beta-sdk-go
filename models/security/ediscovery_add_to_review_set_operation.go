...
func (m *EdiscoveryAddToReviewSetOperation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EdiscoveryAddToReviewSetOperation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
