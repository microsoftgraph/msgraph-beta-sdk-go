...
func (m *UserExperienceAnalyticsResourcePerformance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsResourcePerformance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
