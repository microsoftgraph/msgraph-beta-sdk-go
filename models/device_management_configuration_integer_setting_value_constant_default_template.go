...
func (m *DeviceManagementConfigurationIntegerSettingValueConstantDefaultTemplate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationIntegerSettingValueConstantDefaultTemplate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
