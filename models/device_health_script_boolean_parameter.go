...
func (m *DeviceHealthScriptBooleanParameter) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceHealthScriptBooleanParameter) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
