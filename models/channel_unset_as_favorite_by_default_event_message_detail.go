...
func (m *ChannelUnsetAsFavoriteByDefaultEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ChannelUnsetAsFavoriteByDefaultEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
