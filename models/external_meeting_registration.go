...
func (m *ExternalMeetingRegistration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ExternalMeetingRegistration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
