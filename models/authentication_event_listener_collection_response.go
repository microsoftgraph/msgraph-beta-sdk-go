...
func (m *AuthenticationEventListenerCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *AuthenticationEventListenerCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *AuthenticationEventListenerCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *AuthenticationEventListenerCollectionResponse) SetOdataNextLink(value *string)() {
