...
func (m *DeviceManagementSettingAbstractImplementationConstraint) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementSettingAbstractImplementationConstraint) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
