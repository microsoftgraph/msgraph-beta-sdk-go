...
// returns a DeviceManagementConfigurationChoiceSettingValueDefaultTemplateable when successful
...
// returns a DeviceManagementConfigurationChoiceSettingValueDefinitionTemplateable when successful
