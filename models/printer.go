...
func (m *Printer) GetAcceptingJobs()(*bool) {
    val, err := m.GetBackingStore().Get("acceptingJobs")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *Printer) GetOdataType()(*string) {
...
func (m *Printer) SetAcceptingJobs(value *bool)() {
    err := m.GetBackingStore().Set("acceptingJobs", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *Printer) SetOdataType(value *string)() {
