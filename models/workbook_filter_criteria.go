...
// GetIcon gets the icon property value. An icon applied via conditional formatting.
...
// SetIcon sets the icon property value. An icon applied via conditional formatting.
