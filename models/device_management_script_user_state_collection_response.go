...
func (m *DeviceManagementScriptUserStateCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementScriptUserStateCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
