...
func (m *AndroidDeviceOwnerVpnConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceOwnerVpnConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
