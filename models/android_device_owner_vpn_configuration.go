...
func (m *AndroidDeviceOwnerVpnConfiguration) GetLockdownExclusionList()([]string) {
...
func (m *AndroidDeviceOwnerVpnConfiguration) SetLockdownExclusionList(value []string)() {
