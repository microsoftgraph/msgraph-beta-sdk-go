...
func (m *TrustFramework) GetAdditionalData()(map[string]any) {
...
func (m *TrustFramework) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *TrustFramework) GetKeySets()([]TrustFrameworkKeySetable) {
    val, err := m.GetBackingStore().Get("keySets")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.([]TrustFrameworkKeySetable)
    }
    return nil
}
...
func (m *TrustFramework) SetAdditionalData(value map[string]any)() {
...
func (m *TrustFramework) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *TrustFramework) SetKeySets(value []TrustFrameworkKeySetable)() {
    err := m.GetBackingStore().Set("keySets", value)
    if err != nil {
        panic(err)
    }
}
