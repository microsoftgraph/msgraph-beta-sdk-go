...
func (m *Win32LobAppPowerShellScriptRule) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Win32LobAppPowerShellScriptRule) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
