...
func (m *SpecifiedCaptiveNetworkPlugins) GetAllowedBundleIdentifiers()([]string) {
    val, err := m.GetBackingStore().Get("allowedBundleIdentifiers")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *SpecifiedCaptiveNetworkPlugins) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *SpecifiedCaptiveNetworkPlugins) SetAllowedBundleIdentifiers(value []string)() {
    err := m.GetBackingStore().Set("allowedBundleIdentifiers", value)
    if err != nil {
        panic(err)
    }
}
// SetBackingStore sets the BackingStore property value. Stores model information.
func (m *SpecifiedCaptiveNetworkPlugins) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
