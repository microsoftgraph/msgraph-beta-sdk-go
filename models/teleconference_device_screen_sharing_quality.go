...
func (m *TeleconferenceDeviceScreenSharingQuality) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TeleconferenceDeviceScreenSharingQuality) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
