...
func (m *DetectedSensitiveContentBase) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *DetectedSensitiveContentBase) SetRecommendedConfidence(value *int32)() {
    err := m.GetBackingStore().Set("recommendedConfidence", value)
    if err != nil {
        panic(err)
    }
}
