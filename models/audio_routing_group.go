...
// AudioRoutingGroup provides operations to manage the commsApplication singleton.
...
func (m *AudioRoutingGroup) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AudioRoutingGroup) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
