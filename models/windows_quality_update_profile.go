...
func (m *WindowsQualityUpdateProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsQualityUpdateProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
