...
func (m *InformationalUrls) GetAdditionalData()(map[string]any) {
...
func (m *InformationalUrls) GetAppSignUpUrl()(*string) {
    val, err := m.GetBackingStore().Get("appSignUpUrl")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *InformationalUrls) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *InformationalUrls) GetSingleSignOnDocumentationUrl()(*string) {
    val, err := m.GetBackingStore().Get("singleSignOnDocumentationUrl")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *InformationalUrls) SetAdditionalData(value map[string]any)() {
...
func (m *InformationalUrls) SetAppSignUpUrl(value *string)() {
    err := m.GetBackingStore().Set("appSignUpUrl", value)
    if err != nil {
        panic(err)
    }
}
// SetBackingStore sets the backingStore property value. Stores model information.
func (m *InformationalUrls) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *InformationalUrls) SetSingleSignOnDocumentationUrl(value *string)() {
    err := m.GetBackingStore().Set("singleSignOnDocumentationUrl", value)
    if err != nil {
        panic(err)
    }
}
// InformationalUrlsable 
type InformationalUrlsable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackedModel
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetAppSignUpUrl()(*string)
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetOdataType()(*string)
    GetSingleSignOnDocumentationUrl()(*string)
    SetAppSignUpUrl(value *string)()
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetOdataType(value *string)()
    SetSingleSignOnDocumentationUrl(value *string)()
}
