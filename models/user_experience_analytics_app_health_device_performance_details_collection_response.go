...
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionResponse) GetOdatanextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionResponse) SetOdatanextLink(value *string)() {
    if m != nil {
        m.nextLink = value
    }
}
