...
func (m *TemporaryAccessPassAuthenticationMethodCollectionResponse) GetOdatanextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *TemporaryAccessPassAuthenticationMethodCollectionResponse) SetOdatanextLink(value *string)() {
    if m != nil {
        m.nextLink = value
    }
}
