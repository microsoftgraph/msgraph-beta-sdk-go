...
func (m *AospDeviceOwnerPkcsCertificateProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AospDeviceOwnerPkcsCertificateProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
