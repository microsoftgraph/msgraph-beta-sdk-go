...
func (m *TeamMembersNotificationRecipient) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
// GetTeamId gets the teamId property value. The team's identifier.
...
func (m *TeamMembersNotificationRecipient) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
        m.additionalData = value
    }
}
// SetTeamId sets the teamId property value. The team's identifier.
