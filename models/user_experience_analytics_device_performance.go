...
func (m *UserExperienceAnalyticsDevicePerformance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsDevicePerformance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
