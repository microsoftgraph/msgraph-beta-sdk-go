...
func (m *UserExperienceAnalyticsBatteryHealthDeviceAppImpactCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *UserExperienceAnalyticsBatteryHealthDeviceAppImpactCollectionResponse) SetOdataNextLink(value *string)() {
