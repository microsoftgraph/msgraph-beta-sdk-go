...
func (m *DeviceManagementEnumConstraint) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementEnumConstraint) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
