...
func (m *ProtectOnlineMeetingAction) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ProtectOnlineMeetingAction) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
