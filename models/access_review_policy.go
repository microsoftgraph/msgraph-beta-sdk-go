...
// AccessReviewPolicy provides operations to manage the collection of accessReview entities.
...
func (m *AccessReviewPolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessReviewPolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
