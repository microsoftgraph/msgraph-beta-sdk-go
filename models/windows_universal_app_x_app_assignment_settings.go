...
func (m *WindowsUniversalAppXAppAssignmentSettings) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsUniversalAppXAppAssignmentSettings) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
