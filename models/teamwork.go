...
// GetRegion gets the region property value. Represents the region of the organization.
...
// SetRegion sets the region property value. Represents the region of the organization.
