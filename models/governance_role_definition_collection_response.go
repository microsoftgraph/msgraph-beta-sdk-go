...
func (m *GovernanceRoleDefinitionCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *GovernanceRoleDefinitionCollectionResponse) SetOdataNextLink(value *string)() {
