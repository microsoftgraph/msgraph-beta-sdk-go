...
// GetExternalAuthenticationMethods gets the externalAuthenticationMethods property value. Represents the external MFA registered to a user for authentication.
...
// SetExternalAuthenticationMethods sets the externalAuthenticationMethods property value. Represents the external MFA registered to a user for authentication.
