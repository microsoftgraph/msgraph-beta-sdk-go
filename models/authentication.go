...
// GetHardwareOathMethods gets the hardwareOathMethods property value. The hardware OATH time-based one-time password (TOTP) devices assigned to a user for authentication.
...
func (m *Authentication) GetPasswordlessMicrosoftAuthenticatorMethods()([]PasswordlessMicrosoftAuthenticatorAuthenticationMethodable) {
    ...
    if val != nil {
        return val.([]PasswordlessMicrosoftAuthenticatorAuthenticationMethodable)
    }
    return nil
}
...
// SetHardwareOathMethods sets the hardwareOathMethods property value. The hardware OATH time-based one-time password (TOTP) devices assigned to a user for authentication.
...
func (m *Authentication) SetPasswordlessMicrosoftAuthenticatorMethods(value []PasswordlessMicrosoftAuthenticatorAuthenticationMethodable)() {
    err := m.GetBackingStore().Set("passwordlessMicrosoftAuthenticatorMethods", value)
    if err != nil {
        panic(err)
    }
}
