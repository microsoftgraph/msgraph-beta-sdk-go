...
// GetDevicesPerOffer gets the devicesPerOffer property value. The devicesPerOffer property
...
// SetDevicesPerOffer sets the devicesPerOffer property value. The devicesPerOffer property
