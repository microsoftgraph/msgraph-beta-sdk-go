...
func (m *ScheduleSettings) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
// returns a GradualRolloutSettingsable when successful
func (m *ScheduleSettings) GetGradualRollout()(GradualRolloutSettingsable) {
    val, err := m.GetBackingStore().Get("gradualRollout")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(GradualRolloutSettingsable)
    }
    return nil
}
...
func (m *ScheduleSettings) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *ScheduleSettings) SetGradualRollout(value GradualRolloutSettingsable)() {
    err := m.GetBackingStore().Set("gradualRollout", value)
    if err != nil {
        panic(err)
    }
}
...
type ScheduleSettingsable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackedModel
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetGradualRollout()(GradualRolloutSettingsable)
    GetOdataType()(*string)
    GetStartDateTime()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetGradualRollout(value GradualRolloutSettingsable)()
