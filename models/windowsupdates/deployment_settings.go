...
// GetContentApplicability gets the contentApplicability property value. The contentApplicability property
func (m *DeploymentSettings) GetContentApplicability()(ContentApplicabilitySettingsable) {
    return m.contentApplicability
}
// GetExpedite gets the expedite property value. The expedite property
...
// GetUserExperience gets the userExperience property value. The userExperience property
...
// SetContentApplicability sets the contentApplicability property value. The contentApplicability property
func (m *DeploymentSettings) SetContentApplicability(value ContentApplicabilitySettingsable)() {
    m.contentApplicability = value
}
// SetExpedite sets the expedite property value. The expedite property
...
// SetUserExperience sets the userExperience property value. The userExperience property
