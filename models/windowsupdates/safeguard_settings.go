...
func (m *SafeguardSettings) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
// returns a []SafeguardProfileable when successful
func (m *SafeguardSettings) GetDisabledSafeguardProfiles()([]SafeguardProfileable) {
    val, err := m.GetBackingStore().Get("disabledSafeguardProfiles")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *SafeguardSettings) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *SafeguardSettings) SetDisabledSafeguardProfiles(value []SafeguardProfileable)() {
    err := m.GetBackingStore().Set("disabledSafeguardProfiles", value)
    if err != nil {
        panic(err)
    }
}
