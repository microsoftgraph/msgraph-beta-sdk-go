...
func (m *MonitoringSettings) GetAdditionalData()(map[string]any) {
...
func (m *MonitoringSettings) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
// returns a []MonitoringRuleable when successful
func (m *MonitoringSettings) GetMonitoringRules()([]MonitoringRuleable) {
    val, err := m.GetBackingStore().Get("monitoringRules")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.([]MonitoringRuleable)
    }
    return nil
}
...
func (m *MonitoringSettings) SetAdditionalData(value map[string]any)() {
...
func (m *MonitoringSettings) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *MonitoringSettings) SetMonitoringRules(value []MonitoringRuleable)() {
    err := m.GetBackingStore().Set("monitoringRules", value)
    if err != nil {
        panic(err)
    }
}
