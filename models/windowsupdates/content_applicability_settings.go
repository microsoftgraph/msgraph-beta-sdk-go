...
func (m *ContentApplicabilitySettings) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
// GetOfferWhileRecommendedBy gets the offerWhileRecommendedBy property value. Offer if the update is recommended by a vendor in the list, otherwise withhold the offer.
// returns a []string when successful
func (m *ContentApplicabilitySettings) GetOfferWhileRecommendedBy()([]string) {
    val, err := m.GetBackingStore().Get("offerWhileRecommendedBy")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
// returns a SafeguardSettingsable when successful
func (m *ContentApplicabilitySettings) GetSafeguard()(SafeguardSettingsable) {
    ...
    if val != nil {
        return val.(SafeguardSettingsable)
    }
    return nil
}
...
func (m *ContentApplicabilitySettings) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
// SetOfferWhileRecommendedBy sets the offerWhileRecommendedBy property value. Offer if the update is recommended by a vendor in the list, otherwise withhold the offer.
func (m *ContentApplicabilitySettings) SetOfferWhileRecommendedBy(value []string)() {
    err := m.GetBackingStore().Set("offerWhileRecommendedBy", value)
    if err != nil {
        panic(err)
    }
}
