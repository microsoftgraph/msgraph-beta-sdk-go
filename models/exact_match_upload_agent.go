...
// ExactMatchUploadAgent provides operations to manage the collection of accessReview entities.
...
func (m *ExactMatchUploadAgent) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ExactMatchUploadAgent) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
