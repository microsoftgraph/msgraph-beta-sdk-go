...
func (m *DeviceManagementConfigurationGroupSettingValue) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationGroupSettingValue) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
