...
// DeviceManagementConfigurationGroupSettingValue setting value
...
func (m *DeviceManagementConfigurationGroupSettingValue) GetOdataType()(*string) {
...
func (m *DeviceManagementConfigurationGroupSettingValue) SetOdataType(value *string)() {
