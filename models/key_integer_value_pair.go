...
// KeyIntegerValuePair a key-value pair with a string key and a typed value.
...
func (m *KeyIntegerValuePair) GetOdataType()(*string) {
...
func (m *KeyIntegerValuePair) SetOdataType(value *string)() {
