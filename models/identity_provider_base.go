...
// IdentityProviderBase provides operations to manage the collection of accessReviewDecision entities.
...
func (m *IdentityProviderBase) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *IdentityProviderBase) SetType(value *string)() {
    if m != nil {
