...
func (m *AddLargeGalleryViewOperation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AddLargeGalleryViewOperation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
