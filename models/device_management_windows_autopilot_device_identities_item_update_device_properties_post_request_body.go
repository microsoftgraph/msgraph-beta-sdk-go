...
func (m *DeviceManagementWindowsAutopilotDeviceIdentitiesItemUpdateDevicePropertiesPostRequestBody) GetDeviceAccountPassword()(*string) {
    return m.deviceAccountPassword
}
// GetDeviceAccountUpn gets the deviceAccountUpn property value. The deviceAccountUpn property
func (m *DeviceManagementWindowsAutopilotDeviceIdentitiesItemUpdateDevicePropertiesPostRequestBody) GetDeviceAccountUpn()(*string) {
...
func (m *DeviceManagementWindowsAutopilotDeviceIdentitiesItemUpdateDevicePropertiesPostRequestBody) GetDeviceFriendlyName()(*string) {
...
func (m *DeviceManagementWindowsAutopilotDeviceIdentitiesItemUpdateDevicePropertiesPostRequestBody) SetDeviceAccountPassword(value *string)() {
    m.deviceAccountPassword = value
}
// SetDeviceAccountUpn sets the deviceAccountUpn property value. The deviceAccountUpn property
func (m *DeviceManagementWindowsAutopilotDeviceIdentitiesItemUpdateDevicePropertiesPostRequestBody) SetDeviceAccountUpn(value *string)() {
    m.deviceAccountUpn = value
}
// SetDeviceFriendlyName sets the deviceFriendlyName property value. The deviceFriendlyName property
func (m *DeviceManagementWindowsAutopilotDeviceIdentitiesItemUpdateDevicePropertiesPostRequestBody) SetDeviceFriendlyName(value *string)() {
