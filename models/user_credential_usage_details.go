...
func (m *UserCredentialUsageDetails) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserCredentialUsageDetails) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
