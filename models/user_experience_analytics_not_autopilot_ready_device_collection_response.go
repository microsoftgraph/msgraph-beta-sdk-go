...
func (m *UserExperienceAnalyticsNotAutopilotReadyDeviceCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *UserExperienceAnalyticsNotAutopilotReadyDeviceCollectionResponse) SetOdataNextLink(value *string)() {
