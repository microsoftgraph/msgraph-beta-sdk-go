...
func (m *WindowsOfficeClientConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsOfficeClientConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
