...
// GetAdditionalDetails gets the additionalDetails property value. Additional details if there is error.
...
// SetAdditionalDetails sets the additionalDetails property value. Additional details if there is error.
