...
func (m *MobileAppTroubleshootingEvent) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MobileAppTroubleshootingEvent) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
