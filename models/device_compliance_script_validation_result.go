...
// returns a []DeviceComplianceScriptRuleErrorable when successful
...
// returns a []DeviceComplianceScriptRuleable when successful
...
// returns a []DeviceComplianceScriptErrorable when successful
