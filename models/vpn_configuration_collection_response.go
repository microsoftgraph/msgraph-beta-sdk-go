...
func (m *VpnConfigurationCollectionResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["value"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateVpnConfigurationFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]VpnConfigurationable, len(val))
            for i, v := range val {
                res[i] = v.(VpnConfigurationable)
            }
            m.SetValue(res)
        }
        return nil
...
func (m *VpnConfigurationCollectionResponse) GetValue()([]VpnConfigurationable) {
    ...
    if val != nil {
        return val.([]VpnConfigurationable)
    }
    return nil
}
...
// VpnConfigurationCollectionResponseable 
type VpnConfigurationCollectionResponseable interface {
    BaseCollectionPaginationCountResponseable
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetValue()([]VpnConfigurationable)
    SetValue(value []VpnConfigurationable)()
}
