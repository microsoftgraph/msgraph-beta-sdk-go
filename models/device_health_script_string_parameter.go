...
func (m *DeviceHealthScriptStringParameter) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceHealthScriptStringParameter) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
