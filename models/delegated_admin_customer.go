...
// DelegatedAdminCustomer provides operations to manage the collection of accessReview entities.
...
func (m *DelegatedAdminCustomer) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DelegatedAdminCustomer) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
