...
func CreateWindowsDefenderApplicationControlSupplementalPolicyCollectionResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
...
func (m *WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
