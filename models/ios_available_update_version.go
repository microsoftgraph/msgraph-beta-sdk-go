...
func (m *IosAvailableUpdateVersion) SetAdditionalData(value map[string]any)() {
...
func (m *IosAvailableUpdateVersion) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *IosAvailableUpdateVersion) SetPostingDateTime(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    err := m.GetBackingStore().Set("postingDateTime", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *IosAvailableUpdateVersion) SetSupportedDevices(value []string)() {
    err := m.GetBackingStore().Set("supportedDevices", value)
    if err != nil {
        panic(err)
    }
}
