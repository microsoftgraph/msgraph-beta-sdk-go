...
func (m *DeviceHealthScriptTimeSchedule) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceHealthScriptTimeSchedule) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
