...
func (m *TeamsAppUpgradedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TeamsAppUpgradedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
