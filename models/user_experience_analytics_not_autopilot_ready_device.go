...
func (m *UserExperienceAnalyticsNotAutopilotReadyDevice) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsNotAutopilotReadyDevice) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
