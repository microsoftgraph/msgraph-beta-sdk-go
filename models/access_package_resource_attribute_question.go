...
func (m *AccessPackageResourceAttributeQuestion) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessPackageResourceAttributeQuestion) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
