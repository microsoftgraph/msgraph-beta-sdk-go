...
// IdentityUserFlow provides operations to manage the collection of accessReview entities.
...
func (m *IdentityUserFlow) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *IdentityUserFlow) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
