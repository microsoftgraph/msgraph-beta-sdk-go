...
func (m *ProvisioningServicePrincipal) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ProvisioningServicePrincipal) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
