...
// Synchronization casts the previous resource to application.
...
func (m *Synchronization) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Synchronization) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
