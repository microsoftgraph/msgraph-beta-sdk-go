...
func (m *DeviceManagementConfigurationChoiceSettingValueConstantDefaultTemplate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationChoiceSettingValueConstantDefaultTemplate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
