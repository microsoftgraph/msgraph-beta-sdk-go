...
func (m *GroupPolicyPresentationValueBoolean) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *GroupPolicyPresentationValueBoolean) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
