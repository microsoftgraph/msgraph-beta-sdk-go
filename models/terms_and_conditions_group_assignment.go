...
func (m *TermsAndConditionsGroupAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TermsAndConditionsGroupAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
