...
func (m *DeviceConfigurationGroupAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceConfigurationGroupAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
