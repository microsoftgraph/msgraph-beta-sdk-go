...
func (m *Windows10XCertificateProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Windows10XCertificateProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
