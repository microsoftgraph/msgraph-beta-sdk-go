...
func (m *ActivateDeviceEsimActionResult) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ActivateDeviceEsimActionResult) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
