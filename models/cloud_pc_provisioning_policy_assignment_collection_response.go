...
func (m *CloudPcProvisioningPolicyAssignmentCollectionResponse) GetOdatanextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *CloudPcProvisioningPolicyAssignmentCollectionResponse) SetOdatanextLink(value *string)() {
    if m != nil {
        m.nextLink = value
    }
}
