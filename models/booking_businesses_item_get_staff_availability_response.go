...
func (m *BookingBusinessesItemGetStaffAvailabilityResponse) GetValue()([]StaffAvailabilityItemable) {
    return m.value
}
...
func (m *BookingBusinessesItemGetStaffAvailabilityResponse) SetValue(value []StaffAvailabilityItemable)() {
    m.value = value
}
