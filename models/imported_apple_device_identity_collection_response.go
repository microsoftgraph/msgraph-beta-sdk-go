...
func (m *ImportedAppleDeviceIdentityCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *ImportedAppleDeviceIdentityCollectionResponse) SetOdataNextLink(value *string)() {
