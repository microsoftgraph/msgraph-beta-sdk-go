...
func (m *DeviceManagementConfigurationSettingGroupInstance) GetOdataType()(*string) {
...
func (m *DeviceManagementConfigurationSettingGroupInstance) SetOdataType(value *string)() {
