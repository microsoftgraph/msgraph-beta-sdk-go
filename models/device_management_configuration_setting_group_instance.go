...
func (m *DeviceManagementConfigurationSettingGroupInstance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationSettingGroupInstance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
