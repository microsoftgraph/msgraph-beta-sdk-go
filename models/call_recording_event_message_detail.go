...
func (m *CallRecordingEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CallRecordingEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
