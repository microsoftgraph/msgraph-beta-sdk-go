...
// SecureScoreControlProfile provides operations to manage the collection of accessReviewDecision entities.
...
func NewSecureScoreControlProfile()(*SecureScoreControlProfile) {
    ...
    odataTypeValue := "#microsoft.graph.secureScoreControlProfile";
