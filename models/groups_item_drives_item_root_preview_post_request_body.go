...
func (m *GroupsItemDrivesItemRootPreviewPostRequestBody) GetAllowEdit()(*bool) {
    return m.allowEdit
}
// GetChromeless gets the chromeless property value. The chromeless property
func (m *GroupsItemDrivesItemRootPreviewPostRequestBody) GetChromeless()(*bool) {
    return m.chromeless
}
...
func (m *GroupsItemDrivesItemRootPreviewPostRequestBody) GetViewer()(*string) {
    return m.viewer
}
...
func (m *GroupsItemDrivesItemRootPreviewPostRequestBody) SetAllowEdit(value *bool)() {
    m.allowEdit = value
}
// SetChromeless sets the chromeless property value. The chromeless property
func (m *GroupsItemDrivesItemRootPreviewPostRequestBody) SetChromeless(value *bool)() {
    m.chromeless = value
}
...
func (m *GroupsItemDrivesItemRootPreviewPostRequestBody) SetViewer(value *string)() {
    m.viewer = value
}
