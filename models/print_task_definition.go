...
// PrintTaskDefinition provides operations to manage the collection of accessReview entities.
...
func (m *PrintTaskDefinition) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PrintTaskDefinition) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
