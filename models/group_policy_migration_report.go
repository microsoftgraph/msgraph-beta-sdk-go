...
func (m *GroupPolicyMigrationReport) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *GroupPolicyMigrationReport) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
