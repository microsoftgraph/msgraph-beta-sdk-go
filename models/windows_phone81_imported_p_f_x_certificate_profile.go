...
func (m *WindowsPhone81ImportedPFXCertificateProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsPhone81ImportedPFXCertificateProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
