...
// OutlookCategory provides operations to manage the collection of accessReview entities.
...
func (m *OutlookCategory) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *OutlookCategory) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
