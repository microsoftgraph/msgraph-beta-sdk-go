...
func (m *AndroidWorkProfileCustomConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidWorkProfileCustomConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
