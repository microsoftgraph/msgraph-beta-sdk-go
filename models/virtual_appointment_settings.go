...
func (m *VirtualAppointmentSettings) GetAllowClientToJoinUsingBrowser()(*bool) {
    val, err := m.GetBackingStore().Get("allowClientToJoinUsingBrowser")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *VirtualAppointmentSettings) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *VirtualAppointmentSettings) SetAllowClientToJoinUsingBrowser(value *bool)() {
    err := m.GetBackingStore().Set("allowClientToJoinUsingBrowser", value)
    if err != nil {
        panic(err)
    }
}
// SetBackingStore sets the backingStore property value. Stores model information.
func (m *VirtualAppointmentSettings) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
