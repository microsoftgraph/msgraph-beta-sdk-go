...
func (m *MobileAppTroubleshootingAppPolicyCreationHistory) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MobileAppTroubleshootingAppPolicyCreationHistory) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
