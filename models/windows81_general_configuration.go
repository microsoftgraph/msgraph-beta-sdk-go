...
// returns a *UpdateClassification when successful
func (m *Windows81GeneralConfiguration) GetMinimumAutoInstallClassification()(*UpdateClassification) {
    val, err := m.GetBackingStore().Get("minimumAutoInstallClassification")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*UpdateClassification)
    }
    return nil
}
...
func (m *Windows81GeneralConfiguration) GetUpdatesMinimumAutoInstallClassification()(*UpdateClassification) {
    val, err := m.GetBackingStore().Get("updatesMinimumAutoInstallClassification")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *Windows81GeneralConfiguration) SetMinimumAutoInstallClassification(value *UpdateClassification)() {
    err := m.GetBackingStore().Set("minimumAutoInstallClassification", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *Windows81GeneralConfiguration) SetUpdatesMinimumAutoInstallClassification(value *UpdateClassification)() {
    err := m.GetBackingStore().Set("updatesMinimumAutoInstallClassification", value)
    if err != nil {
        panic(err)
    }
}
