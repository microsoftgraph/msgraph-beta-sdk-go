...
func (m *Error) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
// GetMessage gets the message property value. The message for the error
// returns a *string when successful
...
// returns a *string when successful
func (m *Error) GetOdataType()(*string) {
...
func (m *Error) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetCode sets the code property value. The error code
func (m *Error) SetCode(value *string)() {
    err := m.GetBackingStore().Set("code", value)
    if err != nil {
        panic(err)
    }
}
// SetMessage sets the message property value. The message for the error
...
func (m *Error) SetOdataType(value *string)() {
