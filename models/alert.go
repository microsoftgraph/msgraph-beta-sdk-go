...
// GetCreatedDateTime gets the createdDateTime property value. Time at which the alert provider created the alert. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Required.
// returns a *Time when successful
...
// GetFileStates gets the fileStates property value. Security-related stateful information generated by the provider about the files related to this alert.
...
// GetHostStates gets the hostStates property value. Security-related stateful information generated by the provider about the hosts related to this alert.
...
// GetNetworkConnections gets the networkConnections property value. Security-related stateful information generated by the provider about the network connections related to this alert.
...
// GetRecommendedActions gets the recommendedActions property value. Vendor/provider recommended actions to take as a result of the alert (for example, isolate machine, enforce2FA, reimage host).
// returns a []string when successful
...
// GetSecurityResources gets the securityResources property value. Resources related to current alert. For example, some alerts have the Azure Resource value.
...
// GetTags gets the tags property value. User-definable labels that can be applied to an alert and can serve as filter conditions (for example, 'HVA', 'SAW'). Updatable.
// returns a []string when successful
...
// SetCreatedDateTime sets the createdDateTime property value. Time at which the alert provider created the alert. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Required.
...
// SetFileStates sets the fileStates property value. Security-related stateful information generated by the provider about the files related to this alert.
...
// SetHostStates sets the hostStates property value. Security-related stateful information generated by the provider about the hosts related to this alert.
...
// SetNetworkConnections sets the networkConnections property value. Security-related stateful information generated by the provider about the network connections related to this alert.
...
// SetRecommendedActions sets the recommendedActions property value. Vendor/provider recommended actions to take as a result of the alert (for example, isolate machine, enforce2FA, reimage host).
...
// SetSecurityResources sets the securityResources property value. Resources related to current alert. For example, some alerts have the Azure Resource value.
...
// SetTags sets the tags property value. User-definable labels that can be applied to an alert and can serve as filter conditions (for example, 'HVA', 'SAW'). Updatable.
