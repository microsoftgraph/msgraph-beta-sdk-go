...
func (m *DrivesItemItemsItemCreateLinkPostRequestBody) GetRecipients()([]DriveRecipientable) {
    return m.recipients
}
...
func (m *DrivesItemItemsItemCreateLinkPostRequestBody) SetRecipients(value []DriveRecipientable)() {
    m.recipients = value
}
