...
func (m *ManagedDeviceEncryptionState) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ManagedDeviceEncryptionState) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
