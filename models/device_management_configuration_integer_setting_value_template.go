...
func (m *DeviceManagementConfigurationIntegerSettingValueTemplate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationIntegerSettingValueTemplate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
