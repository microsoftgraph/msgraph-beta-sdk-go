...
// GetCreatedDateTime gets the createdDateTime property value. Indicates the date and time the conditional access policy was created.
...
// GetDescription gets the description property value. Provides a summary of the conditional access policy.
...
// GetDisplayName gets the displayName property value. Represents the human-readable name or title assigned to the conditional access policy.
...
// GetModifiedDateTime gets the modifiedDateTime property value. Indicates the date and time when the conditional access policy was last modified.
...
func (m *ConditionalAccessPolicy) GetOdataType()(*string) {
...
// SetCreatedDateTime sets the createdDateTime property value. Indicates the date and time the conditional access policy was created.
...
// SetDescription sets the description property value. Provides a summary of the conditional access policy.
...
// SetDisplayName sets the displayName property value. Represents the human-readable name or title assigned to the conditional access policy.
...
// SetModifiedDateTime sets the modifiedDateTime property value. Indicates the date and time when the conditional access policy was last modified.
...
func (m *ConditionalAccessPolicy) SetOdataType(value *string)() {
