...
func (m *DestinationSummary) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["trafficType"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseDestinationSummary_trafficType)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTrafficType(val.(*DestinationSummary_trafficType))
        }
        return nil
    }
    return res
...
func (m *DestinationSummary) GetTrafficType()(*DestinationSummary_trafficType) {
    val, err := m.GetBackingStore().Get("trafficType")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*DestinationSummary_trafficType)
    }
    return nil
}
...
func (m *DestinationSummary) SetTrafficType(value *DestinationSummary_trafficType)() {
...
type DestinationSummaryable interface {
    ...
    GetOdataType()(*string)
    GetTrafficType()(*DestinationSummary_trafficType)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetCount(value *int32)()
    SetDestination(value *string)()
    SetOdataType(value *string)()
    SetTrafficType(value *DestinationSummary_trafficType)()
}
