...
func (m *AuditActivityInitiator) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["linkableIdentifiers"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateLinkableIdentifiersFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetLinkableIdentifiers(val.(LinkableIdentifiersable))
        }
        return nil
    }
...
// GetLinkableIdentifiers gets the linkableIdentifiers property value. A set of linkable claims to link together all the authentication artifacts issued from a single interactive root authentication.
// returns a LinkableIdentifiersable when successful
func (m *AuditActivityInitiator) GetLinkableIdentifiers()(LinkableIdentifiersable) {
    val, err := m.GetBackingStore().Get("linkableIdentifiers")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(LinkableIdentifiersable)
    }
    return nil
}
...
func (m *AuditActivityInitiator) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err := writer.WriteObjectValue("linkableIdentifiers", m.GetLinkableIdentifiers())
        if err != nil {
            return err
        }
    }
...
// SetLinkableIdentifiers sets the linkableIdentifiers property value. A set of linkable claims to link together all the authentication artifacts issued from a single interactive root authentication.
func (m *AuditActivityInitiator) SetLinkableIdentifiers(value LinkableIdentifiersable)() {
    err := m.GetBackingStore().Set("linkableIdentifiers", value)
    if err != nil {
        panic(err)
    }
}
...
type AuditActivityInitiatorable interface {
    ...
    GetLinkableIdentifiers()(LinkableIdentifiersable)
    GetOdataType()(*string)
    GetUser()(AuditUserIdentityable)
    SetApp(value AppIdentityable)()
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetLinkableIdentifiers(value LinkableIdentifiersable)()
