...
func (m *DataLossPreventionPolicyCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *DataLossPreventionPolicyCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
