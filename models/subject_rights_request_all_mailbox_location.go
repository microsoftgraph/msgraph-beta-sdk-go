...
func (m *SubjectRightsRequestAllMailboxLocation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *SubjectRightsRequestAllMailboxLocation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
