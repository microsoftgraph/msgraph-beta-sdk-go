...
func (m *AndroidWorkProfileCertificateProfileBase) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidWorkProfileCertificateProfileBase) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
