...
// GetCertificationControls gets the certificationControls property value. The certificationControls property
func (m *ComplianceInformation) GetCertificationControls()([]CertificationControlable) {
    return m.certificationControls
}
// GetCertificationName gets the certificationName property value. The certificationName property
...
// SetCertificationControls sets the certificationControls property value. The certificationControls property
func (m *ComplianceInformation) SetCertificationControls(value []CertificationControlable)() {
    m.certificationControls = value
}
// SetCertificationName sets the certificationName property value. The certificationName property
