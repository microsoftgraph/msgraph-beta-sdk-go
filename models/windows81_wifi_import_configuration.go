...
func (m *Windows81WifiImportConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Windows81WifiImportConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
