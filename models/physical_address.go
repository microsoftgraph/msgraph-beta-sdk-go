...
func (m *PhysicalAddress) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["type"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetTypeEscaped(val.(*PhysicalAddress_type))
        }
        return nil
    }
    return res
...
func (m *PhysicalAddress) GetPostOfficeBox()(*string) {
    val, err := m.GetBackingStore().Get("postOfficeBox")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *PhysicalAddress) GetTypeEscaped()(*PhysicalAddress_type) {
    val, err := m.GetBackingStore().Get("typeEscaped")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*PhysicalAddress_type)
    }
    return nil
}
...
func (m *PhysicalAddress) SetPostOfficeBox(value *string)() {
    err := m.GetBackingStore().Set("postOfficeBox", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *PhysicalAddress) SetTypeEscaped(value *PhysicalAddress_type)() {
...
type PhysicalAddressable interface {
    ...
    GetState()(*string)
    GetStreet()(*string)
    GetTypeEscaped()(*PhysicalAddress_type)
    ...
    SetTypeEscaped(value *PhysicalAddress_type)()
}
