...
func (m *DeviceManagementScriptUserState) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementScriptUserState) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
