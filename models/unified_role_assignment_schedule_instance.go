...
func (m *UnifiedRoleAssignmentScheduleInstance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UnifiedRoleAssignmentScheduleInstance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
