...
// InferenceClassification provides operations to manage the collection of accessReview entities.
...
func (m *InferenceClassification) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *InferenceClassification) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
