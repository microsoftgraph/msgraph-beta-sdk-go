...
func (m *LocalizedNotificationMessage) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *LocalizedNotificationMessage) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
