...
func (m *DeliveryOptimizationMaxCacheSizePercentage) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeliveryOptimizationMaxCacheSizePercentage) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
