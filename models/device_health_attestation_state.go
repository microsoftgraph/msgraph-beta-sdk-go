...
// returns a *FirmwareProtectionType when successful
...
// returns a *AzureAttestationSettingStatus when successful
...
// returns a *SystemManagementModeLevel when successful
