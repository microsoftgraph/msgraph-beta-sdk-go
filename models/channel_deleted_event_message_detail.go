...
func (m *ChannelDeletedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ChannelDeletedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
