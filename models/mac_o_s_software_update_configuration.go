...
func (m *MacOSSoftwareUpdateConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MacOSSoftwareUpdateConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
