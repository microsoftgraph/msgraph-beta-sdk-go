...
func (m *VirtualEventRegistrationCustomQuestion) GetAnswerInputType()(*VirtualEventRegistrationCustomQuestion_answerInputType) {
    val, err := m.GetBackingStore().Get("answerInputType")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*VirtualEventRegistrationCustomQuestion_answerInputType)
    }
    return nil
}
...
func (m *VirtualEventRegistrationCustomQuestion) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["answerInputType"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseVirtualEventRegistrationCustomQuestion_answerInputType)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAnswerInputType(val.(*VirtualEventRegistrationCustomQuestion_answerInputType))
        }
        return nil
    }
    return res
...
func (m *VirtualEventRegistrationCustomQuestion) SetAnswerInputType(value *VirtualEventRegistrationCustomQuestion_answerInputType)() {
...
type VirtualEventRegistrationCustomQuestionable interface {
    ...
    GetAnswerInputType()(*VirtualEventRegistrationCustomQuestion_answerInputType)
    SetAnswerChoices(value []string)()
    SetAnswerInputType(value *VirtualEventRegistrationCustomQuestion_answerInputType)()
}
