...
// AdminReportSettings provides operations to manage the admin singleton.
...
func (m *AdminReportSettings) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AdminReportSettings) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
