...
func (m *MdmWindowsInformationProtectionPolicyPolicySetItem) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MdmWindowsInformationProtectionPolicyPolicySetItem) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
