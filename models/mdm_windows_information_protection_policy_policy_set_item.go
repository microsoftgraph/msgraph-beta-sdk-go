...
func (m *MdmWindowsInformationProtectionPolicyPolicySetItem) GetOdataType()(*string) {
...
func (m *MdmWindowsInformationProtectionPolicyPolicySetItem) SetOdataType(value *string)() {
    err := m.GetBackingStore().Set("odataType", value)
    if err != nil {
        panic(err)
    }
}
// MdmWindowsInformationProtectionPolicyPolicySetItemable 
