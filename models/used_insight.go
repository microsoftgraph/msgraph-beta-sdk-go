...
// UsedInsight provides operations to manage the collection of accessReview entities.
...
func (m *UsedInsight) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UsedInsight) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
