...
func (m *TeamsAppRemovedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *TeamsAppRemovedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
