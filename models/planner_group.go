...
// PlannerGroup provides operations to manage the collection of accessReview entities.
...
func (m *PlannerGroup) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PlannerGroup) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
