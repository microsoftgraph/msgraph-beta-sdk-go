...
// GetInitiatorType gets the initiatorType property value. The type of the initiator. The possible values are: user, application, system, unknownFutureValue.
...
// SetInitiatorType sets the initiatorType property value. The type of the initiator. The possible values are: user, application, system, unknownFutureValue.
