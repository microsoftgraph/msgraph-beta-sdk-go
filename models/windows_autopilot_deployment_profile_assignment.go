...
func (m *WindowsAutopilotDeploymentProfileAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsAutopilotDeploymentProfileAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
