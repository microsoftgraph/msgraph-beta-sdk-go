...
func (m *UserExperienceAnalyticsOverview) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsOverview) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
