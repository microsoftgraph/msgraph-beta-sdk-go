...
func (m *LogicAppTriggerEndpointConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *LogicAppTriggerEndpointConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
