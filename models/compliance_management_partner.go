...
func (m *ComplianceManagementPartner) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["windowsEnrollmentAssignments"] = i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.SetCollectionOfObjectValues(CreateComplianceManagementPartnerAssignmentFromDiscriminatorValue , m.SetWindowsEnrollmentAssignments)
    res["windowsOnboarded"] = i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.SetBoolValue(m.SetWindowsOnboarded)
    return res
}
...
// GetWindowsEnrollmentAssignments gets the windowsEnrollmentAssignments property value. User groups which enroll Windows devices through partner.
func (m *ComplianceManagementPartner) GetWindowsEnrollmentAssignments()([]ComplianceManagementPartnerAssignmentable) {
    return m.windowsEnrollmentAssignments
}
// GetWindowsOnboarded gets the windowsOnboarded property value. Partner onboarded for Windows devices.
func (m *ComplianceManagementPartner) GetWindowsOnboarded()(*bool) {
    return m.windowsOnboarded
}
...
func (m *ComplianceManagementPartner) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    if m.GetWindowsEnrollmentAssignments() != nil {
        cast := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.CollectionCast[i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable](m.GetWindowsEnrollmentAssignments())
        err = writer.WriteCollectionOfObjectValues("windowsEnrollmentAssignments", cast)
        if err != nil {
            return err
        }
    }
    {
        err = writer.WriteBoolValue("windowsOnboarded", m.GetWindowsOnboarded())
        if err != nil {
            return err
        }
    }
...
// SetWindowsEnrollmentAssignments sets the windowsEnrollmentAssignments property value. User groups which enroll Windows devices through partner.
func (m *ComplianceManagementPartner) SetWindowsEnrollmentAssignments(value []ComplianceManagementPartnerAssignmentable)() {
    m.windowsEnrollmentAssignments = value
}
// SetWindowsOnboarded sets the windowsOnboarded property value. Partner onboarded for Windows devices.
func (m *ComplianceManagementPartner) SetWindowsOnboarded(value *bool)() {
    m.windowsOnboarded = value
}
