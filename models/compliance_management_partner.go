...
func (m *ComplianceManagementPartner) GetWindowsEnrollmentAssignments()([]ComplianceManagementPartnerAssignmentable) {
    val, err := m.GetBackingStore().Get("windowsEnrollmentAssignments")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ComplianceManagementPartner) GetWindowsOnboarded()(*bool) {
    val, err := m.GetBackingStore().Get("windowsOnboarded")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ComplianceManagementPartner) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    if m.GetWindowsEnrollmentAssignments() != nil {
        cast := make([]i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, len(m.GetWindowsEnrollmentAssignments()))
        for i, v := range m.GetWindowsEnrollmentAssignments() {
            cast[i] = v.(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable)
        }
...
func (m *ComplianceManagementPartner) SetWindowsEnrollmentAssignments(value []ComplianceManagementPartnerAssignmentable)() {
    err := m.GetBackingStore().Set("windowsEnrollmentAssignments", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *ComplianceManagementPartner) SetWindowsOnboarded(value *bool)() {
    err := m.GetBackingStore().Set("windowsOnboarded", value)
    if err != nil {
        panic(err)
    }
}
...
type ComplianceManagementPartnerable interface {
    ...
    GetWindowsEnrollmentAssignments()([]ComplianceManagementPartnerAssignmentable)
    GetWindowsOnboarded()(*bool)
    ...
    SetWindowsEnrollmentAssignments(value []ComplianceManagementPartnerAssignmentable)()
    SetWindowsOnboarded(value *bool)()
}
