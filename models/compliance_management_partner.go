...
func (m *ComplianceManagementPartner) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ComplianceManagementPartner) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
