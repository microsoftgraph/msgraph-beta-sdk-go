...
// LinkedResource provides operations to manage the collection of accessReview entities.
...
func (m *LinkedResource) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *LinkedResource) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
