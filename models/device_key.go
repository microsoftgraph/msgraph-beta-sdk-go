...
func (m *DeviceKey) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *DeviceKey) SetKeyMaterial(value []byte)() {
    err := m.GetBackingStore().Set("keyMaterial", value)
    if err != nil {
        panic(err)
    }
}
