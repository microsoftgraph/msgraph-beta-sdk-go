...
func (m *AgentInterface) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *AgentInterface) GetOdataType()(*string) {
...
// GetTransport gets the transport property value. The transport protocol supported at this URL.
// returns a *string when successful
...
// GetUrl gets the url property value. The URL where this interface is available. Must be a valid absolute HTTPS URL in production.
// returns a *string when successful
...
func (m *AgentInterface) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err := writer.WriteStringValue("transport", m.GetTransport())
        if err != nil {
            return err
        }
    }
...
func (m *AgentInterface) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetOdataType sets the @odata.type property value. The OdataType property
func (m *AgentInterface) SetOdataType(value *string)() {
    err := m.GetBackingStore().Set("odataType", value)
    if err != nil {
        panic(err)
    }
}
// SetTransport sets the transport property value. The transport protocol supported at this URL.
func (m *AgentInterface) SetTransport(value *string)() {
    err := m.GetBackingStore().Set("transport", value)
    if err != nil {
        panic(err)
    }
}
// SetUrl sets the url property value. The URL where this interface is available. Must be a valid absolute HTTPS URL in production.
