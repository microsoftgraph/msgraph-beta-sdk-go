...
func (m *DeviceManagementConfigurationSettingValueDefinition) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationSettingValueDefinition) SetType(value *string)() {
    if m != nil {
