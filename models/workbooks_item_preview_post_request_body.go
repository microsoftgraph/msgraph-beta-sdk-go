...
func (m *WorkbooksItemPreviewPostRequestBody) GetAllowEdit()(*bool) {
    return m.allowEdit
}
// GetChromeless gets the chromeless property value. The chromeless property
func (m *WorkbooksItemPreviewPostRequestBody) GetChromeless()(*bool) {
    return m.chromeless
}
...
func (m *WorkbooksItemPreviewPostRequestBody) GetViewer()(*string) {
    return m.viewer
}
...
func (m *WorkbooksItemPreviewPostRequestBody) SetAllowEdit(value *bool)() {
    m.allowEdit = value
}
// SetChromeless sets the chromeless property value. The chromeless property
func (m *WorkbooksItemPreviewPostRequestBody) SetChromeless(value *bool)() {
    m.chromeless = value
}
...
func (m *WorkbooksItemPreviewPostRequestBody) SetViewer(value *string)() {
    m.viewer = value
}
