...
func (m *BusinessScenarioTaskTargetBase) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
// returns a *PlannerTaskTargetKind when successful
func (m *BusinessScenarioTaskTargetBase) GetTaskTargetKind()(*PlannerTaskTargetKind) {
    val, err := m.GetBackingStore().Get("taskTargetKind")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*PlannerTaskTargetKind)
    }
    return nil
}
...
func (m *BusinessScenarioTaskTargetBase) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *BusinessScenarioTaskTargetBase) SetTaskTargetKind(value *PlannerTaskTargetKind)() {
    err := m.GetBackingStore().Set("taskTargetKind", value)
    if err != nil {
        panic(err)
    }
}
type BusinessScenarioTaskTargetBaseable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackedModel
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetOdataType()(*string)
    GetTaskTargetKind()(*PlannerTaskTargetKind)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetOdataType(value *string)()
    SetTaskTargetKind(value *PlannerTaskTargetKind)()
}
