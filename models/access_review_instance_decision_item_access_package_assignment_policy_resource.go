...
func (m *AccessReviewInstanceDecisionItemAccessPackageAssignmentPolicyResource) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessReviewInstanceDecisionItemAccessPackageAssignmentPolicyResource) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
