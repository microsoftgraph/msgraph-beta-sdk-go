...
func (m *OpenIdConnectIdentityProvider) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *OpenIdConnectIdentityProvider) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
