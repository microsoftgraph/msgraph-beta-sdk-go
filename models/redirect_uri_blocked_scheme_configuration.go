...
type RedirectUriBlockedSchemeConfiguration struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewRedirectUriBlockedSchemeConfiguration instantiates a new RedirectUriBlockedSchemeConfiguration and sets the default values.
func NewRedirectUriBlockedSchemeConfiguration()(*RedirectUriBlockedSchemeConfiguration) {
    m := &RedirectUriBlockedSchemeConfiguration{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateRedirectUriBlockedSchemeConfigurationFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateRedirectUriBlockedSchemeConfigurationFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewRedirectUriBlockedSchemeConfiguration(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *RedirectUriBlockedSchemeConfiguration) GetAdditionalData()(map[string]any) {
...
func (m *RedirectUriBlockedSchemeConfiguration) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    res := make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
    res["blockedSchemes"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
    ...
    res["exemptFormats"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfPrimitiveValues("string")
        if err != nil {
            return err
        }
    ...
    res["publicClient"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateRedirectUriPlatformBlockedSchemeConfigurationFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetPublicClient(val.(RedirectUriPlatformBlockedSchemeConfigurationable))
        }
        return nil
    }
    ...
    res["spa"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetSpa(val.(RedirectUriPlatformBlockedSchemeConfigurationable))
        }
        return nil
    }
    ...
    res["web"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetWeb(val.(RedirectUriPlatformBlockedSchemeConfigurationable))
        }
        return nil
    }
    return res
...
// returns a *string when successful
func (m *RedirectUriBlockedSchemeConfiguration) GetOdataType()(*string) {
...
func (m *RedirectUriBlockedSchemeConfiguration) GetPublicClient()(RedirectUriPlatformBlockedSchemeConfigurationable) {
    ...
    if val != nil {
        return val.(RedirectUriPlatformBlockedSchemeConfigurationable)
    }
    return nil
}
...
func (m *RedirectUriBlockedSchemeConfiguration) GetState()(*AppManagementRestrictionState) {
...
func (m *RedirectUriBlockedSchemeConfiguration) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetBlockedSchemes() != nil {
        err := writer.WriteCollectionOfStringValues("blockedSchemes", m.GetBlockedSchemes())
        if err != nil {
            return err
        }
    }
    ...
    if m.GetExemptFormats() != nil {
        err := writer.WriteCollectionOfStringValues("exemptFormats", m.GetExemptFormats())
        if err != nil {
            return err
        }
    }
...
func (m *RedirectUriBlockedSchemeConfiguration) SetAdditionalData(value map[string]any)() {
...
func (m *RedirectUriBlockedSchemeConfiguration) SetOdataType(value *string)() {
...
func (m *RedirectUriBlockedSchemeConfiguration) SetState(value *AppManagementRestrictionState)() {
