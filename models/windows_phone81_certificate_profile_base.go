...
func (m *WindowsPhone81CertificateProfileBase) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsPhone81CertificateProfileBase) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
