...
func (m *X509CertificateAuthenticationMethodConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *X509CertificateAuthenticationMethodConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
