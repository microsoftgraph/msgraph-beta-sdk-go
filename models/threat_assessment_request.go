...
// GetRequestSource gets the requestSource property value. The source of the threat assessment request. The possible values are: user, administrator.
...
// SetRequestSource sets the requestSource property value. The source of the threat assessment request. The possible values are: user, administrator.
