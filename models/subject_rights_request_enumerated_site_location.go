...
func (m *SubjectRightsRequestEnumeratedSiteLocation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *SubjectRightsRequestEnumeratedSiteLocation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
