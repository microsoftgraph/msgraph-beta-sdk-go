...
func (m *ExactMatchDetectedSensitiveContent) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ExactMatchDetectedSensitiveContent) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
