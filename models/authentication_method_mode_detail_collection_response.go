...
func (m *AuthenticationMethodModeDetailCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *AuthenticationMethodModeDetailCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *AuthenticationMethodModeDetailCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *AuthenticationMethodModeDetailCollectionResponse) SetOdataNextLink(value *string)() {
