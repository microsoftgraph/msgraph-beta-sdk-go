...
func (m *DeviceCompliancePolicyPolicySetItem) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceCompliancePolicyPolicySetItem) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
