...
func (m *GroupPolicyPresentationLongDecimalTextBox) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *GroupPolicyPresentationLongDecimalTextBox) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
