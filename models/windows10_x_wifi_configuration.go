...
func (m *Windows10XWifiConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Windows10XWifiConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
