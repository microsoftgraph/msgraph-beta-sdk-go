...
func (m *DeviceConfigurationPolicySetItem) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceConfigurationPolicySetItem) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
