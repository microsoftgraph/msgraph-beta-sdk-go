...
func (m *SubjectRightsRequestEnumeratedMailboxLocation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *SubjectRightsRequestEnumeratedMailboxLocation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
