...
func (m *AndroidForWorkAppConfigurationSchema) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidForWorkAppConfigurationSchema) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
