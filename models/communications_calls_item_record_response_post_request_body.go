...
func (m *CommunicationsCallsItemRecordResponsePostRequestBody) GetStreamWhileRecording()(*bool) {
...
func (m *CommunicationsCallsItemRecordResponsePostRequestBody) SetStreamWhileRecording(value *bool)() {
