...
func (m *TeamDiscoverySettings) GetAdditionalData()(map[string]any) {
...
func (m *TeamDiscoverySettings) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *TeamDiscoverySettings) GetShowInTeamsSearchAndSuggestions()(*bool) {
    val, err := m.GetBackingStore().Get("showInTeamsSearchAndSuggestions")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *TeamDiscoverySettings) SetAdditionalData(value map[string]any)() {
...
func (m *TeamDiscoverySettings) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *TeamDiscoverySettings) SetShowInTeamsSearchAndSuggestions(value *bool)() {
    err := m.GetBackingStore().Set("showInTeamsSearchAndSuggestions", value)
    if err != nil {
        panic(err)
    }
}
