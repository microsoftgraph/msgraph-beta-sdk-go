...
func (m *ChannelMembersNotificationRecipient) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ChannelMembersNotificationRecipient) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
