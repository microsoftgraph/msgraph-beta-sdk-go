...
func (m *DeviceHealthScriptAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceHealthScriptAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
