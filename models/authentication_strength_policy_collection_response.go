...
func (m *AuthenticationStrengthPolicyCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *AuthenticationStrengthPolicyCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *AuthenticationStrengthPolicyCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *AuthenticationStrengthPolicyCollectionResponse) SetOdataNextLink(value *string)() {
