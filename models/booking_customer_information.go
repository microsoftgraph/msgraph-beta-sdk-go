...
func (m *BookingCustomerInformation) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
// GetSmsNotificationsEnabled gets the smsNotificationsEnabled property value. Indicates if the SMS notifications will be sent to the customer for the appointment
func (m *BookingCustomerInformation) GetSmsNotificationsEnabled()(*bool) {
    if m == nil {
        return nil
    } else {
...
func (m *BookingCustomerInformation) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
...
// SetSmsNotificationsEnabled sets the smsNotificationsEnabled property value. Indicates if the SMS notifications will be sent to the customer for the appointment
func (m *BookingCustomerInformation) SetSmsNotificationsEnabled(value *bool)() {
    if m != nil {
