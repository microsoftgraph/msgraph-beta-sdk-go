...
// RankedEmailAddress_RankedEmailAddress_rank composed type wrapper for classes float64, ReferenceNumeric, string
type RankedEmailAddress_RankedEmailAddress_rank struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewRankedEmailAddress_RankedEmailAddress_rank instantiates a new RankedEmailAddress_RankedEmailAddress_rank and sets the default values.
func NewRankedEmailAddress_RankedEmailAddress_rank()(*RankedEmailAddress_RankedEmailAddress_rank) {
    m := &RankedEmailAddress_RankedEmailAddress_rank{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    return m
}
// CreateRankedEmailAddress_RankedEmailAddress_rankFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateRankedEmailAddress_RankedEmailAddress_rankFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    result := NewRankedEmailAddress_RankedEmailAddress_rank()
    if parseNode != nil {
...
func (m *RankedEmailAddress_RankedEmailAddress_rank) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetDouble gets the double property value. Composed type representation for type float64
// returns a *float64 when successful
func (m *RankedEmailAddress_RankedEmailAddress_rank) GetDouble()(*float64) {
...
func (m *RankedEmailAddress_RankedEmailAddress_rank) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    return make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
}
// GetIsComposedType determines if the current object is a wrapper around a composed type
// returns a bool when successful
func (m *RankedEmailAddress_RankedEmailAddress_rank) GetIsComposedType()(bool) {
    return true
}
...
func (m *RankedEmailAddress_RankedEmailAddress_rank) GetReferenceNumeric()(*ReferenceNumeric) {
...
func (m *RankedEmailAddress_RankedEmailAddress_rank) GetString()(*string) {
...
func (m *RankedEmailAddress_RankedEmailAddress_rank) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *RankedEmailAddress_RankedEmailAddress_rank) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetDouble sets the double property value. Composed type representation for type float64
func (m *RankedEmailAddress_RankedEmailAddress_rank) SetDouble(value *float64)() {
...
func (m *RankedEmailAddress_RankedEmailAddress_rank) SetReferenceNumeric(value *ReferenceNumeric)() {
...
func (m *RankedEmailAddress_RankedEmailAddress_rank) SetString(value *string)() {
    err := m.GetBackingStore().Set("string", value)
    if err != nil {
        panic(err)
    }
}
type RankedEmailAddress_RankedEmailAddress_rankable interface {
...
func (m *RankedEmailAddress) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["rank"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetRank(val.(*RankedEmailAddress_RankedEmailAddress_rank))
        }
        return nil
    }
    return res
...
// returns a RankedEmailAddress_RankedEmailAddress_rankable when successful
func (m *RankedEmailAddress) GetRank()(RankedEmailAddress_RankedEmailAddress_rankable) {
    val, err := m.GetBackingStore().Get("rank")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(RankedEmailAddress_RankedEmailAddress_rankable)
    }
    return nil
}
// Serialize serializes information the current object
...
func (m *RankedEmailAddress) SetRank(value RankedEmailAddress_RankedEmailAddress_rankable)() {
...
type RankedEmailAddressable interface {
    ...
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetOdataType()(*string)
    GetRank()(RankedEmailAddress_RankedEmailAddress_rankable)
    SetAddress(value *string)()
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetOdataType(value *string)()
    SetRank(value RankedEmailAddress_RankedEmailAddress_rankable)()
}
