...
func (m *UnifiedRbacResourceNamespace) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UnifiedRbacResourceNamespace) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
