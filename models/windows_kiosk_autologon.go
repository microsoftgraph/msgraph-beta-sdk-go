...
// WindowsKioskAutologon the user base class used to identify the account info for the kiosk configuration
...
func (m *WindowsKioskAutologon) GetOdataType()(*string) {
...
func (m *WindowsKioskAutologon) SetOdataType(value *string)() {
