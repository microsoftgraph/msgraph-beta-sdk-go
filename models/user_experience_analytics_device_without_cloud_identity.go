...
func (m *UserExperienceAnalyticsDeviceWithoutCloudIdentity) GetOdataType()(*string) {
...
func (m *UserExperienceAnalyticsDeviceWithoutCloudIdentity) SetOdataType(value *string)() {
