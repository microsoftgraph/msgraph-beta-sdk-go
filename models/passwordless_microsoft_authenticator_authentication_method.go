...
func (m *PasswordlessMicrosoftAuthenticatorAuthenticationMethod) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PasswordlessMicrosoftAuthenticatorAuthenticationMethod) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
