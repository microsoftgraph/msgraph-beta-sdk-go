...
// WorkbookChartLegendFormat provides operations to manage the collection of accessReview entities.
...
func (m *WorkbookChartLegendFormat) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookChartLegendFormat) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
