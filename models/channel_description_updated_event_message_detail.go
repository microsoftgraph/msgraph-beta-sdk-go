...
func (m *ChannelDescriptionUpdatedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ChannelDescriptionUpdatedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
