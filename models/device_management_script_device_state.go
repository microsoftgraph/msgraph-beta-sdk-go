...
func (m *DeviceManagementScriptDeviceState) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementScriptDeviceState) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
