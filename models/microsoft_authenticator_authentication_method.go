...
func (m *MicrosoftAuthenticatorAuthenticationMethod) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MicrosoftAuthenticatorAuthenticationMethod) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
