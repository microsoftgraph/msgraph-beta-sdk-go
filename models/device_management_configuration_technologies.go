...
func (i DeviceManagementConfigurationTechnologies) String() string {
    var values []string
    options := []string{"none", "mdm", "windows10XManagement", "configManager", "appleRemoteManagement", "microsoftSense", "exchangeOnline", "mobileApplicationManagement", "linuxMdm", "enrollment", "endpointPrivilegeManagement", "unknownFutureValue"}
    for p := 0; p < 12; p++ {
