...
func (m *AccessPackageResourceEnvironmentCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessPackageResourceEnvironmentCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
