...
// PlannerBucket provides operations to manage the collection of accessReview entities.
...
func (m *PlannerBucket) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PlannerBucket) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
