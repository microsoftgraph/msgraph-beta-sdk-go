...
func (m *AndroidEnterpriseWiFiConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidEnterpriseWiFiConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
