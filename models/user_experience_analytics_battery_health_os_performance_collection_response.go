...
func (m *UserExperienceAnalyticsBatteryHealthOsPerformanceCollectionResponse) GetOdatanextLink()(*string) {
    if m == nil {
        return nil
    } else {
        return m.nextLink
...
func (m *UserExperienceAnalyticsBatteryHealthOsPerformanceCollectionResponse) SetOdatanextLink(value *string)() {
    if m != nil {
        m.nextLink = value
    }
}
