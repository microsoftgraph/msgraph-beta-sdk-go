...
func (m *CertificateConnectorHealthMetricValue) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *CertificateConnectorHealthMetricValue) GetFailureCount()(*int64) {
    val, err := m.GetBackingStore().Get("failureCount")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *CertificateConnectorHealthMetricValue) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *CertificateConnectorHealthMetricValue) SetFailureCount(value *int64)() {
    err := m.GetBackingStore().Set("failureCount", value)
    if err != nil {
        panic(err)
    }
}
