...
func (m *PropertyToEvaluate) GetAdditionalData()(map[string]any) {
...
func (m *PropertyToEvaluate) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *PropertyToEvaluate) GetPropertyValue()(*string) {
    val, err := m.GetBackingStore().Get("propertyValue")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *PropertyToEvaluate) SetAdditionalData(value map[string]any)() {
...
func (m *PropertyToEvaluate) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *PropertyToEvaluate) SetPropertyValue(value *string)() {
    err := m.GetBackingStore().Set("propertyValue", value)
    if err != nil {
        panic(err)
    }
}
