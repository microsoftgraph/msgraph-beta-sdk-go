...
func (m *UserSet) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *UserSet) GetIsBackup()(*bool) {
    val, err := m.GetBackingStore().Get("isBackup")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *UserSet) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *UserSet) SetIsBackup(value *bool)() {
    err := m.GetBackingStore().Set("isBackup", value)
    if err != nil {
        panic(err)
    }
}
