...
// UserFlowLanguagePage provides operations to manage the collection of accessReview entities.
...
func (m *UserFlowLanguagePage) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserFlowLanguagePage) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
