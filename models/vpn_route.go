...
func (m *VpnRoute) GetAdditionalData()(map[string]any) {
...
func (m *VpnRoute) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *VpnRoute) GetDestinationPrefix()(*string) {
    val, err := m.GetBackingStore().Get("destinationPrefix")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *VpnRoute) SetAdditionalData(value map[string]any)() {
...
func (m *VpnRoute) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *VpnRoute) SetDestinationPrefix(value *string)() {
    err := m.GetBackingStore().Set("destinationPrefix", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *VpnRoute) SetPrefixSize(value *int32)() {
    err := m.GetBackingStore().Set("prefixSize", value)
    if err != nil {
        panic(err)
    }
}
