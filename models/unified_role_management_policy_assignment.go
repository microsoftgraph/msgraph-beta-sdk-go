...
func (m *UnifiedRoleManagementPolicyAssignment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UnifiedRoleManagementPolicyAssignment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
