...
func (m *UserExperienceAnalyticsWorkFromAnywhereDevice) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsWorkFromAnywhereDevice) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
