...
func (m *UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
