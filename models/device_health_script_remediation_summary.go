...
func (m *DeviceHealthScriptRemediationSummary) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *DeviceHealthScriptRemediationSummary) GetScriptCount()(*int32) {
    val, err := m.GetBackingStore().Get("scriptCount")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *DeviceHealthScriptRemediationSummary) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *DeviceHealthScriptRemediationSummary) SetScriptCount(value *int32)() {
    err := m.GetBackingStore().Set("scriptCount", value)
    if err != nil {
        panic(err)
    }
}
