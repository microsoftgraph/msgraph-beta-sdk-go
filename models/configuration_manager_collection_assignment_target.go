...
func (m *ConfigurationManagerCollectionAssignmentTarget) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ConfigurationManagerCollectionAssignmentTarget) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
