...
func (m *CustomAccessPackageWorkflowExtension) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CustomAccessPackageWorkflowExtension) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
