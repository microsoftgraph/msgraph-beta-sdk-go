...
func (m *AddContentFooterAction) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
// GetAlignment gets the alignment property value. Possible values are: left, right, center.
...
func (m *AddContentFooterAction) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
        m.additionalData = value
    }
}
// SetAlignment sets the alignment property value. Possible values are: left, right, center.
