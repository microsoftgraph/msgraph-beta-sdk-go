...
func NewAlertData()(*AlertData) {
    ...
    odataTypeValue := "#microsoft.graph.managedTenants.alertData";
...
func (m *AlertData) GetAdditionalData()(map[string]interface{}) {
...
func (m *AlertData) SetAdditionalData(value map[string]interface{})() {
