...
// CredentialUserRegistrationsSummary provides operations to manage the collection of accessReview entities.
...
func (m *CredentialUserRegistrationsSummary) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CredentialUserRegistrationsSummary) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
