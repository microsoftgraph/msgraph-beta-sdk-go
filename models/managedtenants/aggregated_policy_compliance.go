...
// AggregatedPolicyCompliance provides operations to manage the collection of accessReview entities.
...
func (m *AggregatedPolicyCompliance) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AggregatedPolicyCompliance) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
