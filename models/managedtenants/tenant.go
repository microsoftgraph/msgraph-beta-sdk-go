...
// Tenant provides operations to manage the collection of accessReview entities.
type Tenant struct {
...
func (m *Tenant) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Tenant) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
