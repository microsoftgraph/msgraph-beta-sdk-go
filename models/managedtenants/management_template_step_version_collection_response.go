...
func (m *ManagementTemplateStepVersionCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *ManagementTemplateStepVersionCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
