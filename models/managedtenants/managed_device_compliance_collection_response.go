...
func (m *ManagedDeviceComplianceCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *ManagedDeviceComplianceCollectionResponse) SetOdataNextLink(value *string)() {
