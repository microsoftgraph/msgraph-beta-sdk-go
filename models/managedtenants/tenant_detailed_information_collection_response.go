...
func (m *TenantDetailedInformationCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *TenantDetailedInformationCollectionResponse) SetOdataNextLink(value *string)() {
