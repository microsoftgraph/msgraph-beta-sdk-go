...
// ManagedTenantAlertLog provides operations to manage the collection of accessReviewDecision entities.
...
func NewManagedTenantAlertLog()(*ManagedTenantAlertLog) {
    ...
    odataTypeValue := "#microsoft.graph.managedTenants.managedTenantAlertLog";
