...
func (m *ConditionalAccessPolicyCoverage) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ConditionalAccessPolicyCoverage) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
