...
type PrinterCapabilitiesable interface {
    ...
    SetSupportedColorConfigurations(value []string)()
    SetSupportedCopiesPerJob(value IntegerRangeable)()
    SetSupportedDocumentMimeTypes(value []string)()
    SetSupportedDuplexConfigurations(value []string)()
    SetSupportedFinishings(value []string)()
    SetSupportedMediaColors(value []string)()
    SetSupportedMediaSizes(value []string)()
    SetSupportedMediaTypes(value []string)()
    SetSupportedOrientations(value []string)()
    SetSupportedOutputBins(value []string)()
    SetSupportedPagesPerSheet(value IntegerRangeable)()
    SetSupportedPresentationDirections(value []string)()
    SetSupportedPrintQualities(value []string)()
