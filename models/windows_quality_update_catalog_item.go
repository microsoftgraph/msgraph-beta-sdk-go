...
func (m *WindowsQualityUpdateCatalogItem) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsQualityUpdateCatalogItem) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
