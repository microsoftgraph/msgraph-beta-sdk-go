...
func (m *WindowsAutopilotDeploymentProfilePolicySetItem) GetOdataType()(*string) {
...
func (m *WindowsAutopilotDeploymentProfilePolicySetItem) SetOdataType(value *string)() {
