...
func (m *ValidationResult) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *ValidationResult) GetValidationPassed()(*bool) {
    val, err := m.GetBackingStore().Get("validationPassed")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ValidationResult) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *ValidationResult) SetValidationPassed(value *bool)() {
    err := m.GetBackingStore().Set("validationPassed", value)
    if err != nil {
        panic(err)
    }
}
// ValidationResultable 
type ValidationResultable interface {
    ...
    GetOdataType()(*string)
    GetRuleName()(*string)
    GetValidationPassed()(*bool)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetMessage(value *string)()
    SetOdataType(value *string)()
    SetRuleName(value *string)()
    SetValidationPassed(value *bool)()
}
