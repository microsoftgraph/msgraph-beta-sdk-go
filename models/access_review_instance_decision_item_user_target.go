...
func (m *AccessReviewInstanceDecisionItemUserTarget) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessReviewInstanceDecisionItemUserTarget) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
