...
func (m *UsersItemManagedDevicesItemWipePostRequestBody) GetUseProtectedWipe()(*bool) {
...
func (m *UsersItemManagedDevicesItemWipePostRequestBody) SetUseProtectedWipe(value *bool)() {
