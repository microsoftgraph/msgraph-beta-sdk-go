...
func (m *RuleCondition) GetAggregation()(*RuleCondition_aggregation) {
    val, err := m.GetBackingStore().Get("aggregation")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*RuleCondition_aggregation)
    }
    return nil
}
...
func (m *RuleCondition) GetConditionCategory()(*RuleCondition_conditionCategory) {
    val, err := m.GetBackingStore().Get("conditionCategory")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*RuleCondition_conditionCategory)
    }
    return nil
}
...
func (m *RuleCondition) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["aggregation"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseRuleCondition_aggregation)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAggregation(val.(*RuleCondition_aggregation))
        }
        return nil
    }
    res["conditionCategory"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseRuleCondition_conditionCategory)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetConditionCategory(val.(*RuleCondition_conditionCategory))
        }
        return nil
    }
    ...
    res["operator"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseRuleCondition_operator)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetOperator(val.(*RuleCondition_operator))
        }
        return nil
    }
    res["relationshipType"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseRuleCondition_relationshipType)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetRelationshipType(val.(*RuleCondition_relationshipType))
        }
        return nil
    }
...
func (m *RuleCondition) GetOperator()(*RuleCondition_operator) {
    val, err := m.GetBackingStore().Get("operator")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*RuleCondition_operator)
    }
    return nil
}
// GetRelationshipType gets the relationshipType property value. The relationship type.  Possible values are: and, or.
func (m *RuleCondition) GetRelationshipType()(*RuleCondition_relationshipType) {
    val, err := m.GetBackingStore().Get("relationshipType")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*RuleCondition_relationshipType)
    }
    return nil
}
...
func (m *RuleCondition) SetAggregation(value *RuleCondition_aggregation)() {
...
func (m *RuleCondition) SetConditionCategory(value *RuleCondition_conditionCategory)() {
...
func (m *RuleCondition) SetOperator(value *RuleCondition_operator)() {
...
func (m *RuleCondition) SetRelationshipType(value *RuleCondition_relationshipType)() {
...
type RuleConditionable interface {
    ...
    GetAggregation()(*RuleCondition_aggregation)
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetConditionCategory()(*RuleCondition_conditionCategory)
    GetOdataType()(*string)
    GetOperator()(*RuleCondition_operator)
    GetRelationshipType()(*RuleCondition_relationshipType)
    GetThresholdValue()(*string)
    SetAggregation(value *RuleCondition_aggregation)()
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetConditionCategory(value *RuleCondition_conditionCategory)()
    SetOdataType(value *string)()
    SetOperator(value *RuleCondition_operator)()
    SetRelationshipType(value *RuleCondition_relationshipType)()
