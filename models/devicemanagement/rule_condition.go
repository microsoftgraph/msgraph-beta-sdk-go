...
// GetRelationshipType gets the relationshipType property value. The relationship type.  The possible values are: and, or.
...
// SetRelationshipType sets the relationshipType property value. The relationship type.  The possible values are: and, or.
