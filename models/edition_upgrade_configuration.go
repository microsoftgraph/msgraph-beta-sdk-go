...
func (m *EditionUpgradeConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EditionUpgradeConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
