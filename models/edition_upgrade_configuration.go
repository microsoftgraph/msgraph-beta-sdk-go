...
func (m *EditionUpgradeConfiguration) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["windowsSMode"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseWindowsSModeConfiguration)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetWindowsSMode(val.(*WindowsSModeConfiguration))
        }
        return nil
    }
    return res
...
// returns a *WindowsSModeConfiguration when successful
func (m *EditionUpgradeConfiguration) GetWindowsSMode()(*WindowsSModeConfiguration) {
    val, err := m.GetBackingStore().Get("windowsSMode")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*WindowsSModeConfiguration)
    }
    return nil
}
...
func (m *EditionUpgradeConfiguration) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    if m.GetWindowsSMode() != nil {
        cast := (*m.GetWindowsSMode()).String()
        err = writer.WriteStringValue("windowsSMode", &cast)
        if err != nil {
            return err
        }
    }
...
func (m *EditionUpgradeConfiguration) SetWindowsSMode(value *WindowsSModeConfiguration)() {
    err := m.GetBackingStore().Set("windowsSMode", value)
    if err != nil {
        panic(err)
    }
}
