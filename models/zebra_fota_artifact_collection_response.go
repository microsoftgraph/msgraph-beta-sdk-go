...
func (m *ZebraFotaArtifactCollectionResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *ZebraFotaArtifactCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *ZebraFotaArtifactCollectionResponse) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *ZebraFotaArtifactCollectionResponse) SetOdataNextLink(value *string)() {
