...
// GetRemaining gets the remaining property value. Total space remaining before reaching the quota limit in bytes.
// returns a *int64 when successful
...
// GetServices gets the services property value. The breakdown of services contributing to the user's quota usage.
...
// GetState gets the state property value. Indicates the state of the storage space. The possible values are: normal, nearing, critical, full, and overLimit.
// returns a *string when successful
...
// GetTotal gets the total property value. Total allowed storage space in bytes.
// returns a *int64 when successful
...
// GetUsed gets the used property value. Total space used in bytes.
// returns a *int64 when successful
...
// SetRemaining sets the remaining property value. Total space remaining before reaching the quota limit in bytes.
...
// SetServices sets the services property value. The breakdown of services contributing to the user's quota usage.
...
// SetState sets the state property value. Indicates the state of the storage space. The possible values are: normal, nearing, critical, full, and overLimit.
...
// SetTotal sets the total property value. Total allowed storage space in bytes.
...
// SetUsed sets the used property value. Total space used in bytes.
