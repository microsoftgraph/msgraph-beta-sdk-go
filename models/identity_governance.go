...
func (m *IdentityGovernance) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["roleManagementAlerts"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateRoleManagementAlertFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetRoleManagementAlerts(val.(RoleManagementAlertable))
        }
        return nil
    }
...
func (m *IdentityGovernance) GetRoleManagementAlerts()(RoleManagementAlertable) {
    ...
    if val != nil {
        return val.(RoleManagementAlertable)
    }
    return nil
}
...
func (m *IdentityGovernance) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err := writer.WriteObjectValue("roleManagementAlerts", m.GetRoleManagementAlerts())
        if err != nil {
            return err
        }
    }
...
// SetRoleManagementAlerts sets the roleManagementAlerts property value. The roleManagementAlerts property
func (m *IdentityGovernance) SetRoleManagementAlerts(value RoleManagementAlertable)() {
    err := m.GetBackingStore().Set("roleManagementAlerts", value)
    if err != nil {
        panic(err)
    }
}
