...
// PlannerProgressTaskBoardTaskFormat provides operations to manage the collection of accessReview entities.
...
func (m *PlannerProgressTaskBoardTaskFormat) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *PlannerProgressTaskBoardTaskFormat) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
