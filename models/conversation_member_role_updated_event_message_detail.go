...
func (m *ConversationMemberRoleUpdatedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ConversationMemberRoleUpdatedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
