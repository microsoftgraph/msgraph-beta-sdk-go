...
// GetForceChangePasswordNextSignIn gets the forceChangePasswordNextSignIn property value. true if the user must change their password on the next sign-in; otherwise false. If not set, default is false.
...
// SetForceChangePasswordNextSignIn sets the forceChangePasswordNextSignIn property value. true if the user must change their password on the next sign-in; otherwise false. If not set, default is false.
