...
func (m *CrossCloudAzureActiveDirectoryTenant) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CrossCloudAzureActiveDirectoryTenant) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
