...
func (m *DeviceManagementConfigurationChoiceSettingValue) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationChoiceSettingValue) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
