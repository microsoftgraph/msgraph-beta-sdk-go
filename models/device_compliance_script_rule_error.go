...
func (m *DeviceComplianceScriptRuleError) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceComplianceScriptRuleError) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
