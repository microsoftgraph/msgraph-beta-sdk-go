...
func (m *IosImportedPFXCertificateProfile) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *IosImportedPFXCertificateProfile) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
