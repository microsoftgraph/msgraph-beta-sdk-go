...
func (m *EmbeddedSIMActivationCodePoolAssignmentCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *EmbeddedSIMActivationCodePoolAssignmentCollectionResponse) SetOdataNextLink(value *string)() {
