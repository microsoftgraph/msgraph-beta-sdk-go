...
// GetState gets the state property value. The possible values are: accepted, declined. Supports $filter (eq).
...
// SetState sets the state property value. The possible values are: accepted, declined. Supports $filter (eq).
