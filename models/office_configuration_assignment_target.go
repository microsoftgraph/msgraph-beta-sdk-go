...
func NewOfficeConfigurationAssignmentTarget()(*OfficeConfigurationAssignmentTarget) {
    ...
    typeValue := "#microsoft.graph.officeConfigurationAssignmentTarget";
    m.SetType(&typeValue);
    return m
}
...
func (m *OfficeConfigurationAssignmentTarget) GetType()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *OfficeConfigurationAssignmentTarget) SetType(value *string)() {
    if m != nil {
