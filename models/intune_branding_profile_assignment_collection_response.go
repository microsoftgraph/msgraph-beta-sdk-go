...
func (m *IntuneBrandingProfileAssignmentCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *IntuneBrandingProfileAssignmentCollectionResponse) SetOdataNextLink(value *string)() {
