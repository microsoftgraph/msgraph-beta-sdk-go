...
func (m *AccessReviewNotificationRecipientQueryScope) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AccessReviewNotificationRecipientQueryScope) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
