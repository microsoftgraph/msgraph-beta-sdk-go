...
func (m *WindowsDeviceAzureADAccount) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsDeviceAzureADAccount) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
