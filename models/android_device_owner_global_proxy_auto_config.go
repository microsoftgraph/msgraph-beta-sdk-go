...
func (m *AndroidDeviceOwnerGlobalProxyAutoConfig) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceOwnerGlobalProxyAutoConfig) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
