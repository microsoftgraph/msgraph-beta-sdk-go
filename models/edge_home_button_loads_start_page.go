...
func (m *EdgeHomeButtonLoadsStartPage) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EdgeHomeButtonLoadsStartPage) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
