...
func (m *ContentProperties) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
// returns a ContentMetadataable when successful
func (m *ContentProperties) GetMetadata()(ContentMetadataable) {
    ...
    if val != nil {
        return val.(ContentMetadataable)
    }
    return nil
}
...
func (m *ContentProperties) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
type ContentPropertiesable interface {
