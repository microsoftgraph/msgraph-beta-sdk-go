...
func (m *EmailAuthenticationMethodConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *EmailAuthenticationMethodConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
