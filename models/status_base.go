...
func (m *StatusBase) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["status"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseStatusBase_status)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetStatus(val.(*StatusBase_status))
        }
        return nil
    }
    return res
...
func (m *StatusBase) GetStatus()(*StatusBase_status) {
    val, err := m.GetBackingStore().Get("status")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*StatusBase_status)
    }
    return nil
}
...
func (m *StatusBase) SetStatus(value *StatusBase_status)() {
...
type StatusBaseable interface {
    ...
    GetOdataType()(*string)
    GetStatus()(*StatusBase_status)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetOdataType(value *string)()
    SetStatus(value *StatusBase_status)()
}
