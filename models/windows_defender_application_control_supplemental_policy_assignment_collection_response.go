...
func (m *WindowsDefenderApplicationControlSupplementalPolicyAssignmentCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsDefenderApplicationControlSupplementalPolicyAssignmentCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
