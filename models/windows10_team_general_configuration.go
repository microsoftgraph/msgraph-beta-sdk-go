...
func (m *Windows10TeamGeneralConfiguration) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Windows10TeamGeneralConfiguration) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
