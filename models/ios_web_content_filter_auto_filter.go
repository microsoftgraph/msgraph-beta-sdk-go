...
func (m *IosWebContentFilterAutoFilter) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *IosWebContentFilterAutoFilter) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
