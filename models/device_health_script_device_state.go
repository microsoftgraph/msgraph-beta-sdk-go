...
func (m *DeviceHealthScriptDeviceState) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceHealthScriptDeviceState) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
