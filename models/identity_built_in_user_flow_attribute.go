...
func (m *IdentityBuiltInUserFlowAttribute) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *IdentityBuiltInUserFlowAttribute) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
