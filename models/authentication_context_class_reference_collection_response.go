...
func (m *AuthenticationContextClassReferenceCollectionResponse) GetOdataNextLink()(*string) {
    if m == nil {
        return nil
    } else {
...
func (m *AuthenticationContextClassReferenceCollectionResponse) SetOdataNextLink(value *string)() {
    if m != nil {
