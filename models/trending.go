...
// Trending provides operations to manage the collection of accessReview entities.
...
func (m *Trending) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Trending) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
