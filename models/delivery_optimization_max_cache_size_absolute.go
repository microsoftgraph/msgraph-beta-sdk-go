...
// DeliveryOptimizationMaxCacheSizeAbsolute delivery Optimization max cache size types.
...
func (m *DeliveryOptimizationMaxCacheSizeAbsolute) GetOdataType()(*string) {
...
func (m *DeliveryOptimizationMaxCacheSizeAbsolute) SetOdataType(value *string)() {
