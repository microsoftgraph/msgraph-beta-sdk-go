...
// WorkbookChartSeriesFormat provides operations to manage the collection of accessReview entities.
...
func (m *WorkbookChartSeriesFormat) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WorkbookChartSeriesFormat) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
