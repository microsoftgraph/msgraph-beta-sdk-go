...
// ContactFolder provides operations to manage the collection of accessReviewDecision entities.
...
func (m *ContactFolder) GetWellKnownName()(*string) {
...
func (m *ContactFolder) SetWellKnownName(value *string)() {
