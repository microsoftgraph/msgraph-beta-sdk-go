...
// Segment provides operations to manage the collection of accessReview entities.
type Segment struct {
...
func (m *Segment) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Segment) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
