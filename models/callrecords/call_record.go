...
// CallRecord provides operations to manage the collection of accessReview entities.
type CallRecord struct {
    ...
    organizer ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.IdentitySetable
    // List of distinct identities involved in the call.
    participants []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.IdentitySetable
...
func (m *CallRecord) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *CallRecord) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
