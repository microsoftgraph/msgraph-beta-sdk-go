...
// Session provides operations to manage the collection of accessReview entities.
type Session struct {
...
func (m *Session) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *Session) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
