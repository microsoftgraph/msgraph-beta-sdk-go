...
func (m *WindowsPhone81CompliancePolicy) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *WindowsPhone81CompliancePolicy) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
