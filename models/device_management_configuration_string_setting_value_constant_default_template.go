...
func (m *DeviceManagementConfigurationStringSettingValueConstantDefaultTemplate) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeviceManagementConfigurationStringSettingValueConstantDefaultTemplate) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
