...
func (m *ExclusionGroupAssignmentTarget) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *ExclusionGroupAssignmentTarget) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
