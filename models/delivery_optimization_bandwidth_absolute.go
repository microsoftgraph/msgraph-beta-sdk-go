...
func (m *DeliveryOptimizationBandwidthAbsolute) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *DeliveryOptimizationBandwidthAbsolute) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
