...
func (m *AppleUserInitiatedEnrollmentProfileCollectionResponse) GetOdataNextLink()(*string) {
...
func (m *AppleUserInitiatedEnrollmentProfileCollectionResponse) SetOdataNextLink(value *string)() {
