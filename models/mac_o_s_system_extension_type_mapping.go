...
func (m *MacOSSystemExtensionTypeMapping) GetAllowedTypes()(*MacOSSystemExtensionType) {
    val, err := m.GetBackingStore().Get("allowedTypes")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*MacOSSystemExtensionType)
    }
    return nil
}
// GetBackingStore gets the backingStore property value. Stores model information.
func (m *MacOSSystemExtensionTypeMapping) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *MacOSSystemExtensionTypeMapping) SetAllowedTypes(value *MacOSSystemExtensionType)() {
    err := m.GetBackingStore().Set("allowedTypes", value)
    if err != nil {
        panic(err)
    }
}
// SetBackingStore sets the backingStore property value. Stores model information.
func (m *MacOSSystemExtensionTypeMapping) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
