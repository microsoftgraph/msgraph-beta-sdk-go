...
func (m *AndroidDeviceComplianceLocalActionBase) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *AndroidDeviceComplianceLocalActionBase) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
