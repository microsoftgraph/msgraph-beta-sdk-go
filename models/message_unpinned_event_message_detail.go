...
func (m *MessageUnpinnedEventMessageDetail) GetAdditionalData()(map[string]interface{}) {
    if m == nil {
        return nil
    } else {
...
func (m *MessageUnpinnedEventMessageDetail) SetAdditionalData(value map[string]interface{})() {
    if m != nil {
