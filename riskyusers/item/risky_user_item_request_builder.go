...
// DeleteWithRequestConfigurationAndResponseHandler delete entity from riskyUsers
...
// PatchWithRequestConfigurationAndResponseHandler update entity in riskyUsers
