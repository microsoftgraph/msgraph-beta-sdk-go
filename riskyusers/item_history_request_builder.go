...
// ItemHistoryRequestBuilderGetQueryParameters get the risk history of a riskyUser resource. This API is supported in the following national cloud deployments.
...
func NewItemHistoryRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemHistoryRequestBuilder) {
    m := &ItemHistoryRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/riskyUsers/{riskyUser%2Did}/history{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemHistoryRequestBuilder instantiates a new HistoryRequestBuilder and sets the default values.
...
// Get get the risk history of a riskyUser resource. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation get the risk history of a riskyUser resource. This API is supported in the following national cloud deployments.
