...
// RiskyUserItemRequestBuilderGetQueryParameters retrieve the properties and relationships of a riskyUser object. This API is supported in the following national cloud deployments.
...
func NewRiskyUserItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RiskyUserItemRequestBuilder) {
    m := &RiskyUserItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/riskyUsers/{riskyUser%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
// Get retrieve the properties and relationships of a riskyUser object. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToGetRequestInformation retrieve the properties and relationships of a riskyUser object. This API is supported in the following national cloud deployments.
...
func (m *RiskyUserItemRequestBuilder) WithUrl(rawUrl string)(*RiskyUserItemRequestBuilder) {
    return NewRiskyUserItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
