...
func NewDismissRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DismissRequestBuilder) {
    m := &DismissRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/riskyUsers/dismiss", pathParameters),
    }
    return m
}
...
// Post dismiss the risk of one or more riskyUser objects. This action sets the targeted user's risk level to none. The maximum count of users to dismiss in one call is 60. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToPostRequestInformation dismiss the risk of one or more riskyUser objects. This action sets the targeted user's risk level to none. The maximum count of users to dismiss in one call is 60. This API is supported in the following national cloud deployments.
...
func (m *DismissRequestBuilder) WithUrl(rawUrl string)(*DismissRequestBuilder) {
    return NewDismissRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
