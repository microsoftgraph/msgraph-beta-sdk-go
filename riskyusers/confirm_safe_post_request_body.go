...
func (m *ConfirmSafePostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ConfirmSafePostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *ConfirmSafePostRequestBody) GetUserIds()([]string) {
...
func (m *ConfirmSafePostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ConfirmSafePostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetUserIds sets the userIds property value. The userIds property
func (m *ConfirmSafePostRequestBody) SetUserIds(value []string)() {
    err := m.GetBackingStore().Set("userIds", value)
    if err != nil {
        panic(err)
    }
}
type ConfirmSafePostRequestBodyable interface {
