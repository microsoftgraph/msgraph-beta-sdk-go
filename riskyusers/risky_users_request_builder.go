...
func (m *RiskyUsersRequestBuilder) MicrosoftGraphConfirmCompromised()(*MicrosoftGraphConfirmCompromisedRequestBuilder) {
    return NewMicrosoftGraphConfirmCompromisedRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDismiss provides operations to call the dismiss method.
func (m *RiskyUsersRequestBuilder) MicrosoftGraphDismiss()(*MicrosoftGraphDismissRequestBuilder) {
    return NewMicrosoftGraphDismissRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
