...
func (m *RiskyUsersRequestBuilder) MicrosoftGraphConfirmCompromised()(*MicrosoftGraphConfirmCompromisedConfirmCompromisedRequestBuilder) {
    return NewMicrosoftGraphConfirmCompromisedConfirmCompromisedRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDismiss provides operations to call the dismiss method.
func (m *RiskyUsersRequestBuilder) MicrosoftGraphDismiss()(*MicrosoftGraphDismissDismissRequestBuilder) {
    return NewMicrosoftGraphDismissDismissRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
