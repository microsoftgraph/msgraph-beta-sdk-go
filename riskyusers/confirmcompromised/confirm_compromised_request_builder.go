...
func (m *ConfirmCompromisedRequestBuilder) CreatePostRequestInformationWithRequestConfiguration(body ConfirmCompromisedRequestBodyable)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// PostWithResponseHandler invoke action confirmCompromised
func (m *ConfirmCompromisedRequestBuilder) PostWithResponseHandler(body ConfirmCompromisedRequestBodyable, requestConfiguration *ConfirmCompromisedRequestBuilderPostRequestConfiguration)(error) {
    return m.PostWithResponseHandler(body, requestConfiguration, nil);
}
// PostWithResponseHandler invoke action confirmCompromised
func (m *ConfirmCompromisedRequestBuilder) PostWithResponseHandler(body ConfirmCompromisedRequestBodyable, requestConfiguration *ConfirmCompromisedRequestBuilderPostRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(error) {
