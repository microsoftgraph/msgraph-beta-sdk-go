...
// ConfirmCompromisedRequestBuilder builds and executes requests for operations under \riskyUsers\microsoft.graph.confirmCompromised
...
type ConfirmCompromisedRequestBuilderPostOptions struct {
    // 
    Body *ConfirmCompromisedRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func (m *ConfirmCompromisedRequestBuilder) CreatePostRequestInformation(options *ConfirmCompromisedRequestBuilderPostOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
