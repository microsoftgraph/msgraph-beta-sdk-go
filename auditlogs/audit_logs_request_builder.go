...
func (m *AuditLogsRequestBuilder) DirectoryAuditsById(id string)(*DirectoryAuditsDirectoryAuditItemRequestBuilder) {
    ...
    idPtr := &id
    return NewDirectoryAuditsDirectoryAuditItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *AuditLogsRequestBuilder) DirectoryProvisioningById(id string)(*DirectoryProvisioningProvisioningObjectSummaryItemRequestBuilder) {
    ...
    idPtr := &id
    return NewDirectoryProvisioningProvisioningObjectSummaryItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
// Get get auditLogs
...
func (m *AuditLogsRequestBuilder) ProvisioningById(id string)(*ProvisioningProvisioningObjectSummaryItemRequestBuilder) {
    ...
    idPtr := &id
    return NewProvisioningProvisioningObjectSummaryItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
...
func (m *AuditLogsRequestBuilder) SignInsById(id string)(*SignInsSignInItemRequestBuilder) {
    ...
    idPtr := &id
    return NewSignInsSignInItemRequestBuilderInternal(urlTplParams, m.requestAdapter, idPtr)
}
