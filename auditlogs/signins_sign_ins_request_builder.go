...
func (m *SigninsSignInsRequestBuilder) ConfirmCompromised()(*SigninsConfirmcompromisedConfirmCompromisedRequestBuilder) {
    return NewSigninsConfirmcompromisedConfirmCompromisedRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *SigninsSignInsRequestBuilder) ConfirmSafe()(*SigninsConfirmsafeConfirmSafeRequestBuilder) {
    return NewSigninsConfirmsafeConfirmSafeRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *SigninsSignInsRequestBuilder) Get(ctx context.Context, requestConfiguration *SigninsSignInsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SignInCollectionResponseable, error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *SigninsSignInsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SignInable, requestConfiguration *SigninsSignInsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.SignInable, error) {
