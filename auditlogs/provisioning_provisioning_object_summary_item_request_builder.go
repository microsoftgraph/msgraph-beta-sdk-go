...
// ProvisioningProvisioningObjectSummaryItemRequestBuilderGetQueryParameters represents an action performed by the Microsoft Entra provisioning service and its associated properties.
...
// Get represents an action performed by the Microsoft Entra provisioning service and its associated properties.
func (m *ProvisioningProvisioningObjectSummaryItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ProvisioningProvisioningObjectSummaryItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ProvisioningObjectSummaryable, error) {
...
// ToGetRequestInformation represents an action performed by the Microsoft Entra provisioning service and its associated properties.
