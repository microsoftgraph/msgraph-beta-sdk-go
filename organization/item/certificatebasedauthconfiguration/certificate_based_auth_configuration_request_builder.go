...
func NewCertificateBasedAuthConfigurationRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CertificateBasedAuthConfigurationRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/organization/{organization_id}/certificateBasedAuthConfiguration{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *CertificateBasedAuthConfigurationRequestBuilder) Get(q func (value *CertificateBasedAuthConfigurationRequestBuilderGetQueryParameters) (err error), h func (value map[string]string) (err error), o []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption, responseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler)(*CertificateBasedAuthConfigurationResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(q, h, o);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewCertificateBasedAuthConfigurationResponse() }, responseHandler)
    if err != nil {
        return nil, err
    }
    return res.(*CertificateBasedAuthConfigurationResponse), nil
}
func (m *CertificateBasedAuthConfigurationRequestBuilder) Ref()(*i0963f9c6d85d5185b4e521540e69a0f9a7846488d94ca5bf9fedd21e81fe49a4.RefRequestBuilder) {
    return i0963f9c6d85d5185b4e521540e69a0f9a7846488d94ca5bf9fedd21e81fe49a4.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
