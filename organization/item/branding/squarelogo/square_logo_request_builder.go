...
type SquareLogoRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
type SquareLogoRequestBuilderPutOptions struct {
    // Binary request body
    Body []byte;
    // Request headers
    H map[string]string;
...
func NewSquareLogoRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SquareLogoRequestBuilder) {
    m := &SquareLogoRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/organization/{organization_id}/branding/squareLogo";
...
func NewSquareLogoRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*SquareLogoRequestBuilder) {
...
func (m *SquareLogoRequestBuilder) CreateGetRequestInformation(options *SquareLogoRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *SquareLogoRequestBuilder) CreatePutRequestInformation(options *SquareLogoRequestBuilderPutOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
