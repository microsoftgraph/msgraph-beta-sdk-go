...
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/organization-list?view=graph-rest-beta
...
func (m *OrganizationRequestBuilder) GetUserOwnedObjects()(*GetuserownedobjectsGetUserOwnedObjectsRequestBuilder) {
