...
// ItemActivateServicePostRequestBody provides operations to call the activateService method.
...
func (m *ItemActivateServicePostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemActivateServicePostRequestBody) SetAdditionalData(value map[string]interface{})() {
