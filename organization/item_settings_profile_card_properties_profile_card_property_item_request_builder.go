...
func (m *ItemSettingsProfileCardPropertiesProfileCardPropertyItemRequestBuilder) WithUrl(rawUrl string)(*ItemSettingsProfileCardPropertiesProfileCardPropertyItemRequestBuilder) {
    return NewItemSettingsProfileCardPropertiesProfileCardPropertyItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
