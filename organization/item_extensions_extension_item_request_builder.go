...
// ItemExtensionsExtensionItemRequestBuilderGetQueryParameters the collection of open extensions defined for the organization resource. Nullable.
...
func NewItemExtensionsExtensionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, extensionId *string)(*ItemExtensionsExtensionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/organization/{organization%2Did}/extensions/{extension%2Did}{?%24select,%24expand}";
