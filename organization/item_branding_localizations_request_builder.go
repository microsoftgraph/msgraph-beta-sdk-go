...
// ByOrganizationalBrandingLocalizationIdString provides operations to manage the localizations property of the microsoft.graph.organizationalBranding entity.
func (m *ItemBrandingLocalizationsRequestBuilder) ByOrganizationalBrandingLocalizationIdString(organizationalBrandingLocalizationId string)(*ItemBrandingLocalizationsOrganizationalBrandingLocalizationItemRequestBuilder) {
