...
func (m *OrganizationItemRequestBuilder) MicrosoftGraphActivateService()(*ItemMicrosoftGraphActivateServiceRequestBuilder) {
    return NewItemMicrosoftGraphActivateServiceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
