...
func (m *ItemSettingsContactInsightsRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemSettingsContactInsightsRequestBuilderDeleteRequestConfiguration)([]byte, error) {
