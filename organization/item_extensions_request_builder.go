...
// ItemExtensionsRequestBuilderGetQueryParameters the collection of open extensions defined for the organization resource. Nullable.
...
// ByExtensionIdString provides operations to manage the extensions property of the microsoft.graph.organization entity.
func (m *ItemExtensionsRequestBuilder) ByExtensionIdString(extensionId string)(*ItemExtensionsExtensionItemRequestBuilder) {
...
func NewItemExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemExtensionsRequestBuilder) {
    m := &ItemExtensionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/organization/{organization%2Did}/extensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *ItemExtensionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemExtensionsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ExtensionCollectionResponseable, error) {
...
// ToGetRequestInformation the collection of open extensions defined for the organization resource. Nullable.
