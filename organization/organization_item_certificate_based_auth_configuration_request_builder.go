...
func NewOrganizationItemCertificateBasedAuthConfigurationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationItemCertificateBasedAuthConfigurationRequestBuilder) {
    m := &OrganizationItemCertificateBasedAuthConfigurationRequestBuilder{
    }
...
func NewOrganizationItemCertificateBasedAuthConfigurationRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OrganizationItemCertificateBasedAuthConfigurationRequestBuilder) {
    ...
    return NewOrganizationItemCertificateBasedAuthConfigurationRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *OrganizationItemCertificateBasedAuthConfigurationRequestBuilder) Count()(*OrganizationItemCertificateBasedAuthConfigurationCountRequestBuilder) {
    return NewOrganizationItemCertificateBasedAuthConfigurationCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation get a list of certificateBasedAuthConfiguration objects.
func (m *OrganizationItemCertificateBasedAuthConfigurationRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *OrganizationItemCertificateBasedAuthConfigurationRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OrganizationItemCertificateBasedAuthConfigurationRequestBuilder) Get(ctx context.Context, requestConfiguration *OrganizationItemCertificateBasedAuthConfigurationRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CertificateBasedAuthConfigurationCollectionResponseable, error) {
