...
// ByProfileCardPropertyIdString provides operations to manage the profileCardProperties property of the microsoft.graph.organizationSettings entity.
func (m *ItemSettingsProfileCardPropertiesRequestBuilder) ByProfileCardPropertyIdString(profileCardPropertyId string)(*ItemSettingsProfileCardPropertiesProfileCardPropertyItemRequestBuilder) {
