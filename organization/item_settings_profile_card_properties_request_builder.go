...
// ItemSettingsProfileCardPropertiesRequestBuilderGetQueryParameters get profileCardProperties from organization
...
// ByProfileCardPropertyId provides operations to manage the profileCardProperties property of the microsoft.graph.organizationSettings entity.
func (m *ItemSettingsProfileCardPropertiesRequestBuilder) ByProfileCardPropertyId(profileCardPropertyId string)(*ItemSettingsProfileCardPropertiesProfileCardPropertyItemRequestBuilder) {
...
// ToPostRequestInformation create new navigation property to profileCardProperties for organization
...
func (m *ItemSettingsProfileCardPropertiesRequestBuilder) WithUrl(rawUrl string)(*ItemSettingsProfileCardPropertiesRequestBuilder) {
    return NewItemSettingsProfileCardPropertiesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
