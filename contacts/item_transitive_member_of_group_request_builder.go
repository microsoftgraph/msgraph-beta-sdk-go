...
func NewItemTransitiveMemberOfGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTransitiveMemberOfGroupRequestBuilder) {
    m := &ItemTransitiveMemberOfGroupRequestBuilder{
    }
...
func NewItemTransitiveMemberOfGroupRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTransitiveMemberOfGroupRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemTransitiveMemberOfGroupRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ItemTransitiveMemberOfGroupRequestBuilder) Count()(*ItemTransitiveMemberOfGroupCountRequestBuilder) {
    return NewItemTransitiveMemberOfGroupCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ItemTransitiveMemberOfGroupRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTransitiveMemberOfGroupRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemTransitiveMemberOfGroupRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTransitiveMemberOfGroupRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.GroupCollectionResponseable, error) {
