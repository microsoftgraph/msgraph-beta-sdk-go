...
func NewItemDirectReportsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDirectReportsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/directReports/$count";
...
func (m *ItemDirectReportsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemDirectReportsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
