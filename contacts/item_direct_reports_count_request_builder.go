...
func (m *ItemDirectReportsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDirectReportsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
