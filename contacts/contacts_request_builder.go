...
func (m *ContactsRequestBuilder) MicrosoftGraphDelta()(*MicrosoftGraphDeltaDeltaRequestBuilder) {
...
func (m *ContactsRequestBuilder) MicrosoftGraphGetByIds()(*MicrosoftGraphGetByIdsGetByIdsRequestBuilder) {
...
func (m *ContactsRequestBuilder) MicrosoftGraphGetUserOwnedObjects()(*MicrosoftGraphGetUserOwnedObjectsGetUserOwnedObjectsRequestBuilder) {
...
func (m *ContactsRequestBuilder) MicrosoftGraphValidateProperties()(*MicrosoftGraphValidatePropertiesValidatePropertiesRequestBuilder) {
...
func (m *ContactsRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OrgContactable, requestConfiguration *ContactsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
