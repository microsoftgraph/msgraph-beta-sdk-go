...
// ItemTransitiveReportsRequestBuilder provides operations to manage the transitiveReports property of the microsoft.graph.orgContact entity.
...
// ItemTransitiveReportsRequestBuilderGetQueryParameters the transitive reports for a contact. Read-only.
...
func (m *ItemTransitiveReportsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTransitiveReportsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
