...
// ItemMemberofMemberOfRequestBuilderGetQueryParameters retrieve the list of groups and adminstrative units the contact is a member of.
...
// Get retrieve the list of groups and adminstrative units the contact is a member of.
...
// ToGetRequestInformation retrieve the list of groups and adminstrative units the contact is a member of.
