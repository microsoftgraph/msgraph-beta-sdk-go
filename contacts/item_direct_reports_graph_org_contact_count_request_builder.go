...
func (m *ItemDirectReportsGraphOrgContactCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDirectReportsGraphOrgContactCountRequestBuilderGetRequestConfiguration)(*int64, error) {
