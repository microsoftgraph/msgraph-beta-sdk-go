...
func (m *ItemMemberOfGraphAdministrativeUnitCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMemberOfGraphAdministrativeUnitCountRequestBuilderGetRequestConfiguration)(*int64, error) {
