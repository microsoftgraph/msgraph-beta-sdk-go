...
import (
    ...
    i3c00bde30e634de189b51010ce60901e32c59de7534923a59442776eb666c6a2 "github.com/microsoftgraph/msgraph-beta-sdk-go/contacts/item/manager/ref"
)
...
func NewManagerRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ManagerRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/contacts/{orgContact_id}/manager{?select,expand}";
...
func (m *ManagerRequestBuilder) CreateGetRequestInformation(q func (value *ManagerRequestBuilderGetQueryParameters) (err error), h func (value map[string]string) (err error), o []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
    requestInfo.Method = ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.GET
    if q != nil {
        qParams := new(ManagerRequestBuilderGetQueryParameters)
        err := q(qParams)
        if err != nil {
            return nil, err
        }
...
func (m *ManagerRequestBuilder) Ref()(*i3c00bde30e634de189b51010ce60901e32c59de7534923a59442776eb666c6a2.RefRequestBuilder) {
    return i3c00bde30e634de189b51010ce60901e32c59de7534923a59442776eb666c6a2.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
