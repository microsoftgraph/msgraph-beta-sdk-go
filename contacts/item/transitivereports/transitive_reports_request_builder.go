...
// Builds and executes requests for operations under \contacts\{orgContact-id}\transitiveReports
...
func NewTransitiveReportsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*TransitiveReportsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/contacts/{orgContact_id}/transitiveReports{?top,skip,search,filter,count,orderby,select,expand}";
