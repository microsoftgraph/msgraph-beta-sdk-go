...
// DirectoryObjectItemRequestBuilder provides operations to manage the transitiveReports property of the microsoft.graph.orgContact entity.
...
// DirectoryObjectItemRequestBuilderGetQueryParameters the transitive reports for a contact. Read-only.
...
// CreateGetRequestInformationWithRequestConfiguration the transitive reports for a contact. Read-only.
...
// GetWithRequestConfigurationAndResponseHandler the transitive reports for a contact. Read-only.
