...
// ContactsOrgContactItemRequestBuilderGetQueryParameters get the properties and relationships of an organizational contact object.
...
func (m *ContactsOrgContactItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OrgContactable, requestConfiguration *ContactsOrgContactItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *ContactsOrgContactItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ContactsOrgContactItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OrgContactable, error) {
...
func (m *ContactsOrgContactItemRequestBuilder) Patch(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OrgContactable, requestConfiguration *ContactsOrgContactItemRequestBuilderPatchRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.OrgContactable, error) {
...
func (m *ContactsOrgContactItemRequestBuilder) TransitiveReports()(*ContactsItemTransitiveReportsRequestBuilder) {
    return NewContactsItemTransitiveReportsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *ContactsOrgContactItemRequestBuilder) TransitiveReportsById(id string)(*ContactsItemTransitiveReportsDirectoryObjectItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewContactsItemTransitiveReportsDirectoryObjectItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
