...
// RefRequestBuilder builds and executes requests for operations under \connections\{externalConnection-id}\quota\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/connections/{externalConnection_id}/quota/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property quota for connections
...
// CreateGetRequestInformation get ref of quota from connections
...
// CreatePutRequestInformation update the ref of navigation property quota in connections
...
// Delete delete ref of navigation property quota for connections
...
// Get get ref of quota from connections
...
// Put update the ref of navigation property quota in connections
