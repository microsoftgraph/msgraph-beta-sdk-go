...
func NewItemItemsItemActivitiesExternalActivityItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, externalActivityId *string)(*ItemItemsItemActivitiesExternalActivityItemRequestBuilder) {
...
func NewItemItemsItemActivitiesExternalActivityItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemActivitiesExternalActivityItemRequestBuilder) {
    ...
    return NewItemItemsItemActivitiesExternalActivityItemRequestBuilderInternal(urlParams, requestAdapter, nil)
}
