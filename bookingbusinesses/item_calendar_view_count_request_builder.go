...
func (m *ItemCalendarViewCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCalendarViewCountRequestBuilderGetRequestConfiguration)(*int64, error) {
