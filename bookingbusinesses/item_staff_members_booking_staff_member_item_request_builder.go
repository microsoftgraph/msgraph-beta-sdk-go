...
// ItemStaffMembersBookingStaffMemberItemRequestBuilder provides operations to manage the staffMembers property of the microsoft.graph.bookingBusiness entity.
type ItemStaffMembersBookingStaffMemberItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemStaffMembersBookingStaffMemberItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemStaffMembersBookingStaffMemberItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// ItemStaffMembersBookingStaffMemberItemRequestBuilderGetQueryParameters get the properties and relationships of a bookingStaffMember in the specified bookingBusiness. This API is supported in the following national cloud deployments.
...
type ItemStaffMembersBookingStaffMemberItemRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemStaffMembersBookingStaffMemberItemRequestBuilderGetQueryParameters
}
// ItemStaffMembersBookingStaffMemberItemRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemStaffMembersBookingStaffMemberItemRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewItemStaffMembersBookingStaffMemberItemRequestBuilderInternal instantiates a new BookingStaffMemberItemRequestBuilder and sets the default values.
func NewItemStaffMembersBookingStaffMemberItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemStaffMembersBookingStaffMemberItemRequestBuilder) {
    m := &ItemStaffMembersBookingStaffMemberItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/staffMembers/{bookingStaffMember%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
// NewItemStaffMembersBookingStaffMemberItemRequestBuilder instantiates a new BookingStaffMemberItemRequestBuilder and sets the default values.
func NewItemStaffMembersBookingStaffMemberItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemStaffMembersBookingStaffMemberItemRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemStaffMembersBookingStaffMemberItemRequestBuilderInternal(urlParams, requestAdapter)
}
// Delete delete a staff member in the specified bookingbusiness. This API is supported in the following national cloud deployments.
// [Find more info here]
// 
...
// ToDeleteRequestInformation delete a staff member in the specified bookingbusiness. This API is supported in the following national cloud deployments.
...
func (m *ItemStaffMembersBookingStaffMemberItemRequestBuilder) WithUrl(rawUrl string)(*ItemStaffMembersBookingStaffMemberItemRequestBuilder) {
    return NewItemStaffMembersBookingStaffMemberItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
