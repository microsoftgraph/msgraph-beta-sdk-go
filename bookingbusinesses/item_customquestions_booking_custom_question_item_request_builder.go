...
// ItemCustomquestionsBookingCustomQuestionItemRequestBuilder provides operations to manage the customQuestions property of the microsoft.graph.bookingBusiness entity.
type ItemCustomquestionsBookingCustomQuestionItemRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemCustomquestionsBookingCustomQuestionItemRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemCustomquestionsBookingCustomQuestionItemRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// ItemCustomquestionsBookingCustomQuestionItemRequestBuilderGetQueryParameters all custom questions of this business.
...
// ItemCustomquestionsBookingCustomQuestionItemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemCustomquestionsBookingCustomQuestionItemRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemCustomquestionsBookingCustomQuestionItemRequestBuilderGetQueryParameters
}
// ItemCustomquestionsBookingCustomQuestionItemRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemCustomquestionsBookingCustomQuestionItemRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewItemCustomquestionsBookingCustomQuestionItemRequestBuilderInternal instantiates a new ItemCustomquestionsBookingCustomQuestionItemRequestBuilder and sets the default values.
func NewItemCustomquestionsBookingCustomQuestionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCustomquestionsBookingCustomQuestionItemRequestBuilder) {
    m := &ItemCustomquestionsBookingCustomQuestionItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/customQuestions/{bookingCustomQuestion%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemCustomquestionsBookingCustomQuestionItemRequestBuilder instantiates a new ItemCustomquestionsBookingCustomQuestionItemRequestBuilder and sets the default values.
...
func (m *ItemCustomquestionsBookingCustomQuestionItemRequestBuilder) WithUrl(rawUrl string)(*ItemCustomquestionsBookingCustomQuestionItemRequestBuilder) {
    return NewItemCustomquestionsBookingCustomQuestionItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
