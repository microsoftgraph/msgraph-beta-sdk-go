...
// ByBookingStaffMemberIdString provides operations to manage the staffMembers property of the microsoft.graph.bookingBusiness entity.
func (m *ItemStaffMembersRequestBuilder) ByBookingStaffMemberIdString(bookingStaffMemberId string)(*ItemStaffMembersBookingStaffMemberItemRequestBuilder) {
