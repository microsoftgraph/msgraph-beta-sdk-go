...
func (m *BookingBusinessItemRequestBuilder) MicrosoftGraphGetStaffAvailability()(*ItemMicrosoftGraphGetStaffAvailabilityRequestBuilder) {
    return NewItemMicrosoftGraphGetStaffAvailabilityRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphPublish provides operations to call the publish method.
func (m *BookingBusinessItemRequestBuilder) MicrosoftGraphPublish()(*ItemMicrosoftGraphPublishRequestBuilder) {
    return NewItemMicrosoftGraphPublishRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUnpublish provides operations to call the unpublish method.
func (m *BookingBusinessItemRequestBuilder) MicrosoftGraphUnpublish()(*ItemMicrosoftGraphUnpublishRequestBuilder) {
    return NewItemMicrosoftGraphUnpublishRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
