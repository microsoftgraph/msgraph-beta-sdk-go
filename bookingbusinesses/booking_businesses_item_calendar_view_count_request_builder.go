...
func NewBookingBusinessesItemCalendarViewCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BookingBusinessesItemCalendarViewCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/calendarView/$count";
...
func (m *BookingBusinessesItemCalendarViewCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *BookingBusinessesItemCalendarViewCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
