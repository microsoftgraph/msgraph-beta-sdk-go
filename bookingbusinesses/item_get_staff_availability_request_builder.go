...
// NewItemGetStaffAvailabilityRequestBuilderInternal instantiates a new ItemGetStaffAvailabilityRequestBuilder and sets the default values.
...
// NewItemGetStaffAvailabilityRequestBuilder instantiates a new ItemGetStaffAvailabilityRequestBuilder and sets the default values.
...
func (m *ItemGetStaffAvailabilityRequestBuilder) PostAsGetStaffAvailabilityPostResponse(ctx context.Context, body ItemGetStaffAvailabilityPostRequestBodyable, requestConfiguration *ItemGetStaffAvailabilityRequestBuilderPostRequestConfiguration)(ItemGetStaffAvailabilityPostResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateItemGetStaffAvailabilityPostResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ItemGetStaffAvailabilityPostResponseable), nil
}
...
func (m *ItemGetStaffAvailabilityRequestBuilder) WithUrl(rawUrl string)(*ItemGetStaffAvailabilityRequestBuilder) {
    return NewItemGetStaffAvailabilityRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
