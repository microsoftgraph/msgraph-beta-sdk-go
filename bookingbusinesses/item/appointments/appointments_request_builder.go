...
type AppointmentsRequestBuilderGetOptions struct {
    ...
    Q *AppointmentsRequestBuilderGetQueryParameters;
...
func NewAppointmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AppointmentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/bookingBusinesses/{bookingBusiness_id}/appointments{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *AppointmentsRequestBuilder) Get(options *AppointmentsRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.BookingAppointmentCollectionResponseable, error) {
...
func (m *AppointmentsRequestBuilder) Post(options *AppointmentsRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.BookingAppointmentable, error) {
