...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property appointments for bookingBusinesses
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property appointments in bookingBusinesses
