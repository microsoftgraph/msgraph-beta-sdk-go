...
// CustomersRequestBuilderGetQueryParameters get a list of bookingCustomer objects.
...
// CreateGetRequestInformationWithRequestConfiguration get a list of bookingCustomer objects.
