...
// DeleteWithResponseHandler delete navigation property calendarView for bookingBusinesses
...
// PatchWithResponseHandler update the navigation property calendarView in bookingBusinesses
