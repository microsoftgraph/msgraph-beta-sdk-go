...
// CreatePostRequestInformationWithRequestConfiguration make the scheduling page of this business available to external customers. Set the **isPublished** property to true, and **publicUrl** property to the URL of the scheduling page.
