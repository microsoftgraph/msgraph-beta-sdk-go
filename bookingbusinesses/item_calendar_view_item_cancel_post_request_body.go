...
// ItemCalendarViewItemCancelPostRequestBody provides operations to call the cancel method.
...
func (m *ItemCalendarViewItemCancelPostRequestBody) GetAdditionalData()(map[string]interface{}) {
    return m.additionalData
}
// GetCancellationMessage gets the cancellationMessage property value. The cancellationMessage property
func (m *ItemCalendarViewItemCancelPostRequestBody) GetCancellationMessage()(*string) {
...
func (m *ItemCalendarViewItemCancelPostRequestBody) SetAdditionalData(value map[string]interface{})() {
    m.additionalData = value
}
// SetCancellationMessage sets the cancellationMessage property value. The cancellationMessage property
func (m *ItemCalendarViewItemCancelPostRequestBody) SetCancellationMessage(value *string)() {
