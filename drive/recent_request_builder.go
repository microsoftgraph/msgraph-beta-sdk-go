...
func (m *RecentRequestBuilder) Get(ctx context.Context, requestConfiguration *RecentRequestBuilderGetRequestConfiguration)(RecentResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateRecentResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *RecentRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *RecentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
