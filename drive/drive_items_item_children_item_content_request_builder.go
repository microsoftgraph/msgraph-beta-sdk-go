...
func NewDriveItemsItemChildrenItemContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemChildrenItemContentRequestBuilder) {
    m := &DriveItemsItemChildrenItemContentRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/children/{driveItem%2Did1}/content";
...
func NewDriveItemsItemChildrenItemContentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemChildrenItemContentRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveItemsItemChildrenItemContentRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation the content stream, if the item represents a file.
func (m *DriveItemsItemChildrenItemContentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveItemsItemChildrenItemContentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveItemsItemChildrenItemContentRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *DriveItemsItemChildrenItemContentRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *DriveItemsItemChildrenItemContentRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveItemsItemChildrenItemContentRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *DriveItemsItemChildrenItemContentRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *DriveItemsItemChildrenItemContentRequestBuilderPutRequestConfiguration)(error) {
