...
// RefRequestBuilder builds and executes requests for operations under \drive\list\items\{listItem-id}\activities\{itemActivityOLD-id}\driveItem\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/list/items/{listItem_id}/activities/{itemActivityOLD_id}/driveItem/$ref";
...
// CreateDeleteRequestInformation delete ref of navigation property driveItem for drive
...
// CreateGetRequestInformation get ref of driveItem from drive
...
// CreatePutRequestInformation update the ref of navigation property driveItem in drive
...
// Delete delete ref of navigation property driveItem for drive
...
// Get get ref of driveItem from drive
...
// Put update the ref of navigation property driveItem in drive
