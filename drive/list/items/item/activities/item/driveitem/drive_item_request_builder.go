...
import (
    ...
    ibb5b562dc5562911ad40d29d45f47897c23f3c51704b6f27fb706a051078bf03 "github.com/microsoftgraph/msgraph-beta-sdk-go/drive/list/items/item/activities/item/driveitem/content"
)

// driveItemRequestBuilder builds and executes requests for operations under \drive\list\items\{listItem-id}\activities\{itemActivityOLD-id}\driveItem
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/list/items/{listItem_id}/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*ibb5b562dc5562911ad40d29d45f47897c23f3c51704b6f27fb706a051078bf03.ContentRequestBuilder) {
    return ibb5b562dc5562911ad40d29d45f47897c23f3c51704b6f27fb706a051078bf03.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
