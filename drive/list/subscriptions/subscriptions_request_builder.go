...
import (
    ...
    i2438579bfcee49fe02a075f122be99a96fea96d44ed7b19ee96b6c5da81bc02d "github.com/microsoftgraph/msgraph-beta-sdk-go/drive/list/subscriptions/count"
)
...
func NewSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubscriptionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/list/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
func (m *SubscriptionsRequestBuilder) Count()(*i2438579bfcee49fe02a075f122be99a96fea96d44ed7b19ee96b6c5da81bc02d.CountRequestBuilder) {
    return i2438579bfcee49fe02a075f122be99a96fea96d44ed7b19ee96b6c5da81bc02d.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
// CreatePostRequestInformationWithRequestConfiguration create new navigation property to subscriptions for drive
...
// PostWithResponseHandler create new navigation property to subscriptions for drive
