...
// subscriptionRequestBuilder builds and executes requests for operations under \drive\list\subscriptions\{subscription-id}
...
// subscriptionRequestBuilderGetQueryParameters the set of subscriptions on the list.
