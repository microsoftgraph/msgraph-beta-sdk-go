...
func NewSubscriptionItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubscriptionItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/list/subscriptions/{subscription%2Did}{?%24select,%24expand}";
...
// CreateDeleteRequestInformationWithRequestConfiguration delete navigation property subscriptions for drive
...
// CreatePatchRequestInformationWithRequestConfiguration update the navigation property subscriptions in drive
...
// DeleteWithResponseHandler delete navigation property subscriptions for drive
...
// PatchWithResponseHandler update the navigation property subscriptions in drive
