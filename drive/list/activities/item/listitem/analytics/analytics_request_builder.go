...
// Builds and executes requests for operations under \drive\list\activities\{itemActivityOLD-id}\listItem\analytics
...
func NewAnalyticsRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*AnalyticsRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/drive/list/activities/{itemActivityOLD_id}/listItem/analytics{?select,expand}";
...
func (m *AnalyticsRequestBuilder) Ref()(*i1f5a1cd8a303bbbcddb260ed743b65e77d4532edc382a5f3e89fe3440391cdbb.RefRequestBuilder) {
    return i1f5a1cd8a303bbbcddb260ed743b65e77d4532edc382a5f3e89fe3440391cdbb.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
