...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property list for drive
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property list in drive
