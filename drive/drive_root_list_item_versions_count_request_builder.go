...
func NewDriveRootListItemVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootListItemVersionsCountRequestBuilder) {
    m := &DriveRootListItemVersionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/root/listItem/versions/$count";
...
func NewDriveRootListItemVersionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootListItemVersionsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveRootListItemVersionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveRootListItemVersionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveRootListItemVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveRootListItemVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveRootListItemVersionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
