...
func NewBundlesDriveItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BundlesDriveItemItemRequestBuilder) {
    m := &BundlesDriveItemItemRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/bundles/{driveItem%2Did}{?%24select,%24expand}";
...
func NewBundlesDriveItemItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BundlesDriveItemItemRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewBundlesDriveItemItemRequestBuilderInternal(urlParams, requestAdapter)
}
// Content provides operations to manage the media for the drive entity.
func (m *BundlesDriveItemItemRequestBuilder) Content()(*BundlesItemContentRequestBuilder) {
    return NewBundlesItemContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *BundlesDriveItemItemRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *BundlesDriveItemItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *BundlesDriveItemItemRequestBuilder) Get(ctx context.Context, requestConfiguration *BundlesDriveItemItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
