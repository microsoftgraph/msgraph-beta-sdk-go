...
func NewRootChildrenItemContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootChildrenItemContentRequestBuilder) {
    m := &RootChildrenItemContentRequestBuilder{
    }
...
func NewRootChildrenItemContentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootChildrenItemContentRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewRootChildrenItemContentRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation the content stream, if the item represents a file.
func (m *RootChildrenItemContentRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *RootChildrenItemContentRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RootChildrenItemContentRequestBuilder) CreatePutRequestInformation(ctx context.Context, body []byte, requestConfiguration *RootChildrenItemContentRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *RootChildrenItemContentRequestBuilder) Get(ctx context.Context, requestConfiguration *RootChildrenItemContentRequestBuilderGetRequestConfiguration)([]byte, error) {
...
func (m *RootChildrenItemContentRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *RootChildrenItemContentRequestBuilderPutRequestConfiguration)(error) {
