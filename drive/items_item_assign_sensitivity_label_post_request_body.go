...
// ItemsItemAssignSensitivityLabelPostRequestBody provides operations to call the assignSensitivityLabel method.
...
func (m *ItemsItemAssignSensitivityLabelPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemsItemAssignSensitivityLabelPostRequestBody) SetAdditionalData(value map[string]interface{})() {
