...
func NewDriveListOperationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListOperationsCountRequestBuilder) {
    m := &DriveListOperationsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/list/operations/$count";
...
func NewDriveListOperationsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListOperationsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveListOperationsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveListOperationsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveListOperationsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveListOperationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveListOperationsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
