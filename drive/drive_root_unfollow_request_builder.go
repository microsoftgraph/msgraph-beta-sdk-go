...
func NewDriveRootUnfollowRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootUnfollowRequestBuilder) {
    m := &DriveRootUnfollowRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/root/microsoft.graph.unfollow";
...
func NewDriveRootUnfollowRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootUnfollowRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveRootUnfollowRequestBuilderInternal(urlParams, requestAdapter)
}
// CreatePostRequestInformation unfollow a driveItem.
func (m *DriveRootUnfollowRequestBuilder) CreatePostRequestInformation(ctx context.Context, requestConfiguration *DriveRootUnfollowRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveRootUnfollowRequestBuilder) Post(ctx context.Context, requestConfiguration *DriveRootUnfollowRequestBuilderPostRequestConfiguration)(error) {
