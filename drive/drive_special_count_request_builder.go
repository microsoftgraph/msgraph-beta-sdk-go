...
func NewDriveSpecialCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveSpecialCountRequestBuilder) {
    m := &DriveSpecialCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/special/$count";
...
func NewDriveSpecialCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveSpecialCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveSpecialCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveSpecialCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveSpecialCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveSpecialCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveSpecialCountRequestBuilderGetRequestConfiguration)(*int32, error) {
