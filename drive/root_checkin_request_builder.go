...
func NewRootCheckinRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootCheckinRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewRootCheckinRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *RootCheckinRequestBuilder) CreatePostRequestInformation(ctx context.Context, body RootCheckinPostRequestBodyable, requestConfiguration *RootCheckinRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RootCheckinRequestBuilder) Post(ctx context.Context, body RootCheckinPostRequestBodyable, requestConfiguration *RootCheckinRequestBuilderPostRequestConfiguration)(error) {
