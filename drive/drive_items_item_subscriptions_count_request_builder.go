...
func NewDriveItemsItemSubscriptionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemSubscriptionsCountRequestBuilder) {
    m := &DriveItemsItemSubscriptionsCountRequestBuilder{
    }
...
func NewDriveItemsItemSubscriptionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemSubscriptionsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveItemsItemSubscriptionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveItemsItemSubscriptionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveItemsItemSubscriptionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveItemsItemSubscriptionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveItemsItemSubscriptionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
