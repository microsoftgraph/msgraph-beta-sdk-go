...
func NewItemsItemCreateUploadSessionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemCreateUploadSessionRequestBuilder) {
    m := &ItemsItemCreateUploadSessionRequestBuilder{
    }
...
func NewItemsItemCreateUploadSessionRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemsItemCreateUploadSessionRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemsItemCreateUploadSessionRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemsItemCreateUploadSessionRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ItemsItemCreateUploadSessionPostRequestBodyable, requestConfiguration *ItemsItemCreateUploadSessionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
