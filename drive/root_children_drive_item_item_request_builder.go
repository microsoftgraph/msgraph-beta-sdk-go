...
func NewRootChildrenDriveItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootChildrenDriveItemItemRequestBuilder) {
    m := &RootChildrenDriveItemItemRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/root/children/{driveItem%2Did}{?%24select,%24expand}";
...
func NewRootChildrenDriveItemItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootChildrenDriveItemItemRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewRootChildrenDriveItemItemRequestBuilderInternal(urlParams, requestAdapter)
}
// Content provides operations to manage the media for the drive entity.
func (m *RootChildrenDriveItemItemRequestBuilder) Content()(*RootChildrenItemContentRequestBuilder) {
    return NewRootChildrenItemContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *RootChildrenDriveItemItemRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *RootChildrenDriveItemItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RootChildrenDriveItemItemRequestBuilder) Get(ctx context.Context, requestConfiguration *RootChildrenDriveItemItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
