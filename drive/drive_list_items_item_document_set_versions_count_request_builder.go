...
func NewDriveListItemsItemDocumentSetVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListItemsItemDocumentSetVersionsCountRequestBuilder) {
    m := &DriveListItemsItemDocumentSetVersionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/list/items/{listItem%2Did}/documentSetVersions/$count";
...
func NewDriveListItemsItemDocumentSetVersionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveListItemsItemDocumentSetVersionsCountRequestBuilder) {
    ...
    return NewDriveListItemsItemDocumentSetVersionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveListItemsItemDocumentSetVersionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveListItemsItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveListItemsItemDocumentSetVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveListItemsItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
