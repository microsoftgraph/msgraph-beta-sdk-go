...
import (
    ...
    ib1f2722ffe9dc2961ea1c738fa1d1010afefbc8da613b87bd3c03a791c8248b0 "github.com/microsoftgraph/msgraph-beta-sdk-go/drive/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*ib1f2722ffe9dc2961ea1c738fa1d1010afefbc8da613b87bd3c03a791c8248b0.CountRequestBuilder) {
    return ib1f2722ffe9dc2961ea1c738fa1d1010afefbc8da613b87bd3c03a791c8248b0.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
