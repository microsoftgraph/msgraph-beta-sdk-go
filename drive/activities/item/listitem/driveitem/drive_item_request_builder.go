...
import (
    ...
    i4dfa4a40e6a1182361bfd2af922d29735254562c8d21c099f9fccf80d3654dff "github.com/microsoftgraph/msgraph-beta-sdk-go/drive/activities/item/listitem/driveitem/content"
)

// DriveItemRequestBuilder builds and executes requests for operations under \drive\activities\{itemActivityOLD-id}\listItem\driveItem
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/activities/{itemActivityOLD_id}/listItem/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i4dfa4a40e6a1182361bfd2af922d29735254562c8d21c099f9fccf80d3654dff.ContentRequestBuilder) {
    return i4dfa4a40e6a1182361bfd2af922d29735254562c8d21c099f9fccf80d3654dff.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
