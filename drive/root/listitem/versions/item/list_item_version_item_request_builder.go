...
// DeleteWithRequestConfigurationAndResponseHandler delete navigation property versions for drive
...
// PatchWithRequestConfigurationAndResponseHandler update the navigation property versions in drive
