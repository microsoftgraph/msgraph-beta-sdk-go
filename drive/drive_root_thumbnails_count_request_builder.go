...
func NewDriveRootThumbnailsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootThumbnailsCountRequestBuilder) {
    m := &DriveRootThumbnailsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/root/thumbnails/$count";
...
func NewDriveRootThumbnailsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveRootThumbnailsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveRootThumbnailsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveRootThumbnailsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveRootThumbnailsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveRootThumbnailsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveRootThumbnailsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
