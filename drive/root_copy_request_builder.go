...
func NewRootCopyRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RootCopyRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewRootCopyRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *RootCopyRequestBuilder) CreatePostRequestInformation(ctx context.Context, body RootCopyPostRequestBodyable, requestConfiguration *RootCopyRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RootCopyRequestBuilder) Post(ctx context.Context, body RootCopyPostRequestBodyable, requestConfiguration *RootCopyRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
