...
func (m *DriveItemsDriveItemItemRequestBuilder) Activities()(*DriveItemsItemActivitiesRequestBuilder) {
    return NewDriveItemsItemActivitiesRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// ActivitiesById provides operations to manage the activities property of the microsoft.graph.driveItem entity.
func (m *DriveItemsDriveItemItemRequestBuilder) ActivitiesById(id string)(*DriveItemsItemActivitiesItemActivityOLDItemRequestBuilder) {
    ...
    return NewDriveItemsItemActivitiesItemActivityOLDItemRequestBuilderInternal(urlTplParams, m.requestAdapter);
}
...
func (m *DriveItemsDriveItemItemRequestBuilder) AssignSensitivityLabel()(*DriveItemsItemAssignSensitivityLabelRequestBuilder) {
    return NewDriveItemsItemAssignSensitivityLabelRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DriveItemsDriveItemItemRequestBuilder) CreatePatchRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, requestConfiguration *DriveItemsDriveItemItemRequestBuilderPatchRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *DriveItemsDriveItemItemRequestBuilder) ExtractSensitivityLabels()(*DriveItemsItemExtractSensitivityLabelsRequestBuilder) {
    return NewDriveItemsItemExtractSensitivityLabelsRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DriveItemsDriveItemItemRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveItemsDriveItemItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DriveItemable, error) {
