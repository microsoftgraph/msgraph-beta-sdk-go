...
import (
    ...
    ibb3713a0366e99b68cf3f714366ccfe0b188ebba792b89a47c36050037ce6cb0 "github.com/microsoftgraph/msgraph-beta-sdk-go/drive/bundles/item/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*ibb3713a0366e99b68cf3f714366ccfe0b188ebba792b89a47c36050037ce6cb0.CountRequestBuilder) {
    return ibb3713a0366e99b68cf3f714366ccfe0b188ebba792b89a47c36050037ce6cb0.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
