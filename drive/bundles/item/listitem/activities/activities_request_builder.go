...
import (
    ...
    i1979781051a0a70d5e26ea0d5a8730486a4269548481e6e5222e6be60b4f2e5e "github.com/microsoftgraph/msgraph-beta-sdk-go/drive/bundles/item/listitem/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/listItem/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i1979781051a0a70d5e26ea0d5a8730486a4269548481e6e5222e6be60b4f2e5e.CountRequestBuilder) {
    return i1979781051a0a70d5e26ea0d5a8730486a4269548481e6e5222e6be60b4f2e5e.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
