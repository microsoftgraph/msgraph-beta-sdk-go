...
import (
    ...
    i4157cb261237ad8c0a2b62f72ed9dc772b82ce3a9a3b6bef557761e76107b0b5 "github.com/microsoftgraph/msgraph-beta-sdk-go/drive/special/item/listitem/activities/count"
)
...
func NewActivitiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*ActivitiesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/special/{driveItem_id}/listItem/activities{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *ActivitiesRequestBuilder) Count()(*i4157cb261237ad8c0a2b62f72ed9dc772b82ce3a9a3b6bef557761e76107b0b5.CountRequestBuilder) {
    return i4157cb261237ad8c0a2b62f72ed9dc772b82ce3a9a3b6bef557761e76107b0b5.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
