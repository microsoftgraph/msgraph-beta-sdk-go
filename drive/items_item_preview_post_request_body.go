...
func (m *ItemsItemPreviewPostRequestBody) GetAllowEdit()(*bool) {
    return m.allowEdit
}
// GetChromeless gets the chromeless property value. The chromeless property
func (m *ItemsItemPreviewPostRequestBody) GetChromeless()(*bool) {
    return m.chromeless
}
...
func (m *ItemsItemPreviewPostRequestBody) GetViewer()(*string) {
    return m.viewer
}
...
func (m *ItemsItemPreviewPostRequestBody) SetAllowEdit(value *bool)() {
    m.allowEdit = value
}
// SetChromeless sets the chromeless property value. The chromeless property
func (m *ItemsItemPreviewPostRequestBody) SetChromeless(value *bool)() {
    m.chromeless = value
}
...
func (m *ItemsItemPreviewPostRequestBody) SetViewer(value *string)() {
    m.viewer = value
}
