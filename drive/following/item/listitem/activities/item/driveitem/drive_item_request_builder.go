...
import (
    ...
    i6ec367819b0f671eef5b56d475e8182cf76bcbaeb31bb394c7cc51b7639a55ad "github.com/microsoftgraph/msgraph-beta-sdk-go/drive/following/item/listitem/activities/item/driveitem/content"
)
...
func NewDriveItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DriveItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drive/following/{driveItem_id}/listItem/activities/{itemActivityOLD_id}/driveItem{?select,expand}";
...
func (m *DriveItemRequestBuilder) Content()(*i6ec367819b0f671eef5b56d475e8182cf76bcbaeb31bb394c7cc51b7639a55ad.ContentRequestBuilder) {
    return i6ec367819b0f671eef5b56d475e8182cf76bcbaeb31bb394c7cc51b7639a55ad.NewContentRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
