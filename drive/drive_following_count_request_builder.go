...
func NewDriveFollowingCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveFollowingCountRequestBuilder) {
    m := &DriveFollowingCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/following/$count";
...
func NewDriveFollowingCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveFollowingCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDriveFollowingCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveFollowingCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveFollowingCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveFollowingCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveFollowingCountRequestBuilderGetRequestConfiguration)(*int32, error) {
