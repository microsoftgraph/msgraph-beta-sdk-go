...
func NewDriveItemsItemListItemDocumentSetVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemListItemDocumentSetVersionsCountRequestBuilder) {
    m := &DriveItemsItemListItemDocumentSetVersionsCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/documentSetVersions/$count";
...
func NewDriveItemsItemListItemDocumentSetVersionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DriveItemsItemListItemDocumentSetVersionsCountRequestBuilder) {
    ...
    return NewDriveItemsItemListItemDocumentSetVersionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// CreateGetRequestInformation get the number of the resource
func (m *DriveItemsItemListItemDocumentSetVersionsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *DriveItemsItemListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DriveItemsItemListItemDocumentSetVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DriveItemsItemListItemDocumentSetVersionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
