...
func (m *PrivilegedApprovalItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *PrivilegedApprovalItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
