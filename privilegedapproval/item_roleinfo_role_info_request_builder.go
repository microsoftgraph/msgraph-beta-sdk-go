...
// ItemRoleinfoRoleInfoRequestBuilder provides operations to manage the roleInfo property of the microsoft.graph.privilegedApproval entity.
...
// ItemRoleinfoRoleInfoRequestBuilderGetQueryParameters get roleInfo from privilegedApproval
