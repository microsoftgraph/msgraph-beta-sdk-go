...
// GetWithRequestConfigurationAndResponseHandler get entities from privilegedApproval
...
// PostWithRequestConfigurationAndResponseHandler add new entity to privilegedApproval
