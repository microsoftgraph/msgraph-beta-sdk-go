...
func (m *PrivilegedApprovalRequestBuilder) MicrosoftGraphMyRequests()(*MicrosoftGraphMyRequestsRequestBuilder) {
    return NewMicrosoftGraphMyRequestsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
