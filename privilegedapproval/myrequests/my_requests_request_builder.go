...
// MyRequestsRequestBuilderGetOptions options for Get
type MyRequestsRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
func (m *MyRequestsRequestBuilder) CreateGetRequestInformation(options *MyRequestsRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *MyRequestsRequestBuilder) Get(options *MyRequestsRequestBuilderGetOptions)([]MyRequests, error) {
    ...
    res, err := m.requestAdapter.SendCollectionAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewMyRequests() }, nil)
    if err != nil {
        return nil, err
    }
