...
// RefRequestBuilder builds and executes requests for operations under \privilegedApproval\{privilegedApproval-id}\request\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/privilegedApproval/{privilegedApproval_id}/request/$ref";
...
// CreateDeleteRequestInformation read-only. The role assignment request for this approval object
...
// CreatePutRequestInformation read-only. The role assignment request for this approval object
...
// Delete read-only. The role assignment request for this approval object
...
// Put read-only. The role assignment request for this approval object
