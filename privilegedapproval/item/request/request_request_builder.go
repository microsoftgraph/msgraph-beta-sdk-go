...
// RequestRequestBuilder provides operations to manage the request property of the microsoft.graph.privilegedApproval entity.
...
func NewRequestRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RequestRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/request{?%24select,%24expand}";
...
// CreateGetRequestInformationWithRequestConfiguration read-only. The role assignment request for this approval object
func (m *RequestRequestBuilder) CreateGetRequestInformationWithRequestConfiguration()(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    return m.CreateGetRequestInformationWithRequestConfiguration(nil);
}
// CreateGetRequestInformationWithRequestConfiguration read-only. The role assignment request for this approval object
func (m *RequestRequestBuilder) CreateGetRequestInformationWithRequestConfiguration(requestConfiguration *RequestRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// GetWithResponseHandler read-only. The role assignment request for this approval object
func (m *RequestRequestBuilder) GetWithResponseHandler(requestConfiguration *RequestRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrivilegedRoleAssignmentRequestable, error) {
    return m.GetWithResponseHandler(requestConfiguration, nil);
}
// GetWithResponseHandler read-only. The role assignment request for this approval object
func (m *RequestRequestBuilder) GetWithResponseHandler(requestConfiguration *RequestRequestBuilderGetRequestConfiguration, responseHandler i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ResponseHandler)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PrivilegedRoleAssignmentRequestable, error) {
