...
// GetWithRequestConfigurationAndResponseHandler get entity from privilegedApproval by key
...
// PatchWithRequestConfigurationAndResponseHandler update entity in privilegedApproval
