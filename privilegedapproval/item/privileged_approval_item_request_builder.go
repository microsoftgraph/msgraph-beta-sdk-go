...
// PrivilegedApprovalItemRequestBuilder builds and executes requests for operations under \privilegedApproval\{privilegedApproval-id}
...
// PrivilegedApprovalItemRequestBuilderDeleteOptions options for Delete
type PrivilegedApprovalItemRequestBuilderDeleteOptions struct {
    // Request headers
    H map[string]string;
    // Request options
...
// PrivilegedApprovalItemRequestBuilderGetOptions options for Get
type PrivilegedApprovalItemRequestBuilderGetOptions struct {
    // Request headers
    H map[string]string;
    // Request options
    O []ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestOption;
    // Request query parameters
    Q *PrivilegedApprovalItemRequestBuilderGetQueryParameters;
    // Response handler to use in place of the default response handling provided by the core service
    ResponseHandler ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.ResponseHandler;
}
...
// PrivilegedApprovalItemRequestBuilderPatchOptions options for Patch
type PrivilegedApprovalItemRequestBuilderPatchOptions struct {
    // 
...
func NewPrivilegedApprovalItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PrivilegedApprovalItemRequestBuilder) {
...
func NewPrivilegedApprovalItemRequestBuilder(rawUrl string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*PrivilegedApprovalItemRequestBuilder) {
...
func (m *PrivilegedApprovalItemRequestBuilder) CreateDeleteRequestInformation(options *PrivilegedApprovalItemRequestBuilderDeleteOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
...
func (m *PrivilegedApprovalItemRequestBuilder) CreateGetRequestInformation(options *PrivilegedApprovalItemRequestBuilderGetOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *PrivilegedApprovalItemRequestBuilder) CreatePatchRequestInformation(options *PrivilegedApprovalItemRequestBuilderPatchOptions)(*ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestInformation, error) {
    requestInfo := ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
func (m *PrivilegedApprovalItemRequestBuilder) Delete(options *PrivilegedApprovalItemRequestBuilderDeleteOptions)(error) {
...
func (m *PrivilegedApprovalItemRequestBuilder) Get(options *PrivilegedApprovalItemRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PrivilegedApproval, error) {
...
func (m *PrivilegedApprovalItemRequestBuilder) Patch(options *PrivilegedApprovalItemRequestBuilderPatchOptions)(error) {
