...
// DeleteWithResponseHandler delete navigation property roleInfo for privilegedApproval
...
// PatchWithResponseHandler update the navigation property roleInfo in privilegedApproval
