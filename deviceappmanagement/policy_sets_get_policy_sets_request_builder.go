...
// NewPolicySetsGetPolicySetsRequestBuilderInternal instantiates a new PolicySetsGetPolicySetsRequestBuilder and sets the default values.
...
// NewPolicySetsGetPolicySetsRequestBuilder instantiates a new PolicySetsGetPolicySetsRequestBuilder and sets the default values.
...
// returns a PolicySetsGetPolicySetsPostResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
