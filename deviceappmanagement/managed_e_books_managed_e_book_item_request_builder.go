...
func (m *ManagedEBooksManagedEBookItemRequestBuilder) CategoriesById(id string)(*ManagedEBooksItemCategoriesManagedEBookCategoryItemRequestBuilder) {
    ...
    return NewManagedEBooksItemCategoriesManagedEBookCategoryItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ManagedEBooksManagedEBookItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *ManagedEBooksManagedEBookItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
