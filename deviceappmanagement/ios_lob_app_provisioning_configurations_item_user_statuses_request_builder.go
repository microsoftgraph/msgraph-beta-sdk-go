...
// NewIosLobAppProvisioningConfigurationsItemUserStatusesRequestBuilderInternal instantiates a new UserStatusesRequestBuilder and sets the default values.
...
// NewIosLobAppProvisioningConfigurationsItemUserStatusesRequestBuilder instantiates a new UserStatusesRequestBuilder and sets the default values.
...
func (m *IosLobAppProvisioningConfigurationsItemUserStatusesRequestBuilder) Count()(*IosLobAppProvisioningConfigurationsItemUserStatusesCountRequestBuilder) {
    return NewIosLobAppProvisioningConfigurationsItemUserStatusesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation the list of user installation states for this mobile app configuration.
func (m *IosLobAppProvisioningConfigurationsItemUserStatusesRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *IosLobAppProvisioningConfigurationsItemUserStatusesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
