...
// ByUserInstallStateSummaryIdString provides operations to manage the userStateSummary property of the microsoft.graph.managedEBook entity.
func (m *ManagedEBooksItemUserStateSummaryRequestBuilder) ByUserInstallStateSummaryIdString(userInstallStateSummaryId string)(*ManagedEBooksItemUserStateSummaryUserInstallStateSummaryItemRequestBuilder) {
