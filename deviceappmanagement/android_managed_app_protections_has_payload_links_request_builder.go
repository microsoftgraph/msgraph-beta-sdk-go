...
// NewAndroidManagedAppProtectionsHasPayloadLinksRequestBuilderInternal instantiates a new AndroidManagedAppProtectionsHasPayloadLinksRequestBuilder and sets the default values.
...
// NewAndroidManagedAppProtectionsHasPayloadLinksRequestBuilder instantiates a new AndroidManagedAppProtectionsHasPayloadLinksRequestBuilder and sets the default values.
...
// returns a AndroidManagedAppProtectionsHasPayloadLinksPostResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
...
// returns a *AndroidManagedAppProtectionsHasPayloadLinksRequestBuilder when successful
