...
func (m *VpptokensVppTokenItemRequestBuilder) RevokeLicenses()(*VpptokensItemRevokelicensesRevokeLicensesRequestBuilder) {
    return NewVpptokensItemRevokelicensesRevokeLicensesRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
