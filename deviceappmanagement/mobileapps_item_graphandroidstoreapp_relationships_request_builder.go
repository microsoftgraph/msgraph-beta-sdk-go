...
// MobileappsItemGraphandroidstoreappRelationshipsRequestBuilderGetQueryParameters the set of direct relationships for this app.
...
// NewMobileappsItemGraphandroidstoreappRelationshipsRequestBuilderInternal instantiates a new MobileappsItemGraphandroidstoreappRelationshipsRequestBuilder and sets the default values.
func NewMobileappsItemGraphandroidstoreappRelationshipsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileappsItemGraphandroidstoreappRelationshipsRequestBuilder) {
    m := &MobileappsItemGraphandroidstoreappRelationshipsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidStoreApp/relationships{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewMobileappsItemGraphandroidstoreappRelationshipsRequestBuilder instantiates a new MobileappsItemGraphandroidstoreappRelationshipsRequestBuilder and sets the default values.
