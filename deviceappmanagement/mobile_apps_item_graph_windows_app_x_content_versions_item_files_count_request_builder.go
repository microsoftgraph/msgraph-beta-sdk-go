...
func (m *MobileAppsItemGraphWindowsAppXContentVersionsItemFilesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphWindowsAppXContentVersionsItemFilesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
