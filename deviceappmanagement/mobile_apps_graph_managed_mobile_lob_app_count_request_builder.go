...
func (m *MobileAppsGraphManagedMobileLobAppCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsGraphManagedMobileLobAppCountRequestBuilderGetRequestConfiguration)(*int64, error) {
