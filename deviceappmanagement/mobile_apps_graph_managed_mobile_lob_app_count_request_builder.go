...
// NewMobileAppsGraphManagedMobileLobAppCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewMobileAppsGraphManagedMobileLobAppCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileAppsGraphManagedMobileLobAppCountRequestBuilder) {
    m := &MobileAppsGraphManagedMobileLobAppCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.managedMobileLobApp/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
// NewMobileAppsGraphManagedMobileLobAppCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
