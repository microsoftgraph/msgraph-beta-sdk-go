...
func (m *PolicySetsPolicySetItemRequestBuilder) MicrosoftGraphUpdate()(*PolicySetsItemMicrosoftGraphUpdateRequestBuilder) {
    return NewPolicySetsItemMicrosoftGraphUpdateRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
