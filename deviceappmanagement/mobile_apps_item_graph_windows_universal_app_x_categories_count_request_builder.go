...
func (m *MobileAppsItemGraphWindowsUniversalAppXCategoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphWindowsUniversalAppXCategoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
