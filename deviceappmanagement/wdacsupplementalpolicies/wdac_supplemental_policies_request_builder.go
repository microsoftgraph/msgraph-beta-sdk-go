...
type WdacSupplementalPoliciesRequestBuilderGetOptions struct {
    ...
    Q *WdacSupplementalPoliciesRequestBuilderGetQueryParameters;
...
func (m *WdacSupplementalPoliciesRequestBuilder) Get(options *WdacSupplementalPoliciesRequestBuilderGetOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WindowsDefenderApplicationControlSupplementalPolicyCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(requestInfo, i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.CreateWindowsDefenderApplicationControlSupplementalPolicyCollectionResponseFromDiscriminatorValue, nil, errorMapping)
    if err != nil {
        return nil, err
    }
    return res.(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WindowsDefenderApplicationControlSupplementalPolicyCollectionResponseable), nil
}
// Post create new navigation property to wdacSupplementalPolicies for deviceAppManagement
func (m *WdacSupplementalPoliciesRequestBuilder) Post(options *WdacSupplementalPoliciesRequestBuilderPostOptions)(i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.WindowsDefenderApplicationControlSupplementalPolicyable, error) {
