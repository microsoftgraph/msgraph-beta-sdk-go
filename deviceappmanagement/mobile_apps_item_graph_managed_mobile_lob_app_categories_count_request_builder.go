...
func (m *MobileAppsItemGraphManagedMobileLobAppCategoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphManagedMobileLobAppCategoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
