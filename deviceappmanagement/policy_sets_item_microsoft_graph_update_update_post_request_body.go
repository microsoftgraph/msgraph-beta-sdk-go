...
// PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody 
type PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody struct {
...
// NewPolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody instantiates a new PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody and sets the default values.
func NewPolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody()(*PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) {
    m := &PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreatePolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody(), nil
}
// GetAddedPolicySetItems gets the addedPolicySetItems property value. The addedPolicySetItems property
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) GetAddedPolicySetItems()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PolicySetItemable) {
    return m.addedPolicySetItems
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAssignments gets the assignments property value. The assignments property
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) GetAssignments()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PolicySetAssignmentable) {
    return m.assignments
}
// GetDeletedPolicySetItems gets the deletedPolicySetItems property value. The deletedPolicySetItems property
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) GetDeletedPolicySetItems()([]string) {
    return m.deletedPolicySetItems
}
// GetFieldDeserializers the deserialization information for the current model
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) GetUpdatedPolicySetItems()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PolicySetItemable) {
    return m.updatedPolicySetItems
}
// Serialize serializes information the current object
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) SetAddedPolicySetItems(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PolicySetItemable)() {
    m.addedPolicySetItems = value
}
// SetAdditionalData sets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAssignments sets the assignments property value. The assignments property
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) SetAssignments(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PolicySetAssignmentable)() {
    m.assignments = value
}
// SetDeletedPolicySetItems sets the deletedPolicySetItems property value. The deletedPolicySetItems property
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) SetDeletedPolicySetItems(value []string)() {
...
func (m *PolicySetsItemMicrosoftGraphUpdateUpdatePostRequestBody) SetUpdatedPolicySetItems(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.PolicySetItemable)() {
