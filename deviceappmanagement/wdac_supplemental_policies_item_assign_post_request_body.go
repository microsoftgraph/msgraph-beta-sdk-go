...
// WdacSupplementalPoliciesItemAssignPostRequestBody provides operations to call the assign method.
...
func (m *WdacSupplementalPoliciesItemAssignPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *WdacSupplementalPoliciesItemAssignPostRequestBody) SetAdditionalData(value map[string]interface{})() {
