...
func (m *WdacSupplementalPoliciesItemAssignPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *WdacSupplementalPoliciesItemAssignPostRequestBody) GetWdacPolicyAssignments()([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WindowsDefenderApplicationControlSupplementalPolicyAssignmentable) {
    val, err := m.GetBackingStore().Get("wdacPolicyAssignments")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.([]ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WindowsDefenderApplicationControlSupplementalPolicyAssignmentable)
    }
    return nil
}
...
func (m *WdacSupplementalPoliciesItemAssignPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *WdacSupplementalPoliciesItemAssignPostRequestBody) SetWdacPolicyAssignments(value []ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WindowsDefenderApplicationControlSupplementalPolicyAssignmentable)() {
    err := m.GetBackingStore().Set("wdacPolicyAssignments", value)
    if err != nil {
        panic(err)
    }
}
// WdacSupplementalPoliciesItemAssignPostRequestBodyable 
type WdacSupplementalPoliciesItemAssignPostRequestBodyable interface {
