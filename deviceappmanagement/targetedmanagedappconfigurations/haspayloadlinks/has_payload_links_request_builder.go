...
// Builds and executes requests for operations under \deviceAppManagement\targetedManagedAppConfigurations\microsoft.graph.hasPayloadLinks
...
func NewHasPayloadLinksRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*HasPayloadLinksRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/deviceAppManagement/targetedManagedAppConfigurations/microsoft.graph.hasPayloadLinks";
