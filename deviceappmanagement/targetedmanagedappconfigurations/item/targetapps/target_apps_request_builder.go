...
// Builds and executes requests for operations under \deviceAppManagement\targetedManagedAppConfigurations\{targetedManagedAppConfiguration-id}\microsoft.graph.targetApps
...
// Options for Post
type TargetAppsRequestBuilderPostOptions struct {
    // 
    Body *TargetAppsRequestBody;
    // Request headers
    H map[string]string;
    // Request options
