...
func (m *VppTokensVppTokenItemRequestBuilder) MicrosoftGraphRevokeLicenses()(*VppTokensItemMicrosoftGraphRevokeLicensesRevokeLicensesRequestBuilder) {
    return NewVppTokensItemMicrosoftGraphRevokeLicensesRevokeLicensesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
