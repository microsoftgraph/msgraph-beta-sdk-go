...
func (m *VppTokensVppTokenItemRequestBuilder) Get(ctx context.Context, requestConfiguration *VppTokensVppTokenItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.VppTokenable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateVppTokenFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphRevokeLicenses provides operations to call the revokeLicenses method.
func (m *VppTokensVppTokenItemRequestBuilder) MicrosoftGraphRevokeLicenses()(*VppTokensItemMicrosoftGraphRevokeLicensesRequestBuilder) {
    return NewVppTokensItemMicrosoftGraphRevokeLicensesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSyncLicenses provides operations to call the syncLicenses method.
func (m *VppTokensVppTokenItemRequestBuilder) MicrosoftGraphSyncLicenses()(*VppTokensItemMicrosoftGraphSyncLicensesRequestBuilder) {
    return NewVppTokensItemMicrosoftGraphSyncLicensesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
