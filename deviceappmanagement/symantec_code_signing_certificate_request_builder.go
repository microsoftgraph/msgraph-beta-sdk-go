...
func (m *SymantecCodeSigningCertificateRequestBuilder) Delete(ctx context.Context, requestConfiguration *SymantecCodeSigningCertificateRequestBuilderDeleteRequestConfiguration)([]byte, error) {
