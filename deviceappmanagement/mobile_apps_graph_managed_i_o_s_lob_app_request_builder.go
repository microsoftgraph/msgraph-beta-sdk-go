...
// MobileAppsGraphManagedIOSLobAppRequestBuilder casts the previous resource to managedIOSLobApp.
type MobileAppsGraphManagedIOSLobAppRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// MobileAppsGraphManagedIOSLobAppRequestBuilderGetQueryParameters get the items of type microsoft.graph.managedIOSLobApp in the microsoft.graph.mobileApp collection
type MobileAppsGraphManagedIOSLobAppRequestBuilderGetQueryParameters struct {
...
// MobileAppsGraphManagedIOSLobAppRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type MobileAppsGraphManagedIOSLobAppRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
func (m *MobileAppsGraphManagedIOSLobAppRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsGraphManagedIOSLobAppRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.ManagedIOSLobAppCollectionResponseable, error) {
