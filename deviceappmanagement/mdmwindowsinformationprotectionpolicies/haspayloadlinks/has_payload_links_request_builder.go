...
func (m *HasPayloadLinksRequestBuilder) Post(ctx context.Context, body HasPayloadLinksPostRequestBodyable, requestConfiguration *HasPayloadLinksRequestBuilderPostRequestConfiguration)(HasPayloadLinksResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateHasPayloadLinksResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
