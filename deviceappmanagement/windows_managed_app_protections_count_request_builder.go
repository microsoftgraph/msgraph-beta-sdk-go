...
func (m *WindowsManagedAppProtectionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsManagedAppProtectionsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
