...
func (m *WdacSupplementalPoliciesWindowsDefenderApplicationControlSupplementalPolicyItemRequestBuilder) MicrosoftGraphAssign()(*WdacSupplementalPoliciesItemMicrosoftGraphAssignRequestBuilder) {
    return NewWdacSupplementalPoliciesItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
