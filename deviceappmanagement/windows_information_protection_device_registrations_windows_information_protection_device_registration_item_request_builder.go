...
func (m *WindowsInformationProtectionDeviceRegistrationsWindowsInformationProtectionDeviceRegistrationItemRequestBuilder) MicrosoftGraphWipe()(*WindowsInformationProtectionDeviceRegistrationsItemMicrosoftGraphWipeRequestBuilder) {
    return NewWindowsInformationProtectionDeviceRegistrationsItemMicrosoftGraphWipeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
