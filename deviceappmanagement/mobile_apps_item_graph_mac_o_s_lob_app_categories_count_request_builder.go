...
func (m *MobileAppsItemGraphMacOSLobAppCategoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphMacOSLobAppCategoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
