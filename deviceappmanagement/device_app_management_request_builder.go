...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.androidManagedAppProtections.item collection
// Parameters:
...
func NewDeviceAppManagementRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*DeviceAppManagementRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/deviceAppManagement{?select,expand}";
    urlTplParams := make(map[string]string)
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.defaultManagedAppProtections.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.deviceAppManagementTasks.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.enterpriseCodeSigningCertificates.item collection
// Parameters:
//  - id : Unique identifier of the item
...
func (m *DeviceAppManagementRequestBuilder) Get(options *DeviceAppManagementRequestBuilderGetOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DeviceAppManagement, error) {
    ...
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewDeviceAppManagement() }, nil)
    if err != nil {
        return nil, err
    }
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.iosLobAppProvisioningConfigurations.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.iosManagedAppProtections.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.managedAppPolicies.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.managedAppRegistrations.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.managedAppStatuses.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.managedEBookCategories.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.managedEBooks.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.mdmWindowsInformationProtectionPolicies.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.mobileAppCategories.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.mobileAppConfigurations.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.mobileApps.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.policySets.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.sideLoadingKeys.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.targetedManagedAppConfigurations.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.vppTokens.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.wdacSupplementalPolicies.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.windowsInformationProtectionDeviceRegistrations.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.windowsInformationProtectionPolicies.item collection
// Parameters:
//  - id : Unique identifier of the item
...
// Gets an item from the github.com/microsoftgraph/msgraph-beta-sdk-go.deviceAppManagement.windowsInformationProtectionWipeActions.item collection
// Parameters:
//  - id : Unique identifier of the item
