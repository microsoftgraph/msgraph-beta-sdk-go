...
// NewMobileAppsItemGraphManagedMobileLobAppContentVersionsItemContainedAppsMobileContainedAppItemRequestBuilder instantiates a new MobileContainedAppItemRequestBuilder and sets the default values.
