...
// MobileAppsGetMobileAppCountWithStatusRequestBuilder provides operations to call the getMobileAppCount method.
type MobileAppsGetMobileAppCountWithStatusRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// MobileAppsGetMobileAppCountWithStatusRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type MobileAppsGetMobileAppCountWithStatusRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewMobileAppsGetMobileAppCountWithStatusRequestBuilderInternal instantiates a new GetMobileAppCountWithStatusRequestBuilder and sets the default values.
func NewMobileAppsGetMobileAppCountWithStatusRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter, status *string)(*MobileAppsGetMobileAppCountWithStatusRequestBuilder) {
    m := &MobileAppsGetMobileAppCountWithStatusRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/getMobileAppCount(status='{status}')", pathParameters),
    }
    if status != nil {
        m.BaseRequestBuilder.PathParameters["status"] = *status
    }
    return m
}
...
func NewMobileAppsGetMobileAppCountWithStatusRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileAppsGetMobileAppCountWithStatusRequestBuilder) {
...
func (m *MobileAppsGetMobileAppCountWithStatusRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsGetMobileAppCountWithStatusRequestBuilderGetRequestConfiguration)(MobileAppsGetMobileAppCountWithStatusResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateMobileAppsGetMobileAppCountWithStatusResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
