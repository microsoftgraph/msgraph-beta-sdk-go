...
// ManagedDeviceMobileAppConfigurationDeviceStatusRequestBuilder builds and executes requests for operations under \deviceAppManagement\iosLobAppProvisioningConfigurations\{iosLobAppProvisioningConfiguration-id}\deviceStatuses\{managedDeviceMobileAppConfigurationDeviceStatus-id}
...
// ManagedDeviceMobileAppConfigurationDeviceStatusRequestBuilderGetQueryParameters the list of device installation states for this mobile app configuration.
