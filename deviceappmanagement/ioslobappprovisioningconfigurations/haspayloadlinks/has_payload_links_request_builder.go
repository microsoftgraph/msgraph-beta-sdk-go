...
// HasPayloadLinksRequestBuilder builds and executes requests for operations under \deviceAppManagement\iosLobAppProvisioningConfigurations\microsoft.graph.hasPayloadLinks
