...
// NewPolicySetsItemItemsPolicySetItemItemRequestBuilderInternal instantiates a new PolicySetItemItemRequestBuilder and sets the default values.
...
// NewPolicySetsItemItemsPolicySetItemItemRequestBuilder instantiates a new PolicySetItemItemRequestBuilder and sets the default values.
...
func (m *PolicySetsItemItemsPolicySetItemItemRequestBuilder) CreateDeleteRequestInformation(ctx context.Context, requestConfiguration *PolicySetsItemItemsPolicySetItemItemRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PolicySetsItemItemsPolicySetItemItemRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *PolicySetsItemItemsPolicySetItemItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
