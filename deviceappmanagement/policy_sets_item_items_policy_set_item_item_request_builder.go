...
func NewPolicySetsItemItemsPolicySetItemItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PolicySetsItemItemsPolicySetItemItemRequestBuilder) {
    m := &PolicySetsItemItemsPolicySetItemItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/policySets/{policySet%2Did}/items/{policySetItem%2Did}{?%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *PolicySetsItemItemsPolicySetItemItemRequestBuilder) Delete(ctx context.Context, requestConfiguration *PolicySetsItemItemsPolicySetItemItemRequestBuilderDeleteRequestConfiguration)([]byte, error) {
