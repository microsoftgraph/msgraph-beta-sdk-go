...
func (m *MobileAppsItemGraphMacOSDmgAppCategoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphMacOSDmgAppCategoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
