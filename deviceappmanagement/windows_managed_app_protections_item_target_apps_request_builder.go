...
// NewWindowsManagedAppProtectionsItemTargetAppsRequestBuilderInternal instantiates a new WindowsManagedAppProtectionsItemTargetAppsRequestBuilder and sets the default values.
...
// NewWindowsManagedAppProtectionsItemTargetAppsRequestBuilder instantiates a new WindowsManagedAppProtectionsItemTargetAppsRequestBuilder and sets the default values.
...
func (m *WindowsManagedAppProtectionsItemTargetAppsRequestBuilder) WithUrl(rawUrl string)(*WindowsManagedAppProtectionsItemTargetAppsRequestBuilder) {
    return NewWindowsManagedAppProtectionsItemTargetAppsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
