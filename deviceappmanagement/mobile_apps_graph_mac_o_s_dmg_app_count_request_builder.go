...
func (m *MobileAppsGraphMacOSDmgAppCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsGraphMacOSDmgAppCountRequestBuilderGetRequestConfiguration)(*int64, error) {
