...
func (m *MobileAppsItemGraphIosLobAppContentVersionsMobileAppContentItemRequestBuilder) Scripts()(*MobileAppsItemGraphIosLobAppContentVersionsItemScriptsRequestBuilder) {
    return NewMobileAppsItemGraphIosLobAppContentVersionsItemScriptsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
