...
// ItemsRequestBuilder builds and executes requests for operations under \deviceAppManagement\policySets\{policySet-id}\items
...
// CreatePostRequestInformation items of the PolicySet with maximum count 100.
...
// Post items of the PolicySet with maximum count 100.
func (m *ItemsRequestBuilder) Post(options *ItemsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.PolicySetItem, error) {
