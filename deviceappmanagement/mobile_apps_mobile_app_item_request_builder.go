...
func (m *MobileAppsMobileAppItemRequestBuilder) MicrosoftGraphGetRelatedAppStatesWithUserPrincipalNameWithDeviceId(deviceId *string, userPrincipalName *string)(*MobileAppsItemMicrosoftGraphGetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder) {
    return NewMobileAppsItemMicrosoftGraphGetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilderInternal(m.pathParameters, m.requestAdapter, deviceId, userPrincipalName)
}
...
func (m *MobileAppsMobileAppItemRequestBuilder) MicrosoftGraphUpdateRelationships()(*MobileAppsItemMicrosoftGraphUpdateRelationshipsRequestBuilder) {
    return NewMobileAppsItemMicrosoftGraphUpdateRelationshipsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
