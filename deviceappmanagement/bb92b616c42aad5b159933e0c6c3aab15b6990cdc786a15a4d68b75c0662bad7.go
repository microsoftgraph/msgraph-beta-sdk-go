...
// returns a *MobileAppsItemGraphManagedAndroidLobAppContentVersionsItemScriptsRequestBuilder when successful
func (m *MobileAppsItemGraphManagedAndroidLobAppContentVersionsMobileAppContentItemRequestBuilder) Scripts()(*MobileAppsItemGraphManagedAndroidLobAppContentVersionsItemScriptsRequestBuilder) {
    return NewMobileAppsItemGraphManagedAndroidLobAppContentVersionsItemScriptsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
