...
func (m *AndroidManagedAppProtectionsRequestBuilder) Get(ctx context.Context, requestConfiguration *AndroidManagedAppProtectionsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.AndroidManagedAppProtectionCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateAndroidManagedAppProtectionCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *AndroidManagedAppProtectionsRequestBuilder) MicrosoftGraphHasPayloadLinks()(*AndroidManagedAppProtectionsMicrosoftGraphHasPayloadLinksHasPayloadLinksRequestBuilder) {
    return NewAndroidManagedAppProtectionsMicrosoftGraphHasPayloadLinksHasPayloadLinksRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
