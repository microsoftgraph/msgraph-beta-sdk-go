...
func (m *AndroidManagedAppProtectionsRequestBuilder) MicrosoftGraphHasPayloadLinks()(*AndroidManagedAppProtectionsMicrosoftGraphHasPayloadLinksRequestBuilder) {
    return NewAndroidManagedAppProtectionsMicrosoftGraphHasPayloadLinksRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
