...
// NewMobileappsItemGraphwindowsmobilemsiRelationshipsCountRequestBuilderInternal instantiates a new MobileappsItemGraphwindowsmobilemsiRelationshipsCountRequestBuilder and sets the default values.
func NewMobileappsItemGraphwindowsmobilemsiRelationshipsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileappsItemGraphwindowsmobilemsiRelationshipsCountRequestBuilder) {
    m := &MobileappsItemGraphwindowsmobilemsiRelationshipsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsMobileMSI/relationships/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewMobileappsItemGraphwindowsmobilemsiRelationshipsCountRequestBuilder instantiates a new MobileappsItemGraphwindowsmobilemsiRelationshipsCountRequestBuilder and sets the default values.
...
// returns a *MobileappsItemGraphwindowsmobilemsiRelationshipsCountRequestBuilder when successful
