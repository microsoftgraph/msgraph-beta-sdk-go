...
func (m *MobileAppsItemGraphMacOSPkgAppCategoriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphMacOSPkgAppCategoriesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
