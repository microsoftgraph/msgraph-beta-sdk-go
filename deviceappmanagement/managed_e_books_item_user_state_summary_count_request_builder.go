...
func (m *ManagedEBooksItemUserStateSummaryCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedEBooksItemUserStateSummaryCountRequestBuilderGetRequestConfiguration)(*int64, error) {
