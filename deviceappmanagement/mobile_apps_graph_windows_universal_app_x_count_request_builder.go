...
func (m *MobileAppsGraphWindowsUniversalAppXCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsGraphWindowsUniversalAppXCountRequestBuilderGetRequestConfiguration)(*int64, error) {
