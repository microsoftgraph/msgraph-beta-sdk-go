...
func (m *DeviceAppManagementMobileAppsRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MobileAppable, requestConfiguration *DeviceAppManagementMobileAppsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    requestInfo.UrlTemplate = m.urlTemplate
    requestInfo.PathParameters = m.pathParameters
...
// Get the mobile apps.
func (m *DeviceAppManagementMobileAppsRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceAppManagementMobileAppsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MobileAppCollectionResponseable, error) {
...
func (m *DeviceAppManagementMobileAppsRequestBuilder) GetMobileAppCountWithStatus(status *string)(*DeviceAppManagementMobileAppsGetMobileAppCountWithStatusRequestBuilder) {
    return NewDeviceAppManagementMobileAppsGetMobileAppCountWithStatusRequestBuilderInternal(m.pathParameters, m.requestAdapter, status);
}
// GetTopMobileAppsWithStatusWithCount provides operations to call the getTopMobileApps method.
func (m *DeviceAppManagementMobileAppsRequestBuilder) GetTopMobileAppsWithStatusWithCount(count *int64, status *string)(*DeviceAppManagementMobileAppsGetTopMobileAppsWithStatusWithCountRequestBuilder) {
    return NewDeviceAppManagementMobileAppsGetTopMobileAppsWithStatusWithCountRequestBuilderInternal(m.pathParameters, m.requestAdapter, count, status);
}
// HasPayloadLinks provides operations to call the hasPayloadLinks method.
func (m *DeviceAppManagementMobileAppsRequestBuilder) HasPayloadLinks()(*DeviceAppManagementMobileAppsHasPayloadLinksRequestBuilder) {
    return NewDeviceAppManagementMobileAppsHasPayloadLinksRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
...
func (m *DeviceAppManagementMobileAppsRequestBuilder) Post(ctx context.Context, body ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MobileAppable, requestConfiguration *DeviceAppManagementMobileAppsRequestBuilderPostRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.MobileAppable, error) {
...
func (m *DeviceAppManagementMobileAppsRequestBuilder) ValidateXml()(*DeviceAppManagementMobileAppsValidateXmlRequestBuilder) {
    return NewDeviceAppManagementMobileAppsValidateXmlRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
