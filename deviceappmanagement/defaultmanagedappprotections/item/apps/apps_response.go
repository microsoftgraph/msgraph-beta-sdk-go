...
type AppsResponse struct {
    ...
    nextLink *string;
    // 
    value []i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ManagedMobileApp;
}
...
func (m *AppsResponse) GetValue()([]i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ManagedMobileApp) {
    if m == nil {
        return nil
    } else {
        return m.value
...
func (m *AppsResponse) SetValue(value []i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.ManagedMobileApp)() {
    if m != nil {
        m.value = value
    }
}
