...
// DefaultManagedAppProtectionsRequestBuilder builds and executes requests for operations under \deviceAppManagement\defaultManagedAppProtections
...
// CreatePostRequestInformation default managed app policies.
...
func (m *DefaultManagedAppProtectionsRequestBuilder) Get(options *DefaultManagedAppProtectionsRequestBuilderGetOptions)(*DefaultManagedAppProtectionsResponse, error) {
    requestInfo, err := m.CreateGetRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return NewDefaultManagedAppProtectionsResponse() }, nil)
    if err != nil {
        return nil, err
    }
    return res.(*DefaultManagedAppProtectionsResponse), nil
}
// Post default managed app policies.
func (m *DefaultManagedAppProtectionsRequestBuilder) Post(options *DefaultManagedAppProtectionsRequestBuilderPostOptions)(*i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.DefaultManagedAppProtection, error) {
    requestInfo, err := m.CreatePostRequestInformation(options);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendAsync(*requestInfo, func () i04eb5309aeaafadd28374d79c8471df9b267510b4dc2e3144c378c50f6fd7b55.Parsable { return i535684e11b5500196ecb4b5c6634e0651fe2c2f78b6cd0fbe097d3c9029ae7bc.NewDefaultManagedAppProtection() }, nil)
    if err != nil {
        return nil, err
    }
