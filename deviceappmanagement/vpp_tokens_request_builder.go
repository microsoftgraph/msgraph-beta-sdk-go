...
func (m *VppTokensRequestBuilder) MicrosoftGraphGetLicensesForAppWithBundleId(bundleId *string)(*VppTokensMicrosoftGraphGetLicensesForAppWithBundleIdRequestBuilder) {
    return NewVppTokensMicrosoftGraphGetLicensesForAppWithBundleIdRequestBuilderInternal(m.pathParameters, m.requestAdapter, bundleId)
}
// MicrosoftGraphSyncLicenseCounts provides operations to call the syncLicenseCounts method.
func (m *VppTokensRequestBuilder) MicrosoftGraphSyncLicenseCounts()(*VppTokensMicrosoftGraphSyncLicenseCountsRequestBuilder) {
    return NewVppTokensMicrosoftGraphSyncLicenseCountsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
