...
func (m *VppTokensRequestBuilder) Get(ctx context.Context, requestConfiguration *VppTokensRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.VppTokenCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateVppTokenCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// MicrosoftGraphGetLicensesForAppWithBundleId provides operations to call the getLicensesForApp method.
func (m *VppTokensRequestBuilder) MicrosoftGraphGetLicensesForAppWithBundleId(bundleId *string)(*VppTokensMicrosoftGraphGetLicensesForAppWithBundleIdGetLicensesForAppWithBundleIdRequestBuilder) {
    return NewVppTokensMicrosoftGraphGetLicensesForAppWithBundleIdGetLicensesForAppWithBundleIdRequestBuilderInternal(m.pathParameters, m.requestAdapter, bundleId)
}
// MicrosoftGraphSyncLicenseCounts provides operations to call the syncLicenseCounts method.
func (m *VppTokensRequestBuilder) MicrosoftGraphSyncLicenseCounts()(*VppTokensMicrosoftGraphSyncLicenseCountsSyncLicenseCountsRequestBuilder) {
    return NewVppTokensMicrosoftGraphSyncLicenseCountsSyncLicenseCountsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
