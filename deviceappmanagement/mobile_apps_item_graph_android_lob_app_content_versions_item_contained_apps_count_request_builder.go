...
// NewMobileAppsItemGraphAndroidLobAppContentVersionsItemContainedAppsCountRequestBuilderInternal instantiates a new MobileAppsItemGraphAndroidLobAppContentVersionsItemContainedAppsCountRequestBuilder and sets the default values.
func NewMobileAppsItemGraphAndroidLobAppContentVersionsItemContainedAppsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileAppsItemGraphAndroidLobAppContentVersionsItemContainedAppsCountRequestBuilder) {
    m := &MobileAppsItemGraphAndroidLobAppContentVersionsItemContainedAppsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidLobApp/contentVersions/{mobileAppContent%2Did}/containedApps/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewMobileAppsItemGraphAndroidLobAppContentVersionsItemContainedAppsCountRequestBuilder instantiates a new MobileAppsItemGraphAndroidLobAppContentVersionsItemContainedAppsCountRequestBuilder and sets the default values.
