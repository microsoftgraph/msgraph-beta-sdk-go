...
func (m *MobileAppsItemGraphWindowsStoreAppAssignmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphWindowsStoreAppAssignmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
