...
// NewMobileAppsItemGraphWin32LobAppRelationshipsCountRequestBuilderInternal instantiates a new MobileAppsItemGraphWin32LobAppRelationshipsCountRequestBuilder and sets the default values.
func NewMobileAppsItemGraphWin32LobAppRelationshipsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileAppsItemGraphWin32LobAppRelationshipsCountRequestBuilder) {
    m := &MobileAppsItemGraphWin32LobAppRelationshipsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.win32LobApp/relationships/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewMobileAppsItemGraphWin32LobAppRelationshipsCountRequestBuilder instantiates a new MobileAppsItemGraphWin32LobAppRelationshipsCountRequestBuilder and sets the default values.
