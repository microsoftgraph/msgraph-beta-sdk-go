...
func (m *MobileAppsItemGraphWin32LobAppRelationshipsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphWin32LobAppRelationshipsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
