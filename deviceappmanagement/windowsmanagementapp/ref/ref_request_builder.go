...
// RefRequestBuilder builds and executes requests for operations under \deviceAppManagement\windowsManagementApp\$ref
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RefRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceAppManagement/windowsManagementApp/$ref";
...
// CreateDeleteRequestInformation windows management app.
...
// CreatePutRequestInformation windows management app.
