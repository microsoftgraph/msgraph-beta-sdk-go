...
func (m *WindowsManagedAppProtectionsWindowsManagedAppProtectionItemRequestBuilder) MicrosoftGraphAssign()(*WindowsManagedAppProtectionsItemMicrosoftGraphAssignRequestBuilder) {
    return NewWindowsManagedAppProtectionsItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphTargetApps provides operations to call the targetApps method.
func (m *WindowsManagedAppProtectionsWindowsManagedAppProtectionItemRequestBuilder) MicrosoftGraphTargetApps()(*WindowsManagedAppProtectionsItemMicrosoftGraphTargetAppsRequestBuilder) {
    return NewWindowsManagedAppProtectionsItemMicrosoftGraphTargetAppsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
