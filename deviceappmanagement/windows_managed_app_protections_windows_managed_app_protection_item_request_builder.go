...
func (m *WindowsManagedAppProtectionsWindowsManagedAppProtectionItemRequestBuilder) DeploymentSummary()(*WindowsManagedAppProtectionsItemDeploymentSummaryRequestBuilder) {
    return NewWindowsManagedAppProtectionsItemDeploymentSummaryRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
