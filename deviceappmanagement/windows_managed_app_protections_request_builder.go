...
func (m *WindowsManagedAppProtectionsRequestBuilder) WithUrl(rawUrl string)(*WindowsManagedAppProtectionsRequestBuilder) {
    return NewWindowsManagedAppProtectionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
