...
func (m *WindowsManagedAppProtectionsRequestBuilder) Count()(*WindowsManagedAppProtectionsCountRequestBuilder) {
    return NewWindowsManagedAppProtectionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *WindowsManagedAppProtectionsRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsManagedAppProtectionsRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.WindowsManagedAppProtectionCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateWindowsManagedAppProtectionCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
