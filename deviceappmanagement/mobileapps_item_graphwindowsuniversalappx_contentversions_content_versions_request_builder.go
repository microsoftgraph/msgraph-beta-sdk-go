...
// MobileappsItemGraphwindowsuniversalappxContentversionsContentVersionsRequestBuilderGetQueryParameters the list of content versions for this app. This property is read-only.
