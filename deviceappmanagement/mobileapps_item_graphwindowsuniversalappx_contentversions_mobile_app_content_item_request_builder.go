...
func (m *MobileappsItemGraphwindowsuniversalappxContentversionsMobileAppContentItemRequestBuilder) ContainedApps()(*MobileappsItemGraphwindowsuniversalappxContentversionsItemContainedappsContainedAppsRequestBuilder) {
    return NewMobileappsItemGraphwindowsuniversalappxContentversionsItemContainedappsContainedAppsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
