...
// MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder provides operations to manage the relationships property of the microsoft.graph.mobileApp entity.
...
type MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilderGetQueryParameters
}
// MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func (m *MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder) ByMobileAppRelationshipId(mobileAppRelationshipId string)(*MobileappsItemGraphwindowsmobilemsiRelationshipsMobileAppRelationshipItemRequestBuilder) {
    ...
    return NewMobileappsItemGraphwindowsmobilemsiRelationshipsMobileAppRelationshipItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
// NewMobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilderInternal instantiates a new MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder and sets the default values.
func NewMobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder) {
    m := &MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsMobileMSI/relationships{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewMobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder instantiates a new MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder and sets the default values.
func NewMobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewMobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder) WithUrl(rawUrl string)(*MobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder) {
    return NewMobileappsItemGraphwindowsmobilemsiRelationshipsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
