...
func (m *MobileAppsRequestBuilder) MicrosoftGraphGetMobileAppCountWithStatus(status *string)(*MobileAppsMicrosoftGraphGetMobileAppCountWithStatusRequestBuilder) {
    return NewMobileAppsMicrosoftGraphGetMobileAppCountWithStatusRequestBuilderInternal(m.pathParameters, m.requestAdapter, status)
}
// MicrosoftGraphGetTopMobileAppsWithStatusWithCount provides operations to call the getTopMobileApps method.
func (m *MobileAppsRequestBuilder) MicrosoftGraphGetTopMobileAppsWithStatusWithCount(count *int64, status *string)(*MobileAppsMicrosoftGraphGetTopMobileAppsWithStatusWithCountRequestBuilder) {
    return NewMobileAppsMicrosoftGraphGetTopMobileAppsWithStatusWithCountRequestBuilderInternal(m.pathParameters, m.requestAdapter, count, status)
}
// MicrosoftGraphHasPayloadLinks provides operations to call the hasPayloadLinks method.
func (m *MobileAppsRequestBuilder) MicrosoftGraphHasPayloadLinks()(*MobileAppsMicrosoftGraphHasPayloadLinksRequestBuilder) {
    return NewMobileAppsMicrosoftGraphHasPayloadLinksRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *MobileAppsRequestBuilder) MicrosoftGraphValidateXml()(*MobileAppsMicrosoftGraphValidateXmlRequestBuilder) {
    return NewMobileAppsMicrosoftGraphValidateXmlRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
