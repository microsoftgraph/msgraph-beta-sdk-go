...
func (m *PolicySetsItemAssignmentsRequestBuilder) Count()(*PolicySetsItemAssignmentsCountRequestBuilder) {
    return NewPolicySetsItemAssignmentsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
// CreateGetRequestInformation assignments of the PolicySet.
func (m *PolicySetsItemAssignmentsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *PolicySetsItemAssignmentsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
