...
func (m *TargetedmanagedappconfigurationsItemSettingsDeviceManagementConfigurationSettingItemRequestBuilder) SettingDefinitions()(*TargetedmanagedappconfigurationsItemSettingsItemSettingdefinitionsSettingDefinitionsRequestBuilder) {
    return NewTargetedmanagedappconfigurationsItemSettingsItemSettingdefinitionsSettingDefinitionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
