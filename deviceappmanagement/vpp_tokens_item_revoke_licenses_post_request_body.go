...
func NewVppTokensItemRevokeLicensesPostRequestBody()(*VppTokensItemRevokeLicensesPostRequestBody) {
    ...
    notifyManagedDevicesValue := false
    m.SetNotifyManagedDevices(&notifyManagedDevicesValue)
    revokeUntrackedLicensesValue := false
    m.SetRevokeUntrackedLicenses(&revokeUntrackedLicensesValue)
    return m
}
