...
// MobileAppsItemUpdateRelationshipsPostRequestBody provides operations to call the updateRelationships method.
...
func (m *MobileAppsItemUpdateRelationshipsPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *MobileAppsItemUpdateRelationshipsPostRequestBody) SetAdditionalData(value map[string]interface{})() {
