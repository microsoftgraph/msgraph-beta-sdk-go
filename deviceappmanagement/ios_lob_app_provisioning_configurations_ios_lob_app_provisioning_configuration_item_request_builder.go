...
func (m *IosLobAppProvisioningConfigurationsIosLobAppProvisioningConfigurationItemRequestBuilder) MicrosoftGraphAssign()(*IosLobAppProvisioningConfigurationsItemMicrosoftGraphAssignRequestBuilder) {
    return NewIosLobAppProvisioningConfigurationsItemMicrosoftGraphAssignRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
