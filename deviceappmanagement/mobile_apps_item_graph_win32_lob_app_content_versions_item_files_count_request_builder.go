...
func (m *MobileAppsItemGraphWin32LobAppContentVersionsItemFilesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphWin32LobAppContentVersionsItemFilesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
