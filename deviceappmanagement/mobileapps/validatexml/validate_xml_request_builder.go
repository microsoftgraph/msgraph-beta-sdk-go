...
func (m *ValidateXmlRequestBuilder) CreatePostRequestInformation(ctx context.Context, body ValidateXmlPostRequestBodyable, requestConfiguration *ValidateXmlRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ValidateXmlRequestBuilder) Post(ctx context.Context, body ValidateXmlPostRequestBodyable, requestConfiguration *ValidateXmlRequestBuilderPostRequestConfiguration)(ValidateXmlResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, CreateValidateXmlResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
