...
// RevokeAllLicensesRequestBuilder builds and executes requests for operations under \deviceAppManagement\mobileApps\{mobileApp-id}\userStatuses\{userAppInstallStatus-id}\app\microsoft.graph.iosVppApp\microsoft.graph.revokeAllLicenses
...
func NewRevokeAllLicensesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RevokeAllLicensesRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp_id}/userStatuses/{userAppInstallStatus_id}/app/microsoft.graph.iosVppApp/microsoft.graph.revokeAllLicenses";
