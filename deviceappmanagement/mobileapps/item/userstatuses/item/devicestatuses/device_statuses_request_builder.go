...
// DeviceStatusesRequestBuilder builds and executes requests for operations under \deviceAppManagement\mobileApps\{mobileApp-id}\userStatuses\{userAppInstallStatus-id}\deviceStatuses
...
// CreatePostRequestInformation the install state of the app on devices.
...
// Post the install state of the app on devices.
