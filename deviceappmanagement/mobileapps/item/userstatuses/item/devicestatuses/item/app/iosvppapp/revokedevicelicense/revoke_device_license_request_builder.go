...
// RevokeDeviceLicenseRequestBuilder builds and executes requests for operations under \deviceAppManagement\mobileApps\{mobileApp-id}\userStatuses\{userAppInstallStatus-id}\deviceStatuses\{mobileAppInstallStatus-id}\app\microsoft.graph.iosVppApp\microsoft.graph.revokeDeviceLicense
...
type RevokeDeviceLicenseRequestBuilderPostOptions struct {
    // 
    Body *RevokeDeviceLicenseRequestBody;
    // Request headers
    H map[string]string;
    // Request options
...
func NewRevokeDeviceLicenseRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*RevokeDeviceLicenseRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp_id}/userStatuses/{userAppInstallStatus_id}/deviceStatuses/{mobileAppInstallStatus_id}/app/microsoft.graph.iosVppApp/microsoft.graph.revokeDeviceLicense";
