...
// Builds and executes requests for operations under \deviceAppManagement\mobileApps\{mobileApp-id}\microsoft.graph.iosVppApp\microsoft.graph.revokeUserLicense
...
// Instantiates a new RevokeUserLicenseRequestBuilder and sets the default values.
// Parameters:
