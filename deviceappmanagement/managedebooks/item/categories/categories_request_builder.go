...
// Builds and executes requests for operations under \deviceAppManagement\managedEBooks\{managedEBook-id}\categories
...
func NewCategoriesRequestBuilderInternal(pathParameters map[string]string, requestAdapter ida96af0f171bb75f894a4013a6b3146a4397c58f11adb81a2b7cbea9314783a9.RequestAdapter)(*CategoriesRequestBuilder) {
    ...
    m.urlTemplate = "https://graph.microsoft.com/beta/deviceAppManagement/managedEBooks/{managedEBook_id}/categories{?top,skip,search,filter,count,orderby,select,expand}";
...
func (m *CategoriesRequestBuilder) Ref()(*i396bfe954496e31281b28a8f50ec136c3f84d1fa5cd51791df5a5ce64aa3be54.RefRequestBuilder) {
    return i396bfe954496e31281b28a8f50ec136c3f84d1fa5cd51791df5a5ce64aa3be54.NewRefRequestBuilderInternal(m.pathParameters, m.requestAdapter);
}
