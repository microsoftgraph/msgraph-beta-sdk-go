...
// NewMobileappsItemGraphwindowsstoreappAssignmentsCountRequestBuilderInternal instantiates a new MobileappsItemGraphwindowsstoreappAssignmentsCountRequestBuilder and sets the default values.
func NewMobileappsItemGraphwindowsstoreappAssignmentsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileappsItemGraphwindowsstoreappAssignmentsCountRequestBuilder) {
    m := &MobileappsItemGraphwindowsstoreappAssignmentsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsStoreApp/assignments/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewMobileappsItemGraphwindowsstoreappAssignmentsCountRequestBuilder instantiates a new MobileappsItemGraphwindowsstoreappAssignmentsCountRequestBuilder and sets the default values.
