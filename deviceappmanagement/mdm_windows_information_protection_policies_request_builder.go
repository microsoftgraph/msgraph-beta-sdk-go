...
func (m *MdmWindowsInformationProtectionPoliciesRequestBuilder) MicrosoftGraphHasPayloadLinks()(*MdmWindowsInformationProtectionPoliciesMicrosoftGraphHasPayloadLinksRequestBuilder) {
    return NewMdmWindowsInformationProtectionPoliciesMicrosoftGraphHasPayloadLinksRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
