...
func (m *MobileAppsItemGraphMacOSPkgAppAssignmentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphMacOSPkgAppAssignmentsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
