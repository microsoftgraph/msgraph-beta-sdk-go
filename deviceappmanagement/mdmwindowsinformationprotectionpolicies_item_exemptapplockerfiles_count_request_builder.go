...
// NewMdmwindowsinformationprotectionpoliciesItemExemptapplockerfilesCountRequestBuilderInternal instantiates a new MdmwindowsinformationprotectionpoliciesItemExemptapplockerfilesCountRequestBuilder and sets the default values.
func NewMdmwindowsinformationprotectionpoliciesItemExemptapplockerfilesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MdmwindowsinformationprotectionpoliciesItemExemptapplockerfilesCountRequestBuilder) {
    m := &MdmwindowsinformationprotectionpoliciesItemExemptapplockerfilesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicy%2Did}/exemptAppLockerFiles/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewMdmwindowsinformationprotectionpoliciesItemExemptapplockerfilesCountRequestBuilder instantiates a new MdmwindowsinformationprotectionpoliciesItemExemptapplockerfilesCountRequestBuilder and sets the default values.
...
func (m *MdmwindowsinformationprotectionpoliciesItemExemptapplockerfilesCountRequestBuilder) WithUrl(rawUrl string)(*MdmwindowsinformationprotectionpoliciesItemExemptapplockerfilesCountRequestBuilder) {
    return NewMdmwindowsinformationprotectionpoliciesItemExemptapplockerfilesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
