...
// AndroidManagedAppProtectionsResponse 
...
// NewAndroidManagedAppProtectionsResponse instantiates a new androidManagedAppProtectionsResponse and sets the default values.
