...
func (m *MobileAppsItemGraphWindowsAppXRelationshipsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphWindowsAppXRelationshipsCountRequestBuilderGetRequestConfiguration)(*int64, error) {
