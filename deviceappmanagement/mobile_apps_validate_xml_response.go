...
// MobileAppsValidateXmlResponse provides operations to call the validateXml method.
...
func (m *MobileAppsValidateXmlResponse) GetAdditionalData()(map[string]interface{}) {
...
func (m *MobileAppsValidateXmlResponse) SetAdditionalData(value map[string]interface{})() {
