...
// NewWindowsManagedAppProtectionsItemAssignRequestBuilderInternal instantiates a new AssignRequestBuilder and sets the default values.
func NewWindowsManagedAppProtectionsItemAssignRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsManagedAppProtectionsItemAssignRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/deviceAppManagement/windowsManagedAppProtections/{windowsManagedAppProtection%2Did}/assign";
...
// NewWindowsManagedAppProtectionsItemAssignRequestBuilder instantiates a new AssignRequestBuilder and sets the default values.
