...
func (m *DeviceAppManagementTasksDeviceAppManagementTaskItemRequestBuilder) Get(ctx context.Context, requestConfiguration *DeviceAppManagementTasksDeviceAppManagementTaskItemRequestBuilderGetRequestConfiguration)(ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.DeviceAppManagementTaskable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, ie233ee762e29b4ba6970aa2a2efce4b7fde11697ca9ea81099d0f8269309c1be.CreateDeviceAppManagementTaskFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *DeviceAppManagementTasksDeviceAppManagementTaskItemRequestBuilder) MicrosoftGraphUpdateStatus()(*DeviceAppManagementTasksItemMicrosoftGraphUpdateStatusRequestBuilder) {
    return NewDeviceAppManagementTasksItemMicrosoftGraphUpdateStatusRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
