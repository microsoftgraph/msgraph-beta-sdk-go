...
// NewMobileAppsItemGraphMacOSPkgAppContentVersionsCountRequestBuilderInternal instantiates a new MobileAppsItemGraphMacOSPkgAppContentVersionsCountRequestBuilder and sets the default values.
func NewMobileAppsItemGraphMacOSPkgAppContentVersionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileAppsItemGraphMacOSPkgAppContentVersionsCountRequestBuilder) {
    m := &MobileAppsItemGraphMacOSPkgAppContentVersionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSPkgApp/contentVersions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewMobileAppsItemGraphMacOSPkgAppContentVersionsCountRequestBuilder instantiates a new MobileAppsItemGraphMacOSPkgAppContentVersionsCountRequestBuilder and sets the default values.
...
// returns a *MobileAppsItemGraphMacOSPkgAppContentVersionsCountRequestBuilder when successful
