...
// AndroidManagedAppProtectionsHasPayloadLinksPostRequestBody provides operations to call the hasPayloadLinks method.
...
func (m *AndroidManagedAppProtectionsHasPayloadLinksPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *AndroidManagedAppProtectionsHasPayloadLinksPostRequestBody) SetAdditionalData(value map[string]interface{})() {
