...
func (m *CertificateBasedApplicationConfigurationsItemTrustedCertificateAuthoritiesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CertificateBasedApplicationConfigurationsItemTrustedCertificateAuthoritiesCountRequestBuilderGetRequestConfiguration)(*int64, error) {
